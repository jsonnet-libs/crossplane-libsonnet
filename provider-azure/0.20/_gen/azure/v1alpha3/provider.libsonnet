{
  ...
  '#':: d.pkg(name='provider', url='', help="\"A Provider configures an Azure 'provider', i.e. a connection to a particular Azure account using a particular Azure Service Principal.\""),
