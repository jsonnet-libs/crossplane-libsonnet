{
  ...
  '#':: d.pkg(name='providerConfig', url='', help="\"A ProviderConfig configures an Azure 'provider', i.e. a connection to a particular Azure account using a particular Azure Service Principal.\""),
