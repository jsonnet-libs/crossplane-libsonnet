{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#serverNameRef':: d.obj(help='"ServerNameRef - A reference to a server object to retrieve its name"'),
      serverNameRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { serverNameRef+: { name: name } } } },
      },
      '#serverNameSelector':: d.obj(help='"ServerNameSelector - A selector for a server object to retrieve its name"'),
      serverNameSelector: {
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
