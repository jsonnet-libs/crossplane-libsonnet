{
  ...
  spec: {
    ...
    connectionDetails: {
      ...
      '#withSkipPartOfReleaseCheck':: d.fn(help='"SkipPartOfReleaseCheck skips check for meta.helm.sh/release-name annotation."', args=[d.arg(name='skipPartOfReleaseCheck', type=d.T.boolean)]),
      withSkipPartOfReleaseCheck(skipPartOfReleaseCheck): { skipPartOfReleaseCheck: skipPartOfReleaseCheck },
    ...
    forProvider: {
      ...
      chart: {
        '#pullSecretRef':: d.obj(help='"PullSecretRef is reference to the secret containing credentials to helm repository"'),
        pullSecretRef: {
        ...
        '#withName':: d.fn(help='"Name of Helm chart, required if ChartSpec.URL not set"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { chart+: { name: name } } } },
        '#withRepository':: d.fn(help='"Repository: Helm repository URL, required if ChartSpec.URL not set"', args=[d.arg(name='repository', type=d.T.string)]),
        withRepository(repository): { spec+: { forProvider+: { chart+: { repository: repository } } } },
        '#withUrl':: d.fn(help='"URL to chart package (typically .tgz), optional and overrides others fields in the spec"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { forProvider+: { chart+: { url: url } } } },
        '#withVersion':: d.fn(help='"Version of Helm chart, late initialized with latest version if not set"', args=[d.arg(name='version', type=d.T.string)]),
        withVersion(version): { spec+: { forProvider+: { chart+: { version: version } } } },
      },
      '#patchesFrom':: d.obj(help='"PatchesFrom describe patches to be applied to the rendered manifests."'),
      patchesFrom: {
      ...
      '#withInsecureSkipTLSVerify':: d.fn(help='"InsecureSkipTLSVerify skips tls certificate checks for the chart download"', args=[d.arg(name='insecureSkipTLSVerify', type=d.T.boolean)]),
      withInsecureSkipTLSVerify(insecureSkipTLSVerify): { spec+: { forProvider+: { insecureSkipTLSVerify: insecureSkipTLSVerify } } },
      '#withNamespace':: d.fn(help='"Namespace to install the release into."', args=[d.arg(name='namespace', type=d.T.string)]),
      withNamespace(namespace): { spec+: { forProvider+: { namespace: namespace } } },
      '#withPatchesFrom':: d.fn(help='"PatchesFrom describe patches to be applied to the rendered manifests."', args=[d.arg(name='patchesFrom', type=d.T.array)]),
      withPatchesFrom(patchesFrom): { spec+: { forProvider+: { patchesFrom: if std.isArray(v=patchesFrom) then patchesFrom else [patchesFrom] } } },
      '#withPatchesFromMixin':: d.fn(help='"PatchesFrom describe patches to be applied to the rendered manifests."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='patchesFrom', type=d.T.array)]),
      ...
      '#withSkipCRDs':: d.fn(help='"SkipCRDs skips installation of CRDs for the release."', args=[d.arg(name='skipCRDs', type=d.T.boolean)]),
      withSkipCRDs(skipCRDs): { spec+: { forProvider+: { skipCRDs: skipCRDs } } },
      '#withSkipCreateNamespace':: d.fn(help="\"SkipCreateNamespace won't create the namespace for the release. This requires the namespace to already exist.\"", args=[d.arg(name='skipCreateNamespace', type=d.T.boolean)]),
      withSkipCreateNamespace(skipCreateNamespace): { spec+: { forProvider+: { skipCreateNamespace: skipCreateNamespace } } },
      ...
      '#withWait':: d.fn(help='"Wait for the release to become ready."', args=[d.arg(name='wait', type=d.T.boolean)]),
      withWait(wait): { spec+: { forProvider+: { wait: wait } } },
      '#withWaitTimeout':: d.fn(help='"WaitTimeout is the duration Helm will wait for the release to become ready. Only applies if wait is also set. Defaults to 5m."', args=[d.arg(name='waitTimeout', type=d.T.string)]),
      withWaitTimeout(waitTimeout): { spec+: { forProvider+: { waitTimeout: waitTimeout } } },
    },
