{
  ...
  spec: {
    ...
    forProvider: {
      ...
      ip: {
        '#withIpRanges':: d.fn(help='"List of IP address ranges in IPv4 CIDR format (e.g. 1.2.3.4/32) or any allowable IPv6 format from IETF RFC596."', args=[d.arg(name='ipRanges', type=d.T.array)]),
        withIpRanges(ipRanges): { ipRanges: if std.isArray(v=ipRanges) then ipRanges else [ipRanges] },
        '#withIpRangesMixin':: d.fn(help='"List of IP address ranges in IPv4 CIDR format (e.g. 1.2.3.4/32) or any allowable IPv6 format from IETF RFC596."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipRanges', type=d.T.array)]),
