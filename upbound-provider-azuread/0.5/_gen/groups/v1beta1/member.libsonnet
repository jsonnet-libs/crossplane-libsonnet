{
  ...
  '#':: d.pkg(name='member', url='', help='"Member is the Schema for the Members API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#groupObjectIdRef':: d.obj(help='"Reference to a Group to populate groupObjectId."'),
      groupObjectIdRef: {
      ...
      '#groupObjectIdSelector':: d.obj(help='"Selector for a Group to populate groupObjectId."'),
      ...
      '#withGroupObjectId':: d.fn(help='"The object ID of the group you want to add the member to"', args=[d.arg(name='groupObjectId', type=d.T.string)]),
      withGroupObjectId(groupObjectId): { spec+: { forProvider+: { groupObjectId: groupObjectId } } },
      '#withMemberObjectId':: d.fn(help='"The object ID of the principal you want to add as a member to the group. Supported object types are Users, Groups or Service Principals"', args=[d.arg(name='memberObjectId', type=d.T.string)]),
