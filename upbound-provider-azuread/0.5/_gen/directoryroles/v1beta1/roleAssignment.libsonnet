{
  ...
  '#':: d.pkg(name='roleAssignment', url='', help='"RoleAssignment is the Schema for the RoleAssignments API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#roleIdRef':: d.obj(help='"Reference to a Role to populate roleId."'),
      roleIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#roleIdSelector':: d.obj(help='"Selector for a Role to populate roleId."'),
      roleIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withAppScopeId':: d.fn(help='"Identifier of the app-specific scope when the assignment scope is app-specific"', args=[d.arg(name='appScopeId', type=d.T.string)]),
      withAppScopeId(appScopeId): { spec+: { forProvider+: { appScopeId: appScopeId } } },
      '#withAppScopeObjectId':: d.fn(help='"Identifier of the app-specific scope when the assignment scope is app-specific"', args=[d.arg(name='appScopeObjectId', type=d.T.string)]),
      withAppScopeObjectId(appScopeObjectId): { spec+: { forProvider+: { appScopeObjectId: appScopeObjectId } } },
      '#withDirectoryScopeId':: d.fn(help='"Identifier of the directory object representing the scope of the assignment"', args=[d.arg(name='directoryScopeId', type=d.T.string)]),
      withDirectoryScopeId(directoryScopeId): { spec+: { forProvider+: { directoryScopeId: directoryScopeId } } },
      '#withDirectoryScopeObjectId':: d.fn(help='"Identifier of the directory object representing the scope of the assignment"', args=[d.arg(name='directoryScopeObjectId', type=d.T.string)]),
      withDirectoryScopeObjectId(directoryScopeObjectId): { spec+: { forProvider+: { directoryScopeObjectId: directoryScopeObjectId } } },
      '#withPrincipalObjectId':: d.fn(help='"The object ID of the member principal"', args=[d.arg(name='principalObjectId', type=d.T.string)]),
      withPrincipalObjectId(principalObjectId): { spec+: { forProvider+: { principalObjectId: principalObjectId } } },
      '#withRoleId':: d.fn(help='"The object ID of the directory role for this assignment"', args=[d.arg(name='roleId', type=d.T.string)]),
