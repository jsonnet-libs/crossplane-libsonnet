{
  ...
  spec: {
    ...
    forProvider: {
      '#permissions':: d.obj(help='"A collection of permissions blocks as documented below. List of permissions that are included in the custom directory role"'),
      permissions: {
        '#withAllowedResourceActions':: d.fn(help='"A set of tasks that can be performed on a resource. For more information, see the Permissions Reference documentation. Set of tasks that can be performed on a resource"', args=[d.arg(name='allowedResourceActions', type=d.T.array)]),
        ...
        '#withAllowedResourceActionsMixin':: d.fn(help='"A set of tasks that can be performed on a resource. For more information, see the Permissions Reference documentation. Set of tasks that can be performed on a resource"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedResourceActions', type=d.T.array)]),
      ...
      '#withDescription':: d.fn(help='"The description of the custom directory role. The description of the custom directory role"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name of the custom directory role. The display name of the custom directory role"', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withEnabled':: d.fn(help='"Indicates whether the role is enabled for assignment. Indicates whether the role is enabled for assignment"', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withPermissions':: d.fn(help='"A collection of permissions blocks as documented below. List of permissions that are included in the custom directory role"', args=[d.arg(name='permissions', type=d.T.array)]),
      withPermissions(permissions): { spec+: { forProvider+: { permissions: if std.isArray(v=permissions) then permissions else [permissions] } } },
      '#withPermissionsMixin':: d.fn(help='"A collection of permissions blocks as documented below. List of permissions that are included in the custom directory role"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='permissions', type=d.T.array)]),
      ...
      '#withTemplateId':: d.fn(help='"Custom template identifier that is typically used if one needs an identifier to be the same across different directories. Changing this forces a new resource to be created. Custom template identifier that is typically used if one needs an identifier to be the same across different directories."', args=[d.arg(name='templateId', type=d.T.string)]),
      withTemplateId(templateId): { spec+: { forProvider+: { templateId: templateId } } },
      '#withVersion':: d.fn(help='"- The version of the role definition. This can be any arbitrary string between 1-128 characters. The version of the role definition."', args=[d.arg(name='version', type=d.T.string)]),
