{
  ...
  '#':: d.pkg(name='certificate', url='', help='"Certificate is the Schema for the Certificates API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#valueSecretRef':: d.obj(help='"The certificate data, which can be PEM encoded, base64 encoded DER or hexadecimal encoded DER. See also the `encoding` argumen"'),
      valueSecretRef: {
      ...
      '#withApplicationObjectId':: d.fn(help='"The object ID of the application for which this certificate should be created"', args=[d.arg(name='applicationObjectId', type=d.T.string)]),
      withApplicationObjectId(applicationObjectId): { spec+: { forProvider+: { applicationObjectId: applicationObjectId } } },
      '#withEncoding':: d.fn(help='"Specifies the encoding used for the supplied certificate data"', args=[d.arg(name='encoding', type=d.T.string)]),
      withEncoding(encoding): { spec+: { forProvider+: { encoding: encoding } } },
      '#withEndDate':: d.fn(help='"The end date until which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If omitted, the API will decide a suitable expiry date, which is typically around 2 years from the start date"', args=[d.arg(name='endDate', type=d.T.string)]),
      withEndDate(endDate): { spec+: { forProvider+: { endDate: endDate } } },
      '#withEndDateRelative':: d.fn(help='"A relative duration for which the certificate is valid until, for example `240h` (10 days) or `2400h30m`"', args=[d.arg(name='endDateRelative', type=d.T.string)]),
      withEndDateRelative(endDateRelative): { spec+: { forProvider+: { endDateRelative: endDateRelative } } },
      '#withKeyId':: d.fn(help='"A UUID used to uniquely identify this certificate. If omitted, a random UUID will be automatically generated"', args=[d.arg(name='keyId', type=d.T.string)]),
      withKeyId(keyId): { spec+: { forProvider+: { keyId: keyId } } },
      '#withStartDate':: d.fn(help="\"The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date and time are use\"", args=[d.arg(name='startDate', type=d.T.string)]),
      withStartDate(startDate): { spec+: { forProvider+: { startDate: startDate } } },
      '#withType':: d.fn(help='"The type of key/certificate"', args=[d.arg(name='type', type=d.T.string)]),
