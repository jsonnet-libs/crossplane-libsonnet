{
  ...
  '#':: d.pkg(name='password', url='', help='"Password is the Schema for the Passwords API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationObjectId':: d.fn(help='"The object ID of the application for which this password should be created"', args=[d.arg(name='applicationObjectId', type=d.T.string)]),
      withApplicationObjectId(applicationObjectId): { spec+: { forProvider+: { applicationObjectId: applicationObjectId } } },
      '#withDisplayName':: d.fn(help='"A display name for the password"', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withEndDate':: d.fn(help='"The end date until which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`)"', args=[d.arg(name='endDate', type=d.T.string)]),
      withEndDate(endDate): { spec+: { forProvider+: { endDate: endDate } } },
      '#withEndDateRelative':: d.fn(help='"A relative duration for which the password is valid until, for example `240h` (10 days) or `2400h30m`. Changing this field forces a new resource to be created"', args=[d.arg(name='endDateRelative', type=d.T.string)]),
      withEndDateRelative(endDateRelative): { spec+: { forProvider+: { endDateRelative: endDateRelative } } },
      '#withRotateWhenChanged':: d.fn(help='"Arbitrary map of values that, when changed, will trigger rotation of the password"', args=[d.arg(name='rotateWhenChanged', type=d.T.object)]),
      withRotateWhenChanged(rotateWhenChanged): { spec+: { forProvider+: { rotateWhenChanged: rotateWhenChanged } } },
      '#withRotateWhenChangedMixin':: d.fn(help='"Arbitrary map of values that, when changed, will trigger rotation of the password"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rotateWhenChanged', type=d.T.object)]),
      withRotateWhenChangedMixin(rotateWhenChanged): { spec+: { forProvider+: { rotateWhenChanged+: rotateWhenChanged } } },
      '#withStartDate':: d.fn(help="\"The start date from which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used\"", args=[d.arg(name='startDate', type=d.T.string)]),
