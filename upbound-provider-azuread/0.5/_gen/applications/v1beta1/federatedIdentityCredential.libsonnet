{
  ...
  '#':: d.pkg(name='federatedIdentityCredential', url='', help='"FederatedIdentityCredential is the Schema for the FederatedIdentityCredentials API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationObjectId':: d.fn(help='"The object ID of the application for which this federated identity credential should be created"', args=[d.arg(name='applicationObjectId', type=d.T.string)]),
      withApplicationObjectId(applicationObjectId): { spec+: { forProvider+: { applicationObjectId: applicationObjectId } } },
      '#withAudiences':: d.fn(help='"List of audiences that can appear in the external token. This specifies what should be accepted in the `aud` claim of incoming tokens."', args=[d.arg(name='audiences', type=d.T.array)]),
      ...
      '#withDescription':: d.fn(help='"A description for the federated identity credential"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"A unique display name for the federated identity credential"', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withIssuer':: d.fn(help='"The URL of the external identity provider, which must match the issuer claim of the external token being exchanged. The combination of the values of issuer and subject must be unique on the app."', args=[d.arg(name='issuer', type=d.T.string)]),
      withIssuer(issuer): { spec+: { forProvider+: { issuer: issuer } } },
      '#withSubject':: d.fn(help='"The identifier of the external software workload within the external identity provider. The combination of issuer and subject must be unique on the app."', args=[d.arg(name='subject', type=d.T.string)]),
