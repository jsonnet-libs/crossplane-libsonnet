{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnabled':: d.fn(help='"Whether or not the synchronization job is enabled"', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withServicePrincipalId':: d.fn(help='"The object ID of the service principal for which this synchronization job should be created"', args=[d.arg(name='servicePrincipalId', type=d.T.string)]),
      withServicePrincipalId(servicePrincipalId): { spec+: { forProvider+: { servicePrincipalId: servicePrincipalId } } },
      '#withTemplateId':: d.fn(help='"Identifier of the synchronization template this job is based on."', args=[d.arg(name='templateId', type=d.T.string)]),
