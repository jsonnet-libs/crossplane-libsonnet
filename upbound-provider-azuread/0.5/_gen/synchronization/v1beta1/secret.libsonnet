{
  ...
  '#':: d.pkg(name='secret', url='', help='"Secret is the Schema for the Secrets API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#credential':: d.obj(help=''),
      credential: {
        '#valueSecretRef':: d.obj(help='"Value for this key-value pair."'),
        valueSecretRef: {
        ...
        '#withKey':: d.fn(help='"Name for this key-value pair."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { key: key },
      },
