{
  ...
  '#':: d.pkg(name='tokenSigningCertificate', url='', help='"TokenSigningCertificate is the Schema for the TokenSigningCertificates API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDisplayName':: d.fn(help='"A friendly name for the certificate"', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withEndDate':: d.fn(help='"The end date until which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Default is 3 years from current date."', args=[d.arg(name='endDate', type=d.T.string)]),
