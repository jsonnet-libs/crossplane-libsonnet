{
  ...
  spec: {
    ...
    forProvider: {
      '#servicePrincipalIdRef':: d.obj(help='"Reference to a Principal to populate servicePrincipalId."'),
      ...
      '#servicePrincipalIdSelector':: d.obj(help='"Selector for a Principal to populate servicePrincipalId."'),
      ...
      '#valueSecretRef':: d.obj(help='"The certificate data, which can be PEM encoded, base64 encoded DER or hexadecimal encoded DER"'),
      valueSecretRef: {
      ...
      '#withEndDate':: d.fn(help='"The end date until which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`)"', args=[d.arg(name='endDate', type=d.T.string)]),
      withEndDate(endDate): { spec+: { forProvider+: { endDate: endDate } } },
      '#withEndDateRelative':: d.fn(help='"A relative duration for which the certificate is valid until, for example `240h` (10 days) or `2400h30m`. Valid time units are \\"ns\\", \\"us\\" (or \\"µs\\"), \\"ms\\", \\"s\\", \\"m\\", \\"h\\', args=[d.arg(name='endDateRelative', type=d.T.string)]),
      withEndDateRelative(endDateRelative): { spec+: { forProvider+: { endDateRelative: endDateRelative } } },
      '#withKeyId':: d.fn(help='"A UUID used to uniquely identify this certificate. If not specified a UUID will be automatically generated"', args=[d.arg(name='keyId', type=d.T.string)]),
      withKeyId(keyId): { spec+: { forProvider+: { keyId: keyId } } },
      '#withServicePrincipalId':: d.fn(help='"The object ID of the service principal for which this certificate should be created"', args=[d.arg(name='servicePrincipalId', type=d.T.string)]),
      withServicePrincipalId(servicePrincipalId): { spec+: { forProvider+: { servicePrincipalId: servicePrincipalId } } },
      '#withStartDate':: d.fn(help="\"The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used\"", args=[d.arg(name='startDate', type=d.T.string)]),
