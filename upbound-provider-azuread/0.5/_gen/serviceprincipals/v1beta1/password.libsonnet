{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withServicePrincipalId':: d.fn(help='"The object ID of the service principal for which this password should be created"', args=[d.arg(name='servicePrincipalId', type=d.T.string)]),
