{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withClaimsMappingPolicyId':: d.fn(help='"The ID of the claims mapping policy to assign. ID of the claims mapping policy to assign"', args=[d.arg(name='claimsMappingPolicyId', type=d.T.string)]),
      withClaimsMappingPolicyId(claimsMappingPolicyId): { spec+: { forProvider+: { claimsMappingPolicyId: claimsMappingPolicyId } } },
      '#withServicePrincipalId':: d.fn(help='"The object ID of the service principal for the policy assignment. Object ID of the service principal for which to assign the policy"', args=[d.arg(name='servicePrincipalId', type=d.T.string)]),
