{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAppRoleId':: d.fn(help='"The ID of the app role to be assigned"', args=[d.arg(name='appRoleId', type=d.T.string)]),
      withAppRoleId(appRoleId): { spec+: { forProvider+: { appRoleId: appRoleId } } },
      '#withPrincipalObjectId':: d.fn(help='"The object ID of the user, group or service principal to be assigned this app role"', args=[d.arg(name='principalObjectId', type=d.T.string)]),
      withPrincipalObjectId(principalObjectId): { spec+: { forProvider+: { principalObjectId: principalObjectId } } },
      '#withResourceObjectId':: d.fn(help='"The object ID of the service principal representing the resource"', args=[d.arg(name='resourceObjectId', type=d.T.string)]),
