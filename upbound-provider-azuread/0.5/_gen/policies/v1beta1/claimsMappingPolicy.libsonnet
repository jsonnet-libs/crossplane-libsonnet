{
  ...
  '#':: d.pkg(name='claimsMappingPolicy', url='', help='"ClaimsMappingPolicy is the Schema for the ClaimsMappingPolicys API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClaimsMappingPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClaimsMappingPolicySpec defines the desired state of ClaimsMappingPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDefinition':: d.fn(help='"The claims mapping policy. This is a JSON formatted string, for which the jsonencode() function can be used. A string collection containing a JSON string that defines the rules and settings for this policy"', args=[d.arg(name='definition', type=d.T.array)]),
      withDefinition(definition): { spec+: { forProvider+: { definition: if std.isArray(v=definition) then definition else [definition] } } },
      '#withDefinitionMixin':: d.fn(help='"The claims mapping policy. This is a JSON formatted string, for which the jsonencode() function can be used. A string collection containing a JSON string that defines the rules and settings for this policy"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='definition', type=d.T.array)]),
      withDefinitionMixin(definition): { spec+: { forProvider+: { definition+: if std.isArray(v=definition) then definition else [definition] } } },
      '#withDisplayName':: d.fn(help='"The display name for this Claims Mapping Policy. Display name for this policy"', args=[d.arg(name='displayName', type=d.T.string)]),
