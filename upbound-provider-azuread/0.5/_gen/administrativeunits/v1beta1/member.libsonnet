{
  ...
  spec: {
    ...
    forProvider: {
      '#administrativeUnitObjectIdRef':: d.obj(help='"Reference to a Unit to populate administrativeUnitObjectId."'),
      ...
      '#administrativeUnitObjectIdSelector':: d.obj(help='"Selector for a Unit to populate administrativeUnitObjectId."'),
      ...
      '#withAdministrativeUnitObjectId':: d.fn(help='"The object ID of the administrative unit"', args=[d.arg(name='administrativeUnitObjectId', type=d.T.string)]),
      ...
      '#withMemberObjectId':: d.fn(help='"The object ID of the member"', args=[d.arg(name='memberObjectId', type=d.T.string)]),
