{
  ...
  '#':: d.pkg(name='unit', url='', help='"Unit is the Schema for the Units API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Unit', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"UnitSpec defines the desired state of Unit"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"The description for the administrative unit"', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name for the administrative unit"', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withHiddenMembershipEnabled':: d.fn(help='"Whether the administrative unit and its members are hidden or publicly viewable in the directory"', args=[d.arg(name='hiddenMembershipEnabled', type=d.T.boolean)]),
      withHiddenMembershipEnabled(hiddenMembershipEnabled): { spec+: { forProvider+: { hiddenMembershipEnabled: hiddenMembershipEnabled } } },
      '#withMembers':: d.fn(help='"A set of object IDs of members who should be present in this administrative unit. Supported object types are Users or Groups"', args=[d.arg(name='members', type=d.T.array)]),
      withMembers(members): { spec+: { forProvider+: { members: if std.isArray(v=members) then members else [members] } } },
      '#withMembersMixin':: d.fn(help='"A set of object IDs of members who should be present in this administrative unit. Supported object types are Users or Groups"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='members', type=d.T.array)]),
      withMembersMixin(members): { spec+: { forProvider+: { members+: if std.isArray(v=members) then members else [members] } } },
      '#withPreventDuplicateNames':: d.fn(help='"If `true`, will return an error if an existing administrative unit is found with the same name"', args=[d.arg(name='preventDuplicateNames', type=d.T.boolean)]),
