{
  ...
  spec: {
    ...
    forProvider: {
      '#restore':: d.obj(help='"A restore block as defined below. only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new resource to be created."'),
      restore: {
      ...
      '#withCollation':: d.fn(help='"The name of the collation to use with this pool, only applicable when create_mode is set to Default. Azure default is SQL_LATIN1_GENERAL_CP1_CI_AS. Changing this forces a new resource to be created."', args=[d.arg(name='collation', type=d.T.string)]),
      withCollation(collation): { spec+: { forProvider+: { collation: collation } } },
      '#withCreateMode':: d.fn(help='"Specifies how to create the SQL Pool. Valid values are: Default, Recovery or PointInTimeRestore. Must be Default to create a new database. Defaults to Default. Changing this forces a new resource to be created."', args=[d.arg(name='createMode', type=d.T.string)]),
      ...
      '#withGeoBackupPolicyEnabled':: d.fn(help='"Is geo-backup policy enabled? Defaults to true."', args=[d.arg(name='geoBackupPolicyEnabled', type=d.T.boolean)]),
      ...
      '#withRestore':: d.fn(help='"A restore block as defined below. only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new resource to be created."', args=[d.arg(name='restore', type=d.T.array)]),
      withRestore(restore): { spec+: { forProvider+: { restore: if std.isArray(v=restore) then restore else [restore] } } },
      '#withRestoreMixin':: d.fn(help='"A restore block as defined below. only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='restore', type=d.T.array)]),
