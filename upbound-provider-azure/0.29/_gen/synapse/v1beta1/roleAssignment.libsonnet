{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRoleName':: d.fn(help='"The Role Name of the Synapse Built-In Role. Changing this forces a new resource to be created."', args=[d.arg(name='roleName', type=d.T.string)]),
