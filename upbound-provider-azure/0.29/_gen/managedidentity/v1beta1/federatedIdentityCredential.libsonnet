{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAudience':: d.fn(help='"Specifies the audience for this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created."', args=[d.arg(name='audience', type=d.T.array)]),
      withAudience(audience): { spec+: { forProvider+: { audience: if std.isArray(v=audience) then audience else [audience] } } },
      '#withAudienceMixin':: d.fn(help='"Specifies the audience for this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='audience', type=d.T.array)]),
      withAudienceMixin(audience): { spec+: { forProvider+: { audience+: if std.isArray(v=audience) then audience else [audience] } } },
      '#withIssuer':: d.fn(help='"Specifies the issuer of this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created."', args=[d.arg(name='issuer', type=d.T.string)]),
      ...
      '#withSubject':: d.fn(help='"Specifies the subject for this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created."', args=[d.arg(name='subject', type=d.T.string)]),
