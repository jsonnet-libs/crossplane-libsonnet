{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReservationCapacityInGbPerDay':: d.fn(help='"The capacity reservation level in GB for this workspace. Must be in increments of 100 between 100 and 5000."', args=[d.arg(name='reservationCapacityInGbPerDay', type=d.T.number)]),
