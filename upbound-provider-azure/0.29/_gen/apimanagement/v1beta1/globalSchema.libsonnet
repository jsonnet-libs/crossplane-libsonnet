{
  ...
  '#':: d.pkg(name='globalSchema', url='', help='"GlobalSchema is the Schema for the GlobalSchemas API. Manages a Global Schema within an API Management Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalSchema', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GlobalSchemaSpec defines the desired state of GlobalSchema"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the schema."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The content type of the Schema. Possible values are xml and json."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { forProvider+: { type: type } } },
      '#withValue':: d.fn(help='"The string defining the document representing the Schema."', args=[d.arg(name='value', type=d.T.string)]),
