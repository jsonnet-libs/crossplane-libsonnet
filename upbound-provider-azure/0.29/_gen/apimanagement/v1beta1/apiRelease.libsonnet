{
  ...
  '#':: d.pkg(name='apiRelease', url='', help='"APIRelease is the Schema for the APIReleases API. Manages a API Management API Release."'),
  ...
  '#new':: d.fn(help='new returns an instance of APIRelease', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APIReleaseSpec defines the desired state of APIRelease"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiId':: d.fn(help='"The ID of the API Management API. Changing this forces a new API Management API Release to be created."', args=[d.arg(name='apiId', type=d.T.string)]),
      withApiId(apiId): { spec+: { forProvider+: { apiId: apiId } } },
      '#withNotes':: d.fn(help='"The Release Notes."', args=[d.arg(name='notes', type=d.T.string)]),
