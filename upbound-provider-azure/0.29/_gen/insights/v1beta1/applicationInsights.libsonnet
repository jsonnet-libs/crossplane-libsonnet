{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withWorkspaceId':: d.fn(help='"Specifies the id of a log analytics workspace resource. Changing this forces a new resource to be created."', args=[d.arg(name='workspaceId', type=d.T.string)]),
