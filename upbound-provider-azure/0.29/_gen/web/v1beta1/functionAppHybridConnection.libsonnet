{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFunctionAppId':: d.fn(help='"The ID of the Function App for this Hybrid Connection. Changing this forces a new resource to be created. The ID of the Function App for this Hybrid Connection."', args=[d.arg(name='functionAppId', type=d.T.string)]),
      withFunctionAppId(functionAppId): { spec+: { forProvider+: { functionAppId: functionAppId } } },
      '#withHostname':: d.fn(help='"The hostname of the endpoint. The hostname of the endpoint."', args=[d.arg(name='hostname', type=d.T.string)]),
      withHostname(hostname): { spec+: { forProvider+: { hostname: hostname } } },
      '#withPort':: d.fn(help='"The port to use for the endpoint The port to use for the endpoint"', args=[d.arg(name='port', type=d.T.number)]),
      withPort(port): { spec+: { forProvider+: { port: port } } },
      '#withRelayId':: d.fn(help='"The ID of the Relay Hybrid Connection to use. Changing this forces a new resource to be created. The ID of the Relay Hybrid Connection to use."', args=[d.arg(name='relayId', type=d.T.string)]),
      withRelayId(relayId): { spec+: { forProvider+: { relayId: relayId } } },
      '#withSendKeyName':: d.fn(help='"The name of the Relay key with Send permission to use. Defaults to RootManageSharedAccessKey The name of the Relay key with `Send` permission to use. Defaults to `RootManageSharedAccessKey`"', args=[d.arg(name='sendKeyName', type=d.T.string)]),
