{
  ...
  spec: {
    ...
    forProvider: {
      ...
      file: {
        '#withContent':: d.fn(help='"The content of the file. Changing this forces a new resource to be created. The content of the file."', args=[d.arg(name='content', type=d.T.string)]),
        withContent(content): { content: content },
        '#withName':: d.fn(help='"The filename of the file to be uploaded. Changing this forces a new resource to be created. The filename of the file to be uploaded."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withConfigJson':: d.fn(help='"The config for this Function in JSON format. The config for this Function in JSON format."', args=[d.arg(name='configJson', type=d.T.string)]),
      withConfigJson(configJson): { spec+: { forProvider+: { configJson: configJson } } },
      '#withEnabled':: d.fn(help='"Should this function be enabled. Defaults to true. Should this function be enabled. Defaults to `true`."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withFunctionAppId':: d.fn(help='"The ID of the Function App in which this function should reside. Changing this forces a new resource to be created. The ID of the Function App in which this function should reside."', args=[d.arg(name='functionAppId', type=d.T.string)]),
      withFunctionAppId(functionAppId): { spec+: { forProvider+: { functionAppId: functionAppId } } },
      '#withLanguage':: d.fn(help='"The language the Function is written in. Possible values are CSharp, Custom, Java, Javascript, Python, PowerShell, and TypeScript. The language the Function is written in."', args=[d.arg(name='language', type=d.T.string)]),
      withLanguage(language): { spec+: { forProvider+: { language: language } } },
      '#withName':: d.fn(help='"The name of the function. Changing this forces a new resource to be created. The name of the function."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withTestData':: d.fn(help='"The test data for the function. The test data for the function."', args=[d.arg(name='testData', type=d.T.string)]),
