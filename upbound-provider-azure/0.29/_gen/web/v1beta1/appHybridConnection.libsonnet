{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withWebAppId':: d.fn(help='"The ID of the Web App for this Hybrid Connection. Changing this forces a new resource to be created. The ID of the Web App for this Hybrid Connection."', args=[d.arg(name='webAppId', type=d.T.string)]),
