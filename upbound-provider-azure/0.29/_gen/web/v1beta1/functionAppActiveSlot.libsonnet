{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOverwriteNetworkConfig':: d.fn(help="\"The swap action should overwrite the Production slot's network configuration with the configuration from this slot. Defaults to true. Changing this forces a new resource to be created. The swap action should overwrite the Production slot's network configuration with the configuration from this slot. Defaults to `true`.\"", args=[d.arg(name='overwriteNetworkConfig', type=d.T.boolean)]),
      withOverwriteNetworkConfig(overwriteNetworkConfig): { spec+: { forProvider+: { overwriteNetworkConfig: overwriteNetworkConfig } } },
      '#withSlotId':: d.fn(help='"The ID of the Slot to swap with Production. The ID of the Slot to swap with `Production`."', args=[d.arg(name='slotId', type=d.T.string)]),
