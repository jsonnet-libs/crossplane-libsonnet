{
  ...
  spec: {
    ...
    forProvider: {
      ...
      password1: {
        '#withExpiry':: d.fn(help='"The expiration date of the password in RFC3339 format. Changing this forces a new resource to be created."', args=[d.arg(name='expiry', type=d.T.string)]),
