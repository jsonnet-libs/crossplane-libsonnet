{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withServiceLevel':: d.fn(help='"The service level of the file system. Valid values include Premium, Standard, or Ultra. Changing this forces a new resource to be created."', args=[d.arg(name='serviceLevel', type=d.T.string)]),
      withServiceLevel(serviceLevel): { spec+: { forProvider+: { serviceLevel: serviceLevel } } },
      '#withSizeInTb':: d.fn(help='"Provisioned size of the pool in TB. Value must be between 4 and 500."', args=[d.arg(name='sizeInTb', type=d.T.number)]),
