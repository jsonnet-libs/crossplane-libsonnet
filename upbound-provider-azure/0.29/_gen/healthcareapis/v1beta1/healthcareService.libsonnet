{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCosmosdbThroughput':: d.fn(help='"The provisioned throughput for the backing database. Range of 400-10000. Defaults to 400."', args=[d.arg(name='cosmosdbThroughput', type=d.T.number)]),
