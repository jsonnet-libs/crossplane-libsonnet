{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLoadbalancerId':: d.fn(help='"The ID of the LoadBalancer in which to create the NAT Rule. Changing this forces a new resource to be created."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
      withLoadbalancerId(loadbalancerId): { spec+: { forProvider+: { loadbalancerId: loadbalancerId } } },
      '#withNumberOfProbes':: d.fn(help='"The number of failed probe attempts after which the backend endpoint is removed from rotation. The default value is 2. NumberOfProbes multiplied by intervalInSeconds value must be greater or equal to 10.Endpoints are returned to rotation when at least one probe is successful."', args=[d.arg(name='numberOfProbes', type=d.T.number)]),
