  ...
  spec: {
    ...
    forProvider: {
      ...
      httpListener: {
        ...
        withProtocol(protocol): { protocol: protocol },
        '#withRequireSni':: d.fn(help='"Should Server Name Indication be Required?"', args=[d.arg(name='requireSni', type=d.T.boolean)]),
      ...
      wafConfiguration: {
        ...
        '#withRuleSetType':: d.fn(help='"The Type of the Rule Set used for this Web Application Firewall. Possible values are OWASP and Microsoft_BotManagerRuleSet."', args=[d.arg(name='ruleSetType', type=d.T.string)]),
        withRuleSetType(ruleSetType): { ruleSetType: ruleSetType },
        '#withRuleSetVersion':: d.fn(help='"The Version of the Rule Set used for this Web Application Firewall. Possible values are 0.1, 1.0, 2.2.9, 3.0, 3.1 and 3.2."', args=[d.arg(name='ruleSetVersion', type=d.T.string)]),
