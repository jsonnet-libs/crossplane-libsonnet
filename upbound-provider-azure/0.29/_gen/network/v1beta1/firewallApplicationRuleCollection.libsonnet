{
  ...
  spec: {
    ...
    forProvider: {
      '#azureFirewallNameRef':: d.obj(help='"Reference to a Firewall to populate azureFirewallName."'),
      ...
      '#azureFirewallNameSelector':: d.obj(help='"Selector for a Firewall to populate azureFirewallName."'),
