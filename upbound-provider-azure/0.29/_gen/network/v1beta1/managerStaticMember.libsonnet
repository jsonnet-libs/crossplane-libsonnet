{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#targetVirtualNetworkIdRef':: d.obj(help='"Reference to a VirtualNetwork to populate targetVirtualNetworkId."'),
      ...
      '#targetVirtualNetworkIdSelector':: d.obj(help='"Selector for a VirtualNetwork to populate targetVirtualNetworkId."'),
