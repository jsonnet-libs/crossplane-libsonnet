{
  ...
  '#':: d.pkg(name='managerNetworkGroup', url='', help='"ManagerNetworkGroup is the Schema for the ManagerNetworkGroups API. Manages a Network Manager Network Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagerNetworkGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagerNetworkGroupSpec defines the desired state of ManagerNetworkGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description of the Network Manager Network Group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withNetworkManagerId':: d.fn(help='"Specifies the ID of the Network Manager. Changing this forces a new Network Manager Network Group to be created."', args=[d.arg(name='networkManagerId', type=d.T.string)]),
