{
  ...
  '#':: d.pkg(name='dDoSProtectionPlan', url='', help='"DDoSProtectionPlan is the Schema for the DDoSProtectionPlans API. Manages an Azure Network DDoS Protection Plan."'),
  ...
  '#new':: d.fn(help='new returns an instance of DDoSProtectionPlan', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DDoSProtectionPlanSpec defines the desired state of DDoSProtectionPlan"'),
  spec: {
