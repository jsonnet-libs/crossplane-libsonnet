{
  ...
  '#':: d.pkg(name='watcher', url='', help='"Watcher is the Schema for the Watchers API. Manages a Network Watcher."'),
  ...
  '#new':: d.fn(help='new returns an instance of Watcher', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WatcherSpec defines the desired state of Watcher"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Network Watcher. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
