{
  ...
  spec: {
    ...
    forProvider: {
      '#natRuleIdRef':: d.obj(help='"Reference to a LoadBalancerNatRule to populate natRuleId."'),
      natRuleIdRef: {
      ...
      '#natRuleIdSelector':: d.obj(help='"Selector for a LoadBalancerNatRule to populate natRuleId."'),
      natRuleIdSelector: {
