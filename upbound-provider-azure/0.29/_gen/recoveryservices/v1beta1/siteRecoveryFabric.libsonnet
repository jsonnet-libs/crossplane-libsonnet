{
  ...
  '#':: d.pkg(name='siteRecoveryFabric', url='', help='"SiteRecoveryFabric is the Schema for the SiteRecoveryFabrics API. Manages a Site Recovery Replication Fabric on Azure."'),
  ...
  '#new':: d.fn(help='new returns an instance of SiteRecoveryFabric', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SiteRecoveryFabricSpec defines the desired state of SiteRecoveryFabric"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"In what region should the fabric be located. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
