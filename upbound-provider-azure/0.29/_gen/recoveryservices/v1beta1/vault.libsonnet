  ...
  spec: {
    ...
    forProvider: {
      ...
      encryption: {
        ...
        '#withUseSystemAssignedIdentity':: d.fn(help='"Indicate that system assigned identity should be used or not. Defaults to true."', args=[d.arg(name='useSystemAssignedIdentity', type=d.T.boolean)]),
