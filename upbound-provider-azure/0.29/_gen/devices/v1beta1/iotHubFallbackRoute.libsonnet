{
  ...
  spec: {
    ...
    forProvider: {
      '#endpointNamesRefs':: d.obj(help='"References to IOTHubEndpointStorageContainer to populate endpointNames."'),
      endpointNamesRefs: {
      ...
      '#endpointNamesSelector':: d.obj(help='"Selector for a list of IOTHubEndpointStorageContainer to populate endpointNames."'),
      ...
      '#iothubNameRef':: d.obj(help='"Reference to a IOTHub to populate iothubName."'),
      iothubNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#iothubNameSelector':: d.obj(help='"Selector for a IOTHub to populate iothubName."'),
      iothubNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withCondition':: d.fn(help='"The condition that is evaluated to apply the routing rule. If no condition is provided, it evaluates to true by default. For grammar, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language."', args=[d.arg(name='condition', type=d.T.string)]),
      ...
      '#withEndpointNamesRefs':: d.fn(help='"References to IOTHubEndpointStorageContainer to populate endpointNames."', args=[d.arg(name='endpointNamesRefs', type=d.T.array)]),
      ...
      '#withEndpointNamesRefsMixin':: d.fn(help='"References to IOTHubEndpointStorageContainer to populate endpointNames."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpointNamesRefs', type=d.T.array)]),
      ...
      '#withSource':: d.fn(help='"The source that the routing rule is to be applied to. Possible values include: DeviceConnectionStateEvents, DeviceJobLifecycleEvents, DeviceLifecycleEvents, DeviceMessages, DigitalTwinChangeEvents, Invalid, TwinChangeEvents."', args=[d.arg(name='source', type=d.T.string)]),
