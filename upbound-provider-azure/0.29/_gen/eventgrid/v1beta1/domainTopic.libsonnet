{
  ...
  '#':: d.pkg(name='domainTopic', url='', help='"DomainTopic is the Schema for the DomainTopics API. Manages an EventGrid Domain Topic"'),
  ...
  '#new':: d.fn(help='new returns an instance of DomainTopic', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DomainTopicSpec defines the desired state of DomainTopic"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#domainNameRef':: d.obj(help='"Reference to a Domain in eventgrid to populate domainName."'),
      domainNameRef: {
      ...
      '#domainNameSelector':: d.obj(help='"Selector for a Domain in eventgrid to populate domainName."'),
      domainNameSelector: {
      ...
      '#withDomainName':: d.fn(help='"Specifies the name of the EventGrid Domain. Changing this forces a new resource to be created."', args=[d.arg(name='domainName', type=d.T.string)]),
