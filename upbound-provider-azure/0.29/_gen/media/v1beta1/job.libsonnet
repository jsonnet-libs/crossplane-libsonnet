{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPriority':: d.fn(help='"Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal. Changing this forces a new Media Job to be created. Possible values are High, Normal and Low."', args=[d.arg(name='priority', type=d.T.string)]),
