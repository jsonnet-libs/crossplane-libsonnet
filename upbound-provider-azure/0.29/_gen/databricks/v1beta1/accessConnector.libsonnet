{
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"The type of identity to use for this Access Connector. SystemAssigned is the only possible value."', args=[d.arg(name='type', type=d.T.string)]),
