{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNotificationSettings':: d.fn(help='"The notification setting of a schedule. A notification_settings as defined below."', args=[d.arg(name='notificationSettings', type=d.T.array)]),
      ...
      '#withNotificationSettingsMixin':: d.fn(help='"The notification setting of a schedule. A notification_settings as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='notificationSettings', type=d.T.array)]),
