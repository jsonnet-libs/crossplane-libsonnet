{
  ...
  spec: {
    ...
    forProvider: {
      ...
      subnet: {
        '#withUseInVirtualMachineCreation':: d.fn(help='"Can this subnet be used for creating Virtual Machines? Possible values are Allow, Default and Deny."', args=[d.arg(name='useInVirtualMachineCreation', type=d.T.string)]),
        withUseInVirtualMachineCreation(useInVirtualMachineCreation): { useInVirtualMachineCreation: useInVirtualMachineCreation },
        '#withUsePublicIpAddress':: d.fn(help='"Can Virtual Machines in this Subnet use Public IP Addresses? Possible values are Allow, Default and Deny."', args=[d.arg(name='usePublicIpAddress', type=d.T.string)]),
