{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSubscriptionId':: d.fn(help='"The ID of the Subscription. Changing this forces a new Subscription to be created. The GUID of the Subscription."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
      withSubscriptionId(subscriptionId): { spec+: { forProvider+: { subscriptionId: subscriptionId } } },
      '#withSubscriptionName':: d.fn(help='"The Name of the Subscription. This is the Display Name in the portal. The Display Name for the Subscription."', args=[d.arg(name='subscriptionName', type=d.T.string)]),
      ...
      '#withWorkload':: d.fn(help='"The workload type of the Subscription. Possible values are Production (default) and DevTest. Changing this forces a new Subscription to be created. The workload type for the Subscription. Possible values are `Production` (default) and `DevTest`."', args=[d.arg(name='workload', type=d.T.string)]),
