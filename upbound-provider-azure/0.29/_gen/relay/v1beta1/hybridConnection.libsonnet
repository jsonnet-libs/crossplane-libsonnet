{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRequiresClientAuthorization':: d.fn(help='"Specify if client authorization is needed for this hybrid connection. True by default. Changing this forces a new resource to be created. Defaults to true."', args=[d.arg(name='requiresClientAuthorization', type=d.T.boolean)]),
