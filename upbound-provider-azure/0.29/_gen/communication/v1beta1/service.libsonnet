{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDataLocation':: d.fn(help='"The location where the Communication service stores its data at rest. Possible values are Africa, Asia Pacific, Australia, Brazil, Canada, Europe, France, Germany, India, Japan, Korea, Norway, Switzerland, UAE, UK and United States. Defaults to United States."', args=[d.arg(name='dataLocation', type=d.T.string)]),
