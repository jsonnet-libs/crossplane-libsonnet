{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDatastoreType':: d.fn(help='"Specifies the type of the data store. Possible values are ArchiveStore, SnapshotStore and VaultStore. Changing this forces a new resource to be created."', args=[d.arg(name='datastoreType', type=d.T.string)]),
      ...
      '#withRedundancy':: d.fn(help='"Specifies the backup storage redundancy. Possible values are GeoRedundant and LocallyRedundant. Changing this forces a new Backup Vault to be created."', args=[d.arg(name='redundancy', type=d.T.string)]),
