{
  ...
  spec: {
    ...
    forProvider: {
      ...
      encryption: {
        '#withKeySource':: d.fn(help='"The source of the encryption key. Possible values are Microsoft.Automation and Microsoft.Keyvault."', args=[d.arg(name='keySource', type=d.T.string)]),
