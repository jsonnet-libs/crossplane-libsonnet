{
  ...
  spec: {
    ...
    forProvider: {
      '#eventhubNameRef':: d.obj(help='"Reference to a EventHub to populate eventhubName."'),
      eventhubNameRef: {
      ...
      '#eventhubNameSelector':: d.obj(help='"Selector for a EventHub to populate eventhubName."'),
