{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#namespaceNameRef':: d.obj(help='"Reference to a EventHubNamespace to populate namespaceName."'),
      namespaceNameRef: {
      ...
      '#namespaceNameSelector':: d.obj(help='"Selector for a EventHubNamespace to populate namespaceName."'),
      ...
      '#withPartitionCount':: d.fn(help='"Specifies the current number of shards on the Event Hub. Changing this will force-recreate the resource."', args=[d.arg(name='partitionCount', type=d.T.number)]),
