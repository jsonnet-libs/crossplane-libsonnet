{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#namespaceJunction':: d.obj(help='"Can be specified multiple times to define multiple namespace_junction. Each namespace_juntion block supports fields documented below."'),
      namespaceJunction: {
      ...
      '#withNamespaceJunction':: d.fn(help='"Can be specified multiple times to define multiple namespace_junction. Each namespace_juntion block supports fields documented below."', args=[d.arg(name='namespaceJunction', type=d.T.array)]),
      ...
      '#withNamespaceJunctionMixin':: d.fn(help='"Can be specified multiple times to define multiple namespace_junction. Each namespace_juntion block supports fields documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='namespaceJunction', type=d.T.array)]),
      ...
      '#withUsageModel':: d.fn(help='"The type of usage of the HPC Cache NFS Target. Possible values are: READ_HEAVY_INFREQ, READ_HEAVY_CHECK_180, WRITE_WORKLOAD_15, WRITE_AROUND, WRITE_WORKLOAD_CHECK_30, WRITE_WORKLOAD_CHECK_60 and WRITE_WORKLOAD_CLOUDWS."', args=[d.arg(name='usageModel', type=d.T.string)]),
