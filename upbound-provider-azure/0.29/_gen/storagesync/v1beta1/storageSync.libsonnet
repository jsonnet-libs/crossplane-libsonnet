{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIncomingTrafficPolicy':: d.fn(help='"Incoming traffic policy. Possible values are AllowAllTraffic and AllowVirtualNetworksOnly."', args=[d.arg(name='incomingTrafficPolicy', type=d.T.string)]),
