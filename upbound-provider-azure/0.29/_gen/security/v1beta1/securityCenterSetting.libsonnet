{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSettingName':: d.fn(help='"The setting to manage. Possible values are MCAS , WDATP and SENTINEL. Changing this forces a new resource to be created."', args=[d.arg(name='settingName', type=d.T.string)]),
