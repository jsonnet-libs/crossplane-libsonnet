{
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"The type of Managed Service Identity that is configured on this Digital Twins instance. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
