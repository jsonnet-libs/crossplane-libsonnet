{
  ...
  spec: {
    ...
    forProvider: {
      '#dataDisk':: d.obj(help='"One or more data_disk elements as defined below."'),
      dataDisk: {
      ...
      '#osDisk':: d.obj(help='"One or more os_disk elements as defined below. Changing this forces a new resource to be created."'),
      osDisk: {
      ...
      '#withDataDisk':: d.fn(help='"One or more data_disk elements as defined below."', args=[d.arg(name='dataDisk', type=d.T.array)]),
      withDataDisk(dataDisk): { spec+: { forProvider+: { dataDisk: if std.isArray(v=dataDisk) then dataDisk else [dataDisk] } } },
      '#withDataDiskMixin':: d.fn(help='"One or more data_disk elements as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dataDisk', type=d.T.array)]),
      withDataDiskMixin(dataDisk): { spec+: { forProvider+: { dataDisk+: if std.isArray(v=dataDisk) then dataDisk else [dataDisk] } } },
      '#withHyperVGeneration':: d.fn(help='"The HyperVGenerationType of the VirtualMachine created from the image as V1, V2. The default is V1. Changing this forces a new resource to be created."', args=[d.arg(name='hyperVGeneration', type=d.T.string)]),
      withHyperVGeneration(hyperVGeneration): { spec+: { forProvider+: { hyperVGeneration: hyperVGeneration } } },
      '#withLocation':: d.fn(help='"Specified the supported Azure location where the resource exists. Changing this forces a new resource to be created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withOsDisk':: d.fn(help='"One or more os_disk elements as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='osDisk', type=d.T.array)]),
      withOsDisk(osDisk): { spec+: { forProvider+: { osDisk: if std.isArray(v=osDisk) then osDisk else [osDisk] } } },
      '#withOsDiskMixin':: d.fn(help='"One or more os_disk elements as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='osDisk', type=d.T.array)]),
      withOsDiskMixin(osDisk): { spec+: { forProvider+: { osDisk+: if std.isArray(v=osDisk) then osDisk else [osDisk] } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create. Changing this forces a new resource to be created. the image. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
