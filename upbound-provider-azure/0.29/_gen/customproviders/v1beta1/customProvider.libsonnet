  ...
  spec: {
    ...
    forProvider: {
      ...
      resourceType: {
        ...
        withName(name): { name: name },
        '#withRoutingType':: d.fn(help='"The routing type that is supported for the resource request. Valid values are Proxy and Proxy,Cache. This value defaults to ResourceTypeRoutingProxy."', args=[d.arg(name='routingType', type=d.T.string)]),
