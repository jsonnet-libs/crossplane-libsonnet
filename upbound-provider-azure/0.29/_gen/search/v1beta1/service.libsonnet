{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowedIps':: d.fn(help='"A list of IPv4 addresses or CIDRs that are allowed access to the search service endpoint."', args=[d.arg(name='allowedIps', type=d.T.array)]),
      withAllowedIps(allowedIps): { spec+: { forProvider+: { allowedIps: if std.isArray(v=allowedIps) then allowedIps else [allowedIps] } } },
      '#withAllowedIpsMixin':: d.fn(help='"A list of IPv4 addresses or CIDRs that are allowed access to the search service endpoint."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedIps', type=d.T.array)]),
      ...
      '#withPartitionCount':: d.fn(help='"The number of partitions which should be created."', args=[d.arg(name='partitionCount', type=d.T.number)]),
      withPartitionCount(partitionCount): { spec+: { forProvider+: { partitionCount: partitionCount } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Whether or not public network access is allowed for this resource. Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withReplicaCount':: d.fn(help="\"The number of replica's which should be created.\"", args=[d.arg(name='replicaCount', type=d.T.number)]),
      ...
      '#withSku':: d.fn(help='"The SKU which should be used for this Search Service. Possible values are basic, free, standard, standard2, standard3, storage_optimized_l1 and storage_optimized_l2. Changing this forces a new Search Service to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Search Service."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Search Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
