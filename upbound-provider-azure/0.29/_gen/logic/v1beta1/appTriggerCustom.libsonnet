{
  ...
  '#':: d.pkg(name='appTriggerCustom', url='', help='"AppTriggerCustom is the Schema for the AppTriggerCustoms API. Manages a Custom Trigger within a Logic App Workflow"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppTriggerCustom', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppTriggerCustomSpec defines the desired state of AppTriggerCustom"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBody':: d.fn(help='"Specifies the JSON Blob defining the Body of this Custom Trigger."', args=[d.arg(name='body', type=d.T.string)]),
