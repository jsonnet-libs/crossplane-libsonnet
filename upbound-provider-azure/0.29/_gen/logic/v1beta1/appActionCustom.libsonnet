{
  ...
  '#':: d.pkg(name='appActionCustom', url='', help='"AppActionCustom is the Schema for the AppActionCustoms API. Manages a Custom Action within a Logic App Workflow"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppActionCustom', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppActionCustomSpec defines the desired state of AppActionCustom"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBody':: d.fn(help='"Specifies the JSON Blob defining the Body of this Custom Action."', args=[d.arg(name='body', type=d.T.string)]),
