{
  ...
  '#':: d.pkg(name='mssqlElasticPool', url='', help='"MSSQLElasticPool is the Schema for the MSSQLElasticPools API. Manages a SQL Elastic Pool."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      sku: {
        ...
        '#withName':: d.fn(help='"Specifies the SKU Name for this Elasticpool. The name of the SKU, will be either vCore based tier + family pattern (e.g. GP_Gen4, BC_Gen5) or the DTU based BasicPool, StandardPool, or PremiumPool pattern. Possible values are BasicPool, StandardPool, PremiumPool, GP_Gen4, GP_Gen5, GP_Fsv2, GP_DC, BC_Gen4, BC_Gen5 and BC_DC."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withTier':: d.fn(help='"The tier of the particular SKU. Possible values are GeneralPurpose, BusinessCritical, Basic, Standard, or Premium. For more information see the documentation for your Elasticpool configuration: vCore-based or DTU-based."', args=[d.arg(name='tier', type=d.T.string)]),
