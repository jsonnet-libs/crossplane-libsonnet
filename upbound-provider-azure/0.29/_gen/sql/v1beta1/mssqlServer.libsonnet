  ...
  spec: {
    ...
    forProvider: {
      ...
      azureadAdministrator: {
        '#withAzureadAuthenticationOnly':: d.fn(help='"Specifies whether only AD Users and administrators (like azuread_administrator.0.login_username) can be used to login, or also local database users (like administrator_login). When true, the administrator_login and administrator_login_password properties can be omitted."', args=[d.arg(name='azureadAuthenticationOnly', type=d.T.boolean)]),
      ...
      identity: {
        ...
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this SQL Server. Possible values are SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
