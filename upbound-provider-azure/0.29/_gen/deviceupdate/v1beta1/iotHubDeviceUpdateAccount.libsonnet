{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSku':: d.fn(help='"Sku of the IoT Hub Device Update Account. Possible values are Free and Standard. Defaults to Standard."', args=[d.arg(name='sku', type=d.T.string)]),
