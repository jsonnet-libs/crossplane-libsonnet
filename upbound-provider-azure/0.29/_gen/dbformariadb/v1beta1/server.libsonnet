{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#creationSourceServerIdRef':: d.obj(help='"Reference to a Server to populate creationSourceServerId."'),
      ...
      '#creationSourceServerIdSelector':: d.obj(help='"Selector for a Server to populate creationSourceServerId."'),
