{
  ...
  '#':: d.pkg(name='kubernetesFleetManager', url='', help='"KubernetesFleetManager is the Schema for the KubernetesFleetManagers API. Manages a Kubernetes Fleet Manager."'),
  ...
  '#new':: d.fn(help='new returns an instance of KubernetesFleetManager', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"KubernetesFleetManagerSpec defines the desired state of KubernetesFleetManager"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#hubProfile':: d.obj(help="\"A hub_profile block as defined below. The FleetHubProfile configures the Fleet's hub. Changing this forces a new Kubernetes Fleet Manager to be created.\""),
      hubProfile: {
        '#withDnsPrefix':: d.fn(help='', args=[d.arg(name='dnsPrefix', type=d.T.string)]),
        withDnsPrefix(dnsPrefix): { dnsPrefix: dnsPrefix },
      },
      ...
      '#withHubProfile':: d.fn(help="\"A hub_profile block as defined below. The FleetHubProfile configures the Fleet's hub. Changing this forces a new Kubernetes Fleet Manager to be created.\"", args=[d.arg(name='hubProfile', type=d.T.array)]),
      withHubProfile(hubProfile): { spec+: { forProvider+: { hubProfile: if std.isArray(v=hubProfile) then hubProfile else [hubProfile] } } },
      '#withHubProfileMixin':: d.fn(help="\"A hub_profile block as defined below. The FleetHubProfile configures the Fleet's hub. Changing this forces a new Kubernetes Fleet Manager to be created.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='hubProfile', type=d.T.array)]),
      withHubProfileMixin(hubProfile): { spec+: { forProvider+: { hubProfile+: if std.isArray(v=hubProfile) then hubProfile else [hubProfile] } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Kubernetes Fleet Manager should exist. Changing this forces a new Kubernetes Fleet Manager to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group within which this Kubernetes Fleet Manager should exist. Changing this forces a new Kubernetes Fleet Manager to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Kubernetes Fleet Manager."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Kubernetes Fleet Manager."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
