  ...
  spec: {
    ...
    forProvider: {
      ...
      apiServerAccessProfile: {
        ...
        withVnetIntegrationEnabled(vnetIntegrationEnabled): { vnetIntegrationEnabled: vnetIntegrationEnabled },
      },
      ...
      defaultNodePool: {
        ...
        '#withNodeTaints':: d.fn(help='"A list of the taints added to new nodes during node pool create and scale. Changing this forces a new resource to be created."', args=[d.arg(name='nodeTaints', type=d.T.array)]),
        withNodeTaints(nodeTaints): { nodeTaints: if std.isArray(v=nodeTaints) then nodeTaints else [nodeTaints] },
        '#withNodeTaintsMixin':: d.fn(help='"A list of the taints added to new nodes during node pool create and scale. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeTaints', type=d.T.array)]),
      ...
      keyManagementService: {
        '#withKeyVaultKeyId':: d.fn(help='"Identifier of Azure Key Vault key. See key identifier format for more details. When Azure Key Vault key management service is enabled, this field is required and must be a valid key identifier. When enabled is false, leave the field empty."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
        withKeyVaultKeyId(keyVaultKeyId): { keyVaultKeyId: keyVaultKeyId },
        '#withKeyVaultNetworkAccess':: d.fn(help='"Network access of the key vault Network access of key vault. The possible values are Public and Private. Public means the key vault allows public access from all networks. Private means the key vault disables public access and enables private link. The default value is Public."', args=[d.arg(name='keyVaultNetworkAccess', type=d.T.string)]),
      ...
      networkProfile: {
        ...
        '#natGatewayProfile':: d.obj(help='"A nat_gateway_profile block as defined below."'),
        natGatewayProfile: {
          '#withIdleTimeoutInMinutes':: d.fn(help='"Desired outbound flow idle timeout in minutes for the cluster load balancer. Must be between 4 and 120 inclusive. Defaults to 4."', args=[d.arg(name='idleTimeoutInMinutes', type=d.T.number)]),
          withIdleTimeoutInMinutes(idleTimeoutInMinutes): { idleTimeoutInMinutes: idleTimeoutInMinutes },
          '#withManagedOutboundIpCount':: d.fn(help='"Count of desired managed outbound IPs for the cluster load balancer. Must be between 1 and 100 inclusive."', args=[d.arg(name='managedOutboundIpCount', type=d.T.number)]),
        ...
        '#withNatGatewayProfile':: d.fn(help='"A nat_gateway_profile block as defined below."', args=[d.arg(name='natGatewayProfile', type=d.T.array)]),
      ...
      '#withApiServerAuthorizedIpRanges':: d.fn(help='', args=[d.arg(name='apiServerAuthorizedIpRanges', type=d.T.array)]),
      ...
      '#withNodeResourceGroup':: d.fn(help='"The auto-generated Resource Group which contains the resources for this Managed Kubernetes Cluster. Changing this forces a new resource to be created."', args=[d.arg(name='nodeResourceGroup', type=d.T.string)]),
