{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#streamAnalyticsJobIdRef':: d.obj(help='"Reference to a Job to populate streamAnalyticsJobId."'),
      ...
      '#streamAnalyticsJobIdSelector':: d.obj(help='"Selector for a Job to populate streamAnalyticsJobId."'),
