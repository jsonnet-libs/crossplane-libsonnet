{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVirtualNetworkSubnetIds':: d.fn(help='"A list of virtual network subnet ids to be used by Integration Service Environment. Exactly four distinct ids to subnets must be provided. Changing this forces a new Integration Service Environment to be created."', args=[d.arg(name='virtualNetworkSubnetIds', type=d.T.array)]),
      ...
      '#withVirtualNetworkSubnetIdsMixin':: d.fn(help='"A list of virtual network subnet ids to be used by Integration Service Environment. Exactly four distinct ids to subnets must be provided. Changing this forces a new Integration Service Environment to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='virtualNetworkSubnetIds', type=d.T.array)]),
