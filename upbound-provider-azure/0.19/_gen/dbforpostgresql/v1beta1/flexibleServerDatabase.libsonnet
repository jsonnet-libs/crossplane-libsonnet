{
  ...
  spec: {
    ...
    forProvider: {
      '#serverIdRef':: d.obj(help='"Reference to a FlexibleServer to populate serverId."'),
      serverIdRef: {
      ...
      '#serverIdSelector':: d.obj(help='"Selector for a FlexibleServer to populate serverId."'),
      serverIdSelector: {
