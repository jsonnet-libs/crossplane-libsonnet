  ...
  spec: {
    ...
    forProvider: {
      ...
      frontendIpConfiguration: {
        ...
        '#withGatewayLoadBalancerFrontendIpConfigurationId':: d.fn(help='"The id of the Frontend IP Configuration of a Gateway Load Balancer that this Load Balancer points to."', args=[d.arg(name='gatewayLoadBalancerFrontendIpConfigurationId', type=d.T.string)]),
        ...
        '#withPrivateIpAddress':: d.fn(help='"Private IP Address to assign to the Load Balancer."', args=[d.arg(name='privateIpAddress', type=d.T.string)]),
        withPrivateIpAddress(privateIpAddress): { privateIpAddress: privateIpAddress },
        '#withPrivateIpAddressAllocation':: d.fn(help='"The allocation method for the Private IP Address used by this Load Balancer."', args=[d.arg(name='privateIpAddressAllocation', type=d.T.string)]),
        ...
        '#withPublicIpAddressId':: d.fn(help='"The ID of a  Public IP Address which is associated with this Load Balancer."', args=[d.arg(name='publicIpAddressId', type=d.T.string)]),
        withPublicIpAddressId(publicIpAddressId): { publicIpAddressId: publicIpAddressId },
        '#withPublicIpPrefixId':: d.fn(help='"The ID of a Public IP Prefix which is associated with the Load Balancer."', args=[d.arg(name='publicIpPrefixId', type=d.T.string)]),
        withPublicIpPrefixId(publicIpPrefixId): { publicIpPrefixId: publicIpPrefixId },
        '#withSubnetId':: d.fn(help='"The ID of the Subnet which is associated with the IP Configuration."', args=[d.arg(name='subnetId', type=d.T.string)]),
      ...
      '#withLocation':: d.fn(help='"Specifies the supported Azure Region where the Load Balancer should be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which to create the Load Balancer."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"The SKU of the Azure Load Balancer. Accepted values are Basic, Standard and Gateway. Defaults to Basic."', args=[d.arg(name='sku', type=d.T.string)]),
