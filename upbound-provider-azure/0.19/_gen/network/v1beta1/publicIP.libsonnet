{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIpTags':: d.fn(help='"A mapping of IP tags to assign to the public IP."', args=[d.arg(name='ipTags', type=d.T.object)]),
      withIpTags(ipTags): { spec+: { forProvider+: { ipTags: ipTags } } },
      '#withIpTagsMixin':: d.fn(help='"A mapping of IP tags to assign to the public IP."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipTags', type=d.T.object)]),
      withIpTagsMixin(ipTags): { spec+: { forProvider+: { ipTags+: ipTags } } },
      '#withIpVersion':: d.fn(help='"The IP Version to use, IPv6 or IPv4."', args=[d.arg(name='ipVersion', type=d.T.string)]),
      ...
      '#withPublicIpPrefixId':: d.fn(help='"If specified then public IP address allocated will be provided from the public IP prefix resource."', args=[d.arg(name='publicIpPrefixId', type=d.T.string)]),
      ...
      '#withSku':: d.fn(help='"The SKU of the Public IP. Accepted values are Basic and Standard. Defaults to Basic."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withSkuTier':: d.fn(help='"The SKU Tier that should be used for the Public IP. Possible values are Regional and Global. Defaults to Regional."', args=[d.arg(name='skuTier', type=d.T.string)]),
      ...
      '#withZones':: d.fn(help='"A collection containing the availability zone to allocate the Public IP in."', args=[d.arg(name='zones', type=d.T.array)]),
      withZones(zones): { spec+: { forProvider+: { zones: if std.isArray(v=zones) then zones else [zones] } } },
      '#withZonesMixin':: d.fn(help='"A collection containing the availability zone to allocate the Public IP in."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zones', type=d.T.array)]),
