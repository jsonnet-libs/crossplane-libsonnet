{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the local network gateway."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
