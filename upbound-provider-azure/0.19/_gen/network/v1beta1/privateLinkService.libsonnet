{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnableProxyProtocol':: d.fn(help='"Should the Private Link Service support the Proxy Protocol? Defaults to false."', args=[d.arg(name='enableProxyProtocol', type=d.T.boolean)]),
      withEnableProxyProtocol(enableProxyProtocol): { spec+: { forProvider+: { enableProxyProtocol: enableProxyProtocol } } },
      '#withLoadBalancerFrontendIpConfigurationIds':: d.fn(help='"A list of Frontend IP Configuration IDs from a Standard Load Balancer, where traffic from the Private Link Service should be routed. You can use Load Balancer Rules to direct this traffic to appropriate backend pools where your applications are running."', args=[d.arg(name='loadBalancerFrontendIpConfigurationIds', type=d.T.array)]),
      ...
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource. Changing this forces a new resource to be created."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the resource. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
