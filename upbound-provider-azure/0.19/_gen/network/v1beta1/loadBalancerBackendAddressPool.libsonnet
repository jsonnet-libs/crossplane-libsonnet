  ...
  spec: {
    ...
    forProvider: {
      ...
      tunnelInterface: {
        ...
        '#withProtocol':: d.fn(help='"The protocol used for this Gateway Lodbalancer Tunnel Interface. Possible values are Native and VXLAN."', args=[d.arg(name='protocol', type=d.T.string)]),
        withProtocol(protocol): { protocol: protocol },
        '#withType':: d.fn(help='"The traffic type of this Gateway Lodbalancer Tunnel Interface. Possible values are Internal and External."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the Backend Address Pool."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
