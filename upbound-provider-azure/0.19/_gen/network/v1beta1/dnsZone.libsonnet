{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#soaRecord':: d.obj(help='"An soa_record block as defined below. Changing this forces a new resource to be created."'),
      soaRecord: {
        ...
        '#withHostName':: d.fn(help='"The domain name of the authoritative name server for the SOA record. Defaults to ns1-03.azure-dns.com.."', args=[d.arg(name='hostName', type=d.T.string)]),
      ...
      '#withSoaRecord':: d.fn(help='"An soa_record block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='soaRecord', type=d.T.array)]),
      withSoaRecord(soaRecord): { spec+: { forProvider+: { soaRecord: if std.isArray(v=soaRecord) then soaRecord else [soaRecord] } } },
      '#withSoaRecordMixin':: d.fn(help='"An soa_record block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='soaRecord', type=d.T.array)]),
