{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#route':: d.obj(help='"List of objects representing routes. Each object accepts the arguments documented below."'),
      route: {
        ...
        '#withName':: d.fn(help='"The name of the route table. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRoute':: d.fn(help='"List of objects representing routes. Each object accepts the arguments documented below."', args=[d.arg(name='route', type=d.T.array)]),
      withRoute(route): { spec+: { forProvider+: { route: if std.isArray(v=route) then route else [route] } } },
      '#withRouteMixin':: d.fn(help='"List of objects representing routes. Each object accepts the arguments documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='route', type=d.T.array)]),
