{
  ...
  spec: {
    ...
    forProvider: {
      '#privateDnsZoneNameRef':: d.obj(help='"Reference to a PrivateDNSZone to populate privateDnsZoneName."'),
      ...
      '#privateDnsZoneNameSelector':: d.obj(help='"Selector for a PrivateDNSZone to populate privateDnsZoneName."'),
