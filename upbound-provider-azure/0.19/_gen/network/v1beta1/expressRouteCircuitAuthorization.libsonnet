{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExpressRouteCircuitName':: d.fn(help='"The name of the Express Route Circuit in which to create the Authorization."', args=[d.arg(name='expressRouteCircuitName', type=d.T.string)]),
