{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBackendPort':: d.fn(help='"The port used for internal connections on the endpoint. Possible values range between 0 and 65535, inclusive."', args=[d.arg(name='backendPort', type=d.T.number)]),
      ...
      '#withEnableTcpReset':: d.fn(help='"Is TCP Reset enabled for this Load Balancer Rule? Defaults to false."', args=[d.arg(name='enableTcpReset', type=d.T.boolean)]),
      ...
      '#withFrontendPort':: d.fn(help='"The port for the external endpoint. Port numbers for each Rule must be unique within the Load Balancer. Possible values range between 0 and 65534, inclusive."', args=[d.arg(name='frontendPort', type=d.T.number)]),
      ...
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the NAT Rule."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
