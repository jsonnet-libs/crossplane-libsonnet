{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVirtualHubId':: d.fn(help='"The ID of a Virtual HUB within which the ExpressRoute gateway should be created."', args=[d.arg(name='virtualHubId', type=d.T.string)]),
