{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Public IP Prefix."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
