  ...
  spec: {
    ...
    forProvider: {
      ...
      ipConfiguration: {
        ...
        '#withSubnetId':: d.fn(help='"Reference to the subnet associated with the IP Configuration."', args=[d.arg(name='subnetId', type=d.T.string)]),
        withSubnetId(subnetId): { subnetId: subnetId },
      },
      '#managementIpConfiguration':: d.obj(help='"A management_ip_configuration block as documented below, which allows force-tunnelling of traffic to be performed by the firewall. Adding or removing this block or changing the subnet_id in an existing block forces a new resource to be created."'),
      ...
      '#withManagementIpConfigurationMixin':: d.fn(help='"A management_ip_configuration block as documented below, which allows force-tunnelling of traffic to be performed by the firewall. Adding or removing this block or changing the subnet_id in an existing block forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managementIpConfiguration', type=d.T.array)]),
      ...
      '#withSkuTier':: d.fn(help='"SKU tier of the Firewall. Possible values are Premium and Standard.  Changing this forces a new resource to be created."', args=[d.arg(name='skuTier', type=d.T.string)]),
      ...
      '#withThreatIntelMode':: d.fn(help='"The operation mode for threat intelligence-based filtering. Possible values are: Off, Alert,Deny and \\"\\"(empty string). Defaults to Alert."', args=[d.arg(name='threatIntelMode', type=d.T.string)]),
