{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExpressRoutePortId':: d.fn(help='"The ID of the Express Route Port this Express Route Circuit is based on."', args=[d.arg(name='expressRoutePortId', type=d.T.string)]),
