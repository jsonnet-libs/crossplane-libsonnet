{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFloatingIpEnabled':: d.fn(help='"Are the floating IPs enabled for this Load Balancer Rule? A floating IP is reassigned to a secondary server in case the primary server fails. Required to configure a SQL AlwaysOn Availability Group. Defaults to false."', args=[d.arg(name='floatingIpEnabled', type=d.T.boolean)]),
      ...
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the NAT pool."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
      withLoadbalancerId(loadbalancerId): { spec+: { forProvider+: { loadbalancerId: loadbalancerId } } },
      '#withProtocol':: d.fn(help='"The transport protocol for the external endpoint. Possible values are Udp or Tcp."', args=[d.arg(name='protocol', type=d.T.string)]),
      withProtocol(protocol): { spec+: { forProvider+: { protocol: protocol } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the resource."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTcpResetEnabled':: d.fn(help='"Is TCP Reset enabled for this Load Balancer Rule? Defaults to false."', args=[d.arg(name='tcpResetEnabled', type=d.T.boolean)]),
