{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnableFloatingIp':: d.fn(help='"Are the Floating IPs enabled for this Load Balncer Rule? A \\"floating” IP is reassigned to a secondary server in case the primary server fails. Required to configure a SQL AlwaysOn Availability Group. Defaults to false."', args=[d.arg(name='enableFloatingIp', type=d.T.boolean)]),
      ...
      '#withLoadDistribution':: d.fn(help='"Specifies the load balancing distribution type to be used by the Load Balancer. Possible values are: Default – The load balancer is configured to use a 5 tuple hash to map traffic to available servers. SourceIP – The load balancer is configured to use a 2 tuple hash to map traffic to available servers. SourceIPProtocol – The load balancer is configured to use a 3 tuple hash to map traffic to available servers. Also known as Session Persistence, where  the options are called None, Client IP and Client IP and Protocol respectively."', args=[d.arg(name='loadDistribution', type=d.T.string)]),
      withLoadDistribution(loadDistribution): { spec+: { forProvider+: { loadDistribution: loadDistribution } } },
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the Rule."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
