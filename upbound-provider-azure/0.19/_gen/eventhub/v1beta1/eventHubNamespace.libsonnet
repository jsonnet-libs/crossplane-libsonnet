{
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Event Hub Namespace. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      networkRulesets: {
        ...
        virtualNetworkRule: {
          ...
          '#withIgnoreMissingVirtualNetworkServiceEndpoint':: d.fn(help='"Are missing virtual network service endpoints ignored? Defaults to false."', args=[d.arg(name='ignoreMissingVirtualNetworkServiceEndpoint', type=d.T.boolean)]),
        ...
        '#withDefaultAction':: d.fn(help='"The default action to take when a rule is not matched. Possible values are Allow and Deny. Defaults to Deny."', args=[d.arg(name='defaultAction', type=d.T.string)]),
      ...
      '#withCapacity':: d.fn(help='"Specifies the Capacity / Throughput Units for a Standard SKU namespace. Default capacity has a maximum of 2, but can be increased in blocks of 2 on a committed purchase basis."', args=[d.arg(name='capacity', type=d.T.number)]),
      ...
      '#withSku':: d.fn(help='"Defines which tier to use. Valid options are Basic, Standard, and Premium. Please note that setting this field to Premium will force the creation of a new resource and also requires setting zone_redundant to true."', args=[d.arg(name='sku', type=d.T.string)]),
