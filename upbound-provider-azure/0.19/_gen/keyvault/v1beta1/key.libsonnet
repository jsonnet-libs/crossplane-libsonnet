{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExpirationDate':: d.fn(help="\"Expiration UTC datetime (Y-m-d'T'H:M:S'Z').\"", args=[d.arg(name='expirationDate', type=d.T.string)]),
      ...
      '#withKeyType':: d.fn(help='"Specifies the Key Type to use for this Key Vault Key. Possible values are EC (Elliptic Curve), EC-HSM, Oct (Octet), RSA and RSA-HSM. Changing this forces a new resource to be created."', args=[d.arg(name='keyType', type=d.T.string)]),
