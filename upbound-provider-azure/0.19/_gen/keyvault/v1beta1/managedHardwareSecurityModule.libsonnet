{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPurgeProtectionEnabled':: d.fn(help='"Is Purge Protection enabled for this Key Vault Managed Hardware Security Module? Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='purgeProtectionEnabled', type=d.T.boolean)]),
