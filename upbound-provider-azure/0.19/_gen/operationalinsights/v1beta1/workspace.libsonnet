{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInternetQueryEnabled':: d.fn(help='"Should the Log Analytics Workflow support querying over the Public Internet? Defaults to true."', args=[d.arg(name='internetQueryEnabled', type=d.T.boolean)]),
