{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withServerRole':: d.fn(help='"The role of the linked Redis cache (eg \\"Secondary\\"). Changing this forces a new Redis to be created."', args=[d.arg(name='serverRole', type=d.T.string)]),
