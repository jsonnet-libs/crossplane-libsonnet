{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMinimumTlsVersion':: d.fn(help='"The minimum TLS version.  Defaults to 1.2. Changing this forces a new Redis Enterprise Cluster to be created."', args=[d.arg(name='minimumTlsVersion', type=d.T.string)]),
