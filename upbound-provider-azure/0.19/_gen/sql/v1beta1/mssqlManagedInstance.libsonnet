{
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"The identity type of the SQL Managed Instance. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withDnsZonePartnerId':: d.fn(help='"The ID of the SQL Managed Instance which will share the DNS zone. This is a prerequisite for creating an azurerm_managed_instance_failover_group. Setting this after creation forces a new resource to be created."', args=[d.arg(name='dnsZonePartnerId', type=d.T.string)]),
      ...
      '#withLicenseType':: d.fn(help='"What type of license the Managed Instance will use. Valid values include can be PriceIncluded or BasePrice."', args=[d.arg(name='licenseType', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the SQL Managed Instance."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU Name for the SQL Managed Instance. Valid values include GP_Gen4, GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen4, BC_Gen5, BC_G8IM or BC_G8IH."', args=[d.arg(name='skuName', type=d.T.string)]),
      ...
      '#withSubnetId':: d.fn(help='"The subnet resource id that the SQL Managed Instance will be associated with."', args=[d.arg(name='subnetId', type=d.T.string)]),
