{
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withIdentityIds':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this API Management Service."', args=[d.arg(name='identityIds', type=d.T.array)]),
        withIdentityIds(identityIds): { identityIds: if std.isArray(v=identityIds) then identityIds else [identityIds] },
        '#withIdentityIdsMixin':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this API Management Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        withIdentityIdsMixin(identityIds): { identityIds+: if std.isArray(v=identityIds) then identityIds else [identityIds] },
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this API Management Service. Possible values are SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withMinimumTlsVersion':: d.fn(help='"The Minimum TLS Version for all SQL Database and SQL Data Warehouse databases associated with the server. Valid values are: 1.0, 1.1 and 1.2."', args=[d.arg(name='minimumTlsVersion', type=d.T.string)]),
      ...
      '#withPrimaryUserAssignedIdentityId':: d.fn(help='"Specifies the primary user managed identity id. Required if type is UserAssigned and should be combined with user_assigned_identity_ids."', args=[d.arg(name='primaryUserAssignedIdentityId', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Microsoft SQL Server."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withVersion':: d.fn(help='"The version for the new server. Valid values are: 2.0 (for v11 server) and 12.0 (for v12 server)."', args=[d.arg(name='version', type=d.T.string)]),
