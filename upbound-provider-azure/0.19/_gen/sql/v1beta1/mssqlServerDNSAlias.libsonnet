{
  ...
  spec: {
    ...
    forProvider: {
      '#mssqlServerIdRef':: d.obj(help='"Reference to a MSSQLServer to populate mssqlServerId."'),
      mssqlServerIdRef: {
      ...
      '#mssqlServerIdSelector':: d.obj(help='"Selector for a MSSQLServer to populate mssqlServerId."'),
