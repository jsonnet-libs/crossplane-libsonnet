{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInternetIngestionEnabled':: d.fn(help='', args=[d.arg(name='internetIngestionEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Application Insights component."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withSamplingPercentage':: d.fn(help='"Specifies the percentage of the data produced by the monitored application that is sampled for Application Insights telemetry."', args=[d.arg(name='samplingPercentage', type=d.T.number)]),
