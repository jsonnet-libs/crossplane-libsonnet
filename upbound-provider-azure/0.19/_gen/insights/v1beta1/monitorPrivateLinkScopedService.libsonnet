{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLinkedResourceId':: d.fn(help='"The ID of the linked resource. It must be the Log Analytics Workspace or the Application Insights component. Changing this forces a new resource to be created."', args=[d.arg(name='linkedResourceId', type=d.T.string)]),
