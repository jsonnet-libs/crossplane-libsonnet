{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withParentManagementGroupId':: d.fn(help='"The ID of the Parent Management Group. Changing this forces a new resource to be created."', args=[d.arg(name='parentManagementGroupId', type=d.T.string)]),
