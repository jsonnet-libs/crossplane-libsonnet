{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRestorePointInTime':: d.fn(help='"When create_mode is PointInTimeRestore, specifies the point in time to restore from creation_source_server_id."', args=[d.arg(name='restorePointInTime', type=d.T.string)]),
      withRestorePointInTime(restorePointInTime): { spec+: { forProvider+: { restorePointInTime: restorePointInTime } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU Name for this MariaDB Server. The name of the SKU, follows the tier + family + cores pattern (e.g. B_Gen4_1, GP_Gen5_8). For more information see the product documentation."', args=[d.arg(name='skuName', type=d.T.string)]),
