{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoStopEnabled':: d.fn(help='"Specifies if the cluster could be automatically stopped (due to lack of data or no activity for many days)."', args=[d.arg(name='autoStopEnabled', type=d.T.boolean)]),
      ...
      '#withDoubleEncryptionEnabled':: d.fn(help="\"Is the cluster's double encryption enabled? Defaults to false. Changing this forces a new resource to be created.\"", args=[d.arg(name='doubleEncryptionEnabled', type=d.T.boolean)]),
      withDoubleEncryptionEnabled(doubleEncryptionEnabled): { spec+: { forProvider+: { doubleEncryptionEnabled: doubleEncryptionEnabled } } },
      '#withEngine':: d.fn(help='". The engine type that should be used. Possible values are V2 and V3. Defaults to V2."', args=[d.arg(name='engine', type=d.T.string)]),
