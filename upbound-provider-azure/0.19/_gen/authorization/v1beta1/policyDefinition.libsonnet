{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicyType':: d.fn(help='"The policy type. Possible values are BuiltIn, Custom and NotSpecified. Changing this forces a new resource to be created."', args=[d.arg(name='policyType', type=d.T.string)]),
