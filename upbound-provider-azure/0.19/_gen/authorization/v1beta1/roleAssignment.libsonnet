{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSkipServicePrincipalAadCheck':: d.fn(help='"If the principal_id is a newly provisioned Service Principal set this value to true to skip the Azure Active Directory check which may fail due to replication lag. This argument is only valid if the principal_id is a Service Principal identity. If it is not a Service Principal identity it will cause the role assignment to fail. Defaults to false."', args=[d.arg(name='skipServicePrincipalAadCheck', type=d.T.boolean)]),
