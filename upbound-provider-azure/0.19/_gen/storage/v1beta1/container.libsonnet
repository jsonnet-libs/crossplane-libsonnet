{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStorageAccountName':: d.fn(help='"The name of the Storage Account where the Container should be created."', args=[d.arg(name='storageAccountName', type=d.T.string)]),
