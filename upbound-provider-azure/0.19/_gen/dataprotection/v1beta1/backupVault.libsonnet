{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDatastoreType':: d.fn(help='"Specifies the type of the data store. Possible values are ArchiveStore, SnapshotStore and VaultStore."', args=[d.arg(name='datastoreType', type=d.T.string)]),
