  ...
  spec: {
    ...
    forProvider: {
      ...
      osDisk: {
        ...
        '#withManagedDiskId':: d.fn(help='"Specifies the ID of the managed disk resource that you want to use to create the image."', args=[d.arg(name='managedDiskId', type=d.T.string)]),
        withManagedDiskId(managedDiskId): { managedDiskId: managedDiskId },
        '#withOsState':: d.fn(help='"Specifies the state of the operating system contained in the blob. Currently, the only value is Generalized."', args=[d.arg(name='osState', type=d.T.string)]),
      ...
      '#withHyperVGeneration':: d.fn(help='"The HyperVGenerationType of the VirtualMachine created from the image as V1, V2. The default is V1."', args=[d.arg(name='hyperVGeneration', type=d.T.string)]),
