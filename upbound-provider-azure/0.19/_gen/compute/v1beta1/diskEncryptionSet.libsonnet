{
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"The type of Managed Service Identity that is configured on this Disk Encryption Set. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withAutoKeyRotationEnabled':: d.fn(help='"Boolean flag to specify whether Azure Disk Encryption Set automatically rotates encryption Key to latest version. Defaults to false."', args=[d.arg(name='autoKeyRotationEnabled', type=d.T.boolean)]),
      withAutoKeyRotationEnabled(autoKeyRotationEnabled): { spec+: { forProvider+: { autoKeyRotationEnabled: autoKeyRotationEnabled } } },
      '#withEncryptionType':: d.fn(help='"The type of key used to encrypt the data of the disk. Possible values are EncryptionAtRestWithCustomerKey, EncryptionAtRestWithPlatformAndCustomerKeys and ConfidentialVmEncryptedWithCustomerKey. Defaults to EncryptionAtRestWithCustomerKey."', args=[d.arg(name='encryptionType', type=d.T.string)]),
