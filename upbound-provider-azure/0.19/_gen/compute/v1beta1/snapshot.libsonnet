{
  ...
  spec: {
    ...
    forProvider: {
      '#encryptionSettings':: d.obj(help=''),
      encryptionSettings: {
        '#diskEncryptionKey':: d.obj(help=''),
        diskEncryptionKey: {
          '#withSecretUrl':: d.fn(help='', args=[d.arg(name='secretUrl', type=d.T.string)]),
          withSecretUrl(secretUrl): { secretUrl: secretUrl },
          '#withSourceVaultId':: d.fn(help='"The Snapshot ID."', args=[d.arg(name='sourceVaultId', type=d.T.string)]),
          withSourceVaultId(sourceVaultId): { sourceVaultId: sourceVaultId },
        },
        '#keyEncryptionKey':: d.obj(help=''),
        keyEncryptionKey: {
          '#withKeyUrl':: d.fn(help='', args=[d.arg(name='keyUrl', type=d.T.string)]),
          withKeyUrl(keyUrl): { keyUrl: keyUrl },
          '#withSourceVaultId':: d.fn(help='"The Snapshot ID."', args=[d.arg(name='sourceVaultId', type=d.T.string)]),
          withSourceVaultId(sourceVaultId): { sourceVaultId: sourceVaultId },
        },
        '#withDiskEncryptionKey':: d.fn(help='', args=[d.arg(name='diskEncryptionKey', type=d.T.array)]),
        ...
        '#withKeyEncryptionKey':: d.fn(help='', args=[d.arg(name='keyEncryptionKey', type=d.T.array)]),
      ...
      '#withCreateOption':: d.fn(help='"Indicates how the snapshot is to be created. Possible values are Copy or Import. Changing this forces a new resource to be created."', args=[d.arg(name='createOption', type=d.T.string)]),
      ...
      '#withEncryptionSettings':: d.fn(help='', args=[d.arg(name='encryptionSettings', type=d.T.array)]),
