{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withManaged':: d.fn(help='"Specifies whether the availability set is managed or not. Possible values are true (to specify aligned) or false (to specify classic). Default is true."', args=[d.arg(name='managed', type=d.T.boolean)]),
