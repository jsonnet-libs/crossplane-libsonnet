{
  ...
  '#':: d.pkg(name='virtualNetworkRule', url='', help='"VirtualNetworkRule is the Schema for the VirtualNetworkRules API. Manages a MariaDB Virtual Network Rule."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group where the MariaDB server resides. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServerName':: d.fn(help='"The name of the SQL Server to which this MariaDB virtual network rule will be applied to. Changing this forces a new resource to be created."', args=[d.arg(name='serverName', type=d.T.string)]),
      withServerName(serverName): { spec+: { forProvider+: { serverName: serverName } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet that the MariaDB server will be connected to."', args=[d.arg(name='subnetId', type=d.T.string)]),
