{
  ...
  '#':: d.pkg(name='database', url='', help='"Database is the Schema for the Databases API. Manages a MariaDB Database within a MariaDB Server."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCharset':: d.fn(help='"Specifies the Charset for the MariaDB Database, which needs to be a valid MariaDB Charset. Changing this forces a new resource to be created."', args=[d.arg(name='charset', type=d.T.string)]),
      withCharset(charset): { spec+: { forProvider+: { charset: charset } } },
      '#withCollation':: d.fn(help='"Specifies the Collation for the MariaDB Database, which needs to be a valid MariaDB Collation. Changing this forces a new resource to be created."', args=[d.arg(name='collation', type=d.T.string)]),
