  ...
  spec: {
    ...
    forProvider: {
      ...
      windowsProfile: {
        ...
        withOutboundNatEnabled(outboundNatEnabled): { outboundNatEnabled: outboundNatEnabled },
      },
      ...
      '#withKubeletConfig':: d.fn(help='"A kubelet_config block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='kubeletConfig', type=d.T.array)]),
      ...
      '#withKubeletConfigMixin':: d.fn(help='"A kubelet_config block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='kubeletConfig', type=d.T.array)]),
      ...
      '#withLinuxOsConfig':: d.fn(help='"A linux_os_config block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='linuxOsConfig', type=d.T.array)]),
      ...
      '#withLinuxOsConfigMixin':: d.fn(help='"A linux_os_config block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='linuxOsConfig', type=d.T.array)]),
      ...
      withNodeNetworkProfile(nodeNetworkProfile): { spec+: { forProvider+: { nodeNetworkProfile: if std.isArray(v=nodeNetworkProfile) then nodeNetworkProfile else [nodeNetworkProfile] } } },
      ...
      withNodeNetworkProfileMixin(nodeNetworkProfile): { spec+: { forProvider+: { nodeNetworkProfile+: if std.isArray(v=nodeNetworkProfile) then nodeNetworkProfile else [nodeNetworkProfile] } } },
      ...
      '#withWindowsProfile':: d.fn(help='"A windows_profile block as documented below. Changing this forces a new resource to be created."', args=[d.arg(name='windowsProfile', type=d.T.array)]),
      ...
      '#withWindowsProfileMixin':: d.fn(help='"A windows_profile block as documented below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='windowsProfile', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withKubeletConfig':: d.fn(help='"A kubelet_config block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='kubeletConfig', type=d.T.array)]),
      withKubeletConfig(kubeletConfig): { spec+: { initProvider+: { kubeletConfig: if std.isArray(v=kubeletConfig) then kubeletConfig else [kubeletConfig] } } },
      '#withKubeletConfigMixin':: d.fn(help='"A kubelet_config block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='kubeletConfig', type=d.T.array)]),
      withKubeletConfigMixin(kubeletConfig): { spec+: { initProvider+: { kubeletConfig+: if std.isArray(v=kubeletConfig) then kubeletConfig else [kubeletConfig] } } },
      '#withKubeletDiskType':: d.fn(help='"The type of disk used by kubelet. Possible values are OS and Temporary."', args=[d.arg(name='kubeletDiskType', type=d.T.string)]),
      withKubeletDiskType(kubeletDiskType): { spec+: { initProvider+: { kubeletDiskType: kubeletDiskType } } },
      '#withLinuxOsConfig':: d.fn(help='"A linux_os_config block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='linuxOsConfig', type=d.T.array)]),
      withLinuxOsConfig(linuxOsConfig): { spec+: { initProvider+: { linuxOsConfig: if std.isArray(v=linuxOsConfig) then linuxOsConfig else [linuxOsConfig] } } },
      '#withLinuxOsConfigMixin':: d.fn(help='"A linux_os_config block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='linuxOsConfig', type=d.T.array)]),
      withLinuxOsConfigMixin(linuxOsConfig): { spec+: { initProvider+: { linuxOsConfig+: if std.isArray(v=linuxOsConfig) then linuxOsConfig else [linuxOsConfig] } } },
      '#withMaxCount':: d.fn(help='"The maximum number of nodes which should exist within this Node Pool. Valid values are between 0 and 1000 and must be greater than or equal to min_count."', args=[d.arg(name='maxCount', type=d.T.number)]),
      ...
      '#withNodeNetworkProfile':: d.fn(help='"A node_network_profile block as documented below."', args=[d.arg(name='nodeNetworkProfile', type=d.T.array)]),
      withNodeNetworkProfile(nodeNetworkProfile): { spec+: { initProvider+: { nodeNetworkProfile: if std.isArray(v=nodeNetworkProfile) then nodeNetworkProfile else [nodeNetworkProfile] } } },
      '#withNodeNetworkProfileMixin':: d.fn(help='"A node_network_profile block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeNetworkProfile', type=d.T.array)]),
      withNodeNetworkProfileMixin(nodeNetworkProfile): { spec+: { initProvider+: { nodeNetworkProfile+: if std.isArray(v=nodeNetworkProfile) then nodeNetworkProfile else [nodeNetworkProfile] } } },
      '#withNodePublicIpPrefixId':: d.fn(help='"Resource ID for the Public IP Addresses Prefix for the nodes in this Node Pool. enable_node_public_ip should be true. Changing this forces a new resource to be created."', args=[d.arg(name='nodePublicIpPrefixId', type=d.T.string)]),
