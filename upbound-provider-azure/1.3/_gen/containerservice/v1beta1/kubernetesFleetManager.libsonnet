{
  ...
  spec: {
    ...
    initProvider: {
      ...
      '#withHubProfile':: d.fn(help='', args=[d.arg(name='hubProfile', type=d.T.array)]),
      withHubProfile(hubProfile): { spec+: { initProvider+: { hubProfile: if std.isArray(v=hubProfile) then hubProfile else [hubProfile] } } },
      '#withHubProfileMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hubProfile', type=d.T.array)]),
      withHubProfileMixin(hubProfile): { spec+: { initProvider+: { hubProfile+: if std.isArray(v=hubProfile) then hubProfile else [hubProfile] } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Kubernetes Fleet Manager should exist. Changing this forces a new Kubernetes Fleet Manager to be created."', args=[d.arg(name='location', type=d.T.string)]),
