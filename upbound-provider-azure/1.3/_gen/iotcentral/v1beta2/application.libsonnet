{
  ...
  '#':: d.pkg(name='application', url='', help='"Application is the Schema for the Applications API. Manages an IotCentral Application"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this IoT Central Application. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withDisplayName':: d.fn(help='"A display_name name. Custom display name for the IoT Central application. Default is resource name."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource has to be create. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"Specifies the name of the IotHub resource. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Whether public network access is allowed for the IoT Central Application. Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withSku':: d.fn(help='"A sku name. Possible values is ST0, ST1, ST2, Default value is ST1"', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withSubDomain':: d.fn(help='"A sub_domain name. Subdomain for the IoT Central URL. Each application must have a unique subdomain."', args=[d.arg(name='subDomain', type=d.T.string)]),
      withSubDomain(subDomain): { spec+: { forProvider+: { subDomain: subDomain } } },
      ...
      '#withTemplate':: d.fn(help='"A template name. IoT Central application template name. Default is a custom application. Changing this forces a new resource to be created."', args=[d.arg(name='template', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSubDomain':: d.fn(help='"A sub_domain name. Subdomain for the IoT Central URL. Each application must have a unique subdomain."', args=[d.arg(name='subDomain', type=d.T.string)]),
      withSubDomain(subDomain): { spec+: { initProvider+: { subDomain: subDomain } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
