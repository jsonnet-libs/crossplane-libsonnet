{
  ...
  '#':: d.pkg(name='applicationNetworkRuleSet', url='', help='"ApplicationNetworkRuleSet is the Schema for the ApplicationNetworkRuleSets API. Manages an IoT Central Application Network Rule Set."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApplicationNetworkRuleSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ApplicationNetworkRuleSetSpec defines the desired state of ApplicationNetworkRuleSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#iotcentralApplicationIdRef':: d.obj(help='"Reference to a Application in iotcentral to populate iotcentralApplicationId."'),
      iotcentralApplicationIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { iotcentralApplicationIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { iotcentralApplicationIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { iotcentralApplicationIdRef+: { name: name } } } },
      },
      '#iotcentralApplicationIdSelector':: d.obj(help='"Selector for a Application in iotcentral to populate iotcentralApplicationId."'),
      iotcentralApplicationIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { iotcentralApplicationIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { iotcentralApplicationIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { iotcentralApplicationIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { iotcentralApplicationIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { iotcentralApplicationIdSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      ipRule: {
        ...
        '#withName':: d.fn(help='"The name of the IP Rule"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#withApplyToDevice':: d.fn(help='"Whether these IP Rules apply for device connectivity to IoT Hub and Device Provisioning Service associated with this IoT Central Application. Possible values are true, false. Defaults to true"', args=[d.arg(name='applyToDevice', type=d.T.boolean)]),
      withApplyToDevice(applyToDevice): { spec+: { forProvider+: { applyToDevice: applyToDevice } } },
      '#withDefaultAction':: d.fn(help='"Specifies the default action for the IoT Central Application Network Rule Set. Possible values are Allow and Deny. Defaults to Deny."', args=[d.arg(name='defaultAction', type=d.T.string)]),
      withDefaultAction(defaultAction): { spec+: { forProvider+: { defaultAction: defaultAction } } },
      '#withIotcentralApplicationId':: d.fn(help='"The ID of the IoT Central Application. Changing this forces a new resource to be created."', args=[d.arg(name='iotcentralApplicationId', type=d.T.string)]),
      withIotcentralApplicationId(iotcentralApplicationId): { spec+: { forProvider+: { iotcentralApplicationId: iotcentralApplicationId } } },
      '#withIpRule':: d.fn(help='"One or more ip_rule blocks as defined below."', args=[d.arg(name='ipRule', type=d.T.array)]),
      withIpRule(ipRule): { spec+: { forProvider+: { ipRule: if std.isArray(v=ipRule) then ipRule else [ipRule] } } },
      ...
      withIpRuleMixin(ipRule): { spec+: { forProvider+: { ipRule+: if std.isArray(v=ipRule) then ipRule else [ipRule] } } },
    },
    ...
    initProvider: {
      ...
      iotcentralApplicationIdRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { iotcentralApplicationIdRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { iotcentralApplicationIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { iotcentralApplicationIdRef+: { name: name } } } },
      },
      '#iotcentralApplicationIdSelector':: d.obj(help='"Selector for a Application in iotcentral to populate iotcentralApplicationId."'),
      iotcentralApplicationIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { iotcentralApplicationIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { iotcentralApplicationIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { iotcentralApplicationIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { iotcentralApplicationIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { iotcentralApplicationIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#ipRule':: d.obj(help='"One or more ip_rule blocks as defined below."'),
      ipRule: {
        '#withIpMask':: d.fn(help='"The IP address range in CIDR notation for the IP Rule."', args=[d.arg(name='ipMask', type=d.T.string)]),
      ...
      '#withApplyToDevice':: d.fn(help='"Whether these IP Rules apply for device connectivity to IoT Hub and Device Provisioning Service associated with this IoT Central Application. Possible values are true, false. Defaults to true"', args=[d.arg(name='applyToDevice', type=d.T.boolean)]),
      withApplyToDevice(applyToDevice): { spec+: { initProvider+: { applyToDevice: applyToDevice } } },
      '#withDefaultAction':: d.fn(help='"Specifies the default action for the IoT Central Application Network Rule Set. Possible values are Allow and Deny. Defaults to Deny."', args=[d.arg(name='defaultAction', type=d.T.string)]),
      withDefaultAction(defaultAction): { spec+: { initProvider+: { defaultAction: defaultAction } } },
      '#withIotcentralApplicationId':: d.fn(help='"The ID of the IoT Central Application. Changing this forces a new resource to be created."', args=[d.arg(name='iotcentralApplicationId', type=d.T.string)]),
      withIotcentralApplicationId(iotcentralApplicationId): { spec+: { initProvider+: { iotcentralApplicationId: iotcentralApplicationId } } },
      '#withIpRule':: d.fn(help='"One or more ip_rule blocks as defined below."', args=[d.arg(name='ipRule', type=d.T.array)]),
      withIpRule(ipRule): { spec+: { initProvider+: { ipRule: if std.isArray(v=ipRule) then ipRule else [ipRule] } } },
      '#withIpRuleMixin':: d.fn(help='"One or more ip_rule blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipRule', type=d.T.array)]),
      withIpRuleMixin(ipRule): { spec+: { initProvider+: { ipRule+: if std.isArray(v=ipRule) then ipRule else [ipRule] } } },
    },
