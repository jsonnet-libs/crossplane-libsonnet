    ...
    forProvider: {
      ...
      filter: {
        ...
        dimension: {
          ...
          '#withOperator':: d.fn(help='"The operator to use for comparison. The allowed values are In. Defaults to In."', args=[d.arg(name='operator', type=d.T.string)]),
        ...
        not: {
          ...
          dimension: {
            '#withName':: d.fn(help='"The name of the tag to use for the filter."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { forProvider+: { filter+: { not+: { dimension+: { name: name } } } } } },
            '#withOperator':: d.fn(help='"The operator to use for comparison. The allowed values are In. Defaults to In."', args=[d.arg(name='operator', type=d.T.string)]),
            withOperator(operator): { spec+: { forProvider+: { filter+: { not+: { dimension+: { operator: operator } } } } } },
            '#withValues':: d.fn(help='"Specifies a list of values for the tag."', args=[d.arg(name='values', type=d.T.array)]),
            withValues(values): { spec+: { forProvider+: { filter+: { not+: { dimension+: { values: if std.isArray(v=values) then values else [values] } } } } } },
            '#withValuesMixin':: d.fn(help='"Specifies a list of values for the tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
            withValuesMixin(values): { spec+: { forProvider+: { filter+: { not+: { dimension+: { values+: if std.isArray(v=values) then values else [values] } } } } } },
          },
          '#tag':: d.obj(help='"One tag block as defined below to filter the budget on. Conflicts with dimension."'),
          tag: {
            '#withName':: d.fn(help='"The name of the tag to use for the filter."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { forProvider+: { filter+: { not+: { tag+: { name: name } } } } } },
            '#withOperator':: d.fn(help='"The operator to use for comparison. The allowed values are In. Defaults to In."', args=[d.arg(name='operator', type=d.T.string)]),
            withOperator(operator): { spec+: { forProvider+: { filter+: { not+: { tag+: { operator: operator } } } } } },
            '#withValues':: d.fn(help='"Specifies a list of values for the tag."', args=[d.arg(name='values', type=d.T.array)]),
            withValues(values): { spec+: { forProvider+: { filter+: { not+: { tag+: { values: if std.isArray(v=values) then values else [values] } } } } } },
            '#withValuesMixin':: d.fn(help='"Specifies a list of values for the tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
            withValuesMixin(values): { spec+: { forProvider+: { filter+: { not+: { tag+: { values+: if std.isArray(v=values) then values else [values] } } } } } },
          },
        },
        ...
        withDimension(dimension): { spec+: { forProvider+: { filter+: { dimension: if std.isArray(v=dimension) then dimension else [dimension] } } } },
        ...
        withDimensionMixin(dimension): { spec+: { forProvider+: { filter+: { dimension+: if std.isArray(v=dimension) then dimension else [dimension] } } } },
        '#withTag':: d.fn(help='"One or more tag blocks as defined below to filter the budget on."', args=[d.arg(name='tag', type=d.T.array)]),
        withTag(tag): { spec+: { forProvider+: { filter+: { tag: if std.isArray(v=tag) then tag else [tag] } } } },
        ...
        withTagMixin(tag): { spec+: { forProvider+: { filter+: { tag+: if std.isArray(v=tag) then tag else [tag] } } } },
      },
      ...
      timePeriod: {
        ...
        withEndDate(endDate): { spec+: { forProvider+: { timePeriod+: { endDate: endDate } } } },
        ...
        withStartDate(startDate): { spec+: { forProvider+: { timePeriod+: { startDate: startDate } } } },
      },
      ...
      '#withTimeGrain':: d.fn(help='"The time covered by a budget. Tracking of the amount will be reset based on the time grain. Must be one of BillingAnnual, BillingMonth, BillingQuarter, Annually, Monthly and Quarterly. Defaults to Monthly. Changing this forces a new resource to be created."', args=[d.arg(name='timeGrain', type=d.T.string)]),
    ...
    initProvider: {
      ...
      filter: {
        ...
        not: {
          ...
          dimension: {
            '#withName':: d.fn(help='"The name of the tag to use for the filter."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { initProvider+: { filter+: { not+: { dimension+: { name: name } } } } } },
            '#withOperator':: d.fn(help='"The operator to use for comparison. The allowed values are In. Defaults to In."', args=[d.arg(name='operator', type=d.T.string)]),
            withOperator(operator): { spec+: { initProvider+: { filter+: { not+: { dimension+: { operator: operator } } } } } },
            '#withValues':: d.fn(help='"Specifies a list of values for the tag."', args=[d.arg(name='values', type=d.T.array)]),
            withValues(values): { spec+: { initProvider+: { filter+: { not+: { dimension+: { values: if std.isArray(v=values) then values else [values] } } } } } },
            '#withValuesMixin':: d.fn(help='"Specifies a list of values for the tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
            withValuesMixin(values): { spec+: { initProvider+: { filter+: { not+: { dimension+: { values+: if std.isArray(v=values) then values else [values] } } } } } },
          },
          '#tag':: d.obj(help='"One tag block as defined below to filter the budget on. Conflicts with dimension."'),
          tag: {
            '#withName':: d.fn(help='"The name of the tag to use for the filter."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { initProvider+: { filter+: { not+: { tag+: { name: name } } } } } },
            '#withOperator':: d.fn(help='"The operator to use for comparison. The allowed values are In. Defaults to In."', args=[d.arg(name='operator', type=d.T.string)]),
            withOperator(operator): { spec+: { initProvider+: { filter+: { not+: { tag+: { operator: operator } } } } } },
            '#withValues':: d.fn(help='"Specifies a list of values for the tag."', args=[d.arg(name='values', type=d.T.array)]),
            withValues(values): { spec+: { initProvider+: { filter+: { not+: { tag+: { values: if std.isArray(v=values) then values else [values] } } } } } },
            '#withValuesMixin':: d.fn(help='"Specifies a list of values for the tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
            withValuesMixin(values): { spec+: { initProvider+: { filter+: { not+: { tag+: { values+: if std.isArray(v=values) then values else [values] } } } } } },
          },
        },
        '#tag':: d.obj(help='"One or more tag blocks as defined below to filter the budget on."'),
        tag: {
        ...
        '#withDimension':: d.fn(help='"One or more dimension blocks as defined below to filter the budget on."', args=[d.arg(name='dimension', type=d.T.array)]),
        withDimension(dimension): { spec+: { initProvider+: { filter+: { dimension: if std.isArray(v=dimension) then dimension else [dimension] } } } },
        '#withDimensionMixin':: d.fn(help='"One or more dimension blocks as defined below to filter the budget on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dimension', type=d.T.array)]),
        withDimensionMixin(dimension): { spec+: { initProvider+: { filter+: { dimension+: if std.isArray(v=dimension) then dimension else [dimension] } } } },
        '#withTag':: d.fn(help='"One or more tag blocks as defined below to filter the budget on."', args=[d.arg(name='tag', type=d.T.array)]),
        withTag(tag): { spec+: { initProvider+: { filter+: { tag: if std.isArray(v=tag) then tag else [tag] } } } },
        '#withTagMixin':: d.fn(help='"One or more tag blocks as defined below to filter the budget on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tag', type=d.T.array)]),
        withTagMixin(tag): { spec+: { initProvider+: { filter+: { tag+: if std.isArray(v=tag) then tag else [tag] } } } },
      },
      '#notification':: d.obj(help='"One or more notification blocks as defined below."'),
      notification: {
        '#withContactEmails':: d.fn(help='"Specifies a list of email addresses to send the budget notification to when the threshold is exceeded."', args=[d.arg(name='contactEmails', type=d.T.array)]),
      ...
      timePeriod: {
        '#withEndDate':: d.fn(help='"The end date for the budget. If not set this will be 10 years after the start date."', args=[d.arg(name='endDate', type=d.T.string)]),
        withEndDate(endDate): { spec+: { initProvider+: { timePeriod+: { endDate: endDate } } } },
        '#withStartDate':: d.fn(help='"The start date for the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than twelve months. Past start date should be selected within the timegrain period. Changing this forces a new Resource Group Consumption Budget to be created."', args=[d.arg(name='startDate', type=d.T.string)]),
        withStartDate(startDate): { spec+: { initProvider+: { timePeriod+: { startDate: startDate } } } },
      },
      '#withAmount':: d.fn(help='"The total amount of cost to track with the budget."', args=[d.arg(name='amount', type=d.T.number)]),
      ...
      '#withTimeGrain':: d.fn(help='"The time covered by a budget. Tracking of the amount will be reset based on the time grain. Must be one of BillingAnnual, BillingMonth, BillingQuarter, Annually, Monthly and Quarterly. Defaults to Monthly. Changing this forces a new resource to be created."', args=[d.arg(name='timeGrain', type=d.T.string)]),
      withTimeGrain(timeGrain): { spec+: { initProvider+: { timeGrain: timeGrain } } },
    },
