{
  ...
  '#':: d.pkg(name='provider', url='', help='"Provider is the Schema for the Providers API. Manages an Attestation Provider."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      policy: {
        ...
        '#withEnvironmentType':: d.fn(help='', args=[d.arg(name='environmentType', type=d.T.string)]),
        withEnvironmentType(environmentType): { environmentType: environmentType },
      },
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Attestation Provider should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withOpenEnclavePolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='openEnclavePolicyBase64', type=d.T.string)]),
      withOpenEnclavePolicyBase64(openEnclavePolicyBase64): { spec+: { forProvider+: { openEnclavePolicyBase64: openEnclavePolicyBase64 } } },
      '#withPolicy':: d.fn(help='', args=[d.arg(name='policy', type=d.T.array)]),
      withPolicy(policy): { spec+: { forProvider+: { policy: if std.isArray(v=policy) then policy else [policy] } } },
      '#withPolicyMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='policy', type=d.T.array)]),
      withPolicyMixin(policy): { spec+: { forProvider+: { policy+: if std.isArray(v=policy) then policy else [policy] } } },
      '#withPolicySigningCertificateData':: d.fn(help='"A valid X.509 certificate (Section 4 of RFC4648). Changing this forces a new resource to be created."', args=[d.arg(name='policySigningCertificateData', type=d.T.string)]),
      withPolicySigningCertificateData(policySigningCertificateData): { spec+: { forProvider+: { policySigningCertificateData: policySigningCertificateData } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the attestation provider should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSevSnpPolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='sevSnpPolicyBase64', type=d.T.string)]),
      withSevSnpPolicyBase64(sevSnpPolicyBase64): { spec+: { forProvider+: { sevSnpPolicyBase64: sevSnpPolicyBase64 } } },
      '#withSgxEnclavePolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='sgxEnclavePolicyBase64', type=d.T.string)]),
      withSgxEnclavePolicyBase64(sgxEnclavePolicyBase64): { spec+: { forProvider+: { sgxEnclavePolicyBase64: sgxEnclavePolicyBase64 } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Attestation Provider."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Attestation Provider."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withTpmPolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='tpmPolicyBase64', type=d.T.string)]),
      withTpmPolicyBase64(tpmPolicyBase64): { spec+: { forProvider+: { tpmPolicyBase64: tpmPolicyBase64 } } },
    },
    ...
    initProvider: {
      ...
      '#withOpenEnclavePolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='openEnclavePolicyBase64', type=d.T.string)]),
      withOpenEnclavePolicyBase64(openEnclavePolicyBase64): { spec+: { initProvider+: { openEnclavePolicyBase64: openEnclavePolicyBase64 } } },
      '#withPolicy':: d.fn(help='', args=[d.arg(name='policy', type=d.T.array)]),
      ...
      '#withPolicySigningCertificateData':: d.fn(help='"A valid X.509 certificate (Section 4 of RFC4648). Changing this forces a new resource to be created."', args=[d.arg(name='policySigningCertificateData', type=d.T.string)]),
      withPolicySigningCertificateData(policySigningCertificateData): { spec+: { initProvider+: { policySigningCertificateData: policySigningCertificateData } } },
      '#withSevSnpPolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='sevSnpPolicyBase64', type=d.T.string)]),
      withSevSnpPolicyBase64(sevSnpPolicyBase64): { spec+: { initProvider+: { sevSnpPolicyBase64: sevSnpPolicyBase64 } } },
      '#withSgxEnclavePolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='sgxEnclavePolicyBase64', type=d.T.string)]),
      withSgxEnclavePolicyBase64(sgxEnclavePolicyBase64): { spec+: { initProvider+: { sgxEnclavePolicyBase64: sgxEnclavePolicyBase64 } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Attestation Provider."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Attestation Provider."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withTpmPolicyBase64':: d.fn(help='"Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy."', args=[d.arg(name='tpmPolicyBase64', type=d.T.string)]),
      withTpmPolicyBase64(tpmPolicyBase64): { spec+: { initProvider+: { tpmPolicyBase64: tpmPolicyBase64 } } },
    },
