{
  ...
  '#':: d.pkg(name='applicationInsightsWorkbook', url='', help='"ApplicationInsightsWorkbook is the Schema for the ApplicationInsightsWorkbooks API. Manages an Azure Workbook."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApplicationInsightsWorkbook', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ApplicationInsightsWorkbookSpec defines the desired state of ApplicationInsightsWorkbook"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#identity':: d.obj(help='"An identity block as defined below. Changing this forces a new Workbook to be created."'),
      identity: {
        '#withIdentityIds':: d.fn(help='"The list of User Assigned Managed Identity IDs assigned to this Workbook. Changing this forces a new resource to be created."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"The list of User Assigned Managed Identity IDs assigned to this Workbook. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"The type of Managed Service Identity that is configured on this Workbook. Possible values are UserAssigned, SystemAssigned and SystemAssigned, UserAssigned. Changing this forces a new resource to be created."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withCategory':: d.fn(help='"Workbook category, as defined by the user at creation time. There may be additional category types beyond the following: workbook, sentinel. Defaults to workbook."', args=[d.arg(name='category', type=d.T.string)]),
      withCategory(category): { spec+: { forProvider+: { category: category } } },
      '#withDataJson':: d.fn(help='"Configuration of this particular workbook. Configuration data is a string containing valid JSON."', args=[d.arg(name='dataJson', type=d.T.string)]),
      withDataJson(dataJson): { spec+: { forProvider+: { dataJson: dataJson } } },
      '#withDescription':: d.fn(help='"Specifies the description of the workbook."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"Specifies the user-defined name (display name) of the workbook."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withLocation':: d.fn(help='"Specifies the Azure Region where the Workbook should exist. Changing this forces a new Workbook to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"Specifies the name of this Workbook as a UUID/GUID. It should not contain any uppercase letters. Changing this forces a new Workbook to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group where the Workbook should exist. Changing this forces a new Workbook to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSourceId':: d.fn(help='"Resource ID for a source resource. It should not contain any uppercase letters. Defaults to azure monitor."', args=[d.arg(name='sourceId', type=d.T.string)]),
      withSourceId(sourceId): { spec+: { forProvider+: { sourceId: sourceId } } },
      '#withStorageContainerId':: d.fn(help='"Specifies the Resource Manager ID of the Storage Container when bring your own storage is used. Changing this forces a new Workbook to be created."', args=[d.arg(name='storageContainerId', type=d.T.string)]),
      withStorageContainerId(storageContainerId): { spec+: { forProvider+: { storageContainerId: storageContainerId } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Workbook."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Workbook."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withDataJson':: d.fn(help='"Configuration of this particular workbook. Configuration data is a string containing valid JSON."', args=[d.arg(name='dataJson', type=d.T.string)]),
      withDataJson(dataJson): { spec+: { initProvider+: { dataJson: dataJson } } },
      '#withDescription':: d.fn(help='"Specifies the description of the workbook."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withSourceId':: d.fn(help='"Resource ID for a source resource. It should not contain any uppercase letters. Defaults to azure monitor."', args=[d.arg(name='sourceId', type=d.T.string)]),
      withSourceId(sourceId): { spec+: { initProvider+: { sourceId: sourceId } } },
      '#withStorageContainerId':: d.fn(help='"Specifies the Resource Manager ID of the Storage Container when bring your own storage is used. Changing this forces a new Workbook to be created."', args=[d.arg(name='storageContainerId', type=d.T.string)]),
