{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIdentity':: d.fn(help='"An identity block as defined below. Changing this forces a new Workbook to be created."', args=[d.arg(name='identity', type=d.T.array)]),
      withIdentity(identity): { spec+: { forProvider+: { identity: if std.isArray(v=identity) then identity else [identity] } } },
      '#withIdentityMixin':: d.fn(help='"An identity block as defined below. Changing this forces a new Workbook to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identity', type=d.T.array)]),
