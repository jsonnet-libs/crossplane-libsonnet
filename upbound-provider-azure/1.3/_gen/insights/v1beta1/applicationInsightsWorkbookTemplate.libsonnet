{
  ...
  '#':: d.pkg(name='applicationInsightsWorkbookTemplate', url='', help='"ApplicationInsightsWorkbookTemplate is the Schema for the ApplicationInsightsWorkbookTemplates API. Manages an Application Insights Workbook Template."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApplicationInsightsWorkbookTemplate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ApplicationInsightsWorkbookTemplateSpec defines the desired state of ApplicationInsightsWorkbookTemplate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#galleries':: d.obj(help='"A galleries block as defined below."'),
      galleries: {
        '#withCategory':: d.fn(help='"Category for the gallery."', args=[d.arg(name='category', type=d.T.string)]),
        withCategory(category): { category: category },
        '#withName':: d.fn(help='"Name of the workbook template in the gallery."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withOrder':: d.fn(help='"Order of the template within the gallery. Defaults to 0."', args=[d.arg(name='order', type=d.T.number)]),
        withOrder(order): { order: order },
        '#withResourceType':: d.fn(help='"Azure resource type supported by the gallery. Defaults to Azure Monitor."', args=[d.arg(name='resourceType', type=d.T.string)]),
        withResourceType(resourceType): { resourceType: resourceType },
        '#withType':: d.fn(help='"Type of workbook supported by the workbook template. Defaults to workbook."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withAuthor':: d.fn(help='"Information about the author of the workbook template."', args=[d.arg(name='author', type=d.T.string)]),
      withAuthor(author): { spec+: { forProvider+: { author: author } } },
      '#withGalleries':: d.fn(help='"A galleries block as defined below."', args=[d.arg(name='galleries', type=d.T.array)]),
      withGalleries(galleries): { spec+: { forProvider+: { galleries: if std.isArray(v=galleries) then galleries else [galleries] } } },
      '#withGalleriesMixin':: d.fn(help='"A galleries block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='galleries', type=d.T.array)]),
      withGalleriesMixin(galleries): { spec+: { forProvider+: { galleries+: if std.isArray(v=galleries) then galleries else [galleries] } } },
      '#withLocalized':: d.fn(help='"Key value pairs of localized gallery. Each key is the locale code of languages supported by the Azure portal."', args=[d.arg(name='localized', type=d.T.string)]),
      withLocalized(localized): { spec+: { forProvider+: { localized: localized } } },
      '#withLocation':: d.fn(help='"Specifies the Azure Region where the Application Insights Workbook Template should exist. Changing this forces a new Application Insights Workbook Template to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"Specifies the name which should be used for this Application Insights Workbook Template. Changing this forces a new Application Insights Workbook Template to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPriority':: d.fn(help='"Priority of the template. Determines which template to open when a workbook gallery is opened in viewer mode. Defaults to 0."', args=[d.arg(name='priority', type=d.T.number)]),
      withPriority(priority): { spec+: { forProvider+: { priority: priority } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group where the Application Insights Workbook Template should exist. Changing this forces a new Application Insights Workbook Template to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Application Insights Workbook Template."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Application Insights Workbook Template."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withTemplateData':: d.fn(help='"Valid JSON object containing workbook template payload."', args=[d.arg(name='templateData', type=d.T.string)]),
      withTemplateData(templateData): { spec+: { forProvider+: { templateData: templateData } } },
    },
    ...
    initProvider: {
      ...
      '#withAuthor':: d.fn(help='"Information about the author of the workbook template."', args=[d.arg(name='author', type=d.T.string)]),
      withAuthor(author): { spec+: { initProvider+: { author: author } } },
      '#withGalleries':: d.fn(help='"A galleries block as defined below."', args=[d.arg(name='galleries', type=d.T.array)]),
      withGalleries(galleries): { spec+: { initProvider+: { galleries: if std.isArray(v=galleries) then galleries else [galleries] } } },
      '#withGalleriesMixin':: d.fn(help='"A galleries block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='galleries', type=d.T.array)]),
      withGalleriesMixin(galleries): { spec+: { initProvider+: { galleries+: if std.isArray(v=galleries) then galleries else [galleries] } } },
      '#withLocalized':: d.fn(help='"Key value pairs of localized gallery. Each key is the locale code of languages supported by the Azure portal."', args=[d.arg(name='localized', type=d.T.string)]),
      withLocalized(localized): { spec+: { initProvider+: { localized: localized } } },
      '#withLocation':: d.fn(help='"Specifies the Azure Region where the Application Insights Workbook Template should exist. Changing this forces a new Application Insights Workbook Template to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withTemplateData':: d.fn(help='"Valid JSON object containing workbook template payload."', args=[d.arg(name='templateData', type=d.T.string)]),
      withTemplateData(templateData): { spec+: { initProvider+: { templateData: templateData } } },
    },
