{
  ...
  '#':: d.pkg(name='monitorDataCollectionEndpoint', url='', help='"MonitorDataCollectionEndpoint is the Schema for the MonitorDataCollectionEndpoints API. Manages a Data Collection Endpoint."'),
  ...
  '#new':: d.fn(help='new returns an instance of MonitorDataCollectionEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MonitorDataCollectionEndpointSpec defines the desired state of MonitorDataCollectionEndpoint"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Specifies a description for the Data Collection Endpoint."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withKind':: d.fn(help='"The kind of the Data Collection Endpoint. Possible values are Linux and Windows."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { forProvider+: { kind: kind } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Data Collection Endpoint should exist. Changing this forces a new Data Collection Endpoint to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Whether network access from public internet to the Data Collection Endpoint are allowed. Possible values are true and false. Default to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Data Collection Endpoint should exist. Changing this forces a new Data Collection Endpoint to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Data Collection Endpoint."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Data Collection Endpoint."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
