{
  ...
  '#':: d.pkg(name='applicationInsightsAnalyticsItem', url='', help='"ApplicationInsightsAnalyticsItem is the Schema for the ApplicationInsightsAnalyticsItems API. Manages an Application Insights Analytics Item component."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApplicationInsightsAnalyticsItem', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ApplicationInsightsAnalyticsItemSpec defines the desired state of ApplicationInsightsAnalyticsItem"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationInsightsId':: d.fn(help='"The ID of the Application Insights component on which the Analytics Item exists. Changing this forces a new resource to be created."', args=[d.arg(name='applicationInsightsId', type=d.T.string)]),
      withApplicationInsightsId(applicationInsightsId): { spec+: { forProvider+: { applicationInsightsId: applicationInsightsId } } },
      '#withContent':: d.fn(help='"The content for the Analytics Item, for example the query text if type is query."', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { spec+: { forProvider+: { content: content } } },
      '#withFunctionAlias':: d.fn(help='"The alias to use for the function. Required when type is function."', args=[d.arg(name='functionAlias', type=d.T.string)]),
      withFunctionAlias(functionAlias): { spec+: { forProvider+: { functionAlias: functionAlias } } },
      '#withName':: d.fn(help='"Specifies the name of the Application Insights Analytics Item. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withScope':: d.fn(help='"The scope for the Analytics Item. Can be shared or user. Changing this forces a new resource to be created. Must be shared for functions."', args=[d.arg(name='scope', type=d.T.string)]),
      withScope(scope): { spec+: { forProvider+: { scope: scope } } },
      '#withType':: d.fn(help='"The type of Analytics Item to create. Can be one of query, function, folder, recent. Changing this forces a new resource to be created."', args=[d.arg(name='type', type=d.T.string)]),
