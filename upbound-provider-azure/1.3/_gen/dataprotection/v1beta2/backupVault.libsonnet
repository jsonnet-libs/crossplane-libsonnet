{
  ...
  '#':: d.pkg(name='backupVault', url='', help='"BackupVault is the Schema for the BackupVaults API. Manages a Backup Vault."'),
  ...
  '#new':: d.fn(help='new returns an instance of BackupVault', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BackupVaultSpec defines the desired state of BackupVault"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#identity':: d.obj(help='"An identity block as defined below."'),
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Backup Vault. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withDatastoreType':: d.fn(help='"Specifies the type of the data store. Possible values are ArchiveStore, OperationalStore, SnapshotStore and VaultStore. Changing this forces a new resource to be created."', args=[d.arg(name='datastoreType', type=d.T.string)]),
      withDatastoreType(datastoreType): { spec+: { forProvider+: { datastoreType: datastoreType } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Backup Vault should exist. Changing this forces a new Backup Vault to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withRedundancy':: d.fn(help='"Specifies the backup storage redundancy. Possible values are GeoRedundant, LocallyRedundant and ZoneRedundant. Changing this forces a new Backup Vault to be created."', args=[d.arg(name='redundancy', type=d.T.string)]),
      withRedundancy(redundancy): { spec+: { forProvider+: { redundancy: redundancy } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Backup Vault should exist. Changing this forces a new Backup Vault to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withRetentionDurationInDays':: d.fn(help='"The soft delete retention duration for this Backup Vault. Possible values are between 14 and 180. Defaults to 14."', args=[d.arg(name='retentionDurationInDays', type=d.T.number)]),
      withRetentionDurationInDays(retentionDurationInDays): { spec+: { forProvider+: { retentionDurationInDays: retentionDurationInDays } } },
      '#withSoftDelete':: d.fn(help='"The state of soft delete for this Backup Vault. Possible values are AlwaysOn, Off and On. Defaults to On."', args=[d.arg(name='softDelete', type=d.T.string)]),
      withSoftDelete(softDelete): { spec+: { forProvider+: { softDelete: softDelete } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Backup Vault."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Backup Vault."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withDatastoreType':: d.fn(help='"Specifies the type of the data store. Possible values are ArchiveStore, OperationalStore, SnapshotStore and VaultStore. Changing this forces a new resource to be created."', args=[d.arg(name='datastoreType', type=d.T.string)]),
      withDatastoreType(datastoreType): { spec+: { initProvider+: { datastoreType: datastoreType } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Backup Vault should exist. Changing this forces a new Backup Vault to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withRedundancy':: d.fn(help='"Specifies the backup storage redundancy. Possible values are GeoRedundant, LocallyRedundant and ZoneRedundant. Changing this forces a new Backup Vault to be created."', args=[d.arg(name='redundancy', type=d.T.string)]),
      withRedundancy(redundancy): { spec+: { initProvider+: { redundancy: redundancy } } },
      '#withRetentionDurationInDays':: d.fn(help='"The soft delete retention duration for this Backup Vault. Possible values are between 14 and 180. Defaults to 14."', args=[d.arg(name='retentionDurationInDays', type=d.T.number)]),
      withRetentionDurationInDays(retentionDurationInDays): { spec+: { initProvider+: { retentionDurationInDays: retentionDurationInDays } } },
      '#withSoftDelete':: d.fn(help='"The state of soft delete for this Backup Vault. Possible values are AlwaysOn, Off and On. Defaults to On."', args=[d.arg(name='softDelete', type=d.T.string)]),
      withSoftDelete(softDelete): { spec+: { initProvider+: { softDelete: softDelete } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Backup Vault."', args=[d.arg(name='tags', type=d.T.object)]),
