{
  ...
  '#':: d.pkg(name='resourceGuard', url='', help='"ResourceGuard is the Schema for the ResourceGuards API. Manages a Resource Guard."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceGuard', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ResourceGuardSpec defines the desired state of ResourceGuard"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Resource Guard should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Resource Guard should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Resource Guard."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Resource Guard."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withVaultCriticalOperationExclusionList':: d.fn(help='"A list of the critical operations which are not protected by this Resource Guard."', args=[d.arg(name='vaultCriticalOperationExclusionList', type=d.T.array)]),
      withVaultCriticalOperationExclusionList(vaultCriticalOperationExclusionList): { spec+: { forProvider+: { vaultCriticalOperationExclusionList: if std.isArray(v=vaultCriticalOperationExclusionList) then vaultCriticalOperationExclusionList else [vaultCriticalOperationExclusionList] } } },
      '#withVaultCriticalOperationExclusionListMixin':: d.fn(help='"A list of the critical operations which are not protected by this Resource Guard."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vaultCriticalOperationExclusionList', type=d.T.array)]),
      withVaultCriticalOperationExclusionListMixin(vaultCriticalOperationExclusionList): { spec+: { forProvider+: { vaultCriticalOperationExclusionList+: if std.isArray(v=vaultCriticalOperationExclusionList) then vaultCriticalOperationExclusionList else [vaultCriticalOperationExclusionList] } } },
    },
    ...
    initProvider: {
      ...
      '#withVaultCriticalOperationExclusionList':: d.fn(help='"A list of the critical operations which are not protected by this Resource Guard."', args=[d.arg(name='vaultCriticalOperationExclusionList', type=d.T.array)]),
      withVaultCriticalOperationExclusionList(vaultCriticalOperationExclusionList): { spec+: { initProvider+: { vaultCriticalOperationExclusionList: if std.isArray(v=vaultCriticalOperationExclusionList) then vaultCriticalOperationExclusionList else [vaultCriticalOperationExclusionList] } } },
      '#withVaultCriticalOperationExclusionListMixin':: d.fn(help='"A list of the critical operations which are not protected by this Resource Guard."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vaultCriticalOperationExclusionList', type=d.T.array)]),
      withVaultCriticalOperationExclusionListMixin(vaultCriticalOperationExclusionList): { spec+: { initProvider+: { vaultCriticalOperationExclusionList+: if std.isArray(v=vaultCriticalOperationExclusionList) then vaultCriticalOperationExclusionList else [vaultCriticalOperationExclusionList] } } },
    },
