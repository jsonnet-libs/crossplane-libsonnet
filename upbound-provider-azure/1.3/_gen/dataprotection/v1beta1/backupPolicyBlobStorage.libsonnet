{
  ...
  '#':: d.pkg(name='backupPolicyBlobStorage', url='', help='"BackupPolicyBlobStorage is the Schema for the BackupPolicyBlobStorages API. Manages a Backup Policy Blob Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of BackupPolicyBlobStorage', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BackupPolicyBlobStorageSpec defines the desired state of BackupPolicyBlobStorage"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRetentionDuration':: d.fn(help='"Duration of deletion after given timespan. It should follow ISO 8601 duration format. Changing this forces a new Backup Policy Blob Storage to be created."', args=[d.arg(name='retentionDuration', type=d.T.string)]),
      withRetentionDuration(retentionDuration): { spec+: { forProvider+: { retentionDuration: retentionDuration } } },
      '#withVaultId':: d.fn(help='"The ID of the Backup Vault within which the Backup Policy Blob Storage should exist. Changing this forces a new Backup Policy Blob Storage to be created."', args=[d.arg(name='vaultId', type=d.T.string)]),
    ...
    initProvider: {
      '#withRetentionDuration':: d.fn(help='"Duration of deletion after given timespan. It should follow ISO 8601 duration format. Changing this forces a new Backup Policy Blob Storage to be created."', args=[d.arg(name='retentionDuration', type=d.T.string)]),
      withRetentionDuration(retentionDuration): { spec+: { initProvider+: { retentionDuration: retentionDuration } } },
    },
