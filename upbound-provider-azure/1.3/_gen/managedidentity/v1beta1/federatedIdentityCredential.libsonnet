{
  ...
  '#':: d.pkg(name='federatedIdentityCredential', url='', help='"FederatedIdentityCredential is the Schema for the FederatedIdentityCredentials API. Manages a Federated Identity Credential."'),
  ...
  spec: {
    ...
    forProvider: {
      '#parentIdRef':: d.obj(help='"Reference to a UserAssignedIdentity in managedidentity to populate parentId."'),
      parentIdRef: {
      ...
      '#parentIdSelector':: d.obj(help='"Selector for a UserAssignedIdentity in managedidentity to populate parentId."'),
      parentIdSelector: {
      ...
      '#withAudience':: d.fn(help='"Specifies the audience for this Federated Identity Credential."', args=[d.arg(name='audience', type=d.T.array)]),
      withAudience(audience): { spec+: { forProvider+: { audience: if std.isArray(v=audience) then audience else [audience] } } },
      '#withAudienceMixin':: d.fn(help='"Specifies the audience for this Federated Identity Credential."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='audience', type=d.T.array)]),
      withAudienceMixin(audience): { spec+: { forProvider+: { audience+: if std.isArray(v=audience) then audience else [audience] } } },
      '#withIssuer':: d.fn(help='"Specifies the issuer of this Federated Identity Credential."', args=[d.arg(name='issuer', type=d.T.string)]),
      withIssuer(issuer): { spec+: { forProvider+: { issuer: issuer } } },
      '#withParentId':: d.fn(help='"Specifies parent ID of User Assigned Identity for this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created."', args=[d.arg(name='parentId', type=d.T.string)]),
      withParentId(parentId): { spec+: { forProvider+: { parentId: parentId } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group within which this Federated Identity Credential should exist. Changing this forces a new Federated Identity Credential to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSubject':: d.fn(help='"Specifies the subject for this Federated Identity Credential."', args=[d.arg(name='subject', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAudience':: d.fn(help='"Specifies the audience for this Federated Identity Credential."', args=[d.arg(name='audience', type=d.T.array)]),
      withAudience(audience): { spec+: { initProvider+: { audience: if std.isArray(v=audience) then audience else [audience] } } },
      '#withAudienceMixin':: d.fn(help='"Specifies the audience for this Federated Identity Credential."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='audience', type=d.T.array)]),
      withAudienceMixin(audience): { spec+: { initProvider+: { audience+: if std.isArray(v=audience) then audience else [audience] } } },
      '#withIssuer':: d.fn(help='"Specifies the issuer of this Federated Identity Credential."', args=[d.arg(name='issuer', type=d.T.string)]),
