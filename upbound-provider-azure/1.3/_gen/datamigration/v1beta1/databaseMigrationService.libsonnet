{
  ...
  '#':: d.pkg(name='databaseMigrationService', url='', help='"DatabaseMigrationService is the Schema for the DatabaseMigrationServices API. Manage a Azure Database Migration Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of DatabaseMigrationService', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatabaseMigrationServiceSpec defines the desired state of DatabaseMigrationService"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Specify the name of the database migration service. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withResourceGroupName':: d.fn(help='"Name of the resource group in which to create the database migration service. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"The SKU name of the database migration service. Possible values are Premium_4vCores, Standard_1vCores, Standard_2vCores and Standard_4vCores. Changing this forces a new resource to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withSubnetId':: d.fn(help='"The ID of the virtual subnet resource to which the database migration service should be joined. Changing this forces a new resource to be created."', args=[d.arg(name='subnetId', type=d.T.string)]),
      withSubnetId(subnetId): { spec+: { forProvider+: { subnetId: subnetId } } },
      '#withTags':: d.fn(help='"A mapping of tags to assigned to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assigned to the resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
