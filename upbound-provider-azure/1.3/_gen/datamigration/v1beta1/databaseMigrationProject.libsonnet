{
  ...
  '#':: d.pkg(name='databaseMigrationProject', url='', help='"DatabaseMigrationProject is the Schema for the DatabaseMigrationProjects API. Manage Azure Database Migration Project instance."'),
  ...
  '#new':: d.fn(help='new returns an instance of DatabaseMigrationProject', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatabaseMigrationProjectSpec defines the desired state of DatabaseMigrationProject"'),
  spec: {
    ...
    forProvider: {
      ...
      '#serviceNameRef':: d.obj(help='"Reference to a DatabaseMigrationService in datamigration to populate serviceName."'),
      serviceNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#serviceNameSelector':: d.obj(help='"Selector for a DatabaseMigrationService in datamigration to populate serviceName."'),
      serviceNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"Specify the name of the database migration project. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withResourceGroupName':: d.fn(help='"Name of the resource group in which to create the database migration project. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServiceName':: d.fn(help='"Name of the database migration service where resource belongs to. Changing this forces a new resource to be created."', args=[d.arg(name='serviceName', type=d.T.string)]),
      withServiceName(serviceName): { spec+: { forProvider+: { serviceName: serviceName } } },
      '#withSourcePlatform':: d.fn(help='"The platform type of the migration source. Currently only support: SQL(on-premises SQL Server). Changing this forces a new resource to be created."', args=[d.arg(name='sourcePlatform', type=d.T.string)]),
      withSourcePlatform(sourcePlatform): { spec+: { forProvider+: { sourcePlatform: sourcePlatform } } },
      ...
      '#withTargetPlatform':: d.fn(help='"The platform type of the migration target. Currently only support: SQLDB(Azure SQL Database). Changing this forces a new resource to be created."', args=[d.arg(name='targetPlatform', type=d.T.string)]),
      withTargetPlatform(targetPlatform): { spec+: { forProvider+: { targetPlatform: targetPlatform } } },
    },
    ...
    initProvider: {
      ...
      '#withSourcePlatform':: d.fn(help='"The platform type of the migration source. Currently only support: SQL(on-premises SQL Server). Changing this forces a new resource to be created."', args=[d.arg(name='sourcePlatform', type=d.T.string)]),
      withSourcePlatform(sourcePlatform): { spec+: { initProvider+: { sourcePlatform: sourcePlatform } } },
      '#withTags':: d.fn(help='"A mapping of tags to assigned to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assigned to the resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withTargetPlatform':: d.fn(help='"The platform type of the migration target. Currently only support: SQLDB(Azure SQL Database). Changing this forces a new resource to be created."', args=[d.arg(name='targetPlatform', type=d.T.string)]),
      withTargetPlatform(targetPlatform): { spec+: { initProvider+: { targetPlatform: targetPlatform } } },
    },
