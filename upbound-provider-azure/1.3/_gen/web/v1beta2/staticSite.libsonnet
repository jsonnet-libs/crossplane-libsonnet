{
  ...
  '#':: d.pkg(name='staticSite', url='', help='"StaticSite is the Schema for the StaticSites API. Manages a Static Site."'),
  ...
  '#new':: d.fn(help='new returns an instance of StaticSite', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"StaticSiteSpec defines the desired state of StaticSite"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#identity':: d.obj(help='"An identity block as defined below."'),
      identity: {
        '#withIdentityIds':: d.fn(help='"A list of Managed Identity IDs which should be assigned to this Static Site resource."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"A list of Managed Identity IDs which should be assigned to this Static Site resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"The Type of Managed Identity assigned to this Static Site resource. Possible values are SystemAssigned, UserAssigned and SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Static Web App should exist. Changing this forces a new Static Web App to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Static Web App should exist. Changing this forces a new Static Web App to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuSize':: d.fn(help='"Specifies the SKU size of the Static Web App. Possible values are Free or Standard. Defaults to Free."', args=[d.arg(name='skuSize', type=d.T.string)]),
      withSkuSize(skuSize): { spec+: { forProvider+: { skuSize: skuSize } } },
      '#withSkuTier':: d.fn(help='"Specifies the SKU tier of the Static Web App. Possible values are Free or Standard. Defaults to Free."', args=[d.arg(name='skuTier', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSkuSize':: d.fn(help='"Specifies the SKU size of the Static Web App. Possible values are Free or Standard. Defaults to Free."', args=[d.arg(name='skuSize', type=d.T.string)]),
      withSkuSize(skuSize): { spec+: { initProvider+: { skuSize: skuSize } } },
      '#withSkuTier':: d.fn(help='"Specifies the SKU tier of the Static Web App. Possible values are Free or Standard. Defaults to Free."', args=[d.arg(name='skuTier', type=d.T.string)]),
