{
  ...
  '#':: d.pkg(name='servicePlan', url='', help='"ServicePlan is the Schema for the ServicePlans API. Manages an App Service: Service Plan."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServicePlan', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServicePlanSpec defines the desired state of ServicePlan"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAppServiceEnvironmentId':: d.fn(help='"The ID of the App Service Environment to create this Service Plan in."', args=[d.arg(name='appServiceEnvironmentId', type=d.T.string)]),
      withAppServiceEnvironmentId(appServiceEnvironmentId): { spec+: { forProvider+: { appServiceEnvironmentId: appServiceEnvironmentId } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Service Plan should exist. Changing this forces a new Service Plan to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withMaximumElasticWorkerCount':: d.fn(help='"The maximum number of workers to use in an Elastic SKU Plan. Cannot be set unless using an Elastic SKU."', args=[d.arg(name='maximumElasticWorkerCount', type=d.T.number)]),
      ...
      '#withOsType':: d.fn(help='"The O/S type for the App Services to be hosted in this plan. Possible values include Windows, Linux, and WindowsContainer. Changing this forces a new resource to be created."', args=[d.arg(name='osType', type=d.T.string)]),
      withOsType(osType): { spec+: { forProvider+: { osType: osType } } },
      '#withPerSiteScalingEnabled':: d.fn(help='"Should Per Site Scaling be enabled. Defaults to false."', args=[d.arg(name='perSiteScalingEnabled', type=d.T.boolean)]),
      withPerSiteScalingEnabled(perSiteScalingEnabled): { spec+: { forProvider+: { perSiteScalingEnabled: perSiteScalingEnabled } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Service Plan should exist. Changing this forces a new Service Plan to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"The SKU for the plan. Possible values include B1, B2, B3, D1, F1, I1, I2, I3, I1v2, I2v2, I3v2, I4v2, I5v2, I6v2, P1v2, P2v2, P3v2, P0v3, P1v3, P2v3, P3v3, P1mv3, P2mv3, P3mv3, P4mv3, P5mv3, S1, S2, S3, SHARED, EP1, EP2, EP3, WS1, WS2, WS3, and Y1."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the AppService."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the AppService."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withWorkerCount':: d.fn(help='"The number of Workers (instances) to be allocated."', args=[d.arg(name='workerCount', type=d.T.number)]),
      withWorkerCount(workerCount): { spec+: { forProvider+: { workerCount: workerCount } } },
      '#withZoneBalancingEnabled':: d.fn(help='"Should the Service Plan balance across Availability Zones in the region. Changing this forces a new resource to be created."', args=[d.arg(name='zoneBalancingEnabled', type=d.T.boolean)]),
      withZoneBalancingEnabled(zoneBalancingEnabled): { spec+: { forProvider+: { zoneBalancingEnabled: zoneBalancingEnabled } } },
    },
    ...
    initProvider: {
      ...
      '#withPerSiteScalingEnabled':: d.fn(help='"Should Per Site Scaling be enabled. Defaults to false."', args=[d.arg(name='perSiteScalingEnabled', type=d.T.boolean)]),
      withPerSiteScalingEnabled(perSiteScalingEnabled): { spec+: { initProvider+: { perSiteScalingEnabled: perSiteScalingEnabled } } },
      '#withSkuName':: d.fn(help='"The SKU for the plan. Possible values include B1, B2, B3, D1, F1, I1, I2, I3, I1v2, I2v2, I3v2, I4v2, I5v2, I6v2, P1v2, P2v2, P3v2, P0v3, P1v3, P2v3, P3v3, P1mv3, P2mv3, P3mv3, P4mv3, P5mv3, S1, S2, S3, SHARED, EP1, EP2, EP3, WS1, WS2, WS3, and Y1."', args=[d.arg(name='skuName', type=d.T.string)]),
      ...
      '#withWorkerCount':: d.fn(help='"The number of Workers (instances) to be allocated."', args=[d.arg(name='workerCount', type=d.T.number)]),
      withWorkerCount(workerCount): { spec+: { initProvider+: { workerCount: workerCount } } },
      '#withZoneBalancingEnabled':: d.fn(help='"Should the Service Plan balance across Availability Zones in the region. Changing this forces a new resource to be created."', args=[d.arg(name='zoneBalancingEnabled', type=d.T.boolean)]),
      withZoneBalancingEnabled(zoneBalancingEnabled): { spec+: { initProvider+: { zoneBalancingEnabled: zoneBalancingEnabled } } },
    },
