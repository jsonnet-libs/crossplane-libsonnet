{
  ...
  spec: {
    ...
    initProvider: {
      ...
      '#withAppServiceEnvironmentId':: d.fn(help='"The ID of the App Service Environment where the App Service Plan should be located. Changing forces a new resource to be created."', args=[d.arg(name='appServiceEnvironmentId', type=d.T.string)]),
      withAppServiceEnvironmentId(appServiceEnvironmentId): { spec+: { initProvider+: { appServiceEnvironmentId: appServiceEnvironmentId } } },
      '#withIsXenon':: d.fn(help='"Whether to create a xenon App Service Plan."', args=[d.arg(name='isXenon', type=d.T.boolean)]),
      withIsXenon(isXenon): { spec+: { initProvider+: { isXenon: isXenon } } },
      '#withKind':: d.fn(help='"The kind of the App Service Plan to create. Possible values are Windows (also available as App), Linux, elastic (for Premium Consumption), xenon and FunctionApp (for a Consumption Plan). Defaults to Windows. Changing this forces a new resource to be created."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { initProvider+: { kind: kind } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withMaximumElasticWorkerCount':: d.fn(help='"The maximum number of total workers allowed for this ElasticScaleEnabled App Service Plan."', args=[d.arg(name='maximumElasticWorkerCount', type=d.T.number)]),
      withMaximumElasticWorkerCount(maximumElasticWorkerCount): { spec+: { initProvider+: { maximumElasticWorkerCount: maximumElasticWorkerCount } } },
      '#withPerSiteScaling':: d.fn(help='"Can Apps assigned to this App Service Plan be scaled independently? If set to false apps assigned to this plan will scale to all instances of the plan."', args=[d.arg(name='perSiteScaling', type=d.T.boolean)]),
      withPerSiteScaling(perSiteScaling): { spec+: { initProvider+: { perSiteScaling: perSiteScaling } } },
      '#withReserved':: d.fn(help='"Is this App Service Plan Reserved."', args=[d.arg(name='reserved', type=d.T.boolean)]),
      withReserved(reserved): { spec+: { initProvider+: { reserved: reserved } } },
      '#withSku':: d.fn(help='"A sku block as documented below."', args=[d.arg(name='sku', type=d.T.array)]),
