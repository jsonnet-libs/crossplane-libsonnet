{
  ...
  '#':: d.pkg(name='functionAppFunction', url='', help='"FunctionAppFunction is the Schema for the FunctionAppFunctions API. Manages a Function App Function."'),
  ...
  '#new':: d.fn(help='new returns an instance of FunctionAppFunction', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FunctionAppFunctionSpec defines the desired state of FunctionAppFunction"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#file':: d.obj(help='"A file block as detailed below. Changing this forces a new resource to be created."'),
      file: {
        '#withContent':: d.fn(help='"The content of the file. Changing this forces a new resource to be created.\\nThe content of the file."', args=[d.arg(name='content', type=d.T.string)]),
        withContent(content): { content: content },
        '#withName':: d.fn(help='"The filename of the file to be uploaded. Changing this forces a new resource to be created.\\nThe filename of the file to be uploaded."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withConfigJson':: d.fn(help='"The config for this Function in JSON format.\\nThe config for this Function in JSON format."', args=[d.arg(name='configJson', type=d.T.string)]),
      withConfigJson(configJson): { spec+: { forProvider+: { configJson: configJson } } },
      '#withEnabled':: d.fn(help='"Should this function be enabled. Defaults to true.\\nShould this function be enabled. Defaults to `true`."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withFile':: d.fn(help='"A file block as detailed below. Changing this forces a new resource to be created."', args=[d.arg(name='file', type=d.T.array)]),
      withFile(file): { spec+: { forProvider+: { file: if std.isArray(v=file) then file else [file] } } },
      '#withFileMixin':: d.fn(help='"A file block as detailed below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='file', type=d.T.array)]),
      withFileMixin(file): { spec+: { forProvider+: { file+: if std.isArray(v=file) then file else [file] } } },
      '#withFunctionAppId':: d.fn(help='"The ID of the Function App in which this function should reside. Changing this forces a new resource to be created.\\nThe ID of the Function App in which this function should reside."', args=[d.arg(name='functionAppId', type=d.T.string)]),
      withFunctionAppId(functionAppId): { spec+: { forProvider+: { functionAppId: functionAppId } } },
      '#withLanguage':: d.fn(help='"The language the Function is written in. Possible values are CSharp, Custom, Java, Javascript, Python, PowerShell, and TypeScript.\\nThe language the Function is written in."', args=[d.arg(name='language', type=d.T.string)]),
      withLanguage(language): { spec+: { forProvider+: { language: language } } },
      '#withName':: d.fn(help='"The name of the function. Changing this forces a new resource to be created.\\nThe name of the function."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withTestData':: d.fn(help='"The test data for the function.\\nThe test data for the function."', args=[d.arg(name='testData', type=d.T.string)]),
      withTestData(testData): { spec+: { forProvider+: { testData: testData } } },
    },
    ...
    initProvider: {
      ...
      '#withFile':: d.fn(help='"A file block as detailed below. Changing this forces a new resource to be created."', args=[d.arg(name='file', type=d.T.array)]),
      withFile(file): { spec+: { initProvider+: { file: if std.isArray(v=file) then file else [file] } } },
      '#withFileMixin':: d.fn(help='"A file block as detailed below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='file', type=d.T.array)]),
      withFileMixin(file): { spec+: { initProvider+: { file+: if std.isArray(v=file) then file else [file] } } },
      '#withFunctionAppId':: d.fn(help='"The ID of the Function App in which this function should reside. Changing this forces a new resource to be created.\\nThe ID of the Function App in which this function should reside."', args=[d.arg(name='functionAppId', type=d.T.string)]),
      ...
      '#withTestData':: d.fn(help='"The test data for the function.\\nThe test data for the function."', args=[d.arg(name='testData', type=d.T.string)]),
      withTestData(testData): { spec+: { initProvider+: { testData: testData } } },
    },
