{
  ...
  '#':: d.pkg(name='appActiveSlot', url='', help='"AppActiveSlot is the Schema for the AppActiveSlots API. Manages a Web App Active Slot."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppActiveSlot', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppActiveSlotSpec defines the desired state of AppActiveSlot"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#slotIdRef':: d.obj(help='"Reference to a WindowsWebAppSlot in web to populate slotId."'),
      slotIdRef: {
      ...
      '#slotIdSelector':: d.obj(help='"Selector for a WindowsWebAppSlot in web to populate slotId."'),
      slotIdSelector: {
