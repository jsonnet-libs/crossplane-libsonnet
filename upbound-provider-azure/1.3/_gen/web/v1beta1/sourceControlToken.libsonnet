{
  ...
  '#':: d.pkg(name='sourceControlToken', url='', help='"SourceControlToken is the Schema for the SourceControlTokens API. Manages an App Service GitHub Token."'),
  ...
  '#new':: d.fn(help='new returns an instance of SourceControlToken', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SourceControlTokenSpec defines the desired state of SourceControlToken"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#tokenSecretRef':: d.obj(help='"The Access Token."'),
      tokenSecretRef: {
      ...
      '#tokenSecretSecretRef':: d.obj(help='"The Access Token Secret."'),
      tokenSecretSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { tokenSecretSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { tokenSecretSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { tokenSecretSecretRef+: { namespace: namespace } } } },
      },
      '#withType':: d.fn(help='"The Token type. Possible values include Bitbucket, Dropbox, Github, and OneDrive."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      tokenSecretSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { tokenSecretSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { tokenSecretSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { tokenSecretSecretRef+: { namespace: namespace } } } },
      },
      '#withType':: d.fn(help='"The Token type. Possible values include Bitbucket, Dropbox, Github, and OneDrive."', args=[d.arg(name='type', type=d.T.string)]),
