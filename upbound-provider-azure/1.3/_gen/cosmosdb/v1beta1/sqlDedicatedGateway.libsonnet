{
  ...
  '#':: d.pkg(name='sqlDedicatedGateway', url='', help='"SQLDedicatedGateway is the Schema for the SQLDedicatedGateways API. Manages a SQL Dedicated Gateway within a Cosmos DB Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLDedicatedGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLDedicatedGatewaySpec defines the desired state of SQLDedicatedGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCosmosdbAccountId':: d.fn(help='"The resource ID of the CosmosDB Account. Changing this forces a new resource to be created."', args=[d.arg(name='cosmosdbAccountId', type=d.T.string)]),
      withCosmosdbAccountId(cosmosdbAccountId): { spec+: { forProvider+: { cosmosdbAccountId: cosmosdbAccountId } } },
      '#withInstanceCount':: d.fn(help='"The instance count for the CosmosDB SQL Dedicated Gateway. Possible value is between 1 and 5."', args=[d.arg(name='instanceCount', type=d.T.number)]),
      withInstanceCount(instanceCount): { spec+: { forProvider+: { instanceCount: instanceCount } } },
      '#withInstanceSize':: d.fn(help='"The instance size for the CosmosDB SQL Dedicated Gateway. Changing this forces a new resource to be created. Possible values are Cosmos.D4s, Cosmos.D8s and Cosmos.D16s."', args=[d.arg(name='instanceSize', type=d.T.string)]),
      withInstanceSize(instanceSize): { spec+: { forProvider+: { instanceSize: instanceSize } } },
    },
    ...
    initProvider: {
      ...
      '#withInstanceSize':: d.fn(help='"The instance size for the CosmosDB SQL Dedicated Gateway. Changing this forces a new resource to be created. Possible values are Cosmos.D4s, Cosmos.D8s and Cosmos.D16s."', args=[d.arg(name='instanceSize', type=d.T.string)]),
      withInstanceSize(instanceSize): { spec+: { initProvider+: { instanceSize: instanceSize } } },
    },
