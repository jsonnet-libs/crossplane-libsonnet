{
  ...
  '#':: d.pkg(name='sqlStoredProcedure', url='', help='"SQLStoredProcedure is the Schema for the SQLStoredProcedures API. Manages a SQL Stored Procedure within a Cosmos DB Account SQL Database."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLStoredProcedure', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLStoredProcedureSpec defines the desired state of SQLStoredProcedure"'),
  spec: {
    ...
    forProvider: {
      ...
      '#containerNameRef':: d.obj(help='"Reference to a SQLContainer in cosmosdb to populate containerName."'),
      containerNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#containerNameSelector':: d.obj(help='"Selector for a SQLContainer in cosmosdb to populate containerName."'),
      ...
      '#withAccountName':: d.fn(help='"The name of the Cosmos DB Account to create the stored procedure within. Changing this forces a new resource to be created."', args=[d.arg(name='accountName', type=d.T.string)]),
      withAccountName(accountName): { spec+: { forProvider+: { accountName: accountName } } },
      '#withBody':: d.fn(help='"The body of the stored procedure."', args=[d.arg(name='body', type=d.T.string)]),
      withBody(body): { spec+: { forProvider+: { body: body } } },
      '#withContainerName':: d.fn(help='"The name of the Cosmos DB SQL Container to create the stored procedure within. Changing this forces a new resource to be created."', args=[d.arg(name='containerName', type=d.T.string)]),
      withContainerName(containerName): { spec+: { forProvider+: { containerName: containerName } } },
      '#withDatabaseName':: d.fn(help='"The name of the Cosmos DB SQL Database to create the stored procedure within. Changing this forces a new resource to be created."', args=[d.arg(name='databaseName', type=d.T.string)]),
      withDatabaseName(databaseName): { spec+: { forProvider+: { databaseName: databaseName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Cosmos DB SQL Database is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
