{
  ...
  '#':: d.pkg(name='table', url='', help='"Table is the Schema for the Tables API. Manages a Table within a Cosmos DB Account."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      autoscaleSettings: {
        '#withMaxThroughput':: d.fn(help='"The maximum throughput of the Table (RU/s). Must be between 1,000 and 1,000,000. Must be set in increments of 1,000. Conflicts with throughput."', args=[d.arg(name='maxThroughput', type=d.T.number)]),
      ...
      '#withAccountName':: d.fn(help='"The name of the Cosmos DB Table to create the table within. Changing this forces a new resource to be created."', args=[d.arg(name='accountName', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Cosmos DB Table is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withThroughput':: d.fn(help='"The throughput of Table (RU/s). Must be set in increments of 100. The minimum value is 400."', args=[d.arg(name='throughput', type=d.T.number)]),
