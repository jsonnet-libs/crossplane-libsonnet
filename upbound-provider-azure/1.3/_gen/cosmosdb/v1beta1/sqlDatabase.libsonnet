{
  ...
  '#':: d.pkg(name='sqlDatabase', url='', help='"SQLDatabase is the Schema for the SQLDatabases API. Manages a SQL Database within a Cosmos DB Account."'),
  ...
  '#spec':: d.obj(help='"SQLDatabaseSpec defines the desired state of SQLDatabase"'),
  spec: {
    ...
    forProvider: {
      ...
      autoscaleSettings: {
        '#withMaxThroughput':: d.fn(help='"The maximum throughput of the SQL database (RU/s). Must be between 1,000 and 1,000,000. Must be set in increments of 1,000. Conflicts with throughput."', args=[d.arg(name='maxThroughput', type=d.T.number)]),
      ...
      '#withAccountName':: d.fn(help='"The name of the Cosmos DB SQL Database to create the table within. Changing this forces a new resource to be created."', args=[d.arg(name='accountName', type=d.T.string)]),
      ...
      '#withThroughput':: d.fn(help='"The throughput of SQL database (RU/s). Must be set in increments of 100. The minimum value is 400. Do not set when azurerm_cosmosdb_account is configured with EnableServerless capability."', args=[d.arg(name='throughput', type=d.T.number)]),
