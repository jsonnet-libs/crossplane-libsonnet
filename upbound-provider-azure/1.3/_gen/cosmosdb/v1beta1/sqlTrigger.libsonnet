{
  ...
  '#':: d.pkg(name='sqlTrigger', url='', help='"SQLTrigger is the Schema for the SQLTriggers API. Manages an SQL Trigger."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLTrigger', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLTriggerSpec defines the desired state of SQLTrigger"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#containerIdRef':: d.obj(help='"Reference to a SQLContainer in cosmosdb to populate containerId."'),
      containerIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { containerIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { containerIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { containerIdRef+: { name: name } } } },
      },
      '#containerIdSelector':: d.obj(help='"Selector for a SQLContainer in cosmosdb to populate containerId."'),
      containerIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { containerIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { containerIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { containerIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { containerIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { containerIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withBody':: d.fn(help='"Body of the Trigger."', args=[d.arg(name='body', type=d.T.string)]),
      withBody(body): { spec+: { forProvider+: { body: body } } },
      '#withContainerId':: d.fn(help='"The id of the Cosmos DB SQL Container to create the SQL Trigger within. Changing this forces a new SQL Trigger to be created."', args=[d.arg(name='containerId', type=d.T.string)]),
      withContainerId(containerId): { spec+: { forProvider+: { containerId: containerId } } },
      '#withOperation':: d.fn(help='"The operation the trigger is associated with. Possible values are All, Create, Update, Delete and Replace."', args=[d.arg(name='operation', type=d.T.string)]),
      withOperation(operation): { spec+: { forProvider+: { operation: operation } } },
      '#withType':: d.fn(help='"Type of the Trigger. Possible values are Pre and Post."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withOperation':: d.fn(help='"The operation the trigger is associated with. Possible values are All, Create, Update, Delete and Replace."', args=[d.arg(name='operation', type=d.T.string)]),
      withOperation(operation): { spec+: { initProvider+: { operation: operation } } },
      '#withType':: d.fn(help='"Type of the Trigger. Possible values are Pre and Post."', args=[d.arg(name='type', type=d.T.string)]),
