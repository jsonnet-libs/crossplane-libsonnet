{
  ...
  '#':: d.pkg(name='sqlFunction', url='', help='"SQLFunction is the Schema for the SQLFunctions API. Manages an SQL User Defined Function."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLFunction', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLFunctionSpec defines the desired state of SQLFunction"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBody':: d.fn(help='"Body of the User Defined Function."', args=[d.arg(name='body', type=d.T.string)]),
      withBody(body): { spec+: { forProvider+: { body: body } } },
      '#withContainerId':: d.fn(help='"The id of the Cosmos DB SQL Container to create the SQL User Defined Function within. Changing this forces a new SQL User Defined Function to be created."', args=[d.arg(name='containerId', type=d.T.string)]),
