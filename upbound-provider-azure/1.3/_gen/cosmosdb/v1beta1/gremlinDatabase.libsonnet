{
  ...
  '#':: d.pkg(name='gremlinDatabase', url='', help='"GremlinDatabase is the Schema for the GremlinDatabases API. Manages a Gremlin Database within a Cosmos DB Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of GremlinDatabase', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GremlinDatabaseSpec defines the desired state of GremlinDatabase"'),
  spec: {
    ...
    forProvider: {
      ...
      autoscaleSettings: {
        '#withMaxThroughput':: d.fn(help='"The maximum throughput of the Gremlin database (RU/s). Must be between 1,000 and 1,000,000. Must be set in increments of 1,000. Conflicts with throughput."', args=[d.arg(name='maxThroughput', type=d.T.number)]),
      ...
      '#withAccountName':: d.fn(help='"The name of the CosmosDB Account to create the Gremlin Database within. Changing this forces a new resource to be created."', args=[d.arg(name='accountName', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Cosmos DB Gremlin Database is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withThroughput':: d.fn(help='"The throughput of the Gremlin database (RU/s). Must be set in increments of 100. The minimum value is 400."', args=[d.arg(name='throughput', type=d.T.number)]),
