{
  ...
  '#':: d.pkg(name='cassandraKeySpace', url='', help='"CassandraKeySpace is the Schema for the CassandraKeySpaces API. Manages a Cassandra KeySpace within a Cosmos DB Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of CassandraKeySpace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CassandraKeySpaceSpec defines the desired state of CassandraKeySpace"'),
  spec: {
    ...
    forProvider: {
      ...
      autoscaleSettings: {
        '#withMaxThroughput':: d.fn(help='"The maximum throughput of the Cassandra KeySpace (RU/s). Must be between 1,000 and 1,000,000. Must be set in increments of 1,000. Conflicts with throughput."', args=[d.arg(name='maxThroughput', type=d.T.number)]),
      ...
      '#withAccountName':: d.fn(help='"The name of the Cosmos DB Cassandra KeySpace to create the table within. Changing this forces a new resource to be created."', args=[d.arg(name='accountName', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Cosmos DB Cassandra KeySpace is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
