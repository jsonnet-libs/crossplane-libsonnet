  ...
  spec: {
    ...
    forProvider: {
      ...
      monitoring: {
        ...
        withAlertsForAllJobFailuresEnabled(alertsForAllJobFailuresEnabled): { alertsForAllJobFailuresEnabled: alertsForAllJobFailuresEnabled },
        ...
        withAlertsForCriticalOperationFailuresEnabled(alertsForCriticalOperationFailuresEnabled): { alertsForCriticalOperationFailuresEnabled: alertsForCriticalOperationFailuresEnabled },
      },
      ...
      '#withEncryption':: d.fn(help='"An encryption block as defined below. Required with identity."', args=[d.arg(name='encryption', type=d.T.array)]),
      withEncryption(encryption): { spec+: { forProvider+: { encryption: if std.isArray(v=encryption) then encryption else [encryption] } } },
      '#withEncryptionMixin':: d.fn(help='"An encryption block as defined below. Required with identity."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryption', type=d.T.array)]),
