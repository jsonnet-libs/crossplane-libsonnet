{
  ...
  '#':: d.pkg(name='siteRecoveryProtectionContainer', url='', help='"SiteRecoveryProtectionContainer is the Schema for the SiteRecoveryProtectionContainers API. Manages a site recovery services protection container on Azure."'),
  ...
  '#new':: d.fn(help='new returns an instance of SiteRecoveryProtectionContainer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SiteRecoveryProtectionContainerSpec defines the desired state of SiteRecoveryProtectionContainer"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRecoveryFabricName':: d.fn(help='"Name of fabric that should contain this protection container. Changing this forces a new resource to be created."', args=[d.arg(name='recoveryFabricName', type=d.T.string)]),
