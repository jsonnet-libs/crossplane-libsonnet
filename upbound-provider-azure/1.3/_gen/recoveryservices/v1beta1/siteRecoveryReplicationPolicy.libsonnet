{
  ...
  '#':: d.pkg(name='siteRecoveryReplicationPolicy', url='', help='"SiteRecoveryReplicationPolicy is the Schema for the SiteRecoveryReplicationPolicys API. Manages an Azure Site Recovery replication policy on Azure."'),
  ...
  '#new':: d.fn(help='new returns an instance of SiteRecoveryReplicationPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SiteRecoveryReplicationPolicySpec defines the desired state of SiteRecoveryReplicationPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationConsistentSnapshotFrequencyInMinutes':: d.fn(help='"Specifies the frequency(in minutes) at which to create application consistent recovery points."', args=[d.arg(name='applicationConsistentSnapshotFrequencyInMinutes', type=d.T.number)]),
      withApplicationConsistentSnapshotFrequencyInMinutes(applicationConsistentSnapshotFrequencyInMinutes): { spec+: { forProvider+: { applicationConsistentSnapshotFrequencyInMinutes: applicationConsistentSnapshotFrequencyInMinutes } } },
      '#withRecoveryPointRetentionInMinutes':: d.fn(help='"The duration in minutes for which the recovery points need to be stored."', args=[d.arg(name='recoveryPointRetentionInMinutes', type=d.T.number)]),
      withRecoveryPointRetentionInMinutes(recoveryPointRetentionInMinutes): { spec+: { forProvider+: { recoveryPointRetentionInMinutes: recoveryPointRetentionInMinutes } } },
    ...
    initProvider: {
      '#withApplicationConsistentSnapshotFrequencyInMinutes':: d.fn(help='"Specifies the frequency(in minutes) at which to create application consistent recovery points."', args=[d.arg(name='applicationConsistentSnapshotFrequencyInMinutes', type=d.T.number)]),
      withApplicationConsistentSnapshotFrequencyInMinutes(applicationConsistentSnapshotFrequencyInMinutes): { spec+: { initProvider+: { applicationConsistentSnapshotFrequencyInMinutes: applicationConsistentSnapshotFrequencyInMinutes } } },
      '#withRecoveryPointRetentionInMinutes':: d.fn(help='"The duration in minutes for which the recovery points need to be stored."', args=[d.arg(name='recoveryPointRetentionInMinutes', type=d.T.number)]),
      withRecoveryPointRetentionInMinutes(recoveryPointRetentionInMinutes): { spec+: { initProvider+: { recoveryPointRetentionInMinutes: recoveryPointRetentionInMinutes } } },
    },
