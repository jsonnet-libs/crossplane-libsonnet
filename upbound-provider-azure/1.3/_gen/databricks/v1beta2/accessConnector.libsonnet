{
  ...
  '#':: d.pkg(name='accessConnector', url='', help='"AccessConnector is the Schema for the AccessConnectors API. Manages a Databricks Access Connector"'),
  ...
  '#new':: d.fn(help='new returns an instance of AccessConnector', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AccessConnectorSpec defines the desired state of AccessConnector"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#identity':: d.obj(help='"An identity block as defined below."'),
      identity: {
        '#withIdentityIds':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to the Databricks Access Connector. Only one User Assigned Managed Identity ID is supported per Databricks Access Connector resource."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to the Databricks Access Connector. Only one User Assigned Managed Identity ID is supported per Databricks Access Connector resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on the Databricks Access Connector. Possible values include SystemAssigned or UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the Databricks Access Connector should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
