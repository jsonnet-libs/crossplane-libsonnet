{
  ...
  '#new':: d.fn(help='new returns an instance of WorkspaceCustomerManagedKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkspaceCustomerManagedKeySpec defines the desired state of WorkspaceCustomerManagedKey"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withKeyVaultKeyId':: d.fn(help='"The ID of the Key Vault."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
      withKeyVaultKeyId(keyVaultKeyId): { spec+: { forProvider+: { keyVaultKeyId: keyVaultKeyId } } },
      '#withWorkspaceId':: d.fn(help='"The ID of the Databricks Workspace.."', args=[d.arg(name='workspaceId', type=d.T.string)]),
