{
  ...
  '#':: d.pkg(name='workspaceRootDbfsCustomerManagedKey', url='', help='"WorkspaceRootDbfsCustomerManagedKey is the Schema for the WorkspaceRootDbfsCustomerManagedKeys API. Manages a Customer Managed Key for the Databricks Workspaces root Databricks File System(DBFS)"'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkspaceRootDbfsCustomerManagedKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkspaceRootDbfsCustomerManagedKeySpec defines the desired state of WorkspaceRootDbfsCustomerManagedKey"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withKeyVaultKeyId':: d.fn(help='"The resource ID of the Key Vault Key to be used."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
      withKeyVaultKeyId(keyVaultKeyId): { spec+: { forProvider+: { keyVaultKeyId: keyVaultKeyId } } },
      '#withWorkspaceId':: d.fn(help='"The resource ID of the Databricks Workspace."', args=[d.arg(name='workspaceId', type=d.T.string)]),
      withWorkspaceId(workspaceId): { spec+: { forProvider+: { workspaceId: workspaceId } } },
      '#workspaceIdRef':: d.obj(help='"Reference to a Workspace in databricks to populate workspaceId."'),
      workspaceIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#workspaceIdSelector':: d.obj(help='"Selector for a Workspace in databricks to populate workspaceId."'),
      workspaceIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
