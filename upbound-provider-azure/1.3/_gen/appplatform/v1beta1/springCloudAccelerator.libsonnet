{
  ...
  '#':: d.pkg(name='springCloudAccelerator', url='', help='"SpringCloudAccelerator is the Schema for the SpringCloudAccelerators API. Manages a Spring Cloud Accelerator."'),
  ...
  '#new':: d.fn(help='new returns an instance of SpringCloudAccelerator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SpringCloudAcceleratorSpec defines the desired state of SpringCloudAccelerator"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"The name which should be used for this Spring Cloud Accelerator. Changing this forces a new Spring Cloud Accelerator to be created. The only possible value is default."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withSpringCloudServiceId':: d.fn(help='"The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Accelerator to be created."', args=[d.arg(name='springCloudServiceId', type=d.T.string)]),
