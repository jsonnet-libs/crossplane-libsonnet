{
  ...
  '#':: d.pkg(name='springCloudBuildPackBinding', url='', help='"SpringCloudBuildPackBinding is the Schema for the SpringCloudBuildPackBindings API. Manages a Spring Cloud Build Pack Binding."'),
  ...
  '#new':: d.fn(help='new returns an instance of SpringCloudBuildPackBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SpringCloudBuildPackBindingSpec defines the desired state of SpringCloudBuildPackBinding"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#launch':: d.obj(help='"A launch block as defined below."'),
      launch: {
        '#withProperties':: d.fn(help='"Specifies a map of non-sensitive properties for launchProperties."', args=[d.arg(name='properties', type=d.T.object)]),
        withProperties(properties): { properties: properties },
        '#withPropertiesMixin':: d.fn(help='"Specifies a map of non-sensitive properties for launchProperties."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='properties', type=d.T.object)]),
        withPropertiesMixin(properties): { properties+: properties },
        '#withSecrets':: d.fn(help='"Specifies a map of sensitive properties for launchProperties."', args=[d.arg(name='secrets', type=d.T.object)]),
        withSecrets(secrets): { secrets: secrets },
        '#withSecretsMixin':: d.fn(help='"Specifies a map of sensitive properties for launchProperties."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.object)]),
        withSecretsMixin(secrets): { secrets+: secrets },
      },
      '#springCloudBuilderIdRef':: d.obj(help='"Reference to a SpringCloudBuilder in appplatform to populate springCloudBuilderId."'),
      springCloudBuilderIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { springCloudBuilderIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { springCloudBuilderIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { springCloudBuilderIdRef+: { name: name } } } },
      },
      '#springCloudBuilderIdSelector':: d.obj(help='"Selector for a SpringCloudBuilder in appplatform to populate springCloudBuilderId."'),
      springCloudBuilderIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { springCloudBuilderIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { springCloudBuilderIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { springCloudBuilderIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { springCloudBuilderIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { springCloudBuilderIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withBindingType':: d.fn(help='"Specifies the Build Pack Binding Type. Allowed values are ApacheSkyWalking, AppDynamics, ApplicationInsights, Dynatrace, ElasticAPM and NewRelic."', args=[d.arg(name='bindingType', type=d.T.string)]),
      withBindingType(bindingType): { spec+: { forProvider+: { bindingType: bindingType } } },
      '#withLaunch':: d.fn(help='"A launch block as defined below."', args=[d.arg(name='launch', type=d.T.array)]),
      withLaunch(launch): { spec+: { forProvider+: { launch: if std.isArray(v=launch) then launch else [launch] } } },
      '#withLaunchMixin':: d.fn(help='"A launch block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='launch', type=d.T.array)]),
      withLaunchMixin(launch): { spec+: { forProvider+: { launch+: if std.isArray(v=launch) then launch else [launch] } } },
      '#withSpringCloudBuilderId':: d.fn(help='"The ID of the Spring Cloud Builder. Changing this forces a new Spring Cloud Build Pack Binding to be created."', args=[d.arg(name='springCloudBuilderId', type=d.T.string)]),
      withSpringCloudBuilderId(springCloudBuilderId): { spec+: { forProvider+: { springCloudBuilderId: springCloudBuilderId } } },
    },
    ...
    initProvider: {
      ...
      '#withBindingType':: d.fn(help='"Specifies the Build Pack Binding Type. Allowed values are ApacheSkyWalking, AppDynamics, ApplicationInsights, Dynatrace, ElasticAPM and NewRelic."', args=[d.arg(name='bindingType', type=d.T.string)]),
      withBindingType(bindingType): { spec+: { initProvider+: { bindingType: bindingType } } },
      '#withLaunch':: d.fn(help='"A launch block as defined below."', args=[d.arg(name='launch', type=d.T.array)]),
      withLaunch(launch): { spec+: { initProvider+: { launch: if std.isArray(v=launch) then launch else [launch] } } },
      '#withLaunchMixin':: d.fn(help='"A launch block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='launch', type=d.T.array)]),
      withLaunchMixin(launch): { spec+: { initProvider+: { launch+: if std.isArray(v=launch) then launch else [launch] } } },
    },
