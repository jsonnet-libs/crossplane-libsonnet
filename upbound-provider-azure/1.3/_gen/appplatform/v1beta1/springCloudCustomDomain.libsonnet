{
  ...
  '#':: d.pkg(name='springCloudCustomDomain', url='', help='"SpringCloudCustomDomain is the Schema for the SpringCloudCustomDomains API. Manages an Azure Spring Cloud Custom Domain."'),
  ...
  '#new':: d.fn(help='new returns an instance of SpringCloudCustomDomain', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SpringCloudCustomDomainSpec defines the desired state of SpringCloudCustomDomain"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCertificateName':: d.fn(help='"Specifies the name of the Spring Cloud Certificate that binds to the Spring Cloud Custom Domain. Required when thumbprint is specified"', args=[d.arg(name='certificateName', type=d.T.string)]),
      withCertificateName(certificateName): { spec+: { forProvider+: { certificateName: certificateName } } },
      '#withName':: d.fn(help='"Specifies the name of the Spring Cloud Custom Domain. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withSpringCloudAppId':: d.fn(help='"Specifies the resource ID of the Spring Cloud Application. Changing this forces a new resource to be created."', args=[d.arg(name='springCloudAppId', type=d.T.string)]),
      withSpringCloudAppId(springCloudAppId): { spec+: { forProvider+: { springCloudAppId: springCloudAppId } } },
      '#withThumbprint':: d.fn(help='"Specifies the thumbprint of the Spring Cloud Certificate that binds to the Spring Cloud Custom Domain. Required when certificate_name is specified. Changing this forces a new resource to be created."', args=[d.arg(name='thumbprint', type=d.T.string)]),
      withThumbprint(thumbprint): { spec+: { forProvider+: { thumbprint: thumbprint } } },
    },
    ...
    initProvider: {
      ...
      '#withThumbprint':: d.fn(help='"Specifies the thumbprint of the Spring Cloud Certificate that binds to the Spring Cloud Custom Domain. Required when certificate_name is specified. Changing this forces a new resource to be created."', args=[d.arg(name='thumbprint', type=d.T.string)]),
      withThumbprint(thumbprint): { spec+: { initProvider+: { thumbprint: thumbprint } } },
    },
