{
  ...
  '#':: d.pkg(name='queueAuthorizationRule', url='', help='"QueueAuthorizationRule is the Schema for the QueueAuthorizationRules API. Manages an Authorization Rule for a ServiceBus Queue."'),
  ...
  '#new':: d.fn(help='new returns an instance of QueueAuthorizationRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"QueueAuthorizationRuleSpec defines the desired state of QueueAuthorizationRule"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#queueIdRef':: d.obj(help='"Reference to a Queue in servicebus to populate queueId."'),
      queueIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { queueIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { queueIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { queueIdRef+: { name: name } } } },
      },
      '#queueIdSelector':: d.obj(help='"Selector for a Queue in servicebus to populate queueId."'),
      queueIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { queueIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { queueIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { queueIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { queueIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { queueIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withListen':: d.fn(help='"Does this Authorization Rule have Listen permissions to the ServiceBus Queue? Defaults to false."', args=[d.arg(name='listen', type=d.T.boolean)]),
      withListen(listen): { spec+: { forProvider+: { listen: listen } } },
      '#withManage':: d.fn(help='"Does this Authorization Rule have Manage permissions to the ServiceBus Queue? When this property is true - both listen and send must be too. Defaults to false."', args=[d.arg(name='manage', type=d.T.boolean)]),
      withManage(manage): { spec+: { forProvider+: { manage: manage } } },
      '#withQueueId':: d.fn(help='"Specifies the ID of the ServiceBus Queue. Changing this forces a new resource to be created."', args=[d.arg(name='queueId', type=d.T.string)]),
      withQueueId(queueId): { spec+: { forProvider+: { queueId: queueId } } },
      '#withSend':: d.fn(help='"Does this Authorization Rule have Send permissions to the ServiceBus Queue? Defaults to false."', args=[d.arg(name='send', type=d.T.boolean)]),
