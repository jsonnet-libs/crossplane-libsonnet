  ...
  spec: {
    ...
    forProvider: {
      ...
      customerManagedKey: {
        ...
        withInfrastructureEncryptionEnabled(infrastructureEncryptionEnabled): { infrastructureEncryptionEnabled: infrastructureEncryptionEnabled },
      ...
      networkRuleSet: {
        ...
        withNetworkRules(networkRules): { networkRules: if std.isArray(v=networkRules) then networkRules else [networkRules] },
        ...
        withNetworkRulesMixin(networkRules): { networkRules+: if std.isArray(v=networkRules) then networkRules else [networkRules] },
        ...
        withTrustedServicesAllowed(trustedServicesAllowed): { trustedServicesAllowed: trustedServicesAllowed },
      },
      ...
      '#withCustomerManagedKey':: d.fn(help='"An customer_managed_key block as defined below."', args=[d.arg(name='customerManagedKey', type=d.T.array)]),
      ...
      '#withNetworkRuleSet':: d.fn(help='"An network_rule_set block as defined below."', args=[d.arg(name='networkRuleSet', type=d.T.array)]),
