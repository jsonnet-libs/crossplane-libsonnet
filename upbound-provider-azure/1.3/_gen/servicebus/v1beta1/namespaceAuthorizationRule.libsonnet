{
  ...
  '#':: d.pkg(name='namespaceAuthorizationRule', url='', help='"NamespaceAuthorizationRule is the Schema for the NamespaceAuthorizationRules API. Manages a ServiceBus Namespace authorization Rule within a ServiceBus."'),
  ...
  '#new':: d.fn(help='new returns an instance of NamespaceAuthorizationRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NamespaceAuthorizationRuleSpec defines the desired state of NamespaceAuthorizationRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withListen':: d.fn(help='"Grants listen access to this this Authorization Rule. Defaults to false."', args=[d.arg(name='listen', type=d.T.boolean)]),
      withListen(listen): { spec+: { forProvider+: { listen: listen } } },
      '#withManage':: d.fn(help='"Grants manage access to this this Authorization Rule. When this property is true - both listen and send must be too. Defaults to false."', args=[d.arg(name='manage', type=d.T.boolean)]),
      withManage(manage): { spec+: { forProvider+: { manage: manage } } },
      '#withNamespaceId':: d.fn(help='"Specifies the ID of the ServiceBus Namespace. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceId', type=d.T.string)]),
      withNamespaceId(namespaceId): { spec+: { forProvider+: { namespaceId: namespaceId } } },
      '#withSend':: d.fn(help='"Grants send access to this this Authorization Rule. Defaults to false."', args=[d.arg(name='send', type=d.T.boolean)]),
