{
  ...
  '#':: d.pkg(name='topicAuthorizationRule', url='', help='"TopicAuthorizationRule is the Schema for the TopicAuthorizationRules API. Manages a ServiceBus Topic authorization Rule within a ServiceBus Topic."'),
  ...
  '#new':: d.fn(help='new returns an instance of TopicAuthorizationRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TopicAuthorizationRuleSpec defines the desired state of TopicAuthorizationRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withTopicId':: d.fn(help='"Specifies the ID of the ServiceBus Topic. Changing this forces a new resource to be created."', args=[d.arg(name='topicId', type=d.T.string)]),
