{
  ...
  '#':: d.pkg(name='pool', url='', help='"Pool is the Schema for the Pools API. Manages a Pool within a NetApp Account."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEncryptionType':: d.fn(help='"The encryption type of the pool. Valid values include Single, and Double. Defaults to Single. Changing this forces a new resource to be created."', args=[d.arg(name='encryptionType', type=d.T.string)]),
      ...
      '#withQosType':: d.fn(help='"QoS Type of the pool. Valid values include Auto or Manual."', args=[d.arg(name='qosType', type=d.T.string)]),
      withQosType(qosType): { spec+: { forProvider+: { qosType: qosType } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group where the NetApp Pool should be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServiceLevel':: d.fn(help='"The service level of the file system. Valid values include Premium, Standard, and Ultra. Changing this forces a new resource to be created."', args=[d.arg(name='serviceLevel', type=d.T.string)]),
      withServiceLevel(serviceLevel): { spec+: { forProvider+: { serviceLevel: serviceLevel } } },
      '#withSizeInTb':: d.fn(help='"Provisioned size of the pool in TB. Value must be between 2 and 500."', args=[d.arg(name='sizeInTb', type=d.T.number)]),
      withSizeInTb(sizeInTb): { spec+: { forProvider+: { sizeInTb: sizeInTb } } },
    ...
    initProvider: {
      ...
      '#withQosType':: d.fn(help='"QoS Type of the pool. Valid values include Auto or Manual."', args=[d.arg(name='qosType', type=d.T.string)]),
      withQosType(qosType): { spec+: { initProvider+: { qosType: qosType } } },
      '#withServiceLevel':: d.fn(help='"The service level of the file system. Valid values include Premium, Standard, and Ultra. Changing this forces a new resource to be created."', args=[d.arg(name='serviceLevel', type=d.T.string)]),
      withServiceLevel(serviceLevel): { spec+: { initProvider+: { serviceLevel: serviceLevel } } },
      '#withSizeInTb':: d.fn(help='"Provisioned size of the pool in TB. Value must be between 2 and 500."', args=[d.arg(name='sizeInTb', type=d.T.number)]),
      withSizeInTb(sizeInTb): { spec+: { initProvider+: { sizeInTb: sizeInTb } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
