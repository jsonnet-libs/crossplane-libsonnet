  ...
  spec: {
    ...
    forProvider: {
      ...
      activeDirectory: {
        ...
        '#withOrganizationalUnit':: d.fn(help='"The Organizational Unit (OU) within the Active Directory Domain."', args=[d.arg(name='organizationalUnit', type=d.T.string)]),
        ...
        withSmbServerName(smbServerName): { smbServerName: smbServerName },
      ...
      withActiveDirectory(activeDirectory): { spec+: { forProvider+: { activeDirectory: if std.isArray(v=activeDirectory) then activeDirectory else [activeDirectory] } } },
      ...
      withActiveDirectoryMixin(activeDirectory): { spec+: { forProvider+: { activeDirectory+: if std.isArray(v=activeDirectory) then activeDirectory else [activeDirectory] } } },
      '#withIdentity':: d.fn(help='"The identity block where it is used when customer managed keys based encryption will be enabled as defined below."', args=[d.arg(name='identity', type=d.T.array)]),
      withIdentity(identity): { spec+: { forProvider+: { identity: if std.isArray(v=identity) then identity else [identity] } } },
      '#withIdentityMixin':: d.fn(help='"The identity block where it is used when customer managed keys based encryption will be enabled as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identity', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withActiveDirectory':: d.fn(help='"A active_directory block as defined below."', args=[d.arg(name='activeDirectory', type=d.T.array)]),
      withActiveDirectory(activeDirectory): { spec+: { initProvider+: { activeDirectory: if std.isArray(v=activeDirectory) then activeDirectory else [activeDirectory] } } },
      '#withActiveDirectoryMixin':: d.fn(help='"A active_directory block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='activeDirectory', type=d.T.array)]),
      withActiveDirectoryMixin(activeDirectory): { spec+: { initProvider+: { activeDirectory+: if std.isArray(v=activeDirectory) then activeDirectory else [activeDirectory] } } },
      '#withIdentity':: d.fn(help='"The identity block where it is used when customer managed keys based encryption will be enabled as defined below."', args=[d.arg(name='identity', type=d.T.array)]),
