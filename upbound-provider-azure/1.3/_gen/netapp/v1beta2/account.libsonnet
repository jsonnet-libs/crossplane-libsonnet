    ...
    forProvider: {
      ...
      activeDirectory: {
        ...
        passwordSecretRef: {
          ...
          withNamespace(namespace): { spec+: { forProvider+: { activeDirectory+: { passwordSecretRef+: { namespace: namespace } } } } },
        },
    ...
    initProvider: {
      ...
      activeDirectory: {
        ...
        passwordSecretRef: {
          ...
          '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { spec+: { initProvider+: { activeDirectory+: { passwordSecretRef+: { namespace: namespace } } } } },
        },
        '#withDnsServers':: d.fn(help='"A list of DNS server IP addresses for the Active Directory domain. Only allows IPv4 address."', args=[d.arg(name='dnsServers', type=d.T.array)]),
