{
  ...
  '#':: d.pkg(name='pipeline', url='', help='"Pipeline is the Schema for the Pipelines API. Manages a Pipeline inside a Azure Data Factory."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withActivitiesJson':: d.fn(help='"A JSON object that contains the activities that will be associated with the Data Factory Pipeline."', args=[d.arg(name='activitiesJson', type=d.T.string)]),
      withActivitiesJson(activitiesJson): { spec+: { forProvider+: { activitiesJson: activitiesJson } } },
      '#withAnnotations':: d.fn(help='"List of tags that can be used for describing the Data Factory Pipeline."', args=[d.arg(name='annotations', type=d.T.array)]),
      withAnnotations(annotations): { spec+: { forProvider+: { annotations: if std.isArray(v=annotations) then annotations else [annotations] } } },
      '#withAnnotationsMixin':: d.fn(help='"List of tags that can be used for describing the Data Factory Pipeline."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.array)]),
      ...
      '#withConcurrency':: d.fn(help='"The max number of concurrent runs for the Data Factory Pipeline. Must be between 1 and 50."', args=[d.arg(name='concurrency', type=d.T.number)]),
      ...
      '#withDescription':: d.fn(help='"The description for the Data Factory Pipeline."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFolder':: d.fn(help='"The folder that this Pipeline is in. If not specified, the Pipeline will appear at the root level."', args=[d.arg(name='folder', type=d.T.string)]),
      withFolder(folder): { spec+: { forProvider+: { folder: folder } } },
      '#withMoniterMetricsAfterDuration':: d.fn(help='"The TimeSpan value after which an Azure Monitoring Metric is fired."', args=[d.arg(name='moniterMetricsAfterDuration', type=d.T.string)]),
      withMoniterMetricsAfterDuration(moniterMetricsAfterDuration): { spec+: { forProvider+: { moniterMetricsAfterDuration: moniterMetricsAfterDuration } } },
      '#withParameters':: d.fn(help='"A map of parameters to associate with the Data Factory Pipeline."', args=[d.arg(name='parameters', type=d.T.object)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: parameters } } },
      '#withParametersMixin':: d.fn(help='"A map of parameters to associate with the Data Factory Pipeline."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.object)]),
      withParametersMixin(parameters): { spec+: { forProvider+: { parameters+: parameters } } },
      '#withVariables':: d.fn(help='"A map of variables to associate with the Data Factory Pipeline."', args=[d.arg(name='variables', type=d.T.object)]),
      withVariables(variables): { spec+: { forProvider+: { variables: variables } } },
      '#withVariablesMixin':: d.fn(help='"A map of variables to associate with the Data Factory Pipeline."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.object)]),
    ...
    initProvider: {
      '#withActivitiesJson':: d.fn(help='"A JSON object that contains the activities that will be associated with the Data Factory Pipeline."', args=[d.arg(name='activitiesJson', type=d.T.string)]),
      withActivitiesJson(activitiesJson): { spec+: { initProvider+: { activitiesJson: activitiesJson } } },
      '#withAnnotations':: d.fn(help='"List of tags that can be used for describing the Data Factory Pipeline."', args=[d.arg(name='annotations', type=d.T.array)]),
      ...
      '#withMoniterMetricsAfterDuration':: d.fn(help='"The TimeSpan value after which an Azure Monitoring Metric is fired."', args=[d.arg(name='moniterMetricsAfterDuration', type=d.T.string)]),
      withMoniterMetricsAfterDuration(moniterMetricsAfterDuration): { spec+: { initProvider+: { moniterMetricsAfterDuration: moniterMetricsAfterDuration } } },
      '#withParameters':: d.fn(help='"A map of parameters to associate with the Data Factory Pipeline."', args=[d.arg(name='parameters', type=d.T.object)]),
