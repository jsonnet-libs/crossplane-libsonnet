{
  ...
  '#':: d.pkg(name='integrationRuntimeAzure', url='', help='"IntegrationRuntimeAzure is the Schema for the IntegrationRuntimeAzures API. Manages a Data Factory Azure Integration Runtime."'),
  ...
  '#new':: d.fn(help='new returns an instance of IntegrationRuntimeAzure', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IntegrationRuntimeAzureSpec defines the desired state of IntegrationRuntimeAzure"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCleanupEnabled':: d.fn(help='"Cluster will not be recycled and it will be used in next data flow activity run until TTL (time to live) is reached if this is set as false. Default is true."', args=[d.arg(name='cleanupEnabled', type=d.T.boolean)]),
      withCleanupEnabled(cleanupEnabled): { spec+: { forProvider+: { cleanupEnabled: cleanupEnabled } } },
      '#withComputeType':: d.fn(help='"Compute type of the cluster which will execute data flow job. Valid values are General, ComputeOptimized and MemoryOptimized. Defaults to General."', args=[d.arg(name='computeType', type=d.T.string)]),
      withComputeType(computeType): { spec+: { forProvider+: { computeType: computeType } } },
      '#withCoreCount':: d.fn(help='"Core count of the cluster which will execute data flow job. Valid values are 8, 16, 32, 48, 80, 144 and 272. Defaults to 8."', args=[d.arg(name='coreCount', type=d.T.number)]),
      withCoreCount(coreCount): { spec+: { forProvider+: { coreCount: coreCount } } },
      ...
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Use AutoResolve to create an auto-resolve integration runtime. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withTimeToLiveMin':: d.fn(help='"Time to live (in minutes) setting of the cluster which will execute data flow job. Defaults to 0."', args=[d.arg(name='timeToLiveMin', type=d.T.number)]),
      withTimeToLiveMin(timeToLiveMin): { spec+: { forProvider+: { timeToLiveMin: timeToLiveMin } } },
      '#withVirtualNetworkEnabled':: d.fn(help='"Is Integration Runtime compute provisioned within Managed Virtual Network? Changing this forces a new resource to be created."', args=[d.arg(name='virtualNetworkEnabled', type=d.T.boolean)]),
      withVirtualNetworkEnabled(virtualNetworkEnabled): { spec+: { forProvider+: { virtualNetworkEnabled: virtualNetworkEnabled } } },
    },
    ...
    initProvider: {
      '#withCleanupEnabled':: d.fn(help='"Cluster will not be recycled and it will be used in next data flow activity run until TTL (time to live) is reached if this is set as false. Default is true."', args=[d.arg(name='cleanupEnabled', type=d.T.boolean)]),
      withCleanupEnabled(cleanupEnabled): { spec+: { initProvider+: { cleanupEnabled: cleanupEnabled } } },
      '#withComputeType':: d.fn(help='"Compute type of the cluster which will execute data flow job. Valid values are General, ComputeOptimized and MemoryOptimized. Defaults to General."', args=[d.arg(name='computeType', type=d.T.string)]),
      withComputeType(computeType): { spec+: { initProvider+: { computeType: computeType } } },
      '#withCoreCount':: d.fn(help='"Core count of the cluster which will execute data flow job. Valid values are 8, 16, 32, 48, 80, 144 and 272. Defaults to 8."', args=[d.arg(name='coreCount', type=d.T.number)]),
      withCoreCount(coreCount): { spec+: { initProvider+: { coreCount: coreCount } } },
      '#withDescription':: d.fn(help='"Integration runtime description."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withTimeToLiveMin':: d.fn(help='"Time to live (in minutes) setting of the cluster which will execute data flow job. Defaults to 0."', args=[d.arg(name='timeToLiveMin', type=d.T.number)]),
      withTimeToLiveMin(timeToLiveMin): { spec+: { initProvider+: { timeToLiveMin: timeToLiveMin } } },
      '#withVirtualNetworkEnabled':: d.fn(help='"Is Integration Runtime compute provisioned within Managed Virtual Network? Changing this forces a new resource to be created."', args=[d.arg(name='virtualNetworkEnabled', type=d.T.boolean)]),
      withVirtualNetworkEnabled(virtualNetworkEnabled): { spec+: { initProvider+: { virtualNetworkEnabled: virtualNetworkEnabled } } },
    },
