{
  ...
  '#':: d.pkg(name='linkedServicePostgreSQL', url='', help='"LinkedServicePostgreSQL is the Schema for the LinkedServicePostgreSQLs API. Manages a Linked Service (connection) between PostgreSQL and Azure Data Factory."'),
  ...
  '#new':: d.fn(help='new returns an instance of LinkedServicePostgreSQL', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LinkedServicePostgreSQLSpec defines the desired state of LinkedServicePostgreSQL"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAdditionalProperties':: d.fn(help='"A map of additional properties to associate with the Data Factory Linked Service PostgreSQL."', args=[d.arg(name='additionalProperties', type=d.T.object)]),
      withAdditionalProperties(additionalProperties): { spec+: { forProvider+: { additionalProperties: additionalProperties } } },
      '#withAdditionalPropertiesMixin':: d.fn(help='"A map of additional properties to associate with the Data Factory Linked Service PostgreSQL."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalProperties', type=d.T.object)]),
      withAdditionalPropertiesMixin(additionalProperties): { spec+: { forProvider+: { additionalProperties+: additionalProperties } } },
      '#withAnnotations':: d.fn(help='"List of tags that can be used for describing the Data Factory Linked Service PostgreSQL."', args=[d.arg(name='annotations', type=d.T.array)]),
      withAnnotations(annotations): { spec+: { forProvider+: { annotations: if std.isArray(v=annotations) then annotations else [annotations] } } },
      '#withAnnotationsMixin':: d.fn(help='"List of tags that can be used for describing the Data Factory Linked Service PostgreSQL."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.array)]),
      ...
      '#withConnectionString':: d.fn(help='"The connection string in which to authenticate with PostgreSQL."', args=[d.arg(name='connectionString', type=d.T.string)]),
      ...
      '#withDescription':: d.fn(help='"The description for the Data Factory Linked Service PostgreSQL."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIntegrationRuntimeName':: d.fn(help='"The integration runtime reference to associate with the Data Factory Linked Service PostgreSQL."', args=[d.arg(name='integrationRuntimeName', type=d.T.string)]),
      withIntegrationRuntimeName(integrationRuntimeName): { spec+: { forProvider+: { integrationRuntimeName: integrationRuntimeName } } },
      '#withParameters':: d.fn(help='"A map of parameters to associate with the Data Factory Linked Service PostgreSQL."', args=[d.arg(name='parameters', type=d.T.object)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: parameters } } },
      '#withParametersMixin':: d.fn(help='"A map of parameters to associate with the Data Factory Linked Service PostgreSQL."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.object)]),
