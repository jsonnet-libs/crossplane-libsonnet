{
  ...
  '#':: d.pkg(name='linkedServiceAzureTableStorage', url='', help='"LinkedServiceAzureTableStorage is the Schema for the LinkedServiceAzureTableStorages API. Manages a Linked Service (connection) between an Azure Table Storage and Azure Data Factory."'),
  ...
  '#new':: d.fn(help='new returns an instance of LinkedServiceAzureTableStorage', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LinkedServiceAzureTableStorageSpec defines the desired state of LinkedServiceAzureTableStorage"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#connectionStringSecretRef':: d.obj(help='"The connection string to an Azure Storage Account."'),
