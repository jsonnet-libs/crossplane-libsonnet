{
  ...
  '#':: d.pkg(name='integrationRuntimeSelfHosted', url='', help='"IntegrationRuntimeSelfHosted is the Schema for the IntegrationRuntimeSelfHosteds API. Manages a Data Factory Self-hosted Integration Runtime."'),
  ...
  '#new':: d.fn(help='new returns an instance of IntegrationRuntimeSelfHosted', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IntegrationRuntimeSelfHostedSpec defines the desired state of IntegrationRuntimeSelfHosted"'),
  spec: {
    ...
    forProvider: {
      ...
      '#rbacAuthorization':: d.obj(help='"A rbac_authorization block as defined below. Changing this forces a new resource to be created."'),
      rbacAuthorization: {
        '#withResourceId':: d.fn(help='"The resource identifier of the integration runtime to be shared."', args=[d.arg(name='resourceId', type=d.T.string)]),
      ...
      '#withRbacAuthorization':: d.fn(help='"A rbac_authorization block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='rbacAuthorization', type=d.T.array)]),
      withRbacAuthorization(rbacAuthorization): { spec+: { forProvider+: { rbacAuthorization: if std.isArray(v=rbacAuthorization) then rbacAuthorization else [rbacAuthorization] } } },
      '#withRbacAuthorizationMixin':: d.fn(help='"A rbac_authorization block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rbacAuthorization', type=d.T.array)]),
      withRbacAuthorizationMixin(rbacAuthorization): { spec+: { forProvider+: { rbacAuthorization+: if std.isArray(v=rbacAuthorization) then rbacAuthorization else [rbacAuthorization] } } },
    },
    ...
    initProvider: {
      ...
      '#withRbacAuthorization':: d.fn(help='"A rbac_authorization block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='rbacAuthorization', type=d.T.array)]),
      withRbacAuthorization(rbacAuthorization): { spec+: { initProvider+: { rbacAuthorization: if std.isArray(v=rbacAuthorization) then rbacAuthorization else [rbacAuthorization] } } },
      '#withRbacAuthorizationMixin':: d.fn(help='"A rbac_authorization block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rbacAuthorization', type=d.T.array)]),
      withRbacAuthorizationMixin(rbacAuthorization): { spec+: { initProvider+: { rbacAuthorization+: if std.isArray(v=rbacAuthorization) then rbacAuthorization else [rbacAuthorization] } } },
    },
