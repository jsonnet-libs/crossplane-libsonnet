{
  ...
  '#':: d.pkg(name='globalVMShutdownSchedule', url='', help='"GlobalVMShutdownSchedule is the Schema for the GlobalVMShutdownSchedules API. Manages automated shutdown schedules for Azure Resource Manager VMs outside of Dev Test Labs."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalVMShutdownSchedule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GlobalVMShutdownScheduleSpec defines the desired state of GlobalVMShutdownSchedule"'),
  spec: {
    ...
    forProvider: {
      ...
      notificationSettings: {
        '#withEmail':: d.fn(help='"E-mail address to which the notification will be sent."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { email: email },
        '#withEnabled':: d.fn(help='"Whether to enable pre-shutdown notifications. Possible values are true and false."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { enabled: enabled },
        '#withTimeInMinutes':: d.fn(help='"Time in minutes between 15 and 120 before a shutdown event at which a notification will be sent. Defaults to 30."', args=[d.arg(name='timeInMinutes', type=d.T.number)]),
      ...
      '#withDailyRecurrenceTime':: d.fn(help='"The time each day when the schedule takes effect. Must match the format HHmm where HH is 00-23 and mm is 00-59 (e.g. 0930, 2300, etc.)"', args=[d.arg(name='dailyRecurrenceTime', type=d.T.string)]),
      withDailyRecurrenceTime(dailyRecurrenceTime): { spec+: { forProvider+: { dailyRecurrenceTime: dailyRecurrenceTime } } },
      '#withEnabled':: d.fn(help='"Whether to enable the schedule. Possible values are true and false. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withTimezone':: d.fn(help='"The time zone ID (e.g. Pacific Standard time). Refer to this guide for a full list of accepted time zone names."', args=[d.arg(name='timezone', type=d.T.string)]),
      withTimezone(timezone): { spec+: { forProvider+: { timezone: timezone } } },
      '#withVirtualMachineId':: d.fn(help='"The resource ID of the target ARM-based Virtual Machine. Changing this forces a new resource to be created."', args=[d.arg(name='virtualMachineId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDailyRecurrenceTime':: d.fn(help='"The time each day when the schedule takes effect. Must match the format HHmm where HH is 00-23 and mm is 00-59 (e.g. 0930, 2300, etc.)"', args=[d.arg(name='dailyRecurrenceTime', type=d.T.string)]),
      withDailyRecurrenceTime(dailyRecurrenceTime): { spec+: { initProvider+: { dailyRecurrenceTime: dailyRecurrenceTime } } },
      '#withEnabled':: d.fn(help='"Whether to enable the schedule. Possible values are true and false. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
