{
  ...
  '#':: d.pkg(name='policy', url='', help='"Policy is the Schema for the Policys API. Manages a Policy within a Dev Test Policy Set."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEvaluatorType':: d.fn(help="\"The Evaluation Type used for this Policy. Possible values include: 'AllowedValuesPolicy', 'MaxValuePolicy'. Changing this forces a new resource to be created.\"", args=[d.arg(name='evaluatorType', type=d.T.string)]),
      withEvaluatorType(evaluatorType): { spec+: { forProvider+: { evaluatorType: evaluatorType } } },
      '#withFactData':: d.fn(help='"The Fact Data for this Policy."', args=[d.arg(name='factData', type=d.T.string)]),
      withFactData(factData): { spec+: { forProvider+: { factData: factData } } },
      '#withLabName':: d.fn(help='"Specifies the name of the Dev Test Lab in which the Policy should be created. Changing this forces a new resource to be created."', args=[d.arg(name='labName', type=d.T.string)]),
      withLabName(labName): { spec+: { forProvider+: { labName: labName } } },
      '#withName':: d.fn(help='"Specifies the name of the Dev Test Policy. Possible values are GalleryImage, LabPremiumVmCount, LabTargetCost, LabVmCount, LabVmSize, UserOwnedLabPremiumVmCount, UserOwnedLabVmCount and UserOwnedLabVmCountInSubnet. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPolicySetName':: d.fn(help='"Specifies the name of the Policy Set within the Dev Test Lab where this policy should be created. Changing this forces a new resource to be created."', args=[d.arg(name='policySetName', type=d.T.string)]),
      withPolicySetName(policySetName): { spec+: { forProvider+: { policySetName: policySetName } } },
      ...
      '#withThreshold':: d.fn(help='"The Threshold for this Policy."', args=[d.arg(name='threshold', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withEvaluatorType':: d.fn(help="\"The Evaluation Type used for this Policy. Possible values include: 'AllowedValuesPolicy', 'MaxValuePolicy'. Changing this forces a new resource to be created.\"", args=[d.arg(name='evaluatorType', type=d.T.string)]),
      withEvaluatorType(evaluatorType): { spec+: { initProvider+: { evaluatorType: evaluatorType } } },
      '#withFactData':: d.fn(help='"The Fact Data for this Policy."', args=[d.arg(name='factData', type=d.T.string)]),
      withFactData(factData): { spec+: { initProvider+: { factData: factData } } },
      '#withLabName':: d.fn(help='"Specifies the name of the Dev Test Lab in which the Policy should be created. Changing this forces a new resource to be created."', args=[d.arg(name='labName', type=d.T.string)]),
      withLabName(labName): { spec+: { initProvider+: { labName: labName } } },
      '#withName':: d.fn(help='"Specifies the name of the Dev Test Policy. Possible values are GalleryImage, LabPremiumVmCount, LabTargetCost, LabVmCount, LabVmSize, UserOwnedLabPremiumVmCount, UserOwnedLabVmCount and UserOwnedLabVmCountInSubnet. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withPolicySetName':: d.fn(help='"Specifies the name of the Policy Set within the Dev Test Lab where this policy should be created. Changing this forces a new resource to be created."', args=[d.arg(name='policySetName', type=d.T.string)]),
      withPolicySetName(policySetName): { spec+: { initProvider+: { policySetName: policySetName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Dev Test Lab resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
