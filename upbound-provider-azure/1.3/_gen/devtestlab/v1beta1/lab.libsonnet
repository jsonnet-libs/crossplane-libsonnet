{
  ...
  '#':: d.pkg(name='lab', url='', help='"Lab is the Schema for the Labs API. Manages a Dev Test Lab."'),
  ...
  '#new':: d.fn(help='new returns an instance of Lab', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LabSpec defines the desired state of Lab"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Dev Test Lab should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the Dev Test Lab resource has to be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withStorageType':: d.fn(help='"The type of storage used by the Dev Test Lab. Possible values are Standard and Premium. Defaults to Premium."', args=[d.arg(name='storageType', type=d.T.string)]),
