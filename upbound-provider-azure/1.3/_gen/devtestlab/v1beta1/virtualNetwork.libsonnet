{
  ...
  '#':: d.pkg(name='virtualNetwork', url='', help='"VirtualNetwork is the Schema for the VirtualNetworks API. Manages a Virtual Network within a DevTest Lab."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#subnet':: d.obj(help='"A subnet block as defined below."'),
      subnet: {
        '#withUseInVirtualMachineCreation':: d.fn(help='"Can this subnet be used for creating Virtual Machines? Possible values are Allow, Default and Deny. Defaults to Allow."', args=[d.arg(name='useInVirtualMachineCreation', type=d.T.string)]),
        withUseInVirtualMachineCreation(useInVirtualMachineCreation): { useInVirtualMachineCreation: useInVirtualMachineCreation },
        '#withUsePublicIpAddress':: d.fn(help='"Can Virtual Machines in this Subnet use Public IP Addresses? Possible values are Allow, Default and Deny. Defaults to Allow."', args=[d.arg(name='usePublicIpAddress', type=d.T.string)]),
        withUsePublicIpAddress(usePublicIpAddress): { usePublicIpAddress: usePublicIpAddress },
      },
      '#withDescription':: d.fn(help='"A description for the Virtual Network."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLabName':: d.fn(help='"Specifies the name of the Dev Test Lab in which the Virtual Network should be created. Changing this forces a new resource to be created."', args=[d.arg(name='labName', type=d.T.string)]),
      withLabName(labName): { spec+: { forProvider+: { labName: labName } } },
      '#withName':: d.fn(help='"Specifies the name of the Dev Test Virtual Network. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
