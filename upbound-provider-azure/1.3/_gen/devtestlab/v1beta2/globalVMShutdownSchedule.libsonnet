  ...
  spec: {
    ...
    forProvider: {
      ...
      notificationSettings: {
        ...
        withEmail(email): { spec+: { forProvider+: { notificationSettings+: { email: email } } } },
        ...
        withEnabled(enabled): { spec+: { forProvider+: { notificationSettings+: { enabled: enabled } } } },
        ...
        withTimeInMinutes(timeInMinutes): { spec+: { forProvider+: { notificationSettings+: { timeInMinutes: timeInMinutes } } } },
        ...
        withWebhookUrl(webhookUrl): { spec+: { forProvider+: { notificationSettings+: { webhookUrl: webhookUrl } } } },
      },
    ...
    initProvider: {
      ...
      notificationSettings: {
        '#withEmail':: d.fn(help='"E-mail address to which the notification will be sent."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { spec+: { initProvider+: { notificationSettings+: { email: email } } } },
        '#withEnabled':: d.fn(help='"Whether to enable pre-shutdown notifications. Possible values are true and false."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { initProvider+: { notificationSettings+: { enabled: enabled } } } },
        '#withTimeInMinutes':: d.fn(help='"Time in minutes between 15 and 120 before a shutdown event at which a notification will be sent. Defaults to 30."', args=[d.arg(name='timeInMinutes', type=d.T.number)]),
        withTimeInMinutes(timeInMinutes): { spec+: { initProvider+: { notificationSettings+: { timeInMinutes: timeInMinutes } } } },
        '#withWebhookUrl':: d.fn(help='"The webhook URL to which the notification will be sent."', args=[d.arg(name='webhookUrl', type=d.T.string)]),
        withWebhookUrl(webhookUrl): { spec+: { initProvider+: { notificationSettings+: { webhookUrl: webhookUrl } } } },
      },
      '#virtualMachineIdRef':: d.obj(help='"Reference to a LinuxVirtualMachine in compute to populate virtualMachineId."'),
      virtualMachineIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
