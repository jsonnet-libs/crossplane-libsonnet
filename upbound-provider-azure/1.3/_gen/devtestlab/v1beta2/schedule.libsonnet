  ...
  spec: {
    ...
    forProvider: {
      ...
      dailyRecurrence: {
        ...
        withTime(time): { spec+: { forProvider+: { dailyRecurrence+: { time: time } } } },
      },
      ...
      hourlyRecurrence: {
        ...
        withMinute(minute): { spec+: { forProvider+: { hourlyRecurrence+: { minute: minute } } } },
      },
      ...
      weeklyRecurrence: {
        ...
        withTime(time): { spec+: { forProvider+: { weeklyRecurrence+: { time: time } } } },
        ...
        withWeekDays(weekDays): { spec+: { forProvider+: { weeklyRecurrence+: { weekDays: if std.isArray(v=weekDays) then weekDays else [weekDays] } } } },
        ...
        withWeekDaysMixin(weekDays): { spec+: { forProvider+: { weeklyRecurrence+: { weekDays+: if std.isArray(v=weekDays) then weekDays else [weekDays] } } } },
      },
    ...
    initProvider: {
      ...
      dailyRecurrence: {
        '#withTime':: d.fn(help='"The time each day when the schedule takes effect."', args=[d.arg(name='time', type=d.T.string)]),
        withTime(time): { spec+: { initProvider+: { dailyRecurrence+: { time: time } } } },
      },
      '#hourlyRecurrence':: d.obj(help='"The properties of an hourly schedule. If the schedule occurs multiple times a day, specify the hourly recurrence. A hourly_recurrence block as defined below."'),
      hourlyRecurrence: {
        '#withMinute':: d.fn(help='"Minutes of the hour the schedule will run."', args=[d.arg(name='minute', type=d.T.number)]),
        withMinute(minute): { spec+: { initProvider+: { hourlyRecurrence+: { minute: minute } } } },
      },
      '#notificationSettings':: d.obj(help='"The notification setting of a schedule. A notification_settings block as defined below."'),
      notificationSettings: {
        '#withTimeInMinutes':: d.fn(help='"Time in minutes before event at which notification will be sent."', args=[d.arg(name='timeInMinutes', type=d.T.number)]),
      ...
      weeklyRecurrence: {
        '#withTime':: d.fn(help='"The time when the schedule takes effect."', args=[d.arg(name='time', type=d.T.string)]),
        withTime(time): { spec+: { initProvider+: { weeklyRecurrence+: { time: time } } } },
        '#withWeekDays':: d.fn(help='"A list of days that this schedule takes effect . Possible values include Monday, Tuesday, Wednesday, Thursday, Friday, Saturday and Sunday."', args=[d.arg(name='weekDays', type=d.T.array)]),
        withWeekDays(weekDays): { spec+: { initProvider+: { weeklyRecurrence+: { weekDays: if std.isArray(v=weekDays) then weekDays else [weekDays] } } } },
        '#withWeekDaysMixin':: d.fn(help='"A list of days that this schedule takes effect . Possible values include Monday, Tuesday, Wednesday, Thursday, Friday, Saturday and Sunday."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='weekDays', type=d.T.array)]),
        withWeekDaysMixin(weekDays): { spec+: { initProvider+: { weeklyRecurrence+: { weekDays+: if std.isArray(v=weekDays) then weekDays else [weekDays] } } } },
      },
      '#withLocation':: d.fn(help='"The location where the schedule is created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
