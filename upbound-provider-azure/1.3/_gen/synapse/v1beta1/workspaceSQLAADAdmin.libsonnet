{
  ...
  '#':: d.pkg(name='workspaceSQLAADAdmin', url='', help='"WorkspaceSQLAADAdmin is the Schema for the WorkspaceSQLAADAdmins API. Manages Synapse Workspace AAD Admin"'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkspaceSQLAADAdmin', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkspaceSQLAADAdminSpec defines the desired state of WorkspaceSQLAADAdmin"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSynapseWorkspaceId':: d.fn(help='"The ID of the Synapse Workspace where the Azure AD Administrator should be configured."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
