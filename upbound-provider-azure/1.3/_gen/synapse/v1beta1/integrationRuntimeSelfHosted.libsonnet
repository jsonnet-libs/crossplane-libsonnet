{
  ...
  '#':: d.pkg(name='integrationRuntimeSelfHosted', url='', help='"IntegrationRuntimeSelfHosted is the Schema for the IntegrationRuntimeSelfHosteds API. Manages a Synapse Self-hosted Integration Runtime."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSynapseWorkspaceId':: d.fn(help='"The Synapse Workspace ID in which to associate the Integration Runtime with. Changing this forces a new Synapse Self-hosted Integration Runtime to be created."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
