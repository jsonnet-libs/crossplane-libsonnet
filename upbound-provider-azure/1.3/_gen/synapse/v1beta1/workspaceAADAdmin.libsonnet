{
  ...
  '#':: d.pkg(name='workspaceAADAdmin', url='', help='"WorkspaceAADAdmin is the Schema for the WorkspaceAADAdmins API. Manages Synapse Workspace AAD Admin"'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkspaceAADAdmin', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkspaceAADAdminSpec defines the desired state of WorkspaceAADAdmin"'),
  spec: {
