{
  ...
  '#':: d.pkg(name='sqlPoolWorkloadGroup', url='', help='"SQLPoolWorkloadGroup is the Schema for the SQLPoolWorkloadGroups API. Manages a Synapse SQL Pool Workload Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLPoolWorkloadGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLPoolWorkloadGroupSpec defines the desired state of SQLPoolWorkloadGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withImportance':: d.fn(help='"The workload group importance level. Defaults to normal."', args=[d.arg(name='importance', type=d.T.string)]),
      withImportance(importance): { spec+: { forProvider+: { importance: importance } } },
      '#withMaxResourcePercent':: d.fn(help='"The workload group cap percentage resource."', args=[d.arg(name='maxResourcePercent', type=d.T.number)]),
      withMaxResourcePercent(maxResourcePercent): { spec+: { forProvider+: { maxResourcePercent: maxResourcePercent } } },
      '#withMaxResourcePercentPerRequest':: d.fn(help='"The workload group request maximum grant percentage. Defaults to 3."', args=[d.arg(name='maxResourcePercentPerRequest', type=d.T.number)]),
      withMaxResourcePercentPerRequest(maxResourcePercentPerRequest): { spec+: { forProvider+: { maxResourcePercentPerRequest: maxResourcePercentPerRequest } } },
      '#withMinResourcePercent':: d.fn(help='"The workload group minimum percentage resource."', args=[d.arg(name='minResourcePercent', type=d.T.number)]),
      withMinResourcePercent(minResourcePercent): { spec+: { forProvider+: { minResourcePercent: minResourcePercent } } },
      '#withMinResourcePercentPerRequest':: d.fn(help='"The workload group request minimum grant percentage."', args=[d.arg(name='minResourcePercentPerRequest', type=d.T.number)]),
      withMinResourcePercentPerRequest(minResourcePercentPerRequest): { spec+: { forProvider+: { minResourcePercentPerRequest: minResourcePercentPerRequest } } },
      '#withQueryExecutionTimeoutInSeconds':: d.fn(help='"The workload group query execution timeout."', args=[d.arg(name='queryExecutionTimeoutInSeconds', type=d.T.number)]),
      withQueryExecutionTimeoutInSeconds(queryExecutionTimeoutInSeconds): { spec+: { forProvider+: { queryExecutionTimeoutInSeconds: queryExecutionTimeoutInSeconds } } },
      '#withSqlPoolId':: d.fn(help='"The ID of the Synapse SQL Pool. Changing this forces a new Synapse SQL Pool Workload Group to be created."', args=[d.arg(name='sqlPoolId', type=d.T.string)]),
    ...
    initProvider: {
      '#withImportance':: d.fn(help='"The workload group importance level. Defaults to normal."', args=[d.arg(name='importance', type=d.T.string)]),
      withImportance(importance): { spec+: { initProvider+: { importance: importance } } },
      '#withMaxResourcePercent':: d.fn(help='"The workload group cap percentage resource."', args=[d.arg(name='maxResourcePercent', type=d.T.number)]),
      withMaxResourcePercent(maxResourcePercent): { spec+: { initProvider+: { maxResourcePercent: maxResourcePercent } } },
      '#withMaxResourcePercentPerRequest':: d.fn(help='"The workload group request maximum grant percentage. Defaults to 3."', args=[d.arg(name='maxResourcePercentPerRequest', type=d.T.number)]),
      withMaxResourcePercentPerRequest(maxResourcePercentPerRequest): { spec+: { initProvider+: { maxResourcePercentPerRequest: maxResourcePercentPerRequest } } },
      '#withMinResourcePercent':: d.fn(help='"The workload group minimum percentage resource."', args=[d.arg(name='minResourcePercent', type=d.T.number)]),
      withMinResourcePercent(minResourcePercent): { spec+: { initProvider+: { minResourcePercent: minResourcePercent } } },
      '#withMinResourcePercentPerRequest':: d.fn(help='"The workload group request minimum grant percentage."', args=[d.arg(name='minResourcePercentPerRequest', type=d.T.number)]),
      withMinResourcePercentPerRequest(minResourcePercentPerRequest): { spec+: { initProvider+: { minResourcePercentPerRequest: minResourcePercentPerRequest } } },
      '#withQueryExecutionTimeoutInSeconds':: d.fn(help='"The workload group query execution timeout."', args=[d.arg(name='queryExecutionTimeoutInSeconds', type=d.T.number)]),
      withQueryExecutionTimeoutInSeconds(queryExecutionTimeoutInSeconds): { spec+: { initProvider+: { queryExecutionTimeoutInSeconds: queryExecutionTimeoutInSeconds } } },
    },
