{
  ...
  '#':: d.pkg(name='workspaceExtendedAuditingPolicy', url='', help='"WorkspaceExtendedAuditingPolicy is the Schema for the WorkspaceExtendedAuditingPolicys API. Manages a Synapse Workspace Extended Auditing Policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkspaceExtendedAuditingPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkspaceExtendedAuditingPolicySpec defines the desired state of WorkspaceExtendedAuditingPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSynapseWorkspaceId':: d.fn(help='"The ID of the Synapse workspace to set the extended auditing policy. Changing this forces a new resource to be created."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
