{
  ...
  '#':: d.pkg(name='sqlPoolWorkloadClassifier', url='', help='"SQLPoolWorkloadClassifier is the Schema for the SQLPoolWorkloadClassifiers API. Manages a Synapse SQL Pool Workload Classifier."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLPoolWorkloadClassifier', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLPoolWorkloadClassifierSpec defines the desired state of SQLPoolWorkloadClassifier"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withContext':: d.fn(help='"Specifies the session context value that a request can be classified against."', args=[d.arg(name='context', type=d.T.string)]),
      withContext(context): { spec+: { forProvider+: { context: context } } },
      '#withEndTime':: d.fn(help="\"The workload classifier end time for classification. It's of the HH:MM format in UTC time zone.\"", args=[d.arg(name='endTime', type=d.T.string)]),
      withEndTime(endTime): { spec+: { forProvider+: { endTime: endTime } } },
      '#withImportance':: d.fn(help='"The workload classifier importance. The allowed values are low, below_normal, normal, above_normal and high."', args=[d.arg(name='importance', type=d.T.string)]),
      withImportance(importance): { spec+: { forProvider+: { importance: importance } } },
      '#withLabel':: d.fn(help='"Specifies the label value that a request can be classified against."', args=[d.arg(name='label', type=d.T.string)]),
      withLabel(label): { spec+: { forProvider+: { label: label } } },
      '#withMemberName':: d.fn(help='"The workload classifier member name used to classified against."', args=[d.arg(name='memberName', type=d.T.string)]),
      withMemberName(memberName): { spec+: { forProvider+: { memberName: memberName } } },
      '#withStartTime':: d.fn(help="\"The workload classifier start time for classification. It's of the HH:MM format in UTC time zone.\"", args=[d.arg(name='startTime', type=d.T.string)]),
      withStartTime(startTime): { spec+: { forProvider+: { startTime: startTime } } },
      '#withWorkloadGroupId':: d.fn(help='"The ID of the Synapse SQL Pool Workload Group. Changing this forces a new Synapse SQL Pool Workload Classifier to be created."', args=[d.arg(name='workloadGroupId', type=d.T.string)]),
      withWorkloadGroupId(workloadGroupId): { spec+: { forProvider+: { workloadGroupId: workloadGroupId } } },
      '#workloadGroupIdRef':: d.obj(help='"Reference to a SQLPoolWorkloadGroup in synapse to populate workloadGroupId."'),
      workloadGroupIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { workloadGroupIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { workloadGroupIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { workloadGroupIdRef+: { name: name } } } },
      },
      '#workloadGroupIdSelector':: d.obj(help='"Selector for a SQLPoolWorkloadGroup in synapse to populate workloadGroupId."'),
      workloadGroupIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { workloadGroupIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { workloadGroupIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { workloadGroupIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { workloadGroupIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { workloadGroupIdSelector+: { matchLabels+: matchLabels } } } },
      },
    },
    ...
    initProvider: {
      ...
      '#withLabel':: d.fn(help='"Specifies the label value that a request can be classified against."', args=[d.arg(name='label', type=d.T.string)]),
      withLabel(label): { spec+: { initProvider+: { label: label } } },
      '#withMemberName':: d.fn(help='"The workload classifier member name used to classified against."', args=[d.arg(name='memberName', type=d.T.string)]),
      withMemberName(memberName): { spec+: { initProvider+: { memberName: memberName } } },
      '#withStartTime':: d.fn(help="\"The workload classifier start time for classification. It's of the HH:MM format in UTC time zone.\"", args=[d.arg(name='startTime', type=d.T.string)]),
