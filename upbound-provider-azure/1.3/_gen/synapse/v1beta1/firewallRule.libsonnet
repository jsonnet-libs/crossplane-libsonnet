{
  ...
  '#':: d.pkg(name='firewallRule', url='', help='"FirewallRule is the Schema for the FirewallRules API. Manages a Synapse Firewall Rule."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSynapseWorkspaceId':: d.fn(help='"The ID of the Synapse Workspace on which to create the Firewall Rule. Changing this forces a new resource to be created."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
