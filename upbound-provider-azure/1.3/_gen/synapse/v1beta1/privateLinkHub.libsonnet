{
  ...
  '#':: d.pkg(name='privateLinkHub', url='', help='"PrivateLinkHub is the Schema for the PrivateLinkHubs API. Manages a Synapse Private Link Hub."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateLinkHub', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateLinkHubSpec defines the desired state of PrivateLinkHub"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"Specifies the Azure location where the Synapse Private Link Hub exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Synapse Private Link Hub. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Synapse Private Link Hub."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Synapse Private Link Hub."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
