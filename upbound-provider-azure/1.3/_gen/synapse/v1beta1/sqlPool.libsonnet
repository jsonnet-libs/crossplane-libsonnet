{
  ...
  '#':: d.pkg(name='sqlPool', url='', help='"SQLPool is the Schema for the SQLPools API. Manages a Synapse SQL Pool."'),
  ...
  '#new':: d.fn(help='new returns an instance of SQLPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SQLPoolSpec defines the desired state of SQLPool"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#restore':: d.obj(help='"A restore block as defined below. Only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new Synapse SQL Pool to be created."'),
      restore: {
        '#withPointInTime':: d.fn(help='"Specifies the Snapshot time to restore formatted as an RFC3339 date string. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='pointInTime', type=d.T.string)]),
        withPointInTime(pointInTime): { pointInTime: pointInTime },
        '#withSourceDatabaseId':: d.fn(help='"The ID of the Synapse SQL Pool or SQL Database which is to restore. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='sourceDatabaseId', type=d.T.string)]),
      ...
      '#withCollation':: d.fn(help='"The name of the collation to use with this pool, only applicable when create_mode is set to Default. Azure default is SQL_LATIN1_GENERAL_CP1_CI_AS. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='collation', type=d.T.string)]),
      withCollation(collation): { spec+: { forProvider+: { collation: collation } } },
      '#withCreateMode':: d.fn(help='"Specifies how to create the SQL Pool. Valid values are: Default, Recovery or PointInTimeRestore. Must be Default to create a new database. Defaults to Default. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='createMode', type=d.T.string)]),
      withCreateMode(createMode): { spec+: { forProvider+: { createMode: createMode } } },
      '#withDataEncrypted':: d.fn(help='"Is transparent data encryption enabled?"', args=[d.arg(name='dataEncrypted', type=d.T.boolean)]),
      withDataEncrypted(dataEncrypted): { spec+: { forProvider+: { dataEncrypted: dataEncrypted } } },
      '#withGeoBackupPolicyEnabled':: d.fn(help='"Is geo-backup policy enabled? Possible values include true or false. Defaults to true."', args=[d.arg(name='geoBackupPolicyEnabled', type=d.T.boolean)]),
      withGeoBackupPolicyEnabled(geoBackupPolicyEnabled): { spec+: { forProvider+: { geoBackupPolicyEnabled: geoBackupPolicyEnabled } } },
      '#withRecoveryDatabaseId':: d.fn(help='"The ID of the Synapse SQL Pool or SQL Database which is to back up, only applicable when create_mode is set to Recovery. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='recoveryDatabaseId', type=d.T.string)]),
      withRecoveryDatabaseId(recoveryDatabaseId): { spec+: { forProvider+: { recoveryDatabaseId: recoveryDatabaseId } } },
      '#withRestore':: d.fn(help='"A restore block as defined below. Only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='restore', type=d.T.array)]),
      withRestore(restore): { spec+: { forProvider+: { restore: if std.isArray(v=restore) then restore else [restore] } } },
      '#withRestoreMixin':: d.fn(help='"A restore block as defined below. Only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new Synapse SQL Pool to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='restore', type=d.T.array)]),
      withRestoreMixin(restore): { spec+: { forProvider+: { restore+: if std.isArray(v=restore) then restore else [restore] } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU Name for this Synapse SQL Pool. Possible values are DW100c, DW200c, DW300c, DW400c, DW500c, DW1000c, DW1500c, DW2000c, DW2500c, DW3000c, DW5000c, DW6000c, DW7500c, DW10000c, DW15000c or DW30000c."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withStorageAccountType':: d.fn(help='"The storage account type that will be used to store backups for this Synapse SQL Pool. Possible values are LRS or GRS. Changing this forces a new Synapse SQL Pool to be created. Defaults to GRS."', args=[d.arg(name='storageAccountType', type=d.T.string)]),
      withStorageAccountType(storageAccountType): { spec+: { forProvider+: { storageAccountType: storageAccountType } } },
      '#withSynapseWorkspaceId':: d.fn(help='"The ID of Synapse Workspace within which this SQL Pool should be created. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
      withSynapseWorkspaceId(synapseWorkspaceId): { spec+: { forProvider+: { synapseWorkspaceId: synapseWorkspaceId } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Synapse SQL Pool."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Synapse SQL Pool."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withDataEncrypted':: d.fn(help='"Is transparent data encryption enabled?"', args=[d.arg(name='dataEncrypted', type=d.T.boolean)]),
      withDataEncrypted(dataEncrypted): { spec+: { initProvider+: { dataEncrypted: dataEncrypted } } },
      '#withGeoBackupPolicyEnabled':: d.fn(help='"Is geo-backup policy enabled? Possible values include true or false. Defaults to true."', args=[d.arg(name='geoBackupPolicyEnabled', type=d.T.boolean)]),
      withGeoBackupPolicyEnabled(geoBackupPolicyEnabled): { spec+: { initProvider+: { geoBackupPolicyEnabled: geoBackupPolicyEnabled } } },
      '#withRecoveryDatabaseId':: d.fn(help='"The ID of the Synapse SQL Pool or SQL Database which is to back up, only applicable when create_mode is set to Recovery. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='recoveryDatabaseId', type=d.T.string)]),
      withRecoveryDatabaseId(recoveryDatabaseId): { spec+: { initProvider+: { recoveryDatabaseId: recoveryDatabaseId } } },
      '#withRestore':: d.fn(help='"A restore block as defined below. Only applicable when create_mode is set to PointInTimeRestore. Changing this forces a new Synapse SQL Pool to be created."', args=[d.arg(name='restore', type=d.T.array)]),
