{
  ...
  '#':: d.pkg(name='managedPrivateEndpoint', url='', help='"ManagedPrivateEndpoint is the Schema for the ManagedPrivateEndpoints API. Manages a Synapse Managed Private Endpoint."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSubresourceName':: d.fn(help='"Specifies the sub resource name which the Synapse Private Endpoint is able to connect to. Changing this forces a new resource to be created."', args=[d.arg(name='subresourceName', type=d.T.string)]),
      withSubresourceName(subresourceName): { spec+: { forProvider+: { subresourceName: subresourceName } } },
      '#withSynapseWorkspaceId':: d.fn(help='"The ID of the Synapse Workspace on which to create the Managed Private Endpoint. Changing this forces a new resource to be created."', args=[d.arg(name='synapseWorkspaceId', type=d.T.string)]),
      withSynapseWorkspaceId(synapseWorkspaceId): { spec+: { forProvider+: { synapseWorkspaceId: synapseWorkspaceId } } },
      '#withTargetResourceId':: d.fn(help='"The ID of the Private Link Enabled Remote Resource which this Synapse Private Endpoint should be connected to. Changing this forces a new resource to be created."', args=[d.arg(name='targetResourceId', type=d.T.string)]),
