{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIntegrationRuntime':: d.fn(help='"A integration_runtime block as defined below."', args=[d.arg(name='integrationRuntime', type=d.T.array)]),
