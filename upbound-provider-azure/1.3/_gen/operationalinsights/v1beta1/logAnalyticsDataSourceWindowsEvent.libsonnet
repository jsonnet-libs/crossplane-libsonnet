{
  ...
  '#':: d.pkg(name='logAnalyticsDataSourceWindowsEvent', url='', help='"LogAnalyticsDataSourceWindowsEvent is the Schema for the LogAnalyticsDataSourceWindowsEvents API. Manages a Log Analytics Windows Event DataSource."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogAnalyticsDataSourceWindowsEvent', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LogAnalyticsDataSourceWindowsEventSpec defines the desired state of LogAnalyticsDataSourceWindowsEvent"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEventLogName':: d.fn(help='"Specifies the name of the Windows Event Log to collect events from."', args=[d.arg(name='eventLogName', type=d.T.string)]),
      withEventLogName(eventLogName): { spec+: { forProvider+: { eventLogName: eventLogName } } },
      '#withEventTypes':: d.fn(help='"Specifies an array of event types applied to the specified event log. Possible values include Error, Warning and Information."', args=[d.arg(name='eventTypes', type=d.T.array)]),
      withEventTypes(eventTypes): { spec+: { forProvider+: { eventTypes: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } } },
      '#withEventTypesMixin':: d.fn(help='"Specifies an array of event types applied to the specified event log. Possible values include Error, Warning and Information."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypes', type=d.T.array)]),
      withEventTypesMixin(eventTypes): { spec+: { forProvider+: { eventTypes+: if std.isArray(v=eventTypes) then eventTypes else [eventTypes] } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Log Analytics Windows Event DataSource should exist. Changing this forces a new Log Analytics Windows Event DataSource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withWorkspaceName':: d.fn(help='"The name of the Log Analytics Workspace where the Log Analytics Windows Event DataSource should exist. Changing this forces a new Log Analytics Windows Event DataSource to be created."', args=[d.arg(name='workspaceName', type=d.T.string)]),
    ...
    initProvider: {
      '#withEventLogName':: d.fn(help='"Specifies the name of the Windows Event Log to collect events from."', args=[d.arg(name='eventLogName', type=d.T.string)]),
      withEventLogName(eventLogName): { spec+: { initProvider+: { eventLogName: eventLogName } } },
      '#withEventTypes':: d.fn(help='"Specifies an array of event types applied to the specified event log. Possible values include Error, Warning and Information."', args=[d.arg(name='eventTypes', type=d.T.array)]),
