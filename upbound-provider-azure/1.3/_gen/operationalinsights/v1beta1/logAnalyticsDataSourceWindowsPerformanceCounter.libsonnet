{
  ...
  '#':: d.pkg(name='logAnalyticsDataSourceWindowsPerformanceCounter', url='', help='"LogAnalyticsDataSourceWindowsPerformanceCounter is the Schema for the LogAnalyticsDataSourceWindowsPerformanceCounters API. Manages a Log Analytics (formally Operational Insights) Windows Performance Counter DataSource."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogAnalyticsDataSourceWindowsPerformanceCounter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LogAnalyticsDataSourceWindowsPerformanceCounterSpec defines the desired state of LogAnalyticsDataSourceWindowsPerformanceCounter"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCounterName':: d.fn(help='"The friendly name of the performance counter."', args=[d.arg(name='counterName', type=d.T.string)]),
      withCounterName(counterName): { spec+: { forProvider+: { counterName: counterName } } },
      '#withInstanceName':: d.fn(help='"The name of the virtual machine instance to which the Windows Performance Counter DataSource be applied. Specify a * will apply to all instances."', args=[d.arg(name='instanceName', type=d.T.string)]),
      withInstanceName(instanceName): { spec+: { forProvider+: { instanceName: instanceName } } },
      '#withIntervalSeconds':: d.fn(help='"The time of sample interval in seconds. Supports values between 10 and 2147483647."', args=[d.arg(name='intervalSeconds', type=d.T.number)]),
      withIntervalSeconds(intervalSeconds): { spec+: { forProvider+: { intervalSeconds: intervalSeconds } } },
      '#withObjectName':: d.fn(help='"The object name of the Log Analytics Windows Performance Counter DataSource."', args=[d.arg(name='objectName', type=d.T.string)]),
      withObjectName(objectName): { spec+: { forProvider+: { objectName: objectName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Log Analytics Windows Performance Counter DataSource should exist. Changing this forces a new Log Analytics Windows Performance Counter DataSource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withWorkspaceName':: d.fn(help='"The name of the Log Analytics Workspace where the Log Analytics Windows Performance Counter DataSource should exist. Changing this forces a new Log Analytics Windows Performance Counter DataSource to be created."', args=[d.arg(name='workspaceName', type=d.T.string)]),
    ...
    initProvider: {
      '#withCounterName':: d.fn(help='"The friendly name of the performance counter."', args=[d.arg(name='counterName', type=d.T.string)]),
      withCounterName(counterName): { spec+: { initProvider+: { counterName: counterName } } },
      '#withInstanceName':: d.fn(help='"The name of the virtual machine instance to which the Windows Performance Counter DataSource be applied. Specify a * will apply to all instances."', args=[d.arg(name='instanceName', type=d.T.string)]),
      ...
      '#withObjectName':: d.fn(help='"The object name of the Log Analytics Windows Performance Counter DataSource."', args=[d.arg(name='objectName', type=d.T.string)]),
      withObjectName(objectName): { spec+: { initProvider+: { objectName: objectName } } },
    },
