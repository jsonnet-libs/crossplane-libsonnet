{
  ...
  '#':: d.pkg(name='logAnalyticsQueryPack', url='', help='"LogAnalyticsQueryPack is the Schema for the LogAnalyticsQueryPacks API. Manages a Log Analytics Query Pack."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogAnalyticsQueryPack', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LogAnalyticsQueryPackSpec defines the desired state of LogAnalyticsQueryPack"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Log Analytics Query Pack should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Log Analytics Query Pack should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Log Analytics Query Pack."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Log Analytics Query Pack."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
