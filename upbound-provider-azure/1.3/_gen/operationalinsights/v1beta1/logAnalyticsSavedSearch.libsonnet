{
  ...
  '#':: d.pkg(name='logAnalyticsSavedSearch', url='', help='"LogAnalyticsSavedSearch is the Schema for the LogAnalyticsSavedSearchs API. Manages a Log Analytics (formally Operational Insights) Saved Search."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogAnalyticsSavedSearch', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LogAnalyticsSavedSearchSpec defines the desired state of LogAnalyticsSavedSearch"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCategory':: d.fn(help='"The category that the Saved Search will be listed under. Changing this forces a new resource to be created."', args=[d.arg(name='category', type=d.T.string)]),
      withCategory(category): { spec+: { forProvider+: { category: category } } },
      '#withDisplayName':: d.fn(help='"The name that Saved Search will be displayed as. Changing this forces a new resource to be created."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withFunctionAlias':: d.fn(help='"The function alias if the query serves as a function. Changing this forces a new resource to be created."', args=[d.arg(name='functionAlias', type=d.T.string)]),
      withFunctionAlias(functionAlias): { spec+: { forProvider+: { functionAlias: functionAlias } } },
      '#withFunctionParameters':: d.fn(help='"The function parameters if the query serves as a function. Changing this forces a new resource to be created."', args=[d.arg(name='functionParameters', type=d.T.array)]),
      withFunctionParameters(functionParameters): { spec+: { forProvider+: { functionParameters: if std.isArray(v=functionParameters) then functionParameters else [functionParameters] } } },
      '#withFunctionParametersMixin':: d.fn(help='"The function parameters if the query serves as a function. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='functionParameters', type=d.T.array)]),
      withFunctionParametersMixin(functionParameters): { spec+: { forProvider+: { functionParameters+: if std.isArray(v=functionParameters) then functionParameters else [functionParameters] } } },
      '#withLogAnalyticsWorkspaceId':: d.fn(help='"Specifies the ID of the Log Analytics Workspace that the Saved Search will be associated with. Changing this forces a new resource to be created."', args=[d.arg(name='logAnalyticsWorkspaceId', type=d.T.string)]),
      withLogAnalyticsWorkspaceId(logAnalyticsWorkspaceId): { spec+: { forProvider+: { logAnalyticsWorkspaceId: logAnalyticsWorkspaceId } } },
      '#withQuery':: d.fn(help='"The query expression for the saved search. Changing this forces a new resource to be created."', args=[d.arg(name='query', type=d.T.string)]),
      withQuery(query): { spec+: { forProvider+: { query: query } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Logs Analytics Saved Search. Changing this forces a new resource to be created."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Logs Analytics Saved Search. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withFunctionAlias':: d.fn(help='"The function alias if the query serves as a function. Changing this forces a new resource to be created."', args=[d.arg(name='functionAlias', type=d.T.string)]),
      withFunctionAlias(functionAlias): { spec+: { initProvider+: { functionAlias: functionAlias } } },
      '#withFunctionParameters':: d.fn(help='"The function parameters if the query serves as a function. Changing this forces a new resource to be created."', args=[d.arg(name='functionParameters', type=d.T.array)]),
      withFunctionParameters(functionParameters): { spec+: { initProvider+: { functionParameters: if std.isArray(v=functionParameters) then functionParameters else [functionParameters] } } },
      '#withFunctionParametersMixin':: d.fn(help='"The function parameters if the query serves as a function. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='functionParameters', type=d.T.array)]),
      withFunctionParametersMixin(functionParameters): { spec+: { initProvider+: { functionParameters+: if std.isArray(v=functionParameters) then functionParameters else [functionParameters] } } },
      '#withQuery':: d.fn(help='"The query expression for the saved search. Changing this forces a new resource to be created."', args=[d.arg(name='query', type=d.T.string)]),
