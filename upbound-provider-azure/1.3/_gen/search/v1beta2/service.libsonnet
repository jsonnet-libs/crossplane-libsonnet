{
  ...
  '#':: d.pkg(name='service', url='', help='"Service is the Schema for the Services API. Manages a Search Service."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Search Service. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withAllowedIps':: d.fn(help='"Specifies a list of inbound IPv4 or CIDRs that are allowed to access the Search Service. If the incoming IP request is from an IP address which is not included in the allowed_ips it will be blocked by the Search Services firewall."', args=[d.arg(name='allowedIps', type=d.T.array)]),
      withAllowedIps(allowedIps): { spec+: { forProvider+: { allowedIps: if std.isArray(v=allowedIps) then allowedIps else [allowedIps] } } },
      '#withAllowedIpsMixin':: d.fn(help='"Specifies a list of inbound IPv4 or CIDRs that are allowed to access the Search Service. If the incoming IP request is from an IP address which is not included in the allowed_ips it will be blocked by the Search Services firewall."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedIps', type=d.T.array)]),
      withAllowedIpsMixin(allowedIps): { spec+: { forProvider+: { allowedIps+: if std.isArray(v=allowedIps) then allowedIps else [allowedIps] } } },
      '#withAuthenticationFailureMode':: d.fn(help='"Specifies the response that the Search Service should return for requests that fail authentication. Possible values include http401WithBearerChallenge or http403."', args=[d.arg(name='authenticationFailureMode', type=d.T.string)]),
      withAuthenticationFailureMode(authenticationFailureMode): { spec+: { forProvider+: { authenticationFailureMode: authenticationFailureMode } } },
      '#withCustomerManagedKeyEnforcementEnabled':: d.fn(help='"Specifies whether the Search Service should enforce that non-customer resources are encrypted. Defaults to false."', args=[d.arg(name='customerManagedKeyEnforcementEnabled', type=d.T.boolean)]),
      withCustomerManagedKeyEnforcementEnabled(customerManagedKeyEnforcementEnabled): { spec+: { forProvider+: { customerManagedKeyEnforcementEnabled: customerManagedKeyEnforcementEnabled } } },
      '#withHostingMode':: d.fn(help='"Specifies the Hosting Mode, which allows for High Density partitions (that allow for up to 1000 indexes) should be supported. Possible values are highDensity or default. Defaults to default. Changing this forces a new Search Service to be created."', args=[d.arg(name='hostingMode', type=d.T.string)]),
      withHostingMode(hostingMode): { spec+: { forProvider+: { hostingMode: hostingMode } } },
      '#withLocalAuthenticationEnabled':: d.fn(help='"Specifies whether the Search Service allows authenticating using API Keys? Defaults to true."', args=[d.arg(name='localAuthenticationEnabled', type=d.T.boolean)]),
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Search Service should exist. Changing this forces a new Search Service to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPartitionCount':: d.fn(help='"Specifies the number of partitions which should be created. This field cannot be set when using a free or basic sku (see the Microsoft documentation). Possible values include 1, 2, 3, 4, 6, or 12. Defaults to 1."', args=[d.arg(name='partitionCount', type=d.T.number)]),
      withPartitionCount(partitionCount): { spec+: { forProvider+: { partitionCount: partitionCount } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Specifies whether Public Network Access is allowed for this resource. Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withReplicaCount':: d.fn(help="\"Specifies the number of Replica's which should be created for this Search Service. This field cannot be set when using a free sku (see the Microsoft documentation).\"", args=[d.arg(name='replicaCount', type=d.T.number)]),
      withReplicaCount(replicaCount): { spec+: { forProvider+: { replicaCount: replicaCount } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Search Service should exist. Changing this forces a new Search Service to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSemanticSearchSku':: d.fn(help='"Specifies the Semantic Search SKU which should be used for this Search Service. Possible values include free and standard."', args=[d.arg(name='semanticSearchSku', type=d.T.string)]),
      withSemanticSearchSku(semanticSearchSku): { spec+: { forProvider+: { semanticSearchSku: semanticSearchSku } } },
      '#withSku':: d.fn(help='"The SKU which should be used for this Search Service. Possible values include basic, free, standard, standard2, standard3, storage_optimized_l1 and storage_optimized_l2. Changing this forces a new Search Service to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withTags':: d.fn(help='"Specifies a mapping of tags which should be assigned to this Search Service."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Specifies a mapping of tags which should be assigned to this Search Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withAllowedIps':: d.fn(help='"Specifies a list of inbound IPv4 or CIDRs that are allowed to access the Search Service. If the incoming IP request is from an IP address which is not included in the allowed_ips it will be blocked by the Search Services firewall."', args=[d.arg(name='allowedIps', type=d.T.array)]),
      withAllowedIps(allowedIps): { spec+: { initProvider+: { allowedIps: if std.isArray(v=allowedIps) then allowedIps else [allowedIps] } } },
      '#withAllowedIpsMixin':: d.fn(help='"Specifies a list of inbound IPv4 or CIDRs that are allowed to access the Search Service. If the incoming IP request is from an IP address which is not included in the allowed_ips it will be blocked by the Search Services firewall."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedIps', type=d.T.array)]),
      withAllowedIpsMixin(allowedIps): { spec+: { initProvider+: { allowedIps+: if std.isArray(v=allowedIps) then allowedIps else [allowedIps] } } },
      '#withAuthenticationFailureMode':: d.fn(help='"Specifies the response that the Search Service should return for requests that fail authentication. Possible values include http401WithBearerChallenge or http403."', args=[d.arg(name='authenticationFailureMode', type=d.T.string)]),
      withAuthenticationFailureMode(authenticationFailureMode): { spec+: { initProvider+: { authenticationFailureMode: authenticationFailureMode } } },
      '#withCustomerManagedKeyEnforcementEnabled':: d.fn(help='"Specifies whether the Search Service should enforce that non-customer resources are encrypted. Defaults to false."', args=[d.arg(name='customerManagedKeyEnforcementEnabled', type=d.T.boolean)]),
      withCustomerManagedKeyEnforcementEnabled(customerManagedKeyEnforcementEnabled): { spec+: { initProvider+: { customerManagedKeyEnforcementEnabled: customerManagedKeyEnforcementEnabled } } },
      '#withHostingMode':: d.fn(help='"Specifies the Hosting Mode, which allows for High Density partitions (that allow for up to 1000 indexes) should be supported. Possible values are highDensity or default. Defaults to default. Changing this forces a new Search Service to be created."', args=[d.arg(name='hostingMode', type=d.T.string)]),
      withHostingMode(hostingMode): { spec+: { initProvider+: { hostingMode: hostingMode } } },
      '#withLocalAuthenticationEnabled':: d.fn(help='"Specifies whether the Search Service allows authenticating using API Keys? Defaults to true."', args=[d.arg(name='localAuthenticationEnabled', type=d.T.boolean)]),
      ...
      '#withSemanticSearchSku':: d.fn(help='"Specifies the Semantic Search SKU which should be used for this Search Service. Possible values include free and standard."', args=[d.arg(name='semanticSearchSku', type=d.T.string)]),
      withSemanticSearchSku(semanticSearchSku): { spec+: { initProvider+: { semanticSearchSku: semanticSearchSku } } },
      '#withSku':: d.fn(help='"The SKU which should be used for this Search Service. Possible values include basic, free, standard, standard2, standard3, storage_optimized_l1 and storage_optimized_l2. Changing this forces a new Search Service to be created."', args=[d.arg(name='sku', type=d.T.string)]),
