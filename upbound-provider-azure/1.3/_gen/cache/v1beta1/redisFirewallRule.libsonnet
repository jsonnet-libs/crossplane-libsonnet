{
  ...
  '#':: d.pkg(name='redisFirewallRule', url='', help='"RedisFirewallRule is the Schema for the RedisFirewallRules API. Manages a Firewall Rule associated with a Redis Cache."'),
  ...
  '#new':: d.fn(help='new returns an instance of RedisFirewallRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RedisFirewallRuleSpec defines the desired state of RedisFirewallRule"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#redisCacheNameRef':: d.obj(help='"Reference to a RedisCache in cache to populate redisCacheName."'),
      redisCacheNameRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { redisCacheNameRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { redisCacheNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { redisCacheNameRef+: { name: name } } } },
      },
      '#redisCacheNameSelector':: d.obj(help='"Selector for a RedisCache in cache to populate redisCacheName."'),
      redisCacheNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { redisCacheNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { redisCacheNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { redisCacheNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { redisCacheNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { redisCacheNameSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withEndIp':: d.fn(help='"The highest IP address included in the range."', args=[d.arg(name='endIp', type=d.T.string)]),
      withEndIp(endIp): { spec+: { forProvider+: { endIp: endIp } } },
      '#withRedisCacheName':: d.fn(help='"The name of the Redis Cache. Changing this forces a new resource to be created."', args=[d.arg(name='redisCacheName', type=d.T.string)]),
      withRedisCacheName(redisCacheName): { spec+: { forProvider+: { redisCacheName: redisCacheName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which this Redis Cache exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withStartIp':: d.fn(help='"The lowest IP address included in the range"', args=[d.arg(name='startIp', type=d.T.string)]),
      withStartIp(startIp): { spec+: { forProvider+: { startIp: startIp } } },
    },
    ...
    initProvider: {
      '#withEndIp':: d.fn(help='"The highest IP address included in the range."', args=[d.arg(name='endIp', type=d.T.string)]),
      withEndIp(endIp): { spec+: { initProvider+: { endIp: endIp } } },
      '#withStartIp':: d.fn(help='"The lowest IP address included in the range"', args=[d.arg(name='startIp', type=d.T.string)]),
      withStartIp(startIp): { spec+: { initProvider+: { startIp: startIp } } },
    },
