{
  ...
  '#':: d.pkg(name='managedApplicationDefinition', url='', help='"ManagedApplicationDefinition is the Schema for the ManagedApplicationDefinitions API. Manages a Managed Application Definition."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagedApplicationDefinition', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagedApplicationDefinitionSpec defines the desired state of ManagedApplicationDefinition"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#authorization':: d.obj(help='"One or more authorization block defined below."'),
      authorization: {
        '#withRoleDefinitionId':: d.fn(help="\"Specifies a role definition identifier for the provider. This role will define all the permissions that the provider must have on the managed application's container resource group. This role definition cannot have permission to delete the resource group.\"", args=[d.arg(name='roleDefinitionId', type=d.T.string)]),
        withRoleDefinitionId(roleDefinitionId): { roleDefinitionId: roleDefinitionId },
        '#withServicePrincipalId':: d.fn(help='"Specifies a service principal identifier for the provider. This is the identity that the provider will use to call ARM to manage the managed application resources."', args=[d.arg(name='servicePrincipalId', type=d.T.string)]),
        withServicePrincipalId(servicePrincipalId): { servicePrincipalId: servicePrincipalId },
      },
      ...
      '#withAuthorization':: d.fn(help='"One or more authorization block defined below."', args=[d.arg(name='authorization', type=d.T.array)]),
      ...
      '#withCreateUiDefinition':: d.fn(help='"Specifies the createUiDefinition JSON for the backing template with Microsoft.Solutions/applications resource."', args=[d.arg(name='createUiDefinition', type=d.T.string)]),
      withCreateUiDefinition(createUiDefinition): { spec+: { forProvider+: { createUiDefinition: createUiDefinition } } },
      '#withDescription':: d.fn(help='"Specifies the managed application definition description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"Specifies the managed application definition display name."', args=[d.arg(name='displayName', type=d.T.string)]),
      ...
      '#withLockLevel':: d.fn(help='"Specifies the managed application lock level. Valid values include CanNotDelete, None, ReadOnly. Changing this forces a new resource to be created."', args=[d.arg(name='lockLevel', type=d.T.string)]),
      withLockLevel(lockLevel): { spec+: { forProvider+: { lockLevel: lockLevel } } },
      '#withMainTemplate':: d.fn(help='"Specifies the inline main template JSON which has resources to be provisioned."', args=[d.arg(name='mainTemplate', type=d.T.string)]),
      withMainTemplate(mainTemplate): { spec+: { forProvider+: { mainTemplate: mainTemplate } } },
      '#withPackageEnabled':: d.fn(help='"Is the package enabled? Defaults to true."', args=[d.arg(name='packageEnabled', type=d.T.boolean)]),
      withPackageEnabled(packageEnabled): { spec+: { forProvider+: { packageEnabled: packageEnabled } } },
      '#withPackageFileUri':: d.fn(help='"Specifies the managed application definition package file Uri."', args=[d.arg(name='packageFileUri', type=d.T.string)]),
      withPackageFileUri(packageFileUri): { spec+: { forProvider+: { packageFileUri: packageFileUri } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Managed Application Definition should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withCreateUiDefinition':: d.fn(help='"Specifies the createUiDefinition JSON for the backing template with Microsoft.Solutions/applications resource."', args=[d.arg(name='createUiDefinition', type=d.T.string)]),
      withCreateUiDefinition(createUiDefinition): { spec+: { initProvider+: { createUiDefinition: createUiDefinition } } },
      '#withDescription':: d.fn(help='"Specifies the managed application definition description."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withLockLevel':: d.fn(help='"Specifies the managed application lock level. Valid values include CanNotDelete, None, ReadOnly. Changing this forces a new resource to be created."', args=[d.arg(name='lockLevel', type=d.T.string)]),
      withLockLevel(lockLevel): { spec+: { initProvider+: { lockLevel: lockLevel } } },
      '#withMainTemplate':: d.fn(help='"Specifies the inline main template JSON which has resources to be provisioned."', args=[d.arg(name='mainTemplate', type=d.T.string)]),
      withMainTemplate(mainTemplate): { spec+: { initProvider+: { mainTemplate: mainTemplate } } },
      '#withPackageEnabled':: d.fn(help='"Is the package enabled? Defaults to true."', args=[d.arg(name='packageEnabled', type=d.T.boolean)]),
      withPackageEnabled(packageEnabled): { spec+: { initProvider+: { packageEnabled: packageEnabled } } },
      '#withPackageFileUri':: d.fn(help='"Specifies the managed application definition package file Uri."', args=[d.arg(name='packageFileUri', type=d.T.string)]),
      withPackageFileUri(packageFileUri): { spec+: { initProvider+: { packageFileUri: packageFileUri } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
