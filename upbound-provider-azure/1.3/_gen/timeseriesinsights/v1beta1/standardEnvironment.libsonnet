{
  ...
  '#':: d.pkg(name='standardEnvironment', url='', help='"StandardEnvironment is the Schema for the StandardEnvironments API. Manages an Azure IoT Time Series Insights Standard Environment."'),
  ...
  '#new':: d.fn(help='new returns an instance of StandardEnvironment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"StandardEnvironmentSpec defines the desired state of StandardEnvironment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDataRetentionTime':: d.fn(help="\"Specifies the ISO8601 timespan specifying the minimum number of days the environment's events will be available for query. Changing this forces a new resource to be created.\"", args=[d.arg(name='dataRetentionTime', type=d.T.string)]),
      withDataRetentionTime(dataRetentionTime): { spec+: { forProvider+: { dataRetentionTime: dataRetentionTime } } },
      ...
      '#withPartitionKey':: d.fn(help='"The name of the event property which will be used to partition data. Changing this forces a new resource to be created."', args=[d.arg(name='partitionKey', type=d.T.string)]),
      withPartitionKey(partitionKey): { spec+: { forProvider+: { partitionKey: partitionKey } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Azure IoT Time Series Insights Standard Environment. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU Name for this IoT Time Series Insights Standard Environment. It is string consisting of two parts separated by an underscore(_).The first part is the name, valid values include: S1 and S2. The second part is the capacity (e.g. the number of deployed units of the sku), which must be a positive integer (e.g. S1_1). Possible values are S1_1, S1_2, S1_3, S1_4, S1_5, S1_6, S1_7, S1_8, S1_9, S1_10, S2_1, S2_2, S2_3, S2_4, S2_5, S2_6, S2_7, S2_8, S2_9 and S2_10. Changing this forces a new resource to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withStorageLimitExceededBehavior':: d.fn(help="\"Specifies the behaviour the IoT Time Series Insights service should take when the environment's capacity has been exceeded. Valid values include PauseIngress and PurgeOldData. Defaults to PurgeOldData.\"", args=[d.arg(name='storageLimitExceededBehavior', type=d.T.string)]),
      withStorageLimitExceededBehavior(storageLimitExceededBehavior): { spec+: { forProvider+: { storageLimitExceededBehavior: storageLimitExceededBehavior } } },
    ...
    initProvider: {
      '#withDataRetentionTime':: d.fn(help="\"Specifies the ISO8601 timespan specifying the minimum number of days the environment's events will be available for query. Changing this forces a new resource to be created.\"", args=[d.arg(name='dataRetentionTime', type=d.T.string)]),
      withDataRetentionTime(dataRetentionTime): { spec+: { initProvider+: { dataRetentionTime: dataRetentionTime } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withStorageLimitExceededBehavior':: d.fn(help="\"Specifies the behaviour the IoT Time Series Insights service should take when the environment's capacity has been exceeded. Valid values include PauseIngress and PurgeOldData. Defaults to PurgeOldData.\"", args=[d.arg(name='storageLimitExceededBehavior', type=d.T.string)]),
      withStorageLimitExceededBehavior(storageLimitExceededBehavior): { spec+: { initProvider+: { storageLimitExceededBehavior: storageLimitExceededBehavior } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
