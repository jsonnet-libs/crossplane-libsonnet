{
  ...
  '#':: d.pkg(name='referenceDataSet', url='', help='"ReferenceDataSet is the Schema for the ReferenceDataSets API. Manages an Azure IoT Time Series Insights Reference Data Set."'),
  ...
  '#new':: d.fn(help='new returns an instance of ReferenceDataSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ReferenceDataSetSpec defines the desired state of ReferenceDataSet"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#keyProperty':: d.obj(help='"A key_property block as defined below. Changing this forces a new resource to be created."'),
      keyProperty: {
        '#withName':: d.fn(help='"The name of the key property. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withType':: d.fn(help='"The data type of the key property. Valid values include Bool, DateTime, Double, String. Changing this forces a new resource to be created."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#timeSeriesInsightsEnvironmentIdRef':: d.obj(help='"Reference to a StandardEnvironment in timeseriesinsights to populate timeSeriesInsightsEnvironmentId."'),
      timeSeriesInsightsEnvironmentIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdRef+: { name: name } } } },
      },
      '#timeSeriesInsightsEnvironmentIdSelector':: d.obj(help='"Selector for a StandardEnvironment in timeseriesinsights to populate timeSeriesInsightsEnvironmentId."'),
      timeSeriesInsightsEnvironmentIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withDataStringComparisonBehavior':: d.fn(help='"The comparison behavior that will be used to compare keys. Valid values include Ordinal and OrdinalIgnoreCase. Defaults to Ordinal. Changing this forces a new resource to be created."', args=[d.arg(name='dataStringComparisonBehavior', type=d.T.string)]),
      withDataStringComparisonBehavior(dataStringComparisonBehavior): { spec+: { forProvider+: { dataStringComparisonBehavior: dataStringComparisonBehavior } } },
      '#withKeyProperty':: d.fn(help='"A key_property block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='keyProperty', type=d.T.array)]),
      withKeyProperty(keyProperty): { spec+: { forProvider+: { keyProperty: if std.isArray(v=keyProperty) then keyProperty else [keyProperty] } } },
      '#withKeyPropertyMixin':: d.fn(help='"A key_property block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='keyProperty', type=d.T.array)]),
      withKeyPropertyMixin(keyProperty): { spec+: { forProvider+: { keyProperty+: if std.isArray(v=keyProperty) then keyProperty else [keyProperty] } } },
      ...
      '#withTimeSeriesInsightsEnvironmentId':: d.fn(help='"The resource ID of the Azure IoT Time Series Insights Environment in which to create the Azure IoT Time Series Insights Reference Data Set. Changing this forces a new resource to be created."', args=[d.arg(name='timeSeriesInsightsEnvironmentId', type=d.T.string)]),
      withTimeSeriesInsightsEnvironmentId(timeSeriesInsightsEnvironmentId): { spec+: { forProvider+: { timeSeriesInsightsEnvironmentId: timeSeriesInsightsEnvironmentId } } },
    },
    ...
    initProvider: {
      ...
      '#withDataStringComparisonBehavior':: d.fn(help='"The comparison behavior that will be used to compare keys. Valid values include Ordinal and OrdinalIgnoreCase. Defaults to Ordinal. Changing this forces a new resource to be created."', args=[d.arg(name='dataStringComparisonBehavior', type=d.T.string)]),
      withDataStringComparisonBehavior(dataStringComparisonBehavior): { spec+: { initProvider+: { dataStringComparisonBehavior: dataStringComparisonBehavior } } },
      '#withKeyProperty':: d.fn(help='"A key_property block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='keyProperty', type=d.T.array)]),
      withKeyProperty(keyProperty): { spec+: { initProvider+: { keyProperty: if std.isArray(v=keyProperty) then keyProperty else [keyProperty] } } },
      '#withKeyPropertyMixin':: d.fn(help='"A key_property block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='keyProperty', type=d.T.array)]),
      withKeyPropertyMixin(keyProperty): { spec+: { initProvider+: { keyProperty+: if std.isArray(v=keyProperty) then keyProperty else [keyProperty] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
