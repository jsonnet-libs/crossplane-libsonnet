  ...
  spec: {
    ...
    forProvider: {
      ...
      configuration: {
        ...
        withAssignmentType(assignmentType): { assignmentType: assignmentType },
        ...
        withContentHash(contentHash): { contentHash: contentHash },
        ...
        withContentUri(contentUri): { contentUri: contentUri },
      ...
      '#withConfiguration':: d.fn(help='"A configuration block as defined below."', args=[d.arg(name='configuration', type=d.T.array)]),
