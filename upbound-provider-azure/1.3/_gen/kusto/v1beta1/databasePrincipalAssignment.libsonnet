{
  ...
  '#':: d.pkg(name='databasePrincipalAssignment', url='', help='"DatabasePrincipalAssignment is the Schema for the DatabasePrincipalAssignments API. Manages a Kusto / Data Explorer Database Principal Assignment"'),
  ...
  '#new':: d.fn(help='new returns an instance of DatabasePrincipalAssignment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatabasePrincipalAssignmentSpec defines the desired state of DatabasePrincipalAssignment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withClusterName':: d.fn(help='"The name of the cluster in which to create the resource. Changing this forces a new resource to be created."', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withDatabaseName':: d.fn(help='"The name of the database in which to create the resource. Changing this forces a new resource to be created."', args=[d.arg(name='databaseName', type=d.T.string)]),
      withDatabaseName(databaseName): { spec+: { forProvider+: { databaseName: databaseName } } },
      '#withPrincipalId':: d.fn(help='"The object id of the principal. Changing this forces a new resource to be created."', args=[d.arg(name='principalId', type=d.T.string)]),
      withPrincipalId(principalId): { spec+: { forProvider+: { principalId: principalId } } },
      '#withPrincipalType':: d.fn(help='"The type of the principal. Valid values include App, Group, User. Changing this forces a new resource to be created."', args=[d.arg(name='principalType', type=d.T.string)]),
      ...
      '#withRole':: d.fn(help='"The database role assigned to the principal. Valid values include Admin, Ingestor, Monitor, UnrestrictedViewer, User and Viewer. Changing this forces a new resource to be created."', args=[d.arg(name='role', type=d.T.string)]),
      withRole(role): { spec+: { forProvider+: { role: role } } },
      '#withTenantId':: d.fn(help='"The tenant id in which the principal resides. Changing this forces a new resource to be created."', args=[d.arg(name='tenantId', type=d.T.string)]),
