{
  ...
  '#':: d.pkg(name='database', url='', help='"Database is the Schema for the Databases API. Manages Kusto / Data Explorer Database"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withClusterName':: d.fn(help='"Specifies the name of the Kusto Cluster this database will be added to. Changing this forces a new resource to be created."', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withHotCachePeriod':: d.fn(help='"The time the data that should be kept in cache for fast queries as ISO 8601 timespan. Default is unlimited. For more information see: ISO 8601 Timespan"', args=[d.arg(name='hotCachePeriod', type=d.T.string)]),
      withHotCachePeriod(hotCachePeriod): { spec+: { forProvider+: { hotCachePeriod: hotCachePeriod } } },
      ...
      '#withSoftDeletePeriod':: d.fn(help='"The time the data should be kept before it stops being accessible to queries as ISO 8601 timespan. Default is unlimited. For more information see: ISO 8601 Timespan"', args=[d.arg(name='softDeletePeriod', type=d.T.string)]),
      withSoftDeletePeriod(softDeletePeriod): { spec+: { forProvider+: { softDeletePeriod: softDeletePeriod } } },
    },
    ...
    initProvider: {
      '#withHotCachePeriod':: d.fn(help='"The time the data that should be kept in cache for fast queries as ISO 8601 timespan. Default is unlimited. For more information see: ISO 8601 Timespan"', args=[d.arg(name='hotCachePeriod', type=d.T.string)]),
      withHotCachePeriod(hotCachePeriod): { spec+: { initProvider+: { hotCachePeriod: hotCachePeriod } } },
      '#withLocation':: d.fn(help='"The location where the Kusto Database should be created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withSoftDeletePeriod':: d.fn(help='"The time the data should be kept before it stops being accessible to queries as ISO 8601 timespan. Default is unlimited. For more information see: ISO 8601 Timespan"', args=[d.arg(name='softDeletePeriod', type=d.T.string)]),
      withSoftDeletePeriod(softDeletePeriod): { spec+: { initProvider+: { softDeletePeriod: softDeletePeriod } } },
    },
