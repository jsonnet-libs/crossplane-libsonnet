{
  ...
  '#':: d.pkg(name='clusterPrincipalAssignment', url='', help='"ClusterPrincipalAssignment is the Schema for the ClusterPrincipalAssignments API. Manages a Kusto Cluster Principal Assignment."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterPrincipalAssignment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClusterPrincipalAssignmentSpec defines the desired state of ClusterPrincipalAssignment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRole':: d.fn(help='"The cluster role assigned to the principal. Valid values include AllDatabasesAdmin and AllDatabasesViewer. Changing this forces a new resource to be created."', args=[d.arg(name='role', type=d.T.string)]),
