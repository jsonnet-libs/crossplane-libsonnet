{
  ...
  '#':: d.pkg(name='eventRelayNamespace', url='', help='"EventRelayNamespace is the Schema for the EventRelayNamespaces API. Manages an Azure Relay Namespace."'),
  ...
  '#new':: d.fn(help='new returns an instance of EventRelayNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EventRelayNamespaceSpec defines the desired state of EventRelayNamespace"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Azure Relay Namespace exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Azure Relay Namespace. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"The name of the SKU to use. At this time the only supported value is Standard."', args=[d.arg(name='skuName', type=d.T.string)]),
