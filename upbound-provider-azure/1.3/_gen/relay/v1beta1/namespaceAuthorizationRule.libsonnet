{
  ...
  '#':: d.pkg(name='namespaceAuthorizationRule', url='', help='"NamespaceAuthorizationRule is the Schema for the NamespaceAuthorizationRules API. Manages an Azure Relay Namespace Authorization Rule."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNamespaceName':: d.fn(help='"Name of the Azure Relay Namespace for which this Azure Relay Namespace Authorization Rule will be created. Changing this forces a new Azure Relay Namespace Authorization Rule to be created."', args=[d.arg(name='namespaceName', type=d.T.string)]),
      withNamespaceName(namespaceName): { spec+: { forProvider+: { namespaceName: namespaceName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Azure Relay Namespace Authorization Rule should exist. Changing this forces a new Azure Relay Namespace Authorization Rule to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
