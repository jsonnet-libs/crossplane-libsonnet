{
  ...
  '#':: d.pkg(name='cluster', url='', help='"Cluster is the Schema for the Clusters API. Manages an Azure Stack HCI Cluster."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutomanageConfigurationId':: d.fn(help='"The ID of the Automanage Configuration assigned to the Azure Stack HCI Cluster."', args=[d.arg(name='automanageConfigurationId', type=d.T.string)]),
      withAutomanageConfigurationId(automanageConfigurationId): { spec+: { forProvider+: { automanageConfigurationId: automanageConfigurationId } } },
      '#withClientId':: d.fn(help='"The Client ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created."', args=[d.arg(name='clientId', type=d.T.string)]),
      withClientId(clientId): { spec+: { forProvider+: { clientId: clientId } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Azure Stack HCI Cluster."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Azure Stack HCI Cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withTenantId':: d.fn(help='"The Tenant ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created."', args=[d.arg(name='tenantId', type=d.T.string)]),
    ...
    initProvider: {
      '#withAutomanageConfigurationId':: d.fn(help='"The ID of the Automanage Configuration assigned to the Azure Stack HCI Cluster."', args=[d.arg(name='automanageConfigurationId', type=d.T.string)]),
      withAutomanageConfigurationId(automanageConfigurationId): { spec+: { initProvider+: { automanageConfigurationId: automanageConfigurationId } } },
      '#withClientId':: d.fn(help='"The Client ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created."', args=[d.arg(name='clientId', type=d.T.string)]),
