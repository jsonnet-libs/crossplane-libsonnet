{
  ...
  '#':: d.pkg(name='container', url='', help='"Container is the Schema for the Containers API. Manages a Container within an Azure Storage Account."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withContainerAccessType':: d.fn(help='"The Access Level configured for this Container. Possible values are blob, container or private. Defaults to private."', args=[d.arg(name='containerAccessType', type=d.T.string)]),
      withContainerAccessType(containerAccessType): { spec+: { forProvider+: { containerAccessType: containerAccessType } } },
      '#withMetadata':: d.fn(help='"A mapping of MetaData for this Container. All metadata keys should be lowercase."', args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: metadata } } },
      '#withMetadataMixin':: d.fn(help='"A mapping of MetaData for this Container. All metadata keys should be lowercase."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadataMixin(metadata): { spec+: { forProvider+: { metadata+: metadata } } },
      '#withStorageAccountName':: d.fn(help='"The name of the Storage Account where the Container should be created. Changing this forces a new resource to be created."', args=[d.arg(name='storageAccountName', type=d.T.string)]),
    ...
    initProvider: {
      '#withContainerAccessType':: d.fn(help='"The Access Level configured for this Container. Possible values are blob, container or private. Defaults to private."', args=[d.arg(name='containerAccessType', type=d.T.string)]),
      withContainerAccessType(containerAccessType): { spec+: { initProvider+: { containerAccessType: containerAccessType } } },
      '#withMetadata':: d.fn(help='"A mapping of MetaData for this Container. All metadata keys should be lowercase."', args=[d.arg(name='metadata', type=d.T.object)]),
