{
  ...
  '#':: d.pkg(name='table', url='', help='"Table is the Schema for the Tables API. Manages a Table within an Azure Storage Account."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      acl: {
        ...
        accessPolicy: {
          '#withExpiry':: d.fn(help='"The ISO8061 UTC time at which this Access Policy should be valid until."', args=[d.arg(name='expiry', type=d.T.string)]),
          withExpiry(expiry): { expiry: expiry },
          '#withPermissions':: d.fn(help='"The permissions which should associated with this Shared Identifier."', args=[d.arg(name='permissions', type=d.T.string)]),
          withPermissions(permissions): { permissions: permissions },
          '#withStart':: d.fn(help='"The ISO8061 UTC time at which this Access Policy should be valid from."', args=[d.arg(name='start', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name of the storage table. Only Alphanumeric characters allowed, starting with a letter. Must be unique within the storage account the table is located. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withStorageAccountName':: d.fn(help='"Specifies the storage account in which to create the storage table. Changing this forces a new resource to be created."', args=[d.arg(name='storageAccountName', type=d.T.string)]),
