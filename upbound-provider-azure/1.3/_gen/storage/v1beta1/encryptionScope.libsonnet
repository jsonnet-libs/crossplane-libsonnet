{
  ...
  '#':: d.pkg(name='encryptionScope', url='', help='"EncryptionScope is the Schema for the EncryptionScopes API. Manages a Storage Encryption Scope."'),
  ...
  '#new':: d.fn(help='new returns an instance of EncryptionScope', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EncryptionScopeSpec defines the desired state of EncryptionScope"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withInfrastructureEncryptionRequired':: d.fn(help='"Is a secondary layer of encryption with Platform Managed Keys for data applied? Changing this forces a new resource to be created."', args=[d.arg(name='infrastructureEncryptionRequired', type=d.T.boolean)]),
      withInfrastructureEncryptionRequired(infrastructureEncryptionRequired): { spec+: { forProvider+: { infrastructureEncryptionRequired: infrastructureEncryptionRequired } } },
      '#withKeyVaultKeyId':: d.fn(help='"The ID of the Key Vault Key. Required when source is Microsoft.KeyVault."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
      withKeyVaultKeyId(keyVaultKeyId): { spec+: { forProvider+: { keyVaultKeyId: keyVaultKeyId } } },
      '#withSource':: d.fn(help='"The source of the Storage Encryption Scope. Possible values are Microsoft.KeyVault and Microsoft.Storage."', args=[d.arg(name='source', type=d.T.string)]),
      withSource(source): { spec+: { forProvider+: { source: source } } },
      '#withStorageAccountId':: d.fn(help='"The ID of the Storage Account where this Storage Encryption Scope is created. Changing this forces a new Storage Encryption Scope to be created."', args=[d.arg(name='storageAccountId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withInfrastructureEncryptionRequired':: d.fn(help='"Is a secondary layer of encryption with Platform Managed Keys for data applied? Changing this forces a new resource to be created."', args=[d.arg(name='infrastructureEncryptionRequired', type=d.T.boolean)]),
      withInfrastructureEncryptionRequired(infrastructureEncryptionRequired): { spec+: { initProvider+: { infrastructureEncryptionRequired: infrastructureEncryptionRequired } } },
      '#withKeyVaultKeyId':: d.fn(help='"The ID of the Key Vault Key. Required when source is Microsoft.KeyVault."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
