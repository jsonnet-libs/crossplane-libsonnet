{
  ...
  '#':: d.pkg(name='queue', url='', help='"Queue is the Schema for the Queues API. Manages a Queue within an Azure Storage Account."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMetadata':: d.fn(help='"A mapping of MetaData which should be assigned to this Storage Queue."', args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: metadata } } },
      '#withMetadataMixin':: d.fn(help='"A mapping of MetaData which should be assigned to this Storage Queue."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadataMixin(metadata): { spec+: { forProvider+: { metadata+: metadata } } },
      '#withStorageAccountName':: d.fn(help='"Specifies the Storage Account in which the Storage Queue should exist. Changing this forces a new resource to be created."', args=[d.arg(name='storageAccountName', type=d.T.string)]),
