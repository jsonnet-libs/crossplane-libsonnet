{
  ...
  '#':: d.pkg(name='sentinelWatchlist', url='', help='"SentinelWatchlist is the Schema for the SentinelWatchlists API. Manages a Sentinel Watchlist."'),
  ...
  '#new':: d.fn(help='new returns an instance of SentinelWatchlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SentinelWatchlistSpec defines the desired state of SentinelWatchlist"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultDuration':: d.fn(help='"The default duration in ISO8601 duration form of this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='defaultDuration', type=d.T.string)]),
      withDefaultDuration(defaultDuration): { spec+: { forProvider+: { defaultDuration: defaultDuration } } },
      '#withDescription':: d.fn(help='"The description of this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name of this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withItemSearchKey':: d.fn(help='"The key used to optimize query performance when using Watchlist for joins with other data. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='itemSearchKey', type=d.T.string)]),
      withItemSearchKey(itemSearchKey): { spec+: { forProvider+: { itemSearchKey: itemSearchKey } } },
      '#withLabels':: d.fn(help='"Specifies a list of labels related to this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='labels', type=d.T.array)]),
      withLabels(labels): { spec+: { forProvider+: { labels: if std.isArray(v=labels) then labels else [labels] } } },
      '#withLabelsMixin':: d.fn(help='"Specifies a list of labels related to this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.array)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: if std.isArray(v=labels) then labels else [labels] } } },
      '#withLogAnalyticsWorkspaceId':: d.fn(help='"The ID of the Log Analytics Workspace where this Sentinel Watchlist resides in. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='logAnalyticsWorkspaceId', type=d.T.string)]),
    ...
    initProvider: {
      '#withDefaultDuration':: d.fn(help='"The default duration in ISO8601 duration form of this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='defaultDuration', type=d.T.string)]),
      withDefaultDuration(defaultDuration): { spec+: { initProvider+: { defaultDuration: defaultDuration } } },
      '#withDescription':: d.fn(help='"The description of this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withItemSearchKey':: d.fn(help='"The key used to optimize query performance when using Watchlist for joins with other data. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='itemSearchKey', type=d.T.string)]),
      withItemSearchKey(itemSearchKey): { spec+: { initProvider+: { itemSearchKey: itemSearchKey } } },
      '#withLabels':: d.fn(help='"Specifies a list of labels related to this Sentinel Watchlist. Changing this forces a new Sentinel Watchlist to be created."', args=[d.arg(name='labels', type=d.T.array)]),
