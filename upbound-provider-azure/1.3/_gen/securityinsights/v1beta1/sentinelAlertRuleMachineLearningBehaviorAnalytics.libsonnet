{
  ...
  '#':: d.pkg(name='sentinelAlertRuleMachineLearningBehaviorAnalytics', url='', help='"SentinelAlertRuleMachineLearningBehaviorAnalytics is the Schema for the SentinelAlertRuleMachineLearningBehaviorAnalyticss API. Manages a Sentinel Machine Learning Behavior Analytics Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of SentinelAlertRuleMachineLearningBehaviorAnalytics', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SentinelAlertRuleMachineLearningBehaviorAnalyticsSpec defines the desired state of SentinelAlertRuleMachineLearningBehaviorAnalytics"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAlertRuleTemplateGuid':: d.fn(help='"The GUID of the alert rule template which is used for this Sentinel Machine Learning Behavior Analytics Alert Rule. Changing this forces a new Sentinel Machine Learning Behavior Analytics Alert Rule to be created."', args=[d.arg(name='alertRuleTemplateGuid', type=d.T.string)]),
      withAlertRuleTemplateGuid(alertRuleTemplateGuid): { spec+: { forProvider+: { alertRuleTemplateGuid: alertRuleTemplateGuid } } },
      '#withEnabled':: d.fn(help='"Should this Sentinel Machine Learning Behavior Analytics Alert Rule be enabled? Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withLogAnalyticsWorkspaceId':: d.fn(help='"The ID of the Log Analytics Workspace this SentinelMachine Learning Behavior Analytics Alert Rule belongs to. Changing this forces a new Sentinel Machine Learning Behavior Analytics Alert Rule to be created."', args=[d.arg(name='logAnalyticsWorkspaceId', type=d.T.string)]),
      withLogAnalyticsWorkspaceId(logAnalyticsWorkspaceId): { spec+: { forProvider+: { logAnalyticsWorkspaceId: logAnalyticsWorkspaceId } } },
      '#withName':: d.fn(help='"The name which should be used for this SentinelMachine Learning Behavior Analytics Alert Rule. Changing this forces a new Sentinel Machine Learning Behavior Analytics Alert Rule to be created."', args=[d.arg(name='name', type=d.T.string)]),
