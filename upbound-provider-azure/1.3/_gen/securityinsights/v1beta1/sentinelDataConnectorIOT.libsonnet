{
  ...
  '#':: d.pkg(name='sentinelDataConnectorIOT', url='', help='"SentinelDataConnectorIOT is the Schema for the SentinelDataConnectorIOTs API. Manages an Iot Data Connector."'),
  ...
  '#new':: d.fn(help='new returns an instance of SentinelDataConnectorIOT', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SentinelDataConnectorIOTSpec defines the desired state of SentinelDataConnectorIOT"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLogAnalyticsWorkspaceId':: d.fn(help='"The ID of the Log Analytics Workspace that this Iot Data Connector resides in. Changing this forces a new Iot Data Connector to be created."', args=[d.arg(name='logAnalyticsWorkspaceId', type=d.T.string)]),
      withLogAnalyticsWorkspaceId(logAnalyticsWorkspaceId): { spec+: { forProvider+: { logAnalyticsWorkspaceId: logAnalyticsWorkspaceId } } },
      '#withSubscriptionId':: d.fn(help='"The ID of the subscription that this Iot Data Connector connects to. Changing this forces a new Iot Data Connector to be created."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
