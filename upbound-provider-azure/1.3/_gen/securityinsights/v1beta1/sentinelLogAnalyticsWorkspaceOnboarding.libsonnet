{
  ...
  '#':: d.pkg(name='sentinelLogAnalyticsWorkspaceOnboarding', url='', help='"SentinelLogAnalyticsWorkspaceOnboarding is the Schema for the SentinelLogAnalyticsWorkspaceOnboardings API. Manages a Security Insights Sentinel Onboarding States."'),
  ...
  '#new':: d.fn(help='new returns an instance of SentinelLogAnalyticsWorkspaceOnboarding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SentinelLogAnalyticsWorkspaceOnboardingSpec defines the desired state of SentinelLogAnalyticsWorkspaceOnboarding"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCustomerManagedKeyEnabled':: d.fn(help='"Specifies if the Workspace is using Customer managed key. Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='customerManagedKeyEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group where the Security Insights Sentinel Onboarding States should exist. Changing this forces the Log Analytics Workspace off the board and onboard again."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withWorkspaceId':: d.fn(help='"The ID of the Security Insights Sentinel Onboarding States."', args=[d.arg(name='workspaceId', type=d.T.string)]),
      withWorkspaceId(workspaceId): { spec+: { forProvider+: { workspaceId: workspaceId } } },
      '#withWorkspaceName':: d.fn(help='"Specifies the Workspace Name. Changing this forces the Log Analytics Workspace off the board and onboard again. Changing this forces a new resource to be created."', args=[d.arg(name='workspaceName', type=d.T.string)]),
