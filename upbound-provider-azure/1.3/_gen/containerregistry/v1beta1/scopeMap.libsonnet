{
  ...
  '#':: d.pkg(name='scopeMap', url='', help='"ScopeMap is the Schema for the ScopeMaps API. Manages an Azure Container Registry scope map."'),
  ...
  '#new':: d.fn(help='new returns an instance of ScopeMap', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ScopeMapSpec defines the desired state of ScopeMap"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withActions':: d.fn(help='"A list of actions to attach to the scope map (e.g. repo/content/read, repo2/content/delete)."', args=[d.arg(name='actions', type=d.T.array)]),
      withActions(actions): { spec+: { forProvider+: { actions: if std.isArray(v=actions) then actions else [actions] } } },
      '#withActionsMixin':: d.fn(help='"A list of actions to attach to the scope map (e.g. repo/content/read, repo2/content/delete)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='actions', type=d.T.array)]),
      ...
      '#withDescription':: d.fn(help='"The description of the Container Registry."', args=[d.arg(name='description', type=d.T.string)]),
