{
  ...
  '#':: d.pkg(name='webhook', url='', help='"Webhook is the Schema for the Webhooks API. Manages an Azure Container Registry Webhook."'),
  ...
  spec: {
    ...
    forProvider: {
      '#registryNameRef':: d.obj(help='"Reference to a Registry in containerregistry to populate registryName."'),
      registryNameRef: {
      ...
      '#registryNameSelector':: d.obj(help='"Selector for a Registry in containerregistry to populate registryName."'),
      ...
      '#withActions':: d.fn(help='"A list of actions that trigger the Webhook to post notifications. At least one action needs to be specified. Valid values are: push, delete, quarantine, chart_push, chart_delete"', args=[d.arg(name='actions', type=d.T.array)]),
      withActions(actions): { spec+: { forProvider+: { actions: if std.isArray(v=actions) then actions else [actions] } } },
      '#withActionsMixin':: d.fn(help='"A list of actions that trigger the Webhook to post notifications. At least one action needs to be specified. Valid values are: push, delete, quarantine, chart_push, chart_delete"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='actions', type=d.T.array)]),
      withActionsMixin(actions): { spec+: { forProvider+: { actions+: if std.isArray(v=actions) then actions else [actions] } } },
      '#withCustomHeaders':: d.fn(help='"Custom headers that will be added to the webhook notifications request."', args=[d.arg(name='customHeaders', type=d.T.object)]),
      withCustomHeaders(customHeaders): { spec+: { forProvider+: { customHeaders: customHeaders } } },
      '#withCustomHeadersMixin':: d.fn(help='"Custom headers that will be added to the webhook notifications request."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customHeaders', type=d.T.object)]),
      withCustomHeadersMixin(customHeaders): { spec+: { forProvider+: { customHeaders+: customHeaders } } },
      ...
      '#withRegistryName':: d.fn(help='"The Name of Container registry this Webhook belongs to. Changing this forces a new resource to be created."', args=[d.arg(name='registryName', type=d.T.string)]),
      withRegistryName(registryName): { spec+: { forProvider+: { registryName: registryName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Container Registry Webhook. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withScope':: d.fn(help="\"Specifies the scope of repositories that can trigger an event. For example, foo:* means events for all tags under repository foo. foo:bar means events for 'foo:bar' only. foo is equivalent to foo:latest. Empty means all events. Defaults to \\\"\\\".\"", args=[d.arg(name='scope', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withCustomHeadersMixin':: d.fn(help='"Custom headers that will be added to the webhook notifications request."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customHeaders', type=d.T.object)]),
      withCustomHeadersMixin(customHeaders): { spec+: { initProvider+: { customHeaders+: customHeaders } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withServiceUri':: d.fn(help='"Specifies the service URI for the Webhook to post notifications."', args=[d.arg(name='serviceUri', type=d.T.string)]),
      withServiceUri(serviceUri): { spec+: { initProvider+: { serviceUri: serviceUri } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
