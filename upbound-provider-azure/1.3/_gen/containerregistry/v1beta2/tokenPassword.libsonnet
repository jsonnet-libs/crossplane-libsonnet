  ...
  spec: {
    ...
    forProvider: {
      ...
      password1: {
        ...
        withExpiry(expiry): { spec+: { forProvider+: { password1+: { expiry: expiry } } } },
      },
      '#password2':: d.obj(help='"One password block as defined below."'),
      password2: {
        '#withExpiry':: d.fn(help='"The expiration date of the password in RFC3339 format. If not specified, the password never expires. Changing this forces a new resource to be created."', args=[d.arg(name='expiry', type=d.T.string)]),
        withExpiry(expiry): { spec+: { forProvider+: { password2+: { expiry: expiry } } } },
      },
    ...
    initProvider: {
      ...
      password1: {
        '#withExpiry':: d.fn(help='"The expiration date of the password in RFC3339 format. If not specified, the password never expires. Changing this forces a new resource to be created."', args=[d.arg(name='expiry', type=d.T.string)]),
        withExpiry(expiry): { spec+: { initProvider+: { password1+: { expiry: expiry } } } },
      },
      '#password2':: d.obj(help='"One password block as defined below."'),
      password2: {
        '#withExpiry':: d.fn(help='"The expiration date of the password in RFC3339 format. If not specified, the password never expires. Changing this forces a new resource to be created."', args=[d.arg(name='expiry', type=d.T.string)]),
        withExpiry(expiry): { spec+: { initProvider+: { password2+: { expiry: expiry } } } },
      },
      '#withContainerRegistryTokenId':: d.fn(help='"The ID of the Container Registry Token that this Container Registry Token Password resides in. Changing this forces a new Container Registry Token Password to be created."', args=[d.arg(name='containerRegistryTokenId', type=d.T.string)]),
