{
  ...
  '#':: d.pkg(name='healthcareDICOMService', url='', help='"HealthcareDICOMService is the Schema for the HealthcareDICOMServices API. Manages a Healthcare DICOM (Digital Imaging and Communications in Medicine) Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of HealthcareDICOMService', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HealthcareDICOMServiceSpec defines the desired state of HealthcareDICOMService"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#identity':: d.obj(help='"An identity block as defined below."'),
      identity: {
        '#withIdentityIds':: d.fn(help='"A list of User Assigned Identity IDs which should be assigned to this Healthcare DICOM service."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"A list of User Assigned Identity IDs which should be assigned to this Healthcare DICOM service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"The type of identity used for the Healthcare DICOM service. Possible values are UserAssigned, SystemAssigned and SystemAssigned, UserAssigned. If UserAssigned is set, an identity_ids must be set as well."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { forProvider+: { identity+: { type: type } } } },
      },
      '#withLocation':: d.fn(help='"Specifies the Azure Region where the Healthcare DICOM Service should be created. Changing this forces a new Healthcare DICOM Service to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Whether to enabled public networks when data plane traffic coming from public networks while private endpoint is enabled. Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Healthcare DICOM Service."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Healthcare DICOM Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withWorkspaceId':: d.fn(help='"Specifies the id of the Healthcare Workspace where the Healthcare DICOM Service should exist. Changing this forces a new Healthcare DICOM Service to be created."', args=[d.arg(name='workspaceId', type=d.T.string)]),
