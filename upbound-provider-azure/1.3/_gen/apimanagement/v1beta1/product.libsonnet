{
  ...
  '#':: d.pkg(name='product', url='', help='"Product is the Schema for the Products API. Manages an API Management Product."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApprovalRequired':: d.fn(help='"Do subscribers need to be approved prior to being able to use the Product?"', args=[d.arg(name='approvalRequired', type=d.T.boolean)]),
      withApprovalRequired(approvalRequired): { spec+: { forProvider+: { approvalRequired: approvalRequired } } },
      '#withDescription':: d.fn(help='"A description of this Product, which may include HTML formatting tags."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The Display Name for this API Management Product."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withPublished':: d.fn(help='"Is this Product Published?"', args=[d.arg(name='published', type=d.T.boolean)]),
      withPublished(published): { spec+: { forProvider+: { published: published } } },
      ...
      '#withSubscriptionRequired':: d.fn(help="\"Is a Subscription required to access API's included in this Product? Defaults to true.\"", args=[d.arg(name='subscriptionRequired', type=d.T.boolean)]),
      withSubscriptionRequired(subscriptionRequired): { spec+: { forProvider+: { subscriptionRequired: subscriptionRequired } } },
      '#withSubscriptionsLimit':: d.fn(help='"The number of subscriptions a user can have to this Product at the same time."', args=[d.arg(name='subscriptionsLimit', type=d.T.number)]),
      withSubscriptionsLimit(subscriptionsLimit): { spec+: { forProvider+: { subscriptionsLimit: subscriptionsLimit } } },
      '#withTerms':: d.fn(help='"The Terms and Conditions for this Product, which must be accepted by Developers before they can begin the Subscription process."', args=[d.arg(name='terms', type=d.T.string)]),
      withTerms(terms): { spec+: { forProvider+: { terms: terms } } },
    },
    ...
    initProvider: {
      '#withApprovalRequired':: d.fn(help='"Do subscribers need to be approved prior to being able to use the Product?"', args=[d.arg(name='approvalRequired', type=d.T.boolean)]),
      withApprovalRequired(approvalRequired): { spec+: { initProvider+: { approvalRequired: approvalRequired } } },
      '#withDescription':: d.fn(help='"A description of this Product, which may include HTML formatting tags."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withPublished':: d.fn(help='"Is this Product Published?"', args=[d.arg(name='published', type=d.T.boolean)]),
      withPublished(published): { spec+: { initProvider+: { published: published } } },
      '#withSubscriptionRequired':: d.fn(help="\"Is a Subscription required to access API's included in this Product? Defaults to true.\"", args=[d.arg(name='subscriptionRequired', type=d.T.boolean)]),
      withSubscriptionRequired(subscriptionRequired): { spec+: { initProvider+: { subscriptionRequired: subscriptionRequired } } },
      '#withSubscriptionsLimit':: d.fn(help='"The number of subscriptions a user can have to this Product at the same time."', args=[d.arg(name='subscriptionsLimit', type=d.T.number)]),
      withSubscriptionsLimit(subscriptionsLimit): { spec+: { initProvider+: { subscriptionsLimit: subscriptionsLimit } } },
      '#withTerms':: d.fn(help='"The Terms and Conditions for this Product, which must be accepted by Developers before they can begin the Subscription process."', args=[d.arg(name='terms', type=d.T.string)]),
      withTerms(terms): { spec+: { initProvider+: { terms: terms } } },
    },
