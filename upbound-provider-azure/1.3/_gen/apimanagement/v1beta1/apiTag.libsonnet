{
  ...
  '#':: d.pkg(name='apiTag', url='', help='"APITag is the Schema for the APITags API. Manages an API Management API Tag."'),
  ...
  '#new':: d.fn(help='new returns an instance of APITag', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APITagSpec defines the desired state of APITag"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiId':: d.fn(help='"The ID of the API Management API. Changing this forces a new API Management API Tag to be created."', args=[d.arg(name='apiId', type=d.T.string)]),
