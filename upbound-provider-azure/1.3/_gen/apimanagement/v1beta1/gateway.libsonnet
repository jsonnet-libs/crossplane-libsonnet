{
  ...
  '#':: d.pkg(name='gateway', url='', help='"Gateway is the Schema for the Gateways API. Manages an API Management Gateway."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#locationData':: d.obj(help='"A location_data block as documented below."'),
      locationData: {
        '#withCity':: d.fn(help='"The city or locality where the resource is located."', args=[d.arg(name='city', type=d.T.string)]),
        withCity(city): { city: city },
        '#withDistrict':: d.fn(help='"The district, state, or province where the resource is located."', args=[d.arg(name='district', type=d.T.string)]),
        withDistrict(district): { district: district },
        '#withName':: d.fn(help='"A canonical name for the geographic or physical location."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRegion':: d.fn(help='"The country or region where the resource is located."', args=[d.arg(name='region', type=d.T.string)]),
        withRegion(region): { region: region },
      },
      '#withApiManagementId':: d.fn(help='"The ID of the API Management Resource in which the gateway will be created. Changing this forces a new API Management Gateway resource to be created."', args=[d.arg(name='apiManagementId', type=d.T.string)]),
      withApiManagementId(apiManagementId): { spec+: { forProvider+: { apiManagementId: apiManagementId } } },
      '#withDescription':: d.fn(help='"The description of the API Management Gateway."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLocationData':: d.fn(help='"A location_data block as documented below."', args=[d.arg(name='locationData', type=d.T.array)]),
      withLocationData(locationData): { spec+: { forProvider+: { locationData: if std.isArray(v=locationData) then locationData else [locationData] } } },
      '#withLocationDataMixin':: d.fn(help='"A location_data block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='locationData', type=d.T.array)]),
      withLocationDataMixin(locationData): { spec+: { forProvider+: { locationData+: if std.isArray(v=locationData) then locationData else [locationData] } } },
    },
    ...
    initProvider: {
      ...
      '#withLocationData':: d.fn(help='"A location_data block as documented below."', args=[d.arg(name='locationData', type=d.T.array)]),
      withLocationData(locationData): { spec+: { initProvider+: { locationData: if std.isArray(v=locationData) then locationData else [locationData] } } },
      '#withLocationDataMixin':: d.fn(help='"A location_data block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='locationData', type=d.T.array)]),
      withLocationDataMixin(locationData): { spec+: { initProvider+: { locationData+: if std.isArray(v=locationData) then locationData else [locationData] } } },
    },
