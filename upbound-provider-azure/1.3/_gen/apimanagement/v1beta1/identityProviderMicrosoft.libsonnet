{
  ...
  '#':: d.pkg(name='identityProviderMicrosoft', url='', help='"IdentityProviderMicrosoft is the Schema for the IdentityProviderMicrosofts API. Manages an API Management Microsoft Identity Provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of IdentityProviderMicrosoft', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IdentityProviderMicrosoftSpec defines the desired state of IdentityProviderMicrosoft"'),
  spec: {
    ...
    forProvider: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"Client secret of the Azure AD Application."'),
      ...
      '#withApiManagementName':: d.fn(help='"The Name of the API Management Service where this Microsoft Identity Provider should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withClientId':: d.fn(help='"Client Id of the Azure AD Application."', args=[d.arg(name='clientId', type=d.T.string)]),
