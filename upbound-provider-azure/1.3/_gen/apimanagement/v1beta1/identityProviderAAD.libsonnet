{
  ...
  '#':: d.pkg(name='identityProviderAAD', url='', help='"IdentityProviderAAD is the Schema for the IdentityProviderAADs API. Manages an API Management AAD Identity Provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of IdentityProviderAAD', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IdentityProviderAADSpec defines the desired state of IdentityProviderAAD"'),
  spec: {
    ...
    forProvider: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"Client secret of the Application in the AAD Identity Provider."'),
      ...
      '#withAllowedTenants':: d.fn(help='"List of allowed AAD Tenants."', args=[d.arg(name='allowedTenants', type=d.T.array)]),
      withAllowedTenants(allowedTenants): { spec+: { forProvider+: { allowedTenants: if std.isArray(v=allowedTenants) then allowedTenants else [allowedTenants] } } },
      '#withAllowedTenantsMixin':: d.fn(help='"List of allowed AAD Tenants."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedTenants', type=d.T.array)]),
      withAllowedTenantsMixin(allowedTenants): { spec+: { forProvider+: { allowedTenants+: if std.isArray(v=allowedTenants) then allowedTenants else [allowedTenants] } } },
      '#withApiManagementName':: d.fn(help='"The Name of the API Management Service where this AAD Identity Provider should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withClientId':: d.fn(help='"Client Id of the Application in the AAD Identity Provider."', args=[d.arg(name='clientId', type=d.T.string)]),
      ...
      '#withSigninTenant':: d.fn(help='"The AAD Tenant to use instead of Common when logging into Active Directory"', args=[d.arg(name='signinTenant', type=d.T.string)]),
      withSigninTenant(signinTenant): { spec+: { forProvider+: { signinTenant: signinTenant } } },
    },
    ...
    initProvider: {
      ...
      '#withAllowedTenants':: d.fn(help='"List of allowed AAD Tenants."', args=[d.arg(name='allowedTenants', type=d.T.array)]),
      withAllowedTenants(allowedTenants): { spec+: { initProvider+: { allowedTenants: if std.isArray(v=allowedTenants) then allowedTenants else [allowedTenants] } } },
      '#withAllowedTenantsMixin':: d.fn(help='"List of allowed AAD Tenants."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedTenants', type=d.T.array)]),
      withAllowedTenantsMixin(allowedTenants): { spec+: { initProvider+: { allowedTenants+: if std.isArray(v=allowedTenants) then allowedTenants else [allowedTenants] } } },
      '#withClientId':: d.fn(help='"Client Id of the Application in the AAD Identity Provider."', args=[d.arg(name='clientId', type=d.T.string)]),
      withClientId(clientId): { spec+: { initProvider+: { clientId: clientId } } },
      '#withSigninTenant':: d.fn(help='"The AAD Tenant to use instead of Common when logging into Active Directory"', args=[d.arg(name='signinTenant', type=d.T.string)]),
      withSigninTenant(signinTenant): { spec+: { initProvider+: { signinTenant: signinTenant } } },
    },
