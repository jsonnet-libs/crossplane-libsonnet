{
  ...
  '#':: d.pkg(name='gatewayAPI', url='', help='"GatewayAPI is the Schema for the GatewayAPIs API. Manages a API Management Gateway API."'),
  ...
  '#new':: d.fn(help='new returns an instance of GatewayAPI', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GatewayAPISpec defines the desired state of GatewayAPI"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#apiIdRef':: d.obj(help='"Reference to a API in apimanagement to populate apiId."'),
      apiIdRef: {
      ...
      '#apiIdSelector':: d.obj(help='"Selector for a API in apimanagement to populate apiId."'),
      apiIdSelector: {
      ...
      '#gatewayIdRef':: d.obj(help='"Reference to a Gateway in apimanagement to populate gatewayId."'),
      gatewayIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#gatewayIdSelector':: d.obj(help='"Selector for a Gateway in apimanagement to populate gatewayId."'),
      gatewayIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withApiId':: d.fn(help='"The Identifier of the API Management API within the API Management Service. Changing this forces a new API Management Gateway API to be created."', args=[d.arg(name='apiId', type=d.T.string)]),
      withApiId(apiId): { spec+: { forProvider+: { apiId: apiId } } },
      '#withGatewayId':: d.fn(help='"The Identifier for the API Management Gateway. Changing this forces a new API Management Gateway API to be created."', args=[d.arg(name='gatewayId', type=d.T.string)]),
