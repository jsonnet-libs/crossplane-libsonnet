{
  ...
  '#':: d.pkg(name='identityProviderGoogle', url='', help='"IdentityProviderGoogle is the Schema for the IdentityProviderGoogles API. Manages an API Management Google Identity Provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of IdentityProviderGoogle', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IdentityProviderGoogleSpec defines the desired state of IdentityProviderGoogle"'),
  spec: {
    ...
    forProvider: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"Client secret for Google Sign-in."'),
      ...
      '#withApiManagementName':: d.fn(help='"The Name of the API Management Service where this Google Identity Provider should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withClientId':: d.fn(help='"Client Id for Google Sign-in."', args=[d.arg(name='clientId', type=d.T.string)]),
