{
  ...
  '#':: d.pkg(name='productPolicy', url='', help='"ProductPolicy is the Schema for the ProductPolicys API. Manages an API Management Product Policy"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProductPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProductPolicySpec defines the desired state of ProductPolicy"'),
  spec: {
