{
  ...
  '#':: d.pkg(name='productAPI', url='', help='"ProductAPI is the Schema for the ProductAPIs API. Manages an API Management API Assignment to a Product."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProductAPI', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProductAPISpec defines the desired state of ProductAPI"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiName':: d.fn(help='"The Name of the API Management API within the API Management Service. Changing this forces a new resource to be created."', args=[d.arg(name='apiName', type=d.T.string)]),
      withApiName(apiName): { spec+: { forProvider+: { apiName: apiName } } },
      '#withProductId':: d.fn(help='"The ID of the API Management Product within the API Management Service. Changing this forces a new resource to be created."', args=[d.arg(name='productId', type=d.T.string)]),
