{
  ...
  '#':: d.pkg(name='openIDConnectProvider', url='', help='"OpenIDConnectProvider is the Schema for the OpenIDConnectProviders API. Manages an OpenID Connect Provider within a API Management Service."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#clientIdSecretRef':: d.obj(help='"The Client ID used for the Client Application."'),
      clientIdSecretRef: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"The Client Secret used for the Client Application."'),
      ...
      '#withApiManagementName':: d.fn(help='"The name of the API Management Service in which this OpenID Connect Provider should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withDescription':: d.fn(help='"A description of this OpenID Connect Provider."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"A user-friendly name for this OpenID Connect Provider."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withMetadataEndpoint':: d.fn(help='"The URI of the Metadata endpoint."', args=[d.arg(name='metadataEndpoint', type=d.T.string)]),
      withMetadataEndpoint(metadataEndpoint): { spec+: { forProvider+: { metadataEndpoint: metadataEndpoint } } },
    ...
    initProvider: {
      ...
      '#withMetadataEndpoint':: d.fn(help='"The URI of the Metadata endpoint."', args=[d.arg(name='metadataEndpoint', type=d.T.string)]),
      withMetadataEndpoint(metadataEndpoint): { spec+: { initProvider+: { metadataEndpoint: metadataEndpoint } } },
    },
