{
  ...
  '#':: d.pkg(name='namedValue', url='', help='"NamedValue is the Schema for the NamedValues API. Manages an API Management Named Value."'),
  ...
  '#new':: d.fn(help='new returns an instance of NamedValue', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NamedValueSpec defines the desired state of NamedValue"'),
  spec: {
    ...
    forProvider: {
      ...
      '#valueFromKeyVault':: d.obj(help='"A value_from_key_vault block as defined below."'),
      valueFromKeyVault: {
        '#withIdentityClientId':: d.fn(help='"The client ID of User Assigned Identity, for the API Management Service, which will be used to access the key vault secret. The System Assigned Identity will be used in absence."', args=[d.arg(name='identityClientId', type=d.T.string)]),
        withIdentityClientId(identityClientId): { identityClientId: identityClientId },
        '#withSecretId':: d.fn(help='"The resource ID of the Key Vault Secret."', args=[d.arg(name='secretId', type=d.T.string)]),
        withSecretId(secretId): { secretId: secretId },
      },
      '#valueSecretRef':: d.obj(help='"The value of this API Management Named Value."'),
      valueSecretRef: {
      ...
      '#withApiManagementName':: d.fn(help='"The name of the API Management Service in which the API Management Named Value should exist. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withDisplayName':: d.fn(help='"The display name of this API Management Named Value."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the API Management Named Value should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSecret':: d.fn(help='"Specifies whether the API Management Named Value is secret. Valid values are true or false. The default value is false."', args=[d.arg(name='secret', type=d.T.boolean)]),
      withSecret(secret): { spec+: { forProvider+: { secret: secret } } },
      '#withTags':: d.fn(help='"A list of tags to be applied to the API Management Named Value."', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help='"A list of tags to be applied to the API Management Named Value."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.array)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: if std.isArray(v=tags) then tags else [tags] } } },
      '#withValueFromKeyVault':: d.fn(help='"A value_from_key_vault block as defined below."', args=[d.arg(name='valueFromKeyVault', type=d.T.array)]),
      withValueFromKeyVault(valueFromKeyVault): { spec+: { forProvider+: { valueFromKeyVault: if std.isArray(v=valueFromKeyVault) then valueFromKeyVault else [valueFromKeyVault] } } },
      '#withValueFromKeyVaultMixin':: d.fn(help='"A value_from_key_vault block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='valueFromKeyVault', type=d.T.array)]),
      withValueFromKeyVaultMixin(valueFromKeyVault): { spec+: { forProvider+: { valueFromKeyVault+: if std.isArray(v=valueFromKeyVault) then valueFromKeyVault else [valueFromKeyVault] } } },
    },
    ...
    initProvider: {
      ...
      '#withSecret':: d.fn(help='"Specifies whether the API Management Named Value is secret. Valid values are true or false. The default value is false."', args=[d.arg(name='secret', type=d.T.boolean)]),
      withSecret(secret): { spec+: { initProvider+: { secret: secret } } },
      '#withTags':: d.fn(help='"A list of tags to be applied to the API Management Named Value."', args=[d.arg(name='tags', type=d.T.array)]),
      ...
      '#withValueFromKeyVault':: d.fn(help='"A value_from_key_vault block as defined below."', args=[d.arg(name='valueFromKeyVault', type=d.T.array)]),
      withValueFromKeyVault(valueFromKeyVault): { spec+: { initProvider+: { valueFromKeyVault: if std.isArray(v=valueFromKeyVault) then valueFromKeyVault else [valueFromKeyVault] } } },
      '#withValueFromKeyVaultMixin':: d.fn(help='"A value_from_key_vault block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='valueFromKeyVault', type=d.T.array)]),
      withValueFromKeyVaultMixin(valueFromKeyVault): { spec+: { initProvider+: { valueFromKeyVault+: if std.isArray(v=valueFromKeyVault) then valueFromKeyVault else [valueFromKeyVault] } } },
    },
