{
  ...
  '#':: d.pkg(name='notificationRecipientEmail', url='', help='"NotificationRecipientEmail is the Schema for the NotificationRecipientEmails API. Manages a API Management Notification Recipient Email."'),
  ...
  '#new':: d.fn(help='new returns an instance of NotificationRecipientEmail', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NotificationRecipientEmailSpec defines the desired state of NotificationRecipientEmail"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiManagementId':: d.fn(help='"The ID of the API Management Service from which to create this Notification Recipient Email. Changing this forces a new API Management Notification Recipient Email to be created."', args=[d.arg(name='apiManagementId', type=d.T.string)]),
      withApiManagementId(apiManagementId): { spec+: { forProvider+: { apiManagementId: apiManagementId } } },
      '#withEmail':: d.fn(help='"The recipient email address. Changing this forces a new API Management Notification Recipient Email to be created."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withNotificationType':: d.fn(help='"The Notification Name to be received. Changing this forces a new API Management Notification Recipient Email to be created. Possible values are AccountClosedPublisher, BCC, NewApplicationNotificationMessage, NewIssuePublisherNotificationMessage, PurchasePublisherNotificationMessage, QuotaLimitApproachingPublisherNotificationMessage, and RequestPublisherNotificationMessage."', args=[d.arg(name='notificationType', type=d.T.string)]),
