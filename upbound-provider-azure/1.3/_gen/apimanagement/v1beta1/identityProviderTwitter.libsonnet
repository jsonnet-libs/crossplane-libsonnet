{
  ...
  '#':: d.pkg(name='identityProviderTwitter', url='', help='"IdentityProviderTwitter is the Schema for the IdentityProviderTwitters API. Manages an API Management Twitter Identity Provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of IdentityProviderTwitter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IdentityProviderTwitterSpec defines the desired state of IdentityProviderTwitter"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#apiKeySecretRef':: d.obj(help='"App Consumer API key for Twitter."'),
      apiKeySecretRef: {
      ...
      '#apiSecretKeySecretRef':: d.obj(help='"App Consumer API secret key for Twitter."'),
      apiSecretKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { apiSecretKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { apiSecretKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { apiSecretKeySecretRef+: { namespace: namespace } } } },
      },
      ...
      '#withApiManagementName':: d.fn(help='"The Name of the API Management Service where this Twitter Identity Provider should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      apiSecretKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { apiSecretKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { apiSecretKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { apiSecretKeySecretRef+: { namespace: namespace } } } },
      },
      '#resourceGroupNameRef':: d.obj(help='"Reference to a ResourceGroup in azure to populate resourceGroupName."'),
      resourceGroupNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
