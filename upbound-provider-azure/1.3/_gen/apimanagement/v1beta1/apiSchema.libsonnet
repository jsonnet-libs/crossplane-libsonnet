{
  ...
  '#':: d.pkg(name='apiSchema', url='', help='"APISchema is the Schema for the APISchemas API. Manages an API Schema within an API Management Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of APISchema', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APISchemaSpec defines the desired state of APISchema"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiName':: d.fn(help='"The name of the API within the API Management Service where this API Schema should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiName', type=d.T.string)]),
      withApiName(apiName): { spec+: { forProvider+: { apiName: apiName } } },
      '#withComponents':: d.fn(help='"Types definitions. Used for Swagger/OpenAPI v2/v3 schemas only."', args=[d.arg(name='components', type=d.T.string)]),
      withComponents(components): { spec+: { forProvider+: { components: components } } },
      '#withContentType':: d.fn(help='"The content type of the API Schema."', args=[d.arg(name='contentType', type=d.T.string)]),
      withContentType(contentType): { spec+: { forProvider+: { contentType: contentType } } },
      '#withDefinitions':: d.fn(help='"Types definitions. Used for Swagger/OpenAPI v1 schemas only."', args=[d.arg(name='definitions', type=d.T.string)]),
      withDefinitions(definitions): { spec+: { forProvider+: { definitions: definitions } } },
      ...
      '#withValue':: d.fn(help='"The JSON escaped string defining the document representing the Schema."', args=[d.arg(name='value', type=d.T.string)]),
    ...
    initProvider: {
      '#withComponents':: d.fn(help='"Types definitions. Used for Swagger/OpenAPI v2/v3 schemas only."', args=[d.arg(name='components', type=d.T.string)]),
      withComponents(components): { spec+: { initProvider+: { components: components } } },
      '#withContentType':: d.fn(help='"The content type of the API Schema."', args=[d.arg(name='contentType', type=d.T.string)]),
      withContentType(contentType): { spec+: { initProvider+: { contentType: contentType } } },
      '#withDefinitions':: d.fn(help='"Types definitions. Used for Swagger/OpenAPI v1 schemas only."', args=[d.arg(name='definitions', type=d.T.string)]),
      withDefinitions(definitions): { spec+: { initProvider+: { definitions: definitions } } },
      '#withValue':: d.fn(help='"The JSON escaped string defining the document representing the Schema."', args=[d.arg(name='value', type=d.T.string)]),
