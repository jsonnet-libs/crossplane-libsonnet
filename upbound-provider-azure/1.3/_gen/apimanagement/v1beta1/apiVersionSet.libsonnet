{
  ...
  '#':: d.pkg(name='apiVersionSet', url='', help='"APIVersionSet is the Schema for the APIVersionSets API. Manages an API Version Set within an API Management Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of APIVersionSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APIVersionSetSpec defines the desired state of APIVersionSet"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiManagementName':: d.fn(help='"The name of the API Management Service in which the API Version Set should exist. May only contain alphanumeric characters and dashes up to 50 characters in length. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withDescription':: d.fn(help='"The description of API Version Set."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name of this API Version Set."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the parent API Management Service exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withVersionHeaderName':: d.fn(help='"The name of the Header which should be read from Inbound Requests which defines the API Version."', args=[d.arg(name='versionHeaderName', type=d.T.string)]),
      withVersionHeaderName(versionHeaderName): { spec+: { forProvider+: { versionHeaderName: versionHeaderName } } },
      '#withVersionQueryName':: d.fn(help='"The name of the Query String which should be read from Inbound Requests which defines the API Version."', args=[d.arg(name='versionQueryName', type=d.T.string)]),
      withVersionQueryName(versionQueryName): { spec+: { forProvider+: { versionQueryName: versionQueryName } } },
      '#withVersioningScheme':: d.fn(help='"Specifies where in an Inbound HTTP Request that the API Version should be read from. Possible values are Header, Query and Segment."', args=[d.arg(name='versioningScheme', type=d.T.string)]),
      withVersioningScheme(versioningScheme): { spec+: { forProvider+: { versioningScheme: versioningScheme } } },
    },
    ...
    initProvider: {
      ...
      '#withVersionHeaderName':: d.fn(help='"The name of the Header which should be read from Inbound Requests which defines the API Version."', args=[d.arg(name='versionHeaderName', type=d.T.string)]),
      withVersionHeaderName(versionHeaderName): { spec+: { initProvider+: { versionHeaderName: versionHeaderName } } },
      '#withVersionQueryName':: d.fn(help='"The name of the Query String which should be read from Inbound Requests which defines the API Version."', args=[d.arg(name='versionQueryName', type=d.T.string)]),
      withVersionQueryName(versionQueryName): { spec+: { initProvider+: { versionQueryName: versionQueryName } } },
      '#withVersioningScheme':: d.fn(help='"Specifies where in an Inbound HTTP Request that the API Version should be read from. Possible values are Header, Query and Segment."', args=[d.arg(name='versioningScheme', type=d.T.string)]),
      withVersioningScheme(versioningScheme): { spec+: { initProvider+: { versioningScheme: versioningScheme } } },
    },
