{
  ...
  '#':: d.pkg(name='user', url='', help='"User is the Schema for the Users API. Manages an API Management User."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#passwordSecretRef':: d.obj(help='"The password associated with this user."'),
      passwordSecretRef: {
      ...
      '#withApiManagementName':: d.fn(help='"The name of the API Management Service in which the User should be created. Changing this forces a new resource to be created."', args=[d.arg(name='apiManagementName', type=d.T.string)]),
      withApiManagementName(apiManagementName): { spec+: { forProvider+: { apiManagementName: apiManagementName } } },
      '#withConfirmation':: d.fn(help='"The kind of confirmation email which will be sent to this user. Possible values are invite and signup. Changing this forces a new resource to be created."', args=[d.arg(name='confirmation', type=d.T.string)]),
      withConfirmation(confirmation): { spec+: { forProvider+: { confirmation: confirmation } } },
      '#withEmail':: d.fn(help='"The email address associated with this user."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withFirstName':: d.fn(help='"The first name for this user."', args=[d.arg(name='firstName', type=d.T.string)]),
      withFirstName(firstName): { spec+: { forProvider+: { firstName: firstName } } },
      '#withLastName':: d.fn(help='"The last name for this user."', args=[d.arg(name='lastName', type=d.T.string)]),
      withLastName(lastName): { spec+: { forProvider+: { lastName: lastName } } },
      '#withNote':: d.fn(help='"A note about this user."', args=[d.arg(name='note', type=d.T.string)]),
      withNote(note): { spec+: { forProvider+: { note: note } } },
      ...
      '#withState':: d.fn(help='"The state of this user. Possible values are active, blocked and pending."', args=[d.arg(name='state', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withConfirmation':: d.fn(help='"The kind of confirmation email which will be sent to this user. Possible values are invite and signup. Changing this forces a new resource to be created."', args=[d.arg(name='confirmation', type=d.T.string)]),
      withConfirmation(confirmation): { spec+: { initProvider+: { confirmation: confirmation } } },
      '#withEmail':: d.fn(help='"The email address associated with this user."', args=[d.arg(name='email', type=d.T.string)]),
      ...
      '#withNote':: d.fn(help='"A note about this user."', args=[d.arg(name='note', type=d.T.string)]),
      withNote(note): { spec+: { initProvider+: { note: note } } },
      '#withState':: d.fn(help='"The state of this user. Possible values are active, blocked and pending."', args=[d.arg(name='state', type=d.T.string)]),
