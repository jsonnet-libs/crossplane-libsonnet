{
  ...
  '#':: d.pkg(name='apiPolicy', url='', help='"APIPolicy is the Schema for the APIPolicys API. Manages an API Management API Policy"'),
  ...
  '#new':: d.fn(help='new returns an instance of APIPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APIPolicySpec defines the desired state of APIPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withApiName':: d.fn(help='"The ID of the API Management API within the API Management Service. Changing this forces a new resource to be created."', args=[d.arg(name='apiName', type=d.T.string)]),
      ...
      '#withXmlContent':: d.fn(help='"The XML Content for this Policy as a string."', args=[d.arg(name='xmlContent', type=d.T.string)]),
