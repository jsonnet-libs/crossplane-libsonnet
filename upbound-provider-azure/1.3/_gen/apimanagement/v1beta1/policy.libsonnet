{
  ...
  '#':: d.pkg(name='policy', url='', help='"Policy is the Schema for the Policys API. Manages a API Management service Policy."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiManagementId':: d.fn(help='"The ID of the API Management service. Changing this forces a new API Management service Policy to be created."', args=[d.arg(name='apiManagementId', type=d.T.string)]),
