  ...
  spec: {
    ...
    forProvider: {
      ...
      valueFromKeyVault: {
        ...
        withIdentityClientId(identityClientId): { spec+: { forProvider+: { valueFromKeyVault+: { identityClientId: identityClientId } } } },
        '#withSecretId':: d.fn(help='"The resource ID of the Key Vault Secret."', args=[d.arg(name='secretId', type=d.T.string)]),
        withSecretId(secretId): { spec+: { forProvider+: { valueFromKeyVault+: { secretId: secretId } } } },
      },
    ...
    initProvider: {
      ...
      valueFromKeyVault: {
        '#withIdentityClientId':: d.fn(help='"The client ID of User Assigned Identity, for the API Management Service, which will be used to access the key vault secret. The System Assigned Identity will be used in absence."', args=[d.arg(name='identityClientId', type=d.T.string)]),
        withIdentityClientId(identityClientId): { spec+: { initProvider+: { valueFromKeyVault+: { identityClientId: identityClientId } } } },
        '#withSecretId':: d.fn(help='"The resource ID of the Key Vault Secret."', args=[d.arg(name='secretId', type=d.T.string)]),
        withSecretId(secretId): { spec+: { initProvider+: { valueFromKeyVault+: { secretId: secretId } } } },
      },
      '#valueSecretRef':: d.obj(help='"The value of this API Management Named Value."'),
      valueSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
