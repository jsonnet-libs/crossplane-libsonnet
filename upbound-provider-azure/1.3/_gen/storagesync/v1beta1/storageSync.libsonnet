{
  ...
  '#':: d.pkg(name='storageSync', url='', help='"StorageSync is the Schema for the StorageSyncs API. Manages a Storage Sync."'),
  ...
  '#new':: d.fn(help='new returns an instance of StorageSync', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"StorageSyncSpec defines the desired state of StorageSync"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIncomingTrafficPolicy':: d.fn(help='"Incoming traffic policy. Possible values are AllowAllTraffic and AllowVirtualNetworksOnly. Defaults to AllowAllTraffic."', args=[d.arg(name='incomingTrafficPolicy', type=d.T.string)]),
      withIncomingTrafficPolicy(incomingTrafficPolicy): { spec+: { forProvider+: { incomingTrafficPolicy: incomingTrafficPolicy } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Storage Sync should exist. Changing this forces a new Storage Sync to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Storage Sync should exist. Changing this forces a new Storage Sync to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Storage Sync."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Storage Sync."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      '#withIncomingTrafficPolicy':: d.fn(help='"Incoming traffic policy. Possible values are AllowAllTraffic and AllowVirtualNetworksOnly. Defaults to AllowAllTraffic."', args=[d.arg(name='incomingTrafficPolicy', type=d.T.string)]),
      withIncomingTrafficPolicy(incomingTrafficPolicy): { spec+: { initProvider+: { incomingTrafficPolicy: incomingTrafficPolicy } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Storage Sync should exist. Changing this forces a new Storage Sync to be created."', args=[d.arg(name='location', type=d.T.string)]),
