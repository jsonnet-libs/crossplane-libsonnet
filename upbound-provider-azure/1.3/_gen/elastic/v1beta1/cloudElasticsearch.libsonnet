  ...
  spec: {
    ...
    forProvider: {
      ...
      logs: {
        ...
        withFilteringTag(filteringTag): { filteringTag: if std.isArray(v=filteringTag) then filteringTag else [filteringTag] },
        ...
        withFilteringTagMixin(filteringTag): { filteringTag+: if std.isArray(v=filteringTag) then filteringTag else [filteringTag] },
        ...
        withSendActivityLogs(sendActivityLogs): { sendActivityLogs: sendActivityLogs },
        ...
        withSendAzureadLogs(sendAzureadLogs): { sendAzureadLogs: sendAzureadLogs },
        ...
        withSendSubscriptionLogs(sendSubscriptionLogs): { sendSubscriptionLogs: sendSubscriptionLogs },
      },
