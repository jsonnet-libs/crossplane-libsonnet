{
  ...
  '#':: d.pkg(name='cloudElasticsearch', url='', help='"CloudElasticsearch is the Schema for the CloudElasticsearchs API. Manages an Elasticsearch cluster in Elastic Cloud."'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudElasticsearch', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CloudElasticsearchSpec defines the desired state of CloudElasticsearch"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#logs':: d.obj(help='"A logs block as defined below."'),
      logs: {
        '#filteringTag':: d.obj(help='"A list of filtering_tag blocks as defined above."'),
        filteringTag: {
          '#withAction':: d.fn(help='"Specifies the type of action which should be taken when the Tag matches the name and value. Possible values are Exclude and Include."', args=[d.arg(name='action', type=d.T.string)]),
          withAction(action): { action: action },
          '#withName':: d.fn(help='"The name which should be used for this Elasticsearch resource. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
          '#withValue':: d.fn(help='"Specifies the value of the Tag which should be filtered."', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { value: value },
        },
        '#withFilteringTag':: d.fn(help='"A list of filtering_tag blocks as defined above."', args=[d.arg(name='filteringTag', type=d.T.array)]),
        withFilteringTag(filteringTag): { spec+: { forProvider+: { logs+: { filteringTag: if std.isArray(v=filteringTag) then filteringTag else [filteringTag] } } } },
        '#withFilteringTagMixin':: d.fn(help='"A list of filtering_tag blocks as defined above."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='filteringTag', type=d.T.array)]),
        withFilteringTagMixin(filteringTag): { spec+: { forProvider+: { logs+: { filteringTag+: if std.isArray(v=filteringTag) then filteringTag else [filteringTag] } } } },
        '#withSendActivityLogs':: d.fn(help='"Specifies if the Azure Activity Logs should be sent to the Elasticsearch cluster. Defaults to false."', args=[d.arg(name='sendActivityLogs', type=d.T.boolean)]),
        withSendActivityLogs(sendActivityLogs): { spec+: { forProvider+: { logs+: { sendActivityLogs: sendActivityLogs } } } },
        '#withSendAzureadLogs':: d.fn(help='"Specifies if the AzureAD Logs should be sent to the Elasticsearch cluster. Defaults to false."', args=[d.arg(name='sendAzureadLogs', type=d.T.boolean)]),
        withSendAzureadLogs(sendAzureadLogs): { spec+: { forProvider+: { logs+: { sendAzureadLogs: sendAzureadLogs } } } },
        '#withSendSubscriptionLogs':: d.fn(help='"Specifies if the Azure Subscription Logs should be sent to the Elasticsearch cluster. Defaults to false."', args=[d.arg(name='sendSubscriptionLogs', type=d.T.boolean)]),
        withSendSubscriptionLogs(sendSubscriptionLogs): { spec+: { forProvider+: { logs+: { sendSubscriptionLogs: sendSubscriptionLogs } } } },
      },
      ...
      '#withElasticCloudEmailAddress':: d.fn(help='"Specifies the Email Address which should be associated with this Elasticsearch account. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='elasticCloudEmailAddress', type=d.T.string)]),
      withElasticCloudEmailAddress(elasticCloudEmailAddress): { spec+: { forProvider+: { elasticCloudEmailAddress: elasticCloudEmailAddress } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Elasticsearch resource should exist. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withMonitoringEnabled':: d.fn(help='"Specifies if the Elasticsearch should have monitoring configured? Defaults to true. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='monitoringEnabled', type=d.T.boolean)]),
      withMonitoringEnabled(monitoringEnabled): { spec+: { forProvider+: { monitoringEnabled: monitoringEnabled } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Elasticsearch resource should exist. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"Specifies the name of the SKU for this Elasticsearch. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Elasticsearch resource."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Elasticsearch resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      logs: {
        ...
        '#withFilteringTag':: d.fn(help='"A list of filtering_tag blocks as defined above."', args=[d.arg(name='filteringTag', type=d.T.array)]),
        withFilteringTag(filteringTag): { spec+: { initProvider+: { logs+: { filteringTag: if std.isArray(v=filteringTag) then filteringTag else [filteringTag] } } } },
        '#withFilteringTagMixin':: d.fn(help='"A list of filtering_tag blocks as defined above."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='filteringTag', type=d.T.array)]),
        withFilteringTagMixin(filteringTag): { spec+: { initProvider+: { logs+: { filteringTag+: if std.isArray(v=filteringTag) then filteringTag else [filteringTag] } } } },
        '#withSendActivityLogs':: d.fn(help='"Specifies if the Azure Activity Logs should be sent to the Elasticsearch cluster. Defaults to false."', args=[d.arg(name='sendActivityLogs', type=d.T.boolean)]),
        withSendActivityLogs(sendActivityLogs): { spec+: { initProvider+: { logs+: { sendActivityLogs: sendActivityLogs } } } },
        '#withSendAzureadLogs':: d.fn(help='"Specifies if the AzureAD Logs should be sent to the Elasticsearch cluster. Defaults to false."', args=[d.arg(name='sendAzureadLogs', type=d.T.boolean)]),
        withSendAzureadLogs(sendAzureadLogs): { spec+: { initProvider+: { logs+: { sendAzureadLogs: sendAzureadLogs } } } },
        '#withSendSubscriptionLogs':: d.fn(help='"Specifies if the Azure Subscription Logs should be sent to the Elasticsearch cluster. Defaults to false."', args=[d.arg(name='sendSubscriptionLogs', type=d.T.boolean)]),
        withSendSubscriptionLogs(sendSubscriptionLogs): { spec+: { initProvider+: { logs+: { sendSubscriptionLogs: sendSubscriptionLogs } } } },
      },
      '#withElasticCloudEmailAddress':: d.fn(help='"Specifies the Email Address which should be associated with this Elasticsearch account. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='elasticCloudEmailAddress', type=d.T.string)]),
      withElasticCloudEmailAddress(elasticCloudEmailAddress): { spec+: { initProvider+: { elasticCloudEmailAddress: elasticCloudEmailAddress } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Elasticsearch resource should exist. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withMonitoringEnabled':: d.fn(help='"Specifies if the Elasticsearch should have monitoring configured? Defaults to true. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='monitoringEnabled', type=d.T.boolean)]),
      withMonitoringEnabled(monitoringEnabled): { spec+: { initProvider+: { monitoringEnabled: monitoringEnabled } } },
      '#withSkuName':: d.fn(help='"Specifies the name of the SKU for this Elasticsearch. Changing this forces a new Elasticsearch to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
