{
  ...
  '#':: d.pkg(name='frontdoorRuleSet', url='', help='"FrontdoorRuleSet is the Schema for the FrontdoorRuleSets API. Manages a Front Door (standard/premium) Rule Set."'),
  ...
  '#new':: d.fn(help='new returns an instance of FrontdoorRuleSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FrontdoorRuleSetSpec defines the desired state of FrontdoorRuleSet"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCdnFrontdoorProfileId':: d.fn(help='"The ID of the Front Door Profile. Changing this forces a new Front Door Rule Set to be created."', args=[d.arg(name='cdnFrontdoorProfileId', type=d.T.string)]),
