{
  ...
  '#':: d.pkg(name='frontdoorProfile', url='', help='"FrontdoorProfile is the Schema for the FrontdoorProfiles API. Manages a Front Door (standard/premium) Profile."'),
  ...
  '#new':: d.fn(help='new returns an instance of FrontdoorProfile', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FrontdoorProfileSpec defines the desired state of FrontdoorProfile"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where this Front Door Profile should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withResponseTimeoutSeconds':: d.fn(help='"Specifies the maximum response timeout in seconds. Possible values are between 16 and 240 seconds (inclusive). Defaults to 120 seconds."', args=[d.arg(name='responseTimeoutSeconds', type=d.T.number)]),
      withResponseTimeoutSeconds(responseTimeoutSeconds): { spec+: { forProvider+: { responseTimeoutSeconds: responseTimeoutSeconds } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU for this Front Door Profile. Possible values include Standard_AzureFrontDoor and Premium_AzureFrontDoor. Changing this forces a new resource to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withTags':: d.fn(help='"Specifies a mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Specifies a mapping of tags to assign to the resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      '#withResponseTimeoutSeconds':: d.fn(help='"Specifies the maximum response timeout in seconds. Possible values are between 16 and 240 seconds (inclusive). Defaults to 120 seconds."', args=[d.arg(name='responseTimeoutSeconds', type=d.T.number)]),
      withResponseTimeoutSeconds(responseTimeoutSeconds): { spec+: { initProvider+: { responseTimeoutSeconds: responseTimeoutSeconds } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU for this Front Door Profile. Possible values include Standard_AzureFrontDoor and Premium_AzureFrontDoor. Changing this forces a new resource to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
