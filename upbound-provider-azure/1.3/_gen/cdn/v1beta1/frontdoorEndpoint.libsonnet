{
  ...
  '#':: d.pkg(name='frontdoorEndpoint', url='', help='"FrontdoorEndpoint is the Schema for the FrontdoorEndpoints API. Manages a Front Door (standard/premium) Endpoint."'),
  ...
  '#new':: d.fn(help='new returns an instance of FrontdoorEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FrontdoorEndpointSpec defines the desired state of FrontdoorEndpoint"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCdnFrontdoorProfileId':: d.fn(help='"The ID of the Front Door Profile within which this Front Door Endpoint should exist. Changing this forces a new Front Door Endpoint to be created."', args=[d.arg(name='cdnFrontdoorProfileId', type=d.T.string)]),
      withCdnFrontdoorProfileId(cdnFrontdoorProfileId): { spec+: { forProvider+: { cdnFrontdoorProfileId: cdnFrontdoorProfileId } } },
      '#withEnabled':: d.fn(help='"Specifies if this Front Door Endpoint is enabled? Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withTags':: d.fn(help='"Specifies a mapping of tags which should be assigned to the Front Door Endpoint."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Specifies a mapping of tags which should be assigned to the Front Door Endpoint."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
