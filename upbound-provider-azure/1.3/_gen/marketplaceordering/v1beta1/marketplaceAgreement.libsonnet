{
  ...
  '#':: d.pkg(name='marketplaceAgreement', url='', help='"MarketplaceAgreement is the Schema for the MarketplaceAgreements API. Allows accepting the Legal Terms for a Marketplace Image."'),
  ...
  '#new':: d.fn(help='new returns an instance of MarketplaceAgreement', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'marketplaceordering.azure.upbound.io/v1beta1',
    kind: 'MarketplaceAgreement',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'false',
  }),
  '#spec':: d.obj(help='"MarketplaceAgreementSpec defines the desired state of MarketplaceAgreement"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withOffer':: d.fn(help='"The Offer of the Marketplace Image. Changing this forces a new resource to be created."', args=[d.arg(name='offer', type=d.T.string)]),
      withOffer(offer): { spec+: { forProvider+: { offer: offer } } },
      '#withPlan':: d.fn(help='"The Plan of the Marketplace Image. Changing this forces a new resource to be created."', args=[d.arg(name='plan', type=d.T.string)]),
      withPlan(plan): { spec+: { forProvider+: { plan: plan } } },
      '#withPublisher':: d.fn(help='"The Publisher of the Marketplace Image. Changing this forces a new resource to be created."', args=[d.arg(name='publisher', type=d.T.string)]),
    ...
    initProvider: {
      '#withOffer':: d.fn(help='"The Offer of the Marketplace Image. Changing this forces a new resource to be created."', args=[d.arg(name='offer', type=d.T.string)]),
      withOffer(offer): { spec+: { initProvider+: { offer: offer } } },
      '#withPlan':: d.fn(help='"The Plan of the Marketplace Image. Changing this forces a new resource to be created."', args=[d.arg(name='plan', type=d.T.string)]),
      withPlan(plan): { spec+: { initProvider+: { plan: plan } } },
      '#withPublisher':: d.fn(help='"The Publisher of the Marketplace Image. Changing this forces a new resource to be created."', args=[d.arg(name='publisher', type=d.T.string)]),
