{
  ...
  '#':: d.pkg(name='monitor', url='', help='"Monitor is the Schema for the Monitors API. Manages a logz Monitor."'),
  ...
  '#new':: d.fn(help='new returns an instance of Monitor', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MonitorSpec defines the desired state of Monitor"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#plan':: d.obj(help='"A plan block as defined below. Changing this forces a new resource to be created."'),
      plan: {
        '#withBillingCycle':: d.fn(help='"Different billing cycles. Possible values are MONTHLY or WEEKLY. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='billingCycle', type=d.T.string)]),
        withBillingCycle(billingCycle): { billingCycle: billingCycle },
        '#withEffectiveDate':: d.fn(help='"Date when plan was applied. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='effectiveDate', type=d.T.string)]),
        withEffectiveDate(effectiveDate): { effectiveDate: effectiveDate },
        '#withPlanId':: d.fn(help='"Plan id as published by Logz. The only possible value is 100gb14days. Defaults to 100gb14days. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='planId', type=d.T.string)]),
        withPlanId(planId): { planId: planId },
        '#withUsageType':: d.fn(help='"Different usage types. Possible values are PAYG or COMMITTED. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='usageType', type=d.T.string)]),
        withUsageType(usageType): { usageType: usageType },
      },
      ...
      '#user':: d.obj(help='"A user block as defined below. Changing this forces a new resource to be created."'),
      user: {
        '#withEmail':: d.fn(help='"Email of the user used by Logz for contacting them if needed. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { email: email },
        '#withFirstName':: d.fn(help='"First Name of the user. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='firstName', type=d.T.string)]),
        withFirstName(firstName): { firstName: firstName },
        '#withLastName':: d.fn(help='"Last Name of the user. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='lastName', type=d.T.string)]),
        withLastName(lastName): { lastName: lastName },
        '#withPhoneNumber':: d.fn(help='"Phone number of the user used by Logz for contacting them if needed. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='phoneNumber', type=d.T.string)]),
        withPhoneNumber(phoneNumber): { phoneNumber: phoneNumber },
      },
      '#withCompanyName':: d.fn(help='"Name of the Logz organization. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='companyName', type=d.T.string)]),
      withCompanyName(companyName): { spec+: { forProvider+: { companyName: companyName } } },
      '#withEnabled':: d.fn(help='"Whether the resource monitoring is enabled? Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withEnterpriseAppId':: d.fn(help='"The ID of the Enterprise App. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='enterpriseAppId', type=d.T.string)]),
      withEnterpriseAppId(enterpriseAppId): { spec+: { forProvider+: { enterpriseAppId: enterpriseAppId } } },
      '#withLocation':: d.fn(help='"The Azure Region where the logz Monitor should exist. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the logz Monitor should exist. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the logz Monitor."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the logz Monitor."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withUser':: d.fn(help='"A user block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='user', type=d.T.array)]),
      withUser(user): { spec+: { forProvider+: { user: if std.isArray(v=user) then user else [user] } } },
      '#withUserMixin':: d.fn(help='"A user block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='user', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withEnterpriseAppId':: d.fn(help='"The ID of the Enterprise App. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='enterpriseAppId', type=d.T.string)]),
      withEnterpriseAppId(enterpriseAppId): { spec+: { initProvider+: { enterpriseAppId: enterpriseAppId } } },
      '#withLocation':: d.fn(help='"The Azure Region where the logz Monitor should exist. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='location', type=d.T.string)]),
