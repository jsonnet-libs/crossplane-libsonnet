{
  ...
  '#':: d.pkg(name='tagRule', url='', help='"TagRule is the Schema for the TagRules API. Manages a logz Tag Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of TagRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TagRuleSpec defines the desired state of TagRule"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#logzMonitorIdRef':: d.obj(help='"Reference to a Monitor in logz to populate logzMonitorId."'),
      logzMonitorIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { logzMonitorIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { logzMonitorIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { logzMonitorIdRef+: { name: name } } } },
      },
      '#logzMonitorIdSelector':: d.obj(help='"Selector for a Monitor in logz to populate logzMonitorId."'),
      logzMonitorIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { logzMonitorIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { logzMonitorIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { logzMonitorIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { logzMonitorIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { logzMonitorIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#tagFilter':: d.obj(help='"One or more (up to 10) tag_filter blocks as defined below."'),
      tagFilter: {
        '#withAction':: d.fn(help='"The action for a filtering tag. Possible values are Include and Exclude is allowed. Note that the Exclude takes priority over the Include."', args=[d.arg(name='action', type=d.T.string)]),
        withAction(action): { action: action },
        '#withName':: d.fn(help='"The name of this tag_filter."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"The value of this tag_filter."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withLogzMonitorId':: d.fn(help='"The ID of the Logz Monitor. Changing this forces a new logz Tag Rule to be created."', args=[d.arg(name='logzMonitorId', type=d.T.string)]),
      withLogzMonitorId(logzMonitorId): { spec+: { forProvider+: { logzMonitorId: logzMonitorId } } },
      ...
      '#withSendActivityLogs':: d.fn(help='"Whether activity logs from Azure resources should be sent to the Monitor resource?"', args=[d.arg(name='sendActivityLogs', type=d.T.boolean)]),
