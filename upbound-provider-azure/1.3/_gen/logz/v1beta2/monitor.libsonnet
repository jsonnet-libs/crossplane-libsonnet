  ...
  spec: {
    ...
    forProvider: {
      ...
      plan: {
        ...
        withBillingCycle(billingCycle): { spec+: { forProvider+: { plan+: { billingCycle: billingCycle } } } },
        ...
        withEffectiveDate(effectiveDate): { spec+: { forProvider+: { plan+: { effectiveDate: effectiveDate } } } },
        ...
        withPlanId(planId): { spec+: { forProvider+: { plan+: { planId: planId } } } },
        ...
        withUsageType(usageType): { spec+: { forProvider+: { plan+: { usageType: usageType } } } },
      },
      ...
      user: {
        ...
        withEmail(email): { spec+: { forProvider+: { user+: { email: email } } } },
        ...
        withFirstName(firstName): { spec+: { forProvider+: { user+: { firstName: firstName } } } },
        ...
        withLastName(lastName): { spec+: { forProvider+: { user+: { lastName: lastName } } } },
        ...
        withPhoneNumber(phoneNumber): { spec+: { forProvider+: { user+: { phoneNumber: phoneNumber } } } },
      },
    ...
    initProvider: {
      ...
      plan: {
        '#withBillingCycle':: d.fn(help='"Different billing cycles. Possible values are MONTHLY or WEEKLY. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='billingCycle', type=d.T.string)]),
        withBillingCycle(billingCycle): { spec+: { initProvider+: { plan+: { billingCycle: billingCycle } } } },
        '#withEffectiveDate':: d.fn(help='"Date when plan was applied. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='effectiveDate', type=d.T.string)]),
        withEffectiveDate(effectiveDate): { spec+: { initProvider+: { plan+: { effectiveDate: effectiveDate } } } },
        '#withPlanId':: d.fn(help='"Plan id as published by Logz. The only possible value is 100gb14days. Defaults to 100gb14days. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='planId', type=d.T.string)]),
        withPlanId(planId): { spec+: { initProvider+: { plan+: { planId: planId } } } },
        '#withUsageType':: d.fn(help='"Different usage types. Possible values are PAYG or COMMITTED. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='usageType', type=d.T.string)]),
        withUsageType(usageType): { spec+: { initProvider+: { plan+: { usageType: usageType } } } },
      },
      '#user':: d.obj(help='"A user block as defined below. Changing this forces a new resource to be created."'),
      user: {
        '#withEmail':: d.fn(help='"Email of the user used by Logz for contacting them if needed. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { spec+: { initProvider+: { user+: { email: email } } } },
        '#withFirstName':: d.fn(help='"First Name of the user. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='firstName', type=d.T.string)]),
        withFirstName(firstName): { spec+: { initProvider+: { user+: { firstName: firstName } } } },
        '#withLastName':: d.fn(help='"Last Name of the user. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='lastName', type=d.T.string)]),
        withLastName(lastName): { spec+: { initProvider+: { user+: { lastName: lastName } } } },
        '#withPhoneNumber':: d.fn(help='"Phone number of the user used by Logz for contacting them if needed. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='phoneNumber', type=d.T.string)]),
        withPhoneNumber(phoneNumber): { spec+: { initProvider+: { user+: { phoneNumber: phoneNumber } } } },
      },
      '#withCompanyName':: d.fn(help='"Name of the Logz organization. Changing this forces a new logz Monitor to be created."', args=[d.arg(name='companyName', type=d.T.string)]),
