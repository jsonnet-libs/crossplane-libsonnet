{
  ...
  '#':: d.pkg(name='subAccount', url='', help='"SubAccount is the Schema for the SubAccounts API. Manages a logz Sub Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of SubAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubAccountSpec defines the desired state of SubAccount"'),
  spec: {
    ...
    forProvider: {
      ...
      user: {
        '#withEmail':: d.fn(help='"Email of the user used by Logz for contacting them if needed. A valid email address consists of an email prefix and an email domain. The prefix and domain may contain only letters, numbers, underscores, periods and dashes. Changing this forces a new logz Sub Account to be created."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { spec+: { forProvider+: { user+: { email: email } } } },
        '#withFirstName':: d.fn(help='"First Name of the user. Possible values must be between 1 and 50 characters in length. Changing this forces a new logz Sub Account to be created."', args=[d.arg(name='firstName', type=d.T.string)]),
        withFirstName(firstName): { spec+: { forProvider+: { user+: { firstName: firstName } } } },
        '#withLastName':: d.fn(help='"Last Name of the user. Possible values must be between 1 and 50 characters in length. Changing this forces a new logz Sub Account to be created."', args=[d.arg(name='lastName', type=d.T.string)]),
        withLastName(lastName): { spec+: { forProvider+: { user+: { lastName: lastName } } } },
        '#withPhoneNumber':: d.fn(help='"Phone number of the user used by Logz for contacting them if needed. Possible values must be between 1 and 40 characters in length. Changing this forces a new logz Sub Account to be created."', args=[d.arg(name='phoneNumber', type=d.T.string)]),
      ...
      '#withLogzMonitorId':: d.fn(help='"The ID of the Logz Monitor. Changing this forces a new logz Sub Account to be created."', args=[d.arg(name='logzMonitorId', type=d.T.string)]),
      withLogzMonitorId(logzMonitorId): { spec+: { forProvider+: { logzMonitorId: logzMonitorId } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the logz Sub Account."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the logz Sub Account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
