{
  ...
  '#':: d.pkg(name='flexibleServerFirewallRule', url='', help='"FlexibleServerFirewallRule is the Schema for the FlexibleServerFirewallRules API. Manages a PostgreSQL Flexible Server Firewall Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of FlexibleServerFirewallRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FlexibleServerFirewallRuleSpec defines the desired state of FlexibleServerFirewallRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEndIpAddress':: d.fn(help='"The End IP Address associated with this PostgreSQL Flexible Server Firewall Rule."', args=[d.arg(name='endIpAddress', type=d.T.string)]),
      withEndIpAddress(endIpAddress): { spec+: { forProvider+: { endIpAddress: endIpAddress } } },
      '#withServerId':: d.fn(help='"The ID of the PostgreSQL Flexible Server from which to create this PostgreSQL Flexible Server Firewall Rule. Changing this forces a new PostgreSQL Flexible Server Firewall Rule to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
      withServerId(serverId): { spec+: { forProvider+: { serverId: serverId } } },
      '#withStartIpAddress':: d.fn(help='"The Start IP Address associated with this PostgreSQL Flexible Server Firewall Rule."', args=[d.arg(name='startIpAddress', type=d.T.string)]),
      withStartIpAddress(startIpAddress): { spec+: { forProvider+: { startIpAddress: startIpAddress } } },
    },
    ...
    initProvider: {
      '#withEndIpAddress':: d.fn(help='"The End IP Address associated with this PostgreSQL Flexible Server Firewall Rule."', args=[d.arg(name='endIpAddress', type=d.T.string)]),
      withEndIpAddress(endIpAddress): { spec+: { initProvider+: { endIpAddress: endIpAddress } } },
      '#withStartIpAddress':: d.fn(help='"The Start IP Address associated with this PostgreSQL Flexible Server Firewall Rule."', args=[d.arg(name='startIpAddress', type=d.T.string)]),
      withStartIpAddress(startIpAddress): { spec+: { initProvider+: { startIpAddress: startIpAddress } } },
    },
