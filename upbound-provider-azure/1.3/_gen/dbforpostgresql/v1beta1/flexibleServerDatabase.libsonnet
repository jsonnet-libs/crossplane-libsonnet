{
  ...
  '#':: d.pkg(name='flexibleServerDatabase', url='', help='"FlexibleServerDatabase is the Schema for the FlexibleServerDatabases API. Manages a PostgreSQL Flexible Server Database."'),
  ...
  '#new':: d.fn(help='new returns an instance of FlexibleServerDatabase', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FlexibleServerDatabaseSpec defines the desired state of FlexibleServerDatabase"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#serverIdRef':: d.obj(help='"Reference to a FlexibleServer in dbforpostgresql to populate serverId."'),
      serverIdRef: {
      ...
      '#serverIdSelector':: d.obj(help='"Selector for a FlexibleServer in dbforpostgresql to populate serverId."'),
      serverIdSelector: {
      ...
      '#withCharset':: d.fn(help='"Specifies the Charset for the Azure PostgreSQL Flexible Server Database, which needs to be a valid PostgreSQL Charset. Defaults to UTF8. Changing this forces a new Azure PostgreSQL Flexible Server Database to be created."', args=[d.arg(name='charset', type=d.T.string)]),
      withCharset(charset): { spec+: { forProvider+: { charset: charset } } },
      '#withCollation':: d.fn(help='"Specifies the Collation for the Azure PostgreSQL Flexible Server Database, which needs to be a valid PostgreSQL Collation. Defaults to en_US.utf8. Changing this forces a new Azure PostgreSQL Flexible Server Database to be created."', args=[d.arg(name='collation', type=d.T.string)]),
      withCollation(collation): { spec+: { forProvider+: { collation: collation } } },
      '#withServerId':: d.fn(help='"The ID of the Azure PostgreSQL Flexible Server from which to create this PostgreSQL Flexible Server Database. Changing this forces a new Azure PostgreSQL Flexible Server Database to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
