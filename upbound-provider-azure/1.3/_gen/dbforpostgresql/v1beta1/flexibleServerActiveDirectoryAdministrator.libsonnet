{
  ...
  '#':: d.pkg(name='flexibleServerActiveDirectoryAdministrator', url='', help='"FlexibleServerActiveDirectoryAdministrator is the Schema for the FlexibleServerActiveDirectoryAdministrators API. Manages an Active Directory administrator on a PostgreSQL Flexible server"'),
  ...
  '#new':: d.fn(help='new returns an instance of FlexibleServerActiveDirectoryAdministrator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FlexibleServerActiveDirectoryAdministratorSpec defines the desired state of FlexibleServerActiveDirectoryAdministrator"'),
  spec: {
    ...
    forProvider: {
      ...
      '#serverNameRef':: d.obj(help='"Reference to a FlexibleServer in dbforpostgresql to populate serverName."'),
      serverNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#serverNameSelector':: d.obj(help='"Selector for a FlexibleServer in dbforpostgresql to populate serverName."'),
      serverNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withObjectId':: d.fn(help='"The object ID of a user, service principal or security group in the Azure Active Directory tenant set as the Flexible Server Admin. Changing this forces a new resource to be created."', args=[d.arg(name='objectId', type=d.T.string)]),
      withObjectId(objectId): { spec+: { forProvider+: { objectId: objectId } } },
      '#withPrincipalName':: d.fn(help='"The name of Azure Active Directory principal. Changing this forces a new resource to be created."', args=[d.arg(name='principalName', type=d.T.string)]),
      withPrincipalName(principalName): { spec+: { forProvider+: { principalName: principalName } } },
      '#withPrincipalType':: d.fn(help='"The type of Azure Active Directory principal. Possible values are Group, ServicePrincipal and User. Changing this forces a new resource to be created."', args=[d.arg(name='principalType', type=d.T.string)]),
      withPrincipalType(principalType): { spec+: { forProvider+: { principalType: principalType } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group for the PostgreSQL Server. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServerName':: d.fn(help='"The name of the PostgreSQL Flexible Server on which to set the administrator. Changing this forces a new resource to be created."', args=[d.arg(name='serverName', type=d.T.string)]),
      withServerName(serverName): { spec+: { forProvider+: { serverName: serverName } } },
      '#withTenantId':: d.fn(help='"The Azure Tenant ID. Changing this forces a new resource to be created."', args=[d.arg(name='tenantId', type=d.T.string)]),
    ...
    initProvider: {
      '#withPrincipalName':: d.fn(help='"The name of Azure Active Directory principal. Changing this forces a new resource to be created."', args=[d.arg(name='principalName', type=d.T.string)]),
      withPrincipalName(principalName): { spec+: { initProvider+: { principalName: principalName } } },
      '#withPrincipalType':: d.fn(help='"The type of Azure Active Directory principal. Possible values are Group, ServicePrincipal and User. Changing this forces a new resource to be created."', args=[d.arg(name='principalType', type=d.T.string)]),
