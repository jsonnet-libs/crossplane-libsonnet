{
  ...
  '#':: d.pkg(name='serverKey', url='', help='"ServerKey is the Schema for the ServerKeys API. Manages a PostgreSQL Server Key."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServerKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServerKeySpec defines the desired state of ServerKey"'),
  spec: {
    ...
    forProvider: {
      ...
      '#serverIdRef':: d.obj(help='"Reference to a Server in dbforpostgresql to populate serverId."'),
      serverIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#serverIdSelector':: d.obj(help='"Selector for a Server in dbforpostgresql to populate serverId."'),
      serverIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withKeyVaultKeyId':: d.fn(help='"The URL to a Key Vault Key."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
      withKeyVaultKeyId(keyVaultKeyId): { spec+: { forProvider+: { keyVaultKeyId: keyVaultKeyId } } },
      '#withServerId':: d.fn(help='"The ID of the PostgreSQL Server. Changing this forces a new resource to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
