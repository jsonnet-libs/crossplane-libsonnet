{
  ...
  '#':: d.pkg(name='database', url='', help='"Database is the Schema for the Databases API. Manages a PostgreSQL Database within a PostgreSQL Server."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCharset':: d.fn(help='"Specifies the Charset for the PostgreSQL Database, which needs to be a valid PostgreSQL Charset. Changing this forces a new resource to be created."', args=[d.arg(name='charset', type=d.T.string)]),
      withCharset(charset): { spec+: { forProvider+: { charset: charset } } },
      '#withCollation':: d.fn(help='"Specifies the Collation for the PostgreSQL Database, which needs to be a valid PostgreSQL Collation. Note that Microsoft uses different notation - en-US instead of en_US. Changing this forces a new resource to be created."', args=[d.arg(name='collation', type=d.T.string)]),
