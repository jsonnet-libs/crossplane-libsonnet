{
  ...
  '#':: d.pkg(name='flexibleServerConfiguration', url='', help='"FlexibleServerConfiguration is the Schema for the FlexibleServerConfigurations API. Sets a PostgreSQL Configuration value on a Azure PostgreSQL Flexible Server."'),
  ...
  '#new':: d.fn(help='new returns an instance of FlexibleServerConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FlexibleServerConfigurationSpec defines the desired state of FlexibleServerConfiguration"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withServerId':: d.fn(help='"The ID of the PostgreSQL Flexible Server where we want to change configuration. Changing this forces a new PostgreSQL Flexible Server Configuration resource."', args=[d.arg(name='serverId', type=d.T.string)]),
      withServerId(serverId): { spec+: { forProvider+: { serverId: serverId } } },
      '#withValue':: d.fn(help='"Specifies the value of the PostgreSQL Configuration. See the PostgreSQL documentation for valid values."', args=[d.arg(name='value', type=d.T.string)]),
