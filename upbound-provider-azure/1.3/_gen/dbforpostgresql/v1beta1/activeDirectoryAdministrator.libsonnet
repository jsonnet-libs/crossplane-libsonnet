{
  ...
  '#':: d.pkg(name='activeDirectoryAdministrator', url='', help='"ActiveDirectoryAdministrator is the Schema for the ActiveDirectoryAdministrators API. Manages an Active Directory administrator on a PostgreSQL server"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withServerName':: d.fn(help='"The name of the PostgreSQL Server on which to set the administrator. Changing this forces a new resource to be created."', args=[d.arg(name='serverName', type=d.T.string)]),
