{
  ...
  '#':: d.pkg(name='virtualNetworkRule', url='', help='"VirtualNetworkRule is the Schema for the VirtualNetworkRules API. Manages a PostgreSQL Virtual Network Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualNetworkRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualNetworkRuleSpec defines the desired state of VirtualNetworkRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIgnoreMissingVnetServiceEndpoint':: d.fn(help='"Should the Virtual Network Rule be created before the Subnet has the Virtual Network Service Endpoint enabled?"', args=[d.arg(name='ignoreMissingVnetServiceEndpoint', type=d.T.boolean)]),
      withIgnoreMissingVnetServiceEndpoint(ignoreMissingVnetServiceEndpoint): { spec+: { forProvider+: { ignoreMissingVnetServiceEndpoint: ignoreMissingVnetServiceEndpoint } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group where the PostgreSQL server resides. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServerName':: d.fn(help='"The name of the SQL Server to which this PostgreSQL virtual network rule will be applied to. Changing this forces a new resource to be created."', args=[d.arg(name='serverName', type=d.T.string)]),
      withServerName(serverName): { spec+: { forProvider+: { serverName: serverName } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet that the PostgreSQL server will be connected to."', args=[d.arg(name='subnetId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withIgnoreMissingVnetServiceEndpoint':: d.fn(help='"Should the Virtual Network Rule be created before the Subnet has the Virtual Network Service Endpoint enabled?"', args=[d.arg(name='ignoreMissingVnetServiceEndpoint', type=d.T.boolean)]),
      withIgnoreMissingVnetServiceEndpoint(ignoreMissingVnetServiceEndpoint): { spec+: { initProvider+: { ignoreMissingVnetServiceEndpoint: ignoreMissingVnetServiceEndpoint } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet that the PostgreSQL server will be connected to."', args=[d.arg(name='subnetId', type=d.T.string)]),
