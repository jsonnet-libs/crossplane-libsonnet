{
  ...
  '#':: d.pkg(name='firewallRule', url='', help='"FirewallRule is the Schema for the FirewallRules API. Manages a Firewall Rule for a PostgreSQL Server."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEndIpAddress':: d.fn(help='"Specifies the End IP Address associated with this Firewall Rule. Changing this forces a new resource to be created."', args=[d.arg(name='endIpAddress', type=d.T.string)]),
      ...
      '#withStartIpAddress':: d.fn(help='"Specifies the Start IP Address associated with this Firewall Rule. Changing this forces a new resource to be created."', args=[d.arg(name='startIpAddress', type=d.T.string)]),
