{
  ...
  '#':: d.pkg(name='managementLock', url='', help='"ManagementLock is the Schema for the ManagementLocks API. Manages a Management Lock which is scoped to a Subscription, Resource Group or Resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagementLock', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagementLockSpec defines the desired state of ManagementLock"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLockLevel':: d.fn(help='"Specifies the Level to be used for this Lock. Possible values are CanNotDelete and ReadOnly. Changing this forces a new resource to be created."', args=[d.arg(name='lockLevel', type=d.T.string)]),
      withLockLevel(lockLevel): { spec+: { forProvider+: { lockLevel: lockLevel } } },
      '#withName':: d.fn(help='"Specifies the name of the Management Lock. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withNotes':: d.fn(help='"Specifies some notes about the lock. Maximum of 512 characters. Changing this forces a new resource to be created."', args=[d.arg(name='notes', type=d.T.string)]),
      withNotes(notes): { spec+: { forProvider+: { notes: notes } } },
      '#withScope':: d.fn(help='"Specifies the scope at which the Management Lock should be created. Changing this forces a new resource to be created."', args=[d.arg(name='scope', type=d.T.string)]),
