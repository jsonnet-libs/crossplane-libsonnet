{
  ...
  '#':: d.pkg(name='policyDefinition', url='', help='"PolicyDefinition is the Schema for the PolicyDefinitions API. Manages a policy rule definition. Policy definitions do not take effect until they are assigned to a scope using a Policy Assignment."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"The description of the policy definition."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The display name of the policy definition."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withManagementGroupId':: d.fn(help='"The id of the Management Group where this policy should be defined. Changing this forces a new resource to be created."', args=[d.arg(name='managementGroupId', type=d.T.string)]),
      withManagementGroupId(managementGroupId): { spec+: { forProvider+: { managementGroupId: managementGroupId } } },
      '#withMetadata':: d.fn(help='"The metadata for the policy definition. This is a JSON string representing additional metadata that should be stored with the policy definition."', args=[d.arg(name='metadata', type=d.T.string)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: metadata } } },
      '#withMode':: d.fn(help='"The policy resource manager mode that allows you to specify which resource types will be evaluated. Possible values are All, Indexed, Microsoft.ContainerService.Data, Microsoft.CustomerLockbox.Data, Microsoft.DataCatalog.Data, Microsoft.KeyVault.Data, Microsoft.Kubernetes.Data, Microsoft.MachineLearningServices.Data, Microsoft.Network.Data and Microsoft.Synapse.Data."', args=[d.arg(name='mode', type=d.T.string)]),
      withMode(mode): { spec+: { forProvider+: { mode: mode } } },
      '#withParameters':: d.fn(help='"Parameters for the policy definition. This field is a JSON string that allows you to parameterize your policy definition."', args=[d.arg(name='parameters', type=d.T.string)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: parameters } } },
      '#withPolicyRule':: d.fn(help='"The policy rule for the policy definition. This is a JSON string representing the rule that contains an if and a then block."', args=[d.arg(name='policyRule', type=d.T.string)]),
      withPolicyRule(policyRule): { spec+: { forProvider+: { policyRule: policyRule } } },
      '#withPolicyType':: d.fn(help='"The policy type. Possible values are BuiltIn, Custom, NotSpecified and Static. Changing this forces a new resource to be created."', args=[d.arg(name='policyType', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withPolicyRule':: d.fn(help='"The policy rule for the policy definition. This is a JSON string representing the rule that contains an if and a then block."', args=[d.arg(name='policyRule', type=d.T.string)]),
      withPolicyRule(policyRule): { spec+: { initProvider+: { policyRule: policyRule } } },
      '#withPolicyType':: d.fn(help='"The policy type. Possible values are BuiltIn, Custom, NotSpecified and Static. Changing this forces a new resource to be created."', args=[d.arg(name='policyType', type=d.T.string)]),
