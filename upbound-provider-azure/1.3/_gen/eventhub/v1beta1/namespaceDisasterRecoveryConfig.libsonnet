{
  ...
  '#':: d.pkg(name='namespaceDisasterRecoveryConfig', url='', help='"NamespaceDisasterRecoveryConfig is the Schema for the NamespaceDisasterRecoveryConfigs API. Manages an Disaster Recovery Config for an Event Hub Namespace."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#partnerNamespaceIdRef':: d.obj(help='"Reference to a EventHubNamespace in eventhub to populate partnerNamespaceId."'),
      ...
      '#partnerNamespaceIdSelector':: d.obj(help='"Selector for a EventHubNamespace in eventhub to populate partnerNamespaceId."'),
      ...
      '#withNamespaceName':: d.fn(help='"Specifies the name of the primary EventHub Namespace to replicate. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceName', type=d.T.string)]),
      withNamespaceName(namespaceName): { spec+: { forProvider+: { namespaceName: namespaceName } } },
      '#withPartnerNamespaceId':: d.fn(help='"The ID of the EventHub Namespace to replicate to."', args=[d.arg(name='partnerNamespaceId', type=d.T.string)]),
      withPartnerNamespaceId(partnerNamespaceId): { spec+: { forProvider+: { partnerNamespaceId: partnerNamespaceId } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Disaster Recovery Config exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
