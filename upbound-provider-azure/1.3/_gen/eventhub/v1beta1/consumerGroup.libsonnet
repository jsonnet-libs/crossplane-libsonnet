{
  ...
  '#':: d.pkg(name='consumerGroup', url='', help='"ConsumerGroup is the Schema for the ConsumerGroups API. Manages a Event Hubs Consumer Group as a nested resource within an Event Hub."'),
  ...
  '#new':: d.fn(help='new returns an instance of ConsumerGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ConsumerGroupSpec defines the desired state of ConsumerGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help="\"The name of the resource group in which the EventHub Consumer Group's grandparent Namespace exists. Changing this forces a new resource to be created.\"", args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withUserMetadata':: d.fn(help='"Specifies the user metadata."', args=[d.arg(name='userMetadata', type=d.T.string)]),
