{
  ...
  '#':: d.pkg(name='namespaceSchemaGroup', url='', help='"NamespaceSchemaGroup is the Schema for the NamespaceSchemaGroups API. Manages a Schema Group for a EventHub Namespace."'),
  ...
  '#new':: d.fn(help='new returns an instance of NamespaceSchemaGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NamespaceSchemaGroupSpec defines the desired state of NamespaceSchemaGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#namespaceIdRef':: d.obj(help='"Reference to a EventHubNamespace in eventhub to populate namespaceId."'),
      namespaceIdRef: {
      ...
      '#namespaceIdSelector':: d.obj(help='"Selector for a EventHubNamespace in eventhub to populate namespaceId."'),
      namespaceIdSelector: {
      ...
      '#withNamespaceId':: d.fn(help='"Specifies the ID of the EventHub Namespace. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceId', type=d.T.string)]),
      withNamespaceId(namespaceId): { spec+: { forProvider+: { namespaceId: namespaceId } } },
      '#withSchemaCompatibility':: d.fn(help='"Specifies the compatibility of this schema group. Possible values are None, Backward, Forward. Changing this forces a new resource to be created."', args=[d.arg(name='schemaCompatibility', type=d.T.string)]),
      withSchemaCompatibility(schemaCompatibility): { spec+: { forProvider+: { schemaCompatibility: schemaCompatibility } } },
      '#withSchemaType':: d.fn(help='"Specifies the Type of this schema group. Possible values are Avro, Unknown. Changing this forces a new resource to be created."', args=[d.arg(name='schemaType', type=d.T.string)]),
      withSchemaType(schemaType): { spec+: { forProvider+: { schemaType: schemaType } } },
    },
    ...
    initProvider: {
      '#withSchemaCompatibility':: d.fn(help='"Specifies the compatibility of this schema group. Possible values are None, Backward, Forward. Changing this forces a new resource to be created."', args=[d.arg(name='schemaCompatibility', type=d.T.string)]),
      withSchemaCompatibility(schemaCompatibility): { spec+: { initProvider+: { schemaCompatibility: schemaCompatibility } } },
      '#withSchemaType':: d.fn(help='"Specifies the Type of this schema group. Possible values are Avro, Unknown. Changing this forces a new resource to be created."', args=[d.arg(name='schemaType', type=d.T.string)]),
      withSchemaType(schemaType): { spec+: { initProvider+: { schemaType: schemaType } } },
    },
