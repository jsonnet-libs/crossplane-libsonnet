{
  ...
  '#':: d.pkg(name='authorizationRule', url='', help='"AuthorizationRule is the Schema for the AuthorizationRules API. Manages a Event Hubs authorization Rule within an Event Hub."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventhubName':: d.fn(help='"Specifies the name of the EventHub. Changing this forces a new resource to be created."', args=[d.arg(name='eventhubName', type=d.T.string)]),
      withEventhubName(eventhubName): { spec+: { forProvider+: { eventhubName: eventhubName } } },
      '#withListen':: d.fn(help='"Does this Authorization Rule have permissions to Listen to the Event Hub? Defaults to false."', args=[d.arg(name='listen', type=d.T.boolean)]),
      withListen(listen): { spec+: { forProvider+: { listen: listen } } },
      '#withManage':: d.fn(help='"Does this Authorization Rule have permissions to Manage to the Event Hub? When this property is true - both listen and send must be too. Defaults to false."', args=[d.arg(name='manage', type=d.T.boolean)]),
      withManage(manage): { spec+: { forProvider+: { manage: manage } } },
      '#withNamespaceName':: d.fn(help='"Specifies the name of the grandparent EventHub Namespace. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceName', type=d.T.string)]),
      withNamespaceName(namespaceName): { spec+: { forProvider+: { namespaceName: namespaceName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the EventHub Namespace exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSend':: d.fn(help='"Does this Authorization Rule have permissions to Send to the Event Hub? Defaults to false."', args=[d.arg(name='send', type=d.T.boolean)]),
