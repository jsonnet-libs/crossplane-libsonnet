{
  ...
  '#':: d.pkg(name='customProvider', url='', help='"CustomProvider is the Schema for the CustomProviders API. Manages an Azure Custom Provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of CustomProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CustomProviderSpec defines the desired state of CustomProvider"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#action':: d.obj(help='"Any number of action block as defined below. One of resource_type or action must be specified."'),
      action: {
        '#withEndpoint':: d.fn(help='"Specifies the endpoint of the action."', args=[d.arg(name='endpoint', type=d.T.string)]),
        withEndpoint(endpoint): { endpoint: endpoint },
        '#withName':: d.fn(help='"Specifies the name of the action."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#resourceType':: d.obj(help='"Any number of resource_type block as defined below. One of resource_type or action must be specified."'),
      resourceType: {
        '#withEndpoint':: d.fn(help='"Specifies the endpoint of the route definition."', args=[d.arg(name='endpoint', type=d.T.string)]),
        withEndpoint(endpoint): { endpoint: endpoint },
        '#withName':: d.fn(help='"Specifies the name of the route definition."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRoutingType':: d.fn(help='"The routing type that is supported for the resource request. Valid values are Proxy and Proxy,Cache. Defaults to Proxy."', args=[d.arg(name='routingType', type=d.T.string)]),
        withRoutingType(routingType): { routingType: routingType },
      },
      '#validation':: d.obj(help='"Any number of validation block as defined below."'),
      validation: {
        '#withSpecification':: d.fn(help='"The endpoint where the validation specification is located."', args=[d.arg(name='specification', type=d.T.string)]),
        withSpecification(specification): { specification: specification },
      },
      '#withAction':: d.fn(help='"Any number of action block as defined below. One of resource_type or action must be specified."', args=[d.arg(name='action', type=d.T.array)]),
      withAction(action): { spec+: { forProvider+: { action: if std.isArray(v=action) then action else [action] } } },
      '#withActionMixin':: d.fn(help='"Any number of action block as defined below. One of resource_type or action must be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='action', type=d.T.array)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Custom Provider. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withResourceType':: d.fn(help='"Any number of resource_type block as defined below. One of resource_type or action must be specified."', args=[d.arg(name='resourceType', type=d.T.array)]),
      withResourceType(resourceType): { spec+: { forProvider+: { resourceType: if std.isArray(v=resourceType) then resourceType else [resourceType] } } },
      '#withResourceTypeMixin':: d.fn(help='"Any number of resource_type block as defined below. One of resource_type or action must be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceType', type=d.T.array)]),
      withResourceTypeMixin(resourceType): { spec+: { forProvider+: { resourceType+: if std.isArray(v=resourceType) then resourceType else [resourceType] } } },
      ...
      '#withValidation':: d.fn(help='"Any number of validation block as defined below."', args=[d.arg(name='validation', type=d.T.array)]),
      withValidation(validation): { spec+: { forProvider+: { validation: if std.isArray(v=validation) then validation else [validation] } } },
      '#withValidationMixin':: d.fn(help='"Any number of validation block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='validation', type=d.T.array)]),
      withValidationMixin(validation): { spec+: { forProvider+: { validation+: if std.isArray(v=validation) then validation else [validation] } } },
    },
    ...
    initProvider: {
      ...
      '#withResourceType':: d.fn(help='"Any number of resource_type block as defined below. One of resource_type or action must be specified."', args=[d.arg(name='resourceType', type=d.T.array)]),
      withResourceType(resourceType): { spec+: { initProvider+: { resourceType: if std.isArray(v=resourceType) then resourceType else [resourceType] } } },
      '#withResourceTypeMixin':: d.fn(help='"Any number of resource_type block as defined below. One of resource_type or action must be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceType', type=d.T.array)]),
      withResourceTypeMixin(resourceType): { spec+: { initProvider+: { resourceType+: if std.isArray(v=resourceType) then resourceType else [resourceType] } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource. Changing this forces a new resource to be created."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the resource. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withValidation':: d.fn(help='"Any number of validation block as defined below."', args=[d.arg(name='validation', type=d.T.array)]),
      withValidation(validation): { spec+: { initProvider+: { validation: if std.isArray(v=validation) then validation else [validation] } } },
      '#withValidationMixin':: d.fn(help='"Any number of validation block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='validation', type=d.T.array)]),
      withValidationMixin(validation): { spec+: { initProvider+: { validation+: if std.isArray(v=validation) then validation else [validation] } } },
    },
