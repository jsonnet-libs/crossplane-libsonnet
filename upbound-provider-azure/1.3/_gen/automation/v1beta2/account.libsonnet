{
  ...
  '#':: d.pkg(name='account', url='', help='"Account is the Schema for the Accounts API. Manages a Automation Account."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      encryption: {
        '#withKeySource':: d.fn(help='', args=[d.arg(name='keySource', type=d.T.string)]),
        withKeySource(keySource): { keySource: keySource },
        '#withKeyVaultKeyId':: d.fn(help='"The ID of the Key Vault Key which should be used to Encrypt the data in this Automation Account."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
        withKeyVaultKeyId(keyVaultKeyId): { keyVaultKeyId: keyVaultKeyId },
        '#withUserAssignedIdentityId':: d.fn(help='"The User Assigned Managed Identity ID to be used for accessing the Customer Managed Key for encryption."', args=[d.arg(name='userAssignedIdentityId', type=d.T.string)]),
      ...
      identity: {
        '#withIdentityIds':: d.fn(help='"The ID of the User Assigned Identity which should be assigned to this Automation Account."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"The ID of the User Assigned Identity which should be assigned to this Automation Account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"The type of identity used for this Automation Account. Possible values are SystemAssigned, UserAssigned and SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withLocalAuthenticationEnabled':: d.fn(help='"Whether requests using non-AAD authentication are blocked. Defaults to true."', args=[d.arg(name='localAuthenticationEnabled', type=d.T.boolean)]),
      ...
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Whether public network access is allowed for the automation account. Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Automation Account is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"The SKU of the account. Possible values are Basic and Free."', args=[d.arg(name='skuName', type=d.T.string)]),
