  ...
  spec: {
    ...
    forProvider: {
      ...
      moduleLink: {
        ...
        hash: {
          ...
          withAlgorithm(algorithm): { spec+: { forProvider+: { moduleLink+: { hash+: { algorithm: algorithm } } } } },
          '#withValue':: d.fn(help='"The hash value of the content."', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { spec+: { forProvider+: { moduleLink+: { hash+: { value: value } } } } },
        },
        '#withUri':: d.fn(help='"The URI of the module content (zip or nupkg)."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { spec+: { forProvider+: { moduleLink+: { uri: uri } } } },
      },
    ...
    initProvider: {
      ...
      moduleLink: {
        ...
        hash: {
          '#withAlgorithm':: d.fn(help='"Specifies the algorithm used for the hash content."', args=[d.arg(name='algorithm', type=d.T.string)]),
          withAlgorithm(algorithm): { spec+: { initProvider+: { moduleLink+: { hash+: { algorithm: algorithm } } } } },
          '#withValue':: d.fn(help='"The hash value of the content."', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { spec+: { initProvider+: { moduleLink+: { hash+: { value: value } } } } },
        },
        '#withUri':: d.fn(help='"The URI of the module content (zip or nupkg)."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { spec+: { initProvider+: { moduleLink+: { uri: uri } } } },
      },
    },
