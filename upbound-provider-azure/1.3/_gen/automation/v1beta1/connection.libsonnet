{
  ...
  '#':: d.pkg(name='connection', url='', help='"Connection is the Schema for the Connections API. Manages an Automation Connection."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withType':: d.fn(help='"The type of the Connection - can be either builtin type such as Azure, AzureClassicCertificate, and AzureServicePrincipal, or a user defined types. Changing this forces a new resource to be created."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { forProvider+: { type: type } } },
      '#withValues':: d.fn(help='"A mapping of key value pairs passed to the connection. Different type needs different parameters in the values. Builtin types have required field values as below:"', args=[d.arg(name='values', type=d.T.object)]),
      withValues(values): { spec+: { forProvider+: { values: values } } },
      '#withValuesMixin':: d.fn(help='"A mapping of key value pairs passed to the connection. Different type needs different parameters in the values. Builtin types have required field values as below:"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withValues':: d.fn(help='"A mapping of key value pairs passed to the connection. Different type needs different parameters in the values. Builtin types have required field values as below:"', args=[d.arg(name='values', type=d.T.object)]),
      withValues(values): { spec+: { initProvider+: { values: values } } },
      '#withValuesMixin':: d.fn(help='"A mapping of key value pairs passed to the connection. Different type needs different parameters in the values. Builtin types have required field values as below:"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.object)]),
      withValuesMixin(values): { spec+: { initProvider+: { values+: values } } },
    },
