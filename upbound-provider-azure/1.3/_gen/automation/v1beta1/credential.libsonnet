{
  ...
  '#':: d.pkg(name='credential', url='', help='"Credential is the Schema for the Credentials API. Manages a Automation Credential."'),
  ...
  '#new':: d.fn(help='new returns an instance of Credential', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CredentialSpec defines the desired state of Credential"'),
  spec: {
    ...
    forProvider: {
      ...
      '#passwordSecretRef':: d.obj(help='"The password associated with this Automation Credential."'),
      passwordSecretRef: {
      ...
      '#withAutomationAccountName':: d.fn(help='"The name of the automation account in which the Credential is created. Changing this forces a new resource to be created."', args=[d.arg(name='automationAccountName', type=d.T.string)]),
      withAutomationAccountName(automationAccountName): { spec+: { forProvider+: { automationAccountName: automationAccountName } } },
      '#withDescription':: d.fn(help='"The description associated with this Automation Credential."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Credential is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withUsername':: d.fn(help='"The username associated with this Automation Credential."', args=[d.arg(name='username', type=d.T.string)]),
