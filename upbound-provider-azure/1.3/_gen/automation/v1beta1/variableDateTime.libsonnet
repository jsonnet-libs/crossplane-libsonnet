{
  ...
  '#':: d.pkg(name='variableDateTime', url='', help='"VariableDateTime is the Schema for the VariableDateTimes API. Manages a DateTime variable in Azure Automation."'),
  ...
  '#new':: d.fn(help='new returns an instance of VariableDateTime', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VariableDateTimeSpec defines the desired state of VariableDateTime"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAutomationAccountName':: d.fn(help='"The name of the automation account in which the Variable is created. Changing this forces a new resource to be created."', args=[d.arg(name='automationAccountName', type=d.T.string)]),
      withAutomationAccountName(automationAccountName): { spec+: { forProvider+: { automationAccountName: automationAccountName } } },
      '#withDescription':: d.fn(help='"The description of the Automation Variable."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEncrypted':: d.fn(help='"Specifies if the Automation Variable is encrypted. Defaults to false."', args=[d.arg(name='encrypted', type=d.T.boolean)]),
      withEncrypted(encrypted): { spec+: { forProvider+: { encrypted: encrypted } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Automation Variable. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withValue':: d.fn(help='"The value of the Automation Variable in the RFC3339 Section 5.6 Internet Date/Time Format."', args=[d.arg(name='value', type=d.T.string)]),
