{
  ...
  '#':: d.pkg(name='variableInt', url='', help='"VariableInt is the Schema for the VariableInts API. Manages a integer variable in Azure Automation."'),
  ...
  '#new':: d.fn(help='new returns an instance of VariableInt', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VariableIntSpec defines the desired state of VariableInt"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withValue':: d.fn(help='"The value of the Automation Variable as a integer."', args=[d.arg(name='value', type=d.T.number)]),
