{
  ...
  '#':: d.pkg(name='module', url='', help='"Module is the Schema for the Modules API. Manages a Automation Module."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#moduleLink':: d.obj(help='"A module_link block as defined below."'),
      moduleLink: {
        '#hash':: d.obj(help='"A hash block as defined below."'),
        hash: {
          '#withAlgorithm':: d.fn(help='"Specifies the algorithm used for the hash content."', args=[d.arg(name='algorithm', type=d.T.string)]),
          withAlgorithm(algorithm): { algorithm: algorithm },
          '#withValue':: d.fn(help='"The hash value of the content."', args=[d.arg(name='value', type=d.T.string)]),
        ...
        '#withUri':: d.fn(help='"The URI of the module content (zip or nupkg)."', args=[d.arg(name='uri', type=d.T.string)]),
        withUri(uri): { uri: uri },
      },
      ...
      '#withAutomationAccountName':: d.fn(help='"The name of the automation account in which the Module is created. Changing this forces a new resource to be created."', args=[d.arg(name='automationAccountName', type=d.T.string)]),
      withAutomationAccountName(automationAccountName): { spec+: { forProvider+: { automationAccountName: automationAccountName } } },
      '#withModuleLink':: d.fn(help='"A module_link block as defined below."', args=[d.arg(name='moduleLink', type=d.T.array)]),
      withModuleLink(moduleLink): { spec+: { forProvider+: { moduleLink: if std.isArray(v=moduleLink) then moduleLink else [moduleLink] } } },
      '#withModuleLinkMixin':: d.fn(help='"A module_link block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='moduleLink', type=d.T.array)]),
      withModuleLinkMixin(moduleLink): { spec+: { forProvider+: { moduleLink+: if std.isArray(v=moduleLink) then moduleLink else [moduleLink] } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Module is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withModuleLink':: d.fn(help='"A module_link block as defined below."', args=[d.arg(name='moduleLink', type=d.T.array)]),
      withModuleLink(moduleLink): { spec+: { initProvider+: { moduleLink: if std.isArray(v=moduleLink) then moduleLink else [moduleLink] } } },
      '#withModuleLinkMixin':: d.fn(help='"A module_link block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='moduleLink', type=d.T.array)]),
      withModuleLinkMixin(moduleLink): { spec+: { initProvider+: { moduleLink+: if std.isArray(v=moduleLink) then moduleLink else [moduleLink] } } },
    },
