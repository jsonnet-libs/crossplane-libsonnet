{
  ...
  '#':: d.pkg(name='variableString', url='', help='"VariableString is the Schema for the VariableStrings API. Manages a string variable in Azure Automation."'),
  ...
  '#new':: d.fn(help='new returns an instance of VariableString', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VariableStringSpec defines the desired state of VariableString"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withValue':: d.fn(help='"The value of the Automation Variable as a string."', args=[d.arg(name='value', type=d.T.string)]),
