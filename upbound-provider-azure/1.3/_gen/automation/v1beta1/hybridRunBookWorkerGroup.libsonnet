{
  ...
  '#':: d.pkg(name='hybridRunBookWorkerGroup', url='', help='"HybridRunBookWorkerGroup is the Schema for the HybridRunBookWorkerGroups API. Manages a Automation Account Runbook Worker Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of HybridRunBookWorkerGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HybridRunBookWorkerGroupSpec defines the desired state of HybridRunBookWorkerGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAutomationAccountName':: d.fn(help='"The name of the Automation Account in which the Runbook Worker Group is created. Changing this forces a new resource to be created."', args=[d.arg(name='automationAccountName', type=d.T.string)]),
      withAutomationAccountName(automationAccountName): { spec+: { forProvider+: { automationAccountName: automationAccountName } } },
      '#withCredentialName':: d.fn(help='"The name of resource type azurerm_automation_credential to use for hybrid worker."', args=[d.arg(name='credentialName', type=d.T.string)]),
      withCredentialName(credentialName): { spec+: { forProvider+: { credentialName: credentialName } } },
      '#withName':: d.fn(help='"The name which should be used for this Automation Account Runbook Worker Group. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
