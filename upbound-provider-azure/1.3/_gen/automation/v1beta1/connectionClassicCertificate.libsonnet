{
  ...
  '#':: d.pkg(name='connectionClassicCertificate', url='', help='"ConnectionClassicCertificate is the Schema for the ConnectionClassicCertificates API. Manages an Automation Connection with type"'),
  ...
  '#new':: d.fn(help='new returns an instance of ConnectionClassicCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ConnectionClassicCertificateSpec defines the desired state of ConnectionClassicCertificate"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCertificateAssetName':: d.fn(help='"The name of the certificate asset."', args=[d.arg(name='certificateAssetName', type=d.T.string)]),
      withCertificateAssetName(certificateAssetName): { spec+: { forProvider+: { certificateAssetName: certificateAssetName } } },
      '#withDescription':: d.fn(help='"A description for this Connection."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the Connection is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSubscriptionId':: d.fn(help='"The id of subscription."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
      withSubscriptionId(subscriptionId): { spec+: { forProvider+: { subscriptionId: subscriptionId } } },
      '#withSubscriptionName':: d.fn(help='"The name of subscription."', args=[d.arg(name='subscriptionName', type=d.T.string)]),
      withSubscriptionName(subscriptionName): { spec+: { forProvider+: { subscriptionName: subscriptionName } } },
    },
    ...
    initProvider: {
      '#withCertificateAssetName':: d.fn(help='"The name of the certificate asset."', args=[d.arg(name='certificateAssetName', type=d.T.string)]),
      withCertificateAssetName(certificateAssetName): { spec+: { initProvider+: { certificateAssetName: certificateAssetName } } },
      '#withDescription':: d.fn(help='"A description for this Connection."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withSubscriptionName':: d.fn(help='"The name of subscription."', args=[d.arg(name='subscriptionName', type=d.T.string)]),
      withSubscriptionName(subscriptionName): { spec+: { initProvider+: { subscriptionName: subscriptionName } } },
    },
