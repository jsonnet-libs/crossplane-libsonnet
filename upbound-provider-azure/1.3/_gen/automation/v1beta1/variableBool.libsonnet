{
  ...
  '#':: d.pkg(name='variableBool', url='', help='"VariableBool is the Schema for the VariableBools API. Manages a boolean variable in Azure Automation."'),
  ...
  '#new':: d.fn(help='new returns an instance of VariableBool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VariableBoolSpec defines the desired state of VariableBool"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withValue':: d.fn(help='"The value of the Automation Variable as a boolean."', args=[d.arg(name='value', type=d.T.boolean)]),
