{
  ...
  '#':: d.pkg(name='server', url='', help='"Server is the Schema for the Servers API. Manages a Fluid Relay Server."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withIdentityIds':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this Fluid Relay Service."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this Fluid Relay Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Fluid Relay Service. Possible values are SystemAssigned,UserAssigned and SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Fluid Relay Server should exist. Changing this forces a new Fluid Relay Server to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"The name which should be used for this Fluid Relay Server. Changing this forces a new Fluid Relay Server to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Fluid Relay Server should exist. Changing this forces a new Fluid Relay Server to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withStorageSku':: d.fn(help='"Sku of the storage associated with the resource, Possible values are standard and basic. Changing this forces a new Fluid Relay Server to be created."', args=[d.arg(name='storageSku', type=d.T.string)]),
      withStorageSku(storageSku): { spec+: { forProvider+: { storageSku: storageSku } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Fluid Relay Server."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Fluid Relay Server."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withStorageSku':: d.fn(help='"Sku of the storage associated with the resource, Possible values are standard and basic. Changing this forces a new Fluid Relay Server to be created."', args=[d.arg(name='storageSku', type=d.T.string)]),
      withStorageSku(storageSku): { spec+: { initProvider+: { storageSku: storageSku } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Fluid Relay Server."', args=[d.arg(name='tags', type=d.T.object)]),
