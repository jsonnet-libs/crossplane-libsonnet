{
  ...
  '#':: d.pkg(name='loadBalancerNatPool', url='', help='"LoadBalancerNatPool is the Schema for the LoadBalancerNatPools API. Manages a Load Balancer NAT Pool."'),
  ...
  '#new':: d.fn(help='new returns an instance of LoadBalancerNatPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LoadBalancerNatPoolSpec defines the desired state of LoadBalancerNatPool"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBackendPort':: d.fn(help='"The port used for the internal endpoint. Possible values range between 1 and 65535, inclusive."', args=[d.arg(name='backendPort', type=d.T.number)]),
      withBackendPort(backendPort): { spec+: { forProvider+: { backendPort: backendPort } } },
      '#withFloatingIpEnabled':: d.fn(help='"Are the floating IPs enabled for this Load Balancer Rule? A floating IP is reassigned to a secondary server in case the primary server fails. Required to configure a SQL AlwaysOn Availability Group."', args=[d.arg(name='floatingIpEnabled', type=d.T.boolean)]),
      withFloatingIpEnabled(floatingIpEnabled): { spec+: { forProvider+: { floatingIpEnabled: floatingIpEnabled } } },
      ...
      '#withFrontendPortEnd':: d.fn(help='"The last port number in the range of external ports that will be used to provide Inbound NAT to NICs associated with this Load Balancer. Possible values range between 1 and 65534, inclusive."', args=[d.arg(name='frontendPortEnd', type=d.T.number)]),
      withFrontendPortEnd(frontendPortEnd): { spec+: { forProvider+: { frontendPortEnd: frontendPortEnd } } },
      '#withFrontendPortStart':: d.fn(help='"The first port number in the range of external ports that will be used to provide Inbound NAT to NICs associated with this Load Balancer. Possible values range between 1 and 65534, inclusive."', args=[d.arg(name='frontendPortStart', type=d.T.number)]),
      withFrontendPortStart(frontendPortStart): { spec+: { forProvider+: { frontendPortStart: frontendPortStart } } },
      '#withIdleTimeoutInMinutes':: d.fn(help='"Specifies the idle timeout in minutes for TCP connections. Valid values are between 4 and 30. Defaults to 4."', args=[d.arg(name='idleTimeoutInMinutes', type=d.T.number)]),
      withIdleTimeoutInMinutes(idleTimeoutInMinutes): { spec+: { forProvider+: { idleTimeoutInMinutes: idleTimeoutInMinutes } } },
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the NAT pool. Changing this forces a new resource to be created."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
      withLoadbalancerId(loadbalancerId): { spec+: { forProvider+: { loadbalancerId: loadbalancerId } } },
      '#withProtocol':: d.fn(help='"The transport protocol for the external endpoint. Possible values are All, Tcp and Udp."', args=[d.arg(name='protocol', type=d.T.string)]),
      ...
      '#withTcpResetEnabled':: d.fn(help='"Is TCP Reset enabled for this Load Balancer Rule?"', args=[d.arg(name='tcpResetEnabled', type=d.T.boolean)]),
      withTcpResetEnabled(tcpResetEnabled): { spec+: { forProvider+: { tcpResetEnabled: tcpResetEnabled } } },
    },
    ...
    initProvider: {
      ...
      '#withFloatingIpEnabled':: d.fn(help='"Are the floating IPs enabled for this Load Balancer Rule? A floating IP is reassigned to a secondary server in case the primary server fails. Required to configure a SQL AlwaysOn Availability Group."', args=[d.arg(name='floatingIpEnabled', type=d.T.boolean)]),
      withFloatingIpEnabled(floatingIpEnabled): { spec+: { initProvider+: { floatingIpEnabled: floatingIpEnabled } } },
      '#withFrontendIpConfigurationName':: d.fn(help='"The name of the frontend IP configuration exposing this rule."', args=[d.arg(name='frontendIpConfigurationName', type=d.T.string)]),
      ...
      '#withTcpResetEnabled':: d.fn(help='"Is TCP Reset enabled for this Load Balancer Rule?"', args=[d.arg(name='tcpResetEnabled', type=d.T.boolean)]),
      withTcpResetEnabled(tcpResetEnabled): { spec+: { initProvider+: { tcpResetEnabled: tcpResetEnabled } } },
    },
