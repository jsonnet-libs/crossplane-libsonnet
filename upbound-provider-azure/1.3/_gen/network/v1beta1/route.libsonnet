{
  ...
  '#':: d.pkg(name='route', url='', help='"Route is the Schema for the Routes API. Manages a Route within a Route Table."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#routeTableNameRef':: d.obj(help='"Reference to a RouteTable in network to populate routeTableName."'),
      routeTableNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { routeTableNameRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { routeTableNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { routeTableNameRef+: { name: name } } } },
      },
      '#routeTableNameSelector':: d.obj(help='"Selector for a RouteTable in network to populate routeTableName."'),
      routeTableNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { routeTableNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { routeTableNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { routeTableNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { routeTableNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { routeTableNameSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withAddressPrefix':: d.fn(help='"The destination to which the route applies. Can be CIDR (such as 10.1.0.0/16) or Azure Service Tag (such as ApiManagement, AzureBackup or AzureMonitor) format."', args=[d.arg(name='addressPrefix', type=d.T.string)]),
      withAddressPrefix(addressPrefix): { spec+: { forProvider+: { addressPrefix: addressPrefix } } },
      '#withNextHopInIpAddress':: d.fn(help='"Contains the IP address packets should be forwarded to. Next hop values are only allowed in routes where the next hop type is VirtualAppliance."', args=[d.arg(name='nextHopInIpAddress', type=d.T.string)]),
      withNextHopInIpAddress(nextHopInIpAddress): { spec+: { forProvider+: { nextHopInIpAddress: nextHopInIpAddress } } },
      '#withNextHopType':: d.fn(help='"The type of Azure hop the packet should be sent to. Possible values are VirtualNetworkGateway, VnetLocal, Internet, VirtualAppliance and None."', args=[d.arg(name='nextHopType', type=d.T.string)]),
      withNextHopType(nextHopType): { spec+: { forProvider+: { nextHopType: nextHopType } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the route. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withRouteTableName':: d.fn(help='"The name of the route table within which create the route. Changing this forces a new resource to be created."', args=[d.arg(name='routeTableName', type=d.T.string)]),
      withRouteTableName(routeTableName): { spec+: { forProvider+: { routeTableName: routeTableName } } },
    },
    ...
    initProvider: {
      ...
      '#withNextHopInIpAddress':: d.fn(help='"Contains the IP address packets should be forwarded to. Next hop values are only allowed in routes where the next hop type is VirtualAppliance."', args=[d.arg(name='nextHopInIpAddress', type=d.T.string)]),
      withNextHopInIpAddress(nextHopInIpAddress): { spec+: { initProvider+: { nextHopInIpAddress: nextHopInIpAddress } } },
      '#withNextHopType':: d.fn(help='"The type of Azure hop the packet should be sent to. Possible values are VirtualNetworkGateway, VnetLocal, Internet, VirtualAppliance and None."', args=[d.arg(name='nextHopType', type=d.T.string)]),
