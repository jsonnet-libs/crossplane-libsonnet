{
  ...
  '#':: d.pkg(name='firewallNATRuleCollection', url='', help='"FirewallNATRuleCollection is the Schema for the FirewallNATRuleCollections API. Manages a NAT Rule Collection within an Azure Firewall."'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallNATRuleCollection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallNATRuleCollectionSpec defines the desired state of FirewallNATRuleCollection"'),
  spec: {
    ...
    forProvider: {
      ...
      rule: {
        ...
        '#withDestinationAddresses':: d.fn(help='"A list of destination IP addresses and/or IP ranges."', args=[d.arg(name='destinationAddresses', type=d.T.array)]),
        ...
        '#withProtocols':: d.fn(help='"A list of protocols. Possible values are Any, ICMP, TCP and UDP. If action is Dnat, protocols can only be TCP and UDP."', args=[d.arg(name='protocols', type=d.T.array)]),
        withProtocols(protocols): { protocols: if std.isArray(v=protocols) then protocols else [protocols] },
        '#withProtocolsMixin':: d.fn(help='"A list of protocols. Possible values are Any, ICMP, TCP and UDP. If action is Dnat, protocols can only be TCP and UDP."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='protocols', type=d.T.array)]),
        ...
        '#withTranslatedAddress':: d.fn(help='"The address of the service behind the Firewall."', args=[d.arg(name='translatedAddress', type=d.T.string)]),
        withTranslatedAddress(translatedAddress): { translatedAddress: translatedAddress },
        '#withTranslatedPort':: d.fn(help='"The port of the service behind the Firewall."', args=[d.arg(name='translatedPort', type=d.T.string)]),
        withTranslatedPort(translatedPort): { translatedPort: translatedPort },
      },
      '#withAction':: d.fn(help='"Specifies the action the rule will apply to matching traffic. Possible values are Dnat and Snat."', args=[d.arg(name='action', type=d.T.string)]),
      withAction(action): { spec+: { forProvider+: { action: action } } },
      '#withAzureFirewallName':: d.fn(help='"Specifies the name of the Firewall in which the NAT Rule Collection should be created. Changing this forces a new resource to be created."', args=[d.arg(name='azureFirewallName', type=d.T.string)]),
