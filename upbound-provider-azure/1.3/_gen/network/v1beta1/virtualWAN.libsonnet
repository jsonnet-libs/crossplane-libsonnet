{
  ...
  '#':: d.pkg(name='virtualWAN', url='', help='"VirtualWAN is the Schema for the VirtualWANs API. Manages a Virtual WAN."'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualWAN', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualWANSpec defines the desired state of VirtualWAN"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowBranchToBranchTraffic':: d.fn(help='"Boolean flag to specify whether branch to branch traffic is allowed. Defaults to true."', args=[d.arg(name='allowBranchToBranchTraffic', type=d.T.boolean)]),
      withAllowBranchToBranchTraffic(allowBranchToBranchTraffic): { spec+: { forProvider+: { allowBranchToBranchTraffic: allowBranchToBranchTraffic } } },
      '#withDisableVpnEncryption':: d.fn(help='"Boolean flag to specify whether VPN encryption is disabled. Defaults to false."', args=[d.arg(name='disableVpnEncryption', type=d.T.boolean)]),
      withDisableVpnEncryption(disableVpnEncryption): { spec+: { forProvider+: { disableVpnEncryption: disableVpnEncryption } } },
      ...
      '#withOffice365LocalBreakoutCategory':: d.fn(help='"Specifies the Office365 local breakout category. Possible values include: Optimize, OptimizeAndAllow, All, None. Defaults to None."', args=[d.arg(name='office365LocalBreakoutCategory', type=d.T.string)]),
      withOffice365LocalBreakoutCategory(office365LocalBreakoutCategory): { spec+: { forProvider+: { office365LocalBreakoutCategory: office365LocalBreakoutCategory } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Virtual WAN. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Virtual WAN."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Virtual WAN."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withType':: d.fn(help='"Specifies the Virtual WAN type. Possible Values include: Basic and Standard. Defaults to Standard."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      '#withAllowBranchToBranchTraffic':: d.fn(help='"Boolean flag to specify whether branch to branch traffic is allowed. Defaults to true."', args=[d.arg(name='allowBranchToBranchTraffic', type=d.T.boolean)]),
      withAllowBranchToBranchTraffic(allowBranchToBranchTraffic): { spec+: { initProvider+: { allowBranchToBranchTraffic: allowBranchToBranchTraffic } } },
      '#withDisableVpnEncryption':: d.fn(help='"Boolean flag to specify whether VPN encryption is disabled. Defaults to false."', args=[d.arg(name='disableVpnEncryption', type=d.T.boolean)]),
      withDisableVpnEncryption(disableVpnEncryption): { spec+: { initProvider+: { disableVpnEncryption: disableVpnEncryption } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withOffice365LocalBreakoutCategory':: d.fn(help='"Specifies the Office365 local breakout category. Possible values include: Optimize, OptimizeAndAllow, All, None. Defaults to None."', args=[d.arg(name='office365LocalBreakoutCategory', type=d.T.string)]),
      withOffice365LocalBreakoutCategory(office365LocalBreakoutCategory): { spec+: { initProvider+: { office365LocalBreakoutCategory: office365LocalBreakoutCategory } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Virtual WAN."', args=[d.arg(name='tags', type=d.T.object)]),
