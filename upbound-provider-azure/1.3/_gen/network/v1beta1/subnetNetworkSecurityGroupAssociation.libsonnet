{
  ...
  '#':: d.pkg(name='subnetNetworkSecurityGroupAssociation', url='', help='"SubnetNetworkSecurityGroupAssociation is the Schema for the SubnetNetworkSecurityGroupAssociations API. Associates a"'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetNetworkSecurityGroupAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubnetNetworkSecurityGroupAssociationSpec defines the desired state of SubnetNetworkSecurityGroupAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withNetworkSecurityGroupId':: d.fn(help='"The ID of the Network Security Group which should be associated with the Subnet. Changing this forces a new resource to be created."', args=[d.arg(name='networkSecurityGroupId', type=d.T.string)]),
