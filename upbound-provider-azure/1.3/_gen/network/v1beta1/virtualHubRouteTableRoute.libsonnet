{
  ...
  '#':: d.pkg(name='virtualHubRouteTableRoute', url='', help='"VirtualHubRouteTableRoute is the Schema for the VirtualHubRouteTableRoutes API. Manages a Route in a Virtual Hub Route Table."'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualHubRouteTableRoute', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualHubRouteTableRouteSpec defines the desired state of VirtualHubRouteTableRoute"'),
  spec: {
    ...
    forProvider: {
      ...
      nextHopRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { nextHopRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { nextHopRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { nextHopRef+: { name: name } } } },
      },
      ...
      nextHopSelector: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { nextHopSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { nextHopSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { nextHopSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { nextHopSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { nextHopSelector+: { matchLabels+: matchLabels } } } },
      },
      '#routeTableIdRef':: d.obj(help='"Reference to a VirtualHubRouteTable in network to populate routeTableId."'),
      routeTableIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#routeTableIdSelector':: d.obj(help='"Selector for a VirtualHubRouteTable in network to populate routeTableId."'),
      ...
      withDestinationsType(destinationsType): { spec+: { forProvider+: { destinationsType: destinationsType } } },
      '#withNextHop':: d.fn(help="\"The next hop's resource ID.\"", args=[d.arg(name='nextHop', type=d.T.string)]),
      withNextHop(nextHop): { spec+: { forProvider+: { nextHop: nextHop } } },
      ...
      withNextHopType(nextHopType): { spec+: { forProvider+: { nextHopType: nextHopType } } },
      '#withRouteTableId':: d.fn(help='"The ID of the Virtual Hub Route Table to link this route to. Changing this forces a new resource to be created."', args=[d.arg(name='routeTableId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      nextHopRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { nextHopRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { nextHopRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { nextHopRef+: { name: name } } } },
      },
      '#nextHopSelector':: d.obj(help='"Selector for a VirtualHubConnection in network to populate nextHop."'),
      nextHopSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { nextHopSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { nextHopSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { nextHopSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { nextHopSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { nextHopSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withDestinations':: d.fn(help='"A list of destination addresses for this route."', args=[d.arg(name='destinations', type=d.T.array)]),
      ...
      '#withDestinationsType':: d.fn(help='"The type of destinations. Possible values are CIDR, ResourceId and Service."', args=[d.arg(name='destinationsType', type=d.T.string)]),
      withDestinationsType(destinationsType): { spec+: { initProvider+: { destinationsType: destinationsType } } },
      '#withNextHop':: d.fn(help="\"The next hop's resource ID.\"", args=[d.arg(name='nextHop', type=d.T.string)]),
      withNextHop(nextHop): { spec+: { initProvider+: { nextHop: nextHop } } },
      '#withNextHopType':: d.fn(help='"The type of next hop. Currently the only possible value is ResourceId. Defaults to ResourceId."', args=[d.arg(name='nextHopType', type=d.T.string)]),
      withNextHopType(nextHopType): { spec+: { initProvider+: { nextHopType: nextHopType } } },
    },
