{
  ...
  '#':: d.pkg(name='firewallNetworkRuleCollection', url='', help='"FirewallNetworkRuleCollection is the Schema for the FirewallNetworkRuleCollections API. Manages a Network Rule Collection within an Azure Firewall."'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallNetworkRuleCollection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallNetworkRuleCollectionSpec defines the desired state of FirewallNetworkRuleCollection"'),
  spec: {
    ...
    forProvider: {
      ...
      rule: {
        ...
        '#withDestinationAddresses':: d.fn(help='"Either a list of destination IP addresses and/or IP ranges, or a list of destination Service Tags."', args=[d.arg(name='destinationAddresses', type=d.T.array)]),
        ...
        '#withDestinationAddressesMixin':: d.fn(help='"Either a list of destination IP addresses and/or IP ranges, or a list of destination Service Tags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='destinationAddresses', type=d.T.array)]),
        ...
        '#withDestinationFqdns':: d.fn(help='"A list of destination FQDNS for the rule."', args=[d.arg(name='destinationFqdns', type=d.T.array)]),
        ...
        '#withDestinationIpGroups':: d.fn(help='"A list of destination IP Group IDs for the rule."', args=[d.arg(name='destinationIpGroups', type=d.T.array)]),
        ...
        '#withDestinationPorts':: d.fn(help='"A list of destination ports."', args=[d.arg(name='destinationPorts', type=d.T.array)]),
        ...
        '#withProtocols':: d.fn(help='"A list of protocols. Possible values are Any, ICMP, TCP and UDP."', args=[d.arg(name='protocols', type=d.T.array)]),
        withProtocols(protocols): { protocols: if std.isArray(v=protocols) then protocols else [protocols] },
        '#withProtocolsMixin':: d.fn(help='"A list of protocols. Possible values are Any, ICMP, TCP and UDP."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='protocols', type=d.T.array)]),
      ...
      '#withAzureFirewallName':: d.fn(help='"Specifies the name of the Firewall in which the Network Rule Collection should be created. Changing this forces a new resource to be created."', args=[d.arg(name='azureFirewallName', type=d.T.string)]),
