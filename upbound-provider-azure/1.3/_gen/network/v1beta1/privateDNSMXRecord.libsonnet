{
  ...
  '#':: d.pkg(name='privateDNSMXRecord', url='', help='"PrivateDNSMXRecord is the Schema for the PrivateDNSMXRecords API. Manages a Private DNS MX Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSMXRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSMXRecordSpec defines the desired state of PrivateDNSMXRecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"One or more record blocks as defined below."'),
      record: {
        '#withExchange':: d.fn(help='"The FQDN of the exchange to MX record points to."', args=[d.arg(name='exchange', type=d.T.string)]),
        withExchange(exchange): { exchange: exchange },
        '#withPreference':: d.fn(help='"The preference of the MX record."', args=[d.arg(name='preference', type=d.T.number)]),
