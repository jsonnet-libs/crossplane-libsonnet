{
  ...
  '#':: d.pkg(name='privateDNSSRVRecord', url='', help='"PrivateDNSSRVRecord is the Schema for the PrivateDNSSRVRecords API. Manages a Private DNS SRV Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSSRVRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSSRVRecordSpec defines the desired state of PrivateDNSSRVRecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"One or more record blocks as defined below."'),
      record: {
        '#withPort':: d.fn(help='"The Port the service is listening on."', args=[d.arg(name='port', type=d.T.number)]),
        withPort(port): { port: port },
        '#withPriority':: d.fn(help='"The priority of the SRV record."', args=[d.arg(name='priority', type=d.T.number)]),
        withPriority(priority): { priority: priority },
        '#withTarget':: d.fn(help='"The FQDN of the service."', args=[d.arg(name='target', type=d.T.string)]),
        withTarget(target): { target: target },
        '#withWeight':: d.fn(help='"The Weight of the SRV record."', args=[d.arg(name='weight', type=d.T.number)]),
      ...
      '#withZoneName':: d.fn(help='"Specifies the Private DNS Zone where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='zoneName', type=d.T.string)]),
      withZoneName(zoneName): { spec+: { forProvider+: { zoneName: zoneName } } },
      '#zoneNameRef':: d.obj(help='"Reference to a PrivateDNSZone in network to populate zoneName."'),
      zoneNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#zoneNameSelector':: d.obj(help='"Selector for a PrivateDNSZone in network to populate zoneName."'),
      zoneNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
