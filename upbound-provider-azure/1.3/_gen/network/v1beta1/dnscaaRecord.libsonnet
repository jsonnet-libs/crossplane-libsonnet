{
  ...
  '#':: d.pkg(name='dnscaaRecord', url='', help='"DNSCAARecord is the Schema for the DNSCAARecords API. Manages a DNS CAA Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSCAARecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSCAARecordSpec defines the desired state of DNSCAARecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"A list of values that make up the CAA record. Each record block supports fields documented below."'),
      record: {
        '#withFlags':: d.fn(help='"Extensible CAA flags, currently only 1 is implemented to set the issuer critical flag."', args=[d.arg(name='flags', type=d.T.number)]),
        withFlags(flags): { flags: flags },
        '#withTag':: d.fn(help='"A property tag, options are issue, issuewild and iodef."', args=[d.arg(name='tag', type=d.T.string)]),
        withTag(tag): { tag: tag },
        '#withValue':: d.fn(help='"A property value such as a registrar domain."', args=[d.arg(name='value', type=d.T.string)]),
      ...
      '#withRecord':: d.fn(help='"A list of values that make up the CAA record. Each record block supports fields documented below."', args=[d.arg(name='record', type=d.T.array)]),
      withRecord(record): { spec+: { forProvider+: { record: if std.isArray(v=record) then record else [record] } } },
      '#withRecordMixin':: d.fn(help='"A list of values that make up the CAA record. Each record block supports fields documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='record', type=d.T.array)]),
      withRecordMixin(record): { spec+: { forProvider+: { record+: if std.isArray(v=record) then record else [record] } } },
    ...
    initProvider: {
      ...
      '#withRecord':: d.fn(help='"A list of values that make up the CAA record. Each record block supports fields documented below."', args=[d.arg(name='record', type=d.T.array)]),
      withRecord(record): { spec+: { initProvider+: { record: if std.isArray(v=record) then record else [record] } } },
      '#withRecordMixin':: d.fn(help='"A list of values that make up the CAA record. Each record block supports fields documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='record', type=d.T.array)]),
      withRecordMixin(record): { spec+: { initProvider+: { record+: if std.isArray(v=record) then record else [record] } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
