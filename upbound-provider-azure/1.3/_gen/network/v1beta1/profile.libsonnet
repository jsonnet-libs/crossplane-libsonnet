{
  ...
  '#':: d.pkg(name='profile', url='', help='"Profile is the Schema for the Profiles API. Manages a Network Profile."'),
  ...
  spec: {
    ...
    forProvider: {
      '#containerNetworkInterface':: d.obj(help='"A container_network_interface block as documented below."'),
      containerNetworkInterface: {
        '#ipConfiguration':: d.obj(help='"One or more ip_configuration blocks as documented below."'),
        ipConfiguration: {
          ...
          '#withName':: d.fn(help='"Specifies the name of the Network Profile. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
        ...
        '#withIpConfiguration':: d.fn(help='"One or more ip_configuration blocks as documented below."', args=[d.arg(name='ipConfiguration', type=d.T.array)]),
      ...
      '#withContainerNetworkInterface':: d.fn(help='"A container_network_interface block as documented below."', args=[d.arg(name='containerNetworkInterface', type=d.T.array)]),
      withContainerNetworkInterface(containerNetworkInterface): { spec+: { forProvider+: { containerNetworkInterface: if std.isArray(v=containerNetworkInterface) then containerNetworkInterface else [containerNetworkInterface] } } },
      '#withContainerNetworkInterfaceMixin':: d.fn(help='"A container_network_interface block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='containerNetworkInterface', type=d.T.array)]),
      withContainerNetworkInterfaceMixin(containerNetworkInterface): { spec+: { forProvider+: { containerNetworkInterface+: if std.isArray(v=containerNetworkInterface) then containerNetworkInterface else [containerNetworkInterface] } } },
    ...
    initProvider: {
      ...
      '#withContainerNetworkInterface':: d.fn(help='"A container_network_interface block as documented below."', args=[d.arg(name='containerNetworkInterface', type=d.T.array)]),
      withContainerNetworkInterface(containerNetworkInterface): { spec+: { initProvider+: { containerNetworkInterface: if std.isArray(v=containerNetworkInterface) then containerNetworkInterface else [containerNetworkInterface] } } },
      '#withContainerNetworkInterfaceMixin':: d.fn(help='"A container_network_interface block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='containerNetworkInterface', type=d.T.array)]),
      withContainerNetworkInterfaceMixin(containerNetworkInterface): { spec+: { initProvider+: { containerNetworkInterface+: if std.isArray(v=containerNetworkInterface) then containerNetworkInterface else [containerNetworkInterface] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
