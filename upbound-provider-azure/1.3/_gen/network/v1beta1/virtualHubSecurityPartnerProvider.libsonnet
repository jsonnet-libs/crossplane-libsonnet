{
  ...
  '#':: d.pkg(name='virtualHubSecurityPartnerProvider', url='', help='"VirtualHubSecurityPartnerProvider is the Schema for the VirtualHubSecurityPartnerProviders API. Manages a Security Partner Provider which could be associated to virtual hub."'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualHubSecurityPartnerProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualHubSecurityPartnerProviderSpec defines the desired state of VirtualHubSecurityPartnerProvider"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Security Partner Provider should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Security Partner Provider should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSecurityProviderName':: d.fn(help='"The security provider name. Possible values are ZScaler, IBoss and Checkpoint is allowed. Changing this forces a new resource to be created."', args=[d.arg(name='securityProviderName', type=d.T.string)]),
      withSecurityProviderName(securityProviderName): { spec+: { forProvider+: { securityProviderName: securityProviderName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Security Partner Provider."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Security Partner Provider."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withVirtualHubId':: d.fn(help='"The ID of the Virtual Hub within which this Security Partner Provider should be created. Changing this forces a new resource to be created."', args=[d.arg(name='virtualHubId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSecurityProviderName':: d.fn(help='"The security provider name. Possible values are ZScaler, IBoss and Checkpoint is allowed. Changing this forces a new resource to be created."', args=[d.arg(name='securityProviderName', type=d.T.string)]),
      withSecurityProviderName(securityProviderName): { spec+: { initProvider+: { securityProviderName: securityProviderName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Security Partner Provider."', args=[d.arg(name='tags', type=d.T.object)]),
