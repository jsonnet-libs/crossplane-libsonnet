{
  ...
  '#':: d.pkg(name='privateDNSPTRRecord', url='', help='"PrivateDNSPTRRecord is the Schema for the PrivateDNSPTRRecords API. Manages a Private DNS PTR Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSPTRRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSPTRRecordSpec defines the desired state of PrivateDNSPTRRecord"'),
  spec: {
