  ...
  spec: {
    ...
    forProvider: {
      ...
      soaRecord: {
        ...
        withExpireTime(expireTime): { expireTime: expireTime },
        ...
        withMinimumTtl(minimumTtl): { minimumTtl: minimumTtl },
        ...
        withSerialNumber(serialNumber): { serialNumber: serialNumber },
      ...
      '#withSoaRecord':: d.fn(help='"An soa_record block as defined below."', args=[d.arg(name='soaRecord', type=d.T.array)]),
      withSoaRecord(soaRecord): { spec+: { forProvider+: { soaRecord: if std.isArray(v=soaRecord) then soaRecord else [soaRecord] } } },
      '#withSoaRecordMixin':: d.fn(help='"An soa_record block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='soaRecord', type=d.T.array)]),
      withSoaRecordMixin(soaRecord): { spec+: { forProvider+: { soaRecord+: if std.isArray(v=soaRecord) then soaRecord else [soaRecord] } } },
    ...
    initProvider: {
      ...
      '#withSoaRecord':: d.fn(help='"An soa_record block as defined below."', args=[d.arg(name='soaRecord', type=d.T.array)]),
      withSoaRecord(soaRecord): { spec+: { initProvider+: { soaRecord: if std.isArray(v=soaRecord) then soaRecord else [soaRecord] } } },
      '#withSoaRecordMixin':: d.fn(help='"An soa_record block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='soaRecord', type=d.T.array)]),
      withSoaRecordMixin(soaRecord): { spec+: { initProvider+: { soaRecord+: if std.isArray(v=soaRecord) then soaRecord else [soaRecord] } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
