{
  ...
  '#':: d.pkg(name='dnsaRecord', url='', help='"DNSARecord is the Schema for the DNSARecords API. Manages a DNS A Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSARecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSARecordSpec defines the desired state of DNSARecord"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRecords':: d.fn(help='"List of IPv4 Addresses. Conflicts with target_resource_id."', args=[d.arg(name='records', type=d.T.array)]),
      withRecords(records): { spec+: { forProvider+: { records: if std.isArray(v=records) then records else [records] } } },
      '#withRecordsMixin':: d.fn(help='"List of IPv4 Addresses. Conflicts with target_resource_id."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='records', type=d.T.array)]),
