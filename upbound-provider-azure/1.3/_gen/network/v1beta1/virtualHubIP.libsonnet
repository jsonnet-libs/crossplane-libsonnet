{
  ...
  '#':: d.pkg(name='virtualHubIP', url='', help='"VirtualHubIP is the Schema for the VirtualHubIPs API. Manages a Virtual Hub IP. This resource is also known as a Route Server."'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualHubIP', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualHubIPSpec defines the desired state of VirtualHubIP"'),
  spec: {
    ...
    forProvider: {
      ...
      publicIpAddressIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { publicIpAddressIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { publicIpAddressIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { publicIpAddressIdRef+: { name: name } } } },
      },
      ...
      publicIpAddressIdSelector: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { publicIpAddressIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { publicIpAddressIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { publicIpAddressIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { publicIpAddressIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { publicIpAddressIdSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withPrivateIpAddress':: d.fn(help='"The private IP address of the IP configuration."', args=[d.arg(name='privateIpAddress', type=d.T.string)]),
      withPrivateIpAddress(privateIpAddress): { spec+: { forProvider+: { privateIpAddress: privateIpAddress } } },
      '#withPrivateIpAllocationMethod':: d.fn(help='"The private IP address allocation method. Possible values are Static and Dynamic is allowed. Defaults to Dynamic."', args=[d.arg(name='privateIpAllocationMethod', type=d.T.string)]),
      withPrivateIpAllocationMethod(privateIpAllocationMethod): { spec+: { forProvider+: { privateIpAllocationMethod: privateIpAllocationMethod } } },
      '#withPublicIpAddressId':: d.fn(help='"The ID of the Public IP Address. This option is required since September 1st 2021. Changing this forces a new resource to be created."', args=[d.arg(name='publicIpAddressId', type=d.T.string)]),
      withPublicIpAddressId(publicIpAddressId): { spec+: { forProvider+: { publicIpAddressId: publicIpAddressId } } },
      '#withSubnetId':: d.fn(help='"The ID of the Subnet that the IP will reside. Changing this forces a new resource to be created."', args=[d.arg(name='subnetId', type=d.T.string)]),
      withSubnetId(subnetId): { spec+: { forProvider+: { subnetId: subnetId } } },
      '#withVirtualHubId':: d.fn(help='"The ID of the Virtual Hub within which this IP configuration should be created. Changing this forces a new resource to be created."', args=[d.arg(name='virtualHubId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      publicIpAddressIdRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { publicIpAddressIdRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { publicIpAddressIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { publicIpAddressIdRef+: { name: name } } } },
      },
      '#publicIpAddressIdSelector':: d.obj(help='"Selector for a PublicIP in network to populate publicIpAddressId."'),
      publicIpAddressIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { publicIpAddressIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { publicIpAddressIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { publicIpAddressIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { publicIpAddressIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { publicIpAddressIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#subnetIdRef':: d.obj(help='"Reference to a Subnet in network to populate subnetId."'),
      subnetIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
      ...
      '#withPrivateIpAllocationMethod':: d.fn(help='"The private IP address allocation method. Possible values are Static and Dynamic is allowed. Defaults to Dynamic."', args=[d.arg(name='privateIpAllocationMethod', type=d.T.string)]),
      withPrivateIpAllocationMethod(privateIpAllocationMethod): { spec+: { initProvider+: { privateIpAllocationMethod: privateIpAllocationMethod } } },
      '#withPublicIpAddressId':: d.fn(help='"The ID of the Public IP Address. This option is required since September 1st 2021. Changing this forces a new resource to be created."', args=[d.arg(name='publicIpAddressId', type=d.T.string)]),
