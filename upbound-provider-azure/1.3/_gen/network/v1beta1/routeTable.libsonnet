{
  ...
  '#':: d.pkg(name='routeTable', url='', help='"RouteTable is the Schema for the RouteTables API. Manages a Route Table"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#route':: d.obj(help='"List of route objects representing routes as defined below. Each object accepts the arguments documented below."'),
      route: {
        ...
        withAddressPrefix(addressPrefix): { addressPrefix: addressPrefix },
        '#withName':: d.fn(help='"The name of the route."', args=[d.arg(name='name', type=d.T.string)]),
        ...
        withNextHopInIpAddress(nextHopInIpAddress): { nextHopInIpAddress: nextHopInIpAddress },
      ...
      '#withDisableBgpRoutePropagation':: d.fn(help='"Boolean flag which controls propagation of routes learned by BGP on that route table. True means disable."', args=[d.arg(name='disableBgpRoutePropagation', type=d.T.boolean)]),
      withDisableBgpRoutePropagation(disableBgpRoutePropagation): { spec+: { forProvider+: { disableBgpRoutePropagation: disableBgpRoutePropagation } } },
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the route table. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withRoute':: d.fn(help='"List of route objects representing routes as defined below. Each object accepts the arguments documented below."', args=[d.arg(name='route', type=d.T.array)]),
      withRoute(route): { spec+: { forProvider+: { route: if std.isArray(v=route) then route else [route] } } },
      '#withRouteMixin':: d.fn(help='"List of route objects representing routes as defined below. Each object accepts the arguments documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='route', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withDisableBgpRoutePropagation':: d.fn(help='"Boolean flag which controls propagation of routes learned by BGP on that route table. True means disable."', args=[d.arg(name='disableBgpRoutePropagation', type=d.T.boolean)]),
      withDisableBgpRoutePropagation(disableBgpRoutePropagation): { spec+: { initProvider+: { disableBgpRoutePropagation: disableBgpRoutePropagation } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
