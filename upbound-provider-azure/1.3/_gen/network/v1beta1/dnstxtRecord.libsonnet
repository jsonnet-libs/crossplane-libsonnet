{
  ...
  '#':: d.pkg(name='dnstxtRecord', url='', help='"DNSTXTRecord is the Schema for the DNSTXTRecords API. Manages a DNS TXT Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSTXTRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSTXTRecordSpec defines the desired state of DNSTXTRecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"A list of values that make up the txt record. Each record block supports fields documented below."'),
      record: {
        '#withValue':: d.fn(help='"The value of the record. Max length: 4096 characters"', args=[d.arg(name='value', type=d.T.string)]),
      ...
      '#withRecord':: d.fn(help='"A list of values that make up the txt record. Each record block supports fields documented below."', args=[d.arg(name='record', type=d.T.array)]),
      withRecord(record): { spec+: { forProvider+: { record: if std.isArray(v=record) then record else [record] } } },
      '#withRecordMixin':: d.fn(help='"A list of values that make up the txt record. Each record block supports fields documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='record', type=d.T.array)]),
