{
  ...
  '#':: d.pkg(name='managerManagementGroupConnection', url='', help='"ManagerManagementGroupConnection is the Schema for the ManagerManagementGroupConnections API. Manages a Network Manager Management Group Connection."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagerManagementGroupConnection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagerManagementGroupConnectionSpec defines the desired state of ManagerManagementGroupConnection"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description of the Network Manager Management Group Connection."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withManagementGroupId':: d.fn(help='"Specifies the ID of the target Management Group. Changing this forces a new resource to be created."', args=[d.arg(name='managementGroupId', type=d.T.string)]),
      withManagementGroupId(managementGroupId): { spec+: { forProvider+: { managementGroupId: managementGroupId } } },
      '#withNetworkManagerId':: d.fn(help='"Specifies the ID of the Network Manager which the Management Group is connected to. Changing this forces a new resource to be created."', args=[d.arg(name='networkManagerId', type=d.T.string)]),
