{
  ...
  '#':: d.pkg(name='loadBalancerProbe', url='', help='"LoadBalancerProbe is the Schema for the LoadBalancerProbes API. Manages a Load Balancer Probe Resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of LoadBalancerProbe', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LoadBalancerProbeSpec defines the desired state of LoadBalancerProbe"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIntervalInSeconds':: d.fn(help='"The interval, in seconds between probes to the backend endpoint for health status. The default value is 15, the minimum value is 5."', args=[d.arg(name='intervalInSeconds', type=d.T.number)]),
      withIntervalInSeconds(intervalInSeconds): { spec+: { forProvider+: { intervalInSeconds: intervalInSeconds } } },
      '#withLoadbalancerId':: d.fn(help='"The ID of the LoadBalancer in which to create the Probe. Changing this forces a new resource to be created."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
      withLoadbalancerId(loadbalancerId): { spec+: { forProvider+: { loadbalancerId: loadbalancerId } } },
      '#withNumberOfProbes':: d.fn(help='"The number of failed probe attempts after which the backend endpoint is removed from rotation. Default to 2. NumberOfProbes multiplied by intervalInSeconds value must be greater or equal to 10.Endpoints are returned to rotation when at least one probe is successful."', args=[d.arg(name='numberOfProbes', type=d.T.number)]),
      withNumberOfProbes(numberOfProbes): { spec+: { forProvider+: { numberOfProbes: numberOfProbes } } },
      '#withPort':: d.fn(help='"Port on which the Probe queries the backend endpoint. Possible values range from 1 to 65535, inclusive."', args=[d.arg(name='port', type=d.T.number)]),
      withPort(port): { spec+: { forProvider+: { port: port } } },
      '#withProbeThreshold':: d.fn(help='"The number of consecutive successful or failed probes that allow or deny traffic to this endpoint. Possible values range from 1 to 100. The default value is 1."', args=[d.arg(name='probeThreshold', type=d.T.number)]),
      withProbeThreshold(probeThreshold): { spec+: { forProvider+: { probeThreshold: probeThreshold } } },
      '#withProtocol':: d.fn(help='"Specifies the protocol of the end point. Possible values are Http, Https or Tcp. If TCP is specified, a received ACK is required for the probe to be successful. If HTTP is specified, a 200 OK response from the specified URI is required for the probe to be successful. Defaults to Tcp."', args=[d.arg(name='protocol', type=d.T.string)]),
      withProtocol(protocol): { spec+: { forProvider+: { protocol: protocol } } },
      '#withRequestPath':: d.fn(help='"The URI used for requesting health status from the backend endpoint. Required if protocol is set to Http or Https. Otherwise, it is not allowed."', args=[d.arg(name='requestPath', type=d.T.string)]),
    ...
    initProvider: {
      '#withIntervalInSeconds':: d.fn(help='"The interval, in seconds between probes to the backend endpoint for health status. The default value is 15, the minimum value is 5."', args=[d.arg(name='intervalInSeconds', type=d.T.number)]),
      withIntervalInSeconds(intervalInSeconds): { spec+: { initProvider+: { intervalInSeconds: intervalInSeconds } } },
      '#withNumberOfProbes':: d.fn(help='"The number of failed probe attempts after which the backend endpoint is removed from rotation. Default to 2. NumberOfProbes multiplied by intervalInSeconds value must be greater or equal to 10.Endpoints are returned to rotation when at least one probe is successful."', args=[d.arg(name='numberOfProbes', type=d.T.number)]),
      withNumberOfProbes(numberOfProbes): { spec+: { initProvider+: { numberOfProbes: numberOfProbes } } },
      '#withPort':: d.fn(help='"Port on which the Probe queries the backend endpoint. Possible values range from 1 to 65535, inclusive."', args=[d.arg(name='port', type=d.T.number)]),
      withPort(port): { spec+: { initProvider+: { port: port } } },
      '#withProbeThreshold':: d.fn(help='"The number of consecutive successful or failed probes that allow or deny traffic to this endpoint. Possible values range from 1 to 100. The default value is 1."', args=[d.arg(name='probeThreshold', type=d.T.number)]),
      withProbeThreshold(probeThreshold): { spec+: { initProvider+: { probeThreshold: probeThreshold } } },
      '#withProtocol':: d.fn(help='"Specifies the protocol of the end point. Possible values are Http, Https or Tcp. If TCP is specified, a received ACK is required for the probe to be successful. If HTTP is specified, a 200 OK response from the specified URI is required for the probe to be successful. Defaults to Tcp."', args=[d.arg(name='protocol', type=d.T.string)]),
