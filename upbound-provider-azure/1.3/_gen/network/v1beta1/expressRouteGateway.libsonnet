{
  ...
  '#':: d.pkg(name='expressRouteGateway', url='', help='"ExpressRouteGateway is the Schema for the ExpressRouteGateways API. Manages an ExpressRoute gateway."'),
  ...
  '#new':: d.fn(help='new returns an instance of ExpressRouteGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ExpressRouteGatewaySpec defines the desired state of ExpressRouteGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowNonVirtualWanTraffic':: d.fn(help='"Specified whether this gateway accept traffic from non-Virtual WAN networks. Defaults to false."', args=[d.arg(name='allowNonVirtualWanTraffic', type=d.T.boolean)]),
      withAllowNonVirtualWanTraffic(allowNonVirtualWanTraffic): { spec+: { forProvider+: { allowNonVirtualWanTraffic: allowNonVirtualWanTraffic } } },
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the ExpressRoute gateway. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withScaleUnits':: d.fn(help='"The number of scale units with which to provision the ExpressRoute gateway. Each scale unit is equal to 2Gbps, with support for up to 10 scale units (20Gbps)."', args=[d.arg(name='scaleUnits', type=d.T.number)]),
      ...
      '#withVirtualHubId':: d.fn(help='"The ID of a Virtual HUB within which the ExpressRoute gateway should be created. Changing this forces a new resource to be created."', args=[d.arg(name='virtualHubId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAllowNonVirtualWanTraffic':: d.fn(help='"Specified whether this gateway accept traffic from non-Virtual WAN networks. Defaults to false."', args=[d.arg(name='allowNonVirtualWanTraffic', type=d.T.boolean)]),
      withAllowNonVirtualWanTraffic(allowNonVirtualWanTraffic): { spec+: { initProvider+: { allowNonVirtualWanTraffic: allowNonVirtualWanTraffic } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
