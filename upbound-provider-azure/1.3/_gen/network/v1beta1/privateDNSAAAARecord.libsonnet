{
  ...
  '#':: d.pkg(name='privateDNSAAAARecord', url='', help='"PrivateDNSAAAARecord is the Schema for the PrivateDNSAAAARecords API. Manages a Private DNS AAAA Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSAAAARecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSAAAARecordSpec defines the desired state of PrivateDNSAAAARecord"'),
  spec: {
