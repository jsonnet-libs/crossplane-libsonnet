{
  ...
  '#':: d.pkg(name='virtualNetwork', url='', help='"VirtualNetwork is the Schema for the VirtualNetworks API. Manages a virtual network including any configured subnets. Each subnet can optionally be configured with a security group to be associated with the subnet."'),
  ...
  '#spec':: d.obj(help='"VirtualNetworkSpec defines the desired state of VirtualNetwork"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#ddosProtectionPlan':: d.obj(help='"A ddos_protection_plan block as documented below."'),
      ddosProtectionPlan: {
        '#withEnable':: d.fn(help='"Enable/disable DDoS Protection Plan on Virtual Network."', args=[d.arg(name='enable', type=d.T.boolean)]),
        withEnable(enable): { enable: enable },
        '#withId':: d.fn(help='"The ID of DDoS Protection Plan."', args=[d.arg(name='id', type=d.T.string)]),
        withId(id): { id: id },
      },
      '#encryption':: d.obj(help='"A encryption block as defined below."'),
      encryption: {
        '#withEnforcement':: d.fn(help='"Specifies if the encrypted Virtual Network allows VM that does not support encryption. Possible values are DropUnencrypted and AllowUnencrypted."', args=[d.arg(name='enforcement', type=d.T.string)]),
        withEnforcement(enforcement): { enforcement: enforcement },
      },
      ...
      '#withAddressSpace':: d.fn(help='"The address space that is used the virtual network. You can supply more than one address space."', args=[d.arg(name='addressSpace', type=d.T.array)]),
      withAddressSpace(addressSpace): { spec+: { forProvider+: { addressSpace: if std.isArray(v=addressSpace) then addressSpace else [addressSpace] } } },
      '#withAddressSpaceMixin':: d.fn(help='"The address space that is used the virtual network. You can supply more than one address space."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addressSpace', type=d.T.array)]),
      withAddressSpaceMixin(addressSpace): { spec+: { forProvider+: { addressSpace+: if std.isArray(v=addressSpace) then addressSpace else [addressSpace] } } },
      '#withBgpCommunity':: d.fn(help='"The BGP community attribute in format <as-number>:<community-value>."', args=[d.arg(name='bgpCommunity', type=d.T.string)]),
      withBgpCommunity(bgpCommunity): { spec+: { forProvider+: { bgpCommunity: bgpCommunity } } },
      '#withDdosProtectionPlan':: d.fn(help='"A ddos_protection_plan block as documented below."', args=[d.arg(name='ddosProtectionPlan', type=d.T.array)]),
      withDdosProtectionPlan(ddosProtectionPlan): { spec+: { forProvider+: { ddosProtectionPlan: if std.isArray(v=ddosProtectionPlan) then ddosProtectionPlan else [ddosProtectionPlan] } } },
      '#withDdosProtectionPlanMixin':: d.fn(help='"A ddos_protection_plan block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ddosProtectionPlan', type=d.T.array)]),
      withDdosProtectionPlanMixin(ddosProtectionPlan): { spec+: { forProvider+: { ddosProtectionPlan+: if std.isArray(v=ddosProtectionPlan) then ddosProtectionPlan else [ddosProtectionPlan] } } },
      '#withDnsServers':: d.fn(help='"List of IP addresses of DNS servers"', args=[d.arg(name='dnsServers', type=d.T.array)]),
      withDnsServers(dnsServers): { spec+: { forProvider+: { dnsServers: if std.isArray(v=dnsServers) then dnsServers else [dnsServers] } } },
      '#withDnsServersMixin':: d.fn(help='"List of IP addresses of DNS servers"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dnsServers', type=d.T.array)]),
      withDnsServersMixin(dnsServers): { spec+: { forProvider+: { dnsServers+: if std.isArray(v=dnsServers) then dnsServers else [dnsServers] } } },
      '#withEdgeZone':: d.fn(help='"Specifies the Edge Zone within the Azure Region where this Virtual Network should exist. Changing this forces a new Virtual Network to be created."', args=[d.arg(name='edgeZone', type=d.T.string)]),
      withEdgeZone(edgeZone): { spec+: { forProvider+: { edgeZone: edgeZone } } },
      '#withEncryption':: d.fn(help='"A encryption block as defined below."', args=[d.arg(name='encryption', type=d.T.array)]),
      withEncryption(encryption): { spec+: { forProvider+: { encryption: if std.isArray(v=encryption) then encryption else [encryption] } } },
      '#withEncryptionMixin':: d.fn(help='"A encryption block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryption', type=d.T.array)]),
      withEncryptionMixin(encryption): { spec+: { forProvider+: { encryption+: if std.isArray(v=encryption) then encryption else [encryption] } } },
      '#withFlowTimeoutInMinutes':: d.fn(help='"The flow timeout in minutes for the Virtual Network, which is used to enable connection tracking for intra-VM flows. Possible values are between 4 and 30 minutes."', args=[d.arg(name='flowTimeoutInMinutes', type=d.T.number)]),
      withFlowTimeoutInMinutes(flowTimeoutInMinutes): { spec+: { forProvider+: { flowTimeoutInMinutes: flowTimeoutInMinutes } } },
      '#withLocation':: d.fn(help='"The location/region where the virtual network is created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the virtual network. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAddressSpace':: d.fn(help='"The address space that is used the virtual network. You can supply more than one address space."', args=[d.arg(name='addressSpace', type=d.T.array)]),
      withAddressSpace(addressSpace): { spec+: { initProvider+: { addressSpace: if std.isArray(v=addressSpace) then addressSpace else [addressSpace] } } },
      '#withAddressSpaceMixin':: d.fn(help='"The address space that is used the virtual network. You can supply more than one address space."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addressSpace', type=d.T.array)]),
      withAddressSpaceMixin(addressSpace): { spec+: { initProvider+: { addressSpace+: if std.isArray(v=addressSpace) then addressSpace else [addressSpace] } } },
      '#withBgpCommunity':: d.fn(help='"The BGP community attribute in format <as-number>:<community-value>."', args=[d.arg(name='bgpCommunity', type=d.T.string)]),
      withBgpCommunity(bgpCommunity): { spec+: { initProvider+: { bgpCommunity: bgpCommunity } } },
      '#withDdosProtectionPlan':: d.fn(help='"A ddos_protection_plan block as documented below."', args=[d.arg(name='ddosProtectionPlan', type=d.T.array)]),
      withDdosProtectionPlan(ddosProtectionPlan): { spec+: { initProvider+: { ddosProtectionPlan: if std.isArray(v=ddosProtectionPlan) then ddosProtectionPlan else [ddosProtectionPlan] } } },
      '#withDdosProtectionPlanMixin':: d.fn(help='"A ddos_protection_plan block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ddosProtectionPlan', type=d.T.array)]),
      withDdosProtectionPlanMixin(ddosProtectionPlan): { spec+: { initProvider+: { ddosProtectionPlan+: if std.isArray(v=ddosProtectionPlan) then ddosProtectionPlan else [ddosProtectionPlan] } } },
      '#withDnsServers':: d.fn(help='"List of IP addresses of DNS servers"', args=[d.arg(name='dnsServers', type=d.T.array)]),
      ...
      '#withFlowTimeoutInMinutes':: d.fn(help='"The flow timeout in minutes for the Virtual Network, which is used to enable connection tracking for intra-VM flows. Possible values are between 4 and 30 minutes."', args=[d.arg(name='flowTimeoutInMinutes', type=d.T.number)]),
      withFlowTimeoutInMinutes(flowTimeoutInMinutes): { spec+: { initProvider+: { flowTimeoutInMinutes: flowTimeoutInMinutes } } },
      '#withLocation':: d.fn(help='"The location/region where the virtual network is created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
