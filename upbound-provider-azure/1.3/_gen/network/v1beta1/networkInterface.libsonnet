{
  ...
  '#':: d.pkg(name='networkInterface', url='', help='"NetworkInterface is the Schema for the NetworkInterfaces API. Manages a Network Interface."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      ipConfiguration: {
        ...
        '#withGatewayLoadBalancerFrontendIpConfigurationId':: d.fn(help='"The Frontend IP Configuration ID of a Gateway SKU Load Balancer."', args=[d.arg(name='gatewayLoadBalancerFrontendIpConfigurationId', type=d.T.string)]),
        withGatewayLoadBalancerFrontendIpConfigurationId(gatewayLoadBalancerFrontendIpConfigurationId): { gatewayLoadBalancerFrontendIpConfigurationId: gatewayLoadBalancerFrontendIpConfigurationId },
        '#withName':: d.fn(help='"A name used for this IP Configuration."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withPrimary':: d.fn(help='"Is this the Primary IP Configuration? Must be true for the first ip_configuration when multiple are specified. Defaults to false."', args=[d.arg(name='primary', type=d.T.boolean)]),
        ...
        '#withPrivateIpAddressVersion':: d.fn(help='"The IP Version to use. Possible values are IPv4 or IPv6. Defaults to IPv4."', args=[d.arg(name='privateIpAddressVersion', type=d.T.string)]),
        withPrivateIpAddressVersion(privateIpAddressVersion): { privateIpAddressVersion: privateIpAddressVersion },
        '#withPublicIpAddressId':: d.fn(help='"Reference to a Public IP Address to associate with this NIC"', args=[d.arg(name='publicIpAddressId', type=d.T.string)]),
        withPublicIpAddressId(publicIpAddressId): { publicIpAddressId: publicIpAddressId },
        '#withSubnetId':: d.fn(help='"The ID of the Subnet where this Network Interface should be located in."', args=[d.arg(name='subnetId', type=d.T.string)]),
      ...
      '#withAuxiliaryMode':: d.fn(help='"Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). This feature offers competitive performance in Connections Per Second (CPS) optimization, along with improvements to handling large amounts of simultaneous connections. Possible values are AcceleratedConnections, Floating, MaxConnections and None."', args=[d.arg(name='auxiliaryMode', type=d.T.string)]),
      withAuxiliaryMode(auxiliaryMode): { spec+: { forProvider+: { auxiliaryMode: auxiliaryMode } } },
      '#withAuxiliarySku':: d.fn(help='"Specifies the SKU used for the network high-performance feature on Network Virtual Appliances (NVAs). Possible values are A8, A4, A1, A2 and None."', args=[d.arg(name='auxiliarySku', type=d.T.string)]),
      withAuxiliarySku(auxiliarySku): { spec+: { forProvider+: { auxiliarySku: auxiliarySku } } },
      '#withDnsServers':: d.fn(help='"A list of IP Addresses defining the DNS Servers which should be used for this Network Interface."', args=[d.arg(name='dnsServers', type=d.T.array)]),
      withDnsServers(dnsServers): { spec+: { forProvider+: { dnsServers: if std.isArray(v=dnsServers) then dnsServers else [dnsServers] } } },
      '#withDnsServersMixin':: d.fn(help='"A list of IP Addresses defining the DNS Servers which should be used for this Network Interface."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dnsServers', type=d.T.array)]),
      withDnsServersMixin(dnsServers): { spec+: { forProvider+: { dnsServers+: if std.isArray(v=dnsServers) then dnsServers else [dnsServers] } } },
      '#withEdgeZone':: d.fn(help='"Specifies the Edge Zone within the Azure Region where this Network Interface should exist. Changing this forces a new Network Interface to be created."', args=[d.arg(name='edgeZone', type=d.T.string)]),
      withEdgeZone(edgeZone): { spec+: { forProvider+: { edgeZone: edgeZone } } },
      '#withEnableAcceleratedNetworking':: d.fn(help='"Should Accelerated Networking be enabled? Defaults to false."', args=[d.arg(name='enableAcceleratedNetworking', type=d.T.boolean)]),
      withEnableAcceleratedNetworking(enableAcceleratedNetworking): { spec+: { forProvider+: { enableAcceleratedNetworking: enableAcceleratedNetworking } } },
      '#withEnableIpForwarding':: d.fn(help='"Should IP Forwarding be enabled? Defaults to false."', args=[d.arg(name='enableIpForwarding', type=d.T.boolean)]),
      withEnableIpForwarding(enableIpForwarding): { spec+: { forProvider+: { enableIpForwarding: enableIpForwarding } } },
      '#withInternalDnsNameLabel':: d.fn(help='"The (relative) DNS Name used for internal communications between Virtual Machines in the same Virtual Network."', args=[d.arg(name='internalDnsNameLabel', type=d.T.string)]),
      withInternalDnsNameLabel(internalDnsNameLabel): { spec+: { forProvider+: { internalDnsNameLabel: internalDnsNameLabel } } },
      ...
      '#withLocation':: d.fn(help='"The location where the Network Interface should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which to create the Network Interface. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAuxiliaryMode':: d.fn(help='"Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). This feature offers competitive performance in Connections Per Second (CPS) optimization, along with improvements to handling large amounts of simultaneous connections. Possible values are AcceleratedConnections, Floating, MaxConnections and None."', args=[d.arg(name='auxiliaryMode', type=d.T.string)]),
      withAuxiliaryMode(auxiliaryMode): { spec+: { initProvider+: { auxiliaryMode: auxiliaryMode } } },
      '#withAuxiliarySku':: d.fn(help='"Specifies the SKU used for the network high-performance feature on Network Virtual Appliances (NVAs). Possible values are A8, A4, A1, A2 and None."', args=[d.arg(name='auxiliarySku', type=d.T.string)]),
      withAuxiliarySku(auxiliarySku): { spec+: { initProvider+: { auxiliarySku: auxiliarySku } } },
      '#withDnsServers':: d.fn(help='"A list of IP Addresses defining the DNS Servers which should be used for this Network Interface."', args=[d.arg(name='dnsServers', type=d.T.array)]),
      ...
      '#withEnableAcceleratedNetworking':: d.fn(help='"Should Accelerated Networking be enabled? Defaults to false."', args=[d.arg(name='enableAcceleratedNetworking', type=d.T.boolean)]),
      withEnableAcceleratedNetworking(enableAcceleratedNetworking): { spec+: { initProvider+: { enableAcceleratedNetworking: enableAcceleratedNetworking } } },
      '#withEnableIpForwarding':: d.fn(help='"Should IP Forwarding be enabled? Defaults to false."', args=[d.arg(name='enableIpForwarding', type=d.T.boolean)]),
      withEnableIpForwarding(enableIpForwarding): { spec+: { initProvider+: { enableIpForwarding: enableIpForwarding } } },
      '#withInternalDnsNameLabel':: d.fn(help='"The (relative) DNS Name used for internal communications between Virtual Machines in the same Virtual Network."', args=[d.arg(name='internalDnsNameLabel', type=d.T.string)]),
      withInternalDnsNameLabel(internalDnsNameLabel): { spec+: { initProvider+: { internalDnsNameLabel: internalDnsNameLabel } } },
      '#withIpConfiguration':: d.fn(help='"One or more ip_configuration blocks as defined below."', args=[d.arg(name='ipConfiguration', type=d.T.array)]),
