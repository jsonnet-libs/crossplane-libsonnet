{
  ...
  '#':: d.pkg(name='privateDNSZoneVirtualNetworkLink', url='', help='"PrivateDNSZoneVirtualNetworkLink is the Schema for the PrivateDNSZoneVirtualNetworkLinks API. Manages a Private DNS Zone Virtual Network Link."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSZoneVirtualNetworkLink', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSZoneVirtualNetworkLinkSpec defines the desired state of PrivateDNSZoneVirtualNetworkLink"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#privateDnsZoneNameRef':: d.obj(help='"Reference to a PrivateDNSZone in network to populate privateDnsZoneName."'),
      privateDnsZoneNameRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { privateDnsZoneNameRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { privateDnsZoneNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { privateDnsZoneNameRef+: { name: name } } } },
      },
      '#privateDnsZoneNameSelector':: d.obj(help='"Selector for a PrivateDNSZone in network to populate privateDnsZoneName."'),
      privateDnsZoneNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { privateDnsZoneNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { privateDnsZoneNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { privateDnsZoneNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { privateDnsZoneNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { privateDnsZoneNameSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withPrivateDnsZoneName':: d.fn(help='"The name of the Private DNS zone (without a terminating dot). Changing this forces a new resource to be created."', args=[d.arg(name='privateDnsZoneName', type=d.T.string)]),
      withPrivateDnsZoneName(privateDnsZoneName): { spec+: { forProvider+: { privateDnsZoneName: privateDnsZoneName } } },
      '#withRegistrationEnabled':: d.fn(help='"Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled? Defaults to false."', args=[d.arg(name='registrationEnabled', type=d.T.boolean)]),
      withRegistrationEnabled(registrationEnabled): { spec+: { forProvider+: { registrationEnabled: registrationEnabled } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the resource group where the Private DNS Zone exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withVirtualNetworkId':: d.fn(help='"The ID of the Virtual Network that should be linked to the DNS Zone. Changing this forces a new resource to be created."', args=[d.arg(name='virtualNetworkId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withRegistrationEnabled':: d.fn(help='"Is auto-registration of virtual machine records in the virtual network in the Private DNS zone enabled? Defaults to false."', args=[d.arg(name='registrationEnabled', type=d.T.boolean)]),
      withRegistrationEnabled(registrationEnabled): { spec+: { initProvider+: { registrationEnabled: registrationEnabled } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
