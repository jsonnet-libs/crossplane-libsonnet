{
  ...
  '#':: d.pkg(name='routeServer', url='', help='"RouteServer is the Schema for the RouteServers API. Manages an Azure Route Server"'),
  ...
  '#new':: d.fn(help='new returns an instance of RouteServer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RouteServerSpec defines the desired state of RouteServer"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBranchToBranchTrafficEnabled':: d.fn(help='"Whether to enable route exchange between Azure Route Server and the gateway(s)"', args=[d.arg(name='branchToBranchTrafficEnabled', type=d.T.boolean)]),
      withBranchToBranchTrafficEnabled(branchToBranchTrafficEnabled): { spec+: { forProvider+: { branchToBranchTrafficEnabled: branchToBranchTrafficEnabled } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Route Server should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group where the Route Server should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"The SKU of the Route Server. The only possible value is Standard. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withSubnetId':: d.fn(help='"The ID of the Subnet that the Route Server will reside. Changing this forces a new resource to be created."', args=[d.arg(name='subnetId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withBranchToBranchTrafficEnabled':: d.fn(help='"Whether to enable route exchange between Azure Route Server and the gateway(s)"', args=[d.arg(name='branchToBranchTrafficEnabled', type=d.T.boolean)]),
      withBranchToBranchTrafficEnabled(branchToBranchTrafficEnabled): { spec+: { initProvider+: { branchToBranchTrafficEnabled: branchToBranchTrafficEnabled } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Route Server should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
