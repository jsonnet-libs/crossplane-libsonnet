  ...
  spec: {
    ...
    forProvider: {
      ...
      scope: {
        ...
        withManagementGroupIds(managementGroupIds): { managementGroupIds: if std.isArray(v=managementGroupIds) then managementGroupIds else [managementGroupIds] },
        ...
        withManagementGroupIdsMixin(managementGroupIds): { managementGroupIds+: if std.isArray(v=managementGroupIds) then managementGroupIds else [managementGroupIds] },
        '#withSubscriptionIds':: d.fn(help='"A list of subscription IDs."', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
        withSubscriptionIds(subscriptionIds): { subscriptionIds: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] },
        ...
        withSubscriptionIdsMixin(subscriptionIds): { subscriptionIds+: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] },
      },
