{
  ...
  '#':: d.pkg(name='privateDNSARecord', url='', help='"PrivateDNSARecord is the Schema for the PrivateDNSARecords API. Manages a Private DNS A Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSARecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSARecordSpec defines the desired state of PrivateDNSARecord"'),
  spec: {
