{
  ...
  '#':: d.pkg(name='loadBalancer', url='', help='"LoadBalancer is the Schema for the LoadBalancers API. Manages a Load Balancer Resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#frontendIpConfiguration':: d.obj(help='"One or more frontend_ip_configuration blocks as documented below."'),
      frontendIpConfiguration: {
        ...
        '#withName':: d.fn(help='"Specifies the name of the frontend IP configuration."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withPrivateIpAddress':: d.fn(help='"Private IP Address to assign to the Load Balancer. The last one and first four IPs in any range are reserved and cannot be manually assigned."', args=[d.arg(name='privateIpAddress', type=d.T.string)]),
        withPrivateIpAddress(privateIpAddress): { privateIpAddress: privateIpAddress },
        '#withPrivateIpAddressAllocation':: d.fn(help='"The allocation method for the Private IP Address used by this Load Balancer. Possible values as Dynamic and Static."', args=[d.arg(name='privateIpAddressAllocation', type=d.T.string)]),
        withPrivateIpAddressAllocation(privateIpAddressAllocation): { privateIpAddressAllocation: privateIpAddressAllocation },
        '#withPrivateIpAddressVersion':: d.fn(help='"The version of IP that the Private IP Address is. Possible values are IPv4 or IPv6."', args=[d.arg(name='privateIpAddressVersion', type=d.T.string)]),
        withPrivateIpAddressVersion(privateIpAddressVersion): { privateIpAddressVersion: privateIpAddressVersion },
        '#withPublicIpAddressId':: d.fn(help='"The ID of a Public IP Address which should be associated with the Load Balancer."', args=[d.arg(name='publicIpAddressId', type=d.T.string)]),
        withPublicIpAddressId(publicIpAddressId): { publicIpAddressId: publicIpAddressId },
        '#withPublicIpPrefixId':: d.fn(help='"The ID of a Public IP Prefix which should be associated with the Load Balancer. Public IP Prefix can only be used with outbound rules."', args=[d.arg(name='publicIpPrefixId', type=d.T.string)]),
        withPublicIpPrefixId(publicIpPrefixId): { publicIpPrefixId: publicIpPrefixId },
        '#withSubnetId':: d.fn(help='"The ID of the Subnet which should be associated with the IP Configuration."', args=[d.arg(name='subnetId', type=d.T.string)]),
        withSubnetId(subnetId): { subnetId: subnetId },
        '#withZones':: d.fn(help='"Specifies a list of Availability Zones in which the IP Address for this Load Balancer should be located."', args=[d.arg(name='zones', type=d.T.array)]),
        withZones(zones): { zones: if std.isArray(v=zones) then zones else [zones] },
        '#withZonesMixin':: d.fn(help='"Specifies a list of Availability Zones in which the IP Address for this Load Balancer should be located."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zones', type=d.T.array)]),
      ...
      '#withEdgeZone':: d.fn(help='"Specifies the Edge Zone within the Azure Region where this Load Balancer should exist. Changing this forces a new Load Balancer to be created."', args=[d.arg(name='edgeZone', type=d.T.string)]),
      withEdgeZone(edgeZone): { spec+: { forProvider+: { edgeZone: edgeZone } } },
      '#withFrontendIpConfiguration':: d.fn(help='"One or more frontend_ip_configuration blocks as documented below."', args=[d.arg(name='frontendIpConfiguration', type=d.T.array)]),
      ...
      '#withLocation':: d.fn(help='"Specifies the supported Azure Region where the Load Balancer should be created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which to create the Load Balancer. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"The SKU of the Azure Load Balancer. Accepted values are Basic, Standard and Gateway. Defaults to Basic. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withSkuTier':: d.fn(help='"sku_tier -  The SKU tier of this Load Balancer. Possible values are Global and Regional. Defaults to Regional. Changing this forces a new resource to be created."', args=[d.arg(name='skuTier', type=d.T.string)]),
