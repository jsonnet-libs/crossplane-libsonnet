{
  ...
  '#':: d.pkg(name='natGatewayPublicIPAssociation', url='', help='"NATGatewayPublicIPAssociation is the Schema for the NATGatewayPublicIPAssociations API. Manages the association between a NAT Gateway and a Public IP."'),
  ...
  '#new':: d.fn(help='new returns an instance of NATGatewayPublicIPAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NATGatewayPublicIPAssociationSpec defines the desired state of NATGatewayPublicIPAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPublicIpAddressId':: d.fn(help='"The ID of the Public IP which this NAT Gateway which should be connected to. Changing this forces a new resource to be created."', args=[d.arg(name='publicIpAddressId', type=d.T.string)]),
