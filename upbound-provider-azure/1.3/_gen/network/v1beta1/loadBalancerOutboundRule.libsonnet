{
  ...
  '#':: d.pkg(name='loadBalancerOutboundRule', url='', help='"LoadBalancerOutboundRule is the Schema for the LoadBalancerOutboundRules API. Manages a Load Balancer Outbound Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of LoadBalancerOutboundRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LoadBalancerOutboundRuleSpec defines the desired state of LoadBalancerOutboundRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAllocatedOutboundPorts':: d.fn(help='"The number of outbound ports to be used for NAT. Defaults to 1024."', args=[d.arg(name='allocatedOutboundPorts', type=d.T.number)]),
      withAllocatedOutboundPorts(allocatedOutboundPorts): { spec+: { forProvider+: { allocatedOutboundPorts: allocatedOutboundPorts } } },
      '#withBackendAddressPoolId':: d.fn(help='"The ID of the Backend Address Pool. Outbound traffic is randomly load balanced across IPs in the backend IPs."', args=[d.arg(name='backendAddressPoolId', type=d.T.string)]),
      withBackendAddressPoolId(backendAddressPoolId): { spec+: { forProvider+: { backendAddressPoolId: backendAddressPoolId } } },
      '#withEnableTcpReset':: d.fn(help='"Receive bidirectional TCP Reset on TCP flow idle timeout or unexpected connection termination. This element is only used when the protocol is set to TCP."', args=[d.arg(name='enableTcpReset', type=d.T.boolean)]),
      ...
      '#withIdleTimeoutInMinutes':: d.fn(help='"The timeout for the TCP idle connection Defaults to 4."', args=[d.arg(name='idleTimeoutInMinutes', type=d.T.number)]),
      withIdleTimeoutInMinutes(idleTimeoutInMinutes): { spec+: { forProvider+: { idleTimeoutInMinutes: idleTimeoutInMinutes } } },
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the Outbound Rule. Changing this forces a new resource to be created."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAllocatedOutboundPorts':: d.fn(help='"The number of outbound ports to be used for NAT. Defaults to 1024."', args=[d.arg(name='allocatedOutboundPorts', type=d.T.number)]),
      withAllocatedOutboundPorts(allocatedOutboundPorts): { spec+: { initProvider+: { allocatedOutboundPorts: allocatedOutboundPorts } } },
      '#withBackendAddressPoolId':: d.fn(help='"The ID of the Backend Address Pool. Outbound traffic is randomly load balanced across IPs in the backend IPs."', args=[d.arg(name='backendAddressPoolId', type=d.T.string)]),
