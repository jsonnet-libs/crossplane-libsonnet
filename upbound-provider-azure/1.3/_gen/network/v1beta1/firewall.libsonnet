  ...
  spec: {
    ...
    forProvider: {
      ...
      virtualHub: {
        ...
        withPublicIpCount(publicIpCount): { publicIpCount: publicIpCount },
        ...
        withVirtualHubId(virtualHubId): { virtualHubId: virtualHubId },
      },
      ...
      '#withManagementIpConfiguration':: d.fn(help='"A management_ip_configuration block as documented below, which allows force-tunnelling of traffic to be performed by the firewall. Adding or removing this block or changing the subnet_id in an existing block forces a new resource to be created. Changing this forces a new resource to be created."', args=[d.arg(name='managementIpConfiguration', type=d.T.array)]),
      withManagementIpConfiguration(managementIpConfiguration): { spec+: { forProvider+: { managementIpConfiguration: if std.isArray(v=managementIpConfiguration) then managementIpConfiguration else [managementIpConfiguration] } } },
      '#withManagementIpConfigurationMixin':: d.fn(help='"A management_ip_configuration block as documented below, which allows force-tunnelling of traffic to be performed by the firewall. Adding or removing this block or changing the subnet_id in an existing block forces a new resource to be created. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managementIpConfiguration', type=d.T.array)]),
      withManagementIpConfigurationMixin(managementIpConfiguration): { spec+: { forProvider+: { managementIpConfiguration+: if std.isArray(v=managementIpConfiguration) then managementIpConfiguration else [managementIpConfiguration] } } },
      ...
      '#withVirtualHub':: d.fn(help='"A virtual_hub block as documented below."', args=[d.arg(name='virtualHub', type=d.T.array)]),
      withVirtualHub(virtualHub): { spec+: { forProvider+: { virtualHub: if std.isArray(v=virtualHub) then virtualHub else [virtualHub] } } },
      '#withVirtualHubMixin':: d.fn(help='"A virtual_hub block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='virtualHub', type=d.T.array)]),
      withVirtualHubMixin(virtualHub): { spec+: { forProvider+: { virtualHub+: if std.isArray(v=virtualHub) then virtualHub else [virtualHub] } } },
    ...
    initProvider: {
      ...
      '#withManagementIpConfiguration':: d.fn(help='"A management_ip_configuration block as documented below, which allows force-tunnelling of traffic to be performed by the firewall. Adding or removing this block or changing the subnet_id in an existing block forces a new resource to be created. Changing this forces a new resource to be created."', args=[d.arg(name='managementIpConfiguration', type=d.T.array)]),
      withManagementIpConfiguration(managementIpConfiguration): { spec+: { initProvider+: { managementIpConfiguration: if std.isArray(v=managementIpConfiguration) then managementIpConfiguration else [managementIpConfiguration] } } },
      '#withManagementIpConfigurationMixin':: d.fn(help='"A management_ip_configuration block as documented below, which allows force-tunnelling of traffic to be performed by the firewall. Adding or removing this block or changing the subnet_id in an existing block forces a new resource to be created. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managementIpConfiguration', type=d.T.array)]),
      withManagementIpConfigurationMixin(managementIpConfiguration): { spec+: { initProvider+: { managementIpConfiguration+: if std.isArray(v=managementIpConfiguration) then managementIpConfiguration else [managementIpConfiguration] } } },
      '#withPrivateIpRanges':: d.fn(help='"A list of SNAT private CIDR IP ranges, or the special string IANAPrivateRanges, which indicates Azure Firewall does not SNAT when the destination IP address is a private range per IANA RFC 1918."', args=[d.arg(name='privateIpRanges', type=d.T.array)]),
      ...
      '#withVirtualHub':: d.fn(help='"A virtual_hub block as documented below."', args=[d.arg(name='virtualHub', type=d.T.array)]),
      withVirtualHub(virtualHub): { spec+: { initProvider+: { virtualHub: if std.isArray(v=virtualHub) then virtualHub else [virtualHub] } } },
      '#withVirtualHubMixin':: d.fn(help='"A virtual_hub block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='virtualHub', type=d.T.array)]),
      withVirtualHubMixin(virtualHub): { spec+: { initProvider+: { virtualHub+: if std.isArray(v=virtualHub) then virtualHub else [virtualHub] } } },
      '#withZones':: d.fn(help='"Specifies a list of Availability Zones in which this Azure Firewall should be located. Changing this forces a new Azure Firewall to be created."', args=[d.arg(name='zones', type=d.T.array)]),
