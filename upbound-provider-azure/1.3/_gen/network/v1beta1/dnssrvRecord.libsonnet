{
  ...
  '#':: d.pkg(name='dnssrvRecord', url='', help='"DNSSRVRecord is the Schema for the DNSSRVRecords API. Manages a DNS SRV Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSSRVRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSSRVRecordSpec defines the desired state of DNSSRVRecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"A list of values that make up the SRV record. Each record block supports fields documented below."'),
      record: {
        '#withPort':: d.fn(help='"Port the service is listening on."', args=[d.arg(name='port', type=d.T.number)]),
        withPort(port): { port: port },
        '#withPriority':: d.fn(help='"Priority of the SRV record."', args=[d.arg(name='priority', type=d.T.number)]),
        withPriority(priority): { priority: priority },
        '#withTarget':: d.fn(help='"FQDN of the service."', args=[d.arg(name='target', type=d.T.string)]),
        withTarget(target): { target: target },
        '#withWeight':: d.fn(help='"Weight of the SRV record."', args=[d.arg(name='weight', type=d.T.number)]),
      ...
      '#withRecord':: d.fn(help='"A list of values that make up the SRV record. Each record block supports fields documented below."', args=[d.arg(name='record', type=d.T.array)]),
      withRecord(record): { spec+: { forProvider+: { record: if std.isArray(v=record) then record else [record] } } },
      '#withRecordMixin':: d.fn(help='"A list of values that make up the SRV record. Each record block supports fields documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='record', type=d.T.array)]),
