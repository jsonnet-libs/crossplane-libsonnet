{
  ...
  '#':: d.pkg(name='routeServerBGPConnection', url='', help='"RouteServerBGPConnection is the Schema for the RouteServerBGPConnections API. Manages a BGP Connection for a Route Server."'),
  ...
  '#new':: d.fn(help='new returns an instance of RouteServerBGPConnection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RouteServerBGPConnectionSpec defines the desired state of RouteServerBGPConnection"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#routeServerIdRef':: d.obj(help='"Reference to a RouteServer in network to populate routeServerId."'),
      routeServerIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { routeServerIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { routeServerIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { routeServerIdRef+: { name: name } } } },
      },
      '#routeServerIdSelector':: d.obj(help='"Selector for a RouteServer in network to populate routeServerId."'),
      routeServerIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { routeServerIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { routeServerIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { routeServerIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { routeServerIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { routeServerIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withPeerAsn':: d.fn(help='"The peer autonomous system number for the Route Server Bgp Connection. Changing this forces a new resource to be created."', args=[d.arg(name='peerAsn', type=d.T.number)]),
      withPeerAsn(peerAsn): { spec+: { forProvider+: { peerAsn: peerAsn } } },
      '#withPeerIp':: d.fn(help='"The peer ip address for the Route Server Bgp Connection. Changing this forces a new resource to be created."', args=[d.arg(name='peerIp', type=d.T.string)]),
      withPeerIp(peerIp): { spec+: { forProvider+: { peerIp: peerIp } } },
      '#withRouteServerId':: d.fn(help='"The ID of the Route Server within which this Bgp connection should be created. Changing this forces a new resource to be created."', args=[d.arg(name='routeServerId', type=d.T.string)]),
      withRouteServerId(routeServerId): { spec+: { forProvider+: { routeServerId: routeServerId } } },
    },
