{
  ...
  '#':: d.pkg(name='virtualHubRouteTable', url='', help='"VirtualHubRouteTable is the Schema for the VirtualHubRouteTables API. Manages a Virtual Hub Route Table."'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualHubRouteTable', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualHubRouteTableSpec defines the desired state of VirtualHubRouteTable"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#route':: d.obj(help='"One or more route blocks as defined below."'),
      route: {
        '#nextHopRef':: d.obj(help='"Reference to a VirtualHubConnection in network to populate nextHop."'),
        nextHopRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { nextHopRef+: { policy+: { resolution: resolution } } },
            ...
            withResolve(resolve): { nextHopRef+: { policy+: { resolve: resolve } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { nextHopRef+: { name: name } },
        },
        '#nextHopSelector':: d.obj(help='"Selector for a VirtualHubConnection in network to populate nextHop."'),
        nextHopSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { nextHopSelector+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { nextHopSelector+: { policy+: { resolve: resolve } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { nextHopSelector+: { matchControllerRef: matchControllerRef } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { nextHopSelector+: { matchLabels: matchLabels } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { nextHopSelector+: { matchLabels+: matchLabels } },
        },
        '#withDestinations':: d.fn(help='"A list of destination addresses for this route."', args=[d.arg(name='destinations', type=d.T.array)]),
        withDestinations(destinations): { destinations: if std.isArray(v=destinations) then destinations else [destinations] },
        '#withDestinationsMixin':: d.fn(help='"A list of destination addresses for this route."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='destinations', type=d.T.array)]),
        withDestinationsMixin(destinations): { destinations+: if std.isArray(v=destinations) then destinations else [destinations] },
        '#withDestinationsType':: d.fn(help='"The type of destinations. Possible values are CIDR, ResourceId and Service."', args=[d.arg(name='destinationsType', type=d.T.string)]),
        withDestinationsType(destinationsType): { destinationsType: destinationsType },
        '#withName':: d.fn(help='"The name which should be used for this route."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withNextHop':: d.fn(help="\"The next hop's resource ID.\"", args=[d.arg(name='nextHop', type=d.T.string)]),
        withNextHop(nextHop): { nextHop: nextHop },
        '#withNextHopType':: d.fn(help='"The type of next hop. Currently the only possible value is ResourceId. Defaults to ResourceId."', args=[d.arg(name='nextHopType', type=d.T.string)]),
        withNextHopType(nextHopType): { nextHopType: nextHopType },
      },
      ...
      '#withVirtualHubId':: d.fn(help='"The ID of the Virtual Hub within which this route table should be created. Changing this forces a new resource to be created."', args=[d.arg(name='virtualHubId', type=d.T.string)]),
