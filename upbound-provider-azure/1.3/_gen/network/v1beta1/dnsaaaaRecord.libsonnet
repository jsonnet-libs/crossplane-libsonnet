{
  ...
  '#':: d.pkg(name='dnsaaaaRecord', url='', help='"DNSAAAARecord is the Schema for the DNSAAAARecords API. Manages a DNS AAAA Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSAAAARecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSAAAARecordSpec defines the desired state of DNSAAAARecord"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRecords':: d.fn(help='"List of IPv6 Addresses. Conflicts with target_resource_id."', args=[d.arg(name='records', type=d.T.array)]),
      withRecords(records): { spec+: { forProvider+: { records: if std.isArray(v=records) then records else [records] } } },
      '#withRecordsMixin':: d.fn(help='"List of IPv6 Addresses. Conflicts with target_resource_id."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='records', type=d.T.array)]),
      withRecordsMixin(records): { spec+: { forProvider+: { records+: if std.isArray(v=records) then records else [records] } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the resource group where the DNS Zone (parent resource) exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withTargetResourceId':: d.fn(help='"The Azure resource id of the target object. Conflicts with records."', args=[d.arg(name='targetResourceId', type=d.T.string)]),
      withTargetResourceId(targetResourceId): { spec+: { forProvider+: { targetResourceId: targetResourceId } } },
      '#withTtl':: d.fn(help='"The Time To Live (TTL) of the DNS record in seconds."', args=[d.arg(name='ttl', type=d.T.number)]),
      withTtl(ttl): { spec+: { forProvider+: { ttl: ttl } } },
      '#withZoneName':: d.fn(help='"Specifies the DNS Zone where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='zoneName', type=d.T.string)]),
      withZoneName(zoneName): { spec+: { forProvider+: { zoneName: zoneName } } },
      '#zoneNameRef':: d.obj(help='"Reference to a DNSZone in network to populate zoneName."'),
      zoneNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { zoneNameRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { zoneNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { zoneNameRef+: { name: name } } } },
      },
      '#zoneNameSelector':: d.obj(help='"Selector for a DNSZone in network to populate zoneName."'),
      zoneNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { zoneNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { zoneNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
