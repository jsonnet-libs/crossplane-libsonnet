{
  ...
  '#':: d.pkg(name='vpnServerConfigurationPolicyGroup', url='', help='"VPNServerConfigurationPolicyGroup is the Schema for the VPNServerConfigurationPolicyGroups API. Manages a VPN Server Configuration Policy Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of VPNServerConfigurationPolicyGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VPNServerConfigurationPolicyGroupSpec defines the desired state of VPNServerConfigurationPolicyGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#policy':: d.obj(help='"One or more policy blocks as documented below."'),
      policy: {
        '#withName':: d.fn(help='"The name of the VPN Server Configuration Policy member."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withType':: d.fn(help='"The attribute type of the VPN Server Configuration Policy member. Possible values are AADGroupId, CertificateGroupId and RadiusAzureGroupId."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
        '#withValue':: d.fn(help='"The value of the attribute that is used for the VPN Server Configuration Policy member."', args=[d.arg(name='value', type=d.T.string)]),
      ...
      '#withIsDefault':: d.fn(help='"Is this a default VPN Server Configuration Policy Group? Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='isDefault', type=d.T.boolean)]),
      withIsDefault(isDefault): { spec+: { forProvider+: { isDefault: isDefault } } },
      '#withPolicy':: d.fn(help='"One or more policy blocks as documented below."', args=[d.arg(name='policy', type=d.T.array)]),
      withPolicy(policy): { spec+: { forProvider+: { policy: if std.isArray(v=policy) then policy else [policy] } } },
      '#withPolicyMixin':: d.fn(help='"One or more policy blocks as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='policy', type=d.T.array)]),
      withPolicyMixin(policy): { spec+: { forProvider+: { policy+: if std.isArray(v=policy) then policy else [policy] } } },
      '#withPriority':: d.fn(help='"The priority of this VPN Server Configuration Policy Group. Defaults to 0."', args=[d.arg(name='priority', type=d.T.number)]),
      withPriority(priority): { spec+: { forProvider+: { priority: priority } } },
      '#withVpnServerConfigurationId':: d.fn(help='"The ID of the VPN Server Configuration that the VPN Server Configuration Policy Group belongs to. Changing this forces a new resource to be created."', args=[d.arg(name='vpnServerConfigurationId', type=d.T.string)]),
