{
  ...
  '#':: d.pkg(name='publicIPPrefix', url='', help='"PublicIPPrefix is the Schema for the PublicIPPrefixs API. Manages a Public IP Prefix."'),
  ...
  '#new':: d.fn(help='new returns an instance of PublicIPPrefix', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PublicIPPrefixSpec defines the desired state of PublicIPPrefix"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIpVersion':: d.fn(help='"The IP Version to use, IPv6 or IPv4. Changing this forces a new resource to be created. Default is IPv4."', args=[d.arg(name='ipVersion', type=d.T.string)]),
      ...
      '#withPrefixLength':: d.fn(help='"Specifies the number of bits of the prefix. The value can be set between 0 (4,294,967,296 addresses) and 31 (2 addresses). Defaults to 28(16 addresses). Changing this forces a new resource to be created."', args=[d.arg(name='prefixLength', type=d.T.number)]),
      withPrefixLength(prefixLength): { spec+: { forProvider+: { prefixLength: prefixLength } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Public IP Prefix. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"The SKU of the Public IP Prefix. Accepted values are Standard. Defaults to Standard. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      ...
      '#withZones':: d.fn(help='"Specifies a list of Availability Zones in which this Public IP Prefix should be located. Changing this forces a new Public IP Prefix to be created."', args=[d.arg(name='zones', type=d.T.array)]),
      withZones(zones): { spec+: { forProvider+: { zones: if std.isArray(v=zones) then zones else [zones] } } },
      '#withZonesMixin':: d.fn(help='"Specifies a list of Availability Zones in which this Public IP Prefix should be located. Changing this forces a new Public IP Prefix to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zones', type=d.T.array)]),
