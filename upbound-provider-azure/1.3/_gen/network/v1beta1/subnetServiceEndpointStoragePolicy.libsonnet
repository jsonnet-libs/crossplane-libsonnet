{
  ...
  '#':: d.pkg(name='subnetServiceEndpointStoragePolicy', url='', help='"SubnetServiceEndpointStoragePolicy is the Schema for the SubnetServiceEndpointStoragePolicys API. Manages a Subnet Service Endpoint Storage Policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetServiceEndpointStoragePolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubnetServiceEndpointStoragePolicySpec defines the desired state of SubnetServiceEndpointStoragePolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#definition':: d.obj(help='"A definition block as defined below"'),
      definition: {
        '#withDescription':: d.fn(help='"The description of this Subnet Service Endpoint Storage Policy Definition."', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { description: description },
        '#withName':: d.fn(help='"The name which should be used for this Subnet Service Endpoint Storage Policy Definition."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withService':: d.fn(help='"The type of service resources. Valid values are Microsoft.Storage or Global. When the service_resources property contains resource IDs, this property must be Microsoft.Storage. When the service_resources property contains Aliases, this property must be Global. Defaults to Microsoft.Storage."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { service: service },
        '#withServiceResources':: d.fn(help='"Specifies a list of resources or aliases that this Subnet Service Endpoint Storage Policy Definition applies to."', args=[d.arg(name='serviceResources', type=d.T.array)]),
        withServiceResources(serviceResources): { serviceResources: if std.isArray(v=serviceResources) then serviceResources else [serviceResources] },
        '#withServiceResourcesMixin':: d.fn(help='"Specifies a list of resources or aliases that this Subnet Service Endpoint Storage Policy Definition applies to."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceResources', type=d.T.array)]),
        withServiceResourcesMixin(serviceResources): { serviceResources+: if std.isArray(v=serviceResources) then serviceResources else [serviceResources] },
      },
      ...
      '#withDefinition':: d.fn(help='"A definition block as defined below"', args=[d.arg(name='definition', type=d.T.array)]),
      withDefinition(definition): { spec+: { forProvider+: { definition: if std.isArray(v=definition) then definition else [definition] } } },
      '#withDefinitionMixin':: d.fn(help='"A definition block as defined below"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='definition', type=d.T.array)]),
      withDefinitionMixin(definition): { spec+: { forProvider+: { definition+: if std.isArray(v=definition) then definition else [definition] } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Subnet Service Endpoint Storage Policy should exist. Changing this forces a new Subnet Service Endpoint Storage Policy to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Subnet Service Endpoint Storage Policy should exist. Changing this forces a new Subnet Service Endpoint Storage Policy to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Subnet Service Endpoint Storage Policy."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Subnet Service Endpoint Storage Policy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
