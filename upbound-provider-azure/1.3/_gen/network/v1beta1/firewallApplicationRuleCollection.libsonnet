{
  ...
  '#':: d.pkg(name='firewallApplicationRuleCollection', url='', help='"FirewallApplicationRuleCollection is the Schema for the FirewallApplicationRuleCollections API. Manages an Application Rule Collection within an Azure Firewall."'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallApplicationRuleCollection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallApplicationRuleCollectionSpec defines the desired state of FirewallApplicationRuleCollection"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#azureFirewallNameRef':: d.obj(help='"Reference to a Firewall in network to populate azureFirewallName."'),
      azureFirewallNameRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { azureFirewallNameRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { azureFirewallNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { azureFirewallNameRef+: { name: name } } } },
      },
      '#azureFirewallNameSelector':: d.obj(help='"Selector for a Firewall in network to populate azureFirewallName."'),
      azureFirewallNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { azureFirewallNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { azureFirewallNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { azureFirewallNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { azureFirewallNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { azureFirewallNameSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      rule: {
        '#protocol':: d.obj(help='"One or more protocol blocks as defined below."'),
        protocol: {
          '#withPort':: d.fn(help='"Specify a port for the connection."', args=[d.arg(name='port', type=d.T.number)]),
          withPort(port): { port: port },
          '#withType':: d.fn(help='"Specifies the type of connection. Possible values are Http, Https and Mssql."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        '#withDescription':: d.fn(help='"Specifies a description for the rule."', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { description: description },
        '#withFqdnTags':: d.fn(help='"A list of FQDN tags. Possible values are AppServiceEnvironment, AzureBackup, AzureKubernetesService, HDInsight, MicrosoftActiveProtectionService, WindowsDiagnostics, WindowsUpdate and WindowsVirtualDesktop."', args=[d.arg(name='fqdnTags', type=d.T.array)]),
        withFqdnTags(fqdnTags): { fqdnTags: if std.isArray(v=fqdnTags) then fqdnTags else [fqdnTags] },
        '#withFqdnTagsMixin':: d.fn(help='"A list of FQDN tags. Possible values are AppServiceEnvironment, AzureBackup, AzureKubernetesService, HDInsight, MicrosoftActiveProtectionService, WindowsDiagnostics, WindowsUpdate and WindowsVirtualDesktop."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fqdnTags', type=d.T.array)]),
        withFqdnTagsMixin(fqdnTags): { fqdnTags+: if std.isArray(v=fqdnTags) then fqdnTags else [fqdnTags] },
        '#withName':: d.fn(help='"Specifies the name of the rule."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withProtocol':: d.fn(help='"One or more protocol blocks as defined below."', args=[d.arg(name='protocol', type=d.T.array)]),
        withProtocol(protocol): { protocol: if std.isArray(v=protocol) then protocol else [protocol] },
        '#withProtocolMixin':: d.fn(help='"One or more protocol blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='protocol', type=d.T.array)]),
        withProtocolMixin(protocol): { protocol+: if std.isArray(v=protocol) then protocol else [protocol] },
        '#withSourceAddresses':: d.fn(help='"A list of source IP addresses and/or IP ranges."', args=[d.arg(name='sourceAddresses', type=d.T.array)]),
        ...
        '#withTargetFqdns':: d.fn(help='"A list of FQDNs."', args=[d.arg(name='targetFqdns', type=d.T.array)]),
        withTargetFqdns(targetFqdns): { targetFqdns: if std.isArray(v=targetFqdns) then targetFqdns else [targetFqdns] },
        '#withTargetFqdnsMixin':: d.fn(help='"A list of FQDNs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetFqdns', type=d.T.array)]),
        withTargetFqdnsMixin(targetFqdns): { targetFqdns+: if std.isArray(v=targetFqdns) then targetFqdns else [targetFqdns] },
      },
      '#withAction':: d.fn(help='"Specifies the action the rule will apply to matching traffic. Possible values are Allow and Deny."', args=[d.arg(name='action', type=d.T.string)]),
      withAction(action): { spec+: { forProvider+: { action: action } } },
      '#withAzureFirewallName':: d.fn(help='"Specifies the name of the Firewall in which the Application Rule Collection should be created. Changing this forces a new resource to be created."', args=[d.arg(name='azureFirewallName', type=d.T.string)]),
      withAzureFirewallName(azureFirewallName): { spec+: { forProvider+: { azureFirewallName: azureFirewallName } } },
      '#withPriority':: d.fn(help='"Specifies the priority of the rule collection. Possible values are between 100 - 65000."', args=[d.arg(name='priority', type=d.T.number)]),
      withPriority(priority): { spec+: { forProvider+: { priority: priority } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
