{
  ...
  '#':: d.pkg(name='loadBalancerBackendAddressPool', url='', help='"LoadBalancerBackendAddressPool is the Schema for the LoadBalancerBackendAddressPools API. Manages a Load Balancer Backend Address Pool."'),
  ...
  '#new':: d.fn(help='new returns an instance of LoadBalancerBackendAddressPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LoadBalancerBackendAddressPoolSpec defines the desired state of LoadBalancerBackendAddressPool"'),
  spec: {
    ...
    forProvider: {
      ...
      '#tunnelInterface':: d.obj(help='"One or more tunnel_interface blocks as defined below."'),
      tunnelInterface: {
        '#withIdentifier':: d.fn(help='"The unique identifier of this Gateway Lodbalancer Tunnel Interface."', args=[d.arg(name='identifier', type=d.T.number)]),
        withIdentifier(identifier): { identifier: identifier },
        '#withPort':: d.fn(help='"The port number that this Gateway Lodbalancer Tunnel Interface listens to."', args=[d.arg(name='port', type=d.T.number)]),
        withPort(port): { port: port },
        '#withProtocol':: d.fn(help='"The protocol used for this Gateway Lodbalancer Tunnel Interface. Possible values are None, Native and VXLAN."', args=[d.arg(name='protocol', type=d.T.string)]),
        withProtocol(protocol): { protocol: protocol },
        '#withType':: d.fn(help='"The traffic type of this Gateway Lodbalancer Tunnel Interface. Possible values are None, Internal and External."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withLoadbalancerId':: d.fn(help='"The ID of the Load Balancer in which to create the Backend Address Pool. Changing this forces a new resource to be created."', args=[d.arg(name='loadbalancerId', type=d.T.string)]),
      withLoadbalancerId(loadbalancerId): { spec+: { forProvider+: { loadbalancerId: loadbalancerId } } },
      '#withTunnelInterface':: d.fn(help='"One or more tunnel_interface blocks as defined below."', args=[d.arg(name='tunnelInterface', type=d.T.array)]),
      withTunnelInterface(tunnelInterface): { spec+: { forProvider+: { tunnelInterface: if std.isArray(v=tunnelInterface) then tunnelInterface else [tunnelInterface] } } },
      '#withTunnelInterfaceMixin':: d.fn(help='"One or more tunnel_interface blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tunnelInterface', type=d.T.array)]),
      withTunnelInterfaceMixin(tunnelInterface): { spec+: { forProvider+: { tunnelInterface+: if std.isArray(v=tunnelInterface) then tunnelInterface else [tunnelInterface] } } },
    ...
    initProvider: {
      ...
      '#withTunnelInterface':: d.fn(help='"One or more tunnel_interface blocks as defined below."', args=[d.arg(name='tunnelInterface', type=d.T.array)]),
      withTunnelInterface(tunnelInterface): { spec+: { initProvider+: { tunnelInterface: if std.isArray(v=tunnelInterface) then tunnelInterface else [tunnelInterface] } } },
      '#withTunnelInterfaceMixin':: d.fn(help='"One or more tunnel_interface blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tunnelInterface', type=d.T.array)]),
      withTunnelInterfaceMixin(tunnelInterface): { spec+: { initProvider+: { tunnelInterface+: if std.isArray(v=tunnelInterface) then tunnelInterface else [tunnelInterface] } } },
      '#withVirtualNetworkId':: d.fn(help='"The ID of the Virtual Network within which the Backend Address Pool should exist."', args=[d.arg(name='virtualNetworkId', type=d.T.string)]),
