{
  ...
  '#':: d.pkg(name='expressRouteCircuit', url='', help='"ExpressRouteCircuit is the Schema for the ExpressRouteCircuits API. Manages an ExpressRoute circuit."'),
  ...
  '#new':: d.fn(help='new returns an instance of ExpressRouteCircuit', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ExpressRouteCircuitSpec defines the desired state of ExpressRouteCircuit"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#authorizationKeySecretRef':: d.obj(help='"The authorization key. This can be used to set up an ExpressRoute Circuit with an ExpressRoute Port from another subscription."'),
      ...
      '#sku':: d.obj(help='"A sku block for the ExpressRoute circuit as documented below."'),
      sku: {
        '#withFamily':: d.fn(help='"The billing mode for bandwidth. Possible values are MeteredData or UnlimitedData."', args=[d.arg(name='family', type=d.T.string)]),
        withFamily(family): { family: family },
        '#withTier':: d.fn(help='"The service tier. Possible values are Basic, Local, Standard or Premium."', args=[d.arg(name='tier', type=d.T.string)]),
        withTier(tier): { tier: tier },
      },
      '#withAllowClassicOperations':: d.fn(help='"Allow the circuit to interact with classic (RDFE) resources. Defaults to false."', args=[d.arg(name='allowClassicOperations', type=d.T.boolean)]),
      withAllowClassicOperations(allowClassicOperations): { spec+: { forProvider+: { allowClassicOperations: allowClassicOperations } } },
      '#withBandwidthInGbps':: d.fn(help='"The bandwidth in Gbps of the circuit being created on the Express Route Port."', args=[d.arg(name='bandwidthInGbps', type=d.T.number)]),
      withBandwidthInGbps(bandwidthInGbps): { spec+: { forProvider+: { bandwidthInGbps: bandwidthInGbps } } },
      '#withBandwidthInMbps':: d.fn(help='"The bandwidth in Mbps of the circuit being created on the Service Provider."', args=[d.arg(name='bandwidthInMbps', type=d.T.number)]),
      withBandwidthInMbps(bandwidthInMbps): { spec+: { forProvider+: { bandwidthInMbps: bandwidthInMbps } } },
      '#withExpressRoutePortId':: d.fn(help='"The ID of the Express Route Port this Express Route Circuit is based on. Changing this forces a new resource to be created."', args=[d.arg(name='expressRoutePortId', type=d.T.string)]),
      withExpressRoutePortId(expressRoutePortId): { spec+: { forProvider+: { expressRoutePortId: expressRoutePortId } } },
      ...
      '#withPeeringLocation':: d.fn(help='"The name of the peering location and not the Azure resource location. Changing this forces a new resource to be created."', args=[d.arg(name='peeringLocation', type=d.T.string)]),
      withPeeringLocation(peeringLocation): { spec+: { forProvider+: { peeringLocation: peeringLocation } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the ExpressRoute circuit. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServiceProviderName':: d.fn(help='"The name of the ExpressRoute Service Provider. Changing this forces a new resource to be created."', args=[d.arg(name='serviceProviderName', type=d.T.string)]),
      withServiceProviderName(serviceProviderName): { spec+: { forProvider+: { serviceProviderName: serviceProviderName } } },
      '#withSku':: d.fn(help='"A sku block for the ExpressRoute circuit as documented below."', args=[d.arg(name='sku', type=d.T.array)]),
      withSku(sku): { spec+: { forProvider+: { sku: if std.isArray(v=sku) then sku else [sku] } } },
      '#withSkuMixin':: d.fn(help='"A sku block for the ExpressRoute circuit as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sku', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withAllowClassicOperations':: d.fn(help='"Allow the circuit to interact with classic (RDFE) resources. Defaults to false."', args=[d.arg(name='allowClassicOperations', type=d.T.boolean)]),
      withAllowClassicOperations(allowClassicOperations): { spec+: { initProvider+: { allowClassicOperations: allowClassicOperations } } },
      '#withBandwidthInGbps':: d.fn(help='"The bandwidth in Gbps of the circuit being created on the Express Route Port."', args=[d.arg(name='bandwidthInGbps', type=d.T.number)]),
      withBandwidthInGbps(bandwidthInGbps): { spec+: { initProvider+: { bandwidthInGbps: bandwidthInGbps } } },
      '#withBandwidthInMbps':: d.fn(help='"The bandwidth in Mbps of the circuit being created on the Service Provider."', args=[d.arg(name='bandwidthInMbps', type=d.T.number)]),
      withBandwidthInMbps(bandwidthInMbps): { spec+: { initProvider+: { bandwidthInMbps: bandwidthInMbps } } },
      '#withExpressRoutePortId':: d.fn(help='"The ID of the Express Route Port this Express Route Circuit is based on. Changing this forces a new resource to be created."', args=[d.arg(name='expressRoutePortId', type=d.T.string)]),
      withExpressRoutePortId(expressRoutePortId): { spec+: { initProvider+: { expressRoutePortId: expressRoutePortId } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withServiceProviderName':: d.fn(help='"The name of the ExpressRoute Service Provider. Changing this forces a new resource to be created."', args=[d.arg(name='serviceProviderName', type=d.T.string)]),
      withServiceProviderName(serviceProviderName): { spec+: { initProvider+: { serviceProviderName: serviceProviderName } } },
      '#withSku':: d.fn(help='"A sku block for the ExpressRoute circuit as documented below."', args=[d.arg(name='sku', type=d.T.array)]),
