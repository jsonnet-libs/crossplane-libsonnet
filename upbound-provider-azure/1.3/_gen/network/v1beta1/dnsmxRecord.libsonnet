{
  ...
  '#':: d.pkg(name='dnsmxRecord', url='', help='"DNSMXRecord is the Schema for the DNSMXRecords API. Manages a DNS MX Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSMXRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSMXRecordSpec defines the desired state of DNSMXRecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"A list of values that make up the MX record. Each record block supports fields documented below."'),
      record: {
        '#withExchange':: d.fn(help='"The mail server responsible for the domain covered by the MX record."', args=[d.arg(name='exchange', type=d.T.string)]),
        withExchange(exchange): { exchange: exchange },
        '#withPreference':: d.fn(help='"String representing the \\"preference” value of the MX records. Records with lower preference value take priority."', args=[d.arg(name='preference', type=d.T.string)]),
      ...
      '#withRecord':: d.fn(help='"A list of values that make up the MX record. Each record block supports fields documented below."', args=[d.arg(name='record', type=d.T.array)]),
      withRecord(record): { spec+: { forProvider+: { record: if std.isArray(v=record) then record else [record] } } },
      '#withRecordMixin':: d.fn(help='"A list of values that make up the MX record. Each record block supports fields documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='record', type=d.T.array)]),
