{
  ...
  '#':: d.pkg(name='privateDNSTXTRecord', url='', help='"PrivateDNSTXTRecord is the Schema for the PrivateDNSTXTRecords API. Manages a Private DNS TXT Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSTXTRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSTXTRecordSpec defines the desired state of PrivateDNSTXTRecord"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#record':: d.obj(help='"One or more record blocks as defined below."'),
      record: {
        '#withValue':: d.fn(help='"The value of the TXT record. Max length: 1024 characters"', args=[d.arg(name='value', type=d.T.string)]),
