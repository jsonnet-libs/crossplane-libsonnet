{
  ...
  '#':: d.pkg(name='dnscnameRecord', url='', help='"DNSCNAMERecord is the Schema for the DNSCNAMERecords API. Manages a DNS CNAME Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSCNAMERecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSCNAMERecordSpec defines the desired state of DNSCNAMERecord"'),
  spec: {
    ...
    forProvider: {
      ...
      '#targetResourceIdRef':: d.obj(help='"Reference to a DNSCNAMERecord in network to populate targetResourceId."'),
      targetResourceIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#targetResourceIdSelector':: d.obj(help='"Selector for a DNSCNAMERecord in network to populate targetResourceId."'),
      ...
      '#withRecord':: d.fn(help='"The target of the CNAME."', args=[d.arg(name='record', type=d.T.string)]),
      withRecord(record): { spec+: { forProvider+: { record: record } } },
      ...
      '#withTargetResourceId':: d.fn(help='"The Azure resource id of the target object. Conflicts with record."', args=[d.arg(name='targetResourceId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withRecord':: d.fn(help='"The target of the CNAME."', args=[d.arg(name='record', type=d.T.string)]),
      withRecord(record): { spec+: { initProvider+: { record: record } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
