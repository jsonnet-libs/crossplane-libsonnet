  ...
  spec: {
    ...
    forProvider: {
      ...
      link1: {
        ...
        withAdminEnabled(adminEnabled): { adminEnabled: adminEnabled },
        ...
        withMacsecCakKeyvaultSecretId(macsecCakKeyvaultSecretId): { macsecCakKeyvaultSecretId: macsecCakKeyvaultSecretId },
        ...
        withMacsecCipher(macsecCipher): { macsecCipher: macsecCipher },
        ...
        withMacsecCknKeyvaultSecretId(macsecCknKeyvaultSecretId): { macsecCknKeyvaultSecretId: macsecCknKeyvaultSecretId },
        ...
        withMacsecSciEnabled(macsecSciEnabled): { macsecSciEnabled: macsecSciEnabled },
      },
      ...
      '#withLink1':: d.fn(help='"A list of link blocks as defined below."', args=[d.arg(name='link1', type=d.T.array)]),
      withLink1(link1): { spec+: { forProvider+: { link1: if std.isArray(v=link1) then link1 else [link1] } } },
      '#withLink1Mixin':: d.fn(help='"A list of link blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='link1', type=d.T.array)]),
      withLink1Mixin(link1): { spec+: { forProvider+: { link1+: if std.isArray(v=link1) then link1 else [link1] } } },
      '#withLink2':: d.fn(help='"A list of link blocks as defined below."', args=[d.arg(name='link2', type=d.T.array)]),
      withLink2(link2): { spec+: { forProvider+: { link2: if std.isArray(v=link2) then link2 else [link2] } } },
      '#withLink2Mixin':: d.fn(help='"A list of link blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='link2', type=d.T.array)]),
      withLink2Mixin(link2): { spec+: { forProvider+: { link2+: if std.isArray(v=link2) then link2 else [link2] } } },
    ...
    initProvider: {
      ...
      '#withLink1':: d.fn(help='"A list of link blocks as defined below."', args=[d.arg(name='link1', type=d.T.array)]),
      withLink1(link1): { spec+: { initProvider+: { link1: if std.isArray(v=link1) then link1 else [link1] } } },
      '#withLink1Mixin':: d.fn(help='"A list of link blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='link1', type=d.T.array)]),
      withLink1Mixin(link1): { spec+: { initProvider+: { link1+: if std.isArray(v=link1) then link1 else [link1] } } },
      '#withLink2':: d.fn(help='"A list of link blocks as defined below."', args=[d.arg(name='link2', type=d.T.array)]),
      withLink2(link2): { spec+: { initProvider+: { link2: if std.isArray(v=link2) then link2 else [link2] } } },
      '#withLink2Mixin':: d.fn(help='"A list of link blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='link2', type=d.T.array)]),
      withLink2Mixin(link2): { spec+: { initProvider+: { link2+: if std.isArray(v=link2) then link2 else [link2] } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Express Route Port should exist. Changing this forces a new Express Route Port to be created."', args=[d.arg(name='location', type=d.T.string)]),
