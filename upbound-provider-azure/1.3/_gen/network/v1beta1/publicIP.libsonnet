{
  ...
  '#':: d.pkg(name='publicIP', url='', help='"PublicIP is the Schema for the PublicIPs API. Manages a Public IP Address."'),
  ...
  '#new':: d.fn(help='new returns an instance of PublicIP', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PublicIPSpec defines the desired state of PublicIP"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAllocationMethod':: d.fn(help='"Defines the allocation method for this IP address. Possible values are Static or Dynamic."', args=[d.arg(name='allocationMethod', type=d.T.string)]),
      withAllocationMethod(allocationMethod): { spec+: { forProvider+: { allocationMethod: allocationMethod } } },
      '#withDdosProtectionMode':: d.fn(help='"The DDoS protection mode of the public IP. Possible values are Disabled, Enabled, and VirtualNetworkInherited. Defaults to VirtualNetworkInherited."', args=[d.arg(name='ddosProtectionMode', type=d.T.string)]),
      withDdosProtectionMode(ddosProtectionMode): { spec+: { forProvider+: { ddosProtectionMode: ddosProtectionMode } } },
      '#withDdosProtectionPlanId':: d.fn(help='"The ID of DDoS protection plan associated with the public IP."', args=[d.arg(name='ddosProtectionPlanId', type=d.T.string)]),
      withDdosProtectionPlanId(ddosProtectionPlanId): { spec+: { forProvider+: { ddosProtectionPlanId: ddosProtectionPlanId } } },
      '#withDomainNameLabel':: d.fn(help='"Label for the Domain Name. Will be used to make up the FQDN. If a domain name label is specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system."', args=[d.arg(name='domainNameLabel', type=d.T.string)]),
      withDomainNameLabel(domainNameLabel): { spec+: { forProvider+: { domainNameLabel: domainNameLabel } } },
      '#withEdgeZone':: d.fn(help='"Specifies the Edge Zone within the Azure Region where this Public IP should exist. Changing this forces a new Public IP to be created."', args=[d.arg(name='edgeZone', type=d.T.string)]),
      withEdgeZone(edgeZone): { spec+: { forProvider+: { edgeZone: edgeZone } } },
      '#withIdleTimeoutInMinutes':: d.fn(help='"Specifies the timeout for the TCP idle connection. The value can be set between 4 and 30 minutes."', args=[d.arg(name='idleTimeoutInMinutes', type=d.T.number)]),
      withIdleTimeoutInMinutes(idleTimeoutInMinutes): { spec+: { forProvider+: { idleTimeoutInMinutes: idleTimeoutInMinutes } } },
      '#withIpTags':: d.fn(help='"A mapping of IP tags to assign to the public IP. Changing this forces a new resource to be created."', args=[d.arg(name='ipTags', type=d.T.object)]),
      withIpTags(ipTags): { spec+: { forProvider+: { ipTags: ipTags } } },
      '#withIpTagsMixin':: d.fn(help='"A mapping of IP tags to assign to the public IP. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipTags', type=d.T.object)]),
      withIpTagsMixin(ipTags): { spec+: { forProvider+: { ipTags+: ipTags } } },
      '#withIpVersion':: d.fn(help='"The IP Version to use, IPv6 or IPv4. Changing this forces a new resource to be created. Defaults to IPv4."', args=[d.arg(name='ipVersion', type=d.T.string)]),
      withIpVersion(ipVersion): { spec+: { forProvider+: { ipVersion: ipVersion } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Public IP should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPublicIpPrefixId':: d.fn(help='"If specified then public IP address allocated will be provided from the public IP prefix resource. Changing this forces a new resource to be created."', args=[d.arg(name='publicIpPrefixId', type=d.T.string)]),
      withPublicIpPrefixId(publicIpPrefixId): { spec+: { forProvider+: { publicIpPrefixId: publicIpPrefixId } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where this Public IP should exist. Changing this forces a new Public IP to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withReverseFqdn':: d.fn(help='"A fully qualified domain name that resolves to this public IP address. If the reverseFqdn is specified, then a PTR DNS record is created pointing from the IP address in the in-addr.arpa domain to the reverse FQDN."', args=[d.arg(name='reverseFqdn', type=d.T.string)]),
      withReverseFqdn(reverseFqdn): { spec+: { forProvider+: { reverseFqdn: reverseFqdn } } },
      '#withSku':: d.fn(help='"The SKU of the Public IP. Accepted values are Basic and Standard. Defaults to Basic. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withSkuTier':: d.fn(help='"The SKU Tier that should be used for the Public IP. Possible values are Regional and Global. Defaults to Regional. Changing this forces a new resource to be created."', args=[d.arg(name='skuTier', type=d.T.string)]),
      ...
      '#withZones':: d.fn(help='"A collection containing the availability zone to allocate the Public IP in. Changing this forces a new resource to be created."', args=[d.arg(name='zones', type=d.T.array)]),
      withZones(zones): { spec+: { forProvider+: { zones: if std.isArray(v=zones) then zones else [zones] } } },
      '#withZonesMixin':: d.fn(help='"A collection containing the availability zone to allocate the Public IP in. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zones', type=d.T.array)]),
    ...
    initProvider: {
      '#withAllocationMethod':: d.fn(help='"Defines the allocation method for this IP address. Possible values are Static or Dynamic."', args=[d.arg(name='allocationMethod', type=d.T.string)]),
      withAllocationMethod(allocationMethod): { spec+: { initProvider+: { allocationMethod: allocationMethod } } },
      '#withDdosProtectionMode':: d.fn(help='"The DDoS protection mode of the public IP. Possible values are Disabled, Enabled, and VirtualNetworkInherited. Defaults to VirtualNetworkInherited."', args=[d.arg(name='ddosProtectionMode', type=d.T.string)]),
      withDdosProtectionMode(ddosProtectionMode): { spec+: { initProvider+: { ddosProtectionMode: ddosProtectionMode } } },
      '#withDdosProtectionPlanId':: d.fn(help='"The ID of DDoS protection plan associated with the public IP."', args=[d.arg(name='ddosProtectionPlanId', type=d.T.string)]),
      withDdosProtectionPlanId(ddosProtectionPlanId): { spec+: { initProvider+: { ddosProtectionPlanId: ddosProtectionPlanId } } },
      '#withDomainNameLabel':: d.fn(help='"Label for the Domain Name. Will be used to make up the FQDN. If a domain name label is specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system."', args=[d.arg(name='domainNameLabel', type=d.T.string)]),
      withDomainNameLabel(domainNameLabel): { spec+: { initProvider+: { domainNameLabel: domainNameLabel } } },
      '#withEdgeZone':: d.fn(help='"Specifies the Edge Zone within the Azure Region where this Public IP should exist. Changing this forces a new Public IP to be created."', args=[d.arg(name='edgeZone', type=d.T.string)]),
      ...
      '#withIpTags':: d.fn(help='"A mapping of IP tags to assign to the public IP. Changing this forces a new resource to be created."', args=[d.arg(name='ipTags', type=d.T.object)]),
      withIpTags(ipTags): { spec+: { initProvider+: { ipTags: ipTags } } },
      '#withIpTagsMixin':: d.fn(help='"A mapping of IP tags to assign to the public IP. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipTags', type=d.T.object)]),
      withIpTagsMixin(ipTags): { spec+: { initProvider+: { ipTags+: ipTags } } },
      '#withIpVersion':: d.fn(help='"The IP Version to use, IPv6 or IPv4. Changing this forces a new resource to be created. Defaults to IPv4."', args=[d.arg(name='ipVersion', type=d.T.string)]),
      withIpVersion(ipVersion): { spec+: { initProvider+: { ipVersion: ipVersion } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Public IP should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withPublicIpPrefixId':: d.fn(help='"If specified then public IP address allocated will be provided from the public IP prefix resource. Changing this forces a new resource to be created."', args=[d.arg(name='publicIpPrefixId', type=d.T.string)]),
      withPublicIpPrefixId(publicIpPrefixId): { spec+: { initProvider+: { publicIpPrefixId: publicIpPrefixId } } },
      '#withReverseFqdn':: d.fn(help='"A fully qualified domain name that resolves to this public IP address. If the reverseFqdn is specified, then a PTR DNS record is created pointing from the IP address in the in-addr.arpa domain to the reverse FQDN."', args=[d.arg(name='reverseFqdn', type=d.T.string)]),
      withReverseFqdn(reverseFqdn): { spec+: { initProvider+: { reverseFqdn: reverseFqdn } } },
      '#withSku':: d.fn(help='"The SKU of the Public IP. Accepted values are Basic and Standard. Defaults to Basic. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
