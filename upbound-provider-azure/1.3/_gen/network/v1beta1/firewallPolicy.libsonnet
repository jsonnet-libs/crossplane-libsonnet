  ...
  spec: {
    ...
    forProvider: {
      ...
      explicitProxy: {
        ...
        withEnablePacFile(enablePacFile): { enablePacFile: enablePacFile },
        ...
        withPacFile(pacFile): { pacFile: pacFile },
        ...
        withPacFilePort(pacFilePort): { pacFilePort: pacFilePort },
      },
      ...
      intrusionDetection: {
        ...
        withPrivateRanges(privateRanges): { privateRanges: if std.isArray(v=privateRanges) then privateRanges else [privateRanges] },
        ...
        withPrivateRangesMixin(privateRanges): { privateRanges+: if std.isArray(v=privateRanges) then privateRanges else [privateRanges] },
      ...
      '#withExplicitProxy':: d.fn(help='"A explicit_proxy block as defined below."', args=[d.arg(name='explicitProxy', type=d.T.array)]),
      withExplicitProxy(explicitProxy): { spec+: { forProvider+: { explicitProxy: if std.isArray(v=explicitProxy) then explicitProxy else [explicitProxy] } } },
      '#withExplicitProxyMixin':: d.fn(help='"A explicit_proxy block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='explicitProxy', type=d.T.array)]),
      withExplicitProxyMixin(explicitProxy): { spec+: { forProvider+: { explicitProxy+: if std.isArray(v=explicitProxy) then explicitProxy else [explicitProxy] } } },
    ...
    initProvider: {
      ...
      '#withExplicitProxy':: d.fn(help='"A explicit_proxy block as defined below."', args=[d.arg(name='explicitProxy', type=d.T.array)]),
      withExplicitProxy(explicitProxy): { spec+: { initProvider+: { explicitProxy: if std.isArray(v=explicitProxy) then explicitProxy else [explicitProxy] } } },
      '#withExplicitProxyMixin':: d.fn(help='"A explicit_proxy block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='explicitProxy', type=d.T.array)]),
      withExplicitProxyMixin(explicitProxy): { spec+: { initProvider+: { explicitProxy+: if std.isArray(v=explicitProxy) then explicitProxy else [explicitProxy] } } },
      '#withIdentity':: d.fn(help='"An identity block as defined below."', args=[d.arg(name='identity', type=d.T.array)]),
      ...
      '#withInsights':: d.fn(help='"An insights block as defined below."', args=[d.arg(name='insights', type=d.T.array)]),
      withInsights(insights): { spec+: { initProvider+: { insights: if std.isArray(v=insights) then insights else [insights] } } },
      '#withInsightsMixin':: d.fn(help='"An insights block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='insights', type=d.T.array)]),
      withInsightsMixin(insights): { spec+: { initProvider+: { insights+: if std.isArray(v=insights) then insights else [insights] } } },
      '#withIntrusionDetection':: d.fn(help='"A intrusion_detection block as defined below."', args=[d.arg(name='intrusionDetection', type=d.T.array)]),
      withIntrusionDetection(intrusionDetection): { spec+: { initProvider+: { intrusionDetection: if std.isArray(v=intrusionDetection) then intrusionDetection else [intrusionDetection] } } },
      '#withIntrusionDetectionMixin':: d.fn(help='"A intrusion_detection block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='intrusionDetection', type=d.T.array)]),
      withIntrusionDetectionMixin(intrusionDetection): { spec+: { initProvider+: { intrusionDetection+: if std.isArray(v=intrusionDetection) then intrusionDetection else [intrusionDetection] } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Firewall Policy should exist. Changing this forces a new Firewall Policy to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withThreatIntelligenceAllowlist':: d.fn(help='"A threat_intelligence_allowlist block as defined below."', args=[d.arg(name='threatIntelligenceAllowlist', type=d.T.array)]),
      withThreatIntelligenceAllowlist(threatIntelligenceAllowlist): { spec+: { initProvider+: { threatIntelligenceAllowlist: if std.isArray(v=threatIntelligenceAllowlist) then threatIntelligenceAllowlist else [threatIntelligenceAllowlist] } } },
      '#withThreatIntelligenceAllowlistMixin':: d.fn(help='"A threat_intelligence_allowlist block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='threatIntelligenceAllowlist', type=d.T.array)]),
      withThreatIntelligenceAllowlistMixin(threatIntelligenceAllowlist): { spec+: { initProvider+: { threatIntelligenceAllowlist+: if std.isArray(v=threatIntelligenceAllowlist) then threatIntelligenceAllowlist else [threatIntelligenceAllowlist] } } },
      '#withThreatIntelligenceMode':: d.fn(help='"The operation mode for Threat Intelligence. Possible values are Alert, Deny and Off. Defaults to Alert."', args=[d.arg(name='threatIntelligenceMode', type=d.T.string)]),
      withThreatIntelligenceMode(threatIntelligenceMode): { spec+: { initProvider+: { threatIntelligenceMode: threatIntelligenceMode } } },
      '#withTlsCertificate':: d.fn(help='"A tls_certificate block as defined below."', args=[d.arg(name='tlsCertificate', type=d.T.array)]),
      withTlsCertificate(tlsCertificate): { spec+: { initProvider+: { tlsCertificate: if std.isArray(v=tlsCertificate) then tlsCertificate else [tlsCertificate] } } },
      '#withTlsCertificateMixin':: d.fn(help='"A tls_certificate block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tlsCertificate', type=d.T.array)]),
      withTlsCertificateMixin(tlsCertificate): { spec+: { initProvider+: { tlsCertificate+: if std.isArray(v=tlsCertificate) then tlsCertificate else [tlsCertificate] } } },
    },
