{
  ...
  '#':: d.pkg(name='subnetNATGatewayAssociation', url='', help='"SubnetNATGatewayAssociation is the Schema for the SubnetNATGatewayAssociations API. Associates a"'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetNATGatewayAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubnetNATGatewayAssociationSpec defines the desired state of SubnetNATGatewayAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withNatGatewayId':: d.fn(help='"The ID of the NAT Gateway which should be associated with the Subnet. Changing this forces a new resource to be created."', args=[d.arg(name='natGatewayId', type=d.T.string)]),
