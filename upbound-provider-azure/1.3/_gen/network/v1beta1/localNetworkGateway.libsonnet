{
  ...
  '#':: d.pkg(name='localNetworkGateway', url='', help='"LocalNetworkGateway is the Schema for the LocalNetworkGateways API. Manages a local network gateway connection over which specific connections can be configured."'),
  ...
  '#new':: d.fn(help='new returns an instance of LocalNetworkGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocalNetworkGatewaySpec defines the desired state of LocalNetworkGateway"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#bgpSettings':: d.obj(help="\"A bgp_settings block as defined below containing the Local Network Gateway's BGP speaker settings.\""),
      bgpSettings: {
        '#withAsn':: d.fn(help="\"The BGP speaker's ASN.\"", args=[d.arg(name='asn', type=d.T.number)]),
        withAsn(asn): { asn: asn },
        '#withBgpPeeringAddress':: d.fn(help='"The BGP peering address and BGP identifier of this BGP speaker."', args=[d.arg(name='bgpPeeringAddress', type=d.T.string)]),
        withBgpPeeringAddress(bgpPeeringAddress): { bgpPeeringAddress: bgpPeeringAddress },
        '#withPeerWeight':: d.fn(help='"The weight added to routes learned from this BGP speaker."', args=[d.arg(name='peerWeight', type=d.T.number)]),
      ...
      '#withAddressSpace':: d.fn(help='"The list of string CIDRs representing the address spaces the gateway exposes."', args=[d.arg(name='addressSpace', type=d.T.array)]),
      ...
      '#withAddressSpaceMixin':: d.fn(help='"The list of string CIDRs representing the address spaces the gateway exposes."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addressSpace', type=d.T.array)]),
      ...
      '#withBgpSettings':: d.fn(help="\"A bgp_settings block as defined below containing the Local Network Gateway's BGP speaker settings.\"", args=[d.arg(name='bgpSettings', type=d.T.array)]),
      withBgpSettings(bgpSettings): { spec+: { forProvider+: { bgpSettings: if std.isArray(v=bgpSettings) then bgpSettings else [bgpSettings] } } },
      '#withBgpSettingsMixin':: d.fn(help="\"A bgp_settings block as defined below containing the Local Network Gateway's BGP speaker settings.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='bgpSettings', type=d.T.array)]),
      ...
      '#withGatewayAddress':: d.fn(help='"The gateway IP address to connect with."', args=[d.arg(name='gatewayAddress', type=d.T.string)]),
      withGatewayAddress(gatewayAddress): { spec+: { forProvider+: { gatewayAddress: gatewayAddress } } },
      '#withGatewayFqdn':: d.fn(help='"The gateway FQDN to connect with."', args=[d.arg(name='gatewayFqdn', type=d.T.string)]),
      withGatewayFqdn(gatewayFqdn): { spec+: { forProvider+: { gatewayFqdn: gatewayFqdn } } },
      '#withLocation':: d.fn(help='"The location/region where the local network gateway is created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the local network gateway. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withGatewayAddress':: d.fn(help='"The gateway IP address to connect with."', args=[d.arg(name='gatewayAddress', type=d.T.string)]),
      withGatewayAddress(gatewayAddress): { spec+: { initProvider+: { gatewayAddress: gatewayAddress } } },
      '#withGatewayFqdn':: d.fn(help='"The gateway FQDN to connect with."', args=[d.arg(name='gatewayFqdn', type=d.T.string)]),
      withGatewayFqdn(gatewayFqdn): { spec+: { initProvider+: { gatewayFqdn: gatewayFqdn } } },
      '#withLocation':: d.fn(help='"The location/region where the local network gateway is created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
