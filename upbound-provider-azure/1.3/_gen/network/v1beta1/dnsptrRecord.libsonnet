{
  ...
  '#':: d.pkg(name='dnsptrRecord', url='', help='"DNSPTRRecord is the Schema for the DNSPTRRecords API. Manages a DNS PTR Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSPTRRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSPTRRecordSpec defines the desired state of DNSPTRRecord"'),
  spec: {
