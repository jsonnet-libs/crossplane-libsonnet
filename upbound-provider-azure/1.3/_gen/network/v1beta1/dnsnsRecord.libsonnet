{
  ...
  '#':: d.pkg(name='dnsnsRecord', url='', help='"DNSNSRecord is the Schema for the DNSNSRecords API. Manages a DNS NS Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSNSRecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSNSRecordSpec defines the desired state of DNSNSRecord"'),
  spec: {
