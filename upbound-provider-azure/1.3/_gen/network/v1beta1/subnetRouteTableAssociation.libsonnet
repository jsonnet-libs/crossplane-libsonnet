{
  ...
  '#':: d.pkg(name='subnetRouteTableAssociation', url='', help='"SubnetRouteTableAssociation is the Schema for the SubnetRouteTableAssociations API. Associates a"'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetRouteTableAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubnetRouteTableAssociationSpec defines the desired state of SubnetRouteTableAssociation"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#routeTableIdRef':: d.obj(help='"Reference to a RouteTable in network to populate routeTableId."'),
      routeTableIdRef: {
      ...
      '#routeTableIdSelector':: d.obj(help='"Selector for a RouteTable in network to populate routeTableId."'),
      ...
      '#withRouteTableId':: d.fn(help='"The ID of the Route Table which should be associated with the Subnet. Changing this forces a new resource to be created."', args=[d.arg(name='routeTableId', type=d.T.string)]),
      withRouteTableId(routeTableId): { spec+: { forProvider+: { routeTableId: routeTableId } } },
      '#withSubnetId':: d.fn(help='"The ID of the Subnet. Changing this forces a new resource to be created."', args=[d.arg(name='subnetId', type=d.T.string)]),
