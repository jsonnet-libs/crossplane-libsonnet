{
  ...
  '#':: d.pkg(name='privateDNSCNAMERecord', url='', help='"PrivateDNSCNAMERecord is the Schema for the PrivateDNSCNAMERecords API. Manages a Private DNS CNAME Record."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSCNAMERecord', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSCNAMERecordSpec defines the desired state of PrivateDNSCNAMERecord"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withTtl':: d.fn(help='"The Time To Live (TTL) of the DNS record in seconds. Possible values are between 0 and 2147483647."', args=[d.arg(name='ttl', type=d.T.number)]),
