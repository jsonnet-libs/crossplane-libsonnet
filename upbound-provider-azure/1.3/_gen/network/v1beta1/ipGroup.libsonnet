{
  ...
  '#':: d.pkg(name='ipGroup', url='', help='"IPGroup is the Schema for the IPGroups API. Manages an IP group which contains a list of CIDRs and/or IP addresses."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCidrs':: d.fn(help='"A list of CIDRs or IP addresses."', args=[d.arg(name='cidrs', type=d.T.array)]),
      withCidrs(cidrs): { spec+: { forProvider+: { cidrs: if std.isArray(v=cidrs) then cidrs else [cidrs] } } },
      '#withCidrsMixin':: d.fn(help='"A list of CIDRs or IP addresses."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cidrs', type=d.T.array)]),
      withCidrsMixin(cidrs): { spec+: { forProvider+: { cidrs+: if std.isArray(v=cidrs) then cidrs else [cidrs] } } },
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the IP group. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      '#withCidrs':: d.fn(help='"A list of CIDRs or IP addresses."', args=[d.arg(name='cidrs', type=d.T.array)]),
      withCidrs(cidrs): { spec+: { initProvider+: { cidrs: if std.isArray(v=cidrs) then cidrs else [cidrs] } } },
      '#withCidrsMixin':: d.fn(help='"A list of CIDRs or IP addresses."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cidrs', type=d.T.array)]),
      withCidrsMixin(cidrs): { spec+: { initProvider+: { cidrs+: if std.isArray(v=cidrs) then cidrs else [cidrs] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
