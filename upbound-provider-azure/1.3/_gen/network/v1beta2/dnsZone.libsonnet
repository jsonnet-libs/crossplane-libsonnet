{
  ...
  '#':: d.pkg(name='dnsZone', url='', help='"DNSZone is the Schema for the DNSZones API. Manages a DNS Zone."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSZone', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSZoneSpec defines the desired state of DNSZone"'),
  spec: {
    ...
    forProvider: {
      ...
      '#soaRecord':: d.obj(help='"An soa_record block as defined below."'),
      soaRecord: {
        '#withEmail':: d.fn(help='"The email contact for the SOA record."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { spec+: { forProvider+: { soaRecord+: { email: email } } } },
        '#withExpireTime':: d.fn(help='"The expire time for the SOA record. Defaults to 2419200."', args=[d.arg(name='expireTime', type=d.T.number)]),
        withExpireTime(expireTime): { spec+: { forProvider+: { soaRecord+: { expireTime: expireTime } } } },
        '#withHostName':: d.fn(help='"The domain name of the authoritative name server for the SOA record. If not set, computed value from Azure will be used."', args=[d.arg(name='hostName', type=d.T.string)]),
        withHostName(hostName): { spec+: { forProvider+: { soaRecord+: { hostName: hostName } } } },
        '#withMinimumTtl':: d.fn(help='"The minimum Time To Live for the SOA record. By convention, it is used to determine the negative caching duration. Defaults to 300."', args=[d.arg(name='minimumTtl', type=d.T.number)]),
        withMinimumTtl(minimumTtl): { spec+: { forProvider+: { soaRecord+: { minimumTtl: minimumTtl } } } },
        '#withRefreshTime':: d.fn(help='"The refresh time for the SOA record. Defaults to 3600."', args=[d.arg(name='refreshTime', type=d.T.number)]),
        withRefreshTime(refreshTime): { spec+: { forProvider+: { soaRecord+: { refreshTime: refreshTime } } } },
        '#withRetryTime':: d.fn(help='"The retry time for the SOA record. Defaults to 300."', args=[d.arg(name='retryTime', type=d.T.number)]),
        withRetryTime(retryTime): { spec+: { forProvider+: { soaRecord+: { retryTime: retryTime } } } },
        '#withSerialNumber':: d.fn(help='"The serial number for the SOA record. Defaults to 1."', args=[d.arg(name='serialNumber', type=d.T.number)]),
        withSerialNumber(serialNumber): { spec+: { forProvider+: { soaRecord+: { serialNumber: serialNumber } } } },
        '#withTags':: d.fn(help='"A mapping of tags to assign to the Record Set."', args=[d.arg(name='tags', type=d.T.object)]),
        withTags(tags): { spec+: { forProvider+: { soaRecord+: { tags: tags } } } },
        '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Record Set."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
        withTagsMixin(tags): { spec+: { forProvider+: { soaRecord+: { tags+: tags } } } },
        '#withTtl':: d.fn(help='"The Time To Live of the SOA Record in seconds. Defaults to 3600."', args=[d.arg(name='ttl', type=d.T.number)]),
        withTtl(ttl): { spec+: { forProvider+: { soaRecord+: { ttl: ttl } } } },
      },
      '#withResourceGroupName':: d.fn(help='"Specifies the resource group where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      soaRecord: {
        '#withEmail':: d.fn(help='"The email contact for the SOA record."', args=[d.arg(name='email', type=d.T.string)]),
        withEmail(email): { spec+: { initProvider+: { soaRecord+: { email: email } } } },
        '#withExpireTime':: d.fn(help='"The expire time for the SOA record. Defaults to 2419200."', args=[d.arg(name='expireTime', type=d.T.number)]),
        withExpireTime(expireTime): { spec+: { initProvider+: { soaRecord+: { expireTime: expireTime } } } },
        '#withHostName':: d.fn(help='"The domain name of the authoritative name server for the SOA record. If not set, computed value from Azure will be used."', args=[d.arg(name='hostName', type=d.T.string)]),
        withHostName(hostName): { spec+: { initProvider+: { soaRecord+: { hostName: hostName } } } },
        '#withMinimumTtl':: d.fn(help='"The minimum Time To Live for the SOA record. By convention, it is used to determine the negative caching duration. Defaults to 300."', args=[d.arg(name='minimumTtl', type=d.T.number)]),
        withMinimumTtl(minimumTtl): { spec+: { initProvider+: { soaRecord+: { minimumTtl: minimumTtl } } } },
        '#withRefreshTime':: d.fn(help='"The refresh time for the SOA record. Defaults to 3600."', args=[d.arg(name='refreshTime', type=d.T.number)]),
        withRefreshTime(refreshTime): { spec+: { initProvider+: { soaRecord+: { refreshTime: refreshTime } } } },
        '#withRetryTime':: d.fn(help='"The retry time for the SOA record. Defaults to 300."', args=[d.arg(name='retryTime', type=d.T.number)]),
        withRetryTime(retryTime): { spec+: { initProvider+: { soaRecord+: { retryTime: retryTime } } } },
        '#withSerialNumber':: d.fn(help='"The serial number for the SOA record. Defaults to 1."', args=[d.arg(name='serialNumber', type=d.T.number)]),
        withSerialNumber(serialNumber): { spec+: { initProvider+: { soaRecord+: { serialNumber: serialNumber } } } },
        '#withTags':: d.fn(help='"A mapping of tags to assign to the Record Set."', args=[d.arg(name='tags', type=d.T.object)]),
        withTags(tags): { spec+: { initProvider+: { soaRecord+: { tags: tags } } } },
        '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Record Set."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
        withTagsMixin(tags): { spec+: { initProvider+: { soaRecord+: { tags+: tags } } } },
        '#withTtl':: d.fn(help='"The Time To Live of the SOA Record in seconds. Defaults to 3600."', args=[d.arg(name='ttl', type=d.T.number)]),
        withTtl(ttl): { spec+: { initProvider+: { soaRecord+: { ttl: ttl } } } },
      },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
