{
  ...
  '#':: d.pkg(name='routeFilter', url='', help='"RouteFilter is the Schema for the RouteFilters API. Manages a Route Filter."'),
  ...
  '#new':: d.fn(help='new returns an instance of RouteFilter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RouteFilterSpec defines the desired state of RouteFilter"'),
  spec: {
    ...
    forProvider: {
      ...
      rule: {
        '#withAccess':: d.fn(help='"The access type of the rule. The only possible value is Allow."', args=[d.arg(name='access', type=d.T.string)]),
        withAccess(access): { spec+: { forProvider+: { rule+: { access: access } } } },
        '#withCommunities':: d.fn(help="\"The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].\"", args=[d.arg(name='communities', type=d.T.array)]),
        withCommunities(communities): { spec+: { forProvider+: { rule+: { communities: if std.isArray(v=communities) then communities else [communities] } } } },
        '#withCommunitiesMixin':: d.fn(help="\"The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='communities', type=d.T.array)]),
        withCommunitiesMixin(communities): { spec+: { forProvider+: { rule+: { communities+: if std.isArray(v=communities) then communities else [communities] } } } },
        '#withName':: d.fn(help='"The name of the route filter rule."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { rule+: { name: name } } } },
        '#withRuleType':: d.fn(help='"The rule type of the rule. The only possible value is Community."', args=[d.arg(name='ruleType', type=d.T.string)]),
        withRuleType(ruleType): { spec+: { forProvider+: { rule+: { ruleType: ruleType } } } },
      },
      '#withLocation':: d.fn(help='"The Azure Region where the Route Filter should exist. Changing this forces a new Route Filter to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Route Filter should exist. Changing this forces a new Route Filter to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Route Filter."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Route Filter."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      rule: {
        '#withAccess':: d.fn(help='"The access type of the rule. The only possible value is Allow."', args=[d.arg(name='access', type=d.T.string)]),
        withAccess(access): { spec+: { initProvider+: { rule+: { access: access } } } },
        '#withCommunities':: d.fn(help="\"The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].\"", args=[d.arg(name='communities', type=d.T.array)]),
        withCommunities(communities): { spec+: { initProvider+: { rule+: { communities: if std.isArray(v=communities) then communities else [communities] } } } },
        '#withCommunitiesMixin':: d.fn(help="\"The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='communities', type=d.T.array)]),
        withCommunitiesMixin(communities): { spec+: { initProvider+: { rule+: { communities+: if std.isArray(v=communities) then communities else [communities] } } } },
        '#withName':: d.fn(help='"The name of the route filter rule."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { rule+: { name: name } } } },
        '#withRuleType':: d.fn(help='"The rule type of the rule. The only possible value is Community."', args=[d.arg(name='ruleType', type=d.T.string)]),
        withRuleType(ruleType): { spec+: { initProvider+: { rule+: { ruleType: ruleType } } } },
      },
      '#withLocation':: d.fn(help='"The Azure Region where the Route Filter should exist. Changing this forces a new Route Filter to be created."', args=[d.arg(name='location', type=d.T.string)]),
