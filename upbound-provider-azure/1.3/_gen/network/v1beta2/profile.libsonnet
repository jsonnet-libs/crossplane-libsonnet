  ...
  spec: {
    ...
    forProvider: {
      ...
      containerNetworkInterface: {
        ...
        withIpConfiguration(ipConfiguration): { spec+: { forProvider+: { containerNetworkInterface+: { ipConfiguration: if std.isArray(v=ipConfiguration) then ipConfiguration else [ipConfiguration] } } } },
        ...
        withIpConfigurationMixin(ipConfiguration): { spec+: { forProvider+: { containerNetworkInterface+: { ipConfiguration+: if std.isArray(v=ipConfiguration) then ipConfiguration else [ipConfiguration] } } } },
        '#withName':: d.fn(help='"Specifies the name of the IP Configuration."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { containerNetworkInterface+: { name: name } } } },
      },
    ...
    initProvider: {
      ...
      containerNetworkInterface: {
        ...
        '#withIpConfiguration':: d.fn(help='"One or more ip_configuration blocks as documented below."', args=[d.arg(name='ipConfiguration', type=d.T.array)]),
        withIpConfiguration(ipConfiguration): { spec+: { initProvider+: { containerNetworkInterface+: { ipConfiguration: if std.isArray(v=ipConfiguration) then ipConfiguration else [ipConfiguration] } } } },
        '#withIpConfigurationMixin':: d.fn(help='"One or more ip_configuration blocks as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipConfiguration', type=d.T.array)]),
        withIpConfigurationMixin(ipConfiguration): { spec+: { initProvider+: { containerNetworkInterface+: { ipConfiguration+: if std.isArray(v=ipConfiguration) then ipConfiguration else [ipConfiguration] } } } },
        '#withName':: d.fn(help='"Specifies the name of the IP Configuration."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { containerNetworkInterface+: { name: name } } } },
      },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
