{
  ...
  '#':: d.pkg(name='manager', url='', help='"Manager is the Schema for the Managers API. Manages a Network Managers."'),
  ...
  '#new':: d.fn(help='new returns an instance of Manager', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagerSpec defines the desired state of Manager"'),
  spec: {
    ...
    forProvider: {
      ...
      scope: {
        '#withManagementGroupIds':: d.fn(help='"A list of management group IDs."', args=[d.arg(name='managementGroupIds', type=d.T.array)]),
        withManagementGroupIds(managementGroupIds): { spec+: { forProvider+: { scope+: { managementGroupIds: if std.isArray(v=managementGroupIds) then managementGroupIds else [managementGroupIds] } } } },
        '#withManagementGroupIdsMixin':: d.fn(help='"A list of management group IDs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managementGroupIds', type=d.T.array)]),
        withManagementGroupIdsMixin(managementGroupIds): { spec+: { forProvider+: { scope+: { managementGroupIds+: if std.isArray(v=managementGroupIds) then managementGroupIds else [managementGroupIds] } } } },
        '#withSubscriptionIds':: d.fn(help='"A list of subscription IDs."', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
        withSubscriptionIds(subscriptionIds): { spec+: { forProvider+: { scope+: { subscriptionIds: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } } },
        '#withSubscriptionIdsMixin':: d.fn(help='"A list of subscription IDs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
        withSubscriptionIdsMixin(subscriptionIds): { spec+: { forProvider+: { scope+: { subscriptionIds+: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } } },
      },
      '#withDescription':: d.fn(help='"A description of the network manager."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLocation':: d.fn(help='"Specifies the Azure Region where the Network Managers should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group where the Network Managers should exist. Changing this forces a new Network Managers to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withScopeAccesses':: d.fn(help='"A list of configuration deployment type. Possible values are Connectivity and SecurityAdmin, corresponds to if Connectivity Configuration and Security Admin Configuration is allowed for the Network Manager."', args=[d.arg(name='scopeAccesses', type=d.T.array)]),
      withScopeAccesses(scopeAccesses): { spec+: { forProvider+: { scopeAccesses: if std.isArray(v=scopeAccesses) then scopeAccesses else [scopeAccesses] } } },
      '#withScopeAccessesMixin':: d.fn(help='"A list of configuration deployment type. Possible values are Connectivity and SecurityAdmin, corresponds to if Connectivity Configuration and Security Admin Configuration is allowed for the Network Manager."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopeAccesses', type=d.T.array)]),
      withScopeAccessesMixin(scopeAccesses): { spec+: { forProvider+: { scopeAccesses+: if std.isArray(v=scopeAccesses) then scopeAccesses else [scopeAccesses] } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Network Managers."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Network Managers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      scope: {
        '#withManagementGroupIds':: d.fn(help='"A list of management group IDs."', args=[d.arg(name='managementGroupIds', type=d.T.array)]),
        withManagementGroupIds(managementGroupIds): { spec+: { initProvider+: { scope+: { managementGroupIds: if std.isArray(v=managementGroupIds) then managementGroupIds else [managementGroupIds] } } } },
        '#withManagementGroupIdsMixin':: d.fn(help='"A list of management group IDs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managementGroupIds', type=d.T.array)]),
        withManagementGroupIdsMixin(managementGroupIds): { spec+: { initProvider+: { scope+: { managementGroupIds+: if std.isArray(v=managementGroupIds) then managementGroupIds else [managementGroupIds] } } } },
        '#withSubscriptionIds':: d.fn(help='"A list of subscription IDs."', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
        withSubscriptionIds(subscriptionIds): { spec+: { initProvider+: { scope+: { subscriptionIds: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } } },
        '#withSubscriptionIdsMixin':: d.fn(help='"A list of subscription IDs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
        withSubscriptionIdsMixin(subscriptionIds): { spec+: { initProvider+: { scope+: { subscriptionIds+: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } } },
      },
      '#withDescription':: d.fn(help='"A description of the network manager."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withScopeAccesses':: d.fn(help='"A list of configuration deployment type. Possible values are Connectivity and SecurityAdmin, corresponds to if Connectivity Configuration and Security Admin Configuration is allowed for the Network Manager."', args=[d.arg(name='scopeAccesses', type=d.T.array)]),
      withScopeAccesses(scopeAccesses): { spec+: { initProvider+: { scopeAccesses: if std.isArray(v=scopeAccesses) then scopeAccesses else [scopeAccesses] } } },
      '#withScopeAccessesMixin':: d.fn(help='"A list of configuration deployment type. Possible values are Connectivity and SecurityAdmin, corresponds to if Connectivity Configuration and Security Admin Configuration is allowed for the Network Manager."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopeAccesses', type=d.T.array)]),
      withScopeAccessesMixin(scopeAccesses): { spec+: { initProvider+: { scopeAccesses+: if std.isArray(v=scopeAccesses) then scopeAccesses else [scopeAccesses] } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Network Managers."', args=[d.arg(name='tags', type=d.T.object)]),
