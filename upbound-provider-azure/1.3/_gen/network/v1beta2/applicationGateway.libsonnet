  ...
  spec: {
    ...
    forProvider: {
      ...
      autoscaleConfiguration: {
        ...
        withMaxCapacity(maxCapacity): { spec+: { forProvider+: { autoscaleConfiguration+: { maxCapacity: maxCapacity } } } },
        ...
        withMinCapacity(minCapacity): { spec+: { forProvider+: { autoscaleConfiguration+: { minCapacity: minCapacity } } } },
      },
      ...
      backendHttpSettings: {
        ...
        connectionDraining: {
          ...
          withDrainTimeoutSec(drainTimeoutSec): { connectionDraining+: { drainTimeoutSec: drainTimeoutSec } },
          '#withEnabled':: d.fn(help='"Is the Web Application Firewall enabled?"', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { connectionDraining+: { enabled: enabled } },
        },
      ...
      global: {
        ...
        withRequestBufferingEnabled(requestBufferingEnabled): { spec+: { forProvider+: { global+: { requestBufferingEnabled: requestBufferingEnabled } } } },
        ...
        withResponseBufferingEnabled(responseBufferingEnabled): { spec+: { forProvider+: { global+: { responseBufferingEnabled: responseBufferingEnabled } } } },
      },
      ...
      probe: {
        ...
        match: {
          ...
          withBody(body): { match+: { body: body } },
          '#withStatusCode':: d.fn(help='"A list of allowed status codes for this Health Probe."', args=[d.arg(name='statusCode', type=d.T.array)]),
          withStatusCode(statusCode): { match+: { statusCode: if std.isArray(v=statusCode) then statusCode else [statusCode] } },
          ...
          withStatusCodeMixin(statusCode): { match+: { statusCode+: if std.isArray(v=statusCode) then statusCode else [statusCode] } },
        },
      ...
      rewriteRuleSet: {
        ...
        rewriteRule: {
          ...
          url: {
            ...
            withComponents(components): { url+: { components: components } },
            ...
            withQueryString(queryString): { url+: { queryString: queryString } },
            ...
            withReroute(reroute): { url+: { reroute: reroute } },
          },
      ...
      sslPolicy: {
        ...
        withCipherSuites(cipherSuites): { spec+: { forProvider+: { sslPolicy+: { cipherSuites: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } } } },
        ...
        withCipherSuitesMixin(cipherSuites): { spec+: { forProvider+: { sslPolicy+: { cipherSuites+: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } } } },
        ...
        withDisabledProtocols(disabledProtocols): { spec+: { forProvider+: { sslPolicy+: { disabledProtocols: if std.isArray(v=disabledProtocols) then disabledProtocols else [disabledProtocols] } } } },
        ...
        withDisabledProtocolsMixin(disabledProtocols): { spec+: { forProvider+: { sslPolicy+: { disabledProtocols+: if std.isArray(v=disabledProtocols) then disabledProtocols else [disabledProtocols] } } } },
        ...
        withMinProtocolVersion(minProtocolVersion): { spec+: { forProvider+: { sslPolicy+: { minProtocolVersion: minProtocolVersion } } } },
        ...
        withPolicyName(policyName): { spec+: { forProvider+: { sslPolicy+: { policyName: policyName } } } },
        ...
        withPolicyType(policyType): { spec+: { forProvider+: { sslPolicy+: { policyType: policyType } } } },
      },
      ...
      sslProfile: {
        ...
        sslPolicy: {
          '#withCipherSuites':: d.fn(help='"A List of accepted cipher suites. Possible values are: TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA256, TLS_DHE_DSS_WITH_AES_256_CBC_SHA, TLS_DHE_DSS_WITH_AES_256_CBC_SHA256, TLS_DHE_RSA_WITH_AES_128_CBC_SHA, TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, TLS_DHE_RSA_WITH_AES_256_CBC_SHA, TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, TLS_RSA_WITH_3DES_EDE_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA256, TLS_RSA_WITH_AES_128_GCM_SHA256, TLS_RSA_WITH_AES_256_CBC_SHA, TLS_RSA_WITH_AES_256_CBC_SHA256 and TLS_RSA_WITH_AES_256_GCM_SHA384."', args=[d.arg(name='cipherSuites', type=d.T.array)]),
          withCipherSuites(cipherSuites): { sslPolicy+: { cipherSuites: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } },
          '#withCipherSuitesMixin':: d.fn(help='"A List of accepted cipher suites. Possible values are: TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA256, TLS_DHE_DSS_WITH_AES_256_CBC_SHA, TLS_DHE_DSS_WITH_AES_256_CBC_SHA256, TLS_DHE_RSA_WITH_AES_128_CBC_SHA, TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, TLS_DHE_RSA_WITH_AES_256_CBC_SHA, TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, TLS_RSA_WITH_3DES_EDE_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA256, TLS_RSA_WITH_AES_128_GCM_SHA256, TLS_RSA_WITH_AES_256_CBC_SHA, TLS_RSA_WITH_AES_256_CBC_SHA256 and TLS_RSA_WITH_AES_256_GCM_SHA384."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cipherSuites', type=d.T.array)]),
          withCipherSuitesMixin(cipherSuites): { sslPolicy+: { cipherSuites+: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } },
          '#withDisabledProtocols':: d.fn(help='"A list of SSL Protocols which should be disabled on this Application Gateway. Possible values are TLSv1_0, TLSv1_1, TLSv1_2 and TLSv1_3."', args=[d.arg(name='disabledProtocols', type=d.T.array)]),
          withDisabledProtocols(disabledProtocols): { sslPolicy+: { disabledProtocols: if std.isArray(v=disabledProtocols) then disabledProtocols else [disabledProtocols] } },
          '#withDisabledProtocolsMixin':: d.fn(help='"A list of SSL Protocols which should be disabled on this Application Gateway. Possible values are TLSv1_0, TLSv1_1, TLSv1_2 and TLSv1_3."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='disabledProtocols', type=d.T.array)]),
          withDisabledProtocolsMixin(disabledProtocols): { sslPolicy+: { disabledProtocols+: if std.isArray(v=disabledProtocols) then disabledProtocols else [disabledProtocols] } },
          '#withMinProtocolVersion':: d.fn(help='"The minimal TLS version. Possible values are TLSv1_0, TLSv1_1, TLSv1_2 and TLSv1_3."', args=[d.arg(name='minProtocolVersion', type=d.T.string)]),
          withMinProtocolVersion(minProtocolVersion): { sslPolicy+: { minProtocolVersion: minProtocolVersion } },
          '#withPolicyName':: d.fn(help='"The Name of the Policy e.g. AppGwSslPolicy20170401S. Required if policy_type is set to Predefined. Possible values can change over time and are published here https://docs.microsoft.com/azure/application-gateway/application-gateway-ssl-policy-overview. Not compatible with disabled_protocols."', args=[d.arg(name='policyName', type=d.T.string)]),
          withPolicyName(policyName): { sslPolicy+: { policyName: policyName } },
          '#withPolicyType':: d.fn(help='"The Type of the Policy. Possible values are Predefined, Custom and CustomV2."', args=[d.arg(name='policyType', type=d.T.string)]),
          withPolicyType(policyType): { sslPolicy+: { policyType: policyType } },
        },
      ...
      wafConfiguration: {
        ...
        withDisabledRuleGroup(disabledRuleGroup): { spec+: { forProvider+: { wafConfiguration+: { disabledRuleGroup: if std.isArray(v=disabledRuleGroup) then disabledRuleGroup else [disabledRuleGroup] } } } },
        ...
        withDisabledRuleGroupMixin(disabledRuleGroup): { spec+: { forProvider+: { wafConfiguration+: { disabledRuleGroup+: if std.isArray(v=disabledRuleGroup) then disabledRuleGroup else [disabledRuleGroup] } } } },
        '#withEnabled':: d.fn(help='"Is the Web Application Firewall enabled?"', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { forProvider+: { wafConfiguration+: { enabled: enabled } } } },
        '#withExclusion':: d.fn(help='"One or more exclusion blocks as defined below."', args=[d.arg(name='exclusion', type=d.T.array)]),
        withExclusion(exclusion): { spec+: { forProvider+: { wafConfiguration+: { exclusion: if std.isArray(v=exclusion) then exclusion else [exclusion] } } } },
        ...
        withExclusionMixin(exclusion): { spec+: { forProvider+: { wafConfiguration+: { exclusion+: if std.isArray(v=exclusion) then exclusion else [exclusion] } } } },
        ...
        withFileUploadLimitMb(fileUploadLimitMb): { spec+: { forProvider+: { wafConfiguration+: { fileUploadLimitMb: fileUploadLimitMb } } } },
        ...
        withFirewallMode(firewallMode): { spec+: { forProvider+: { wafConfiguration+: { firewallMode: firewallMode } } } },
        ...
        withMaxRequestBodySizeKb(maxRequestBodySizeKb): { spec+: { forProvider+: { wafConfiguration+: { maxRequestBodySizeKb: maxRequestBodySizeKb } } } },
        ...
        withRequestBodyCheck(requestBodyCheck): { spec+: { forProvider+: { wafConfiguration+: { requestBodyCheck: requestBodyCheck } } } },
        ...
        withRuleSetType(ruleSetType): { spec+: { forProvider+: { wafConfiguration+: { ruleSetType: ruleSetType } } } },
        ...
        withRuleSetVersion(ruleSetVersion): { spec+: { forProvider+: { wafConfiguration+: { ruleSetVersion: ruleSetVersion } } } },
      },
    ...
    initProvider: {
      ...
      autoscaleConfiguration: {
        '#withMaxCapacity':: d.fn(help='"Maximum capacity for autoscaling. Accepted values are in the range 2 to 125."', args=[d.arg(name='maxCapacity', type=d.T.number)]),
        withMaxCapacity(maxCapacity): { spec+: { initProvider+: { autoscaleConfiguration+: { maxCapacity: maxCapacity } } } },
        '#withMinCapacity':: d.fn(help='"Minimum capacity for autoscaling. Accepted values are in the range 0 to 100."', args=[d.arg(name='minCapacity', type=d.T.number)]),
        withMinCapacity(minCapacity): { spec+: { initProvider+: { autoscaleConfiguration+: { minCapacity: minCapacity } } } },
      },
      '#backendAddressPool':: d.obj(help='"One or more backend_address_pool blocks as defined below."'),
      backendAddressPool: {
        '#withFqdns':: d.fn(help="\"A list of FQDN's which should be part of the Backend Address Pool.\"", args=[d.arg(name='fqdns', type=d.T.array)]),
      ...
      global: {
        '#withRequestBufferingEnabled':: d.fn(help="\"Whether Application Gateway's Request buffer is enabled.\"", args=[d.arg(name='requestBufferingEnabled', type=d.T.boolean)]),
        withRequestBufferingEnabled(requestBufferingEnabled): { spec+: { initProvider+: { global+: { requestBufferingEnabled: requestBufferingEnabled } } } },
        '#withResponseBufferingEnabled':: d.fn(help="\"Whether Application Gateway's Response buffer is enabled.\"", args=[d.arg(name='responseBufferingEnabled', type=d.T.boolean)]),
        withResponseBufferingEnabled(responseBufferingEnabled): { spec+: { initProvider+: { global+: { responseBufferingEnabled: responseBufferingEnabled } } } },
      },
      '#httpListener':: d.obj(help='"One or more http_listener blocks as defined below."'),
      httpListener: {
        '#customErrorConfiguration':: d.obj(help='"One or more custom_error_configuration blocks as defined below."'),
      ...
      sku: {
        ...
        '#withTier':: d.fn(help='"The Tier of the SKU to use for this Application Gateway. Possible values are Standard, Standard_v2, WAF and WAF_v2."', args=[d.arg(name='tier', type=d.T.string)]),
        withTier(tier): { spec+: { initProvider+: { sku+: { tier: tier } } } },
      },
      '#sslCertificate':: d.obj(help='"One or more ssl_certificate blocks as defined below."'),
      sslCertificate: {
        '#dataSecretRef':: d.obj(help='"The base64-encoded PFX certificate data. Required if key_vault_secret_id is not set."'),
      ...
      sslPolicy: {
        '#withCipherSuites':: d.fn(help='"A List of accepted cipher suites. Possible values are: TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA256, TLS_DHE_DSS_WITH_AES_256_CBC_SHA, TLS_DHE_DSS_WITH_AES_256_CBC_SHA256, TLS_DHE_RSA_WITH_AES_128_CBC_SHA, TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, TLS_DHE_RSA_WITH_AES_256_CBC_SHA, TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, TLS_RSA_WITH_3DES_EDE_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA256, TLS_RSA_WITH_AES_128_GCM_SHA256, TLS_RSA_WITH_AES_256_CBC_SHA, TLS_RSA_WITH_AES_256_CBC_SHA256 and TLS_RSA_WITH_AES_256_GCM_SHA384."', args=[d.arg(name='cipherSuites', type=d.T.array)]),
        withCipherSuites(cipherSuites): { spec+: { initProvider+: { sslPolicy+: { cipherSuites: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } } } },
        '#withCipherSuitesMixin':: d.fn(help='"A List of accepted cipher suites. Possible values are: TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA, TLS_DHE_DSS_WITH_AES_128_CBC_SHA256, TLS_DHE_DSS_WITH_AES_256_CBC_SHA, TLS_DHE_DSS_WITH_AES_256_CBC_SHA256, TLS_DHE_RSA_WITH_AES_128_CBC_SHA, TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, TLS_DHE_RSA_WITH_AES_256_CBC_SHA, TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256, TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, TLS_RSA_WITH_3DES_EDE_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA, TLS_RSA_WITH_AES_128_CBC_SHA256, TLS_RSA_WITH_AES_128_GCM_SHA256, TLS_RSA_WITH_AES_256_CBC_SHA, TLS_RSA_WITH_AES_256_CBC_SHA256 and TLS_RSA_WITH_AES_256_GCM_SHA384."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cipherSuites', type=d.T.array)]),
        withCipherSuitesMixin(cipherSuites): { spec+: { initProvider+: { sslPolicy+: { cipherSuites+: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } } } },
        '#withDisabledProtocols':: d.fn(help='"A list of SSL Protocols which should be disabled on this Application Gateway. Possible values are TLSv1_0, TLSv1_1, TLSv1_2 and TLSv1_3."', args=[d.arg(name='disabledProtocols', type=d.T.array)]),
        withDisabledProtocols(disabledProtocols): { spec+: { initProvider+: { sslPolicy+: { disabledProtocols: if std.isArray(v=disabledProtocols) then disabledProtocols else [disabledProtocols] } } } },
        '#withDisabledProtocolsMixin':: d.fn(help='"A list of SSL Protocols which should be disabled on this Application Gateway. Possible values are TLSv1_0, TLSv1_1, TLSv1_2 and TLSv1_3."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='disabledProtocols', type=d.T.array)]),
        withDisabledProtocolsMixin(disabledProtocols): { spec+: { initProvider+: { sslPolicy+: { disabledProtocols+: if std.isArray(v=disabledProtocols) then disabledProtocols else [disabledProtocols] } } } },
        '#withMinProtocolVersion':: d.fn(help='"The minimal TLS version. Possible values are TLSv1_0, TLSv1_1, TLSv1_2 and TLSv1_3."', args=[d.arg(name='minProtocolVersion', type=d.T.string)]),
        withMinProtocolVersion(minProtocolVersion): { spec+: { initProvider+: { sslPolicy+: { minProtocolVersion: minProtocolVersion } } } },
        '#withPolicyName':: d.fn(help='"The Name of the Policy e.g. AppGwSslPolicy20170401S. Required if policy_type is set to Predefined. Possible values can change over time and are published here https://docs.microsoft.com/azure/application-gateway/application-gateway-ssl-policy-overview. Not compatible with disabled_protocols."', args=[d.arg(name='policyName', type=d.T.string)]),
        withPolicyName(policyName): { spec+: { initProvider+: { sslPolicy+: { policyName: policyName } } } },
        '#withPolicyType':: d.fn(help='"The Type of the Policy. Possible values are Predefined, Custom and CustomV2."', args=[d.arg(name='policyType', type=d.T.string)]),
        withPolicyType(policyType): { spec+: { initProvider+: { sslPolicy+: { policyType: policyType } } } },
      },
      '#sslProfile':: d.obj(help='"One or more ssl_profile blocks as defined below."'),
      sslProfile: {
        '#sslPolicy':: d.obj(help='"a ssl_policy block as defined below."'),
      ...
      wafConfiguration: {
        ...
        '#withDisabledRuleGroup':: d.fn(help='"One or more disabled_rule_group blocks as defined below."', args=[d.arg(name='disabledRuleGroup', type=d.T.array)]),
        withDisabledRuleGroup(disabledRuleGroup): { spec+: { initProvider+: { wafConfiguration+: { disabledRuleGroup: if std.isArray(v=disabledRuleGroup) then disabledRuleGroup else [disabledRuleGroup] } } } },
        '#withDisabledRuleGroupMixin':: d.fn(help='"One or more disabled_rule_group blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='disabledRuleGroup', type=d.T.array)]),
        withDisabledRuleGroupMixin(disabledRuleGroup): { spec+: { initProvider+: { wafConfiguration+: { disabledRuleGroup+: if std.isArray(v=disabledRuleGroup) then disabledRuleGroup else [disabledRuleGroup] } } } },
        '#withEnabled':: d.fn(help='"Is the Web Application Firewall enabled?"', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { initProvider+: { wafConfiguration+: { enabled: enabled } } } },
        '#withExclusion':: d.fn(help='"One or more exclusion blocks as defined below."', args=[d.arg(name='exclusion', type=d.T.array)]),
        withExclusion(exclusion): { spec+: { initProvider+: { wafConfiguration+: { exclusion: if std.isArray(v=exclusion) then exclusion else [exclusion] } } } },
        '#withExclusionMixin':: d.fn(help='"One or more exclusion blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exclusion', type=d.T.array)]),
        withExclusionMixin(exclusion): { spec+: { initProvider+: { wafConfiguration+: { exclusion+: if std.isArray(v=exclusion) then exclusion else [exclusion] } } } },
        '#withFileUploadLimitMb':: d.fn(help='"The File Upload Limit in MB. Accepted values are in the range 1MB to 750MB for the WAF_v2 SKU, and 1MB to 500MB for all other SKUs. Defaults to 100MB."', args=[d.arg(name='fileUploadLimitMb', type=d.T.number)]),
        withFileUploadLimitMb(fileUploadLimitMb): { spec+: { initProvider+: { wafConfiguration+: { fileUploadLimitMb: fileUploadLimitMb } } } },
        '#withFirewallMode':: d.fn(help='"The Web Application Firewall Mode. Possible values are Detection and Prevention."', args=[d.arg(name='firewallMode', type=d.T.string)]),
        withFirewallMode(firewallMode): { spec+: { initProvider+: { wafConfiguration+: { firewallMode: firewallMode } } } },
        '#withMaxRequestBodySizeKb':: d.fn(help='"The Maximum Request Body Size in KB. Accepted values are in the range 1KB to 128KB. Defaults to 128KB."', args=[d.arg(name='maxRequestBodySizeKb', type=d.T.number)]),
        withMaxRequestBodySizeKb(maxRequestBodySizeKb): { spec+: { initProvider+: { wafConfiguration+: { maxRequestBodySizeKb: maxRequestBodySizeKb } } } },
        '#withRequestBodyCheck':: d.fn(help='"Is Request Body Inspection enabled? Defaults to true."', args=[d.arg(name='requestBodyCheck', type=d.T.boolean)]),
        withRequestBodyCheck(requestBodyCheck): { spec+: { initProvider+: { wafConfiguration+: { requestBodyCheck: requestBodyCheck } } } },
        '#withRuleSetType':: d.fn(help='"The Type of the Rule Set used for this Web Application Firewall. Possible values are OWASP, Microsoft_BotManagerRuleSet and Microsoft_DefaultRuleSet. Defaults to OWASP."', args=[d.arg(name='ruleSetType', type=d.T.string)]),
        withRuleSetType(ruleSetType): { spec+: { initProvider+: { wafConfiguration+: { ruleSetType: ruleSetType } } } },
        '#withRuleSetVersion':: d.fn(help='"The Version of the Rule Set used for this Web Application Firewall. Possible values are 0.1, 1.0, 2.1, 2.2.9, 3.0, 3.1 and 3.2."', args=[d.arg(name='ruleSetVersion', type=d.T.string)]),
        withRuleSetVersion(ruleSetVersion): { spec+: { initProvider+: { wafConfiguration+: { ruleSetVersion: ruleSetVersion } } } },
      },
      '#withAuthenticationCertificate':: d.fn(help='"One or more authentication_certificate blocks as defined below."', args=[d.arg(name='authenticationCertificate', type=d.T.array)]),
