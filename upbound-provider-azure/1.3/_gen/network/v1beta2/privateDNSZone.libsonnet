{
  ...
  '#':: d.pkg(name='privateDNSZone', url='', help='"PrivateDNSZone is the Schema for the PrivateDNSZones API. Manages a Private DNS Zone."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDNSZone', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateDNSZoneSpec defines the desired state of PrivateDNSZone"'),
  spec: {
    ...
    forProvider: {
      ...
      soaRecord: {
        ...
        '#withMinimumTtl':: d.fn(help='"The minimum Time To Live for the SOA record. By convention, it is used to determine the negative caching duration. Defaults to 10."', args=[d.arg(name='minimumTtl', type=d.T.number)]),
