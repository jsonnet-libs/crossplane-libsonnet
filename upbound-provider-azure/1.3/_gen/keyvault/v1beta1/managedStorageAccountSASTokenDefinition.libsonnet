{
  ...
  '#':: d.pkg(name='managedStorageAccountSASTokenDefinition', url='', help='"ManagedStorageAccountSASTokenDefinition is the Schema for the ManagedStorageAccountSASTokenDefinitions API. Manages a Key Vault Managed Storage Account SAS Definition."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagedStorageAccountSASTokenDefinition', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagedStorageAccountSASTokenDefinitionSpec defines the desired state of ManagedStorageAccountSASTokenDefinition"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#managedStorageAccountIdRef':: d.obj(help='"Reference to a ManagedStorageAccount in keyvault to populate managedStorageAccountId."'),
      managedStorageAccountIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { managedStorageAccountIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { managedStorageAccountIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { managedStorageAccountIdRef+: { name: name } } } },
      },
      '#managedStorageAccountIdSelector':: d.obj(help='"Selector for a ManagedStorageAccount in keyvault to populate managedStorageAccountId."'),
      managedStorageAccountIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { managedStorageAccountIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { managedStorageAccountIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { managedStorageAccountIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { managedStorageAccountIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { managedStorageAccountIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withManagedStorageAccountId':: d.fn(help='"The ID of the Managed Storage Account."', args=[d.arg(name='managedStorageAccountId', type=d.T.string)]),
      withManagedStorageAccountId(managedStorageAccountId): { spec+: { forProvider+: { managedStorageAccountId: managedStorageAccountId } } },
      '#withSasTemplateUri':: d.fn(help='"The SAS definition token template signed with an arbitrary key. Tokens created according to the SAS definition will have the same properties as the template, but regenerated with a new validity period."', args=[d.arg(name='sasTemplateUri', type=d.T.string)]),
      withSasTemplateUri(sasTemplateUri): { spec+: { forProvider+: { sasTemplateUri: sasTemplateUri } } },
      '#withSasType':: d.fn(help='"The type of SAS token the SAS definition will create. Possible values are account and service."', args=[d.arg(name='sasType', type=d.T.string)]),
      withSasType(sasType): { spec+: { forProvider+: { sasType: sasType } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the SAS Definition. Changing this forces a new resource to be created."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the SAS Definition. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withValidityPeriod':: d.fn(help='"Validity period of SAS token. Value needs to be in ISO 8601 duration format."', args=[d.arg(name='validityPeriod', type=d.T.string)]),
      withValidityPeriod(validityPeriod): { spec+: { forProvider+: { validityPeriod: validityPeriod } } },
    },
    ...
    initProvider: {
      '#withSasTemplateUri':: d.fn(help='"The SAS definition token template signed with an arbitrary key. Tokens created according to the SAS definition will have the same properties as the template, but regenerated with a new validity period."', args=[d.arg(name='sasTemplateUri', type=d.T.string)]),
      withSasTemplateUri(sasTemplateUri): { spec+: { initProvider+: { sasTemplateUri: sasTemplateUri } } },
      '#withSasType':: d.fn(help='"The type of SAS token the SAS definition will create. Possible values are account and service."', args=[d.arg(name='sasType', type=d.T.string)]),
      withSasType(sasType): { spec+: { initProvider+: { sasType: sasType } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the SAS Definition. Changing this forces a new resource to be created."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the SAS Definition. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withValidityPeriod':: d.fn(help='"Validity period of SAS token. Value needs to be in ISO 8601 duration format."', args=[d.arg(name='validityPeriod', type=d.T.string)]),
      withValidityPeriod(validityPeriod): { spec+: { initProvider+: { validityPeriod: validityPeriod } } },
    },
