{
  ...
  '#':: d.pkg(name='secret', url='', help='"Secret is the Schema for the Secrets API. Manages a Key Vault Secret."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#valueSecretRef':: d.obj(help='"Specifies the value of the Key Vault Secret. Changing this will create a new version of the Key Vault Secret."'),
      valueSecretRef: {
      ...
      '#withContentType':: d.fn(help='"Specifies the content type for the Key Vault Secret."', args=[d.arg(name='contentType', type=d.T.string)]),
      ...
      '#withKeyVaultId':: d.fn(help='"The ID of the Key Vault where the Secret should be created. Changing this forces a new resource to be created."', args=[d.arg(name='keyVaultId', type=d.T.string)]),
      withKeyVaultId(keyVaultId): { spec+: { forProvider+: { keyVaultId: keyVaultId } } },
      '#withName':: d.fn(help='"Specifies the name of the Key Vault Secret. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
