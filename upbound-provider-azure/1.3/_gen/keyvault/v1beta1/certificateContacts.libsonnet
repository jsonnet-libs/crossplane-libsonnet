{
  ...
  '#':: d.pkg(name='certificateContacts', url='', help='"CertificateContacts is the Schema for the CertificateContactss API. Manages Key Vault Certificate Contacts."'),
  ...
  '#new':: d.fn(help='new returns an instance of CertificateContacts', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CertificateContactsSpec defines the desired state of CertificateContacts"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#contact':: d.obj(help='"One or more contact blocks as defined below."'),
      contact: {
      ...
      '#withContact':: d.fn(help='"One or more contact blocks as defined below."', args=[d.arg(name='contact', type=d.T.array)]),
      withContact(contact): { spec+: { forProvider+: { contact: if std.isArray(v=contact) then contact else [contact] } } },
      '#withContactMixin':: d.fn(help='"One or more contact blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='contact', type=d.T.array)]),
      withContactMixin(contact): { spec+: { forProvider+: { contact+: if std.isArray(v=contact) then contact else [contact] } } },
      '#withKeyVaultId':: d.fn(help='"The ID of the Key Vault. Changing this forces a new resource to be created."', args=[d.arg(name='keyVaultId', type=d.T.string)]),
