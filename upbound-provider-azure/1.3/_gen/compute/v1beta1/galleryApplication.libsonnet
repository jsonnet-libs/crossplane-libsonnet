{
  ...
  '#':: d.pkg(name='galleryApplication', url='', help='"GalleryApplication is the Schema for the GalleryApplications API. Manages a Gallery Application."'),
  ...
  '#new':: d.fn(help='new returns an instance of GalleryApplication', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GalleryApplicationSpec defines the desired state of GalleryApplication"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#galleryIdRef':: d.obj(help='"Reference to a SharedImageGallery in compute to populate galleryId."'),
      galleryIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { galleryIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { galleryIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { galleryIdRef+: { name: name } } } },
      },
      '#galleryIdSelector':: d.obj(help='"Selector for a SharedImageGallery in compute to populate galleryId."'),
      galleryIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { galleryIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { galleryIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { galleryIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { galleryIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { galleryIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withDescription':: d.fn(help='"A description of the Gallery Application."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEndOfLifeDate':: d.fn(help='"The end of life date in RFC3339 format of the Gallery Application."', args=[d.arg(name='endOfLifeDate', type=d.T.string)]),
      withEndOfLifeDate(endOfLifeDate): { spec+: { forProvider+: { endOfLifeDate: endOfLifeDate } } },
      '#withEula':: d.fn(help='"The End User Licence Agreement of the Gallery Application."', args=[d.arg(name='eula', type=d.T.string)]),
      withEula(eula): { spec+: { forProvider+: { eula: eula } } },
      '#withGalleryId':: d.fn(help='"The ID of the Shared Image Gallery. Changing this forces a new resource to be created."', args=[d.arg(name='galleryId', type=d.T.string)]),
      withGalleryId(galleryId): { spec+: { forProvider+: { galleryId: galleryId } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Gallery Application exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPrivacyStatementUri':: d.fn(help='"The URI containing the Privacy Statement associated with the Gallery Application."', args=[d.arg(name='privacyStatementUri', type=d.T.string)]),
      withPrivacyStatementUri(privacyStatementUri): { spec+: { forProvider+: { privacyStatementUri: privacyStatementUri } } },
      '#withReleaseNoteUri':: d.fn(help='"The URI containing the Release Notes associated with the Gallery Application."', args=[d.arg(name='releaseNoteUri', type=d.T.string)]),
      withReleaseNoteUri(releaseNoteUri): { spec+: { forProvider+: { releaseNoteUri: releaseNoteUri } } },
      '#withSupportedOsType':: d.fn(help='"The type of the Operating System supported for the Gallery Application. Possible values are Linux and Windows. Changing this forces a new resource to be created."', args=[d.arg(name='supportedOsType', type=d.T.string)]),
      withSupportedOsType(supportedOsType): { spec+: { forProvider+: { supportedOsType: supportedOsType } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Gallery Application."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Gallery Application."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withSupportedOsType':: d.fn(help='"The type of the Operating System supported for the Gallery Application. Possible values are Linux and Windows. Changing this forces a new resource to be created."', args=[d.arg(name='supportedOsType', type=d.T.string)]),
      withSupportedOsType(supportedOsType): { spec+: { initProvider+: { supportedOsType: supportedOsType } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Gallery Application."', args=[d.arg(name='tags', type=d.T.object)]),
