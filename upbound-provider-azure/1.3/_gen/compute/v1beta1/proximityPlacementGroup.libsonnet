{
  ...
  '#':: d.pkg(name='proximityPlacementGroup', url='', help='"ProximityPlacementGroup is the Schema for the ProximityPlacementGroups API. Manages a proximity placement group for virtual machines, virtual machine scale sets and availability sets."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProximityPlacementGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProximityPlacementGroupSpec defines the desired state of ProximityPlacementGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowedVmSizes':: d.fn(help='"Specifies the supported sizes of Virtual Machines that can be created in the Proximity Placement Group."', args=[d.arg(name='allowedVmSizes', type=d.T.array)]),
      withAllowedVmSizes(allowedVmSizes): { spec+: { forProvider+: { allowedVmSizes: if std.isArray(v=allowedVmSizes) then allowedVmSizes else [allowedVmSizes] } } },
      '#withAllowedVmSizesMixin':: d.fn(help='"Specifies the supported sizes of Virtual Machines that can be created in the Proximity Placement Group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedVmSizes', type=d.T.array)]),
      withAllowedVmSizesMixin(allowedVmSizes): { spec+: { forProvider+: { allowedVmSizes+: if std.isArray(v=allowedVmSizes) then allowedVmSizes else [allowedVmSizes] } } },
      ...
      '#withZone':: d.fn(help='"Specifies the supported zone of the Proximity Placement Group. Changing this forces a new resource to be created."', args=[d.arg(name='zone', type=d.T.string)]),
    ...
    initProvider: {
      '#withAllowedVmSizes':: d.fn(help='"Specifies the supported sizes of Virtual Machines that can be created in the Proximity Placement Group."', args=[d.arg(name='allowedVmSizes', type=d.T.array)]),
      withAllowedVmSizes(allowedVmSizes): { spec+: { initProvider+: { allowedVmSizes: if std.isArray(v=allowedVmSizes) then allowedVmSizes else [allowedVmSizes] } } },
      '#withAllowedVmSizesMixin':: d.fn(help='"Specifies the supported sizes of Virtual Machines that can be created in the Proximity Placement Group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedVmSizes', type=d.T.array)]),
      withAllowedVmSizesMixin(allowedVmSizes): { spec+: { initProvider+: { allowedVmSizes+: if std.isArray(v=allowedVmSizes) then allowedVmSizes else [allowedVmSizes] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
