{
  ...
  '#':: d.pkg(name='managedDiskSASToken', url='', help='"ManagedDiskSASToken is the Schema for the ManagedDiskSASTokens API. Manages a Disk SAS Token."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagedDiskSASToken', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagedDiskSASTokenSpec defines the desired state of ManagedDiskSASToken"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAccessLevel':: d.fn(help='"The level of access required on the disk. Supported are Read, Write. Changing this forces a new resource to be created."', args=[d.arg(name='accessLevel', type=d.T.string)]),
      withAccessLevel(accessLevel): { spec+: { forProvider+: { accessLevel: accessLevel } } },
      '#withDurationInSeconds':: d.fn(help='"The duration for which the export should be allowed. Should be between 30 & 4294967295 seconds. Changing this forces a new resource to be created."', args=[d.arg(name='durationInSeconds', type=d.T.number)]),
      withDurationInSeconds(durationInSeconds): { spec+: { forProvider+: { durationInSeconds: durationInSeconds } } },
      '#withManagedDiskId':: d.fn(help='"The ID of an existing Managed Disk which should be exported. Changing this forces a new resource to be created."', args=[d.arg(name='managedDiskId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDurationInSeconds':: d.fn(help='"The duration for which the export should be allowed. Should be between 30 & 4294967295 seconds. Changing this forces a new resource to be created."', args=[d.arg(name='durationInSeconds', type=d.T.number)]),
      withDurationInSeconds(durationInSeconds): { spec+: { initProvider+: { durationInSeconds: durationInSeconds } } },
      '#withManagedDiskId':: d.fn(help='"The ID of an existing Managed Disk which should be exported. Changing this forces a new resource to be created."', args=[d.arg(name='managedDiskId', type=d.T.string)]),
