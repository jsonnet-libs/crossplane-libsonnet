{
  ...
  '#':: d.pkg(name='sshPublicKey', url='', help='"SSHPublicKey is the Schema for the SSHPublicKeys API. Manages a SSH Public Key."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the SSH Public Key should exist. Changing this forces a new SSH Public Key to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPublicKey':: d.fn(help='"SSH public key used to authenticate to a virtual machine through ssh. the provided public key needs to be at least 2048-bit and in ssh-rsa format."', args=[d.arg(name='publicKey', type=d.T.string)]),
      withPublicKey(publicKey): { spec+: { forProvider+: { publicKey: publicKey } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the SSH Public Key should exist. Changing this forces a new SSH Public Key to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the SSH Public Key."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the SSH Public Key."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
