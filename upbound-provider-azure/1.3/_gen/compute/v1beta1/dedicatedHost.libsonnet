{
  ...
  '#':: d.pkg(name='dedicatedHost', url='', help='"DedicatedHost is the Schema for the DedicatedHosts API. Manage a Dedicated Host within a Dedicated Host Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of DedicatedHost', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DedicatedHostSpec defines the desired state of DedicatedHost"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAutoReplaceOnFailure':: d.fn(help='"Should the Dedicated Host automatically be replaced in case of a Hardware Failure? Defaults to true."', args=[d.arg(name='autoReplaceOnFailure', type=d.T.boolean)]),
      withAutoReplaceOnFailure(autoReplaceOnFailure): { spec+: { forProvider+: { autoReplaceOnFailure: autoReplaceOnFailure } } },
      '#withDedicatedHostGroupId':: d.fn(help='"Specifies the ID of the Dedicated Host Group where the Dedicated Host should exist. Changing this forces a new resource to be created."', args=[d.arg(name='dedicatedHostGroupId', type=d.T.string)]),
      withDedicatedHostGroupId(dedicatedHostGroupId): { spec+: { forProvider+: { dedicatedHostGroupId: dedicatedHostGroupId } } },
      '#withLicenseType':: d.fn(help='"Specifies the software license type that will be applied to the VMs deployed on the Dedicated Host. Possible values are None, Windows_Server_Hybrid and Windows_Server_Perpetual. Defaults to None."', args=[d.arg(name='licenseType', type=d.T.string)]),
      withLicenseType(licenseType): { spec+: { forProvider+: { licenseType: licenseType } } },
      '#withLocation':: d.fn(help='"Specify the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPlatformFaultDomain':: d.fn(help='"Specify the fault domain of the Dedicated Host Group in which to create the Dedicated Host. Changing this forces a new resource to be created."', args=[d.arg(name='platformFaultDomain', type=d.T.number)]),
      withPlatformFaultDomain(platformFaultDomain): { spec+: { forProvider+: { platformFaultDomain: platformFaultDomain } } },
      '#withSkuName':: d.fn(help='"Specify the SKU name of the Dedicated Host. Possible values are DADSv5-Type1, DASv4-Type1, DASv4-Type2, DASv5-Type1, DCSv2-Type1, DDSv4-Type1, DDSv4-Type2, DDSv5-Type1, DSv3-Type1, DSv3-Type2, DSv3-Type3, DSv3-Type4, DSv4-Type1, DSv4-Type2, DSv5-Type1, EADSv5-Type1, EASv4-Type1, EASv4-Type2, EASv5-Type1, EDSv4-Type1, EDSv4-Type2, EDSv5-Type1, ESv3-Type1, ESv3-Type2, ESv3-Type3, ESv3-Type4, ESv4-Type1, ESv4-Type2, ESv5-Type1, FSv2-Type2, FSv2-Type3, FSv2-Type4, FXmds-Type1, LSv2-Type1, LSv3-Type1, MDMSv2MedMem-Type1, MDSv2MedMem-Type1, MMSv2MedMem-Type1, MS-Type1, MSm-Type1, MSmv2-Type1, MSv2-Type1, MSv2MedMem-Type1, NVASv4-Type1 and NVSv3-Type1. Changing this forces a new resource to be created."', args=[d.arg(name='skuName', type=d.T.string)]),
    ...
    initProvider: {
      '#withAutoReplaceOnFailure':: d.fn(help='"Should the Dedicated Host automatically be replaced in case of a Hardware Failure? Defaults to true."', args=[d.arg(name='autoReplaceOnFailure', type=d.T.boolean)]),
      withAutoReplaceOnFailure(autoReplaceOnFailure): { spec+: { initProvider+: { autoReplaceOnFailure: autoReplaceOnFailure } } },
      '#withLicenseType':: d.fn(help='"Specifies the software license type that will be applied to the VMs deployed on the Dedicated Host. Possible values are None, Windows_Server_Hybrid and Windows_Server_Perpetual. Defaults to None."', args=[d.arg(name='licenseType', type=d.T.string)]),
