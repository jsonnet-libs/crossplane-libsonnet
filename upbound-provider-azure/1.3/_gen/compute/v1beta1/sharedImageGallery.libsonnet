{
  ...
  '#':: d.pkg(name='sharedImageGallery', url='', help='"SharedImageGallery is the Schema for the SharedImageGallerys API. Manages a Shared Image Gallery."'),
  ...
  '#new':: d.fn(help='new returns an instance of SharedImageGallery', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SharedImageGallerySpec defines the desired state of SharedImageGallery"'),
  spec: {
    ...
    forProvider: {
      ...
      '#sharing':: d.obj(help='"A sharing block as defined below. Changing this forces a new resource to be created."'),
      sharing: {
        '#communityGallery':: d.obj(help='"A community_gallery block as defined below. Changing this forces a new resource to be created."'),
        communityGallery: {
          '#withEula':: d.fn(help='"The End User Licence Agreement for the Shared Image Gallery. Changing this forces a new resource to be created."', args=[d.arg(name='eula', type=d.T.string)]),
          withEula(eula): { eula: eula },
          '#withPrefix':: d.fn(help='"Prefix of the community public name for the Shared Image Gallery. Changing this forces a new resource to be created."', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { prefix: prefix },
          '#withPublisherEmail':: d.fn(help='"Email of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created."', args=[d.arg(name='publisherEmail', type=d.T.string)]),
          withPublisherEmail(publisherEmail): { publisherEmail: publisherEmail },
          '#withPublisherUri':: d.fn(help='"URI of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created."', args=[d.arg(name='publisherUri', type=d.T.string)]),
          withPublisherUri(publisherUri): { publisherUri: publisherUri },
        },
        '#withCommunityGallery':: d.fn(help='"A community_gallery block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='communityGallery', type=d.T.array)]),
        withCommunityGallery(communityGallery): { communityGallery: if std.isArray(v=communityGallery) then communityGallery else [communityGallery] },
        '#withCommunityGalleryMixin':: d.fn(help='"A community_gallery block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='communityGallery', type=d.T.array)]),
        withCommunityGalleryMixin(communityGallery): { communityGallery+: if std.isArray(v=communityGallery) then communityGallery else [communityGallery] },
        '#withPermission':: d.fn(help='"The permission of the Shared Image Gallery when sharing. Possible values are Community, Groups and Private. Changing this forces a new resource to be created."', args=[d.arg(name='permission', type=d.T.string)]),
        withPermission(permission): { permission: permission },
      },
      '#withDescription':: d.fn(help='"A description for this Shared Image Gallery."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Shared Image Gallery. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSharing':: d.fn(help='"A sharing block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='sharing', type=d.T.array)]),
      withSharing(sharing): { spec+: { forProvider+: { sharing: if std.isArray(v=sharing) then sharing else [sharing] } } },
      '#withSharingMixin':: d.fn(help='"A sharing block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sharing', type=d.T.array)]),
      withSharingMixin(sharing): { spec+: { forProvider+: { sharing+: if std.isArray(v=sharing) then sharing else [sharing] } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Shared Image Gallery."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Shared Image Gallery."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
