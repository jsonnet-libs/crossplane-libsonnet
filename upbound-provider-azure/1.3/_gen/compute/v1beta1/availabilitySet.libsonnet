{
  ...
  '#':: d.pkg(name='availabilitySet', url='', help='"AvailabilitySet is the Schema for the AvailabilitySets API. Manages an Availability Set for Virtual Machines."'),
  ...
  '#new':: d.fn(help='new returns an instance of AvailabilitySet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AvailabilitySetSpec defines the desired state of AvailabilitySet"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withManaged':: d.fn(help='"Specifies whether the availability set is managed or not. Possible values are true (to specify aligned) or false (to specify classic). Default is true. Changing this forces a new resource to be created."', args=[d.arg(name='managed', type=d.T.boolean)]),
      withManaged(managed): { spec+: { forProvider+: { managed: managed } } },
      '#withPlatformFaultDomainCount':: d.fn(help='"Specifies the number of fault domains that are used. Defaults to 3. Changing this forces a new resource to be created."', args=[d.arg(name='platformFaultDomainCount', type=d.T.number)]),
      withPlatformFaultDomainCount(platformFaultDomainCount): { spec+: { forProvider+: { platformFaultDomainCount: platformFaultDomainCount } } },
      '#withPlatformUpdateDomainCount':: d.fn(help='"Specifies the number of update domains that are used. Defaults to 5. Changing this forces a new resource to be created."', args=[d.arg(name='platformUpdateDomainCount', type=d.T.number)]),
      withPlatformUpdateDomainCount(platformUpdateDomainCount): { spec+: { forProvider+: { platformUpdateDomainCount: platformUpdateDomainCount } } },
      '#withProximityPlacementGroupId':: d.fn(help='"The ID of the Proximity Placement Group to which this Virtual Machine should be assigned. Changing this forces a new resource to be created."', args=[d.arg(name='proximityPlacementGroupId', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the availability set. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withManaged':: d.fn(help='"Specifies whether the availability set is managed or not. Possible values are true (to specify aligned) or false (to specify classic). Default is true. Changing this forces a new resource to be created."', args=[d.arg(name='managed', type=d.T.boolean)]),
      withManaged(managed): { spec+: { initProvider+: { managed: managed } } },
      '#withPlatformFaultDomainCount':: d.fn(help='"Specifies the number of fault domains that are used. Defaults to 3. Changing this forces a new resource to be created."', args=[d.arg(name='platformFaultDomainCount', type=d.T.number)]),
      ...
      '#withPlatformUpdateDomainCount':: d.fn(help='"Specifies the number of update domains that are used. Defaults to 5. Changing this forces a new resource to be created."', args=[d.arg(name='platformUpdateDomainCount', type=d.T.number)]),
      withPlatformUpdateDomainCount(platformUpdateDomainCount): { spec+: { initProvider+: { platformUpdateDomainCount: platformUpdateDomainCount } } },
      '#withProximityPlacementGroupId':: d.fn(help='"The ID of the Proximity Placement Group to which this Virtual Machine should be assigned. Changing this forces a new resource to be created."', args=[d.arg(name='proximityPlacementGroupId', type=d.T.string)]),
