{
  ...
  '#':: d.pkg(name='capacityReservation', url='', help='"CapacityReservation is the Schema for the CapacityReservations API. Manages a Capacity Reservation within a Capacity Reservation Group."'),
  ...
  spec: {
    ...
    forProvider: {
      '#capacityReservationGroupIdRef':: d.obj(help='"Reference to a CapacityReservationGroup in compute to populate capacityReservationGroupId."'),
      capacityReservationGroupIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { capacityReservationGroupIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { capacityReservationGroupIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { capacityReservationGroupIdRef+: { name: name } } } },
      },
      '#capacityReservationGroupIdSelector':: d.obj(help='"Selector for a CapacityReservationGroup in compute to populate capacityReservationGroupId."'),
      capacityReservationGroupIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { capacityReservationGroupIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { capacityReservationGroupIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { capacityReservationGroupIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { capacityReservationGroupIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { capacityReservationGroupIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#sku':: d.obj(help='"A sku block as defined below."'),
      sku: {
        '#withCapacity':: d.fn(help='"Specifies the number of instances to be reserved. It must be a positive integer and not exceed the quota in the subscription."', args=[d.arg(name='capacity', type=d.T.number)]),
        withCapacity(capacity): { capacity: capacity },
        '#withName':: d.fn(help='"Name of the sku, such as Standard_F2. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#withCapacityReservationGroupId':: d.fn(help='"The ID of the Capacity Reservation Group where the Capacity Reservation exists. Changing this forces a new resource to be created."', args=[d.arg(name='capacityReservationGroupId', type=d.T.string)]),
      ...
      '#withZone':: d.fn(help='"Specifies the Availability Zone for this Capacity Reservation. Changing this forces a new resource to be created."', args=[d.arg(name='zone', type=d.T.string)]),
