  ...
  spec: {
    ...
    forProvider: {
      ...
      snapshotSchedule: {
        ...
        withName(name): { spec+: { forProvider+: { snapshotSchedule+: { name: name } } } },
        ...
        withRecurrence(recurrence): { spec+: { forProvider+: { snapshotSchedule+: { recurrence: recurrence } } } },
        '#withStartTime':: d.fn(help="\"The synchronization with the source data's start time.\"", args=[d.arg(name='startTime', type=d.T.string)]),
        withStartTime(startTime): { spec+: { forProvider+: { snapshotSchedule+: { startTime: startTime } } } },
      },
    ...
    initProvider: {
      ...
      snapshotSchedule: {
        '#withName':: d.fn(help='"The name of the snapshot schedule."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { snapshotSchedule+: { name: name } } } },
        '#withRecurrence':: d.fn(help='"The interval of the synchronization with the source data. Possible values are Hour and Day."', args=[d.arg(name='recurrence', type=d.T.string)]),
        withRecurrence(recurrence): { spec+: { initProvider+: { snapshotSchedule+: { recurrence: recurrence } } } },
        '#withStartTime':: d.fn(help="\"The synchronization with the source data's start time.\"", args=[d.arg(name='startTime', type=d.T.string)]),
        withStartTime(startTime): { spec+: { initProvider+: { snapshotSchedule+: { startTime: startTime } } } },
      },
      '#withDescription':: d.fn(help="\"The Data Share's description.\"", args=[d.arg(name='description', type=d.T.string)]),
