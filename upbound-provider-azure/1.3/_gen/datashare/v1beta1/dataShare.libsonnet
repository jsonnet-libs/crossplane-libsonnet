{
  ...
  '#':: d.pkg(name='dataShare', url='', help='"DataShare is the Schema for the DataShares API. Manages a Data Share."'),
  ...
  '#new':: d.fn(help='new returns an instance of DataShare', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DataShareSpec defines the desired state of DataShare"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#accountIdRef':: d.obj(help='"Reference to a Account in datashare to populate accountId."'),
      accountIdRef: {
      ...
      '#accountIdSelector':: d.obj(help='"Selector for a Account in datashare to populate accountId."'),
      accountIdSelector: {
      ...
      '#snapshotSchedule':: d.obj(help='"A snapshot_schedule block as defined below."'),
      snapshotSchedule: {
        '#withName':: d.fn(help='"The name of the snapshot schedule."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRecurrence':: d.fn(help='"The interval of the synchronization with the source data. Possible values are Hour and Day."', args=[d.arg(name='recurrence', type=d.T.string)]),
        withRecurrence(recurrence): { recurrence: recurrence },
        '#withStartTime':: d.fn(help="\"The synchronization with the source data's start time.\"", args=[d.arg(name='startTime', type=d.T.string)]),
        withStartTime(startTime): { startTime: startTime },
      },
      '#withAccountId':: d.fn(help='"The ID of the Data Share account in which the Data Share is created. Changing this forces a new Data Share to be created."', args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withDescription':: d.fn(help="\"The Data Share's description.\"", args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withKind':: d.fn(help='"The kind of the Data Share. Possible values are CopyBased and InPlace. Changing this forces a new Data Share to be created."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { forProvider+: { kind: kind } } },
      '#withSnapshotSchedule':: d.fn(help='"A snapshot_schedule block as defined below."', args=[d.arg(name='snapshotSchedule', type=d.T.array)]),
      withSnapshotSchedule(snapshotSchedule): { spec+: { forProvider+: { snapshotSchedule: if std.isArray(v=snapshotSchedule) then snapshotSchedule else [snapshotSchedule] } } },
      '#withSnapshotScheduleMixin':: d.fn(help='"A snapshot_schedule block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='snapshotSchedule', type=d.T.array)]),
      withSnapshotScheduleMixin(snapshotSchedule): { spec+: { forProvider+: { snapshotSchedule+: if std.isArray(v=snapshotSchedule) then snapshotSchedule else [snapshotSchedule] } } },
      '#withTerms':: d.fn(help='"The terms of the Data Share."', args=[d.arg(name='terms', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSnapshotSchedule':: d.fn(help='"A snapshot_schedule block as defined below."', args=[d.arg(name='snapshotSchedule', type=d.T.array)]),
      withSnapshotSchedule(snapshotSchedule): { spec+: { initProvider+: { snapshotSchedule: if std.isArray(v=snapshotSchedule) then snapshotSchedule else [snapshotSchedule] } } },
      '#withSnapshotScheduleMixin':: d.fn(help='"A snapshot_schedule block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='snapshotSchedule', type=d.T.array)]),
      withSnapshotScheduleMixin(snapshotSchedule): { spec+: { initProvider+: { snapshotSchedule+: if std.isArray(v=snapshotSchedule) then snapshotSchedule else [snapshotSchedule] } } },
      '#withTerms':: d.fn(help='"The terms of the Data Share."', args=[d.arg(name='terms', type=d.T.string)]),
