{
  ...
  '#':: d.pkg(name='ledger', url='', help='"Ledger is the Schema for the Ledgers API. Manages a Confidential Ledger."'),
  ...
  spec: {
    ...
    forProvider: {
      '#azureadBasedServicePrincipal':: d.obj(help='"A list of azuread_based_service_principal blocks as defined below."'),
      azureadBasedServicePrincipal: {
        '#withLedgerRoleName':: d.fn(help='"Specifies the Ledger Role to grant this AzureAD Service Principal. Possible values are Administrator, Contributor and Reader."', args=[d.arg(name='ledgerRoleName', type=d.T.string)]),
        withLedgerRoleName(ledgerRoleName): { ledgerRoleName: ledgerRoleName },
        '#withPrincipalId':: d.fn(help='"Specifies the Principal ID of the AzureAD Service Principal."', args=[d.arg(name='principalId', type=d.T.string)]),
        withPrincipalId(principalId): { principalId: principalId },
        '#withTenantId':: d.fn(help='"Specifies the Tenant ID for this AzureAD Service Principal."', args=[d.arg(name='tenantId', type=d.T.string)]),
        withTenantId(tenantId): { tenantId: tenantId },
      },
      '#certificateBasedSecurityPrincipal':: d.obj(help='"A list of certificate_based_security_principal blocks as defined below."'),
      certificateBasedSecurityPrincipal: {
        '#withLedgerRoleName':: d.fn(help='"Specifies the Ledger Role to grant this Certificate Security Principal. Possible values are Administrator, Contributor and Reader."', args=[d.arg(name='ledgerRoleName', type=d.T.string)]),
        withLedgerRoleName(ledgerRoleName): { ledgerRoleName: ledgerRoleName },
        '#withPemPublicKey':: d.fn(help='"The public key, in PEM format, of the certificate used by this identity to authenticate with the Confidential Ledger."', args=[d.arg(name='pemPublicKey', type=d.T.string)]),
        withPemPublicKey(pemPublicKey): { pemPublicKey: pemPublicKey },
      },
      ...
      '#withAzureadBasedServicePrincipal':: d.fn(help='"A list of azuread_based_service_principal blocks as defined below."', args=[d.arg(name='azureadBasedServicePrincipal', type=d.T.array)]),
      withAzureadBasedServicePrincipal(azureadBasedServicePrincipal): { spec+: { forProvider+: { azureadBasedServicePrincipal: if std.isArray(v=azureadBasedServicePrincipal) then azureadBasedServicePrincipal else [azureadBasedServicePrincipal] } } },
      '#withAzureadBasedServicePrincipalMixin':: d.fn(help='"A list of azuread_based_service_principal blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='azureadBasedServicePrincipal', type=d.T.array)]),
      withAzureadBasedServicePrincipalMixin(azureadBasedServicePrincipal): { spec+: { forProvider+: { azureadBasedServicePrincipal+: if std.isArray(v=azureadBasedServicePrincipal) then azureadBasedServicePrincipal else [azureadBasedServicePrincipal] } } },
      '#withCertificateBasedSecurityPrincipal':: d.fn(help='"A list of certificate_based_security_principal blocks as defined below."', args=[d.arg(name='certificateBasedSecurityPrincipal', type=d.T.array)]),
      withCertificateBasedSecurityPrincipal(certificateBasedSecurityPrincipal): { spec+: { forProvider+: { certificateBasedSecurityPrincipal: if std.isArray(v=certificateBasedSecurityPrincipal) then certificateBasedSecurityPrincipal else [certificateBasedSecurityPrincipal] } } },
      '#withCertificateBasedSecurityPrincipalMixin':: d.fn(help='"A list of certificate_based_security_principal blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='certificateBasedSecurityPrincipal', type=d.T.array)]),
      withCertificateBasedSecurityPrincipalMixin(certificateBasedSecurityPrincipal): { spec+: { forProvider+: { certificateBasedSecurityPrincipal+: if std.isArray(v=certificateBasedSecurityPrincipal) then certificateBasedSecurityPrincipal else [certificateBasedSecurityPrincipal] } } },
      '#withLedgerType':: d.fn(help='"Specifies the type of Confidential Ledger. Possible values are Private and Public. Changing this forces a new resource to be created."', args=[d.arg(name='ledgerType', type=d.T.string)]),
      withLedgerType(ledgerType): { spec+: { forProvider+: { ledgerType: ledgerType } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Confidential Ledger exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Confidential Ledger exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Confidential Ledger."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Confidential Ledger."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withAzureadBasedServicePrincipal':: d.fn(help='"A list of azuread_based_service_principal blocks as defined below."', args=[d.arg(name='azureadBasedServicePrincipal', type=d.T.array)]),
      withAzureadBasedServicePrincipal(azureadBasedServicePrincipal): { spec+: { initProvider+: { azureadBasedServicePrincipal: if std.isArray(v=azureadBasedServicePrincipal) then azureadBasedServicePrincipal else [azureadBasedServicePrincipal] } } },
      '#withAzureadBasedServicePrincipalMixin':: d.fn(help='"A list of azuread_based_service_principal blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='azureadBasedServicePrincipal', type=d.T.array)]),
      withAzureadBasedServicePrincipalMixin(azureadBasedServicePrincipal): { spec+: { initProvider+: { azureadBasedServicePrincipal+: if std.isArray(v=azureadBasedServicePrincipal) then azureadBasedServicePrincipal else [azureadBasedServicePrincipal] } } },
      '#withCertificateBasedSecurityPrincipal':: d.fn(help='"A list of certificate_based_security_principal blocks as defined below."', args=[d.arg(name='certificateBasedSecurityPrincipal', type=d.T.array)]),
      withCertificateBasedSecurityPrincipal(certificateBasedSecurityPrincipal): { spec+: { initProvider+: { certificateBasedSecurityPrincipal: if std.isArray(v=certificateBasedSecurityPrincipal) then certificateBasedSecurityPrincipal else [certificateBasedSecurityPrincipal] } } },
      '#withCertificateBasedSecurityPrincipalMixin':: d.fn(help='"A list of certificate_based_security_principal blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='certificateBasedSecurityPrincipal', type=d.T.array)]),
      withCertificateBasedSecurityPrincipalMixin(certificateBasedSecurityPrincipal): { spec+: { initProvider+: { certificateBasedSecurityPrincipal+: if std.isArray(v=certificateBasedSecurityPrincipal) then certificateBasedSecurityPrincipal else [certificateBasedSecurityPrincipal] } } },
      '#withLedgerType':: d.fn(help='"Specifies the type of Confidential Ledger. Possible values are Private and Public. Changing this forces a new resource to be created."', args=[d.arg(name='ledgerType', type=d.T.string)]),
      withLedgerType(ledgerType): { spec+: { initProvider+: { ledgerType: ledgerType } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the Confidential Ledger exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
