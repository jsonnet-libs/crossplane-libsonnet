{
  ...
  '#':: d.pkg(name='managementGroupSubscriptionAssociation', url='', help='"ManagementGroupSubscriptionAssociation is the Schema for the ManagementGroupSubscriptionAssociations API. Manages a Management Group Subscription Association."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagementGroupSubscriptionAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagementGroupSubscriptionAssociationSpec defines the desired state of ManagementGroupSubscriptionAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withManagementGroupId':: d.fn(help='"The ID of the Management Group to associate the Subscription with. Changing this forces a new Management to be created."', args=[d.arg(name='managementGroupId', type=d.T.string)]),
      withManagementGroupId(managementGroupId): { spec+: { forProvider+: { managementGroupId: managementGroupId } } },
      '#withSubscriptionId':: d.fn(help='"The ID of the Subscription to be associated with the Management Group. Changing this forces a new Management to be created."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
