{
  ...
  '#':: d.pkg(name='managementGroup', url='', help='"ManagementGroup is the Schema for the ManagementGroups API. Manages a Management Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagementGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagementGroupSpec defines the desired state of ManagementGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#parentManagementGroupIdRef':: d.obj(help='"Reference to a ManagementGroup in management to populate parentManagementGroupId."'),
      parentManagementGroupIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { parentManagementGroupIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { parentManagementGroupIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { parentManagementGroupIdRef+: { name: name } } } },
      },
      '#parentManagementGroupIdSelector':: d.obj(help='"Selector for a ManagementGroup in management to populate parentManagementGroupId."'),
      parentManagementGroupIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { parentManagementGroupIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { parentManagementGroupIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { parentManagementGroupIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { parentManagementGroupIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { parentManagementGroupIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withDisplayName':: d.fn(help='"A friendly name for this Management Group. If not specified, this will be the same as the name."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withParentManagementGroupId':: d.fn(help='"The ID of the Parent Management Group."', args=[d.arg(name='parentManagementGroupId', type=d.T.string)]),
      withParentManagementGroupId(parentManagementGroupId): { spec+: { forProvider+: { parentManagementGroupId: parentManagementGroupId } } },
      '#withSubscriptionIds':: d.fn(help='"A list of Subscription GUIDs which should be assigned to the Management Group."', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
      withSubscriptionIds(subscriptionIds): { spec+: { forProvider+: { subscriptionIds: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } },
      '#withSubscriptionIdsMixin':: d.fn(help='"A list of Subscription GUIDs which should be assigned to the Management Group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
      withSubscriptionIdsMixin(subscriptionIds): { spec+: { forProvider+: { subscriptionIds+: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } },
    },
    ...
    initProvider: {
      ...
      parentManagementGroupIdRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { parentManagementGroupIdRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { parentManagementGroupIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { parentManagementGroupIdRef+: { name: name } } } },
      },
      '#parentManagementGroupIdSelector':: d.obj(help='"Selector for a ManagementGroup in management to populate parentManagementGroupId."'),
      parentManagementGroupIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { parentManagementGroupIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { parentManagementGroupIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { parentManagementGroupIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { parentManagementGroupIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { parentManagementGroupIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withDisplayName':: d.fn(help='"A friendly name for this Management Group. If not specified, this will be the same as the name."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { initProvider+: { displayName: displayName } } },
      '#withParentManagementGroupId':: d.fn(help='"The ID of the Parent Management Group."', args=[d.arg(name='parentManagementGroupId', type=d.T.string)]),
      withParentManagementGroupId(parentManagementGroupId): { spec+: { initProvider+: { parentManagementGroupId: parentManagementGroupId } } },
      '#withSubscriptionIds':: d.fn(help='"A list of Subscription GUIDs which should be assigned to the Management Group."', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
      withSubscriptionIds(subscriptionIds): { spec+: { initProvider+: { subscriptionIds: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } },
      '#withSubscriptionIdsMixin':: d.fn(help='"A list of Subscription GUIDs which should be assigned to the Management Group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subscriptionIds', type=d.T.array)]),
      withSubscriptionIdsMixin(subscriptionIds): { spec+: { initProvider+: { subscriptionIds+: if std.isArray(v=subscriptionIds) then subscriptionIds else [subscriptionIds] } } },
    },
