{
  ...
  '#':: d.pkg(name='securityCenterSetting', url='', help='"SecurityCenterSetting is the Schema for the SecurityCenterSettings API. Manages the Data Access Settings for Azure Security Center."'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityCenterSetting', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityCenterSettingSpec defines the desired state of SecurityCenterSetting"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withEnabled':: d.fn(help='"Boolean flag to enable/disable data access."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withSettingName':: d.fn(help='"The setting to manage. Possible values are MCAS , WDATP, WDATP_EXCLUDE_LINUX_PUBLIC_PREVIEW, WDATP_UNIFIED_SOLUTION and Sentinel. Changing this forces a new resource to be created."', args=[d.arg(name='settingName', type=d.T.string)]),
      withSettingName(settingName): { spec+: { forProvider+: { settingName: settingName } } },
    },
    ...
    initProvider: {
      ...
      '#withSettingName':: d.fn(help='"The setting to manage. Possible values are MCAS , WDATP, WDATP_EXCLUDE_LINUX_PUBLIC_PREVIEW, WDATP_UNIFIED_SOLUTION and Sentinel. Changing this forces a new resource to be created."', args=[d.arg(name='settingName', type=d.T.string)]),
      withSettingName(settingName): { spec+: { initProvider+: { settingName: settingName } } },
    },
