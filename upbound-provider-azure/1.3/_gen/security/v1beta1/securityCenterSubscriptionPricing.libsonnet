{
  ...
  '#':: d.pkg(name='securityCenterSubscriptionPricing', url='', help='"SecurityCenterSubscriptionPricing is the Schema for the SecurityCenterSubscriptionPricings API. Manages the Pricing Tier for Azure Security Center in the current subscription."'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityCenterSubscriptionPricing', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityCenterSubscriptionPricingSpec defines the desired state of SecurityCenterSubscriptionPricing"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#extension':: d.obj(help='"One or more extension blocks as defined below."'),
      extension: {
        '#withAdditionalExtensionProperties':: d.fn(help='"Key/Value pairs that are required for some extensions."', args=[d.arg(name='additionalExtensionProperties', type=d.T.object)]),
        withAdditionalExtensionProperties(additionalExtensionProperties): { additionalExtensionProperties: additionalExtensionProperties },
        '#withAdditionalExtensionPropertiesMixin':: d.fn(help='"Key/Value pairs that are required for some extensions."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalExtensionProperties', type=d.T.object)]),
        withAdditionalExtensionPropertiesMixin(additionalExtensionProperties): { additionalExtensionProperties+: additionalExtensionProperties },
        '#withName':: d.fn(help='"The name of extension."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withResourceType':: d.fn(help='"The resource type this setting affects. Possible values are Api, AppServices, ContainerRegistry, KeyVaults, KubernetesService, SqlServers, SqlServerVirtualMachines, StorageAccounts, VirtualMachines, Arm, Dns, OpenSourceRelationalDatabases, Containers, CosmosDbs and CloudPosture. Defaults to VirtualMachines"', args=[d.arg(name='resourceType', type=d.T.string)]),
      withResourceType(resourceType): { spec+: { forProvider+: { resourceType: resourceType } } },
      '#withSubplan':: d.fn(help='"Resource type pricing subplan. Contact your MSFT representative for possible values."', args=[d.arg(name='subplan', type=d.T.string)]),
      withSubplan(subplan): { spec+: { forProvider+: { subplan: subplan } } },
      '#withTier':: d.fn(help='"The pricing tier to use. Possible values are Free and Standard."', args=[d.arg(name='tier', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSubplan':: d.fn(help='"Resource type pricing subplan. Contact your MSFT representative for possible values."', args=[d.arg(name='subplan', type=d.T.string)]),
      withSubplan(subplan): { spec+: { initProvider+: { subplan: subplan } } },
      '#withTier':: d.fn(help='"The pricing tier to use. Possible values are Free and Standard."', args=[d.arg(name='tier', type=d.T.string)]),
