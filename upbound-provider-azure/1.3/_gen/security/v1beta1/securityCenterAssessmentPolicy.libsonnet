{
  ...
  '#':: d.pkg(name='securityCenterAssessmentPolicy', url='', help='"SecurityCenterAssessmentPolicy is the Schema for the SecurityCenterAssessmentPolicys API. Manages the Security Center Assessment Metadata for Azure Security Center."'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityCenterAssessmentPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityCenterAssessmentPolicySpec defines the desired state of SecurityCenterAssessmentPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCategories':: d.fn(help='"A list of the categories of resource that is at risk when the Security Center Assessment is unhealthy. Possible values are Unknown, Compute, Data, IdentityAndAccess, IoT and Networking."', args=[d.arg(name='categories', type=d.T.array)]),
      withCategories(categories): { spec+: { forProvider+: { categories: if std.isArray(v=categories) then categories else [categories] } } },
      '#withCategoriesMixin':: d.fn(help='"A list of the categories of resource that is at risk when the Security Center Assessment is unhealthy. Possible values are Unknown, Compute, Data, IdentityAndAccess, IoT and Networking."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='categories', type=d.T.array)]),
      withCategoriesMixin(categories): { spec+: { forProvider+: { categories+: if std.isArray(v=categories) then categories else [categories] } } },
      '#withDescription':: d.fn(help='"The description of the Security Center Assessment."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The user-friendly display name of the Security Center Assessment."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withImplementationEffort':: d.fn(help='"The implementation effort which is used to remediate the Security Center Assessment. Possible values are Low, Moderate and High."', args=[d.arg(name='implementationEffort', type=d.T.string)]),
      withImplementationEffort(implementationEffort): { spec+: { forProvider+: { implementationEffort: implementationEffort } } },
      '#withRemediationDescription':: d.fn(help='"The description which is used to mitigate the security issue."', args=[d.arg(name='remediationDescription', type=d.T.string)]),
      withRemediationDescription(remediationDescription): { spec+: { forProvider+: { remediationDescription: remediationDescription } } },
      '#withSeverity':: d.fn(help='"The severity level of the Security Center Assessment. Possible values are Low, Medium and High. Defaults to Medium."', args=[d.arg(name='severity', type=d.T.string)]),
      withSeverity(severity): { spec+: { forProvider+: { severity: severity } } },
      '#withThreats':: d.fn(help='"A list of the threat impacts for the Security Center Assessment. Possible values are AccountBreach, DataExfiltration, DataSpillage, DenialOfService, ElevationOfPrivilege, MaliciousInsider, MissingCoverage and ThreatResistance."', args=[d.arg(name='threats', type=d.T.array)]),
      withThreats(threats): { spec+: { forProvider+: { threats: if std.isArray(v=threats) then threats else [threats] } } },
      '#withThreatsMixin':: d.fn(help='"A list of the threat impacts for the Security Center Assessment. Possible values are AccountBreach, DataExfiltration, DataSpillage, DenialOfService, ElevationOfPrivilege, MaliciousInsider, MissingCoverage and ThreatResistance."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='threats', type=d.T.array)]),
      withThreatsMixin(threats): { spec+: { forProvider+: { threats+: if std.isArray(v=threats) then threats else [threats] } } },
      '#withUserImpact':: d.fn(help='"The user impact of the Security Center Assessment. Possible values are Low, Moderate and High."', args=[d.arg(name='userImpact', type=d.T.string)]),
      withUserImpact(userImpact): { spec+: { forProvider+: { userImpact: userImpact } } },
    },
    ...
    initProvider: {
      ...
      '#withImplementationEffort':: d.fn(help='"The implementation effort which is used to remediate the Security Center Assessment. Possible values are Low, Moderate and High."', args=[d.arg(name='implementationEffort', type=d.T.string)]),
      withImplementationEffort(implementationEffort): { spec+: { initProvider+: { implementationEffort: implementationEffort } } },
      '#withRemediationDescription':: d.fn(help='"The description which is used to mitigate the security issue."', args=[d.arg(name='remediationDescription', type=d.T.string)]),
      withRemediationDescription(remediationDescription): { spec+: { initProvider+: { remediationDescription: remediationDescription } } },
      '#withSeverity':: d.fn(help='"The severity level of the Security Center Assessment. Possible values are Low, Medium and High. Defaults to Medium."', args=[d.arg(name='severity', type=d.T.string)]),
      withSeverity(severity): { spec+: { initProvider+: { severity: severity } } },
      '#withThreats':: d.fn(help='"A list of the threat impacts for the Security Center Assessment. Possible values are AccountBreach, DataExfiltration, DataSpillage, DenialOfService, ElevationOfPrivilege, MaliciousInsider, MissingCoverage and ThreatResistance."', args=[d.arg(name='threats', type=d.T.array)]),
      withThreats(threats): { spec+: { initProvider+: { threats: if std.isArray(v=threats) then threats else [threats] } } },
      '#withThreatsMixin':: d.fn(help='"A list of the threat impacts for the Security Center Assessment. Possible values are AccountBreach, DataExfiltration, DataSpillage, DenialOfService, ElevationOfPrivilege, MaliciousInsider, MissingCoverage and ThreatResistance."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='threats', type=d.T.array)]),
      withThreatsMixin(threats): { spec+: { initProvider+: { threats+: if std.isArray(v=threats) then threats else [threats] } } },
      '#withUserImpact':: d.fn(help='"The user impact of the Security Center Assessment. Possible values are Low, Moderate and High."', args=[d.arg(name='userImpact', type=d.T.string)]),
      withUserImpact(userImpact): { spec+: { initProvider+: { userImpact: userImpact } } },
    },
