{
  ...
  '#':: d.pkg(name='securityCenterWorkspace', url='', help="\"SecurityCenterWorkspace is the Schema for the SecurityCenterWorkspaces API. Manages the subscription's Security Center Workspace.\""),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityCenterWorkspace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityCenterWorkspaceSpec defines the desired state of SecurityCenterWorkspace"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withScope':: d.fn(help='"The scope of VMs to send their security data to the desired workspace, unless overridden by a setting with more specific scope."', args=[d.arg(name='scope', type=d.T.string)]),
      withScope(scope): { spec+: { forProvider+: { scope: scope } } },
      '#withWorkspaceId':: d.fn(help='"The ID of the Log Analytics Workspace to save the data in."', args=[d.arg(name='workspaceId', type=d.T.string)]),
