{
  ...
  '#':: d.pkg(name='advancedThreatProtection', url='', help='"AdvancedThreatProtection is the Schema for the AdvancedThreatProtections API. Manages a resources Advanced Threat Protection setting."'),
  ...
  '#new':: d.fn(help='new returns an instance of AdvancedThreatProtection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AdvancedThreatProtectionSpec defines the desired state of AdvancedThreatProtection"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withEnabled':: d.fn(help='"Should Advanced Threat Protection be enabled on this resource?"', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withTargetResourceId':: d.fn(help='"The ID of the Azure Resource which to enable Advanced Threat Protection on. Changing this forces a new resource to be created."', args=[d.arg(name='targetResourceId', type=d.T.string)]),
