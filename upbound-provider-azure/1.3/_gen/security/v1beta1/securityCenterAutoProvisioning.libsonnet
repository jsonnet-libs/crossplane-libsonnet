{
  ...
  '#':: d.pkg(name='securityCenterAutoProvisioning', url='', help="\"SecurityCenterAutoProvisioning is the Schema for the SecurityCenterAutoProvisionings API. Manages the subscription's Security Center Auto Provisioning.\""),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityCenterAutoProvisioning', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityCenterAutoProvisioningSpec defines the desired state of SecurityCenterAutoProvisioning"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAutoProvision':: d.fn(help="\"Should the security agent be automatically provisioned on Virtual Machines in this subscription? Possible values are On (to install the security agent automatically, if it's missing) or Off (to not install the security agent automatically).\"", args=[d.arg(name='autoProvision', type=d.T.string)]),
      withAutoProvision(autoProvision): { spec+: { forProvider+: { autoProvision: autoProvision } } },
    },
    ...
    initProvider: {
      '#withAutoProvision':: d.fn(help="\"Should the security agent be automatically provisioned on Virtual Machines in this subscription? Possible values are On (to install the security agent automatically, if it's missing) or Off (to not install the security agent automatically).\"", args=[d.arg(name='autoProvision', type=d.T.string)]),
      withAutoProvision(autoProvision): { spec+: { initProvider+: { autoProvision: autoProvision } } },
    },
