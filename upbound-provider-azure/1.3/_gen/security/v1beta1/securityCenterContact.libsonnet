{
  ...
  '#':: d.pkg(name='securityCenterContact', url='', help="\"SecurityCenterContact is the Schema for the SecurityCenterContacts API. Manages the subscription's Security Center Contact.\""),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityCenterContact', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecurityCenterContactSpec defines the desired state of SecurityCenterContact"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAlertNotifications':: d.fn(help='"Whether to send security alerts notifications to the security contact."', args=[d.arg(name='alertNotifications', type=d.T.boolean)]),
      withAlertNotifications(alertNotifications): { spec+: { forProvider+: { alertNotifications: alertNotifications } } },
      '#withAlertsToAdmins':: d.fn(help='"Whether to send security alerts notifications to subscription admins."', args=[d.arg(name='alertsToAdmins', type=d.T.boolean)]),
      withAlertsToAdmins(alertsToAdmins): { spec+: { forProvider+: { alertsToAdmins: alertsToAdmins } } },
      '#withEmail':: d.fn(help='"The email of the Security Center Contact."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withName':: d.fn(help='"The name of the Security Center Contact. Defaults to default1."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPhone':: d.fn(help='"The phone number of the Security Center Contact."', args=[d.arg(name='phone', type=d.T.string)]),
      withPhone(phone): { spec+: { forProvider+: { phone: phone } } },
    },
    ...
    initProvider: {
      '#withAlertNotifications':: d.fn(help='"Whether to send security alerts notifications to the security contact."', args=[d.arg(name='alertNotifications', type=d.T.boolean)]),
      withAlertNotifications(alertNotifications): { spec+: { initProvider+: { alertNotifications: alertNotifications } } },
      '#withAlertsToAdmins':: d.fn(help='"Whether to send security alerts notifications to subscription admins."', args=[d.arg(name='alertsToAdmins', type=d.T.boolean)]),
      withAlertsToAdmins(alertsToAdmins): { spec+: { initProvider+: { alertsToAdmins: alertsToAdmins } } },
      '#withEmail':: d.fn(help='"The email of the Security Center Contact."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { initProvider+: { email: email } } },
      '#withName':: d.fn(help='"The name of the Security Center Contact. Defaults to default1."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withPhone':: d.fn(help='"The phone number of the Security Center Contact."', args=[d.arg(name='phone', type=d.T.string)]),
      withPhone(phone): { spec+: { initProvider+: { phone: phone } } },
    },
