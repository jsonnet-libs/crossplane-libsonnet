{
  ...
  '#':: d.pkg(name='botChannelWebChat', url='', help='"BotChannelWebChat is the Schema for the BotChannelWebChats API. Manages a Web Chat integration for a Bot Channel"'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelWebChat', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotChannelWebChatSpec defines the desired state of BotChannelWebChat"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group where the Web Chat Channel should be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withSiteNames':: d.fn(help='"Deprecated: siteNames will be removed in favour of the site code block."', args=[d.arg(name='siteNames', type=d.T.array)]),
      withSiteNames(siteNames): { spec+: { forProvider+: { siteNames: if std.isArray(v=siteNames) then siteNames else [siteNames] } } },
      '#withSiteNamesMixin':: d.fn(help='"Deprecated: siteNames will be removed in favour of the site code block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='siteNames', type=d.T.array)]),
      withSiteNamesMixin(siteNames): { spec+: { forProvider+: { siteNames+: if std.isArray(v=siteNames) then siteNames else [siteNames] } } },
    },
    ...
    initProvider: {
      ...
      '#withSiteNames':: d.fn(help='"Deprecated: siteNames will be removed in favour of the site code block."', args=[d.arg(name='siteNames', type=d.T.array)]),
      withSiteNames(siteNames): { spec+: { initProvider+: { siteNames: if std.isArray(v=siteNames) then siteNames else [siteNames] } } },
      '#withSiteNamesMixin':: d.fn(help='"Deprecated: siteNames will be removed in favour of the site code block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='siteNames', type=d.T.array)]),
      withSiteNamesMixin(siteNames): { spec+: { initProvider+: { siteNames+: if std.isArray(v=siteNames) then siteNames else [siteNames] } } },
    },
