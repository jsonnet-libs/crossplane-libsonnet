{
  ...
  '#':: d.pkg(name='botChannelMSTeams', url='', help='"BotChannelMSTeams is the Schema for the BotChannelMSTeamss API. Manages an MS Teams integration for a Bot Channel"'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelMSTeams', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotChannelMSTeamsSpec defines the desired state of BotChannelMSTeams"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCallingWebHook':: d.fn(help='"Specifies the webhook for Microsoft Teams channel calls."', args=[d.arg(name='callingWebHook', type=d.T.string)]),
      withCallingWebHook(callingWebHook): { spec+: { forProvider+: { callingWebHook: callingWebHook } } },
      '#withDeploymentEnvironment':: d.fn(help='"The deployment environment for Microsoft Teams channel calls. Possible values are CommercialDeployment and GCCModerateDeployment. Defaults to CommercialDeployment."', args=[d.arg(name='deploymentEnvironment', type=d.T.string)]),
      withDeploymentEnvironment(deploymentEnvironment): { spec+: { forProvider+: { deploymentEnvironment: deploymentEnvironment } } },
      '#withEnableCalling':: d.fn(help='"Specifies whether to enable Microsoft Teams channel calls. This defaults to false."', args=[d.arg(name='enableCalling', type=d.T.boolean)]),
      withEnableCalling(enableCalling): { spec+: { forProvider+: { enableCalling: enableCalling } } },
    ...
    initProvider: {
      '#withCallingWebHook':: d.fn(help='"Specifies the webhook for Microsoft Teams channel calls."', args=[d.arg(name='callingWebHook', type=d.T.string)]),
      withCallingWebHook(callingWebHook): { spec+: { initProvider+: { callingWebHook: callingWebHook } } },
      '#withDeploymentEnvironment':: d.fn(help='"The deployment environment for Microsoft Teams channel calls. Possible values are CommercialDeployment and GCCModerateDeployment. Defaults to CommercialDeployment."', args=[d.arg(name='deploymentEnvironment', type=d.T.string)]),
      withDeploymentEnvironment(deploymentEnvironment): { spec+: { initProvider+: { deploymentEnvironment: deploymentEnvironment } } },
      '#withEnableCalling':: d.fn(help='"Specifies whether to enable Microsoft Teams channel calls. This defaults to false."', args=[d.arg(name='enableCalling', type=d.T.boolean)]),
      withEnableCalling(enableCalling): { spec+: { initProvider+: { enableCalling: enableCalling } } },
      '#withLocation':: d.fn(help='"The supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
