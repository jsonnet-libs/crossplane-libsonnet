{
  ...
  '#':: d.pkg(name='botChannelLine', url='', help='"BotChannelLine is the Schema for the BotChannelLines API. Manages a Line integration for a Bot Channel"'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelLine', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotChannelLineSpec defines the desired state of BotChannelLine"'),
  spec: {
    ...
    forProvider: {
      ...
      '#lineChannel':: d.obj(help='"One or more line_channel blocks as defined below."'),
      lineChannel: {
        '#accessTokenSecretRef':: d.obj(help='"The access token which is used to call the Line Channel API."'),
        ...
        '#secretSecretRef':: d.obj(help='"The secret which is used to access the Line Channel."'),
        secretSecretRef: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withLineChannel':: d.fn(help='"One or more line_channel blocks as defined below."', args=[d.arg(name='lineChannel', type=d.T.array)]),
      withLineChannel(lineChannel): { spec+: { forProvider+: { lineChannel: if std.isArray(v=lineChannel) then lineChannel else [lineChannel] } } },
      '#withLineChannelMixin':: d.fn(help='"One or more line_channel blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='lineChannel', type=d.T.array)]),
      withLineChannelMixin(lineChannel): { spec+: { forProvider+: { lineChannel+: if std.isArray(v=lineChannel) then lineChannel else [lineChannel] } } },
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group where the Line Channel should be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withLineChannel':: d.fn(help='"One or more line_channel blocks as defined below."', args=[d.arg(name='lineChannel', type=d.T.array)]),
      withLineChannel(lineChannel): { spec+: { initProvider+: { lineChannel: if std.isArray(v=lineChannel) then lineChannel else [lineChannel] } } },
      '#withLineChannelMixin':: d.fn(help='"One or more line_channel blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='lineChannel', type=d.T.array)]),
      withLineChannelMixin(lineChannel): { spec+: { initProvider+: { lineChannel+: if std.isArray(v=lineChannel) then lineChannel else [lineChannel] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
