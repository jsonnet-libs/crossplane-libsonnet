{
  ...
  '#':: d.pkg(name='botWebApp', url='', help='"BotWebApp is the Schema for the BotWebApps API. Manages a Web App Bot."'),
  ...
  '#new':: d.fn(help='new returns an instance of BotWebApp', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotWebAppSpec defines the desired state of BotWebApp"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#developerAppInsightsApiKeySecretRef':: d.obj(help='"The Application Insights API Key to associate with the Web App Bot."'),
      ...
      '#luisKeySecretRef':: d.obj(help='"The LUIS key to associate with the Web App Bot."'),
      luisKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { luisKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { luisKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { luisKeySecretRef+: { namespace: namespace } } } },
      },
      ...
      '#withDeveloperAppInsightsApplicationId':: d.fn(help='"The Application Insights Application ID to associate with the Web App Bot."', args=[d.arg(name='developerAppInsightsApplicationId', type=d.T.string)]),
      ...
      '#withDeveloperAppInsightsKey':: d.fn(help='"The Application Insights Key to associate with the Web App Bot."', args=[d.arg(name='developerAppInsightsKey', type=d.T.string)]),
      withDeveloperAppInsightsKey(developerAppInsightsKey): { spec+: { forProvider+: { developerAppInsightsKey: developerAppInsightsKey } } },
      '#withDisplayName':: d.fn(help='"The name of the Web App Bot will be displayed as. This defaults to name if not specified."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withEndpoint':: d.fn(help='"The Web App Bot endpoint."', args=[d.arg(name='endpoint', type=d.T.string)]),
      ...
      '#withLuisAppIds':: d.fn(help='"A list of LUIS App IDs to associate with the Web App Bot."', args=[d.arg(name='luisAppIds', type=d.T.array)]),
      withLuisAppIds(luisAppIds): { spec+: { forProvider+: { luisAppIds: if std.isArray(v=luisAppIds) then luisAppIds else [luisAppIds] } } },
      '#withLuisAppIdsMixin':: d.fn(help='"A list of LUIS App IDs to associate with the Web App Bot."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='luisAppIds', type=d.T.array)]),
      withLuisAppIdsMixin(luisAppIds): { spec+: { forProvider+: { luisAppIds+: if std.isArray(v=luisAppIds) then luisAppIds else [luisAppIds] } } },
      '#withMicrosoftAppId':: d.fn(help='"The Microsoft Application ID for the Web App Bot. Changing this forces a new resource to be created."', args=[d.arg(name='microsoftAppId', type=d.T.string)]),
      withMicrosoftAppId(microsoftAppId): { spec+: { forProvider+: { microsoftAppId: microsoftAppId } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Web App Bot. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"The SKU of the Web App Bot. Valid values include F0 or S1. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
    ...
    initProvider: {
      ...
      luisKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { luisKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { luisKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { luisKeySecretRef+: { namespace: namespace } } } },
      },
      '#withDeveloperAppInsightsApplicationId':: d.fn(help='"The Application Insights Application ID to associate with the Web App Bot."', args=[d.arg(name='developerAppInsightsApplicationId', type=d.T.string)]),
      ...
      '#withLuisAppIds':: d.fn(help='"A list of LUIS App IDs to associate with the Web App Bot."', args=[d.arg(name='luisAppIds', type=d.T.array)]),
      withLuisAppIds(luisAppIds): { spec+: { initProvider+: { luisAppIds: if std.isArray(v=luisAppIds) then luisAppIds else [luisAppIds] } } },
      '#withLuisAppIdsMixin':: d.fn(help='"A list of LUIS App IDs to associate with the Web App Bot."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='luisAppIds', type=d.T.array)]),
      withLuisAppIdsMixin(luisAppIds): { spec+: { initProvider+: { luisAppIds+: if std.isArray(v=luisAppIds) then luisAppIds else [luisAppIds] } } },
      '#withMicrosoftAppId':: d.fn(help='"The Microsoft Application ID for the Web App Bot. Changing this forces a new resource to be created."', args=[d.arg(name='microsoftAppId', type=d.T.string)]),
