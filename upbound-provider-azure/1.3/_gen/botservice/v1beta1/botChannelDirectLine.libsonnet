{
  ...
  '#':: d.pkg(name='botChannelDirectLine', url='', help='"BotChannelDirectLine is the Schema for the BotChannelDirectLines API. Manages an Directline integration for a Bot Channel"'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelDirectLine', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'botservice.azure.upbound.io/v1beta1',
    kind: 'BotChannelDirectLine',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'false',
  }),
  '#spec':: d.obj(help='"BotChannelDirectLineSpec defines the desired state of BotChannelDirectLine"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#botNameRef':: d.obj(help='"Reference to a BotChannelsRegistration in botservice to populate botName."'),
      botNameRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { botNameRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { botNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { botNameRef+: { name: name } } } },
      },
      '#botNameSelector':: d.obj(help='"Selector for a BotChannelsRegistration in botservice to populate botName."'),
      botNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { botNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { botNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { botNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { botNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { botNameSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#site':: d.obj(help='"A site represents a client application that you want to connect to your bot. One or more site blocks as defined below."'),
      site: {
        '#withEnabled':: d.fn(help='"Enables/Disables this site. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { enabled: enabled },
        '#withEndpointParametersEnabled':: d.fn(help='"Is the endpoint parameters enabled for this site?"', args=[d.arg(name='endpointParametersEnabled', type=d.T.boolean)]),
        withEndpointParametersEnabled(endpointParametersEnabled): { endpointParametersEnabled: endpointParametersEnabled },
        '#withEnhancedAuthenticationEnabled':: d.fn(help='"Enables additional security measures for this site, see Enhanced Directline Authentication Features. Disabled by default."', args=[d.arg(name='enhancedAuthenticationEnabled', type=d.T.boolean)]),
        withEnhancedAuthenticationEnabled(enhancedAuthenticationEnabled): { enhancedAuthenticationEnabled: enhancedAuthenticationEnabled },
        '#withName':: d.fn(help='"The name of the site"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withStorageEnabled':: d.fn(help='"Is the storage site enabled for detailed logging? Defaults to true."', args=[d.arg(name='storageEnabled', type=d.T.boolean)]),
        withStorageEnabled(storageEnabled): { storageEnabled: storageEnabled },
        '#withTrustedOrigins':: d.fn(help='"This field is required when is_secure_site_enabled is enabled. Determines which origins can establish a Directline conversation for this site."', args=[d.arg(name='trustedOrigins', type=d.T.array)]),
        withTrustedOrigins(trustedOrigins): { trustedOrigins: if std.isArray(v=trustedOrigins) then trustedOrigins else [trustedOrigins] },
        '#withTrustedOriginsMixin':: d.fn(help='"This field is required when is_secure_site_enabled is enabled. Determines which origins can establish a Directline conversation for this site."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='trustedOrigins', type=d.T.array)]),
        withTrustedOriginsMixin(trustedOrigins): { trustedOrigins+: if std.isArray(v=trustedOrigins) then trustedOrigins else [trustedOrigins] },
        '#withUserUploadEnabled':: d.fn(help='"Is the user upload enabled for this site? Defaults to true."', args=[d.arg(name='userUploadEnabled', type=d.T.boolean)]),
        withUserUploadEnabled(userUploadEnabled): { userUploadEnabled: userUploadEnabled },
        '#withV1Allowed':: d.fn(help='"Enables v1 of the Directline protocol for this site. Defaults to true."', args=[d.arg(name='v1Allowed', type=d.T.boolean)]),
        withV1Allowed(v1Allowed): { v1Allowed: v1Allowed },
        '#withV3Allowed':: d.fn(help='"Enables v3 of the Directline protocol for this site. Defaults to true."', args=[d.arg(name='v3Allowed', type=d.T.boolean)]),
        withV3Allowed(v3Allowed): { v3Allowed: v3Allowed },
      },
      '#withBotName':: d.fn(help='"The name of the Bot Resource this channel will be associated with. Changing this forces a new resource to be created."', args=[d.arg(name='botName', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Bot Channel. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSite':: d.fn(help='"A site represents a client application that you want to connect to your bot. One or more site blocks as defined below."', args=[d.arg(name='site', type=d.T.array)]),
      withSite(site): { spec+: { forProvider+: { site: if std.isArray(v=site) then site else [site] } } },
      '#withSiteMixin':: d.fn(help='"A site represents a client application that you want to connect to your bot. One or more site blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='site', type=d.T.array)]),
      withSiteMixin(site): { spec+: { forProvider+: { site+: if std.isArray(v=site) then site else [site] } } },
    },
    ...
    initProvider: {
      ...
      '#withSite':: d.fn(help='"A site represents a client application that you want to connect to your bot. One or more site blocks as defined below."', args=[d.arg(name='site', type=d.T.array)]),
      withSite(site): { spec+: { initProvider+: { site: if std.isArray(v=site) then site else [site] } } },
      '#withSiteMixin':: d.fn(help='"A site represents a client application that you want to connect to your bot. One or more site blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='site', type=d.T.array)]),
      withSiteMixin(site): { spec+: { initProvider+: { site+: if std.isArray(v=site) then site else [site] } } },
    },
