{
  ...
  '#':: d.pkg(name='botChannelSlack', url='', help='"BotChannelSlack is the Schema for the BotChannelSlacks API. Manages a Slack integration for a Bot Channel"'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelSlack', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotChannelSlackSpec defines the desired state of BotChannelSlack"'),
  spec: {
    ...
    forProvider: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"The Client Secret that will be used to authenticate with Slack."'),
      ...
      '#signingSecretSecretRef':: d.obj(help='"The Signing Secret that will be used to sign the requests."'),
      signingSecretSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { signingSecretSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { signingSecretSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { signingSecretSecretRef+: { namespace: namespace } } } },
      },
      '#verificationTokenSecretRef':: d.obj(help='"The Verification Token that will be used to authenticate with Slack."'),
      verificationTokenSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { verificationTokenSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { verificationTokenSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { verificationTokenSecretRef+: { namespace: namespace } } } },
      },
      ...
      '#withClientId':: d.fn(help='"The Client ID that will be used to authenticate with Slack."', args=[d.arg(name='clientId', type=d.T.string)]),
      withClientId(clientId): { spec+: { forProvider+: { clientId: clientId } } },
      '#withLandingPageUrl':: d.fn(help='"The Slack Landing Page URL."', args=[d.arg(name='landingPageUrl', type=d.T.string)]),
      withLandingPageUrl(landingPageUrl): { spec+: { forProvider+: { landingPageUrl: landingPageUrl } } },
    ...
    initProvider: {
      ...
      signingSecretSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { signingSecretSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { signingSecretSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { signingSecretSecretRef+: { namespace: namespace } } } },
      },
      '#verificationTokenSecretRef':: d.obj(help='"The Verification Token that will be used to authenticate with Slack."'),
      verificationTokenSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { verificationTokenSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { verificationTokenSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { verificationTokenSecretRef+: { namespace: namespace } } } },
      },
      '#withClientId':: d.fn(help='"The Client ID that will be used to authenticate with Slack."', args=[d.arg(name='clientId', type=d.T.string)]),
      withClientId(clientId): { spec+: { initProvider+: { clientId: clientId } } },
      '#withLandingPageUrl':: d.fn(help='"The Slack Landing Page URL."', args=[d.arg(name='landingPageUrl', type=d.T.string)]),
      withLandingPageUrl(landingPageUrl): { spec+: { initProvider+: { landingPageUrl: landingPageUrl } } },
      '#withLocation':: d.fn(help='"The supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
