{
  ...
  '#':: d.pkg(name='botConnection', url='', help='"BotConnection is the Schema for the BotConnections API. Manages a Bot Connection."'),
  ...
  '#new':: d.fn(help='new returns an instance of BotConnection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotConnectionSpec defines the desired state of BotConnection"'),
  spec: {
    ...
    forProvider: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"The Client Secret that will be used to authenticate with the service provider."'),
      ...
      '#withBotName':: d.fn(help='"The name of the Bot Resource this connection will be associated with. Changing this forces a new resource to be created."', args=[d.arg(name='botName', type=d.T.string)]),
      withBotName(botName): { spec+: { forProvider+: { botName: botName } } },
      '#withClientId':: d.fn(help='"The Client ID that will be used to authenticate with the service provider."', args=[d.arg(name='clientId', type=d.T.string)]),
      ...
      '#withParameters':: d.fn(help='"A map of additional parameters to apply to the connection."', args=[d.arg(name='parameters', type=d.T.object)]),
      withParameters(parameters): { spec+: { forProvider+: { parameters: parameters } } },
      '#withParametersMixin':: d.fn(help='"A map of additional parameters to apply to the connection."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.object)]),
      withParametersMixin(parameters): { spec+: { forProvider+: { parameters+: parameters } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Bot Connection. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withScopes':: d.fn(help='"The Scopes at which the connection should be applied."', args=[d.arg(name='scopes', type=d.T.string)]),
      withScopes(scopes): { spec+: { forProvider+: { scopes: scopes } } },
      '#withServiceProviderName':: d.fn(help='"The name of the service provider that will be associated with this connection. Changing this forces a new resource to be created."', args=[d.arg(name='serviceProviderName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withScopes':: d.fn(help='"The Scopes at which the connection should be applied."', args=[d.arg(name='scopes', type=d.T.string)]),
      withScopes(scopes): { spec+: { initProvider+: { scopes: scopes } } },
      '#withServiceProviderName':: d.fn(help='"The name of the service provider that will be associated with this connection. Changing this forces a new resource to be created."', args=[d.arg(name='serviceProviderName', type=d.T.string)]),
