{
  ...
  '#':: d.pkg(name='botChannelsRegistration', url='', help='"BotChannelsRegistration is the Schema for the BotChannelsRegistrations API. Manages a Bot Channels Registration."'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelsRegistration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotChannelsRegistrationSpec defines the desired state of BotChannelsRegistration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#developerAppInsightsApiKeySecretRef':: d.obj(help='"The Application Insights API Key to associate with the Bot Channels Registration."'),
      developerAppInsightsApiKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { developerAppInsightsApiKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { developerAppInsightsApiKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { developerAppInsightsApiKeySecretRef+: { namespace: namespace } } } },
      },
      ...
      '#withCmkKeyVaultUrl':: d.fn(help='"The CMK Key Vault Key URL to encrypt the Bot Channels Registration with the Customer Managed Encryption Key."', args=[d.arg(name='cmkKeyVaultUrl', type=d.T.string)]),
      withCmkKeyVaultUrl(cmkKeyVaultUrl): { spec+: { forProvider+: { cmkKeyVaultUrl: cmkKeyVaultUrl } } },
      '#withDescription':: d.fn(help='"The description of the Bot Channels Registration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDeveloperAppInsightsApplicationId':: d.fn(help='"The Application Insights Application ID to associate with the Bot Channels Registration."', args=[d.arg(name='developerAppInsightsApplicationId', type=d.T.string)]),
      withDeveloperAppInsightsApplicationId(developerAppInsightsApplicationId): { spec+: { forProvider+: { developerAppInsightsApplicationId: developerAppInsightsApplicationId } } },
      '#withDeveloperAppInsightsKey':: d.fn(help='"The Application Insights Key to associate with the Bot Channels Registration."', args=[d.arg(name='developerAppInsightsKey', type=d.T.string)]),
      withDeveloperAppInsightsKey(developerAppInsightsKey): { spec+: { forProvider+: { developerAppInsightsKey: developerAppInsightsKey } } },
      '#withDisplayName':: d.fn(help='"The name of the Bot Channels Registration will be displayed as. This defaults to name if not specified."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withEndpoint':: d.fn(help='"The Bot Channels Registration endpoint."', args=[d.arg(name='endpoint', type=d.T.string)]),
      withEndpoint(endpoint): { spec+: { forProvider+: { endpoint: endpoint } } },
      '#withIconUrl':: d.fn(help='"The icon URL to visually identify the Bot Channels Registration."', args=[d.arg(name='iconUrl', type=d.T.string)]),
      withIconUrl(iconUrl): { spec+: { forProvider+: { iconUrl: iconUrl } } },
      '#withIsolatedNetworkEnabled':: d.fn(help='"Is the Bot Channels Registration in an isolated network?"', args=[d.arg(name='isolatedNetworkEnabled', type=d.T.boolean)]),
      withIsolatedNetworkEnabled(isolatedNetworkEnabled): { spec+: { forProvider+: { isolatedNetworkEnabled: isolatedNetworkEnabled } } },
      ...
      '#withMicrosoftAppId':: d.fn(help='"The Microsoft Application ID for the Bot Channels Registration. Changing this forces a new resource to be created."', args=[d.arg(name='microsoftAppId', type=d.T.string)]),
      withMicrosoftAppId(microsoftAppId): { spec+: { forProvider+: { microsoftAppId: microsoftAppId } } },
      '#withName':: d.fn(help='"Specifies the name of the Bot Channels Registration. Changing this forces a new resource to be created. Must be globally unique."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Is the Bot Channels Registration in an isolated network?"', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Bot Channels Registration. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"The SKU of the Bot Channels Registration. Valid values include F0 or S1. Changing this forces a new resource to be created."', args=[d.arg(name='sku', type=d.T.string)]),
      withSku(sku): { spec+: { forProvider+: { sku: sku } } },
      '#withStreamingEndpointEnabled':: d.fn(help='"Is the streaming endpoint enabled for the Bot Channels Registration. Defaults to false."', args=[d.arg(name='streamingEndpointEnabled', type=d.T.boolean)]),
      withStreamingEndpointEnabled(streamingEndpointEnabled): { spec+: { forProvider+: { streamingEndpointEnabled: streamingEndpointEnabled } } },
    ...
    initProvider: {
      ...
      developerAppInsightsApiKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { developerAppInsightsApiKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { developerAppInsightsApiKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { developerAppInsightsApiKeySecretRef+: { namespace: namespace } } } },
      },
      '#resourceGroupNameRef':: d.obj(help='"Reference to a ResourceGroup in azure to populate resourceGroupName."'),
      resourceGroupNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
      ...
      '#withCmkKeyVaultUrl':: d.fn(help='"The CMK Key Vault Key URL to encrypt the Bot Channels Registration with the Customer Managed Encryption Key."', args=[d.arg(name='cmkKeyVaultUrl', type=d.T.string)]),
      withCmkKeyVaultUrl(cmkKeyVaultUrl): { spec+: { initProvider+: { cmkKeyVaultUrl: cmkKeyVaultUrl } } },
      '#withDescription':: d.fn(help='"The description of the Bot Channels Registration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withDeveloperAppInsightsApplicationId':: d.fn(help='"The Application Insights Application ID to associate with the Bot Channels Registration."', args=[d.arg(name='developerAppInsightsApplicationId', type=d.T.string)]),
      withDeveloperAppInsightsApplicationId(developerAppInsightsApplicationId): { spec+: { initProvider+: { developerAppInsightsApplicationId: developerAppInsightsApplicationId } } },
      '#withDeveloperAppInsightsKey':: d.fn(help='"The Application Insights Key to associate with the Bot Channels Registration."', args=[d.arg(name='developerAppInsightsKey', type=d.T.string)]),
      withDeveloperAppInsightsKey(developerAppInsightsKey): { spec+: { initProvider+: { developerAppInsightsKey: developerAppInsightsKey } } },
      '#withDisplayName':: d.fn(help='"The name of the Bot Channels Registration will be displayed as. This defaults to name if not specified."', args=[d.arg(name='displayName', type=d.T.string)]),
      ...
      '#withIsolatedNetworkEnabled':: d.fn(help='"Is the Bot Channels Registration in an isolated network?"', args=[d.arg(name='isolatedNetworkEnabled', type=d.T.boolean)]),
      withIsolatedNetworkEnabled(isolatedNetworkEnabled): { spec+: { initProvider+: { isolatedNetworkEnabled: isolatedNetworkEnabled } } },
      '#withLocation':: d.fn(help='"The supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withMicrosoftAppId':: d.fn(help='"The Microsoft Application ID for the Bot Channels Registration. Changing this forces a new resource to be created."', args=[d.arg(name='microsoftAppId', type=d.T.string)]),
      withMicrosoftAppId(microsoftAppId): { spec+: { initProvider+: { microsoftAppId: microsoftAppId } } },
      '#withName':: d.fn(help='"Specifies the name of the Bot Channels Registration. Changing this forces a new resource to be created. Must be globally unique."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withStreamingEndpointEnabled':: d.fn(help='"Is the streaming endpoint enabled for the Bot Channels Registration. Defaults to false."', args=[d.arg(name='streamingEndpointEnabled', type=d.T.boolean)]),
      withStreamingEndpointEnabled(streamingEndpointEnabled): { spec+: { initProvider+: { streamingEndpointEnabled: streamingEndpointEnabled } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
