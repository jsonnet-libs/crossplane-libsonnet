{
  ...
  '#':: d.pkg(name='botChannelAlexa', url='', help='"BotChannelAlexa is the Schema for the BotChannelAlexas API. Manages an Alexa integration for a Bot Channel"'),
  ...
  '#new':: d.fn(help='new returns an instance of BotChannelAlexa', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BotChannelAlexaSpec defines the desired state of BotChannelAlexa"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group where the Alexa Channel should be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkillId':: d.fn(help='"The Alexa skill ID for the Alexa Channel."', args=[d.arg(name='skillId', type=d.T.string)]),
      withSkillId(skillId): { spec+: { forProvider+: { skillId: skillId } } },
    },
    ...
    initProvider: {
      ...
      '#withSkillId':: d.fn(help='"The Alexa skill ID for the Alexa Channel."', args=[d.arg(name='skillId', type=d.T.string)]),
      withSkillId(skillId): { spec+: { initProvider+: { skillId: skillId } } },
    },
