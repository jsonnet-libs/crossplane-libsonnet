{
  ...
  '#':: d.pkg(name='appServiceCertificateOrder', url='', help='"AppServiceCertificateOrder is the Schema for the AppServiceCertificateOrders API. Manages an App Service Certificate Order."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppServiceCertificateOrder', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppServiceCertificateOrderSpec defines the desired state of AppServiceCertificateOrder"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoRenew':: d.fn(help='"true if the certificate should be automatically renewed when it expires; otherwise, false. Defaults to true."', args=[d.arg(name='autoRenew', type=d.T.boolean)]),
      withAutoRenew(autoRenew): { spec+: { forProvider+: { autoRenew: autoRenew } } },
      '#withCsr':: d.fn(help='"Last CSR that was created for this order."', args=[d.arg(name='csr', type=d.T.string)]),
      withCsr(csr): { spec+: { forProvider+: { csr: csr } } },
      '#withDistinguishedName':: d.fn(help='"The Distinguished Name for the App Service Certificate Order."', args=[d.arg(name='distinguishedName', type=d.T.string)]),
      withDistinguishedName(distinguishedName): { spec+: { forProvider+: { distinguishedName: distinguishedName } } },
      '#withKeySize':: d.fn(help='"Certificate key size. Defaults to 2048."', args=[d.arg(name='keySize', type=d.T.number)]),
      withKeySize(keySize): { spec+: { forProvider+: { keySize: keySize } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created. Currently the only valid value is global."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withProductType':: d.fn(help='"Certificate product type, such as Standard or WildCard. Defaults to Standard."', args=[d.arg(name='productType', type=d.T.string)]),
      withProductType(productType): { spec+: { forProvider+: { productType: productType } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the certificate. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withValidityInYears':: d.fn(help='"Duration in years (must be between 1 and 3). Defaults to 1."', args=[d.arg(name='validityInYears', type=d.T.number)]),
      withValidityInYears(validityInYears): { spec+: { forProvider+: { validityInYears: validityInYears } } },
    },
    ...
    initProvider: {
      '#withAutoRenew':: d.fn(help='"true if the certificate should be automatically renewed when it expires; otherwise, false. Defaults to true."', args=[d.arg(name='autoRenew', type=d.T.boolean)]),
      withAutoRenew(autoRenew): { spec+: { initProvider+: { autoRenew: autoRenew } } },
      '#withCsr':: d.fn(help='"Last CSR that was created for this order."', args=[d.arg(name='csr', type=d.T.string)]),
      withCsr(csr): { spec+: { initProvider+: { csr: csr } } },
      '#withDistinguishedName':: d.fn(help='"The Distinguished Name for the App Service Certificate Order."', args=[d.arg(name='distinguishedName', type=d.T.string)]),
      withDistinguishedName(distinguishedName): { spec+: { initProvider+: { distinguishedName: distinguishedName } } },
      '#withKeySize':: d.fn(help='"Certificate key size. Defaults to 2048."', args=[d.arg(name='keySize', type=d.T.number)]),
      withKeySize(keySize): { spec+: { initProvider+: { keySize: keySize } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created. Currently the only valid value is global."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withProductType':: d.fn(help='"Certificate product type, such as Standard or WildCard. Defaults to Standard."', args=[d.arg(name='productType', type=d.T.string)]),
      withProductType(productType): { spec+: { initProvider+: { productType: productType } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withValidityInYears':: d.fn(help='"Duration in years (must be between 1 and 3). Defaults to 1."', args=[d.arg(name='validityInYears', type=d.T.number)]),
      withValidityInYears(validityInYears): { spec+: { initProvider+: { validityInYears: validityInYears } } },
    },
