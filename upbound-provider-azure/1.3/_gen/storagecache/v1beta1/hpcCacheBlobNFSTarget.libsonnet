{
  ...
  '#':: d.pkg(name='hpcCacheBlobNFSTarget', url='', help='"HPCCacheBlobNFSTarget is the Schema for the HPCCacheBlobNFSTargets API. Manages a Blob NFSv3 Target within a HPC Cache."'),
  ...
  '#new':: d.fn(help='new returns an instance of HPCCacheBlobNFSTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HPCCacheBlobNFSTargetSpec defines the desired state of HPCCacheBlobNFSTarget"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCacheName':: d.fn(help='"The name of the HPC Cache, which the HPC Cache Blob NFS Target will be added to. Changing this forces a new HPC Cache Blob NFS Target to be created."', args=[d.arg(name='cacheName', type=d.T.string)]),
      withCacheName(cacheName): { spec+: { forProvider+: { cacheName: cacheName } } },
      '#withNamespacePath':: d.fn(help='"The client-facing file path of the HPC Cache Blob NFS Target."', args=[d.arg(name='namespacePath', type=d.T.string)]),
      withNamespacePath(namespacePath): { spec+: { forProvider+: { namespacePath: namespacePath } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the HPC Cache Blob NFS Target should exist. Changing this forces a new HPC Cache Blob NFS Target to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withStorageContainerId':: d.fn(help='"The Resource Manager ID of the Storage Container used as the HPC Cache Blob NFS Target. Changing this forces a new resource to be created."', args=[d.arg(name='storageContainerId', type=d.T.string)]),
      withStorageContainerId(storageContainerId): { spec+: { forProvider+: { storageContainerId: storageContainerId } } },
      '#withUsageModel':: d.fn(help='"The type of usage of the HPC Cache Blob NFS Target. Possible values are: READ_HEAVY_INFREQ, READ_HEAVY_CHECK_180, READ_ONLY, READ_WRITE, WRITE_WORKLOAD_15, WRITE_AROUND, WRITE_WORKLOAD_CHECK_30, WRITE_WORKLOAD_CHECK_60 and WRITE_WORKLOAD_CLOUDWS."', args=[d.arg(name='usageModel', type=d.T.string)]),
