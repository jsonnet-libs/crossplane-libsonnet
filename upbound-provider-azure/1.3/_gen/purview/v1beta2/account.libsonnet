{
  ...
  '#':: d.pkg(name='account', url='', help='"Account is the Schema for the Accounts API. Manages a Purview Account."'),
  ...
  new(name): {
    apiVersion: 'purview.azure.upbound.io/v1beta2',
    kind: 'Account',
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withIdentityIds':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this Purview Account."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this Purview Account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Purview Account. Possible values are UserAssigned and SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Purview Account should exist. Changing this forces a new Purview Account to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withManagedResourceGroupName':: d.fn(help='"The name which should be used for the new Resource Group where Purview Account creates the managed resources. Changing this forces a new Purview Account to be created."', args=[d.arg(name='managedResourceGroupName', type=d.T.string)]),
      withManagedResourceGroupName(managedResourceGroupName): { spec+: { forProvider+: { managedResourceGroupName: managedResourceGroupName } } },
      '#withPublicNetworkEnabled':: d.fn(help='"Should the Purview Account be visible to the public network? Defaults to true."', args=[d.arg(name='publicNetworkEnabled', type=d.T.boolean)]),
      withPublicNetworkEnabled(publicNetworkEnabled): { spec+: { forProvider+: { publicNetworkEnabled: publicNetworkEnabled } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Purview Account should exist. Changing this forces a new Purview Account to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Purview Account."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Purview Account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
