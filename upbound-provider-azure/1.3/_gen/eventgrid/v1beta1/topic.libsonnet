{
  ...
  '#':: d.pkg(name='topic', url='', help='"Topic is the Schema for the Topics API. Manages an EventGrid Topic"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      identity: {
        '#withIdentityIds':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this Event Grid Topic."', args=[d.arg(name='identityIds', type=d.T.array)]),
        withIdentityIds(identityIds): { identityIds: if std.isArray(v=identityIds) then identityIds else [identityIds] },
        '#withIdentityIdsMixin':: d.fn(help='"Specifies a list of User Assigned Managed Identity IDs to be assigned to this Event Grid Topic."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        withIdentityIdsMixin(identityIds): { identityIds+: if std.isArray(v=identityIds) then identityIds else [identityIds] },
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Event Grid Topic. Possible values are SystemAssigned, UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withLocalAuthEnabled':: d.fn(help='"Whether local authentication methods is enabled for the EventGrid Topic. Defaults to true."', args=[d.arg(name='localAuthEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the EventGrid Topic exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
