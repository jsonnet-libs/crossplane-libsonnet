{
  ...
  '#':: d.pkg(name='creator', url='', help='"Creator is the Schema for the Creators API. Manages an Azure Maps Creator."'),
  ...
  '#new':: d.fn(help='new returns an instance of Creator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CreatorSpec defines the desired state of Creator"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#mapsAccountIdRef':: d.obj(help='"Reference to a Account in maps to populate mapsAccountId."'),
      mapsAccountIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { mapsAccountIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { mapsAccountIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { mapsAccountIdRef+: { name: name } } } },
      },
      '#mapsAccountIdSelector':: d.obj(help='"Selector for a Account in maps to populate mapsAccountId."'),
      mapsAccountIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { mapsAccountIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { mapsAccountIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { mapsAccountIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { mapsAccountIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { mapsAccountIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withLocation':: d.fn(help='"The Azure Region where the Azure Maps Creator should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withMapsAccountId':: d.fn(help='"The ID of the Azure Maps Creator. Changing this forces a new resource to be created."', args=[d.arg(name='mapsAccountId', type=d.T.string)]),
      withMapsAccountId(mapsAccountId): { spec+: { forProvider+: { mapsAccountId: mapsAccountId } } },
      '#withStorageUnits':: d.fn(help='"The storage units to be allocated. Integer values from 1 to 100, inclusive."', args=[d.arg(name='storageUnits', type=d.T.number)]),
      withStorageUnits(storageUnits): { spec+: { forProvider+: { storageUnits: storageUnits } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Azure Maps Creator."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Azure Maps Creator."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withStorageUnits':: d.fn(help='"The storage units to be allocated. Integer values from 1 to 100, inclusive."', args=[d.arg(name='storageUnits', type=d.T.number)]),
      withStorageUnits(storageUnits): { spec+: { initProvider+: { storageUnits: storageUnits } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Azure Maps Creator."', args=[d.arg(name='tags', type=d.T.object)]),
