{
  ...
  '#':: d.pkg(name='notificationHubNamespace', url='', help='"NotificationHubNamespace is the Schema for the NotificationHubNamespaces API. Manages a Notification Hub Namespace."'),
  ...
  '#new':: d.fn(help='new returns an instance of NotificationHubNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NotificationHubNamespaceSpec defines the desired state of NotificationHubNamespace"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEnabled':: d.fn(help='"Is this Notification Hub Namespace enabled? Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withLocation':: d.fn(help='"The Azure Region in which this Notification Hub Namespace should be created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withNamespaceType':: d.fn(help='"The Type of Namespace - possible values are Messaging or NotificationHub."', args=[d.arg(name='namespaceType', type=d.T.string)]),
      withNamespaceType(namespaceType): { spec+: { forProvider+: { namespaceType: namespaceType } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the Notification Hub Namespace should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"The name of the SKU to use for this Notification Hub Namespace. Possible values are Free, Basic or Standard."', args=[d.arg(name='skuName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withNamespaceType':: d.fn(help='"The Type of Namespace - possible values are Messaging or NotificationHub."', args=[d.arg(name='namespaceType', type=d.T.string)]),
      withNamespaceType(namespaceType): { spec+: { initProvider+: { namespaceType: namespaceType } } },
      '#withSkuName':: d.fn(help='"The name of the SKU to use for this Notification Hub Namespace. Possible values are Free, Basic or Standard."', args=[d.arg(name='skuName', type=d.T.string)]),
