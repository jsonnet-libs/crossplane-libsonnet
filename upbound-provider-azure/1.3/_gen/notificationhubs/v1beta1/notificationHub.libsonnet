{
  ...
  '#':: d.pkg(name='notificationHub', url='', help='"NotificationHub is the Schema for the NotificationHubs API. Manages a Notification Hub within a Notification Hub Namespace."'),
  ...
  '#new':: d.fn(help='new returns an instance of NotificationHub', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NotificationHubSpec defines the desired state of NotificationHub"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#apnsCredential':: d.obj(help='"A apns_credential block as defined below."'),
      apnsCredential: {
        '#tokenSecretRef':: d.obj(help='"The Push Token associated with the Apple Developer Account. This is the contents of the key downloaded from the Apple Developer Portal between the -----BEGIN PRIVATE KEY----- and -----END PRIVATE KEY----- blocks."'),
        tokenSecretRef: {
        ...
        '#withApplicationMode':: d.fn(help='"The Application Mode which defines which server the APNS Messages should be sent to. Possible values are Production and Sandbox."', args=[d.arg(name='applicationMode', type=d.T.string)]),
        withApplicationMode(applicationMode): { applicationMode: applicationMode },
        '#withBundleId':: d.fn(help='"The Bundle ID of the iOS/macOS application to send push notifications for, such as com.hashicorp.example."', args=[d.arg(name='bundleId', type=d.T.string)]),
        withBundleId(bundleId): { bundleId: bundleId },
        '#withKeyId':: d.fn(help='"The Apple Push Notifications Service (APNS) Key."', args=[d.arg(name='keyId', type=d.T.string)]),
        withKeyId(keyId): { keyId: keyId },
        '#withTeamId':: d.fn(help='"The ID of the team the Token."', args=[d.arg(name='teamId', type=d.T.string)]),
        withTeamId(teamId): { teamId: teamId },
      },
      '#gcmCredential':: d.obj(help='"A gcm_credential block as defined below."'),
      gcmCredential: {
        '#apiKeySecretRef':: d.obj(help='"The API Key associated with the Google Cloud Messaging service."'),
        apiKeySecretRef: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#namespaceNameRef':: d.obj(help='"Reference to a NotificationHubNamespace in notificationhubs to populate namespaceName."'),
      namespaceNameRef: {
      ...
      '#namespaceNameSelector':: d.obj(help='"Selector for a NotificationHubNamespace in notificationhubs to populate namespaceName."'),
      ...
      '#withApnsCredential':: d.fn(help='"A apns_credential block as defined below."', args=[d.arg(name='apnsCredential', type=d.T.array)]),
      withApnsCredential(apnsCredential): { spec+: { forProvider+: { apnsCredential: if std.isArray(v=apnsCredential) then apnsCredential else [apnsCredential] } } },
      '#withApnsCredentialMixin':: d.fn(help='"A apns_credential block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='apnsCredential', type=d.T.array)]),
      withApnsCredentialMixin(apnsCredential): { spec+: { forProvider+: { apnsCredential+: if std.isArray(v=apnsCredential) then apnsCredential else [apnsCredential] } } },
      '#withGcmCredential':: d.fn(help='"A gcm_credential block as defined below."', args=[d.arg(name='gcmCredential', type=d.T.array)]),
      withGcmCredential(gcmCredential): { spec+: { forProvider+: { gcmCredential: if std.isArray(v=gcmCredential) then gcmCredential else [gcmCredential] } } },
      '#withGcmCredentialMixin':: d.fn(help='"A gcm_credential block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gcmCredential', type=d.T.array)]),
      withGcmCredentialMixin(gcmCredential): { spec+: { forProvider+: { gcmCredential+: if std.isArray(v=gcmCredential) then gcmCredential else [gcmCredential] } } },
      '#withLocation':: d.fn(help='"The Azure Region in which this Notification Hub Namespace exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withNamespaceName':: d.fn(help='"The name of the Notification Hub Namespace in which to create this Notification Hub. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceName', type=d.T.string)]),
      withNamespaceName(namespaceName): { spec+: { forProvider+: { namespaceName: namespaceName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the Notification Hub Namespace exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withApnsCredential':: d.fn(help='"A apns_credential block as defined below."', args=[d.arg(name='apnsCredential', type=d.T.array)]),
      withApnsCredential(apnsCredential): { spec+: { initProvider+: { apnsCredential: if std.isArray(v=apnsCredential) then apnsCredential else [apnsCredential] } } },
      '#withApnsCredentialMixin':: d.fn(help='"A apns_credential block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='apnsCredential', type=d.T.array)]),
      withApnsCredentialMixin(apnsCredential): { spec+: { initProvider+: { apnsCredential+: if std.isArray(v=apnsCredential) then apnsCredential else [apnsCredential] } } },
      '#withGcmCredential':: d.fn(help='"A gcm_credential block as defined below."', args=[d.arg(name='gcmCredential', type=d.T.array)]),
      withGcmCredential(gcmCredential): { spec+: { initProvider+: { gcmCredential: if std.isArray(v=gcmCredential) then gcmCredential else [gcmCredential] } } },
      '#withGcmCredentialMixin':: d.fn(help='"A gcm_credential block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gcmCredential', type=d.T.array)]),
      withGcmCredentialMixin(gcmCredential): { spec+: { initProvider+: { gcmCredential+: if std.isArray(v=gcmCredential) then gcmCredential else [gcmCredential] } } },
      '#withLocation':: d.fn(help='"The Azure Region in which this Notification Hub Namespace exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
