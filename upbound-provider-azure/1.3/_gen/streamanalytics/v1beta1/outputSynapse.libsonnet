{
  ...
  '#':: d.pkg(name='outputSynapse', url='', help='"OutputSynapse is the Schema for the OutputSynapses API. Manages a Stream Analytics Output to an Azure Synapse Analytics Workspace."'),
  ...
  '#new':: d.fn(help='new returns an instance of OutputSynapse', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OutputSynapseSpec defines the desired state of OutputSynapse"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#passwordSecretRef':: d.obj(help='"The password that will be used to connect to the Azure SQL database."'),
      passwordSecretRef: {
      ...
      '#userRef':: d.obj(help='"Reference to a Workspace in synapse to populate user."'),
      userRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#userSelector':: d.obj(help='"Selector for a Workspace in synapse to populate user."'),
      userSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withDatabase':: d.fn(help='"The name of the Azure SQL database. Changing this forces a new resource to be created."', args=[d.arg(name='database', type=d.T.string)]),
      ...
      '#withServer':: d.fn(help='"The name of the SQL server containing the Azure SQL database. Changing this forces a new resource to be created."', args=[d.arg(name='server', type=d.T.string)]),
      ...
      '#withTable':: d.fn(help='"The name of the table in the Azure SQL database. Changing this forces a new resource to be created."', args=[d.arg(name='table', type=d.T.string)]),
      withTable(table): { spec+: { forProvider+: { table: table } } },
      '#withUser':: d.fn(help='"The user name that will be used to connect to the Azure SQL database. Changing this forces a new resource to be created."', args=[d.arg(name='user', type=d.T.string)]),
