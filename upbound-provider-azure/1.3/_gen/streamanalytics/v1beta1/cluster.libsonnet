{
  ...
  '#':: d.pkg(name='cluster', url='', help='"Cluster is the Schema for the Clusters API. Manages a Stream Analytics Cluster."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Stream Analytics Cluster should exist. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Stream Analytics Cluster should exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withStreamingCapacity':: d.fn(help='"The number of streaming units supported by the Cluster. Accepted values are multiples of 36 in the range of 36 to 216."', args=[d.arg(name='streamingCapacity', type=d.T.number)]),
      withStreamingCapacity(streamingCapacity): { spec+: { forProvider+: { streamingCapacity: streamingCapacity } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Stream Analytics."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Stream Analytics."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withStreamingCapacity':: d.fn(help='"The number of streaming units supported by the Cluster. Accepted values are multiples of 36 in the range of 36 to 216."', args=[d.arg(name='streamingCapacity', type=d.T.number)]),
      withStreamingCapacity(streamingCapacity): { spec+: { initProvider+: { streamingCapacity: streamingCapacity } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Stream Analytics."', args=[d.arg(name='tags', type=d.T.object)]),
