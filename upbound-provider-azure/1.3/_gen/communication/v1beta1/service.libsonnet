{
  ...
  '#':: d.pkg(name='service', url='', help='"Service is the Schema for the Services API. Manages a Communication Service."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDataLocation':: d.fn(help='"The location where the Communication service stores its data at rest. Possible values are Africa, Asia Pacific, Australia, Brazil, Canada, Europe, France, Germany, India, Japan, Korea, Norway, Switzerland, UAE, UK and United States. Defaults to United States. Changing this forces a new Communication Service to be created."', args=[d.arg(name='dataLocation', type=d.T.string)]),
      withDataLocation(dataLocation): { spec+: { forProvider+: { dataLocation: dataLocation } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Communication Service should exist. Changing this forces a new Communication Service to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Communication Service."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Communication Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
    ...
    initProvider: {
      '#withDataLocation':: d.fn(help='"The location where the Communication service stores its data at rest. Possible values are Africa, Asia Pacific, Australia, Brazil, Canada, Europe, France, Germany, India, Japan, Korea, Norway, Switzerland, UAE, UK and United States. Defaults to United States. Changing this forces a new Communication Service to be created."', args=[d.arg(name='dataLocation', type=d.T.string)]),
      withDataLocation(dataLocation): { spec+: { initProvider+: { dataLocation: dataLocation } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Communication Service."', args=[d.arg(name='tags', type=d.T.object)]),
