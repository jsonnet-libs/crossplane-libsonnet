{
  ...
  '#':: d.pkg(name='mssqlManagedInstanceActiveDirectoryAdministrator', url='', help='"MSSQLManagedInstanceActiveDirectoryAdministrator is the Schema for the MSSQLManagedInstanceActiveDirectoryAdministrators API. Manages an Active Directory Administrator on a Microsoft Azure SQL Managed Instance"'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLManagedInstanceActiveDirectoryAdministrator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLManagedInstanceActiveDirectoryAdministratorSpec defines the desired state of MSSQLManagedInstanceActiveDirectoryAdministrator"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAzureadAuthenticationOnly':: d.fn(help='"When true, only permit logins from AAD users and administrators. When false, also allow local database users."', args=[d.arg(name='azureadAuthenticationOnly', type=d.T.boolean)]),
      ...
      '#withLoginUsername':: d.fn(help='"The login name of the principal to set as the Managed Instance Administrator."', args=[d.arg(name='loginUsername', type=d.T.string)]),
      withLoginUsername(loginUsername): { spec+: { forProvider+: { loginUsername: loginUsername } } },
      '#withManagedInstanceId':: d.fn(help='"The ID of the Azure SQL Managed Instance for which to set the administrator. Changing this forces a new resource to be created."', args=[d.arg(name='managedInstanceId', type=d.T.string)]),
      withManagedInstanceId(managedInstanceId): { spec+: { forProvider+: { managedInstanceId: managedInstanceId } } },
      '#withObjectId':: d.fn(help='"The Object ID of the principal to set as the Managed Instance Administrator."', args=[d.arg(name='objectId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withLoginUsername':: d.fn(help='"The login name of the principal to set as the Managed Instance Administrator."', args=[d.arg(name='loginUsername', type=d.T.string)]),
      withLoginUsername(loginUsername): { spec+: { initProvider+: { loginUsername: loginUsername } } },
      '#withObjectId':: d.fn(help='"The Object ID of the principal to set as the Managed Instance Administrator."', args=[d.arg(name='objectId', type=d.T.string)]),
