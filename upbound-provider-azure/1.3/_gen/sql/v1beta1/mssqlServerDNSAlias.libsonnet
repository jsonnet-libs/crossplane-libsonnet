{
  ...
  '#':: d.pkg(name='mssqlServerDNSAlias', url='', help='"MSSQLServerDNSAlias is the Schema for the MSSQLServerDNSAliass API. Manages a MS SQL Server DNS Alias."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLServerDNSAlias', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLServerDNSAliasSpec defines the desired state of MSSQLServerDNSAlias"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#mssqlServerIdRef':: d.obj(help='"Reference to a MSSQLServer in sql to populate mssqlServerId."'),
      mssqlServerIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { mssqlServerIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { mssqlServerIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { mssqlServerIdRef+: { name: name } } } },
      },
      '#mssqlServerIdSelector':: d.obj(help='"Selector for a MSSQLServer in sql to populate mssqlServerId."'),
      mssqlServerIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { mssqlServerIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { mssqlServerIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { mssqlServerIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { mssqlServerIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { mssqlServerIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withMssqlServerId':: d.fn(help='"The ID of the mssql server. Changing this forces a new MSSQL Server DNS Alias to be created."', args=[d.arg(name='mssqlServerId', type=d.T.string)]),
      withMssqlServerId(mssqlServerId): { spec+: { forProvider+: { mssqlServerId: mssqlServerId } } },
    },
