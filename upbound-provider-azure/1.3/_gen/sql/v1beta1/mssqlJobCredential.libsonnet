{
  ...
  '#':: d.pkg(name='mssqlJobCredential', url='', help='"MSSQLJobCredential is the Schema for the MSSQLJobCredentials API. Manages an Elastic Job Credential."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLJobCredential', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLJobCredentialSpec defines the desired state of MSSQLJobCredential"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#jobAgentIdRef':: d.obj(help='"Reference to a MSSQLJobAgent in sql to populate jobAgentId."'),
      jobAgentIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { jobAgentIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { jobAgentIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { jobAgentIdRef+: { name: name } } } },
      },
      '#jobAgentIdSelector':: d.obj(help='"Selector for a MSSQLJobAgent in sql to populate jobAgentId."'),
      jobAgentIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { jobAgentIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { jobAgentIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { jobAgentIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { jobAgentIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { jobAgentIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#passwordSecretRef':: d.obj(help='"The password part of the credential."'),
      passwordSecretRef: {
      ...
      '#withJobAgentId':: d.fn(help='"The ID of the Elastic Job Agent. Changing this forces a new Elastic Job Credential to be created."', args=[d.arg(name='jobAgentId', type=d.T.string)]),
      withJobAgentId(jobAgentId): { spec+: { forProvider+: { jobAgentId: jobAgentId } } },
      '#withUsername':: d.fn(help='"The username part of the credential."', args=[d.arg(name='username', type=d.T.string)]),
