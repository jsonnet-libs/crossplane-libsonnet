{
  ...
  '#':: d.pkg(name='mssqlFirewallRule', url='', help='"MSSQLFirewallRule is the Schema for the MSSQLFirewallRules API. Manages an Azure SQL Firewall Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLFirewallRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLFirewallRuleSpec defines the desired state of MSSQLFirewallRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEndIpAddress':: d.fn(help='"The ending IP address to allow through the firewall for this rule."', args=[d.arg(name='endIpAddress', type=d.T.string)]),
      withEndIpAddress(endIpAddress): { spec+: { forProvider+: { endIpAddress: endIpAddress } } },
      '#withServerId':: d.fn(help='"The resource ID of the SQL Server on which to create the Firewall Rule. Changing this forces a new resource to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
      withServerId(serverId): { spec+: { forProvider+: { serverId: serverId } } },
      '#withStartIpAddress':: d.fn(help='"The starting IP address to allow through the firewall for this rule."', args=[d.arg(name='startIpAddress', type=d.T.string)]),
