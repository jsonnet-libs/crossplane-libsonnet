{
  ...
  '#':: d.pkg(name='mssqlElasticPool', url='', help='"MSSQLElasticPool is the Schema for the MSSQLElasticPools API. Manages an Azure SQL Elastic Pool."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLElasticPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLElasticPoolSpec defines the desired state of MSSQLElasticPool"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#perDatabaseSettings':: d.obj(help='"A per_database_settings block as defined below."'),
      perDatabaseSettings: {
        '#withMaxCapacity':: d.fn(help='"The maximum capacity any one database can consume."', args=[d.arg(name='maxCapacity', type=d.T.number)]),
        withMaxCapacity(maxCapacity): { maxCapacity: maxCapacity },
        '#withMinCapacity':: d.fn(help='"The minimum capacity all databases are guaranteed."', args=[d.arg(name='minCapacity', type=d.T.number)]),
      ...
      sku: {
        '#withCapacity':: d.fn(help="\"The scale up/out capacity, representing server's compute units. For more information see the documentation for your Elasticpool configuration: vCore-based or DTU-based.\"", args=[d.arg(name='capacity', type=d.T.number)]),
        withCapacity(capacity): { capacity: capacity },
        '#withFamily':: d.fn(help='"The family of hardware Gen4, Gen5, Fsv2 or DC."', args=[d.arg(name='family', type=d.T.string)]),
        withFamily(family): { family: family },
        '#withName':: d.fn(help='"Specifies the SKU Name for this Elasticpool. The name of the SKU, will be either vCore based or DTU based. Possible DTU based values are BasicPool, StandardPool, PremiumPool while possible vCore based values are GP_Gen4, GP_Gen5, GP_Fsv2, GP_DC, BC_Gen4, BC_Gen5, BC_DC, or HS_Gen5."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withTier':: d.fn(help='"The tier of the particular SKU. Possible values are GeneralPurpose, BusinessCritical, Basic, Standard, Premium, or HyperScale. For more information see the documentation for your Elasticpool configuration: vCore-based or DTU-based."', args=[d.arg(name='tier', type=d.T.string)]),
        withTier(tier): { tier: tier },
      },
      '#withEnclaveType':: d.fn(help='"Specifies the type of enclave to be used by the elastic pool. Possible value VBS."', args=[d.arg(name='enclaveType', type=d.T.string)]),
      ...
      '#withMaxSizeBytes':: d.fn(help='"The max data size of the elastic pool in bytes. Conflicts with max_size_gb."', args=[d.arg(name='maxSizeBytes', type=d.T.number)]),
      withMaxSizeBytes(maxSizeBytes): { spec+: { forProvider+: { maxSizeBytes: maxSizeBytes } } },
      '#withMaxSizeGb':: d.fn(help='"The max data size of the elastic pool in gigabytes. Conflicts with max_size_bytes."', args=[d.arg(name='maxSizeGb', type=d.T.number)]),
      withMaxSizeGb(maxSizeGb): { spec+: { forProvider+: { maxSizeGb: maxSizeGb } } },
      '#withPerDatabaseSettings':: d.fn(help='"A per_database_settings block as defined below."', args=[d.arg(name='perDatabaseSettings', type=d.T.array)]),
      withPerDatabaseSettings(perDatabaseSettings): { spec+: { forProvider+: { perDatabaseSettings: if std.isArray(v=perDatabaseSettings) then perDatabaseSettings else [perDatabaseSettings] } } },
      '#withPerDatabaseSettingsMixin':: d.fn(help='"A per_database_settings block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='perDatabaseSettings', type=d.T.array)]),
      withPerDatabaseSettingsMixin(perDatabaseSettings): { spec+: { forProvider+: { perDatabaseSettings+: if std.isArray(v=perDatabaseSettings) then perDatabaseSettings else [perDatabaseSettings] } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the elastic pool. This must be the same as the resource group of the underlying SQL server. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServerName':: d.fn(help='"The name of the SQL Server on which to create the elastic pool. Changing this forces a new resource to be created."', args=[d.arg(name='serverName', type=d.T.string)]),
      ...
      '#withZoneRedundant':: d.fn(help='"Whether or not this elastic pool is zone redundant. tier needs to be Premium for DTU based or BusinessCritical for vCore based sku."', args=[d.arg(name='zoneRedundant', type=d.T.boolean)]),
    ...
    initProvider: {
      ...
      '#withMaxSizeBytes':: d.fn(help='"The max data size of the elastic pool in bytes. Conflicts with max_size_gb."', args=[d.arg(name='maxSizeBytes', type=d.T.number)]),
      withMaxSizeBytes(maxSizeBytes): { spec+: { initProvider+: { maxSizeBytes: maxSizeBytes } } },
      '#withMaxSizeGb':: d.fn(help='"The max data size of the elastic pool in gigabytes. Conflicts with max_size_bytes."', args=[d.arg(name='maxSizeGb', type=d.T.number)]),
      withMaxSizeGb(maxSizeGb): { spec+: { initProvider+: { maxSizeGb: maxSizeGb } } },
      '#withPerDatabaseSettings':: d.fn(help='"A per_database_settings block as defined below."', args=[d.arg(name='perDatabaseSettings', type=d.T.array)]),
      withPerDatabaseSettings(perDatabaseSettings): { spec+: { initProvider+: { perDatabaseSettings: if std.isArray(v=perDatabaseSettings) then perDatabaseSettings else [perDatabaseSettings] } } },
      '#withPerDatabaseSettingsMixin':: d.fn(help='"A per_database_settings block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='perDatabaseSettings', type=d.T.array)]),
      withPerDatabaseSettingsMixin(perDatabaseSettings): { spec+: { initProvider+: { perDatabaseSettings+: if std.isArray(v=perDatabaseSettings) then perDatabaseSettings else [perDatabaseSettings] } } },
      '#withSku':: d.fn(help='"A sku block as defined below."', args=[d.arg(name='sku', type=d.T.array)]),
