{
  ...
  '#':: d.pkg(name='mssqlOutboundFirewallRule', url='', help='"MSSQLOutboundFirewallRule is the Schema for the MSSQLOutboundFirewallRules API. Manages an Azure SQL Outbound Firewall Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLOutboundFirewallRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLOutboundFirewallRuleSpec defines the desired state of MSSQLOutboundFirewallRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withServerId':: d.fn(help='"The resource ID of the SQL Server on which to create the Outbound Firewall Rule. Changing this forces a new resource to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
