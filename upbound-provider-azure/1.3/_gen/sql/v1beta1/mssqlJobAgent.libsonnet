{
  ...
  '#':: d.pkg(name='mssqlJobAgent', url='', help='"MSSQLJobAgent is the Schema for the MSSQLJobAgents API. Manages an Elastic Job Agent."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLJobAgent', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLJobAgentSpec defines the desired state of MSSQLJobAgent"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDatabaseId':: d.fn(help='"The ID of the database to store metadata for the Elastic Job Agent. Changing this forces a new Elastic Job Agent to be created."', args=[d.arg(name='databaseId', type=d.T.string)]),
      withDatabaseId(databaseId): { spec+: { forProvider+: { databaseId: databaseId } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Elastic Job Agent should exist. Changing this forces a new Elastic Job Agent to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"The name which should be used for this Elastic Job Agent. Changing this forces a new Elastic Job Agent to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Database."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Database."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
