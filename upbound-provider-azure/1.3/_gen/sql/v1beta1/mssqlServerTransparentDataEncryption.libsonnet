{
  ...
  '#':: d.pkg(name='mssqlServerTransparentDataEncryption', url='', help='"MSSQLServerTransparentDataEncryption is the Schema for the MSSQLServerTransparentDataEncryptions API. Manages the transparent data encryption configuration for a MSSQL Server"'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLServerTransparentDataEncryption', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLServerTransparentDataEncryptionSpec defines the desired state of MSSQLServerTransparentDataEncryption"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoRotationEnabled':: d.fn(help='"When enabled, the server will continuously check the key vault for any new versions of the key being used as the TDE protector. If a new version of the key is detected, the TDE protector on the server will be automatically rotated to the latest key version within 60 minutes."', args=[d.arg(name='autoRotationEnabled', type=d.T.boolean)]),
      withAutoRotationEnabled(autoRotationEnabled): { spec+: { forProvider+: { autoRotationEnabled: autoRotationEnabled } } },
      '#withKeyVaultKeyId':: d.fn(help='"To use customer managed keys from Azure Key Vault, provide the AKV Key ID. To use service managed keys, omit this field."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
      withKeyVaultKeyId(keyVaultKeyId): { spec+: { forProvider+: { keyVaultKeyId: keyVaultKeyId } } },
      '#withServerId':: d.fn(help='"Specifies the name of the MS SQL Server. Changing this forces a new resource to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAutoRotationEnabled':: d.fn(help='"When enabled, the server will continuously check the key vault for any new versions of the key being used as the TDE protector. If a new version of the key is detected, the TDE protector on the server will be automatically rotated to the latest key version within 60 minutes."', args=[d.arg(name='autoRotationEnabled', type=d.T.boolean)]),
      withAutoRotationEnabled(autoRotationEnabled): { spec+: { initProvider+: { autoRotationEnabled: autoRotationEnabled } } },
      '#withKeyVaultKeyId':: d.fn(help='"To use customer managed keys from Azure Key Vault, provide the AKV Key ID. To use service managed keys, omit this field."', args=[d.arg(name='keyVaultKeyId', type=d.T.string)]),
