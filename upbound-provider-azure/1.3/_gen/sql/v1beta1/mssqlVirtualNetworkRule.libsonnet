{
  ...
  '#':: d.pkg(name='mssqlVirtualNetworkRule', url='', help='"MSSQLVirtualNetworkRule is the Schema for the MSSQLVirtualNetworkRules API. Manages an Azure SQL Virtual Network Rule."'),
  ...
  '#new':: d.fn(help='new returns an instance of MSSQLVirtualNetworkRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MSSQLVirtualNetworkRuleSpec defines the desired state of MSSQLVirtualNetworkRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIgnoreMissingVnetServiceEndpoint':: d.fn(help='"Create the virtual network rule before the subnet has the virtual network service endpoint enabled. Defaults to false."', args=[d.arg(name='ignoreMissingVnetServiceEndpoint', type=d.T.boolean)]),
      ...
      '#withServerId':: d.fn(help='"The resource ID of the SQL Server to which this SQL virtual network rule will be applied. Changing this forces a new resource to be created."', args=[d.arg(name='serverId', type=d.T.string)]),
      withServerId(serverId): { spec+: { forProvider+: { serverId: serverId } } },
      '#withSubnetId':: d.fn(help='"The ID of the subnet from which the SQL server will accept communications."', args=[d.arg(name='subnetId', type=d.T.string)]),
