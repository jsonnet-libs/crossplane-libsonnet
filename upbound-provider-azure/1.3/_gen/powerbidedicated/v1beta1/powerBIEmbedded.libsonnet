{
  ...
  '#':: d.pkg(name='powerBIEmbedded', url='', help='"PowerBIEmbedded is the Schema for the PowerBIEmbeddeds API. Manages a PowerBI Embedded."'),
  ...
  '#new':: d.fn(help='new returns an instance of PowerBIEmbedded', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PowerBIEmbeddedSpec defines the desired state of PowerBIEmbedded"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAdministrators':: d.fn(help='"A set of administrator user identities, which manages the Power BI Embedded and must be a member user or a service principal in your AAD tenant."', args=[d.arg(name='administrators', type=d.T.array)]),
      withAdministrators(administrators): { spec+: { forProvider+: { administrators: if std.isArray(v=administrators) then administrators else [administrators] } } },
      '#withAdministratorsMixin':: d.fn(help='"A set of administrator user identities, which manages the Power BI Embedded and must be a member user or a service principal in your AAD tenant."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='administrators', type=d.T.array)]),
      withAdministratorsMixin(administrators): { spec+: { forProvider+: { administrators+: if std.isArray(v=administrators) then administrators else [administrators] } } },
      ...
      '#withMode':: d.fn(help="\"Sets the PowerBI Embedded's mode. Possible values include: Gen1, Gen2. Defaults to Gen1. Changing this forces a new resource to be created.\"", args=[d.arg(name='mode', type=d.T.string)]),
      withMode(mode): { spec+: { forProvider+: { mode: mode } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the PowerBI Embedded should be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help="\"Sets the PowerBI Embedded's pricing level's SKU. Possible values include: A1, A2, A3, A4, A5, A6.\"", args=[d.arg(name='skuName', type=d.T.string)]),
    ...
    initProvider: {
      '#withAdministrators':: d.fn(help='"A set of administrator user identities, which manages the Power BI Embedded and must be a member user or a service principal in your AAD tenant."', args=[d.arg(name='administrators', type=d.T.array)]),
      withAdministrators(administrators): { spec+: { initProvider+: { administrators: if std.isArray(v=administrators) then administrators else [administrators] } } },
      '#withAdministratorsMixin':: d.fn(help='"A set of administrator user identities, which manages the Power BI Embedded and must be a member user or a service principal in your AAD tenant."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='administrators', type=d.T.array)]),
      withAdministratorsMixin(administrators): { spec+: { initProvider+: { administrators+: if std.isArray(v=administrators) then administrators else [administrators] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
