{
  ...
  '#':: d.pkg(name='maintenanceAssignmentVirtualMachine', url='', help='"MaintenanceAssignmentVirtualMachine is the Schema for the MaintenanceAssignmentVirtualMachines API. Manages a Maintenance Assignment."'),
  ...
  '#new':: d.fn(help='new returns an instance of MaintenanceAssignmentVirtualMachine', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MaintenanceAssignmentVirtualMachineSpec defines the desired state of MaintenanceAssignmentVirtualMachine"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withVirtualMachineId':: d.fn(help='"Specifies the Virtual Machine ID to which the Maintenance Configuration will be assigned. Changing this forces a new resource to be created."', args=[d.arg(name='virtualMachineId', type=d.T.string)]),
