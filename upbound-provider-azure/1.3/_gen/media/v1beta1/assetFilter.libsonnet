  ...
  spec: {
    ...
    forProvider: {
      ...
      presentationTimeRange: {
        ...
        withUnitTimescaleInMiliseconds(unitTimescaleInMiliseconds): { unitTimescaleInMiliseconds: unitTimescaleInMiliseconds },
      },
    ...
    initProvider: {
      ...
      '#withPresentationTimeRange':: d.fn(help='"A presentation_time_range block as defined below."', args=[d.arg(name='presentationTimeRange', type=d.T.array)]),
      withPresentationTimeRange(presentationTimeRange): { spec+: { initProvider+: { presentationTimeRange: if std.isArray(v=presentationTimeRange) then presentationTimeRange else [presentationTimeRange] } } },
      '#withPresentationTimeRangeMixin':: d.fn(help='"A presentation_time_range block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='presentationTimeRange', type=d.T.array)]),
      withPresentationTimeRangeMixin(presentationTimeRange): { spec+: { initProvider+: { presentationTimeRange+: if std.isArray(v=presentationTimeRange) then presentationTimeRange else [presentationTimeRange] } } },
      '#withTrackSelection':: d.fn(help='"One or more track_selection blocks as defined below."', args=[d.arg(name='trackSelection', type=d.T.array)]),
