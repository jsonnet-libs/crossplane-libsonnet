{
  ...
  '#':: d.pkg(name='asset', url='', help='"Asset is the Schema for the Assets API. Manages a Media Asset."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAlternateId':: d.fn(help='"The alternate ID of the Asset."', args=[d.arg(name='alternateId', type=d.T.string)]),
      withAlternateId(alternateId): { spec+: { forProvider+: { alternateId: alternateId } } },
      '#withContainer':: d.fn(help='"The name of the asset blob container. Changing this forces a new Media Asset to be created."', args=[d.arg(name='container', type=d.T.string)]),
      withContainer(container): { spec+: { forProvider+: { container: container } } },
      '#withDescription':: d.fn(help='"The Asset description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withMediaServicesAccountName':: d.fn(help='"Specifies the name of the Media Services Account. Changing this forces a new Media Asset to be created."', args=[d.arg(name='mediaServicesAccountName', type=d.T.string)]),
      withMediaServicesAccountName(mediaServicesAccountName): { spec+: { forProvider+: { mediaServicesAccountName: mediaServicesAccountName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Media Asset should exist. Changing this forces a new Media Asset to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withStorageAccountName':: d.fn(help='"The name of the storage account where to store the media asset. Changing this forces a new Media Asset to be created."', args=[d.arg(name='storageAccountName', type=d.T.string)]),
    ...
    initProvider: {
      '#withAlternateId':: d.fn(help='"The alternate ID of the Asset."', args=[d.arg(name='alternateId', type=d.T.string)]),
      withAlternateId(alternateId): { spec+: { initProvider+: { alternateId: alternateId } } },
      '#withContainer':: d.fn(help='"The name of the asset blob container. Changing this forces a new Media Asset to be created."', args=[d.arg(name='container', type=d.T.string)]),
