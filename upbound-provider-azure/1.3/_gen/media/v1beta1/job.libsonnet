{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInputAsset':: d.fn(help='"A input_asset block as defined below. Changing this forces a new Media Job to be created."', args=[d.arg(name='inputAsset', type=d.T.array)]),
      withInputAsset(inputAsset): { spec+: { forProvider+: { inputAsset: if std.isArray(v=inputAsset) then inputAsset else [inputAsset] } } },
      '#withInputAssetMixin':: d.fn(help='"A input_asset block as defined below. Changing this forces a new Media Job to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='inputAsset', type=d.T.array)]),
      withInputAssetMixin(inputAsset): { spec+: { forProvider+: { inputAsset+: if std.isArray(v=inputAsset) then inputAsset else [inputAsset] } } },
    ...
    initProvider: {
      ...
      '#withInputAsset':: d.fn(help='"A input_asset block as defined below. Changing this forces a new Media Job to be created."', args=[d.arg(name='inputAsset', type=d.T.array)]),
      withInputAsset(inputAsset): { spec+: { initProvider+: { inputAsset: if std.isArray(v=inputAsset) then inputAsset else [inputAsset] } } },
      '#withInputAssetMixin':: d.fn(help='"A input_asset block as defined below. Changing this forces a new Media Job to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='inputAsset', type=d.T.array)]),
      withInputAssetMixin(inputAsset): { spec+: { initProvider+: { inputAsset+: if std.isArray(v=inputAsset) then inputAsset else [inputAsset] } } },
      '#withOutputAsset':: d.fn(help='"One or more output_asset blocks as defined below. Changing this forces a new Media Job to be created."', args=[d.arg(name='outputAsset', type=d.T.array)]),
