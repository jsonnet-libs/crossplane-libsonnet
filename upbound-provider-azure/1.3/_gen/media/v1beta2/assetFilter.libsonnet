{
  ...
  '#':: d.pkg(name='assetFilter', url='', help='"AssetFilter is the Schema for the AssetFilters API. Manages an Azure Media Asset Filter."'),
  ...
  '#new':: d.fn(help='new returns an instance of AssetFilter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AssetFilterSpec defines the desired state of AssetFilter"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#assetIdRef':: d.obj(help='"Reference to a Asset in media to populate assetId."'),
      assetIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { assetIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { assetIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { assetIdRef+: { name: name } } } },
      },
      '#assetIdSelector':: d.obj(help='"Selector for a Asset in media to populate assetId."'),
      assetIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { assetIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { assetIdSelector+: { policy+: { resolve: resolve } } } } },
        },
      ...
      presentationTimeRange: {
        ...
        withForceEnd(forceEnd): { spec+: { forProvider+: { presentationTimeRange+: { forceEnd: forceEnd } } } },
        '#withLiveBackoffInUnits':: d.fn(help='"The relative to end right edge. Applies to Live Streaming only.\\nThis value defines the latest live position that a client can seek to. Using this property, you can delay live playback position and create a server-side buffer for players. The unit is defined by unit_timescale_in_miliseconds. The maximum live back off duration is 300 seconds. For example, a value of 20 means that the latest available content is 20 seconds delayed from the real live edge."', args=[d.arg(name='liveBackoffInUnits', type=d.T.number)]),
        withLiveBackoffInUnits(liveBackoffInUnits): { spec+: { forProvider+: { presentationTimeRange+: { liveBackoffInUnits: liveBackoffInUnits } } } },
        '#withPresentationWindowInUnits':: d.fn(help='"The relative to end sliding window. Applies to Live Streaming only. Use presentation_window_in_units to apply a sliding window of fragments to include in a playlist. The unit is defined by unit_timescale_in_miliseconds. For example, set presentation_window_in_units to 120 to apply a two-minute sliding window. Media within 2 minutes of the live edge will be included in the playlist. If a fragment straddles the boundary, the entire fragment will be included in the playlist. The minimum presentation window duration is 60 seconds."', args=[d.arg(name='presentationWindowInUnits', type=d.T.number)]),
        withPresentationWindowInUnits(presentationWindowInUnits): { spec+: { forProvider+: { presentationTimeRange+: { presentationWindowInUnits: presentationWindowInUnits } } } },
        ...
        withStartInUnits(startInUnits): { spec+: { forProvider+: { presentationTimeRange+: { startInUnits: startInUnits } } } },
        '#withUnitTimescaleInMiliseconds':: d.fn(help='"Specified as the number of miliseconds in one unit timescale. For example, if you want to set a start_in_units at 30 seconds, you would use a value of 30 when using the unit_timescale_in_miliseconds in 1000. Or if you want to set start_in_units in 30 miliseconds, you would use a value of 30 when using the unit_timescale_in_miliseconds in 1. Applies timescale to start_in_units, start_timescale and presentation_window_in_timescale and live_backoff_in_timescale."', args=[d.arg(name='unitTimescaleInMiliseconds', type=d.T.number)]),
        withUnitTimescaleInMiliseconds(unitTimescaleInMiliseconds): { spec+: { forProvider+: { presentationTimeRange+: { unitTimescaleInMiliseconds: unitTimescaleInMiliseconds } } } },
      },
      ...
      '#withAssetId':: d.fn(help='"The Asset ID for which the Asset Filter should be created. Changing this forces a new Asset Filter to be created."', args=[d.arg(name='assetId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      presentationTimeRange: {
        '#withEndInUnits':: d.fn(help='"The absolute end time boundary. Applies to Video on Demand (VoD).\\nFor the Live Streaming presentation, it is silently ignored and applied when the presentation ends and the stream becomes VoD. This is a long value that represents an absolute end point of the presentation, rounded to the closest next GOP start. The unit is defined by unit_timescale_in_miliseconds, so an end_in_units of 180 would be for 3 minutes. Use start_in_units and end_in_units to trim the fragments that will be in the playlist (manifest). For example, start_in_units set to 20 and end_in_units set to 60 using unit_timescale_in_miliseconds in 1000 will generate a playlist that contains fragments from between 20 seconds and 60 seconds of the VoD presentation. If a fragment straddles the boundary, the entire fragment will be included in the manifest."', args=[d.arg(name='endInUnits', type=d.T.number)]),
        withEndInUnits(endInUnits): { spec+: { initProvider+: { presentationTimeRange+: { endInUnits: endInUnits } } } },
        '#withForceEnd':: d.fn(help='"Indicates whether the end_in_units property must be present. If true, end_in_units must be specified or a bad request code is returned. Applies to Live Streaming only. Allowed values: false, true."', args=[d.arg(name='forceEnd', type=d.T.boolean)]),
        withForceEnd(forceEnd): { spec+: { initProvider+: { presentationTimeRange+: { forceEnd: forceEnd } } } },
        '#withLiveBackoffInUnits':: d.fn(help='"The relative to end right edge. Applies to Live Streaming only.\\nThis value defines the latest live position that a client can seek to. Using this property, you can delay live playback position and create a server-side buffer for players. The unit is defined by unit_timescale_in_miliseconds. The maximum live back off duration is 300 seconds. For example, a value of 20 means that the latest available content is 20 seconds delayed from the real live edge."', args=[d.arg(name='liveBackoffInUnits', type=d.T.number)]),
        withLiveBackoffInUnits(liveBackoffInUnits): { spec+: { initProvider+: { presentationTimeRange+: { liveBackoffInUnits: liveBackoffInUnits } } } },
        '#withPresentationWindowInUnits':: d.fn(help='"The relative to end sliding window. Applies to Live Streaming only. Use presentation_window_in_units to apply a sliding window of fragments to include in a playlist. The unit is defined by unit_timescale_in_miliseconds. For example, set presentation_window_in_units to 120 to apply a two-minute sliding window. Media within 2 minutes of the live edge will be included in the playlist. If a fragment straddles the boundary, the entire fragment will be included in the playlist. The minimum presentation window duration is 60 seconds."', args=[d.arg(name='presentationWindowInUnits', type=d.T.number)]),
        withPresentationWindowInUnits(presentationWindowInUnits): { spec+: { initProvider+: { presentationTimeRange+: { presentationWindowInUnits: presentationWindowInUnits } } } },
        '#withStartInUnits':: d.fn(help='"The absolute start time boundary. Applies to Video on Demand (VoD) or Live Streaming. This is a long value that represents an absolute start point of the stream. The value gets rounded to the closest next GOP start. The unit is defined by unit_timescale_in_miliseconds, so a start_in_units of 15 would be for 15 seconds. Use start_in_units and end_in_units to trim the fragments that will be in the playlist (manifest). For example, start_in_units set to 20 and end_in_units set to 60 using unit_timescale_in_miliseconds in 1000 will generate a playlist that contains fragments from between 20 seconds and 60 seconds of the VoD presentation. If a fragment straddles the boundary, the entire fragment will be included in the manifest."', args=[d.arg(name='startInUnits', type=d.T.number)]),
        withStartInUnits(startInUnits): { spec+: { initProvider+: { presentationTimeRange+: { startInUnits: startInUnits } } } },
        '#withUnitTimescaleInMiliseconds':: d.fn(help='"Specified as the number of miliseconds in one unit timescale. For example, if you want to set a start_in_units at 30 seconds, you would use a value of 30 when using the unit_timescale_in_miliseconds in 1000. Or if you want to set start_in_units in 30 miliseconds, you would use a value of 30 when using the unit_timescale_in_miliseconds in 1. Applies timescale to start_in_units, start_timescale and presentation_window_in_timescale and live_backoff_in_timescale."', args=[d.arg(name='unitTimescaleInMiliseconds', type=d.T.number)]),
        withUnitTimescaleInMiliseconds(unitTimescaleInMiliseconds): { spec+: { initProvider+: { presentationTimeRange+: { unitTimescaleInMiliseconds: unitTimescaleInMiliseconds } } } },
      },
      '#trackSelection':: d.obj(help='"One or more track_selection blocks as defined below."'),
      trackSelection: {
        '#condition':: d.obj(help='"One or more condition blocks as defined above."'),
      ...
      '#withFirstQualityBitrate':: d.fn(help='"The first quality bitrate. Sets the first video track to appear in the Live Streaming playlist to allow HLS native players to start downloading from this quality level at the beginning."', args=[d.arg(name='firstQualityBitrate', type=d.T.number)]),
      withFirstQualityBitrate(firstQualityBitrate): { spec+: { initProvider+: { firstQualityBitrate: firstQualityBitrate } } },
      '#withTrackSelection':: d.fn(help='"One or more track_selection blocks as defined below."', args=[d.arg(name='trackSelection', type=d.T.array)]),
      withTrackSelection(trackSelection): { spec+: { initProvider+: { trackSelection: if std.isArray(v=trackSelection) then trackSelection else [trackSelection] } } },
      '#withTrackSelectionMixin':: d.fn(help='"One or more track_selection blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='trackSelection', type=d.T.array)]),
      withTrackSelectionMixin(trackSelection): { spec+: { initProvider+: { trackSelection+: if std.isArray(v=trackSelection) then trackSelection else [trackSelection] } } },
    },
