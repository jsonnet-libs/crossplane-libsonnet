{
  ...
  '#':: d.pkg(name='resourceProviderRegistration', url='', help='"ResourceProviderRegistration is the Schema for the ResourceProviderRegistrations API. Manages the Registration of a Resource Provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceProviderRegistration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ResourceProviderRegistrationSpec defines the desired state of ResourceProviderRegistration"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#feature':: d.obj(help='"A list of feature blocks as defined below."'),
      feature: {
        '#withName':: d.fn(help='"Specifies the name of the feature to register."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRegistered':: d.fn(help='"Should this feature be Registered or Unregistered?"', args=[d.arg(name='registered', type=d.T.boolean)]),
        withRegistered(registered): { registered: registered },
      },
      '#withFeature':: d.fn(help='"A list of feature blocks as defined below."', args=[d.arg(name='feature', type=d.T.array)]),
      withFeature(feature): { spec+: { forProvider+: { feature: if std.isArray(v=feature) then feature else [feature] } } },
      '#withFeatureMixin':: d.fn(help='"A list of feature blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='feature', type=d.T.array)]),
      withFeatureMixin(feature): { spec+: { forProvider+: { feature+: if std.isArray(v=feature) then feature else [feature] } } },
      '#withName':: d.fn(help='"The namespace of the Resource Provider which should be registered. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withFeature':: d.fn(help='"A list of feature blocks as defined below."', args=[d.arg(name='feature', type=d.T.array)]),
      withFeature(feature): { spec+: { initProvider+: { feature: if std.isArray(v=feature) then feature else [feature] } } },
      '#withFeatureMixin':: d.fn(help='"A list of feature blocks as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='feature', type=d.T.array)]),
      withFeatureMixin(feature): { spec+: { initProvider+: { feature+: if std.isArray(v=feature) then feature else [feature] } } },
      '#withName':: d.fn(help='"The namespace of the Resource Provider which should be registered. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
