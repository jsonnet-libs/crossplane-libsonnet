{
  ...
  '#':: d.pkg(name='resourceGroup', url='', help='"ResourceGroup is the Schema for the ResourceGroups API. Manages a Resource Group."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withManagedBy':: d.fn(help='"The ID of the resource or application that manages this Resource Group."', args=[d.arg(name='managedBy', type=d.T.string)]),
      withManagedBy(managedBy): { spec+: { forProvider+: { managedBy: managedBy } } },
    ...
    initProvider: {
      ...
      '#withManagedBy':: d.fn(help='"The ID of the resource or application that manages this Resource Group."', args=[d.arg(name='managedBy', type=d.T.string)]),
      withManagedBy(managedBy): { spec+: { initProvider+: { managedBy: managedBy } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Resource Group."', args=[d.arg(name='tags', type=d.T.object)]),
