{
  ...
  '#':: d.pkg(name='subscription', url='', help='"Subscription is the Schema for the Subscriptions API. Manages a Subscription."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBillingScopeId':: d.fn(help='"The Azure Billing Scope ID. Can be a Microsoft Customer Account Billing Scope ID, a Microsoft Partner Account Billing Scope ID or an Enrollment Billing Scope ID."', args=[d.arg(name='billingScopeId', type=d.T.string)]),
      withBillingScopeId(billingScopeId): { spec+: { forProvider+: { billingScopeId: billingScopeId } } },
      '#withSubscriptionId':: d.fn(help='"The ID of the Subscription. Changing this forces a new Subscription to be created.\\nThe GUID of the Subscription."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
      withSubscriptionId(subscriptionId): { spec+: { forProvider+: { subscriptionId: subscriptionId } } },
      '#withSubscriptionName':: d.fn(help='"The Name of the Subscription. This is the Display Name in the portal.\\nThe Display Name for the Subscription."', args=[d.arg(name='subscriptionName', type=d.T.string)]),
      withSubscriptionName(subscriptionName): { spec+: { forProvider+: { subscriptionName: subscriptionName } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the Subscription."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the Subscription."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withWorkload':: d.fn(help='"The workload type of the Subscription. Possible values are Production (default) and DevTest. Changing this forces a new Subscription to be created.\\nThe workload type for the Subscription. Possible values are `Production` (default) and `DevTest`."', args=[d.arg(name='workload', type=d.T.string)]),
      withWorkload(workload): { spec+: { forProvider+: { workload: workload } } },
    },
    ...
    initProvider: {
      '#withBillingScopeId':: d.fn(help='"The Azure Billing Scope ID. Can be a Microsoft Customer Account Billing Scope ID, a Microsoft Partner Account Billing Scope ID or an Enrollment Billing Scope ID."', args=[d.arg(name='billingScopeId', type=d.T.string)]),
      withBillingScopeId(billingScopeId): { spec+: { initProvider+: { billingScopeId: billingScopeId } } },
      '#withSubscriptionId':: d.fn(help='"The ID of the Subscription. Changing this forces a new Subscription to be created.\\nThe GUID of the Subscription."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
      ...
      '#withWorkload':: d.fn(help='"The workload type of the Subscription. Possible values are Production (default) and DevTest. Changing this forces a new Subscription to be created.\\nThe workload type for the Subscription. Possible values are `Production` (default) and `DevTest`."', args=[d.arg(name='workload', type=d.T.string)]),
      withWorkload(workload): { spec+: { initProvider+: { workload: workload } } },
    },
