{
  ...
  '#':: d.pkg(name='iotHubCertificate', url='', help='"IOTHubCertificate is the Schema for the IOTHubCertificates API. Manages an IoTHub Certificate."'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubCertificateSpec defines the desired state of IOTHubCertificate"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIothubName':: d.fn(help='"The name of the IoTHub that this certificate will be attached to. Changing this forces a new resource to be created."', args=[d.arg(name='iothubName', type=d.T.string)]),
      withIothubName(iothubName): { spec+: { forProvider+: { iothubName: iothubName } } },
      '#withIsVerified':: d.fn(help='"Is the certificate verified? Defaults to false."', args=[d.arg(name='isVerified', type=d.T.boolean)]),
      withIsVerified(isVerified): { spec+: { forProvider+: { isVerified: isVerified } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the IotHub Certificate resource has to be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
