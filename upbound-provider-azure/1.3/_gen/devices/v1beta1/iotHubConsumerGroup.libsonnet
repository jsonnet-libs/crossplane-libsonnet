{
  ...
  '#':: d.pkg(name='iotHubConsumerGroup', url='', help='"IOTHubConsumerGroup is the Schema for the IOTHubConsumerGroups API. Manages a Consumer Group within an IotHub"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubConsumerGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubConsumerGroupSpec defines the desired state of IOTHubConsumerGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEventhubEndpointName':: d.fn(help='"The name of the Event Hub-compatible endpoint in the IoT hub. Changing this forces a new resource to be created."', args=[d.arg(name='eventhubEndpointName', type=d.T.string)]),
      withEventhubEndpointName(eventhubEndpointName): { spec+: { forProvider+: { eventhubEndpointName: eventhubEndpointName } } },
      '#withIothubName':: d.fn(help='"The name of the IoT Hub. Changing this forces a new resource to be created."', args=[d.arg(name='iothubName', type=d.T.string)]),
      withIothubName(iothubName): { spec+: { forProvider+: { iothubName: iothubName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group that contains the IoT hub. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
