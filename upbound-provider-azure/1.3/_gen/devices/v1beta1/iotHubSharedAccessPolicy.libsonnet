{
  ...
  '#':: d.pkg(name='iotHubSharedAccessPolicy', url='', help='"IOTHubSharedAccessPolicy is the Schema for the IOTHubSharedAccessPolicys API. Manages an IotHub Shared Access Policy"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubSharedAccessPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubSharedAccessPolicySpec defines the desired state of IOTHubSharedAccessPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDeviceConnect':: d.fn(help='"Adds DeviceConnect permission to this Shared Access Account. It allows sending and receiving on the device-side endpoints."', args=[d.arg(name='deviceConnect', type=d.T.boolean)]),
      withDeviceConnect(deviceConnect): { spec+: { forProvider+: { deviceConnect: deviceConnect } } },
      '#withIothubName':: d.fn(help='"The name of the IoTHub to which this Shared Access Policy belongs. Changing this forces a new resource to be created."', args=[d.arg(name='iothubName', type=d.T.string)]),
      withIothubName(iothubName): { spec+: { forProvider+: { iothubName: iothubName } } },
      '#withRegistryRead':: d.fn(help='"Adds RegistryRead permission to this Shared Access Account. It allows read access to the identity registry."', args=[d.arg(name='registryRead', type=d.T.boolean)]),
      withRegistryRead(registryRead): { spec+: { forProvider+: { registryRead: registryRead } } },
      '#withRegistryWrite':: d.fn(help='"Adds RegistryWrite permission to this Shared Access Account. It allows write access to the identity registry."', args=[d.arg(name='registryWrite', type=d.T.boolean)]),
      withRegistryWrite(registryWrite): { spec+: { forProvider+: { registryWrite: registryWrite } } },
      ...
      '#withServiceConnect':: d.fn(help='"Adds ServiceConnect permission to this Shared Access Account. It allows sending and receiving on the cloud-side endpoints."', args=[d.arg(name='serviceConnect', type=d.T.boolean)]),
      withServiceConnect(serviceConnect): { spec+: { forProvider+: { serviceConnect: serviceConnect } } },
    },
    ...
    initProvider: {
      '#withDeviceConnect':: d.fn(help='"Adds DeviceConnect permission to this Shared Access Account. It allows sending and receiving on the device-side endpoints."', args=[d.arg(name='deviceConnect', type=d.T.boolean)]),
      withDeviceConnect(deviceConnect): { spec+: { initProvider+: { deviceConnect: deviceConnect } } },
      '#withRegistryRead':: d.fn(help='"Adds RegistryRead permission to this Shared Access Account. It allows read access to the identity registry."', args=[d.arg(name='registryRead', type=d.T.boolean)]),
      withRegistryRead(registryRead): { spec+: { initProvider+: { registryRead: registryRead } } },
      '#withRegistryWrite':: d.fn(help='"Adds RegistryWrite permission to this Shared Access Account. It allows write access to the identity registry."', args=[d.arg(name='registryWrite', type=d.T.boolean)]),
      withRegistryWrite(registryWrite): { spec+: { initProvider+: { registryWrite: registryWrite } } },
      '#withServiceConnect':: d.fn(help='"Adds ServiceConnect permission to this Shared Access Account. It allows sending and receiving on the cloud-side endpoints."', args=[d.arg(name='serviceConnect', type=d.T.boolean)]),
      withServiceConnect(serviceConnect): { spec+: { initProvider+: { serviceConnect: serviceConnect } } },
    },
