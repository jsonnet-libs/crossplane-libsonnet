{
  ...
  '#':: d.pkg(name='iotHubDPSSharedAccessPolicy', url='', help='"IOTHubDPSSharedAccessPolicy is the Schema for the IOTHubDPSSharedAccessPolicys API. Manages an IotHub Device Provisioning Service Shared Access Policy"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubDPSSharedAccessPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubDPSSharedAccessPolicySpec defines the desired state of IOTHubDPSSharedAccessPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#iothubDpsNameRef':: d.obj(help='"Reference to a IOTHubDPS in devices to populate iothubDpsName."'),
      iothubDpsNameRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { iothubDpsNameRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { iothubDpsNameRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { iothubDpsNameRef+: { name: name } } } },
      },
      '#iothubDpsNameSelector':: d.obj(help='"Selector for a IOTHubDPS in devices to populate iothubDpsName."'),
      iothubDpsNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { iothubDpsNameSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { iothubDpsNameSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { iothubDpsNameSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { iothubDpsNameSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { iothubDpsNameSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withEnrollmentRead':: d.fn(help='"Adds EnrollmentRead permission to this Shared Access Account. It allows read access to enrollment data."', args=[d.arg(name='enrollmentRead', type=d.T.boolean)]),
      withEnrollmentRead(enrollmentRead): { spec+: { forProvider+: { enrollmentRead: enrollmentRead } } },
      '#withEnrollmentWrite':: d.fn(help='"Adds EnrollmentWrite permission to this Shared Access Account. It allows write access to enrollment data."', args=[d.arg(name='enrollmentWrite', type=d.T.boolean)]),
      withEnrollmentWrite(enrollmentWrite): { spec+: { forProvider+: { enrollmentWrite: enrollmentWrite } } },
      '#withIothubDpsName':: d.fn(help='"The name of the IoT Hub Device Provisioning service to which this Shared Access Policy belongs. Changing this forces a new resource to be created."', args=[d.arg(name='iothubDpsName', type=d.T.string)]),
      withIothubDpsName(iothubDpsName): { spec+: { forProvider+: { iothubDpsName: iothubDpsName } } },
      '#withRegistrationRead':: d.fn(help='"Adds RegistrationStatusRead permission to this Shared Access Account. It allows read access to device registrations."', args=[d.arg(name='registrationRead', type=d.T.boolean)]),
      withRegistrationRead(registrationRead): { spec+: { forProvider+: { registrationRead: registrationRead } } },
      '#withRegistrationWrite':: d.fn(help='"Adds RegistrationStatusWrite permission to this Shared Access Account. It allows write access to device registrations."', args=[d.arg(name='registrationWrite', type=d.T.boolean)]),
      withRegistrationWrite(registrationWrite): { spec+: { forProvider+: { registrationWrite: registrationWrite } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the IotHub Shared Access Policy resource has to be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServiceConfig':: d.fn(help='"Adds ServiceConfig permission to this Shared Access Account. It allows configuration of the Device Provisioning Service."', args=[d.arg(name='serviceConfig', type=d.T.boolean)]),
      withServiceConfig(serviceConfig): { spec+: { forProvider+: { serviceConfig: serviceConfig } } },
    },
    ...
    initProvider: {
      '#withEnrollmentRead':: d.fn(help='"Adds EnrollmentRead permission to this Shared Access Account. It allows read access to enrollment data."', args=[d.arg(name='enrollmentRead', type=d.T.boolean)]),
      withEnrollmentRead(enrollmentRead): { spec+: { initProvider+: { enrollmentRead: enrollmentRead } } },
      '#withEnrollmentWrite':: d.fn(help='"Adds EnrollmentWrite permission to this Shared Access Account. It allows write access to enrollment data."', args=[d.arg(name='enrollmentWrite', type=d.T.boolean)]),
      withEnrollmentWrite(enrollmentWrite): { spec+: { initProvider+: { enrollmentWrite: enrollmentWrite } } },
      '#withRegistrationRead':: d.fn(help='"Adds RegistrationStatusRead permission to this Shared Access Account. It allows read access to device registrations."', args=[d.arg(name='registrationRead', type=d.T.boolean)]),
      withRegistrationRead(registrationRead): { spec+: { initProvider+: { registrationRead: registrationRead } } },
      '#withRegistrationWrite':: d.fn(help='"Adds RegistrationStatusWrite permission to this Shared Access Account. It allows write access to device registrations."', args=[d.arg(name='registrationWrite', type=d.T.boolean)]),
      withRegistrationWrite(registrationWrite): { spec+: { initProvider+: { registrationWrite: registrationWrite } } },
      '#withServiceConfig':: d.fn(help='"Adds ServiceConfig permission to this Shared Access Account. It allows configuration of the Device Provisioning Service."', args=[d.arg(name='serviceConfig', type=d.T.boolean)]),
      withServiceConfig(serviceConfig): { spec+: { initProvider+: { serviceConfig: serviceConfig } } },
    },
