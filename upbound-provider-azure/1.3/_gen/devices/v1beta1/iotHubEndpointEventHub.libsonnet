{
  ...
  '#':: d.pkg(name='iotHubEndpointEventHub', url='', help='"IOTHubEndpointEventHub is the Schema for the IOTHubEndpointEventHubs API. Manages an IotHub EventHub Endpoint"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubEndpointEventHub', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubEndpointEventHubSpec defines the desired state of IOTHubEndpointEventHub"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAuthenticationType':: d.fn(help='"Type used to authenticate against the Event Hub endpoint. Possible values are keyBased and identityBased. Defaults to keyBased."', args=[d.arg(name='authenticationType', type=d.T.string)]),
      withAuthenticationType(authenticationType): { spec+: { forProvider+: { authenticationType: authenticationType } } },
      '#withEndpointUri':: d.fn(help='"URI of the Event Hubs Namespace endpoint. This attribute can only be specified and is mandatory when authentication_type is identityBased."', args=[d.arg(name='endpointUri', type=d.T.string)]),
      withEndpointUri(endpointUri): { spec+: { forProvider+: { endpointUri: endpointUri } } },
      '#withEntityPath':: d.fn(help='"Name of the Event Hub. This attribute can only be specified and is mandatory when authentication_type is identityBased."', args=[d.arg(name='entityPath', type=d.T.string)]),
      withEntityPath(entityPath): { spec+: { forProvider+: { entityPath: entityPath } } },
      '#withIdentityId':: d.fn(help='"ID of the User Managed Identity used to authenticate against the Event Hub endpoint."', args=[d.arg(name='identityId', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the Event Hub has been created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
