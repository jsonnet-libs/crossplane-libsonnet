{
  ...
  '#':: d.pkg(name='iotHubEnrichment', url='', help='"IOTHubEnrichment is the Schema for the IOTHubEnrichments API. Manages an IotHub Enrichment"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubEnrichment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubEnrichmentSpec defines the desired state of IOTHubEnrichment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEndpointNames':: d.fn(help='"The list of endpoints which will be enriched."', args=[d.arg(name='endpointNames', type=d.T.array)]),
      ...
      '#withIothubName':: d.fn(help='"The IoTHub name of the enrichment. Changing this forces a new resource to be created."', args=[d.arg(name='iothubName', type=d.T.string)]),
      withIothubName(iothubName): { spec+: { forProvider+: { iothubName: iothubName } } },
      '#withKey':: d.fn(help='"The key of the enrichment. Changing this forces a new resource to be created."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { forProvider+: { key: key } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the IoTHub resource is created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withValue':: d.fn(help='"The value of the enrichment. Value can be any static string, the name of the IoT hub sending the message (use $iothubname) or information from the device twin (ex: $twin.tags.latitude)"', args=[d.arg(name='value', type=d.T.string)]),
