{
  ...
  '#':: d.pkg(name='iotHubRoute', url='', help='"IOTHubRoute is the Schema for the IOTHubRoutes API. Manages an IotHub Route"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubRoute', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubRouteSpec defines the desired state of IOTHubRoute"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEnabled':: d.fn(help='"Specifies whether a route is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withEndpointNames':: d.fn(help='"The list of endpoints to which messages that satisfy the condition are routed. Currently only one endpoint is allowed."', args=[d.arg(name='endpointNames', type=d.T.array)]),
      ...
      '#withEndpointNamesMixin':: d.fn(help='"The list of endpoints to which messages that satisfy the condition are routed. Currently only one endpoint is allowed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpointNames', type=d.T.array)]),
      ...
      '#withIothubName':: d.fn(help='"The name of the IoTHub to which this Route belongs. Changing this forces a new resource to be created."', args=[d.arg(name='iothubName', type=d.T.string)]),
      withIothubName(iothubName): { spec+: { forProvider+: { iothubName: iothubName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the IotHub Route resource has to be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
