{
  ...
  '#':: d.pkg(name='iotHubEndpointServiceBusQueue', url='', help='"IOTHubEndpointServiceBusQueue is the Schema for the IOTHubEndpointServiceBusQueues API. Manages an IotHub ServiceBus Queue Endpoint"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubEndpointServiceBusQueue', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubEndpointServiceBusQueueSpec defines the desired state of IOTHubEndpointServiceBusQueue"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAuthenticationType':: d.fn(help='"Type used to authenticate against the Service Bus Queue endpoint. Possible values are keyBased and identityBased. Defaults to keyBased."', args=[d.arg(name='authenticationType', type=d.T.string)]),
      ...
      '#withEntityPath':: d.fn(help='"Name of the Service Bus Queue. This attribute can only be specified and is mandatory when authentication_type is identityBased."', args=[d.arg(name='entityPath', type=d.T.string)]),
      withEntityPath(entityPath): { spec+: { forProvider+: { entityPath: entityPath } } },
      '#withIdentityId':: d.fn(help='"ID of the User Managed Identity used to authenticate against the Service Bus Queue endpoint."', args=[d.arg(name='identityId', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the Service Bus Queue has been created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
