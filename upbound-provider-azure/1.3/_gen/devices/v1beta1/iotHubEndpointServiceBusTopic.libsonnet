{
  ...
  '#':: d.pkg(name='iotHubEndpointServiceBusTopic', url='', help='"IOTHubEndpointServiceBusTopic is the Schema for the IOTHubEndpointServiceBusTopics API. Manages an IotHub ServiceBus Topic Endpoint"'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubEndpointServiceBusTopic', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubEndpointServiceBusTopicSpec defines the desired state of IOTHubEndpointServiceBusTopic"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAuthenticationType':: d.fn(help='"Type used to authenticate against the Service Bus Topic endpoint. Possible values are keyBased and identityBased. Defaults to keyBased."', args=[d.arg(name='authenticationType', type=d.T.string)]),
      withAuthenticationType(authenticationType): { spec+: { forProvider+: { authenticationType: authenticationType } } },
      '#withEndpointUri':: d.fn(help='"URI of the Service Bus endpoint. This attribute can only be specified and is mandatory when authentication_type is identityBased."', args=[d.arg(name='endpointUri', type=d.T.string)]),
      withEndpointUri(endpointUri): { spec+: { forProvider+: { endpointUri: endpointUri } } },
      '#withEntityPath':: d.fn(help='"Name of the Service Bus Topic. This attribute can only be specified and is mandatory when authentication_type is identityBased."', args=[d.arg(name='entityPath', type=d.T.string)]),
      withEntityPath(entityPath): { spec+: { forProvider+: { entityPath: entityPath } } },
      '#withIdentityId':: d.fn(help='"ID of the User Managed Identity used to authenticate against the Service Bus Topic endpoint."', args=[d.arg(name='identityId', type=d.T.string)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the Service Bus Topic has been created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withEntityPath':: d.fn(help='"Name of the Service Bus Topic. This attribute can only be specified and is mandatory when authentication_type is identityBased."', args=[d.arg(name='entityPath', type=d.T.string)]),
      withEntityPath(entityPath): { spec+: { initProvider+: { entityPath: entityPath } } },
      '#withIdentityId':: d.fn(help='"ID of the User Managed Identity used to authenticate against the Service Bus Topic endpoint."', args=[d.arg(name='identityId', type=d.T.string)]),
