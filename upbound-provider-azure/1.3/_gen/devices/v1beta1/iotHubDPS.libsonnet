{
  ...
  '#':: d.pkg(name='iotHubDPS', url='', help='"IOTHubDPS is the Schema for the IOTHubDPSs API. Manages an IoT Device Provisioning Service."'),
  ...
  '#new':: d.fn(help='new returns an instance of IOTHubDPS', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IOTHubDPSSpec defines the desired state of IOTHubDPS"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#ipFilterRule':: d.obj(help='"An ip_filter_rule block as defined below."'),
      ipFilterRule: {
        '#withAction':: d.fn(help='"The desired action for requests captured by this rule. Possible values are Accept, Reject"', args=[d.arg(name='action', type=d.T.string)]),
        withAction(action): { action: action },
        '#withIpMask':: d.fn(help='"The IP address range in CIDR notation for the rule."', args=[d.arg(name='ipMask', type=d.T.string)]),
        withIpMask(ipMask): { ipMask: ipMask },
        '#withName':: d.fn(help='"The name of the filter."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withTarget':: d.fn(help='"Target for requests captured by this rule. Possible values are all, deviceApi and serviceApi."', args=[d.arg(name='target', type=d.T.string)]),
        withTarget(target): { target: target },
      },
      '#linkedHub':: d.obj(help='"A linked_hub block as defined below."'),
      linkedHub: {
        '#connectionStringSecretRef':: d.obj(help='"The connection string to connect to the IoT Hub."'),
        ...
        '#withAllocationWeight':: d.fn(help='"The weight applied to the IoT Hub. Defaults to 1."', args=[d.arg(name='allocationWeight', type=d.T.number)]),
        withAllocationWeight(allocationWeight): { allocationWeight: allocationWeight },
        '#withApplyAllocationPolicy':: d.fn(help='"Determines whether to apply allocation policies to the IoT Hub. Defaults to true."', args=[d.arg(name='applyAllocationPolicy', type=d.T.boolean)]),
        withApplyAllocationPolicy(applyAllocationPolicy): { applyAllocationPolicy: applyAllocationPolicy },
        '#withLocation':: d.fn(help='"The location of the IoT hub."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      sku: {
        '#withCapacity':: d.fn(help='"The number of provisioned IoT Device Provisioning Service units."', args=[d.arg(name='capacity', type=d.T.number)]),
        withCapacity(capacity): { capacity: capacity },
        '#withName':: d.fn(help='"The name of the sku. Currently can only be set to S1."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#withAllocationPolicy':: d.fn(help='"The allocation policy of the IoT Device Provisioning Service (Hashed, GeoLatency or Static). Defaults to Hashed."', args=[d.arg(name='allocationPolicy', type=d.T.string)]),
      withAllocationPolicy(allocationPolicy): { spec+: { forProvider+: { allocationPolicy: allocationPolicy } } },
      '#withDataResidencyEnabled':: d.fn(help='"Specifies if the IoT Device Provisioning Service has data residency and disaster recovery enabled. Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='dataResidencyEnabled', type=d.T.boolean)]),
      withDataResidencyEnabled(dataResidencyEnabled): { spec+: { forProvider+: { dataResidencyEnabled: dataResidencyEnabled } } },
      '#withIpFilterRule':: d.fn(help='"An ip_filter_rule block as defined below."', args=[d.arg(name='ipFilterRule', type=d.T.array)]),
      withIpFilterRule(ipFilterRule): { spec+: { forProvider+: { ipFilterRule: if std.isArray(v=ipFilterRule) then ipFilterRule else [ipFilterRule] } } },
      '#withIpFilterRuleMixin':: d.fn(help='"An ip_filter_rule block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipFilterRule', type=d.T.array)]),
      withIpFilterRuleMixin(ipFilterRule): { spec+: { forProvider+: { ipFilterRule+: if std.isArray(v=ipFilterRule) then ipFilterRule else [ipFilterRule] } } },
      '#withLinkedHub':: d.fn(help='"A linked_hub block as defined below."', args=[d.arg(name='linkedHub', type=d.T.array)]),
      withLinkedHub(linkedHub): { spec+: { forProvider+: { linkedHub: if std.isArray(v=linkedHub) then linkedHub else [linkedHub] } } },
      '#withLinkedHubMixin':: d.fn(help='"A linked_hub block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='linkedHub', type=d.T.array)]),
      withLinkedHubMixin(linkedHub): { spec+: { forProvider+: { linkedHub+: if std.isArray(v=linkedHub) then linkedHub else [linkedHub] } } },
      ...
      '#withPublicNetworkAccessEnabled':: d.fn(help='"Whether requests from Public Network are allowed. Defaults to true."', args=[d.arg(name='publicNetworkAccessEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group under which the Iot Device Provisioning Service resource has to be created. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAllocationPolicy':: d.fn(help='"The allocation policy of the IoT Device Provisioning Service (Hashed, GeoLatency or Static). Defaults to Hashed."', args=[d.arg(name='allocationPolicy', type=d.T.string)]),
      withAllocationPolicy(allocationPolicy): { spec+: { initProvider+: { allocationPolicy: allocationPolicy } } },
      '#withDataResidencyEnabled':: d.fn(help='"Specifies if the IoT Device Provisioning Service has data residency and disaster recovery enabled. Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='dataResidencyEnabled', type=d.T.boolean)]),
      withDataResidencyEnabled(dataResidencyEnabled): { spec+: { initProvider+: { dataResidencyEnabled: dataResidencyEnabled } } },
      '#withIpFilterRule':: d.fn(help='"An ip_filter_rule block as defined below."', args=[d.arg(name='ipFilterRule', type=d.T.array)]),
      withIpFilterRule(ipFilterRule): { spec+: { initProvider+: { ipFilterRule: if std.isArray(v=ipFilterRule) then ipFilterRule else [ipFilterRule] } } },
      '#withIpFilterRuleMixin':: d.fn(help='"An ip_filter_rule block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipFilterRule', type=d.T.array)]),
      withIpFilterRuleMixin(ipFilterRule): { spec+: { initProvider+: { ipFilterRule+: if std.isArray(v=ipFilterRule) then ipFilterRule else [ipFilterRule] } } },
      '#withLinkedHub':: d.fn(help='"A linked_hub block as defined below."', args=[d.arg(name='linkedHub', type=d.T.array)]),
      withLinkedHub(linkedHub): { spec+: { initProvider+: { linkedHub: if std.isArray(v=linkedHub) then linkedHub else [linkedHub] } } },
      '#withLinkedHubMixin':: d.fn(help='"A linked_hub block as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='linkedHub', type=d.T.array)]),
      withLinkedHubMixin(linkedHub): { spec+: { initProvider+: { linkedHub+: if std.isArray(v=linkedHub) then linkedHub else [linkedHub] } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource has to be created. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
