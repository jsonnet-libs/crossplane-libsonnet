{
  ...
  '#':: d.pkg(name='flexibleDatabase', url='', help='"FlexibleDatabase is the Schema for the FlexibleDatabases API. Manages a MySQL Database within a MySQL Flexible Server."'),
  ...
  '#new':: d.fn(help='new returns an instance of FlexibleDatabase', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FlexibleDatabaseSpec defines the desired state of FlexibleDatabase"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCharset':: d.fn(help='"Specifies the Charset for the MySQL Database, which needs to be a valid MySQL Charset. Changing this forces a new resource to be created."', args=[d.arg(name='charset', type=d.T.string)]),
      withCharset(charset): { spec+: { forProvider+: { charset: charset } } },
      '#withCollation':: d.fn(help='"Specifies the Collation for the MySQL Database, which needs to be a valid MySQL Collation. Changing this forces a new resource to be created."', args=[d.arg(name='collation', type=d.T.string)]),
