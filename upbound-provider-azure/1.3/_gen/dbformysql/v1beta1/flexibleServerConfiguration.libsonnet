{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withValue':: d.fn(help='"Specifies the value of the MySQL Flexible Server Configuration. See the MySQL documentation for valid values."', args=[d.arg(name='value', type=d.T.string)]),
