{
  ...
  '#':: d.pkg(name='flexibleServerFirewallRule', url='', help='"FlexibleServerFirewallRule is the Schema for the FlexibleServerFirewallRules API. Manages a Firewall Rule for a MySQL Flexible Server."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#serverNameRef':: d.obj(help='"Reference to a FlexibleServer in dbformysql to populate serverName."'),
      serverNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#serverNameSelector':: d.obj(help='"Selector for a FlexibleServer in dbformysql to populate serverName."'),
      serverNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withEndIpAddress':: d.fn(help='"Specifies the End IP Address associated with this Firewall Rule."', args=[d.arg(name='endIpAddress', type=d.T.string)]),
      withEndIpAddress(endIpAddress): { spec+: { forProvider+: { endIpAddress: endIpAddress } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which the MySQL Flexible Server exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withServerName':: d.fn(help='"Specifies the name of the MySQL Flexible Server. Changing this forces a new resource to be created."', args=[d.arg(name='serverName', type=d.T.string)]),
      withServerName(serverName): { spec+: { forProvider+: { serverName: serverName } } },
      '#withStartIpAddress':: d.fn(help='"Specifies the Start IP Address associated with this Firewall Rule."', args=[d.arg(name='startIpAddress', type=d.T.string)]),
