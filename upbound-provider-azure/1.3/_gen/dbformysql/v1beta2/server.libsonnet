{
  ...
  '#':: d.pkg(name='server', url='', help='"Server is the Schema for the Servers API. Manages a MySQL Server."'),
  ...
  spec: {
    ...
    forProvider: {
      '#administratorLoginPasswordSecretRef':: d.obj(help='"The Password associated with the administrator_login for the MySQL Server. Required when create_mode is Default."'),
      ...
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this MySQL Server. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      threatDetectionPolicy: {
        ...
        withEnabled(enabled): { spec+: { forProvider+: { threatDetectionPolicy+: { enabled: enabled } } } },
      ...
      '#withAdministratorLogin':: d.fn(help='"The Administrator login for the MySQL Server. Required when create_mode is Default. Changing this forces a new resource to be created."', args=[d.arg(name='administratorLogin', type=d.T.string)]),
      withAdministratorLogin(administratorLogin): { spec+: { forProvider+: { administratorLogin: administratorLogin } } },
      '#withAutoGrowEnabled':: d.fn(help='"Enable/Disable auto-growing of the storage. Storage auto-grow prevents your server from running out of storage and becoming read-only. If storage auto grow is enabled, the storage automatically grows without impacting the workload. Defaults to true."', args=[d.arg(name='autoGrowEnabled', type=d.T.boolean)]),
      ...
      '#withGeoRedundantBackupEnabled':: d.fn(help='"Turn Geo-redundant server backups on/off. This allows you to choose between locally redundant or geo-redundant backup storage in the General Purpose and Memory Optimized tiers. When the backups are stored in geo-redundant backup storage, they are not only stored within the region in which your server is hosted, but are also replicated to a paired data center. This provides better protection and ability to restore your server in a different region in the event of a disaster. This is not supported for the Basic tier."', args=[d.arg(name='geoRedundantBackupEnabled', type=d.T.boolean)]),
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the MySQL Server. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withRestorePointInTime':: d.fn(help='"When create_mode is PointInTimeRestore, specifies the point in time to restore from creation_source_server_id. It should be provided in RFC3339 format, e.g. 2013-11-08T22:00:40Z."', args=[d.arg(name='restorePointInTime', type=d.T.string)]),
      withRestorePointInTime(restorePointInTime): { spec+: { forProvider+: { restorePointInTime: restorePointInTime } } },
      '#withSkuName':: d.fn(help='"Specifies the SKU Name for this MySQL Server. The name of the SKU, follows the tier + family + cores pattern (e.g. B_Gen4_1, GP_Gen5_8). For more information see the product documentation. Possible values are B_Gen4_1, B_Gen4_2, B_Gen5_1, B_Gen5_2, GP_Gen4_2, GP_Gen4_4, GP_Gen4_8, GP_Gen4_16, GP_Gen4_32, GP_Gen5_2, GP_Gen5_4, GP_Gen5_8, GP_Gen5_16, GP_Gen5_32, GP_Gen5_64, MO_Gen5_2, MO_Gen5_4, MO_Gen5_8, MO_Gen5_16 and MO_Gen5_32."', args=[d.arg(name='skuName', type=d.T.string)]),
      ...
      '#withVersion':: d.fn(help='"Specifies the version of MySQL to use. Valid values are 5.7, or 8.0. Changing this forces a new resource to be created."', args=[d.arg(name='version', type=d.T.string)]),
    ...
    initProvider: {
      ...
      threatDetectionPolicy: {
        ...
        '#withEnabled':: d.fn(help='"Is the policy enabled?"', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { initProvider+: { threatDetectionPolicy+: { enabled: enabled } } } },
        '#withRetentionDays':: d.fn(help='"Specifies the number of days to keep in the Threat Detection audit logs."', args=[d.arg(name='retentionDays', type=d.T.number)]),
      ...
      '#withCreationSourceServerId':: d.fn(help='"For creation modes other than Default, the source server ID to use."', args=[d.arg(name='creationSourceServerId', type=d.T.string)]),
      withCreationSourceServerId(creationSourceServerId): { spec+: { initProvider+: { creationSourceServerId: creationSourceServerId } } },
      '#withGeoRedundantBackupEnabled':: d.fn(help='"Turn Geo-redundant server backups on/off. This allows you to choose between locally redundant or geo-redundant backup storage in the General Purpose and Memory Optimized tiers. When the backups are stored in geo-redundant backup storage, they are not only stored within the region in which your server is hosted, but are also replicated to a paired data center. This provides better protection and ability to restore your server in a different region in the event of a disaster. This is not supported for the Basic tier."', args=[d.arg(name='geoRedundantBackupEnabled', type=d.T.boolean)]),
      ...
      '#withSslEnforcementEnabled':: d.fn(help='"Specifies if SSL should be enforced on connections. Possible values are true and false."', args=[d.arg(name='sslEnforcementEnabled', type=d.T.boolean)]),
      withSslEnforcementEnabled(sslEnforcementEnabled): { spec+: { initProvider+: { sslEnforcementEnabled: sslEnforcementEnabled } } },
      '#withSslMinimalTlsVersionEnforced':: d.fn(help='"The minimum TLS version to support on the sever. Possible values are TLSEnforcementDisabled, TLS1_0, TLS1_1, and TLS1_2. Defaults to TLS1_2."', args=[d.arg(name='sslMinimalTlsVersionEnforced', type=d.T.string)]),
      withSslMinimalTlsVersionEnforced(sslMinimalTlsVersionEnforced): { spec+: { initProvider+: { sslMinimalTlsVersionEnforced: sslMinimalTlsVersionEnforced } } },
      '#withStorageMb':: d.fn(help='"Max storage allowed for a server. Possible values are between 5120 MB(5GB) and 1048576 MB(1TB) for the Basic SKU and between 5120 MB(5GB) and 16777216 MB(16TB) for General Purpose/Memory Optimized SKUs. For more information see the product documentation."', args=[d.arg(name='storageMb', type=d.T.number)]),
