{
  ...
  '#':: d.pkg(name='costAnomalyAlert', url='', help='"CostAnomalyAlert is the Schema for the CostAnomalyAlerts API. Manages a Cost Anomaly Alert."'),
  ...
  '#new':: d.fn(help='new returns an instance of CostAnomalyAlert', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CostAnomalyAlertSpec defines the desired state of CostAnomalyAlert"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDisplayName':: d.fn(help='"The display name which should be used for this Cost Anomaly Alert."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withEmailAddresses':: d.fn(help='"Specifies a list of email addresses which the Anomaly Alerts are send to."', args=[d.arg(name='emailAddresses', type=d.T.array)]),
      ...
      '#withEmailAddressesMixin':: d.fn(help='"Specifies a list of email addresses which the Anomaly Alerts are send to."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='emailAddresses', type=d.T.array)]),
      ...
      '#withEmailSubject':: d.fn(help='"The email subject of the Cost Anomaly Alerts. Maximum length of the subject is 70."', args=[d.arg(name='emailSubject', type=d.T.string)]),
      withEmailSubject(emailSubject): { spec+: { forProvider+: { emailSubject: emailSubject } } },
      '#withMessage':: d.fn(help='"The message of the Cost Anomaly Alert. Maximum length of the message is 250."', args=[d.arg(name='message', type=d.T.string)]),
      withMessage(message): { spec+: { forProvider+: { message: message } } },
      '#withSubscriptionId':: d.fn(help='"The ID of the Subscription this Cost Anomaly Alert is scoped to. Changing this forces a new resource to be created. When not supplied this defaults to the subscription configured in the provider."', args=[d.arg(name='subscriptionId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withEmailSubject':: d.fn(help='"The email subject of the Cost Anomaly Alerts. Maximum length of the subject is 70."', args=[d.arg(name='emailSubject', type=d.T.string)]),
      withEmailSubject(emailSubject): { spec+: { initProvider+: { emailSubject: emailSubject } } },
      '#withMessage':: d.fn(help='"The message of the Cost Anomaly Alert. Maximum length of the message is 250."', args=[d.arg(name='message', type=d.T.string)]),
