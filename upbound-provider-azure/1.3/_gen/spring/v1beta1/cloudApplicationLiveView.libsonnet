{
  ...
  '#':: d.pkg(name='cloudApplicationLiveView', url='', help='"CloudApplicationLiveView is the Schema for the CloudApplicationLiveViews API. Manages a Spring Cloud Application Live View."'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudApplicationLiveView', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'spring.azure.upbound.io/v1beta1',
    kind: 'CloudApplicationLiveView',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'false',
  }),
  '#spec':: d.obj(help='"CloudApplicationLiveViewSpec defines the desired state of CloudApplicationLiveView"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSpringCloudServiceId':: d.fn(help='"The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Application Live View to be created."', args=[d.arg(name='springCloudServiceId', type=d.T.string)]),
