{
  ...
  '#':: d.pkg(name='server', url='', help='"Server is the Schema for the Servers API. Manages an Analysis Services Server."'),
  ...
  spec: {
    ...
    forProvider: {
      '#backupBlobContainerUriSecretRef':: d.obj(help='"URI and SAS token for a blob container to store backups."'),
      backupBlobContainerUriSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { backupBlobContainerUriSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { backupBlobContainerUriSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { backupBlobContainerUriSecretRef+: { namespace: namespace } } } },
      },
      '#ipv4FirewallRule':: d.obj(help='"One or more ipv4_firewall_rule block(s) as defined below."'),
      ipv4FirewallRule: {
        '#withName':: d.fn(help='"Specifies the name of the firewall rule."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRangeEnd':: d.fn(help='"End of the firewall rule range as IPv4 address."', args=[d.arg(name='rangeEnd', type=d.T.string)]),
        withRangeEnd(rangeEnd): { rangeEnd: rangeEnd },
        '#withRangeStart':: d.fn(help='"Start of the firewall rule range as IPv4 address."', args=[d.arg(name='rangeStart', type=d.T.string)]),
      ...
      '#withAdminUsers':: d.fn(help='"List of email addresses of admin users."', args=[d.arg(name='adminUsers', type=d.T.array)]),
      withAdminUsers(adminUsers): { spec+: { forProvider+: { adminUsers: if std.isArray(v=adminUsers) then adminUsers else [adminUsers] } } },
      '#withAdminUsersMixin':: d.fn(help='"List of email addresses of admin users."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='adminUsers', type=d.T.array)]),
      withAdminUsersMixin(adminUsers): { spec+: { forProvider+: { adminUsers+: if std.isArray(v=adminUsers) then adminUsers else [adminUsers] } } },
      '#withEnablePowerBiService':: d.fn(help='"Indicates if the Power BI service is allowed to access or not."', args=[d.arg(name='enablePowerBiService', type=d.T.boolean)]),
      withEnablePowerBiService(enablePowerBiService): { spec+: { forProvider+: { enablePowerBiService: enablePowerBiService } } },
      '#withIpv4FirewallRule':: d.fn(help='"One or more ipv4_firewall_rule block(s) as defined below."', args=[d.arg(name='ipv4FirewallRule', type=d.T.array)]),
      withIpv4FirewallRule(ipv4FirewallRule): { spec+: { forProvider+: { ipv4FirewallRule: if std.isArray(v=ipv4FirewallRule) then ipv4FirewallRule else [ipv4FirewallRule] } } },
      '#withIpv4FirewallRuleMixin':: d.fn(help='"One or more ipv4_firewall_rule block(s) as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipv4FirewallRule', type=d.T.array)]),
      withIpv4FirewallRuleMixin(ipv4FirewallRule): { spec+: { forProvider+: { ipv4FirewallRule+: if std.isArray(v=ipv4FirewallRule) then ipv4FirewallRule else [ipv4FirewallRule] } } },
      '#withLocation':: d.fn(help='"The Azure location where the Analysis Services Server exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"The name of the Analysis Services Server. Only lowercase Alphanumeric characters allowed, starting with a letter. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withQuerypoolConnectionMode':: d.fn(help='"Controls how the read-write server is used in the query pool. If this value is set to All then read-write servers are also used for queries. Otherwise with ReadOnly these servers do not participate in query operations."', args=[d.arg(name='querypoolConnectionMode', type=d.T.string)]),
      withQuerypoolConnectionMode(querypoolConnectionMode): { spec+: { forProvider+: { querypoolConnectionMode: querypoolConnectionMode } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the Analysis Services Server should be exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSku':: d.fn(help='"SKU for the Analysis Services Server. Possible values are: D1, B1, B2, S0, S1, S2, S4, S8, S9, S8v2 and S9v2."', args=[d.arg(name='sku', type=d.T.string)]),
    ...
    initProvider: {
      ...
      backupBlobContainerUriSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { backupBlobContainerUriSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { backupBlobContainerUriSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { backupBlobContainerUriSecretRef+: { namespace: namespace } } } },
      },
      '#ipv4FirewallRule':: d.obj(help='"One or more ipv4_firewall_rule block(s) as defined below."'),
      ipv4FirewallRule: {
        '#withName':: d.fn(help='"Specifies the name of the firewall rule."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withAdminUsers':: d.fn(help='"List of email addresses of admin users."', args=[d.arg(name='adminUsers', type=d.T.array)]),
      withAdminUsers(adminUsers): { spec+: { initProvider+: { adminUsers: if std.isArray(v=adminUsers) then adminUsers else [adminUsers] } } },
      '#withAdminUsersMixin':: d.fn(help='"List of email addresses of admin users."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='adminUsers', type=d.T.array)]),
      withAdminUsersMixin(adminUsers): { spec+: { initProvider+: { adminUsers+: if std.isArray(v=adminUsers) then adminUsers else [adminUsers] } } },
      '#withEnablePowerBiService':: d.fn(help='"Indicates if the Power BI service is allowed to access or not."', args=[d.arg(name='enablePowerBiService', type=d.T.boolean)]),
      withEnablePowerBiService(enablePowerBiService): { spec+: { initProvider+: { enablePowerBiService: enablePowerBiService } } },
      '#withIpv4FirewallRule':: d.fn(help='"One or more ipv4_firewall_rule block(s) as defined below."', args=[d.arg(name='ipv4FirewallRule', type=d.T.array)]),
      withIpv4FirewallRule(ipv4FirewallRule): { spec+: { initProvider+: { ipv4FirewallRule: if std.isArray(v=ipv4FirewallRule) then ipv4FirewallRule else [ipv4FirewallRule] } } },
      '#withIpv4FirewallRuleMixin':: d.fn(help='"One or more ipv4_firewall_rule block(s) as defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipv4FirewallRule', type=d.T.array)]),
      withIpv4FirewallRuleMixin(ipv4FirewallRule): { spec+: { initProvider+: { ipv4FirewallRule+: if std.isArray(v=ipv4FirewallRule) then ipv4FirewallRule else [ipv4FirewallRule] } } },
      '#withLocation':: d.fn(help='"The Azure location where the Analysis Services Server exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { initProvider+: { location: location } } },
      '#withName':: d.fn(help='"The name of the Analysis Services Server. Only lowercase Alphanumeric characters allowed, starting with a letter. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withQuerypoolConnectionMode':: d.fn(help='"Controls how the read-write server is used in the query pool. If this value is set to All then read-write servers are also used for queries. Otherwise with ReadOnly these servers do not participate in query operations."', args=[d.arg(name='querypoolConnectionMode', type=d.T.string)]),
      withQuerypoolConnectionMode(querypoolConnectionMode): { spec+: { initProvider+: { querypoolConnectionMode: querypoolConnectionMode } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group in which the Analysis Services Server should be exist. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
