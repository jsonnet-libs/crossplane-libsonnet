{
  ...
  '#':: d.pkg(name='subscriptionTemplateDeployment', url='', help='"SubscriptionTemplateDeployment is the Schema for the SubscriptionTemplateDeployments API. Manages a Subscription Template Deployment."'),
  ...
  '#new':: d.fn(help='new returns an instance of SubscriptionTemplateDeployment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubscriptionTemplateDeploymentSpec defines the desired state of SubscriptionTemplateDeployment"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDebugLevel':: d.fn(help='"The Debug Level which should be used for this Subscription Template Deployment. Possible values are none, requestContent, responseContent and requestContent, responseContent."', args=[d.arg(name='debugLevel', type=d.T.string)]),
      withDebugLevel(debugLevel): { spec+: { forProvider+: { debugLevel: debugLevel } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Subscription Template Deployment should exist. Changing this forces a new Subscription Template Deployment to be created."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Subscription Template Deployment."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Subscription Template Deployment."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withTemplateContent':: d.fn(help='"The contents of the ARM Template which should be deployed into this Subscription."', args=[d.arg(name='templateContent', type=d.T.string)]),
      withTemplateContent(templateContent): { spec+: { forProvider+: { templateContent: templateContent } } },
      '#withTemplateSpecVersionId':: d.fn(help='"The ID of the Template Spec Version to deploy into the Subscription. Cannot be specified with template_content."', args=[d.arg(name='templateSpecVersionId', type=d.T.string)]),
