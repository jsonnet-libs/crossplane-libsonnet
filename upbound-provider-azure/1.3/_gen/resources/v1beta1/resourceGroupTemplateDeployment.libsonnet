{
  ...
  '#':: d.pkg(name='resourceGroupTemplateDeployment', url='', help='"ResourceGroupTemplateDeployment is the Schema for the ResourceGroupTemplateDeployments API. Manages a Resource Group Template Deployment."'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceGroupTemplateDeployment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ResourceGroupTemplateDeploymentSpec defines the desired state of ResourceGroupTemplateDeployment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDebugLevel':: d.fn(help='"The Debug Level which should be used for this Resource Group Template Deployment. Possible values are none, requestContent, responseContent and requestContent, responseContent."', args=[d.arg(name='debugLevel', type=d.T.string)]),
      withDebugLevel(debugLevel): { spec+: { forProvider+: { debugLevel: debugLevel } } },
      '#withDeploymentMode':: d.fn(help='"The Deployment Mode for this Resource Group Template Deployment. Possible values are Complete (where resources in the Resource Group not specified in the ARM Template will be destroyed) and Incremental (where resources are additive only)."', args=[d.arg(name='deploymentMode', type=d.T.string)]),
      withDeploymentMode(deploymentMode): { spec+: { forProvider+: { deploymentMode: deploymentMode } } },
      '#withParametersContent':: d.fn(help='"The contents of the ARM Template parameters file - containing a JSON list of parameters."', args=[d.arg(name='parametersContent', type=d.T.string)]),
      withParametersContent(parametersContent): { spec+: { forProvider+: { parametersContent: parametersContent } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Resource Group Template Deployment should exist. Changing this forces a new Resource Group Template Deployment to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Resource Group Template Deployment."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Resource Group Template Deployment."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withTemplateContent':: d.fn(help='"The contents of the ARM Template which should be deployed into this Resource Group. Cannot be specified with template_spec_version_id."', args=[d.arg(name='templateContent', type=d.T.string)]),
      withTemplateContent(templateContent): { spec+: { forProvider+: { templateContent: templateContent } } },
      '#withTemplateSpecVersionId':: d.fn(help='"The ID of the Template Spec Version to deploy. Cannot be specified with template_content."', args=[d.arg(name='templateSpecVersionId', type=d.T.string)]),
      withTemplateSpecVersionId(templateSpecVersionId): { spec+: { forProvider+: { templateSpecVersionId: templateSpecVersionId } } },
    },
    ...
    initProvider: {
      '#withDebugLevel':: d.fn(help='"The Debug Level which should be used for this Resource Group Template Deployment. Possible values are none, requestContent, responseContent and requestContent, responseContent."', args=[d.arg(name='debugLevel', type=d.T.string)]),
      withDebugLevel(debugLevel): { spec+: { initProvider+: { debugLevel: debugLevel } } },
      '#withDeploymentMode':: d.fn(help='"The Deployment Mode for this Resource Group Template Deployment. Possible values are Complete (where resources in the Resource Group not specified in the ARM Template will be destroyed) and Incremental (where resources are additive only)."', args=[d.arg(name='deploymentMode', type=d.T.string)]),
      withDeploymentMode(deploymentMode): { spec+: { initProvider+: { deploymentMode: deploymentMode } } },
      '#withParametersContent':: d.fn(help='"The contents of the ARM Template parameters file - containing a JSON list of parameters."', args=[d.arg(name='parametersContent', type=d.T.string)]),
      withParametersContent(parametersContent): { spec+: { initProvider+: { parametersContent: parametersContent } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Resource Group Template Deployment."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Resource Group Template Deployment."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withTemplateContent':: d.fn(help='"The contents of the ARM Template which should be deployed into this Resource Group. Cannot be specified with template_spec_version_id."', args=[d.arg(name='templateContent', type=d.T.string)]),
      withTemplateContent(templateContent): { spec+: { initProvider+: { templateContent: templateContent } } },
      '#withTemplateSpecVersionId':: d.fn(help='"The ID of the Template Spec Version to deploy. Cannot be specified with template_content."', args=[d.arg(name='templateSpecVersionId', type=d.T.string)]),
      withTemplateSpecVersionId(templateSpecVersionId): { spec+: { initProvider+: { templateSpecVersionId: templateSpecVersionId } } },
    },
