{
  ...
  '#':: d.pkg(name='loadTest', url='', help='"LoadTest is the Schema for the LoadTests API. Manages a Load Test."'),
  ...
  spec: {
    ...
    forProvider: {
      '#identity':: d.obj(help='"An identity block as defined below. Specifies the Managed Identity which should be assigned to this Load Test."'),
      identity: {
        '#withIdentityIds':: d.fn(help='"A list of the User Assigned Identity IDs that should be assigned to this Load Test."', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withIdentityIdsMixin':: d.fn(help='"A list of the User Assigned Identity IDs that should be assigned to this Load Test."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityIds', type=d.T.array)]),
        ...
        '#withType':: d.fn(help='"Specifies the type of Managed Identity that should be assigned to this Load Test. Possible values are SystemAssigned, SystemAssigned, UserAssigned and UserAssigned."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withDescription':: d.fn(help='"Description of the resource. Changing this forces a new Load Test to be created."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLocation':: d.fn(help='"The Azure Region where the Load Test should exist. Changing this forces a new Load Test to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withResourceGroupName':: d.fn(help='"Specifies the name of the Resource Group within which this Load Test should exist. Changing this forces a new Load Test to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Load Test."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Load Test."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
