{
  ...
  '#':: d.pkg(name='spacecraft', url='', help='"Spacecraft is the Schema for the Spacecrafts API. Manages a Spacecraft resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of Spacecraft', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SpacecraftSpec defines the desired state of Spacecraft"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#links':: d.obj(help='"A links block as defined below. Changing this forces a new resource to be created."'),
      links: {
        ...
        '#withDirection':: d.fn(help='"Direction if the communication. Possible values are Uplink and Downlink."', args=[d.arg(name='direction', type=d.T.string)]),
        withDirection(direction): { direction: direction },
        '#withName':: d.fn(help='"Name of the link."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withPolarization':: d.fn(help='"Polarization. Possible values are RHCP, LHCP, linearVertical and linearHorizontal."', args=[d.arg(name='polarization', type=d.T.string)]),
      ...
      '#withLinks':: d.fn(help='"A links block as defined below. Changing this forces a new resource to be created."', args=[d.arg(name='links', type=d.T.array)]),
      withLinks(links): { spec+: { forProvider+: { links: if std.isArray(v=links) then links else [links] } } },
      '#withLinksMixin':: d.fn(help='"A links block as defined below. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='links', type=d.T.array)]),
      withLinksMixin(links): { spec+: { forProvider+: { links+: if std.isArray(v=links) then links else [links] } } },
      '#withLocation':: d.fn(help='"The location where the Spacecraft exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withNoradId':: d.fn(help='"NORAD ID of the Spacecraft."', args=[d.arg(name='noradId', type=d.T.string)]),
      withNoradId(noradId): { spec+: { forProvider+: { noradId: noradId } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Spacecraft exists. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      ...
      '#withTitleLine':: d.fn(help='"Title of the two line elements (TLE)."', args=[d.arg(name='titleLine', type=d.T.string)]),
      withTitleLine(titleLine): { spec+: { forProvider+: { titleLine: titleLine } } },
      '#withTwoLineElements':: d.fn(help='"A list of the two line elements (TLE), the first string being the first of the TLE, the second string being the second line of the TLE. Changing this forces a new resource to be created."', args=[d.arg(name='twoLineElements', type=d.T.array)]),
      withTwoLineElements(twoLineElements): { spec+: { forProvider+: { twoLineElements: if std.isArray(v=twoLineElements) then twoLineElements else [twoLineElements] } } },
      '#withTwoLineElementsMixin':: d.fn(help='"A list of the two line elements (TLE), the first string being the first of the TLE, the second string being the second line of the TLE. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='twoLineElements', type=d.T.array)]),
      withTwoLineElementsMixin(twoLineElements): { spec+: { forProvider+: { twoLineElements+: if std.isArray(v=twoLineElements) then twoLineElements else [twoLineElements] } } },
    },
    ...
    initProvider: {
      ...
      '#withNoradId':: d.fn(help='"NORAD ID of the Spacecraft."', args=[d.arg(name='noradId', type=d.T.string)]),
      withNoradId(noradId): { spec+: { initProvider+: { noradId: noradId } } },
      '#withTags':: d.fn(help='"A mapping of tags to assign to the resource."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags to assign to the resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withTitleLine':: d.fn(help='"Title of the two line elements (TLE)."', args=[d.arg(name='titleLine', type=d.T.string)]),
      withTitleLine(titleLine): { spec+: { initProvider+: { titleLine: titleLine } } },
      '#withTwoLineElements':: d.fn(help='"A list of the two line elements (TLE), the first string being the first of the TLE, the second string being the second line of the TLE. Changing this forces a new resource to be created."', args=[d.arg(name='twoLineElements', type=d.T.array)]),
      withTwoLineElements(twoLineElements): { spec+: { initProvider+: { twoLineElements: if std.isArray(v=twoLineElements) then twoLineElements else [twoLineElements] } } },
      '#withTwoLineElementsMixin':: d.fn(help='"A list of the two line elements (TLE), the first string being the first of the TLE, the second string being the second line of the TLE. Changing this forces a new resource to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='twoLineElements', type=d.T.array)]),
      withTwoLineElementsMixin(twoLineElements): { spec+: { initProvider+: { twoLineElements+: if std.isArray(v=twoLineElements) then twoLineElements else [twoLineElements] } } },
    },
