{
  ...
  '#':: d.pkg(name='appIntegrationAccountPartner', url='', help='"AppIntegrationAccountPartner is the Schema for the AppIntegrationAccountPartners API. Manages a Logic App Integration Account Partner."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppIntegrationAccountPartner', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppIntegrationAccountPartnerSpec defines the desired state of AppIntegrationAccountPartner"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#businessIdentity':: d.obj(help='"A business_identity block as documented below."'),
      businessIdentity: {
        '#withQualifier':: d.fn(help='"The authenticating body that provides unique business identities to organizations."', args=[d.arg(name='qualifier', type=d.T.string)]),
        withQualifier(qualifier): { qualifier: qualifier },
        '#withValue':: d.fn(help='"The value that identifies the documents that your logic apps receive."', args=[d.arg(name='value', type=d.T.string)]),
      ...
      '#withBusinessIdentity':: d.fn(help='"A business_identity block as documented below."', args=[d.arg(name='businessIdentity', type=d.T.array)]),
      withBusinessIdentity(businessIdentity): { spec+: { forProvider+: { businessIdentity: if std.isArray(v=businessIdentity) then businessIdentity else [businessIdentity] } } },
      '#withBusinessIdentityMixin':: d.fn(help='"A business_identity block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='businessIdentity', type=d.T.array)]),
      withBusinessIdentityMixin(businessIdentity): { spec+: { forProvider+: { businessIdentity+: if std.isArray(v=businessIdentity) then businessIdentity else [businessIdentity] } } },
      '#withIntegrationAccountName':: d.fn(help='"The name of the Logic App Integration Account. Changing this forces a new Logic App Integration Account Partner to be created."', args=[d.arg(name='integrationAccountName', type=d.T.string)]),
      withIntegrationAccountName(integrationAccountName): { spec+: { forProvider+: { integrationAccountName: integrationAccountName } } },
      '#withMetadata':: d.fn(help='"A JSON mapping of any Metadata for this Logic App Integration Account Partner."', args=[d.arg(name='metadata', type=d.T.string)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: metadata } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Logic App Integration Account Partner should exist. Changing this forces a new Logic App Integration Account Partner to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withBusinessIdentity':: d.fn(help='"A business_identity block as documented below."', args=[d.arg(name='businessIdentity', type=d.T.array)]),
      withBusinessIdentity(businessIdentity): { spec+: { initProvider+: { businessIdentity: if std.isArray(v=businessIdentity) then businessIdentity else [businessIdentity] } } },
      '#withBusinessIdentityMixin':: d.fn(help='"A business_identity block as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='businessIdentity', type=d.T.array)]),
      withBusinessIdentityMixin(businessIdentity): { spec+: { initProvider+: { businessIdentity+: if std.isArray(v=businessIdentity) then businessIdentity else [businessIdentity] } } },
      '#withMetadata':: d.fn(help='"A JSON mapping of any Metadata for this Logic App Integration Account Partner."', args=[d.arg(name='metadata', type=d.T.string)]),
