{
  ...
  '#':: d.pkg(name='appIntegrationAccountSession', url='', help='"AppIntegrationAccountSession is the Schema for the AppIntegrationAccountSessions API. Manages a Logic App Integration Account Session."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppIntegrationAccountSession', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppIntegrationAccountSessionSpec defines the desired state of AppIntegrationAccountSession"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withContent':: d.fn(help='"The content of the Logic App Integration Account Session."', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { spec+: { forProvider+: { content: content } } },
      '#withIntegrationAccountName':: d.fn(help='"The name of the Logic App Integration Account. Changing this forces a new Logic App Integration Account Session to be created."', args=[d.arg(name='integrationAccountName', type=d.T.string)]),
      withIntegrationAccountName(integrationAccountName): { spec+: { forProvider+: { integrationAccountName: integrationAccountName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Logic App Integration Account Session should exist. Changing this forces a new Logic App Integration Account Session to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
