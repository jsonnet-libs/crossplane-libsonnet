{
  ...
  '#':: d.pkg(name='appIntegrationAccountSchema', url='', help='"AppIntegrationAccountSchema is the Schema for the AppIntegrationAccountSchemas API. Manages a Logic App Integration Account Schema."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppIntegrationAccountSchema', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppIntegrationAccountSchemaSpec defines the desired state of AppIntegrationAccountSchema"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withContent':: d.fn(help='"The content of the Logic App Integration Account Schema."', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { spec+: { forProvider+: { content: content } } },
      '#withFileName':: d.fn(help='"The file name of the Logic App Integration Account Schema."', args=[d.arg(name='fileName', type=d.T.string)]),
      withFileName(fileName): { spec+: { forProvider+: { fileName: fileName } } },
      '#withIntegrationAccountName':: d.fn(help='"The name of the Logic App Integration Account. Changing this forces a new Logic App Integration Account Schema to be created."', args=[d.arg(name='integrationAccountName', type=d.T.string)]),
      withIntegrationAccountName(integrationAccountName): { spec+: { forProvider+: { integrationAccountName: integrationAccountName } } },
      '#withMetadata':: d.fn(help='"The metadata of the Logic App Integration Account Schema."', args=[d.arg(name='metadata', type=d.T.string)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: metadata } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Logic App Integration Account Schema should exist. Changing this forces a new Logic App Integration Account Schema to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
