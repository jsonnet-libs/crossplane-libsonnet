{
  ...
  '#':: d.pkg(name='appTriggerHTTPRequest', url='', help='"AppTriggerHTTPRequest is the Schema for the AppTriggerHTTPRequests API. Manages a HTTP Request Trigger within a Logic App Workflow"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppTriggerHTTPRequest', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppTriggerHTTPRequestSpec defines the desired state of AppTriggerHTTPRequest"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withMethod':: d.fn(help='"Specifies the HTTP Method which the request be using. Possible values include DELETE, GET, PATCH, POST or PUT."', args=[d.arg(name='method', type=d.T.string)]),
      withMethod(method): { spec+: { forProvider+: { method: method } } },
      '#withRelativePath':: d.fn(help='"Specifies the Relative Path used for this Request."', args=[d.arg(name='relativePath', type=d.T.string)]),
      withRelativePath(relativePath): { spec+: { forProvider+: { relativePath: relativePath } } },
      '#withSchema':: d.fn(help='"A JSON Blob defining the Schema of the incoming request. This needs to be valid JSON."', args=[d.arg(name='schema', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withRelativePath':: d.fn(help='"Specifies the Relative Path used for this Request."', args=[d.arg(name='relativePath', type=d.T.string)]),
      withRelativePath(relativePath): { spec+: { initProvider+: { relativePath: relativePath } } },
      '#withSchema':: d.fn(help='"A JSON Blob defining the Schema of the incoming request. This needs to be valid JSON."', args=[d.arg(name='schema', type=d.T.string)]),
