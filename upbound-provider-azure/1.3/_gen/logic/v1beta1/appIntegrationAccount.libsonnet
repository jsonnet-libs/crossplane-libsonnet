{
  ...
  '#':: d.pkg(name='appIntegrationAccount', url='', help='"AppIntegrationAccount is the Schema for the AppIntegrationAccounts API. Manages a Logic App Integration Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppIntegrationAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppIntegrationAccountSpec defines the desired state of AppIntegrationAccount"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIntegrationServiceEnvironmentId':: d.fn(help='"The resource ID of the Integration Service Environment. Changing this forces a new Logic App Integration Account to be created."', args=[d.arg(name='integrationServiceEnvironmentId', type=d.T.string)]),
      ...
      '#withLocation':: d.fn(help='"The Azure Region where the Logic App Integration Account should exist. Changing this forces a new Logic App Integration Account to be created."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"The name which should be used for this Logic App Integration Account. Changing this forces a new Logic App Integration Account to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withResourceGroupName':: d.fn(help='"The name of the Resource Group where the Logic App Integration Account should exist. Changing this forces a new Logic App Integration Account to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
      withResourceGroupName(resourceGroupName): { spec+: { forProvider+: { resourceGroupName: resourceGroupName } } },
      '#withSkuName':: d.fn(help='"The SKU name of the Logic App Integration Account. Possible Values are Basic, Free and Standard."', args=[d.arg(name='skuName', type=d.T.string)]),
      withSkuName(skuName): { spec+: { forProvider+: { skuName: skuName } } },
      '#withTags':: d.fn(help='"A mapping of tags which should be assigned to the Logic App Integration Account."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"A mapping of tags which should be assigned to the Logic App Integration Account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
