{
  ...
  '#':: d.pkg(name='dashboard', url='', help='"Dashboard is the Schema for the Dashboards API. Manages a shared dashboard in the Azure Portal."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDashboardProperties':: d.fn(help='"JSON data representing dashboard body. See above for details on how to obtain this from the Portal."', args=[d.arg(name='dashboardProperties', type=d.T.string)]),
      withDashboardProperties(dashboardProperties): { spec+: { forProvider+: { dashboardProperties: dashboardProperties } } },
      ...
      '#withName':: d.fn(help='"Specifies the name of the Shared Dashboard. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the dashboard. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDashboardProperties':: d.fn(help='"JSON data representing dashboard body. See above for details on how to obtain this from the Portal."', args=[d.arg(name='dashboardProperties', type=d.T.string)]),
      withDashboardProperties(dashboardProperties): { spec+: { initProvider+: { dashboardProperties: dashboardProperties } } },
      '#withLocation':: d.fn(help='"Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created."', args=[d.arg(name='location', type=d.T.string)]),
