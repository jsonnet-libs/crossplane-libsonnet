{
  ...
  spec: {
    ...
    forProvider: {
      '#managedStorageAccountIdRef':: d.obj(help='"Reference to a ManagedStorageAccount to populate managedStorageAccountId."'),
      ...
      '#managedStorageAccountIdSelector':: d.obj(help='"Selector for a ManagedStorageAccount to populate managedStorageAccountId."'),
