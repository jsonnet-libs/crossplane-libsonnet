{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#site':: d.obj(help='"A site represents a client application that you want to connect to your bot. Multiple site blocks may be defined as below"'),
      site: {
        '#withEnabled':: d.fn(help='"Enables/Disables this site. Enabled by default Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        ...
        '#withV1Allowed':: d.fn(help='"Enables v1 of the Directline protocol for this site. Enabled by default Defaults to true."', args=[d.arg(name='v1Allowed', type=d.T.boolean)]),
        withV1Allowed(v1Allowed): { v1Allowed: v1Allowed },
        '#withV3Allowed':: d.fn(help='"Enables v3 of the Directline protocol for this site. Enabled by default Defaults to true."', args=[d.arg(name='v3Allowed', type=d.T.boolean)]),
      ...
      '#withSite':: d.fn(help='"A site represents a client application that you want to connect to your bot. Multiple site blocks may be defined as below"', args=[d.arg(name='site', type=d.T.array)]),
      withSite(site): { spec+: { forProvider+: { site: if std.isArray(v=site) then site else [site] } } },
      '#withSiteMixin':: d.fn(help='"A site represents a client application that you want to connect to your bot. Multiple site blocks may be defined as below"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='site', type=d.T.array)]),
