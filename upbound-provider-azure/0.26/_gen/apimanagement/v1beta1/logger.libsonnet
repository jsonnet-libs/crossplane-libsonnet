{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#applicationInsights':: d.obj(help='"An application_insights block as documented below."'),
      applicationInsights: {
      ...
      '#eventhub':: d.obj(help='"An eventhub block as documented below."'),
      eventhub: {
      ...
      '#withApplicationInsights':: d.fn(help='"An application_insights block as documented below."', args=[d.arg(name='applicationInsights', type=d.T.array)]),
