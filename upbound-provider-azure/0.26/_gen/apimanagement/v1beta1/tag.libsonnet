{
  ...
  '#':: d.pkg(name='tag', url='', help='"Tag is the Schema for the Tags API. Manages a API Management Tag."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiManagementId':: d.fn(help='"The ID of the API Management. Changing this forces a new API Management Tag to be created."', args=[d.arg(name='apiManagementId', type=d.T.string)]),
      withApiManagementId(apiManagementId): { spec+: { forProvider+: { apiManagementId: apiManagementId } } },
      '#withDisplayName':: d.fn(help='"The display name of the API Management Tag. Defaults to the name."', args=[d.arg(name='displayName', type=d.T.string)]),
