{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#moduleLink':: d.obj(help='"The published Module link."'),
      moduleLink: {
        '#hash':: d.obj(help=''),
        hash: {
