{
  ...
  spec: {
    ...
    forProvider: {
      '#containerIdRef':: d.obj(help='"Reference to a SQLContainer to populate containerId."'),
      containerIdRef: {
      ...
      '#containerIdSelector':: d.obj(help='"Selector for a SQLContainer to populate containerId."'),
      containerIdSelector: {
