  ...
  spec: {
    ...
    forProvider: {
      ...
      encryption: {
        ...
        '#withUseSystemAssignedIdentity':: d.fn(help='"Indicate that system assigned identity should be used or not. At this time the only possible value is true. Defaults to true."', args=[d.arg(name='useSystemAssignedIdentity', type=d.T.boolean)]),
      ...
      identity: {
        '#withType':: d.fn(help='"Specifies the type of Managed Service Identity that should be configured on this Recovery Services Vault. The only possible value is SystemAssigned."', args=[d.arg(name='type', type=d.T.string)]),
