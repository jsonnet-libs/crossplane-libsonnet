{
  ...
  '#':: d.pkg(name='spatialAnchorsAccount', url='', help='"SpatialAnchorsAccount is the Schema for the SpatialAnchorsAccounts API. Manages an Azure Spatial Anchors Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of SpatialAnchorsAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SpatialAnchorsAccountSpec defines the desired state of SpatialAnchorsAccount"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Spatial Anchors Account. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
