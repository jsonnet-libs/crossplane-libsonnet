{
  ...
  spec: {
    ...
    forProvider: {
      '#withResourceType':: d.fn(help='"The resource type this setting affects. Possible values are AppServices, ContainerRegistry, KeyVaults, KubernetesService, SqlServers, SqlServerVirtualMachines, StorageAccounts, VirtualMachines, Arm, Dns, OpenSourceRelationalDatabases, Containers and CloudPosture. Defaults to VirtualMachines"', args=[d.arg(name='resourceType', type=d.T.string)]),
