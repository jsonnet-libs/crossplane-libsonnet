{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#dnsZonePartnerIdRef':: d.obj(help='"Reference to a MSSQLManagedInstance to populate dnsZonePartnerId."'),
      dnsZonePartnerIdRef: {
      ...
      '#dnsZonePartnerIdSelector':: d.obj(help='"Selector for a MSSQLManagedInstance to populate dnsZonePartnerId."'),
      ...
      '#withStorageAccountType':: d.fn(help='"Specifies the storage account type used to store backups for this database. Changing this forces a new resource to be created. Possible values are GRS, LRS and ZRS. The default value is GRS."', args=[d.arg(name='storageAccountType', type=d.T.string)]),
      ...
      '#withVcores':: d.fn(help='"Number of cores that should be assigned to the SQL Managed Instance. Values can be 8, 16, or 24 for Gen4 SKUs, or 4, 8, 16, 24, 32, 40, 64, or 80 for Gen5 SKUs."', args=[d.arg(name='vcores', type=d.T.number)]),
