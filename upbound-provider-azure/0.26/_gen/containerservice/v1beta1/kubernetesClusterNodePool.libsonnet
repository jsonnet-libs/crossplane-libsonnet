{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#windowsProfile':: d.obj(help='"A windows_profile block as documented below."'),
      windowsProfile: {
      ...
      '#withWindowsProfile':: d.fn(help='"A windows_profile block as documented below."', args=[d.arg(name='windowsProfile', type=d.T.array)]),
