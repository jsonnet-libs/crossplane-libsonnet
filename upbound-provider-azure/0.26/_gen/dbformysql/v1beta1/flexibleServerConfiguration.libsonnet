{
  ...
  '#':: d.pkg(name='flexibleServerConfiguration', url='', help='"FlexibleServerConfiguration is the Schema for the FlexibleServerConfigurations API. Sets a MySQL Flexible Server Configuration value on a MySQL Flexible Server."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withValue':: d.fn(help='"Specifies the value of the MySQL Flexible Server Configuration. See the MySQL documentation for valid values. Changing this forces a new resource to be created."', args=[d.arg(name='value', type=d.T.string)]),
