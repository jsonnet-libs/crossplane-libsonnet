{
  ...
  '#':: d.pkg(name='workspaceCustomerManagedKey', url='', help='"WorkspaceCustomerManagedKey is the Schema for the WorkspaceCustomerManagedKeys API. Manages a Customer Managed Key for a Databricks Workspace"'),
