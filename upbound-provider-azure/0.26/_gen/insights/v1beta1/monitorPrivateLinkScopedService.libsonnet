{
  ...
  spec: {
    ...
    forProvider: {
      '#linkedResourceIdRef':: d.obj(help='"Reference to a ApplicationInsights to populate linkedResourceId."'),
      linkedResourceIdRef: {
      ...
      '#linkedResourceIdSelector':: d.obj(help='"Selector for a ApplicationInsights to populate linkedResourceId."'),
      ...
      '#scopeNameRef':: d.obj(help='"Reference to a MonitorPrivateLinkScope to populate scopeName."'),
      scopeNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#scopeNameSelector':: d.obj(help='"Selector for a MonitorPrivateLinkScope to populate scopeName."'),
      scopeNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
