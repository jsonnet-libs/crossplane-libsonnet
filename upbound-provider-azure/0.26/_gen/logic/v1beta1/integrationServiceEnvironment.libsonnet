{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSkuName':: d.fn(help='"The SKU name and capacity of the Integration Service Environment. Possible Values for sku element are Developer and Premium and possible values for the capacity element are from 0 to 10.  Defaults to sku of Developer with a Capacity of 0 (e.g. Developer_0). Changing this forces a new Integration Service Environment to be created when sku element is not the same with existing one."', args=[d.arg(name='skuName', type=d.T.string)]),
