{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoKeyRotationEnabled':: d.fn(help='"Boolean flag to specify whether Azure Disk Encryption Set automatically rotates encryption Key to latest version."', args=[d.arg(name='autoKeyRotationEnabled', type=d.T.boolean)]),
