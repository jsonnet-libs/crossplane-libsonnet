{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#osDisk':: d.obj(help='"One or more os_disk elements as defined below."'),
      osDisk: {
        '#withBlobUri':: d.fn(help='"Specifies the URI in Azure storage of the blob that you want to use to create the image."', args=[d.arg(name='blobUri', type=d.T.string)]),
        withBlobUri(blobUri): { blobUri: blobUri },
        '#withCaching':: d.fn(help='"Specifies the caching mode as ReadWrite, ReadOnly, or None. The default is None."', args=[d.arg(name='caching', type=d.T.string)]),
