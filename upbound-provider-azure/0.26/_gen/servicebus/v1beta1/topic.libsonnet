{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnableBatchedOperations':: d.fn(help='"Boolean flag which controls if server-side batched operations are enabled. Defaults to false."', args=[d.arg(name='enableBatchedOperations', type=d.T.boolean)]),
      withEnableBatchedOperations(enableBatchedOperations): { spec+: { forProvider+: { enableBatchedOperations: enableBatchedOperations } } },
      '#withEnableExpress':: d.fn(help='"Boolean flag which controls whether Express Entities are enabled. An express topic holds a message in memory temporarily before writing it to persistent storage. Defaults to false."', args=[d.arg(name='enableExpress', type=d.T.boolean)]),
      withEnableExpress(enableExpress): { spec+: { forProvider+: { enableExpress: enableExpress } } },
      '#withEnablePartitioning':: d.fn(help='"Boolean flag which controls whether to enable Changing this forces a new resource to be created. the topic to be partitioned across multiple message brokers. Defaults to false. Changing this forces a new resource to be created."', args=[d.arg(name='enablePartitioning', type=d.T.boolean)]),
      ...
      '#withNamespaceId':: d.fn(help='"The ID of the ServiceBus Namespace to create Changing this forces a new resource to be created. this topic in. Changing this forces a new resource to be created."', args=[d.arg(name='namespaceId', type=d.T.string)]),
      ...
      '#withSupportOrdering':: d.fn(help='"Boolean flag which controls whether the Topic supports ordering. Defaults to false."', args=[d.arg(name='supportOrdering', type=d.T.boolean)]),
