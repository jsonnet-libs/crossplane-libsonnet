{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultAction':: d.fn(help='"Specifies the default action for the ServiceBus Namespace Network Rule Set. Possible values are Allow and Deny. Defaults to Deny."', args=[d.arg(name='defaultAction', type=d.T.string)]),
