{
  ...
  '#':: d.pkg(name='applicationSecurityGroup', url='', help='"ApplicationSecurityGroup is the Schema for the ApplicationSecurityGroups API. Manages an Application Security Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApplicationSecurityGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ApplicationSecurityGroupSpec defines the desired state of ApplicationSecurityGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to create the Application Security Group. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
