{
  ...
  '#':: d.pkg(name='expressRouteCircuitAuthorization', url='', help='"ExpressRouteCircuitAuthorization is the Schema for the ExpressRouteCircuitAuthorizations API. Manages an ExpressRoute Circuit Authorization."'),
  ...
  '#new':: d.fn(help='new returns an instance of ExpressRouteCircuitAuthorization', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ExpressRouteCircuitAuthorizationSpec defines the desired state of ExpressRouteCircuitAuthorization"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withExpressRouteCircuitName':: d.fn(help='"The name of the Express Route Circuit in which to create the Authorization. Changing this forces a new resource to be created."', args=[d.arg(name='expressRouteCircuitName', type=d.T.string)]),
      withExpressRouteCircuitName(expressRouteCircuitName): { spec+: { forProvider+: { expressRouteCircuitName: expressRouteCircuitName } } },
      '#withResourceGroupName':: d.fn(help='"The name of the resource group in which to Changing this forces a new resource to be created. create the ExpressRoute circuit. Changing this forces a new resource to be created."', args=[d.arg(name='resourceGroupName', type=d.T.string)]),
