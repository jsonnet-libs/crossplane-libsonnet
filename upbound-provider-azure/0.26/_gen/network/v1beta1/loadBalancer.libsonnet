{
  ...
  spec: {
    ...
    forProvider: {
      '#frontendIpConfiguration':: d.obj(help='"One or multiple frontend_ip_configuration blocks as documented below."'),
      frontendIpConfiguration: {
        ...
        '#withName':: d.fn(help='"Specifies the name of the frontend IP configuration. Changing this forces a new resource to be created."', args=[d.arg(name='name', type=d.T.string)]),
        ...
        '#withZones':: d.fn(help='"Specifies a list of Availability Zones in which the IP Address for this Load Balancer should be located. Changing this forces a new Load Balancer to be created."', args=[d.arg(name='zones', type=d.T.array)]),
        withZones(zones): { zones: if std.isArray(v=zones) then zones else [zones] },
        '#withZonesMixin':: d.fn(help='"Specifies a list of Availability Zones in which the IP Address for this Load Balancer should be located. Changing this forces a new Load Balancer to be created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zones', type=d.T.array)]),
      ...
      '#withFrontendIpConfiguration':: d.fn(help='"One or multiple frontend_ip_configuration blocks as documented below."', args=[d.arg(name='frontendIpConfiguration', type=d.T.array)]),
