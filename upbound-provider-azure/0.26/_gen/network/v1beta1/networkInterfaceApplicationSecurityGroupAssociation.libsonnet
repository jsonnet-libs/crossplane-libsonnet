{
  ...
  spec: {
    ...
    forProvider: {
      '#applicationSecurityGroupIdRef':: d.obj(help='"Reference to a ApplicationSecurityGroup to populate applicationSecurityGroupId."'),
      ...
      '#applicationSecurityGroupIdSelector':: d.obj(help='"Selector for a ApplicationSecurityGroup to populate applicationSecurityGroupId."'),
