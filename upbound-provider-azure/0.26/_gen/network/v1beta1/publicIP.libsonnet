{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIpVersion':: d.fn(help='"The IP Version to use, IPv6 or IPv4. Changing this forces a new resource to be created."', args=[d.arg(name='ipVersion', type=d.T.string)]),
