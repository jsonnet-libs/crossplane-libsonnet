{
  ...
  '#':: d.pkg(name='networkInterfaceSecurityGroupAssociation', url='', help='"NetworkInterfaceSecurityGroupAssociation is the Schema for the NetworkInterfaceSecurityGroupAssociations API. Manages the association between a Network Interface and a Network Security Group."'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkInterfaceSecurityGroupAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NetworkInterfaceSecurityGroupAssociationSpec defines the desired state of NetworkInterfaceSecurityGroupAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withNetworkSecurityGroupId':: d.fn(help='"The ID of the Network Security Group which should be attached to the Network Interface. Changing this forces a new resource to be created."', args=[d.arg(name='networkSecurityGroupId', type=d.T.string)]),
