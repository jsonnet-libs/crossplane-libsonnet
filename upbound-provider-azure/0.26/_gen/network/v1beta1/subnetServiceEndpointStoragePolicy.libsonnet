  ...
  spec: {
    ...
    forProvider: {
      ...
      definition: {
        ...
        '#withServiceResources':: d.fn(help='"Specifies a list of resources that this Subnet Service Endpoint Storage Policy Definition applies to."', args=[d.arg(name='serviceResources', type=d.T.array)]),
        ...
        '#withServiceResourcesMixin':: d.fn(help='"Specifies a list of resources that this Subnet Service Endpoint Storage Policy Definition applies to."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceResources', type=d.T.array)]),
