{
  ...
  '#':: d.pkg(name='nopResource', url='', help='"A NopResource is an example API type."'),
  ...
  '#new':: d.fn(help='new returns an instance of NopResource', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"A NopResourceSpec defines the desired state of a NopResource."'),
  spec: {
    '#forProvider':: d.obj(help='"NopResourceParameters are the configurable fields of a NopResource."'),
    forProvider: {
      '#conditionAfter':: d.obj(help='"ConditionAfter can be used to set status conditions after a specified time. By default a NopResource will only have a status condition of Type: Synced. It will never have a status condition of Type: Ready unless one is configured here."'),
      conditionAfter: {
        '#withConditionReason':: d.fn(help='"ConditionReason to set - e.g. Available."', args=[d.arg(name='conditionReason', type=d.T.string)]),
        withConditionReason(conditionReason): { conditionReason: conditionReason },
        '#withConditionStatus':: d.fn(help='"ConditionStatus to set - e.g. True."', args=[d.arg(name='conditionStatus', type=d.T.string)]),
        withConditionStatus(conditionStatus): { conditionStatus: conditionStatus },
        '#withConditionType':: d.fn(help='"ConditionType to set - e.g. Ready."', args=[d.arg(name='conditionType', type=d.T.string)]),
        withConditionType(conditionType): { conditionType: conditionType },
        '#withTime':: d.fn(help='"Time is the duration after which the condition should be set."', args=[d.arg(name='time', type=d.T.string)]),
        withTime(time): { time: time },
      },
      '#connectionDetails':: d.obj(help='"ConnectionDetails that this NopResource should emit on each reconcile."'),
      connectionDetails: {
        '#withName':: d.fn(help='"Name of the connection detail."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"Value of the connection detail."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withConditionAfter':: d.fn(help='"ConditionAfter can be used to set status conditions after a specified time. By default a NopResource will only have a status condition of Type: Synced. It will never have a status condition of Type: Ready unless one is configured here."', args=[d.arg(name='conditionAfter', type=d.T.array)]),
      withConditionAfter(conditionAfter): { spec+: { forProvider+: { conditionAfter: if std.isArray(v=conditionAfter) then conditionAfter else [conditionAfter] } } },
      '#withConditionAfterMixin':: d.fn(help='"ConditionAfter can be used to set status conditions after a specified time. By default a NopResource will only have a status condition of Type: Synced. It will never have a status condition of Type: Ready unless one is configured here."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='conditionAfter', type=d.T.array)]),
      withConditionAfterMixin(conditionAfter): { spec+: { forProvider+: { conditionAfter+: if std.isArray(v=conditionAfter) then conditionAfter else [conditionAfter] } } },
      '#withConnectionDetails':: d.fn(help='"ConnectionDetails that this NopResource should emit on each reconcile."', args=[d.arg(name='connectionDetails', type=d.T.array)]),
      withConnectionDetails(connectionDetails): { spec+: { forProvider+: { connectionDetails: if std.isArray(v=connectionDetails) then connectionDetails else [connectionDetails] } } },
      '#withConnectionDetailsMixin':: d.fn(help='"ConnectionDetails that this NopResource should emit on each reconcile."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='connectionDetails', type=d.T.array)]),
      withConnectionDetailsMixin(connectionDetails): { spec+: { forProvider+: { connectionDetails+: if std.isArray(v=connectionDetails) then connectionDetails else [connectionDetails] } } },
      '#withFields':: d.fn(help='"Fields is an arbitrary object you can patch to and from. It has no schema, is not validated, and is not used by the NopResource controller."', args=[d.arg(name='fields', type=d.T.object)]),
      withFields(fields): { spec+: { forProvider+: { fields: fields } } },
      ...
      withFieldsMixin(fields): { spec+: { forProvider+: { fields+: fields } } },
    },
