{
  ...
  '#':: d.pkg(name='configurationRecorder', url='', help='"ConfigurationRecorder is the Schema for the ConfigurationRecorders API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#recordingGroup':: d.obj(help=''),
      recordingGroup: {
        '#withAllSupported':: d.fn(help='', args=[d.arg(name='allSupported', type=d.T.boolean)]),
        withAllSupported(allSupported): { allSupported: allSupported },
        '#withIncludeGlobalResourceTypes':: d.fn(help='', args=[d.arg(name='includeGlobalResourceTypes', type=d.T.boolean)]),
      ...
      '#withRecordingGroup':: d.fn(help='', args=[d.arg(name='recordingGroup', type=d.T.array)]),
