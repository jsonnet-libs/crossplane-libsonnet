{
  ...
  '#':: d.pkg(name='configurationAggregator', url='', help='"ConfigurationAggregator is the Schema for the ConfigurationAggregators API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#organizationAggregationSource':: d.obj(help=''),
      ...
      '#withAccountAggregationSource':: d.fn(help='', args=[d.arg(name='accountAggregationSource', type=d.T.array)]),
      ...
      '#withOrganizationAggregationSource':: d.fn(help='', args=[d.arg(name='organizationAggregationSource', type=d.T.array)]),
