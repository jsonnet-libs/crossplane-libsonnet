{
  ...
  '#':: d.pkg(name='remediationConfiguration', url='', help='"RemediationConfiguration is the Schema for the RemediationConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      parameter: {
        ...
        '#withResourceValue':: d.fn(help='', args=[d.arg(name='resourceValue', type=d.T.string)]),
        withResourceValue(resourceValue): { resourceValue: resourceValue },
        '#withStaticValue':: d.fn(help='', args=[d.arg(name='staticValue', type=d.T.string)]),
        withStaticValue(staticValue): { staticValue: staticValue },
      },
      '#withConfigRuleName':: d.fn(help='', args=[d.arg(name='configRuleName', type=d.T.string)]),
      withConfigRuleName(configRuleName): { spec+: { forProvider+: { configRuleName: configRuleName } } },
