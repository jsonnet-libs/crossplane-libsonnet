{
  ...
  '#':: d.pkg(name='organizationManagedRule', url='', help='"OrganizationManagedRule is the Schema for the OrganizationManagedRules API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationManagedRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationManagedRuleSpec defines the desired state of OrganizationManagedRule"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRuleIdentifier':: d.fn(help='', args=[d.arg(name='ruleIdentifier', type=d.T.string)]),
      withRuleIdentifier(ruleIdentifier): { spec+: { forProvider+: { ruleIdentifier: ruleIdentifier } } },
