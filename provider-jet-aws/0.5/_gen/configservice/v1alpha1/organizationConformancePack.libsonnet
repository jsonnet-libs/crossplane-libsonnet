{
  ...
  '#':: d.pkg(name='organizationConformancePack', url='', help='"OrganizationConformancePack is the Schema for the OrganizationConformancePacks API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationConformancePack', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationConformancePackSpec defines the desired state of OrganizationConformancePack"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#inputParameter':: d.obj(help=''),
      inputParameter: {
      ...
      '#withDeliveryS3Bucket':: d.fn(help='', args=[d.arg(name='deliveryS3Bucket', type=d.T.string)]),
      withDeliveryS3Bucket(deliveryS3Bucket): { spec+: { forProvider+: { deliveryS3Bucket: deliveryS3Bucket } } },
      '#withDeliveryS3KeyPrefix':: d.fn(help='', args=[d.arg(name='deliveryS3KeyPrefix', type=d.T.string)]),
      ...
      '#withInputParameter':: d.fn(help='', args=[d.arg(name='inputParameter', type=d.T.array)]),
      ...
      '#withTemplateS3Uri':: d.fn(help='', args=[d.arg(name='templateS3Uri', type=d.T.string)]),
