{
  ...
  '#':: d.pkg(name='deliveryChannel', url='', help='"DeliveryChannel is the Schema for the DeliveryChannels API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#snapshotDeliveryProperties':: d.obj(help=''),
      snapshotDeliveryProperties: {
        '#withDeliveryFrequency':: d.fn(help='', args=[d.arg(name='deliveryFrequency', type=d.T.string)]),
      ...
      '#withSnapshotDeliveryProperties':: d.fn(help='', args=[d.arg(name='snapshotDeliveryProperties', type=d.T.array)]),
