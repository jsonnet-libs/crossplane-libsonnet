{
  ...
  '#':: d.pkg(name='aggregateAuthorization', url='', help='"AggregateAuthorization is the Schema for the AggregateAuthorizations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AggregateAuthorization', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AggregateAuthorizationSpec defines the desired state of AggregateAuthorization"'),
  spec: {
