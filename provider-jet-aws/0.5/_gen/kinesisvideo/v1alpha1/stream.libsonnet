{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDataRetentionInHours':: d.fn(help='', args=[d.arg(name='dataRetentionInHours', type=d.T.number)]),
      ...
      '#withMediaType':: d.fn(help='', args=[d.arg(name='mediaType', type=d.T.string)]),
