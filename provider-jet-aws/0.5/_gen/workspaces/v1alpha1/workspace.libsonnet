{
  ...
  spec: {
    ...
    forProvider: {
      '#withBundleId':: d.fn(help='', args=[d.arg(name='bundleId', type=d.T.string)]),
      ...
      '#withRootVolumeEncryptionEnabled':: d.fn(help='', args=[d.arg(name='rootVolumeEncryptionEnabled', type=d.T.boolean)]),
      withRootVolumeEncryptionEnabled(rootVolumeEncryptionEnabled): { spec+: { forProvider+: { rootVolumeEncryptionEnabled: rootVolumeEncryptionEnabled } } },
      ...
      '#withUserVolumeEncryptionEnabled':: d.fn(help='', args=[d.arg(name='userVolumeEncryptionEnabled', type=d.T.boolean)]),
      withUserVolumeEncryptionEnabled(userVolumeEncryptionEnabled): { spec+: { forProvider+: { userVolumeEncryptionEnabled: userVolumeEncryptionEnabled } } },
      '#withVolumeEncryptionKey':: d.fn(help='', args=[d.arg(name='volumeEncryptionKey', type=d.T.string)]),
      withVolumeEncryptionKey(volumeEncryptionKey): { spec+: { forProvider+: { volumeEncryptionKey: volumeEncryptionKey } } },
      '#withWorkspaceProperties':: d.fn(help='', args=[d.arg(name='workspaceProperties', type=d.T.array)]),
      withWorkspaceProperties(workspaceProperties): { spec+: { forProvider+: { workspaceProperties: if std.isArray(v=workspaceProperties) then workspaceProperties else [workspaceProperties] } } },
      '#withWorkspacePropertiesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='workspaceProperties', type=d.T.array)]),
      withWorkspacePropertiesMixin(workspaceProperties): { spec+: { forProvider+: { workspaceProperties+: if std.isArray(v=workspaceProperties) then workspaceProperties else [workspaceProperties] } } },
      '#workspaceProperties':: d.obj(help=''),
      workspaceProperties: {
        '#withComputeTypeName':: d.fn(help='', args=[d.arg(name='computeTypeName', type=d.T.string)]),
        withComputeTypeName(computeTypeName): { computeTypeName: computeTypeName },
        '#withRootVolumeSizeGib':: d.fn(help='', args=[d.arg(name='rootVolumeSizeGib', type=d.T.number)]),
        withRootVolumeSizeGib(rootVolumeSizeGib): { rootVolumeSizeGib: rootVolumeSizeGib },
        '#withRunningMode':: d.fn(help='', args=[d.arg(name='runningMode', type=d.T.string)]),
        withRunningMode(runningMode): { runningMode: runningMode },
        '#withRunningModeAutoStopTimeoutInMinutes':: d.fn(help='', args=[d.arg(name='runningModeAutoStopTimeoutInMinutes', type=d.T.number)]),
        withRunningModeAutoStopTimeoutInMinutes(runningModeAutoStopTimeoutInMinutes): { runningModeAutoStopTimeoutInMinutes: runningModeAutoStopTimeoutInMinutes },
        '#withUserVolumeSizeGib':: d.fn(help='', args=[d.arg(name='userVolumeSizeGib', type=d.T.number)]),
        withUserVolumeSizeGib(userVolumeSizeGib): { userVolumeSizeGib: userVolumeSizeGib },
      },
    },
