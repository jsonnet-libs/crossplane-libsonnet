{
  ...
  '#':: d.pkg(name='staticIPAttachment', url='', help='"StaticIPAttachment is the Schema for the StaticIPAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStaticIpName':: d.fn(help='', args=[d.arg(name='staticIpName', type=d.T.string)]),
