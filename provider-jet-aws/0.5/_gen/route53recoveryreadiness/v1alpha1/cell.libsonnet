{
  ...
  '#':: d.pkg(name='cell', url='', help='"Cell is the Schema for the Cells API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCellName':: d.fn(help='', args=[d.arg(name='cellName', type=d.T.string)]),
      withCellName(cellName): { spec+: { forProvider+: { cellName: cellName } } },
