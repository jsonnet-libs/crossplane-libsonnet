{
  ...
  '#':: d.pkg(name='readinessCheck', url='', help='"ReadinessCheck is the Schema for the ReadinessChecks API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withReadinessCheckName':: d.fn(help='', args=[d.arg(name='readinessCheckName', type=d.T.string)]),
      withReadinessCheckName(readinessCheckName): { spec+: { forProvider+: { readinessCheckName: readinessCheckName } } },
