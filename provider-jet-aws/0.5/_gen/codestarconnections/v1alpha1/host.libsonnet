  ...
  spec: {
    ...
    forProvider: {
      ...
      vpcConfiguration: {
        ...
        '#withTlsCertificate':: d.fn(help='', args=[d.arg(name='tlsCertificate', type=d.T.string)]),
      ...
      '#withProviderEndpoint':: d.fn(help='', args=[d.arg(name='providerEndpoint', type=d.T.string)]),
