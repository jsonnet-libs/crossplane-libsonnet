{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAttachmentsSource':: d.fn(help='', args=[d.arg(name='attachmentsSource', type=d.T.array)]),
      ...
      '#withDocumentFormat':: d.fn(help='', args=[d.arg(name='documentFormat', type=d.T.string)]),
      withDocumentFormat(documentFormat): { spec+: { forProvider+: { documentFormat: documentFormat } } },
      '#withDocumentType':: d.fn(help='', args=[d.arg(name='documentType', type=d.T.string)]),
      withDocumentType(documentType): { spec+: { forProvider+: { documentType: documentType } } },
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPermissions':: d.fn(help='', args=[d.arg(name='permissions', type=d.T.object)]),
      ...
      '#withVersionName':: d.fn(help='', args=[d.arg(name='versionName', type=d.T.string)]),
