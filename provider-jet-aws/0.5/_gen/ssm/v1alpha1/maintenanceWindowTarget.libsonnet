{
  ...
  '#':: d.pkg(name='maintenanceWindowTarget', url='', help='"MaintenanceWindowTarget is the Schema for the MaintenanceWindowTargets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOwnerInformation':: d.fn(help='', args=[d.arg(name='ownerInformation', type=d.T.string)]),
