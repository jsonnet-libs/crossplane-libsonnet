{
  ...
  '#':: d.pkg(name='parameter', url='', help='"Parameter is the Schema for the Parameters API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowedPattern':: d.fn(help='', args=[d.arg(name='allowedPattern', type=d.T.string)]),
