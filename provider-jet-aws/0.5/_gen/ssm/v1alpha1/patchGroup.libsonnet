{
  ...
  '#':: d.pkg(name='patchGroup', url='', help='"PatchGroup is the Schema for the PatchGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBaselineId':: d.fn(help='', args=[d.arg(name='baselineId', type=d.T.string)]),
      withBaselineId(baselineId): { spec+: { forProvider+: { baselineId: baselineId } } },
      '#withPatchGroup':: d.fn(help='', args=[d.arg(name='patchGroup', type=d.T.string)]),
