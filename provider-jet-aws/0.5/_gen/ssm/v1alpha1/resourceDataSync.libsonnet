{
  ...
  '#':: d.pkg(name='resourceDataSync', url='', help='"ResourceDataSync is the Schema for the ResourceDataSyncs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      s3Destination: {
        ...
        '#withSyncFormat':: d.fn(help='', args=[d.arg(name='syncFormat', type=d.T.string)]),
