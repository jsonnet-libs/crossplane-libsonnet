{
  ...
  '#':: d.pkg(name='maintenanceWindow', url='', help='"MaintenanceWindow is the Schema for the MaintenanceWindows API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAllowUnassociatedTargets':: d.fn(help='', args=[d.arg(name='allowUnassociatedTargets', type=d.T.boolean)]),
      withAllowUnassociatedTargets(allowUnassociatedTargets): { spec+: { forProvider+: { allowUnassociatedTargets: allowUnassociatedTargets } } },
      '#withCutoff':: d.fn(help='', args=[d.arg(name='cutoff', type=d.T.number)]),
      ...
      '#withScheduleOffset':: d.fn(help='', args=[d.arg(name='scheduleOffset', type=d.T.number)]),
      withScheduleOffset(scheduleOffset): { spec+: { forProvider+: { scheduleOffset: scheduleOffset } } },
      '#withScheduleTimezone':: d.fn(help='', args=[d.arg(name='scheduleTimezone', type=d.T.string)]),
      withScheduleTimezone(scheduleTimezone): { spec+: { forProvider+: { scheduleTimezone: scheduleTimezone } } },
      '#withStartDate':: d.fn(help='', args=[d.arg(name='startDate', type=d.T.string)]),
