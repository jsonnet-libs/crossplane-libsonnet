{
  ...
  '#':: d.pkg(name='association', url='', help='"Association is the Schema for the Associations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApplyOnlyAtCronInterval':: d.fn(help='', args=[d.arg(name='applyOnlyAtCronInterval', type=d.T.boolean)]),
      withApplyOnlyAtCronInterval(applyOnlyAtCronInterval): { spec+: { forProvider+: { applyOnlyAtCronInterval: applyOnlyAtCronInterval } } },
      '#withAssociationName':: d.fn(help='', args=[d.arg(name='associationName', type=d.T.string)]),
      withAssociationName(associationName): { spec+: { forProvider+: { associationName: associationName } } },
      '#withAutomationTargetParameterName':: d.fn(help='', args=[d.arg(name='automationTargetParameterName', type=d.T.string)]),
      ...
      '#withComplianceSeverity':: d.fn(help='', args=[d.arg(name='complianceSeverity', type=d.T.string)]),
      ...
      '#withOutputLocation':: d.fn(help='', args=[d.arg(name='outputLocation', type=d.T.array)]),
      ...
      '#withScheduleExpression':: d.fn(help='', args=[d.arg(name='scheduleExpression', type=d.T.string)]),
