{
  ...
  '#':: d.pkg(name='activation', url='', help='"Activation is the Schema for the Activations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExpirationDate':: d.fn(help='', args=[d.arg(name='expirationDate', type=d.T.string)]),
      ...
      '#withRegistrationLimit':: d.fn(help='', args=[d.arg(name='registrationLimit', type=d.T.number)]),
