{
  ...
  '#':: d.pkg(name='trafficMirrorSession', url='', help='"TrafficMirrorSession is the Schema for the TrafficMirrorSessions API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TrafficMirrorSession', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TrafficMirrorSessionSpec defines the desired state of TrafficMirrorSession"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPacketLength':: d.fn(help='', args=[d.arg(name='packetLength', type=d.T.number)]),
      withPacketLength(packetLength): { spec+: { forProvider+: { packetLength: packetLength } } },
      ...
      '#withSessionNumber':: d.fn(help='', args=[d.arg(name='sessionNumber', type=d.T.number)]),
      withSessionNumber(sessionNumber): { spec+: { forProvider+: { sessionNumber: sessionNumber } } },
      ...
      '#withTrafficMirrorFilterId':: d.fn(help='', args=[d.arg(name='trafficMirrorFilterId', type=d.T.string)]),
      withTrafficMirrorFilterId(trafficMirrorFilterId): { spec+: { forProvider+: { trafficMirrorFilterId: trafficMirrorFilterId } } },
      '#withTrafficMirrorTargetId':: d.fn(help='', args=[d.arg(name='trafficMirrorTargetId', type=d.T.string)]),
      withTrafficMirrorTargetId(trafficMirrorTargetId): { spec+: { forProvider+: { trafficMirrorTargetId: trafficMirrorTargetId } } },
      '#withVirtualNetworkId':: d.fn(help='', args=[d.arg(name='virtualNetworkId', type=d.T.number)]),
