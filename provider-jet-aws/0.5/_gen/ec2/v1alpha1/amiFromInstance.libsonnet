{
  ...
  '#':: d.pkg(name='amiFromInstance', url='', help='"AMIFromInstance is the Schema for the AMIFromInstances API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AMIFromInstance', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AMIFromInstanceSpec defines the desired state of AMIFromInstance"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSnapshotWithoutReboot':: d.fn(help='', args=[d.arg(name='snapshotWithoutReboot', type=d.T.boolean)]),
      withSnapshotWithoutReboot(snapshotWithoutReboot): { spec+: { forProvider+: { snapshotWithoutReboot: snapshotWithoutReboot } } },
      '#withSourceInstanceId':: d.fn(help='', args=[d.arg(name='sourceInstanceId', type=d.T.string)]),
      withSourceInstanceId(sourceInstanceId): { spec+: { forProvider+: { sourceInstanceId: sourceInstanceId } } },
