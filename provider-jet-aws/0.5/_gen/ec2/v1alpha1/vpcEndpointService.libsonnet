{
  ...
  '#':: d.pkg(name='vpcEndpointService', url='', help='"VPCEndpointService is the Schema for the VPCEndpointServices API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAcceptanceRequired':: d.fn(help='', args=[d.arg(name='acceptanceRequired', type=d.T.boolean)]),
      withAcceptanceRequired(acceptanceRequired): { spec+: { forProvider+: { acceptanceRequired: acceptanceRequired } } },
      '#withAllowedPrincipals':: d.fn(help='', args=[d.arg(name='allowedPrincipals', type=d.T.array)]),
      withAllowedPrincipals(allowedPrincipals): { spec+: { forProvider+: { allowedPrincipals: if std.isArray(v=allowedPrincipals) then allowedPrincipals else [allowedPrincipals] } } },
      '#withAllowedPrincipalsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allowedPrincipals', type=d.T.array)]),
      withAllowedPrincipalsMixin(allowedPrincipals): { spec+: { forProvider+: { allowedPrincipals+: if std.isArray(v=allowedPrincipals) then allowedPrincipals else [allowedPrincipals] } } },
      '#withGatewayLoadBalancerArns':: d.fn(help='', args=[d.arg(name='gatewayLoadBalancerArns', type=d.T.array)]),
      ...
      '#withNetworkLoadBalancerArns':: d.fn(help='', args=[d.arg(name='networkLoadBalancerArns', type=d.T.array)]),
      ...
      '#withPrivateDnsName':: d.fn(help='', args=[d.arg(name='privateDnsName', type=d.T.string)]),
