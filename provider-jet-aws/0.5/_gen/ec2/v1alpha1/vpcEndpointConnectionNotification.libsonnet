{
  ...
  '#':: d.pkg(name='vpcEndpointConnectionNotification', url='', help='"VPCEndpointConnectionNotification is the Schema for the VPCEndpointConnectionNotifications API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withConnectionEvents':: d.fn(help='', args=[d.arg(name='connectionEvents', type=d.T.array)]),
      ...
      '#withConnectionNotificationArn':: d.fn(help='', args=[d.arg(name='connectionNotificationArn', type=d.T.string)]),
      ...
      '#withVpcEndpointServiceId':: d.fn(help='', args=[d.arg(name='vpcEndpointServiceId', type=d.T.string)]),
