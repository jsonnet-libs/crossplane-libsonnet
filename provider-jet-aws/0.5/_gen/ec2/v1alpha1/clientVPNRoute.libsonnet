{
  ...
  '#':: d.pkg(name='clientVPNRoute', url='', help='"ClientVPNRoute is the Schema for the ClientVPNRoutes API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClientVPNRoute', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClientVPNRouteSpec defines the desired state of ClientVPNRoute"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withTargetVpcSubnetId':: d.fn(help='', args=[d.arg(name='targetVpcSubnetId', type=d.T.string)]),
      withTargetVpcSubnetId(targetVpcSubnetId): { spec+: { forProvider+: { targetVpcSubnetId: targetVpcSubnetId } } },
    },
