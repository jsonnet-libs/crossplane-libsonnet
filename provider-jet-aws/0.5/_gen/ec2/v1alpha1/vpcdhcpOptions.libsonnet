{
  ...
  '#':: d.pkg(name='vpcdhcpOptions', url='', help='"VPCDHCPOptions is the Schema for the VPCDHCPOptionss API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDomainNameServers':: d.fn(help='', args=[d.arg(name='domainNameServers', type=d.T.array)]),
      ...
      '#withNetbiosNameServers':: d.fn(help='', args=[d.arg(name='netbiosNameServers', type=d.T.array)]),
