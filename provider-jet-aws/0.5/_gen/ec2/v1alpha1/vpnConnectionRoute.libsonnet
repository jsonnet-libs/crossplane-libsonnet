{
  ...
  '#':: d.pkg(name='vpnConnectionRoute', url='', help='"VPNConnectionRoute is the Schema for the VPNConnectionRoutes API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVpnConnectionId':: d.fn(help='', args=[d.arg(name='vpnConnectionId', type=d.T.string)]),
