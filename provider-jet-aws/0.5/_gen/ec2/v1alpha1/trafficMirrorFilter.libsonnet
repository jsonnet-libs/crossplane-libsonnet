{
  ...
  '#':: d.pkg(name='trafficMirrorFilter', url='', help='"TrafficMirrorFilter is the Schema for the TrafficMirrorFilters API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNetworkServices':: d.fn(help='', args=[d.arg(name='networkServices', type=d.T.array)]),
