{
  ...
  '#':: d.pkg(name='ebsSnapshotCopy', url='', help='"EBSSnapshotCopy is the Schema for the EBSSnapshotCopys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSourceSnapshotId':: d.fn(help='', args=[d.arg(name='sourceSnapshotId', type=d.T.string)]),
