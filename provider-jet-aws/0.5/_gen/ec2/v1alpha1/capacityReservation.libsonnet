{
  ...
  '#':: d.pkg(name='capacityReservation', url='', help='"CapacityReservation is the Schema for the CapacityReservations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEndDate':: d.fn(help='', args=[d.arg(name='endDate', type=d.T.string)]),
      withEndDate(endDate): { spec+: { forProvider+: { endDate: endDate } } },
      '#withEndDateType':: d.fn(help='', args=[d.arg(name='endDateType', type=d.T.string)]),
      withEndDateType(endDateType): { spec+: { forProvider+: { endDateType: endDateType } } },
      '#withEphemeralStorage':: d.fn(help='', args=[d.arg(name='ephemeralStorage', type=d.T.boolean)]),
      ...
      '#withInstanceMatchCriteria':: d.fn(help='', args=[d.arg(name='instanceMatchCriteria', type=d.T.string)]),
      withInstanceMatchCriteria(instanceMatchCriteria): { spec+: { forProvider+: { instanceMatchCriteria: instanceMatchCriteria } } },
      '#withInstancePlatform':: d.fn(help='', args=[d.arg(name='instancePlatform', type=d.T.string)]),
