{
  ...
  '#':: d.pkg(name='trafficMirrorTarget', url='', help='"TrafficMirrorTarget is the Schema for the TrafficMirrorTargets API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TrafficMirrorTarget', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TrafficMirrorTargetSpec defines the desired state of TrafficMirrorTarget"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withNetworkLoadBalancerArn':: d.fn(help='', args=[d.arg(name='networkLoadBalancerArn', type=d.T.string)]),
      withNetworkLoadBalancerArn(networkLoadBalancerArn): { spec+: { forProvider+: { networkLoadBalancerArn: networkLoadBalancerArn } } },
