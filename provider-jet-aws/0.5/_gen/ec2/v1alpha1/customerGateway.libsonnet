{
  ...
  '#':: d.pkg(name='customerGateway', url='', help='"CustomerGateway is the Schema for the CustomerGateways API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBgpAsn':: d.fn(help='', args=[d.arg(name='bgpAsn', type=d.T.string)]),
