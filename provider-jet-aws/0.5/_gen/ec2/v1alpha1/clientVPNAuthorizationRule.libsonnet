{
  ...
  '#':: d.pkg(name='clientVPNAuthorizationRule', url='', help='"ClientVPNAuthorizationRule is the Schema for the ClientVPNAuthorizationRules API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClientVPNAuthorizationRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClientVPNAuthorizationRuleSpec defines the desired state of ClientVPNAuthorizationRule"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAccessGroupId':: d.fn(help='', args=[d.arg(name='accessGroupId', type=d.T.string)]),
      withAccessGroupId(accessGroupId): { spec+: { forProvider+: { accessGroupId: accessGroupId } } },
      '#withAuthorizeAllGroups':: d.fn(help='', args=[d.arg(name='authorizeAllGroups', type=d.T.boolean)]),
      withAuthorizeAllGroups(authorizeAllGroups): { spec+: { forProvider+: { authorizeAllGroups: authorizeAllGroups } } },
      '#withClientVpnEndpointId':: d.fn(help='', args=[d.arg(name='clientVpnEndpointId', type=d.T.string)]),
      withClientVpnEndpointId(clientVpnEndpointId): { spec+: { forProvider+: { clientVpnEndpointId: clientVpnEndpointId } } },
      ...
      '#withTargetNetworkCidr':: d.fn(help='', args=[d.arg(name='targetNetworkCidr', type=d.T.string)]),
      withTargetNetworkCidr(targetNetworkCidr): { spec+: { forProvider+: { targetNetworkCidr: targetNetworkCidr } } },
    },
