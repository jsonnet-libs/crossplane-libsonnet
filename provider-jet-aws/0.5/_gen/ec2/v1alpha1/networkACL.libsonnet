{
  ...
  '#':: d.pkg(name='networkACL', url='', help='"NetworkACL is the Schema for the NetworkACLs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      egress: {
        ...
        '#withIcmpCode':: d.fn(help='', args=[d.arg(name='icmpCode', type=d.T.number)]),
        withIcmpCode(icmpCode): { icmpCode: icmpCode },
        '#withIcmpType':: d.fn(help='', args=[d.arg(name='icmpType', type=d.T.number)]),
        ...
        '#withRuleNo':: d.fn(help='', args=[d.arg(name='ruleNo', type=d.T.number)]),
