{
  ...
  '#':: d.pkg(name='amiCopy', url='', help='"AMICopy is the Schema for the AMICopys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDestinationOutpostArn':: d.fn(help='', args=[d.arg(name='destinationOutpostArn', type=d.T.string)]),
      ...
      '#withSourceAmiId':: d.fn(help='', args=[d.arg(name='sourceAmiId', type=d.T.string)]),
      withSourceAmiId(sourceAmiId): { spec+: { forProvider+: { sourceAmiId: sourceAmiId } } },
      '#withSourceAmiRegion':: d.fn(help='', args=[d.arg(name='sourceAmiRegion', type=d.T.string)]),
