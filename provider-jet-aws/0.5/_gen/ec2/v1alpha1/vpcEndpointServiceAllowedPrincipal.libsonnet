{
  ...
  '#':: d.pkg(name='vpcEndpointServiceAllowedPrincipal', url='', help='"VPCEndpointServiceAllowedPrincipal is the Schema for the VPCEndpointServiceAllowedPrincipals API"'),
