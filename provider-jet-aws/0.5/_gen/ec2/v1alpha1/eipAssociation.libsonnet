{
  ...
  '#':: d.pkg(name='eipAssociation', url='', help='"EIPAssociation is the Schema for the EIPAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowReassociation':: d.fn(help='', args=[d.arg(name='allowReassociation', type=d.T.boolean)]),
