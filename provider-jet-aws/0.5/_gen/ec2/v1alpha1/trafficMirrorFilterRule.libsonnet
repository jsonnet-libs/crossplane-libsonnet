{
  ...
  '#':: d.pkg(name='trafficMirrorFilterRule', url='', help='"TrafficMirrorFilterRule is the Schema for the TrafficMirrorFilterRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#destinationPortRange':: d.obj(help=''),
      ...
      '#withDestinationPortRange':: d.fn(help='', args=[d.arg(name='destinationPortRange', type=d.T.array)]),
      ...
      '#withProtocol':: d.fn(help='', args=[d.arg(name='protocol', type=d.T.number)]),
      ...
      '#withRuleAction':: d.fn(help='', args=[d.arg(name='ruleAction', type=d.T.string)]),
      withRuleAction(ruleAction): { spec+: { forProvider+: { ruleAction: ruleAction } } },
      '#withRuleNumber':: d.fn(help='', args=[d.arg(name='ruleNumber', type=d.T.number)]),
      withRuleNumber(ruleNumber): { spec+: { forProvider+: { ruleNumber: ruleNumber } } },
      '#withSourceCidrBlock':: d.fn(help='', args=[d.arg(name='sourceCidrBlock', type=d.T.string)]),
      withSourceCidrBlock(sourceCidrBlock): { spec+: { forProvider+: { sourceCidrBlock: sourceCidrBlock } } },
      '#withSourcePortRange':: d.fn(help='', args=[d.arg(name='sourcePortRange', type=d.T.array)]),
      ...
      '#withTrafficDirection':: d.fn(help='', args=[d.arg(name='trafficDirection', type=d.T.string)]),
