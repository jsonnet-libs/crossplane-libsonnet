{
  ...
  '#':: d.pkg(name='localGatewayRouteTableVPCAssociation', url='', help='"LocalGatewayRouteTableVPCAssociation is the Schema for the LocalGatewayRouteTableVPCAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocalGatewayRouteTableVPCAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocalGatewayRouteTableVPCAssociationSpec defines the desired state of LocalGatewayRouteTableVPCAssociation"'),
  spec: {
