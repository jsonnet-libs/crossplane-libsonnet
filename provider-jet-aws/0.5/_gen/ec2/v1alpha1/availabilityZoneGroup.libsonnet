{
  ...
  '#':: d.pkg(name='availabilityZoneGroup', url='', help='"AvailabilityZoneGroup is the Schema for the AvailabilityZoneGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOptInStatus':: d.fn(help='', args=[d.arg(name='optInStatus', type=d.T.string)]),
