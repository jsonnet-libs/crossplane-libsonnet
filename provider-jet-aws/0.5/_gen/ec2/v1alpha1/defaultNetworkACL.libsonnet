{
  ...
  '#':: d.pkg(name='defaultNetworkACL', url='', help='"DefaultNetworkACL is the Schema for the DefaultNetworkACLs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultNetworkAclId':: d.fn(help='', args=[d.arg(name='defaultNetworkAclId', type=d.T.string)]),
