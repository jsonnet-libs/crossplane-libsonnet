{
  ...
  '#':: d.pkg(name='natGateway', url='', help='"NATGateway is the Schema for the NATGateways API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConnectivityType':: d.fn(help='', args=[d.arg(name='connectivityType', type=d.T.string)]),
