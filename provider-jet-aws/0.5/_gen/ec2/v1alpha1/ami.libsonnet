{
  ...
  '#':: d.pkg(name='ami', url='', help='"AMI is the Schema for the AMIs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnaSupport':: d.fn(help='', args=[d.arg(name='enaSupport', type=d.T.boolean)]),
      ...
      '#withImageLocation':: d.fn(help='', args=[d.arg(name='imageLocation', type=d.T.string)]),
      ...
      '#withRootDeviceName':: d.fn(help='', args=[d.arg(name='rootDeviceName', type=d.T.string)]),
      withRootDeviceName(rootDeviceName): { spec+: { forProvider+: { rootDeviceName: rootDeviceName } } },
      '#withSriovNetSupport':: d.fn(help='', args=[d.arg(name='sriovNetSupport', type=d.T.string)]),
