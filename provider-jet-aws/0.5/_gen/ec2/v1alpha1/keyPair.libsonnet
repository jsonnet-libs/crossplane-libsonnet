{
  ...
  '#':: d.pkg(name='keyPair', url='', help='"KeyPair is the Schema for the KeyPairs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withKeyNamePrefix':: d.fn(help='', args=[d.arg(name='keyNamePrefix', type=d.T.string)]),
      withKeyNamePrefix(keyNamePrefix): { spec+: { forProvider+: { keyNamePrefix: keyNamePrefix } } },
