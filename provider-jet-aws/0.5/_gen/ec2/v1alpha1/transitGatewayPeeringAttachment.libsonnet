{
  ...
  '#':: d.pkg(name='transitGatewayPeeringAttachment', url='', help='"TransitGatewayPeeringAttachment is the Schema for the TransitGatewayPeeringAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withPeerAccountId':: d.fn(help='', args=[d.arg(name='peerAccountId', type=d.T.string)]),
      ...
      '#withPeerTransitGatewayId':: d.fn(help='', args=[d.arg(name='peerTransitGatewayId', type=d.T.string)]),
