{
  ...
  '#':: d.pkg(name='defaultRouteTable', url='', help='"DefaultRouteTable is the Schema for the DefaultRouteTables API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultRouteTableId':: d.fn(help='', args=[d.arg(name='defaultRouteTableId', type=d.T.string)]),
