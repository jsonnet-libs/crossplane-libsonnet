{
  ...
  '#':: d.pkg(name='clientVPNNetworkAssociation', url='', help='"ClientVPNNetworkAssociation is the Schema for the ClientVPNNetworkAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClientVPNNetworkAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClientVPNNetworkAssociationSpec defines the desired state of ClientVPNNetworkAssociation"'),
  spec: {
