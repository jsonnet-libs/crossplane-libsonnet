{
  ...
  '#':: d.pkg(name='vpnGateway', url='', help='"VPNGateway is the Schema for the VPNGateways API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAmazonSideAsn':: d.fn(help='', args=[d.arg(name='amazonSideAsn', type=d.T.string)]),
