{
  ...
  '#':: d.pkg(name='volumeAttachment', url='', help='"VolumeAttachment is the Schema for the VolumeAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withForceDetach':: d.fn(help='', args=[d.arg(name='forceDetach', type=d.T.boolean)]),
