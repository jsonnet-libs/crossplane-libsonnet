{
  ...
  '#':: d.pkg(name='localGatewayRoute', url='', help='"LocalGatewayRoute is the Schema for the LocalGatewayRoutes API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocalGatewayRoute', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocalGatewayRouteSpec defines the desired state of LocalGatewayRoute"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLocalGatewayRouteTableId':: d.fn(help='', args=[d.arg(name='localGatewayRouteTableId', type=d.T.string)]),
      withLocalGatewayRouteTableId(localGatewayRouteTableId): { spec+: { forProvider+: { localGatewayRouteTableId: localGatewayRouteTableId } } },
      '#withLocalGatewayVirtualInterfaceGroupId':: d.fn(help='', args=[d.arg(name='localGatewayVirtualInterfaceGroupId', type=d.T.string)]),
      withLocalGatewayVirtualInterfaceGroupId(localGatewayVirtualInterfaceGroupId): { spec+: { forProvider+: { localGatewayVirtualInterfaceGroupId: localGatewayVirtualInterfaceGroupId } } },
