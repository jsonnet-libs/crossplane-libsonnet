{
  ...
  '#':: d.pkg(name='networkACLRule', url='', help='"NetworkACLRule is the Schema for the NetworkACLRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEgress':: d.fn(help='', args=[d.arg(name='egress', type=d.T.boolean)]),
      ...
      '#withIcmpCode':: d.fn(help='', args=[d.arg(name='icmpCode', type=d.T.string)]),
      withIcmpCode(icmpCode): { spec+: { forProvider+: { icmpCode: icmpCode } } },
      '#withIcmpType':: d.fn(help='', args=[d.arg(name='icmpType', type=d.T.string)]),
      ...
      '#withNetworkAclId':: d.fn(help='', args=[d.arg(name='networkAclId', type=d.T.string)]),
