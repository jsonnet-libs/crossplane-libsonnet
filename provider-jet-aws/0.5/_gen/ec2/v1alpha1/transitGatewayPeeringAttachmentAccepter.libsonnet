{
  ...
  '#':: d.pkg(name='transitGatewayPeeringAttachmentAccepter', url='', help='"TransitGatewayPeeringAttachmentAccepter is the Schema for the TransitGatewayPeeringAttachmentAccepters API"'),
