{
  ...
  '#':: d.pkg(name='ebsSnapshotImport', url='', help='"EBSSnapshotImport is the Schema for the EBSSnapshotImports API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#clientData':: d.obj(help=''),
      clientData: {
        '#withComment':: d.fn(help='', args=[d.arg(name='comment', type=d.T.string)]),
        withComment(comment): { comment: comment },
        '#withUploadEnd':: d.fn(help='', args=[d.arg(name='uploadEnd', type=d.T.string)]),
        withUploadEnd(uploadEnd): { uploadEnd: uploadEnd },
        '#withUploadSize':: d.fn(help='', args=[d.arg(name='uploadSize', type=d.T.number)]),
        withUploadSize(uploadSize): { uploadSize: uploadSize },
        '#withUploadStart':: d.fn(help='', args=[d.arg(name='uploadStart', type=d.T.string)]),
        withUploadStart(uploadStart): { uploadStart: uploadStart },
      },
      '#diskContainer':: d.obj(help=''),
      diskContainer: {
        '#userBucket':: d.obj(help=''),
        userBucket: {
      ...
      '#withDiskContainer':: d.fn(help='', args=[d.arg(name='diskContainer', type=d.T.array)]),
