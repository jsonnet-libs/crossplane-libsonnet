{
  ...
  spec: {
    ...
    forProvider: {
      '#gatewayIdRef':: d.obj(help='"A Reference to a named object."'),
      gatewayIdRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { gatewayIdRef+: { name: name } } } },
      },
      '#gatewayIdSelector':: d.obj(help='"A Selector selects an object."'),
      gatewayIdSelector: {
      ...
      '#routeTableIdRef':: d.obj(help='"A Reference to a named object."'),
      routeTableIdRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { routeTableIdRef+: { name: name } } } },
      },
      '#routeTableIdSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#transitGatewayIdRef':: d.obj(help='"A Reference to a named object."'),
      transitGatewayIdRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { transitGatewayIdRef+: { name: name } } } },
      },
      '#transitGatewayIdSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withDestinationCidrBlock':: d.fn(help='', args=[d.arg(name='destinationCidrBlock', type=d.T.string)]),
      withDestinationCidrBlock(destinationCidrBlock): { spec+: { forProvider+: { destinationCidrBlock: destinationCidrBlock } } },
      '#withDestinationIpv6CidrBlock':: d.fn(help='', args=[d.arg(name='destinationIpv6CidrBlock', type=d.T.string)]),
      ...
      '#withRouteTableId':: d.fn(help='', args=[d.arg(name='routeTableId', type=d.T.string)]),
