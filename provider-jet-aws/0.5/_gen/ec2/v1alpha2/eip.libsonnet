{
  ...
  '#':: d.pkg(name='eip', url='', help='"EIP is the Schema for the EIPs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#networkInterfaceRef':: d.obj(help='"A Reference to a named object."'),
      networkInterfaceRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { networkInterfaceRef+: { name: name } } } },
      },
      '#networkInterfaceSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withAssociateWithPrivateIp':: d.fn(help='', args=[d.arg(name='associateWithPrivateIp', type=d.T.string)]),
      ...
      '#withNetworkInterface':: d.fn(help='', args=[d.arg(name='networkInterface', type=d.T.string)]),
      ...
      '#withVpc':: d.fn(help='', args=[d.arg(name='vpc', type=d.T.boolean)]),
