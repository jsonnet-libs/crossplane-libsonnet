{
  ...
  '#':: d.pkg(name='vpc', url='', help='"VPC is the Schema for the VPCs API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAssignGeneratedIpv6CidrBlock':: d.fn(help='', args=[d.arg(name='assignGeneratedIpv6CidrBlock', type=d.T.boolean)]),
      ...
      '#withEnableClassiclink':: d.fn(help='', args=[d.arg(name='enableClassiclink', type=d.T.boolean)]),
      withEnableClassiclink(enableClassiclink): { spec+: { forProvider+: { enableClassiclink: enableClassiclink } } },
      '#withEnableClassiclinkDnsSupport':: d.fn(help='', args=[d.arg(name='enableClassiclinkDnsSupport', type=d.T.boolean)]),
      ...
      '#withEnableDnsHostnames':: d.fn(help='', args=[d.arg(name='enableDnsHostnames', type=d.T.boolean)]),
      ...
      '#withInstanceTenancy':: d.fn(help='', args=[d.arg(name='instanceTenancy', type=d.T.string)]),
