{
  ...
  '#':: d.pkg(name='subnet', url='', help='"Subnet is the Schema for the Subnets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAvailabilityZoneId':: d.fn(help='', args=[d.arg(name='availabilityZoneId', type=d.T.string)]),
      ...
      '#withMapPublicIpOnLaunch':: d.fn(help='', args=[d.arg(name='mapPublicIpOnLaunch', type=d.T.boolean)]),
      withMapPublicIpOnLaunch(mapPublicIpOnLaunch): { spec+: { forProvider+: { mapPublicIpOnLaunch: mapPublicIpOnLaunch } } },
      '#withOutpostArn':: d.fn(help='', args=[d.arg(name='outpostArn', type=d.T.string)]),
