{
  ...
  '#':: d.pkg(name='networkInterface', url='', help='"NetworkInterface is the Schema for the NetworkInterfaces API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#attachment':: d.obj(help=''),
      attachment: {
        '#instanceRef':: d.obj(help='"A Reference to a named object."'),
        instanceRef: {
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { instanceRef+: { name: name } },
        },
        '#instanceSelector':: d.obj(help='"A Selector selects an object."'),
        instanceSelector: {
        ...
        '#withInstance':: d.fn(help='', args=[d.arg(name='instance', type=d.T.string)]),
      ...
      '#withAttachment':: d.fn(help='', args=[d.arg(name='attachment', type=d.T.array)]),
      withAttachment(attachment): { spec+: { forProvider+: { attachment: if std.isArray(v=attachment) then attachment else [attachment] } } },
      '#withAttachmentMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='attachment', type=d.T.array)]),
      withAttachmentMixin(attachment): { spec+: { forProvider+: { attachment+: if std.isArray(v=attachment) then attachment else [attachment] } } },
