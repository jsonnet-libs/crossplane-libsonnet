{
  ...
  '#':: d.pkg(name='ebsVolume', url='', help='"EBSVolume is the Schema for the EBSVolumes API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMultiAttachEnabled':: d.fn(help='', args=[d.arg(name='multiAttachEnabled', type=d.T.boolean)]),
