{
  ...
  spec: {
    ...
    forProvider: {
      '#accepter':: d.obj(help=''),
      accepter: {
        '#withAllowClassicLinkToRemoteVpc':: d.fn(help='', args=[d.arg(name='allowClassicLinkToRemoteVpc', type=d.T.boolean)]),
        withAllowClassicLinkToRemoteVpc(allowClassicLinkToRemoteVpc): { allowClassicLinkToRemoteVpc: allowClassicLinkToRemoteVpc },
        '#withAllowRemoteVpcDnsResolution':: d.fn(help='', args=[d.arg(name='allowRemoteVpcDnsResolution', type=d.T.boolean)]),
        withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution): { allowRemoteVpcDnsResolution: allowRemoteVpcDnsResolution },
        '#withAllowVpcToRemoteClassicLink':: d.fn(help='', args=[d.arg(name='allowVpcToRemoteClassicLink', type=d.T.boolean)]),
        withAllowVpcToRemoteClassicLink(allowVpcToRemoteClassicLink): { allowVpcToRemoteClassicLink: allowVpcToRemoteClassicLink },
      },
      '#peerVpcidRef':: d.obj(help='"A Reference to a named object."'),
      peerVpcidRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { peerVpcidRef+: { name: name } } } },
      },
      '#peerVpcidSelector':: d.obj(help='"A Selector selects an object."'),
      peerVpcidSelector: {
