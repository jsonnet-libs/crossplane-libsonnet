{
  ...
  '#':: d.pkg(name='securityGroupRule', url='', help='"SecurityGroupRule is the Schema for the SecurityGroupRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#securityGroupIdRef':: d.obj(help='"A Reference to a named object."'),
      securityGroupIdRef: {
      ...
      '#withIpv6CidrBlocks':: d.fn(help='', args=[d.arg(name='ipv6CidrBlocks', type=d.T.array)]),
      ...
      '#withPrefixListIds':: d.fn(help='', args=[d.arg(name='prefixListIds', type=d.T.array)]),
      ...
      '#withSecurityGroupId':: d.fn(help='', args=[d.arg(name='securityGroupId', type=d.T.string)]),
      withSecurityGroupId(securityGroupId): { spec+: { forProvider+: { securityGroupId: securityGroupId } } },
      '#withSelf':: d.fn(help='', args=[d.arg(name='Self', type=d.T.boolean)]),
