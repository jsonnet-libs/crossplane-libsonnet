{
  ...
  '#':: d.pkg(name='transitGatewayRouteTablePropagation', url='', help='"TransitGatewayRouteTablePropagation is the Schema for the TransitGatewayRouteTablePropagations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#transitGatewayRouteTableIdRef':: d.obj(help='"A Reference to a named object."'),
      transitGatewayRouteTableIdRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { transitGatewayRouteTableIdRef+: { name: name } } } },
      },
      '#transitGatewayRouteTableIdSelector':: d.obj(help='"A Selector selects an object."'),
