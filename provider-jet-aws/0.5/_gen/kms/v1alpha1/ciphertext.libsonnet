{
  ...
  '#':: d.pkg(name='ciphertext', url='', help='"Ciphertext is the Schema for the Ciphertexts API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#plaintextSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      plaintextSecretRef: {
