{
  ...
  '#':: d.pkg(name='key', url='', help='"Key is the Schema for the Keys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCustomerMasterKeySpec':: d.fn(help='', args=[d.arg(name='customerMasterKeySpec', type=d.T.string)]),
      ...
      '#withEnableKeyRotation':: d.fn(help='', args=[d.arg(name='enableKeyRotation', type=d.T.boolean)]),
      ...
      '#withKeyUsage':: d.fn(help='', args=[d.arg(name='keyUsage', type=d.T.string)]),
