{
  ...
  '#':: d.pkg(name='proxyProtocolPolicy', url='', help='"ProxyProtocolPolicy is the Schema for the ProxyProtocolPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withInstancePorts':: d.fn(help='', args=[d.arg(name='instancePorts', type=d.T.array)]),
