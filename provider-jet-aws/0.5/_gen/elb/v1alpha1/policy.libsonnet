{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLoadBalancerName':: d.fn(help='', args=[d.arg(name='loadBalancerName', type=d.T.string)]),
      withLoadBalancerName(loadBalancerName): { spec+: { forProvider+: { loadBalancerName: loadBalancerName } } },
      '#withPolicyAttribute':: d.fn(help='', args=[d.arg(name='policyAttribute', type=d.T.array)]),
      ...
      '#withPolicyTypeName':: d.fn(help='', args=[d.arg(name='policyTypeName', type=d.T.string)]),
