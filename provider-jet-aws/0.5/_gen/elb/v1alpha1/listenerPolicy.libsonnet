{
  ...
  '#':: d.pkg(name='listenerPolicy', url='', help='"ListenerPolicy is the Schema for the ListenerPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLoadBalancerPort':: d.fn(help='', args=[d.arg(name='loadBalancerPort', type=d.T.number)]),
