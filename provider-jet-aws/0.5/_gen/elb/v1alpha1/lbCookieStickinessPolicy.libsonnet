{
  ...
  '#':: d.pkg(name='lbCookieStickinessPolicy', url='', help='"LBCookieStickinessPolicy is the Schema for the LBCookieStickinessPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCookieExpirationPeriod':: d.fn(help='', args=[d.arg(name='cookieExpirationPeriod', type=d.T.number)]),
