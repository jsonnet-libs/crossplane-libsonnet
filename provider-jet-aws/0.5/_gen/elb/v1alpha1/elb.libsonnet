{
  ...
  '#':: d.pkg(name='elb', url='', help='"ELB is the Schema for the ELBs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConnectionDraining':: d.fn(help='', args=[d.arg(name='connectionDraining', type=d.T.boolean)]),
      withConnectionDraining(connectionDraining): { spec+: { forProvider+: { connectionDraining: connectionDraining } } },
      '#withConnectionDrainingTimeout':: d.fn(help='', args=[d.arg(name='connectionDrainingTimeout', type=d.T.number)]),
      ...
      '#withCrossZoneLoadBalancing':: d.fn(help='', args=[d.arg(name='crossZoneLoadBalancing', type=d.T.boolean)]),
      ...
      '#withIdleTimeout':: d.fn(help='', args=[d.arg(name='idleTimeout', type=d.T.number)]),
      ...
      '#withSourceSecurityGroup':: d.fn(help='', args=[d.arg(name='sourceSecurityGroup', type=d.T.string)]),
