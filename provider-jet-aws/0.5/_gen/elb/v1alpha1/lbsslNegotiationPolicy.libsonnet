{
  ...
  '#':: d.pkg(name='lbsslNegotiationPolicy', url='', help='"LBSSLNegotiationPolicy is the Schema for the LBSSLNegotiationPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLoadBalancer':: d.fn(help='', args=[d.arg(name='loadBalancer', type=d.T.string)]),
