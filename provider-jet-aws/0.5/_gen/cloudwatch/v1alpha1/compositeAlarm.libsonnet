{
  ...
  '#':: d.pkg(name='compositeAlarm', url='', help='"CompositeAlarm is the Schema for the CompositeAlarms API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAlarmRule':: d.fn(help='', args=[d.arg(name='alarmRule', type=d.T.string)]),
