{
  ...
  spec: {
    ...
    forProvider: {
      '#withDashboardBody':: d.fn(help='', args=[d.arg(name='dashboardBody', type=d.T.string)]),
      withDashboardBody(dashboardBody): { spec+: { forProvider+: { dashboardBody: dashboardBody } } },
      '#withDashboardName':: d.fn(help='', args=[d.arg(name='dashboardName', type=d.T.string)]),
      withDashboardName(dashboardName): { spec+: { forProvider+: { dashboardName: dashboardName } } },
