{
  ...
  '#':: d.pkg(name='metricStream', url='', help='"MetricStream is the Schema for the MetricStreams API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExcludeFilter':: d.fn(help='', args=[d.arg(name='excludeFilter', type=d.T.array)]),
      ...
      '#withFirehoseArn':: d.fn(help='', args=[d.arg(name='firehoseArn', type=d.T.string)]),
      withFirehoseArn(firehoseArn): { spec+: { forProvider+: { firehoseArn: firehoseArn } } },
      '#withIncludeFilter':: d.fn(help='', args=[d.arg(name='includeFilter', type=d.T.array)]),
