{
  ...
  '#':: d.pkg(name='assessmentTemplate', url='', help='"AssessmentTemplate is the Schema for the AssessmentTemplates API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRulesPackageArns':: d.fn(help='', args=[d.arg(name='rulesPackageArns', type=d.T.array)]),
