{
  ...
  '#':: d.pkg(name='assessmentTarget', url='', help='"AssessmentTarget is the Schema for the AssessmentTargets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceGroupArn':: d.fn(help='', args=[d.arg(name='resourceGroupArn', type=d.T.string)]),
