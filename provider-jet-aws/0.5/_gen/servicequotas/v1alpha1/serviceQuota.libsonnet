{
  ...
  '#':: d.pkg(name='serviceQuota', url='', help='"ServiceQuota is the Schema for the ServiceQuotas API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withQuotaCode':: d.fn(help='', args=[d.arg(name='quotaCode', type=d.T.string)]),
      ...
      '#withServiceCode':: d.fn(help='', args=[d.arg(name='serviceCode', type=d.T.string)]),
