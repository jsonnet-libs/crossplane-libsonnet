{
  ...
  '#':: d.pkg(name='publicKey', url='', help='"PublicKey is the Schema for the PublicKeys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEncodedKey':: d.fn(help='', args=[d.arg(name='encodedKey', type=d.T.string)]),
      withEncodedKey(encodedKey): { spec+: { forProvider+: { encodedKey: encodedKey } } },
