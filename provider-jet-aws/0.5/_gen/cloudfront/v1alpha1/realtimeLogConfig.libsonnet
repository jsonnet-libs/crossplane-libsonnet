{
  ...
  '#':: d.pkg(name='realtimeLogConfig', url='', help='"RealtimeLogConfig is the Schema for the RealtimeLogConfigs API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#endpoint':: d.obj(help=''),
      endpoint: {
        '#kinesisStreamConfig':: d.obj(help=''),
        kinesisStreamConfig: {
        ...
        '#withKinesisStreamConfig':: d.fn(help='', args=[d.arg(name='kinesisStreamConfig', type=d.T.array)]),
      ...
      '#withSamplingRate':: d.fn(help='', args=[d.arg(name='samplingRate', type=d.T.number)]),
