{
  ...
  '#':: d.pkg(name='catalogDatabase', url='', help='"CatalogDatabase is the Schema for the CatalogDatabases API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTargetDatabase':: d.fn(help='', args=[d.arg(name='targetDatabase', type=d.T.array)]),
