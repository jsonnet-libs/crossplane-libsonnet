{
  ...
  '#':: d.pkg(name='userDefinedFunction', url='', help='"UserDefinedFunction is the Schema for the UserDefinedFunctions API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOwnerName':: d.fn(help='', args=[d.arg(name='ownerName', type=d.T.string)]),
      withOwnerName(ownerName): { spec+: { forProvider+: { ownerName: ownerName } } },
      '#withOwnerType':: d.fn(help='', args=[d.arg(name='ownerType', type=d.T.string)]),
      ...
      '#withResourceUris':: d.fn(help='', args=[d.arg(name='resourceUris', type=d.T.array)]),
