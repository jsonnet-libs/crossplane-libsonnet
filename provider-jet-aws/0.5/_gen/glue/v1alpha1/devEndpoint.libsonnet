{
  ...
  '#':: d.pkg(name='devEndpoint', url='', help='"DevEndpoint is the Schema for the DevEndpoints API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DevEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DevEndpointSpec defines the desired state of DevEndpoint"'),
  spec: {
    ...
    forProvider: {
      ...
      withArguments(arguments): { spec+: { forProvider+: { arguments: arguments } } },
      ...
      withArgumentsMixin(arguments): { spec+: { forProvider+: { arguments+: arguments } } },
      '#withExtraJarsS3Path':: d.fn(help='', args=[d.arg(name='extraJarsS3Path', type=d.T.string)]),
      withExtraJarsS3Path(extraJarsS3Path): { spec+: { forProvider+: { extraJarsS3Path: extraJarsS3Path } } },
      '#withExtraPythonLibsS3Path':: d.fn(help='', args=[d.arg(name='extraPythonLibsS3Path', type=d.T.string)]),
      withExtraPythonLibsS3Path(extraPythonLibsS3Path): { spec+: { forProvider+: { extraPythonLibsS3Path: extraPythonLibsS3Path } } },
      ...
      '#withPublicKeys':: d.fn(help='', args=[d.arg(name='publicKeys', type=d.T.array)]),
      withPublicKeys(publicKeys): { spec+: { forProvider+: { publicKeys: if std.isArray(v=publicKeys) then publicKeys else [publicKeys] } } },
      '#withPublicKeysMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='publicKeys', type=d.T.array)]),
      withPublicKeysMixin(publicKeys): { spec+: { forProvider+: { publicKeys+: if std.isArray(v=publicKeys) then publicKeys else [publicKeys] } } },
