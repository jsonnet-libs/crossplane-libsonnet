{
  ...
  '#':: d.pkg(name='schema', url='', help='"Schema is the Schema for the Schemas API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCompatibility':: d.fn(help='', args=[d.arg(name='compatibility', type=d.T.string)]),
      ...
      '#withSchemaDefinition':: d.fn(help='', args=[d.arg(name='schemaDefinition', type=d.T.string)]),
