{
  ...
  '#':: d.pkg(name='mlTransform', url='', help='"MLTransform is the Schema for the MLTransforms API"'),
  ...
  '#new':: d.fn(help='new returns an instance of MLTransform', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MLTransformSpec defines the desired state of MLTransform"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#inputRecordTables':: d.obj(help=''),
      inputRecordTables: {
      ...
      parameters: {
        '#findMatchesParameters':: d.obj(help=''),
        findMatchesParameters: {
          '#withAccuracyCostTradeOff':: d.fn(help='', args=[d.arg(name='accuracyCostTradeOff', type=d.T.number)]),
          withAccuracyCostTradeOff(accuracyCostTradeOff): { accuracyCostTradeOff: accuracyCostTradeOff },
          '#withEnforceProvidedLabels':: d.fn(help='', args=[d.arg(name='enforceProvidedLabels', type=d.T.boolean)]),
          withEnforceProvidedLabels(enforceProvidedLabels): { enforceProvidedLabels: enforceProvidedLabels },
          '#withPrecisionRecallTradeOff':: d.fn(help='', args=[d.arg(name='precisionRecallTradeOff', type=d.T.number)]),
          withPrecisionRecallTradeOff(precisionRecallTradeOff): { precisionRecallTradeOff: precisionRecallTradeOff },
          '#withPrimaryKeyColumnName':: d.fn(help='', args=[d.arg(name='primaryKeyColumnName', type=d.T.string)]),
          withPrimaryKeyColumnName(primaryKeyColumnName): { primaryKeyColumnName: primaryKeyColumnName },
        },
        '#withFindMatchesParameters':: d.fn(help='', args=[d.arg(name='findMatchesParameters', type=d.T.array)]),
        withFindMatchesParameters(findMatchesParameters): { findMatchesParameters: if std.isArray(v=findMatchesParameters) then findMatchesParameters else [findMatchesParameters] },
        '#withFindMatchesParametersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='findMatchesParameters', type=d.T.array)]),
        withFindMatchesParametersMixin(findMatchesParameters): { findMatchesParameters+: if std.isArray(v=findMatchesParameters) then findMatchesParameters else [findMatchesParameters] },
        '#withTransformType':: d.fn(help='', args=[d.arg(name='transformType', type=d.T.string)]),
        withTransformType(transformType): { transformType: transformType },
      },
      ...
      '#withInputRecordTables':: d.fn(help='', args=[d.arg(name='inputRecordTables', type=d.T.array)]),
      withInputRecordTables(inputRecordTables): { spec+: { forProvider+: { inputRecordTables: if std.isArray(v=inputRecordTables) then inputRecordTables else [inputRecordTables] } } },
      '#withInputRecordTablesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='inputRecordTables', type=d.T.array)]),
      withInputRecordTablesMixin(inputRecordTables): { spec+: { forProvider+: { inputRecordTables+: if std.isArray(v=inputRecordTables) then inputRecordTables else [inputRecordTables] } } },
