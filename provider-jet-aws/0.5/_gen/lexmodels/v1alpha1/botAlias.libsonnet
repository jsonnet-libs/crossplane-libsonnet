{
  ...
  '#':: d.pkg(name='botAlias', url='', help='"BotAlias is the Schema for the BotAliass API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#conversationLogs':: d.obj(help=''),
      conversationLogs: {
        '#logSettings':: d.obj(help=''),
        logSettings: {
