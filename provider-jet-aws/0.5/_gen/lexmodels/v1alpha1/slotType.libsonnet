{
  ...
  '#':: d.pkg(name='slotType', url='', help='"SlotType is the Schema for the SlotTypes API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnumerationValue':: d.fn(help='', args=[d.arg(name='enumerationValue', type=d.T.array)]),
      ...
      '#withValueSelectionStrategy':: d.fn(help='', args=[d.arg(name='valueSelectionStrategy', type=d.T.string)]),
