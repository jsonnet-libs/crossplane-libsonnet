{
  ...
  spec: {
    ...
    forProvider: {
      '#capacityProvidersRefs':: d.obj(help=''),
      capacityProvidersRefs: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#capacityProvidersSelector':: d.obj(help='"A Selector selects an object."'),
      capacityProvidersSelector: {
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { capacityProvidersSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { capacityProvidersSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { capacityProvidersSelector+: { matchLabels+: matchLabels } } } },
      },
      '#configuration':: d.obj(help=''),
      configuration: {
        '#executeCommandConfiguration':: d.obj(help=''),
        executeCommandConfiguration: {
          '#logConfiguration':: d.obj(help=''),
          logConfiguration: {
            ...
            '#withS3BucketEncryptionEnabled':: d.fn(help='', args=[d.arg(name='s3BucketEncryptionEnabled', type=d.T.boolean)]),
          ...
          '#withLogConfiguration':: d.fn(help='', args=[d.arg(name='logConfiguration', type=d.T.array)]),
        ...
        '#withExecuteCommandConfiguration':: d.fn(help='', args=[d.arg(name='executeCommandConfiguration', type=d.T.array)]),
      ...
      '#defaultCapacityProviderStrategy':: d.obj(help=''),
      ...
      '#withCapacityProviders':: d.fn(help='', args=[d.arg(name='capacityProviders', type=d.T.array)]),
      ...
      '#withCapacityProvidersRefs':: d.fn(help='', args=[d.arg(name='capacityProvidersRefs', type=d.T.array)]),
      withCapacityProvidersRefs(capacityProvidersRefs): { spec+: { forProvider+: { capacityProvidersRefs: if std.isArray(v=capacityProvidersRefs) then capacityProvidersRefs else [capacityProvidersRefs] } } },
      '#withCapacityProvidersRefsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='capacityProvidersRefs', type=d.T.array)]),
      withCapacityProvidersRefsMixin(capacityProvidersRefs): { spec+: { forProvider+: { capacityProvidersRefs+: if std.isArray(v=capacityProvidersRefs) then capacityProvidersRefs else [capacityProvidersRefs] } } },
      ...
      '#withDefaultCapacityProviderStrategy':: d.fn(help='', args=[d.arg(name='defaultCapacityProviderStrategy', type=d.T.array)]),
