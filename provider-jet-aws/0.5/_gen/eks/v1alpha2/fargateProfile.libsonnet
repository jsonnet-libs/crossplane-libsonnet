{
  ...
  '#':: d.pkg(name='fargateProfile', url='', help='"FargateProfile is the Schema for the FargateProfiles API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#podExecutionRoleArnRef':: d.obj(help='"A Reference to a named object."'),
      podExecutionRoleArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { podExecutionRoleArnRef+: { name: name } } } },
      },
      '#podExecutionRoleArnSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withPodExecutionRoleArn':: d.fn(help='', args=[d.arg(name='podExecutionRoleArn', type=d.T.string)]),
      ...
      '#withSelector':: d.fn(help='', args=[d.arg(name='selector', type=d.T.array)]),
