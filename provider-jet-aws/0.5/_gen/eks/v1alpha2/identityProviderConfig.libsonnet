{
  ...
  '#':: d.pkg(name='identityProviderConfig', url='', help='"IdentityProviderConfig is the Schema for the IdentityProviderConfigs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      oidc: {
        ...
        '#withGroupsPrefix':: d.fn(help='', args=[d.arg(name='groupsPrefix', type=d.T.string)]),
        withGroupsPrefix(groupsPrefix): { groupsPrefix: groupsPrefix },
        '#withIdentityProviderConfigName':: d.fn(help='', args=[d.arg(name='identityProviderConfigName', type=d.T.string)]),
        withIdentityProviderConfigName(identityProviderConfigName): { identityProviderConfigName: identityProviderConfigName },
        '#withIssuerUrl':: d.fn(help='', args=[d.arg(name='issuerUrl', type=d.T.string)]),
        withIssuerUrl(issuerUrl): { issuerUrl: issuerUrl },
        '#withRequiredClaims':: d.fn(help='', args=[d.arg(name='requiredClaims', type=d.T.object)]),
        withRequiredClaims(requiredClaims): { requiredClaims: requiredClaims },
        '#withRequiredClaimsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredClaims', type=d.T.object)]),
