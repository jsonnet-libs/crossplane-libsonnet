{
  ...
  '#':: d.pkg(name='nodeGroup', url='', help='"NodeGroup is the Schema for the NodeGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#clusterNameRef':: d.obj(help='"A Reference to a named object."'),
      clusterNameRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { clusterNameRef+: { name: name } } } },
      },
      '#clusterNameSelector':: d.obj(help='"A Selector selects an object."'),
      clusterNameSelector: {
      ...
      '#nodeRoleArnRef':: d.obj(help='"A Reference to a named object."'),
      nodeRoleArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { nodeRoleArnRef+: { name: name } } } },
      },
      '#nodeRoleArnSelector':: d.obj(help='"A Selector selects an object."'),
      nodeRoleArnSelector: {
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
      ...
      '#remoteAccess':: d.obj(help=''),
      remoteAccess: {
        '#sourceSecurityGroupIdRefs':: d.obj(help=''),
        ...
        '#withEc2SshKey':: d.fn(help='', args=[d.arg(name='ec2SshKey', type=d.T.string)]),
        withEc2SshKey(ec2SshKey): { ec2SshKey: ec2SshKey },
        '#withSourceSecurityGroupIdRefs':: d.fn(help='', args=[d.arg(name='sourceSecurityGroupIdRefs', type=d.T.array)]),
        ...
        '#withSourceSecurityGroupIds':: d.fn(help='', args=[d.arg(name='sourceSecurityGroupIds', type=d.T.array)]),
      ...
      '#scalingConfig':: d.obj(help=''),
      scalingConfig: {
        '#withDesiredSize':: d.fn(help='', args=[d.arg(name='desiredSize', type=d.T.number)]),
      ...
      updateConfig: {
        '#withMaxUnavailable':: d.fn(help='', args=[d.arg(name='maxUnavailable', type=d.T.number)]),
        withMaxUnavailable(maxUnavailable): { maxUnavailable: maxUnavailable },
        '#withMaxUnavailablePercentage':: d.fn(help='', args=[d.arg(name='maxUnavailablePercentage', type=d.T.number)]),
        withMaxUnavailablePercentage(maxUnavailablePercentage): { maxUnavailablePercentage: maxUnavailablePercentage },
      },
      '#withAmiType':: d.fn(help='', args=[d.arg(name='amiType', type=d.T.string)]),
      withAmiType(amiType): { spec+: { forProvider+: { amiType: amiType } } },
      '#withCapacityType':: d.fn(help='', args=[d.arg(name='capacityType', type=d.T.string)]),
      ...
      '#withDiskSize':: d.fn(help='', args=[d.arg(name='diskSize', type=d.T.number)]),
      withDiskSize(diskSize): { spec+: { forProvider+: { diskSize: diskSize } } },
      '#withForceUpdateVersion':: d.fn(help='', args=[d.arg(name='forceUpdateVersion', type=d.T.boolean)]),
      ...
      '#withNodeRoleArn':: d.fn(help='', args=[d.arg(name='nodeRoleArn', type=d.T.string)]),
      ...
      '#withReleaseVersion':: d.fn(help='', args=[d.arg(name='releaseVersion', type=d.T.string)]),
      withReleaseVersion(releaseVersion): { spec+: { forProvider+: { releaseVersion: releaseVersion } } },
      '#withRemoteAccess':: d.fn(help='', args=[d.arg(name='remoteAccess', type=d.T.array)]),
      ...
      '#withScalingConfig':: d.fn(help='', args=[d.arg(name='scalingConfig', type=d.T.array)]),
