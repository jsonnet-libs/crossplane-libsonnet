{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#serviceAccountRoleArnRef':: d.obj(help='"A Reference to a named object."'),
      serviceAccountRoleArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { serviceAccountRoleArnRef+: { name: name } } } },
      },
      '#serviceAccountRoleArnSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withAddonVersion':: d.fn(help='', args=[d.arg(name='addonVersion', type=d.T.string)]),
      ...
      '#withResolveConflicts':: d.fn(help='', args=[d.arg(name='resolveConflicts', type=d.T.string)]),
      withResolveConflicts(resolveConflicts): { spec+: { forProvider+: { resolveConflicts: resolveConflicts } } },
      '#withServiceAccountRoleArn':: d.fn(help='', args=[d.arg(name='serviceAccountRoleArn', type=d.T.string)]),
