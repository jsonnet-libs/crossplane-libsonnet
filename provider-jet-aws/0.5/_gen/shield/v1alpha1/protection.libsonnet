{
  ...
  '#':: d.pkg(name='protection', url='', help='"Protection is the Schema for the Protections API"'),
  ...
  '#new':: d.fn(help='new returns an instance of Protection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProtectionSpec defines the desired state of Protection"'),
  spec: {
