{
  ...
  '#':: d.pkg(name='protectionGroup', url='', help='"ProtectionGroup is the Schema for the ProtectionGroups API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProtectionGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProtectionGroupSpec defines the desired state of ProtectionGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAggregation':: d.fn(help='', args=[d.arg(name='aggregation', type=d.T.string)]),
      withAggregation(aggregation): { spec+: { forProvider+: { aggregation: aggregation } } },
      ...
      '#withProtectionGroupId':: d.fn(help='', args=[d.arg(name='protectionGroupId', type=d.T.string)]),
      withProtectionGroupId(protectionGroupId): { spec+: { forProvider+: { protectionGroupId: protectionGroupId } } },
