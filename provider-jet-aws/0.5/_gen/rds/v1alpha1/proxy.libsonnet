{
  ...
  '#':: d.pkg(name='proxy', url='', help='"Proxy is the Schema for the Proxys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDebugLogging':: d.fn(help='', args=[d.arg(name='debugLogging', type=d.T.boolean)]),
      withDebugLogging(debugLogging): { spec+: { forProvider+: { debugLogging: debugLogging } } },
      '#withEngineFamily':: d.fn(help='', args=[d.arg(name='engineFamily', type=d.T.string)]),
      withEngineFamily(engineFamily): { spec+: { forProvider+: { engineFamily: engineFamily } } },
      '#withIdleClientTimeout':: d.fn(help='', args=[d.arg(name='idleClientTimeout', type=d.T.number)]),
      ...
      '#withRequireTls':: d.fn(help='', args=[d.arg(name='requireTls', type=d.T.boolean)]),
      ...
      '#withVpcSubnetIds':: d.fn(help='', args=[d.arg(name='vpcSubnetIds', type=d.T.array)]),
