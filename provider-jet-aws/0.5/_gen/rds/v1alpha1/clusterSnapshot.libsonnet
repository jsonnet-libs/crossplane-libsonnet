{
  ...
  '#':: d.pkg(name='clusterSnapshot', url='', help='"ClusterSnapshot is the Schema for the ClusterSnapshots API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDbClusterSnapshotIdentifier':: d.fn(help='', args=[d.arg(name='dbClusterSnapshotIdentifier', type=d.T.string)]),
