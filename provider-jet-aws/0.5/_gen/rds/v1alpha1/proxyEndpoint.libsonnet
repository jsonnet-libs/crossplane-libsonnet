{
  ...
  '#':: d.pkg(name='proxyEndpoint', url='', help='"ProxyEndpoint is the Schema for the ProxyEndpoints API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDbProxyEndpointName':: d.fn(help='', args=[d.arg(name='dbProxyEndpointName', type=d.T.string)]),
      withDbProxyEndpointName(dbProxyEndpointName): { spec+: { forProvider+: { dbProxyEndpointName: dbProxyEndpointName } } },
      '#withDbProxyName':: d.fn(help='', args=[d.arg(name='dbProxyName', type=d.T.string)]),
      ...
      '#withTargetRole':: d.fn(help='', args=[d.arg(name='targetRole', type=d.T.string)]),
