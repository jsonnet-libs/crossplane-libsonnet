{
  ...
  spec: {
    ...
    forProvider: {
      '#withClusterEndpointIdentifier':: d.fn(help='', args=[d.arg(name='clusterEndpointIdentifier', type=d.T.string)]),
      withClusterEndpointIdentifier(clusterEndpointIdentifier): { spec+: { forProvider+: { clusterEndpointIdentifier: clusterEndpointIdentifier } } },
      ...
      '#withCustomEndpointType':: d.fn(help='', args=[d.arg(name='customEndpointType', type=d.T.string)]),
