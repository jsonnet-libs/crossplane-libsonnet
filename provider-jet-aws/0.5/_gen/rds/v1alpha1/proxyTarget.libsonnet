{
  ...
  '#':: d.pkg(name='proxyTarget', url='', help='"ProxyTarget is the Schema for the ProxyTargets API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDbClusterIdentifier':: d.fn(help='', args=[d.arg(name='dbClusterIdentifier', type=d.T.string)]),
      withDbClusterIdentifier(dbClusterIdentifier): { spec+: { forProvider+: { dbClusterIdentifier: dbClusterIdentifier } } },
      '#withDbInstanceIdentifier':: d.fn(help='', args=[d.arg(name='dbInstanceIdentifier', type=d.T.string)]),
      ...
      '#withTargetGroupName':: d.fn(help='', args=[d.arg(name='targetGroupName', type=d.T.string)]),
