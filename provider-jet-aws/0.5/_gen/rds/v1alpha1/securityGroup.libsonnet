  ...
  spec: {
    ...
    forProvider: {
      ...
      ingress: {
        ...
        '#withSecurityGroupName':: d.fn(help='', args=[d.arg(name='securityGroupName', type=d.T.string)]),
        withSecurityGroupName(securityGroupName): { securityGroupName: securityGroupName },
        '#withSecurityGroupOwnerId':: d.fn(help='', args=[d.arg(name='securityGroupOwnerId', type=d.T.string)]),
