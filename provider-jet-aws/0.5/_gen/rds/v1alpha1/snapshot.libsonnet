{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDbSnapshotIdentifier':: d.fn(help='', args=[d.arg(name='dbSnapshotIdentifier', type=d.T.string)]),
      withDbSnapshotIdentifier(dbSnapshotIdentifier): { spec+: { forProvider+: { dbSnapshotIdentifier: dbSnapshotIdentifier } } },
