  ...
  spec: {
    ...
    forProvider: {
      ...
      samlOptions: {
        ...
        '#masterUserNameSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
        ...
        '#withSessionTimeoutMinutes':: d.fn(help='', args=[d.arg(name='sessionTimeoutMinutes', type=d.T.number)]),
