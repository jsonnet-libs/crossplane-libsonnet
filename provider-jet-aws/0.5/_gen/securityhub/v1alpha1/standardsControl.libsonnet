{
  ...
  '#':: d.pkg(name='standardsControl', url='', help='"StandardsControl is the Schema for the StandardsControls API"'),
  ...
  '#new':: d.fn(help='new returns an instance of StandardsControl', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"StandardsControlSpec defines the desired state of StandardsControl"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withControlStatus':: d.fn(help='', args=[d.arg(name='controlStatus', type=d.T.string)]),
      withControlStatus(controlStatus): { spec+: { forProvider+: { controlStatus: controlStatus } } },
      '#withDisabledReason':: d.fn(help='', args=[d.arg(name='disabledReason', type=d.T.string)]),
      withDisabledReason(disabledReason): { spec+: { forProvider+: { disabledReason: disabledReason } } },
      ...
      '#withStandardsControlArn':: d.fn(help='', args=[d.arg(name='standardsControlArn', type=d.T.string)]),
      withStandardsControlArn(standardsControlArn): { spec+: { forProvider+: { standardsControlArn: standardsControlArn } } },
    },
