{
  ...
  '#':: d.pkg(name='standardsSubscription', url='', help='"StandardsSubscription is the Schema for the StandardsSubscriptions API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStandardsArn':: d.fn(help='', args=[d.arg(name='standardsArn', type=d.T.string)]),
