{
  ...
  '#':: d.pkg(name='productSubscription', url='', help='"ProductSubscription is the Schema for the ProductSubscriptions API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withProductArn':: d.fn(help='', args=[d.arg(name='productArn', type=d.T.string)]),
