{
  ...
  '#':: d.pkg(name='hostedZoneDNSSEC', url='', help='"HostedZoneDNSSEC is the Schema for the HostedZoneDNSSECs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSigningStatus':: d.fn(help='', args=[d.arg(name='signingStatus', type=d.T.string)]),
