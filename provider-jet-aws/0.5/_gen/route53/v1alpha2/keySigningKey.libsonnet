{
  ...
  '#':: d.pkg(name='keySigningKey', url='', help='"KeySigningKey is the Schema for the KeySigningKeys API"'),
  ...
  '#new':: d.fn(help='new returns an instance of KeySigningKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"KeySigningKeySpec defines the desired state of KeySigningKey"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#hostedZoneIdRef':: d.obj(help='"A Reference to a named object."'),
      hostedZoneIdRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { hostedZoneIdRef+: { name: name } } } },
      },
      '#hostedZoneIdSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#keyManagementServiceArnRef':: d.obj(help='"A Reference to a named object."'),
      keyManagementServiceArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { keyManagementServiceArnRef+: { name: name } } } },
      },
      '#keyManagementServiceArnSelector':: d.obj(help='"A Selector selects an object."'),
      keyManagementServiceArnSelector: {
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { keyManagementServiceArnSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { keyManagementServiceArnSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { keyManagementServiceArnSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withKeyManagementServiceArn':: d.fn(help='', args=[d.arg(name='keyManagementServiceArn', type=d.T.string)]),
      withKeyManagementServiceArn(keyManagementServiceArn): { spec+: { forProvider+: { keyManagementServiceArn: keyManagementServiceArn } } },
