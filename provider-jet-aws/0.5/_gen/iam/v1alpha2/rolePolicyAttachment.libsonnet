{
  ...
  '#':: d.pkg(name='rolePolicyAttachment', url='', help='"RolePolicyAttachment is the Schema for the RolePolicyAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#roleRef':: d.obj(help='"A Reference to a named object."'),
      roleRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { roleRef+: { name: name } } } },
      },
      '#roleSelector':: d.obj(help='"A Selector selects an object."'),
      roleSelector: {
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
