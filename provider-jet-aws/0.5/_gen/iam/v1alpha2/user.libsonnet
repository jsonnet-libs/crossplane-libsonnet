{
  ...
  spec: {
    ...
    forProvider: {
      '#withForceDestroy':: d.fn(help='"Delete user even if it has non-Terraform-managed IAM access keys, login profile or MFA devices"', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
