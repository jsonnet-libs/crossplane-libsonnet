{
  ...
  '#':: d.pkg(name='groupPolicyAttachment', url='', help='"GroupPolicyAttachment is the Schema for the GroupPolicyAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#groupRef':: d.obj(help='"A Reference to a named object."'),
      groupRef: {
      ...
      '#policyArnRef':: d.obj(help='"A Reference to a named object."'),
      policyArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { policyArnRef+: { name: name } } } },
      },
      '#policyArnSelector':: d.obj(help='"A Selector selects an object."'),
      policyArnSelector: {
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference as the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
