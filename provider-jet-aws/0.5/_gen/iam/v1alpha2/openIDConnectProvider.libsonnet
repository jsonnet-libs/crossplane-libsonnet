{
  ...
  spec: {
    ...
    forProvider: {
      '#withClientIdList':: d.fn(help='', args=[d.arg(name='clientIdList', type=d.T.array)]),
      ...
      '#withThumbprintList':: d.fn(help='', args=[d.arg(name='thumbprintList', type=d.T.array)]),
