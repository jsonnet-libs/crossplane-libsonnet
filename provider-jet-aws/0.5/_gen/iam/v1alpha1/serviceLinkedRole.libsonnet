{
  ...
  '#':: d.pkg(name='serviceLinkedRole', url='', help='"ServiceLinkedRole is the Schema for the ServiceLinkedRoles API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAwsServiceName':: d.fn(help='', args=[d.arg(name='awsServiceName', type=d.T.string)]),
      withAwsServiceName(awsServiceName): { spec+: { forProvider+: { awsServiceName: awsServiceName } } },
      '#withCustomSuffix':: d.fn(help='', args=[d.arg(name='customSuffix', type=d.T.string)]),
