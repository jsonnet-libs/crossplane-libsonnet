{
  ...
  '#':: d.pkg(name='accountPasswordPolicy', url='', help='"AccountPasswordPolicy is the Schema for the AccountPasswordPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAllowUsersToChangePassword':: d.fn(help='', args=[d.arg(name='allowUsersToChangePassword', type=d.T.boolean)]),
      ...
      '#withHardExpiry':: d.fn(help='', args=[d.arg(name='hardExpiry', type=d.T.boolean)]),
      withHardExpiry(hardExpiry): { spec+: { forProvider+: { hardExpiry: hardExpiry } } },
      '#withMaxPasswordAge':: d.fn(help='', args=[d.arg(name='maxPasswordAge', type=d.T.number)]),
      withMaxPasswordAge(maxPasswordAge): { spec+: { forProvider+: { maxPasswordAge: maxPasswordAge } } },
      '#withMinimumPasswordLength':: d.fn(help='', args=[d.arg(name='minimumPasswordLength', type=d.T.number)]),
      withMinimumPasswordLength(minimumPasswordLength): { spec+: { forProvider+: { minimumPasswordLength: minimumPasswordLength } } },
      '#withPasswordReusePrevention':: d.fn(help='', args=[d.arg(name='passwordReusePrevention', type=d.T.number)]),
      withPasswordReusePrevention(passwordReusePrevention): { spec+: { forProvider+: { passwordReusePrevention: passwordReusePrevention } } },
      '#withRequireLowercaseCharacters':: d.fn(help='', args=[d.arg(name='requireLowercaseCharacters', type=d.T.boolean)]),
      ...
      '#withRequireUppercaseCharacters':: d.fn(help='', args=[d.arg(name='requireUppercaseCharacters', type=d.T.boolean)]),
