{
  ...
  '#':: d.pkg(name='accountAlias', url='', help='"AccountAlias is the Schema for the AccountAliass API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAccountAlias':: d.fn(help='', args=[d.arg(name='accountAlias', type=d.T.string)]),
      withAccountAlias(accountAlias): { spec+: { forProvider+: { accountAlias: accountAlias } } },
    },
