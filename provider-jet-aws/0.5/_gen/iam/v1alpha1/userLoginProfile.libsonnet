{
  ...
  '#':: d.pkg(name='userLoginProfile', url='', help='"UserLoginProfile is the Schema for the UserLoginProfiles API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withPasswordLength':: d.fn(help='', args=[d.arg(name='passwordLength', type=d.T.number)]),
      withPasswordLength(passwordLength): { spec+: { forProvider+: { passwordLength: passwordLength } } },
      '#withPasswordResetRequired':: d.fn(help='', args=[d.arg(name='passwordResetRequired', type=d.T.boolean)]),
      withPasswordResetRequired(passwordResetRequired): { spec+: { forProvider+: { passwordResetRequired: passwordResetRequired } } },
      '#withPgpKey':: d.fn(help='', args=[d.arg(name='pgpKey', type=d.T.string)]),
