{
  ...
  '#':: d.pkg(name='samlProvider', url='', help='"SAMLProvider is the Schema for the SAMLProviders API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSamlMetadataDocument':: d.fn(help='', args=[d.arg(name='samlMetadataDocument', type=d.T.string)]),
