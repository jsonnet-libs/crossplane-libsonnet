{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCertificateSigningRequest':: d.fn(help='', args=[d.arg(name='certificateSigningRequest', type=d.T.string)]),
      withCertificateSigningRequest(certificateSigningRequest): { spec+: { forProvider+: { certificateSigningRequest: certificateSigningRequest } } },
