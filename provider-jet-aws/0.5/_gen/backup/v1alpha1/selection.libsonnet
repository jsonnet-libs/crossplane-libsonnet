{
  ...
  '#':: d.pkg(name='selection', url='', help='"Selection is the Schema for the Selections API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPlanId':: d.fn(help='', args=[d.arg(name='planId', type=d.T.string)]),
      ...
      '#withSelectionTag':: d.fn(help='', args=[d.arg(name='selectionTag', type=d.T.array)]),
