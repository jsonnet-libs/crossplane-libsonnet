{
  ...
  '#':: d.pkg(name='regionSettings', url='', help='"RegionSettings is the Schema for the RegionSettingss API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceTypeOptInPreference':: d.fn(help='', args=[d.arg(name='resourceTypeOptInPreference', type=d.T.object)]),
