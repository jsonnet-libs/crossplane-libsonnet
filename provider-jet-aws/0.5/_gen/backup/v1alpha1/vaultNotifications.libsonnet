{
  ...
  '#':: d.pkg(name='vaultNotifications', url='', help='"VaultNotifications is the Schema for the VaultNotificationss API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBackupVaultEvents':: d.fn(help='', args=[d.arg(name='backupVaultEvents', type=d.T.array)]),
      ...
      '#withBackupVaultName':: d.fn(help='', args=[d.arg(name='backupVaultName', type=d.T.string)]),
