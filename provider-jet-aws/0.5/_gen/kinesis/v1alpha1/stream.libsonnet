{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnforceConsumerDeletion':: d.fn(help='', args=[d.arg(name='enforceConsumerDeletion', type=d.T.boolean)]),
      ...
      '#withShardCount':: d.fn(help='', args=[d.arg(name='shardCount', type=d.T.number)]),
