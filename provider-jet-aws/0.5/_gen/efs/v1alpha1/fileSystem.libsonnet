{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#lifecyclePolicy':: d.obj(help=''),
      lifecyclePolicy: {
        '#withTransitionToIa':: d.fn(help='', args=[d.arg(name='transitionToIa', type=d.T.string)]),
        withTransitionToIa(transitionToIa): { transitionToIa: transitionToIa },
      },
      '#withAvailabilityZoneName':: d.fn(help='', args=[d.arg(name='availabilityZoneName', type=d.T.string)]),
      withAvailabilityZoneName(availabilityZoneName): { spec+: { forProvider+: { availabilityZoneName: availabilityZoneName } } },
      '#withCreationToken':: d.fn(help='', args=[d.arg(name='creationToken', type=d.T.string)]),
      ...
      '#withLifecyclePolicy':: d.fn(help='', args=[d.arg(name='lifecyclePolicy', type=d.T.array)]),
      ...
      '#withPerformanceMode':: d.fn(help='', args=[d.arg(name='performanceMode', type=d.T.string)]),
      withPerformanceMode(performanceMode): { spec+: { forProvider+: { performanceMode: performanceMode } } },
      '#withProvisionedThroughputInMibps':: d.fn(help='', args=[d.arg(name='provisionedThroughputInMibps', type=d.T.number)]),
