{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#rootDirectory':: d.obj(help=''),
      rootDirectory: {
        '#creationInfo':: d.obj(help=''),
        creationInfo: {
          '#withOwnerGid':: d.fn(help='', args=[d.arg(name='ownerGid', type=d.T.number)]),
          withOwnerGid(ownerGid): { ownerGid: ownerGid },
          '#withOwnerUid':: d.fn(help='', args=[d.arg(name='ownerUid', type=d.T.number)]),
      ...
      '#withRootDirectory':: d.fn(help='', args=[d.arg(name='rootDirectory', type=d.T.array)]),
