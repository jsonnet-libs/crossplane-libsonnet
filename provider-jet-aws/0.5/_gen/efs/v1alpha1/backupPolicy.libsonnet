{
  ...
  '#':: d.pkg(name='backupPolicy', url='', help='"BackupPolicy is the Schema for the BackupPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#backupPolicy':: d.obj(help=''),
      backupPolicy: {},
      '#withBackupPolicy':: d.fn(help='', args=[d.arg(name='backupPolicy', type=d.T.array)]),
