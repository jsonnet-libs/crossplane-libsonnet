{
  ...
  '#':: d.pkg(name='eventSubscription', url='', help='"EventSubscription is the Schema for the EventSubscriptions API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventCategories':: d.fn(help='', args=[d.arg(name='eventCategories', type=d.T.array)]),
