{
  ...
  '#':: d.pkg(name='snapshotScheduleAssociation', url='', help='"SnapshotScheduleAssociation is the Schema for the SnapshotScheduleAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withScheduleIdentifier':: d.fn(help='', args=[d.arg(name='scheduleIdentifier', type=d.T.string)]),
