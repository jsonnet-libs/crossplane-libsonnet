{
  ...
  '#':: d.pkg(name='snapshotCopyGrant', url='', help='"SnapshotCopyGrant is the Schema for the SnapshotCopyGrants API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSnapshotCopyGrantName':: d.fn(help='', args=[d.arg(name='snapshotCopyGrantName', type=d.T.string)]),
