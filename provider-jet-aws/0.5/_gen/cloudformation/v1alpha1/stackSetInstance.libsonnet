{
  ...
  '#':: d.pkg(name='stackSetInstance', url='', help='"StackSetInstance is the Schema for the StackSetInstances API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRetainStack':: d.fn(help='', args=[d.arg(name='retainStack', type=d.T.boolean)]),
      withRetainStack(retainStack): { spec+: { forProvider+: { retainStack: retainStack } } },
      '#withStackSetName':: d.fn(help='', args=[d.arg(name='stackSetName', type=d.T.string)]),
