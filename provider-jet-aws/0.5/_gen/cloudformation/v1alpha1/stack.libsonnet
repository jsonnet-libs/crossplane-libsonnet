{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDisableRollback':: d.fn(help='', args=[d.arg(name='disableRollback', type=d.T.boolean)]),
      ...
      '#withOnFailure':: d.fn(help='', args=[d.arg(name='onFailure', type=d.T.string)]),
      ...
      '#withPolicyBody':: d.fn(help='', args=[d.arg(name='policyBody', type=d.T.string)]),
      withPolicyBody(policyBody): { spec+: { forProvider+: { policyBody: policyBody } } },
      '#withPolicyUrl':: d.fn(help='', args=[d.arg(name='policyUrl', type=d.T.string)]),
      ...
      '#withTimeoutInMinutes':: d.fn(help='', args=[d.arg(name='timeoutInMinutes', type=d.T.number)]),
