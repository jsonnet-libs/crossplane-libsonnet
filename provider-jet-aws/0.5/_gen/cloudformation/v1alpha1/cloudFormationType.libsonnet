{
  ...
  '#':: d.pkg(name='cloudFormationType', url='', help='"CloudFormationType is the Schema for the CloudFormationTypes API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CloudFormationType', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CloudFormationTypeSpec defines the desired state of CloudFormationType"'),
  spec: {
    ...
    forProvider: {
      ...
      loggingConfig: {
        ...
        '#withLogRoleArn':: d.fn(help='', args=[d.arg(name='logRoleArn', type=d.T.string)]),
        withLogRoleArn(logRoleArn): { logRoleArn: logRoleArn },
      },
      ...
      '#withSchemaHandlerPackage':: d.fn(help='', args=[d.arg(name='schemaHandlerPackage', type=d.T.string)]),
      withSchemaHandlerPackage(schemaHandlerPackage): { spec+: { forProvider+: { schemaHandlerPackage: schemaHandlerPackage } } },
