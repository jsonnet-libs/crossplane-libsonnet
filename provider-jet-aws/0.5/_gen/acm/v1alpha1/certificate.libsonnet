{
  ...
  spec: {
    ...
    forProvider: {
      '#options':: d.obj(help=''),
      options: {
        '#withCertificateTransparencyLoggingPreference':: d.fn(help='', args=[d.arg(name='certificateTransparencyLoggingPreference', type=d.T.string)]),
      ...
      '#withCertificateAuthorityArn':: d.fn(help='', args=[d.arg(name='certificateAuthorityArn', type=d.T.string)]),
      ...
      '#withValidationMethod':: d.fn(help='', args=[d.arg(name='validationMethod', type=d.T.string)]),
