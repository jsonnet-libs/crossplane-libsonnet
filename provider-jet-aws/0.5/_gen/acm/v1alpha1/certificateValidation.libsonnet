{
  ...
  '#':: d.pkg(name='certificateValidation', url='', help='"CertificateValidation is the Schema for the CertificateValidations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withValidationRecordFqdns':: d.fn(help='', args=[d.arg(name='validationRecordFqdns', type=d.T.array)]),
