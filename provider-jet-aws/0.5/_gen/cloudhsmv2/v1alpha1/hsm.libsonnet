{
  ...
  '#':: d.pkg(name='hsm', url='', help='"HSM is the Schema for the HSMs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of HSM', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HSMSpec defines the desired state of HSM"'),
  spec: {
