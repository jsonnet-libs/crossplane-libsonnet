{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withHsmType':: d.fn(help='', args=[d.arg(name='hsmType', type=d.T.string)]),
      withHsmType(hsmType): { spec+: { forProvider+: { hsmType: hsmType } } },
      ...
      '#withSourceBackupIdentifier':: d.fn(help='', args=[d.arg(name='sourceBackupIdentifier', type=d.T.string)]),
      withSourceBackupIdentifier(sourceBackupIdentifier): { spec+: { forProvider+: { sourceBackupIdentifier: sourceBackupIdentifier } } },
