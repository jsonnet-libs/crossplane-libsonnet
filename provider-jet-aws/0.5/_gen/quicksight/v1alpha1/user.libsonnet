{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIamArn':: d.fn(help='', args=[d.arg(name='iamArn', type=d.T.string)]),
      withIamArn(iamArn): { spec+: { forProvider+: { iamArn: iamArn } } },
      '#withIdentityType':: d.fn(help='', args=[d.arg(name='identityType', type=d.T.string)]),
      ...
      '#withUserRole':: d.fn(help='', args=[d.arg(name='userRole', type=d.T.string)]),
