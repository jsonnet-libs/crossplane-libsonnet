{
  ...
  '#':: d.pkg(name='deploymentStrategy', url='', help='"DeploymentStrategy is the Schema for the DeploymentStrategys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDeploymentDurationInMinutes':: d.fn(help='', args=[d.arg(name='deploymentDurationInMinutes', type=d.T.number)]),
      ...
      '#withFinalBakeTimeInMinutes':: d.fn(help='', args=[d.arg(name='finalBakeTimeInMinutes', type=d.T.number)]),
      withFinalBakeTimeInMinutes(finalBakeTimeInMinutes): { spec+: { forProvider+: { finalBakeTimeInMinutes: finalBakeTimeInMinutes } } },
      '#withGrowthFactor':: d.fn(help='', args=[d.arg(name='growthFactor', type=d.T.number)]),
      withGrowthFactor(growthFactor): { spec+: { forProvider+: { growthFactor: growthFactor } } },
      '#withGrowthType':: d.fn(help='', args=[d.arg(name='growthType', type=d.T.string)]),
      ...
      '#withReplicateTo':: d.fn(help='', args=[d.arg(name='replicateTo', type=d.T.string)]),
