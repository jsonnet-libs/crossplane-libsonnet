{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConfigurationProfileId':: d.fn(help='', args=[d.arg(name='configurationProfileId', type=d.T.string)]),
      withConfigurationProfileId(configurationProfileId): { spec+: { forProvider+: { configurationProfileId: configurationProfileId } } },
      '#withConfigurationVersion':: d.fn(help='', args=[d.arg(name='configurationVersion', type=d.T.string)]),
      withConfigurationVersion(configurationVersion): { spec+: { forProvider+: { configurationVersion: configurationVersion } } },
      '#withDeploymentStrategyId':: d.fn(help='', args=[d.arg(name='deploymentStrategyId', type=d.T.string)]),
      ...
      '#withEnvironmentId':: d.fn(help='', args=[d.arg(name='environmentId', type=d.T.string)]),
