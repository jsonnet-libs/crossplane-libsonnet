{
  ...
  spec: {
    ...
    forProvider: {
      '#monitor':: d.obj(help=''),
      monitor: {
        '#withAlarmArn':: d.fn(help='', args=[d.arg(name='alarmArn', type=d.T.string)]),
        withAlarmArn(alarmArn): { alarmArn: alarmArn },
        '#withAlarmRoleArn':: d.fn(help='', args=[d.arg(name='alarmRoleArn', type=d.T.string)]),
