{
  ...
  '#':: d.pkg(name='configurationProfile', url='', help='"ConfigurationProfile is the Schema for the ConfigurationProfiles API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#retrievalRoleArnRef':: d.obj(help='"A Reference to a named object."'),
      retrievalRoleArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { retrievalRoleArnRef+: { name: name } } } },
      },
      '#retrievalRoleArnSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#validator':: d.obj(help=''),
      validator: {
        '#contentSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
        contentSecretRef: {
      ...
      '#withLocationUri':: d.fn(help='', args=[d.arg(name='locationUri', type=d.T.string)]),
      ...
      '#withRetrievalRoleArn':: d.fn(help='', args=[d.arg(name='retrievalRoleArn', type=d.T.string)]),
