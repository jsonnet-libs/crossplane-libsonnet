{
  ...
  '#':: d.pkg(name='railsAppLayer', url='', help='"RailsAppLayer is the Schema for the RailsAppLayers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAppServer':: d.fn(help='', args=[d.arg(name='appServer', type=d.T.string)]),
      ...
      '#withBundlerVersion':: d.fn(help='', args=[d.arg(name='bundlerVersion', type=d.T.string)]),
      ...
      '#withManageBundler':: d.fn(help='', args=[d.arg(name='manageBundler', type=d.T.boolean)]),
      ...
      '#withPassengerVersion':: d.fn(help='', args=[d.arg(name='passengerVersion', type=d.T.string)]),
      ...
      '#withRubyVersion':: d.fn(help='', args=[d.arg(name='rubyVersion', type=d.T.string)]),
      withRubyVersion(rubyVersion): { spec+: { forProvider+: { rubyVersion: rubyVersion } } },
      '#withRubygemsVersion':: d.fn(help='', args=[d.arg(name='rubygemsVersion', type=d.T.string)]),
