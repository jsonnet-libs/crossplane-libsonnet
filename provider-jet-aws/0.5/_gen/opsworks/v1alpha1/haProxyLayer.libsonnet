{
  ...
  '#':: d.pkg(name='haProxyLayer', url='', help='"HAProxyLayer is the Schema for the HAProxyLayers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withHealthcheckMethod':: d.fn(help='', args=[d.arg(name='healthcheckMethod', type=d.T.string)]),
      withHealthcheckMethod(healthcheckMethod): { spec+: { forProvider+: { healthcheckMethod: healthcheckMethod } } },
      '#withHealthcheckUrl':: d.fn(help='', args=[d.arg(name='healthcheckUrl', type=d.T.string)]),
      ...
      '#withStatsPassword':: d.fn(help='', args=[d.arg(name='statsPassword', type=d.T.string)]),
      withStatsPassword(statsPassword): { spec+: { forProvider+: { statsPassword: statsPassword } } },
      '#withStatsUrl':: d.fn(help='', args=[d.arg(name='statsUrl', type=d.T.string)]),
      withStatsUrl(statsUrl): { spec+: { forProvider+: { statsUrl: statsUrl } } },
      '#withStatsUser':: d.fn(help='', args=[d.arg(name='statsUser', type=d.T.string)]),
