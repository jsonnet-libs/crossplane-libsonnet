{
  ...
  '#':: d.pkg(name='javaAppLayer', url='', help='"JavaAppLayer is the Schema for the JavaAppLayers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAppServerVersion':: d.fn(help='', args=[d.arg(name='appServerVersion', type=d.T.string)]),
      ...
      '#withJvmOptions':: d.fn(help='', args=[d.arg(name='jvmOptions', type=d.T.string)]),
      withJvmOptions(jvmOptions): { spec+: { forProvider+: { jvmOptions: jvmOptions } } },
      '#withJvmType':: d.fn(help='', args=[d.arg(name='jvmType', type=d.T.string)]),
      withJvmType(jvmType): { spec+: { forProvider+: { jvmType: jvmType } } },
      '#withJvmVersion':: d.fn(help='', args=[d.arg(name='jvmVersion', type=d.T.string)]),
