{
  ...
  '#':: d.pkg(name='rdsdbInstance', url='', help='"RDSDBInstance is the Schema for the RDSDBInstances API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#dbPasswordSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      dbPasswordSecretRef: {
