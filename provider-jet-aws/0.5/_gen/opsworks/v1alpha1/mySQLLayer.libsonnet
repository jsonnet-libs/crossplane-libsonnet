{
  ...
  '#':: d.pkg(name='mySQLLayer', url='', help='"MySQLLayer is the Schema for the MySQLLayers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRootPassword':: d.fn(help='', args=[d.arg(name='rootPassword', type=d.T.string)]),
      withRootPassword(rootPassword): { spec+: { forProvider+: { rootPassword: rootPassword } } },
      '#withRootPasswordOnAllInstances':: d.fn(help='', args=[d.arg(name='rootPasswordOnAllInstances', type=d.T.boolean)]),
