{
  ...
  '#':: d.pkg(name='memcachedLayer', url='', help='"MemcachedLayer is the Schema for the MemcachedLayers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllocatedMemory':: d.fn(help='', args=[d.arg(name='allocatedMemory', type=d.T.number)]),
