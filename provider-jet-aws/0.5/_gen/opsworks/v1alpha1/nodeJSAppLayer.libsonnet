{
  ...
  '#':: d.pkg(name='nodeJSAppLayer', url='', help='"NodeJSAppLayer is the Schema for the NodeJSAppLayers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNodejsVersion':: d.fn(help='', args=[d.arg(name='nodejsVersion', type=d.T.string)]),
