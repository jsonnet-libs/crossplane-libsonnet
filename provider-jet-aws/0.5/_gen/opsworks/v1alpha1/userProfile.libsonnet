{
  ...
  spec: {
    ...
    forProvider: {
      '#withAllowSelfManagement':: d.fn(help='', args=[d.arg(name='allowSelfManagement', type=d.T.boolean)]),
      ...
      '#withSshPublicKey':: d.fn(help='', args=[d.arg(name='sshPublicKey', type=d.T.string)]),
      withSshPublicKey(sshPublicKey): { spec+: { forProvider+: { sshPublicKey: sshPublicKey } } },
      '#withSshUsername':: d.fn(help='', args=[d.arg(name='sshUsername', type=d.T.string)]),
      withSshUsername(sshUsername): { spec+: { forProvider+: { sshUsername: sshUsername } } },
      '#withUserArn':: d.fn(help='', args=[d.arg(name='userArn', type=d.T.string)]),
