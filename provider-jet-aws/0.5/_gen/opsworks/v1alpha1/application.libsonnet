{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#sslConfiguration':: d.obj(help=''),
      sslConfiguration: {
        '#privateKeySecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
        privateKeySecretRef: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withDocumentRoot':: d.fn(help='', args=[d.arg(name='documentRoot', type=d.T.string)]),
      ...
      '#withEnableSsl':: d.fn(help='', args=[d.arg(name='enableSsl', type=d.T.boolean)]),
      ...
      '#withRailsEnv':: d.fn(help='', args=[d.arg(name='railsEnv', type=d.T.string)]),
      ...
      '#withShortName':: d.fn(help='', args=[d.arg(name='shortName', type=d.T.string)]),
      withShortName(shortName): { spec+: { forProvider+: { shortName: shortName } } },
      '#withSslConfiguration':: d.fn(help='', args=[d.arg(name='sslConfiguration', type=d.T.array)]),
