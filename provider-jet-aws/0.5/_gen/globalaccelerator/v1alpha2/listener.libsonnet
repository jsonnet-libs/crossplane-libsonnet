{
  ...
  spec: {
    ...
    forProvider: {
      '#acceleratorArnRef':: d.obj(help='"A Reference to a named object."'),
      acceleratorArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { acceleratorArnRef+: { name: name } } } },
      },
      '#acceleratorArnSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withAcceleratorArn':: d.fn(help='', args=[d.arg(name='acceleratorArn', type=d.T.string)]),
      withAcceleratorArn(acceleratorArn): { spec+: { forProvider+: { acceleratorArn: acceleratorArn } } },
      '#withClientAffinity':: d.fn(help='', args=[d.arg(name='clientAffinity', type=d.T.string)]),
