{
  ...
  '#':: d.pkg(name='accelerator', url='', help='"Accelerator is the Schema for the Accelerators API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      attributes: {
        '#withFlowLogsEnabled':: d.fn(help='', args=[d.arg(name='flowLogsEnabled', type=d.T.boolean)]),
        withFlowLogsEnabled(flowLogsEnabled): { flowLogsEnabled: flowLogsEnabled },
        '#withFlowLogsS3Bucket':: d.fn(help='', args=[d.arg(name='flowLogsS3Bucket', type=d.T.string)]),
        withFlowLogsS3Bucket(flowLogsS3Bucket): { flowLogsS3Bucket: flowLogsS3Bucket },
        '#withFlowLogsS3Prefix':: d.fn(help='', args=[d.arg(name='flowLogsS3Prefix', type=d.T.string)]),
