{
  ...
  spec: {
    ...
    forProvider: {
      '#publicAccessBlockConfiguration':: d.obj(help=''),
      ...
      '#withPublicAccessBlockConfiguration':: d.fn(help='', args=[d.arg(name='publicAccessBlockConfiguration', type=d.T.array)]),
