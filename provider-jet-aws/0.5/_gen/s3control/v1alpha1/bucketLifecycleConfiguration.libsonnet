{
  ...
  '#':: d.pkg(name='bucketLifecycleConfiguration', url='', help='"BucketLifecycleConfiguration is the Schema for the BucketLifecycleConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#rule':: d.obj(help=''),
      rule: {
        '#abortIncompleteMultipartUpload':: d.obj(help=''),
        abortIncompleteMultipartUpload: {
          '#withDaysAfterInitiation':: d.fn(help='', args=[d.arg(name='daysAfterInitiation', type=d.T.number)]),
        ...
        '#withAbortIncompleteMultipartUpload':: d.fn(help='', args=[d.arg(name='abortIncompleteMultipartUpload', type=d.T.array)]),
