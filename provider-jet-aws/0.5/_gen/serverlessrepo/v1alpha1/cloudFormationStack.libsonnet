{
  ...
  '#':: d.pkg(name='cloudFormationStack', url='', help='"CloudFormationStack is the Schema for the CloudFormationStacks API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSemanticVersion':: d.fn(help='', args=[d.arg(name='semanticVersion', type=d.T.string)]),
