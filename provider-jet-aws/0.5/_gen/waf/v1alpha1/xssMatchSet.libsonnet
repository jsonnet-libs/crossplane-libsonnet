{
  ...
  '#':: d.pkg(name='xssMatchSet', url='', help='"XSSMatchSet is the Schema for the XSSMatchSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withXssMatchTuples':: d.fn(help='', args=[d.arg(name='xssMatchTuples', type=d.T.array)]),
