{
  ...
  '#':: d.pkg(name='byteMatchSet', url='', help='"ByteMatchSet is the Schema for the ByteMatchSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      byteMatchTuples: {
        ...
        '#withTargetString':: d.fn(help='', args=[d.arg(name='targetString', type=d.T.string)]),
      ...
      '#withByteMatchTuples':: d.fn(help='', args=[d.arg(name='byteMatchTuples', type=d.T.array)]),
