{
  ...
  '#':: d.pkg(name='sqlInjectionMatchSet', url='', help='"SQLInjectionMatchSet is the Schema for the SQLInjectionMatchSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#sqlInjectionMatchTuples':: d.obj(help=''),
      ...
      '#withSqlInjectionMatchTuples':: d.fn(help='', args=[d.arg(name='sqlInjectionMatchTuples', type=d.T.array)]),
