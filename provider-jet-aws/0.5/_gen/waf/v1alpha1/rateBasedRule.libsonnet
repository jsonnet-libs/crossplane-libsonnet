{
  ...
  '#':: d.pkg(name='rateBasedRule', url='', help='"RateBasedRule is the Schema for the RateBasedRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#predicates':: d.obj(help=''),
      predicates: {
        '#withDataId':: d.fn(help='', args=[d.arg(name='dataId', type=d.T.string)]),
        withDataId(dataId): { dataId: dataId },
        '#withNegated':: d.fn(help='', args=[d.arg(name='negated', type=d.T.boolean)]),
