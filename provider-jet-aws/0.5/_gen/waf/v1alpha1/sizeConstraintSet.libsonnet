{
  ...
  '#':: d.pkg(name='sizeConstraintSet', url='', help='"SizeConstraintSet is the Schema for the SizeConstraintSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      sizeConstraints: {
        ...
        '#withTextTransformation':: d.fn(help='', args=[d.arg(name='textTransformation', type=d.T.string)]),
      ...
      '#withSizeConstraints':: d.fn(help='', args=[d.arg(name='sizeConstraints', type=d.T.array)]),
