{
  ...
  '#':: d.pkg(name='autoScalingConfigurationVersion', url='', help='"AutoScalingConfigurationVersion is the Schema for the AutoScalingConfigurationVersions API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAutoScalingConfigurationName':: d.fn(help='', args=[d.arg(name='autoScalingConfigurationName', type=d.T.string)]),
      ...
      '#withMaxConcurrency':: d.fn(help='', args=[d.arg(name='maxConcurrency', type=d.T.number)]),
