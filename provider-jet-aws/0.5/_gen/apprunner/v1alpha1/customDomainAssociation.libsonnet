{
  ...
  '#':: d.pkg(name='customDomainAssociation', url='', help='"CustomDomainAssociation is the Schema for the CustomDomainAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CustomDomainAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CustomDomainAssociationSpec defines the desired state of CustomDomainAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEnableWwwSubdomain':: d.fn(help='', args=[d.arg(name='enableWwwSubdomain', type=d.T.boolean)]),
      withEnableWwwSubdomain(enableWwwSubdomain): { spec+: { forProvider+: { enableWwwSubdomain: enableWwwSubdomain } } },
      ...
      '#withServiceArn':: d.fn(help='', args=[d.arg(name='serviceArn', type=d.T.string)]),
