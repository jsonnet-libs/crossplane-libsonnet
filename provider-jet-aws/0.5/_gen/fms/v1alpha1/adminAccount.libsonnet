{
  ...
  '#':: d.pkg(name='adminAccount', url='', help='"AdminAccount is the Schema for the AdminAccounts API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AdminAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AdminAccountSpec defines the desired state of AdminAccount"'),
  spec: {
