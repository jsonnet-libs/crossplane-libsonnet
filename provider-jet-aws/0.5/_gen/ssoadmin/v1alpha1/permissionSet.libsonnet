{
  ...
  '#':: d.pkg(name='permissionSet', url='', help='"PermissionSet is the Schema for the PermissionSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRelayState':: d.fn(help='', args=[d.arg(name='relayState', type=d.T.string)]),
      withRelayState(relayState): { spec+: { forProvider+: { relayState: relayState } } },
      '#withSessionDuration':: d.fn(help='', args=[d.arg(name='sessionDuration', type=d.T.string)]),
