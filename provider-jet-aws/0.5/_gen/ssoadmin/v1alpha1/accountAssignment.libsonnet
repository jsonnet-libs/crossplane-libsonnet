{
  ...
  '#':: d.pkg(name='accountAssignment', url='', help='"AccountAssignment is the Schema for the AccountAssignments API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withInstanceArn':: d.fn(help='', args=[d.arg(name='instanceArn', type=d.T.string)]),
      withInstanceArn(instanceArn): { spec+: { forProvider+: { instanceArn: instanceArn } } },
      '#withPermissionSetArn':: d.fn(help='', args=[d.arg(name='permissionSetArn', type=d.T.string)]),
      withPermissionSetArn(permissionSetArn): { spec+: { forProvider+: { permissionSetArn: permissionSetArn } } },
      '#withPrincipalId':: d.fn(help='', args=[d.arg(name='principalId', type=d.T.string)]),
      withPrincipalId(principalId): { spec+: { forProvider+: { principalId: principalId } } },
      '#withPrincipalType':: d.fn(help='', args=[d.arg(name='principalType', type=d.T.string)]),
