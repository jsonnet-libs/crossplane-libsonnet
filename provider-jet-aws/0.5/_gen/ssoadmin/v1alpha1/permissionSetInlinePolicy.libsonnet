{
  ...
  '#':: d.pkg(name='permissionSetInlinePolicy', url='', help='"PermissionSetInlinePolicy is the Schema for the PermissionSetInlinePolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withInlinePolicy':: d.fn(help='', args=[d.arg(name='inlinePolicy', type=d.T.string)]),
