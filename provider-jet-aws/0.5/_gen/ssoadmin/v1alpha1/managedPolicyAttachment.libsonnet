{
  ...
  '#':: d.pkg(name='managedPolicyAttachment', url='', help='"ManagedPolicyAttachment is the Schema for the ManagedPolicyAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withManagedPolicyArn':: d.fn(help='', args=[d.arg(name='managedPolicyArn', type=d.T.string)]),
