{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withClusterIdentifierPrefix':: d.fn(help='', args=[d.arg(name='clusterIdentifierPrefix', type=d.T.string)]),
      withClusterIdentifierPrefix(clusterIdentifierPrefix): { spec+: { forProvider+: { clusterIdentifierPrefix: clusterIdentifierPrefix } } },
