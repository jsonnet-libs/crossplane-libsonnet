{
  ...
  '#':: d.pkg(name='loggingConfiguration', url='', help='"LoggingConfiguration is the Schema for the LoggingConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      loggingConfiguration: {
        ...
        '#withLogDestinationConfig':: d.fn(help='', args=[d.arg(name='logDestinationConfig', type=d.T.array)]),
      ...
      '#withFirewallArn':: d.fn(help='', args=[d.arg(name='firewallArn', type=d.T.string)]),
