{
  ...
  '#':: d.pkg(name='notificationRule', url='', help='"NotificationRule is the Schema for the NotificationRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDetailType':: d.fn(help='', args=[d.arg(name='detailType', type=d.T.string)]),
      withDetailType(detailType): { spec+: { forProvider+: { detailType: detailType } } },
      '#withEventTypeIds':: d.fn(help='', args=[d.arg(name='eventTypeIds', type=d.T.array)]),
