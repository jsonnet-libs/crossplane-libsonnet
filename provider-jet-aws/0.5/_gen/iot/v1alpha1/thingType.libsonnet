{
  ...
  '#':: d.pkg(name='thingType', url='', help='"ThingType is the Schema for the ThingTypes API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      properties: {
        ...
        '#withSearchableAttributes':: d.fn(help='', args=[d.arg(name='searchableAttributes', type=d.T.array)]),
      ...
      '#withDeprecated':: d.fn(help='', args=[d.arg(name='deprecated', type=d.T.boolean)]),
