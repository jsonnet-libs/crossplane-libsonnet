{
  ...
  '#':: d.pkg(name='thingPrincipalAttachment', url='', help='"ThingPrincipalAttachment is the Schema for the ThingPrincipalAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withThing':: d.fn(help='', args=[d.arg(name='thing', type=d.T.string)]),
