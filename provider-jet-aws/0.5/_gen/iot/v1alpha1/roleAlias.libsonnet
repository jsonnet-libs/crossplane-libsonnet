{
  ...
  '#':: d.pkg(name='roleAlias', url='', help='"RoleAlias is the Schema for the RoleAliass API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCredentialDuration':: d.fn(help='', args=[d.arg(name='credentialDuration', type=d.T.number)]),
