{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCnamePrefix':: d.fn(help='', args=[d.arg(name='cnamePrefix', type=d.T.string)]),
      withCnamePrefix(cnamePrefix): { spec+: { forProvider+: { cnamePrefix: cnamePrefix } } },
      ...
      '#withPlatformArn':: d.fn(help='', args=[d.arg(name='platformArn', type=d.T.string)]),
      withPlatformArn(platformArn): { spec+: { forProvider+: { platformArn: platformArn } } },
      '#withPollInterval':: d.fn(help='', args=[d.arg(name='pollInterval', type=d.T.string)]),
      withPollInterval(pollInterval): { spec+: { forProvider+: { pollInterval: pollInterval } } },
      ...
      '#withSolutionStackName':: d.fn(help='', args=[d.arg(name='solutionStackName', type=d.T.string)]),
      ...
      '#withTier':: d.fn(help='', args=[d.arg(name='tier', type=d.T.string)]),
      withTier(tier): { spec+: { forProvider+: { tier: tier } } },
      '#withVersionLabel':: d.fn(help='', args=[d.arg(name='versionLabel', type=d.T.string)]),
      withVersionLabel(versionLabel): { spec+: { forProvider+: { versionLabel: versionLabel } } },
      '#withWaitForReadyTimeout':: d.fn(help='', args=[d.arg(name='waitForReadyTimeout', type=d.T.string)]),
      withWaitForReadyTimeout(waitForReadyTimeout): { spec+: { forProvider+: { waitForReadyTimeout: waitForReadyTimeout } } },
    },
