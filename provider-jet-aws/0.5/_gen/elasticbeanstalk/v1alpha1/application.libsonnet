{
  ...
  spec: {
    ...
    forProvider: {
      ...
      appversionLifecycle: {
        '#withDeleteSourceFromS3':: d.fn(help='', args=[d.arg(name='deleteSourceFromS3', type=d.T.boolean)]),
        withDeleteSourceFromS3(deleteSourceFromS3): { deleteSourceFromS3: deleteSourceFromS3 },
        '#withMaxAgeInDays':: d.fn(help='', args=[d.arg(name='maxAgeInDays', type=d.T.number)]),
        withMaxAgeInDays(maxAgeInDays): { maxAgeInDays: maxAgeInDays },
        '#withMaxCount':: d.fn(help='', args=[d.arg(name='maxCount', type=d.T.number)]),
