{
  ...
  '#':: d.pkg(name='replicationTask', url='', help='"ReplicationTask is the Schema for the ReplicationTasks API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCdcStartTime':: d.fn(help='', args=[d.arg(name='cdcStartTime', type=d.T.string)]),
      withCdcStartTime(cdcStartTime): { spec+: { forProvider+: { cdcStartTime: cdcStartTime } } },
      '#withMigrationType':: d.fn(help='', args=[d.arg(name='migrationType', type=d.T.string)]),
      ...
      '#withReplicationInstanceArn':: d.fn(help='', args=[d.arg(name='replicationInstanceArn', type=d.T.string)]),
      withReplicationInstanceArn(replicationInstanceArn): { spec+: { forProvider+: { replicationInstanceArn: replicationInstanceArn } } },
      '#withReplicationTaskId':: d.fn(help='', args=[d.arg(name='replicationTaskId', type=d.T.string)]),
      withReplicationTaskId(replicationTaskId): { spec+: { forProvider+: { replicationTaskId: replicationTaskId } } },
      '#withReplicationTaskSettings':: d.fn(help='', args=[d.arg(name='replicationTaskSettings', type=d.T.string)]),
      withReplicationTaskSettings(replicationTaskSettings): { spec+: { forProvider+: { replicationTaskSettings: replicationTaskSettings } } },
      '#withSourceEndpointArn':: d.fn(help='', args=[d.arg(name='sourceEndpointArn', type=d.T.string)]),
      withSourceEndpointArn(sourceEndpointArn): { spec+: { forProvider+: { sourceEndpointArn: sourceEndpointArn } } },
      '#withTableMappings':: d.fn(help='', args=[d.arg(name='tableMappings', type=d.T.string)]),
      ...
      '#withTargetEndpointArn':: d.fn(help='', args=[d.arg(name='targetEndpointArn', type=d.T.string)]),
