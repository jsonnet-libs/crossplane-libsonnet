{
  ...
  '#':: d.pkg(name='replicationSubnetGroup', url='', help='"ReplicationSubnetGroup is the Schema for the ReplicationSubnetGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReplicationSubnetGroupDescription':: d.fn(help='', args=[d.arg(name='replicationSubnetGroupDescription', type=d.T.string)]),
