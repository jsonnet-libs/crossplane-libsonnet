{
  ...
  '#':: d.pkg(name='replicationInstance', url='', help='"ReplicationInstance is the Schema for the ReplicationInstances API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReplicationInstanceClass':: d.fn(help='', args=[d.arg(name='replicationInstanceClass', type=d.T.string)]),
      withReplicationInstanceClass(replicationInstanceClass): { spec+: { forProvider+: { replicationInstanceClass: replicationInstanceClass } } },
      '#withReplicationInstanceId':: d.fn(help='', args=[d.arg(name='replicationInstanceId', type=d.T.string)]),
      withReplicationInstanceId(replicationInstanceId): { spec+: { forProvider+: { replicationInstanceId: replicationInstanceId } } },
      '#withReplicationSubnetGroupId':: d.fn(help='', args=[d.arg(name='replicationSubnetGroupId', type=d.T.string)]),
