{
  ...
  '#':: d.pkg(name='smsPreferences', url='', help='"SMSPreferences is the Schema for the SMSPreferencess API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#deliveryStatusIamRoleArnRef':: d.obj(help='"A Reference to a named object."'),
      deliveryStatusIamRoleArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { deliveryStatusIamRoleArnRef+: { name: name } } } },
      },
      '#deliveryStatusIamRoleArnSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withDefaultSenderId':: d.fn(help='', args=[d.arg(name='defaultSenderId', type=d.T.string)]),
      withDefaultSenderId(defaultSenderId): { spec+: { forProvider+: { defaultSenderId: defaultSenderId } } },
      '#withDefaultSmsType':: d.fn(help='', args=[d.arg(name='defaultSmsType', type=d.T.string)]),
      withDefaultSmsType(defaultSmsType): { spec+: { forProvider+: { defaultSmsType: defaultSmsType } } },
      '#withDeliveryStatusIamRoleArn':: d.fn(help='', args=[d.arg(name='deliveryStatusIamRoleArn', type=d.T.string)]),
      withDeliveryStatusIamRoleArn(deliveryStatusIamRoleArn): { spec+: { forProvider+: { deliveryStatusIamRoleArn: deliveryStatusIamRoleArn } } },
      '#withDeliveryStatusSuccessSamplingRate':: d.fn(help='', args=[d.arg(name='deliveryStatusSuccessSamplingRate', type=d.T.string)]),
      ...
      '#withMonthlySpendLimit':: d.fn(help='', args=[d.arg(name='monthlySpendLimit', type=d.T.string)]),
      ...
      '#withUsageReportS3Bucket':: d.fn(help='', args=[d.arg(name='usageReportS3Bucket', type=d.T.string)]),
