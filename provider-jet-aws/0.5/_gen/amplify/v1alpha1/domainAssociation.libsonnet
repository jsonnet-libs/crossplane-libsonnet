{
  ...
  '#':: d.pkg(name='domainAssociation', url='', help='"DomainAssociation is the Schema for the DomainAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DomainAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DomainAssociationSpec defines the desired state of DomainAssociation"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#subDomain':: d.obj(help=''),
      subDomain: {
      ...
      '#withSubDomain':: d.fn(help='', args=[d.arg(name='subDomain', type=d.T.array)]),
      withSubDomain(subDomain): { spec+: { forProvider+: { subDomain: if std.isArray(v=subDomain) then subDomain else [subDomain] } } },
      '#withSubDomainMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subDomain', type=d.T.array)]),
      withSubDomainMixin(subDomain): { spec+: { forProvider+: { subDomain+: if std.isArray(v=subDomain) then subDomain else [subDomain] } } },
      '#withWaitForVerification':: d.fn(help='', args=[d.arg(name='waitForVerification', type=d.T.boolean)]),
      withWaitForVerification(waitForVerification): { spec+: { forProvider+: { waitForVerification: waitForVerification } } },
    },
