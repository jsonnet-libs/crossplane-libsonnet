{
  ...
  '#':: d.pkg(name='branch', url='', help='"Branch is the Schema for the Branchs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBackendEnvironmentArn':: d.fn(help='', args=[d.arg(name='backendEnvironmentArn', type=d.T.string)]),
      withBackendEnvironmentArn(backendEnvironmentArn): { spec+: { forProvider+: { backendEnvironmentArn: backendEnvironmentArn } } },
      '#withBranchName':: d.fn(help='', args=[d.arg(name='branchName', type=d.T.string)]),
      ...
      '#withEnableNotification':: d.fn(help='', args=[d.arg(name='enableNotification', type=d.T.boolean)]),
