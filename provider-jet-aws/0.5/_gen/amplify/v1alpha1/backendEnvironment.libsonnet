{
  ...
  '#':: d.pkg(name='backendEnvironment', url='', help='"BackendEnvironment is the Schema for the BackendEnvironments API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeploymentArtifacts':: d.fn(help='', args=[d.arg(name='deploymentArtifacts', type=d.T.string)]),
      withDeploymentArtifacts(deploymentArtifacts): { spec+: { forProvider+: { deploymentArtifacts: deploymentArtifacts } } },
      '#withEnvironmentName':: d.fn(help='', args=[d.arg(name='environmentName', type=d.T.string)]),
      withEnvironmentName(environmentName): { spec+: { forProvider+: { environmentName: environmentName } } },
      ...
      '#withStackName':: d.fn(help='', args=[d.arg(name='stackName', type=d.T.string)]),
