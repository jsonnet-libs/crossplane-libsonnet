{
  ...
  spec: {
    ...
    forProvider: {
      '#retentionProperties':: d.obj(help=''),
      retentionProperties: {
        '#withMagneticStoreRetentionPeriodInDays':: d.fn(help='', args=[d.arg(name='magneticStoreRetentionPeriodInDays', type=d.T.number)]),
        ...
        '#withMemoryStoreRetentionPeriodInHours':: d.fn(help='', args=[d.arg(name='memoryStoreRetentionPeriodInHours', type=d.T.number)]),
      ...
      '#withRetentionProperties':: d.fn(help='', args=[d.arg(name='retentionProperties', type=d.T.array)]),
