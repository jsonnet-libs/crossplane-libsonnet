{
  ...
  '#':: d.pkg(name='environmentEC2', url='', help='"EnvironmentEC2 is the Schema for the EnvironmentEC2s API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutomaticStopTimeMinutes':: d.fn(help='', args=[d.arg(name='automaticStopTimeMinutes', type=d.T.number)]),
      ...
      '#withOwnerArn':: d.fn(help='', args=[d.arg(name='ownerArn', type=d.T.string)]),
