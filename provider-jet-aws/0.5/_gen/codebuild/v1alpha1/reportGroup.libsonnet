{
  ...
  '#':: d.pkg(name='reportGroup', url='', help='"ReportGroup is the Schema for the ReportGroups API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ReportGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ReportGroupSpec defines the desired state of ReportGroup"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#exportConfig':: d.obj(help=''),
      exportConfig: {
        '#s3Destination':: d.obj(help=''),
        s3Destination: {
      ...
      '#withDeleteReports':: d.fn(help='', args=[d.arg(name='deleteReports', type=d.T.boolean)]),
      withDeleteReports(deleteReports): { spec+: { forProvider+: { deleteReports: deleteReports } } },
      '#withExportConfig':: d.fn(help='', args=[d.arg(name='exportConfig', type=d.T.array)]),
      withExportConfig(exportConfig): { spec+: { forProvider+: { exportConfig: if std.isArray(v=exportConfig) then exportConfig else [exportConfig] } } },
      '#withExportConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exportConfig', type=d.T.array)]),
      withExportConfigMixin(exportConfig): { spec+: { forProvider+: { exportConfig+: if std.isArray(v=exportConfig) then exportConfig else [exportConfig] } } },
