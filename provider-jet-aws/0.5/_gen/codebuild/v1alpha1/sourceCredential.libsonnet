{
  ...
  '#':: d.pkg(name='sourceCredential', url='', help='"SourceCredential is the Schema for the SourceCredentials API"'),
  ...
  '#new':: d.fn(help='new returns an instance of SourceCredential', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SourceCredentialSpec defines the desired state of SourceCredential"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#tokenSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      tokenSecretRef: {
      ...
      '#withServerType':: d.fn(help='', args=[d.arg(name='serverType', type=d.T.string)]),
      withServerType(serverType): { spec+: { forProvider+: { serverType: serverType } } },
