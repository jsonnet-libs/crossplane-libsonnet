{
  ...
  spec: {
    ...
    forProvider: {
      '#filterGroup':: d.obj(help=''),
      filterGroup: {
        '#filter':: d.obj(help=''),
        filter: {
          '#withExcludeMatchedPattern':: d.fn(help='', args=[d.arg(name='excludeMatchedPattern', type=d.T.boolean)]),
          withExcludeMatchedPattern(excludeMatchedPattern): { excludeMatchedPattern: excludeMatchedPattern },
      ...
      '#withBranchFilter':: d.fn(help='', args=[d.arg(name='branchFilter', type=d.T.string)]),
      withBranchFilter(branchFilter): { spec+: { forProvider+: { branchFilter: branchFilter } } },
      '#withBuildType':: d.fn(help='', args=[d.arg(name='buildType', type=d.T.string)]),
      withBuildType(buildType): { spec+: { forProvider+: { buildType: buildType } } },
      '#withFilterGroup':: d.fn(help='', args=[d.arg(name='filterGroup', type=d.T.array)]),
      withFilterGroup(filterGroup): { spec+: { forProvider+: { filterGroup: if std.isArray(v=filterGroup) then filterGroup else [filterGroup] } } },
      '#withFilterGroupMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='filterGroup', type=d.T.array)]),
      withFilterGroupMixin(filterGroup): { spec+: { forProvider+: { filterGroup+: if std.isArray(v=filterGroup) then filterGroup else [filterGroup] } } },
      '#withProjectName':: d.fn(help='', args=[d.arg(name='projectName', type=d.T.string)]),
      withProjectName(projectName): { spec+: { forProvider+: { projectName: projectName } } },
