{
  ...
  '#':: d.pkg(name='vaultLock', url='', help='"VaultLock is the Schema for the VaultLocks API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCompleteLock':: d.fn(help='', args=[d.arg(name='completeLock', type=d.T.boolean)]),
      withCompleteLock(completeLock): { spec+: { forProvider+: { completeLock: completeLock } } },
      '#withIgnoreDeletionError':: d.fn(help='', args=[d.arg(name='ignoreDeletionError', type=d.T.boolean)]),
      ...
      '#withVaultName':: d.fn(help='', args=[d.arg(name='vaultName', type=d.T.string)]),
