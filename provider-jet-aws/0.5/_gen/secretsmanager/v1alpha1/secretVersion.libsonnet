{
  ...
  spec: {
    ...
    forProvider: {
      '#secretBinarySecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      ...
      '#secretStringSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      ...
      '#withVersionStages':: d.fn(help='', args=[d.arg(name='versionStages', type=d.T.array)]),
