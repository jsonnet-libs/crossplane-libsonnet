{
  ...
  '#':: d.pkg(name='gatewayRoute', url='', help='"GatewayRoute is the Schema for the GatewayRoutes API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVirtualGatewayName':: d.fn(help='', args=[d.arg(name='virtualGatewayName', type=d.T.string)]),
