{
  ...
  '#':: d.pkg(name='virtualService', url='', help='"VirtualService is the Schema for the VirtualServices API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      spec: {
        '#provider':: d.obj(help=''),
        provider: {
          '#virtualNode':: d.obj(help=''),
          virtualNode: {
            '#withVirtualNodeName':: d.fn(help='', args=[d.arg(name='virtualNodeName', type=d.T.string)]),
            withVirtualNodeName(virtualNodeName): { virtualNodeName: virtualNodeName },
          },
          '#virtualRouter':: d.obj(help=''),
          virtualRouter: {
