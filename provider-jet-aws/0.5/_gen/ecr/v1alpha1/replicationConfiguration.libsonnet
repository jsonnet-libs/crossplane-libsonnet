{
  ...
  '#':: d.pkg(name='replicationConfiguration', url='', help='"ReplicationConfiguration is the Schema for the ReplicationConfigurations API"'),
      ...
      replicationConfiguration: {
        ...
        rule: {
          ...
          destination: {
            ...
            '#withRegistryId':: d.fn(help='', args=[d.arg(name='registryId', type=d.T.string)]),
