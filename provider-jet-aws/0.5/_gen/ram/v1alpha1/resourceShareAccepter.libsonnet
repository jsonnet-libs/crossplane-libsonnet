{
  ...
  '#':: d.pkg(name='resourceShareAccepter', url='', help='"ResourceShareAccepter is the Schema for the ResourceShareAccepters API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withShareArn':: d.fn(help='', args=[d.arg(name='shareArn', type=d.T.string)]),
