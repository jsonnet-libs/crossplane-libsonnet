{
  ...
  '#':: d.pkg(name='resourceAssociation', url='', help='"ResourceAssociation is the Schema for the ResourceAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceShareArn':: d.fn(help='', args=[d.arg(name='resourceShareArn', type=d.T.string)]),
