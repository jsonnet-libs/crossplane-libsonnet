{
  ...
  '#':: d.pkg(name='locationEFS', url='', help='"LocationEFS is the Schema for the LocationEFSs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocationEFS', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocationEFSSpec defines the desired state of LocationEFS"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#ec2Config':: d.obj(help=''),
      ec2Config: {
        '#withSecurityGroupArns':: d.fn(help='', args=[d.arg(name='securityGroupArns', type=d.T.array)]),
        withSecurityGroupArns(securityGroupArns): { securityGroupArns: if std.isArray(v=securityGroupArns) then securityGroupArns else [securityGroupArns] },
        '#withSecurityGroupArnsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupArns', type=d.T.array)]),
        withSecurityGroupArnsMixin(securityGroupArns): { securityGroupArns+: if std.isArray(v=securityGroupArns) then securityGroupArns else [securityGroupArns] },
        '#withSubnetArn':: d.fn(help='', args=[d.arg(name='subnetArn', type=d.T.string)]),
        withSubnetArn(subnetArn): { subnetArn: subnetArn },
      },
      '#withEc2Config':: d.fn(help='', args=[d.arg(name='ec2Config', type=d.T.array)]),
      withEc2Config(ec2Config): { spec+: { forProvider+: { ec2Config: if std.isArray(v=ec2Config) then ec2Config else [ec2Config] } } },
      '#withEc2ConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ec2Config', type=d.T.array)]),
      withEc2ConfigMixin(ec2Config): { spec+: { forProvider+: { ec2Config+: if std.isArray(v=ec2Config) then ec2Config else [ec2Config] } } },
      '#withEfsFileSystemArn':: d.fn(help='', args=[d.arg(name='efsFileSystemArn', type=d.T.string)]),
      withEfsFileSystemArn(efsFileSystemArn): { spec+: { forProvider+: { efsFileSystemArn: efsFileSystemArn } } },
