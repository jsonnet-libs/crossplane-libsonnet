{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPrivateLinkEndpoint':: d.fn(help='', args=[d.arg(name='privateLinkEndpoint', type=d.T.string)]),
      withPrivateLinkEndpoint(privateLinkEndpoint): { spec+: { forProvider+: { privateLinkEndpoint: privateLinkEndpoint } } },
