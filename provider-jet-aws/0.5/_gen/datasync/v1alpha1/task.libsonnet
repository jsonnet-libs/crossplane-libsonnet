{
  ...
  '#':: d.pkg(name='task', url='', help='"Task is the Schema for the Tasks API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#options':: d.obj(help=''),
      options: {
        '#withAtime':: d.fn(help='', args=[d.arg(name='atime', type=d.T.string)]),
        withAtime(atime): { atime: atime },
        '#withBytesPerSecond':: d.fn(help='', args=[d.arg(name='bytesPerSecond', type=d.T.number)]),
        withBytesPerSecond(bytesPerSecond): { bytesPerSecond: bytesPerSecond },
        '#withGid':: d.fn(help='', args=[d.arg(name='gid', type=d.T.string)]),
        withGid(gid): { gid: gid },
        '#withLogLevel':: d.fn(help='', args=[d.arg(name='logLevel', type=d.T.string)]),
        withLogLevel(logLevel): { logLevel: logLevel },
        '#withMtime':: d.fn(help='', args=[d.arg(name='mtime', type=d.T.string)]),
        withMtime(mtime): { mtime: mtime },
        '#withOverwriteMode':: d.fn(help='', args=[d.arg(name='overwriteMode', type=d.T.string)]),
        withOverwriteMode(overwriteMode): { overwriteMode: overwriteMode },
        '#withPosixPermissions':: d.fn(help='', args=[d.arg(name='posixPermissions', type=d.T.string)]),
        withPosixPermissions(posixPermissions): { posixPermissions: posixPermissions },
        '#withPreserveDeletedFiles':: d.fn(help='', args=[d.arg(name='preserveDeletedFiles', type=d.T.string)]),
        withPreserveDeletedFiles(preserveDeletedFiles): { preserveDeletedFiles: preserveDeletedFiles },
        '#withPreserveDevices':: d.fn(help='', args=[d.arg(name='preserveDevices', type=d.T.string)]),
        withPreserveDevices(preserveDevices): { preserveDevices: preserveDevices },
        '#withTaskQueueing':: d.fn(help='', args=[d.arg(name='taskQueueing', type=d.T.string)]),
        withTaskQueueing(taskQueueing): { taskQueueing: taskQueueing },
        '#withTransferMode':: d.fn(help='', args=[d.arg(name='transferMode', type=d.T.string)]),
        withTransferMode(transferMode): { transferMode: transferMode },
        '#withUid':: d.fn(help='', args=[d.arg(name='uid', type=d.T.string)]),
        withUid(uid): { uid: uid },
        '#withVerifyMode':: d.fn(help='', args=[d.arg(name='verifyMode', type=d.T.string)]),
      ...
      '#withDestinationLocationArn':: d.fn(help='', args=[d.arg(name='destinationLocationArn', type=d.T.string)]),
      ...
      '#withSourceLocationArn':: d.fn(help='', args=[d.arg(name='sourceLocationArn', type=d.T.string)]),
