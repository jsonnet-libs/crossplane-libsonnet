{
  ...
  '#':: d.pkg(name='locationSMB', url='', help='"LocationSMB is the Schema for the LocationSMBs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocationSMB', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocationSMBSpec defines the desired state of LocationSMB"'),
  spec: {
