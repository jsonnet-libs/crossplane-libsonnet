{
  ...
  '#':: d.pkg(name='locationS3', url='', help='"LocationS3 is the Schema for the LocationS3s API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#s3Config':: d.obj(help=''),
      s3Config: {
        '#withBucketAccessRoleArn':: d.fn(help='', args=[d.arg(name='bucketAccessRoleArn', type=d.T.string)]),
