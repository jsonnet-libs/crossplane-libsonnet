{
  ...
  '#':: d.pkg(name='locationFSXWindowsFileSystem', url='', help='"LocationFSXWindowsFileSystem is the Schema for the LocationFSXWindowsFileSystems API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocationFSXWindowsFileSystem', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocationFSXWindowsFileSystemSpec defines the desired state of LocationFSXWindowsFileSystem"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withFsxFilesystemArn':: d.fn(help='', args=[d.arg(name='fsxFilesystemArn', type=d.T.string)]),
      withFsxFilesystemArn(fsxFilesystemArn): { spec+: { forProvider+: { fsxFilesystemArn: fsxFilesystemArn } } },
      ...
      withSecurityGroupArns(securityGroupArns): { spec+: { forProvider+: { securityGroupArns: if std.isArray(v=securityGroupArns) then securityGroupArns else [securityGroupArns] } } },
      ...
      withSecurityGroupArnsMixin(securityGroupArns): { spec+: { forProvider+: { securityGroupArns+: if std.isArray(v=securityGroupArns) then securityGroupArns else [securityGroupArns] } } },
