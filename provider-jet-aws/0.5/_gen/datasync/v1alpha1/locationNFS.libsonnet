{
  ...
  '#':: d.pkg(name='locationNFS', url='', help='"LocationNFS is the Schema for the LocationNFSs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocationNFS', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LocationNFSSpec defines the desired state of LocationNFS"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#mountOptions':: d.obj(help=''),
      mountOptions: {
        '#withVersion':: d.fn(help='', args=[d.arg(name='version', type=d.T.string)]),
        withVersion(version): { version: version },
      },
      '#onPremConfig':: d.obj(help=''),
      onPremConfig: {
        '#withAgentArns':: d.fn(help='', args=[d.arg(name='agentArns', type=d.T.array)]),
        withAgentArns(agentArns): { agentArns: if std.isArray(v=agentArns) then agentArns else [agentArns] },
        '#withAgentArnsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='agentArns', type=d.T.array)]),
        withAgentArnsMixin(agentArns): { agentArns+: if std.isArray(v=agentArns) then agentArns else [agentArns] },
      },
      '#withMountOptions':: d.fn(help='', args=[d.arg(name='mountOptions', type=d.T.array)]),
      withMountOptions(mountOptions): { spec+: { forProvider+: { mountOptions: if std.isArray(v=mountOptions) then mountOptions else [mountOptions] } } },
      ...
      withMountOptionsMixin(mountOptions): { spec+: { forProvider+: { mountOptions+: if std.isArray(v=mountOptions) then mountOptions else [mountOptions] } } },
      '#withOnPremConfig':: d.fn(help='', args=[d.arg(name='onPremConfig', type=d.T.array)]),
      withOnPremConfig(onPremConfig): { spec+: { forProvider+: { onPremConfig: if std.isArray(v=onPremConfig) then onPremConfig else [onPremConfig] } } },
      '#withOnPremConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='onPremConfig', type=d.T.array)]),
      withOnPremConfigMixin(onPremConfig): { spec+: { forProvider+: { onPremConfig+: if std.isArray(v=onPremConfig) then onPremConfig else [onPremConfig] } } },
      ...
      '#withServerHostname':: d.fn(help='', args=[d.arg(name='serverHostname', type=d.T.string)]),
      withServerHostname(serverHostname): { spec+: { forProvider+: { serverHostname: serverHostname } } },
      '#withSubdirectory':: d.fn(help='', args=[d.arg(name='subdirectory', type=d.T.string)]),
