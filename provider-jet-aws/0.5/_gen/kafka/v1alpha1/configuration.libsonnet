{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withKafkaVersions':: d.fn(help='', args=[d.arg(name='kafkaVersions', type=d.T.array)]),
      ...
      '#withServerProperties':: d.fn(help='', args=[d.arg(name='serverProperties', type=d.T.string)]),
