{
  ...
  '#':: d.pkg(name='scramSecretAssociation', url='', help='"ScramSecretAssociation is the Schema for the ScramSecretAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSecretArnList':: d.fn(help='', args=[d.arg(name='secretArnList', type=d.T.array)]),
