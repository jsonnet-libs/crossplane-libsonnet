{
  ...
  '#':: d.pkg(name='memberAccountAssociation', url='', help='"MemberAccountAssociation is the Schema for the MemberAccountAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of MemberAccountAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"MemberAccountAssociationSpec defines the desired state of MemberAccountAssociation"'),
  spec: {
