{
  ...
  '#':: d.pkg(name='s3BucketAssociation', url='', help='"S3BucketAssociation is the Schema for the S3BucketAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of S3BucketAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"S3BucketAssociationSpec defines the desired state of S3BucketAssociation"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#classificationType':: d.obj(help=''),
      classificationType: {
        '#withContinuous':: d.fn(help='', args=[d.arg(name='continuous', type=d.T.string)]),
        withContinuous(continuous): { continuous: continuous },
        '#withOneTime':: d.fn(help='', args=[d.arg(name='oneTime', type=d.T.string)]),
        withOneTime(oneTime): { oneTime: oneTime },
      },
      ...
      '#withClassificationType':: d.fn(help='', args=[d.arg(name='classificationType', type=d.T.array)]),
      withClassificationType(classificationType): { spec+: { forProvider+: { classificationType: if std.isArray(v=classificationType) then classificationType else [classificationType] } } },
      '#withClassificationTypeMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='classificationType', type=d.T.array)]),
      withClassificationTypeMixin(classificationType): { spec+: { forProvider+: { classificationType+: if std.isArray(v=classificationType) then classificationType else [classificationType] } } },
      '#withMemberAccountId':: d.fn(help='', args=[d.arg(name='memberAccountId', type=d.T.string)]),
      withMemberAccountId(memberAccountId): { spec+: { forProvider+: { memberAccountId: memberAccountId } } },
