  ...
  spec: {
    ...
    forProvider: {
      ...
      catalogData: {
        ...
        '#withLogoImageBlob':: d.fn(help='', args=[d.arg(name='logoImageBlob', type=d.T.string)]),
        withLogoImageBlob(logoImageBlob): { logoImageBlob: logoImageBlob },
        '#withOperatingSystems':: d.fn(help='', args=[d.arg(name='operatingSystems', type=d.T.array)]),
