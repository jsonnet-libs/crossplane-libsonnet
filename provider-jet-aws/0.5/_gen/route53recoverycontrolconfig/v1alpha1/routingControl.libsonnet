{
  ...
  '#':: d.pkg(name='routingControl', url='', help='"RoutingControl is the Schema for the RoutingControls API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withClusterArn':: d.fn(help='', args=[d.arg(name='clusterArn', type=d.T.string)]),
