{
  ...
  '#':: d.pkg(name='safetyRule', url='', help='"SafetyRule is the Schema for the SafetyRules API"'),
  ...
  new(name): {
    apiVersion: 'route53recoverycontrolconfig.aws.jet.crossplane.io/v1alpha1',
    kind: 'SafetyRule',
  ...
  spec: {
    ...
    forProvider: {
      '#ruleConfig':: d.obj(help=''),
      ruleConfig: {
        '#withInverted':: d.fn(help='', args=[d.arg(name='inverted', type=d.T.boolean)]),
      ...
      '#withAssertedControls':: d.fn(help='', args=[d.arg(name='assertedControls', type=d.T.array)]),
      ...
      '#withControlPanelArn':: d.fn(help='', args=[d.arg(name='controlPanelArn', type=d.T.string)]),
      withControlPanelArn(controlPanelArn): { spec+: { forProvider+: { controlPanelArn: controlPanelArn } } },
      '#withGatingControls':: d.fn(help='', args=[d.arg(name='gatingControls', type=d.T.array)]),
      ...
      '#withWaitPeriodMs':: d.fn(help='', args=[d.arg(name='waitPeriodMs', type=d.T.number)]),
