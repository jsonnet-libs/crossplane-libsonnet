{
  ...
  '#':: d.pkg(name='infrastructureConfiguration', url='', help='"InfrastructureConfiguration is the Schema for the InfrastructureConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstanceProfileName':: d.fn(help='', args=[d.arg(name='instanceProfileName', type=d.T.string)]),
      ...
      '#withKeyPair':: d.fn(help='', args=[d.arg(name='keyPair', type=d.T.string)]),
      ...
      '#withSnsTopicArn':: d.fn(help='', args=[d.arg(name='snsTopicArn', type=d.T.string)]),
      ...
      '#withTerminateInstanceOnFailure':: d.fn(help='', args=[d.arg(name='terminateInstanceOnFailure', type=d.T.boolean)]),
