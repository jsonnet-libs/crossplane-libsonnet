{
  ...
  '#':: d.pkg(name='imagePipeline', url='', help='"ImagePipeline is the Schema for the ImagePipelines API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#imageTestsConfiguration':: d.obj(help=''),
      imageTestsConfiguration: {
        '#withImageTestsEnabled':: d.fn(help='', args=[d.arg(name='imageTestsEnabled', type=d.T.boolean)]),
        withImageTestsEnabled(imageTestsEnabled): { imageTestsEnabled: imageTestsEnabled },
        '#withTimeoutMinutes':: d.fn(help='', args=[d.arg(name='timeoutMinutes', type=d.T.number)]),
        withTimeoutMinutes(timeoutMinutes): { timeoutMinutes: timeoutMinutes },
      },
      '#schedule':: d.obj(help=''),
      schedule: {
        '#withPipelineExecutionStartCondition':: d.fn(help='', args=[d.arg(name='pipelineExecutionStartCondition', type=d.T.string)]),
      ...
      '#withDistributionConfigurationArn':: d.fn(help='', args=[d.arg(name='distributionConfigurationArn', type=d.T.string)]),
      ...
      '#withEnhancedImageMetadataEnabled':: d.fn(help='', args=[d.arg(name='enhancedImageMetadataEnabled', type=d.T.boolean)]),
      ...
      '#withImageRecipeArn':: d.fn(help='', args=[d.arg(name='imageRecipeArn', type=d.T.string)]),
      withImageRecipeArn(imageRecipeArn): { spec+: { forProvider+: { imageRecipeArn: imageRecipeArn } } },
      '#withImageTestsConfiguration':: d.fn(help='', args=[d.arg(name='imageTestsConfiguration', type=d.T.array)]),
      ...
      '#withInfrastructureConfigurationArn':: d.fn(help='', args=[d.arg(name='infrastructureConfigurationArn', type=d.T.string)]),
