{
  ...
  '#':: d.pkg(name='component', url='', help='"Component is the Schema for the Components API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withChangeDescription':: d.fn(help='', args=[d.arg(name='changeDescription', type=d.T.string)]),
      ...
      '#withSupportedOsVersions':: d.fn(help='', args=[d.arg(name='supportedOsVersions', type=d.T.array)]),
