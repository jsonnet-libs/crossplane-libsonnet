{
  ...
  '#':: d.pkg(name='imageRecipe', url='', help='"ImageRecipe is the Schema for the ImageRecipes API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#component':: d.obj(help=''),
      component: {
        '#withComponentArn':: d.fn(help='', args=[d.arg(name='componentArn', type=d.T.string)]),
        withComponentArn(componentArn): { componentArn: componentArn },
      },
      '#withBlockDeviceMapping':: d.fn(help='', args=[d.arg(name='blockDeviceMapping', type=d.T.array)]),
      ...
      '#withParentImage':: d.fn(help='', args=[d.arg(name='parentImage', type=d.T.string)]),
