{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeduplicationScope':: d.fn(help='', args=[d.arg(name='deduplicationScope', type=d.T.string)]),
      withDeduplicationScope(deduplicationScope): { spec+: { forProvider+: { deduplicationScope: deduplicationScope } } },
      '#withDelaySeconds':: d.fn(help='', args=[d.arg(name='delaySeconds', type=d.T.number)]),
      withDelaySeconds(delaySeconds): { spec+: { forProvider+: { delaySeconds: delaySeconds } } },
      '#withFifoQueue':: d.fn(help='', args=[d.arg(name='fifoQueue', type=d.T.boolean)]),
      withFifoQueue(fifoQueue): { spec+: { forProvider+: { fifoQueue: fifoQueue } } },
      '#withFifoThroughputLimit':: d.fn(help='', args=[d.arg(name='fifoThroughputLimit', type=d.T.string)]),
      withFifoThroughputLimit(fifoThroughputLimit): { spec+: { forProvider+: { fifoThroughputLimit: fifoThroughputLimit } } },
      '#withKmsDataKeyReusePeriodSeconds':: d.fn(help='', args=[d.arg(name='kmsDataKeyReusePeriodSeconds', type=d.T.number)]),
      ...
      '#withMaxMessageSize':: d.fn(help='', args=[d.arg(name='maxMessageSize', type=d.T.number)]),
      withMaxMessageSize(maxMessageSize): { spec+: { forProvider+: { maxMessageSize: maxMessageSize } } },
      '#withMessageRetentionSeconds':: d.fn(help='', args=[d.arg(name='messageRetentionSeconds', type=d.T.number)]),
      ...
      '#withReceiveWaitTimeSeconds':: d.fn(help='', args=[d.arg(name='receiveWaitTimeSeconds', type=d.T.number)]),
      withReceiveWaitTimeSeconds(receiveWaitTimeSeconds): { spec+: { forProvider+: { receiveWaitTimeSeconds: receiveWaitTimeSeconds } } },
      '#withRedrivePolicy':: d.fn(help='', args=[d.arg(name='redrivePolicy', type=d.T.string)]),
      ...
      '#withVisibilityTimeoutSeconds':: d.fn(help='', args=[d.arg(name='visibilityTimeoutSeconds', type=d.T.number)]),
