{
  ...
  '#':: d.pkg(name='websiteCertificateAuthorityAssociation', url='', help='"WebsiteCertificateAuthorityAssociation is the Schema for the WebsiteCertificateAuthorityAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebsiteCertificateAuthorityAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebsiteCertificateAuthorityAssociationSpec defines the desired state of WebsiteCertificateAuthorityAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withFleetArn':: d.fn(help='', args=[d.arg(name='fleetArn', type=d.T.string)]),
      withFleetArn(fleetArn): { spec+: { forProvider+: { fleetArn: fleetArn } } },
