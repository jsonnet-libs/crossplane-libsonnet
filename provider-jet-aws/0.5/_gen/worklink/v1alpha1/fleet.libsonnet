{
  ...
  spec: {
    ...
    forProvider: {
      '#identityProvider':: d.obj(help=''),
      identityProvider: {
        '#withSamlMetadata':: d.fn(help='', args=[d.arg(name='samlMetadata', type=d.T.string)]),
        withSamlMetadata(samlMetadata): { samlMetadata: samlMetadata },
      ...
      '#withAuditStreamArn':: d.fn(help='', args=[d.arg(name='auditStreamArn', type=d.T.string)]),
      withAuditStreamArn(auditStreamArn): { spec+: { forProvider+: { auditStreamArn: auditStreamArn } } },
      '#withDeviceCaCertificate':: d.fn(help='', args=[d.arg(name='deviceCaCertificate', type=d.T.string)]),
      withDeviceCaCertificate(deviceCaCertificate): { spec+: { forProvider+: { deviceCaCertificate: deviceCaCertificate } } },
      ...
      '#withIdentityProvider':: d.fn(help='', args=[d.arg(name='identityProvider', type=d.T.array)]),
      withIdentityProvider(identityProvider): { spec+: { forProvider+: { identityProvider: if std.isArray(v=identityProvider) then identityProvider else [identityProvider] } } },
      '#withIdentityProviderMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identityProvider', type=d.T.array)]),
      withIdentityProviderMixin(identityProvider): { spec+: { forProvider+: { identityProvider+: if std.isArray(v=identityProvider) then identityProvider else [identityProvider] } } },
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withNetwork':: d.fn(help='', args=[d.arg(name='network', type=d.T.array)]),
      withNetwork(network): { spec+: { forProvider+: { network: if std.isArray(v=network) then network else [network] } } },
      '#withNetworkMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='network', type=d.T.array)]),
      withNetworkMixin(network): { spec+: { forProvider+: { network+: if std.isArray(v=network) then network else [network] } } },
      '#withOptimizeForEndUserLocation':: d.fn(help='', args=[d.arg(name='optimizeForEndUserLocation', type=d.T.boolean)]),
      withOptimizeForEndUserLocation(optimizeForEndUserLocation): { spec+: { forProvider+: { optimizeForEndUserLocation: optimizeForEndUserLocation } } },
