{
  ...
  '#':: d.pkg(name='baiduChannel', url='', help='"BaiduChannel is the Schema for the BaiduChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of BaiduChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BaiduChannelSpec defines the desired state of BaiduChannel"'),
  spec: {
    ...
    forProvider: {
      ...
      '#secretKeySecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      secretKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { secretKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { secretKeySecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { secretKeySecretRef+: { namespace: namespace } } } },
      },
