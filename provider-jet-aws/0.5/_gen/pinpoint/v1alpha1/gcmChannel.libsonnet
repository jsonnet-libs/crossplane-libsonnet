{
  ...
  '#':: d.pkg(name='gcmChannel', url='', help='"GCMChannel is the Schema for the GCMChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of GCMChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GCMChannelSpec defines the desired state of GCMChannel"'),
  spec: {
