{
  ...
  '#':: d.pkg(name='apnsChannel', url='', help='"APNSChannel is the Schema for the APNSChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of APNSChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APNSChannelSpec defines the desired state of APNSChannel"'),
  spec: {
