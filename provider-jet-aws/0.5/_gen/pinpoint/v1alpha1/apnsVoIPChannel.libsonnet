{
  ...
  '#':: d.pkg(name='apnsVoIPChannel', url='', help='"APNSVoIPChannel is the Schema for the APNSVoIPChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of APNSVoIPChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APNSVoIPChannelSpec defines the desired state of APNSVoIPChannel"'),
  spec: {
