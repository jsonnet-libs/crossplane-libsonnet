{
  ...
  '#':: d.pkg(name='apnsSandboxChannel', url='', help='"APNSSandboxChannel is the Schema for the APNSSandboxChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of APNSSandboxChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"APNSSandboxChannelSpec defines the desired state of APNSSandboxChannel"'),
  spec: {
