{
  ...
  '#':: d.pkg(name='emailChannel', url='', help='"EmailChannel is the Schema for the EmailChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of EmailChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EmailChannelSpec defines the desired state of EmailChannel"'),
  spec: {
    ...
    forProvider: {
      ...
      withConfigurationSet(configurationSet): { spec+: { forProvider+: { configurationSet: configurationSet } } },
      '#withEnabled':: d.fn(help='', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withFromAddress':: d.fn(help='', args=[d.arg(name='fromAddress', type=d.T.string)]),
      withFromAddress(fromAddress): { spec+: { forProvider+: { fromAddress: fromAddress } } },
      '#withIdentity':: d.fn(help='', args=[d.arg(name='identity', type=d.T.string)]),
