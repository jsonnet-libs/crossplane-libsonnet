{
  ...
  '#':: d.pkg(name='admChannel', url='', help='"ADMChannel is the Schema for the ADMChannels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ADMChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ADMChannelSpec defines the desired state of ADMChannel"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#clientIdSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      clientIdSecretRef: {
