{
  ...
  '#':: d.pkg(name='smsChannel', url='', help='"SMSChannel is the Schema for the SMSChannels API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSenderId':: d.fn(help='', args=[d.arg(name='senderId', type=d.T.string)]),
      withSenderId(senderId): { spec+: { forProvider+: { senderId: senderId } } },
      '#withShortCode':: d.fn(help='', args=[d.arg(name='shortCode', type=d.T.string)]),
