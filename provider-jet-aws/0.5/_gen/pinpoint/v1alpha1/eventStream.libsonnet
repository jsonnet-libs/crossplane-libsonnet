{
  ...
  '#':: d.pkg(name='eventStream', url='', help='"EventStream is the Schema for the EventStreams API"'),
  ...
  '#new':: d.fn(help='new returns an instance of EventStream', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EventStreamSpec defines the desired state of EventStream"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDestinationStreamArn':: d.fn(help='', args=[d.arg(name='destinationStreamArn', type=d.T.string)]),
      withDestinationStreamArn(destinationStreamArn): { spec+: { forProvider+: { destinationStreamArn: destinationStreamArn } } },
