{
  ...
  spec: {
    ...
    forProvider: {
      '#campaignHook':: d.obj(help=''),
      campaignHook: {
        '#withLambdaFunctionName':: d.fn(help='', args=[d.arg(name='lambdaFunctionName', type=d.T.string)]),
        ...
        '#withWebUrl':: d.fn(help='', args=[d.arg(name='webUrl', type=d.T.string)]),
        withWebUrl(webUrl): { webUrl: webUrl },
      },
      '#limits':: d.obj(help=''),
      limits: {
        '#withDaily':: d.fn(help='', args=[d.arg(name='daily', type=d.T.number)]),
        withDaily(daily): { daily: daily },
        '#withMaximumDuration':: d.fn(help='', args=[d.arg(name='maximumDuration', type=d.T.number)]),
        withMaximumDuration(maximumDuration): { maximumDuration: maximumDuration },
        '#withMessagesPerSecond':: d.fn(help='', args=[d.arg(name='messagesPerSecond', type=d.T.number)]),
        withMessagesPerSecond(messagesPerSecond): { messagesPerSecond: messagesPerSecond },
        '#withTotal':: d.fn(help='', args=[d.arg(name='total', type=d.T.number)]),
        withTotal(total): { total: total },
      },
      '#quietTime':: d.obj(help=''),
      quietTime: {
      ...
      '#withCampaignHook':: d.fn(help='', args=[d.arg(name='campaignHook', type=d.T.array)]),
      ...
      '#withLimits':: d.fn(help='', args=[d.arg(name='limits', type=d.T.array)]),
