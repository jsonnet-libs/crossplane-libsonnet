{
  ...
  '#':: d.pkg(name='definition', url='', help='"Definition is the Schema for the Definitions API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withLogGroupNames':: d.fn(help='', args=[d.arg(name='logGroupNames', type=d.T.array)]),
      ...
      '#withQueryString':: d.fn(help='', args=[d.arg(name='queryString', type=d.T.string)]),
