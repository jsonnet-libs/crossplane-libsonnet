{
  ...
  '#':: d.pkg(name='metricFilter', url='', help='"MetricFilter is the Schema for the MetricFilters API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#metricTransformation':: d.obj(help=''),
      ...
      '#withMetricTransformation':: d.fn(help='', args=[d.arg(name='metricTransformation', type=d.T.array)]),
