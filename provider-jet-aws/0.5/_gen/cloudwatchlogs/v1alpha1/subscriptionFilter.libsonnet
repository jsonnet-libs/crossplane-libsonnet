{
  ...
  '#':: d.pkg(name='subscriptionFilter', url='', help='"SubscriptionFilter is the Schema for the SubscriptionFilters API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDistribution':: d.fn(help='', args=[d.arg(name='distribution', type=d.T.string)]),
      withDistribution(distribution): { spec+: { forProvider+: { distribution: distribution } } },
      '#withFilterPattern':: d.fn(help='', args=[d.arg(name='filterPattern', type=d.T.string)]),
