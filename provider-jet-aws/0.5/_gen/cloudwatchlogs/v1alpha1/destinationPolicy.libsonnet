{
  ...
  '#':: d.pkg(name='destinationPolicy', url='', help='"DestinationPolicy is the Schema for the DestinationPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAccessPolicy':: d.fn(help='', args=[d.arg(name='accessPolicy', type=d.T.string)]),
      withAccessPolicy(accessPolicy): { spec+: { forProvider+: { accessPolicy: accessPolicy } } },
      '#withDestinationName':: d.fn(help='', args=[d.arg(name='destinationName', type=d.T.string)]),
      withDestinationName(destinationName): { spec+: { forProvider+: { destinationName: destinationName } } },
