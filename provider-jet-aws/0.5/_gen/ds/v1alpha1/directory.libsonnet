  ...
  spec: {
    ...
    forProvider: {
      ...
      connectSettings: {
        ...
        '#withCustomerUsername':: d.fn(help='', args=[d.arg(name='customerUsername', type=d.T.string)]),
      ...
      '#withConnectSettings':: d.fn(help='', args=[d.arg(name='connectSettings', type=d.T.array)]),
      ...
      '#withEdition':: d.fn(help='', args=[d.arg(name='edition', type=d.T.string)]),
      withEdition(edition): { spec+: { forProvider+: { edition: edition } } },
      '#withEnableSso':: d.fn(help='', args=[d.arg(name='enableSso', type=d.T.boolean)]),
