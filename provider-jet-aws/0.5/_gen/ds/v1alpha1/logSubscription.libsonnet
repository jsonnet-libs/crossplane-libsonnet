{
  ...
  '#':: d.pkg(name='logSubscription', url='', help='"LogSubscription is the Schema for the LogSubscriptions API"'),
  ...
  '#new':: d.fn(help='new returns an instance of LogSubscription', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LogSubscriptionSpec defines the desired state of LogSubscription"'),
  spec: {
