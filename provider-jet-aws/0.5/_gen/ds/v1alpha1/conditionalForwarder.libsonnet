{
  ...
  '#':: d.pkg(name='conditionalForwarder', url='', help='"ConditionalForwarder is the Schema for the ConditionalForwarders API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRemoteDomainName':: d.fn(help='', args=[d.arg(name='remoteDomainName', type=d.T.string)]),
