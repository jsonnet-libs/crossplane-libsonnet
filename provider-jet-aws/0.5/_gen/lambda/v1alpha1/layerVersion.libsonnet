{
  ...
  '#':: d.pkg(name='layerVersion', url='', help='"LayerVersion is the Schema for the LayerVersions API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCompatibleRuntimes':: d.fn(help='', args=[d.arg(name='compatibleRuntimes', type=d.T.array)]),
      ...
      '#withLayerName':: d.fn(help='', args=[d.arg(name='layerName', type=d.T.string)]),
      withLayerName(layerName): { spec+: { forProvider+: { layerName: layerName } } },
      '#withLicenseInfo':: d.fn(help='', args=[d.arg(name='licenseInfo', type=d.T.string)]),
