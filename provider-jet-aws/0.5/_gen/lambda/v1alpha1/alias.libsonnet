{
  ...
  '#':: d.pkg(name='alias', url='', help='"Alias is the Schema for the Aliass API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFunctionVersion':: d.fn(help='', args=[d.arg(name='functionVersion', type=d.T.string)]),
      ...
      '#withRoutingConfig':: d.fn(help='', args=[d.arg(name='routingConfig', type=d.T.array)]),
