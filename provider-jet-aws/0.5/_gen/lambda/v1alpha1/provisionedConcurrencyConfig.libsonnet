{
  ...
  '#':: d.pkg(name='provisionedConcurrencyConfig', url='', help='"ProvisionedConcurrencyConfig is the Schema for the ProvisionedConcurrencyConfigs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withProvisionedConcurrentExecutions':: d.fn(help='', args=[d.arg(name='provisionedConcurrentExecutions', type=d.T.number)]),
