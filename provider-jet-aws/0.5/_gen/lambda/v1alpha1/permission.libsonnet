{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventSourceToken':: d.fn(help='', args=[d.arg(name='eventSourceToken', type=d.T.string)]),
      ...
      '#withSourceAccount':: d.fn(help='', args=[d.arg(name='sourceAccount', type=d.T.string)]),
      ...
      '#withStatementId':: d.fn(help='', args=[d.arg(name='statementId', type=d.T.string)]),
      withStatementId(statementId): { spec+: { forProvider+: { statementId: statementId } } },
      '#withStatementIdPrefix':: d.fn(help='', args=[d.arg(name='statementIdPrefix', type=d.T.string)]),
