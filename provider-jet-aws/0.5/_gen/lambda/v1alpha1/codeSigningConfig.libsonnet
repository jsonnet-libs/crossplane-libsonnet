{
  ...
  '#':: d.pkg(name='codeSigningConfig', url='', help='"CodeSigningConfig is the Schema for the CodeSigningConfigs API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#allowedPublishers':: d.obj(help=''),
      allowedPublishers: {
        '#withSigningProfileVersionArns':: d.fn(help='', args=[d.arg(name='signingProfileVersionArns', type=d.T.array)]),
      ...
      '#policies':: d.obj(help=''),
      policies: {
        '#withUntrustedArtifactOnDeployment':: d.fn(help='', args=[d.arg(name='untrustedArtifactOnDeployment', type=d.T.string)]),
      ...
      '#withAllowedPublishers':: d.fn(help='', args=[d.arg(name='allowedPublishers', type=d.T.array)]),
