{
  ...
  spec: {
    ...
    forProvider: {
      '#withComputeEnvironments':: d.fn(help='', args=[d.arg(name='computeEnvironments', type=d.T.array)]),
      withComputeEnvironments(computeEnvironments): { spec+: { forProvider+: { computeEnvironments: if std.isArray(v=computeEnvironments) then computeEnvironments else [computeEnvironments] } } },
      '#withComputeEnvironmentsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='computeEnvironments', type=d.T.array)]),
      withComputeEnvironmentsMixin(computeEnvironments): { spec+: { forProvider+: { computeEnvironments+: if std.isArray(v=computeEnvironments) then computeEnvironments else [computeEnvironments] } } },
