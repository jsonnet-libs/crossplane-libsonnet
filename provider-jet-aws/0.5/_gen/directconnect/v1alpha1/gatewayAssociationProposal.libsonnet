{
  ...
  '#':: d.pkg(name='gatewayAssociationProposal', url='', help='"GatewayAssociationProposal is the Schema for the GatewayAssociationProposals API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDxGatewayOwnerAccountId':: d.fn(help='', args=[d.arg(name='dxGatewayOwnerAccountId', type=d.T.string)]),
