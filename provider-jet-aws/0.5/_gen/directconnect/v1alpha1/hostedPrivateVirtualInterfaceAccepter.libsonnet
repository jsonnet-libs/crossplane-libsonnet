{
  ...
  '#':: d.pkg(name='hostedPrivateVirtualInterfaceAccepter', url='', help='"HostedPrivateVirtualInterfaceAccepter is the Schema for the HostedPrivateVirtualInterfaceAccepters API"'),
