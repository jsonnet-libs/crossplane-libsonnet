{
  ...
  '#':: d.pkg(name='privateVirtualInterface', url='', help='"PrivateVirtualInterface is the Schema for the PrivateVirtualInterfaces API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAddressFamily':: d.fn(help='', args=[d.arg(name='addressFamily', type=d.T.string)]),
      withAddressFamily(addressFamily): { spec+: { forProvider+: { addressFamily: addressFamily } } },
      '#withAmazonAddress':: d.fn(help='', args=[d.arg(name='amazonAddress', type=d.T.string)]),
      withAmazonAddress(amazonAddress): { spec+: { forProvider+: { amazonAddress: amazonAddress } } },
      '#withBgpAsn':: d.fn(help='', args=[d.arg(name='bgpAsn', type=d.T.number)]),
      withBgpAsn(bgpAsn): { spec+: { forProvider+: { bgpAsn: bgpAsn } } },
      '#withBgpAuthKey':: d.fn(help='', args=[d.arg(name='bgpAuthKey', type=d.T.string)]),
      ...
      '#withCustomerAddress':: d.fn(help='', args=[d.arg(name='customerAddress', type=d.T.string)]),
      withCustomerAddress(customerAddress): { spec+: { forProvider+: { customerAddress: customerAddress } } },
      '#withDxGatewayId':: d.fn(help='', args=[d.arg(name='dxGatewayId', type=d.T.string)]),
      withDxGatewayId(dxGatewayId): { spec+: { forProvider+: { dxGatewayId: dxGatewayId } } },
      '#withMtu':: d.fn(help='', args=[d.arg(name='mtu', type=d.T.number)]),
      ...
      '#withVlan':: d.fn(help='', args=[d.arg(name='vlan', type=d.T.number)]),
