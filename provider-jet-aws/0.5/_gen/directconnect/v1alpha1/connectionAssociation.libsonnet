{
  ...
  '#':: d.pkg(name='connectionAssociation', url='', help='"ConnectionAssociation is the Schema for the ConnectionAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLagId':: d.fn(help='', args=[d.arg(name='lagId', type=d.T.string)]),
