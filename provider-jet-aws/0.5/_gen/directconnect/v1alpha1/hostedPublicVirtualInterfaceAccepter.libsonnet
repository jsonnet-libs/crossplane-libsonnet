{
  ...
  '#':: d.pkg(name='hostedPublicVirtualInterfaceAccepter', url='', help='"HostedPublicVirtualInterfaceAccepter is the Schema for the HostedPublicVirtualInterfaceAccepters API"'),
