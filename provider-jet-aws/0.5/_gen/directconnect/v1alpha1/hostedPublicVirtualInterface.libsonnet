{
  ...
  '#':: d.pkg(name='hostedPublicVirtualInterface', url='', help='"HostedPublicVirtualInterface is the Schema for the HostedPublicVirtualInterfaces API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOwnerAccountId':: d.fn(help='', args=[d.arg(name='ownerAccountId', type=d.T.string)]),
      ...
      '#withRouteFilterPrefixes':: d.fn(help='', args=[d.arg(name='routeFilterPrefixes', type=d.T.array)]),
