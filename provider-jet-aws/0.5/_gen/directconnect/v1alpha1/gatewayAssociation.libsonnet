{
  ...
  '#':: d.pkg(name='gatewayAssociation', url='', help='"GatewayAssociation is the Schema for the GatewayAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAllowedPrefixes':: d.fn(help='', args=[d.arg(name='allowedPrefixes', type=d.T.array)]),
      ...
      '#withAssociatedGatewayId':: d.fn(help='', args=[d.arg(name='associatedGatewayId', type=d.T.string)]),
      withAssociatedGatewayId(associatedGatewayId): { spec+: { forProvider+: { associatedGatewayId: associatedGatewayId } } },
      '#withAssociatedGatewayOwnerAccountId':: d.fn(help='', args=[d.arg(name='associatedGatewayOwnerAccountId', type=d.T.string)]),
      ...
      '#withProposalId':: d.fn(help='', args=[d.arg(name='proposalId', type=d.T.string)]),
