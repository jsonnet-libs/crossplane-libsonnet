{
  ...
  '#':: d.pkg(name='hostedTransitVirtualInterfaceAccepter', url='', help='"HostedTransitVirtualInterfaceAccepter is the Schema for the HostedTransitVirtualInterfaceAccepters API"'),
