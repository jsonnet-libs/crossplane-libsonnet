{
  ...
  '#':: d.pkg(name='bgpPeer', url='', help='"BGPPeer is the Schema for the BGPPeers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVirtualInterfaceId':: d.fn(help='', args=[d.arg(name='virtualInterfaceId', type=d.T.string)]),
