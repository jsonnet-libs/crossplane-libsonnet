{
  ...
  '#':: d.pkg(name='notebookInstanceLifecycleConfiguration', url='', help='"NotebookInstanceLifecycleConfiguration is the Schema for the NotebookInstanceLifecycleConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOnCreate':: d.fn(help='', args=[d.arg(name='onCreate', type=d.T.string)]),
      withOnCreate(onCreate): { spec+: { forProvider+: { onCreate: onCreate } } },
      '#withOnStart':: d.fn(help='', args=[d.arg(name='onStart', type=d.T.string)]),
