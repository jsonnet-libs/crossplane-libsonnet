{
  ...
  '#':: d.pkg(name='codeRepository', url='', help='"CodeRepository is the Schema for the CodeRepositorys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCodeRepositoryName':: d.fn(help='', args=[d.arg(name='codeRepositoryName', type=d.T.string)]),
      withCodeRepositoryName(codeRepositoryName): { spec+: { forProvider+: { codeRepositoryName: codeRepositoryName } } },
      '#withGitConfig':: d.fn(help='', args=[d.arg(name='gitConfig', type=d.T.array)]),
      withGitConfig(gitConfig): { spec+: { forProvider+: { gitConfig: if std.isArray(v=gitConfig) then gitConfig else [gitConfig] } } },
      '#withGitConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gitConfig', type=d.T.array)]),
