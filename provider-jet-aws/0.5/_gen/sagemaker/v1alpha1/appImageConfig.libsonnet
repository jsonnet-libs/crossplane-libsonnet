{
  ...
  '#':: d.pkg(name='appImageConfig', url='', help='"AppImageConfig is the Schema for the AppImageConfigs API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#kernelGatewayImageConfig':: d.obj(help=''),
      kernelGatewayImageConfig: {
        '#fileSystemConfig':: d.obj(help=''),
        fileSystemConfig: {
          '#withDefaultGid':: d.fn(help='', args=[d.arg(name='defaultGid', type=d.T.number)]),
          withDefaultGid(defaultGid): { defaultGid: defaultGid },
          '#withDefaultUid':: d.fn(help='', args=[d.arg(name='defaultUid', type=d.T.number)]),
      ...
      withAppImageConfigName(appImageConfigName): { spec+: { forProvider+: { appImageConfigName: appImageConfigName } } },
      '#withKernelGatewayImageConfig':: d.fn(help='', args=[d.arg(name='kernelGatewayImageConfig', type=d.T.array)]),
