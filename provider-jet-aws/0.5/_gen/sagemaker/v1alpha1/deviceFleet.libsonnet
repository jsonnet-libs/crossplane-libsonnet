{
  ...
  '#':: d.pkg(name='deviceFleet', url='', help='"DeviceFleet is the Schema for the DeviceFleets API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#outputConfig':: d.obj(help=''),
      outputConfig: {
        '#withKmsKeyId':: d.fn(help='', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
        withKmsKeyId(kmsKeyId): { kmsKeyId: kmsKeyId },
        '#withS3OutputLocation':: d.fn(help='', args=[d.arg(name='s3OutputLocation', type=d.T.string)]),
      ...
      '#withDeviceFleetName':: d.fn(help='', args=[d.arg(name='deviceFleetName', type=d.T.string)]),
      withDeviceFleetName(deviceFleetName): { spec+: { forProvider+: { deviceFleetName: deviceFleetName } } },
      '#withEnableIotRoleAlias':: d.fn(help='', args=[d.arg(name='enableIotRoleAlias', type=d.T.boolean)]),
      withEnableIotRoleAlias(enableIotRoleAlias): { spec+: { forProvider+: { enableIotRoleAlias: enableIotRoleAlias } } },
      '#withOutputConfig':: d.fn(help='', args=[d.arg(name='outputConfig', type=d.T.array)]),
