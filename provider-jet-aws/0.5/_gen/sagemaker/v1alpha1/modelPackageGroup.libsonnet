{
  ...
  '#':: d.pkg(name='modelPackageGroup', url='', help='"ModelPackageGroup is the Schema for the ModelPackageGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withModelPackageGroupDescription':: d.fn(help='', args=[d.arg(name='modelPackageGroupDescription', type=d.T.string)]),
      ...
      '#withModelPackageGroupName':: d.fn(help='', args=[d.arg(name='modelPackageGroupName', type=d.T.string)]),
