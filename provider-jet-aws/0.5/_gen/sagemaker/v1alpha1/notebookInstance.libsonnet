{
  ...
  '#':: d.pkg(name='notebookInstance', url='', help='"NotebookInstance is the Schema for the NotebookInstances API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAdditionalCodeRepositories':: d.fn(help='', args=[d.arg(name='additionalCodeRepositories', type=d.T.array)]),
      ...
      '#withDefaultCodeRepository':: d.fn(help='', args=[d.arg(name='defaultCodeRepository', type=d.T.string)]),
      withDefaultCodeRepository(defaultCodeRepository): { spec+: { forProvider+: { defaultCodeRepository: defaultCodeRepository } } },
      '#withDirectInternetAccess':: d.fn(help='', args=[d.arg(name='directInternetAccess', type=d.T.string)]),
      ...
      '#withLifecycleConfigName':: d.fn(help='', args=[d.arg(name='lifecycleConfigName', type=d.T.string)]),
      ...
      '#withRootAccess':: d.fn(help='', args=[d.arg(name='rootAccess', type=d.T.string)]),
