{
  ...
  '#':: d.pkg(name='workforce', url='', help='"Workforce is the Schema for the Workforces API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      oidcConfig: {
        ...
        '#withLogoutEndpoint':: d.fn(help='', args=[d.arg(name='logoutEndpoint', type=d.T.string)]),
      ...
      '#withSourceIpConfig':: d.fn(help='', args=[d.arg(name='sourceIpConfig', type=d.T.array)]),
