{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAppType':: d.fn(help='', args=[d.arg(name='appType', type=d.T.string)]),
      ...
      '#withResourceSpec':: d.fn(help='', args=[d.arg(name='resourceSpec', type=d.T.array)]),
