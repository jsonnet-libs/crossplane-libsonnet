{
  ...
  '#':: d.pkg(name='humanTaskUI', url='', help='"HumanTaskUI is the Schema for the HumanTaskUIs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of HumanTaskUI', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HumanTaskUISpec defines the desired state of HumanTaskUI"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#uiTemplate':: d.obj(help=''),
      uiTemplate: {
        '#withContent':: d.fn(help='', args=[d.arg(name='content', type=d.T.string)]),
        withContent(content): { content: content },
      },
      '#withHumanTaskUiName':: d.fn(help='', args=[d.arg(name='humanTaskUiName', type=d.T.string)]),
      withHumanTaskUiName(humanTaskUiName): { spec+: { forProvider+: { humanTaskUiName: humanTaskUiName } } },
      ...
      '#withUiTemplate':: d.fn(help='', args=[d.arg(name='uiTemplate', type=d.T.array)]),
      withUiTemplate(uiTemplate): { spec+: { forProvider+: { uiTemplate: if std.isArray(v=uiTemplate) then uiTemplate else [uiTemplate] } } },
      '#withUiTemplateMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='uiTemplate', type=d.T.array)]),
      withUiTemplateMixin(uiTemplate): { spec+: { forProvider+: { uiTemplate+: if std.isArray(v=uiTemplate) then uiTemplate else [uiTemplate] } } },
    },
