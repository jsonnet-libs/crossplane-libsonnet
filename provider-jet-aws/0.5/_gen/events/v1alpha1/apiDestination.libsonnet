{
  ...
  '#':: d.pkg(name='apiDestination', url='', help='"APIDestination is the Schema for the APIDestinations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInvocationEndpoint':: d.fn(help='', args=[d.arg(name='invocationEndpoint', type=d.T.string)]),
      withInvocationEndpoint(invocationEndpoint): { spec+: { forProvider+: { invocationEndpoint: invocationEndpoint } } },
      '#withInvocationRateLimitPerSecond':: d.fn(help='', args=[d.arg(name='invocationRateLimitPerSecond', type=d.T.number)]),
