{
  ...
  '#':: d.pkg(name='clusterEndpoint', url='', help='"ClusterEndpoint is the Schema for the ClusterEndpoints API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withExcludedMembers':: d.fn(help='', args=[d.arg(name='excludedMembers', type=d.T.array)]),
      ...
      '#withStaticMembers':: d.fn(help='', args=[d.arg(name='staticMembers', type=d.T.array)]),
