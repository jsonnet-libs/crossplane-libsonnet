{
  ...
  '#':: d.pkg(name='samplingRule', url='', help='"SamplingRule is the Schema for the SamplingRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFixedRate':: d.fn(help='', args=[d.arg(name='fixedRate', type=d.T.number)]),
      ...
      '#withReservoirSize':: d.fn(help='', args=[d.arg(name='reservoirSize', type=d.T.number)]),
      ...
      withRuleName(ruleName): { spec+: { forProvider+: { ruleName: ruleName } } },
      ...
      '#withUrlPath':: d.fn(help='', args=[d.arg(name='urlPath', type=d.T.string)]),
      withUrlPath(urlPath): { spec+: { forProvider+: { urlPath: urlPath } } },
      '#withVersion':: d.fn(help='', args=[d.arg(name='version', type=d.T.number)]),
