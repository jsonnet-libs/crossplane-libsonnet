{
  ...
  '#':: d.pkg(name='voiceConnector', url='', help='"VoiceConnector is the Schema for the VoiceConnectors API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRequireEncryption':: d.fn(help='', args=[d.arg(name='requireEncryption', type=d.T.boolean)]),
