{
  ...
  spec: {
    ...
    forProvider: {
      '#domainNameConfiguration':: d.obj(help=''),
      ...
      '#withDomainNameConfiguration':: d.fn(help='', args=[d.arg(name='domainNameConfiguration', type=d.T.array)]),
