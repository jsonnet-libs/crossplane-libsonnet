  ...
  spec: {
    ...
    forProvider: {
      ...
      corsConfiguration: {
        ...
        '#withMaxAge':: d.fn(help='', args=[d.arg(name='maxAge', type=d.T.number)]),
      ...
      '#withCorsConfiguration':: d.fn(help='', args=[d.arg(name='corsConfiguration', type=d.T.array)]),
      ...
      '#withFailOnWarnings':: d.fn(help='', args=[d.arg(name='failOnWarnings', type=d.T.boolean)]),
