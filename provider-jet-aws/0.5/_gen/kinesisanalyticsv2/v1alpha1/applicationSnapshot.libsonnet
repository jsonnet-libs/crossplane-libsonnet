{
  ...
  '#':: d.pkg(name='applicationSnapshot', url='', help='"ApplicationSnapshot is the Schema for the ApplicationSnapshots API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withApplicationName':: d.fn(help='', args=[d.arg(name='applicationName', type=d.T.string)]),
