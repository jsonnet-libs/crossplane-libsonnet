{
  ...
  '#':: d.pkg(name='signingProfile', url='', help='"SigningProfile is the Schema for the SigningProfiles API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#signatureValidityPeriod':: d.obj(help=''),
      ...
      '#withPlatformId':: d.fn(help='', args=[d.arg(name='platformId', type=d.T.string)]),
      ...
      '#withSignatureValidityPeriod':: d.fn(help='', args=[d.arg(name='signatureValidityPeriod', type=d.T.array)]),
