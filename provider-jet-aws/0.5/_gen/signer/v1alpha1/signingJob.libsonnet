{
  ...
  '#':: d.pkg(name='signingJob', url='', help='"SigningJob is the Schema for the SigningJobs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIgnoreSigningJobFailure':: d.fn(help='', args=[d.arg(name='ignoreSigningJobFailure', type=d.T.boolean)]),
      withIgnoreSigningJobFailure(ignoreSigningJobFailure): { spec+: { forProvider+: { ignoreSigningJobFailure: ignoreSigningJobFailure } } },
      '#withProfileName':: d.fn(help='', args=[d.arg(name='profileName', type=d.T.string)]),
