{
  ...
  '#':: d.pkg(name='signingProfilePermission', url='', help='"SigningProfilePermission is the Schema for the SigningProfilePermissions API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withProfileVersion':: d.fn(help='', args=[d.arg(name='profileVersion', type=d.T.string)]),
