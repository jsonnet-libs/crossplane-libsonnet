{
  ...
  '#':: d.pkg(name='canary', url='', help='"Canary is the Schema for the Canarys API"'),
  ...
  '#spec':: d.obj(help='"CanarySpec defines the desired state of Canary"'),
  spec: {
    ...
    forProvider: {
      ...
      '#runConfig':: d.obj(help=''),
      runConfig: {
        '#withActiveTracing':: d.fn(help='', args=[d.arg(name='activeTracing', type=d.T.boolean)]),
        withActiveTracing(activeTracing): { activeTracing: activeTracing },
        '#withMemoryInMb':: d.fn(help='', args=[d.arg(name='memoryInMb', type=d.T.number)]),
        withMemoryInMb(memoryInMb): { memoryInMb: memoryInMb },
      ...
      '#schedule':: d.obj(help=''),
      schedule: {
        '#withDurationInSeconds':: d.fn(help='', args=[d.arg(name='durationInSeconds', type=d.T.number)]),
        withDurationInSeconds(durationInSeconds): { durationInSeconds: durationInSeconds },
      ...
      '#withArtifactS3Location':: d.fn(help='', args=[d.arg(name='artifactS3Location', type=d.T.string)]),
      withArtifactS3Location(artifactS3Location): { spec+: { forProvider+: { artifactS3Location: artifactS3Location } } },
      ...
      '#withFailureRetentionPeriod':: d.fn(help='', args=[d.arg(name='failureRetentionPeriod', type=d.T.number)]),
      withFailureRetentionPeriod(failureRetentionPeriod): { spec+: { forProvider+: { failureRetentionPeriod: failureRetentionPeriod } } },
      ...
      '#withRunConfig':: d.fn(help='', args=[d.arg(name='runConfig', type=d.T.array)]),
      withRunConfig(runConfig): { spec+: { forProvider+: { runConfig: if std.isArray(v=runConfig) then runConfig else [runConfig] } } },
      '#withRunConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='runConfig', type=d.T.array)]),
      withRunConfigMixin(runConfig): { spec+: { forProvider+: { runConfig+: if std.isArray(v=runConfig) then runConfig else [runConfig] } } },
      '#withRuntimeVersion':: d.fn(help='', args=[d.arg(name='runtimeVersion', type=d.T.string)]),
      ...
      '#withS3Version':: d.fn(help='', args=[d.arg(name='s3Version', type=d.T.string)]),
      withS3Version(s3Version): { spec+: { forProvider+: { s3Version: s3Version } } },
      '#withSchedule':: d.fn(help='', args=[d.arg(name='schedule', type=d.T.array)]),
      withSchedule(schedule): { spec+: { forProvider+: { schedule: if std.isArray(v=schedule) then schedule else [schedule] } } },
      '#withScheduleMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schedule', type=d.T.array)]),
      withScheduleMixin(schedule): { spec+: { forProvider+: { schedule+: if std.isArray(v=schedule) then schedule else [schedule] } } },
      '#withStartCanary':: d.fn(help='', args=[d.arg(name='startCanary', type=d.T.boolean)]),
      withStartCanary(startCanary): { spec+: { forProvider+: { startCanary: startCanary } } },
      '#withSuccessRetentionPeriod':: d.fn(help='', args=[d.arg(name='successRetentionPeriod', type=d.T.number)]),
      withSuccessRetentionPeriod(successRetentionPeriod): { spec+: { forProvider+: { successRetentionPeriod: successRetentionPeriod } } },
      ...
      '#withZipFile':: d.fn(help='', args=[d.arg(name='zipFile', type=d.T.string)]),
