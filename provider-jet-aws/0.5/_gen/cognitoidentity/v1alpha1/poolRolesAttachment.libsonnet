{
  ...
  '#':: d.pkg(name='poolRolesAttachment', url='', help='"PoolRolesAttachment is the Schema for the PoolRolesAttachments API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#roleMapping':: d.obj(help=''),
      roleMapping: {
        '#mappingRule':: d.obj(help=''),
        mappingRule: {
          '#withClaim':: d.fn(help='', args=[d.arg(name='claim', type=d.T.string)]),
          withClaim(claim): { claim: claim },
          '#withMatchType':: d.fn(help='', args=[d.arg(name='matchType', type=d.T.string)]),
        ...
        '#withAmbiguousRoleResolution':: d.fn(help='', args=[d.arg(name='ambiguousRoleResolution', type=d.T.string)]),
      ...
      '#withRoles':: d.fn(help='', args=[d.arg(name='roles', type=d.T.object)]),
