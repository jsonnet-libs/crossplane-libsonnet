{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRequestMappingTemplate':: d.fn(help='', args=[d.arg(name='requestMappingTemplate', type=d.T.string)]),
      withRequestMappingTemplate(requestMappingTemplate): { spec+: { forProvider+: { requestMappingTemplate: requestMappingTemplate } } },
      '#withResponseMappingTemplate':: d.fn(help='', args=[d.arg(name='responseMappingTemplate', type=d.T.string)]),
