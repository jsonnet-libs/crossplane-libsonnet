{
  ...
  '#':: d.pkg(name='storedISCSIVolume', url='', help='"StoredISCSIVolume is the Schema for the StoredISCSIVolumes API"'),
  ...
  '#new':: d.fn(help='new returns an instance of StoredISCSIVolume', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"StoredISCSIVolumeSpec defines the desired state of StoredISCSIVolume"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDiskId':: d.fn(help='', args=[d.arg(name='diskId', type=d.T.string)]),
      ...
      '#withPreserveExistingData':: d.fn(help='', args=[d.arg(name='preserveExistingData', type=d.T.boolean)]),
      withPreserveExistingData(preserveExistingData): { spec+: { forProvider+: { preserveExistingData: preserveExistingData } } },
