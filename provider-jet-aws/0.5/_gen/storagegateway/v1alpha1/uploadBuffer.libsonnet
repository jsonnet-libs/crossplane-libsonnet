{
  ...
  '#':: d.pkg(name='uploadBuffer', url='', help='"UploadBuffer is the Schema for the UploadBuffers API"'),
  ...
  '#new':: d.fn(help='new returns an instance of UploadBuffer', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"UploadBufferSpec defines the desired state of UploadBuffer"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDiskId':: d.fn(help='', args=[d.arg(name='diskId', type=d.T.string)]),
      withDiskId(diskId): { spec+: { forProvider+: { diskId: diskId } } },
      '#withDiskPath':: d.fn(help='', args=[d.arg(name='diskPath', type=d.T.string)]),
