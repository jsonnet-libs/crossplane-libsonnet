{
  ...
  '#':: d.pkg(name='cache', url='', help='"Cache is the Schema for the Caches API"'),
  ...
  '#new':: d.fn(help='new returns an instance of Cache', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CacheSpec defines the desired state of Cache"'),
  spec: {
