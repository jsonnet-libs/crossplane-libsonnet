{
  ...
  '#':: d.pkg(name='tapePool', url='', help='"TapePool is the Schema for the TapePools API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TapePool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TapePoolSpec defines the desired state of TapePool"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withPoolName':: d.fn(help='', args=[d.arg(name='poolName', type=d.T.string)]),
      ...
      '#withRetentionLockTimeInDays':: d.fn(help='', args=[d.arg(name='retentionLockTimeInDays', type=d.T.number)]),
      withRetentionLockTimeInDays(retentionLockTimeInDays): { spec+: { forProvider+: { retentionLockTimeInDays: retentionLockTimeInDays } } },
      '#withRetentionLockType':: d.fn(help='', args=[d.arg(name='retentionLockType', type=d.T.string)]),
      withRetentionLockType(retentionLockType): { spec+: { forProvider+: { retentionLockType: retentionLockType } } },
