{
  ...
  '#':: d.pkg(name='fileSystemAssociation', url='', help='"FileSystemAssociation is the Schema for the FileSystemAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FileSystemAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FileSystemAssociationSpec defines the desired state of FileSystemAssociation"'),
  spec: {
