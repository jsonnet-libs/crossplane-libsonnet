{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiKeySource':: d.fn(help='', args=[d.arg(name='apiKeySource', type=d.T.string)]),
      withApiKeySource(apiKeySource): { spec+: { forProvider+: { apiKeySource: apiKeySource } } },
      '#withBinaryMediaTypes':: d.fn(help='', args=[d.arg(name='binaryMediaTypes', type=d.T.array)]),
      ...
      '#withMinimumCompressionSize':: d.fn(help='', args=[d.arg(name='minimumCompressionSize', type=d.T.number)]),
