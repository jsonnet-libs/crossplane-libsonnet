{
  ...
  spec: {
    ...
    forProvider: {
      '#withAuthorizerCredentials':: d.fn(help='', args=[d.arg(name='authorizerCredentials', type=d.T.string)]),
      ...
      '#withIdentitySource':: d.fn(help='', args=[d.arg(name='identitySource', type=d.T.string)]),
      ...
      '#withProviderArns':: d.fn(help='', args=[d.arg(name='providerArns', type=d.T.array)]),
