{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withValidateRequestBody':: d.fn(help='', args=[d.arg(name='validateRequestBody', type=d.T.boolean)]),
      withValidateRequestBody(validateRequestBody): { spec+: { forProvider+: { validateRequestBody: validateRequestBody } } },
      '#withValidateRequestParameters':: d.fn(help='', args=[d.arg(name='validateRequestParameters', type=d.T.boolean)]),
