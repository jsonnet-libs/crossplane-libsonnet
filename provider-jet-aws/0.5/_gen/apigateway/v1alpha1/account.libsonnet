{
  ...
  '#':: d.pkg(name='account', url='', help='"Account is the Schema for the Accounts API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#cloudwatchRoleArnRef':: d.obj(help='"A Reference to a named object."'),
      cloudwatchRoleArnRef: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { cloudwatchRoleArnRef+: { name: name } } } },
      },
      '#cloudwatchRoleArnSelector':: d.obj(help='"A Selector selects an object."'),
      ...
      '#withCloudwatchRoleArn':: d.fn(help='', args=[d.arg(name='cloudwatchRoleArn', type=d.T.string)]),
