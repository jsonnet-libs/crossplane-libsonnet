{
  ...
  '#':: d.pkg(name='gameSessionQueue', url='', help='"GameSessionQueue is the Schema for the GameSessionQueues API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#playerLatencyPolicy':: d.obj(help=''),
      playerLatencyPolicy: {
        '#withMaximumIndividualPlayerLatencyMilliseconds':: d.fn(help='', args=[d.arg(name='maximumIndividualPlayerLatencyMilliseconds', type=d.T.number)]),
        ...
        '#withPolicyDurationSeconds':: d.fn(help='', args=[d.arg(name='policyDurationSeconds', type=d.T.number)]),
      ...
      '#withPlayerLatencyPolicy':: d.fn(help='', args=[d.arg(name='playerLatencyPolicy', type=d.T.array)]),
