{
  ...
  spec: {
    ...
    forProvider: {
      '#routingStrategy':: d.obj(help=''),
      routingStrategy: {
        '#withFleetId':: d.fn(help='', args=[d.arg(name='fleetId', type=d.T.string)]),
      ...
      '#withRoutingStrategy':: d.fn(help='', args=[d.arg(name='routingStrategy', type=d.T.array)]),
