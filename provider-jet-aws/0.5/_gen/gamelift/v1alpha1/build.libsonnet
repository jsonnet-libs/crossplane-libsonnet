{
  ...
  '#':: d.pkg(name='build', url='', help='"Build is the Schema for the Builds API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStorageLocation':: d.fn(help='', args=[d.arg(name='storageLocation', type=d.T.array)]),
