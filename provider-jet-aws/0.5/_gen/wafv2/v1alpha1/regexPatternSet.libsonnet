{
  ...
  '#':: d.pkg(name='regexPatternSet', url='', help='"RegexPatternSet is the Schema for the RegexPatternSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#regularExpression':: d.obj(help=''),
      regularExpression: {
        '#withRegexString':: d.fn(help='', args=[d.arg(name='regexString', type=d.T.string)]),
      ...
      '#withRegularExpression':: d.fn(help='', args=[d.arg(name='regularExpression', type=d.T.array)]),
