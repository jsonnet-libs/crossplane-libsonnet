{
  ...
  '#':: d.pkg(name='webACLAssociation', url='', help='"WebACLAssociation is the Schema for the WebACLAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withWebAclArn':: d.fn(help='', args=[d.arg(name='webAclArn', type=d.T.string)]),
