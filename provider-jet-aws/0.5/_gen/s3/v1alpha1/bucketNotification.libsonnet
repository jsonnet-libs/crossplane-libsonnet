{
  ...
  '#':: d.pkg(name='bucketNotification', url='', help='"BucketNotification is the Schema for the BucketNotifications API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      lambdaFunction: {
        ...
        '#withFilterPrefix':: d.fn(help='', args=[d.arg(name='filterPrefix', type=d.T.string)]),
        withFilterPrefix(filterPrefix): { filterPrefix: filterPrefix },
        '#withFilterSuffix':: d.fn(help='', args=[d.arg(name='filterSuffix', type=d.T.string)]),
      ...
      '#withLambdaFunction':: d.fn(help='', args=[d.arg(name='lambdaFunction', type=d.T.array)]),
