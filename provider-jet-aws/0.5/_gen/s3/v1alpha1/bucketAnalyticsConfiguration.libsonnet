{
  ...
  '#':: d.pkg(name='bucketAnalyticsConfiguration', url='', help='"BucketAnalyticsConfiguration is the Schema for the BucketAnalyticsConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#storageClassAnalysis':: d.obj(help=''),
      storageClassAnalysis: {
        '#dataExport':: d.obj(help=''),
        dataExport: {
          '#destination':: d.obj(help=''),
          destination: {
            '#s3BucketDestination':: d.obj(help=''),
            s3BucketDestination: {
            ...
            '#withS3BucketDestination':: d.fn(help='', args=[d.arg(name='s3BucketDestination', type=d.T.array)]),
      ...
      '#withStorageClassAnalysis':: d.fn(help='', args=[d.arg(name='storageClassAnalysis', type=d.T.array)]),
