{
  ...
  '#':: d.pkg(name='portfolioShare', url='', help='"PortfolioShare is the Schema for the PortfolioShares API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPortfolioId':: d.fn(help='', args=[d.arg(name='portfolioId', type=d.T.string)]),
      ...
      '#withShareTagOptions':: d.fn(help='', args=[d.arg(name='shareTagOptions', type=d.T.boolean)]),
      ...
      '#withWaitForAcceptance':: d.fn(help='', args=[d.arg(name='waitForAcceptance', type=d.T.boolean)]),
