{
  ...
  '#':: d.pkg(name='organizationsAccess', url='', help='"OrganizationsAccess is the Schema for the OrganizationsAccesss API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationsAccess', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationsAccessSpec defines the desired state of OrganizationsAccess"'),
  spec: {
