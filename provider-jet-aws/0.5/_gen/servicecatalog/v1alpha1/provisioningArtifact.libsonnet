{
  ...
  '#':: d.pkg(name='provisioningArtifact', url='', help='"ProvisioningArtifact is the Schema for the ProvisioningArtifacts API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withGuidance':: d.fn(help='', args=[d.arg(name='guidance', type=d.T.string)]),
