{
  ...
  '#':: d.pkg(name='productPortfolioAssociation', url='', help='"ProductPortfolioAssociation is the Schema for the ProductPortfolioAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSourcePortfolioId':: d.fn(help='', args=[d.arg(name='sourcePortfolioId', type=d.T.string)]),
