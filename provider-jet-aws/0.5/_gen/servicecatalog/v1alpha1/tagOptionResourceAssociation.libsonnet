{
  ...
  '#':: d.pkg(name='tagOptionResourceAssociation', url='', help='"TagOptionResourceAssociation is the Schema for the TagOptionResourceAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTagOptionId':: d.fn(help='', args=[d.arg(name='tagOptionId', type=d.T.string)]),
