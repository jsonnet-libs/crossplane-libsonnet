{
  ...
  '#':: d.pkg(name='serviceAction', url='', help='"ServiceAction is the Schema for the ServiceActions API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      definition: {
        '#withAssumeRole':: d.fn(help='', args=[d.arg(name='assumeRole', type=d.T.string)]),
