{
  ...
  '#':: d.pkg(name='lustreFileSystem', url='', help='"LustreFileSystem is the Schema for the LustreFileSystems API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoImportPolicy':: d.fn(help='', args=[d.arg(name='autoImportPolicy', type=d.T.string)]),
      ...
      '#withDataCompressionType':: d.fn(help='', args=[d.arg(name='dataCompressionType', type=d.T.string)]),
      ...
      '#withDriveCacheType':: d.fn(help='', args=[d.arg(name='driveCacheType', type=d.T.string)]),
      withDriveCacheType(driveCacheType): { spec+: { forProvider+: { driveCacheType: driveCacheType } } },
      '#withExportPath':: d.fn(help='', args=[d.arg(name='exportPath', type=d.T.string)]),
      withExportPath(exportPath): { spec+: { forProvider+: { exportPath: exportPath } } },
      '#withImportPath':: d.fn(help='', args=[d.arg(name='importPath', type=d.T.string)]),
      withImportPath(importPath): { spec+: { forProvider+: { importPath: importPath } } },
      '#withImportedFileChunkSize':: d.fn(help='', args=[d.arg(name='importedFileChunkSize', type=d.T.number)]),
      ...
      '#withPerUnitStorageThroughput':: d.fn(help='', args=[d.arg(name='perUnitStorageThroughput', type=d.T.number)]),
