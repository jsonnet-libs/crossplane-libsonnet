{
  ...
  '#':: d.pkg(name='domainMailFrom', url='', help='"DomainMailFrom is the Schema for the DomainMailFroms API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBehaviorOnMxFailure':: d.fn(help='', args=[d.arg(name='behaviorOnMxFailure', type=d.T.string)]),
      ...
      '#withMailFromDomain':: d.fn(help='', args=[d.arg(name='mailFromDomain', type=d.T.string)]),
