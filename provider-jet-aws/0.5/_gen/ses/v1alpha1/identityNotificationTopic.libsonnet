{
  ...
  '#':: d.pkg(name='identityNotificationTopic', url='', help='"IdentityNotificationTopic is the Schema for the IdentityNotificationTopics API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIncludeOriginalHeaders':: d.fn(help='', args=[d.arg(name='includeOriginalHeaders', type=d.T.boolean)]),
