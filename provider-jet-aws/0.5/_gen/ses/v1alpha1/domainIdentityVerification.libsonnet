{
  ...
  '#':: d.pkg(name='domainIdentityVerification', url='', help='"DomainIdentityVerification is the Schema for the DomainIdentityVerifications API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DomainIdentityVerification', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DomainIdentityVerificationSpec defines the desired state of DomainIdentityVerification"'),
  spec: {
