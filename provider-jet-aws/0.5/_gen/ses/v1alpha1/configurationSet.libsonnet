{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReputationMetricsEnabled':: d.fn(help='', args=[d.arg(name='reputationMetricsEnabled', type=d.T.boolean)]),
      withReputationMetricsEnabled(reputationMetricsEnabled): { spec+: { forProvider+: { reputationMetricsEnabled: reputationMetricsEnabled } } },
      '#withSendingEnabled':: d.fn(help='', args=[d.arg(name='sendingEnabled', type=d.T.boolean)]),
