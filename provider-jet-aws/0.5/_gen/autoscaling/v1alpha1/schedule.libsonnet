{
  ...
  '#':: d.pkg(name='schedule', url='', help='"Schedule is the Schema for the Schedules API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withScheduledActionName':: d.fn(help='', args=[d.arg(name='scheduledActionName', type=d.T.string)]),
      withScheduledActionName(scheduledActionName): { spec+: { forProvider+: { scheduledActionName: scheduledActionName } } },
