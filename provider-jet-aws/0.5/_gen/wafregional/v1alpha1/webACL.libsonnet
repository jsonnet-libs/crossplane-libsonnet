{
  ...
  '#':: d.pkg(name='webACL', url='', help='"WebACL is the Schema for the WebACLs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#loggingConfiguration':: d.obj(help=''),
      loggingConfiguration: {
        '#redactedFields':: d.obj(help=''),
        redactedFields: {
      ...
      rule: {
        ...
        '#withRuleId':: d.fn(help='', args=[d.arg(name='ruleId', type=d.T.string)]),
      ...
      '#withLoggingConfiguration':: d.fn(help='', args=[d.arg(name='loggingConfiguration', type=d.T.array)]),
