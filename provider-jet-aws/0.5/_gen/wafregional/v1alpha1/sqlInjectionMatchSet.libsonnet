{
  ...
  spec: {
    ...
    forProvider: {
      '#sqlInjectionMatchTuple':: d.obj(help=''),
      ...
      '#withSqlInjectionMatchTuple':: d.fn(help='', args=[d.arg(name='sqlInjectionMatchTuple', type=d.T.array)]),
