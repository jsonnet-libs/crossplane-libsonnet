{
  ...
  '#':: d.pkg(name='regexMatchSet', url='', help='"RegexMatchSet is the Schema for the RegexMatchSets API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      regexMatchTuple: {
        ...
        '#withRegexPatternSetId':: d.fn(help='', args=[d.arg(name='regexPatternSetId', type=d.T.string)]),
      ...
      '#withRegexMatchTuple':: d.fn(help='', args=[d.arg(name='regexMatchTuple', type=d.T.array)]),
