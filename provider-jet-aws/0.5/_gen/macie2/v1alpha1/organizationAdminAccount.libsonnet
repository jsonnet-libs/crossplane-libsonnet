{
  ...
  '#':: d.pkg(name='organizationAdminAccount', url='', help='"OrganizationAdminAccount is the Schema for the OrganizationAdminAccounts API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationAdminAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationAdminAccountSpec defines the desired state of OrganizationAdminAccount"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAdminAccountId':: d.fn(help='', args=[d.arg(name='adminAccountId', type=d.T.string)]),
      withAdminAccountId(adminAccountId): { spec+: { forProvider+: { adminAccountId: adminAccountId } } },
