{
  ...
  '#':: d.pkg(name='invitationAccepter', url='', help='"InvitationAccepter is the Schema for the InvitationAccepters API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAdministratorAccountId':: d.fn(help='', args=[d.arg(name='administratorAccountId', type=d.T.string)]),
