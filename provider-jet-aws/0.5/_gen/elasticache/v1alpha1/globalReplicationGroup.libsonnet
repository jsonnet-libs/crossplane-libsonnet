{
  ...
  '#':: d.pkg(name='globalReplicationGroup', url='', help='"GlobalReplicationGroup is the Schema for the GlobalReplicationGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withGlobalReplicationGroupDescription':: d.fn(help='', args=[d.arg(name='globalReplicationGroupDescription', type=d.T.string)]),
      ...
      '#withGlobalReplicationGroupIdSuffix':: d.fn(help='', args=[d.arg(name='globalReplicationGroupIdSuffix', type=d.T.string)]),
      ...
      '#withPrimaryReplicationGroupId':: d.fn(help='', args=[d.arg(name='primaryReplicationGroupId', type=d.T.string)]),
