{
  ...
  '#':: d.pkg(name='userGroup', url='', help='"UserGroup is the Schema for the UserGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#userIdRefs':: d.obj(help=''),
      userIdRefs: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#userIdSelector':: d.obj(help='"A Selector selects an object."'),
      userIdSelector: {
