{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAccessString':: d.fn(help='', args=[d.arg(name='accessString', type=d.T.string)]),
      ...
      '#withNoPasswordRequired':: d.fn(help='', args=[d.arg(name='noPasswordRequired', type=d.T.boolean)]),
