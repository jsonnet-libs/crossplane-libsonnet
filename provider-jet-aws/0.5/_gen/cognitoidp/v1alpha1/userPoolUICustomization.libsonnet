{
  ...
  '#':: d.pkg(name='userPoolUICustomization', url='', help='"UserPoolUICustomization is the Schema for the UserPoolUICustomizations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCss':: d.fn(help='', args=[d.arg(name='css', type=d.T.string)]),
      withCss(css): { spec+: { forProvider+: { css: css } } },
      '#withImageFile':: d.fn(help='', args=[d.arg(name='imageFile', type=d.T.string)]),
