{
  ...
  spec: {
    ...
    forProvider: {
      ...
      configuration: {
        '#resultConfiguration':: d.obj(help=''),
        resultConfiguration: {
        ...
        '#withBytesScannedCutoffPerQuery':: d.fn(help='', args=[d.arg(name='bytesScannedCutoffPerQuery', type=d.T.number)]),
        ...
        '#withResultConfiguration':: d.fn(help='', args=[d.arg(name='resultConfiguration', type=d.T.array)]),
