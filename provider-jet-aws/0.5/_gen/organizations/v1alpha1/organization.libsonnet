{
  ...
  spec: {
    ...
    forProvider: {
      '#withAwsServiceAccessPrincipals':: d.fn(help='', args=[d.arg(name='awsServiceAccessPrincipals', type=d.T.array)]),
      ...
      '#withEnabledPolicyTypes':: d.fn(help='', args=[d.arg(name='enabledPolicyTypes', type=d.T.array)]),
      ...
      '#withFeatureSet':: d.fn(help='', args=[d.arg(name='featureSet', type=d.T.string)]),
