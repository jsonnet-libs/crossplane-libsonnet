{
  ...
  '#':: d.pkg(name='delegatedAdministrator', url='', help='"DelegatedAdministrator is the Schema for the DelegatedAdministrators API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withServicePrincipal':: d.fn(help='', args=[d.arg(name='servicePrincipal', type=d.T.string)]),
