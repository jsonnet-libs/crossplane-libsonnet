{
  ...
  '#':: d.pkg(name='firewallRuleGroup', url='', help='"FirewallRuleGroup is the Schema for the FirewallRuleGroups API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallRuleGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallRuleGroupSpec defines the desired state of FirewallRuleGroup"'),
  spec: {
