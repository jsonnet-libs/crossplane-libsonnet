{
  ...
  '#':: d.pkg(name='firewallConfig', url='', help='"FirewallConfig is the Schema for the FirewallConfigs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallConfigSpec defines the desired state of FirewallConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withFirewallFailOpen':: d.fn(help='', args=[d.arg(name='firewallFailOpen', type=d.T.string)]),
      withFirewallFailOpen(firewallFailOpen): { spec+: { forProvider+: { firewallFailOpen: firewallFailOpen } } },
