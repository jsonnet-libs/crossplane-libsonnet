{
  ...
  '#':: d.pkg(name='ruleAssociation', url='', help='"RuleAssociation is the Schema for the RuleAssociations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResolverRuleId':: d.fn(help='', args=[d.arg(name='resolverRuleId', type=d.T.string)]),
