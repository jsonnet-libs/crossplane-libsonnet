{
  ...
  '#':: d.pkg(name='queryLogConfig', url='', help='"QueryLogConfig is the Schema for the QueryLogConfigs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of QueryLogConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"QueryLogConfigSpec defines the desired state of QueryLogConfig"'),
  spec: {
