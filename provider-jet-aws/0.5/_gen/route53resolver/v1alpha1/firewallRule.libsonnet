{
  ...
  '#':: d.pkg(name='firewallRule', url='', help='"FirewallRule is the Schema for the FirewallRules API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBlockOverrideDnsType':: d.fn(help='', args=[d.arg(name='blockOverrideDnsType', type=d.T.string)]),
      withBlockOverrideDnsType(blockOverrideDnsType): { spec+: { forProvider+: { blockOverrideDnsType: blockOverrideDnsType } } },
      '#withBlockOverrideDomain':: d.fn(help='', args=[d.arg(name='blockOverrideDomain', type=d.T.string)]),
      withBlockOverrideDomain(blockOverrideDomain): { spec+: { forProvider+: { blockOverrideDomain: blockOverrideDomain } } },
      '#withBlockOverrideTtl':: d.fn(help='', args=[d.arg(name='blockOverrideTtl', type=d.T.number)]),
      withBlockOverrideTtl(blockOverrideTtl): { spec+: { forProvider+: { blockOverrideTtl: blockOverrideTtl } } },
      '#withBlockResponse':: d.fn(help='', args=[d.arg(name='blockResponse', type=d.T.string)]),
      withBlockResponse(blockResponse): { spec+: { forProvider+: { blockResponse: blockResponse } } },
      '#withFirewallDomainListId':: d.fn(help='', args=[d.arg(name='firewallDomainListId', type=d.T.string)]),
      withFirewallDomainListId(firewallDomainListId): { spec+: { forProvider+: { firewallDomainListId: firewallDomainListId } } },
      '#withFirewallRuleGroupId':: d.fn(help='', args=[d.arg(name='firewallRuleGroupId', type=d.T.string)]),
      withFirewallRuleGroupId(firewallRuleGroupId): { spec+: { forProvider+: { firewallRuleGroupId: firewallRuleGroupId } } },
