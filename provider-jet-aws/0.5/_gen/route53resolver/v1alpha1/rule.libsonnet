{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResolverEndpointId':: d.fn(help='', args=[d.arg(name='resolverEndpointId', type=d.T.string)]),
      withResolverEndpointId(resolverEndpointId): { spec+: { forProvider+: { resolverEndpointId: resolverEndpointId } } },
      '#withRuleType':: d.fn(help='', args=[d.arg(name='ruleType', type=d.T.string)]),
