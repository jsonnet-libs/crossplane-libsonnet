{
  ...
  '#':: d.pkg(name='queryLogConfigAssociation', url='', help='"QueryLogConfigAssociation is the Schema for the QueryLogConfigAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of QueryLogConfigAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"QueryLogConfigAssociationSpec defines the desired state of QueryLogConfigAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResolverQueryLogConfigId':: d.fn(help='', args=[d.arg(name='resolverQueryLogConfigId', type=d.T.string)]),
      withResolverQueryLogConfigId(resolverQueryLogConfigId): { spec+: { forProvider+: { resolverQueryLogConfigId: resolverQueryLogConfigId } } },
