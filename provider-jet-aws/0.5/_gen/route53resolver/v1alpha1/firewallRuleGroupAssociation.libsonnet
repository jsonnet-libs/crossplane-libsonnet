{
  ...
  '#':: d.pkg(name='firewallRuleGroupAssociation', url='', help='"FirewallRuleGroupAssociation is the Schema for the FirewallRuleGroupAssociations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallRuleGroupAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallRuleGroupAssociationSpec defines the desired state of FirewallRuleGroupAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withMutationProtection':: d.fn(help='', args=[d.arg(name='mutationProtection', type=d.T.string)]),
      withMutationProtection(mutationProtection): { spec+: { forProvider+: { mutationProtection: mutationProtection } } },
