{
  ...
  '#':: d.pkg(name='dnssecConfig', url='', help='"DNSSECConfig is the Schema for the DNSSECConfigs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSSECConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSSECConfigSpec defines the desired state of DNSSECConfig"'),
  spec: {
