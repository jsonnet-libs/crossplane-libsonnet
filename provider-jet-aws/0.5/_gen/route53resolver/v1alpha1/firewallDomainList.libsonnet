{
  ...
  '#':: d.pkg(name='firewallDomainList', url='', help='"FirewallDomainList is the Schema for the FirewallDomainLists API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallDomainList', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallDomainListSpec defines the desired state of FirewallDomainList"'),
  spec: {
