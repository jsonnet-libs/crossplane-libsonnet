{
  ...
  '#':: d.pkg(name='publishingDestination', url='', help='"PublishingDestination is the Schema for the PublishingDestinations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of PublishingDestination', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PublishingDestinationSpec defines the desired state of PublishingDestination"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDestinationType':: d.fn(help='', args=[d.arg(name='destinationType', type=d.T.string)]),
      withDestinationType(destinationType): { spec+: { forProvider+: { destinationType: destinationType } } },
