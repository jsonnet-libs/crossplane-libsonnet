{
  ...
  '#':: d.pkg(name='inviteAccepter', url='', help='"InviteAccepter is the Schema for the InviteAccepters API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMasterAccountId':: d.fn(help='', args=[d.arg(name='masterAccountId', type=d.T.string)]),
      withMasterAccountId(masterAccountId): { spec+: { forProvider+: { masterAccountId: masterAccountId } } },
