{
  ...
  '#':: d.pkg(name='threatintelset', url='', help='"Threatintelset is the Schema for the Threatintelsets API"'),
  ...
  '#new':: d.fn(help='new returns an instance of Threatintelset', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ThreatintelsetSpec defines the desired state of Threatintelset"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withActivate':: d.fn(help='', args=[d.arg(name='activate', type=d.T.boolean)]),
      withActivate(activate): { spec+: { forProvider+: { activate: activate } } },
