{
  ...
  '#':: d.pkg(name='detector', url='', help='"Detector is the Schema for the Detectors API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFindingPublishingFrequency':: d.fn(help='', args=[d.arg(name='findingPublishingFrequency', type=d.T.string)]),
