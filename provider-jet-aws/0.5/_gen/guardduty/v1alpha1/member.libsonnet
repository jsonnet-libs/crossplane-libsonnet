{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDisableEmailNotification':: d.fn(help='', args=[d.arg(name='disableEmailNotification', type=d.T.boolean)]),
      ...
      '#withInvitationMessage':: d.fn(help='', args=[d.arg(name='invitationMessage', type=d.T.string)]),
      withInvitationMessage(invitationMessage): { spec+: { forProvider+: { invitationMessage: invitationMessage } } },
      '#withInvite':: d.fn(help='', args=[d.arg(name='invite', type=d.T.boolean)]),
