{
  ...
  '#':: d.pkg(name='organizationConfiguration', url='', help='"OrganizationConfiguration is the Schema for the OrganizationConfigurations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationConfiguration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationConfigurationSpec defines the desired state of OrganizationConfiguration"'),
  spec: {
    ...
    forProvider: {
      ...
      datasources: {
        '#s3Logs':: d.obj(help=''),
        s3Logs: {
          '#withAutoEnable':: d.fn(help='', args=[d.arg(name='autoEnable', type=d.T.boolean)]),
          withAutoEnable(autoEnable): { autoEnable: autoEnable },
        },
      ...
      '#withAutoEnable':: d.fn(help='', args=[d.arg(name='autoEnable', type=d.T.boolean)]),
      withAutoEnable(autoEnable): { spec+: { forProvider+: { autoEnable: autoEnable } } },
