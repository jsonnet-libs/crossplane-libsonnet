{
  ...
  '#':: d.pkg(name='filter', url='', help='"Filter is the Schema for the Filters API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDetectorId':: d.fn(help='', args=[d.arg(name='detectorId', type=d.T.string)]),
      withDetectorId(detectorId): { spec+: { forProvider+: { detectorId: detectorId } } },
      '#withFindingCriteria':: d.fn(help='', args=[d.arg(name='findingCriteria', type=d.T.array)]),
      ...
      '#withRank':: d.fn(help='', args=[d.arg(name='rank', type=d.T.number)]),
