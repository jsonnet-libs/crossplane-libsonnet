{
  ...
  '#':: d.pkg(name='albListenerCertificate', url='', help='"ALBListenerCertificate is the Schema for the ALBListenerCertificates API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ALBListenerCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ALBListenerCertificateSpec defines the desired state of ALBListenerCertificate"'),
  spec: {
