{
  ...
  '#':: d.pkg(name='albTargetGroup', url='', help='"ALBTargetGroup is the Schema for the ALBTargetGroups API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ALBTargetGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ALBTargetGroupSpec defines the desired state of ALBTargetGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      healthCheck: {
        ...
        '#withMatcher':: d.fn(help='', args=[d.arg(name='matcher', type=d.T.string)]),
      ...
      stickiness: {
        '#withCookieDuration':: d.fn(help='', args=[d.arg(name='cookieDuration', type=d.T.number)]),
        withCookieDuration(cookieDuration): { cookieDuration: cookieDuration },
        '#withCookieName':: d.fn(help='', args=[d.arg(name='cookieName', type=d.T.string)]),
      ...
      '#withDeregistrationDelay':: d.fn(help='', args=[d.arg(name='deregistrationDelay', type=d.T.number)]),
      ...
      '#withLambdaMultiValueHeadersEnabled':: d.fn(help='', args=[d.arg(name='lambdaMultiValueHeadersEnabled', type=d.T.boolean)]),
      ...
      '#withLoadBalancingAlgorithmType':: d.fn(help='', args=[d.arg(name='loadBalancingAlgorithmType', type=d.T.string)]),
      ...
      '#withPreserveClientIp':: d.fn(help='', args=[d.arg(name='preserveClientIp', type=d.T.string)]),
      ...
      '#withProtocolVersion':: d.fn(help='', args=[d.arg(name='protocolVersion', type=d.T.string)]),
      withProtocolVersion(protocolVersion): { spec+: { forProvider+: { protocolVersion: protocolVersion } } },
      '#withProxyProtocolV2':: d.fn(help='', args=[d.arg(name='proxyProtocolV2', type=d.T.boolean)]),
      ...
      '#withSlowStart':: d.fn(help='', args=[d.arg(name='slowStart', type=d.T.number)]),
      ...
      '#withTargetType':: d.fn(help='', args=[d.arg(name='targetType', type=d.T.string)]),
