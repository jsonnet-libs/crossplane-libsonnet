{
  ...
  '#':: d.pkg(name='instanceGroup', url='', help='"InstanceGroup is the Schema for the InstanceGroups API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      withAutoscalingPolicy(autoscalingPolicy): { spec+: { forProvider+: { autoscalingPolicy: autoscalingPolicy } } },
      '#withBidPrice':: d.fn(help='', args=[d.arg(name='bidPrice', type=d.T.string)]),
      withBidPrice(bidPrice): { spec+: { forProvider+: { bidPrice: bidPrice } } },
      ...
      withEbsConfig(ebsConfig): { spec+: { forProvider+: { ebsConfig: if std.isArray(v=ebsConfig) then ebsConfig else [ebsConfig] } } },
      ...
      withEbsConfigMixin(ebsConfig): { spec+: { forProvider+: { ebsConfig+: if std.isArray(v=ebsConfig) then ebsConfig else [ebsConfig] } } },
