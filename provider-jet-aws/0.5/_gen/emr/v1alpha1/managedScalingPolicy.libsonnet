{
  ...
  '#':: d.pkg(name='managedScalingPolicy', url='', help='"ManagedScalingPolicy is the Schema for the ManagedScalingPolicys API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagedScalingPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagedScalingPolicySpec defines the desired state of ManagedScalingPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#computeLimits':: d.obj(help=''),
      computeLimits: {
        '#withMaximumCapacityUnits':: d.fn(help='', args=[d.arg(name='maximumCapacityUnits', type=d.T.number)]),
        withMaximumCapacityUnits(maximumCapacityUnits): { maximumCapacityUnits: maximumCapacityUnits },
        '#withMaximumCoreCapacityUnits':: d.fn(help='', args=[d.arg(name='maximumCoreCapacityUnits', type=d.T.number)]),
        withMaximumCoreCapacityUnits(maximumCoreCapacityUnits): { maximumCoreCapacityUnits: maximumCoreCapacityUnits },
        '#withMaximumOndemandCapacityUnits':: d.fn(help='', args=[d.arg(name='maximumOndemandCapacityUnits', type=d.T.number)]),
        withMaximumOndemandCapacityUnits(maximumOndemandCapacityUnits): { maximumOndemandCapacityUnits: maximumOndemandCapacityUnits },
        '#withMinimumCapacityUnits':: d.fn(help='', args=[d.arg(name='minimumCapacityUnits', type=d.T.number)]),
        withMinimumCapacityUnits(minimumCapacityUnits): { minimumCapacityUnits: minimumCapacityUnits },
        '#withUnitType':: d.fn(help='', args=[d.arg(name='unitType', type=d.T.string)]),
        withUnitType(unitType): { unitType: unitType },
      },
      ...
      '#withComputeLimits':: d.fn(help='', args=[d.arg(name='computeLimits', type=d.T.array)]),
      withComputeLimits(computeLimits): { spec+: { forProvider+: { computeLimits: if std.isArray(v=computeLimits) then computeLimits else [computeLimits] } } },
      '#withComputeLimitsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='computeLimits', type=d.T.array)]),
      withComputeLimitsMixin(computeLimits): { spec+: { forProvider+: { computeLimits+: if std.isArray(v=computeLimits) then computeLimits else [computeLimits] } } },
