{
  ...
  '#':: d.pkg(name='scheduledAction', url='', help='"ScheduledAction is the Schema for the ScheduledActions API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#scalableTargetAction':: d.obj(help=''),
      scalableTargetAction: {
        '#withMaxCapacity':: d.fn(help='', args=[d.arg(name='maxCapacity', type=d.T.string)]),
        withMaxCapacity(maxCapacity): { maxCapacity: maxCapacity },
        '#withMinCapacity':: d.fn(help='', args=[d.arg(name='minCapacity', type=d.T.string)]),
      ...
      '#withScalableTargetAction':: d.fn(help='', args=[d.arg(name='scalableTargetAction', type=d.T.array)]),
