{
  ...
  '#':: d.pkg(name='licenseConfiguration', url='', help='"LicenseConfiguration is the Schema for the LicenseConfigurations API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLicenseCount':: d.fn(help='', args=[d.arg(name='licenseCount', type=d.T.number)]),
      withLicenseCount(licenseCount): { spec+: { forProvider+: { licenseCount: licenseCount } } },
      '#withLicenseCountHardLimit':: d.fn(help='', args=[d.arg(name='licenseCountHardLimit', type=d.T.boolean)]),
      withLicenseCountHardLimit(licenseCountHardLimit): { spec+: { forProvider+: { licenseCountHardLimit: licenseCountHardLimit } } },
      '#withLicenseCountingType':: d.fn(help='', args=[d.arg(name='licenseCountingType', type=d.T.string)]),
      withLicenseCountingType(licenseCountingType): { spec+: { forProvider+: { licenseCountingType: licenseCountingType } } },
      '#withLicenseRules':: d.fn(help='', args=[d.arg(name='licenseRules', type=d.T.array)]),
