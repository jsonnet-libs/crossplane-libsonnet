{
  ...
  spec: {
    ...
    forProvider: {
      ...
      ldapServerMetadata: {
        '#serviceAccountPasswordSecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      ...
      '#logs':: d.obj(help=''),
      logs: {
        '#withAudit':: d.fn(help='', args=[d.arg(name='audit', type=d.T.string)]),
      ...
      '#withBrokerName':: d.fn(help='', args=[d.arg(name='brokerName', type=d.T.string)]),
      withBrokerName(brokerName): { spec+: { forProvider+: { brokerName: brokerName } } },
      '#withConfiguration':: d.fn(help='', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withEncryptionOptions':: d.fn(help='', args=[d.arg(name='encryptionOptions', type=d.T.array)]),
      ...
      '#withLdapServerMetadata':: d.fn(help='', args=[d.arg(name='ldapServerMetadata', type=d.T.array)]),
