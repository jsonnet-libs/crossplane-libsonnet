{
  ...
  '#':: d.pkg(name='repository', url='', help='"Repository is the Schema for the Repositorys API"'),
  ...
  spec: {
    ...
    forProvider: {
      '#externalConnections':: d.obj(help=''),
      externalConnections: {
        '#withExternalConnectionName':: d.fn(help='', args=[d.arg(name='externalConnectionName', type=d.T.string)]),
        withExternalConnectionName(externalConnectionName): { externalConnectionName: externalConnectionName },
      },
      '#upstream':: d.obj(help=''),
      upstream: {
        '#withRepositoryName':: d.fn(help='', args=[d.arg(name='repositoryName', type=d.T.string)]),
      ...
      '#withDomainOwner':: d.fn(help='', args=[d.arg(name='domainOwner', type=d.T.string)]),
      withDomainOwner(domainOwner): { spec+: { forProvider+: { domainOwner: domainOwner } } },
      '#withExternalConnections':: d.fn(help='', args=[d.arg(name='externalConnections', type=d.T.array)]),
      withExternalConnections(externalConnections): { spec+: { forProvider+: { externalConnections: if std.isArray(v=externalConnections) then externalConnections else [externalConnections] } } },
      '#withExternalConnectionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='externalConnections', type=d.T.array)]),
      withExternalConnectionsMixin(externalConnections): { spec+: { forProvider+: { externalConnections+: if std.isArray(v=externalConnections) then externalConnections else [externalConnections] } } },
