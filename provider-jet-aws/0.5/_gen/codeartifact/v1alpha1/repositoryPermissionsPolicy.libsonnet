{
  ...
  '#':: d.pkg(name='repositoryPermissionsPolicy', url='', help='"RepositoryPermissionsPolicy is the Schema for the RepositoryPermissionsPolicys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicyDocument':: d.fn(help='', args=[d.arg(name='policyDocument', type=d.T.string)]),
      withPolicyDocument(policyDocument): { spec+: { forProvider+: { policyDocument: policyDocument } } },
      '#withPolicyRevision':: d.fn(help='', args=[d.arg(name='policyRevision', type=d.T.string)]),
