{
  ...
  spec: {
    ...
    forProvider: {
      ...
      deliveryConfig: {
        '#withDeliveryRequirement':: d.fn(help='"When this subscription should send messages to subscribers relative to messages persistence in storage. Possible values are DELIVER_IMMEDIATELY, DELIVER_AFTER_STORED, and DELIVERY_REQUIREMENT_UNSPECIFIED."', args=[d.arg(name='deliveryRequirement', type=d.T.string)]),
