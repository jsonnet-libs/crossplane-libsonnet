{
  ...
  '#':: d.pkg(name='release', url='', help='"Release is the Schema for the Releases API. The Firebaserules Release resource"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRulesetName':: d.fn(help='"Name of the Ruleset referred to by this Release. The Ruleset must exist the Release to be created."', args=[d.arg(name='rulesetName', type=d.T.string)]),
