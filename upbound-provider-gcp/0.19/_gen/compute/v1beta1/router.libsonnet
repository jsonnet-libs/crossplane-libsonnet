  ...
  spec: {
    ...
    forProvider: {
      ...
      bgp: {
        ...
        '#withAdvertiseMode':: d.fn(help='"User-specified flag to indicate which mode to use for advertisement. Default value is DEFAULT. Possible values are DEFAULT and CUSTOM."', args=[d.arg(name='advertiseMode', type=d.T.string)]),
      ...
      '#withEncryptedInterconnectRouter':: d.fn(help='"Field to indicate if a router is dedicated to use with encrypted Interconnect Attachment (IPsec-encrypted Cloud Interconnect feature). Not currently available publicly."', args=[d.arg(name='encryptedInterconnectRouter', type=d.T.boolean)]),
