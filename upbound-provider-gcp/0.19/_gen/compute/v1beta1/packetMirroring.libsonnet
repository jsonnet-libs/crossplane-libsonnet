  ...
  spec: {
    ...
    forProvider: {
      ...
      filter: {
        ...
        '#withDirection':: d.fn(help='"Direction of traffic to mirror. Default value is BOTH. Possible values are INGRESS, EGRESS, and BOTH."', args=[d.arg(name='direction', type=d.T.string)]),
        withDirection(direction): { direction: direction },
        '#withIpProtocols':: d.fn(help='"Protocols that apply as a filter on mirrored traffic. Each value may be one of tcp, udp, and icmp."', args=[d.arg(name='ipProtocols', type=d.T.array)]),
        withIpProtocols(ipProtocols): { ipProtocols: if std.isArray(v=ipProtocols) then ipProtocols else [ipProtocols] },
        '#withIpProtocolsMixin':: d.fn(help='"Protocols that apply as a filter on mirrored traffic. Each value may be one of tcp, udp, and icmp."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipProtocols', type=d.T.array)]),
