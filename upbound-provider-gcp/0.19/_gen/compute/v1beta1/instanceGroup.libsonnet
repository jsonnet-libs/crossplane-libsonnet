{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstances':: d.fn(help='"List of instances in the group. They should be given as either self_link or id. When adding instances they must all be in the same network and zone as the instance group."', args=[d.arg(name='instances', type=d.T.array)]),
      withInstances(instances): { spec+: { forProvider+: { instances: if std.isArray(v=instances) then instances else [instances] } } },
      '#withInstancesMixin':: d.fn(help='"List of instances in the group. They should be given as either self_link or id. When adding instances they must all be in the same network and zone as the instance group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='instances', type=d.T.array)]),
