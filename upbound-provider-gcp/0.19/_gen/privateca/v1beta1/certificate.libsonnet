    ...
    forProvider: {
      ...
      config: {
        ...
        publicKey: {
          ...
          '#withFormat':: d.fn(help='"The format of the public key. Currently, only PEM format is supported. Possible values are KEY_TYPE_UNSPECIFIED and PEM."', args=[d.arg(name='format', type=d.T.string)]),
        ...
        x509Config: {
          '#additionalExtensions':: d.obj(help='"Describes custom X.509 extensions. Structure is documented below."'),
          additionalExtensions: {
            ...
            '#withCritical':: d.fn(help='"Required. Indicates whether or not this extension is critical (i.e., if the client does not know how to handle this extension, the client should consider this to be an error)."', args=[d.arg(name='critical', type=d.T.boolean)]),
            ...
            '#withValue':: d.fn(help='"The value of this X.509 extension."', args=[d.arg(name='value', type=d.T.string)]),
          ...
          '#withAdditionalExtensions':: d.fn(help='"Describes custom X.509 extensions. Structure is documented below."', args=[d.arg(name='additionalExtensions', type=d.T.array)]),
