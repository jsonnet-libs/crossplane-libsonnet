{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDetectMd5Hash':: d.fn(help='"(Computed) Base 64 MD5 hash of the uploaded data."', args=[d.arg(name='detectMd5Hash', type=d.T.string)]),
      withDetectMd5Hash(detectMd5Hash): { spec+: { forProvider+: { detectMd5Hash: detectMd5Hash } } },
      '#withEventBasedHold':: d.fn(help='', args=[d.arg(name='eventBasedHold', type=d.T.boolean)]),
      ...
      '#withTemporaryHold':: d.fn(help='', args=[d.arg(name='temporaryHold', type=d.T.boolean)]),
