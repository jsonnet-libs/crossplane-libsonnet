{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCertificates':: d.fn(help='"A set of Certificates defines for the given hostname.\\nThere can be defined up to fifteen certificates in each Certificate Map Entry.\\nEach certificate must match pattern projects//locations//certificates/*."', args=[d.arg(name='certificates', type=d.T.array)]),
