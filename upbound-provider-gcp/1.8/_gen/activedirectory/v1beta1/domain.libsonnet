{
  ...
  spec: {
    ...
    forProvider: {
      '#withAdmin':: d.fn(help='"The name of delegated administrator account used to perform Active Directory operations.\\nIf not specified, setupadmin will be used."', args=[d.arg(name='admin', type=d.T.string)]),
      ...
      '#withAuthorizedNetworksMixin':: d.fn(help='"The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks.\\nIf CIDR subnets overlap between networks, domain creation will fail."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authorizedNetworks', type=d.T.array)]),
      ...
      '#withDomainName':: d.fn(help='"The fully qualified domain name. e.g. mydomain.myorganization.com, with the restrictions\\nof https://cloud.google.com/managed-microsoft-ad/reference/rest/v1/projects.locations.global.domains."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withLabels':: d.fn(help='"Resource labels that can contain user-provided metadata\\nNote: This field is non-authoritative, and will only manage the labels present in your configuration.\\nPlease refer to the field effective_labels for all of the labels present on the resource."', args=[d.arg(name='labels', type=d.T.object)]),
      ...
      '#withLocations':: d.fn(help='"Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/]\\ne.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block."', args=[d.arg(name='locations', type=d.T.array)]),
      withLocations(locations): { spec+: { forProvider+: { locations: if std.isArray(v=locations) then locations else [locations] } } },
      '#withLocationsMixin':: d.fn(help='"Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/]\\ne.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='locations', type=d.T.array)]),
      ...
      '#withReservedIpRange':: d.fn(help='"The CIDR range of internal addresses that are reserved for this domain. Reserved networks must be /24 or larger.\\nRanges must be unique and non-overlapping with existing subnets in authorizedNetworks"', args=[d.arg(name='reservedIpRange', type=d.T.string)]),
