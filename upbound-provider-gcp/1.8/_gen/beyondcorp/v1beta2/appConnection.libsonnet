  ...
  spec: {
    ...
    forProvider: {
      ...
      applicationEndpoint: {
        ...
        withHost(host): { spec+: { forProvider+: { applicationEndpoint+: { host: host } } } },
        '#withPort':: d.fn(help='"Port of the remote application endpoint."', args=[d.arg(name='port', type=d.T.number)]),
        withPort(port): { spec+: { forProvider+: { applicationEndpoint+: { port: port } } } },
      },
      ...
      gateway: {
        ...
        appGatewayRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { spec+: { forProvider+: { gateway+: { appGatewayRef+: { policy+: { resolution: resolution } } } } } },
            ...
            withResolve(resolve): { spec+: { forProvider+: { gateway+: { appGatewayRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { forProvider+: { gateway+: { appGatewayRef+: { name: name } } } } },
        },
        ...
        appGatewaySelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { forProvider+: { gateway+: { appGatewaySelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { forProvider+: { gateway+: { appGatewaySelector+: { policy+: { resolve: resolve } } } } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { gateway+: { appGatewaySelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { forProvider+: { gateway+: { appGatewaySelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { gateway+: { appGatewaySelector+: { matchLabels+: matchLabels } } } } },
        },
        ...
        withAppGateway(appGateway): { spec+: { forProvider+: { gateway+: { appGateway: appGateway } } } },
        ...
        withType(type): { spec+: { forProvider+: { gateway+: { type: type } } } },
      },
    ...
    initProvider: {
      ...
      applicationEndpoint: {
        '#withHost':: d.fn(help='"Hostname or IP address of the remote application endpoint."', args=[d.arg(name='host', type=d.T.string)]),
        withHost(host): { spec+: { initProvider+: { applicationEndpoint+: { host: host } } } },
        '#withPort':: d.fn(help='"Port of the remote application endpoint."', args=[d.arg(name='port', type=d.T.number)]),
        withPort(port): { spec+: { initProvider+: { applicationEndpoint+: { port: port } } } },
      },
      '#gateway':: d.obj(help='"Gateway used by the AppConnection.\\nStructure is documented below."'),
      gateway: {
        '#appGatewayRef':: d.obj(help='"Reference to a AppGateway in beyondcorp to populate appGateway."'),
        appGatewayRef: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { gateway+: { appGatewayRef+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { gateway+: { appGatewayRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { initProvider+: { gateway+: { appGatewayRef+: { name: name } } } } },
        },
        '#appGatewaySelector':: d.obj(help='"Selector for a AppGateway in beyondcorp to populate appGateway."'),
        appGatewaySelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { gateway+: { appGatewaySelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { gateway+: { appGatewaySelector+: { policy+: { resolve: resolve } } } } } },
          },
          '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
          withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { gateway+: { appGatewaySelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { initProvider+: { gateway+: { appGatewaySelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { gateway+: { appGatewaySelector+: { matchLabels+: matchLabels } } } } },
        },
        '#withAppGateway':: d.fn(help='"AppGateway name in following format: projects/{project_id}/locations/{locationId}/appgateways/{gateway_id}."', args=[d.arg(name='appGateway', type=d.T.string)]),
        withAppGateway(appGateway): { spec+: { initProvider+: { gateway+: { appGateway: appGateway } } } },
        '#withType':: d.fn(help='"The type of hosting used by the gateway. Refer to\\nhttps://cloud.google.com/beyondcorp/docs/reference/rest/v1/projects.locations.appConnections#Type_1\\nfor a list of possible values."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { initProvider+: { gateway+: { type: type } } } },
      },
      '#withConnectors':: d.fn(help='"List of AppConnectors that are authorised to be associated with this AppConnection"', args=[d.arg(name='connectors', type=d.T.array)]),
