  ...
  spec: {
    ...
    forProvider: {
      ...
      principalInfo: {
        ...
        '#withServiceAccount':: d.fn(help='"ServiceAccount represents a GCP service account.\\nStructure is documented below."', args=[d.arg(name='serviceAccount', type=d.T.array)]),
        withServiceAccount(serviceAccount): { serviceAccount: if std.isArray(v=serviceAccount) then serviceAccount else [serviceAccount] },
        '#withServiceAccountMixin':: d.fn(help='"ServiceAccount represents a GCP service account.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAccount', type=d.T.array)]),
      ...
      '#withPrincipalInfo':: d.fn(help='"Principal information about the Identity of the AppConnector.\\nStructure is documented below."', args=[d.arg(name='principalInfo', type=d.T.array)]),
