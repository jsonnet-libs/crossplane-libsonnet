{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withHostType':: d.fn(help='"The type of hosting used by the AppGateway.\\nDefault value is HOST_TYPE_UNSPECIFIED.\\nPossible values are: HOST_TYPE_UNSPECIFIED, GCP_REGIONAL_MIG."', args=[d.arg(name='hostType', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of network connectivity used by the AppGateway.\\nDefault value is TYPE_UNSPECIFIED.\\nPossible values are: TYPE_UNSPECIFIED, TCP_PROXY."', args=[d.arg(name='type', type=d.T.string)]),
