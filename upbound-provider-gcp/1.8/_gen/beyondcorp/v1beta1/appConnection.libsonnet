{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationEndpoint':: d.fn(help='"Address of the remote application endpoint for the BeyondCorp AppConnection.\\nStructure is documented below."', args=[d.arg(name='applicationEndpoint', type=d.T.array)]),
      ...
      '#withApplicationEndpointMixin':: d.fn(help='"Address of the remote application endpoint for the BeyondCorp AppConnection.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='applicationEndpoint', type=d.T.array)]),
