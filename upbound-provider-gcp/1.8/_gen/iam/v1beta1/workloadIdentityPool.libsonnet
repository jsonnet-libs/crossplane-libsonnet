{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDisabled':: d.fn(help='"Whether the pool is disabled. You cannot use a disabled pool to exchange tokens, or use\\nexisting tokens to access resources. If the pool is re-enabled, existing tokens grant\\naccess again."', args=[d.arg(name='disabled', type=d.T.boolean)]),
