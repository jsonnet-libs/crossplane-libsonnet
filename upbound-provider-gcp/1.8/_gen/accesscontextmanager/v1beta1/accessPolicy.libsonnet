{
  ...
  spec: {
    ...
    forProvider: {
      '#withParent':: d.fn(help='"The parent of this AccessPolicy in the Cloud Resource Hierarchy.\\nFormat: organizations/{organization_id}"', args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withScopes':: d.fn(help='"Folder or project on which this policy is applicable.\\nFormat: folders/{{folder_id}} or projects/{{project_id}}"', args=[d.arg(name='scopes', type=d.T.array)]),
      withScopes(scopes): { spec+: { forProvider+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } },
      '#withScopesMixin':: d.fn(help='"Folder or project on which this policy is applicable.\\nFormat: folders/{{folder_id}} or projects/{{project_id}}"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
