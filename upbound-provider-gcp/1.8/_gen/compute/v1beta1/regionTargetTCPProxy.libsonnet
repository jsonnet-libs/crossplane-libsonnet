{
  ...
  '#':: d.pkg(name='regionTargetTCPProxy', url='', help='"RegionTargetTCPProxy is the Schema for the RegionTargetTCPProxys API. Represents a RegionTargetTcpProxy resource, which is used by one or more forwarding rules to route incoming TCP requests to a regional TCP proxy load balancer."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionTargetTCPProxy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionTargetTCPProxySpec defines the desired state of RegionTargetTCPProxy"'),
  spec: {
