{
  ...
  '#':: d.pkg(name='regionDiskIAMMember', url='', help='"RegionDiskIAMMember is the Schema for the RegionDiskIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionDiskIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionDiskIAMMemberSpec defines the desired state of RegionDiskIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#nameRef':: d.obj(help='"Reference to a RegionDisk in compute to populate name."'),
      nameRef: {
      ...
      '#nameSelector':: d.obj(help='"Selector for a RegionDisk in compute to populate name."'),
      nameSelector: {
