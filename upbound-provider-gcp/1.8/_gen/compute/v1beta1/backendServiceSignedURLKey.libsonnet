{
  ...
  '#':: d.pkg(name='backendServiceSignedURLKey', url='', help='"BackendServiceSignedURLKey is the Schema for the BackendServiceSignedURLKeys API. A key for signing Cloud CDN signed URLs for Backend Services."'),
  ...
  '#new':: d.fn(help='new returns an instance of BackendServiceSignedURLKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BackendServiceSignedURLKeySpec defines the desired state of BackendServiceSignedURLKey"'),
  spec: {
    ...
    forProvider: {
      ...
      '#keyValueSecretRef':: d.obj(help='"128-bit key value used for signing the URL. The key value must be a\\nvalid RFC 4648 Section 5 base64url encoded string.\\nNote: This property is sensitive and will not be displayed in the plan."'),
      keyValueSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { keyValueSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { keyValueSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { keyValueSecretRef+: { namespace: namespace } } } },
      },
      '#withBackendService':: d.fn(help='"The backend service this signed URL key belongs."', args=[d.arg(name='backendService', type=d.T.string)]),
      withBackendService(backendService): { spec+: { forProvider+: { backendService: backendService } } },
      '#withName':: d.fn(help='"Name of the signed URL key."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      keyValueSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { keyValueSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { keyValueSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { keyValueSecretRef+: { namespace: namespace } } } },
      },
      '#withBackendService':: d.fn(help='"The backend service this signed URL key belongs."', args=[d.arg(name='backendService', type=d.T.string)]),
