{
  ...
  spec: {
    ...
    forProvider: {
      '#withNetworkTier':: d.fn(help='"The default network tier to be configured for the project.\\nThis field can take the following values: PREMIUM or STANDARD."', args=[d.arg(name='networkTier', type=d.T.string)]),
