{
  ...
  '#':: d.pkg(name='address', url='', help='"Address is the Schema for the Addresss API. Represents an Address resource."'),
  ...
  '#spec':: d.obj(help='"AddressSpec defines the desired state of Address"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIpVersion':: d.fn(help='"The IP Version that will be used by this address. The default value is IPV4.\\nPossible values are: IPV4, IPV6."', args=[d.arg(name='ipVersion', type=d.T.string)]),
      withIpVersion(ipVersion): { spec+: { forProvider+: { ipVersion: ipVersion } } },
      '#withIpv6EndpointType':: d.fn(help='"The endpoint type of this address, which should be VM or NETLB. This is\\nused for deciding which type of endpoint this address can be used after\\nthe external IPv6 address reservation.\\nPossible values are: VM, NETLB."', args=[d.arg(name='ipv6EndpointType', type=d.T.string)]),
      withIpv6EndpointType(ipv6EndpointType): { spec+: { forProvider+: { ipv6EndpointType: ipv6EndpointType } } },
      '#withLabels':: d.fn(help='"Labels to apply to this address.  A list of key->value pairs."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Labels to apply to this address.  A list of key->value pairs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withNetwork':: d.fn(help='"The URL of the network in which to reserve the address. This field\\ncan only be used with INTERNAL type with the VPC_PEERING and\\nIPSEC_INTERCONNECT purposes."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withNetworkTier':: d.fn(help="\"The networking tier used for configuring this address. If this field is not\\nspecified, it is assumed to be PREMIUM.\\nThis argument should not be used when configuring Internal addresses, because network tier cannot be set for internal traffic; it's always Premium.\\nPossible values are: PREMIUM, STANDARD.\"", args=[d.arg(name='networkTier', type=d.T.string)]),
      withNetworkTier(networkTier): { spec+: { forProvider+: { networkTier: networkTier } } },
      '#withPrefixLength':: d.fn(help='"The prefix length if the resource represents an IP range."', args=[d.arg(name='prefixLength', type=d.T.number)]),
      ...
      '#withPurpose':: d.fn(help='"The purpose of this resource, which can be one of the following values."', args=[d.arg(name='purpose', type=d.T.string)]),
      ...
      '#withSubnetwork':: d.fn(help="\"The URL of the subnetwork in which to reserve the address. If an IP\\naddress is specified, it must be within the subnetwork's IP range.\\nThis field can only be used with INTERNAL type with\\nGCE_ENDPOINT/DNS_RESOLVER purposes.\"", args=[d.arg(name='subnetwork', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAddressType':: d.fn(help="\"The type of address to reserve.\\nNote: if you set this argument's value as INTERNAL you need to leave the network_tier argument unset in that resource block.\\nDefault value is EXTERNAL.\\nPossible values are: INTERNAL, EXTERNAL.\"", args=[d.arg(name='addressType', type=d.T.string)]),
      withAddressType(addressType): { spec+: { initProvider+: { addressType: addressType } } },
      '#withDescription':: d.fn(help='"An optional description of this resource."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withIpv6EndpointType':: d.fn(help='"The endpoint type of this address, which should be VM or NETLB. This is\\nused for deciding which type of endpoint this address can be used after\\nthe external IPv6 address reservation.\\nPossible values are: VM, NETLB."', args=[d.arg(name='ipv6EndpointType', type=d.T.string)]),
      withIpv6EndpointType(ipv6EndpointType): { spec+: { initProvider+: { ipv6EndpointType: ipv6EndpointType } } },
      '#withLabels':: d.fn(help='"Labels to apply to this address.  A list of key->value pairs."', args=[d.arg(name='labels', type=d.T.object)]),
      ...
      '#withPrefixLength':: d.fn(help='"The prefix length if the resource represents an IP range."', args=[d.arg(name='prefixLength', type=d.T.number)]),
      withPrefixLength(prefixLength): { spec+: { initProvider+: { prefixLength: prefixLength } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
