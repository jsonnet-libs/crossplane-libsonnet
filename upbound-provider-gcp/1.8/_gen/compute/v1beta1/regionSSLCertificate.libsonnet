{
  ...
  spec: {
    ...
    forProvider: {
      '#certificateSecretRef':: d.obj(help='"The certificate in PEM format.\\nThe certificate chain must be no greater than 5 certs long.\\nThe chain must include at least one intermediate cert.\\nNote: This property is sensitive and will not be displayed in the plan."'),
      ...
      '#withRegion':: d.fn(help='"The Region in which the created regional ssl certificate should reside.\\nIf it is not provided, the provider region is used."', args=[d.arg(name='region', type=d.T.string)]),
