  ...
  spec: {
    ...
    forProvider: {
      ...
      bgp: {
        ...
        withIdentifierRange(identifierRange): { identifierRange: identifierRange },
      ...
      '#withBgp':: d.fn(help='"BGP information specific to this router.\\nStructure is documented below."', args=[d.arg(name='bgp', type=d.T.array)]),
      withBgp(bgp): { spec+: { forProvider+: { bgp: if std.isArray(v=bgp) then bgp else [bgp] } } },
      '#withBgpMixin':: d.fn(help='"BGP information specific to this router.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='bgp', type=d.T.array)]),
