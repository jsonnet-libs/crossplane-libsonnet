{
  ...
  '#':: d.pkg(name='instanceGroup', url='', help='"InstanceGroup is the Schema for the InstanceGroups API. Manages an Instance Group within GCE."'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"InstanceGroupSpec defines the desired state of InstanceGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      namedPort: {
        ...
        '#withPort':: d.fn(help='"The port number to map the name to."', args=[d.arg(name='port', type=d.T.number)]),
      ...
      '#withNetwork':: d.fn(help='"The URL of the network the instance group is in. If\\nthis is different from the network where the instances are in, the creation\\nfails. Defaults to the network where the instances are in (if neither\\nnetwork nor instances is specified, this field will be blank)."', args=[d.arg(name='network', type=d.T.string)]),
      ...
      '#withZone':: d.fn(help='"The zone that this instance group should be created in."', args=[d.arg(name='zone', type=d.T.string)]),
