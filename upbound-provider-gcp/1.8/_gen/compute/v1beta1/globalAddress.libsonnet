{
  ...
  '#':: d.pkg(name='globalAddress', url='', help='"GlobalAddress is the Schema for the GlobalAddresss API. Represents a Global Address resource."'),
  ...
  '#spec':: d.obj(help='"GlobalAddressSpec defines the desired state of GlobalAddress"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAddress':: d.fn(help='"The IP address or beginning of the address range represented by this\\nresource. This can be supplied as an input to reserve a specific\\naddress or omitted to allow GCP to choose a valid one for you."', args=[d.arg(name='address', type=d.T.string)]),
      withAddress(address): { spec+: { forProvider+: { address: address } } },
      '#withAddressType':: d.fn(help='"The type of the address to reserve."', args=[d.arg(name='addressType', type=d.T.string)]),
      ...
      '#withNetwork':: d.fn(help='"The URL of the network in which to reserve the IP range. The IP range\\nmust be in RFC1918 space. The network cannot be deleted if there are\\nany reserved IP ranges referring to it.\\nThis should only be set when using an Internal address."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withPrefixLength':: d.fn(help='"The prefix length of the IP range. If not present, it means the\\naddress field is a single IP address.\\nThis field is not applicable to addresses with addressType=INTERNAL\\nwhen purpose=PRIVATE_SERVICE_CONNECT"', args=[d.arg(name='prefixLength', type=d.T.number)]),
      ...
      '#withPurpose':: d.fn(help='"The purpose of the resource. Possible values include:"', args=[d.arg(name='purpose', type=d.T.string)]),
