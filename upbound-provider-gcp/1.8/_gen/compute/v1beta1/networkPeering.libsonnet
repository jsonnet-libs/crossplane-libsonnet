{
  ...
  '#':: d.pkg(name='networkPeering', url='', help='"NetworkPeering is the Schema for the NetworkPeerings API. Manages a network peering within GCE."'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkPeering', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NetworkPeeringSpec defines the desired state of NetworkPeering"'),
  spec: {
    ...
    forProvider: {
      ...
      '#peerNetworkRef':: d.obj(help='"Reference to a Network in compute to populate peerNetwork."'),
      peerNetworkRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { peerNetworkRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { peerNetworkRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { peerNetworkRef+: { name: name } } } },
      },
      '#peerNetworkSelector':: d.obj(help='"Selector for a Network in compute to populate peerNetwork."'),
      peerNetworkSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { peerNetworkSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { peerNetworkSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { peerNetworkSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { peerNetworkSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { peerNetworkSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      withExportCustomRoutes(exportCustomRoutes): { spec+: { forProvider+: { exportCustomRoutes: exportCustomRoutes } } },
      '#withExportSubnetRoutesWithPublicIp':: d.fn(help='"Whether subnet routes with public IP range are exported. The default value is true, all subnet routes are exported. The IPv4 special-use ranges (https://en.wikipedia.org/wiki/IPv4#Special_addresses) are always exported to peers and are not controlled by this field."', args=[d.arg(name='exportSubnetRoutesWithPublicIp', type=d.T.boolean)]),
      withExportSubnetRoutesWithPublicIp(exportSubnetRoutesWithPublicIp): { spec+: { forProvider+: { exportSubnetRoutesWithPublicIp: exportSubnetRoutesWithPublicIp } } },
      '#withImportCustomRoutes':: d.fn(help='"Whether to import the custom routes from the peer network. Defaults to false."', args=[d.arg(name='importCustomRoutes', type=d.T.boolean)]),
      withImportCustomRoutes(importCustomRoutes): { spec+: { forProvider+: { importCustomRoutes: importCustomRoutes } } },
      '#withImportSubnetRoutesWithPublicIp':: d.fn(help='"Whether subnet routes with public IP range are imported. The default value is false. The IPv4 special-use ranges (https://en.wikipedia.org/wiki/IPv4#Special_addresses) are always imported from peers and are not controlled by this field."', args=[d.arg(name='importSubnetRoutesWithPublicIp', type=d.T.boolean)]),
      withImportSubnetRoutesWithPublicIp(importSubnetRoutesWithPublicIp): { spec+: { forProvider+: { importSubnetRoutesWithPublicIp: importSubnetRoutesWithPublicIp } } },
      '#withNetwork':: d.fn(help='"The primary network of the peering."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withPeerNetwork':: d.fn(help='"The peer network in the peering. The peer network\\nmay belong to a different project."', args=[d.arg(name='peerNetwork', type=d.T.string)]),
      withPeerNetwork(peerNetwork): { spec+: { forProvider+: { peerNetwork: peerNetwork } } },
    ...
    initProvider: {
      ...
      peerNetworkRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { peerNetworkRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { peerNetworkRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { peerNetworkRef+: { name: name } } } },
      },
      '#peerNetworkSelector':: d.obj(help='"Selector for a Network in compute to populate peerNetwork."'),
      peerNetworkSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { peerNetworkSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { peerNetworkSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { peerNetworkSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { peerNetworkSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { peerNetworkSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withExportCustomRoutes':: d.fn(help='"Whether to export the custom routes to the peer network. Defaults to false."', args=[d.arg(name='exportCustomRoutes', type=d.T.boolean)]),
      withExportCustomRoutes(exportCustomRoutes): { spec+: { initProvider+: { exportCustomRoutes: exportCustomRoutes } } },
      '#withExportSubnetRoutesWithPublicIp':: d.fn(help='"Whether subnet routes with public IP range are exported. The default value is true, all subnet routes are exported. The IPv4 special-use ranges (https://en.wikipedia.org/wiki/IPv4#Special_addresses) are always exported to peers and are not controlled by this field."', args=[d.arg(name='exportSubnetRoutesWithPublicIp', type=d.T.boolean)]),
      withExportSubnetRoutesWithPublicIp(exportSubnetRoutesWithPublicIp): { spec+: { initProvider+: { exportSubnetRoutesWithPublicIp: exportSubnetRoutesWithPublicIp } } },
      '#withImportCustomRoutes':: d.fn(help='"Whether to import the custom routes from the peer network. Defaults to false."', args=[d.arg(name='importCustomRoutes', type=d.T.boolean)]),
      withImportCustomRoutes(importCustomRoutes): { spec+: { initProvider+: { importCustomRoutes: importCustomRoutes } } },
      '#withImportSubnetRoutesWithPublicIp':: d.fn(help='"Whether subnet routes with public IP range are imported. The default value is false. The IPv4 special-use ranges (https://en.wikipedia.org/wiki/IPv4#Special_addresses) are always imported from peers and are not controlled by this field."', args=[d.arg(name='importSubnetRoutesWithPublicIp', type=d.T.boolean)]),
      withImportSubnetRoutesWithPublicIp(importSubnetRoutesWithPublicIp): { spec+: { initProvider+: { importSubnetRoutesWithPublicIp: importSubnetRoutesWithPublicIp } } },
      '#withPeerNetwork':: d.fn(help='"The peer network in the peering. The peer network\\nmay belong to a different project."', args=[d.arg(name='peerNetwork', type=d.T.string)]),
      withPeerNetwork(peerNetwork): { spec+: { initProvider+: { peerNetwork: peerNetwork } } },
      '#withStackType':: d.fn(help='"Which IP version(s) of traffic and routes are allowed to be imported or exported between peer networks. The default value is IPV4_ONLY. Possible values: [\\"IPV4_ONLY\\", \\"IPV4_IPV6\\"]."', args=[d.arg(name='stackType', type=d.T.string)]),
