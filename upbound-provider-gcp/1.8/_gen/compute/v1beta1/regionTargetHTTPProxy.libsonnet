{
  ...
  '#':: d.pkg(name='regionTargetHTTPProxy', url='', help='"RegionTargetHTTPProxy is the Schema for the RegionTargetHTTPProxys API. Represents a RegionTargetHttpProxy resource, which is used by one or more forwarding rules to route incoming HTTP requests to a URL map."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionTargetHTTPProxy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionTargetHTTPProxySpec defines the desired state of RegionTargetHTTPProxy"'),
  spec: {
