{
  ...
  '#':: d.pkg(name='diskResourcePolicyAttachment', url='', help='"DiskResourcePolicyAttachment is the Schema for the DiskResourcePolicyAttachments API. Adds existing resource policies to a disk."'),
  ...
  '#new':: d.fn(help='new returns an instance of DiskResourcePolicyAttachment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DiskResourcePolicyAttachmentSpec defines the desired state of DiskResourcePolicyAttachment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDisk':: d.fn(help='"The name of the disk in which the resource policies are attached to."', args=[d.arg(name='disk', type=d.T.string)]),
