{
  ...
  '#':: d.pkg(name='regionNetworkEndpoint', url='', help='"RegionNetworkEndpoint is the Schema for the RegionNetworkEndpoints API. A Region network endpoint represents a IP address/FQDN and port combination that is part of a specific network endpoint group (NEG)."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionNetworkEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionNetworkEndpointSpec defines the desired state of RegionNetworkEndpoint"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#regionNetworkEndpointGroupRef':: d.obj(help='"Reference to a RegionNetworkEndpointGroup in compute to populate regionNetworkEndpointGroup."'),
      regionNetworkEndpointGroupRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { regionNetworkEndpointGroupRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { regionNetworkEndpointGroupRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { regionNetworkEndpointGroupRef+: { name: name } } } },
      },
      '#regionNetworkEndpointGroupSelector':: d.obj(help='"Selector for a RegionNetworkEndpointGroup in compute to populate regionNetworkEndpointGroup."'),
      regionNetworkEndpointGroupSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { regionNetworkEndpointGroupSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { regionNetworkEndpointGroupSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { regionNetworkEndpointGroupSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { regionNetworkEndpointGroupSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { regionNetworkEndpointGroupSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withFqdn':: d.fn(help='"Fully qualified domain name of network endpoint.\\nThis can only be specified when network_endpoint_type of the NEG is INTERNET_FQDN_PORT."', args=[d.arg(name='fqdn', type=d.T.string)]),
      withFqdn(fqdn): { spec+: { forProvider+: { fqdn: fqdn } } },
      '#withIpAddress':: d.fn(help='"IPv4 address external endpoint.\\nThis can only be specified when network_endpoint_type of the NEG is INTERNET_IP_PORT."', args=[d.arg(name='ipAddress', type=d.T.string)]),
      withIpAddress(ipAddress): { spec+: { forProvider+: { ipAddress: ipAddress } } },
      '#withPort':: d.fn(help='"Port number of network endpoint."', args=[d.arg(name='port', type=d.T.number)]),
      ...
      '#withRegion':: d.fn(help='"Region where the containing network endpoint group is located."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withRegionNetworkEndpointGroup':: d.fn(help='"The network endpoint group this endpoint is part of."', args=[d.arg(name='regionNetworkEndpointGroup', type=d.T.string)]),
      withRegionNetworkEndpointGroup(regionNetworkEndpointGroup): { spec+: { forProvider+: { regionNetworkEndpointGroup: regionNetworkEndpointGroup } } },
    },
    ...
    initProvider: {
      ...
      regionNetworkEndpointGroupRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { regionNetworkEndpointGroupRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { regionNetworkEndpointGroupRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { regionNetworkEndpointGroupRef+: { name: name } } } },
      },
      '#regionNetworkEndpointGroupSelector':: d.obj(help='"Selector for a RegionNetworkEndpointGroup in compute to populate regionNetworkEndpointGroup."'),
      regionNetworkEndpointGroupSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { regionNetworkEndpointGroupSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { regionNetworkEndpointGroupSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { regionNetworkEndpointGroupSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { regionNetworkEndpointGroupSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { regionNetworkEndpointGroupSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withFqdn':: d.fn(help='"Fully qualified domain name of network endpoint.\\nThis can only be specified when network_endpoint_type of the NEG is INTERNET_FQDN_PORT."', args=[d.arg(name='fqdn', type=d.T.string)]),
      ...
      '#withRegionNetworkEndpointGroup':: d.fn(help='"The network endpoint group this endpoint is part of."', args=[d.arg(name='regionNetworkEndpointGroup', type=d.T.string)]),
      withRegionNetworkEndpointGroup(regionNetworkEndpointGroup): { spec+: { initProvider+: { regionNetworkEndpointGroup: regionNetworkEndpointGroup } } },
    },
