{
  ...
  '#':: d.pkg(name='networkEndpointGroup', url='', help='"NetworkEndpointGroup is the Schema for the NetworkEndpointGroups API. Network endpoint groups (NEGs) are zonal resources that represent collections of IP address and port combinations for GCP resources within a single subnet."'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkEndpointGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NetworkEndpointGroupSpec defines the desired state of NetworkEndpointGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultPort':: d.fn(help='"The default port used if the port number is not specified in the\\nnetwork endpoint."', args=[d.arg(name='defaultPort', type=d.T.number)]),
      withDefaultPort(defaultPort): { spec+: { forProvider+: { defaultPort: defaultPort } } },
      ...
      '#withNetwork':: d.fn(help='"The network to which all network endpoints in the NEG belong.\\nUses \\"default\\" project network if unspecified."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withNetworkEndpointType':: d.fn(help='"Type of network endpoints in this network endpoint group.\\nNON_GCP_PRIVATE_IP_PORT is used for hybrid connectivity network\\nendpoint groups (see https://cloud.google.com/load-balancing/docs/hybrid).\\nNote that NON_GCP_PRIVATE_IP_PORT can only be used with Backend Services\\nthat 1) have the following load balancing schemes: EXTERNAL, EXTERNAL_MANAGED,\\nINTERNAL_MANAGED, and INTERNAL_SELF_MANAGED and 2) support the RATE or\\nCONNECTION balancing modes.\\nPossible values include: GCE_VM_IP, GCE_VM_IP_PORT, NON_GCP_PRIVATE_IP_PORT, INTERNET_IP_PORT, INTERNET_FQDN_PORT, SERVERLESS, and PRIVATE_SERVICE_CONNECT.\\nDefault value is GCE_VM_IP_PORT.\\nPossible values are: GCE_VM_IP, GCE_VM_IP_PORT, NON_GCP_PRIVATE_IP_PORT, INTERNET_IP_PORT, INTERNET_FQDN_PORT, SERVERLESS, PRIVATE_SERVICE_CONNECT."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
      ...
      '#withSubnetwork':: d.fn(help='"Optional subnetwork to which all network endpoints in the NEG belong."', args=[d.arg(name='subnetwork', type=d.T.string)]),
      withSubnetwork(subnetwork): { spec+: { forProvider+: { subnetwork: subnetwork } } },
      '#withZone':: d.fn(help='"Zone where the network endpoint group is located."', args=[d.arg(name='zone', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDefaultPort':: d.fn(help='"The default port used if the port number is not specified in the\\nnetwork endpoint."', args=[d.arg(name='defaultPort', type=d.T.number)]),
      withDefaultPort(defaultPort): { spec+: { initProvider+: { defaultPort: defaultPort } } },
      '#withDescription':: d.fn(help='"An optional description of this resource. Provide this property when\\nyou create the resource."', args=[d.arg(name='description', type=d.T.string)]),
