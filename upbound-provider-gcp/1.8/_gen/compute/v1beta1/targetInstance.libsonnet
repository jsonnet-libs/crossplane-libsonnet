{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstance':: d.fn(help='"The Compute instance VM handling traffic for this target instance.\\nAccepts the instance self-link, relative path\\n(e.g. projects/project/zones/zone/instances/instance) or name. If\\nname is given, the zone will default to the given zone or\\nthe provider-default zone and the project will default to the\\nprovider-level project."', args=[d.arg(name='instance', type=d.T.string)]),
      withInstance(instance): { spec+: { forProvider+: { instance: instance } } },
      '#withNatPolicy':: d.fn(help="\"NAT option controlling how IPs are NAT'ed to the instance.\\nCurrently only NO_NAT (default value) is supported.\\nDefault value is NO_NAT.\\nPossible values are: NO_NAT.\"", args=[d.arg(name='natPolicy', type=d.T.string)]),
