{
  ...
  '#':: d.pkg(name='targetHTTPProxy', url='', help='"TargetHTTPProxy is the Schema for the TargetHTTPProxys API. Represents a TargetHttpProxy resource, which is used by one or more global forwarding rule to route incoming HTTP requests to a URL map."'),
  ...
  '#new':: d.fn(help='new returns an instance of TargetHTTPProxy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TargetHTTPProxySpec defines the desired state of TargetHTTPProxy"'),
  spec: {
