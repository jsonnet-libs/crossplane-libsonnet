{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#instanceNameRef':: d.obj(help='"Reference to a Instance in compute to populate instanceName."'),
      instanceNameRef: {
      ...
      '#instanceNameSelector':: d.obj(help='"Selector for a Instance in compute to populate instanceName."'),
