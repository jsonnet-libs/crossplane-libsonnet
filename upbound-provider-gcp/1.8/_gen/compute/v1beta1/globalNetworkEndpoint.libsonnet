{
  ...
  '#':: d.pkg(name='globalNetworkEndpoint', url='', help='"GlobalNetworkEndpoint is the Schema for the GlobalNetworkEndpoints API. A Global Network endpoint represents a IP address and port combination that exists outside of GCP."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalNetworkEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GlobalNetworkEndpointSpec defines the desired state of GlobalNetworkEndpoint"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#globalNetworkEndpointGroupRef':: d.obj(help='"Reference to a GlobalNetworkEndpointGroup in compute to populate globalNetworkEndpointGroup."'),
      globalNetworkEndpointGroupRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { globalNetworkEndpointGroupRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { globalNetworkEndpointGroupRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { globalNetworkEndpointGroupRef+: { name: name } } } },
      },
      '#globalNetworkEndpointGroupSelector':: d.obj(help='"Selector for a GlobalNetworkEndpointGroup in compute to populate globalNetworkEndpointGroup."'),
      globalNetworkEndpointGroupSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { globalNetworkEndpointGroupSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { globalNetworkEndpointGroupSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { globalNetworkEndpointGroupSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { globalNetworkEndpointGroupSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { globalNetworkEndpointGroupSelector+: { matchLabels+: matchLabels } } } },
      },
      ...
      '#withGlobalNetworkEndpointGroup':: d.fn(help='"The global network endpoint group this endpoint is part of."', args=[d.arg(name='globalNetworkEndpointGroup', type=d.T.string)]),
      withGlobalNetworkEndpointGroup(globalNetworkEndpointGroup): { spec+: { forProvider+: { globalNetworkEndpointGroup: globalNetworkEndpointGroup } } },
      '#withIpAddress':: d.fn(help='"IPv4 address external endpoint."', args=[d.arg(name='ipAddress', type=d.T.string)]),
      withIpAddress(ipAddress): { spec+: { forProvider+: { ipAddress: ipAddress } } },
      '#withPort':: d.fn(help='"Port number of the external endpoint."', args=[d.arg(name='port', type=d.T.number)]),
    ...
    initProvider: {
      ...
      globalNetworkEndpointGroupRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { globalNetworkEndpointGroupRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { globalNetworkEndpointGroupRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { globalNetworkEndpointGroupRef+: { name: name } } } },
      },
      '#globalNetworkEndpointGroupSelector':: d.obj(help='"Selector for a GlobalNetworkEndpointGroup in compute to populate globalNetworkEndpointGroup."'),
      globalNetworkEndpointGroupSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { globalNetworkEndpointGroupSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { globalNetworkEndpointGroupSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { globalNetworkEndpointGroupSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { globalNetworkEndpointGroupSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { globalNetworkEndpointGroupSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withFqdn':: d.fn(help='"Fully qualified domain name of network endpoint.\\nThis can only be specified when network_endpoint_type of the NEG is INTERNET_FQDN_PORT."', args=[d.arg(name='fqdn', type=d.T.string)]),
      withFqdn(fqdn): { spec+: { initProvider+: { fqdn: fqdn } } },
      '#withGlobalNetworkEndpointGroup':: d.fn(help='"The global network endpoint group this endpoint is part of."', args=[d.arg(name='globalNetworkEndpointGroup', type=d.T.string)]),
      withGlobalNetworkEndpointGroup(globalNetworkEndpointGroup): { spec+: { initProvider+: { globalNetworkEndpointGroup: globalNetworkEndpointGroup } } },
      '#withIpAddress':: d.fn(help='"IPv4 address external endpoint."', args=[d.arg(name='ipAddress', type=d.T.string)]),
