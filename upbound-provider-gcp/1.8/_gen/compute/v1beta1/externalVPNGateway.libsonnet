{
  ...
  spec: {
    ...
    forProvider: {
      '#interface':: d.obj(help='"A list of interfaces on this external VPN gateway.\\nStructure is documented below."'),
      interface: {
        '#withId':: d.fn(help='"The numeric ID for this interface. Allowed values are based on the redundancy type\\nof this external VPN gateway"', args=[d.arg(name='id', type=d.T.number)]),
        withId(id): { id: id },
        '#withIpAddress':: d.fn(help="\"IP address of the interface in the external VPN gateway.\\nOnly IPv4 is supported. This IP address can be either from\\nyour on-premise gateway or another Cloud provider's VPN gateway,\\nit cannot be an IP address from Google Compute Engine.\"", args=[d.arg(name='ipAddress', type=d.T.string)]),
      ...
      '#withRedundancyType':: d.fn(help='"Indicates the redundancy type of this external VPN gateway\\nPossible values are: FOUR_IPS_REDUNDANCY, SINGLE_IP_INTERNALLY_REDUNDANT, TWO_IPS_REDUNDANCY."', args=[d.arg(name='redundancyType', type=d.T.string)]),
