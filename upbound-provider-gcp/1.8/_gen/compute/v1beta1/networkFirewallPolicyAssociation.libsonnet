{
  ...
  '#':: d.pkg(name='networkFirewallPolicyAssociation', url='', help='"NetworkFirewallPolicyAssociation is the Schema for the NetworkFirewallPolicyAssociations API. The Compute NetworkFirewallPolicyAssociation resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkFirewallPolicyAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NetworkFirewallPolicyAssociationSpec defines the desired state of NetworkFirewallPolicyAssociation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#firewallPolicyRef':: d.obj(help='"Reference to a NetworkFirewallPolicy in compute to populate firewallPolicy."'),
      firewallPolicyRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#firewallPolicySelector':: d.obj(help='"Selector for a NetworkFirewallPolicy in compute to populate firewallPolicy."'),
