{
  ...
  '#':: d.pkg(name='regionNetworkFirewallPolicyAssociation', url='', help='"RegionNetworkFirewallPolicyAssociation is the Schema for the RegionNetworkFirewallPolicyAssociations API. The Compute NetworkFirewallPolicyAssociation resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionNetworkFirewallPolicyAssociation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionNetworkFirewallPolicyAssociationSpec defines the desired state of RegionNetworkFirewallPolicyAssociation"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#attachmentTargetRef':: d.obj(help='"Reference to a Network in compute to populate attachmentTarget."'),
      attachmentTargetRef: {
      ...
      '#attachmentTargetSelector':: d.obj(help='"Selector for a Network in compute to populate attachmentTarget."'),
      ...
      '#firewallPolicyRef':: d.obj(help='"Reference to a RegionNetworkFirewallPolicy in compute to populate firewallPolicy."'),
      firewallPolicyRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#firewallPolicySelector':: d.obj(help='"Selector for a RegionNetworkFirewallPolicy in compute to populate firewallPolicy."'),
      ...
      '#withRegion':: d.fn(help='"The location of this resource."', args=[d.arg(name='region', type=d.T.string)]),
