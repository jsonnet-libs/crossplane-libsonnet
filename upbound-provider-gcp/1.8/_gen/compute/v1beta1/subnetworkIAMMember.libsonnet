{
  ...
  '#':: d.pkg(name='subnetworkIAMMember', url='', help='"SubnetworkIAMMember is the Schema for the SubnetworkIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetworkIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
