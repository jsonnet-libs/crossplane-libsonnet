{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withType':: d.fn(help='"Enum field whose value is always MANAGED - used to signal to the API\\nwhich type this is.\\nDefault value is MANAGED.\\nPossible values are: MANAGED."', args=[d.arg(name='type', type=d.T.string)]),
