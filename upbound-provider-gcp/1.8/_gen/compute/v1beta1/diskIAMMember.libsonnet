{
  ...
  '#':: d.pkg(name='diskIAMMember', url='', help='"DiskIAMMember is the Schema for the DiskIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of DiskIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DiskIAMMemberSpec defines the desired state of DiskIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#nameRef':: d.obj(help='"Reference to a Disk in compute to populate name."'),
      nameRef: {
      ...
      '#nameSelector':: d.obj(help='"Selector for a Disk in compute to populate name."'),
      nameSelector: {
