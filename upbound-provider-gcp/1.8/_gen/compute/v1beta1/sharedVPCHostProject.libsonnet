{
  ...
  '#':: d.pkg(name='sharedVPCHostProject', url='', help='"SharedVPCHostProject is the Schema for the SharedVPCHostProjects API. Enables the Google Compute Engine Shared VPC feature for a project, assigning it as a host project."'),
  ...
  '#new':: d.fn(help='new returns an instance of SharedVPCHostProject', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SharedVPCHostProjectSpec defines the desired state of SharedVPCHostProject"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withProject':: d.fn(help='"The ID of the project that will serve as a Shared VPC host project"', args=[d.arg(name='project', type=d.T.string)]),
