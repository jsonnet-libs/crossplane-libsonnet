{
  ...
  spec: {
    ...
    forProvider: {
      '#withAutoCreateSubnetworks':: d.fn(help='"When set to true, the network is created in \\"auto subnet mode\\" and\\nit will create a subnet for each region automatically across the\\n10.128.0.0/9 address range.\\nWhen set to false, the network is created in \\"custom subnet mode\\" so\\nthe user can explicitly connect subnetwork resources."', args=[d.arg(name='autoCreateSubnetworks', type=d.T.boolean)]),
      withAutoCreateSubnetworks(autoCreateSubnetworks): { spec+: { forProvider+: { autoCreateSubnetworks: autoCreateSubnetworks } } },
      '#withDeleteDefaultRoutesOnCreate':: d.fn(help='"If set to true, default routes (0.0.0.0/0) will be deleted\\nimmediately after network creation. Defaults to false."', args=[d.arg(name='deleteDefaultRoutesOnCreate', type=d.T.boolean)]),
      ...
      '#withDescription':: d.fn(help='"An optional description of this resource. The resource must be\\nrecreated to modify this field."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEnableUlaInternalIpv6':: d.fn(help='"Enable ULA internal ipv6 on this network. Enabling this feature will assign\\na /48 from google defined ULA prefix fd20::/20."', args=[d.arg(name='enableUlaInternalIpv6', type=d.T.boolean)]),
      withEnableUlaInternalIpv6(enableUlaInternalIpv6): { spec+: { forProvider+: { enableUlaInternalIpv6: enableUlaInternalIpv6 } } },
      '#withInternalIpv6Range':: d.fn(help='"When enabling ula internal ipv6, caller optionally can specify the /48 range\\nthey want from the google defined ULA prefix fd20::/20. The input must be a\\nvalid /48 ULA IPv6 address and must be within the fd20::/20. Operation will\\nfail if the speficied /48 is already in used by another resource.\\nIf the field is not speficied, then a /48 range will be randomly allocated from fd20::/20 and returned via this field."', args=[d.arg(name='internalIpv6Range', type=d.T.string)]),
      withInternalIpv6Range(internalIpv6Range): { spec+: { forProvider+: { internalIpv6Range: internalIpv6Range } } },
      '#withMtu':: d.fn(help='"Maximum Transmission Unit in bytes. The default value is 1460 bytes.\\nThe minimum value for this field is 1300 and the maximum value is 8896 bytes (jumbo frames).\\nNote that packets larger than 1500 bytes (standard Ethernet) can be subject to TCP-MSS clamping or dropped\\nwith an ICMP Fragmentation-Needed message if the packets are routed to the Internet or other VPCs\\nwith varying MTUs."', args=[d.arg(name='mtu', type=d.T.number)]),
      withMtu(mtu): { spec+: { forProvider+: { mtu: mtu } } },
      '#withNetworkFirewallPolicyEnforcementOrder':: d.fn(help='"Set the order that Firewall Rules and Firewall Policies are evaluated.\\nDefault value is AFTER_CLASSIC_FIREWALL.\\nPossible values are: BEFORE_CLASSIC_FIREWALL, AFTER_CLASSIC_FIREWALL."', args=[d.arg(name='networkFirewallPolicyEnforcementOrder', type=d.T.string)]),
      ...
      '#withRoutingMode':: d.fn(help="\"The network-wide routing mode to use. If set to REGIONAL, this\\nnetwork's cloud routers will only advertise routes with subnetworks\\nof this network in the same region as the router. If set to GLOBAL,\\nthis network's cloud routers will advertise routes with all\\nsubnetworks of this network, across regions.\\nPossible values are: REGIONAL, GLOBAL.\"", args=[d.arg(name='routingMode', type=d.T.string)]),
