{
  ...
  '#':: d.pkg(name='haVPNGateway', url='', help='"HaVPNGateway is the Schema for the HaVPNGateways API. Represents a VPN gateway running in GCP."'),
  ...
  '#new':: d.fn(help='new returns an instance of HaVPNGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HaVPNGatewaySpec defines the desired state of HaVPNGateway"'),
  spec: {
    ...
    forProvider: {
      ...
      '#vpnInterfaces':: d.obj(help='"A list of interfaces on this VPN gateway.\\nStructure is documented below."'),
      vpnInterfaces: {
        '#interconnectAttachmentRef':: d.obj(help='"Reference to a InterconnectAttachment in compute to populate interconnectAttachment."'),
        interconnectAttachmentRef: {
          '#policy':: d.obj(help='"Policies for referencing."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { interconnectAttachmentRef+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { interconnectAttachmentRef+: { policy+: { resolve: resolve } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { interconnectAttachmentRef+: { name: name } },
        },
        '#interconnectAttachmentSelector':: d.obj(help='"Selector for a InterconnectAttachment in compute to populate interconnectAttachment."'),
        interconnectAttachmentSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { interconnectAttachmentSelector+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { interconnectAttachmentSelector+: { policy+: { resolve: resolve } } },
          },
          '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
          withMatchControllerRef(matchControllerRef): { interconnectAttachmentSelector+: { matchControllerRef: matchControllerRef } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { interconnectAttachmentSelector+: { matchLabels: matchLabels } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { interconnectAttachmentSelector+: { matchLabels+: matchLabels } },
        },
        '#withId':: d.fn(help='"The numeric ID of this VPN gateway interface."', args=[d.arg(name='id', type=d.T.number)]),
        withId(id): { id: id },
        '#withInterconnectAttachment':: d.fn(help='"URL of the interconnect attachment resource. When the value\\nof this field is present, the VPN Gateway will be used for\\nIPsec-encrypted Cloud Interconnect; all Egress or Ingress\\ntraffic for this VPN Gateway interface will go through the\\nspecified interconnect attachment resource.\\nNot currently available publicly."', args=[d.arg(name='interconnectAttachment', type=d.T.string)]),
        withInterconnectAttachment(interconnectAttachment): { interconnectAttachment: interconnectAttachment },
      },
      ...
      '#withNetwork':: d.fn(help='"The network this VPN gateway is accepting traffic for."', args=[d.arg(name='network', type=d.T.string)]),
      ...
      '#withRegion':: d.fn(help='"The region this gateway should sit in."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withStackType':: d.fn(help='"The stack type for this VPN gateway to identify the IP protocols that are enabled.\\nIf not specified, IPV4_ONLY will be used.\\nDefault value is IPV4_ONLY.\\nPossible values are: IPV4_ONLY, IPV4_IPV6."', args=[d.arg(name='stackType', type=d.T.string)]),
      withStackType(stackType): { spec+: { forProvider+: { stackType: stackType } } },
      '#withVpnInterfaces':: d.fn(help='"A list of interfaces on this VPN gateway.\\nStructure is documented below."', args=[d.arg(name='vpnInterfaces', type=d.T.array)]),
      withVpnInterfaces(vpnInterfaces): { spec+: { forProvider+: { vpnInterfaces: if std.isArray(v=vpnInterfaces) then vpnInterfaces else [vpnInterfaces] } } },
      '#withVpnInterfacesMixin':: d.fn(help='"A list of interfaces on this VPN gateway.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vpnInterfaces', type=d.T.array)]),
      withVpnInterfacesMixin(vpnInterfaces): { spec+: { forProvider+: { vpnInterfaces+: if std.isArray(v=vpnInterfaces) then vpnInterfaces else [vpnInterfaces] } } },
    },
    ...
    initProvider: {
      ...
      '#withVpnInterfaces':: d.fn(help='"A list of interfaces on this VPN gateway.\\nStructure is documented below."', args=[d.arg(name='vpnInterfaces', type=d.T.array)]),
      withVpnInterfaces(vpnInterfaces): { spec+: { initProvider+: { vpnInterfaces: if std.isArray(v=vpnInterfaces) then vpnInterfaces else [vpnInterfaces] } } },
      '#withVpnInterfacesMixin':: d.fn(help='"A list of interfaces on this VPN gateway.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vpnInterfaces', type=d.T.array)]),
      withVpnInterfacesMixin(vpnInterfaces): { spec+: { initProvider+: { vpnInterfaces+: if std.isArray(v=vpnInterfaces) then vpnInterfaces else [vpnInterfaces] } } },
    },
