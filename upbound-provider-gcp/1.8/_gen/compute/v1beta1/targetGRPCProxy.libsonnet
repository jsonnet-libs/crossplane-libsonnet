{
  ...
  '#':: d.pkg(name='targetGRPCProxy', url='', help='"TargetGRPCProxy is the Schema for the TargetGRPCProxys API. Represents a Target gRPC Proxy resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of TargetGRPCProxy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TargetGRPCProxySpec defines the desired state of TargetGRPCProxy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withUrlMap':: d.fn(help='"URL to the UrlMap resource that defines the mapping from URL to\\nthe BackendService. The protocol field in the BackendService\\nmust be set to GRPC."', args=[d.arg(name='urlMap', type=d.T.string)]),
      withUrlMap(urlMap): { spec+: { forProvider+: { urlMap: urlMap } } },
      '#withValidateForProxyless':: d.fn(help='"If true, indicates that the BackendServices referenced by\\nthe urlMap may be accessed by gRPC applications without using\\na sidecar proxy. This will enable configuration checks on urlMap\\nand its referenced BackendServices to not allow unsupported features.\\nA gRPC application must use \\"xds:///\\" scheme in the target URI\\nof the service it is connecting to. If false, indicates that the\\nBackendServices referenced by the urlMap will be accessed by gRPC\\napplications via a sidecar proxy. In this case, a gRPC application\\nmust not use \\"xds:///\\" scheme in the target URI of the service\\nit is connecting to"', args=[d.arg(name='validateForProxyless', type=d.T.boolean)]),
      withValidateForProxyless(validateForProxyless): { spec+: { forProvider+: { validateForProxyless: validateForProxyless } } },
    },
    ...
    initProvider: {
      ...
      '#withValidateForProxyless':: d.fn(help='"If true, indicates that the BackendServices referenced by\\nthe urlMap may be accessed by gRPC applications without using\\na sidecar proxy. This will enable configuration checks on urlMap\\nand its referenced BackendServices to not allow unsupported features.\\nA gRPC application must use \\"xds:///\\" scheme in the target URI\\nof the service it is connecting to. If false, indicates that the\\nBackendServices referenced by the urlMap will be accessed by gRPC\\napplications via a sidecar proxy. In this case, a gRPC application\\nmust not use \\"xds:///\\" scheme in the target URI of the service\\nit is connecting to"', args=[d.arg(name='validateForProxyless', type=d.T.boolean)]),
      withValidateForProxyless(validateForProxyless): { spec+: { initProvider+: { validateForProxyless: validateForProxyless } } },
    },
