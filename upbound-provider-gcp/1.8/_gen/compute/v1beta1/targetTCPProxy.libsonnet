{
  ...
  '#':: d.pkg(name='targetTCPProxy', url='', help='"TargetTCPProxy is the Schema for the TargetTCPProxys API. Represents a TargetTcpProxy resource, which is used by one or more global forwarding rule to route incoming TCP requests to a Backend service."'),
  ...
  '#new':: d.fn(help='new returns an instance of TargetTCPProxy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
