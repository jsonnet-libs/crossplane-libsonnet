  ...
  spec: {
    ...
    forProvider: {
      ...
      nodeTypeFlexibility: {
        ...
        withCpus(cpus): { spec+: { forProvider+: { nodeTypeFlexibility+: { cpus: cpus } } } },
        '#withMemory':: d.fn(help='"Physical memory available to the node, defined in MB."', args=[d.arg(name='memory', type=d.T.string)]),
        withMemory(memory): { spec+: { forProvider+: { nodeTypeFlexibility+: { memory: memory } } } },
      },
      ...
      serverBinding: {
        ...
        withType(type): { spec+: { forProvider+: { serverBinding+: { type: type } } } },
      },
    ...
    initProvider: {
      ...
      nodeTypeFlexibility: {
        '#withCpus':: d.fn(help='"Number of virtual CPUs to use."', args=[d.arg(name='cpus', type=d.T.string)]),
        withCpus(cpus): { spec+: { initProvider+: { nodeTypeFlexibility+: { cpus: cpus } } } },
        '#withMemory':: d.fn(help='"Physical memory available to the node, defined in MB."', args=[d.arg(name='memory', type=d.T.string)]),
        withMemory(memory): { spec+: { initProvider+: { nodeTypeFlexibility+: { memory: memory } } } },
      },
      '#serverBinding':: d.obj(help='"The server binding policy for nodes using this template. Determines\\nwhere the nodes should restart following a maintenance event.\\nStructure is documented below."'),
      serverBinding: {
        '#withType':: d.fn(help='"Type of server binding policy. If RESTART_NODE_ON_ANY_SERVER,\\nnodes using this template will restart on any physical server\\nfollowing a maintenance event.\\nIf RESTART_NODE_ON_MINIMAL_SERVER, nodes using this template\\nwill restart on the same physical server following a maintenance\\nevent, instead of being live migrated to or restarted on a new\\nphysical server. This option may be useful if you are using\\nsoftware licenses tied to the underlying server characteristics\\nsuch as physical sockets or cores, to avoid the need for\\nadditional licenses when maintenance occurs. However, VMs on such\\nnodes will experience outages while maintenance is applied.\\nPossible values are: RESTART_NODE_ON_ANY_SERVER, RESTART_NODE_ON_MINIMAL_SERVERS."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { initProvider+: { serverBinding+: { type: type } } } },
      },
      '#withCpuOvercommitType':: d.fn(help='"CPU overcommit.\\nDefault value is NONE.\\nPossible values are: ENABLED, NONE."', args=[d.arg(name='cpuOvercommitType', type=d.T.string)]),
