{
  ...
  spec: {
    ...
    forProvider: {
      '#defaultVersion':: d.obj(help='"The default version of the model. This version will be used to handle\\nprediction requests that do not specify a version.\\nStructure is documented below."'),
      defaultVersion: {
        '#withName':: d.fn(help='"The name specified for the version when it was created."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#withDefaultVersion':: d.fn(help='"The default version of the model. This version will be used to handle\\nprediction requests that do not specify a version.\\nStructure is documented below."', args=[d.arg(name='defaultVersion', type=d.T.array)]),
