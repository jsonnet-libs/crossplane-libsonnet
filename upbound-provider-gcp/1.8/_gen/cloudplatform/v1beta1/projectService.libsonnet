{
  ...
  '#':: d.pkg(name='projectService', url='', help='"ProjectService is the Schema for the ProjectServices API. Allows management of a single API service for a Google Cloud project."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectService', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectServiceSpec defines the desired state of ProjectService"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDisableDependentServices':: d.fn(help='"If true, services that are enabled\\nand which depend on this service should also be disabled when this service is\\ndestroyed. If false or unset, an error will be returned if any enabled\\nservices depend on this service when attempting to destroy it."', args=[d.arg(name='disableDependentServices', type=d.T.boolean)]),
      withDisableDependentServices(disableDependentServices): { spec+: { forProvider+: { disableDependentServices: disableDependentServices } } },
      '#withDisableOnDestroy':: d.fn(help='"Defaults to true. Most configurations should\\nset this to false; it should generally only be true or unset in configurations\\nthat manage the google_project resource itself."', args=[d.arg(name='disableOnDestroy', type=d.T.boolean)]),
      withDisableOnDestroy(disableOnDestroy): { spec+: { forProvider+: { disableOnDestroy: disableOnDestroy } } },
      '#withProject':: d.fn(help='"The project ID. If not provided, the provider project\\nis used."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { forProvider+: { project: project } } },
      '#withService':: d.fn(help='"The service to enable."', args=[d.arg(name='service', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDisableDependentServices':: d.fn(help='"If true, services that are enabled\\nand which depend on this service should also be disabled when this service is\\ndestroyed. If false or unset, an error will be returned if any enabled\\nservices depend on this service when attempting to destroy it."', args=[d.arg(name='disableDependentServices', type=d.T.boolean)]),
      withDisableDependentServices(disableDependentServices): { spec+: { initProvider+: { disableDependentServices: disableDependentServices } } },
      '#withDisableOnDestroy':: d.fn(help='"Defaults to true. Most configurations should\\nset this to false; it should generally only be true or unset in configurations\\nthat manage the google_project resource itself."', args=[d.arg(name='disableOnDestroy', type=d.T.boolean)]),
      withDisableOnDestroy(disableOnDestroy): { spec+: { initProvider+: { disableOnDestroy: disableOnDestroy } } },
      '#withProject':: d.fn(help='"The project ID. If not provided, the provider project\\nis used."', args=[d.arg(name='project', type=d.T.string)]),
