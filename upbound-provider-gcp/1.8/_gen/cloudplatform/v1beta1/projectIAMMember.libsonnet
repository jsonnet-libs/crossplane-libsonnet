{
  ...
  '#':: d.pkg(name='projectIAMMember', url='', help='"ProjectIAMMember is the Schema for the ProjectIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectIAMMemberSpec defines the desired state of ProjectIAMMember"'),
  spec: {
