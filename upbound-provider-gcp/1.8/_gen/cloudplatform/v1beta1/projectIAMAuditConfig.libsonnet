{
  ...
  '#':: d.pkg(name='projectIAMAuditConfig', url='', help='"ProjectIAMAuditConfig is the Schema for the ProjectIAMAuditConfigs API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectIAMAuditConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectIAMAuditConfigSpec defines the desired state of ProjectIAMAuditConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#auditLogConfig':: d.obj(help=''),
      auditLogConfig: {
        '#withExemptedMembers':: d.fn(help='', args=[d.arg(name='exemptedMembers', type=d.T.array)]),
      ...
      '#withAuditLogConfig':: d.fn(help='', args=[d.arg(name='auditLogConfig', type=d.T.array)]),
      withAuditLogConfig(auditLogConfig): { spec+: { forProvider+: { auditLogConfig: if std.isArray(v=auditLogConfig) then auditLogConfig else [auditLogConfig] } } },
      '#withAuditLogConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='auditLogConfig', type=d.T.array)]),
      withAuditLogConfigMixin(auditLogConfig): { spec+: { forProvider+: { auditLogConfig+: if std.isArray(v=auditLogConfig) then auditLogConfig else [auditLogConfig] } } },
    ...
    initProvider: {
      ...
      '#withAuditLogConfig':: d.fn(help='', args=[d.arg(name='auditLogConfig', type=d.T.array)]),
      withAuditLogConfig(auditLogConfig): { spec+: { initProvider+: { auditLogConfig: if std.isArray(v=auditLogConfig) then auditLogConfig else [auditLogConfig] } } },
      '#withAuditLogConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='auditLogConfig', type=d.T.array)]),
      withAuditLogConfigMixin(auditLogConfig): { spec+: { initProvider+: { auditLogConfig+: if std.isArray(v=auditLogConfig) then auditLogConfig else [auditLogConfig] } } },
      '#withProject':: d.fn(help='', args=[d.arg(name='project', type=d.T.string)]),
