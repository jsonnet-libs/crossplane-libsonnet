{
  ...
  '#':: d.pkg(name='folderIAMMember', url='', help='"FolderIAMMember is the Schema for the FolderIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of FolderIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FolderIAMMemberSpec defines the desired state of FolderIAMMember"'),
  spec: {
