{
  ...
  '#':: d.pkg(name='serviceAccountIAMMember', url='', help='"ServiceAccountIAMMember is the Schema for the ServiceAccountIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceAccountIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServiceAccountIAMMemberSpec defines the desired state of ServiceAccountIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withServiceAccountId':: d.fn(help='', args=[d.arg(name='serviceAccountId', type=d.T.string)]),
