{
  ...
  '#':: d.pkg(name='projectUsageExportBucket', url='', help="\"ProjectUsageExportBucket is the Schema for the ProjectUsageExportBuckets API. Manages a project's usage export bucket.\""),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectUsageExportBucket', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectUsageExportBucketSpec defines the desired state of ProjectUsageExportBucket"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withBucketName':: d.fn(help='":  The bucket to store reports in."', args=[d.arg(name='bucketName', type=d.T.string)]),
      withBucketName(bucketName): { spec+: { forProvider+: { bucketName: bucketName } } },
      '#withPrefix':: d.fn(help='":  A prefix for the reports, for instance, the project name."', args=[d.arg(name='prefix', type=d.T.string)]),
      withPrefix(prefix): { spec+: { forProvider+: { prefix: prefix } } },
      '#withProject':: d.fn(help='":  The project to set the export bucket on. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
