{
  ...
  '#':: d.pkg(name='projectDefaultServiceAccounts', url='', help='"ProjectDefaultServiceAccounts is the Schema for the ProjectDefaultServiceAccountss API. Allows management of Google Cloud Platform project default service accounts."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectDefaultServiceAccounts', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectDefaultServiceAccountsSpec defines the desired state of ProjectDefaultServiceAccounts"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withAction':: d.fn(help='"The action to be performed in the default service accounts. Valid values are: DEPRIVILEGE, DELETE, DISABLE. Note that DEPRIVILEGE action will ignore the REVERT configuration in the restore_policy"', args=[d.arg(name='action', type=d.T.string)]),
      withAction(action): { spec+: { forProvider+: { action: action } } },
      '#withProject':: d.fn(help='"The project ID where service accounts are created."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { forProvider+: { project: project } } },
      '#withRestorePolicy':: d.fn(help='"The action to be performed in the default service accounts on the resource destroy.\\nValid values are NONE, REVERT and REVERT_AND_IGNORE_FAILURE. It is applied for any action but in the DEPRIVILEGE.\\nIf set to REVERT it attempts to restore all default SAs but the DEPRIVILEGE action.\\nIf set to REVERT_AND_IGNORE_FAILURE it is the same behavior as REVERT but ignores errors returned by the API."', args=[d.arg(name='restorePolicy', type=d.T.string)]),
      withRestorePolicy(restorePolicy): { spec+: { forProvider+: { restorePolicy: restorePolicy } } },
    },
    ...
    initProvider: {
      ...
      '#withRestorePolicy':: d.fn(help='"The action to be performed in the default service accounts on the resource destroy.\\nValid values are NONE, REVERT and REVERT_AND_IGNORE_FAILURE. It is applied for any action but in the DEPRIVILEGE.\\nIf set to REVERT it attempts to restore all default SAs but the DEPRIVILEGE action.\\nIf set to REVERT_AND_IGNORE_FAILURE it is the same behavior as REVERT but ignores errors returned by the API."', args=[d.arg(name='restorePolicy', type=d.T.string)]),
      withRestorePolicy(restorePolicy): { spec+: { initProvider+: { restorePolicy: restorePolicy } } },
    },
