{
  ...
  '#':: d.pkg(name='serviceAccount', url='', help='"ServiceAccount is the Schema for the ServiceAccounts API. Allows management of a Google Cloud Platform service account."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCreateIgnoreAlreadyExists':: d.fn(help='"If set to true, skip service account creation if a service account with the same email already exists."', args=[d.arg(name='createIgnoreAlreadyExists', type=d.T.boolean)]),
      withCreateIgnoreAlreadyExists(createIgnoreAlreadyExists): { spec+: { forProvider+: { createIgnoreAlreadyExists: createIgnoreAlreadyExists } } },
      '#withDescription':: d.fn(help='"A text description of the service account.\\nMust be less than or equal to 256 UTF-8 bytes."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisabled':: d.fn(help='"Whether a service account is disabled or not. Defaults to false. This field has no effect during creation.\\nMust be set after creation to disable a service account."', args=[d.arg(name='disabled', type=d.T.boolean)]),
      withDisabled(disabled): { spec+: { forProvider+: { disabled: disabled } } },
      '#withDisplayName':: d.fn(help='"The display name for the service account.\\nCan be updated without creating a new resource."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withProject':: d.fn(help='"The ID of the project that the service account will be created in.\\nDefaults to the provider project configuration."', args=[d.arg(name='project', type=d.T.string)]),
    ...
    initProvider: {
      '#withCreateIgnoreAlreadyExists':: d.fn(help='"If set to true, skip service account creation if a service account with the same email already exists."', args=[d.arg(name='createIgnoreAlreadyExists', type=d.T.boolean)]),
      withCreateIgnoreAlreadyExists(createIgnoreAlreadyExists): { spec+: { initProvider+: { createIgnoreAlreadyExists: createIgnoreAlreadyExists } } },
      '#withDescription':: d.fn(help='"A text description of the service account.\\nMust be less than or equal to 256 UTF-8 bytes."', args=[d.arg(name='description', type=d.T.string)]),
