{
  ...
  '#':: d.pkg(name='folderExclusion', url='', help='"FolderExclusion is the Schema for the FolderExclusions API. Manages a folder-level logging exclusion."'),
  ...
  '#new':: d.fn(help='new returns an instance of FolderExclusion', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FolderExclusionSpec defines the desired state of FolderExclusion"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDisabled':: d.fn(help='"Whether this exclusion rule should be disabled or not. This defaults to\\nfalse."', args=[d.arg(name='disabled', type=d.T.boolean)]),
      withDisabled(disabled): { spec+: { forProvider+: { disabled: disabled } } },
      '#withFilter':: d.fn(help='"The filter to apply when excluding logs. Only log entries that match the filter are excluded.\\nSee Advanced Log Filters for information on how to\\nwrite a filter."', args=[d.arg(name='filter', type=d.T.string)]),
