  ...
  spec: {
    ...
    forProvider: {
      ...
      bucketOptions: {
        ...
        '#withExplicitBuckets':: d.fn(help='"Specifies a set of buckets with arbitrary widths.\\nStructure is documented below."', args=[d.arg(name='explicitBuckets', type=d.T.array)]),
        ...
        '#withExponentialBuckets':: d.fn(help='"Specifies an exponential sequence of buckets that have a width that is proportional to the value of\\nthe lower bound. Each bucket represents a constant relative uncertainty on a specific value in the bucket.\\nStructure is documented below."', args=[d.arg(name='exponentialBuckets', type=d.T.array)]),
        ...
        '#withExponentialBucketsMixin':: d.fn(help='"Specifies an exponential sequence of buckets that have a width that is proportional to the value of\\nthe lower bound. Each bucket represents a constant relative uncertainty on a specific value in the bucket.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exponentialBuckets', type=d.T.array)]),
        ...
        '#withLinearBuckets':: d.fn(help='"Specifies a linear sequence of buckets that all have the same width (except overflow and underflow).\\nEach bucket represents a constant absolute uncertainty on the specific value in the bucket.\\nStructure is documented below."', args=[d.arg(name='linearBuckets', type=d.T.array)]),
        withLinearBuckets(linearBuckets): { linearBuckets: if std.isArray(v=linearBuckets) then linearBuckets else [linearBuckets] },
        '#withLinearBucketsMixin':: d.fn(help='"Specifies a linear sequence of buckets that all have the same width (except overflow and underflow).\\nEach bucket represents a constant absolute uncertainty on the specific value in the bucket.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='linearBuckets', type=d.T.array)]),
      ...
      '#withBucketOptions':: d.fn(help='"The bucketOptions are required when the logs-based metric is using a DISTRIBUTION value type and it\\ndescribes the bucket boundaries used to create a histogram of the extracted values.\\nStructure is documented below."', args=[d.arg(name='bucketOptions', type=d.T.array)]),
      ...
      '#withBucketOptionsMixin':: d.fn(help='"The bucketOptions are required when the logs-based metric is using a DISTRIBUTION value type and it\\ndescribes the bucket boundaries used to create a histogram of the extracted values.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='bucketOptions', type=d.T.array)]),
      ...
      '#withMetricDescriptor':: d.fn(help='"The optional metric descriptor associated with the logs-based metric.\\nIf unspecified, it uses a default metric descriptor with a DELTA metric kind,\\nINT64 value type, with no labels and a unit of \\"1\\". Such a metric counts the\\nnumber of log entries matching the filter expression.\\nStructure is documented below."', args=[d.arg(name='metricDescriptor', type=d.T.array)]),
