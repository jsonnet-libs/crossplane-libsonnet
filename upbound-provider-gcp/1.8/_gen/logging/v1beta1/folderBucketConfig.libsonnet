{
  ...
  '#':: d.pkg(name='folderBucketConfig', url='', help='"FolderBucketConfig is the Schema for the FolderBucketConfigs API. Manages a folder-level logging bucket config."'),
  ...
  '#new':: d.fn(help='new returns an instance of FolderBucketConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FolderBucketConfigSpec defines the desired state of FolderBucketConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#cmekSettings':: d.obj(help=''),
      cmekSettings: {
        '#withKmsKeyName':: d.fn(help='"The resource name of the bucket. For example: \\"folders/my-folder-id/locations/my-location/buckets/my-bucket-id\\', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
      ...
      '#withCmekSettings':: d.fn(help='', args=[d.arg(name='cmekSettings', type=d.T.array)]),
      ...
      '#withFolder':: d.fn(help='"The parent resource that contains the logging bucket."', args=[d.arg(name='folder', type=d.T.string)]),
