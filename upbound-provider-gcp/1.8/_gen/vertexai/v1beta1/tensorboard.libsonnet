{
  ...
  spec: {
    ...
    forProvider: {
      '#encryptionSpec':: d.obj(help='"Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key.\\nStructure is documented below."'),
      encryptionSpec: {
        '#withKmsKeyName':: d.fn(help='"The Cloud KMS resource identifier of the customer managed encryption key used to protect a resource.\\nHas the form: projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key. The key needs to be in the same region as where the resource is created."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
      ...
      '#withEncryptionSpec':: d.fn(help='"Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key.\\nStructure is documented below."', args=[d.arg(name='encryptionSpec', type=d.T.array)]),
      ...
      '#withEncryptionSpecMixin':: d.fn(help='"Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionSpec', type=d.T.array)]),
