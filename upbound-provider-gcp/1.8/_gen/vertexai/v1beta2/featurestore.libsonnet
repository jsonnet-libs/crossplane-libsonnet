  ...
  spec: {
    ...
    forProvider: {
      ...
      onlineServingConfig: {
        ...
        scaling: {
          ...
          withMaxNodeCount(maxNodeCount): { spec+: { forProvider+: { onlineServingConfig+: { scaling+: { maxNodeCount: maxNodeCount } } } } },
          ...
          withMinNodeCount(minNodeCount): { spec+: { forProvider+: { onlineServingConfig+: { scaling+: { minNodeCount: minNodeCount } } } } },
        },
        ...
        withFixedNodeCount(fixedNodeCount): { spec+: { forProvider+: { onlineServingConfig+: { fixedNodeCount: fixedNodeCount } } } },
      },
    ...
    initProvider: {
      ...
      onlineServingConfig: {
        ...
        scaling: {
          '#withMaxNodeCount':: d.fn(help="\"The maximum number of nodes to scale up to. Must be greater than minNodeCount, and less than or equal to 10 times of 'minNodeCount'.\"", args=[d.arg(name='maxNodeCount', type=d.T.number)]),
          withMaxNodeCount(maxNodeCount): { spec+: { initProvider+: { onlineServingConfig+: { scaling+: { maxNodeCount: maxNodeCount } } } } },
          '#withMinNodeCount':: d.fn(help='"The minimum number of nodes to scale down to. Must be greater than or equal to 1."', args=[d.arg(name='minNodeCount', type=d.T.number)]),
          withMinNodeCount(minNodeCount): { spec+: { initProvider+: { onlineServingConfig+: { scaling+: { minNodeCount: minNodeCount } } } } },
        },
        '#withFixedNodeCount':: d.fn(help='"The number of nodes for each cluster. The number of nodes will not scale automatically but can be scaled manually by providing different values when updating."', args=[d.arg(name='fixedNodeCount', type=d.T.number)]),
        withFixedNodeCount(fixedNodeCount): { spec+: { initProvider+: { onlineServingConfig+: { fixedNodeCount: fixedNodeCount } } } },
      },
      '#withForceDestroy':: d.fn(help='"If set to true, any EntityTypes and Features for this Featurestore will also be deleted"', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
