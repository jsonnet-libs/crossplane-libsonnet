  ...
  spec: {
    ...
    forProvider: {
      ...
      attestationAuthority: {
        ...
        hint: {
          ...
          withHumanReadableName(humanReadableName): { spec+: { forProvider+: { attestationAuthority+: { hint+: { humanReadableName: humanReadableName } } } } },
        },
      },
    ...
    initProvider: {
      ...
      attestationAuthority: {
        ...
        hint: {
          '#withHumanReadableName':: d.fn(help='"The human readable name of this Attestation Authority, for\\nexample \\"qa\\"."', args=[d.arg(name='humanReadableName', type=d.T.string)]),
          withHumanReadableName(humanReadableName): { spec+: { initProvider+: { attestationAuthority+: { hint+: { humanReadableName: humanReadableName } } } } },
        },
      },
      '#relatedUrl':: d.obj(help='"URLs associated with this note and related metadata.\\nStructure is documented below."'),
      relatedUrl: {
