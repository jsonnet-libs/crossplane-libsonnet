  ...
  spec: {
    ...
    forProvider: {
      ...
      source: {
        ...
        withFiles(files): { spec+: { forProvider+: { source+: { files: if std.isArray(v=files) then files else [files] } } } },
        ...
        withFilesMixin(files): { spec+: { forProvider+: { source+: { files+: if std.isArray(v=files) then files else [files] } } } },
        ...
        withLanguage(language): { spec+: { forProvider+: { source+: { language: language } } } },
      },
    ...
    initProvider: {
      ...
      source: {
        ...
        '#withFiles':: d.fn(help='"File set constituting the Source bundle."', args=[d.arg(name='files', type=d.T.array)]),
        withFiles(files): { spec+: { initProvider+: { source+: { files: if std.isArray(v=files) then files else [files] } } } },
        '#withFilesMixin':: d.fn(help='"File set constituting the Source bundle."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='files', type=d.T.array)]),
        withFilesMixin(files): { spec+: { initProvider+: { source+: { files+: if std.isArray(v=files) then files else [files] } } } },
        '#withLanguage':: d.fn(help='"Language of the Source bundle. If unspecified, the language will default to FIREBASE_RULES. Possible values: LANGUAGE_UNSPECIFIED, FIREBASE_RULES, EVENT_FLOW_TRIGGERS"', args=[d.arg(name='language', type=d.T.string)]),
        withLanguage(language): { spec+: { initProvider+: { source+: { language: language } } } },
      },
      '#withProject':: d.fn(help='"The project for the resource"', args=[d.arg(name='project', type=d.T.string)]),
