  ...
  spec: {
    ...
    forProvider: {
      ...
      fileShares: {
        ...
        withSourceBackup(sourceBackup): { sourceBackup: sourceBackup },
      },
      ...
      '#withFileShares':: d.fn(help='"File system shares on the instance. For this version, only a\\nsingle file share is supported.\\nStructure is documented below."', args=[d.arg(name='fileShares', type=d.T.array)]),
      withFileShares(fileShares): { spec+: { forProvider+: { fileShares: if std.isArray(v=fileShares) then fileShares else [fileShares] } } },
      '#withFileSharesMixin':: d.fn(help='"File system shares on the instance. For this version, only a\\nsingle file share is supported.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fileShares', type=d.T.array)]),
