{
  ...
  '#':: d.pkg(name='certificateTemplateIAMMember', url='', help='"CertificateTemplateIAMMember is the Schema for the CertificateTemplateIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of CertificateTemplateIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CertificateTemplateIAMMemberSpec defines the desired state of CertificateTemplateIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCertificateTemplate':: d.fn(help='', args=[d.arg(name='certificateTemplate', type=d.T.string)]),
