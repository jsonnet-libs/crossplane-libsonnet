{
  ...
  '#':: d.pkg(name='backup', url='', help='"Backup is the Schema for the Backups API. An AlloyDB Backup."'),
  ...
  spec: {
    ...
    forProvider: {
      '#clusterNameRef':: d.obj(help='"Reference to a Cluster in alloydb to populate clusterName."'),
      clusterNameRef: {
      ...
      '#clusterNameSelector':: d.obj(help='"Selector for a Cluster in alloydb to populate clusterName."'),
      clusterNameSelector: {
      ...
      '#withClusterName':: d.fn(help='"The full resource name of the backup source cluster (e.g., projects/{project}/locations/{location}/clusters/{clusterId})."', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withDescription':: d.fn(help='"User-provided description of the backup."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"User-settable and human-readable display name for the Backup."', args=[d.arg(name='displayName', type=d.T.string)]),
      ...
      '#withLabels':: d.fn(help='"User-defined labels for the alloydb backup. An object containing a list of \\"key\\": value pairs. Example: { \\"name\\": \\"wrench\\", \\"mass\\": \\"1.3kg\\", \\"count\\": \\"3\\" }."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"User-defined labels for the alloydb backup. An object containing a list of \\"key\\": value pairs. Example: { \\"name\\": \\"wrench\\", \\"mass\\": \\"1.3kg\\", \\"count\\": \\"3\\" }."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withLocation':: d.fn(help='"The location where the alloydb backup should reside."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The backup type, which suggests the trigger for the backup.\\nPossible values are: TYPE_UNSPECIFIED, ON_DEMAND, AUTOMATED, CONTINUOUS."', args=[d.arg(name='type', type=d.T.string)]),
