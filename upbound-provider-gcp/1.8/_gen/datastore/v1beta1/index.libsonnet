{
  ...
  '#':: d.pkg(name='index', url='', help='"Index is the Schema for the Indexs API. Describes a composite index for Firestore in Datastore Mode."'),
  ...
  spec: {
    ...
    forProvider: {
      '#properties':: d.obj(help='"An ordered list of properties to index on.\\nStructure is documented below."'),
      properties: {
        '#withDirection':: d.fn(help='"The direction the index should optimize for sorting.\\nPossible values are: ASCENDING, DESCENDING."', args=[d.arg(name='direction', type=d.T.string)]),
      ...
      '#withAncestor':: d.fn(help='"Policy for including ancestors in the index.\\nDefault value is NONE.\\nPossible values are: NONE, ALL_ANCESTORS."', args=[d.arg(name='ancestor', type=d.T.string)]),
