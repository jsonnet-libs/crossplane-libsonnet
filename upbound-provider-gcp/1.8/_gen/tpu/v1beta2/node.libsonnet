{
  ...
  new(name): {
    apiVersion: 'tpu.gcp.upbound.io/v1beta2',
    kind: 'Node',
  ...
  spec: {
    ...
    forProvider: {
      ...
      schedulingConfig: {
        ...
        withPreemptible(preemptible): { spec+: { forProvider+: { schedulingConfig+: { preemptible: preemptible } } } },
      },
    ...
    initProvider: {
      ...
      schedulingConfig: {
        '#withPreemptible':: d.fn(help='"Defines whether the TPU instance is preemptible."', args=[d.arg(name='preemptible', type=d.T.boolean)]),
        withPreemptible(preemptible): { spec+: { initProvider+: { schedulingConfig+: { preemptible: preemptible } } } },
      },
      '#withAcceleratorType':: d.fn(help='"The type of hardware accelerators associated with this node."', args=[d.arg(name='acceleratorType', type=d.T.string)]),
