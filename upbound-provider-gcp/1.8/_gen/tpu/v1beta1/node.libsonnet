{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#schedulingConfig':: d.obj(help='"Sets the scheduling options for this TPU instance.\\nStructure is documented below."'),
      schedulingConfig: {
      ...
      '#withNetwork':: d.fn(help='"The name of a network to peer the TPU node to. It must be a\\npreexisting Compute Engine network inside of the project on which\\nthis API has been activated. If none is provided, \\"default\\" will be\\nused."', args=[d.arg(name='network', type=d.T.string)]),
      ...
      '#withSchedulingConfig':: d.fn(help='"Sets the scheduling options for this TPU instance.\\nStructure is documented below."', args=[d.arg(name='schedulingConfig', type=d.T.array)]),
