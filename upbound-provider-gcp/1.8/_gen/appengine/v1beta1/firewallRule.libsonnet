{
  ...
  '#':: d.pkg(name='firewallRule', url='', help='"FirewallRule is the Schema for the FirewallRules API. A single firewall rule that is evaluated against incoming traffic and provides an action to take on matched requests."'),
  ...
  '#new':: d.fn(help='new returns an instance of FirewallRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FirewallRuleSpec defines the desired state of FirewallRule"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#projectRef':: d.obj(help='"Reference to a Application in appengine to populate project."'),
      projectRef: {
      ...
      '#projectSelector':: d.obj(help='"Selector for a Application in appengine to populate project."'),
      projectSelector: {
      ...
      '#withAction':: d.fn(help='"The action to take if this rule matches.\\nPossible values are: UNSPECIFIED_ACTION, ALLOW, DENY."', args=[d.arg(name='action', type=d.T.string)]),
      ...
      '#withPriority':: d.fn(help='"A positive integer that defines the order of rule evaluation.\\nRules with the lowest priority are evaluated first.\\nA default rule at priority Int32.MaxValue matches all IPv4 and\\nIPv6 traffic when no previous rule matches. Only the action of\\nthis rule can be modified by the user."', args=[d.arg(name='priority', type=d.T.number)]),
      ...
      withSourceRange(sourceRange): { spec+: { forProvider+: { sourceRange: sourceRange } } },
    },
    ...
    initProvider: {
      ...
      '#withSourceRange':: d.fn(help='"IP address or range, defined using CIDR notation, of requests that this rule applies to."', args=[d.arg(name='sourceRange', type=d.T.string)]),
      withSourceRange(sourceRange): { spec+: { initProvider+: { sourceRange: sourceRange } } },
    },
