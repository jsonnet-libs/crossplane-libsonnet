{
  ...
  '#':: d.pkg(name='serviceNetworkSettings', url='', help='"ServiceNetworkSettings is the Schema for the ServiceNetworkSettingss API. A NetworkSettings resource is a container for ingress settings for a version or service."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceNetworkSettings', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#networkSettings':: d.obj(help='"Ingress settings for this service. Will apply to all versions.\\nStructure is documented below."'),
      networkSettings: {
        '#withIngressTrafficAllowed':: d.fn(help='"The ingress settings for version or service.\\nDefault value is INGRESS_TRAFFIC_ALLOWED_UNSPECIFIED.\\nPossible values are: INGRESS_TRAFFIC_ALLOWED_UNSPECIFIED, INGRESS_TRAFFIC_ALLOWED_ALL, INGRESS_TRAFFIC_ALLOWED_INTERNAL_ONLY, INGRESS_TRAFFIC_ALLOWED_INTERNAL_AND_LB."', args=[d.arg(name='ingressTrafficAllowed', type=d.T.string)]),
        withIngressTrafficAllowed(ingressTrafficAllowed): { ingressTrafficAllowed: ingressTrafficAllowed },
      },
      '#serviceRef':: d.obj(help='"Reference to a StandardAppVersion in appengine to populate service."'),
      serviceRef: {
      ...
      '#serviceSelector':: d.obj(help='"Selector for a StandardAppVersion in appengine to populate service."'),
      serviceSelector: {
      ...
      '#withNetworkSettings':: d.fn(help='"Ingress settings for this service. Will apply to all versions.\\nStructure is documented below."', args=[d.arg(name='networkSettings', type=d.T.array)]),
      withNetworkSettings(networkSettings): { spec+: { forProvider+: { networkSettings: if std.isArray(v=networkSettings) then networkSettings else [networkSettings] } } },
      '#withNetworkSettingsMixin':: d.fn(help='"Ingress settings for this service. Will apply to all versions.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networkSettings', type=d.T.array)]),
      withNetworkSettingsMixin(networkSettings): { spec+: { forProvider+: { networkSettings+: if std.isArray(v=networkSettings) then networkSettings else [networkSettings] } } },
      ...
      '#withService':: d.fn(help='"The name of the service these settings apply to."', args=[d.arg(name='service', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withNetworkSettings':: d.fn(help='"Ingress settings for this service. Will apply to all versions.\\nStructure is documented below."', args=[d.arg(name='networkSettings', type=d.T.array)]),
      withNetworkSettings(networkSettings): { spec+: { initProvider+: { networkSettings: if std.isArray(v=networkSettings) then networkSettings else [networkSettings] } } },
      '#withNetworkSettingsMixin':: d.fn(help='"Ingress settings for this service. Will apply to all versions.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networkSettings', type=d.T.array)]),
      withNetworkSettingsMixin(networkSettings): { spec+: { initProvider+: { networkSettings+: if std.isArray(v=networkSettings) then networkSettings else [networkSettings] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
