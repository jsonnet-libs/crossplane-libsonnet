{
  ...
  spec: {
    ...
    forProvider: {
      '#dispatchRules':: d.obj(help='"Rules to match an HTTP request and dispatch that request to a service.\\nStructure is documented below."'),
      dispatchRules: {
        ...
        '#withDomain':: d.fn(help='"Domain name to match against. The wildcard \\"\\" is supported if specified before a period: \\".\\".\\nDefaults to matching all domains: \\"*\\"."', args=[d.arg(name='domain', type=d.T.string)]),
        withDomain(domain): { domain: domain },
        '#withPath':: d.fn(help='"Pathname within the host. Must start with a \\"/\\". A single \\"*\\" can be included at the end of the path.\\nThe sum of the lengths of the domain and path may not exceed 100 characters."', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { path: path },
        '#withService':: d.fn(help='"Pathname within the host. Must start with a \\"/\\". A single \\"*\\" can be included at the end of the path.\\nThe sum of the lengths of the domain and path may not exceed 100 characters."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { service: service },
      },
      '#withDispatchRules':: d.fn(help='"Rules to match an HTTP request and dispatch that request to a service.\\nStructure is documented below."', args=[d.arg(name='dispatchRules', type=d.T.array)]),
      ...
      '#withDispatchRulesMixin':: d.fn(help='"Rules to match an HTTP request and dispatch that request to a service.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dispatchRules', type=d.T.array)]),
