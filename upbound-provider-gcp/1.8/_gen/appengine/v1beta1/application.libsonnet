{
  ...
  '#':: d.pkg(name='application', url='', help='"Application is the Schema for the Applications API. Allows management of an App Engine application."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      featureSettings: {
        '#withSplitHealthChecks':: d.fn(help='"Set to false to use the legacy health check instead of the readiness\\nand liveness checks."', args=[d.arg(name='splitHealthChecks', type=d.T.boolean)]),
      ...
      iap: {
        '#oauth2ClientSecretSecretRef':: d.obj(help='"OAuth2 client secret to use for the authentication flow.\\nThe SHA-256 hash of the value is returned in the oauth2ClientSecretSha256 field."'),
        ...
        '#withEnabled':: d.fn(help='"Whether the serving infrastructure will authenticate and authorize all incoming requests.\\n(default is false)"', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withDatabaseType':: d.fn(help='"The type of the Cloud Firestore or Cloud Datastore database associated with this application.\\nCan be CLOUD_FIRESTORE or CLOUD_DATASTORE_COMPATIBILITY for new\\ninstances.  To support old instances, the value CLOUD_DATASTORE is accepted by the provider, but will be rejected by the API.\\nTo create a Cloud Firestore database without creating an App Engine application, use the\\ngoogle_firestore_database\\nresource instead."', args=[d.arg(name='databaseType', type=d.T.string)]),
      withDatabaseType(databaseType): { spec+: { forProvider+: { databaseType: databaseType } } },
      '#withFeatureSettings':: d.fn(help='"A block of optional settings to configure specific App Engine features:"', args=[d.arg(name='featureSettings', type=d.T.array)]),
      withFeatureSettings(featureSettings): { spec+: { forProvider+: { featureSettings: if std.isArray(v=featureSettings) then featureSettings else [featureSettings] } } },
      '#withFeatureSettingsMixin':: d.fn(help='"A block of optional settings to configure specific App Engine features:"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='featureSettings', type=d.T.array)]),
      withFeatureSettingsMixin(featureSettings): { spec+: { forProvider+: { featureSettings+: if std.isArray(v=featureSettings) then featureSettings else [featureSettings] } } },
      ...
      '#withLocationId':: d.fn(help='"The location\\nto serve the app from."', args=[d.arg(name='locationId', type=d.T.string)]),
      withLocationId(locationId): { spec+: { forProvider+: { locationId: locationId } } },
      '#withProject':: d.fn(help='"The project ID to create the application under.\\n~>NOTE: GCP only accepts project ID, not project number. If you are using number,\\nyou may get a \\"Permission denied\\" error."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { forProvider+: { project: project } } },
      '#withServingStatus':: d.fn(help='"The serving status of the app."', args=[d.arg(name='servingStatus', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAuthDomain':: d.fn(help="\"The domain to authenticate users with when using App Engine's User API.\"", args=[d.arg(name='authDomain', type=d.T.string)]),
      withAuthDomain(authDomain): { spec+: { initProvider+: { authDomain: authDomain } } },
      '#withDatabaseType':: d.fn(help='"The type of the Cloud Firestore or Cloud Datastore database associated with this application.\\nCan be CLOUD_FIRESTORE or CLOUD_DATASTORE_COMPATIBILITY for new\\ninstances.  To support old instances, the value CLOUD_DATASTORE is accepted by the provider, but will be rejected by the API.\\nTo create a Cloud Firestore database without creating an App Engine application, use the\\ngoogle_firestore_database\\nresource instead."', args=[d.arg(name='databaseType', type=d.T.string)]),
      withDatabaseType(databaseType): { spec+: { initProvider+: { databaseType: databaseType } } },
      '#withFeatureSettings':: d.fn(help='"A block of optional settings to configure specific App Engine features:"', args=[d.arg(name='featureSettings', type=d.T.array)]),
      withFeatureSettings(featureSettings): { spec+: { initProvider+: { featureSettings: if std.isArray(v=featureSettings) then featureSettings else [featureSettings] } } },
      '#withFeatureSettingsMixin':: d.fn(help='"A block of optional settings to configure specific App Engine features:"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='featureSettings', type=d.T.array)]),
      withFeatureSettingsMixin(featureSettings): { spec+: { initProvider+: { featureSettings+: if std.isArray(v=featureSettings) then featureSettings else [featureSettings] } } },
      '#withIap':: d.fn(help='"Settings for enabling Cloud Identity Aware Proxy"', args=[d.arg(name='iap', type=d.T.array)]),
      ...
      '#withServingStatus':: d.fn(help='"The serving status of the app."', args=[d.arg(name='servingStatus', type=d.T.string)]),
      withServingStatus(servingStatus): { spec+: { initProvider+: { servingStatus: servingStatus } } },
    },
