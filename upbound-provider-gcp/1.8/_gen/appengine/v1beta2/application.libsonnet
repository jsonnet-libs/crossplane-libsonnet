  ...
  spec: {
    ...
    forProvider: {
      ...
      featureSettings: {
        ...
        withSplitHealthChecks(splitHealthChecks): { spec+: { forProvider+: { featureSettings+: { splitHealthChecks: splitHealthChecks } } } },
      },
      ...
      iap: {
        ...
        withEnabled(enabled): { spec+: { forProvider+: { iap+: { enabled: enabled } } } },
    ...
    initProvider: {
      ...
      featureSettings: {
        '#withSplitHealthChecks':: d.fn(help='"Set to false to use the legacy health check instead of the readiness\\nand liveness checks."', args=[d.arg(name='splitHealthChecks', type=d.T.boolean)]),
        withSplitHealthChecks(splitHealthChecks): { spec+: { initProvider+: { featureSettings+: { splitHealthChecks: splitHealthChecks } } } },
      },
      '#iap':: d.obj(help='"Settings for enabling Cloud Identity Aware Proxy"'),
      iap: {
        '#oauth2ClientSecretSecretRef':: d.obj(help='"OAuth2 client secret to use for the authentication flow.\\nThe SHA-256 hash of the value is returned in the oauth2ClientSecretSha256 field."'),
        ...
        '#withEnabled':: d.fn(help='"Whether the serving infrastructure will authenticate and authorize all incoming requests.\\n(default is false)"', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { initProvider+: { iap+: { enabled: enabled } } } },
        '#withOauth2ClientId':: d.fn(help='"OAuth2 client ID to use for the authentication flow."', args=[d.arg(name='oauth2ClientId', type=d.T.string)]),
