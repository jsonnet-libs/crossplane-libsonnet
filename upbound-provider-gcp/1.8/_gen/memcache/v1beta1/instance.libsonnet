{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMemcacheParameters':: d.fn(help='"User-specified parameters for this memcache instance.\\nStructure is documented below."', args=[d.arg(name='memcacheParameters', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withMemcacheParameters':: d.fn(help='"User-specified parameters for this memcache instance.\\nStructure is documented below."', args=[d.arg(name='memcacheParameters', type=d.T.array)]),
      withMemcacheParameters(memcacheParameters): { spec+: { initProvider+: { memcacheParameters: if std.isArray(v=memcacheParameters) then memcacheParameters else [memcacheParameters] } } },
      '#withMemcacheParametersMixin':: d.fn(help='"User-specified parameters for this memcache instance.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='memcacheParameters', type=d.T.array)]),
      withMemcacheParametersMixin(memcacheParameters): { spec+: { initProvider+: { memcacheParameters+: if std.isArray(v=memcacheParameters) then memcacheParameters else [memcacheParameters] } } },
      '#withMemcacheVersion':: d.fn(help='"The major version of Memcached software. If not provided, latest supported version will be used.\\nCurrently the latest supported major version is MEMCACHE_1_5. The minor version will be automatically\\ndetermined by our system based on the latest supported minor version.\\nDefault value is MEMCACHE_1_5.\\nPossible values are: MEMCACHE_1_5, MEMCACHE_1_6_15."', args=[d.arg(name='memcacheVersion', type=d.T.string)]),
