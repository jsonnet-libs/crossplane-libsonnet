{
  ...
  new(name): {
    apiVersion: 'memcache.gcp.upbound.io/v1beta2',
    kind: 'Instance',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#memcacheParameters':: d.obj(help='"User-specified parameters for this memcache instance.\\nStructure is documented below."'),
      memcacheParameters: {
        ...
        withParams(params): { spec+: { forProvider+: { memcacheParameters+: { params: params } } } },
        ...
        withParamsMixin(params): { spec+: { forProvider+: { memcacheParameters+: { params+: params } } } },
      },
      '#nodeConfig':: d.obj(help='"Configuration for memcache nodes.\\nStructure is documented below."'),
      nodeConfig: {
        '#withCpuCount':: d.fn(help='"Number of CPUs per node."', args=[d.arg(name='cpuCount', type=d.T.number)]),
        withCpuCount(cpuCount): { spec+: { forProvider+: { nodeConfig+: { cpuCount: cpuCount } } } },
        '#withMemorySizeMb':: d.fn(help='"Memory size in Mebibytes for each memcache node."', args=[d.arg(name='memorySizeMb', type=d.T.number)]),
        withMemorySizeMb(memorySizeMb): { spec+: { forProvider+: { nodeConfig+: { memorySizeMb: memorySizeMb } } } },
      },
      '#withAuthorizedNetwork':: d.fn(help="\"The full name of the GCE network to connect the instance to.  If not provided,\\n'default' will be used.\"", args=[d.arg(name='authorizedNetwork', type=d.T.string)]),
      ...
      '#withReservedIpRangeId':: d.fn(help='"Contains the name of allocated IP address ranges associated with\\nthe private service access connection for example, \\"test-default\\"\\nassociated with IP range 10.0.0.0/29."', args=[d.arg(name='reservedIpRangeId', type=d.T.array)]),
      withReservedIpRangeId(reservedIpRangeId): { spec+: { forProvider+: { reservedIpRangeId: if std.isArray(v=reservedIpRangeId) then reservedIpRangeId else [reservedIpRangeId] } } },
      '#withReservedIpRangeIdMixin':: d.fn(help='"Contains the name of allocated IP address ranges associated with\\nthe private service access connection for example, \\"test-default\\"\\nassociated with IP range 10.0.0.0/29."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reservedIpRangeId', type=d.T.array)]),
      withReservedIpRangeIdMixin(reservedIpRangeId): { spec+: { forProvider+: { reservedIpRangeId+: if std.isArray(v=reservedIpRangeId) then reservedIpRangeId else [reservedIpRangeId] } } },
      '#withZones':: d.fn(help='"Zones where memcache nodes should be provisioned.  If not\\nprovided, all zones will be used."', args=[d.arg(name='zones', type=d.T.array)]),
      withZones(zones): { spec+: { forProvider+: { zones: if std.isArray(v=zones) then zones else [zones] } } },
      '#withZonesMixin':: d.fn(help='"Zones where memcache nodes should be provisioned.  If not\\nprovided, all zones will be used."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zones', type=d.T.array)]),
    ...
    initProvider: {
      ...
      memcacheParameters: {
        '#withParams':: d.fn(help='"User-defined set of parameters to use in the memcache process."', args=[d.arg(name='params', type=d.T.object)]),
        withParams(params): { spec+: { initProvider+: { memcacheParameters+: { params: params } } } },
        '#withParamsMixin':: d.fn(help='"User-defined set of parameters to use in the memcache process."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='params', type=d.T.object)]),
        withParamsMixin(params): { spec+: { initProvider+: { memcacheParameters+: { params+: params } } } },
      },
      '#nodeConfig':: d.obj(help='"Configuration for memcache nodes.\\nStructure is documented below."'),
      nodeConfig: {
        '#withCpuCount':: d.fn(help='"Number of CPUs per node."', args=[d.arg(name='cpuCount', type=d.T.number)]),
        withCpuCount(cpuCount): { spec+: { initProvider+: { nodeConfig+: { cpuCount: cpuCount } } } },
        '#withMemorySizeMb':: d.fn(help='"Memory size in Mebibytes for each memcache node."', args=[d.arg(name='memorySizeMb', type=d.T.number)]),
        withMemorySizeMb(memorySizeMb): { spec+: { initProvider+: { nodeConfig+: { memorySizeMb: memorySizeMb } } } },
      },
      '#withAuthorizedNetwork':: d.fn(help="\"The full name of the GCE network to connect the instance to.  If not provided,\\n'default' will be used.\"", args=[d.arg(name='authorizedNetwork', type=d.T.string)]),
      ...
      '#withMemcacheVersion':: d.fn(help='"The major version of Memcached software. If not provided, latest supported version will be used.\\nCurrently the latest supported major version is MEMCACHE_1_5. The minor version will be automatically\\ndetermined by our system based on the latest supported minor version.\\nDefault value is MEMCACHE_1_5.\\nPossible values are: MEMCACHE_1_5, MEMCACHE_1_6_15."', args=[d.arg(name='memcacheVersion', type=d.T.string)]),
      withMemcacheVersion(memcacheVersion): { spec+: { initProvider+: { memcacheVersion: memcacheVersion } } },
      '#withName':: d.fn(help='"The resource name of the instance."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withReservedIpRangeId':: d.fn(help='"Contains the name of allocated IP address ranges associated with\\nthe private service access connection for example, \\"test-default\\"\\nassociated with IP range 10.0.0.0/29."', args=[d.arg(name='reservedIpRangeId', type=d.T.array)]),
      withReservedIpRangeId(reservedIpRangeId): { spec+: { initProvider+: { reservedIpRangeId: if std.isArray(v=reservedIpRangeId) then reservedIpRangeId else [reservedIpRangeId] } } },
      '#withReservedIpRangeIdMixin':: d.fn(help='"Contains the name of allocated IP address ranges associated with\\nthe private service access connection for example, \\"test-default\\"\\nassociated with IP range 10.0.0.0/29."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reservedIpRangeId', type=d.T.array)]),
      withReservedIpRangeIdMixin(reservedIpRangeId): { spec+: { initProvider+: { reservedIpRangeId+: if std.isArray(v=reservedIpRangeId) then reservedIpRangeId else [reservedIpRangeId] } } },
      '#withZones':: d.fn(help='"Zones where memcache nodes should be provisioned.  If not\\nprovided, all zones will be used."', args=[d.arg(name='zones', type=d.T.array)]),
