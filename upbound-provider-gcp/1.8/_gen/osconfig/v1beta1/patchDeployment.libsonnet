  ...
  spec: {
    ...
    forProvider: {
      ...
      patchConfig: {
        ...
        postStep: {
          ...
          linuxExecStepConfig: {
            ...
            '#withGcsObject':: d.fn(help='"A Cloud Storage object containing the executable.\\nStructure is documented below."', args=[d.arg(name='gcsObject', type=d.T.array)]),
          ...
          '#withLinuxExecStepConfig':: d.fn(help='"The ExecStepConfig for all Linux VMs targeted by the PatchJob.\\nStructure is documented below."', args=[d.arg(name='linuxExecStepConfig', type=d.T.array)]),
          ...
          '#withWindowsExecStepConfig':: d.fn(help='"The ExecStepConfig for all Windows VMs targeted by the PatchJob.\\nStructure is documented below."', args=[d.arg(name='windowsExecStepConfig', type=d.T.array)]),
        ...
        '#withApt':: d.fn(help='"Apt update settings. Use this setting to override the default apt patch rules.\\nStructure is documented below."', args=[d.arg(name='apt', type=d.T.array)]),
        ...
        '#withGoo':: d.fn(help='"goo update settings. Use this setting to override the default goo patch rules.\\nStructure is documented below."', args=[d.arg(name='goo', type=d.T.array)]),
        ...
        '#withPostStep':: d.fn(help='"The ExecStep to run after the patch update.\\nStructure is documented below."', args=[d.arg(name='postStep', type=d.T.array)]),
        ...
        '#withPreStep':: d.fn(help='"The ExecStep to run before the patch update.\\nStructure is documented below."', args=[d.arg(name='preStep', type=d.T.array)]),
        ...
        '#withWindowsUpdate':: d.fn(help='"Windows update settings. Use this setting to override the default Windows patch rules.\\nStructure is documented below."', args=[d.arg(name='windowsUpdate', type=d.T.array)]),
        ...
        '#withYum':: d.fn(help='"Yum update settings. Use this setting to override the default yum patch rules.\\nStructure is documented below."', args=[d.arg(name='yum', type=d.T.array)]),
        ...
        '#withZypper':: d.fn(help='"zypper update settings. Use this setting to override the default zypper patch rules.\\nStructure is documented below."', args=[d.arg(name='zypper', type=d.T.array)]),
      ...
      recurringSchedule: {
        ...
        monthly: {
          ...
          weekDayOfMonth: {
            ...
            withDayOffset(dayOffset): { dayOffset: dayOffset },
          ...
          '#withWeekDayOfMonth':: d.fn(help='"Week day in a month.\\nStructure is documented below."', args=[d.arg(name='weekDayOfMonth', type=d.T.array)]),
        ...
        '#withMonthly':: d.fn(help='"Schedule with monthly executions.\\nStructure is documented below."', args=[d.arg(name='monthly', type=d.T.array)]),
        ...
        '#withTimeOfDay':: d.fn(help='"Time of the day to run a recurring deployment.\\nStructure is documented below."', args=[d.arg(name='timeOfDay', type=d.T.array)]),
        ...
        '#withTimeZone':: d.fn(help='"Defines the time zone that timeOfDay is relative to. The rules for daylight saving time are\\ndetermined by the chosen time zone.\\nStructure is documented below."', args=[d.arg(name='timeZone', type=d.T.array)]),
        withTimeZone(timeZone): { timeZone: if std.isArray(v=timeZone) then timeZone else [timeZone] },
        '#withTimeZoneMixin':: d.fn(help='"Defines the time zone that timeOfDay is relative to. The rules for daylight saving time are\\ndetermined by the chosen time zone.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='timeZone', type=d.T.array)]),
        withTimeZoneMixin(timeZone): { timeZone+: if std.isArray(v=timeZone) then timeZone else [timeZone] },
        '#withWeekly':: d.fn(help='"Schedule with weekly executions.\\nStructure is documented below."', args=[d.arg(name='weekly', type=d.T.array)]),
      ...
      rollout: {
        ...
        '#withDisruptionBudget':: d.fn(help='"The maximum number (or percentage) of VMs per zone to disrupt at any given moment. The number of VMs calculated from multiplying the percentage by the total number of VMs in a zone is rounded up.\\nDuring patching, a VM is considered disrupted from the time the agent is notified to begin until patching has completed. This disruption time includes the time to complete reboot and any post-patch steps.\\nA VM contributes to the disruption budget if its patching operation fails either when applying the patches, running pre or post patch steps, or if it fails to respond with a success notification before timing out. VMs that are not running or do not have an active agent do not count toward this disruption budget.\\nFor zone-by-zone rollouts, if the disruption budget in a zone is exceeded, the patch job stops, because continuing to the next zone requires completion of the patch process in the previous zone.\\nFor example, if the disruption budget has a fixed value of 10, and 8 VMs fail to patch in the current zone, the patch job continues to patch 2 VMs at a time until the zone is completed. When that zone is completed successfully, patching begins with 10 VMs at a time in the next zone. If 10 VMs in the next zone fail to patch, the patch job stops.\\nStructure is documented below."', args=[d.arg(name='disruptionBudget', type=d.T.array)]),
        ...
        '#withDisruptionBudgetMixin':: d.fn(help='"The maximum number (or percentage) of VMs per zone to disrupt at any given moment. The number of VMs calculated from multiplying the percentage by the total number of VMs in a zone is rounded up.\\nDuring patching, a VM is considered disrupted from the time the agent is notified to begin until patching has completed. This disruption time includes the time to complete reboot and any post-patch steps.\\nA VM contributes to the disruption budget if its patching operation fails either when applying the patches, running pre or post patch steps, or if it fails to respond with a success notification before timing out. VMs that are not running or do not have an active agent do not count toward this disruption budget.\\nFor zone-by-zone rollouts, if the disruption budget in a zone is exceeded, the patch job stops, because continuing to the next zone requires completion of the patch process in the previous zone.\\nFor example, if the disruption budget has a fixed value of 10, and 8 VMs fail to patch in the current zone, the patch job continues to patch 2 VMs at a time until the zone is completed. When that zone is completed successfully, patching begins with 10 VMs at a time in the next zone. If 10 VMs in the next zone fail to patch, the patch job stops.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='disruptionBudget', type=d.T.array)]),
      ...
      '#withInstanceFilter':: d.fn(help='"VM instances to patch.\\nStructure is documented below."', args=[d.arg(name='instanceFilter', type=d.T.array)]),
      ...
      '#withOneTimeSchedule':: d.fn(help='"Schedule a one-time execution.\\nStructure is documented below."', args=[d.arg(name='oneTimeSchedule', type=d.T.array)]),
      ...
      '#withPatchConfig':: d.fn(help='"Patch configuration that is applied.\\nStructure is documented below."', args=[d.arg(name='patchConfig', type=d.T.array)]),
      ...
      '#withRecurringSchedule':: d.fn(help='"Schedule recurring executions.\\nStructure is documented below."', args=[d.arg(name='recurringSchedule', type=d.T.array)]),
      ...
      '#withRollout':: d.fn(help='"Rollout strategy of the patch job.\\nStructure is documented below."', args=[d.arg(name='rollout', type=d.T.array)]),
