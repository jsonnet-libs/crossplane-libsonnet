  ...
  spec: {
    ...
    initProvider: {
      ...
      alternativeNameServerConfig: {
        ...
        '#withTargetNameServers':: d.fn(help='"Sets an alternative name server for the associated networks. When specified,\\nall DNS queries are forwarded to a name server that you choose. Names such as .internal\\nare not available when an alternative name server is specified.\\nStructure is documented below."', args=[d.arg(name='targetNameServers', type=d.T.array)]),
        withTargetNameServers(targetNameServers): { spec+: { initProvider+: { alternativeNameServerConfig+: { targetNameServers: if std.isArray(v=targetNameServers) then targetNameServers else [targetNameServers] } } } },
        '#withTargetNameServersMixin':: d.fn(help='"Sets an alternative name server for the associated networks. When specified,\\nall DNS queries are forwarded to a name server that you choose. Names such as .internal\\nare not available when an alternative name server is specified.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetNameServers', type=d.T.array)]),
        withTargetNameServersMixin(targetNameServers): { spec+: { initProvider+: { alternativeNameServerConfig+: { targetNameServers+: if std.isArray(v=targetNameServers) then targetNameServers else [targetNameServers] } } } },
      },
      '#networks':: d.obj(help='"List of network names specifying networks to which this policy is applied.\\nStructure is documented below."'),
      networks: {
        '#networkRef':: d.obj(help='"Reference to a Network in compute to populate networkUrl."'),
