{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAlternativeNameServerConfig':: d.fn(help='"Sets an alternative name server for the associated networks.\\nWhen specified, all DNS queries are forwarded to a name server that you choose.\\nNames such as .internal are not available when an alternative name server is specified.\\nStructure is documented below."', args=[d.arg(name='alternativeNameServerConfig', type=d.T.array)]),
      ...
      '#withNetworks':: d.fn(help='"List of network names specifying networks to which this policy is applied.\\nStructure is documented below."', args=[d.arg(name='networks', type=d.T.array)]),
