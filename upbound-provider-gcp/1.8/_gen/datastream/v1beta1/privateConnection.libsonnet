{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVpcPeeringConfig':: d.fn(help="\"The VPC Peering configuration is used to create VPC peering\\nbetween Datastream and the consumer's VPC.\\nStructure is documented below.\"", args=[d.arg(name='vpcPeeringConfig', type=d.T.array)]),
