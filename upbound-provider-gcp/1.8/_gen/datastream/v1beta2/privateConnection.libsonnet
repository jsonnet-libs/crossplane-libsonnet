{
  ...
  '#':: d.pkg(name='privateConnection', url='', help="\"PrivateConnection is the Schema for the PrivateConnections API. The PrivateConnection resource is used to establish private connectivity between Datastream and a customer's network.\""),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateConnection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"PrivateConnectionSpec defines the desired state of PrivateConnection"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#vpcPeeringConfig':: d.obj(help="\"The VPC Peering configuration is used to create VPC peering\\nbetween Datastream and the consumer's VPC.\\nStructure is documented below.\""),
      vpcPeeringConfig: {
        '#vpcRef':: d.obj(help='"Reference to a Network in compute to populate vpc."'),
        vpcRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcRef+: { policy+: { resolution: resolution } } } } } },
            ...
            withResolve(resolve): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcRef+: { name: name } } } } },
        },
        '#vpcSelector':: d.obj(help='"Selector for a Network in compute to populate vpc."'),
        vpcSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcSelector+: { policy+: { resolve: resolve } } } } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { vpcPeeringConfig+: { vpcSelector+: { matchLabels+: matchLabels } } } } },
        },
        '#withSubnet':: d.fn(help='"A free subnet for peering. (CIDR of /29)"', args=[d.arg(name='subnet', type=d.T.string)]),
        withSubnet(subnet): { spec+: { forProvider+: { vpcPeeringConfig+: { subnet: subnet } } } },
        '#withVpc':: d.fn(help='"Fully qualified name of the VPC that Datastream will peer to.\\nFormat: projects/{project}/global/{networks}/{name}"', args=[d.arg(name='vpc', type=d.T.string)]),
        withVpc(vpc): { spec+: { forProvider+: { vpcPeeringConfig+: { vpc: vpc } } } },
      },
      '#withCreateWithoutValidation':: d.fn(help='"If set to true, will skip validations."', args=[d.arg(name='createWithoutValidation', type=d.T.boolean)]),
      ...
      '#withLocation':: d.fn(help='"The name of the location this private connection is located in."', args=[d.arg(name='location', type=d.T.string)]),
    ...
    initProvider: {
      ...
      vpcPeeringConfig: {
        ...
        vpcRef: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcRef+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcRef+: { policy+: { resolve: resolve } } } } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcRef+: { name: name } } } } },
        },
        '#vpcSelector':: d.obj(help='"Selector for a Network in compute to populate vpc."'),
        vpcSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcSelector+: { policy+: { resolution: resolution } } } } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcSelector+: { policy+: { resolve: resolve } } } } } },
          },
          '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
          withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcSelector+: { matchControllerRef: matchControllerRef } } } } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcSelector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { vpcPeeringConfig+: { vpcSelector+: { matchLabels+: matchLabels } } } } },
        },
        '#withSubnet':: d.fn(help='"A free subnet for peering. (CIDR of /29)"', args=[d.arg(name='subnet', type=d.T.string)]),
        withSubnet(subnet): { spec+: { initProvider+: { vpcPeeringConfig+: { subnet: subnet } } } },
        '#withVpc':: d.fn(help='"Fully qualified name of the VPC that Datastream will peer to.\\nFormat: projects/{project}/global/{networks}/{name}"', args=[d.arg(name='vpc', type=d.T.string)]),
        withVpc(vpc): { spec+: { initProvider+: { vpcPeeringConfig+: { vpc: vpc } } } },
      },
      '#withCreateWithoutValidation':: d.fn(help='"If set to true, will skip validations."', args=[d.arg(name='createWithoutValidation', type=d.T.boolean)]),
