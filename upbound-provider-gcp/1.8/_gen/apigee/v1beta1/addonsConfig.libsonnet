{
  ...
  '#':: d.pkg(name='addonsConfig', url='', help='"AddonsConfig is the Schema for the AddonsConfigs API. Configures the add-ons for the Apigee organization."'),
  ...
  '#new':: d.fn(help='new returns an instance of AddonsConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AddonsConfigSpec defines the desired state of AddonsConfig"'),
  spec: {
    ...
    forProvider: {
      ...
      addonsConfig: {
        ...
        advancedApiOpsConfig: {
          ...
          withEnabled(enabled): { spec+: { forProvider+: { addonsConfig+: { advancedApiOpsConfig+: { enabled: enabled } } } } },
        },
        '#apiSecurityConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        apiSecurityConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { forProvider+: { addonsConfig+: { apiSecurityConfig+: { enabled: enabled } } } } },
        },
        '#connectorsPlatformConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        connectorsPlatformConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { forProvider+: { addonsConfig+: { connectorsPlatformConfig+: { enabled: enabled } } } } },
        },
        '#integrationConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        integrationConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { forProvider+: { addonsConfig+: { integrationConfig+: { enabled: enabled } } } } },
        },
        '#monetizationConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        monetizationConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { forProvider+: { addonsConfig+: { monetizationConfig+: { enabled: enabled } } } } },
        },
      },
      '#orgRef':: d.obj(help='"Reference to a Organization in apigee to populate org."'),
      orgRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { orgRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { orgRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { orgRef+: { name: name } } } },
      },
      '#orgSelector':: d.obj(help='"Selector for a Organization in apigee to populate org."'),
      orgSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { orgSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { orgSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { orgSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { orgSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { orgSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withOrg':: d.fn(help='"Name of the Apigee organization."', args=[d.arg(name='org', type=d.T.string)]),
    ...
    initProvider: {
      ...
      addonsConfig: {
        ...
        advancedApiOpsConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { addonsConfig+: { advancedApiOpsConfig+: { enabled: enabled } } } } },
        },
        '#apiSecurityConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        apiSecurityConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { addonsConfig+: { apiSecurityConfig+: { enabled: enabled } } } } },
        },
        '#connectorsPlatformConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        connectorsPlatformConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { addonsConfig+: { connectorsPlatformConfig+: { enabled: enabled } } } } },
        },
        '#integrationConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        integrationConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { addonsConfig+: { integrationConfig+: { enabled: enabled } } } } },
        },
        '#monetizationConfig':: d.obj(help='"Configuration for the Monetization add-on.\\nStructure is documented below."'),
        monetizationConfig: {
          '#withEnabled':: d.fn(help='"Flag that specifies whether the Advanced API Ops add-on is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { addonsConfig+: { monetizationConfig+: { enabled: enabled } } } } },
        },
      },
      '#orgRef':: d.obj(help='"Reference to a Organization in apigee to populate org."'),
      orgRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { orgRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { orgRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { orgRef+: { name: name } } } },
      },
      '#orgSelector':: d.obj(help='"Selector for a Organization in apigee to populate org."'),
      orgSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { orgSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { orgSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { orgSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { orgSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { orgSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withOrg':: d.fn(help='"Name of the Apigee organization."', args=[d.arg(name='org', type=d.T.string)]),
