{
  ...
  '#':: d.pkg(name='syncAuthorization', url='', help='"SyncAuthorization is the Schema for the SyncAuthorizations API. Authorize the Synchronizer to download environment data from the control plane."'),
  ...
  '#new':: d.fn(help='new returns an instance of SyncAuthorization', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SyncAuthorizationSpec defines the desired state of SyncAuthorization"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#nameRef':: d.obj(help='"Reference to a Organization in apigee to populate name."'),
      nameRef: {
      ...
      '#nameSelector':: d.obj(help='"Selector for a Organization in apigee to populate name."'),
      nameSelector: {
      ...
      '#withIdentities':: d.fn(help='"Array of service accounts to grant access to control plane resources, each specified using the following format: serviceAccount:service-account-name.\\nThe service-account-name is formatted like an email address. For example: my-synchronizer-manager-serviceAccount@my_project_id.iam.gserviceaccount.com\\nYou might specify multiple service accounts, for example, if you have multiple environments and wish to assign a unique service account to each one.\\nThe service accounts must have Apigee Synchronizer Manager role. See also Create service accounts."', args=[d.arg(name='identities', type=d.T.array)]),
      withIdentities(identities): { spec+: { forProvider+: { identities: if std.isArray(v=identities) then identities else [identities] } } },
      '#withIdentitiesMixin':: d.fn(help='"Array of service accounts to grant access to control plane resources, each specified using the following format: serviceAccount:service-account-name.\\nThe service-account-name is formatted like an email address. For example: my-synchronizer-manager-serviceAccount@my_project_id.iam.gserviceaccount.com\\nYou might specify multiple service accounts, for example, if you have multiple environments and wish to assign a unique service account to each one.\\nThe service accounts must have Apigee Synchronizer Manager role. See also Create service accounts."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identities', type=d.T.array)]),
      withIdentitiesMixin(identities): { spec+: { forProvider+: { identities+: if std.isArray(v=identities) then identities else [identities] } } },
      '#withName':: d.fn(help='"Name of the Apigee organization."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      '#withIdentities':: d.fn(help='"Array of service accounts to grant access to control plane resources, each specified using the following format: serviceAccount:service-account-name.\\nThe service-account-name is formatted like an email address. For example: my-synchronizer-manager-serviceAccount@my_project_id.iam.gserviceaccount.com\\nYou might specify multiple service accounts, for example, if you have multiple environments and wish to assign a unique service account to each one.\\nThe service accounts must have Apigee Synchronizer Manager role. See also Create service accounts."', args=[d.arg(name='identities', type=d.T.array)]),
      withIdentities(identities): { spec+: { initProvider+: { identities: if std.isArray(v=identities) then identities else [identities] } } },
      '#withIdentitiesMixin':: d.fn(help='"Array of service accounts to grant access to control plane resources, each specified using the following format: serviceAccount:service-account-name.\\nThe service-account-name is formatted like an email address. For example: my-synchronizer-manager-serviceAccount@my_project_id.iam.gserviceaccount.com\\nYou might specify multiple service accounts, for example, if you have multiple environments and wish to assign a unique service account to each one.\\nThe service accounts must have Apigee Synchronizer Manager role. See also Create service accounts."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identities', type=d.T.array)]),
      withIdentitiesMixin(identities): { spec+: { initProvider+: { identities+: if std.isArray(v=identities) then identities else [identities] } } },
    },
