{
  ...
  spec: {
    ...
    forProvider: {
      '#nodeConfig':: d.obj(help='"NodeConfig for setting the min/max number of nodes associated with the environment.\\nStructure is documented below."'),
      nodeConfig: {
        '#withMaxNodeCount':: d.fn(help='"The maximum total number of gateway nodes that the is reserved for all instances that\\nhas the specified environment. If not specified, the default is determined by the\\nrecommended maximum number of nodes for that gateway."', args=[d.arg(name='maxNodeCount', type=d.T.string)]),
        withMaxNodeCount(maxNodeCount): { maxNodeCount: maxNodeCount },
        '#withMinNodeCount':: d.fn(help='"The minimum total number of gateway nodes that the is reserved for all instances that\\nhas the specified environment. If not specified, the default is determined by the\\nrecommended minimum number of nodes for that gateway."', args=[d.arg(name='minNodeCount', type=d.T.string)]),
      ...
      '#withApiProxyType':: d.fn(help='"Optional. API Proxy type supported by the environment. The type can be set when creating\\nthe Environment and cannot be changed.\\nPossible values are: API_PROXY_TYPE_UNSPECIFIED, PROGRAMMABLE, CONFIGURABLE."', args=[d.arg(name='apiProxyType', type=d.T.string)]),
      withApiProxyType(apiProxyType): { spec+: { forProvider+: { apiProxyType: apiProxyType } } },
      '#withDeploymentType':: d.fn(help='"Optional. Deployment type supported by the environment. The deployment type can be\\nset when creating the environment and cannot be changed. When you enable archive\\ndeployment, you will be prevented from performing a subset of actions within the\\nenvironment, including:\\nManaging the deployment of API proxy or shared flow revisions;\\nCreating, updating, or deleting resource files;\\nCreating, updating, or deleting target servers.\\nPossible values are: DEPLOYMENT_TYPE_UNSPECIFIED, PROXY, ARCHIVE."', args=[d.arg(name='deploymentType', type=d.T.string)]),
      ...
      '#withForwardProxyUri':: d.fn(help='"Optional. URI of the forward proxy to be applied to the runtime instances in this environment. Must be in the format of {scheme}://{hostname}:{port}. Note that the scheme must be one of \\"http\\" or \\"https\\", and the port must be supplied."', args=[d.arg(name='forwardProxyUri', type=d.T.string)]),
      withForwardProxyUri(forwardProxyUri): { spec+: { forProvider+: { forwardProxyUri: forwardProxyUri } } },
      '#withNodeConfig':: d.fn(help='"NodeConfig for setting the min/max number of nodes associated with the environment.\\nStructure is documented below."', args=[d.arg(name='nodeConfig', type=d.T.array)]),
      withNodeConfig(nodeConfig): { spec+: { forProvider+: { nodeConfig: if std.isArray(v=nodeConfig) then nodeConfig else [nodeConfig] } } },
      '#withNodeConfigMixin':: d.fn(help='"NodeConfig for setting the min/max number of nodes associated with the environment.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeConfig', type=d.T.array)]),
      withNodeConfigMixin(nodeConfig): { spec+: { forProvider+: { nodeConfig+: if std.isArray(v=nodeConfig) then nodeConfig else [nodeConfig] } } },
      '#withOrgId':: d.fn(help='"The Apigee Organization associated with the Apigee environment,\\nin the format organizations/{{org_name}}."', args=[d.arg(name='orgId', type=d.T.string)]),
      withOrgId(orgId): { spec+: { forProvider+: { orgId: orgId } } },
      '#withType':: d.fn(help="\"Types that can be selected for an Environment. Each of the types are\\nlimited by capability and capacity. Refer to Apigee's public documentation\\nto understand about each of these types in details.\\nAn Apigee org can support heterogeneous Environments.\\nPossible values are: ENVIRONMENT_TYPE_UNSPECIFIED, BASE, INTERMEDIATE, COMPREHENSIVE.\"", args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withForwardProxyUri':: d.fn(help='"Optional. URI of the forward proxy to be applied to the runtime instances in this environment. Must be in the format of {scheme}://{hostname}:{port}. Note that the scheme must be one of \\"http\\" or \\"https\\", and the port must be supplied."', args=[d.arg(name='forwardProxyUri', type=d.T.string)]),
      withForwardProxyUri(forwardProxyUri): { spec+: { initProvider+: { forwardProxyUri: forwardProxyUri } } },
      '#withNodeConfig':: d.fn(help='"NodeConfig for setting the min/max number of nodes associated with the environment.\\nStructure is documented below."', args=[d.arg(name='nodeConfig', type=d.T.array)]),
