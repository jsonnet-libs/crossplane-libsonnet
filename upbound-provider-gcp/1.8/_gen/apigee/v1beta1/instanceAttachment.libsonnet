{
  ...
  '#':: d.pkg(name='instanceAttachment', url='', help='"InstanceAttachment is the Schema for the InstanceAttachments API. An"'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceAttachment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"InstanceAttachmentSpec defines the desired state of InstanceAttachment"'),
  spec: {
    ...
    forProvider: {
      ...
      '#instanceIdRef':: d.obj(help='"Reference to a Instance in apigee to populate instanceId."'),
      instanceIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#instanceIdSelector':: d.obj(help='"Selector for a Instance in apigee to populate instanceId."'),
      instanceIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withInstanceId':: d.fn(help='"The Apigee instance associated with the Apigee environment,\\nin the format organizations/{{org_name}}/instances/{{instance_name}}."', args=[d.arg(name='instanceId', type=d.T.string)]),
