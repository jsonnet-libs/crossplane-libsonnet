{
  ...
  '#':: d.pkg(name='defaultObjectACL', url='', help='"DefaultObjectACL is the Schema for the DefaultObjectACLs API. Authoritatively manages the default object ACLs for a Google Cloud Storage bucket"'),
  ...
  '#new':: d.fn(help='new returns an instance of DefaultObjectACL', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DefaultObjectACLSpec defines the desired state of DefaultObjectACL"'),
  spec: {
