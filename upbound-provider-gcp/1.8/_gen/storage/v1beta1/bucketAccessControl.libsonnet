{
  ...
  '#':: d.pkg(name='bucketAccessControl', url='', help='"BucketAccessControl is the Schema for the BucketAccessControls API. Bucket ACLs can be managed authoritatively using the ["'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketAccessControl', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BucketAccessControlSpec defines the desired state of BucketAccessControl"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withRole':: d.fn(help='"The access permission for the entity.\\nPossible values are: OWNER, READER, WRITER."', args=[d.arg(name='role', type=d.T.string)]),
