{
  ...
  '#':: d.pkg(name='objectAccessControl', url='', help='"ObjectAccessControl is the Schema for the ObjectAccessControls API. The ObjectAccessControls resources represent the Access Control Lists (ACLs) for objects within Google Cloud Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of ObjectAccessControl', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ObjectAccessControlSpec defines the desired state of ObjectAccessControl"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEntity':: d.fn(help='"The entity holding the permission, in one of the following forms:"', args=[d.arg(name='entity', type=d.T.string)]),
      withEntity(entity): { spec+: { forProvider+: { entity: entity } } },
      '#withObject':: d.fn(help='"The name of the object to apply the access control to."', args=[d.arg(name='object', type=d.T.string)]),
      withObject(object): { spec+: { forProvider+: { object: object } } },
      '#withRole':: d.fn(help='"The access permission for the entity.\\nPossible values are: OWNER, READER."', args=[d.arg(name='role', type=d.T.string)]),
