{
  ...
  '#':: d.pkg(name='defaultObjectAccessControl', url='', help='"DefaultObjectAccessControl is the Schema for the DefaultObjectAccessControls API. The DefaultObjectAccessControls resources represent the Access Control Lists (ACLs) applied to a new object within a Google Cloud Storage bucket when no ACL was provided for that object."'),
  ...
  '#new':: d.fn(help='new returns an instance of DefaultObjectAccessControl', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DefaultObjectAccessControlSpec defines the desired state of DefaultObjectAccessControl"'),
  spec: {
