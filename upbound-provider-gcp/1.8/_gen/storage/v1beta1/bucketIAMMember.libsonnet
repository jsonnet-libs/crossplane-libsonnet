{
  ...
  '#':: d.pkg(name='bucketIAMMember', url='', help='"BucketIAMMember is the Schema for the BucketIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BucketIAMMemberSpec defines the desired state of BucketIAMMember"'),
  spec: {
