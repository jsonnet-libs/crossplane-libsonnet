{
  ...
  '#':: d.pkg(name='bucketACL', url='', help='"BucketACL is the Schema for the BucketACLs API. Creates a new bucket ACL in Google Cloud Storage."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBucket':: d.fn(help='"The name of the bucket it applies to."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withDefaultAcl':: d.fn(help='"Configure this ACL to be the default ACL."', args=[d.arg(name='defaultAcl', type=d.T.string)]),
      withDefaultAcl(defaultAcl): { spec+: { forProvider+: { defaultAcl: defaultAcl } } },
      '#withPredefinedAcl':: d.fn(help='"The canned GCS ACL to apply. Must be set if role_entity is not."', args=[d.arg(name='predefinedAcl', type=d.T.string)]),
      withPredefinedAcl(predefinedAcl): { spec+: { forProvider+: { predefinedAcl: predefinedAcl } } },
      '#withRoleEntity':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Bucket ACL documentation  for more details. Must be set if predefined_acl is not."', args=[d.arg(name='roleEntity', type=d.T.array)]),
      withRoleEntity(roleEntity): { spec+: { forProvider+: { roleEntity: if std.isArray(v=roleEntity) then roleEntity else [roleEntity] } } },
      '#withRoleEntityMixin':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Bucket ACL documentation  for more details. Must be set if predefined_acl is not."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='roleEntity', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withDefaultAcl':: d.fn(help='"Configure this ACL to be the default ACL."', args=[d.arg(name='defaultAcl', type=d.T.string)]),
      withDefaultAcl(defaultAcl): { spec+: { initProvider+: { defaultAcl: defaultAcl } } },
      '#withPredefinedAcl':: d.fn(help='"The canned GCS ACL to apply. Must be set if role_entity is not."', args=[d.arg(name='predefinedAcl', type=d.T.string)]),
