{
  ...
  '#':: d.pkg(name='objectACL', url='', help='"ObjectACL is the Schema for the ObjectACLs API. Creates a new object ACL in Google Cloud Storage."'),
  ...
  '#new':: d.fn(help='new returns an instance of ObjectACL', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ObjectACLSpec defines the desired state of ObjectACL"'),
  spec: {
    ...
    forProvider: {
      ...
      objectRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { objectRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { objectRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { objectRef+: { name: name } } } },
      },
      ...
      objectSelector: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { objectSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { objectSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { objectSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { objectSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { objectSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withBucket':: d.fn(help='"The name of the bucket the object is stored in."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withObject':: d.fn(help='"The name of the object to apply the acl to."', args=[d.arg(name='object', type=d.T.string)]),
      withObject(object): { spec+: { forProvider+: { object: object } } },
      '#withPredefinedAcl':: d.fn(help='"The \\"canned\\" predefined ACL to apply. Must be set if role_entity is not."', args=[d.arg(name='predefinedAcl', type=d.T.string)]),
      withPredefinedAcl(predefinedAcl): { spec+: { forProvider+: { predefinedAcl: predefinedAcl } } },
      '#withRoleEntity':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Object ACL documentation for more details.\\nMust be set if predefined_acl is not."', args=[d.arg(name='roleEntity', type=d.T.array)]),
      withRoleEntity(roleEntity): { spec+: { forProvider+: { roleEntity: if std.isArray(v=roleEntity) then roleEntity else [roleEntity] } } },
      '#withRoleEntityMixin':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Object ACL documentation for more details.\\nMust be set if predefined_acl is not."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='roleEntity', type=d.T.array)]),
      withRoleEntityMixin(roleEntity): { spec+: { forProvider+: { roleEntity+: if std.isArray(v=roleEntity) then roleEntity else [roleEntity] } } },
    },
    ...
    initProvider: {
      ...
      objectRef: {
        ...
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { objectRef+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { objectRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { objectRef+: { name: name } } } },
      },
      '#objectSelector':: d.obj(help='"Selector for a BucketObject in storage to populate object."'),
      objectSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { initProvider+: { objectSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { initProvider+: { objectSelector+: { policy+: { resolve: resolve } } } } },
        },
        '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
        withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { objectSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { initProvider+: { objectSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { objectSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withBucket':: d.fn(help='"The name of the bucket the object is stored in."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { initProvider+: { bucket: bucket } } },
      '#withObject':: d.fn(help='"The name of the object to apply the acl to."', args=[d.arg(name='object', type=d.T.string)]),
      withObject(object): { spec+: { initProvider+: { object: object } } },
      '#withPredefinedAcl':: d.fn(help='"The \\"canned\\" predefined ACL to apply. Must be set if role_entity is not."', args=[d.arg(name='predefinedAcl', type=d.T.string)]),
      withPredefinedAcl(predefinedAcl): { spec+: { initProvider+: { predefinedAcl: predefinedAcl } } },
      '#withRoleEntity':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Object ACL documentation for more details.\\nMust be set if predefined_acl is not."', args=[d.arg(name='roleEntity', type=d.T.array)]),
      withRoleEntity(roleEntity): { spec+: { initProvider+: { roleEntity: if std.isArray(v=roleEntity) then roleEntity else [roleEntity] } } },
      '#withRoleEntityMixin':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Object ACL documentation for more details.\\nMust be set if predefined_acl is not."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='roleEntity', type=d.T.array)]),
      withRoleEntityMixin(roleEntity): { spec+: { initProvider+: { roleEntity+: if std.isArray(v=roleEntity) then roleEntity else [roleEntity] } } },
    },
