{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCommonName':: d.fn(help='"The common name to be used in the certificate to identify the\\nclient. Constrained to [a-zA-Z.-_ ]+. Changing this forces a new resource to be created."', args=[d.arg(name='commonName', type=d.T.string)]),
