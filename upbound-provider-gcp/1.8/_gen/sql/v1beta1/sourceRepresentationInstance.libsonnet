{
  ...
  spec: {
    ...
    forProvider: {
      '#passwordSecretRef':: d.obj(help='"The password for the replication user account.\\nNote: This property is sensitive and will not be displayed in the plan."'),
      passwordSecretRef: {
      ...
      '#withDatabaseVersion':: d.fn(help='"The MySQL version running on your source database server.\\nPossible values are: MYSQL_5_6, MYSQL_5_7, MYSQL_8_0, POSTGRES_9_6, POSTGRES_10, POSTGRES_11, POSTGRES_12, POSTGRES_13, POSTGRES_14."', args=[d.arg(name='databaseVersion', type=d.T.string)]),
      ...
      '#withHost':: d.fn(help='"The IPv4 address and port for the external server, or the the DNS address for the external server. If the external server is hosted on Cloud SQL, the port is 5432."', args=[d.arg(name='host', type=d.T.string)]),
      withHost(host): { spec+: { forProvider+: { host: host } } },
      '#withPort':: d.fn(help='"The externally accessible port for the source database server.\\nDefaults to 3306."', args=[d.arg(name='port', type=d.T.number)]),
