{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withType':: d.fn(help='"The type of the schema definition\\nDefault value is TYPE_UNSPECIFIED.\\nPossible values are: TYPE_UNSPECIFIED, PROTOCOL_BUFFER, AVRO."', args=[d.arg(name='type', type=d.T.string)]),
