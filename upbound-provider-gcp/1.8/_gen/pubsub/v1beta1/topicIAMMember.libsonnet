{
  ...
  '#':: d.pkg(name='topicIAMMember', url='', help='"TopicIAMMember is the Schema for the TopicIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of TopicIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
