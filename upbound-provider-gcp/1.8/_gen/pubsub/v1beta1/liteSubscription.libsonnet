{
  ...
  '#':: d.pkg(name='liteSubscription', url='', help='"LiteSubscription is the Schema for the LiteSubscriptions API. A named resource representing the stream of messages from a single, specific topic, to be delivered to the subscribing application."'),
  ...
  '#new':: d.fn(help='new returns an instance of LiteSubscription', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LiteSubscriptionSpec defines the desired state of LiteSubscription"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#deliveryConfig':: d.obj(help="\"The settings for this subscription's message delivery.\\nStructure is documented below.\""),
      deliveryConfig: {
        '#withDeliveryRequirement':: d.fn(help='"When this subscription should send messages to subscribers relative to messages persistence in storage.\\nPossible values are: DELIVER_IMMEDIATELY, DELIVER_AFTER_STORED, DELIVERY_REQUIREMENT_UNSPECIFIED."', args=[d.arg(name='deliveryRequirement', type=d.T.string)]),
        withDeliveryRequirement(deliveryRequirement): { deliveryRequirement: deliveryRequirement },
      },
      '#topicRef':: d.obj(help='"Reference to a LiteTopic in pubsub to populate topic."'),
      topicRef: {
      ...
      '#topicSelector':: d.obj(help='"Selector for a LiteTopic in pubsub to populate topic."'),
      topicSelector: {
      ...
      '#withDeliveryConfig':: d.fn(help="\"The settings for this subscription's message delivery.\\nStructure is documented below.\"", args=[d.arg(name='deliveryConfig', type=d.T.array)]),
      withDeliveryConfig(deliveryConfig): { spec+: { forProvider+: { deliveryConfig: if std.isArray(v=deliveryConfig) then deliveryConfig else [deliveryConfig] } } },
      '#withDeliveryConfigMixin':: d.fn(help="\"The settings for this subscription's message delivery.\\nStructure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='deliveryConfig', type=d.T.array)]),
      withDeliveryConfigMixin(deliveryConfig): { spec+: { forProvider+: { deliveryConfig+: if std.isArray(v=deliveryConfig) then deliveryConfig else [deliveryConfig] } } },
    ...
    initProvider: {
      ...
      '#withDeliveryConfig':: d.fn(help="\"The settings for this subscription's message delivery.\\nStructure is documented below.\"", args=[d.arg(name='deliveryConfig', type=d.T.array)]),
      withDeliveryConfig(deliveryConfig): { spec+: { initProvider+: { deliveryConfig: if std.isArray(v=deliveryConfig) then deliveryConfig else [deliveryConfig] } } },
      '#withDeliveryConfigMixin':: d.fn(help="\"The settings for this subscription's message delivery.\\nStructure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='deliveryConfig', type=d.T.array)]),
      withDeliveryConfigMixin(deliveryConfig): { spec+: { initProvider+: { deliveryConfig+: if std.isArray(v=deliveryConfig) then deliveryConfig else [deliveryConfig] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
