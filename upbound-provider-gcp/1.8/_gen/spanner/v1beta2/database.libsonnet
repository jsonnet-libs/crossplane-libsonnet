{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeletionProtection':: d.fn(help='"Defaults to true.\\nWhen the field is set to false, deleting the database is allowed."', args=[d.arg(name='deletionProtection', type=d.T.boolean)]),
