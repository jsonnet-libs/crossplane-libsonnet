{
  ...
  spec: {
    ...
    forProvider: {
      '#encryptionConfig':: d.obj(help='"Encryption configuration for the database\\nStructure is documented below."'),
      encryptionConfig: {
        '#withKmsKeyName':: d.fn(help='"Fully qualified name of the KMS key to use to encrypt this database. This key must exist\\nin the same location as the Spanner Database."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
      ...
      '#withDatabaseDialect':: d.fn(help='"The dialect of the Cloud Spanner Database.\\nIf it is not provided, \\"GOOGLE_STANDARD_SQL\\" will be used.\\nPossible values are: GOOGLE_STANDARD_SQL, POSTGRESQL."', args=[d.arg(name='databaseDialect', type=d.T.string)]),
      ...
      '#withEnableDropProtection':: d.fn(help='"Whether drop protection is enabled for this database. Defaults to false.\\nwhereas setting “enableDropProtection” to true protects the database from deletions in all interfaces.\\n(2) Setting \\"enableDropProtection\\" to true also prevents the deletion of the parent instance containing the database.\\n\\"deletion_protection\\" attribute does not provide protection against the deletion of the parent instance."', args=[d.arg(name='enableDropProtection', type=d.T.boolean)]),
      withEnableDropProtection(enableDropProtection): { spec+: { forProvider+: { enableDropProtection: enableDropProtection } } },
      '#withEncryptionConfig':: d.fn(help='"Encryption configuration for the database\\nStructure is documented below."', args=[d.arg(name='encryptionConfig', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withEnableDropProtection':: d.fn(help='"Whether drop protection is enabled for this database. Defaults to false.\\nwhereas setting “enableDropProtection” to true protects the database from deletions in all interfaces.\\n(2) Setting \\"enableDropProtection\\" to true also prevents the deletion of the parent instance containing the database.\\n\\"deletion_protection\\" attribute does not provide protection against the deletion of the parent instance."', args=[d.arg(name='enableDropProtection', type=d.T.boolean)]),
      withEnableDropProtection(enableDropProtection): { spec+: { initProvider+: { enableDropProtection: enableDropProtection } } },
      '#withEncryptionConfig':: d.fn(help='"Encryption configuration for the database\\nStructure is documented below."', args=[d.arg(name='encryptionConfig', type=d.T.array)]),
