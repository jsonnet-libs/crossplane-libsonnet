{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#databaseRef':: d.obj(help='"Reference to a Database in spanner to populate database."'),
      databaseRef: {
      ...
      '#databaseSelector':: d.obj(help='"Selector for a Database in spanner to populate database."'),
      databaseSelector: {
