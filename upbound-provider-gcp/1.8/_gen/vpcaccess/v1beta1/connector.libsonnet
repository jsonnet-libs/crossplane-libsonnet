{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMaxInstances':: d.fn(help='"Maximum value of instances in autoscaling group underlying the connector."', args=[d.arg(name='maxInstances', type=d.T.number)]),
      withMaxInstances(maxInstances): { spec+: { forProvider+: { maxInstances: maxInstances } } },
      '#withMaxThroughput':: d.fn(help='"Maximum throughput of the connector in Mbps, must be greater than min_throughput. Default is 300."', args=[d.arg(name='maxThroughput', type=d.T.number)]),
      withMaxThroughput(maxThroughput): { spec+: { forProvider+: { maxThroughput: maxThroughput } } },
      '#withMinInstances':: d.fn(help='"Minimum value of instances in autoscaling group underlying the connector."', args=[d.arg(name='minInstances', type=d.T.number)]),
      withMinInstances(minInstances): { spec+: { forProvider+: { minInstances: minInstances } } },
      '#withMinThroughput':: d.fn(help='"Minimum throughput of the connector in Mbps. Default and min is 200."', args=[d.arg(name='minThroughput', type=d.T.number)]),
      ...
      '#withSubnet':: d.fn(help='"The subnet in which to house the connector\\nStructure is documented below."', args=[d.arg(name='subnet', type=d.T.array)]),
      withSubnet(subnet): { spec+: { forProvider+: { subnet: if std.isArray(v=subnet) then subnet else [subnet] } } },
      '#withSubnetMixin':: d.fn(help='"The subnet in which to house the connector\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnet', type=d.T.array)]),
