{
  ...
  '#':: d.pkg(name='customService', url='', help='"CustomService is the Schema for the CustomServices API. A Service is a discrete, autonomous, and network-accessible unit, designed to solve an individual concern."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      telemetry: {
        '#withResourceName':: d.fn(help='"The full name of the resource that defines this service.\\nFormatted as described in\\nhttps://cloud.google.com/apis/design/resource_names."', args=[d.arg(name='resourceName', type=d.T.string)]),
      ...
      '#withServiceId':: d.fn(help='"An optional service ID to use. If not given, the server will generate a\\nservice ID."', args=[d.arg(name='serviceId', type=d.T.string)]),
      withServiceId(serviceId): { spec+: { forProvider+: { serviceId: serviceId } } },
      '#withTelemetry':: d.fn(help='"Configuration for how to query telemetry on a Service.\\nStructure is documented below."', args=[d.arg(name='telemetry', type=d.T.array)]),
      withTelemetry(telemetry): { spec+: { forProvider+: { telemetry: if std.isArray(v=telemetry) then telemetry else [telemetry] } } },
      '#withTelemetryMixin':: d.fn(help='"Configuration for how to query telemetry on a Service.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='telemetry', type=d.T.array)]),
