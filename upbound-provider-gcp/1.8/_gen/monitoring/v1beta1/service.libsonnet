{
  ...
  '#':: d.pkg(name='service', url='', help='"Service is the Schema for the Services API. A Service is a discrete, autonomous, and network-accessible unit, designed to solve an individual concern."'),
  ...
  spec: {
    ...
    forProvider: {
      '#basicService':: d.obj(help='"A well-known service type, defined by its service type and service labels.\\nValid values of service types and services labels are described at\\nhttps://cloud.google.com/stackdriver/docs/solutions/slo-monitoring/api/api-structures#basic-svc-w-basic-sli\\nStructure is documented below."'),
      basicService: {
        '#withServiceLabels':: d.fn(help='"Labels that specify the resource that emits the monitoring data\\nwhich is used for SLO reporting of this Service."', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabels(serviceLabels): { serviceLabels: serviceLabels },
        '#withServiceLabelsMixin':: d.fn(help='"Labels that specify the resource that emits the monitoring data\\nwhich is used for SLO reporting of this Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabelsMixin(serviceLabels): { serviceLabels+: serviceLabels },
        '#withServiceType':: d.fn(help='"The type of service that this basic service defines, e.g.\\nAPP_ENGINE service type"', args=[d.arg(name='serviceType', type=d.T.string)]),
        withServiceType(serviceType): { serviceType: serviceType },
      },
      '#withBasicService':: d.fn(help='"A well-known service type, defined by its service type and service labels.\\nValid values of service types and services labels are described at\\nhttps://cloud.google.com/stackdriver/docs/solutions/slo-monitoring/api/api-structures#basic-svc-w-basic-sli\\nStructure is documented below."', args=[d.arg(name='basicService', type=d.T.array)]),
      ...
      '#withBasicServiceMixin':: d.fn(help='"A well-known service type, defined by its service type and service labels.\\nValid values of service types and services labels are described at\\nhttps://cloud.google.com/stackdriver/docs/solutions/slo-monitoring/api/api-structures#basic-svc-w-basic-sli\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='basicService', type=d.T.array)]),
      ...
      '#withUserLabels':: d.fn(help='"Labels which have been used to annotate the service. Label keys must start\\nwith a letter. Label keys and values may contain lowercase letters,\\nnumbers, underscores, and dashes. Label keys and values have a maximum\\nlength of 63 characters, and must be less than 128 bytes in size. Up to 64\\nlabel entries may be stored. For labels which do not have a semantic value,\\nthe empty string may be supplied for the label value."', args=[d.arg(name='userLabels', type=d.T.object)]),
      withUserLabels(userLabels): { spec+: { forProvider+: { userLabels: userLabels } } },
      '#withUserLabelsMixin':: d.fn(help='"Labels which have been used to annotate the service. Label keys must start\\nwith a letter. Label keys and values may contain lowercase letters,\\nnumbers, underscores, and dashes. Label keys and values have a maximum\\nlength of 63 characters, and must be less than 128 bytes in size. Up to 64\\nlabel entries may be stored. For labels which do not have a semantic value,\\nthe empty string may be supplied for the label value."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='userLabels', type=d.T.object)]),
