  ...
  spec: {
    ...
    forProvider: {
      ...
      basicService: {
        ...
        withServiceLabels(serviceLabels): { spec+: { forProvider+: { basicService+: { serviceLabels: serviceLabels } } } },
        ...
        withServiceLabelsMixin(serviceLabels): { spec+: { forProvider+: { basicService+: { serviceLabels+: serviceLabels } } } },
        ...
        withServiceType(serviceType): { spec+: { forProvider+: { basicService+: { serviceType: serviceType } } } },
      },
    ...
    initProvider: {
      ...
      basicService: {
        '#withServiceLabels':: d.fn(help='"Labels that specify the resource that emits the monitoring data\\nwhich is used for SLO reporting of this Service."', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabels(serviceLabels): { spec+: { initProvider+: { basicService+: { serviceLabels: serviceLabels } } } },
        '#withServiceLabelsMixin':: d.fn(help='"Labels that specify the resource that emits the monitoring data\\nwhich is used for SLO reporting of this Service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabelsMixin(serviceLabels): { spec+: { initProvider+: { basicService+: { serviceLabels+: serviceLabels } } } },
        '#withServiceType':: d.fn(help='"The type of service that this basic service defines, e.g.\\nAPP_ENGINE service type"', args=[d.arg(name='serviceType', type=d.T.string)]),
        withServiceType(serviceType): { spec+: { initProvider+: { basicService+: { serviceType: serviceType } } } },
      },
      '#withDisplayName':: d.fn(help='"Name used for UI elements listing this Service."', args=[d.arg(name='displayName', type=d.T.string)]),
