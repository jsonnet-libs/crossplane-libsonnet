  ...
  spec: {
    ...
    forProvider: {
      ...
      telemetry: {
        ...
        withResourceName(resourceName): { spec+: { forProvider+: { telemetry+: { resourceName: resourceName } } } },
      },
    ...
    initProvider: {
      ...
      telemetry: {
        '#withResourceName':: d.fn(help='"The full name of the resource that defines this service.\\nFormatted as described in\\nhttps://cloud.google.com/apis/design/resource_names."', args=[d.arg(name='resourceName', type=d.T.string)]),
        withResourceName(resourceName): { spec+: { initProvider+: { telemetry+: { resourceName: resourceName } } } },
      },
      '#withDisplayName':: d.fn(help='"Name used for UI elements listing this Service."', args=[d.arg(name='displayName', type=d.T.string)]),
