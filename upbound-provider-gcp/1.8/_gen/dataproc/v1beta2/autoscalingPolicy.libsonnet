{
  ...
  spec: {
    ...
    forProvider: {
      ...
      basicAlgorithm: {
        '#withCooldownPeriod':: d.fn(help='"Duration between scaling events. A scaling period starts after the\\nupdate operation from the previous event has completed.\\nBounds: [2m, 1d]. Default: 2m."', args=[d.arg(name='cooldownPeriod', type=d.T.string)]),
        withCooldownPeriod(cooldownPeriod): { spec+: { forProvider+: { basicAlgorithm+: { cooldownPeriod: cooldownPeriod } } } },
        '#yarnConfig':: d.obj(help='"YARN autoscaling configuration.\\nStructure is documented below."'),
        yarnConfig: {
          '#withGracefulDecommissionTimeout':: d.fn(help='"Timeout for YARN graceful decommissioning of Node Managers. Specifies the\\nduration to wait for jobs to complete before forcefully removing workers\\n(and potentially interrupting jobs). Only applicable to downscaling operations.\\nBounds: [0s, 1d]."', args=[d.arg(name='gracefulDecommissionTimeout', type=d.T.string)]),
          withGracefulDecommissionTimeout(gracefulDecommissionTimeout): { spec+: { forProvider+: { basicAlgorithm+: { yarnConfig+: { gracefulDecommissionTimeout: gracefulDecommissionTimeout } } } } },
          '#withScaleDownFactor':: d.fn(help='"Fraction of average pending memory in the last cooldown period for which to\\nremove workers. A scale-down factor of 1 will result in scaling down so that there\\nis no available memory remaining after the update (more aggressive scaling).\\nA scale-down factor of 0 disables removing workers, which can be beneficial for\\nautoscaling a single job.\\nBounds: [0.0, 1.0]."', args=[d.arg(name='scaleDownFactor', type=d.T.number)]),
          withScaleDownFactor(scaleDownFactor): { spec+: { forProvider+: { basicAlgorithm+: { yarnConfig+: { scaleDownFactor: scaleDownFactor } } } } },
          ...
          withScaleDownMinWorkerFraction(scaleDownMinWorkerFraction): { spec+: { forProvider+: { basicAlgorithm+: { yarnConfig+: { scaleDownMinWorkerFraction: scaleDownMinWorkerFraction } } } } },
          '#withScaleUpFactor':: d.fn(help='"Fraction of average pending memory in the last cooldown period for which to\\nadd workers. A scale-up factor of 1.0 will result in scaling up so that there\\nis no pending memory remaining after the update (more aggressive scaling).\\nA scale-up factor closer to 0 will result in a smaller magnitude of scaling up\\n(less aggressive scaling).\\nBounds: [0.0, 1.0]."', args=[d.arg(name='scaleUpFactor', type=d.T.number)]),
          withScaleUpFactor(scaleUpFactor): { spec+: { forProvider+: { basicAlgorithm+: { yarnConfig+: { scaleUpFactor: scaleUpFactor } } } } },
          '#withScaleUpMinWorkerFraction':: d.fn(help='"Minimum scale-up threshold as a fraction of total cluster size before scaling\\noccurs. For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler\\nmust recommend at least a 2-worker scale-up for the cluster to scale. A threshold of\\n0 means the autoscaler will scale up on any recommended change.\\nBounds: [0.0, 1.0]. Default: 0.0."', args=[d.arg(name='scaleUpMinWorkerFraction', type=d.T.number)]),
          withScaleUpMinWorkerFraction(scaleUpMinWorkerFraction): { spec+: { forProvider+: { basicAlgorithm+: { yarnConfig+: { scaleUpMinWorkerFraction: scaleUpMinWorkerFraction } } } } },
        },
      },
      '#secondaryWorkerConfig':: d.obj(help='"Describes how the autoscaler will operate for secondary workers.\\nStructure is documented below."'),
      secondaryWorkerConfig: {
        '#withMaxInstances':: d.fn(help='"Maximum number of instances for this group. Note that by default, clusters will not use\\nsecondary workers. Required for secondary workers if the minimum secondary instances is set.\\nBounds: [minInstances, ). Defaults to 0."', args=[d.arg(name='maxInstances', type=d.T.number)]),
        withMaxInstances(maxInstances): { spec+: { forProvider+: { secondaryWorkerConfig+: { maxInstances: maxInstances } } } },
        ...
        withMinInstances(minInstances): { spec+: { forProvider+: { secondaryWorkerConfig+: { minInstances: minInstances } } } },
        '#withWeight':: d.fn(help='"Weight for the instance group, which is used to determine the fraction of total workers\\nin the cluster from this instance group. For example, if primary workers have weight 2,\\nand secondary workers have weight 1, the cluster will have approximately 2 primary workers\\nfor each secondary worker.\\nThe cluster may not reach the specified balance if constrained by min/max bounds or other\\nautoscaling settings. For example, if maxInstances for secondary workers is 0, then only\\nprimary workers will be added. The cluster can also be out of balance when created.\\nIf weight is not set on any instance group, the cluster will default to equal weight for\\nall groups: the cluster will attempt to maintain an equal number of workers in each group\\nwithin the configured size bounds for each group. If weight is set for one group only,\\nthe cluster will default to zero weight on the unset group. For example if weight is set\\nonly on primary workers, the cluster will use primary workers only and no secondary workers."', args=[d.arg(name='weight', type=d.T.number)]),
        withWeight(weight): { spec+: { forProvider+: { secondaryWorkerConfig+: { weight: weight } } } },
      },
      '#withLocation':: d.fn(help='"The  location where the autoscaling policy should reside.\\nThe default value is global."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      workerConfig: {
        ...
        withMaxInstances(maxInstances): { spec+: { forProvider+: { workerConfig+: { maxInstances: maxInstances } } } },
        ...
        withMinInstances(minInstances): { spec+: { forProvider+: { workerConfig+: { minInstances: minInstances } } } },
        '#withWeight':: d.fn(help='"Weight for the instance group, which is used to determine the fraction of total workers\\nin the cluster from this instance group. For example, if primary workers have weight 2,\\nand secondary workers have weight 1, the cluster will have approximately 2 primary workers\\nfor each secondary worker.\\nThe cluster may not reach the specified balance if constrained by min/max bounds or other\\nautoscaling settings. For example, if maxInstances for secondary workers is 0, then only\\nprimary workers will be added. The cluster can also be out of balance when created.\\nIf weight is not set on any instance group, the cluster will default to equal weight for\\nall groups: the cluster will attempt to maintain an equal number of workers in each group\\nwithin the configured size bounds for each group. If weight is set for one group only,\\nthe cluster will default to zero weight on the unset group. For example if weight is set\\nonly on primary workers, the cluster will use primary workers only and no secondary workers."', args=[d.arg(name='weight', type=d.T.number)]),
        withWeight(weight): { spec+: { forProvider+: { workerConfig+: { weight: weight } } } },
      },
    },
    ...
    initProvider: {
      ...
      basicAlgorithm: {
        '#withCooldownPeriod':: d.fn(help='"Duration between scaling events. A scaling period starts after the\\nupdate operation from the previous event has completed.\\nBounds: [2m, 1d]. Default: 2m."', args=[d.arg(name='cooldownPeriod', type=d.T.string)]),
        withCooldownPeriod(cooldownPeriod): { spec+: { initProvider+: { basicAlgorithm+: { cooldownPeriod: cooldownPeriod } } } },
        '#yarnConfig':: d.obj(help='"YARN autoscaling configuration.\\nStructure is documented below."'),
        yarnConfig: {
          '#withGracefulDecommissionTimeout':: d.fn(help='"Timeout for YARN graceful decommissioning of Node Managers. Specifies the\\nduration to wait for jobs to complete before forcefully removing workers\\n(and potentially interrupting jobs). Only applicable to downscaling operations.\\nBounds: [0s, 1d]."', args=[d.arg(name='gracefulDecommissionTimeout', type=d.T.string)]),
          withGracefulDecommissionTimeout(gracefulDecommissionTimeout): { spec+: { initProvider+: { basicAlgorithm+: { yarnConfig+: { gracefulDecommissionTimeout: gracefulDecommissionTimeout } } } } },
          '#withScaleDownFactor':: d.fn(help='"Fraction of average pending memory in the last cooldown period for which to\\nremove workers. A scale-down factor of 1 will result in scaling down so that there\\nis no available memory remaining after the update (more aggressive scaling).\\nA scale-down factor of 0 disables removing workers, which can be beneficial for\\nautoscaling a single job.\\nBounds: [0.0, 1.0]."', args=[d.arg(name='scaleDownFactor', type=d.T.number)]),
          withScaleDownFactor(scaleDownFactor): { spec+: { initProvider+: { basicAlgorithm+: { yarnConfig+: { scaleDownFactor: scaleDownFactor } } } } },
          '#withScaleDownMinWorkerFraction':: d.fn(help='"Minimum scale-down threshold as a fraction of total cluster size before scaling occurs.\\nFor example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler must\\nrecommend at least a 2 worker scale-down for the cluster to scale. A threshold of 0\\nmeans the autoscaler will scale down on any recommended change.\\nBounds: [0.0, 1.0]. Default: 0.0."', args=[d.arg(name='scaleDownMinWorkerFraction', type=d.T.number)]),
          withScaleDownMinWorkerFraction(scaleDownMinWorkerFraction): { spec+: { initProvider+: { basicAlgorithm+: { yarnConfig+: { scaleDownMinWorkerFraction: scaleDownMinWorkerFraction } } } } },
          '#withScaleUpFactor':: d.fn(help='"Fraction of average pending memory in the last cooldown period for which to\\nadd workers. A scale-up factor of 1.0 will result in scaling up so that there\\nis no pending memory remaining after the update (more aggressive scaling).\\nA scale-up factor closer to 0 will result in a smaller magnitude of scaling up\\n(less aggressive scaling).\\nBounds: [0.0, 1.0]."', args=[d.arg(name='scaleUpFactor', type=d.T.number)]),
          withScaleUpFactor(scaleUpFactor): { spec+: { initProvider+: { basicAlgorithm+: { yarnConfig+: { scaleUpFactor: scaleUpFactor } } } } },
          '#withScaleUpMinWorkerFraction':: d.fn(help='"Minimum scale-up threshold as a fraction of total cluster size before scaling\\noccurs. For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler\\nmust recommend at least a 2-worker scale-up for the cluster to scale. A threshold of\\n0 means the autoscaler will scale up on any recommended change.\\nBounds: [0.0, 1.0]. Default: 0.0."', args=[d.arg(name='scaleUpMinWorkerFraction', type=d.T.number)]),
          withScaleUpMinWorkerFraction(scaleUpMinWorkerFraction): { spec+: { initProvider+: { basicAlgorithm+: { yarnConfig+: { scaleUpMinWorkerFraction: scaleUpMinWorkerFraction } } } } },
        },
      },
      '#secondaryWorkerConfig':: d.obj(help='"Describes how the autoscaler will operate for secondary workers.\\nStructure is documented below."'),
      secondaryWorkerConfig: {
        '#withMaxInstances':: d.fn(help='"Maximum number of instances for this group. Note that by default, clusters will not use\\nsecondary workers. Required for secondary workers if the minimum secondary instances is set.\\nBounds: [minInstances, ). Defaults to 0."', args=[d.arg(name='maxInstances', type=d.T.number)]),
        withMaxInstances(maxInstances): { spec+: { initProvider+: { secondaryWorkerConfig+: { maxInstances: maxInstances } } } },
        '#withMinInstances':: d.fn(help='"Minimum number of instances for this group. Bounds: [0, maxInstances]. Defaults to 0."', args=[d.arg(name='minInstances', type=d.T.number)]),
        withMinInstances(minInstances): { spec+: { initProvider+: { secondaryWorkerConfig+: { minInstances: minInstances } } } },
        '#withWeight':: d.fn(help='"Weight for the instance group, which is used to determine the fraction of total workers\\nin the cluster from this instance group. For example, if primary workers have weight 2,\\nand secondary workers have weight 1, the cluster will have approximately 2 primary workers\\nfor each secondary worker.\\nThe cluster may not reach the specified balance if constrained by min/max bounds or other\\nautoscaling settings. For example, if maxInstances for secondary workers is 0, then only\\nprimary workers will be added. The cluster can also be out of balance when created.\\nIf weight is not set on any instance group, the cluster will default to equal weight for\\nall groups: the cluster will attempt to maintain an equal number of workers in each group\\nwithin the configured size bounds for each group. If weight is set for one group only,\\nthe cluster will default to zero weight on the unset group. For example if weight is set\\nonly on primary workers, the cluster will use primary workers only and no secondary workers."', args=[d.arg(name='weight', type=d.T.number)]),
        withWeight(weight): { spec+: { initProvider+: { secondaryWorkerConfig+: { weight: weight } } } },
      },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
      ...
      workerConfig: {
        '#withMaxInstances':: d.fn(help='"Maximum number of instances for this group."', args=[d.arg(name='maxInstances', type=d.T.number)]),
        withMaxInstances(maxInstances): { spec+: { initProvider+: { workerConfig+: { maxInstances: maxInstances } } } },
        '#withMinInstances':: d.fn(help='"Minimum number of instances for this group. Bounds: [2, maxInstances]. Defaults to 2."', args=[d.arg(name='minInstances', type=d.T.number)]),
        withMinInstances(minInstances): { spec+: { initProvider+: { workerConfig+: { minInstances: minInstances } } } },
        '#withWeight':: d.fn(help='"Weight for the instance group, which is used to determine the fraction of total workers\\nin the cluster from this instance group. For example, if primary workers have weight 2,\\nand secondary workers have weight 1, the cluster will have approximately 2 primary workers\\nfor each secondary worker.\\nThe cluster may not reach the specified balance if constrained by min/max bounds or other\\nautoscaling settings. For example, if maxInstances for secondary workers is 0, then only\\nprimary workers will be added. The cluster can also be out of balance when created.\\nIf weight is not set on any instance group, the cluster will default to equal weight for\\nall groups: the cluster will attempt to maintain an equal number of workers in each group\\nwithin the configured size bounds for each group. If weight is set for one group only,\\nthe cluster will default to zero weight on the unset group. For example if weight is set\\nonly on primary workers, the cluster will use primary workers only and no secondary workers."', args=[d.arg(name='weight', type=d.T.number)]),
        withWeight(weight): { spec+: { initProvider+: { workerConfig+: { weight: weight } } } },
      },
    },
