{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#clusterRef':: d.obj(help='"Reference to a Cluster in containerazure to populate cluster."'),
      clusterRef: {
      ...
      '#clusterSelector':: d.obj(help='"Selector for a Cluster in containerazure to populate cluster."'),
      clusterSelector: {
    ...
    initProvider: {
      ...
      '#withAzureAvailabilityZone':: d.fn(help='"Optional. The Azure availability zone of the nodes in this nodepool. When unspecified, it defaults to 1."', args=[d.arg(name='azureAvailabilityZone', type=d.T.string)]),
      withAzureAvailabilityZone(azureAvailabilityZone): { spec+: { initProvider+: { azureAvailabilityZone: azureAvailabilityZone } } },
      '#withConfig':: d.fn(help='"The node configuration of the node pool."', args=[d.arg(name='config', type=d.T.array)]),
