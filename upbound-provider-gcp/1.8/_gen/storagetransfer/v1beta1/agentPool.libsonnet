{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBandwidthLimit':: d.fn(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'.\\nStructure is documented below.\"", args=[d.arg(name='bandwidthLimit', type=d.T.array)]),
      ...
      '#withBandwidthLimitMixin':: d.fn(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'.\\nStructure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='bandwidthLimit', type=d.T.array)]),
