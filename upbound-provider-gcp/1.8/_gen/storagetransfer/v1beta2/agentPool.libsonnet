{
  ...
  new(name): {
    apiVersion: 'storagetransfer.gcp.upbound.io/v1beta2',
    kind: 'AgentPool',
  ...
  spec: {
    ...
    forProvider: {
      ...
      bandwidthLimit: {
        ...
        withLimitMbps(limitMbps): { spec+: { forProvider+: { bandwidthLimit+: { limitMbps: limitMbps } } } },
      },
    ...
    initProvider: {
      ...
      bandwidthLimit: {
        '#withLimitMbps':: d.fn(help='"Bandwidth rate in megabytes per second, distributed across all the agents in the pool."', args=[d.arg(name='limitMbps', type=d.T.string)]),
        withLimitMbps(limitMbps): { spec+: { initProvider+: { bandwidthLimit+: { limitMbps: limitMbps } } } },
      },
      '#withDisplayName':: d.fn(help='"Specifies the client-specified AgentPool description."', args=[d.arg(name='displayName', type=d.T.string)]),
