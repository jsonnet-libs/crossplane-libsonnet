{
  ...
  '#':: d.pkg(name='idsEndpoint', url='', help='"IdsEndpoint is the Schema for the IdsEndpoints API. Cloud IDS is an intrusion detection service that provides threat detection for intrusions, malware, spyware, and command-and-control attacks on your network."'),
  ...
  '#new':: d.fn(help='new returns an instance of IdsEndpoint', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"IdsEndpointSpec defines the desired state of IdsEndpoint"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"An optional description of the endpoint."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLocation':: d.fn(help='"The location for the endpoint."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withName':: d.fn(help='"Name of the endpoint in the format projects/{project_id}/locations/{locationId}/endpoints/{endpointId}."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withNetwork':: d.fn(help='"Name of the VPC network that is connected to the IDS endpoint. This can either contain the VPC network name itself (like \\"src-net\\") or the full URL to the network (like \\"projects/{project_id}/global/networks/src-net\\")."', args=[d.arg(name='network', type=d.T.string)]),
      ...
      '#withSeverity':: d.fn(help='"The minimum alert severity level that is reported by the endpoint.\\nPossible values are: INFORMATIONAL, LOW, MEDIUM, HIGH, CRITICAL."', args=[d.arg(name='severity', type=d.T.string)]),
      ...
      withThreatExceptions(threatExceptions): { spec+: { forProvider+: { threatExceptions: if std.isArray(v=threatExceptions) then threatExceptions else [threatExceptions] } } },
      ...
      withThreatExceptionsMixin(threatExceptions): { spec+: { forProvider+: { threatExceptions+: if std.isArray(v=threatExceptions) then threatExceptions else [threatExceptions] } } },
    },
    ...
    initProvider: {
      ...
      '#withThreatExceptions':: d.fn(help='"Configuration for threat IDs excluded from generating alerts. Limit: 99 IDs."', args=[d.arg(name='threatExceptions', type=d.T.array)]),
      withThreatExceptions(threatExceptions): { spec+: { initProvider+: { threatExceptions: if std.isArray(v=threatExceptions) then threatExceptions else [threatExceptions] } } },
      '#withThreatExceptionsMixin':: d.fn(help='"Configuration for threat IDs excluded from generating alerts. Limit: 99 IDs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='threatExceptions', type=d.T.array)]),
      withThreatExceptionsMixin(threatExceptions): { spec+: { initProvider+: { threatExceptions+: if std.isArray(v=threatExceptions) then threatExceptions else [threatExceptions] } } },
    },
