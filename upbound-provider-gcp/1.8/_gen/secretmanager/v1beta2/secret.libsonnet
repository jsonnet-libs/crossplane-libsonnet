  ...
  spec: {
    ...
    forProvider: {
      ...
      replication: {
        ...
        auto: {
          ...
          customerManagedEncryption: {
            ...
            withKmsKeyName(kmsKeyName): { spec+: { forProvider+: { replication+: { auto+: { customerManagedEncryption+: { kmsKeyName: kmsKeyName } } } } } },
          },
        },
        ...
        userManaged: {
          ...
          replicas: {
            ...
            customerManagedEncryption: {
              '#withKmsKeyName':: d.fn(help='"Describes the Cloud KMS encryption key that will be used to protect destination secret."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
              withKmsKeyName(kmsKeyName): { customerManagedEncryption+: { kmsKeyName: kmsKeyName } },
            },
          ...
          withReplicas(replicas): { spec+: { forProvider+: { replication+: { userManaged+: { replicas: if std.isArray(v=replicas) then replicas else [replicas] } } } } },
          ...
          withReplicasMixin(replicas): { spec+: { forProvider+: { replication+: { userManaged+: { replicas+: if std.isArray(v=replicas) then replicas else [replicas] } } } } },
        },
      },
      ...
      rotation: {
        ...
        withNextRotationTime(nextRotationTime): { spec+: { forProvider+: { rotation+: { nextRotationTime: nextRotationTime } } } },
        ...
        withRotationPeriod(rotationPeriod): { spec+: { forProvider+: { rotation+: { rotationPeriod: rotationPeriod } } } },
      },
    ...
    initProvider: {
      ...
      replication: {
        ...
        auto: {
          ...
          customerManagedEncryption: {
            '#withKmsKeyName':: d.fn(help='"Describes the Cloud KMS encryption key that will be used to protect destination secret."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
            withKmsKeyName(kmsKeyName): { spec+: { initProvider+: { replication+: { auto+: { customerManagedEncryption+: { kmsKeyName: kmsKeyName } } } } } },
          },
        },
        '#userManaged':: d.obj(help='"The Secret will be replicated to the regions specified by the user.\\nStructure is documented below."'),
        userManaged: {
          ...
          '#withReplicas':: d.fn(help='"The list of Replicas for this Secret. Cannot be empty.\\nStructure is documented below."', args=[d.arg(name='replicas', type=d.T.array)]),
          withReplicas(replicas): { spec+: { initProvider+: { replication+: { userManaged+: { replicas: if std.isArray(v=replicas) then replicas else [replicas] } } } } },
          '#withReplicasMixin':: d.fn(help='"The list of Replicas for this Secret. Cannot be empty.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='replicas', type=d.T.array)]),
          withReplicasMixin(replicas): { spec+: { initProvider+: { replication+: { userManaged+: { replicas+: if std.isArray(v=replicas) then replicas else [replicas] } } } } },
        },
      },
      '#rotation':: d.obj(help='"The rotation time and period for a Secret. At next_rotation_time, Secret Manager will send a Pub/Sub notification to the topics configured on the Secret. topics must be set to configure rotation.\\nStructure is documented below."'),
      rotation: {
        '#withNextRotationTime':: d.fn(help='"Timestamp in UTC at which the Secret is scheduled to rotate.\\nA timestamp in RFC3339 UTC \\"Zulu\\" format, with nanosecond resolution and up to nine fractional digits. Examples: \\"2014-10-02T15:01:23Z\\" and \\"2014-10-02T15:01:23.045123456Z\\"."', args=[d.arg(name='nextRotationTime', type=d.T.string)]),
        withNextRotationTime(nextRotationTime): { spec+: { initProvider+: { rotation+: { nextRotationTime: nextRotationTime } } } },
        '#withRotationPeriod':: d.fn(help='"The Duration between rotation notifications. Must be in seconds and at least 3600s (1h) and at most 3153600000s (100 years).\\nIf rotationPeriod is set, next_rotation_time must be set. next_rotation_time will be advanced by this period when the service automatically sends rotation notifications."', args=[d.arg(name='rotationPeriod', type=d.T.string)]),
        withRotationPeriod(rotationPeriod): { spec+: { initProvider+: { rotation+: { rotationPeriod: rotationPeriod } } } },
      },
      '#topics':: d.obj(help='"A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the secret or its versions.\\nStructure is documented below."'),
      topics: {
        '#withName':: d.fn(help='"The resource name of the Pub/Sub topic that will be published to, in the following format: projects//topics/.\\nFor publication to succeed, the Secret Manager Service Agent service account must have pubsub.publisher permissions on the topic."', args=[d.arg(name='name', type=d.T.string)]),
