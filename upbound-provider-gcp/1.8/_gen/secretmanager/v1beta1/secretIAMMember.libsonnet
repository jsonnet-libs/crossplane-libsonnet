{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#secretIdRef':: d.obj(help='"Reference to a Secret in secretmanager to populate secretId."'),
      secretIdRef: {
      ...
      '#secretIdSelector':: d.obj(help='"Selector for a Secret in secretmanager to populate secretId."'),
      secretIdSelector: {
