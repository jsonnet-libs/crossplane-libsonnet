  ...
  spec: {
    ...
    forProvider: {
      ...
      fields: {
        ...
        '#withOrder':: d.fn(help='"The order of this field with respect to other fields in this tag template.\\nA higher value indicates a more important field. The value can be negative.\\nMultiple fields can have the same order, and field orders within a tag do not have to be sequential."', args=[d.arg(name='order', type=d.T.number)]),
        withOrder(order): { order: order },
        '#withType':: d.fn(help='"The type of value this tag field can contain.\\nStructure is documented below."', args=[d.arg(name='type', type=d.T.array)]),
