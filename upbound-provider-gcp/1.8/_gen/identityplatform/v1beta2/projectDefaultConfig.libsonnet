  ...
  spec: {
    ...
    forProvider: {
      ...
      signIn: {
        ...
        anonymous: {
          ...
          withEnabled(enabled): { spec+: { forProvider+: { signIn+: { anonymous+: { enabled: enabled } } } } },
        },
        '#email':: d.obj(help='"Configuration options related to authenticating a user by their email address.\\nStructure is documented below."'),
        email: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { forProvider+: { signIn+: { email+: { enabled: enabled } } } } },
          ...
          withPasswordRequired(passwordRequired): { spec+: { forProvider+: { signIn+: { email+: { passwordRequired: passwordRequired } } } } },
        },
        '#phoneNumber':: d.obj(help='"Configuration options related to authenticated a user by their phone number.\\nStructure is documented below."'),
        phoneNumber: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { forProvider+: { signIn+: { phoneNumber+: { enabled: enabled } } } } },
          ...
          withTestPhoneNumbers(testPhoneNumbers): { spec+: { forProvider+: { signIn+: { phoneNumber+: { testPhoneNumbers: testPhoneNumbers } } } } },
          ...
          withTestPhoneNumbersMixin(testPhoneNumbers): { spec+: { forProvider+: { signIn+: { phoneNumber+: { testPhoneNumbers+: testPhoneNumbers } } } } },
        },
        ...
        withAllowDuplicateEmails(allowDuplicateEmails): { spec+: { forProvider+: { signIn+: { allowDuplicateEmails: allowDuplicateEmails } } } },
      },
    ...
    initProvider: {
      ...
      signIn: {
        ...
        anonymous: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { signIn+: { anonymous+: { enabled: enabled } } } } },
        },
        '#email':: d.obj(help='"Configuration options related to authenticating a user by their email address.\\nStructure is documented below."'),
        email: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { signIn+: { email+: { enabled: enabled } } } } },
          '#withPasswordRequired':: d.fn(help='"Whether a password is required for email auth or not. If true, both an email and\\npassword must be provided to sign in. If false, a user may sign in via either\\nemail/password or email link."', args=[d.arg(name='passwordRequired', type=d.T.boolean)]),
          withPasswordRequired(passwordRequired): { spec+: { initProvider+: { signIn+: { email+: { passwordRequired: passwordRequired } } } } },
        },
        '#phoneNumber':: d.obj(help='"Configuration options related to authenticated a user by their phone number.\\nStructure is documented below."'),
        phoneNumber: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { initProvider+: { signIn+: { phoneNumber+: { enabled: enabled } } } } },
          '#withTestPhoneNumbers':: d.fn(help='"A map of <test phone number, fake code> that can be used for phone auth testing."', args=[d.arg(name='testPhoneNumbers', type=d.T.object)]),
          withTestPhoneNumbers(testPhoneNumbers): { spec+: { initProvider+: { signIn+: { phoneNumber+: { testPhoneNumbers: testPhoneNumbers } } } } },
          '#withTestPhoneNumbersMixin':: d.fn(help='"A map of <test phone number, fake code> that can be used for phone auth testing."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='testPhoneNumbers', type=d.T.object)]),
          withTestPhoneNumbersMixin(testPhoneNumbers): { spec+: { initProvider+: { signIn+: { phoneNumber+: { testPhoneNumbers+: testPhoneNumbers } } } } },
        },
        '#withAllowDuplicateEmails':: d.fn(help='"Whether to allow more than one account to have the same email."', args=[d.arg(name='allowDuplicateEmails', type=d.T.boolean)]),
        withAllowDuplicateEmails(allowDuplicateEmails): { spec+: { initProvider+: { signIn+: { allowDuplicateEmails: allowDuplicateEmails } } } },
      },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
