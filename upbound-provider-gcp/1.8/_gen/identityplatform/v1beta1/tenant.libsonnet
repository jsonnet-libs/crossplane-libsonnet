{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDisableAuth':: d.fn(help='"Whether authentication is disabled for the tenant. If true, the users under\\nthe disabled tenant are not allowed to sign-in. Admins of the disabled tenant\\nare not able to manage its users."', args=[d.arg(name='disableAuth', type=d.T.boolean)]),
