{
  ...
  '#':: d.pkg(name='tenantOAuthIdPConfig', url='', help='"TenantOAuthIdPConfig is the Schema for the TenantOAuthIdPConfigs API. OIDC IdP configuration for a Identity Toolkit project within a tenant."'),
  ...
  '#new':: d.fn(help='new returns an instance of TenantOAuthIdPConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TenantOAuthIdPConfigSpec defines the desired state of TenantOAuthIdPConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#clientIdSecretRef':: d.obj(help='"The client id of an OAuth client."'),
      clientIdSecretRef: {
      ...
      '#clientSecretSecretRef':: d.obj(help='"The client secret of the OAuth client, to enable OIDC code flow."'),
      ...
      '#withName':: d.fn(help='"The name of the OauthIdpConfig. Must start with oidc.."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withTenant':: d.fn(help='"The name of the tenant where this OIDC IDP configuration resource exists"', args=[d.arg(name='tenant', type=d.T.string)]),
