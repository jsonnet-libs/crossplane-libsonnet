  ...
  spec: {
    ...
    forProvider: {
      ...
      signIn: {
        ...
        '#withAnonymous':: d.fn(help='"Configuration options related to authenticating an anonymous user.\\nStructure is documented below."', args=[d.arg(name='anonymous', type=d.T.array)]),
        withAnonymous(anonymous): { anonymous: if std.isArray(v=anonymous) then anonymous else [anonymous] },
        '#withAnonymousMixin':: d.fn(help='"Configuration options related to authenticating an anonymous user.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='anonymous', type=d.T.array)]),
        withAnonymousMixin(anonymous): { anonymous+: if std.isArray(v=anonymous) then anonymous else [anonymous] },
        '#withEmail':: d.fn(help='"Configuration options related to authenticating a user by their email address.\\nStructure is documented below."', args=[d.arg(name='email', type=d.T.array)]),
        withEmail(email): { email: if std.isArray(v=email) then email else [email] },
        '#withEmailMixin':: d.fn(help='"Configuration options related to authenticating a user by their email address.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='email', type=d.T.array)]),
        withEmailMixin(email): { email+: if std.isArray(v=email) then email else [email] },
        '#withPhoneNumber':: d.fn(help='"Configuration options related to authenticated a user by their phone number.\\nStructure is documented below."', args=[d.arg(name='phoneNumber', type=d.T.array)]),
        withPhoneNumber(phoneNumber): { phoneNumber: if std.isArray(v=phoneNumber) then phoneNumber else [phoneNumber] },
        '#withPhoneNumberMixin':: d.fn(help='"Configuration options related to authenticated a user by their phone number.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='phoneNumber', type=d.T.array)]),
      ...
      '#withSignIn':: d.fn(help='"Configuration related to local sign in methods.\\nStructure is documented below."', args=[d.arg(name='signIn', type=d.T.array)]),
      withSignIn(signIn): { spec+: { forProvider+: { signIn: if std.isArray(v=signIn) then signIn else [signIn] } } },
      '#withSignInMixin':: d.fn(help='"Configuration related to local sign in methods.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='signIn', type=d.T.array)]),
