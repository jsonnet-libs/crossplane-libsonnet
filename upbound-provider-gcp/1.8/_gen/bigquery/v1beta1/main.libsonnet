{
  ...
  analyticsHubDataExchange: (import 'analyticsHubDataExchange.libsonnet'),
  analyticsHubDataExchangeIAMMember: (import 'analyticsHubDataExchangeIAMMember.libsonnet'),
  analyticsHubListing: (import 'analyticsHubListing.libsonnet'),
