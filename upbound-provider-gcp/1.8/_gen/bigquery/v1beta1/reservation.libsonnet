{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoscale':: d.fn(help='"The configuration parameters for the auto scaling feature.\\nStructure is documented below."', args=[d.arg(name='autoscale', type=d.T.array)]),
      withAutoscale(autoscale): { spec+: { forProvider+: { autoscale: if std.isArray(v=autoscale) then autoscale else [autoscale] } } },
      '#withAutoscaleMixin':: d.fn(help='"The configuration parameters for the auto scaling feature.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='autoscale', type=d.T.array)]),
      ...
      '#withSlotCapacity':: d.fn(help='"Minimum slots available to this reservation. A slot is a unit of computational power in BigQuery, and serves as the\\nunit of parallelism. Queries using this reservation might use more slots during runtime if ignoreIdleSlots is set to false."', args=[d.arg(name='slotCapacity', type=d.T.number)]),
