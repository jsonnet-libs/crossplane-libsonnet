{
  ...
  '#':: d.pkg(name='tableIAMPolicy', url='', help='"TableIAMPolicy is the Schema for the TableIAMPolicys API. Collection of resources to manage IAM policy for BigQuery Table"'),
  ...
  '#new':: d.fn(help='new returns an instance of TableIAMPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TableIAMPolicySpec defines the desired state of TableIAMPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicyData':: d.fn(help='"The policy data generated by\\na google_iam_policy data source."', args=[d.arg(name='policyData', type=d.T.string)]),
      withPolicyData(policyData): { spec+: { forProvider+: { policyData: policyData } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withPolicyData':: d.fn(help='"The policy data generated by\\na google_iam_policy data source."', args=[d.arg(name='policyData', type=d.T.string)]),
      withPolicyData(policyData): { spec+: { initProvider+: { policyData: policyData } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs.\\nIf it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
