{
  ...
  '#':: d.pkg(name='version', url='', help='"Version is the Schema for the Versions API. You can create multiple versions of your agent flows and deploy them to separate serving environments."'),
  ...
  '#new':: d.fn(help='new returns an instance of Version', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VersionSpec defines the desired state of Version"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the version. The maximum length is 500 characters. If exceeded, the request is rejected."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The human-readable name of the version. Limit of 64 characters."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withParent':: d.fn(help='"The Flow to create an Version for.\\nFormat: projects//locations//agents//flows/."', args=[d.arg(name='parent', type=d.T.string)]),
