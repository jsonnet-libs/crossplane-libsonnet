{
  ...
  '#':: d.pkg(name='environment', url='', help='"Environment is the Schema for the Environments API. Represents an environment for an agent."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#versionConfigs':: d.obj(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned.\\nStructure is documented below."'),
      versionConfigs: {
        '#versionRef':: d.obj(help='"Reference to a Version in dialogflowcx to populate version."'),
        versionRef: {
          '#policy':: d.obj(help='"Policies for referencing."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
        ...
        '#versionSelector':: d.obj(help='"Selector for a Version in dialogflowcx to populate version."'),
        versionSelector: {
          '#policy':: d.obj(help='"Policies for selection."'),
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
        ...
        '#withVersion':: d.fn(help='"Format: projects/{{project}}/locations/{{location}}/agents/{{agent}}/flows/{{flow}}/versions/{{version}}."', args=[d.arg(name='version', type=d.T.string)]),
        withVersion(version): { version: version },
      },
      '#withDescription':: d.fn(help='"The human-readable description of the environment. The maximum length is 500 characters. If exceeded, the request is rejected."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"The human-readable name of the environment (unique in an agent). Limit of 64 characters."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withParent':: d.fn(help='"The Agent to create an Environment for.\\nFormat: projects//locations//agents/."', args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withVersionConfigs':: d.fn(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned.\\nStructure is documented below."', args=[d.arg(name='versionConfigs', type=d.T.array)]),
      withVersionConfigs(versionConfigs): { spec+: { forProvider+: { versionConfigs: if std.isArray(v=versionConfigs) then versionConfigs else [versionConfigs] } } },
      '#withVersionConfigsMixin':: d.fn(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='versionConfigs', type=d.T.array)]),
      withVersionConfigsMixin(versionConfigs): { spec+: { forProvider+: { versionConfigs+: if std.isArray(v=versionConfigs) then versionConfigs else [versionConfigs] } } },
    },
    ...
    initProvider: {
      ...
      '#withVersionConfigs':: d.fn(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned.\\nStructure is documented below."', args=[d.arg(name='versionConfigs', type=d.T.array)]),
      withVersionConfigs(versionConfigs): { spec+: { initProvider+: { versionConfigs: if std.isArray(v=versionConfigs) then versionConfigs else [versionConfigs] } } },
      '#withVersionConfigsMixin':: d.fn(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='versionConfigs', type=d.T.array)]),
      withVersionConfigsMixin(versionConfigs): { spec+: { initProvider+: { versionConfigs+: if std.isArray(v=versionConfigs) then versionConfigs else [versionConfigs] } } },
    },
