{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEntities':: d.fn(help='"The collection of entity entries associated with the entity type.\\nStructure is documented below."', args=[d.arg(name='entities', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withAutoExpansionMode':: d.fn(help='"Represents kinds of entities."', args=[d.arg(name='autoExpansionMode', type=d.T.string)]),
      withAutoExpansionMode(autoExpansionMode): { spec+: { initProvider+: { autoExpansionMode: autoExpansionMode } } },
      '#withDisplayName':: d.fn(help='"The human-readable name of the entity type, unique within the agent."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { initProvider+: { displayName: displayName } } },
      '#withEnableFuzzyExtraction':: d.fn(help='"Enables fuzzy entity extraction during classification."', args=[d.arg(name='enableFuzzyExtraction', type=d.T.boolean)]),
      withEnableFuzzyExtraction(enableFuzzyExtraction): { spec+: { initProvider+: { enableFuzzyExtraction: enableFuzzyExtraction } } },
      '#withEntities':: d.fn(help='"The collection of entity entries associated with the entity type.\\nStructure is documented below."', args=[d.arg(name='entities', type=d.T.array)]),
      withEntities(entities): { spec+: { initProvider+: { entities: if std.isArray(v=entities) then entities else [entities] } } },
      '#withEntitiesMixin':: d.fn(help='"The collection of entity entries associated with the entity type.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='entities', type=d.T.array)]),
      withEntitiesMixin(entities): { spec+: { initProvider+: { entities+: if std.isArray(v=entities) then entities else [entities] } } },
      '#withExcludedPhrases':: d.fn(help="\"Collection of exceptional words and phrases that shouldn't be matched. For example, if you have a size entity type with entry giant(an adjective), you might consider adding giants(a noun) as an exclusion.\\nIf the kind of entity type is KIND_MAP, then the phrases specified by entities and excluded phrases should be mutually exclusive.\\nStructure is documented below.\"", args=[d.arg(name='excludedPhrases', type=d.T.array)]),
      withExcludedPhrases(excludedPhrases): { spec+: { initProvider+: { excludedPhrases: if std.isArray(v=excludedPhrases) then excludedPhrases else [excludedPhrases] } } },
      '#withExcludedPhrasesMixin':: d.fn(help="\"Collection of exceptional words and phrases that shouldn't be matched. For example, if you have a size entity type with entry giant(an adjective), you might consider adding giants(a noun) as an exclusion.\\nIf the kind of entity type is KIND_MAP, then the phrases specified by entities and excluded phrases should be mutually exclusive.\\nStructure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='excludedPhrases', type=d.T.array)]),
      withExcludedPhrasesMixin(excludedPhrases): { spec+: { initProvider+: { excludedPhrases+: if std.isArray(v=excludedPhrases) then excludedPhrases else [excludedPhrases] } } },
      '#withKind':: d.fn(help='"Indicates whether the entity type can be automatically expanded."', args=[d.arg(name='kind', type=d.T.string)]),
      ...
      '#withRedact':: d.fn(help='"Indicates whether parameters of the entity type should be redacted in log. If redaction is enabled, page parameters and intent parameters referring to the entity type will be replaced by parameter name when logging."', args=[d.arg(name='redact', type=d.T.boolean)]),
      withRedact(redact): { spec+: { initProvider+: { redact: redact } } },
    },
