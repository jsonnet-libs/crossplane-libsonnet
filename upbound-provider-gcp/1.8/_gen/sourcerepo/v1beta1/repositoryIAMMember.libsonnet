{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#repositoryRef':: d.obj(help='"Reference to a Repository in sourcerepo to populate repository."'),
      repositoryRef: {
      ...
      '#repositorySelector':: d.obj(help='"Selector for a Repository in sourcerepo to populate repository."'),
      repositorySelector: {
