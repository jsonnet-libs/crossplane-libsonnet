{
  ...
  '#':: d.pkg(name='table', url='', help='"Table is the Schema for the Tables API. Creates a Google Cloud Bigtable table inside an instance."'),
  ...
  spec: {
    ...
    forProvider: {
      '#automatedBackupPolicy':: d.obj(help='"Defines an automated backup policy for a table, specified by Retention Period and Frequency. To disable, set both Retention Period and Frequency to 0."'),
      automatedBackupPolicy: {
        '#withFrequency':: d.fn(help='', args=[d.arg(name='frequency', type=d.T.string)]),
        withFrequency(frequency): { spec+: { forProvider+: { automatedBackupPolicy+: { frequency: frequency } } } },
        '#withRetentionPeriod':: d.fn(help='', args=[d.arg(name='retentionPeriod', type=d.T.string)]),
        withRetentionPeriod(retentionPeriod): { spec+: { forProvider+: { automatedBackupPolicy+: { retentionPeriod: retentionPeriod } } } },
      },
      '#columnFamily':: d.obj(help='"A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below."'),
      columnFamily: {
      ...
      withChangeStreamRetention(changeStreamRetention): { spec+: { forProvider+: { changeStreamRetention: changeStreamRetention } } },
      '#withColumnFamily':: d.fn(help='"A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below."', args=[d.arg(name='columnFamily', type=d.T.array)]),
      withColumnFamily(columnFamily): { spec+: { forProvider+: { columnFamily: if std.isArray(v=columnFamily) then columnFamily else [columnFamily] } } },
      '#withColumnFamilyMixin':: d.fn(help='"A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='columnFamily', type=d.T.array)]),
      withColumnFamilyMixin(columnFamily): { spec+: { forProvider+: { columnFamily+: if std.isArray(v=columnFamily) then columnFamily else [columnFamily] } } },
      '#withDeletionProtection':: d.fn(help='"A field to make the table protected against data loss i.e. when set to PROTECTED, deleting the table, the column families in the table, and the instance containing the table would be prohibited. If not provided, deletion protection will be set to UNPROTECTED."', args=[d.arg(name='deletionProtection', type=d.T.string)]),
      ...
      '#withSplitKeys':: d.fn(help='"A list of predefined keys to split the table on."', args=[d.arg(name='splitKeys', type=d.T.array)]),
      withSplitKeys(splitKeys): { spec+: { forProvider+: { splitKeys: if std.isArray(v=splitKeys) then splitKeys else [splitKeys] } } },
      '#withSplitKeysMixin':: d.fn(help='"A list of predefined keys to split the table on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='splitKeys', type=d.T.array)]),
      withSplitKeysMixin(splitKeys): { spec+: { forProvider+: { splitKeys+: if std.isArray(v=splitKeys) then splitKeys else [splitKeys] } } },
    },
    ...
    initProvider: {
      ...
      automatedBackupPolicy: {
        '#withFrequency':: d.fn(help='', args=[d.arg(name='frequency', type=d.T.string)]),
        withFrequency(frequency): { spec+: { initProvider+: { automatedBackupPolicy+: { frequency: frequency } } } },
        '#withRetentionPeriod':: d.fn(help='', args=[d.arg(name='retentionPeriod', type=d.T.string)]),
        withRetentionPeriod(retentionPeriod): { spec+: { initProvider+: { automatedBackupPolicy+: { retentionPeriod: retentionPeriod } } } },
      },
      '#columnFamily':: d.obj(help='"A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below."'),
      columnFamily: {
        '#withFamily':: d.fn(help='"The name of the column family."', args=[d.arg(name='family', type=d.T.string)]),
      ...
      '#withChangeStreamRetention':: d.fn(help='"Duration to retain change stream data for the table. Set to 0 to disable. Must be between 1 and 7 days."', args=[d.arg(name='changeStreamRetention', type=d.T.string)]),
      withChangeStreamRetention(changeStreamRetention): { spec+: { initProvider+: { changeStreamRetention: changeStreamRetention } } },
      '#withColumnFamily':: d.fn(help='"A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below."', args=[d.arg(name='columnFamily', type=d.T.array)]),
      withColumnFamily(columnFamily): { spec+: { initProvider+: { columnFamily: if std.isArray(v=columnFamily) then columnFamily else [columnFamily] } } },
      '#withColumnFamilyMixin':: d.fn(help='"A group of columns within a table which share a common configuration. This can be specified multiple times. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='columnFamily', type=d.T.array)]),
      withColumnFamilyMixin(columnFamily): { spec+: { initProvider+: { columnFamily+: if std.isArray(v=columnFamily) then columnFamily else [columnFamily] } } },
      '#withDeletionProtection':: d.fn(help='"A field to make the table protected against data loss i.e. when set to PROTECTED, deleting the table, the column families in the table, and the instance containing the table would be prohibited. If not provided, deletion protection will be set to UNPROTECTED."', args=[d.arg(name='deletionProtection', type=d.T.string)]),
      ...
      '#withSplitKeys':: d.fn(help='"A list of predefined keys to split the table on."', args=[d.arg(name='splitKeys', type=d.T.array)]),
      withSplitKeys(splitKeys): { spec+: { initProvider+: { splitKeys: if std.isArray(v=splitKeys) then splitKeys else [splitKeys] } } },
      '#withSplitKeysMixin':: d.fn(help='"A list of predefined keys to split the table on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='splitKeys', type=d.T.array)]),
      withSplitKeysMixin(splitKeys): { spec+: { initProvider+: { splitKeys+: if std.isArray(v=splitKeys) then splitKeys else [splitKeys] } } },
    },
