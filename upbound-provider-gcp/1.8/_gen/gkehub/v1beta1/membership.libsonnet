  ...
  spec: {
    ...
    forProvider: {
      ...
      endpoint: {
        ...
        '#withGkeCluster':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource.\\nStructure is documented below."', args=[d.arg(name='gkeCluster', type=d.T.array)]),
      ...
      '#withAuthority':: d.fn(help='"Authority encodes how Google will recognize identities from this Membership.\\nSee the workload identity documentation for more details:\\nhttps://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity\\nStructure is documented below."', args=[d.arg(name='authority', type=d.T.array)]),
      withAuthority(authority): { spec+: { forProvider+: { authority: if std.isArray(v=authority) then authority else [authority] } } },
      '#withAuthorityMixin':: d.fn(help='"Authority encodes how Google will recognize identities from this Membership.\\nSee the workload identity documentation for more details:\\nhttps://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authority', type=d.T.array)]),
      withAuthorityMixin(authority): { spec+: { forProvider+: { authority+: if std.isArray(v=authority) then authority else [authority] } } },
      '#withEndpoint':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource.\\nStructure is documented below."', args=[d.arg(name='endpoint', type=d.T.array)]),
      withEndpoint(endpoint): { spec+: { forProvider+: { endpoint: if std.isArray(v=endpoint) then endpoint else [endpoint] } } },
      '#withEndpointMixin':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource.\\nStructure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpoint', type=d.T.array)]),
