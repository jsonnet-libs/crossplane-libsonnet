{
  ...
  spec: {
    ...
    forProvider: {
      '#authority':: d.obj(help='"Authority encodes how Google will recognize identities from this Membership.\\nSee the workload identity documentation for more details:\\nhttps://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity\\nStructure is documented below."'),
      authority: {
        '#withIssuer':: d.fn(help='"A JSON Web Token (JWT) issuer URI. issuer must start with https:// and // be a valid\\nwith length <2000 characters. For example: https://container.googleapis.com/v1/projects/my-project/locations/us-west1/clusters/my-cluster (must be locations rather than zones).googleapis.com/v1/${google_container_cluster.my-cluster.id}\\"."', args=[d.arg(name='issuer', type=d.T.string)]),
        withIssuer(issuer): { spec+: { forProvider+: { authority+: { issuer: issuer } } } },
      },
        ...
        gkeCluster: {
          ...
          resourceLinkRef: {
            ...
            policy: {
              ...
              withResolution(resolution): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkRef+: { policy+: { resolution: resolution } } } } } } },
              ...
              withResolve(resolve): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkRef+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkRef+: { name: name } } } } } },
          },
          ...
          resourceLinkSelector: {
            ...
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { policy+: { resolve: resolve } } } } } } },
            },
            ...
            withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { matchControllerRef: matchControllerRef } } } } } },
            '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabels(matchLabels): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { matchLabels: matchLabels } } } } } },
            '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { matchLabels+: matchLabels } } } } } },
          },
          '#withResourceLink':: d.fn(help='"Self-link of the GCP resource for the GKE cluster.\\nFor example: //container.googleapis.com/projects/my-project/zones/us-west1-a/clusters/my-cluster.\\nIt can be at the most 1000 characters in length.googleapis.com/${google_container_cluster.my-cluster.id}\\" or\\ngoogle_container_cluster.my-cluster.id."', args=[d.arg(name='resourceLink', type=d.T.string)]),
          withResourceLink(resourceLink): { spec+: { forProvider+: { endpoint+: { gkeCluster+: { resourceLink: resourceLink } } } } },
        },
      },
    ...
    initProvider: {
      ...
      authority: {
        '#withIssuer':: d.fn(help='"A JSON Web Token (JWT) issuer URI. issuer must start with https:// and // be a valid\\nwith length <2000 characters. For example: https://container.googleapis.com/v1/projects/my-project/locations/us-west1/clusters/my-cluster (must be locations rather than zones).googleapis.com/v1/${google_container_cluster.my-cluster.id}\\"."', args=[d.arg(name='issuer', type=d.T.string)]),
        withIssuer(issuer): { spec+: { initProvider+: { authority+: { issuer: issuer } } } },
      },
      '#endpoint':: d.obj(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource.\\nStructure is documented below."'),
      endpoint: {
        '#gkeCluster':: d.obj(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource.\\nStructure is documented below."'),
        gkeCluster: {
          ...
          resourceLinkRef: {
            ...
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkRef+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkRef+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkRef+: { name: name } } } } } },
          },
          '#resourceLinkSelector':: d.obj(help='"Selector for a Cluster in container to populate resourceLink."'),
          resourceLinkSelector: {
            '#policy':: d.obj(help='"Policies for selection."'),
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { policy+: { resolution: resolution } } } } } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default\\nis 'IfNotPresent', which will attempt to resolve the reference only when\\nthe corresponding field is not present. Use 'Always' to resolve the\\nreference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { policy+: { resolve: resolve } } } } } } },
            },
            '#withMatchControllerRef':: d.fn(help='"MatchControllerRef ensures an object with the same controller reference\\nas the selecting object is selected."', args=[d.arg(name='matchControllerRef', type=d.T.boolean)]),
            withMatchControllerRef(matchControllerRef): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { matchControllerRef: matchControllerRef } } } } } },
            '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabels(matchLabels): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { matchLabels: matchLabels } } } } } },
            '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabelsMixin(matchLabels): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLinkSelector+: { matchLabels+: matchLabels } } } } } },
          },
          '#withResourceLink':: d.fn(help='"Self-link of the GCP resource for the GKE cluster.\\nFor example: //container.googleapis.com/projects/my-project/zones/us-west1-a/clusters/my-cluster.\\nIt can be at the most 1000 characters in length.googleapis.com/${google_container_cluster.my-cluster.id}\\" or\\ngoogle_container_cluster.my-cluster.id."', args=[d.arg(name='resourceLink', type=d.T.string)]),
          withResourceLink(resourceLink): { spec+: { initProvider+: { endpoint+: { gkeCluster+: { resourceLink: resourceLink } } } } },
        },
      },
      '#withLabels':: d.fn(help='"Labels to apply to this membership."', args=[d.arg(name='labels', type=d.T.object)]),
