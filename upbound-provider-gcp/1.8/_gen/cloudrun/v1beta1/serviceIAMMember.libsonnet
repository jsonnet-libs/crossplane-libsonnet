{
  ...
  '#':: d.pkg(name='serviceIAMMember', url='', help='"ServiceIAMMember is the Schema for the ServiceIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServiceIAMMemberSpec defines the desired state of ServiceIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withMember':: d.fn(help='', args=[d.arg(name='member', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withMember':: d.fn(help='', args=[d.arg(name='member', type=d.T.string)]),
      withMember(member): { spec+: { initProvider+: { member: member } } },
      '#withProject':: d.fn(help='', args=[d.arg(name='project', type=d.T.string)]),
