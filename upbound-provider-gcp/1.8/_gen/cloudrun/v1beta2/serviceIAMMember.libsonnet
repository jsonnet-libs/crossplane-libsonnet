  ...
  spec: {
    ...
    forProvider: {
      ...
      condition: {
        ...
        withDescription(description): { spec+: { forProvider+: { condition+: { description: description } } } },
        '#withExpression':: d.fn(help='', args=[d.arg(name='expression', type=d.T.string)]),
        withExpression(expression): { spec+: { forProvider+: { condition+: { expression: expression } } } },
        '#withTitle':: d.fn(help='', args=[d.arg(name='title', type=d.T.string)]),
        withTitle(title): { spec+: { forProvider+: { condition+: { title: title } } } },
      },
    ...
    initProvider: {
      ...
      condition: {
        '#withDescription':: d.fn(help='', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { spec+: { initProvider+: { condition+: { description: description } } } },
        '#withExpression':: d.fn(help='', args=[d.arg(name='expression', type=d.T.string)]),
        withExpression(expression): { spec+: { initProvider+: { condition+: { expression: expression } } } },
        '#withTitle':: d.fn(help='', args=[d.arg(name='title', type=d.T.string)]),
        withTitle(title): { spec+: { initProvider+: { condition+: { title: title } } } },
      },
      '#projectRef':: d.obj(help='"Reference to a Project in cloudplatform to populate project."'),
      projectRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
