{
  ...
  spec: {
    ...
    forProvider: {
      '#withLocation':: d.fn(help='"The location for the KeyRing.\\nA full list of valid locations can be found by running gcloud kms locations list."', args=[d.arg(name='location', type=d.T.string)]),
