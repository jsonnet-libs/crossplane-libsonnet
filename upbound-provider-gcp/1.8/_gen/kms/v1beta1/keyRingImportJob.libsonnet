{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withImportMethod':: d.fn(help='"The wrapping method to be used for incoming key material.\\nPossible values are: RSA_OAEP_3072_SHA1_AES_256, RSA_OAEP_4096_SHA1_AES_256."', args=[d.arg(name='importMethod', type=d.T.string)]),
      withImportMethod(importMethod): { spec+: { forProvider+: { importMethod: importMethod } } },
      '#withKeyRing':: d.fn(help="\"The KeyRing that this import job belongs to.\\nFormat: 'projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}'.\"", args=[d.arg(name='keyRing', type=d.T.string)]),
      withKeyRing(keyRing): { spec+: { forProvider+: { keyRing: keyRing } } },
      '#withProtectionLevel':: d.fn(help='"The protection level of the ImportJob. This must match the protectionLevel of the\\nversionTemplate on the CryptoKey you attempt to import into.\\nPossible values are: SOFTWARE, HSM, EXTERNAL."', args=[d.arg(name='protectionLevel', type=d.T.string)]),
