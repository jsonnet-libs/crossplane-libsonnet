  ...
  spec: {
    ...
    forProvider: {
      ...
      externalProtectionLevelOptions: {
        ...
        withEkmConnectionKeyPath(ekmConnectionKeyPath): { spec+: { forProvider+: { externalProtectionLevelOptions+: { ekmConnectionKeyPath: ekmConnectionKeyPath } } } },
        ...
        withExternalKeyUri(externalKeyUri): { spec+: { forProvider+: { externalProtectionLevelOptions+: { externalKeyUri: externalKeyUri } } } },
      },
    ...
    initProvider: {
      ...
      externalProtectionLevelOptions: {
        '#withEkmConnectionKeyPath':: d.fn(help='"The path to the external key material on the EKM when using EkmConnection e.g., \\"v0/my/key\\". Set this field instead of externalKeyUri when using an EkmConnection."', args=[d.arg(name='ekmConnectionKeyPath', type=d.T.string)]),
        withEkmConnectionKeyPath(ekmConnectionKeyPath): { spec+: { initProvider+: { externalProtectionLevelOptions+: { ekmConnectionKeyPath: ekmConnectionKeyPath } } } },
        '#withExternalKeyUri':: d.fn(help='"The URI for an external resource that this CryptoKeyVersion represents."', args=[d.arg(name='externalKeyUri', type=d.T.string)]),
        withExternalKeyUri(externalKeyUri): { spec+: { initProvider+: { externalProtectionLevelOptions+: { externalKeyUri: externalKeyUri } } } },
      },
      '#withCryptoKey':: d.fn(help="\"The name of the cryptoKey associated with the CryptoKeyVersions.\\nFormat: 'projects/{{project}}/locations/{{location}}/keyRings/{{keyring}}/cryptoKeys/{{cryptoKey}}'\"", args=[d.arg(name='cryptoKey', type=d.T.string)]),
