{
  ...
  '#':: d.pkg(name='tagKey', url='', help='"TagKey is the Schema for the TagKeys API. A TagKey, used to group a set of TagValues."'),
  ...
  '#new':: d.fn(help='new returns an instance of TagKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TagKeySpec defines the desired state of TagKey"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"User-assigned description of the TagKey. Must not exceed 256 characters."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withParent':: d.fn(help="\"Input only. The resource name of the new TagKey's parent. Must be of the form organizations/{org_id} or projects/{project_id_or_number}.\"", args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withPurpose':: d.fn(help='"Optional. A purpose cannot be changed once set.\\nA purpose denotes that this Tag is intended for use in policies of a specific policy engine, and will involve that policy engine in management operations involving this Tag.\\nPossible values are: GCE_FIREWALL."', args=[d.arg(name='purpose', type=d.T.string)]),
      withPurpose(purpose): { spec+: { forProvider+: { purpose: purpose } } },
      '#withPurposeData':: d.fn(help='"Optional. Purpose data cannot be changed once set.\\nPurpose data corresponds to the policy system that the tag is intended for. For example, the GCE_FIREWALL purpose expects data in the following format: network = \\"<project-name>/<vpc-name>\\"."', args=[d.arg(name='purposeData', type=d.T.object)]),
      withPurposeData(purposeData): { spec+: { forProvider+: { purposeData: purposeData } } },
      '#withPurposeDataMixin':: d.fn(help='"Optional. Purpose data cannot be changed once set.\\nPurpose data corresponds to the policy system that the tag is intended for. For example, the GCE_FIREWALL purpose expects data in the following format: network = \\"<project-name>/<vpc-name>\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='purposeData', type=d.T.object)]),
      withPurposeDataMixin(purposeData): { spec+: { forProvider+: { purposeData+: purposeData } } },
      '#withShortName':: d.fn(help='"Input only. The user friendly name for a TagKey. The short name should be unique for TagKeys within the same tag namespace.\\nThe short name must be 1-63 characters, beginning and ending with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between."', args=[d.arg(name='shortName', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withPurposeData':: d.fn(help='"Optional. Purpose data cannot be changed once set.\\nPurpose data corresponds to the policy system that the tag is intended for. For example, the GCE_FIREWALL purpose expects data in the following format: network = \\"<project-name>/<vpc-name>\\"."', args=[d.arg(name='purposeData', type=d.T.object)]),
      withPurposeData(purposeData): { spec+: { initProvider+: { purposeData: purposeData } } },
      '#withPurposeDataMixin':: d.fn(help='"Optional. Purpose data cannot be changed once set.\\nPurpose data corresponds to the policy system that the tag is intended for. For example, the GCE_FIREWALL purpose expects data in the following format: network = \\"<project-name>/<vpc-name>\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='purposeData', type=d.T.object)]),
      withPurposeDataMixin(purposeData): { spec+: { initProvider+: { purposeData+: purposeData } } },
      '#withShortName':: d.fn(help='"Input only. The user friendly name for a TagKey. The short name should be unique for TagKeys within the same tag namespace.\\nThe short name must be 1-63 characters, beginning and ending with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between."', args=[d.arg(name='shortName', type=d.T.string)]),
