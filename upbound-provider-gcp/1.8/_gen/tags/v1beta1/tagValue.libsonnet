{
  ...
  '#':: d.pkg(name='tagValue', url='', help='"TagValue is the Schema for the TagValues API. A TagValue is a child of a particular TagKey."'),
  ...
  '#new':: d.fn(help='new returns an instance of TagValue', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TagValueSpec defines the desired state of TagValue"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#parentRef':: d.obj(help='"Reference to a TagKey in tags to populate parent."'),
      parentRef: {
      ...
      '#parentSelector':: d.obj(help='"Selector for a TagKey in tags to populate parent."'),
      parentSelector: {
      ...
      '#withParent':: d.fn(help="\"Input only. The resource name of the new TagValue's parent. Must be of the form tagKeys/{tag_key_id}.\"", args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withShortName':: d.fn(help='"Input only. User-assigned short name for TagValue. The short name should be unique for TagValues within the same parent TagKey.\\nThe short name must be 63 characters or less, beginning and ending with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between."', args=[d.arg(name='shortName', type=d.T.string)]),
