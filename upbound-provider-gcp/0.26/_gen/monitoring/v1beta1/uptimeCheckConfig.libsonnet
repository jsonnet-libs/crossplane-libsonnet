  ...
  spec: {
    ...
    forProvider: {
      ...
      contentMatchers: {
        ...
        jsonPathMatcher: {
          '#withJsonMatcher':: d.fn(help='"Options to perform JSONPath content matching. Default value is EXACT_MATCH. Possible values are EXACT_MATCH and REGEX_MATCH."', args=[d.arg(name='jsonMatcher', type=d.T.string)]),
        ...
        '#withMatcher':: d.fn(help='"The type of content matcher that will be applied to the server output, compared to the content string when the check is run. Default value is CONTAINS_STRING. Possible values are CONTAINS_STRING, NOT_CONTAINS_STRING, MATCHES_REGEX, NOT_MATCHES_REGEX, MATCHES_JSON_PATH, and NOT_MATCHES_JSON_PATH."', args=[d.arg(name='matcher', type=d.T.string)]),
      ...
      httpCheck: {
        ...
        acceptedResponseStatusCodes: {
          '#withStatusClass':: d.fn(help='"A class of status codes to accept. Possible values are STATUS_CLASS_1XX, STATUS_CLASS_2XX, STATUS_CLASS_3XX, STATUS_CLASS_4XX, STATUS_CLASS_5XX, and STATUS_CLASS_ANY."', args=[d.arg(name='statusClass', type=d.T.string)]),
