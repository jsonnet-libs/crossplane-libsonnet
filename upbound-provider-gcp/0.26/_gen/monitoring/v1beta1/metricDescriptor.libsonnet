  ...
  spec: {
    ...
    forProvider: {
      ...
      labels: {
        ...
        withKey(key): { key: key },
        '#withValueType':: d.fn(help='"The type of data that can be assigned to the label. Default value is STRING. Possible values are STRING, BOOL, and INT64."', args=[d.arg(name='valueType', type=d.T.string)]),
      ...
      '#withLaunchStage':: d.fn(help='"The launch stage of the metric definition. Possible values are LAUNCH_STAGE_UNSPECIFIED, UNIMPLEMENTED, PRELAUNCH, EARLY_ACCESS, ALPHA, BETA, GA, and DEPRECATED."', args=[d.arg(name='launchStage', type=d.T.string)]),
      ...
      '#withMetricKind':: d.fn(help='"Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metricKind and valueType might not be supported. Possible values are METRIC_KIND_UNSPECIFIED, GAUGE, DELTA, and CUMULATIVE."', args=[d.arg(name='metricKind', type=d.T.string)]),
      ...
      '#withValueType':: d.fn(help='"Whether the measurement is an integer, a floating-point number, etc. Some combinations of metricKind and valueType might not be supported. Possible values are BOOL, INT64, DOUBLE, STRING, and DISTRIBUTION."', args=[d.arg(name='valueType', type=d.T.string)]),
