{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#passwordSecretRef':: d.obj(help='"The password for the user. Can be updated. For Postgres instances this is a Required field, unless type is set to either CLOUD_IAM_USER or CLOUD_IAM_SERVICE_ACCOUNT."'),
      passwordSecretRef: {
      ...
      '#withHost':: d.fn(help="\"The host the user can connect from. This is only supported for MySQL instances. Don't set this field for PostgreSQL instances. Can be an IP address. Changing this forces a new resource to be created.\"", args=[d.arg(name='host', type=d.T.string)]),
