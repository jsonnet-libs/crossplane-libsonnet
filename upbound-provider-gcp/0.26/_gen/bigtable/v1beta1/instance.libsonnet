  ...
  spec: {
    ...
    forProvider: {
      ...
      cluster: {
        ...
        '#withNumNodes':: d.fn(help='"The number of nodes in your Cloud Bigtable cluster. Required, with a minimum of 1 for a PRODUCTION instance. Must be left unset for a DEVELOPMENT instance."', args=[d.arg(name='numNodes', type=d.T.number)]),
