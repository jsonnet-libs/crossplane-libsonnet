{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMtu':: d.fn(help='"Maximum Transmission Unit in bytes. The minimum value for this field is 1460 and the maximum value is 1500 bytes."', args=[d.arg(name='mtu', type=d.T.number)]),
