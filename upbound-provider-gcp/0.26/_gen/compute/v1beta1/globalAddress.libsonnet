{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIpVersion':: d.fn(help='"The IP Version that will be used by this address. The default value is IPV4. Possible values are IPV4 and IPV6."', args=[d.arg(name='ipVersion', type=d.T.string)]),
