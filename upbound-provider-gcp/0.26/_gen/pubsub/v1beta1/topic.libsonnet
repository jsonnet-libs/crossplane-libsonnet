{
  ...
  spec: {
    ...
    forProvider: {
      ...
      schemaSettings: {
        '#withEncoding':: d.fn(help='"The encoding of messages validated against schema. Default value is ENCODING_UNSPECIFIED. Possible values are ENCODING_UNSPECIFIED, JSON, and BINARY."', args=[d.arg(name='encoding', type=d.T.string)]),
