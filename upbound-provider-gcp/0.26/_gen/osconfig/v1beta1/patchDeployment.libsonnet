    ...
    forProvider: {
      ...
      patchConfig: {
        ...
        apt: {
          ...
          '#withType':: d.fn(help='"By changing the type to DIST, the patching is performed using apt-get dist-upgrade instead. Possible values are DIST and UPGRADE."', args=[d.arg(name='type', type=d.T.string)]),
        ...
        postStep: {
          ...
          linuxExecStepConfig: {
            ...
            '#withInterpreter':: d.fn(help='"The script interpreter to use to run the script. If no interpreter is specified the script will be executed directly, which will likely only succeed for scripts with shebang lines. Possible values are SHELL and POWERSHELL."', args=[d.arg(name='interpreter', type=d.T.string)]),
        ...
        windowsUpdate: {
          '#withClassifications':: d.fn(help='"Only apply updates of these windows update classifications. If empty, all updates are applied. Each value may be one of CRITICAL, SECURITY, DEFINITION, DRIVER, FEATURE_PACK, SERVICE_PACK, TOOL, UPDATE_ROLLUP, and UPDATE."', args=[d.arg(name='classifications', type=d.T.array)]),
          ...
          '#withClassificationsMixin':: d.fn(help='"Only apply updates of these windows update classifications. If empty, all updates are applied. Each value may be one of CRITICAL, SECURITY, DEFINITION, DRIVER, FEATURE_PACK, SERVICE_PACK, TOOL, UPDATE_ROLLUP, and UPDATE."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='classifications', type=d.T.array)]),
        ...
        '#withRebootConfig':: d.fn(help='"Post-patch reboot settings. Possible values are DEFAULT, ALWAYS, and NEVER."', args=[d.arg(name='rebootConfig', type=d.T.string)]),
      ...
      recurringSchedule: {
        ...
        monthly: {
          ...
          weekDayOfMonth: {
            '#withDayOfWeek':: d.fn(help='"IANA Time Zone Database time zone, e.g. \\"America/New_York\\". Possible values are MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, and SUNDAY."', args=[d.arg(name='dayOfWeek', type=d.T.string)]),
      ...
      rollout: {
        ...
        '#withMode':: d.fn(help='"Mode of the patch rollout. Possible values are ZONE_BY_ZONE and CONCURRENT_ZONES."', args=[d.arg(name='mode', type=d.T.string)]),
