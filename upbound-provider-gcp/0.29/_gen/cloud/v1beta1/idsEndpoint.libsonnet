{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSeverity':: d.fn(help='"The minimum alert severity level that is reported by the endpoint. Possible values are INFORMATIONAL, LOW, MEDIUM, HIGH, and CRITICAL."', args=[d.arg(name='severity', type=d.T.string)]),
