    ...
    forProvider: {
      ...
      inspectJob: {
        ...
        storageConfig: {
          ...
          bigQueryOptions: {
            '#identifyingFields':: d.obj(help='"Specifies the BigQuery fields that will be returned with findings. If not specified, no identifying fields will be returned for findings. Structure is documented below."'),
            identifyingFields: {
            ...
            '#withIdentifyingFields':: d.fn(help='"Specifies the BigQuery fields that will be returned with findings. If not specified, no identifying fields will be returned for findings. Structure is documented below."', args=[d.arg(name='identifyingFields', type=d.T.array)]),
            ...
            '#withIdentifyingFieldsMixin':: d.fn(help='"Specifies the BigQuery fields that will be returned with findings. If not specified, no identifying fields will be returned for findings. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='identifyingFields', type=d.T.array)]),
