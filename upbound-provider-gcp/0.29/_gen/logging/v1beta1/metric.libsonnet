    ...
    forProvider: {
      ...
      metricDescriptor: {
        ...
        labels: {
          ...
          withKey(key): { key: key },
          '#withValueType':: d.fn(help='"Whether the measurement is an integer, a floating-point number, etc. Some combinations of metricKind and valueType might not be supported. For counter metrics, set this to INT64. Possible values are BOOL, INT64, DOUBLE, STRING, DISTRIBUTION, and MONEY."', args=[d.arg(name='valueType', type=d.T.string)]),
        ...
        '#withMetricKind':: d.fn(help='"Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metricKind and valueType might not be supported. For counter metrics, set this to DELTA. Possible values are DELTA, GAUGE, and CUMULATIVE."', args=[d.arg(name='metricKind', type=d.T.string)]),
