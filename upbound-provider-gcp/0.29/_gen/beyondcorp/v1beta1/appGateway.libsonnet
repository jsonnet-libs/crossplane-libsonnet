{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withHostType':: d.fn(help='"The type of hosting used by the AppGateway. Default value is HOST_TYPE_UNSPECIFIED. Possible values are HOST_TYPE_UNSPECIFIED and GCP_REGIONAL_MIG."', args=[d.arg(name='hostType', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of network connectivity used by the AppGateway. Default value is TYPE_UNSPECIFIED. Possible values are TYPE_UNSPECIFIED and TCP_PROXY."', args=[d.arg(name='type', type=d.T.string)]),
