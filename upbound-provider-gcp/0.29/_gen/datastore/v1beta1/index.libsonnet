{
  ...
  spec: {
    ...
    forProvider: {
      ...
      properties: {
        '#withDirection':: d.fn(help='"The direction the index should optimize for sorting. Possible values are ASCENDING and DESCENDING."', args=[d.arg(name='direction', type=d.T.string)]),
      ...
      '#withAncestor':: d.fn(help='"Policy for including ancestors in the index. Default value is NONE. Possible values are NONE and ALL_ANCESTORS."', args=[d.arg(name='ancestor', type=d.T.string)]),
