{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiProxyType':: d.fn(help='"Optional. API Proxy type supported by the environment. The type can be set when creating the Environment and cannot be changed. Possible values are API_PROXY_TYPE_UNSPECIFIED, PROGRAMMABLE, and CONFIGURABLE."', args=[d.arg(name='apiProxyType', type=d.T.string)]),
      withApiProxyType(apiProxyType): { spec+: { forProvider+: { apiProxyType: apiProxyType } } },
      '#withDeploymentType':: d.fn(help='"Optional. Deployment type supported by the environment. The deployment type can be set when creating the environment and cannot be changed. When you enable archive deployment, you will be prevented from performing a subset of actions within the environment, including: Managing the deployment of API proxy or shared flow revisions; Creating, updating, or deleting resource files; Creating, updating, or deleting target servers. Possible values are DEPLOYMENT_TYPE_UNSPECIFIED, PROXY, and ARCHIVE."', args=[d.arg(name='deploymentType', type=d.T.string)]),
