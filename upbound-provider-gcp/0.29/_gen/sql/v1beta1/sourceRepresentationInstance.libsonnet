{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDatabaseVersion':: d.fn(help='"The MySQL version running on your source database server. Possible values are MYSQL_5_5, MYSQL_5_6, MYSQL_5_7, and MYSQL_8_0."', args=[d.arg(name='databaseVersion', type=d.T.string)]),
