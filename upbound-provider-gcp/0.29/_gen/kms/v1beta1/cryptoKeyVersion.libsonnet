{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withState':: d.fn(help='"The current state of the CryptoKeyVersion. Possible values are PENDING_GENERATION, ENABLED, DISABLED, DESTROYED, DESTROY_SCHEDULED, PENDING_IMPORT, and IMPORT_FAILED."', args=[d.arg(name='state', type=d.T.string)]),
