{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withImportMethod':: d.fn(help='"The wrapping method to be used for incoming key material. Possible values are RSA_OAEP_3072_SHA1_AES_256 and RSA_OAEP_4096_SHA1_AES_256."', args=[d.arg(name='importMethod', type=d.T.string)]),
      ...
      '#withProtectionLevel':: d.fn(help='"The protection level of the ImportJob. This must match the protectionLevel of the versionTemplate on the CryptoKey you attempt to import into. Possible values are SOFTWARE, HSM, and EXTERNAL."', args=[d.arg(name='protectionLevel', type=d.T.string)]),
