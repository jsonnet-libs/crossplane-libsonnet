{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withType':: d.fn(help='"The type of the schema definition Default value is TYPE_UNSPECIFIED. Possible values are TYPE_UNSPECIFIED, PROTOCOL_BUFFER, and AVRO."', args=[d.arg(name='type', type=d.T.string)]),
