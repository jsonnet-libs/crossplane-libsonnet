{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNetworkEndpointType':: d.fn(help='"Type of network endpoints in this network endpoint group. Possible values are INTERNET_IP_PORT and INTERNET_FQDN_PORT."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
