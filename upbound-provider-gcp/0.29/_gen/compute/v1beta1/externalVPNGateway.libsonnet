{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRedundancyType':: d.fn(help='"Indicates the redundancy type of this external VPN gateway Possible values are FOUR_IPS_REDUNDANCY, SINGLE_IP_INTERNALLY_REDUNDANT, and TWO_IPS_REDUNDANCY."', args=[d.arg(name='redundancyType', type=d.T.string)]),
