{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAddressType':: d.fn(help='"The type of address to reserve. Default value is EXTERNAL. Possible values are INTERNAL and EXTERNAL."', args=[d.arg(name='addressType', type=d.T.string)]),
