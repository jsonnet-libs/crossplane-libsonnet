{
  ...
  '#new':: d.fn(help='new returns an instance of Client', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClientSpec defines the desired state of Client"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withApplicationId':: d.fn(help='"The Azure Active Directory Application ID."', args=[d.arg(name='applicationId', type=d.T.string)]),
