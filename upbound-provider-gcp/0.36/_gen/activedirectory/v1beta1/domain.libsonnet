{
  ...
  '#':: d.pkg(name='domain', url='', help='"Domain is the Schema for the Domains API. Creates a Microsoft AD domain"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAdmin':: d.fn(help='"The name of delegated administrator account used to perform Active Directory operations. If not specified, setupadmin will be used."', args=[d.arg(name='admin', type=d.T.string)]),
      withAdmin(admin): { spec+: { forProvider+: { admin: admin } } },
      '#withAuthorizedNetworks':: d.fn(help='"The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks. If CIDR subnets overlap between networks, domain creation will fail."', args=[d.arg(name='authorizedNetworks', type=d.T.array)]),
      withAuthorizedNetworks(authorizedNetworks): { spec+: { forProvider+: { authorizedNetworks: if std.isArray(v=authorizedNetworks) then authorizedNetworks else [authorizedNetworks] } } },
      '#withAuthorizedNetworksMixin':: d.fn(help='"The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks. If CIDR subnets overlap between networks, domain creation will fail."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authorizedNetworks', type=d.T.array)]),
      withAuthorizedNetworksMixin(authorizedNetworks): { spec+: { forProvider+: { authorizedNetworks+: if std.isArray(v=authorizedNetworks) then authorizedNetworks else [authorizedNetworks] } } },
      '#withDomainName':: d.fn(help='"The fully qualified domain name. e.g. mydomain.myorganization.com, with the restrictions, https://cloud.google.com/managed-microsoft-ad/reference/rest/v1/projects.locations.global.domains."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withLabels':: d.fn(help='"Resource labels that can contain user-provided metadata"', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Resource labels that can contain user-provided metadata"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withLocations':: d.fn(help='"Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/] e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block."', args=[d.arg(name='locations', type=d.T.array)]),
      withLocations(locations): { spec+: { forProvider+: { locations: if std.isArray(v=locations) then locations else [locations] } } },
      '#withLocationsMixin':: d.fn(help='"Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/] e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='locations', type=d.T.array)]),
      ...
      '#withReservedIpRange':: d.fn(help='"The CIDR range of internal addresses that are reserved for this domain. Reserved networks must be /24 or larger. Ranges must be unique and non-overlapping with existing subnets in authorizedNetworks"', args=[d.arg(name='reservedIpRange', type=d.T.string)]),
    ...
    initProvider: {
      '#withAdmin':: d.fn(help='"The name of delegated administrator account used to perform Active Directory operations. If not specified, setupadmin will be used."', args=[d.arg(name='admin', type=d.T.string)]),
      withAdmin(admin): { spec+: { initProvider+: { admin: admin } } },
      '#withAuthorizedNetworks':: d.fn(help='"The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks. If CIDR subnets overlap between networks, domain creation will fail."', args=[d.arg(name='authorizedNetworks', type=d.T.array)]),
      withAuthorizedNetworks(authorizedNetworks): { spec+: { initProvider+: { authorizedNetworks: if std.isArray(v=authorizedNetworks) then authorizedNetworks else [authorizedNetworks] } } },
      '#withAuthorizedNetworksMixin':: d.fn(help='"The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks. If CIDR subnets overlap between networks, domain creation will fail."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authorizedNetworks', type=d.T.array)]),
      withAuthorizedNetworksMixin(authorizedNetworks): { spec+: { initProvider+: { authorizedNetworks+: if std.isArray(v=authorizedNetworks) then authorizedNetworks else [authorizedNetworks] } } },
      '#withDomainName':: d.fn(help='"The fully qualified domain name. e.g. mydomain.myorganization.com, with the restrictions, https://cloud.google.com/managed-microsoft-ad/reference/rest/v1/projects.locations.global.domains."', args=[d.arg(name='domainName', type=d.T.string)]),
      ...
      '#withLocations':: d.fn(help='"Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/] e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block."', args=[d.arg(name='locations', type=d.T.array)]),
      withLocations(locations): { spec+: { initProvider+: { locations: if std.isArray(v=locations) then locations else [locations] } } },
      '#withLocationsMixin':: d.fn(help='"Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/] e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='locations', type=d.T.array)]),
      withLocationsMixin(locations): { spec+: { initProvider+: { locations+: if std.isArray(v=locations) then locations else [locations] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
