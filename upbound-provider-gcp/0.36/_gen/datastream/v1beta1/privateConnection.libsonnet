{
  ...
  spec: {
    ...
    forProvider: {
      '#vpcPeeringConfig':: d.obj(help="\"The VPC Peering configuration is used to create VPC peering between Datastream and the consumer's VPC. Structure is documented below.\""),
      vpcPeeringConfig: {
        ...
        vpcRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { vpcRef+: { policy+: { resolution: resolution } } },
            ...
            withResolve(resolve): { vpcRef+: { policy+: { resolve: resolve } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { vpcRef+: { name: name } },
        },
        ...
        vpcSelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { vpcSelector+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { vpcSelector+: { policy+: { resolve: resolve } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { vpcSelector+: { matchControllerRef: matchControllerRef } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { vpcSelector+: { matchLabels: matchLabels } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { vpcSelector+: { matchLabels+: matchLabels } },
        },
        ...
        '#withVpc':: d.fn(help='"Fully qualified name of the VPC that Datastream will peer to. Format: projects/{project}/global/{networks}/{name}"', args=[d.arg(name='vpc', type=d.T.string)]),
        withVpc(vpc): { vpc: vpc },
      },
      ...
      '#withVpcPeeringConfig':: d.fn(help="\"The VPC Peering configuration is used to create VPC peering between Datastream and the consumer's VPC. Structure is documented below.\"", args=[d.arg(name='vpcPeeringConfig', type=d.T.array)]),
      withVpcPeeringConfig(vpcPeeringConfig): { spec+: { forProvider+: { vpcPeeringConfig: if std.isArray(v=vpcPeeringConfig) then vpcPeeringConfig else [vpcPeeringConfig] } } },
      '#withVpcPeeringConfigMixin':: d.fn(help="\"The VPC Peering configuration is used to create VPC peering between Datastream and the consumer's VPC. Structure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='vpcPeeringConfig', type=d.T.array)]),
      withVpcPeeringConfigMixin(vpcPeeringConfig): { spec+: { forProvider+: { vpcPeeringConfig+: if std.isArray(v=vpcPeeringConfig) then vpcPeeringConfig else [vpcPeeringConfig] } } },
    },
    ...
    initProvider: {
      ...
      '#withVpcPeeringConfig':: d.fn(help="\"The VPC Peering configuration is used to create VPC peering between Datastream and the consumer's VPC. Structure is documented below.\"", args=[d.arg(name='vpcPeeringConfig', type=d.T.array)]),
      withVpcPeeringConfig(vpcPeeringConfig): { spec+: { initProvider+: { vpcPeeringConfig: if std.isArray(v=vpcPeeringConfig) then vpcPeeringConfig else [vpcPeeringConfig] } } },
      '#withVpcPeeringConfigMixin':: d.fn(help="\"The VPC Peering configuration is used to create VPC peering between Datastream and the consumer's VPC. Structure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='vpcPeeringConfig', type=d.T.array)]),
      withVpcPeeringConfigMixin(vpcPeeringConfig): { spec+: { initProvider+: { vpcPeeringConfig+: if std.isArray(v=vpcPeeringConfig) then vpcPeeringConfig else [vpcPeeringConfig] } } },
    },
