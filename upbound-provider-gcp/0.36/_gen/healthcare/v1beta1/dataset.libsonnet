{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTimeZone':: d.fn(help='"The default timezone used by this dataset. Must be a either a valid IANA time zone name such as \\"America/New_York\\" or empty, which defaults to UTC. This is used for parsing times in resources (e.g., HL7 messages) where no explicit timezone is specified."', args=[d.arg(name='timeZone', type=d.T.string)]),
