{
  ...
  '#':: d.pkg(name='datasetIAMMember', url='', help='"DatasetIAMMember is the Schema for the DatasetIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of DatasetIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatasetIAMMemberSpec defines the desired state of DatasetIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#datasetIdRef':: d.obj(help='"Reference to a Dataset in healthcare to populate datasetId."'),
      datasetIdRef: {
      ...
      '#datasetIdSelector':: d.obj(help='"Selector for a Dataset in healthcare to populate datasetId."'),
      datasetIdSelector: {
