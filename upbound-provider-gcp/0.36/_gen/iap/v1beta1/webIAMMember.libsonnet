{
  ...
  '#':: d.pkg(name='webIAMMember', url='', help='"WebIAMMember is the Schema for the WebIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebIAMMemberSpec defines the desired state of WebIAMMember"'),
  spec: {
