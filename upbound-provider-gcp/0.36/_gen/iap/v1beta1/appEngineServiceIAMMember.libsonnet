{
  ...
  '#':: d.pkg(name='appEngineServiceIAMMember', url='', help='"AppEngineServiceIAMMember is the Schema for the AppEngineServiceIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppEngineServiceIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppEngineServiceIAMMemberSpec defines the desired state of AppEngineServiceIAMMember"'),
  spec: {
