{
  ...
  '#':: d.pkg(name='tunnelIAMMember', url='', help='"TunnelIAMMember is the Schema for the TunnelIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of TunnelIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TunnelIAMMemberSpec defines the desired state of TunnelIAMMember"'),
  spec: {
