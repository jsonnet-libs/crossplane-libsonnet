{
  ...
  '#':: d.pkg(name='webTypeComputeIAMMember', url='', help='"WebTypeComputeIAMMember is the Schema for the WebTypeComputeIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebTypeComputeIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebTypeComputeIAMMemberSpec defines the desired state of WebTypeComputeIAMMember"'),
  spec: {
