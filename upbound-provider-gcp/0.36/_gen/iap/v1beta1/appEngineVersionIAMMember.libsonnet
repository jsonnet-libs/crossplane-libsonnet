{
  ...
  '#':: d.pkg(name='appEngineVersionIAMMember', url='', help='"AppEngineVersionIAMMember is the Schema for the AppEngineVersionIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppEngineVersionIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppEngineVersionIAMMemberSpec defines the desired state of AppEngineVersionIAMMember"'),
  spec: {
