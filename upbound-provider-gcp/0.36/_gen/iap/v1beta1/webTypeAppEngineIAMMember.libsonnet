{
  ...
  '#':: d.pkg(name='webTypeAppEngineIAMMember', url='', help='"WebTypeAppEngineIAMMember is the Schema for the WebTypeAppEngineIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebTypeAppEngineIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebTypeAppEngineIAMMemberSpec defines the desired state of WebTypeAppEngineIAMMember"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#appIdRef':: d.obj(help='"Reference to a Application in appengine to populate appId."'),
      appIdRef: {
      ...
      '#appIdSelector':: d.obj(help='"Selector for a Application in appengine to populate appId."'),
      appIdSelector: {
