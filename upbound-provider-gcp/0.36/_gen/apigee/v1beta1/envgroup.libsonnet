{
  ...
  '#':: d.pkg(name='envgroup', url='', help='"Envgroup is the Schema for the Envgroups API. An"'),
  ...
  '#new':: d.fn(help='new returns an instance of Envgroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EnvgroupSpec defines the desired state of Envgroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withHostnames':: d.fn(help='"Hostnames of the environment group."', args=[d.arg(name='hostnames', type=d.T.array)]),
      withHostnames(hostnames): { spec+: { forProvider+: { hostnames: if std.isArray(v=hostnames) then hostnames else [hostnames] } } },
      '#withHostnamesMixin':: d.fn(help='"Hostnames of the environment group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostnames', type=d.T.array)]),
      withHostnamesMixin(hostnames): { spec+: { forProvider+: { hostnames+: if std.isArray(v=hostnames) then hostnames else [hostnames] } } },
      '#withOrgId':: d.fn(help='"The Apigee Organization associated with the Apigee environment group, in the format organizations/{{org_name}}."', args=[d.arg(name='orgId', type=d.T.string)]),
    ...
    initProvider: {
      '#withHostnames':: d.fn(help='"Hostnames of the environment group."', args=[d.arg(name='hostnames', type=d.T.array)]),
      withHostnames(hostnames): { spec+: { initProvider+: { hostnames: if std.isArray(v=hostnames) then hostnames else [hostnames] } } },
      '#withHostnamesMixin':: d.fn(help='"Hostnames of the environment group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostnames', type=d.T.array)]),
      withHostnamesMixin(hostnames): { spec+: { initProvider+: { hostnames+: if std.isArray(v=hostnames) then hostnames else [hostnames] } } },
    },
