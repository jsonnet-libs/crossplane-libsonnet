{
  ...
  '#':: d.pkg(name='natAddress', url='', help='"NATAddress is the Schema for the NATAddresss API. Apigee NAT (network address translation) address."'),
  ...
  '#new':: d.fn(help='new returns an instance of NATAddress', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NATAddressSpec defines the desired state of NATAddress"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withInstanceId':: d.fn(help='"The Apigee instance associated with the Apigee environment, in the format organizations/{{org_name}}/instances/{{instance_name}}."', args=[d.arg(name='instanceId', type=d.T.string)]),
