{
  ...
  '#':: d.pkg(name='environment', url='', help='"Environment is the Schema for the Environments API. An"'),
  ...
  spec: {
    ...
    forProvider: {
      '#nodeConfig':: d.obj(help='"NodeConfig for setting the min/max number of nodes associated with the environment. Structure is documented below."'),
      nodeConfig: {
        '#withMaxNodeCount':: d.fn(help='"The maximum total number of gateway nodes that the is reserved for all instances that has the specified environment. If not specified, the default is determined by the recommended maximum number of nodes for that gateway."', args=[d.arg(name='maxNodeCount', type=d.T.string)]),
        withMaxNodeCount(maxNodeCount): { maxNodeCount: maxNodeCount },
        '#withMinNodeCount':: d.fn(help='"The minimum total number of gateway nodes that the is reserved for all instances that has the specified environment. If not specified, the default is determined by the recommended minimum number of nodes for that gateway."', args=[d.arg(name='minNodeCount', type=d.T.string)]),
      ...
      '#withApiProxyType':: d.fn(help='"Optional. API Proxy type supported by the environment. The type can be set when creating the Environment and cannot be changed. Possible values are: API_PROXY_TYPE_UNSPECIFIED, PROGRAMMABLE, CONFIGURABLE."', args=[d.arg(name='apiProxyType', type=d.T.string)]),
      withApiProxyType(apiProxyType): { spec+: { forProvider+: { apiProxyType: apiProxyType } } },
      '#withDeploymentType':: d.fn(help='"Optional. Deployment type supported by the environment. The deployment type can be set when creating the environment and cannot be changed. When you enable archive deployment, you will be prevented from performing a subset of actions within the environment, including: Managing the deployment of API proxy or shared flow revisions; Creating, updating, or deleting resource files; Creating, updating, or deleting target servers. Possible values are: DEPLOYMENT_TYPE_UNSPECIFIED, PROXY, ARCHIVE."', args=[d.arg(name='deploymentType', type=d.T.string)]),
      withDeploymentType(deploymentType): { spec+: { forProvider+: { deploymentType: deploymentType } } },
      '#withDescription':: d.fn(help='"Description of the environment."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"Display name of the environment."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withNodeConfig':: d.fn(help='"NodeConfig for setting the min/max number of nodes associated with the environment. Structure is documented below."', args=[d.arg(name='nodeConfig', type=d.T.array)]),
      withNodeConfig(nodeConfig): { spec+: { forProvider+: { nodeConfig: if std.isArray(v=nodeConfig) then nodeConfig else [nodeConfig] } } },
      '#withNodeConfigMixin':: d.fn(help='"NodeConfig for setting the min/max number of nodes associated with the environment. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeConfig', type=d.T.array)]),
      withNodeConfigMixin(nodeConfig): { spec+: { forProvider+: { nodeConfig+: if std.isArray(v=nodeConfig) then nodeConfig else [nodeConfig] } } },
      '#withOrgId':: d.fn(help='"The Apigee Organization associated with the Apigee environment, in the format organizations/{{org_name}}."', args=[d.arg(name='orgId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withApiProxyType':: d.fn(help='"Optional. API Proxy type supported by the environment. The type can be set when creating the Environment and cannot be changed. Possible values are: API_PROXY_TYPE_UNSPECIFIED, PROGRAMMABLE, CONFIGURABLE."', args=[d.arg(name='apiProxyType', type=d.T.string)]),
      withApiProxyType(apiProxyType): { spec+: { initProvider+: { apiProxyType: apiProxyType } } },
      '#withDeploymentType':: d.fn(help='"Optional. Deployment type supported by the environment. The deployment type can be set when creating the environment and cannot be changed. When you enable archive deployment, you will be prevented from performing a subset of actions within the environment, including: Managing the deployment of API proxy or shared flow revisions; Creating, updating, or deleting resource files; Creating, updating, or deleting target servers. Possible values are: DEPLOYMENT_TYPE_UNSPECIFIED, PROXY, ARCHIVE."', args=[d.arg(name='deploymentType', type=d.T.string)]),
