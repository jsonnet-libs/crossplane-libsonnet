{
  ...
  '#':: d.pkg(name='environmentIAMMember', url='', help='"EnvironmentIAMMember is the Schema for the EnvironmentIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of EnvironmentIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EnvironmentIAMMemberSpec defines the desired state of EnvironmentIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEnvId':: d.fn(help='', args=[d.arg(name='envId', type=d.T.string)]),
      withEnvId(envId): { spec+: { forProvider+: { envId: envId } } },
    ...
    initProvider: {
      ...
      '#withEnvId':: d.fn(help='', args=[d.arg(name='envId', type=d.T.string)]),
      withEnvId(envId): { spec+: { initProvider+: { envId: envId } } },
      '#withMember':: d.fn(help='', args=[d.arg(name='member', type=d.T.string)]),
