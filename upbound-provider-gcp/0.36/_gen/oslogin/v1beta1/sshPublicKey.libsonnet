{
  ...
  '#':: d.pkg(name='sshPublicKey', url='', help='"SSHPublicKey is the Schema for the SSHPublicKeys API. The SSH public key information associated with a Google account."'),
  ...
  '#new':: d.fn(help='new returns an instance of SSHPublicKey', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#keySecretRef':: d.obj(help='"Public key text in SSH format, defined by RFC4253 section 6.6."'),
      keySecretRef: {
      ...
      withExpirationTimeUsec(expirationTimeUsec): { spec+: { forProvider+: { expirationTimeUsec: expirationTimeUsec } } },
      '#withProject':: d.fn(help='"The project ID of the Google Cloud Platform project."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { forProvider+: { project: project } } },
      '#withUser':: d.fn(help='"The user email."', args=[d.arg(name='user', type=d.T.string)]),
    ...
    initProvider: {
      '#withExpirationTimeUsec':: d.fn(help='"An expiration time in microseconds since epoch."', args=[d.arg(name='expirationTimeUsec', type=d.T.string)]),
      withExpirationTimeUsec(expirationTimeUsec): { spec+: { initProvider+: { expirationTimeUsec: expirationTimeUsec } } },
      '#withProject':: d.fn(help='"The project ID of the Google Cloud Platform project."', args=[d.arg(name='project', type=d.T.string)]),
