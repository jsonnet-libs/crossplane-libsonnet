{
  ...
  '#':: d.pkg(name='servicePerimeterResource', url='', help='"ServicePerimeterResource is the Schema for the ServicePerimeterResources API. Allows configuring a single GCP resource that should be inside of a service perimeter."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResource':: d.fn(help='"A GCP resource that is inside of the service perimeter. Currently only projects are allowed. Format: projects/{project_number}"', args=[d.arg(name='resource', type=d.T.string)]),
