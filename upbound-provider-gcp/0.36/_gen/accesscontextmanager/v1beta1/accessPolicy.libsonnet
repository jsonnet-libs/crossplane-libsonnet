{
  ...
  '#':: d.pkg(name='accessPolicy', url='', help='"AccessPolicy is the Schema for the AccessPolicys API. AccessPolicy is a container for AccessLevels (which define the necessary attributes to use GCP services) and ServicePerimeters (which define regions of services able to freely pass data within a perimeter)."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withParent':: d.fn(help='"The parent of this AccessPolicy in the Cloud Resource Hierarchy. Format: organizations/{organization_id}"', args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withScopes':: d.fn(help='"Folder or project on which this policy is applicable. Format: folders/{{folder_id}} or projects/{{project_id}}"', args=[d.arg(name='scopes', type=d.T.array)]),
      withScopes(scopes): { spec+: { forProvider+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } },
      '#withScopesMixin':: d.fn(help='"Folder or project on which this policy is applicable. Format: folders/{{folder_id}} or projects/{{project_id}}"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
      withScopesMixin(scopes): { spec+: { forProvider+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } } },
      '#withTitle':: d.fn(help='"Human readable title. Does not affect behavior."', args=[d.arg(name='title', type=d.T.string)]),
