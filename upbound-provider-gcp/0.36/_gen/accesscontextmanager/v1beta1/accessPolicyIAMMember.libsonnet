{
  ...
  '#':: d.pkg(name='accessPolicyIAMMember', url='', help='"AccessPolicyIAMMember is the Schema for the AccessPolicyIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of AccessPolicyIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AccessPolicyIAMMemberSpec defines the desired state of AccessPolicyIAMMember"'),
  spec: {
