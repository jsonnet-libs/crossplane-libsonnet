{
  ...
  '#':: d.pkg(name='ruleset', url='', help='"Ruleset is the Schema for the Rulesets API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Ruleset', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RulesetSpec defines the desired state of Ruleset"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#source':: d.obj(help='"Source for the Ruleset."'),
      source: {
        '#files':: d.obj(help='"File set constituting the Source bundle."'),
        files: {
          '#withContent':: d.fn(help='"Textual Content."', args=[d.arg(name='content', type=d.T.string)]),
          withContent(content): { content: content },
          '#withFingerprint':: d.fn(help='"Fingerprint (e.g. github sha) associated with the File."', args=[d.arg(name='fingerprint', type=d.T.string)]),
          withFingerprint(fingerprint): { fingerprint: fingerprint },
          '#withName':: d.fn(help='"Output only. Name of the Ruleset. The ruleset_id is auto generated by the service. Format: projects/{project_id}/rulesets/{ruleset_id}"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
        },
        '#withFiles':: d.fn(help='"File set constituting the Source bundle."', args=[d.arg(name='files', type=d.T.array)]),
        withFiles(files): { files: if std.isArray(v=files) then files else [files] },
        '#withFilesMixin':: d.fn(help='"File set constituting the Source bundle."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='files', type=d.T.array)]),
        withFilesMixin(files): { files+: if std.isArray(v=files) then files else [files] },
        '#withLanguage':: d.fn(help='"Language of the Source bundle. If unspecified, the language will default to FIREBASE_RULES. Possible values: LANGUAGE_UNSPECIFIED, FIREBASE_RULES, EVENT_FLOW_TRIGGERS"', args=[d.arg(name='language', type=d.T.string)]),
