{
  ...
  spec: {
    ...
    forProvider: {
      '#instanceFilter':: d.obj(help='"VM instances to patch. Structure is documented below."'),
      instanceFilter: {
        '#groupLabels':: d.obj(help='"Targets VM instances matching ANY of these GroupLabels. This allows targeting of disparate groups of VM instances. Structure is documented below."'),
        groupLabels: {
        ...
        withAll(all): { all: all },
        '#withGroupLabels':: d.fn(help='"Targets VM instances matching ANY of these GroupLabels. This allows targeting of disparate groups of VM instances. Structure is documented below."', args=[d.arg(name='groupLabels', type=d.T.array)]),
        withGroupLabels(groupLabels): { groupLabels: if std.isArray(v=groupLabels) then groupLabels else [groupLabels] },
        '#withGroupLabelsMixin':: d.fn(help='"Targets VM instances matching ANY of these GroupLabels. This allows targeting of disparate groups of VM instances. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='groupLabels', type=d.T.array)]),
      ...
      '#oneTimeSchedule':: d.obj(help='"Schedule a one-time execution. Structure is documented below."'),
      oneTimeSchedule: {
      ...
      '#patchConfig':: d.obj(help='"Patch configuration that is applied. Structure is documented below."'),
      patchConfig: {
        '#apt':: d.obj(help='"Apt update settings. Use this setting to override the default apt patch rules. Structure is documented below."'),
        apt: {
          ...
          '#withType':: d.fn(help='"By changing the type to DIST, the patching is performed using apt-get dist-upgrade instead. Possible values are: DIST, UPGRADE."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        '#goo':: d.obj(help='"goo update settings. Use this setting to override the default goo patch rules. Structure is documented below."'),
        goo: {
        ...
        '#postStep':: d.obj(help='"The ExecStep to run after the patch update. Structure is documented below."'),
        postStep: {
          '#linuxExecStepConfig':: d.obj(help='"The ExecStepConfig for all Linux VMs targeted by the PatchJob. Structure is documented below."'),
          linuxExecStepConfig: {
            '#gcsObject':: d.obj(help='"A Cloud Storage object containing the executable. Structure is documented below."'),
            gcsObject: {
            ...
            '#withGcsObject':: d.fn(help='"A Cloud Storage object containing the executable. Structure is documented below."', args=[d.arg(name='gcsObject', type=d.T.array)]),
            withGcsObject(gcsObject): { gcsObject: if std.isArray(v=gcsObject) then gcsObject else [gcsObject] },
            '#withGcsObjectMixin':: d.fn(help='"A Cloud Storage object containing the executable. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gcsObject', type=d.T.array)]),
            withGcsObjectMixin(gcsObject): { gcsObject+: if std.isArray(v=gcsObject) then gcsObject else [gcsObject] },
            '#withInterpreter':: d.fn(help='"The script interpreter to use to run the script. If no interpreter is specified the script will be executed directly, which will likely only succeed for scripts with shebang lines. Possible values are: SHELL, POWERSHELL."', args=[d.arg(name='interpreter', type=d.T.string)]),
          ...
          '#windowsExecStepConfig':: d.obj(help='"The ExecStepConfig for all Windows VMs targeted by the PatchJob. Structure is documented below."'),
          ...
          '#withLinuxExecStepConfig':: d.fn(help='"The ExecStepConfig for all Linux VMs targeted by the PatchJob. Structure is documented below."', args=[d.arg(name='linuxExecStepConfig', type=d.T.array)]),
          ...
          '#withLinuxExecStepConfigMixin':: d.fn(help='"The ExecStepConfig for all Linux VMs targeted by the PatchJob. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='linuxExecStepConfig', type=d.T.array)]),
          ...
          '#withWindowsExecStepConfig':: d.fn(help='"The ExecStepConfig for all Windows VMs targeted by the PatchJob. Structure is documented below."', args=[d.arg(name='windowsExecStepConfig', type=d.T.array)]),
          ...
          '#withWindowsExecStepConfigMixin':: d.fn(help='"The ExecStepConfig for all Windows VMs targeted by the PatchJob. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='windowsExecStepConfig', type=d.T.array)]),
        ...
        '#preStep':: d.obj(help='"The ExecStep to run before the patch update. Structure is documented below."'),
        preStep: {
          '#linuxExecStepConfig':: d.obj(help='"The ExecStepConfig for all Linux VMs targeted by the PatchJob. Structure is documented below."'),
          linuxExecStepConfig: {
            '#gcsObject':: d.obj(help='"A Cloud Storage object containing the executable. Structure is documented below."'),
        ...
        '#windowsUpdate':: d.obj(help='"Windows update settings. Use this setting to override the default Windows patch rules. Structure is documented below."'),
        windowsUpdate: {
          '#withClassifications':: d.fn(help='"Only apply updates of these windows update classifications. If empty, all updates are applied. Each value may be one of: CRITICAL, SECURITY, DEFINITION, DRIVER, FEATURE_PACK, SERVICE_PACK, TOOL, UPDATE_ROLLUP, UPDATE."', args=[d.arg(name='classifications', type=d.T.array)]),
          ...
          '#withClassificationsMixin':: d.fn(help='"Only apply updates of these windows update classifications. If empty, all updates are applied. Each value may be one of: CRITICAL, SECURITY, DEFINITION, DRIVER, FEATURE_PACK, SERVICE_PACK, TOOL, UPDATE_ROLLUP, UPDATE."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='classifications', type=d.T.array)]),
        ...
        '#withApt':: d.fn(help='"Apt update settings. Use this setting to override the default apt patch rules. Structure is documented below."', args=[d.arg(name='apt', type=d.T.array)]),
        withApt(apt): { apt: if std.isArray(v=apt) then apt else [apt] },
        '#withAptMixin':: d.fn(help='"Apt update settings. Use this setting to override the default apt patch rules. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='apt', type=d.T.array)]),
        withAptMixin(apt): { apt+: if std.isArray(v=apt) then apt else [apt] },
        '#withGoo':: d.fn(help='"goo update settings. Use this setting to override the default goo patch rules. Structure is documented below."', args=[d.arg(name='goo', type=d.T.array)]),
        withGoo(goo): { goo: if std.isArray(v=goo) then goo else [goo] },
        '#withGooMixin':: d.fn(help='"goo update settings. Use this setting to override the default goo patch rules. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='goo', type=d.T.array)]),
        ...
        withMigInstancesAllowed(migInstancesAllowed): { migInstancesAllowed: migInstancesAllowed },
        '#withPostStep':: d.fn(help='"The ExecStep to run after the patch update. Structure is documented below."', args=[d.arg(name='postStep', type=d.T.array)]),
        withPostStep(postStep): { postStep: if std.isArray(v=postStep) then postStep else [postStep] },
        '#withPostStepMixin':: d.fn(help='"The ExecStep to run after the patch update. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='postStep', type=d.T.array)]),
        withPostStepMixin(postStep): { postStep+: if std.isArray(v=postStep) then postStep else [postStep] },
        '#withPreStep':: d.fn(help='"The ExecStep to run before the patch update. Structure is documented below."', args=[d.arg(name='preStep', type=d.T.array)]),
        withPreStep(preStep): { preStep: if std.isArray(v=preStep) then preStep else [preStep] },
        '#withPreStepMixin':: d.fn(help='"The ExecStep to run before the patch update. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preStep', type=d.T.array)]),
        withPreStepMixin(preStep): { preStep+: if std.isArray(v=preStep) then preStep else [preStep] },
        '#withRebootConfig':: d.fn(help='"Post-patch reboot settings. Possible values are: DEFAULT, ALWAYS, NEVER."', args=[d.arg(name='rebootConfig', type=d.T.string)]),
        withRebootConfig(rebootConfig): { rebootConfig: rebootConfig },
        '#withWindowsUpdate':: d.fn(help='"Windows update settings. Use this setting to override the default Windows patch rules. Structure is documented below."', args=[d.arg(name='windowsUpdate', type=d.T.array)]),
        withWindowsUpdate(windowsUpdate): { windowsUpdate: if std.isArray(v=windowsUpdate) then windowsUpdate else [windowsUpdate] },
        '#withWindowsUpdateMixin':: d.fn(help='"Windows update settings. Use this setting to override the default Windows patch rules. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='windowsUpdate', type=d.T.array)]),
        withWindowsUpdateMixin(windowsUpdate): { windowsUpdate+: if std.isArray(v=windowsUpdate) then windowsUpdate else [windowsUpdate] },
        '#withYum':: d.fn(help='"Yum update settings. Use this setting to override the default yum patch rules. Structure is documented below."', args=[d.arg(name='yum', type=d.T.array)]),
        withYum(yum): { yum: if std.isArray(v=yum) then yum else [yum] },
        '#withYumMixin':: d.fn(help='"Yum update settings. Use this setting to override the default yum patch rules. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='yum', type=d.T.array)]),
        withYumMixin(yum): { yum+: if std.isArray(v=yum) then yum else [yum] },
        '#withZypper':: d.fn(help='"zypper update settings. Use this setting to override the default zypper patch rules. Structure is documented below."', args=[d.arg(name='zypper', type=d.T.array)]),
        withZypper(zypper): { zypper: if std.isArray(v=zypper) then zypper else [zypper] },
        '#withZypperMixin':: d.fn(help='"zypper update settings. Use this setting to override the default zypper patch rules. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zypper', type=d.T.array)]),
        withZypperMixin(zypper): { zypper+: if std.isArray(v=zypper) then zypper else [zypper] },
        '#yum':: d.obj(help='"Yum update settings. Use this setting to override the default yum patch rules. Structure is documented below."'),
        yum: {
          '#withExcludes':: d.fn(help='"List of packages to exclude from update."', args=[d.arg(name='excludes', type=d.T.array)]),
          withExcludes(excludes): { excludes: if std.isArray(v=excludes) then excludes else [excludes] },
          '#withExcludesMixin':: d.fn(help='"List of packages to exclude from update."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='excludes', type=d.T.array)]),
        ...
        '#zypper':: d.obj(help='"zypper update settings. Use this setting to override the default zypper patch rules. Structure is documented below."'),
        zypper: {
      ...
      '#recurringSchedule':: d.obj(help='"Schedule recurring executions. Structure is documented below."'),
      recurringSchedule: {
        '#monthly':: d.obj(help='"Schedule with monthly executions. Structure is documented below."'),
        monthly: {
          '#weekDayOfMonth':: d.obj(help='"Week day in a month. Structure is documented below."'),
          weekDayOfMonth: {
            '#withDayOfWeek':: d.fn(help='"IANA Time Zone Database time zone, e.g. \\"America/New_York\\". Possible values are: MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY."', args=[d.arg(name='dayOfWeek', type=d.T.string)]),
          ...
          '#withMonthDay':: d.fn(help='"One day of the month. 1-31 indicates the 1st to the 31st day. -1 indicates the last day of the month. Months without the target day will be skipped. For example, a schedule to run \\"every month on the 31st\\" will not run in February, April, June, etc."', args=[d.arg(name='monthDay', type=d.T.number)]),
          withMonthDay(monthDay): { monthDay: monthDay },
          '#withWeekDayOfMonth':: d.fn(help='"Week day in a month. Structure is documented below."', args=[d.arg(name='weekDayOfMonth', type=d.T.array)]),
          withWeekDayOfMonth(weekDayOfMonth): { weekDayOfMonth: if std.isArray(v=weekDayOfMonth) then weekDayOfMonth else [weekDayOfMonth] },
          '#withWeekDayOfMonthMixin':: d.fn(help='"Week day in a month. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='weekDayOfMonth', type=d.T.array)]),
        ...
        '#timeOfDay':: d.obj(help='"Time of the day to run a recurring deployment. Structure is documented below."'),
        timeOfDay: {
        ...
        '#timeZone':: d.obj(help='"Defines the time zone that timeOfDay is relative to. The rules for daylight saving time are determined by the chosen time zone. Structure is documented below."'),
        timeZone: {
        ...
        '#weekly':: d.obj(help='"Schedule with weekly executions. Structure is documented below."'),
        weekly: {
          '#withDayOfWeek':: d.fn(help='"IANA Time Zone Database time zone, e.g. \\"America/New_York\\". Possible values are: MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY."', args=[d.arg(name='dayOfWeek', type=d.T.string)]),
          withDayOfWeek(dayOfWeek): { dayOfWeek: dayOfWeek },
        },
        ...
        '#withMonthly':: d.fn(help='"Schedule with monthly executions. Structure is documented below."', args=[d.arg(name='monthly', type=d.T.array)]),
        withMonthly(monthly): { monthly: if std.isArray(v=monthly) then monthly else [monthly] },
        '#withMonthlyMixin':: d.fn(help='"Schedule with monthly executions. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='monthly', type=d.T.array)]),
        ...
        '#withTimeOfDay':: d.fn(help='"Time of the day to run a recurring deployment. Structure is documented below."', args=[d.arg(name='timeOfDay', type=d.T.array)]),
        withTimeOfDay(timeOfDay): { timeOfDay: if std.isArray(v=timeOfDay) then timeOfDay else [timeOfDay] },
        '#withTimeOfDayMixin':: d.fn(help='"Time of the day to run a recurring deployment. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='timeOfDay', type=d.T.array)]),
        withTimeOfDayMixin(timeOfDay): { timeOfDay+: if std.isArray(v=timeOfDay) then timeOfDay else [timeOfDay] },
        '#withTimeZone':: d.fn(help='"Defines the time zone that timeOfDay is relative to. The rules for daylight saving time are determined by the chosen time zone. Structure is documented below."', args=[d.arg(name='timeZone', type=d.T.array)]),
        withTimeZone(timeZone): { timeZone: if std.isArray(v=timeZone) then timeZone else [timeZone] },
        '#withTimeZoneMixin':: d.fn(help='"Defines the time zone that timeOfDay is relative to. The rules for daylight saving time are determined by the chosen time zone. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='timeZone', type=d.T.array)]),
        withTimeZoneMixin(timeZone): { timeZone+: if std.isArray(v=timeZone) then timeZone else [timeZone] },
        '#withWeekly':: d.fn(help='"Schedule with weekly executions. Structure is documented below."', args=[d.arg(name='weekly', type=d.T.array)]),
        withWeekly(weekly): { weekly: if std.isArray(v=weekly) then weekly else [weekly] },
        '#withWeeklyMixin':: d.fn(help='"Schedule with weekly executions. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='weekly', type=d.T.array)]),
        withWeeklyMixin(weekly): { weekly+: if std.isArray(v=weekly) then weekly else [weekly] },
      },
      '#rollout':: d.obj(help='"Rollout strategy of the patch job. Structure is documented below."'),
      rollout: {
        ...
        '#withDisruptionBudget':: d.fn(help='"The maximum number (or percentage) of VMs per zone to disrupt at any given moment. The number of VMs calculated from multiplying the percentage by the total number of VMs in a zone is rounded up. During patching, a VM is considered disrupted from the time the agent is notified to begin until patching has completed. This disruption time includes the time to complete reboot and any post-patch steps. A VM contributes to the disruption budget if its patching operation fails either when applying the patches, running pre or post patch steps, or if it fails to respond with a success notification before timing out. VMs that are not running or do not have an active agent do not count toward this disruption budget. For zone-by-zone rollouts, if the disruption budget in a zone is exceeded, the patch job stops, because continuing to the next zone requires completion of the patch process in the previous zone. For example, if the disruption budget has a fixed value of 10, and 8 VMs fail to patch in the current zone, the patch job continues to patch 2 VMs at a time until the zone is completed. When that zone is completed successfully, patching begins with 10 VMs at a time in the next zone. If 10 VMs in the next zone fail to patch, the patch job stops. Structure is documented below."', args=[d.arg(name='disruptionBudget', type=d.T.array)]),
        ...
        '#withMode':: d.fn(help='"Mode of the patch rollout. Possible values are: ZONE_BY_ZONE, CONCURRENT_ZONES."', args=[d.arg(name='mode', type=d.T.string)]),
      ...
      '#withInstanceFilter':: d.fn(help='"VM instances to patch. Structure is documented below."', args=[d.arg(name='instanceFilter', type=d.T.array)]),
      ...
      '#withOneTimeSchedule':: d.fn(help='"Schedule a one-time execution. Structure is documented below."', args=[d.arg(name='oneTimeSchedule', type=d.T.array)]),
      ...
      '#withPatchConfig':: d.fn(help='"Patch configuration that is applied. Structure is documented below."', args=[d.arg(name='patchConfig', type=d.T.array)]),
      withPatchConfig(patchConfig): { spec+: { forProvider+: { patchConfig: if std.isArray(v=patchConfig) then patchConfig else [patchConfig] } } },
      '#withPatchConfigMixin':: d.fn(help='"Patch configuration that is applied. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='patchConfig', type=d.T.array)]),
      ...
      '#withRecurringSchedule':: d.fn(help='"Schedule recurring executions. Structure is documented below."', args=[d.arg(name='recurringSchedule', type=d.T.array)]),
      ...
      '#withRollout':: d.fn(help='"Rollout strategy of the patch job. Structure is documented below."', args=[d.arg(name='rollout', type=d.T.array)]),
      withRollout(rollout): { spec+: { forProvider+: { rollout: if std.isArray(v=rollout) then rollout else [rollout] } } },
      '#withRolloutMixin':: d.fn(help='"Rollout strategy of the patch job. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rollout', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withOneTimeSchedule':: d.fn(help='"Schedule a one-time execution. Structure is documented below."', args=[d.arg(name='oneTimeSchedule', type=d.T.array)]),
      withOneTimeSchedule(oneTimeSchedule): { spec+: { initProvider+: { oneTimeSchedule: if std.isArray(v=oneTimeSchedule) then oneTimeSchedule else [oneTimeSchedule] } } },
      '#withOneTimeScheduleMixin':: d.fn(help='"Schedule a one-time execution. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='oneTimeSchedule', type=d.T.array)]),
      withOneTimeScheduleMixin(oneTimeSchedule): { spec+: { initProvider+: { oneTimeSchedule+: if std.isArray(v=oneTimeSchedule) then oneTimeSchedule else [oneTimeSchedule] } } },
      '#withPatchConfig':: d.fn(help='"Patch configuration that is applied. Structure is documented below."', args=[d.arg(name='patchConfig', type=d.T.array)]),
      withPatchConfig(patchConfig): { spec+: { initProvider+: { patchConfig: if std.isArray(v=patchConfig) then patchConfig else [patchConfig] } } },
      '#withPatchConfigMixin':: d.fn(help='"Patch configuration that is applied. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='patchConfig', type=d.T.array)]),
      withPatchConfigMixin(patchConfig): { spec+: { initProvider+: { patchConfig+: if std.isArray(v=patchConfig) then patchConfig else [patchConfig] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { initProvider+: { project: project } } },
      '#withRecurringSchedule':: d.fn(help='"Schedule recurring executions. Structure is documented below."', args=[d.arg(name='recurringSchedule', type=d.T.array)]),
      withRecurringSchedule(recurringSchedule): { spec+: { initProvider+: { recurringSchedule: if std.isArray(v=recurringSchedule) then recurringSchedule else [recurringSchedule] } } },
      '#withRecurringScheduleMixin':: d.fn(help='"Schedule recurring executions. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='recurringSchedule', type=d.T.array)]),
      withRecurringScheduleMixin(recurringSchedule): { spec+: { initProvider+: { recurringSchedule+: if std.isArray(v=recurringSchedule) then recurringSchedule else [recurringSchedule] } } },
      '#withRollout':: d.fn(help='"Rollout strategy of the patch job. Structure is documented below."', args=[d.arg(name='rollout', type=d.T.array)]),
