{
  ...
  spec: {
    ...
    forProvider: {
      '#cloudFunctionRef':: d.obj(help='"Reference to a Function to populate cloudFunction."'),
      cloudFunctionRef: {
      ...
      '#cloudFunctionSelector':: d.obj(help='"Selector for a Function to populate cloudFunction."'),
