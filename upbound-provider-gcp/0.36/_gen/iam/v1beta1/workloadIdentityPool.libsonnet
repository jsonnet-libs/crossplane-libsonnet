{
  ...
  '#':: d.pkg(name='workloadIdentityPool', url='', help='"WorkloadIdentityPool is the Schema for the WorkloadIdentityPools API. Represents a collection of external workload identities."'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkloadIdentityPool', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WorkloadIdentityPoolSpec defines the desired state of WorkloadIdentityPool"'),
  spec: {
