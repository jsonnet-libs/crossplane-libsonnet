{
  ...
  spec: {
    ...
    forProvider: {
      '#networkSettings':: d.obj(help='"Ingress settings for this service. Will apply to all versions. Structure is documented below."'),
      networkSettings: {
        '#withIngressTrafficAllowed':: d.fn(help='"The ingress settings for version or service. Default value is INGRESS_TRAFFIC_ALLOWED_UNSPECIFIED. Possible values are: INGRESS_TRAFFIC_ALLOWED_UNSPECIFIED, INGRESS_TRAFFIC_ALLOWED_ALL, INGRESS_TRAFFIC_ALLOWED_INTERNAL_ONLY, INGRESS_TRAFFIC_ALLOWED_INTERNAL_AND_LB."', args=[d.arg(name='ingressTrafficAllowed', type=d.T.string)]),
      ...
      '#withNetworkSettings':: d.fn(help='"Ingress settings for this service. Will apply to all versions. Structure is documented below."', args=[d.arg(name='networkSettings', type=d.T.array)]),
      ...
      '#withNetworkSettingsMixin':: d.fn(help='"Ingress settings for this service. Will apply to all versions. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networkSettings', type=d.T.array)]),
