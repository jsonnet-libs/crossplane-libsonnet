{
  ...
  spec: {
    ...
    forProvider: {
      ...
      featureSettings: {
        '#withSplitHealthChecks':: d.fn(help='"Set to false to use the legacy health check instead of the readiness and liveness checks."', args=[d.arg(name='splitHealthChecks', type=d.T.boolean)]),
      ...
      iap: {
        ...
        '#withEnabled':: d.fn(help='"Whether the serving infrastructure will authenticate and authorize all incoming requests. (default is false)"', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withLocationId':: d.fn(help='"The location to serve the app from."', args=[d.arg(name='locationId', type=d.T.string)]),
      withLocationId(locationId): { spec+: { forProvider+: { locationId: locationId } } },
      '#withProject':: d.fn(help='"The project ID to create the application under. ~>NOTE: GCP only accepts project ID, not project number. If you are using number, you may get a \\"Permission denied\\" error."', args=[d.arg(name='project', type=d.T.string)]),
