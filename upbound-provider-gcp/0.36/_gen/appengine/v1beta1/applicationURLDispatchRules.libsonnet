{
  ...
  '#':: d.pkg(name='applicationURLDispatchRules', url='', help='"ApplicationURLDispatchRules is the Schema for the ApplicationURLDispatchRuless API. Rules to match an HTTP request and dispatch that request to a service."'),
  ...
  '#new':: d.fn(help='new returns an instance of ApplicationURLDispatchRules', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#dispatchRules':: d.obj(help='"Rules to match an HTTP request and dispatch that request to a service. Structure is documented below."'),
      dispatchRules: {
        ...
        '#withDomain':: d.fn(help='"Domain name to match against. The wildcard \\"\\" is supported if specified before a period: \\".\\". Defaults to matching all domains: \\"*\\"."', args=[d.arg(name='domain', type=d.T.string)]),
        withDomain(domain): { domain: domain },
        '#withPath':: d.fn(help='"Pathname within the host. Must start with a \\"/\\". A single \\"*\\" can be included at the end of the path. The sum of the lengths of the domain and path may not exceed 100 characters."', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { path: path },
        '#withService':: d.fn(help='"Pathname within the host. Must start with a \\"/\\". A single \\"*\\" can be included at the end of the path. The sum of the lengths of the domain and path may not exceed 100 characters."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { service: service },
      },
      '#withDispatchRules':: d.fn(help='"Rules to match an HTTP request and dispatch that request to a service. Structure is documented below."', args=[d.arg(name='dispatchRules', type=d.T.array)]),
      withDispatchRules(dispatchRules): { spec+: { forProvider+: { dispatchRules: if std.isArray(v=dispatchRules) then dispatchRules else [dispatchRules] } } },
      '#withDispatchRulesMixin':: d.fn(help='"Rules to match an HTTP request and dispatch that request to a service. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dispatchRules', type=d.T.array)]),
      withDispatchRulesMixin(dispatchRules): { spec+: { forProvider+: { dispatchRules+: if std.isArray(v=dispatchRules) then dispatchRules else [dispatchRules] } } },
    ...
    initProvider: {
      ...
      '#withDispatchRules':: d.fn(help='"Rules to match an HTTP request and dispatch that request to a service. Structure is documented below."', args=[d.arg(name='dispatchRules', type=d.T.array)]),
      withDispatchRules(dispatchRules): { spec+: { initProvider+: { dispatchRules: if std.isArray(v=dispatchRules) then dispatchRules else [dispatchRules] } } },
      '#withDispatchRulesMixin':: d.fn(help='"Rules to match an HTTP request and dispatch that request to a service. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dispatchRules', type=d.T.array)]),
      withDispatchRulesMixin(dispatchRules): { spec+: { initProvider+: { dispatchRules+: if std.isArray(v=dispatchRules) then dispatchRules else [dispatchRules] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
