{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAction':: d.fn(help='"The action to take if this rule matches. Possible values are: UNSPECIFIED_ACTION, ALLOW, DENY."', args=[d.arg(name='action', type=d.T.string)]),
