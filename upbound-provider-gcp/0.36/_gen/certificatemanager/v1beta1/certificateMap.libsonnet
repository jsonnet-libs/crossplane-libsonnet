{
  ...
  '#':: d.pkg(name='certificateMap', url='', help='"CertificateMap is the Schema for the CertificateMaps API. CertificateMap defines a collection of certificate configurations, which are usable by any associated target proxies"'),
  ...
  '#new':: d.fn(help='new returns an instance of CertificateMap', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CertificateMapSpec defines the desired state of CertificateMap"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withLabels':: d.fn(help='"Set of labels associated with a Certificate Map resource."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Set of labels associated with a Certificate Map resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
