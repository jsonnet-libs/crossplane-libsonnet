{
  ...
  '#':: d.pkg(name='dnsAuthorization', url='', help='"DNSAuthorization is the Schema for the DNSAuthorizations API. DnsAuthorization represents a HTTP-reachable backend for a DnsAuthorization."'),
  ...
  '#new':: d.fn(help='new returns an instance of DNSAuthorization', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DNSAuthorizationSpec defines the desired state of DNSAuthorization"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDomain':: d.fn(help='"A domain which is being authorized. A DnsAuthorization resource covers a single domain and its wildcard, e.g. authorization for \\"example.com\\" can be used to issue certificates for \\"example.com\\" and \\"*.example.com\\"."', args=[d.arg(name='domain', type=d.T.string)]),
      withDomain(domain): { spec+: { forProvider+: { domain: domain } } },
      '#withLabels':: d.fn(help='"Set of label tags associated with the DNS Authorization resource."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Set of label tags associated with the DNS Authorization resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
