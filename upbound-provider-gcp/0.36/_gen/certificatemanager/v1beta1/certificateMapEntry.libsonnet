{
  ...
  '#':: d.pkg(name='certificateMapEntry', url='', help='"CertificateMapEntry is the Schema for the CertificateMapEntrys API. CertificateMapEntry is a list of certificate configurations, that have been issued for a particular hostname"'),
  ...
  '#new':: d.fn(help='new returns an instance of CertificateMapEntry', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CertificateMapEntrySpec defines the desired state of CertificateMapEntry"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#mapRef':: d.obj(help='"Reference to a CertificateMap in certificatemanager to populate map."'),
      mapRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { mapRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { mapRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { mapRef+: { name: name } } } },
      },
      '#mapSelector':: d.obj(help='"Selector for a CertificateMap in certificatemanager to populate map."'),
      mapSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { mapSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { mapSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { mapSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { mapSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { mapSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withCertificates':: d.fn(help='"A set of Certificates defines for the given hostname. There can be defined up to fifteen certificates in each Certificate Map Entry. Each certificate must match pattern projects//locations//certificates/*."', args=[d.arg(name='certificates', type=d.T.array)]),
      ...
      '#withCertificatesMixin':: d.fn(help='"A set of Certificates defines for the given hostname. There can be defined up to fifteen certificates in each Certificate Map Entry. Each certificate must match pattern projects//locations//certificates/*."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='certificates', type=d.T.array)]),
      ...
      '#withHostname':: d.fn(help='"A Hostname (FQDN, e.g. example.com) or a wildcard hostname expression (*.example.com) for a set of hostnames with common suffix. Used as Server Name Indication (SNI) for selecting a proper certificate."', args=[d.arg(name='hostname', type=d.T.string)]),
      withHostname(hostname): { spec+: { forProvider+: { hostname: hostname } } },
      '#withLabels':: d.fn(help='"Set of labels associated with a Certificate Map Entry. An object containing a list of \\"key\\": value pairs. Example: { \\"name\\": \\"wrench\\", \\"mass\\": \\"1.3kg\\", \\"count\\": \\"3\\" }."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Set of labels associated with a Certificate Map Entry. An object containing a list of \\"key\\": value pairs. Example: { \\"name\\": \\"wrench\\", \\"mass\\": \\"1.3kg\\", \\"count\\": \\"3\\" }."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withMap':: d.fn(help='"A map entry that is inputted into the cetrificate map"', args=[d.arg(name='map', type=d.T.string)]),
      withMap(map): { spec+: { forProvider+: { map: map } } },
      '#withMatcher':: d.fn(help='"A predefined matcher for particular cases, other than SNI selection"', args=[d.arg(name='matcher', type=d.T.string)]),
      withMatcher(matcher): { spec+: { forProvider+: { matcher: matcher } } },
    ...
    initProvider: {
      '#withCertificates':: d.fn(help='"A set of Certificates defines for the given hostname. There can be defined up to fifteen certificates in each Certificate Map Entry. Each certificate must match pattern projects//locations//certificates/*."', args=[d.arg(name='certificates', type=d.T.array)]),
      withCertificates(certificates): { spec+: { initProvider+: { certificates: if std.isArray(v=certificates) then certificates else [certificates] } } },
      '#withCertificatesMixin':: d.fn(help='"A set of Certificates defines for the given hostname. There can be defined up to fifteen certificates in each Certificate Map Entry. Each certificate must match pattern projects//locations//certificates/*."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='certificates', type=d.T.array)]),
      withCertificatesMixin(certificates): { spec+: { initProvider+: { certificates+: if std.isArray(v=certificates) then certificates else [certificates] } } },
      '#withDescription':: d.fn(help='"A human-readable description of the resource."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withMatcher':: d.fn(help='"A predefined matcher for particular cases, other than SNI selection"', args=[d.arg(name='matcher', type=d.T.string)]),
      withMatcher(matcher): { spec+: { initProvider+: { matcher: matcher } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
