{
  ...
  '#':: d.pkg(name='node', url='', help='"Node is the Schema for the Nodes API. A Cloud TPU instance."'),
  ...
  spec: {
    ...
    forProvider: {
      '#networkRef':: d.obj(help='"Reference to a Connection in servicenetworking to populate network."'),
      networkRef: {
      ...
      '#networkSelector':: d.obj(help='"Selector for a Connection in servicenetworking to populate network."'),
      networkSelector: {
      ...
      '#schedulingConfig':: d.obj(help='"Sets the scheduling options for this TPU instance. Structure is documented below."'),
      schedulingConfig: {
        '#withPreemptible':: d.fn(help='"Defines whether the TPU instance is preemptible."', args=[d.arg(name='preemptible', type=d.T.boolean)]),
        withPreemptible(preemptible): { preemptible: preemptible },
      },
      '#withAcceleratorType':: d.fn(help='"The type of hardware accelerators associated with this node."', args=[d.arg(name='acceleratorType', type=d.T.string)]),
      withAcceleratorType(acceleratorType): { spec+: { forProvider+: { acceleratorType: acceleratorType } } },
      '#withCidrBlock':: d.fn(help="\"The CIDR block that the TPU node will use when selecting an IP address. This CIDR block must be a /29 block; the Compute Engine networks API forbids a smaller block, and using a larger block would be wasteful (a node can only consume one IP address). Errors will occur if the CIDR block has already been used for a currently existing TPU node, the CIDR block conflicts with any subnetworks in the user's provided network, or the provided network is peered with another network that is using that CIDR block.\"", args=[d.arg(name='cidrBlock', type=d.T.string)]),
      withCidrBlock(cidrBlock): { spec+: { forProvider+: { cidrBlock: cidrBlock } } },
      '#withDescription':: d.fn(help='"The user-supplied description of the TPU. Maximum of 512 characters."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withNetwork':: d.fn(help='"The name of a network to peer the TPU node to. It must be a preexisting Compute Engine network inside of the project on which this API has been activated. If none is provided, \\"default\\" will be used."', args=[d.arg(name='network', type=d.T.string)]),
      ...
      '#withSchedulingConfig':: d.fn(help='"Sets the scheduling options for this TPU instance. Structure is documented below."', args=[d.arg(name='schedulingConfig', type=d.T.array)]),
      withSchedulingConfig(schedulingConfig): { spec+: { forProvider+: { schedulingConfig: if std.isArray(v=schedulingConfig) then schedulingConfig else [schedulingConfig] } } },
      '#withSchedulingConfigMixin':: d.fn(help='"Sets the scheduling options for this TPU instance. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schedulingConfig', type=d.T.array)]),
      withSchedulingConfigMixin(schedulingConfig): { spec+: { forProvider+: { schedulingConfig+: if std.isArray(v=schedulingConfig) then schedulingConfig else [schedulingConfig] } } },
      ...
      withTensorflowVersion(tensorflowVersion): { spec+: { forProvider+: { tensorflowVersion: tensorflowVersion } } },
      '#withUseServiceNetworking':: d.fn(help='"Whether the VPC peering for the node is set up through Service Networking API. The VPC Peering should be set up before provisioning the node. If this field is set, cidr_block field should not be specified. If the network that you want to peer the TPU Node to is a Shared VPC network, the node must be created with this this field enabled."', args=[d.arg(name='useServiceNetworking', type=d.T.boolean)]),
      withUseServiceNetworking(useServiceNetworking): { spec+: { forProvider+: { useServiceNetworking: useServiceNetworking } } },
      '#withZone':: d.fn(help='"The GCP location for the TPU. If it is not provided, the provider zone is used."', args=[d.arg(name='zone', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSchedulingConfig':: d.fn(help='"Sets the scheduling options for this TPU instance. Structure is documented below."', args=[d.arg(name='schedulingConfig', type=d.T.array)]),
      withSchedulingConfig(schedulingConfig): { spec+: { initProvider+: { schedulingConfig: if std.isArray(v=schedulingConfig) then schedulingConfig else [schedulingConfig] } } },
      '#withSchedulingConfigMixin':: d.fn(help='"Sets the scheduling options for this TPU instance. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schedulingConfig', type=d.T.array)]),
      withSchedulingConfigMixin(schedulingConfig): { spec+: { initProvider+: { schedulingConfig+: if std.isArray(v=schedulingConfig) then schedulingConfig else [schedulingConfig] } } },
      '#withTensorflowVersion':: d.fn(help='"The version of Tensorflow running in the Node."', args=[d.arg(name='tensorflowVersion', type=d.T.string)]),
      withTensorflowVersion(tensorflowVersion): { spec+: { initProvider+: { tensorflowVersion: tensorflowVersion } } },
      '#withUseServiceNetworking':: d.fn(help='"Whether the VPC peering for the node is set up through Service Networking API. The VPC Peering should be set up before provisioning the node. If this field is set, cidr_block field should not be specified. If the network that you want to peer the TPU Node to is a Shared VPC network, the node must be created with this this field enabled."', args=[d.arg(name='useServiceNetworking', type=d.T.boolean)]),
      withUseServiceNetworking(useServiceNetworking): { spec+: { initProvider+: { useServiceNetworking: useServiceNetworking } } },
    },
