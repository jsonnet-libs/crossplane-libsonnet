{
  ...
  '#':: d.pkg(name='registryRepositoryIAMMember', url='', help='"RegistryRepositoryIAMMember is the Schema for the RegistryRepositoryIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of RegistryRepositoryIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegistryRepositoryIAMMemberSpec defines the desired state of RegistryRepositoryIAMMember"'),
  spec: {
