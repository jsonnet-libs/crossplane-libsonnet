{
  ...
  '#':: d.pkg(name='autoscalingPolicy', url='', help='"AutoscalingPolicy is the Schema for the AutoscalingPolicys API. Describes an autoscaling policy for Dataproc cluster autoscaler."'),
  ...
  spec: {
    ...
    forProvider: {
      '#basicAlgorithm':: d.obj(help='"Basic algorithm for autoscaling. Structure is documented below."'),
      basicAlgorithm: {
        '#withCooldownPeriod':: d.fn(help='"Duration between scaling events. A scaling period starts after the update operation from the previous event has completed. Bounds: [2m, 1d]. Default: 2m."', args=[d.arg(name='cooldownPeriod', type=d.T.string)]),
        withCooldownPeriod(cooldownPeriod): { cooldownPeriod: cooldownPeriod },
        '#withYarnConfig':: d.fn(help='"YARN autoscaling configuration. Structure is documented below."', args=[d.arg(name='yarnConfig', type=d.T.array)]),
        withYarnConfig(yarnConfig): { yarnConfig: if std.isArray(v=yarnConfig) then yarnConfig else [yarnConfig] },
        '#withYarnConfigMixin':: d.fn(help='"YARN autoscaling configuration. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='yarnConfig', type=d.T.array)]),
        withYarnConfigMixin(yarnConfig): { yarnConfig+: if std.isArray(v=yarnConfig) then yarnConfig else [yarnConfig] },
        '#yarnConfig':: d.obj(help='"YARN autoscaling configuration. Structure is documented below."'),
        yarnConfig: {
          '#withGracefulDecommissionTimeout':: d.fn(help='"Timeout for YARN graceful decommissioning of Node Managers. Specifies the duration to wait for jobs to complete before forcefully removing workers (and potentially interrupting jobs). Only applicable to downscaling operations. Bounds: [0s, 1d]."', args=[d.arg(name='gracefulDecommissionTimeout', type=d.T.string)]),
          withGracefulDecommissionTimeout(gracefulDecommissionTimeout): { gracefulDecommissionTimeout: gracefulDecommissionTimeout },
          '#withScaleDownFactor':: d.fn(help='"Fraction of average pending memory in the last cooldown period for which to remove workers. A scale-down factor of 1 will result in scaling down so that there is no available memory remaining after the update (more aggressive scaling). A scale-down factor of 0 disables removing workers, which can be beneficial for autoscaling a single job. Bounds: [0.0, 1.0]."', args=[d.arg(name='scaleDownFactor', type=d.T.number)]),
          withScaleDownFactor(scaleDownFactor): { scaleDownFactor: scaleDownFactor },
          '#withScaleDownMinWorkerFraction':: d.fn(help='"Minimum scale-down threshold as a fraction of total cluster size before scaling occurs. For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler must recommend at least a 2 worker scale-down for the cluster to scale. A threshold of 0 means the autoscaler will scale down on any recommended change. Bounds: [0.0, 1.0]. Default: 0.0."', args=[d.arg(name='scaleDownMinWorkerFraction', type=d.T.number)]),
          withScaleDownMinWorkerFraction(scaleDownMinWorkerFraction): { scaleDownMinWorkerFraction: scaleDownMinWorkerFraction },
          '#withScaleUpFactor':: d.fn(help='"Fraction of average pending memory in the last cooldown period for which to add workers. A scale-up factor of 1.0 will result in scaling up so that there is no pending memory remaining after the update (more aggressive scaling). A scale-up factor closer to 0 will result in a smaller magnitude of scaling up (less aggressive scaling). Bounds: [0.0, 1.0]."', args=[d.arg(name='scaleUpFactor', type=d.T.number)]),
          withScaleUpFactor(scaleUpFactor): { scaleUpFactor: scaleUpFactor },
          '#withScaleUpMinWorkerFraction':: d.fn(help='"Minimum scale-up threshold as a fraction of total cluster size before scaling occurs. For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler must recommend at least a 2-worker scale-up for the cluster to scale. A threshold of 0 means the autoscaler will scale up on any recommended change. Bounds: [0.0, 1.0]. Default: 0.0."', args=[d.arg(name='scaleUpMinWorkerFraction', type=d.T.number)]),
          withScaleUpMinWorkerFraction(scaleUpMinWorkerFraction): { scaleUpMinWorkerFraction: scaleUpMinWorkerFraction },
        },
      },
      '#secondaryWorkerConfig':: d.obj(help='"Describes how the autoscaler will operate for secondary workers. Structure is documented below."'),
      secondaryWorkerConfig: {
        '#withMaxInstances':: d.fn(help='"Maximum number of instances for this group. Note that by default, clusters will not use secondary workers. Required for secondary workers if the minimum secondary instances is set. Bounds: [minInstances, ). Defaults to 0."', args=[d.arg(name='maxInstances', type=d.T.number)]),
        withMaxInstances(maxInstances): { maxInstances: maxInstances },
        '#withMinInstances':: d.fn(help='"Minimum number of instances for this group. Bounds: [0, maxInstances]. Defaults to 0."', args=[d.arg(name='minInstances', type=d.T.number)]),
        withMinInstances(minInstances): { minInstances: minInstances },
        '#withWeight':: d.fn(help='"Weight for the instance group, which is used to determine the fraction of total workers in the cluster from this instance group. For example, if primary workers have weight 2, and secondary workers have weight 1, the cluster will have approximately 2 primary workers for each secondary worker. The cluster may not reach the specified balance if constrained by min/max bounds or other autoscaling settings. For example, if maxInstances for secondary workers is 0, then only primary workers will be added. The cluster can also be out of balance when created. If weight is not set on any instance group, the cluster will default to equal weight for all groups: the cluster will attempt to maintain an equal number of workers in each group within the configured size bounds for each group. If weight is set for one group only, the cluster will default to zero weight on the unset group. For example if weight is set only on primary workers, the cluster will use primary workers only and no secondary workers."', args=[d.arg(name='weight', type=d.T.number)]),
        withWeight(weight): { weight: weight },
      },
      '#withBasicAlgorithm':: d.fn(help='"Basic algorithm for autoscaling. Structure is documented below."', args=[d.arg(name='basicAlgorithm', type=d.T.array)]),
      ...
      '#withSecondaryWorkerConfig':: d.fn(help='"Describes how the autoscaler will operate for secondary workers. Structure is documented below."', args=[d.arg(name='secondaryWorkerConfig', type=d.T.array)]),
      ...
      '#withSecondaryWorkerConfigMixin':: d.fn(help='"Describes how the autoscaler will operate for secondary workers. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secondaryWorkerConfig', type=d.T.array)]),
      ...
      '#withWorkerConfig':: d.fn(help='"Describes how the autoscaler will operate for primary workers. Structure is documented below."', args=[d.arg(name='workerConfig', type=d.T.array)]),
      ...
      '#withWorkerConfigMixin':: d.fn(help='"Describes how the autoscaler will operate for primary workers. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='workerConfig', type=d.T.array)]),
      ...
      '#workerConfig':: d.obj(help='"Describes how the autoscaler will operate for primary workers. Structure is documented below."'),
      workerConfig: {
        '#withMaxInstances':: d.fn(help='"Maximum number of instances for this group."', args=[d.arg(name='maxInstances', type=d.T.number)]),
        withMaxInstances(maxInstances): { maxInstances: maxInstances },
        '#withMinInstances':: d.fn(help='"Minimum number of instances for this group. Bounds: [2, maxInstances]. Defaults to 2."', args=[d.arg(name='minInstances', type=d.T.number)]),
        withMinInstances(minInstances): { minInstances: minInstances },
        '#withWeight':: d.fn(help='"Weight for the instance group, which is used to determine the fraction of total workers in the cluster from this instance group. For example, if primary workers have weight 2, and secondary workers have weight 1, the cluster will have approximately 2 primary workers for each secondary worker. The cluster may not reach the specified balance if constrained by min/max bounds or other autoscaling settings. For example, if maxInstances for secondary workers is 0, then only primary workers will be added. The cluster can also be out of balance when created. If weight is not set on any instance group, the cluster will default to equal weight for all groups: the cluster will attempt to maintain an equal number of workers in each group within the configured size bounds for each group. If weight is set for one group only, the cluster will default to zero weight on the unset group. For example if weight is set only on primary workers, the cluster will use primary workers only and no secondary workers."', args=[d.arg(name='weight', type=d.T.number)]),
        withWeight(weight): { weight: weight },
      },
    ...
    initProvider: {
      ...
      '#withBasicAlgorithm':: d.fn(help='"Basic algorithm for autoscaling. Structure is documented below."', args=[d.arg(name='basicAlgorithm', type=d.T.array)]),
      withBasicAlgorithm(basicAlgorithm): { spec+: { initProvider+: { basicAlgorithm: if std.isArray(v=basicAlgorithm) then basicAlgorithm else [basicAlgorithm] } } },
      '#withBasicAlgorithmMixin':: d.fn(help='"Basic algorithm for autoscaling. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='basicAlgorithm', type=d.T.array)]),
      withBasicAlgorithmMixin(basicAlgorithm): { spec+: { initProvider+: { basicAlgorithm+: if std.isArray(v=basicAlgorithm) then basicAlgorithm else [basicAlgorithm] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { initProvider+: { project: project } } },
      '#withSecondaryWorkerConfig':: d.fn(help='"Describes how the autoscaler will operate for secondary workers. Structure is documented below."', args=[d.arg(name='secondaryWorkerConfig', type=d.T.array)]),
      withSecondaryWorkerConfig(secondaryWorkerConfig): { spec+: { initProvider+: { secondaryWorkerConfig: if std.isArray(v=secondaryWorkerConfig) then secondaryWorkerConfig else [secondaryWorkerConfig] } } },
      '#withSecondaryWorkerConfigMixin':: d.fn(help='"Describes how the autoscaler will operate for secondary workers. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secondaryWorkerConfig', type=d.T.array)]),
      withSecondaryWorkerConfigMixin(secondaryWorkerConfig): { spec+: { initProvider+: { secondaryWorkerConfig+: if std.isArray(v=secondaryWorkerConfig) then secondaryWorkerConfig else [secondaryWorkerConfig] } } },
      '#withWorkerConfig':: d.fn(help='"Describes how the autoscaler will operate for primary workers. Structure is documented below."', args=[d.arg(name='workerConfig', type=d.T.array)]),
      withWorkerConfig(workerConfig): { spec+: { initProvider+: { workerConfig: if std.isArray(v=workerConfig) then workerConfig else [workerConfig] } } },
      '#withWorkerConfigMixin':: d.fn(help='"Describes how the autoscaler will operate for primary workers. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='workerConfig', type=d.T.array)]),
      withWorkerConfigMixin(workerConfig): { spec+: { initProvider+: { workerConfig+: if std.isArray(v=workerConfig) then workerConfig else [workerConfig] } } },
      '#workerConfig':: d.obj(help='"Describes how the autoscaler will operate for primary workers. Structure is documented below."'),
      workerConfig: {
        '#withMaxInstances':: d.fn(help='"Maximum number of instances for this group."', args=[d.arg(name='maxInstances', type=d.T.number)]),
        withMaxInstances(maxInstances): { maxInstances: maxInstances },
