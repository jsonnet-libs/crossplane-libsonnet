{
  ...
  '#':: d.pkg(name='registry', url='', help='"Registry is the Schema for the Registrys API. Ensures the GCS bucket backing Google Container Registry exists."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withLocation':: d.fn(help='"The location of the registry. One of ASIA, EU, US or not specified. See the official documentation for more information on registry locations."', args=[d.arg(name='location', type=d.T.string)]),
