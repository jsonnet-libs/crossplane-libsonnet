{
  ...
  '#':: d.pkg(name='dataset', url='', help='"Dataset is the Schema for the Datasets API. A collection of DataItems and Annotations on them."'),
  ...
  spec: {
    ...
    forProvider: {
      '#encryptionSpec':: d.obj(help='"Customer-managed encryption key spec for a Dataset. If set, this Dataset and all sub-resources of this Dataset will be secured by this key. Structure is documented below."'),
      encryptionSpec: {
        '#withKmsKeyName':: d.fn(help='"Required. The Cloud KMS resource identifier of the customer managed encryption key used to protect a resource. Has the form: projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key. The key needs to be in the same region as where the resource is created."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
      ...
      '#withEncryptionSpec':: d.fn(help='"Customer-managed encryption key spec for a Dataset. If set, this Dataset and all sub-resources of this Dataset will be secured by this key. Structure is documented below."', args=[d.arg(name='encryptionSpec', type=d.T.array)]),
      ...
      '#withEncryptionSpecMixin':: d.fn(help='"Customer-managed encryption key spec for a Dataset. If set, this Dataset and all sub-resources of this Dataset will be secured by this key. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionSpec', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withMetadataSchemaUri':: d.fn(help='"Points to a YAML file stored on Google Cloud Storage describing additional information about the Dataset. The schema is defined as an OpenAPI 3.0.2 Schema Object. The schema files that can be used here are found in gs://google-cloud-aiplatform/schema/dataset/metadata/."', args=[d.arg(name='metadataSchemaUri', type=d.T.string)]),
      withMetadataSchemaUri(metadataSchemaUri): { spec+: { initProvider+: { metadataSchemaUri: metadataSchemaUri } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
