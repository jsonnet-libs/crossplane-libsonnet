{
  ...
  '#':: d.pkg(name='tensorboard', url='', help="\"Tensorboard is the Schema for the Tensorboards API. Tensorboard is a physical database that stores users' training metrics.\""),
  ...
  '#new':: d.fn(help='new returns an instance of Tensorboard', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TensorboardSpec defines the desired state of Tensorboard"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#encryptionSpec':: d.obj(help='"Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key. Structure is documented below."'),
      encryptionSpec: {
      ...
      '#withEncryptionSpec':: d.fn(help='"Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key. Structure is documented below."', args=[d.arg(name='encryptionSpec', type=d.T.array)]),
      ...
      '#withEncryptionSpecMixin':: d.fn(help='"Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionSpec', type=d.T.array)]),
      ...
      '#withLabels':: d.fn(help='"The labels with user-defined metadata to organize your Tensorboards."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"The labels with user-defined metadata to organize your Tensorboards."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      ...
      '#withRegion':: d.fn(help='"The region of the tensorboard. eg us-central1"', args=[d.arg(name='region', type=d.T.string)]),
