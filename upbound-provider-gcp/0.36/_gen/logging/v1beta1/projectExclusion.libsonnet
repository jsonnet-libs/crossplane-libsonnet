{
  ...
  '#':: d.pkg(name='projectExclusion', url='', help='"ProjectExclusion is the Schema for the ProjectExclusions API. Manages a project-level logging exclusion."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectExclusion', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectExclusionSpec defines the desired state of ProjectExclusion"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"A human-readable description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisabled':: d.fn(help='"Whether this exclusion rule should be disabled or not. This defaults to false."', args=[d.arg(name='disabled', type=d.T.boolean)]),
      withDisabled(disabled): { spec+: { forProvider+: { disabled: disabled } } },
      '#withFilter':: d.fn(help='"The filter to apply when excluding logs. Only log entries that match the filter are excluded. See Advanced Log Filters for information on how to write a filter."', args=[d.arg(name='filter', type=d.T.string)]),
      withFilter(filter): { spec+: { forProvider+: { filter: filter } } },
      '#withProject':: d.fn(help='"The project to create the exclusion in. If omitted, the project associated with the provider is used."', args=[d.arg(name='project', type=d.T.string)]),
