{
  ...
  '#':: d.pkg(name='logView', url='', help='"LogView is the Schema for the LogViews API. Describes a view over log entries in a bucket."'),
  ...
  '#new':: d.fn(help='new returns an instance of LogView', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LogViewSpec defines the desired state of LogView"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#bucketRef':: d.obj(help='"Reference to a ProjectBucketConfig in logging to populate bucket."'),
      bucketRef: {
      ...
      '#bucketSelector':: d.obj(help='"Selector for a ProjectBucketConfig in logging to populate bucket."'),
      bucketSelector: {
      ...
      '#withBucket':: d.fn(help='"The bucket of the resource"', args=[d.arg(name='bucket', type=d.T.string)]),
