{
  ...
  '#':: d.pkg(name='membership', url='', help='"Membership is the Schema for the Memberships API. Membership contains information about a member cluster."'),
  ...
  spec: {
    ...
    forProvider: {
      '#authority':: d.obj(help='"Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity Structure is documented below."'),
      authority: {
      ...
      '#endpoint':: d.obj(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."'),
      endpoint: {
        '#gkeCluster':: d.obj(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."'),
        gkeCluster: {
          '#resourceLinkRef':: d.obj(help='"Reference to a Cluster in container to populate resourceLink."'),
          resourceLinkRef: {
            ...
            policy: {
              ...
              withResolution(resolution): { resourceLinkRef+: { policy+: { resolution: resolution } } },
              ...
              withResolve(resolve): { resourceLinkRef+: { policy+: { resolve: resolve } } },
            },
            '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resourceLinkRef+: { name: name } },
          },
          '#resourceLinkSelector':: d.obj(help='"Selector for a Cluster in container to populate resourceLink."'),
          resourceLinkSelector: {
            '#policy':: d.obj(help='"Policies for selection."'),
            policy: {
              '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
              withResolution(resolution): { resourceLinkSelector+: { policy+: { resolution: resolution } } },
              '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
              withResolve(resolve): { resourceLinkSelector+: { policy+: { resolve: resolve } } },
            },
            ...
            withMatchControllerRef(matchControllerRef): { resourceLinkSelector+: { matchControllerRef: matchControllerRef } },
            '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabels(matchLabels): { resourceLinkSelector+: { matchLabels: matchLabels } },
            '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabelsMixin(matchLabels): { resourceLinkSelector+: { matchLabels+: matchLabels } },
          },
        ...
        '#withGkeCluster':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."', args=[d.arg(name='gkeCluster', type=d.T.array)]),
        withGkeCluster(gkeCluster): { gkeCluster: if std.isArray(v=gkeCluster) then gkeCluster else [gkeCluster] },
        '#withGkeClusterMixin':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gkeCluster', type=d.T.array)]),
        withGkeClusterMixin(gkeCluster): { gkeCluster+: if std.isArray(v=gkeCluster) then gkeCluster else [gkeCluster] },
      },
      '#withAuthority':: d.fn(help='"Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity Structure is documented below."', args=[d.arg(name='authority', type=d.T.array)]),
      withAuthority(authority): { spec+: { forProvider+: { authority: if std.isArray(v=authority) then authority else [authority] } } },
      '#withAuthorityMixin':: d.fn(help='"Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authority', type=d.T.array)]),
      withAuthorityMixin(authority): { spec+: { forProvider+: { authority+: if std.isArray(v=authority) then authority else [authority] } } },
      '#withEndpoint':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."', args=[d.arg(name='endpoint', type=d.T.array)]),
      withEndpoint(endpoint): { spec+: { forProvider+: { endpoint: if std.isArray(v=endpoint) then endpoint else [endpoint] } } },
      '#withEndpointMixin':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpoint', type=d.T.array)]),
      withEndpointMixin(endpoint): { spec+: { forProvider+: { endpoint+: if std.isArray(v=endpoint) then endpoint else [endpoint] } } },
      '#withLabels':: d.fn(help='"Labels to apply to this membership."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Labels to apply to this membership."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withAuthority':: d.fn(help='"Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity Structure is documented below."', args=[d.arg(name='authority', type=d.T.array)]),
      withAuthority(authority): { spec+: { initProvider+: { authority: if std.isArray(v=authority) then authority else [authority] } } },
      '#withAuthorityMixin':: d.fn(help='"Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authority', type=d.T.array)]),
      withAuthorityMixin(authority): { spec+: { initProvider+: { authority+: if std.isArray(v=authority) then authority else [authority] } } },
      '#withEndpoint':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource. Structure is documented below."', args=[d.arg(name='endpoint', type=d.T.array)]),
