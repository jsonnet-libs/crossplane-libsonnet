{
  ...
  '#':: d.pkg(name='snapshotIAMMember', url='', help='"SnapshotIAMMember is the Schema for the SnapshotIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of SnapshotIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SnapshotIAMMemberSpec defines the desired state of SnapshotIAMMember"'),
  spec: {
