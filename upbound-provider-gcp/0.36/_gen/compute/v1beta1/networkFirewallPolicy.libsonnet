{
  ...
  '#':: d.pkg(name='networkFirewallPolicy', url='', help='"NetworkFirewallPolicy is the Schema for the NetworkFirewallPolicys API. The Compute NetworkFirewallPolicy resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of NetworkFirewallPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"NetworkFirewallPolicySpec defines the desired state of NetworkFirewallPolicy"'),
  spec: {
