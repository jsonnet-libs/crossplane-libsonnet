{
  ...
  '#':: d.pkg(name='httpHealthCheck', url='', help='"HTTPHealthCheck is the Schema for the HTTPHealthChecks API. An HttpHealthCheck resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of HTTPHealthCheck', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HTTPHealthCheckSpec defines the desired state of HTTPHealthCheck"'),
  spec: {
