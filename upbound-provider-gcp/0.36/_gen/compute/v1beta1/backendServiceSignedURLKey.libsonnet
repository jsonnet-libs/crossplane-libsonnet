{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#keyValueSecretRef':: d.obj(help='"128-bit key value used for signing the URL. The key value must be a valid RFC 4648 Section 5 base64url encoded string. Note: This property is sensitive and will not be displayed in the plan."'),
      keyValueSecretRef: {
