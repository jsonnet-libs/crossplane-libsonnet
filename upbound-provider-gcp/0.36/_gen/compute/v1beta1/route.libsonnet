{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#nextHopVpnTunnelRef':: d.obj(help='"Reference to a VPNTunnel to populate nextHopVpnTunnel."'),
      nextHopVpnTunnelRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#nextHopVpnTunnelSelector':: d.obj(help='"Selector for a VPNTunnel to populate nextHopVpnTunnel."'),
      ...
      '#withDestRange':: d.fn(help='"The destination range of outgoing packets that this route applies to. Only IPv4 is supported."', args=[d.arg(name='destRange', type=d.T.string)]),
      ...
      '#withNextHopGateway':: d.fn(help='"URL to a gateway that should handle matching packets. Currently, you can only specify the internet gateway, using a full or partial valid URL:"', args=[d.arg(name='nextHopGateway', type=d.T.string)]),
      withNextHopGateway(nextHopGateway): { spec+: { forProvider+: { nextHopGateway: nextHopGateway } } },
      '#withNextHopIlb':: d.fn(help='"The IP address or URL to a forwarding rule of type loadBalancingScheme=INTERNAL that should handle matching packets. With the GA provider you can only specify the forwarding rule as a partial or full URL. For example, the following are all valid values:"', args=[d.arg(name='nextHopIlb', type=d.T.string)]),
      withNextHopIlb(nextHopIlb): { spec+: { forProvider+: { nextHopIlb: nextHopIlb } } },
      '#withNextHopInstance':: d.fn(help='"URL to an instance that should handle matching packets. You can specify this as a full or partial URL. For example:"', args=[d.arg(name='nextHopInstance', type=d.T.string)]),
      ...
      '#withPriority':: d.fn(help='"The priority of this route. Priority is used to break ties in cases where there is more than one matching route of equal prefix length. In the case of two routes with equal prefix length, the one with the lowest-numbered priority value wins. Default value is 1000. Valid range is 0 through 65535."', args=[d.arg(name='priority', type=d.T.number)]),
