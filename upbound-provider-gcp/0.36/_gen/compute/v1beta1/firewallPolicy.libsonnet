{
  ...
  '#':: d.pkg(name='firewallPolicy', url='', help='"FirewallPolicy is the Schema for the FirewallPolicys API. Creates a hierarchical firewall policy"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withParent':: d.fn(help='"The parent of the firewall policy."', args=[d.arg(name='parent', type=d.T.string)]),
