{
  ...
  '#':: d.pkg(name='externalVPNGateway', url='', help='"ExternalVPNGateway is the Schema for the ExternalVPNGateways API. Represents a VPN gateway managed outside of GCP."'),
  ...
  '#new':: d.fn(help='new returns an instance of ExternalVPNGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ExternalVPNGatewaySpec defines the desired state of ExternalVPNGateway"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#interface':: d.obj(help='"A list of interfaces on this external VPN gateway. Structure is documented below."'),
      interface: {
        '#withId':: d.fn(help='"The numeric ID for this interface. Allowed values are based on the redundancy type of this external VPN gateway"', args=[d.arg(name='id', type=d.T.number)]),
        withId(id): { id: id },
        '#withIpAddress':: d.fn(help="\"IP address of the interface in the external VPN gateway. Only IPv4 is supported. This IP address can be either from your on-premise gateway or another Cloud provider's VPN gateway, it cannot be an IP address from Google Compute Engine.\"", args=[d.arg(name='ipAddress', type=d.T.string)]),
      ...
      '#withInterface':: d.fn(help='"A list of interfaces on this external VPN gateway. Structure is documented below."', args=[d.arg(name='interface', type=d.T.array)]),
      withInterface(interface): { spec+: { forProvider+: { interface: if std.isArray(v=interface) then interface else [interface] } } },
      '#withInterfaceMixin':: d.fn(help='"A list of interfaces on this external VPN gateway. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='interface', type=d.T.array)]),
      withInterfaceMixin(interface): { spec+: { forProvider+: { interface+: if std.isArray(v=interface) then interface else [interface] } } },
      '#withLabels':: d.fn(help='"Labels for the external VPN gateway resource."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Labels for the external VPN gateway resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      ...
      '#withRedundancyType':: d.fn(help='"Indicates the redundancy type of this external VPN gateway Possible values are: FOUR_IPS_REDUNDANCY, SINGLE_IP_INTERNALLY_REDUNDANT, TWO_IPS_REDUNDANCY."', args=[d.arg(name='redundancyType', type=d.T.string)]),
      withRedundancyType(redundancyType): { spec+: { forProvider+: { redundancyType: redundancyType } } },
    },
    ...
    initProvider: {
      ...
      '#withInterface':: d.fn(help='"A list of interfaces on this external VPN gateway. Structure is documented below."', args=[d.arg(name='interface', type=d.T.array)]),
      withInterface(interface): { spec+: { initProvider+: { interface: if std.isArray(v=interface) then interface else [interface] } } },
      '#withInterfaceMixin':: d.fn(help='"A list of interfaces on this external VPN gateway. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='interface', type=d.T.array)]),
      withInterfaceMixin(interface): { spec+: { initProvider+: { interface+: if std.isArray(v=interface) then interface else [interface] } } },
      '#withLabels':: d.fn(help='"Labels for the external VPN gateway resource."', args=[d.arg(name='labels', type=d.T.object)]),
      ...
      '#withRedundancyType':: d.fn(help='"Indicates the redundancy type of this external VPN gateway Possible values are: FOUR_IPS_REDUNDANCY, SINGLE_IP_INTERNALLY_REDUNDANT, TWO_IPS_REDUNDANCY."', args=[d.arg(name='redundancyType', type=d.T.string)]),
      withRedundancyType(redundancyType): { spec+: { initProvider+: { redundancyType: redundancyType } } },
    },
