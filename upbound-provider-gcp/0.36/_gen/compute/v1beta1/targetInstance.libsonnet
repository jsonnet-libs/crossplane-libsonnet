{
  ...
  '#':: d.pkg(name='targetInstance', url='', help='"TargetInstance is the Schema for the TargetInstances API. Represents a TargetInstance resource which defines an endpoint instance that terminates traffic of certain protocols."'),
  ...
  '#new':: d.fn(help='new returns an instance of TargetInstance', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TargetInstanceSpec defines the desired state of TargetInstance"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withInstance':: d.fn(help='"The Compute instance VM handling traffic for this target instance. Accepts the instance self-link, relative path (e.g. projects/project/zones/zone/instances/instance) or name. If name is given, the zone will default to the given zone or the provider-default zone and the project will default to the provider-level project."', args=[d.arg(name='instance', type=d.T.string)]),
      withInstance(instance): { spec+: { forProvider+: { instance: instance } } },
      '#withNatPolicy':: d.fn(help="\"NAT option controlling how IPs are NAT'ed to the instance. Currently only NO_NAT (default value) is supported. Default value is NO_NAT. Possible values are: NO_NAT.\"", args=[d.arg(name='natPolicy', type=d.T.string)]),
      withNatPolicy(natPolicy): { spec+: { forProvider+: { natPolicy: natPolicy } } },
      ...
      '#withZone':: d.fn(help='"URL of the zone where the target instance resides."', args=[d.arg(name='zone', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withNatPolicy':: d.fn(help="\"NAT option controlling how IPs are NAT'ed to the instance. Currently only NO_NAT (default value) is supported. Default value is NO_NAT. Possible values are: NO_NAT.\"", args=[d.arg(name='natPolicy', type=d.T.string)]),
      withNatPolicy(natPolicy): { spec+: { initProvider+: { natPolicy: natPolicy } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
