{
  ...
  '#':: d.pkg(name='instanceGroupNamedPort', url='', help='"InstanceGroupNamedPort is the Schema for the InstanceGroupNamedPorts API. Mange the named ports setting for a managed instance group without managing the group as whole."'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceGroupNamedPort', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"InstanceGroupNamedPortSpec defines the desired state of InstanceGroupNamedPort"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withGroup':: d.fn(help='"The name of the instance group."', args=[d.arg(name='group', type=d.T.string)]),
      withGroup(group): { spec+: { forProvider+: { group: group } } },
      '#withName':: d.fn(help='"The name for this named port. The name must be 1-63 characters long, and comply with RFC1035."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPort':: d.fn(help='"The port number, which can be a value between 1 and 65535."', args=[d.arg(name='port', type=d.T.number)]),
      ...
      '#withZone':: d.fn(help='"The zone of the instance group."', args=[d.arg(name='zone', type=d.T.string)]),
