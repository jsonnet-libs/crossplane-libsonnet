{
  ...
  spec: {
    ...
    forProvider: {
      '#healthChecksRefs':: d.obj(help='"References to HTTPHealthCheck to populate healthChecks."'),
      healthChecksRefs: {
      ...
      '#healthChecksSelector':: d.obj(help='"Selector for a list of HTTPHealthCheck to populate healthChecks."'),
      ...
      '#withBackupPool':: d.fn(help='"URL to the backup target pool. Must also set failover_ratio."', args=[d.arg(name='backupPool', type=d.T.string)]),
      ...
      '#withFailoverRatio':: d.fn(help='"Ratio (0 to 1) of failed nodes before using the backup pool (which must also be set)."', args=[d.arg(name='failoverRatio', type=d.T.number)]),
      withFailoverRatio(failoverRatio): { spec+: { forProvider+: { failoverRatio: failoverRatio } } },
      '#withHealthChecks':: d.fn(help='"List of zero or one health check name or self_link. Only legacy google_compute_http_health_check is supported."', args=[d.arg(name='healthChecks', type=d.T.array)]),
      ...
      '#withHealthChecksMixin':: d.fn(help='"List of zero or one health check name or self_link. Only legacy google_compute_http_health_check is supported."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='healthChecks', type=d.T.array)]),
      ...
      '#withHealthChecksRefs':: d.fn(help='"References to HTTPHealthCheck to populate healthChecks."', args=[d.arg(name='healthChecksRefs', type=d.T.array)]),
      ...
      '#withInstances':: d.fn(help='"List of instances in the pool. They can be given as URLs, or in the form of \\"zone/name\\"."', args=[d.arg(name='instances', type=d.T.array)]),
      withInstances(instances): { spec+: { forProvider+: { instances: if std.isArray(v=instances) then instances else [instances] } } },
      '#withInstancesMixin':: d.fn(help='"List of instances in the pool. They can be given as URLs, or in the form of \\"zone/name\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='instances', type=d.T.array)]),
      ...
      '#withRegion':: d.fn(help='"Where the target pool resides. Defaults to project region."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withSessionAffinity':: d.fn(help='"How to distribute load. Options are \\"NONE\\" (no affinity). \\"CLIENT_IP\\" (hash of the source/dest addresses / ports), and \\"CLIENT_IP_PROTO\\" also includes the protocol (default \\"NONE\\")."', args=[d.arg(name='sessionAffinity', type=d.T.string)]),
