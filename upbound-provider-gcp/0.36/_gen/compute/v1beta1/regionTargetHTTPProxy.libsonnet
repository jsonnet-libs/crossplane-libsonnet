{
  ...
  spec: {
    ...
    forProvider: {
      '#urlMapRef':: d.obj(help='"Reference to a RegionURLMap to populate urlMap."'),
      urlMapRef: {
      ...
      '#urlMapSelector':: d.obj(help='"Selector for a RegionURLMap to populate urlMap."'),
      urlMapSelector: {
      ...
      '#withUrlMap':: d.fn(help='"A reference to the RegionUrlMap resource that defines the mapping from URL to the BackendService."', args=[d.arg(name='urlMap', type=d.T.string)]),
