{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPeerNetwork':: d.fn(help='"The peer network in the peering. The peer network may belong to a different project."', args=[d.arg(name='peerNetwork', type=d.T.string)]),
