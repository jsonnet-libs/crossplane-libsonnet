{
  ...
  '#':: d.pkg(name='httpsHealthCheck', url='', help='"HTTPSHealthCheck is the Schema for the HTTPSHealthChecks API. An HttpsHealthCheck resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of HTTPSHealthCheck', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HTTPSHealthCheckSpec defines the desired state of HTTPSHealthCheck"'),
  spec: {
    ...
    forProvider: {
      ...
      withRequestPath(requestPath): { spec+: { forProvider+: { requestPath: requestPath } } },
    ...
    initProvider: {
      ...
      '#withRequestPath':: d.fn(help='"The request path of the HTTPS health check request. The default value is /."', args=[d.arg(name='requestPath', type=d.T.string)]),
      withRequestPath(requestPath): { spec+: { initProvider+: { requestPath: requestPath } } },
      '#withTimeoutSec':: d.fn(help='"How long (in seconds) to wait before claiming failure. The default value is 5 seconds.  It is invalid for timeoutSec to have greater value than checkIntervalSec."', args=[d.arg(name='timeoutSec', type=d.T.number)]),
