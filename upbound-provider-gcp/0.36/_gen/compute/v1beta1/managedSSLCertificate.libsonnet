{
  ...
  '#':: d.pkg(name='managedSSLCertificate', url='', help='"ManagedSSLCertificate is the Schema for the ManagedSSLCertificates API. An SslCertificate resource, used for HTTPS load balancing."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagedSSLCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagedSSLCertificateSpec defines the desired state of ManagedSSLCertificate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#managed':: d.obj(help='"Properties relevant to a managed certificate.  These will be used if the certificate is managed (as indicated by a value of MANAGED in type). Structure is documented below."'),
      managed: {
        '#withDomains':: d.fn(help='"Domains for which a managed SSL certificate will be valid.  Currently, there can be up to 100 domains in this list."', args=[d.arg(name='domains', type=d.T.array)]),
        withDomains(domains): { domains: if std.isArray(v=domains) then domains else [domains] },
        '#withDomainsMixin':: d.fn(help='"Domains for which a managed SSL certificate will be valid.  Currently, there can be up to 100 domains in this list."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='domains', type=d.T.array)]),
        withDomainsMixin(domains): { domains+: if std.isArray(v=domains) then domains else [domains] },
      },
      '#withCertificateId':: d.fn(help='"The unique identifier for the resource."', args=[d.arg(name='certificateId', type=d.T.number)]),
      withCertificateId(certificateId): { spec+: { forProvider+: { certificateId: certificateId } } },
      ...
      '#withManaged':: d.fn(help='"Properties relevant to a managed certificate.  These will be used if the certificate is managed (as indicated by a value of MANAGED in type). Structure is documented below."', args=[d.arg(name='managed', type=d.T.array)]),
      withManaged(managed): { spec+: { forProvider+: { managed: if std.isArray(v=managed) then managed else [managed] } } },
      '#withManagedMixin':: d.fn(help='"Properties relevant to a managed certificate.  These will be used if the certificate is managed (as indicated by a value of MANAGED in type). Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managed', type=d.T.array)]),
      ...
      '#withType':: d.fn(help='"Enum field whose value is always MANAGED - used to signal to the API which type this is. Default value is MANAGED. Possible values are: MANAGED."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withCertificateId':: d.fn(help='"The unique identifier for the resource."', args=[d.arg(name='certificateId', type=d.T.number)]),
      withCertificateId(certificateId): { spec+: { initProvider+: { certificateId: certificateId } } },
      '#withDescription':: d.fn(help='"An optional description of this resource."', args=[d.arg(name='description', type=d.T.string)]),
