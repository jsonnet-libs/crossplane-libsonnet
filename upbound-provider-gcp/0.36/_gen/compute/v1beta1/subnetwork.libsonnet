{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRole':: d.fn(help='"The role of subnetwork. The value can be set to ACTIVE or BACKUP. An ACTIVE subnetwork is one that is currently being used. A BACKUP subnetwork is one that is ready to be promoted to ACTIVE or is currently draining. Subnetwork role must be specified when purpose is set to INTERNAL_HTTPS_LOAD_BALANCER or REGIONAL_MANAGED_PROXY. Possible values are: ACTIVE, BACKUP."', args=[d.arg(name='role', type=d.T.string)]),
      ...
      '#withStackType':: d.fn(help='"The stack type for this subnet to identify whether the IPv6 feature is enabled or not. If not specified IPV4_ONLY will be used. Possible values are: IPV4_ONLY, IPV4_IPV6."', args=[d.arg(name='stackType', type=d.T.string)]),
