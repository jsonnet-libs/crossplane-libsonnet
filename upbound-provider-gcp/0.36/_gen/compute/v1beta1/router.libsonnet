{
  ...
  '#':: d.pkg(name='router', url='', help='"Router is the Schema for the Routers API. Represents a Router resource."'),
  ...
  '#spec':: d.obj(help='"RouterSpec defines the desired state of Router"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#bgp':: d.obj(help='"BGP information specific to this router. Structure is documented below."'),
      bgp: {
        ...
        '#withAdvertiseMode':: d.fn(help='"User-specified flag to indicate which mode to use for advertisement. Default value is DEFAULT. Possible values are: DEFAULT, CUSTOM."', args=[d.arg(name='advertiseMode', type=d.T.string)]),
        withAdvertiseMode(advertiseMode): { advertiseMode: advertiseMode },
        '#withAdvertisedGroups':: d.fn(help='"User-specified list of prefix groups to advertise in custom mode. This field can only be populated if advertiseMode is CUSTOM and is advertised to all peers of the router. These groups will be advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups. This enum field has the one valid value: ALL_SUBNETS"', args=[d.arg(name='advertisedGroups', type=d.T.array)]),
        ...
        '#withAdvertisedGroupsMixin':: d.fn(help='"User-specified list of prefix groups to advertise in custom mode. This field can only be populated if advertiseMode is CUSTOM and is advertised to all peers of the router. These groups will be advertised in addition to any specified prefixes. Leave this field blank to advertise no custom groups. This enum field has the one valid value: ALL_SUBNETS"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='advertisedGroups', type=d.T.array)]),
        ...
        '#withAsn':: d.fn(help='"Local BGP Autonomous System Number (ASN). Must be an RFC6996 private ASN, either 16-bit or 32-bit. The value will be fixed for this router resource. All VPN tunnels that link to this router will have the same local ASN."', args=[d.arg(name='asn', type=d.T.number)]),
        withAsn(asn): { asn: asn },
        '#withKeepaliveInterval':: d.fn(help="\"The interval in seconds between BGP keepalive messages that are sent to the peer. Hold time is three times the interval at which keepalive messages are sent, and the hold time is the maximum number of seconds allowed to elapse between successive keepalive messages that BGP receives from a peer. BGP will use the smaller of either the local hold time value or the peer's hold time value as the hold time for the BGP connection between the two peers. If set, this value must be between 20 and 60. The default is 20.\"", args=[d.arg(name='keepaliveInterval', type=d.T.number)]),
        withKeepaliveInterval(keepaliveInterval): { keepaliveInterval: keepaliveInterval },
      },
      ...
      '#withBgp':: d.fn(help='"BGP information specific to this router. Structure is documented below."', args=[d.arg(name='bgp', type=d.T.array)]),
      withBgp(bgp): { spec+: { forProvider+: { bgp: if std.isArray(v=bgp) then bgp else [bgp] } } },
      '#withBgpMixin':: d.fn(help='"BGP information specific to this router. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='bgp', type=d.T.array)]),
      withBgpMixin(bgp): { spec+: { forProvider+: { bgp+: if std.isArray(v=bgp) then bgp else [bgp] } } },
      '#withDescription':: d.fn(help='"An optional description of this resource."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEncryptedInterconnectRouter':: d.fn(help='"Indicates if a router is dedicated for use with encrypted VLAN attachments (interconnectAttachments)."', args=[d.arg(name='encryptedInterconnectRouter', type=d.T.boolean)]),
      ...
      '#withNetwork':: d.fn(help='"A reference to the network to which this router belongs."', args=[d.arg(name='network', type=d.T.string)]),
      ...
      '#withRegion':: d.fn(help='"Region where the router resides."', args=[d.arg(name='region', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withBgp':: d.fn(help='"BGP information specific to this router. Structure is documented below."', args=[d.arg(name='bgp', type=d.T.array)]),
      withBgp(bgp): { spec+: { initProvider+: { bgp: if std.isArray(v=bgp) then bgp else [bgp] } } },
      '#withBgpMixin':: d.fn(help='"BGP information specific to this router. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='bgp', type=d.T.array)]),
      withBgpMixin(bgp): { spec+: { initProvider+: { bgp+: if std.isArray(v=bgp) then bgp else [bgp] } } },
      '#withDescription':: d.fn(help='"An optional description of this resource."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withEncryptedInterconnectRouter':: d.fn(help='"Indicates if a router is dedicated for use with encrypted VLAN attachments (interconnectAttachments)."', args=[d.arg(name='encryptedInterconnectRouter', type=d.T.boolean)]),
      withEncryptedInterconnectRouter(encryptedInterconnectRouter): { spec+: { initProvider+: { encryptedInterconnectRouter: encryptedInterconnectRouter } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
