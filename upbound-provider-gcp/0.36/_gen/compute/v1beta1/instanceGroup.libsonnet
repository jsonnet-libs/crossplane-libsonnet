{
  ...
  spec: {
    ...
    forProvider: {
      '#namedPort':: d.obj(help='"The named port configuration. See the section below for details on configuration. Structure is documented below."'),
      namedPort: {
      ...
      '#withDescription':: d.fn(help='"An optional textual description of the instance group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withInstances':: d.fn(help='"The list of instances in the group, in self_link format. When adding instances they must all be in the same network and zone as the instance group."', args=[d.arg(name='instances', type=d.T.array)]),
      withInstances(instances): { spec+: { forProvider+: { instances: if std.isArray(v=instances) then instances else [instances] } } },
      '#withInstancesMixin':: d.fn(help='"The list of instances in the group, in self_link format. When adding instances they must all be in the same network and zone as the instance group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='instances', type=d.T.array)]),
      withInstancesMixin(instances): { spec+: { forProvider+: { instances+: if std.isArray(v=instances) then instances else [instances] } } },
      '#withNamedPort':: d.fn(help='"The named port configuration. See the section below for details on configuration. Structure is documented below."', args=[d.arg(name='namedPort', type=d.T.array)]),
      withNamedPort(namedPort): { spec+: { forProvider+: { namedPort: if std.isArray(v=namedPort) then namedPort else [namedPort] } } },
      '#withNamedPortMixin':: d.fn(help='"The named port configuration. See the section below for details on configuration. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='namedPort', type=d.T.array)]),
      withNamedPortMixin(namedPort): { spec+: { forProvider+: { namedPort+: if std.isArray(v=namedPort) then namedPort else [namedPort] } } },
      '#withNetwork':: d.fn(help='"The URL of the network the instance group is in. If this is different from the network where the instances are in, the creation fails. Defaults to the network where the instances are in (if neither network nor instances is specified, this field will be blank)."', args=[d.arg(name='network', type=d.T.string)]),
