{
  ...
  '#':: d.pkg(name='regionSSLCertificate', url='', help='"RegionSSLCertificate is the Schema for the RegionSSLCertificates API. A RegionSslCertificate resource, used for HTTPS load balancing."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionSSLCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionSSLCertificateSpec defines the desired state of RegionSSLCertificate"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#certificateSecretRef':: d.obj(help='"The certificate in PEM format. The certificate chain must be no greater than 5 certs long. The chain must include at least one intermediate cert. Note: This property is sensitive and will not be displayed in the plan."'),
      ...
      '#privateKeySecretRef':: d.obj(help='"The write-only private key in PEM format. Note: This property is sensitive and will not be displayed in the plan."'),
      privateKeySecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withRegion':: d.fn(help='"The Region in which the created regional ssl certificate should reside. If it is not provided, the provider region is used."', args=[d.arg(name='region', type=d.T.string)]),
