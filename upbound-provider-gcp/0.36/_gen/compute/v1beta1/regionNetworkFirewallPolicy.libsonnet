{
  ...
  '#':: d.pkg(name='regionNetworkFirewallPolicy', url='', help='"RegionNetworkFirewallPolicy is the Schema for the RegionNetworkFirewallPolicys API. The Compute NetworkFirewallPolicy resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionNetworkFirewallPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionNetworkFirewallPolicySpec defines the desired state of RegionNetworkFirewallPolicy"'),
  spec: {
