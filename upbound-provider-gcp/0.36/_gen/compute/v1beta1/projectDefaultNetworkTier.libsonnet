{
  ...
  '#':: d.pkg(name='projectDefaultNetworkTier', url='', help='"ProjectDefaultNetworkTier is the Schema for the ProjectDefaultNetworkTiers API. Configures the default network tier for a project."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectDefaultNetworkTier', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectDefaultNetworkTierSpec defines the desired state of ProjectDefaultNetworkTier"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withNetworkTier':: d.fn(help='"The default network tier to be configured for the project. This field can take the following values: PREMIUM or STANDARD."', args=[d.arg(name='networkTier', type=d.T.string)]),
