{
  ...
  '#':: d.pkg(name='sslCertificate', url='', help='"SSLCertificate is the Schema for the SSLCertificates API. An SslCertificate resource, used for HTTPS load balancing."'),
  ...
  '#new':: d.fn(help='new returns an instance of SSLCertificate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SSLCertificateSpec defines the desired state of SSLCertificate"'),
  spec: {
