{
  ...
  spec: {
    ...
    forProvider: {
      '#collectorIlb':: d.obj(help='"The Forwarding Rule resource (of type load_balancing_scheme=INTERNAL) that will be used as collector for mirrored traffic. The specified forwarding rule must have is_mirroring_collector set to true. Structure is documented below."'),
      collectorIlb: {
      ...
      '#filter':: d.obj(help='"A filter for mirrored traffic.  If unset, all traffic is mirrored. Structure is documented below."'),
      filter: {
        ...
        '#withDirection':: d.fn(help='"Direction of traffic to mirror. Default value is BOTH. Possible values are: INGRESS, EGRESS, BOTH."', args=[d.arg(name='direction', type=d.T.string)]),
      ...
      '#mirroredResources':: d.obj(help='"A means of specifying which resources to mirror. Structure is documented below."'),
      mirroredResources: {
        '#instances':: d.obj(help='"All the listed instances will be mirrored.  Specify at most 50. Structure is documented below."'),
        instances: {
        ...
        '#subnetworks':: d.obj(help='"All instances in one of these subnetworks will be mirrored. Structure is documented below."'),
        subnetworks: {
          '#withUrl':: d.fn(help='"The URL of the subnetwork where this rule should be active."', args=[d.arg(name='url', type=d.T.string)]),
          withUrl(url): { url: url },
        },
        '#withInstances':: d.fn(help='"All the listed instances will be mirrored.  Specify at most 50. Structure is documented below."', args=[d.arg(name='instances', type=d.T.array)]),
        withInstances(instances): { instances: if std.isArray(v=instances) then instances else [instances] },
        '#withInstancesMixin':: d.fn(help='"All the listed instances will be mirrored.  Specify at most 50. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='instances', type=d.T.array)]),
        withInstancesMixin(instances): { instances+: if std.isArray(v=instances) then instances else [instances] },
        '#withSubnetworks':: d.fn(help='"All instances in one of these subnetworks will be mirrored. Structure is documented below."', args=[d.arg(name='subnetworks', type=d.T.array)]),
        withSubnetworks(subnetworks): { subnetworks: if std.isArray(v=subnetworks) then subnetworks else [subnetworks] },
        '#withSubnetworksMixin':: d.fn(help='"All instances in one of these subnetworks will be mirrored. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetworks', type=d.T.array)]),
      ...
      '#network':: d.obj(help='"Specifies the mirrored VPC network. Only packets in this network will be mirrored. All mirrored VMs should have a NIC in the given network. All mirrored subnetworks should belong to the given network. Structure is documented below."'),
      network: {
      ...
      '#withCollectorIlb':: d.fn(help='"The Forwarding Rule resource (of type load_balancing_scheme=INTERNAL) that will be used as collector for mirrored traffic. The specified forwarding rule must have is_mirroring_collector set to true. Structure is documented below."', args=[d.arg(name='collectorIlb', type=d.T.array)]),
      ...
      '#withCollectorIlbMixin':: d.fn(help='"The Forwarding Rule resource (of type load_balancing_scheme=INTERNAL) that will be used as collector for mirrored traffic. The specified forwarding rule must have is_mirroring_collector set to true. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='collectorIlb', type=d.T.array)]),
      ...
      '#withFilter':: d.fn(help='"A filter for mirrored traffic.  If unset, all traffic is mirrored. Structure is documented below."', args=[d.arg(name='filter', type=d.T.array)]),
      withFilter(filter): { spec+: { forProvider+: { filter: if std.isArray(v=filter) then filter else [filter] } } },
      '#withFilterMixin':: d.fn(help='"A filter for mirrored traffic.  If unset, all traffic is mirrored. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='filter', type=d.T.array)]),
      withFilterMixin(filter): { spec+: { forProvider+: { filter+: if std.isArray(v=filter) then filter else [filter] } } },
      '#withMirroredResources':: d.fn(help='"A means of specifying which resources to mirror. Structure is documented below."', args=[d.arg(name='mirroredResources', type=d.T.array)]),
      ...
      '#withMirroredResourcesMixin':: d.fn(help='"A means of specifying which resources to mirror. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='mirroredResources', type=d.T.array)]),
      ...
      '#withNetwork':: d.fn(help='"Specifies the mirrored VPC network. Only packets in this network will be mirrored. All mirrored VMs should have a NIC in the given network. All mirrored subnetworks should belong to the given network. Structure is documented below."', args=[d.arg(name='network', type=d.T.array)]),
      withNetwork(network): { spec+: { forProvider+: { network: if std.isArray(v=network) then network else [network] } } },
      '#withNetworkMixin':: d.fn(help='"Specifies the mirrored VPC network. Only packets in this network will be mirrored. All mirrored VMs should have a NIC in the given network. All mirrored subnetworks should belong to the given network. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='network', type=d.T.array)]),
      withNetworkMixin(network): { spec+: { forProvider+: { network+: if std.isArray(v=network) then network else [network] } } },
      '#withPriority':: d.fn(help='"Since only one rule can be active at a time, priority is used to break ties in the case of two rules that apply to the same instances."', args=[d.arg(name='priority', type=d.T.number)]),
