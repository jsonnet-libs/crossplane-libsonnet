{
  ...
  spec: {
    ...
    forProvider: {
      '#sslCertificatesRefs':: d.obj(help='"References to RegionSSLCertificate to populate sslCertificates."'),
      sslCertificatesRefs: {
      ...
      '#sslCertificatesSelector':: d.obj(help='"Selector for a list of RegionSSLCertificate to populate sslCertificates."'),
      ...
      '#withRegion':: d.fn(help='"The Region in which the created target https proxy should reside. If it is not provided, the provider region is used."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withSslCertificates':: d.fn(help='"A list of RegionSslCertificate resources that are used to authenticate connections between users and the load balancer. Currently, exactly one SSL certificate must be specified."', args=[d.arg(name='sslCertificates', type=d.T.array)]),
      ...
      '#withSslCertificatesMixin':: d.fn(help='"A list of RegionSslCertificate resources that are used to authenticate connections between users and the load balancer. Currently, exactly one SSL certificate must be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sslCertificates', type=d.T.array)]),
      ...
      '#withSslCertificatesRefs':: d.fn(help='"References to RegionSSLCertificate to populate sslCertificates."', args=[d.arg(name='sslCertificatesRefs', type=d.T.array)]),
      ...
      '#withUrlMap':: d.fn(help='"A reference to the RegionUrlMap resource that defines the mapping from URL to the RegionBackendService."', args=[d.arg(name='urlMap', type=d.T.string)]),
