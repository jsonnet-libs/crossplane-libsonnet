{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDefaultPort':: d.fn(help='"The default port used if the port number is not specified in the network endpoint."', args=[d.arg(name='defaultPort', type=d.T.number)]),
      ...
      '#withNetwork':: d.fn(help='"The network to which all network endpoints in the NEG belong. Uses \\"default\\" project network if unspecified."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withNetworkEndpointType':: d.fn(help='"Type of network endpoints in this network endpoint group. NON_GCP_PRIVATE_IP_PORT is used for hybrid connectivity network endpoint groups (see https://cloud.google.com/load-balancing/docs/hybrid). Note that NON_GCP_PRIVATE_IP_PORT can only be used with Backend Services that 1) have the following load balancing schemes: EXTERNAL, EXTERNAL_MANAGED, INTERNAL_MANAGED, and INTERNAL_SELF_MANAGED and 2) support the RATE or CONNECTION balancing modes. Possible values include: GCE_VM_IP, GCE_VM_IP_PORT, and NON_GCP_PRIVATE_IP_PORT. Default value is GCE_VM_IP_PORT. Possible values are: GCE_VM_IP, GCE_VM_IP_PORT, NON_GCP_PRIVATE_IP_PORT."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
