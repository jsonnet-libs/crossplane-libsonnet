{
  ...
  '#':: d.pkg(name='network', url='', help='"Network is the Schema for the Networks API. Manages a VPC network or legacy network resource on GCP."'),
  ...
  '#spec':: d.obj(help='"NetworkSpec defines the desired state of Network"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAutoCreateSubnetworks':: d.fn(help='"When set to true, the network is created in \\"auto subnet mode\\" and it will create a subnet for each region automatically across the 10.128.0.0/9 address range. When set to false, the network is created in \\"custom subnet mode\\" so the user can explicitly connect subnetwork resources."', args=[d.arg(name='autoCreateSubnetworks', type=d.T.boolean)]),
      withAutoCreateSubnetworks(autoCreateSubnetworks): { spec+: { forProvider+: { autoCreateSubnetworks: autoCreateSubnetworks } } },
      '#withDeleteDefaultRoutesOnCreate':: d.fn(help='"If set to true, default routes (0.0.0.0/0) will be deleted immediately after network creation. Defaults to false."', args=[d.arg(name='deleteDefaultRoutesOnCreate', type=d.T.boolean)]),
      withDeleteDefaultRoutesOnCreate(deleteDefaultRoutesOnCreate): { spec+: { forProvider+: { deleteDefaultRoutesOnCreate: deleteDefaultRoutesOnCreate } } },
      '#withDescription':: d.fn(help='"An optional description of this resource. The resource must be recreated to modify this field."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEnableUlaInternalIpv6':: d.fn(help='"Enable ULA internal ipv6 on this network. Enabling this feature will assign a /48 from google defined ULA prefix fd20::/20."', args=[d.arg(name='enableUlaInternalIpv6', type=d.T.boolean)]),
      withEnableUlaInternalIpv6(enableUlaInternalIpv6): { spec+: { forProvider+: { enableUlaInternalIpv6: enableUlaInternalIpv6 } } },
      '#withInternalIpv6Range':: d.fn(help='"When enabling ula internal ipv6, caller optionally can specify the /48 range they want from the google defined ULA prefix fd20::/20. The input must be a valid /48 ULA IPv6 address and must be within the fd20::/20. Operation will fail if the speficied /48 is already in used by another resource. If the field is not speficied, then a /48 range will be randomly allocated from fd20::/20 and returned via this field."', args=[d.arg(name='internalIpv6Range', type=d.T.string)]),
      withInternalIpv6Range(internalIpv6Range): { spec+: { forProvider+: { internalIpv6Range: internalIpv6Range } } },
      '#withMtu':: d.fn(help='"Maximum Transmission Unit in bytes. The default value is 1460 bytes. The minimum value for this field is 1300 and the maximum value is 8896 bytes (jumbo frames). Note that packets larger than 1500 bytes (standard Ethernet) can be subject to TCP-MSS clamping or dropped with an ICMP Fragmentation-Needed message if the packets are routed to the Internet or other VPCs with varying MTUs."', args=[d.arg(name='mtu', type=d.T.number)]),
      withMtu(mtu): { spec+: { forProvider+: { mtu: mtu } } },
      '#withNetworkFirewallPolicyEnforcementOrder':: d.fn(help='"Set the order that Firewall Rules and Firewall Policies are evaluated. Default value is AFTER_CLASSIC_FIREWALL. Possible values are: BEFORE_CLASSIC_FIREWALL, AFTER_CLASSIC_FIREWALL."', args=[d.arg(name='networkFirewallPolicyEnforcementOrder', type=d.T.string)]),
      withNetworkFirewallPolicyEnforcementOrder(networkFirewallPolicyEnforcementOrder): { spec+: { forProvider+: { networkFirewallPolicyEnforcementOrder: networkFirewallPolicyEnforcementOrder } } },
      ...
      '#withRoutingMode':: d.fn(help="\"The network-wide routing mode to use. If set to REGIONAL, this network's cloud routers will only advertise routes with subnetworks of this network in the same region as the router. If set to GLOBAL, this network's cloud routers will advertise routes with all subnetworks of this network, across regions. Possible values are: REGIONAL, GLOBAL.\"", args=[d.arg(name='routingMode', type=d.T.string)]),
      withRoutingMode(routingMode): { spec+: { forProvider+: { routingMode: routingMode } } },
    },
    ...
    initProvider: {
      '#withAutoCreateSubnetworks':: d.fn(help='"When set to true, the network is created in \\"auto subnet mode\\" and it will create a subnet for each region automatically across the 10.128.0.0/9 address range. When set to false, the network is created in \\"custom subnet mode\\" so the user can explicitly connect subnetwork resources."', args=[d.arg(name='autoCreateSubnetworks', type=d.T.boolean)]),
      withAutoCreateSubnetworks(autoCreateSubnetworks): { spec+: { initProvider+: { autoCreateSubnetworks: autoCreateSubnetworks } } },
      '#withDeleteDefaultRoutesOnCreate':: d.fn(help='"If set to true, default routes (0.0.0.0/0) will be deleted immediately after network creation. Defaults to false."', args=[d.arg(name='deleteDefaultRoutesOnCreate', type=d.T.boolean)]),
      withDeleteDefaultRoutesOnCreate(deleteDefaultRoutesOnCreate): { spec+: { initProvider+: { deleteDefaultRoutesOnCreate: deleteDefaultRoutesOnCreate } } },
      '#withDescription':: d.fn(help='"An optional description of this resource. The resource must be recreated to modify this field."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withEnableUlaInternalIpv6':: d.fn(help='"Enable ULA internal ipv6 on this network. Enabling this feature will assign a /48 from google defined ULA prefix fd20::/20."', args=[d.arg(name='enableUlaInternalIpv6', type=d.T.boolean)]),
      withEnableUlaInternalIpv6(enableUlaInternalIpv6): { spec+: { initProvider+: { enableUlaInternalIpv6: enableUlaInternalIpv6 } } },
      '#withInternalIpv6Range':: d.fn(help='"When enabling ula internal ipv6, caller optionally can specify the /48 range they want from the google defined ULA prefix fd20::/20. The input must be a valid /48 ULA IPv6 address and must be within the fd20::/20. Operation will fail if the speficied /48 is already in used by another resource. If the field is not speficied, then a /48 range will be randomly allocated from fd20::/20 and returned via this field."', args=[d.arg(name='internalIpv6Range', type=d.T.string)]),
      withInternalIpv6Range(internalIpv6Range): { spec+: { initProvider+: { internalIpv6Range: internalIpv6Range } } },
      '#withMtu':: d.fn(help='"Maximum Transmission Unit in bytes. The default value is 1460 bytes. The minimum value for this field is 1300 and the maximum value is 8896 bytes (jumbo frames). Note that packets larger than 1500 bytes (standard Ethernet) can be subject to TCP-MSS clamping or dropped with an ICMP Fragmentation-Needed message if the packets are routed to the Internet or other VPCs with varying MTUs."', args=[d.arg(name='mtu', type=d.T.number)]),
      withMtu(mtu): { spec+: { initProvider+: { mtu: mtu } } },
      '#withNetworkFirewallPolicyEnforcementOrder':: d.fn(help='"Set the order that Firewall Rules and Firewall Policies are evaluated. Default value is AFTER_CLASSIC_FIREWALL. Possible values are: BEFORE_CLASSIC_FIREWALL, AFTER_CLASSIC_FIREWALL."', args=[d.arg(name='networkFirewallPolicyEnforcementOrder', type=d.T.string)]),
      withNetworkFirewallPolicyEnforcementOrder(networkFirewallPolicyEnforcementOrder): { spec+: { initProvider+: { networkFirewallPolicyEnforcementOrder: networkFirewallPolicyEnforcementOrder } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { initProvider+: { project: project } } },
      '#withRoutingMode':: d.fn(help="\"The network-wide routing mode to use. If set to REGIONAL, this network's cloud routers will only advertise routes with subnetworks of this network in the same region as the router. If set to GLOBAL, this network's cloud routers will advertise routes with all subnetworks of this network, across regions. Possible values are: REGIONAL, GLOBAL.\"", args=[d.arg(name='routingMode', type=d.T.string)]),
      withRoutingMode(routingMode): { spec+: { initProvider+: { routingMode: routingMode } } },
    },
