{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAddress':: d.fn(help='"The IP address or beginning of the address range represented by this resource. This can be supplied as an input to reserve a specific address or omitted to allow GCP to choose a valid one for you."', args=[d.arg(name='address', type=d.T.string)]),
      ...
      '#withIpVersion':: d.fn(help='"The IP Version that will be used by this address. The default value is IPV4. Possible values are: IPV4, IPV6."', args=[d.arg(name='ipVersion', type=d.T.string)]),
      withIpVersion(ipVersion): { spec+: { forProvider+: { ipVersion: ipVersion } } },
      '#withNetwork':: d.fn(help='"The URL of the network in which to reserve the IP range. The IP range must be in RFC1918 space. The network cannot be deleted if there are any reserved IP ranges referring to it. This should only be set when using an Internal address."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withPrefixLength':: d.fn(help='"The prefix length of the IP range. If not present, it means the address field is a single IP address. This field is not applicable to addresses with addressType=EXTERNAL, or addressType=INTERNAL when purpose=PRIVATE_SERVICE_CONNECT"', args=[d.arg(name='prefixLength', type=d.T.number)]),
