{
  ...
  '#':: d.pkg(name='globalNetworkEndpointGroup', url='', help='"GlobalNetworkEndpointGroup is the Schema for the GlobalNetworkEndpointGroups API. A global network endpoint group contains endpoints that reside outside of Google Cloud."'),
  ...
  '#new':: d.fn(help='new returns an instance of GlobalNetworkEndpointGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GlobalNetworkEndpointGroupSpec defines the desired state of GlobalNetworkEndpointGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withNetworkEndpointType':: d.fn(help='"Type of network endpoints in this network endpoint group. Possible values are: INTERNET_IP_PORT, INTERNET_FQDN_PORT."', args=[d.arg(name='networkEndpointType', type=d.T.string)]),
