{
  ...
  '#':: d.pkg(name='instanceIAMMember', url='', help='"InstanceIAMMember is the Schema for the InstanceIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"InstanceIAMMemberSpec defines the desired state of InstanceIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#instanceNameRef':: d.obj(help='"Reference to a Instance to populate instanceName."'),
      instanceNameRef: {
      ...
      '#instanceNameSelector':: d.obj(help='"Selector for a Instance to populate instanceName."'),
      ...
      '#withInstanceName':: d.fn(help='', args=[d.arg(name='instanceName', type=d.T.string)]),
