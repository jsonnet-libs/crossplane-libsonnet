{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFqdn':: d.fn(help='"Fully qualified domain name of network endpoint. This can only be specified when network_endpoint_type of the NEG is INTERNET_FQDN_PORT."', args=[d.arg(name='fqdn', type=d.T.string)]),
