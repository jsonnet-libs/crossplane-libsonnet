{
  ...
  '#':: d.pkg(name='projectMetadataItem', url='', help='"ProjectMetadataItem is the Schema for the ProjectMetadataItems API. Manages a single key/value pair on common instance metadata"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectMetadataItem', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectMetadataItemSpec defines the desired state of ProjectMetadataItem"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withKey':: d.fn(help='"The metadata key to set."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withValue':: d.fn(help='"The value to set for the given metadata key."', args=[d.arg(name='value', type=d.T.string)]),
