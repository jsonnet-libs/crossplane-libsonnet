{
  ...
  '#':: d.pkg(name='projectMetadata', url='', help='"ProjectMetadata is the Schema for the ProjectMetadatas API. Manages common instance metadata"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectMetadata', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectMetadataSpec defines the desired state of ProjectMetadata"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withMetadata':: d.fn(help='"A series of key value pairs."', args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: metadata } } },
      '#withMetadataMixin':: d.fn(help='"A series of key value pairs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metadata', type=d.T.object)]),
