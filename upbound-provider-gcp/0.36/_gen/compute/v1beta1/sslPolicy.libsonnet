{
  ...
  '#':: d.pkg(name='sslPolicy', url='', help='"SSLPolicy is the Schema for the SSLPolicys API. Represents a SSL policy."'),
  ...
  '#new':: d.fn(help='new returns an instance of SSLPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SSLPolicySpec defines the desired state of SSLPolicy"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withCustomFeatures':: d.fn(help='"Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. This can be one of COMPATIBLE, MODERN, RESTRICTED, or CUSTOM. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. See the official documentation for which ciphers are available to use. Note: this argument must be present when using the CUSTOM profile. This argument must not be present when using any other profile."', args=[d.arg(name='customFeatures', type=d.T.array)]),
      withCustomFeatures(customFeatures): { spec+: { forProvider+: { customFeatures: if std.isArray(v=customFeatures) then customFeatures else [customFeatures] } } },
      '#withCustomFeaturesMixin':: d.fn(help='"Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. This can be one of COMPATIBLE, MODERN, RESTRICTED, or CUSTOM. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. See the official documentation for which ciphers are available to use. Note: this argument must be present when using the CUSTOM profile. This argument must not be present when using any other profile."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customFeatures', type=d.T.array)]),
      withCustomFeaturesMixin(customFeatures): { spec+: { forProvider+: { customFeatures+: if std.isArray(v=customFeatures) then customFeatures else [customFeatures] } } },
      ...
      '#withMinTlsVersion':: d.fn(help='"The minimum version of SSL protocol that can be used by the clients to establish a connection with the load balancer. Default value is TLS_1_0. Possible values are: TLS_1_0, TLS_1_1, TLS_1_2."', args=[d.arg(name='minTlsVersion', type=d.T.string)]),
      withMinTlsVersion(minTlsVersion): { spec+: { forProvider+: { minTlsVersion: minTlsVersion } } },
      '#withProfile':: d.fn(help='"Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. See the official documentation for information on what cipher suites each profile provides. If CUSTOM is used, the custom_features attribute must be set. Default value is COMPATIBLE. Possible values are: COMPATIBLE, MODERN, RESTRICTED, CUSTOM."', args=[d.arg(name='profile', type=d.T.string)]),
      withProfile(profile): { spec+: { forProvider+: { profile: profile } } },
    ...
    initProvider: {
      '#withCustomFeatures':: d.fn(help='"Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. This can be one of COMPATIBLE, MODERN, RESTRICTED, or CUSTOM. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. See the official documentation for which ciphers are available to use. Note: this argument must be present when using the CUSTOM profile. This argument must not be present when using any other profile."', args=[d.arg(name='customFeatures', type=d.T.array)]),
      withCustomFeatures(customFeatures): { spec+: { initProvider+: { customFeatures: if std.isArray(v=customFeatures) then customFeatures else [customFeatures] } } },
      '#withCustomFeaturesMixin':: d.fn(help='"Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. This can be one of COMPATIBLE, MODERN, RESTRICTED, or CUSTOM. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. See the official documentation for which ciphers are available to use. Note: this argument must be present when using the CUSTOM profile. This argument must not be present when using any other profile."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customFeatures', type=d.T.array)]),
      withCustomFeaturesMixin(customFeatures): { spec+: { initProvider+: { customFeatures+: if std.isArray(v=customFeatures) then customFeatures else [customFeatures] } } },
      '#withDescription':: d.fn(help='"An optional description of this resource."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withProfile':: d.fn(help='"Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. See the official documentation for information on what cipher suites each profile provides. If CUSTOM is used, the custom_features attribute must be set. Default value is COMPATIBLE. Possible values are: COMPATIBLE, MODERN, RESTRICTED, CUSTOM."', args=[d.arg(name='profile', type=d.T.string)]),
      withProfile(profile): { spec+: { initProvider+: { profile: profile } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
