{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"The resource policy to be attached to the disk for scheduling snapshot creation. Do not specify the self link."', args=[d.arg(name='name', type=d.T.string)]),
