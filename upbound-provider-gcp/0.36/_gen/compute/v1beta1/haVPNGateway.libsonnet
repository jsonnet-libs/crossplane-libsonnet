{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#vpnInterfaces':: d.obj(help='"A list of interfaces on this VPN gateway. Structure is documented below."'),
      vpnInterfaces: {
        ...
        withId(id): { id: id },
        '#withInterconnectAttachment':: d.fn(help='"URL of the interconnect attachment resource. When the value of this field is present, the VPN Gateway will be used for IPsec-encrypted Cloud Interconnect; all Egress or Ingress traffic for this VPN Gateway interface will go through the specified interconnect attachment resource. Not currently available publicly."', args=[d.arg(name='interconnectAttachment', type=d.T.string)]),
      ...
      '#withStackType':: d.fn(help='"The stack type for this VPN gateway to identify the IP protocols that are enabled. If not specified, IPV4_ONLY will be used. Default value is IPV4_ONLY. Possible values are: IPV4_ONLY, IPV4_IPV6."', args=[d.arg(name='stackType', type=d.T.string)]),
      withStackType(stackType): { spec+: { forProvider+: { stackType: stackType } } },
      '#withVpnInterfaces':: d.fn(help='"A list of interfaces on this VPN gateway. Structure is documented below."', args=[d.arg(name='vpnInterfaces', type=d.T.array)]),
      ...
      '#withVpnInterfacesMixin':: d.fn(help='"A list of interfaces on this VPN gateway. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vpnInterfaces', type=d.T.array)]),
