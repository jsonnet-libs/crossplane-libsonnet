{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstance':: d.fn(help='"The name for a specific VM instance that the IP address belongs to. This is required for network endpoints of type GCE_VM_IP_PORT. The instance must be in the same zone of network endpoint group."', args=[d.arg(name='instance', type=d.T.string)]),
      withInstance(instance): { spec+: { forProvider+: { instance: instance } } },
      '#withIpAddress':: d.fn(help='"IPv4 address of network endpoint. The IP address must belong to a VM in GCE (either the primary IP or as part of an aliased IP range)."', args=[d.arg(name='ipAddress', type=d.T.string)]),
      ...
      '#withPort':: d.fn(help='"Port number of network endpoint. Note port is required unless the Network Endpoint Group is created with the type of GCE_VM_IP"', args=[d.arg(name='port', type=d.T.number)]),
