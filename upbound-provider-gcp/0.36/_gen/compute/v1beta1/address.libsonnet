{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAddress':: d.fn(help='"The static external IP address represented by this resource. Only IPv4 is supported. An address may only be specified for INTERNAL address types. The IP address must be inside the specified subnetwork, if any. Set by the API if undefined."', args=[d.arg(name='address', type=d.T.string)]),
      withAddress(address): { spec+: { forProvider+: { address: address } } },
      '#withAddressType':: d.fn(help="\"The type of address to reserve. Note: if you set this argument's value as INTERNAL you need to leave the network_tier argument unset in that resource block. Default value is EXTERNAL. Possible values are: INTERNAL, EXTERNAL.\"", args=[d.arg(name='addressType', type=d.T.string)]),
      ...
      '#withNetwork':: d.fn(help='"The URL of the network in which to reserve the address. This field can only be used with INTERNAL type with the VPC_PEERING and IPSEC_INTERCONNECT purposes."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withNetworkTier':: d.fn(help="\"The networking tier used for configuring this address. If this field is not specified, it is assumed to be PREMIUM. This argument should not be used when configuring Internal addresses, because network tier cannot be set for internal traffic; it's always Premium. Possible values are: PREMIUM, STANDARD.\"", args=[d.arg(name='networkTier', type=d.T.string)]),
      ...
      '#withSubnetwork':: d.fn(help="\"The URL of the subnetwork in which to reserve the address. If an IP address is specified, it must be within the subnetwork's IP range. This field can only be used with INTERNAL type with GCE_ENDPOINT/DNS_RESOLVER purposes.\"", args=[d.arg(name='subnetwork', type=d.T.string)]),
