{
  ...
  '#':: d.pkg(name='repositoryIAMMember', url='', help='"RepositoryIAMMember is the Schema for the RepositoryIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of RepositoryIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RepositoryIAMMemberSpec defines the desired state of RepositoryIAMMember"'),
  spec: {
