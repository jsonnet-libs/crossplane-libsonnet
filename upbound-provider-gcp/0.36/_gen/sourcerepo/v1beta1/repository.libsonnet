{
  ...
  '#':: d.pkg(name='repository', url='', help='"Repository is the Schema for the Repositorys API. A repository (or repo) is a Git repository storing versioned source content."'),
  ...
  spec: {
    ...
    forProvider: {
      '#pubsubConfigs':: d.obj(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names. Structure is documented below."'),
      pubsubConfigs: {
        ...
        '#withMessageFormat':: d.fn(help='"The format of the Cloud Pub/Sub messages."', args=[d.arg(name='messageFormat', type=d.T.string)]),
        ...
        '#withTopic':: d.fn(help='"The identifier for this object. Format specified above."', args=[d.arg(name='topic', type=d.T.string)]),
      ...
      '#withPubsubConfigs':: d.fn(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names. Structure is documented below."', args=[d.arg(name='pubsubConfigs', type=d.T.array)]),
      withPubsubConfigs(pubsubConfigs): { spec+: { forProvider+: { pubsubConfigs: if std.isArray(v=pubsubConfigs) then pubsubConfigs else [pubsubConfigs] } } },
      '#withPubsubConfigsMixin':: d.fn(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pubsubConfigs', type=d.T.array)]),
      withPubsubConfigsMixin(pubsubConfigs): { spec+: { forProvider+: { pubsubConfigs+: if std.isArray(v=pubsubConfigs) then pubsubConfigs else [pubsubConfigs] } } },
    },
    ...
    initProvider: {
      ...
      '#withPubsubConfigs':: d.fn(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names. Structure is documented below."', args=[d.arg(name='pubsubConfigs', type=d.T.array)]),
      withPubsubConfigs(pubsubConfigs): { spec+: { initProvider+: { pubsubConfigs: if std.isArray(v=pubsubConfigs) then pubsubConfigs else [pubsubConfigs] } } },
      '#withPubsubConfigsMixin':: d.fn(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pubsubConfigs', type=d.T.array)]),
      withPubsubConfigsMixin(pubsubConfigs): { spec+: { initProvider+: { pubsubConfigs+: if std.isArray(v=pubsubConfigs) then pubsubConfigs else [pubsubConfigs] } } },
    },
