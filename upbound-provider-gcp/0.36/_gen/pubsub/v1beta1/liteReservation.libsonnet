{
  ...
  '#':: d.pkg(name='liteReservation', url='', help='"LiteReservation is the Schema for the LiteReservations API. A named resource representing a shared pool of capacity."'),
  ...
  '#new':: d.fn(help='new returns an instance of LiteReservation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LiteReservationSpec defines the desired state of LiteReservation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withThroughputCapacity':: d.fn(help='"The reserved throughput capacity. Every unit of throughput capacity is equivalent to 1 MiB/s of published messages or 2 MiB/s of subscribed messages."', args=[d.arg(name='throughputCapacity', type=d.T.number)]),
