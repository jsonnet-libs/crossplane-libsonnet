{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#messageStoragePolicy':: d.obj(help='"Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect. Structure is documented below."'),
      ...
      '#schemaSettings':: d.obj(help='"Settings for validating messages published against a schema. Structure is documented below."'),
      schemaSettings: {
        '#withEncoding':: d.fn(help='"The encoding of messages validated against schema. Default value is ENCODING_UNSPECIFIED. Possible values are: ENCODING_UNSPECIFIED, JSON, BINARY."', args=[d.arg(name='encoding', type=d.T.string)]),
        withEncoding(encoding): { encoding: encoding },
        '#withSchema':: d.fn(help='"The name of the schema that messages published should be validated against. Format is projects/{project}/schemas/{schema}. The value of this field will be deleted-schema if the schema has been deleted."', args=[d.arg(name='schema', type=d.T.string)]),
      ...
      '#withMessageRetentionDuration':: d.fn(help='"Indicates the minimum duration to retain a message after it is published to the topic. If this field is set, messages published to the topic in the last messageRetentionDuration are always available to subscribers. For instance, it allows any attached subscription to seek to a timestamp that is up to messageRetentionDuration in the past. If this field is not set, message retention is controlled by settings on individual subscriptions. Cannot be more than 31 days or less than 10 minutes."', args=[d.arg(name='messageRetentionDuration', type=d.T.string)]),
      withMessageRetentionDuration(messageRetentionDuration): { spec+: { forProvider+: { messageRetentionDuration: messageRetentionDuration } } },
      '#withMessageStoragePolicy':: d.fn(help='"Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect. Structure is documented below."', args=[d.arg(name='messageStoragePolicy', type=d.T.array)]),
      ...
      '#withMessageStoragePolicyMixin':: d.fn(help='"Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='messageStoragePolicy', type=d.T.array)]),
      ...
      '#withSchemaSettings':: d.fn(help='"Settings for validating messages published against a schema. Structure is documented below."', args=[d.arg(name='schemaSettings', type=d.T.array)]),
      ...
      '#withSchemaSettingsMixin':: d.fn(help='"Settings for validating messages published against a schema. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schemaSettings', type=d.T.array)]),
