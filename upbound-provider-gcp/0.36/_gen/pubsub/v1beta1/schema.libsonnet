{
  ...
  '#':: d.pkg(name='schema', url='', help='"Schema is the Schema for the Schemas API. A schema is a format that messages must follow, creating a contract between publisher and subscriber that Pub/Sub will enforce."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDefinition':: d.fn(help='"The definition of the schema. This should contain a string representing the full definition of the schema that is a valid schema definition of the type specified in type."', args=[d.arg(name='definition', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of the schema definition Default value is TYPE_UNSPECIFIED. Possible values are: TYPE_UNSPECIFIED, PROTOCOL_BUFFER, AVRO."', args=[d.arg(name='type', type=d.T.string)]),
