{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#subscriptionRef':: d.obj(help='"Reference to a Subscription to populate subscription."'),
      subscriptionRef: {
      ...
      '#subscriptionSelector':: d.obj(help='"Selector for a Subscription to populate subscription."'),
