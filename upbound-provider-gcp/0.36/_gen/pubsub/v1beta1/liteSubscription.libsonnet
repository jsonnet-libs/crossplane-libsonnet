{
  ...
  spec: {
    ...
    forProvider: {
      '#deliveryConfig':: d.obj(help="\"The settings for this subscription's message delivery. Structure is documented below.\""),
      deliveryConfig: {
        '#withDeliveryRequirement':: d.fn(help='"When this subscription should send messages to subscribers relative to messages persistence in storage. Possible values are: DELIVER_IMMEDIATELY, DELIVER_AFTER_STORED, DELIVERY_REQUIREMENT_UNSPECIFIED."', args=[d.arg(name='deliveryRequirement', type=d.T.string)]),
        withDeliveryRequirement(deliveryRequirement): { deliveryRequirement: deliveryRequirement },
      },
      '#topicRef':: d.obj(help='"Reference to a LiteTopic to populate topic."'),
      topicRef: {
      ...
      '#topicSelector':: d.obj(help='"Selector for a LiteTopic to populate topic."'),
      topicSelector: {
      ...
      '#withDeliveryConfig':: d.fn(help="\"The settings for this subscription's message delivery. Structure is documented below.\"", args=[d.arg(name='deliveryConfig', type=d.T.array)]),
      ...
      '#withDeliveryConfigMixin':: d.fn(help="\"The settings for this subscription's message delivery. Structure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='deliveryConfig', type=d.T.array)]),
