{
  ...
  '#':: d.pkg(name='contact', url='', help='"Contact is the Schema for the Contacts API. A contact that will receive notifications from Google Cloud."'),
  ...
  '#new':: d.fn(help='new returns an instance of Contact', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ContactSpec defines the desired state of Contact"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withEmail':: d.fn(help='"The email address to send notifications to. This does not need to be a Google account."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withLanguageTag':: d.fn(help='"The preferred language for notifications, as a ISO 639-1 language code. See Supported languages for a list of supported languages."', args=[d.arg(name='languageTag', type=d.T.string)]),
      withLanguageTag(languageTag): { spec+: { forProvider+: { languageTag: languageTag } } },
      '#withNotificationCategorySubscriptions':: d.fn(help='"The categories of notifications that the contact will receive communications for."', args=[d.arg(name='notificationCategorySubscriptions', type=d.T.array)]),
      withNotificationCategorySubscriptions(notificationCategorySubscriptions): { spec+: { forProvider+: { notificationCategorySubscriptions: if std.isArray(v=notificationCategorySubscriptions) then notificationCategorySubscriptions else [notificationCategorySubscriptions] } } },
      '#withNotificationCategorySubscriptionsMixin':: d.fn(help='"The categories of notifications that the contact will receive communications for."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='notificationCategorySubscriptions', type=d.T.array)]),
      withNotificationCategorySubscriptionsMixin(notificationCategorySubscriptions): { spec+: { forProvider+: { notificationCategorySubscriptions+: if std.isArray(v=notificationCategorySubscriptions) then notificationCategorySubscriptions else [notificationCategorySubscriptions] } } },
      '#withParent':: d.fn(help='"The resource to save this contact for. Format: organizations/{organization_id}, folders/{folder_id} or projects/{project_id}"', args=[d.arg(name='parent', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withLanguageTag':: d.fn(help='"The preferred language for notifications, as a ISO 639-1 language code. See Supported languages for a list of supported languages."', args=[d.arg(name='languageTag', type=d.T.string)]),
      withLanguageTag(languageTag): { spec+: { initProvider+: { languageTag: languageTag } } },
      '#withNotificationCategorySubscriptions':: d.fn(help='"The categories of notifications that the contact will receive communications for."', args=[d.arg(name='notificationCategorySubscriptions', type=d.T.array)]),
      withNotificationCategorySubscriptions(notificationCategorySubscriptions): { spec+: { initProvider+: { notificationCategorySubscriptions: if std.isArray(v=notificationCategorySubscriptions) then notificationCategorySubscriptions else [notificationCategorySubscriptions] } } },
      '#withNotificationCategorySubscriptionsMixin':: d.fn(help='"The categories of notifications that the contact will receive communications for."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='notificationCategorySubscriptions', type=d.T.array)]),
      withNotificationCategorySubscriptionsMixin(notificationCategorySubscriptions): { spec+: { initProvider+: { notificationCategorySubscriptions+: if std.isArray(v=notificationCategorySubscriptions) then notificationCategorySubscriptions else [notificationCategorySubscriptions] } } },
      '#withParent':: d.fn(help='"The resource to save this contact for. Format: organizations/{organization_id}, folders/{folder_id} or projects/{project_id}"', args=[d.arg(name='parent', type=d.T.string)]),
