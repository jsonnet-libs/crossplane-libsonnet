{
  ...
  spec: {
    ...
    forProvider: {
      '#certificateTemplateRef':: d.obj(help='"Reference to a CertificateTemplate to populate certificateTemplate."'),
      ...
      '#certificateTemplateSelector':: d.obj(help='"Selector for a CertificateTemplate to populate certificateTemplate."'),
