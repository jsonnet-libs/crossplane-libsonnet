{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#subordinateConfig':: d.obj(help='"If this is a subordinate CertificateAuthority, this field will be set with the subordinate configuration, which describes its issuers. Structure is documented below."'),
      subordinateConfig: {
        ...
        '#pemIssuerChain':: d.obj(help='"Contains the PEM certificate chain for the issuers of this CertificateAuthority, but not pem certificate for this CA itself. Structure is documented below."'),
        pemIssuerChain: {
      ...
      '#withSkipGracePeriod':: d.fn(help='"If this flag is set, the Certificate Authority will be deleted as soon as possible without a 30-day grace period where undeletion would have been allowed. If you proceed, there will be no way to recover this CA. Use with care. Defaults to false."', args=[d.arg(name='skipGracePeriod', type=d.T.boolean)]),
      withSkipGracePeriod(skipGracePeriod): { spec+: { forProvider+: { skipGracePeriod: skipGracePeriod } } },
      '#withSubordinateConfig':: d.fn(help='"If this is a subordinate CertificateAuthority, this field will be set with the subordinate configuration, which describes its issuers. Structure is documented below."', args=[d.arg(name='subordinateConfig', type=d.T.array)]),
      ...
      '#withSubordinateConfigMixin':: d.fn(help='"If this is a subordinate CertificateAuthority, this field will be set with the subordinate configuration, which describes its issuers. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subordinateConfig', type=d.T.array)]),
      ...
      '#withType':: d.fn(help='"The Type of this CertificateAuthority. ~> Note: For SUBORDINATE Certificate Authorities, they need to be activated before they can issue certificates. Default value is SELF_SIGNED. Possible values are: SELF_SIGNED, SUBORDINATE."', args=[d.arg(name='type', type=d.T.string)]),
