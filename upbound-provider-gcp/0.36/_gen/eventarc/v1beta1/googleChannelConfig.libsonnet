{
  ...
  '#':: d.pkg(name='googleChannelConfig', url='', help='"GoogleChannelConfig is the Schema for the GoogleChannelConfigs API. The Eventarc GoogleChannelConfig resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of GoogleChannelConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GoogleChannelConfigSpec defines the desired state of GoogleChannelConfig"'),
  spec: {
