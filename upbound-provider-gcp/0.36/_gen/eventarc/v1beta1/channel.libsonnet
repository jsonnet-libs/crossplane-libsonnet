{
  ...
  '#':: d.pkg(name='channel', url='', help='"Channel is the Schema for the Channels API. The Eventarc Channel resource"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCryptoKeyName':: d.fn(help='"Optional. Resource name of a KMS crypto key (managed by the user) used to encrypt/decrypt their event data. It must match the pattern projects/*/locations/*/keyRings/*/cryptoKeys/*."', args=[d.arg(name='cryptoKeyName', type=d.T.string)]),
      ...
      '#withThirdPartyProvider':: d.fn(help='"The name of the event provider (e.g. Eventarc SaaS partner) associated with the channel. This provider will be granted permissions to publish events to the channel. Format: projects/{project}/locations/{location}/providers/{provider_id}."', args=[d.arg(name='thirdPartyProvider', type=d.T.string)]),
      withThirdPartyProvider(thirdPartyProvider): { spec+: { forProvider+: { thirdPartyProvider: thirdPartyProvider } } },
    },
    ...
    initProvider: {
      ...
      '#withThirdPartyProvider':: d.fn(help='"The name of the event provider (e.g. Eventarc SaaS partner) associated with the channel. This provider will be granted permissions to publish events to the channel. Format: projects/{project}/locations/{location}/providers/{provider_id}."', args=[d.arg(name='thirdPartyProvider', type=d.T.string)]),
      withThirdPartyProvider(thirdPartyProvider): { spec+: { initProvider+: { thirdPartyProvider: thirdPartyProvider } } },
    },
