  ...
  spec: {
    ...
    forProvider: {
      ...
      destination: {
        ...
        '#withCloudFunction':: d.fn(help='"[WARNING] Configuring a Cloud Function in Trigger is not supported as of today. The Cloud Function resource name. Format: projects/{project}/locations/{location}/functions/{function}"', args=[d.arg(name='cloudFunction', type=d.T.string)]),
