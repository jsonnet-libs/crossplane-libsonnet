{
  ...
  '#':: d.pkg(name='tableIAMMember', url='', help='"TableIAMMember is the Schema for the TableIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of TableIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TableIAMMemberSpec defines the desired state of TableIAMMember"'),
  spec: {
