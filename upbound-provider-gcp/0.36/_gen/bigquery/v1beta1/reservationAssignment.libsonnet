{
  ...
  '#':: d.pkg(name='reservationAssignment', url='', help='"ReservationAssignment is the Schema for the ReservationAssignments API. The BigqueryReservation Assignment resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of ReservationAssignment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ReservationAssignmentSpec defines the desired state of ReservationAssignment"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#reservationRef':: d.obj(help='"Reference to a Reservation in bigquery to populate reservation."'),
      reservationRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { reservationRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { reservationRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { reservationRef+: { name: name } } } },
      },
      '#reservationSelector':: d.obj(help='"Selector for a Reservation in bigquery to populate reservation."'),
      reservationSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { reservationSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { reservationSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { reservationSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { reservationSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { reservationSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withAssignee':: d.fn(help='"The resource which will use the reservation. E.g. projects/myproject, folders/123, organizations/456."', args=[d.arg(name='assignee', type=d.T.string)]),
      withAssignee(assignee): { spec+: { forProvider+: { assignee: assignee } } },
      '#withJobType':: d.fn(help='"Types of job, which could be specified when using the reservation. Possible values: JOB_TYPE_UNSPECIFIED, PIPELINE, QUERY"', args=[d.arg(name='jobType', type=d.T.string)]),
      ...
      '#withReservation':: d.fn(help='"The reservation for the resource"', args=[d.arg(name='reservation', type=d.T.string)]),
      withReservation(reservation): { spec+: { forProvider+: { reservation: reservation } } },
    },
    ...
    initProvider: {
      '#withAssignee':: d.fn(help='"The resource which will use the reservation. E.g. projects/myproject, folders/123, organizations/456."', args=[d.arg(name='assignee', type=d.T.string)]),
      withAssignee(assignee): { spec+: { initProvider+: { assignee: assignee } } },
      '#withJobType':: d.fn(help='"Types of job, which could be specified when using the reservation. Possible values: JOB_TYPE_UNSPECIFIED, PIPELINE, QUERY"', args=[d.arg(name='jobType', type=d.T.string)]),
