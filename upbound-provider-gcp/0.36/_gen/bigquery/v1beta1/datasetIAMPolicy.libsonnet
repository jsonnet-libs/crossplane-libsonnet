{
  ...
  '#':: d.pkg(name='datasetIAMPolicy', url='', help='"DatasetIAMPolicy is the Schema for the DatasetIAMPolicys API. Collection of resources to manage IAM policy for a BigQuery dataset."'),
  ...
  '#new':: d.fn(help='new returns an instance of DatasetIAMPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatasetIAMPolicySpec defines the desired state of DatasetIAMPolicy"'),
  spec: {
