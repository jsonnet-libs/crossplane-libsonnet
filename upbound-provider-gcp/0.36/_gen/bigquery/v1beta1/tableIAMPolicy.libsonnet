{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicyData':: d.fn(help='"The policy data generated by a google_iam_policy data source."', args=[d.arg(name='policyData', type=d.T.string)]),
      withPolicyData(policyData): { spec+: { forProvider+: { policyData: policyData } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
