{
  ...
  '#':: d.pkg(name='datasetIAMBinding', url='', help='"DatasetIAMBinding is the Schema for the DatasetIAMBindings API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of DatasetIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatasetIAMBindingSpec defines the desired state of DatasetIAMBinding"'),
  spec: {
