{
  ...
  '#':: d.pkg(name='analyticsHubDataExchange', url='', help='"AnalyticsHubDataExchange is the Schema for the AnalyticsHubDataExchanges API. A Bigquery Analytics Hub data exchange"'),
  ...
  '#new':: d.fn(help='new returns an instance of AnalyticsHubDataExchange', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AnalyticsHubDataExchangeSpec defines the desired state of AnalyticsHubDataExchange"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description of the data exchange."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisplayName':: d.fn(help='"Human-readable display name of the data exchange. The display name must contain only Unicode letters, numbers (0-9), underscores (_), dashes (-), spaces ( ), and must not start or end with spaces."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withDocumentation':: d.fn(help='"Documentation describing the data exchange."', args=[d.arg(name='documentation', type=d.T.string)]),
      withDocumentation(documentation): { spec+: { forProvider+: { documentation: documentation } } },
      '#withIcon':: d.fn(help='"Base64 encoded image representing the data exchange."', args=[d.arg(name='icon', type=d.T.string)]),
      withIcon(icon): { spec+: { forProvider+: { icon: icon } } },
      '#withLocation':: d.fn(help='"The name of the location this data exchange."', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { forProvider+: { location: location } } },
      '#withPrimaryContact':: d.fn(help='"Email or URL of the primary point of contact of the data exchange."', args=[d.arg(name='primaryContact', type=d.T.string)]),
