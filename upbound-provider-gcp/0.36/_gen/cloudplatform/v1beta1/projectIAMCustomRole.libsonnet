{
  ...
  '#':: d.pkg(name='projectIAMCustomRole', url='', help='"ProjectIAMCustomRole is the Schema for the ProjectIAMCustomRoles API. Allows management of a customized Cloud IAM project role."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectIAMCustomRole', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectIAMCustomRoleSpec defines the desired state of ProjectIAMCustomRole"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withProject':: d.fn(help='"The project that the service account will be created in. Defaults to the provider project configuration."', args=[d.arg(name='project', type=d.T.string)]),
