{
  ...
  '#':: d.pkg(name='projectService', url='', help='"ProjectService is the Schema for the ProjectServices API. Allows management of a single API service for a Google Cloud Platform project."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDisableDependentServices':: d.fn(help='"If true, services that are enabled and which depend on this service should also be disabled when this service is destroyed. If false or unset, an error will be generated if any enabled services depend on this service when destroying it."', args=[d.arg(name='disableDependentServices', type=d.T.boolean)]),
      withDisableDependentServices(disableDependentServices): { spec+: { forProvider+: { disableDependentServices: disableDependentServices } } },
      '#withDisableOnDestroy':: d.fn(help='"Defaults to true. May be useful in the event that a project is long-lived but the infrastructure running in that project changes frequently."', args=[d.arg(name='disableOnDestroy', type=d.T.boolean)]),
      withDisableOnDestroy(disableOnDestroy): { spec+: { forProvider+: { disableOnDestroy: disableOnDestroy } } },
      '#withProject':: d.fn(help='"The project ID. If not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
