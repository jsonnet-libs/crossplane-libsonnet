{
  ...
  '#':: d.pkg(name='organizationIAMMember', url='', help='"OrganizationIAMMember is the Schema for the OrganizationIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationIAMMemberSpec defines the desired state of OrganizationIAMMember"'),
  spec: {
