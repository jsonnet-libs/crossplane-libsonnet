{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withParent':: d.fn(help='"The resource name of the parent Folder or Organization. Must be of the form folders/{folder_id} or organizations/{org_id}."', args=[d.arg(name='parent', type=d.T.string)]),
