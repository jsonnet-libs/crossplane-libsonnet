{
  ...
  '#':: d.pkg(name='organizationIAMAuditConfig', url='', help='"OrganizationIAMAuditConfig is the Schema for the OrganizationIAMAuditConfigs API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationIAMAuditConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationIAMAuditConfigSpec defines the desired state of OrganizationIAMAuditConfig"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withOrgId':: d.fn(help='', args=[d.arg(name='orgId', type=d.T.string)]),
