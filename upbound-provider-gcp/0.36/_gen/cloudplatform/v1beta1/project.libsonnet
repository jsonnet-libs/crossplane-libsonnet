{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoCreateNetwork':: d.fn(help="\"Controls whether the 'default' network exists on the project. Defaults to true, where it is created. Therefore, for quota purposes, you will still need to have 1 network slot available to create the project successfully, even if you set auto_create_network to false.googleapis.com on the project to interact with the GCE API and currently leaves it enabled.\"", args=[d.arg(name='autoCreateNetwork', type=d.T.boolean)]),
      withAutoCreateNetwork(autoCreateNetwork): { spec+: { forProvider+: { autoCreateNetwork: autoCreateNetwork } } },
      '#withBillingAccount':: d.fn(help='"The alphanumeric ID of the billing account this project belongs to.user) on the billing account. See Google Cloud Billing API Access Control for more details."', args=[d.arg(name='billingAccount', type=d.T.string)]),
      withBillingAccount(billingAccount): { spec+: { forProvider+: { billingAccount: billingAccount } } },
      '#withFolderId':: d.fn(help='"The numeric ID of the folder this project should be created under. Only one of org_id or folder_id may be specified. If the folder_id is specified, then the project is created under the specified folder. Changing this forces the project to be migrated to the newly specified folder."', args=[d.arg(name='folderId', type=d.T.string)]),
      withFolderId(folderId): { spec+: { forProvider+: { folderId: folderId } } },
      '#withLabels':: d.fn(help='"A set of key/value label pairs to assign to the project."', args=[d.arg(name='labels', type=d.T.object)]),
