{
  ...
  '#':: d.pkg(name='organizationIAMCustomRole', url='', help='"OrganizationIAMCustomRole is the Schema for the OrganizationIAMCustomRoles API. Allows management of a customized Cloud IAM organization role."'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationIAMCustomRole', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationIAMCustomRoleSpec defines the desired state of OrganizationIAMCustomRole"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withOrgId':: d.fn(help='"The numeric ID of the organization in which you want to create a custom role."', args=[d.arg(name='orgId', type=d.T.string)]),
      ...
      '#withRoleId':: d.fn(help='"The role id to use for this role."', args=[d.arg(name='roleId', type=d.T.string)]),
      withRoleId(roleId): { spec+: { forProvider+: { roleId: roleId } } },
      '#withStage':: d.fn(help='"The current launch stage of the role. Defaults to GA. List of possible stages is here."', args=[d.arg(name='stage', type=d.T.string)]),
