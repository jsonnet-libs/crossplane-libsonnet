{
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"A text description of the service account. Must be less than or equal to 256 UTF-8 bytes."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withDisabled':: d.fn(help='"Whether a service account is disabled or not. Defaults to false. This field has no effect during creation. Must be set after creation to disable a service account."', args=[d.arg(name='disabled', type=d.T.boolean)]),
      withDisabled(disabled): { spec+: { forProvider+: { disabled: disabled } } },
      '#withDisplayName':: d.fn(help='"The display name for the service account. Can be updated without creating a new resource."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withProject':: d.fn(help='"The ID of the project that the service account will be created in. Defaults to the provider project configuration."', args=[d.arg(name='project', type=d.T.string)]),
