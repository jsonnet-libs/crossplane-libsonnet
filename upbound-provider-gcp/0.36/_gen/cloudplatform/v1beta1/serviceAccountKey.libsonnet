{
  ...
  spec: {
    ...
    forProvider: {
      '#serviceAccountIdRef':: d.obj(help='"Reference to a ServiceAccount to populate serviceAccountId."'),
      serviceAccountIdRef: {
      ...
      '#serviceAccountIdSelector':: d.obj(help='"Selector for a ServiceAccount to populate serviceAccountId."'),
      ...
      '#withKeyAlgorithm':: d.fn(help='"The algorithm used to generate the key. KEY_ALG_RSA_2048 is the default algorithm. Valid values are listed at ServiceAccountPrivateKeyType (only used on create)"', args=[d.arg(name='keyAlgorithm', type=d.T.string)]),
