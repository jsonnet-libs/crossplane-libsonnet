{
  ...
  '#':: d.pkg(name='serviceNetworkingPeeredDNSDomain', url='', help='"ServiceNetworkingPeeredDNSDomain is the Schema for the ServiceNetworkingPeeredDNSDomains API. Allows management of a single peered DNS domain on a project."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceNetworkingPeeredDNSDomain', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServiceNetworkingPeeredDNSDomainSpec defines the desired state of ServiceNetworkingPeeredDNSDomain"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDnsSuffix':: d.fn(help='"The DNS domain suffix of the peered DNS domain. Make sure to suffix with a . (dot)."', args=[d.arg(name='dnsSuffix', type=d.T.string)]),
      withDnsSuffix(dnsSuffix): { spec+: { forProvider+: { dnsSuffix: dnsSuffix } } },
      '#withNetwork':: d.fn(help='"The network in the consumer project."', args=[d.arg(name='network', type=d.T.string)]),
      withNetwork(network): { spec+: { forProvider+: { network: network } } },
      '#withProject':: d.fn(help='"The producer project number. If not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { forProvider+: { project: project } } },
      '#withService':: d.fn(help='"Private service connection between service and consumer network, defaults to servicenetworking.googleapis.com"', args=[d.arg(name='service', type=d.T.string)]),
    ...
    initProvider: {
      '#withDnsSuffix':: d.fn(help='"The DNS domain suffix of the peered DNS domain. Make sure to suffix with a . (dot)."', args=[d.arg(name='dnsSuffix', type=d.T.string)]),
      withDnsSuffix(dnsSuffix): { spec+: { initProvider+: { dnsSuffix: dnsSuffix } } },
      '#withProject':: d.fn(help='"The producer project number. If not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
