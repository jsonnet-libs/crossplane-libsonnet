{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withParentName':: d.fn(help="\"The name of the group's parent, if it has one. The format is \\\"projects/{project_id_or_number}/groups/{group_id}\\\". For groups with no parent, parentName is the empty string, \\\"\\\".\"", args=[d.arg(name='parentName', type=d.T.string)]),
