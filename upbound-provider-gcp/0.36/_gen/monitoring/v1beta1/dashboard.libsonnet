{
  ...
  '#':: d.pkg(name='dashboard', url='', help='"Dashboard is the Schema for the Dashboards API. A Google Stackdriver dashboard."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDashboardJson':: d.fn(help='"The JSON representation of a dashboard, following the format at https://cloud.google.com/monitoring/api/ref_v3/rest/v1/projects.dashboards. The representation of an existing dashboard can be found by using the API Explorer"', args=[d.arg(name='dashboardJson', type=d.T.string)]),
      withDashboardJson(dashboardJson): { spec+: { forProvider+: { dashboardJson: dashboardJson } } },
    ...
    initProvider: {
      '#withDashboardJson':: d.fn(help='"The JSON representation of a dashboard, following the format at https://cloud.google.com/monitoring/api/ref_v3/rest/v1/projects.dashboards. The representation of an existing dashboard can be found by using the API Explorer"', args=[d.arg(name='dashboardJson', type=d.T.string)]),
      withDashboardJson(dashboardJson): { spec+: { initProvider+: { dashboardJson: dashboardJson } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
