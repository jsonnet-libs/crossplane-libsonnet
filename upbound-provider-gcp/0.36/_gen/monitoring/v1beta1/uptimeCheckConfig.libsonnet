{
  ...
  spec: {
    ...
    forProvider: {
      ...
      contentMatchers: {
        '#jsonPathMatcher':: d.obj(help='"Information needed to perform a JSONPath content match. Used for ContentMatcherOption::MATCHES_JSON_PATH and ContentMatcherOption::NOT_MATCHES_JSON_PATH. Structure is documented below."'),
        jsonPathMatcher: {
          '#withJsonMatcher':: d.fn(help='"Options to perform JSONPath content matching. Default value is EXACT_MATCH. Possible values are: EXACT_MATCH, REGEX_MATCH."', args=[d.arg(name='jsonMatcher', type=d.T.string)]),
        ...
        '#withJsonPathMatcher':: d.fn(help='"Information needed to perform a JSONPath content match. Used for ContentMatcherOption::MATCHES_JSON_PATH and ContentMatcherOption::NOT_MATCHES_JSON_PATH. Structure is documented below."', args=[d.arg(name='jsonPathMatcher', type=d.T.array)]),
        ...
        '#withJsonPathMatcherMixin':: d.fn(help='"Information needed to perform a JSONPath content match. Used for ContentMatcherOption::MATCHES_JSON_PATH and ContentMatcherOption::NOT_MATCHES_JSON_PATH. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='jsonPathMatcher', type=d.T.array)]),
        ...
        '#withMatcher':: d.fn(help='"The type of content matcher that will be applied to the server output, compared to the content string when the check is run. Default value is CONTAINS_STRING. Possible values are: CONTAINS_STRING, NOT_CONTAINS_STRING, MATCHES_REGEX, NOT_MATCHES_REGEX, MATCHES_JSON_PATH, NOT_MATCHES_JSON_PATH."', args=[d.arg(name='matcher', type=d.T.string)]),
      ...
      httpCheck: {
        '#acceptedResponseStatusCodes':: d.obj(help='"If present, the check will only pass if the HTTP response status code is in this set of status codes. If empty, the HTTP status code will only pass if the HTTP status code is 200-299. Structure is documented below."'),
        acceptedResponseStatusCodes: {
          '#withStatusClass':: d.fn(help='"A class of status codes to accept. Possible values are: STATUS_CLASS_1XX, STATUS_CLASS_2XX, STATUS_CLASS_3XX, STATUS_CLASS_4XX, STATUS_CLASS_5XX, STATUS_CLASS_ANY."', args=[d.arg(name='statusClass', type=d.T.string)]),
        ...
        '#withAcceptedResponseStatusCodes':: d.fn(help='"If present, the check will only pass if the HTTP response status code is in this set of status codes. If empty, the HTTP status code will only pass if the HTTP status code is 200-299. Structure is documented below."', args=[d.arg(name='acceptedResponseStatusCodes', type=d.T.array)]),
        ...
        '#withAcceptedResponseStatusCodesMixin':: d.fn(help='"If present, the check will only pass if the HTTP response status code is in this set of status codes. If empty, the HTTP status code will only pass if the HTTP status code is 200-299. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='acceptedResponseStatusCodes', type=d.T.array)]),
        ...
        '#withContentType':: d.fn(help='"The content type to use for the check. Possible values are: TYPE_UNSPECIFIED, URL_ENCODED."', args=[d.arg(name='contentType', type=d.T.string)]),
        ...
        '#withRequestMethod':: d.fn(help='"The HTTP request method to use for the check. If set to METHOD_UNSPECIFIED then requestMethod defaults to GET. Default value is GET. Possible values are: METHOD_UNSPECIFIED, GET, POST."', args=[d.arg(name='requestMethod', type=d.T.string)]),
      ...
      resourceGroup: {
        ...
        '#withResourceType':: d.fn(help='"The resource type of the group members. Possible values are: RESOURCE_TYPE_UNSPECIFIED, INSTANCE, AWS_ELB_LOAD_BALANCER."', args=[d.arg(name='resourceType', type=d.T.string)]),
      ...
      '#withCheckerType':: d.fn(help='"The checker type to use for the check. If the monitored resource type is servicedirectory_service, checkerType must be set to VPC_CHECKERS. Possible values are: STATIC_IP_CHECKERS, VPC_CHECKERS."', args=[d.arg(name='checkerType', type=d.T.string)]),
      ...
      '#withMonitoredResource':: d.fn(help='"The monitored resource (https://cloud.google.com/monitoring/api/resources) associated with the configuration. The following monitored resource types are supported for uptime checks:  uptime_url  gce_instance  gae_app  aws_ec2_instance aws_elb_load_balancer  k8s_service  servicedirectory_service Structure is documented below."', args=[d.arg(name='monitoredResource', type=d.T.array)]),
