{
  ...
  '#':: d.pkg(name='customService', url='', help='"CustomService is the Schema for the CustomServices API. A Service is a discrete, autonomous, and network-accessible unit, designed to solve an individual concern (Wikipedia)."'),
  ...
  '#new':: d.fn(help='new returns an instance of CustomService', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CustomServiceSpec defines the desired state of CustomService"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#telemetry':: d.obj(help='"Configuration for how to query telemetry on a Service. Structure is documented below."'),
      telemetry: {
      ...
      '#withServiceId':: d.fn(help='"An optional service ID to use. If not given, the server will generate a service ID."', args=[d.arg(name='serviceId', type=d.T.string)]),
      withServiceId(serviceId): { spec+: { forProvider+: { serviceId: serviceId } } },
      '#withTelemetry':: d.fn(help='"Configuration for how to query telemetry on a Service. Structure is documented below."', args=[d.arg(name='telemetry', type=d.T.array)]),
      withTelemetry(telemetry): { spec+: { forProvider+: { telemetry: if std.isArray(v=telemetry) then telemetry else [telemetry] } } },
      '#withTelemetryMixin':: d.fn(help='"Configuration for how to query telemetry on a Service. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='telemetry', type=d.T.array)]),
      withTelemetryMixin(telemetry): { spec+: { forProvider+: { telemetry+: if std.isArray(v=telemetry) then telemetry else [telemetry] } } },
    ...
    initProvider: {
      ...
      '#withServiceId':: d.fn(help='"An optional service ID to use. If not given, the server will generate a service ID."', args=[d.arg(name='serviceId', type=d.T.string)]),
      withServiceId(serviceId): { spec+: { initProvider+: { serviceId: serviceId } } },
      '#withTelemetry':: d.fn(help='"Configuration for how to query telemetry on a Service. Structure is documented below."', args=[d.arg(name='telemetry', type=d.T.array)]),
      withTelemetry(telemetry): { spec+: { initProvider+: { telemetry: if std.isArray(v=telemetry) then telemetry else [telemetry] } } },
      '#withTelemetryMixin':: d.fn(help='"Configuration for how to query telemetry on a Service. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='telemetry', type=d.T.array)]),
      withTelemetryMixin(telemetry): { spec+: { initProvider+: { telemetry+: if std.isArray(v=telemetry) then telemetry else [telemetry] } } },
      '#withUserLabels':: d.fn(help='"Labels which have been used to annotate the service. Label keys must start with a letter. Label keys and values may contain lowercase letters, numbers, underscores, and dashes. Label keys and values have a maximum length of 63 characters, and must be less than 128 bytes in size. Up to 64 label entries may be stored. For labels which do not have a semantic value, the empty string may be supplied for the label value."', args=[d.arg(name='userLabels', type=d.T.object)]),
