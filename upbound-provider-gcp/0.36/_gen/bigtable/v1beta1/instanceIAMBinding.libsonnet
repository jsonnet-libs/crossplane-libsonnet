{
  ...
  '#':: d.pkg(name='instanceIAMBinding', url='', help='"InstanceIAMBinding is the Schema for the InstanceIAMBindings API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
