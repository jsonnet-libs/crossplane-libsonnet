{
  ...
  '#':: d.pkg(name='tableIAMPolicy', url='', help='"TableIAMPolicy is the Schema for the TableIAMPolicys API. Collection of resources to manage IAM policy for a Bigtable Table."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withInstance':: d.fn(help='"The name or relative resource id of the instance that owns the table."', args=[d.arg(name='instance', type=d.T.string)]),
      ...
      '#withProject':: d.fn(help='"The project in which the table belongs."', args=[d.arg(name='project', type=d.T.string)]),
      withProject(project): { spec+: { forProvider+: { project: project } } },
      '#withTable':: d.fn(help='"The name or relative resource id of the table to manage IAM policies for."', args=[d.arg(name='table', type=d.T.string)]),
