{
  ...
  '#':: d.pkg(name='instanceIAMPolicy', url='', help='"InstanceIAMPolicy is the Schema for the InstanceIAMPolicys API. Collection of resources to manage IAM policy for a Bigtable instance."'),
  ...
  '#new':: d.fn(help='new returns an instance of InstanceIAMPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      '#withInstance':: d.fn(help='"The name or relative resource id of the instance to manage IAM policies for."', args=[d.arg(name='instance', type=d.T.string)]),
      ...
      '#withProject':: d.fn(help='"The project in which the instance belongs."', args=[d.arg(name='project', type=d.T.string)]),
