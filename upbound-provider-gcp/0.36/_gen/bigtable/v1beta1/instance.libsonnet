{
  ...
  spec: {
    ...
    forProvider: {
      '#cluster':: d.obj(help='"A block of cluster configuration options. This can be specified at least once, and up to as many as possible within 8 cloud regions. Removing the field entirely from the config will cause the provider to default to the backend value. See structure below."'),
      cluster: {
        ...
        '#withNumNodes':: d.fn(help='"The number of nodes in your Cloud Bigtable cluster. Required, with a minimum of 1 for each cluster in an instance."', args=[d.arg(name='numNodes', type=d.T.number)]),
        ...
        '#withZone':: d.fn(help='"The zone to create the Cloud Bigtable cluster in. If it not specified, the provider zone is used. Each cluster must have a different zone in the same region. Zones that support Bigtable instances are noted on the Cloud Bigtable locations page."', args=[d.arg(name='zone', type=d.T.string)]),
        withZone(zone): { zone: zone },
      },
      '#withCluster':: d.fn(help='"A block of cluster configuration options. This can be specified at least once, and up to as many as possible within 8 cloud regions. Removing the field entirely from the config will cause the provider to default to the backend value. See structure below."', args=[d.arg(name='cluster', type=d.T.array)]),
      withCluster(cluster): { spec+: { forProvider+: { cluster: if std.isArray(v=cluster) then cluster else [cluster] } } },
      '#withClusterMixin':: d.fn(help='"A block of cluster configuration options. This can be specified at least once, and up to as many as possible within 8 cloud regions. Removing the field entirely from the config will cause the provider to default to the backend value. See structure below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cluster', type=d.T.array)]),
      ...
      '#withInstanceType':: d.fn(help='"The instance type to create. One of \\"DEVELOPMENT\\" or \\"PRODUCTION\\". Defaults to \\"PRODUCTION\\". It is recommended to leave this field unspecified since the distinction between \\"DEVELOPMENT\\" and \\"PRODUCTION\\" instances is going away, and all instances will become \\"PRODUCTION\\" instances. This means that new and existing \\"DEVELOPMENT\\" instances will be converted to \\"PRODUCTION\\" instances. It is recommended for users to use \\"PRODUCTION\\" instances in any case, since a 1-node \\"PRODUCTION\\" instance is functionally identical to a \\"DEVELOPMENT\\" instance, but without the accompanying restrictions."', args=[d.arg(name='instanceType', type=d.T.string)]),
