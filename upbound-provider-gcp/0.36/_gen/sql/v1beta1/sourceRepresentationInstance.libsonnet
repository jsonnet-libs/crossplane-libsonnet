{
  ...
  '#':: d.pkg(name='sourceRepresentationInstance', url='', help='"SourceRepresentationInstance is the Schema for the SourceRepresentationInstances API. A source representation instance is a Cloud SQL instance that represents the source database server to the Cloud SQL replica."'),
  ...
  '#new':: d.fn(help='new returns an instance of SourceRepresentationInstance', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SourceRepresentationInstanceSpec defines the desired state of SourceRepresentationInstance"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#passwordSecretRef':: d.obj(help='"The password for the replication user account. Note: This property is sensitive and will not be displayed in the plan."'),
      passwordSecretRef: {
      ...
      '#withCaCertificate':: d.fn(help='"The CA certificate on the external server. Include only if SSL/TLS is used on the external server."', args=[d.arg(name='caCertificate', type=d.T.string)]),
      withCaCertificate(caCertificate): { spec+: { forProvider+: { caCertificate: caCertificate } } },
      '#withClientCertificate':: d.fn(help='"The client certificate on the external server. Required only for server-client authentication. Include only if SSL/TLS is used on the external server."', args=[d.arg(name='clientCertificate', type=d.T.string)]),
      withClientCertificate(clientCertificate): { spec+: { forProvider+: { clientCertificate: clientCertificate } } },
      '#withClientKey':: d.fn(help='"The private key file for the client certificate on the external server. Required only for server-client authentication. Include only if SSL/TLS is used on the external server."', args=[d.arg(name='clientKey', type=d.T.string)]),
      withClientKey(clientKey): { spec+: { forProvider+: { clientKey: clientKey } } },
      '#withDatabaseVersion':: d.fn(help='"The MySQL version running on your source database server. Possible values are: MYSQL_5_6, MYSQL_5_7, MYSQL_8_0, POSTGRES_9_6, POSTGRES_10, POSTGRES_11, POSTGRES_12, POSTGRES_13, POSTGRES_14."', args=[d.arg(name='databaseVersion', type=d.T.string)]),
      withDatabaseVersion(databaseVersion): { spec+: { forProvider+: { databaseVersion: databaseVersion } } },
      '#withDumpFilePath':: d.fn(help='"A file in the bucket that contains the data from the external server."', args=[d.arg(name='dumpFilePath', type=d.T.string)]),
      withDumpFilePath(dumpFilePath): { spec+: { forProvider+: { dumpFilePath: dumpFilePath } } },
      '#withHost':: d.fn(help='"The externally accessible IPv4 address for the source database server."', args=[d.arg(name='host', type=d.T.string)]),
      withHost(host): { spec+: { forProvider+: { host: host } } },
      '#withPort':: d.fn(help='"The externally accessible port for the source database server. Defaults to 3306."', args=[d.arg(name='port', type=d.T.number)]),
      ...
      '#withRegion':: d.fn(help='"The Region in which the created instance should reside. If it is not provided, the provider region is used."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withUsername':: d.fn(help='"The replication user account on the external server."', args=[d.arg(name='username', type=d.T.string)]),
    ...
    initProvider: {
      '#withCaCertificate':: d.fn(help='"The CA certificate on the external server. Include only if SSL/TLS is used on the external server."', args=[d.arg(name='caCertificate', type=d.T.string)]),
      withCaCertificate(caCertificate): { spec+: { initProvider+: { caCertificate: caCertificate } } },
      '#withClientCertificate':: d.fn(help='"The client certificate on the external server. Required only for server-client authentication. Include only if SSL/TLS is used on the external server."', args=[d.arg(name='clientCertificate', type=d.T.string)]),
      withClientCertificate(clientCertificate): { spec+: { initProvider+: { clientCertificate: clientCertificate } } },
      '#withClientKey':: d.fn(help='"The private key file for the client certificate on the external server. Required only for server-client authentication. Include only if SSL/TLS is used on the external server."', args=[d.arg(name='clientKey', type=d.T.string)]),
      withClientKey(clientKey): { spec+: { initProvider+: { clientKey: clientKey } } },
      '#withDatabaseVersion':: d.fn(help='"The MySQL version running on your source database server. Possible values are: MYSQL_5_6, MYSQL_5_7, MYSQL_8_0, POSTGRES_9_6, POSTGRES_10, POSTGRES_11, POSTGRES_12, POSTGRES_13, POSTGRES_14."', args=[d.arg(name='databaseVersion', type=d.T.string)]),
      withDatabaseVersion(databaseVersion): { spec+: { initProvider+: { databaseVersion: databaseVersion } } },
      '#withDumpFilePath':: d.fn(help='"A file in the bucket that contains the data from the external server."', args=[d.arg(name='dumpFilePath', type=d.T.string)]),
      withDumpFilePath(dumpFilePath): { spec+: { initProvider+: { dumpFilePath: dumpFilePath } } },
      '#withHost':: d.fn(help='"The externally accessible IPv4 address for the source database server."', args=[d.arg(name='host', type=d.T.string)]),
