{
  ...
  '#':: d.pkg(name='sslCert', url='', help='"SSLCert is the Schema for the SSLCerts API. Creates a new SQL Ssl Cert in Google Cloud SQL."'),
  ...
  '#new':: d.fn(help='new returns an instance of SSLCert', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SSLCertSpec defines the desired state of SSLCert"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withCommonName':: d.fn(help='"The common name to be used in the certificate to identify the client. Constrained to [a-zA-Z.-_ ]+. Changing this forces a new resource to be created."', args=[d.arg(name='commonName', type=d.T.string)]),
      withCommonName(commonName): { spec+: { forProvider+: { commonName: commonName } } },
    ...
    initProvider: {
      '#withCommonName':: d.fn(help='"The common name to be used in the certificate to identify the client. Constrained to [a-zA-Z.-_ ]+. Changing this forces a new resource to be created."', args=[d.arg(name='commonName', type=d.T.string)]),
      withCommonName(commonName): { spec+: { initProvider+: { commonName: commonName } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
