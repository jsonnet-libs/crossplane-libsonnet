{
  ...
  '#':: d.pkg(name='database', url='', help="\"Database is the Schema for the Databases API. Represents a SQL database inside the Cloud SQL instance, hosted in Google's cloud.\""),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCharset':: d.fn(help="\"The charset value. See MySQL's Supported Character Sets and Collations and Postgres' Character Set Support for more details and supported values. Postgres databases only support a value of UTF8 at creation time.\"", args=[d.arg(name='charset', type=d.T.string)]),
      withCharset(charset): { spec+: { forProvider+: { charset: charset } } },
      '#withCollation':: d.fn(help="\"The collation value. See MySQL's Supported Character Sets and Collations and Postgres' Collation Support for more details and supported values. Postgres databases only support a value of en_US.UTF8 at creation time.\"", args=[d.arg(name='collation', type=d.T.string)]),
      withCollation(collation): { spec+: { forProvider+: { collation: collation } } },
      '#withDeletionPolicy':: d.fn(help='"The deletion policy for the database. Setting ABANDON allows the resource to be abandoned rather than deleted. This is useful for Postgres, where databases cannot be deleted from the API if there are users other than cloudsqlsuperuser with access. Possible values are: \\"ABANDON\\", \\"DELETE\\". Defaults to \\"DELETE\\"."', args=[d.arg(name='deletionPolicy', type=d.T.string)]),
      withDeletionPolicy(deletionPolicy): { spec+: { forProvider+: { deletionPolicy: deletionPolicy } } },
      '#withInstance':: d.fn(help='"The name of the Cloud SQL instance. This does not include the project ID."', args=[d.arg(name='instance', type=d.T.string)]),
    ...
    initProvider: {
      '#withCharset':: d.fn(help="\"The charset value. See MySQL's Supported Character Sets and Collations and Postgres' Character Set Support for more details and supported values. Postgres databases only support a value of UTF8 at creation time.\"", args=[d.arg(name='charset', type=d.T.string)]),
      withCharset(charset): { spec+: { initProvider+: { charset: charset } } },
      '#withCollation':: d.fn(help="\"The collation value. See MySQL's Supported Character Sets and Collations and Postgres' Collation Support for more details and supported values. Postgres databases only support a value of en_US.UTF8 at creation time.\"", args=[d.arg(name='collation', type=d.T.string)]),
