{
  ...
  '#':: d.pkg(name='secretIAMMember', url='', help='"SecretIAMMember is the Schema for the SecretIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of SecretIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#secretIdRef':: d.obj(help='"Reference to a Secret to populate secretId."'),
      secretIdRef: {
      ...
      '#secretIdSelector':: d.obj(help='"Selector for a Secret to populate secretId."'),
      secretIdSelector: {
