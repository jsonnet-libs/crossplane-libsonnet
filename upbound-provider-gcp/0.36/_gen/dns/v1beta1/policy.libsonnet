{
  ...
  '#':: d.pkg(name='policy', url='', help='"Policy is the Schema for the Policys API. A policy is a collection of DNS rules applied to one or more Virtual Private Cloud resources."'),
  ...
  spec: {
    ...
    forProvider: {
      '#alternativeNameServerConfig':: d.obj(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."'),
      alternativeNameServerConfig: {
        '#targetNameServers':: d.obj(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."'),
        targetNameServers: {
        ...
        '#withTargetNameServers':: d.fn(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."', args=[d.arg(name='targetNameServers', type=d.T.array)]),
        ...
        '#withTargetNameServersMixin':: d.fn(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetNameServers', type=d.T.array)]),
      ...
      '#networks':: d.obj(help='"List of network names specifying networks to which this policy is applied. Structure is documented below."'),
      networks: {
        '#networkRef':: d.obj(help='"Reference to a Network in compute to populate networkUrl."'),
        networkRef: {
        ...
        '#networkSelector':: d.obj(help='"Selector for a Network in compute to populate networkUrl."'),
        networkSelector: {
      ...
      '#withAlternativeNameServerConfigMixin':: d.fn(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='alternativeNameServerConfig', type=d.T.array)]),
      withAlternativeNameServerConfigMixin(alternativeNameServerConfig): { spec+: { forProvider+: { alternativeNameServerConfig+: if std.isArray(v=alternativeNameServerConfig) then alternativeNameServerConfig else [alternativeNameServerConfig] } } },
      ...
      '#withEnableInboundForwarding':: d.fn(help='"Allows networks bound to this policy to receive DNS queries sent by VMs or applications over VPN connections. When enabled, a virtual IP address will be allocated from each of the sub-networks that are bound to this policy."', args=[d.arg(name='enableInboundForwarding', type=d.T.boolean)]),
      withEnableInboundForwarding(enableInboundForwarding): { spec+: { forProvider+: { enableInboundForwarding: enableInboundForwarding } } },
      '#withEnableLogging':: d.fn(help='"Controls whether logging is enabled for the networks bound to this policy. Defaults to no logging if not set."', args=[d.arg(name='enableLogging', type=d.T.boolean)]),
      withEnableLogging(enableLogging): { spec+: { forProvider+: { enableLogging: enableLogging } } },
      '#withNetworks':: d.fn(help='"List of network names specifying networks to which this policy is applied. Structure is documented below."', args=[d.arg(name='networks', type=d.T.array)]),
      withNetworks(networks): { spec+: { forProvider+: { networks: if std.isArray(v=networks) then networks else [networks] } } },
      '#withNetworksMixin':: d.fn(help='"List of network names specifying networks to which this policy is applied. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='networks', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withAlternativeNameServerConfig':: d.fn(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."', args=[d.arg(name='alternativeNameServerConfig', type=d.T.array)]),
      withAlternativeNameServerConfig(alternativeNameServerConfig): { spec+: { initProvider+: { alternativeNameServerConfig: if std.isArray(v=alternativeNameServerConfig) then alternativeNameServerConfig else [alternativeNameServerConfig] } } },
      '#withAlternativeNameServerConfigMixin':: d.fn(help='"Sets an alternative name server for the associated networks. When specified, all DNS queries are forwarded to a name server that you choose. Names such as .internal are not available when an alternative name server is specified. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='alternativeNameServerConfig', type=d.T.array)]),
      withAlternativeNameServerConfigMixin(alternativeNameServerConfig): { spec+: { initProvider+: { alternativeNameServerConfig+: if std.isArray(v=alternativeNameServerConfig) then alternativeNameServerConfig else [alternativeNameServerConfig] } } },
      '#withDescription':: d.fn(help='"A textual description field."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withEnableInboundForwarding':: d.fn(help='"Allows networks bound to this policy to receive DNS queries sent by VMs or applications over VPN connections. When enabled, a virtual IP address will be allocated from each of the sub-networks that are bound to this policy."', args=[d.arg(name='enableInboundForwarding', type=d.T.boolean)]),
      withEnableInboundForwarding(enableInboundForwarding): { spec+: { initProvider+: { enableInboundForwarding: enableInboundForwarding } } },
      '#withEnableLogging':: d.fn(help='"Controls whether logging is enabled for the networks bound to this policy. Defaults to no logging if not set."', args=[d.arg(name='enableLogging', type=d.T.boolean)]),
