{
  ...
  '#':: d.pkg(name='managedZoneIAMMember', url='', help='"ManagedZoneIAMMember is the Schema for the ManagedZoneIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of ManagedZoneIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ManagedZoneIAMMemberSpec defines the desired state of ManagedZoneIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withManagedZone':: d.fn(help='', args=[d.arg(name='managedZone', type=d.T.string)]),
