{
  ...
  '#':: d.pkg(name='model', url='', help='"Model is the Schema for the Models API. Represents a machine learning solution."'),
  ...
  spec: {
    ...
    forProvider: {
      '#defaultVersion':: d.obj(help='"The default version of the model. This version will be used to handle prediction requests that do not specify a version. Structure is documented below."'),
      defaultVersion: {
        '#withName':: d.fn(help='"The name specified for the version when it was created."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#withDefaultVersion':: d.fn(help='"The default version of the model. This version will be used to handle prediction requests that do not specify a version. Structure is documented below."', args=[d.arg(name='defaultVersion', type=d.T.array)]),
      withDefaultVersion(defaultVersion): { spec+: { forProvider+: { defaultVersion: if std.isArray(v=defaultVersion) then defaultVersion else [defaultVersion] } } },
      '#withDefaultVersionMixin':: d.fn(help='"The default version of the model. This version will be used to handle prediction requests that do not specify a version. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultVersion', type=d.T.array)]),
      withDefaultVersionMixin(defaultVersion): { spec+: { forProvider+: { defaultVersion+: if std.isArray(v=defaultVersion) then defaultVersion else [defaultVersion] } } },
      '#withDescription':: d.fn(help='"The description specified for the model when it was created."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLabels':: d.fn(help='"One or more labels that you can add, to organize your models."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"One or more labels that you can add, to organize your models."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withName':: d.fn(help='"The name specified for the model."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withOnlinePredictionConsoleLogging':: d.fn(help='"If true, online prediction nodes send stderr and stdout streams to Stackdriver Logging"', args=[d.arg(name='onlinePredictionConsoleLogging', type=d.T.boolean)]),
      withOnlinePredictionConsoleLogging(onlinePredictionConsoleLogging): { spec+: { forProvider+: { onlinePredictionConsoleLogging: onlinePredictionConsoleLogging } } },
      '#withOnlinePredictionLogging':: d.fn(help='"If true, online prediction access logs are sent to StackDriver Logging."', args=[d.arg(name='onlinePredictionLogging', type=d.T.boolean)]),
      withOnlinePredictionLogging(onlinePredictionLogging): { spec+: { forProvider+: { onlinePredictionLogging: onlinePredictionLogging } } },
      ...
      '#withRegions':: d.fn(help='"The list of regions where the model is going to be deployed. Currently only one region per model is supported"', args=[d.arg(name='regions', type=d.T.array)]),
      withRegions(regions): { spec+: { forProvider+: { regions: if std.isArray(v=regions) then regions else [regions] } } },
      '#withRegionsMixin':: d.fn(help='"The list of regions where the model is going to be deployed. Currently only one region per model is supported"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='regions', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withDefaultVersion':: d.fn(help='"The default version of the model. This version will be used to handle prediction requests that do not specify a version. Structure is documented below."', args=[d.arg(name='defaultVersion', type=d.T.array)]),
      withDefaultVersion(defaultVersion): { spec+: { initProvider+: { defaultVersion: if std.isArray(v=defaultVersion) then defaultVersion else [defaultVersion] } } },
      '#withDefaultVersionMixin':: d.fn(help='"The default version of the model. This version will be used to handle prediction requests that do not specify a version. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultVersion', type=d.T.array)]),
      withDefaultVersionMixin(defaultVersion): { spec+: { initProvider+: { defaultVersion+: if std.isArray(v=defaultVersion) then defaultVersion else [defaultVersion] } } },
      '#withDescription':: d.fn(help='"The description specified for the model when it was created."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withOnlinePredictionConsoleLogging':: d.fn(help='"If true, online prediction nodes send stderr and stdout streams to Stackdriver Logging"', args=[d.arg(name='onlinePredictionConsoleLogging', type=d.T.boolean)]),
      withOnlinePredictionConsoleLogging(onlinePredictionConsoleLogging): { spec+: { initProvider+: { onlinePredictionConsoleLogging: onlinePredictionConsoleLogging } } },
      '#withOnlinePredictionLogging':: d.fn(help='"If true, online prediction access logs are sent to StackDriver Logging."', args=[d.arg(name='onlinePredictionLogging', type=d.T.boolean)]),
      withOnlinePredictionLogging(onlinePredictionLogging): { spec+: { initProvider+: { onlinePredictionLogging: onlinePredictionLogging } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
