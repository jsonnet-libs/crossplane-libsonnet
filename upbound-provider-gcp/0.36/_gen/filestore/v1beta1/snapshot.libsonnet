{
  ...
  '#':: d.pkg(name='snapshot', url='', help='"Snapshot is the Schema for the Snapshots API. A Google Cloud Filestore snapshot."'),
  ...
  spec: {
    ...
    forProvider: {
      '#instanceRef':: d.obj(help='"Reference to a Instance in filestore to populate instance."'),
      instanceRef: {
      ...
      '#instanceSelector':: d.obj(help='"Selector for a Instance in filestore to populate instance."'),
      instanceSelector: {
      ...
      '#withInstance':: d.fn(help='"The resource name of the filestore instance."', args=[d.arg(name='instance', type=d.T.string)]),
