{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#versionConfigs':: d.obj(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned. Structure is documented below."'),
      versionConfigs: {
      ...
      '#withParent':: d.fn(help='"The Agent to create an Environment for. Format: projects//locations//agents/."', args=[d.arg(name='parent', type=d.T.string)]),
      withParent(parent): { spec+: { forProvider+: { parent: parent } } },
      '#withVersionConfigs':: d.fn(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned. Structure is documented below."', args=[d.arg(name='versionConfigs', type=d.T.array)]),
      ...
      '#withVersionConfigsMixin':: d.fn(help='"A list of configurations for flow versions. You should include version configs for all flows that are reachable from [Start Flow][Agent.start_flow] in the agent. Otherwise, an error will be returned. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='versionConfigs', type=d.T.array)]),
