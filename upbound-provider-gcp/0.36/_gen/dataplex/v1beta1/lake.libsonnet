{
  ...
  '#':: d.pkg(name='lake', url='', help='"Lake is the Schema for the Lakes API. The Dataplex Lake resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of Lake', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"LakeSpec defines the desired state of Lake"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#metastore':: d.obj(help='"Optional. Settings to manage lake and Dataproc Metastore service instance association."'),
      metastore: {
        '#withService':: d.fn(help='"Optional. A relative reference to the Dataproc Metastore (https://cloud.google.com/dataproc-metastore/docs) service associated with the lake: projects/{project_id}/locations/{location_id}/services/{service_id}"', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { service: service },
      },
      '#withDescription':: d.fn(help='"Optional. Description of the lake."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withLabels':: d.fn(help='"Optional. User-defined labels for the lake."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Optional. User-defined labels for the lake."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      ...
      '#withMetastore':: d.fn(help='"Optional. Settings to manage lake and Dataproc Metastore service instance association."', args=[d.arg(name='metastore', type=d.T.array)]),
      withMetastore(metastore): { spec+: { forProvider+: { metastore: if std.isArray(v=metastore) then metastore else [metastore] } } },
      '#withMetastoreMixin':: d.fn(help='"Optional. Settings to manage lake and Dataproc Metastore service instance association."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metastore', type=d.T.array)]),
      withMetastoreMixin(metastore): { spec+: { forProvider+: { metastore+: if std.isArray(v=metastore) then metastore else [metastore] } } },
    ...
    initProvider: {
      ...
      '#withMetastore':: d.fn(help='"Optional. Settings to manage lake and Dataproc Metastore service instance association."', args=[d.arg(name='metastore', type=d.T.array)]),
      withMetastore(metastore): { spec+: { initProvider+: { metastore: if std.isArray(v=metastore) then metastore else [metastore] } } },
      '#withMetastoreMixin':: d.fn(help='"Optional. Settings to manage lake and Dataproc Metastore service instance association."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metastore', type=d.T.array)]),
      withMetastoreMixin(metastore): { spec+: { initProvider+: { metastore+: if std.isArray(v=metastore) then metastore else [metastore] } } },
      '#withProject':: d.fn(help='"The project for the resource"', args=[d.arg(name='project', type=d.T.string)]),
