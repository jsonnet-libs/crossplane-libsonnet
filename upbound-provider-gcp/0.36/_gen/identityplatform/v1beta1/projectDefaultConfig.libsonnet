{
  ...
  '#':: d.pkg(name='projectDefaultConfig', url='', help='"ProjectDefaultConfig is the Schema for the ProjectDefaultConfigs API. There is no persistent data associated with this resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectDefaultConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectDefaultConfigSpec defines the desired state of ProjectDefaultConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#signIn':: d.obj(help='"Configuration related to local sign in methods. Structure is documented below."'),
      signIn: {
        '#anonymous':: d.obj(help='"Configuration options related to authenticating an anonymous user. Structure is documented below."'),
        anonymous: {
        ...
        '#email':: d.obj(help='"Configuration options related to authenticating a user by their email address. Structure is documented below."'),
        email: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { enabled: enabled },
          ...
          withPasswordRequired(passwordRequired): { passwordRequired: passwordRequired },
        },
        '#phoneNumber':: d.obj(help='"Configuration options related to authenticated a user by their phone number. Structure is documented below."'),
        phoneNumber: {
          '#withEnabled':: d.fn(help='"Whether phone number auth is enabled for the project or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { enabled: enabled },
          ...
          withTestPhoneNumbers(testPhoneNumbers): { testPhoneNumbers: testPhoneNumbers },
          ...
          withTestPhoneNumbersMixin(testPhoneNumbers): { testPhoneNumbers+: testPhoneNumbers },
        },
        ...
        withAllowDuplicateEmails(allowDuplicateEmails): { allowDuplicateEmails: allowDuplicateEmails },
        '#withAnonymous':: d.fn(help='"Configuration options related to authenticating an anonymous user. Structure is documented below."', args=[d.arg(name='anonymous', type=d.T.array)]),
        withAnonymous(anonymous): { anonymous: if std.isArray(v=anonymous) then anonymous else [anonymous] },
        '#withAnonymousMixin':: d.fn(help='"Configuration options related to authenticating an anonymous user. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='anonymous', type=d.T.array)]),
        withAnonymousMixin(anonymous): { anonymous+: if std.isArray(v=anonymous) then anonymous else [anonymous] },
        '#withEmail':: d.fn(help='"Configuration options related to authenticating a user by their email address. Structure is documented below."', args=[d.arg(name='email', type=d.T.array)]),
        withEmail(email): { email: if std.isArray(v=email) then email else [email] },
        '#withEmailMixin':: d.fn(help='"Configuration options related to authenticating a user by their email address. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='email', type=d.T.array)]),
        withEmailMixin(email): { email+: if std.isArray(v=email) then email else [email] },
        '#withPhoneNumber':: d.fn(help='"Configuration options related to authenticated a user by their phone number. Structure is documented below."', args=[d.arg(name='phoneNumber', type=d.T.array)]),
        withPhoneNumber(phoneNumber): { phoneNumber: if std.isArray(v=phoneNumber) then phoneNumber else [phoneNumber] },
        '#withPhoneNumberMixin':: d.fn(help='"Configuration options related to authenticated a user by their phone number. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='phoneNumber', type=d.T.array)]),
        withPhoneNumberMixin(phoneNumber): { phoneNumber+: if std.isArray(v=phoneNumber) then phoneNumber else [phoneNumber] },
      },
      ...
      '#withSignIn':: d.fn(help='"Configuration related to local sign in methods. Structure is documented below."', args=[d.arg(name='signIn', type=d.T.array)]),
      withSignIn(signIn): { spec+: { forProvider+: { signIn: if std.isArray(v=signIn) then signIn else [signIn] } } },
      '#withSignInMixin':: d.fn(help='"Configuration related to local sign in methods. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='signIn', type=d.T.array)]),
