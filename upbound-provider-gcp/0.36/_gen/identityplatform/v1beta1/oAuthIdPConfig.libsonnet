{
  ...
  '#':: d.pkg(name='oAuthIdPConfig', url='', help='"OAuthIdPConfig is the Schema for the OAuthIdPConfigs API. OIDC IdP configuration for a Identity Toolkit project."'),
  ...
  '#new':: d.fn(help='new returns an instance of OAuthIdPConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OAuthIdPConfigSpec defines the desired state of OAuthIdPConfig"'),
  spec: {
