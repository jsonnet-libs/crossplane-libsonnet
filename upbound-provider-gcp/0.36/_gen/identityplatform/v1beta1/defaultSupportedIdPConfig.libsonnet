{
  ...
  '#':: d.pkg(name='defaultSupportedIdPConfig', url='', help='"DefaultSupportedIdPConfig is the Schema for the DefaultSupportedIdPConfigs API. Configurations options for authenticating with a the standard set of Identity Toolkit-trusted IDPs."'),
  ...
  '#new':: d.fn(help='new returns an instance of DefaultSupportedIdPConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DefaultSupportedIdPConfigSpec defines the desired state of DefaultSupportedIdPConfig"'),
  spec: {
