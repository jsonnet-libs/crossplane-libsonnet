{
  ...
  '#':: d.pkg(name='tenant', url='', help='"Tenant is the Schema for the Tenants API. Tenant configuration in a multi-tenant project."'),
  ...
  '#spec':: d.obj(help='"TenantSpec defines the desired state of Tenant"'),
  spec: {
    ...
    forProvider: {
      ...
      withAllowPasswordSignup(allowPasswordSignup): { spec+: { forProvider+: { allowPasswordSignup: allowPasswordSignup } } },
      ...
      withDisableAuth(disableAuth): { spec+: { forProvider+: { disableAuth: disableAuth } } },
      '#withDisplayName':: d.fn(help='"Human friendly display name of the tenant."', args=[d.arg(name='displayName', type=d.T.string)]),
      ...
      withEnableEmailLinkSignin(enableEmailLinkSignin): { spec+: { forProvider+: { enableEmailLinkSignin: enableEmailLinkSignin } } },
    ...
    initProvider: {
      '#withAllowPasswordSignup':: d.fn(help='"Whether to allow email/password user authentication."', args=[d.arg(name='allowPasswordSignup', type=d.T.boolean)]),
      withAllowPasswordSignup(allowPasswordSignup): { spec+: { initProvider+: { allowPasswordSignup: allowPasswordSignup } } },
      '#withDisableAuth':: d.fn(help='"Whether authentication is disabled for the tenant. If true, the users under the disabled tenant are not allowed to sign-in. Admins of the disabled tenant are not able to manage its users."', args=[d.arg(name='disableAuth', type=d.T.boolean)]),
      withDisableAuth(disableAuth): { spec+: { initProvider+: { disableAuth: disableAuth } } },
      '#withDisplayName':: d.fn(help='"Human friendly display name of the tenant."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { initProvider+: { displayName: displayName } } },
      '#withEnableEmailLinkSignin':: d.fn(help='"Whether to enable email link user authentication."', args=[d.arg(name='enableEmailLinkSignin', type=d.T.boolean)]),
      withEnableEmailLinkSignin(enableEmailLinkSignin): { spec+: { initProvider+: { enableEmailLinkSignin: enableEmailLinkSignin } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
