{
  ...
  '#':: d.pkg(name='processor', url='', help='"Processor is the Schema for the Processors API. The first-class citizen for Document AI."'),
  ...
  '#new':: d.fn(help='new returns an instance of Processor', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProcessorSpec defines the desired state of Processor"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDisplayName':: d.fn(help='"The display name. Must be unique."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withKmsKeyName':: d.fn(help='"The KMS key used for encryption/decryption in CMEK scenarios. See https://cloud.google.com/security-key-management."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
      withKmsKeyName(kmsKeyName): { spec+: { forProvider+: { kmsKeyName: kmsKeyName } } },
      '#withLocation':: d.fn(help='"The location of the resource."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of processor. For possible types see the official list"', args=[d.arg(name='type', type=d.T.string)]),
