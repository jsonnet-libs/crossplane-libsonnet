{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRoleEntity':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Object ACL documentation for more details. Omitting the field is the same as providing an empty list."', args=[d.arg(name='roleEntity', type=d.T.array)]),
      withRoleEntity(roleEntity): { spec+: { forProvider+: { roleEntity: if std.isArray(v=roleEntity) then roleEntity else [roleEntity] } } },
      '#withRoleEntityMixin':: d.fn(help='"List of role/entity pairs in the form ROLE:entity. See GCS Object ACL documentation for more details. Omitting the field is the same as providing an empty list."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='roleEntity', type=d.T.array)]),
