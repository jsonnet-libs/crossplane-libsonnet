{
  ...
  '#':: d.pkg(name='agentPool', url='', help='"AgentPool is the Schema for the AgentPools API. Represents an On-Premises Agent pool."'),
  ...
  spec: {
    ...
    forProvider: {
      '#bandwidthLimit':: d.obj(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'. Structure is documented below.\""),
      bandwidthLimit: {
        ...
        withLimitMbps(limitMbps): { limitMbps: limitMbps },
      },
      '#withBandwidthLimit':: d.fn(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'. Structure is documented below.\"", args=[d.arg(name='bandwidthLimit', type=d.T.array)]),
      withBandwidthLimit(bandwidthLimit): { spec+: { forProvider+: { bandwidthLimit: if std.isArray(v=bandwidthLimit) then bandwidthLimit else [bandwidthLimit] } } },
      '#withBandwidthLimitMixin':: d.fn(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'. Structure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='bandwidthLimit', type=d.T.array)]),
      withBandwidthLimitMixin(bandwidthLimit): { spec+: { forProvider+: { bandwidthLimit+: if std.isArray(v=bandwidthLimit) then bandwidthLimit else [bandwidthLimit] } } },
    ...
    initProvider: {
      ...
      '#withBandwidthLimit':: d.fn(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'. Structure is documented below.\"", args=[d.arg(name='bandwidthLimit', type=d.T.array)]),
      withBandwidthLimit(bandwidthLimit): { spec+: { initProvider+: { bandwidthLimit: if std.isArray(v=bandwidthLimit) then bandwidthLimit else [bandwidthLimit] } } },
      '#withBandwidthLimitMixin':: d.fn(help="\"Specifies the bandwidth limit details. If this field is unspecified, the default value is set as 'No Limit'. Structure is documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='bandwidthLimit', type=d.T.array)]),
      withBandwidthLimitMixin(bandwidthLimit): { spec+: { initProvider+: { bandwidthLimit+: if std.isArray(v=bandwidthLimit) then bandwidthLimit else [bandwidthLimit] } } },
      '#withDisplayName':: d.fn(help='"Specifies the client-specified AgentPool description."', args=[d.arg(name='displayName', type=d.T.string)]),
