{
  ...
  '#':: d.pkg(name='entryGroup', url='', help='"EntryGroup is the Schema for the EntryGroups API. An EntryGroup resource represents a logical grouping of zero or more Data Catalog Entry resources."'),
  ...
  '#new':: d.fn(help='new returns an instance of EntryGroup', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"EntryGroupSpec defines the desired state of EntryGroup"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withEntryGroupId':: d.fn(help='"The id of the entry group to create. The id must begin with a letter or underscore, contain only English letters, numbers and underscores, and be at most 64 characters."', args=[d.arg(name='entryGroupId', type=d.T.string)]),
      withEntryGroupId(entryGroupId): { spec+: { forProvider+: { entryGroupId: entryGroupId } } },
      ...
      '#withRegion':: d.fn(help='"EntryGroup location region."', args=[d.arg(name='region', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withEntryGroupId':: d.fn(help='"The id of the entry group to create. The id must begin with a letter or underscore, contain only English letters, numbers and underscores, and be at most 64 characters."', args=[d.arg(name='entryGroupId', type=d.T.string)]),
      withEntryGroupId(entryGroupId): { spec+: { initProvider+: { entryGroupId: entryGroupId } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
