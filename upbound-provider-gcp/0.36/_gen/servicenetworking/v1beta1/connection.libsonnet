{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReservedPeeringRanges':: d.fn(help='"Named IP address range(s) of PEERING type reserved for this service provider. Note that invoking this method with a different range when connection is already established will not reallocate already provisioned service producer subnetworks."', args=[d.arg(name='reservedPeeringRanges', type=d.T.array)]),
      ...
      '#withReservedPeeringRangesMixin':: d.fn(help='"Named IP address range(s) of PEERING type reserved for this service provider. Note that invoking this method with a different range when connection is already established will not reallocate already provisioned service producer subnetworks."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reservedPeeringRanges', type=d.T.array)]),
      ...
      '#withService':: d.fn(help="\"Provider peering service that is managing peering connectivity for a service provider organization. For Google services that support this functionality it is 'servicenetworking.googleapis.com'.\"", args=[d.arg(name='service', type=d.T.string)]),
