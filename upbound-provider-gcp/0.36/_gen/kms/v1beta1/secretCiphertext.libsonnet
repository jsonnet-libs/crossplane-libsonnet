{
  ...
  spec: {
    ...
    forProvider: {
      '#additionalAuthenticatedDataSecretRef':: d.obj(help='"The additional authenticated data used for integrity checks during encryption and decryption. Note: This property is sensitive and will not be displayed in the plan."'),
      ...
      '#withCryptoKey':: d.fn(help="\"The full name of the CryptoKey that will be used to encrypt the provided plaintext. Format: 'projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}/cryptoKeys/{{cryptoKey}}'\"", args=[d.arg(name='cryptoKey', type=d.T.string)]),
      withCryptoKey(cryptoKey): { spec+: { forProvider+: { cryptoKey: cryptoKey } } },
      '#withPlaintext':: d.fn(help='"The plaintext to be encrypted. Note: This property is sensitive and will not be displayed in the plan."', args=[d.arg(name='plaintext', type=d.T.string)]),
