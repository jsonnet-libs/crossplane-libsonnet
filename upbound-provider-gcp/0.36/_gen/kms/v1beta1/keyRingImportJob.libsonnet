{
  ...
  '#':: d.pkg(name='keyRingImportJob', url='', help='"KeyRingImportJob is the Schema for the KeyRingImportJobs API. A"'),
  ...
  '#new':: d.fn(help='new returns an instance of KeyRingImportJob', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"KeyRingImportJobSpec defines the desired state of KeyRingImportJob"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#keyRingRef':: d.obj(help='"Reference to a KeyRing to populate keyRing."'),
      keyRingRef: {
      ...
      '#keyRingSelector':: d.obj(help='"Selector for a KeyRing to populate keyRing."'),
      keyRingSelector: {
      ...
      '#withImportMethod':: d.fn(help='"The wrapping method to be used for incoming key material. Possible values are: RSA_OAEP_3072_SHA1_AES_256, RSA_OAEP_4096_SHA1_AES_256."', args=[d.arg(name='importMethod', type=d.T.string)]),
      withImportMethod(importMethod): { spec+: { forProvider+: { importMethod: importMethod } } },
      '#withKeyRing':: d.fn(help="\"The KeyRing that this import job belongs to. Format: 'projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}'.\"", args=[d.arg(name='keyRing', type=d.T.string)]),
      withKeyRing(keyRing): { spec+: { forProvider+: { keyRing: keyRing } } },
      '#withProtectionLevel':: d.fn(help='"The protection level of the ImportJob. This must match the protectionLevel of the versionTemplate on the CryptoKey you attempt to import into. Possible values are: SOFTWARE, HSM, EXTERNAL."', args=[d.arg(name='protectionLevel', type=d.T.string)]),
      withProtectionLevel(protectionLevel): { spec+: { forProvider+: { protectionLevel: protectionLevel } } },
    },
    ...
    initProvider: {
      '#withImportMethod':: d.fn(help='"The wrapping method to be used for incoming key material. Possible values are: RSA_OAEP_3072_SHA1_AES_256, RSA_OAEP_4096_SHA1_AES_256."', args=[d.arg(name='importMethod', type=d.T.string)]),
      withImportMethod(importMethod): { spec+: { initProvider+: { importMethod: importMethod } } },
      '#withProtectionLevel':: d.fn(help='"The protection level of the ImportJob. This must match the protectionLevel of the versionTemplate on the CryptoKey you attempt to import into. Possible values are: SOFTWARE, HSM, EXTERNAL."', args=[d.arg(name='protectionLevel', type=d.T.string)]),
      withProtectionLevel(protectionLevel): { spec+: { initProvider+: { protectionLevel: protectionLevel } } },
    },
