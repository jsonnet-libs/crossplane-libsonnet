{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#cryptoKeyIdRef':: d.obj(help='"Reference to a CryptoKey to populate cryptoKeyId."'),
      cryptoKeyIdRef: {
      ...
      '#cryptoKeyIdSelector':: d.obj(help='"Selector for a CryptoKey to populate cryptoKeyId."'),
      cryptoKeyIdSelector: {
