{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCryptoKey':: d.fn(help="\"The name of the cryptoKey associated with the CryptoKeyVersions. Format: 'projects/{{project}}/locations/{{location}}/keyRings/{{keyring}}/cryptoKeys/{{cryptoKey}}'\"", args=[d.arg(name='cryptoKey', type=d.T.string)]),
      withCryptoKey(cryptoKey): { spec+: { forProvider+: { cryptoKey: cryptoKey } } },
      '#withState':: d.fn(help='"The current state of the CryptoKeyVersion. Possible values are: PENDING_GENERATION, ENABLED, DISABLED, DESTROYED, DESTROY_SCHEDULED, PENDING_IMPORT, IMPORT_FAILED."', args=[d.arg(name='state', type=d.T.string)]),
