{
  ...
  '#':: d.pkg(name='databaseIAMMember', url='', help='"DatabaseIAMMember is the Schema for the DatabaseIAMMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of DatabaseIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DatabaseIAMMemberSpec defines the desired state of DatabaseIAMMember"'),
  spec: {
    ...
    forProvider: {
      ...
      '#databaseRef':: d.obj(help='"Reference to a Database to populate database."'),
      databaseRef: {
      ...
      '#databaseSelector':: d.obj(help='"Selector for a Database to populate database."'),
      databaseSelector: {
      ...
      '#instanceRef':: d.obj(help='"Reference to a Instance to populate instance."'),
      instanceRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#instanceSelector':: d.obj(help='"Selector for a Instance to populate instance."'),
      instanceSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
