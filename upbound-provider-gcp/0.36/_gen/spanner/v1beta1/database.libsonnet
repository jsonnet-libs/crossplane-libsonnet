{
  ...
  '#':: d.pkg(name='database', url='', help='"Database is the Schema for the Databases API. A Cloud Spanner Database which is hosted on a Spanner instance."'),
  ...
  spec: {
    ...
    forProvider: {
      '#encryptionConfig':: d.obj(help='"Encryption configuration for the database Structure is documented below."'),
      encryptionConfig: {
        '#withKmsKeyName':: d.fn(help='"Fully qualified name of the KMS key to use to encrypt this database. This key must exist in the same location as the Spanner Database."', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
        withKmsKeyName(kmsKeyName): { kmsKeyName: kmsKeyName },
      },
      '#instanceRef':: d.obj(help='"Reference to a Instance in spanner to populate instance."'),
      instanceRef: {
      ...
      '#instanceSelector':: d.obj(help='"Selector for a Instance in spanner to populate instance."'),
      instanceSelector: {
      ...
      '#withDatabaseDialect':: d.fn(help='"The dialect of the Cloud Spanner Database. If it is not provided, \\"GOOGLE_STANDARD_SQL\\" will be used. Possible values are: GOOGLE_STANDARD_SQL, POSTGRESQL."', args=[d.arg(name='databaseDialect', type=d.T.string)]),
      withDatabaseDialect(databaseDialect): { spec+: { forProvider+: { databaseDialect: databaseDialect } } },
      '#withDdl':: d.fn(help='"An optional list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created."', args=[d.arg(name='ddl', type=d.T.array)]),
      withDdl(ddl): { spec+: { forProvider+: { ddl: if std.isArray(v=ddl) then ddl else [ddl] } } },
      '#withDdlMixin':: d.fn(help='"An optional list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ddl', type=d.T.array)]),
      withDdlMixin(ddl): { spec+: { forProvider+: { ddl+: if std.isArray(v=ddl) then ddl else [ddl] } } },
      ...
      '#withEncryptionConfig':: d.fn(help='"Encryption configuration for the database Structure is documented below."', args=[d.arg(name='encryptionConfig', type=d.T.array)]),
      ...
      '#withEncryptionConfigMixin':: d.fn(help='"Encryption configuration for the database Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionConfig', type=d.T.array)]),
      ...
      '#withInstance':: d.fn(help='"The instance to create the database on."', args=[d.arg(name='instance', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withDatabaseDialect':: d.fn(help='"The dialect of the Cloud Spanner Database. If it is not provided, \\"GOOGLE_STANDARD_SQL\\" will be used. Possible values are: GOOGLE_STANDARD_SQL, POSTGRESQL."', args=[d.arg(name='databaseDialect', type=d.T.string)]),
      withDatabaseDialect(databaseDialect): { spec+: { initProvider+: { databaseDialect: databaseDialect } } },
      '#withDdl':: d.fn(help='"An optional list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created."', args=[d.arg(name='ddl', type=d.T.array)]),
      withDdl(ddl): { spec+: { initProvider+: { ddl: if std.isArray(v=ddl) then ddl else [ddl] } } },
      '#withDdlMixin':: d.fn(help='"An optional list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ddl', type=d.T.array)]),
      withDdlMixin(ddl): { spec+: { initProvider+: { ddl+: if std.isArray(v=ddl) then ddl else [ddl] } } },
      '#withDeletionProtection':: d.fn(help='', args=[d.arg(name='deletionProtection', type=d.T.boolean)]),
      ...
      '#withVersionRetentionPeriod':: d.fn(help="\"The retention period for the database. The retention period must be between 1 hour and 7 days, and can be specified in days, hours, minutes, or seconds. For example, the values 1d, 24h, 1440m, and 86400s are equivalent. Default value is 1h. If this property is used, you must avoid adding new DDL statements to ddl that update the database's version_retention_period.\"", args=[d.arg(name='versionRetentionPeriod', type=d.T.string)]),
      withVersionRetentionPeriod(versionRetentionPeriod): { spec+: { initProvider+: { versionRetentionPeriod: versionRetentionPeriod } } },
    },
