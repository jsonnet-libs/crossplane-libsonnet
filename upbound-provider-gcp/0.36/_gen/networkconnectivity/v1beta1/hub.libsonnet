{
  ...
  '#':: d.pkg(name='hub', url='', help='"Hub is the Schema for the Hubs API. The NetworkConnectivity Hub resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of Hub', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HubSpec defines the desired state of Hub"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Immutable. The name of the hub. Hub names must be unique. They use the following form: projects/{project_number}/locations/global/hubs/{hub_id}"', args=[d.arg(name='name', type=d.T.string)]),
