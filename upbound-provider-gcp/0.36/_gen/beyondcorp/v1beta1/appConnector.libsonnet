{
  ...
  '#':: d.pkg(name='appConnector', url='', help='"AppConnector is the Schema for the AppConnectors API. A BeyondCorp AppConnector resource represents an application facing component deployed proximal to and with direct access to the application instances."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppConnector', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppConnectorSpec defines the desired state of AppConnector"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#principalInfo':: d.obj(help='"Principal information about the Identity of the AppConnector. Structure is documented below."'),
      principalInfo: {
        '#serviceAccount':: d.obj(help='"ServiceAccount represents a GCP service account. Structure is documented below."'),
        serviceAccount: {
        ...
        '#withServiceAccount':: d.fn(help='"ServiceAccount represents a GCP service account. Structure is documented below."', args=[d.arg(name='serviceAccount', type=d.T.array)]),
        withServiceAccount(serviceAccount): { serviceAccount: if std.isArray(v=serviceAccount) then serviceAccount else [serviceAccount] },
        '#withServiceAccountMixin':: d.fn(help='"ServiceAccount represents a GCP service account. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAccount', type=d.T.array)]),
        withServiceAccountMixin(serviceAccount): { serviceAccount+: if std.isArray(v=serviceAccount) then serviceAccount else [serviceAccount] },
      },
      ...
      '#withPrincipalInfo':: d.fn(help='"Principal information about the Identity of the AppConnector. Structure is documented below."', args=[d.arg(name='principalInfo', type=d.T.array)]),
      withPrincipalInfo(principalInfo): { spec+: { forProvider+: { principalInfo: if std.isArray(v=principalInfo) then principalInfo else [principalInfo] } } },
      '#withPrincipalInfoMixin':: d.fn(help='"Principal information about the Identity of the AppConnector. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='principalInfo', type=d.T.array)]),
      withPrincipalInfoMixin(principalInfo): { spec+: { forProvider+: { principalInfo+: if std.isArray(v=principalInfo) then principalInfo else [principalInfo] } } },
      ...
      '#withRegion':: d.fn(help='"The region of the AppConnector."', args=[d.arg(name='region', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withPrincipalInfo':: d.fn(help='"Principal information about the Identity of the AppConnector. Structure is documented below."', args=[d.arg(name='principalInfo', type=d.T.array)]),
      withPrincipalInfo(principalInfo): { spec+: { initProvider+: { principalInfo: if std.isArray(v=principalInfo) then principalInfo else [principalInfo] } } },
      '#withPrincipalInfoMixin':: d.fn(help='"Principal information about the Identity of the AppConnector. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='principalInfo', type=d.T.array)]),
      withPrincipalInfoMixin(principalInfo): { spec+: { initProvider+: { principalInfo+: if std.isArray(v=principalInfo) then principalInfo else [principalInfo] } } },
      '#withProject':: d.fn(help='"The ID of the project in which the resource belongs. If it is not provided, the provider project is used."', args=[d.arg(name='project', type=d.T.string)]),
