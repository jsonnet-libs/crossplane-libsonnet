{
  ...
  '#':: d.pkg(name='appGateway', url='', help='"AppGateway is the Schema for the AppGateways API. A BeyondCorp AppGateway resource represents a BeyondCorp protected AppGateway to a remote application."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppGateway', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppGatewaySpec defines the desired state of AppGateway"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDisplayName':: d.fn(help='"An arbitrary user-provided name for the AppGateway."', args=[d.arg(name='displayName', type=d.T.string)]),
      withDisplayName(displayName): { spec+: { forProvider+: { displayName: displayName } } },
      '#withHostType':: d.fn(help='"The type of hosting used by the AppGateway. Default value is HOST_TYPE_UNSPECIFIED. Possible values are: HOST_TYPE_UNSPECIFIED, GCP_REGIONAL_MIG."', args=[d.arg(name='hostType', type=d.T.string)]),
      withHostType(hostType): { spec+: { forProvider+: { hostType: hostType } } },
      ...
      '#withRegion':: d.fn(help='"The region of the AppGateway."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withType':: d.fn(help='"The type of network connectivity used by the AppGateway. Default value is TYPE_UNSPECIFIED. Possible values are: TYPE_UNSPECIFIED, TCP_PROXY."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withHostType':: d.fn(help='"The type of hosting used by the AppGateway. Default value is HOST_TYPE_UNSPECIFIED. Possible values are: HOST_TYPE_UNSPECIFIED, GCP_REGIONAL_MIG."', args=[d.arg(name='hostType', type=d.T.string)]),
      withHostType(hostType): { spec+: { initProvider+: { hostType: hostType } } },
      '#withLabels':: d.fn(help='"Resource labels to represent user provided metadata."', args=[d.arg(name='labels', type=d.T.object)]),
