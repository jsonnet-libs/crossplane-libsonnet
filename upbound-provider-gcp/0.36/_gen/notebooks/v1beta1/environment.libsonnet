{
  ...
  '#':: d.pkg(name='environment', url='', help='"Environment is the Schema for the Environments API. A Cloud AI Platform Notebook environment."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPostStartupScript':: d.fn(help='"Path to a Bash script that automatically runs after a notebook instance fully boots up. The path must be a URL or Cloud Storage path. Example: \\"gs://path-to-file/file-name\\', args=[d.arg(name='postStartupScript', type=d.T.string)]),
