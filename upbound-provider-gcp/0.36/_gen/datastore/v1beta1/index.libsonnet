{
  ...
  '#':: d.pkg(name='index', url='', help='"Index is the Schema for the Indexs API. Describes a composite index for Cloud Datastore."'),
  ...
  spec: {
    ...
    forProvider: {
      '#properties':: d.obj(help='"An ordered list of properties to index on. Structure is documented below."'),
      properties: {
        '#withDirection':: d.fn(help='"The direction the index should optimize for sorting. Possible values are: ASCENDING, DESCENDING."', args=[d.arg(name='direction', type=d.T.string)]),
        withDirection(direction): { direction: direction },
        '#withName':: d.fn(help='"The property name to index."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#withAncestor':: d.fn(help='"Policy for including ancestors in the index. Default value is NONE. Possible values are: NONE, ALL_ANCESTORS."', args=[d.arg(name='ancestor', type=d.T.string)]),
      withAncestor(ancestor): { spec+: { forProvider+: { ancestor: ancestor } } },
      '#withKind':: d.fn(help='"The entity kind which the index applies to."', args=[d.arg(name='kind', type=d.T.string)]),
      ...
      '#withProperties':: d.fn(help='"An ordered list of properties to index on. Structure is documented below."', args=[d.arg(name='properties', type=d.T.array)]),
      withProperties(properties): { spec+: { forProvider+: { properties: if std.isArray(v=properties) then properties else [properties] } } },
      '#withPropertiesMixin':: d.fn(help='"An ordered list of properties to index on. Structure is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='properties', type=d.T.array)]),
    ...
    initProvider: {
      ...
      '#withAncestor':: d.fn(help='"Policy for including ancestors in the index. Default value is NONE. Possible values are: NONE, ALL_ANCESTORS."', args=[d.arg(name='ancestor', type=d.T.string)]),
      withAncestor(ancestor): { spec+: { initProvider+: { ancestor: ancestor } } },
      '#withKind':: d.fn(help='"The entity kind which the index applies to."', args=[d.arg(name='kind', type=d.T.string)]),
