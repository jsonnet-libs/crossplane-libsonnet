{
  ...
  spec: {
    '#credentials':: d.obj(help='"Credentials used to connect to the Kubernetes API. Typically a\\nkubeconfig file. Use InjectedIdentity for in-cluster config."'),
    credentials: {
