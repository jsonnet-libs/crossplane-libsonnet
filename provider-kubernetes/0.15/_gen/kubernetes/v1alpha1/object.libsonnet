{
  ...
  spec: {
    ...
    '#providerRef':: d.obj(help='"ProviderReference specifies the provider that will be used to create,\\nobserve, update, and delete this managed resource.\\nDeprecated: Please use ProviderConfigReference, i.e. `providerConfigRef`"'),
    providerRef: {
      '#policy':: d.obj(help='"Policies for referencing."'),
      policy: {
        '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required.\\nThe default is 'Required', which means the reconcile will fail if the\\nreference cannot be resolved. 'Optional' means this reference will be\\na no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
    ...
    '#withManagementPolicy':: d.fn(help='"A ManagementPolicy determines what should happen to the underlying external\\nresource when a managed resource is created, updated, deleted, or observed."', args=[d.arg(name='managementPolicy', type=d.T.string)]),
