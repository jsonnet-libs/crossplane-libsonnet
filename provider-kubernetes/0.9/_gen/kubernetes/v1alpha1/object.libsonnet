{
  ...
  spec: {
    ...
    '#readiness':: d.obj(help="\"Readiness defines how the object's readiness condition should be computed, if not specified it will be considered ready as soon as the underlying external resource is considered up-to-date.\""),
    readiness: {
    ...
    references: {
      '#dependsOn':: d.obj(help='"DependsOn is used to declare dependency on other Object or arbitrary Kubernetes resource."'),
      dependsOn: {
      ...
      '#patchesFrom':: d.obj(help='"PatchesFrom is used to declare dependency on other Object or arbitrary Kubernetes resource, and also patch fields from this object."'),
      patchesFrom: {
        '#withApiVersion':: d.fn(help='"APIVersion of the referenced object."', args=[d.arg(name='apiVersion', type=d.T.string)]),
        withApiVersion(apiVersion): { patchesFrom+: { apiVersion: apiVersion } },
        '#withFieldPath':: d.fn(help='"FieldPath is the path of the field on the resource whose value is to be used as input."', args=[d.arg(name='fieldPath', type=d.T.string)]),
      ...
      '#withToFieldPath':: d.fn(help="\"ToFieldPath is the path of the field on the resource whose value will be changed with the result of transforms. Leave empty if you'd like to propagate to the same path as patchesFrom.fieldPath.\"", args=[d.arg(name='toFieldPath', type=d.T.string)]),
