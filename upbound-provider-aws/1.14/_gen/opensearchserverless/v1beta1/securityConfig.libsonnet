{
  ...
  spec: {
    ...
    forProvider: {
      ...
      samlOptions: {
        '#withGroupAttribute':: d.fn(help='"Group attribute for this SAML integration."', args=[d.arg(name='groupAttribute', type=d.T.string)]),
        withGroupAttribute(groupAttribute): { spec+: { forProvider+: { samlOptions+: { groupAttribute: groupAttribute } } } },
        '#withMetadata':: d.fn(help='"The XML IdP metadata file generated from your identity provider."', args=[d.arg(name='metadata', type=d.T.string)]),
        withMetadata(metadata): { spec+: { forProvider+: { samlOptions+: { metadata: metadata } } } },
        '#withSessionTimeout':: d.fn(help='"Session timeout, in minutes. Minimum is 5 minutes and maximum is 720 minutes (12 hours). Default is 60 minutes."', args=[d.arg(name='sessionTimeout', type=d.T.number)]),
        withSessionTimeout(sessionTimeout): { spec+: { forProvider+: { samlOptions+: { sessionTimeout: sessionTimeout } } } },
        '#withUserAttribute':: d.fn(help='"User attribute for this SAML integration."', args=[d.arg(name='userAttribute', type=d.T.string)]),
        withUserAttribute(userAttribute): { spec+: { forProvider+: { samlOptions+: { userAttribute: userAttribute } } } },
      },
      '#withDescription':: d.fn(help='"Description of the security configuration."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of configuration. Must be saml."', args=[d.arg(name='type', type=d.T.string)]),
