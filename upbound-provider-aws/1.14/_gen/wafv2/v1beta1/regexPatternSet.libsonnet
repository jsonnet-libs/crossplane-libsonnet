{
  ...
  spec: {
    ...
    forProvider: {
      '#regularExpression':: d.obj(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details. A maximum of 10 regular_expression blocks may be specified."'),
      regularExpression: {
      ...
      '#withName':: d.fn(help='"A friendly name of the regular expression pattern set."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRegularExpression':: d.fn(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details. A maximum of 10 regular_expression blocks may be specified."', args=[d.arg(name='regularExpression', type=d.T.array)]),
      ...
      '#withRegularExpressionMixin':: d.fn(help='"One or more blocks of regular expression patterns that you want AWS WAF to search for, such as B[a@]dB[o0]t. See Regular Expression below for details. A maximum of 10 regular_expression blocks may be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='regularExpression', type=d.T.array)]),
