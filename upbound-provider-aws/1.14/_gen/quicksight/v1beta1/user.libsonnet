{
  ...
  spec: {
    ...
    forProvider: {
      '#withAwsAccountId':: d.fn(help='"The ID for the AWS account that the user is in. Currently, you use the ID for the AWS account that contains your Amazon QuickSight account."', args=[d.arg(name='awsAccountId', type=d.T.string)]),
      withAwsAccountId(awsAccountId): { spec+: { forProvider+: { awsAccountId: awsAccountId } } },
      '#withEmail':: d.fn(help='"The email address of the user that you want to register."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withIamArn':: d.fn(help='"The ARN of the IAM user or role that you are registering with Amazon QuickSight."', args=[d.arg(name='iamArn', type=d.T.string)]),
      withIamArn(iamArn): { spec+: { forProvider+: { iamArn: iamArn } } },
      '#withIdentityType':: d.fn(help='"Amazon QuickSight supports several ways of managing the identity of users. This parameter accepts either  IAM or QUICKSIGHT. If IAM is specified, the iam_arn must also be specified."', args=[d.arg(name='identityType', type=d.T.string)]),
      ...
      '#withSessionName':: d.fn(help='"The name of the IAM session to use when assuming roles that can embed QuickSight dashboards. Only valid for registering users using an assumed IAM role. Additionally, if registering multiple users using the same IAM role, each user needs to have a unique session name."', args=[d.arg(name='sessionName', type=d.T.string)]),
      withSessionName(sessionName): { spec+: { forProvider+: { sessionName: sessionName } } },
      '#withUserName':: d.fn(help='"The Amazon QuickSight user name that you want to create for the user you are registering. Only valid for registering a user with identity_type set to QUICKSIGHT."', args=[d.arg(name='userName', type=d.T.string)]),
      withUserName(userName): { spec+: { forProvider+: { userName: userName } } },
      '#withUserRole':: d.fn(help='"The Amazon QuickSight role of the user. The user role can be one of the following: READER, AUTHOR, or ADMIN"', args=[d.arg(name='userRole', type=d.T.string)]),
