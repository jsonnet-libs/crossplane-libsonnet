{
  ...
  '#':: d.pkg(name='notebookInstanceLifecycleConfiguration', url='', help='"NotebookInstanceLifecycleConfiguration is the Schema for the NotebookInstanceLifecycleConfigurations API. Provides a lifecycle configuration for SageMaker Notebook Instances."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withOnCreate':: d.fn(help='"A shell script (base64-encoded) that runs only once when the SageMaker Notebook Instance is created."', args=[d.arg(name='onCreate', type=d.T.string)]),
      withOnCreate(onCreate): { spec+: { forProvider+: { onCreate: onCreate } } },
      '#withOnStart':: d.fn(help="\"A shell script (base64-encoded) that runs every time the SageMaker Notebook Instance is started including the time it's created.\"", args=[d.arg(name='onStart', type=d.T.string)]),
