{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSharedAccounts':: d.fn(help='"List of AWS Account ids to share snapshot with, use all to make snaphot public."', args=[d.arg(name='sharedAccounts', type=d.T.array)]),
      ...
      '#withSharedAccountsMixin':: d.fn(help='"List of AWS Account ids to share snapshot with, use all to make snaphot public."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sharedAccounts', type=d.T.array)]),
