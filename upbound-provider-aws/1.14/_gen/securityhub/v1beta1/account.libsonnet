{
  ...
  '#':: d.pkg(name='account', url='', help='"Account is the Schema for the Accounts API. Enables Security Hub for an AWS account."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAutoEnableControls':: d.fn(help='"Whether to automatically enable new controls when they are added to standards that are enabled. By default, this is set to true, and new controls are enabled automatically. To not automatically enable new controls, set this to false."', args=[d.arg(name='autoEnableControls', type=d.T.boolean)]),
      withAutoEnableControls(autoEnableControls): { spec+: { forProvider+: { autoEnableControls: autoEnableControls } } },
      '#withControlFindingGenerator':: d.fn(help='"Updates whether the calling account has consolidated control findings turned on. If the value for this field is set to SECURITY_CONTROL, Security Hub generates a single finding for a control check even when the check applies to multiple enabled standards. If the value for this field is set to STANDARD_CONTROL, Security Hub generates separate findings for a control check when the check applies to multiple enabled standards. For accounts that are part of an organization, this value can only be updated in the administrator account."', args=[d.arg(name='controlFindingGenerator', type=d.T.string)]),
      withControlFindingGenerator(controlFindingGenerator): { spec+: { forProvider+: { controlFindingGenerator: controlFindingGenerator } } },
      '#withEnableDefaultStandards':: d.fn(help='"Whether to enable the security standards that Security Hub has designated as automatically enabled including:  AWS Foundational Security Best Practices v1.0.0 and CIS AWS Foundations Benchmark v1.2.0. Defaults to true."', args=[d.arg(name='enableDefaultStandards', type=d.T.boolean)]),
      withEnableDefaultStandards(enableDefaultStandards): { spec+: { forProvider+: { enableDefaultStandards: enableDefaultStandards } } },
    ...
    initProvider: {
      '#withAutoEnableControls':: d.fn(help='"Whether to automatically enable new controls when they are added to standards that are enabled. By default, this is set to true, and new controls are enabled automatically. To not automatically enable new controls, set this to false."', args=[d.arg(name='autoEnableControls', type=d.T.boolean)]),
      withAutoEnableControls(autoEnableControls): { spec+: { initProvider+: { autoEnableControls: autoEnableControls } } },
      '#withControlFindingGenerator':: d.fn(help='"Updates whether the calling account has consolidated control findings turned on. If the value for this field is set to SECURITY_CONTROL, Security Hub generates a single finding for a control check even when the check applies to multiple enabled standards. If the value for this field is set to STANDARD_CONTROL, Security Hub generates separate findings for a control check when the check applies to multiple enabled standards. For accounts that are part of an organization, this value can only be updated in the administrator account."', args=[d.arg(name='controlFindingGenerator', type=d.T.string)]),
      withControlFindingGenerator(controlFindingGenerator): { spec+: { initProvider+: { controlFindingGenerator: controlFindingGenerator } } },
      '#withEnableDefaultStandards':: d.fn(help='"Whether to enable the security standards that Security Hub has designated as automatically enabled including:  AWS Foundational Security Best Practices v1.0.0 and CIS AWS Foundations Benchmark v1.2.0. Defaults to true."', args=[d.arg(name='enableDefaultStandards', type=d.T.boolean)]),
      withEnableDefaultStandards(enableDefaultStandards): { spec+: { initProvider+: { enableDefaultStandards: enableDefaultStandards } } },
    },
