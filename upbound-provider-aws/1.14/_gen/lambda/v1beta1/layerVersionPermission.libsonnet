{
  ...
  '#':: d.pkg(name='layerVersionPermission', url='', help='"LayerVersionPermission is the Schema for the LayerVersionPermissions API. Provides a Lambda Layer Version Permission resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAction':: d.fn(help='"Action, which will be allowed. lambda:GetLayerVersion value is suggested by AWS documantation."', args=[d.arg(name='action', type=d.T.string)]),
      withAction(action): { spec+: { forProvider+: { action: action } } },
      '#withLayerName':: d.fn(help='"The name or ARN of the Lambda Layer, which you want to grant access to."', args=[d.arg(name='layerName', type=d.T.string)]),
      withLayerName(layerName): { spec+: { forProvider+: { layerName: layerName } } },
      '#withOrganizationId':: d.fn(help='"An identifier of AWS Organization, which should be able to use your Lambda Layer. principal should be equal to * if organization_id provided."', args=[d.arg(name='organizationId', type=d.T.string)]),
      withOrganizationId(organizationId): { spec+: { forProvider+: { organizationId: organizationId } } },
      '#withPrincipal':: d.fn(help='"AWS account ID which should be able to use your Lambda Layer. * can be used here, if you want to share your Lambda Layer widely."', args=[d.arg(name='principal', type=d.T.string)]),
      ...
      '#withStatementId':: d.fn(help='"The name of Lambda Layer Permission, for example dev-account - human readable note about what is this permission for."', args=[d.arg(name='statementId', type=d.T.string)]),
      withStatementId(statementId): { spec+: { forProvider+: { statementId: statementId } } },
      '#withVersionNumber':: d.fn(help='"Version of Lambda Layer, which you want to grant access to. Note: permissions only apply to a single version of a layer."', args=[d.arg(name='versionNumber', type=d.T.number)]),
