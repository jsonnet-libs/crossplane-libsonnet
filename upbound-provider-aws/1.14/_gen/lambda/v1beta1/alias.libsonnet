{
  ...
  '#':: d.pkg(name='alias', url='', help='"Alias is the Schema for the Aliass API. Creates a Lambda function alias."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#routingConfig':: d.obj(help="\"The Lambda alias' route configuration settings. Fields documented below\""),
      routingConfig: {
        '#withAdditionalVersionWeights':: d.fn(help='"A map that defines the proportion of events that should be sent to different versions of a lambda function."', args=[d.arg(name='additionalVersionWeights', type=d.T.object)]),
        withAdditionalVersionWeights(additionalVersionWeights): { additionalVersionWeights: additionalVersionWeights },
        '#withAdditionalVersionWeightsMixin':: d.fn(help='"A map that defines the proportion of events that should be sent to different versions of a lambda function."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalVersionWeights', type=d.T.object)]),
      ...
      '#withFunctionName':: d.fn(help='"Lambda Function name or ARN."', args=[d.arg(name='functionName', type=d.T.string)]),
      ...
      '#withRoutingConfig':: d.fn(help="\"The Lambda alias' route configuration settings. Fields documented below\"", args=[d.arg(name='routingConfig', type=d.T.array)]),
      ...
      '#withRoutingConfigMixin':: d.fn(help="\"The Lambda alias' route configuration settings. Fields documented below\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='routingConfig', type=d.T.array)]),
