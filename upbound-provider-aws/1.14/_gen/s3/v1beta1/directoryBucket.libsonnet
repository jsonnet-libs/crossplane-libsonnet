{
  ...
  spec: {
    ...
    forProvider: {
      ...
      location: {
        '#withName':: d.fn(help='"Availability Zone ID."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withType':: d.fn(help='"Location type. Valid values: AvailabilityZone."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withDataRedundancy':: d.fn(help='"Data redundancy. Valid values: SingleAvailabilityZone."', args=[d.arg(name='dataRedundancy', type=d.T.string)]),
