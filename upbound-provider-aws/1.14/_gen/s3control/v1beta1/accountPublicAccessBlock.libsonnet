{
  ...
  '#':: d.pkg(name='accountPublicAccessBlock', url='', help='"AccountPublicAccessBlock is the Schema for the AccountPublicAccessBlocks API. Manages S3 account-level Public Access Block Configuration"'),
  ...
  '#new':: d.fn(help='new returns an instance of AccountPublicAccessBlock', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AccountPublicAccessBlockSpec defines the desired state of AccountPublicAccessBlock"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAccountId':: d.fn(help='"AWS account ID to configure."', args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withBlockPublicAcls':: d.fn(help='"Whether Amazon S3 should block public ACLs for buckets in this account. Defaults to false. Enabling this setting does not affect existing policies or ACLs. When set to true causes the following behavior:"', args=[d.arg(name='blockPublicAcls', type=d.T.boolean)]),
      withBlockPublicAcls(blockPublicAcls): { spec+: { forProvider+: { blockPublicAcls: blockPublicAcls } } },
      '#withBlockPublicPolicy':: d.fn(help='"Whether Amazon S3 should block public bucket policies for buckets in this account. Defaults to false. Enabling this setting does not affect existing bucket policies. When set to true causes Amazon S3 to:"', args=[d.arg(name='blockPublicPolicy', type=d.T.boolean)]),
      withBlockPublicPolicy(blockPublicPolicy): { spec+: { forProvider+: { blockPublicPolicy: blockPublicPolicy } } },
      '#withIgnorePublicAcls':: d.fn(help="\"Whether Amazon S3 should ignore public ACLs for buckets in this account. Defaults to false. Enabling this setting does not affect the persistence of any existing ACLs and doesn't prevent new public ACLs from being set. When set to true causes Amazon S3 to:\"", args=[d.arg(name='ignorePublicAcls', type=d.T.boolean)]),
