{
  ...
  spec: {
    ...
    forProvider: {
      '#canarySettings':: d.obj(help='"Input configuration for the canary deployment when the deployment is a canary release deployment. See `canary_settings below."'),
      canarySettings: {
        '#withPercentTraffic':: d.fn(help='"Percentage (0.0-100.0) of traffic routed to the canary deployment."', args=[d.arg(name='percentTraffic', type=d.T.number)]),
        withPercentTraffic(percentTraffic): { spec+: { forProvider+: { canarySettings+: { percentTraffic: percentTraffic } } } },
        '#withStageVariableOverrides':: d.fn(help='"Stage variable overrides used for the canary release deployment. They can override existing stage variables or add new stage variables for the canary release deployment. These stage variables are represented as a string-to-string map between stage variable names and their values."', args=[d.arg(name='stageVariableOverrides', type=d.T.object)]),
        ...
        '#withUseStageCache':: d.fn(help='"Boolean flag to indicate whether the canary release deployment uses the stage cache or not."', args=[d.arg(name='useStageCache', type=d.T.boolean)]),
      ...
      '#withStageDescription':: d.fn(help='"Description to set on the stage managed by the stage_name argument."', args=[d.arg(name='stageDescription', type=d.T.string)]),
      withStageDescription(stageDescription): { spec+: { forProvider+: { stageDescription: stageDescription } } },
      '#withStageName':: d.fn(help='"Name of the stage to create with this deployment. If the specified stage already exists, it will be updated to point to the new deployment. We recommend using the aws_api_gateway_stage resource instead to manage stages."', args=[d.arg(name='stageName', type=d.T.string)]),
      ...
      '#withVariables':: d.fn(help='"Map to set on the stage managed by the stage_name argument."', args=[d.arg(name='variables', type=d.T.object)]),
      withVariables(variables): { spec+: { forProvider+: { variables: variables } } },
      '#withVariablesMixin':: d.fn(help='"Map to set on the stage managed by the stage_name argument."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.object)]),
    ...
    initProvider: {
      ...
      '#withStageDescription':: d.fn(help='"Description to set on the stage managed by the stage_name argument."', args=[d.arg(name='stageDescription', type=d.T.string)]),
      withStageDescription(stageDescription): { spec+: { initProvider+: { stageDescription: stageDescription } } },
      '#withStageName':: d.fn(help='"Name of the stage to create with this deployment. If the specified stage already exists, it will be updated to point to the new deployment. We recommend using the aws_api_gateway_stage resource instead to manage stages."', args=[d.arg(name='stageName', type=d.T.string)]),
