{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllocationId':: d.fn(help='"The allocation ID. This is required for EC2-VPC."', args=[d.arg(name='allocationId', type=d.T.string)]),
      withAllocationId(allocationId): { spec+: { forProvider+: { allocationId: allocationId } } },
      '#withAllowReassociation':: d.fn(help='"Whether to allow an Elastic IP to\\nbe re-associated. Defaults to true in VPC."', args=[d.arg(name='allowReassociation', type=d.T.boolean)]),
      withAllowReassociation(allowReassociation): { spec+: { forProvider+: { allowReassociation: allowReassociation } } },
      '#withInstanceId':: d.fn(help='"The ID of the instance. This is required for\\nEC2-Classic. For EC2-VPC, you can specify either the instance ID or the\\nnetwork interface ID, but not both. The operation fails if you specify an\\ninstance ID unless exactly one network interface is attached."', args=[d.arg(name='instanceId', type=d.T.string)]),
      withInstanceId(instanceId): { spec+: { forProvider+: { instanceId: instanceId } } },
      '#withNetworkInterfaceId':: d.fn(help='"The ID of the network interface. If the\\ninstance has more than one network interface, you must specify a network\\ninterface ID."', args=[d.arg(name='networkInterfaceId', type=d.T.string)]),
      withNetworkInterfaceId(networkInterfaceId): { spec+: { forProvider+: { networkInterfaceId: networkInterfaceId } } },
      '#withPrivateIpAddress':: d.fn(help='"The primary or secondary private IP address\\nto associate with the Elastic IP address. If no private IP address is\\nspecified, the Elastic IP address is associated with the primary private IP\\naddress."', args=[d.arg(name='privateIpAddress', type=d.T.string)]),
      withPrivateIpAddress(privateIpAddress): { spec+: { forProvider+: { privateIpAddress: privateIpAddress } } },
      '#withPublicIp':: d.fn(help='"The Elastic IP address. This is required for EC2-Classic."', args=[d.arg(name='publicIp', type=d.T.string)]),
