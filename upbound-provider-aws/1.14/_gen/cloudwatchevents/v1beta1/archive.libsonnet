{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the new event archive."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEventPattern':: d.fn(help='"Instructs the new event archive to only capture events matched by this pattern. By default, it attempts to archive every event received in the event_source_arn."', args=[d.arg(name='eventPattern', type=d.T.string)]),
      withEventPattern(eventPattern): { spec+: { forProvider+: { eventPattern: eventPattern } } },
      '#withEventSourceArn':: d.fn(help='"Event bus source ARN from where these events should be archived."', args=[d.arg(name='eventSourceArn', type=d.T.string)]),
