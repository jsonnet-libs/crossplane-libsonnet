  ...
  spec: {
    ...
    forProvider: {
      ...
      loggingConfiguration: {
        '#logDestinationConfig':: d.obj(help='"Set of configuration blocks describing the logging details for a firewall. See Log Destination Config below for details. At most, only two blocks can be specified; one for FLOW logs and one for ALERT logs."'),
        logDestinationConfig: {
          ...
          '#withLogType':: d.fn(help='"The type of log to send. Valid values: ALERT or FLOW. Alert logs report traffic that matches a StatefulRule with an action setting that sends a log message. Flow logs are standard network traffic flow logs."', args=[d.arg(name='logType', type=d.T.string)]),
          withLogType(logType): { logType: logType },
        },
        '#withLogDestinationConfig':: d.fn(help='"Set of configuration blocks describing the logging details for a firewall. See Log Destination Config below for details. At most, only two blocks can be specified; one for FLOW logs and one for ALERT logs."', args=[d.arg(name='logDestinationConfig', type=d.T.array)]),
        ...
        '#withLogDestinationConfigMixin':: d.fn(help='"Set of configuration blocks describing the logging details for a firewall. See Log Destination Config below for details. At most, only two blocks can be specified; one for FLOW logs and one for ALERT logs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='logDestinationConfig', type=d.T.array)]),
