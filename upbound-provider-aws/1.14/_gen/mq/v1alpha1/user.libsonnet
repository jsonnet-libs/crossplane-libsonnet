{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConsoleAccess':: d.fn(help='"Setting consoleAccess will result in an update loop till the MQ Broker to which this user belongs is restarted."', args=[d.arg(name='consoleAccess', type=d.T.boolean)]),
      ...
      '#withReplicationUser':: d.fn(help='', args=[d.arg(name='replicationUser', type=d.T.boolean)]),
