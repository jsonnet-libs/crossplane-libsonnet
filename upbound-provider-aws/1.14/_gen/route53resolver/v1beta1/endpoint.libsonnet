{
  ...
  spec: {
    ...
    forProvider: {
      '#ipAddress':: d.obj(help='"The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."'),
      ipAddress: {
        ...
        '#withIp':: d.fn(help='"The IP address in the subnet that you want to use for DNS queries."', args=[d.arg(name='ip', type=d.T.string)]),
        withIp(ip): { ip: ip },
        '#withSubnetId':: d.fn(help='"The ID of the subnet that contains the IP address."', args=[d.arg(name='subnetId', type=d.T.string)]),
      ...
      '#withDirection':: d.fn(help='"The direction of DNS queries to or from the Route 53 Resolver endpoint.\\nValid values are INBOUND (resolver forwards DNS queries to the DNS service for a VPC from your network or another VPC)\\nor OUTBOUND (resolver forwards DNS queries from the DNS service for a VPC to your network or another VPC)."', args=[d.arg(name='direction', type=d.T.string)]),
      withDirection(direction): { spec+: { forProvider+: { direction: direction } } },
      '#withIpAddress':: d.fn(help='"The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddress(ipAddress): { spec+: { forProvider+: { ipAddress: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withIpAddressMixin':: d.fn(help='"The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs\\nto your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddressMixin(ipAddress): { spec+: { forProvider+: { ipAddress+: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withName':: d.fn(help='"The friendly name of the Route 53 Resolver endpoint."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withProtocols':: d.fn(help='"The protocols you want to use for the Route 53 Resolver endpoint. Valid values: DoH, Do53, DoH-FIPS."', args=[d.arg(name='protocols', type=d.T.array)]),
      withProtocols(protocols): { spec+: { forProvider+: { protocols: if std.isArray(v=protocols) then protocols else [protocols] } } },
      '#withProtocolsMixin':: d.fn(help='"The protocols you want to use for the Route 53 Resolver endpoint. Valid values: DoH, Do53, DoH-FIPS."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='protocols', type=d.T.array)]),
      ...
      '#withResolverEndpointType':: d.fn(help='"The Route 53 Resolver endpoint IP address type. Valid values: IPV4, IPV6, DUALSTACK."', args=[d.arg(name='resolverEndpointType', type=d.T.string)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"The ID of one or more security groups that you want to use to control access to this VPC."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSecurityGroupIdsMixin':: d.fn(help='"The ID of one or more security groups that you want to use to control access to this VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
