{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withImageTagMutability':: d.fn(help='"The tag mutability setting for the repository. Must be one of: MUTABLE or IMMUTABLE. Defaults to MUTABLE."', args=[d.arg(name='imageTagMutability', type=d.T.string)]),
