{
  ...
  spec: {
    ...
    forProvider: {
      '#parameter':: d.obj(help='"A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via aws rds describe-db-parameters after initial creation of the group."'),
      parameter: {
        '#withApplyMethod':: d.fn(help="\"\\\"immediate\\\" (default), or \\\"pending-reboot\\\". Some engines can't apply some parameters without a reboot, and you will need to specify \\\"pending-reboot\\\" here.\"", args=[d.arg(name='applyMethod', type=d.T.string)]),
        withApplyMethod(applyMethod): { applyMethod: applyMethod },
        '#withName':: d.fn(help='"The name of the DB parameter group."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withParameter':: d.fn(help='"A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via aws rds describe-db-parameters after initial creation of the group."', args=[d.arg(name='parameter', type=d.T.array)]),
      withParameter(parameter): { spec+: { forProvider+: { parameter: if std.isArray(v=parameter) then parameter else [parameter] } } },
      '#withParameterMixin':: d.fn(help='"A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via aws rds describe-db-parameters after initial creation of the group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameter', type=d.T.array)]),
