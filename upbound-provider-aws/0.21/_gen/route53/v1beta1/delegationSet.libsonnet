{
  ...
  spec: {
    ...
    forProvider: {
      '#withReferenceName':: d.fn(help='"This is a reference name used in Caller Reference (helpful for identifying single delegation set amongst others)"', args=[d.arg(name='referenceName', type=d.T.string)]),
