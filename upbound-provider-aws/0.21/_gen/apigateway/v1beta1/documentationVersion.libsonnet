{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the API documentation version."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withVersion':: d.fn(help='"The version identifier of the API documentation snapshot."', args=[d.arg(name='version', type=d.T.string)]),
