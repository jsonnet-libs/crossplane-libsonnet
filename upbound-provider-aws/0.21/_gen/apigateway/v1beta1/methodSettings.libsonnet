{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#settings':: d.obj(help='"The settings block, see below."'),
      settings: {
        '#withCacheDataEncrypted':: d.fn(help='"Specifies whether the cached responses are encrypted."', args=[d.arg(name='cacheDataEncrypted', type=d.T.boolean)]),
        withCacheDataEncrypted(cacheDataEncrypted): { cacheDataEncrypted: cacheDataEncrypted },
        '#withCacheTtlInSeconds':: d.fn(help='"Specifies the time to live (TTL), in seconds, for cached responses. The higher the TTL, the longer the response will be cached."', args=[d.arg(name='cacheTtlInSeconds', type=d.T.number)]),
        withCacheTtlInSeconds(cacheTtlInSeconds): { cacheTtlInSeconds: cacheTtlInSeconds },
        '#withCachingEnabled':: d.fn(help='"Specifies whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached."', args=[d.arg(name='cachingEnabled', type=d.T.boolean)]),
        withCachingEnabled(cachingEnabled): { cachingEnabled: cachingEnabled },
        '#withDataTraceEnabled':: d.fn(help='"Specifies whether data trace logging is enabled for this method, which effects the log entries pushed to Amazon CloudWatch Logs."', args=[d.arg(name='dataTraceEnabled', type=d.T.boolean)]),
        withDataTraceEnabled(dataTraceEnabled): { dataTraceEnabled: dataTraceEnabled },
        '#withLoggingLevel':: d.fn(help='"Specifies the logging level for this method, which effects the log entries pushed to Amazon CloudWatch Logs. The available levels are OFF, ERROR, and INFO."', args=[d.arg(name='loggingLevel', type=d.T.string)]),
        withLoggingLevel(loggingLevel): { loggingLevel: loggingLevel },
        '#withMetricsEnabled':: d.fn(help='"Specifies whether Amazon CloudWatch metrics are enabled for this method."', args=[d.arg(name='metricsEnabled', type=d.T.boolean)]),
        withMetricsEnabled(metricsEnabled): { metricsEnabled: metricsEnabled },
        '#withRequireAuthorizationForCacheControl':: d.fn(help='"Specifies whether authorization is required for a cache invalidation request."', args=[d.arg(name='requireAuthorizationForCacheControl', type=d.T.boolean)]),
        ...
        '#withThrottlingBurstLimit':: d.fn(help='"Specifies the throttling burst limit. Default: -1 (throttling disabled)."', args=[d.arg(name='throttlingBurstLimit', type=d.T.number)]),
        withThrottlingBurstLimit(throttlingBurstLimit): { throttlingBurstLimit: throttlingBurstLimit },
        '#withThrottlingRateLimit':: d.fn(help='"Specifies the throttling rate limit. Default: -1 (throttling disabled)."', args=[d.arg(name='throttlingRateLimit', type=d.T.number)]),
        withThrottlingRateLimit(throttlingRateLimit): { throttlingRateLimit: throttlingRateLimit },
        '#withUnauthorizedCacheControlHeaderStrategy':: d.fn(help='"Specifies how to handle unauthorized requests for cache invalidation. The available values are FAIL_WITH_403, SUCCEED_WITH_RESPONSE_HEADER, SUCCEED_WITHOUT_RESPONSE_HEADER."', args=[d.arg(name='unauthorizedCacheControlHeaderStrategy', type=d.T.string)]),
