{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStageName':: d.fn(help='"Name of the stage to create with this deployment. If the specified stage already exists, it will be updated to point to the new deployment. It is recommended to use the aws_api_gateway_stage resource instead to manage stages."', args=[d.arg(name='stageName', type=d.T.string)]),
