{
  ...
  spec: {
    ...
    forProvider: {
      '#itemRefs':: d.obj(help='"References to PublicKey to populate items."'),
      itemRefs: {
      ...
      '#itemSelector':: d.obj(help='"Selector for a list of PublicKey to populate items."'),
      itemSelector: {
