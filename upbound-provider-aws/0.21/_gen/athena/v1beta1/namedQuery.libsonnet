{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDatabase':: d.fn(help='"The database to which the query belongs."', args=[d.arg(name='database', type=d.T.string)]),
      withDatabase(database): { spec+: { forProvider+: { database: database } } },
      '#withDescription':: d.fn(help='"A brief explanation of the query. Maximum length of 1024."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The plain language name for the query. Maximum length of 128."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withQuery':: d.fn(help='"The text of the query itself. In other words, all query statements. Maximum length of 262144."', args=[d.arg(name='query', type=d.T.string)]),
      ...
      '#withWorkgroup':: d.fn(help='"The workgroup to which the query belongs. Defaults to primary"', args=[d.arg(name='workgroup', type=d.T.string)]),
