{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPgpKey':: d.fn(help='"Either a base-64 encoded PGP public key, or a keybase username in the form keybase:some_person_that_exists, for use in the encrypted_secret output attribute."', args=[d.arg(name='pgpKey', type=d.T.string)]),
