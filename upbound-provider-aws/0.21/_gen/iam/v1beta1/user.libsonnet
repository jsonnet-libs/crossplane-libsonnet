{
  ...
  spec: {
    ...
    forProvider: {
      '#withForceDestroy':: d.fn(help='"when destroying this user, destroy even if it has non-Upbound official provider-managed iam access keys, login profile or mfa devices. without force_destroy a user with non-Upbound official provider-managed access keys and login profile will fail to be destroyed. delete user even if it has non-Upbound official provider-managed iam access keys, login profile or mfa devices"', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
