{
  ...
  spec: {
    ...
    forProvider: {
      '#clusterNameRef':: d.obj(help='"Reference to a Cluster to populate clusterName. Either ClusterName, ClusterNameRef or ClusterNameSelector has to be given."'),
      clusterNameRef: {
      ...
      '#clusterNameSelector':: d.obj(help='"Selector for a Cluster to populate clusterName. Either ClusterName, ClusterNameRef or ClusterNameSelector has to be given."'),
      clusterNameSelector: {
      ...
      '#withClusterName':: d.fn(help="\"ClusterName is the name of the cluster you'd like to fetch Kubeconfig of. Either ClusterName, ClusterNameRef or ClusterNameSelector has to be given.\"", args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { forProvider+: { clusterName: clusterName } } },
      '#withRefreshPeriod':: d.fn(help="\"RefreshPeriod is how frequently you'd like the token in the published Kubeconfig to be refreshed. The maximum is 10m0s. The default is 10m0s.\"", args=[d.arg(name='refreshPeriod', type=d.T.string)]),
