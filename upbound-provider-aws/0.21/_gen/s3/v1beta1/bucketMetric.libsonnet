{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBucket':: d.fn(help='"The name of the bucket to put metric configuration."', args=[d.arg(name='bucket', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"Unique identifier of the metrics configuration for the bucket."', args=[d.arg(name='name', type=d.T.string)]),
