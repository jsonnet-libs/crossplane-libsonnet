{
  ...
  spec: {
    ...
    forProvider: {
      '#withForceDestroy':: d.fn(help='"A boolean that indicates all objects (including any locked objects) should be deleted from the bucket so that the bucket can be destroyed without error. These objects are not recoverable."', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
      withForceDestroy(forceDestroy): { spec+: { forProvider+: { forceDestroy: forceDestroy } } },
      '#withHostedZoneId':: d.fn(help="\"The Route 53 Hosted Zone ID for this bucket's region.\"", args=[d.arg(name='hostedZoneId', type=d.T.string)]),
      withHostedZoneId(hostedZoneId): { spec+: { forProvider+: { hostedZoneId: hostedZoneId } } },
      '#withObjectLockEnabled':: d.fn(help='"Indicates whether this bucket has an Object Lock configuration enabled. Valid values are true or false."', args=[d.arg(name='objectLockEnabled', type=d.T.boolean)]),
      withObjectLockEnabled(objectLockEnabled): { spec+: { forProvider+: { objectLockEnabled: objectLockEnabled } } },
      '#withRegion':: d.fn(help="\"The AWS region this bucket resides in. Region is the region you'd like your resource to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
