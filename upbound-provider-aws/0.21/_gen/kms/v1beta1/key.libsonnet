{
  ...
  spec: {
    ...
    forProvider: {
      '#withBypassPolicyLockoutSafetyCheck':: d.fn(help='"A flag to indicate whether to bypass the key policy lockout safety check. Setting this value to true increases the risk that the KMS key becomes unmanageable. Do not set this value to true indiscriminately. For more information, refer to the scenario in the Default Key Policy section in the AWS Key Management Service Developer Guide. The default value is false."', args=[d.arg(name='bypassPolicyLockoutSafetyCheck', type=d.T.boolean)]),
      ...
      '#withCustomerMasterKeySpec':: d.fn(help='"Specifies whether the key contains a symmetric key or an asymmetric key pair and the encryption algorithms or signing algorithms that the key supports. Valid values: SYMMETRIC_DEFAULT,  RSA_2048, RSA_3072, RSA_4096, HMAC_256, ECC_NIST_P256, ECC_NIST_P384, ECC_NIST_P521, or ECC_SECG_P256K1. Defaults to SYMMETRIC_DEFAULT. For help with choosing a key spec, see the AWS KMS Developer Guide."', args=[d.arg(name='customerMasterKeySpec', type=d.T.string)]),
      withCustomerMasterKeySpec(customerMasterKeySpec): { spec+: { forProvider+: { customerMasterKeySpec: customerMasterKeySpec } } },
      '#withDeletionWindowInDays':: d.fn(help='"The waiting period, specified in number of days. After the waiting period ends, AWS KMS deletes the KMS key. If you specify a value, it must be between 7 and 30, inclusive. If you do not specify a value, it defaults to 30. If the KMS key is a multi-Region primary key with replicas, the waiting period begins when the last of its replica keys is deleted. Otherwise, the waiting period begins immediately."', args=[d.arg(name='deletionWindowInDays', type=d.T.number)]),
      ...
      '#withKeyUsage':: d.fn(help='"Specifies the intended use of the key. Valid values: ENCRYPT_DECRYPT or SIGN_VERIFY. Defaults to ENCRYPT_DECRYPT."', args=[d.arg(name='keyUsage', type=d.T.string)]),
