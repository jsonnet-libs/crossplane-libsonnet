{
  ...
  '#':: d.pkg(name='replicaExternalKey', url='', help='"ReplicaExternalKey is the Schema for the ReplicaExternalKeys API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#keyMaterialBase64SecretRef':: d.obj(help='"A SecretKeySelector is a reference to a secret key in an arbitrary namespace."'),
      ...
      '#withBypassPolicyLockoutSafetyCheck':: d.fn(help='', args=[d.arg(name='bypassPolicyLockoutSafetyCheck', type=d.T.boolean)]),
      ...
      '#withDeletionWindowInDays':: d.fn(help='', args=[d.arg(name='deletionWindowInDays', type=d.T.number)]),
      ...
      '#withPrimaryKeyArn':: d.fn(help='', args=[d.arg(name='primaryKeyArn', type=d.T.string)]),
      ...
      '#withValidTo':: d.fn(help='', args=[d.arg(name='validTo', type=d.T.string)]),
