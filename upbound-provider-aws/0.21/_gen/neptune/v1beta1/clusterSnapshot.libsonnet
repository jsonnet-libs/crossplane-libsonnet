{
  ...
  spec: {
    ...
    forProvider: {
      '#dbClusterIdentifierRef':: d.obj(help='"Reference to a Cluster to populate dbClusterIdentifier."'),
      ...
      '#dbClusterIdentifierSelector':: d.obj(help='"Selector for a Cluster to populate dbClusterIdentifier."'),
