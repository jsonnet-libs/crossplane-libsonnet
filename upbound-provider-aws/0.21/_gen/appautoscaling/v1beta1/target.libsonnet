{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMaxCapacity':: d.fn(help='"The max capacity of the scalable target."', args=[d.arg(name='maxCapacity', type=d.T.number)]),
      withMaxCapacity(maxCapacity): { spec+: { forProvider+: { maxCapacity: maxCapacity } } },
      '#withMinCapacity':: d.fn(help='"The min capacity of the scalable target."', args=[d.arg(name='minCapacity', type=d.T.number)]),
      ...
      '#withRoleArn':: d.fn(help='"The ARN of the IAM role that allows Application AutoScaling to modify your scalable target on your behalf. This defaults to an IAM Service-Linked Role for most services and custom IAM Roles are ignored by the API for those namespaces. See the AWS Application Auto Scaling documentation for more information about how this service interacts with IAM."', args=[d.arg(name='roleArn', type=d.T.string)]),
