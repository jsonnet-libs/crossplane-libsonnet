{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#certificatePemSecretRef':: d.obj(help='"The certificate to be registered. If ca_pem is unspecified, review RegisterCertificateWithoutCA. If ca_pem is specified, review RegisterCertificate for more information on registering a certificate."'),
      ...
      '#withCsr':: d.fn(help='"The certificate signing request. Review CreateCertificateFromCsr for more information on generating a certificate from a certificate signing request (CSR). If none is specified both the certificate and keys will be generated, review CreateKeysAndCertificate for more information on generating keys and a certificate."', args=[d.arg(name='csr', type=d.T.string)]),
