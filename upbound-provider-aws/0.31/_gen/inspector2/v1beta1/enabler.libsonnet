{
  ...
  spec: {
    ...
    forProvider: {
      '#withAccountIds':: d.fn(help='"Set of account IDs."', args=[d.arg(name='accountIds', type=d.T.array)]),
      ...
      '#withResourceTypes':: d.fn(help='"Type of resources to scan. Valid values are EC2, ECR, and LAMBDA."', args=[d.arg(name='resourceTypes', type=d.T.array)]),
