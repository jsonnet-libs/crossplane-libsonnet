{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeleteProtection':: d.fn(help='"A boolean flag indicating whether it is possible to delete the firewall. Defaults to false."', args=[d.arg(name='deleteProtection', type=d.T.boolean)]),
      ...
      '#withFirewallPolicyChangeProtection':: d.fn(help='"(Option) A boolean flag indicating whether it is possible to change the associated firewall policy. Defaults to false."', args=[d.arg(name='firewallPolicyChangeProtection', type=d.T.boolean)]),
      ...
      '#withSubnetChangeProtection':: d.fn(help='"A boolean flag indicating whether it is possible to change the associated subnet(s). Defaults to false."', args=[d.arg(name='subnetChangeProtection', type=d.T.boolean)]),
