{
  ...
  spec: {
    ...
    forProvider: {
      '#portfolioIdRef':: d.obj(help='"Reference to a Portfolio to populate portfolioId."'),
      portfolioIdRef: {
      ...
      '#portfolioIdSelector':: d.obj(help='"Selector for a Portfolio to populate portfolioId."'),
      portfolioIdSelector: {
      ...
      '#withPrincipalType':: d.fn(help='"Principal type. Setting this argument empty (e.g., principal_type = \\"\\") will result in an error. Valid value is IAM. Default is IAM."', args=[d.arg(name='principalType', type=d.T.string)]),
