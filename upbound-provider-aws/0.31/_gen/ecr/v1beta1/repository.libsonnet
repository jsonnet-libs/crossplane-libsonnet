{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withForceDelete':: d.fn(help='"If true, will delete the repository even if it contains images. Defaults to false."', args=[d.arg(name='forceDelete', type=d.T.boolean)]),
