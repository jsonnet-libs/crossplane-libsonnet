{
  ...
  '#':: d.pkg(name='managedPrefixListEntry', url='', help='"ManagedPrefixListEntry is the Schema for the ManagedPrefixListEntrys API. Provides a managed prefix list entry resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"Description of this entry. Due to API limitations, updating only the description of an entry requires recreating the entry."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withPrefixListId':: d.fn(help='"CIDR block of this entry."', args=[d.arg(name='prefixListId', type=d.T.string)]),
