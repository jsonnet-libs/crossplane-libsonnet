{
  ...
  spec: {
    ...
    forProvider: {
      '#withPartitionCount':: d.fn(help='"The number of partitions to create in the placement group.  Can only be specified when the strategy is set to \\"partition\\".  Valid values are 1 - 7 (default is 2)."', args=[d.arg(name='partitionCount', type=d.T.number)]),
      ...
      '#withSpreadLevel':: d.fn(help='"Determines how placement groups spread instances. Can only be used when the strategy is set to \\"spread\\". Can be \\"host\\" or \\"rack\\". \\"host\\" can only be used for Outpost placement groups."', args=[d.arg(name='spreadLevel', type=d.T.string)]),
