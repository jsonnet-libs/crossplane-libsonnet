{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllocationId':: d.fn(help='"The Allocation ID of the Elastic IP address for the gateway. Required for connectivity_type of public."', args=[d.arg(name='allocationId', type=d.T.string)]),
      withAllocationId(allocationId): { spec+: { forProvider+: { allocationId: allocationId } } },
      '#withConnectivityType':: d.fn(help='"Connectivity type for the gateway. Valid values are private and public. Defaults to public."', args=[d.arg(name='connectivityType', type=d.T.string)]),
      ...
      '#withSubnetId':: d.fn(help='"The Subnet ID of the subnet in which to place the gateway."', args=[d.arg(name='subnetId', type=d.T.string)]),
