{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPrivateDnsEnabled':: d.fn(help='"Whether or not to associate a private hosted zone with the specified VPC. Applicable for endpoints of type Interface. Defaults to false."', args=[d.arg(name='privateDnsEnabled', type=d.T.boolean)]),
