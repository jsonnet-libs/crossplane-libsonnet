{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#networkInterfaceRef':: d.obj(help='"Reference to a NetworkInterface to populate networkInterface."'),
      networkInterfaceRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#networkInterfaceSelector':: d.obj(help='"Selector for a NetworkInterface to populate networkInterface."'),
      ...
      '#withPublicIpv4Pool':: d.fn(help='"EC2 IPv4 address pool identifier or amazon. This option is only available for VPC EIPs."', args=[d.arg(name='publicIpv4Pool', type=d.T.string)]),
      ...
      '#withVpc':: d.fn(help='"Boolean if the EIP is in a VPC or not. Defaults to true unless the region supports EC2-Classic."', args=[d.arg(name='vpc', type=d.T.boolean)]),
