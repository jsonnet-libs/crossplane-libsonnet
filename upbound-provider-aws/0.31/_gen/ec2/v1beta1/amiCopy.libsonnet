{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDestinationOutpostArn':: d.fn(help='"ARN of the Outpost to which to copy the AMI. Only specify this parameter when copying an AMI from an AWS Region to an Outpost. The AMI must be in the Region of the destination Outpost."', args=[d.arg(name='destinationOutpostArn', type=d.T.string)]),
      ...
      '#withSourceAmiId':: d.fn(help='"Id of the AMI to copy. This id must be valid in the region given by source_ami_region."', args=[d.arg(name='sourceAmiId', type=d.T.string)]),
      withSourceAmiId(sourceAmiId): { spec+: { forProvider+: { sourceAmiId: sourceAmiId } } },
      '#withSourceAmiRegion':: d.fn(help='"Region from which the AMI will be copied. This may be the same as the AWS provider region in order to create a copy within the same region."', args=[d.arg(name='sourceAmiRegion', type=d.T.string)]),
