{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowReassociation':: d.fn(help='"Whether to allow an Elastic IP to be re-associated. Defaults to true in VPC."', args=[d.arg(name='allowReassociation', type=d.T.boolean)]),
      withAllowReassociation(allowReassociation): { spec+: { forProvider+: { allowReassociation: allowReassociation } } },
      '#withInstanceId':: d.fn(help='"The ID of the instance. This is required for EC2-Classic. For EC2-VPC, you can specify either the instance ID or the network interface ID, but not both. The operation fails if you specify an instance ID unless exactly one network interface is attached."', args=[d.arg(name='instanceId', type=d.T.string)]),
      withInstanceId(instanceId): { spec+: { forProvider+: { instanceId: instanceId } } },
      '#withNetworkInterfaceId':: d.fn(help='"The ID of the network interface. If the instance has more than one network interface, you must specify a network interface ID."', args=[d.arg(name='networkInterfaceId', type=d.T.string)]),
      withNetworkInterfaceId(networkInterfaceId): { spec+: { forProvider+: { networkInterfaceId: networkInterfaceId } } },
      '#withPrivateIpAddress':: d.fn(help='"The primary or secondary private IP address to associate with the Elastic IP address. If no private IP address is specified, the Elastic IP address is associated with the primary private IP address."', args=[d.arg(name='privateIpAddress', type=d.T.string)]),
