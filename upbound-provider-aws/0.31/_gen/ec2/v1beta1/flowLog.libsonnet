{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLogFormat':: d.fn(help='"The fields to include in the flow log record, in the order in which they should appear."', args=[d.arg(name='logFormat', type=d.T.string)]),
