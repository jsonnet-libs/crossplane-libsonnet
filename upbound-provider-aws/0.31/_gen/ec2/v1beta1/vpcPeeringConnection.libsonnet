{
  ...
  spec: {
    ...
    forProvider: {
      '#peerVpcIdRef':: d.obj(help='"Reference to a VPC to populate peerVpcId."'),
      peerVpcIdRef: {
      ...
      '#peerVpcIdSelector':: d.obj(help='"Selector for a VPC to populate peerVpcId."'),
      peerVpcIdSelector: {
      ...
      '#withPeerOwnerId':: d.fn(help='"The AWS account ID of the owner of the peer VPC. Defaults to the account ID the AWS provider is currently connected to."', args=[d.arg(name='peerOwnerId', type=d.T.string)]),
      withPeerOwnerId(peerOwnerId): { spec+: { forProvider+: { peerOwnerId: peerOwnerId } } },
      '#withPeerRegion':: d.fn(help='"The region of the accepter VPC of the VPC Peering Connection. auto_accept must be false, and use the aws_vpc_peering_connection_accepter to manage the accepter side."', args=[d.arg(name='peerRegion', type=d.T.string)]),
      withPeerRegion(peerRegion): { spec+: { forProvider+: { peerRegion: peerRegion } } },
      '#withPeerVpcId':: d.fn(help='"The ID of the VPC with which you are creating the VPC Peering Connection."', args=[d.arg(name='peerVpcId', type=d.T.string)]),
