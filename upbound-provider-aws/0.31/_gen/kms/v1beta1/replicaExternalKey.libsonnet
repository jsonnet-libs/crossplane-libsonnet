{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#primaryKeyArnRef':: d.obj(help='"Reference to a ExternalKey to populate primaryKeyArn."'),
      primaryKeyArnRef: {
      ...
      '#primaryKeyArnSelector':: d.obj(help='"Selector for a ExternalKey to populate primaryKeyArn."'),
