{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventBusName':: d.fn(help='"The event bus to associate with this rule. If you omit this, the default event bus is used."', args=[d.arg(name='eventBusName', type=d.T.string)]),
      withEventBusName(eventBusName): { spec+: { forProvider+: { eventBusName: eventBusName } } },
      '#withEventPattern':: d.fn(help='"The event pattern described a JSON object. At least one of schedule_expression or event_pattern is required. See full documentation of Events and Event Patterns in EventBridge for details."', args=[d.arg(name='eventPattern', type=d.T.string)]),
      withEventPattern(eventPattern): { spec+: { forProvider+: { eventPattern: eventPattern } } },
      '#withIsEnabled':: d.fn(help='"Whether the rule should be enabled (defaults to true)."', args=[d.arg(name='isEnabled', type=d.T.boolean)]),
