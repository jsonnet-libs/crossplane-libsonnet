{
  ...
  '#':: d.pkg(name='servicecatalogPortfolioStatus', url='', help='"ServicecatalogPortfolioStatus is the Schema for the ServicecatalogPortfolioStatuss API. Manages status of Service Catalog in SageMaker. Service Catalog is used to create SageMaker projects."'),
  ...
  '#new':: d.fn(help='new returns an instance of ServicecatalogPortfolioStatus', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServicecatalogPortfolioStatusSpec defines the desired state of ServicecatalogPortfolioStatus"'),
  spec: {
