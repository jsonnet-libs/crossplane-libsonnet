{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"A name to identify the stream. This is unique to the AWS account and region the Stream is created in."', args=[d.arg(name='name', type=d.T.string)]),
