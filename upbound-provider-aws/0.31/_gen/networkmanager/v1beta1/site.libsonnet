{
  ...
  '#':: d.pkg(name='site', url='', help='"Site is the Schema for the Sites API. Creates a site in a global network."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#location':: d.obj(help='"The site location as documented below."'),
      location: {
      ...
      '#withGlobalNetworkId':: d.fn(help='"The ID of the Global Network to create the site in."', args=[d.arg(name='globalNetworkId', type=d.T.string)]),
      withGlobalNetworkId(globalNetworkId): { spec+: { forProvider+: { globalNetworkId: globalNetworkId } } },
      '#withLocation':: d.fn(help='"The site location as documented below."', args=[d.arg(name='location', type=d.T.array)]),
      withLocation(location): { spec+: { forProvider+: { location: if std.isArray(v=location) then location else [location] } } },
      '#withLocationMixin':: d.fn(help='"The site location as documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='location', type=d.T.array)]),
