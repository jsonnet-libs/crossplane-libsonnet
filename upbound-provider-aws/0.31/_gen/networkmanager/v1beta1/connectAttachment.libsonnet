{
  ...
  '#':: d.pkg(name='connectAttachment', url='', help='"ConnectAttachment is the Schema for the ConnectAttachments API."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#options':: d.obj(help='"Options for creating an attachment."'),
      options: {
      ...
      '#withCoreNetworkId':: d.fn(help='"The ID of a core network where you want to create the attachment."', args=[d.arg(name='coreNetworkId', type=d.T.string)]),
      withCoreNetworkId(coreNetworkId): { spec+: { forProvider+: { coreNetworkId: coreNetworkId } } },
      '#withEdgeLocation':: d.fn(help='"The Region where the edge is located."', args=[d.arg(name='edgeLocation', type=d.T.string)]),
      withEdgeLocation(edgeLocation): { spec+: { forProvider+: { edgeLocation: edgeLocation } } },
      '#withOptions':: d.fn(help='"Options for creating an attachment."', args=[d.arg(name='options', type=d.T.array)]),
      withOptions(options): { spec+: { forProvider+: { options: if std.isArray(v=options) then options else [options] } } },
      '#withOptionsMixin':: d.fn(help='"Options for creating an attachment."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='options', type=d.T.array)]),
      ...
      '#withTransportAttachmentId':: d.fn(help='"The ID of the attachment between the two connections."', args=[d.arg(name='transportAttachmentId', type=d.T.string)]),
