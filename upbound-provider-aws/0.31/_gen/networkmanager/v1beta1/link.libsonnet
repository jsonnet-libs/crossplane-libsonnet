{
  ...
  '#':: d.pkg(name='link', url='', help='"Link is the Schema for the Links API. Creates a link for a site."'),
  ...
  spec: {
    ...
    forProvider: {
      '#bandwidth':: d.obj(help='"The upload speed and download speed in Mbps. Documented below."'),
      bandwidth: {
      ...
      '#siteIdRef':: d.obj(help='"Reference to a Site to populate siteId."'),
      siteIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#siteIdSelector':: d.obj(help='"Selector for a Site to populate siteId."'),
      siteIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withProviderName':: d.fn(help='"The provider of the link."', args=[d.arg(name='providerName', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of the link."', args=[d.arg(name='type', type=d.T.string)]),
