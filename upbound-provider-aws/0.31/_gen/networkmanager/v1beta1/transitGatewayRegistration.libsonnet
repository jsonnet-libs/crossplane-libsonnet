{
  ...
  '#':: d.pkg(name='transitGatewayRegistration', url='', help='"TransitGatewayRegistration is the Schema for the TransitGatewayRegistrations API. Registers a transit gateway to a global network."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withGlobalNetworkId':: d.fn(help='"The ID of the Global Network to register to."', args=[d.arg(name='globalNetworkId', type=d.T.string)]),
      ...
      '#withTransitGatewayArn':: d.fn(help='"The ARN of the Transit Gateway to register."', args=[d.arg(name='transitGatewayArn', type=d.T.string)]),
