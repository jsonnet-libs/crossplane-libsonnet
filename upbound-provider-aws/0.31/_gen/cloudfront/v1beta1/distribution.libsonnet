    ...
    forProvider: {
      ...
      origin: {
        ...
        customOriginConfig: {
          ...
          '#withOriginSslProtocols':: d.fn(help='"SSL/TLS protocols that you want CloudFront to use when communicating with your origin over HTTPS. A list of one or more of SSLv3, TLSv1, TLSv1.1, and TLSv1.2."', args=[d.arg(name='originSslProtocols', type=d.T.array)]),
          ...
          '#withOriginSslProtocolsMixin':: d.fn(help='"SSL/TLS protocols that you want CloudFront to use when communicating with your origin over HTTPS. A list of one or more of SSLv3, TLSv1, TLSv1.1, and TLSv1.2."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='originSslProtocols', type=d.T.array)]),
      ...
      viewerCertificate: {
        ...
        '#withSslSupportMethod':: d.fn(help='"How you want CloudFront to serve HTTPS requests. One of vip or sni-only. Required if you specify acm_certificate_arn or iam_certificate_id. NOTE: vip causes CloudFront to use a dedicated IP address and may incur extra charges."', args=[d.arg(name='sslSupportMethod', type=d.T.string)]),
