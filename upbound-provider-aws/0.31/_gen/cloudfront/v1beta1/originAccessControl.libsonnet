{
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"The description of the Origin Access Control. It may be empty."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withOriginAccessControlOriginType':: d.fn(help='"The type of origin that this Origin Access Control is for. The only valid value is s3."', args=[d.arg(name='originAccessControlOriginType', type=d.T.string)]),
      ...
      '#withSigningBehavior':: d.fn(help='"Specifies which requests CloudFront signs. Specify always for the most common use case. Allowed values: always, never, no-override."', args=[d.arg(name='signingBehavior', type=d.T.string)]),
      withSigningBehavior(signingBehavior): { spec+: { forProvider+: { signingBehavior: signingBehavior } } },
      '#withSigningProtocol':: d.fn(help='"Determines how CloudFront signs (authenticates) requests. Valid values: sigv4."', args=[d.arg(name='signingProtocol', type=d.T.string)]),
