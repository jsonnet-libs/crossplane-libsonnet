{
  ...
  '#':: d.pkg(name='account', url='', help='"Account is the Schema for the Accounts API. Provides a resource to manage Amazon Macie on an AWS Account."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withFindingPublishingFrequency':: d.fn(help='"Specifies how often to publish updates to policy findings for the account. This includes publishing updates to AWS Security Hub and Amazon EventBridge (formerly called Amazon CloudWatch Events). Valid values are FIFTEEN_MINUTES, ONE_HOUR or SIX_HOURS."', args=[d.arg(name='findingPublishingFrequency', type=d.T.string)]),
