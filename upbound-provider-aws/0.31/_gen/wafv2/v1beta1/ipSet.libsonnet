{
  ...
  spec: {
    ...
    forProvider: {
      '#withAddresses':: d.fn(help='"Contains an array of strings that specify one or more IP addresses or blocks of IP addresses in Classless Inter-Domain Routing (CIDR) notation. AWS WAF supports all address ranges for IP versions IPv4 and IPv6."', args=[d.arg(name='addresses', type=d.T.array)]),
      withAddresses(addresses): { spec+: { forProvider+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } },
      '#withAddressesMixin':: d.fn(help='"Contains an array of strings that specify one or more IP addresses or blocks of IP addresses in Classless Inter-Domain Routing (CIDR) notation. AWS WAF supports all address ranges for IP versions IPv4 and IPv6."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addresses', type=d.T.array)]),
      ...
      '#withName':: d.fn(help='"A friendly name of the IP set."', args=[d.arg(name='name', type=d.T.string)]),
