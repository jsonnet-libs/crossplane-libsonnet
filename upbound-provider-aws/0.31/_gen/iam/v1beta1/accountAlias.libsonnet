{
  ...
  '#':: d.pkg(name='accountAlias', url='', help='"AccountAlias is the Schema for the AccountAliass API. Manages the account alias for the AWS Account."'),
  ...
  '#new':: d.fn(help='new returns an instance of AccountAlias', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AccountAliasSpec defines the desired state of AccountAlias"'),
  spec: {
    ...
    '#withForProvider':: d.fn(help='', args=[d.arg(name='forProvider', type=d.T.object)]),
    withForProvider(forProvider): { spec+: { forProvider: forProvider } },
    '#withForProviderMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='forProvider', type=d.T.object)]),
    withForProviderMixin(forProvider): { spec+: { forProvider+: forProvider } },
