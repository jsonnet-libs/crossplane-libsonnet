{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTemplateArn':: d.fn(help='"Template to use when issuing a certificate. See ACM PCA Documentation for more information."', args=[d.arg(name='templateArn', type=d.T.string)]),
