  ...
  spec: {
    ...
    forProvider: {
      ...
      replica: {
        ...
        '#withPropagateTags':: d.fn(help="\"Whether to propagate the global table's tags to a replica. Default is false. Changes to tags only move in one direction: from global (source) to replica. In other words, tag drift on a replica will not trigger an update. Tag or replica changes on the global table, whether from drift or configuration changes, are propagated to replicas. Changing from true to false on a subsequent apply means replica tags are left as they were, unmanaged, not deleted.\"", args=[d.arg(name='propagateTags', type=d.T.boolean)]),
      ...
      '#serverSideEncryption':: d.obj(help="\"Encryption at rest options. AWS DynamoDB tables are automatically encrypted at rest with an AWS-owned Customer Master Key if this argument isn't specified. See below.\""),
      ...
      ttl: {
        '#withAttributeName':: d.fn(help='"Name of the table attribute to store the TTL timestamp in."', args=[d.arg(name='attributeName', type=d.T.string)]),
        withAttributeName(attributeName): { attributeName: attributeName },
        '#withEnabled':: d.fn(help='"Whether TTL is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { enabled: enabled },
      },
      ...
      '#withServerSideEncryption':: d.fn(help="\"Encryption at rest options. AWS DynamoDB tables are automatically encrypted at rest with an AWS-owned Customer Master Key if this argument isn't specified. See below.\"", args=[d.arg(name='serverSideEncryption', type=d.T.array)]),
      ...
      '#withServerSideEncryptionMixin':: d.fn(help="\"Encryption at rest options. AWS DynamoDB tables are automatically encrypted at rest with an AWS-owned Customer Master Key if this argument isn't specified. See below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='serverSideEncryption', type=d.T.array)]),
      ...
      '#withTableClass':: d.fn(help='"Storage class of the table. Valid values are STANDARD and STANDARD_INFREQUENT_ACCESS."', args=[d.arg(name='tableClass', type=d.T.string)]),
