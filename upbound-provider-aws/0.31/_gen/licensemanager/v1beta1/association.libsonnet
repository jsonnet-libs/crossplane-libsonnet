{
  ...
  spec: {
    ...
    forProvider: {
      '#licenseConfigurationArnRef':: d.obj(help='"Reference to a LicenseConfiguration to populate licenseConfigurationArn."'),
      ...
      '#licenseConfigurationArnSelector':: d.obj(help='"Selector for a LicenseConfiguration to populate licenseConfigurationArn."'),
