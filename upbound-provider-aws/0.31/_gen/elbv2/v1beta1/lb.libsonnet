  ...
  spec: {
    ...
    forProvider: {
      ...
      subnetMapping: {
        ...
        '#withAllocationId':: d.fn(help='"The allocation ID of the Elastic IP address for an internet-facing load balancer."', args=[d.arg(name='allocationId', type=d.T.string)]),
        withAllocationId(allocationId): { allocationId: allocationId },
        '#withIpv6Address':: d.fn(help='"The IPv6 address. You associate IPv6 CIDR blocks with your VPC and choose the subnets where you launch both internet-facing and internal Application Load Balancers or Network Load Balancers."', args=[d.arg(name='ipv6Address', type=d.T.string)]),
        withIpv6Address(ipv6Address): { ipv6Address: ipv6Address },
        '#withPrivateIpv4Address':: d.fn(help='"The private IPv4 address for an internal load balancer."', args=[d.arg(name='privateIpv4Address', type=d.T.string)]),
      ...
      '#withPreserveHostHeader':: d.fn(help='"Indicates whether the Application Load Balancer should preserve the Host header in the HTTP request and send it to the target without any change. Defaults to false."', args=[d.arg(name='preserveHostHeader', type=d.T.boolean)]),
