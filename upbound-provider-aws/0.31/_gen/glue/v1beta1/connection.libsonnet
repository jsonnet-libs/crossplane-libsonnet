{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConnectionType':: d.fn(help='"–  The type of the connection. Supported are: CUSTOM, JDBC, KAFKA, MARKETPLACE, MONGODB, and NETWORK. Defaults to JBDC."', args=[d.arg(name='connectionType', type=d.T.string)]),
