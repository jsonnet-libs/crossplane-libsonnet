      ...
      policyDetails: {
        ...
        action: {
          ...
          crossRegionCopy: {
            ...
            retainRule: {
              '#withInterval':: d.fn(help='"How often this lifecycle policy should be evaluated. 1, 2,3,4,6,8,12 or 24 are valid values."', args=[d.arg(name='interval', type=d.T.number)]),
              withInterval(interval): { interval: interval },
              '#withIntervalUnit':: d.fn(help='"The unit for how often the lifecycle policy should be evaluated. HOURS is currently the only allowed value and also the default value."', args=[d.arg(name='intervalUnit', type=d.T.string)]),
        ...
        schedule: {
          ...
          createRule: {
            '#withCronExpression':: d.fn(help='"The schedule, as a Cron expression. The schedule interval must be between 1 hour and 1 year."', args=[d.arg(name='cronExpression', type=d.T.string)]),
            ...
            '#withTimes':: d.fn(help='"A list of times in 24 hour clock format that sets when the lifecycle policy should be evaluated. Max of 1."', args=[d.arg(name='times', type=d.T.array)]),
            withTimes(times): { times: if std.isArray(v=times) then times else [times] },
            '#withTimesMixin':: d.fn(help='"A list of times in 24 hour clock format that sets when the lifecycle policy should be evaluated. Max of 1."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='times', type=d.T.array)]),
          ...
          '#deprecateRule':: d.obj(help='"See the deprecate_rule block. Max of 1 per schedule."'),
          deprecateRule: {
            '#withCount':: d.fn(help='"Specifies the number of oldest AMIs to deprecate. Must be an integer between 1 and 1000."', args=[d.arg(name='count', type=d.T.number)]),
          ...
          shareRule: {
            ...
            '#withUnshareInterval':: d.fn(help='"How often this lifecycle policy should be evaluated. 1, 2,3,4,6,8,12 or 24 are valid values."', args=[d.arg(name='unshareInterval', type=d.T.number)]),
            withUnshareInterval(unshareInterval): { unshareInterval: unshareInterval },
            '#withUnshareIntervalUnit':: d.fn(help='"The unit for how often the lifecycle policy should be evaluated. HOURS is currently the only allowed value and also the default value."', args=[d.arg(name='unshareIntervalUnit', type=d.T.string)]),
