  ...
  spec: {
    ...
    forProvider: {
      ...
      accessLogSettings: {
        ...
        '#withFormat':: d.fn(help='"Formatting and values recorded in the logs. For more information on configuring the log format rules visit the AWS documentation"', args=[d.arg(name='format', type=d.T.string)]),
