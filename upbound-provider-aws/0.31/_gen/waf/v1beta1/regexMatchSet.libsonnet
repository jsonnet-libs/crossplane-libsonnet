  ...
  spec: {
    ...
    forProvider: {
      ...
      regexMatchTuple: {
        ...
        '#withTextTransformation':: d.fn(help='"Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values."', args=[d.arg(name='textTransformation', type=d.T.string)]),
