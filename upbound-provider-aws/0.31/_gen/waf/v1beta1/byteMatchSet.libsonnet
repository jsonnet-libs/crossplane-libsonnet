{
  ...
  spec: {
    ...
    forProvider: {
      '#byteMatchTuples':: d.obj(help='"Specifies the bytes (typically a string that corresponds with ASCII characters) that you want to search for in web requests, the location in requests that you want to search, and other settings."'),
      byteMatchTuples: {
        ...
        '#withPositionalConstraint':: d.fn(help='"Within the portion of a web request that you want to search (for example, in the query string, if any), specify where you want to search. e.g., CONTAINS, CONTAINS_WORD or EXACTLY. See docs for all supported values."', args=[d.arg(name='positionalConstraint', type=d.T.string)]),
        withPositionalConstraint(positionalConstraint): { positionalConstraint: positionalConstraint },
        '#withTargetString':: d.fn(help='"The value that you want to search for within the field specified by field_to_match, e.g., badrefer1. See docs for all supported values."', args=[d.arg(name='targetString', type=d.T.string)]),
        withTargetString(targetString): { targetString: targetString },
        '#withTextTransformation':: d.fn(help='"Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on target_string before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values."', args=[d.arg(name='textTransformation', type=d.T.string)]),
        withTextTransformation(textTransformation): { textTransformation: textTransformation },
      },
      '#withByteMatchTuples':: d.fn(help='"Specifies the bytes (typically a string that corresponds with ASCII characters) that you want to search for in web requests, the location in requests that you want to search, and other settings."', args=[d.arg(name='byteMatchTuples', type=d.T.array)]),
      ...
      '#withByteMatchTuplesMixin':: d.fn(help='"Specifies the bytes (typically a string that corresponds with ASCII characters) that you want to search for in web requests, the location in requests that you want to search, and other settings."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='byteMatchTuples', type=d.T.array)]),
