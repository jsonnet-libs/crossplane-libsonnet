{
  ...
  '#':: d.pkg(name='querySuggestionsBlockList', url='', help='"QuerySuggestionsBlockList is the Schema for the QuerySuggestionsBlockLists API. Upbound official provider resource for managing an aws kendra block list used for query suggestions for an index"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#sourceS3Path':: d.obj(help='"The S3 path where your block list text file sits in S3. Detailed below."'),
      sourceS3Path: {
      ...
      '#withDescription':: d.fn(help='"The description for a block list."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIndexId':: d.fn(help='"The identifier of the index for a block list."', args=[d.arg(name='indexId', type=d.T.string)]),
      withIndexId(indexId): { spec+: { forProvider+: { indexId: indexId } } },
      '#withName':: d.fn(help='"The name for the block list."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"The IAM (Identity and Access Management) role used to access the block list text file in S3."', args=[d.arg(name='roleArn', type=d.T.string)]),
      withRoleArn(roleArn): { spec+: { forProvider+: { roleArn: roleArn } } },
      '#withSourceS3Path':: d.fn(help='"The S3 path where your block list text file sits in S3. Detailed below."', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
      ...
      '#withSourceS3PathMixin':: d.fn(help='"The S3 path where your block list text file sits in S3. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sourceS3Path', type=d.T.array)]),
