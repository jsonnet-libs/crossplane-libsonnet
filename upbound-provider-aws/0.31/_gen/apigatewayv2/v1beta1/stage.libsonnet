  ...
  spec: {
    ...
    forProvider: {
      ...
      defaultRouteSettings: {
        ...
        '#withLoggingLevel':: d.fn(help='"Logging level for the default route. Affects the log entries pushed to Amazon CloudWatch Logs. Valid values: ERROR, INFO, OFF. Defaults to OFF. Supported only for WebSocket APIs."', args=[d.arg(name='loggingLevel', type=d.T.string)]),
      ...
      routeSettings: {
        '#withDataTraceEnabled':: d.fn(help='"Whether data trace logging is enabled for the route. Affects the log entries pushed to Amazon CloudWatch Logs. Defaults to false. Supported only for WebSocket APIs."', args=[d.arg(name='dataTraceEnabled', type=d.T.boolean)]),
        withDataTraceEnabled(dataTraceEnabled): { dataTraceEnabled: dataTraceEnabled },
        ...
        withDetailedMetricsEnabled(detailedMetricsEnabled): { detailedMetricsEnabled: detailedMetricsEnabled },
        '#withLoggingLevel':: d.fn(help='"Logging level for the route. Affects the log entries pushed to Amazon CloudWatch Logs. Valid values: ERROR, INFO, OFF. Defaults to OFF. Supported only for WebSocket APIs."', args=[d.arg(name='loggingLevel', type=d.T.string)]),
        withLoggingLevel(loggingLevel): { loggingLevel: loggingLevel },
      ...
      '#withClientCertificateId':: d.fn(help='"Identifier of a client certificate for the stage. Use the aws_api_gateway_client_certificate resource to configure a client certificate. Supported only for WebSocket APIs."', args=[d.arg(name='clientCertificateId', type=d.T.string)]),
