{
  ...
  spec: {
    ...
    forProvider: {
      '#delegationSetIdRef':: d.obj(help='"Reference to a DelegationSet to populate delegationSetId."'),
      delegationSetIdRef: {
      ...
      '#delegationSetIdSelector':: d.obj(help='"Selector for a DelegationSet to populate delegationSetId."'),
