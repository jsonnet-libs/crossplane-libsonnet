{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAccessPolicy':: d.fn(help='"The policy document. This is a JSON formatted string. The heredoc syntax or file function is helpful here. Use the Glacier Developer Guide for more information on Glacier Vault Policy"', args=[d.arg(name='accessPolicy', type=d.T.string)]),
