{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAvailabilityZones':: d.fn(help='"List of Availability Zones in which the nodes will be created"', args=[d.arg(name='availabilityZones', type=d.T.array)]),
      ...
      '#withClusterEndpointEncryptionType':: d.fn(help="\"–  The type of encryption the cluster's endpoint should support. Valid values are: NONE and TLS. Default value is NONE.\"", args=[d.arg(name='clusterEndpointEncryptionType', type=d.T.string)]),
      ...
      '#withIamRoleArn':: d.fn(help="\"A valid Amazon Resource Name (ARN) that identifies an IAM role. At runtime, DAX will assume this role and use the role's permissions to access DynamoDB on your behalf\"", args=[d.arg(name='iamRoleArn', type=d.T.string)]),
      ...
      '#withNodeType':: d.fn(help='"–  The compute and memory capacity of the nodes. See Nodes for supported node types"', args=[d.arg(name='nodeType', type=d.T.string)]),
      ...
      '#withParameterGroupName':: d.fn(help='"–  Name of the parameter group to associate with this DAX cluster"', args=[d.arg(name='parameterGroupName', type=d.T.string)]),
      ...
      '#withReplicationFactor':: d.fn(help='"node cluster, without any read replicas"', args=[d.arg(name='replicationFactor', type=d.T.number)]),
      ...
      '#withSubnetGroupName':: d.fn(help='"–  Name of the subnet group to be used for the cluster"', args=[d.arg(name='subnetGroupName', type=d.T.string)]),
