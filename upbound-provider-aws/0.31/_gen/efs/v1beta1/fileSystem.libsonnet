{
  ...
  spec: {
    ...
    forProvider: {
      ...
      lifecyclePolicy: {
        '#withTransitionToIa':: d.fn(help='"Indicates how long it takes to transition files to the IA storage class. Valid values: AFTER_1_DAY, AFTER_7_DAYS, AFTER_14_DAYS, AFTER_30_DAYS, AFTER_60_DAYS, or AFTER_90_DAYS."', args=[d.arg(name='transitionToIa', type=d.T.string)]),
