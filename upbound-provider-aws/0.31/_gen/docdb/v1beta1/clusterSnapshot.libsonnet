{
  ...
  '#':: d.pkg(name='clusterSnapshot', url='', help='"ClusterSnapshot is the Schema for the ClusterSnapshots API. Manages a DocDB database cluster snapshot."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDbClusterIdentifier':: d.fn(help='"The DocDB Cluster Identifier from which to take the snapshot."', args=[d.arg(name='dbClusterIdentifier', type=d.T.string)]),
