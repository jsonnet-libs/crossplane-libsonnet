{
  ...
  '#':: d.pkg(name='lbStickinessPolicy', url='', help='"LBStickinessPolicy is the Schema for the LBStickinessPolicys API. Configures Session Stickiness for a Lightsail Load Balancer"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCookieDuration':: d.fn(help='"The cookie duration in seconds. This determines the length of the session stickiness."', args=[d.arg(name='cookieDuration', type=d.T.number)]),
      withCookieDuration(cookieDuration): { spec+: { forProvider+: { cookieDuration: cookieDuration } } },
      '#withEnabled':: d.fn(help='"- The Session Stickiness state of the load balancer. true to activate session stickiness or false to deactivate session stickiness."', args=[d.arg(name='enabled', type=d.T.boolean)]),
