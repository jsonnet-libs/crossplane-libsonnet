{
  ...
  '#':: d.pkg(name='domainEntry', url='', help='"DomainEntry is the Schema for the DomainEntrys API. Provides an Lightsail Domain Entry"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDomainName':: d.fn(help='"The name of the Lightsail domain in which to create the entry"', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withIsAlias':: d.fn(help='"If the entry should be an alias Defaults to false"', args=[d.arg(name='isAlias', type=d.T.boolean)]),
      ...
      '#withType':: d.fn(help='"Type of record"', args=[d.arg(name='type', type=d.T.string)]),
