{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAvailabilityZone':: d.fn(help='"The Availability Zone in which to create your instance (see list below)"', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      withAvailabilityZone(availabilityZone): { spec+: { forProvider+: { availabilityZone: availabilityZone } } },
      '#withBlueprintId':: d.fn(help='"The ID for a virtual private server image. A list of available blueprint IDs can be obtained using the AWS CLI command: aws lightsail get-blueprints"', args=[d.arg(name='blueprintId', type=d.T.string)]),
      withBlueprintId(blueprintId): { spec+: { forProvider+: { blueprintId: blueprintId } } },
      '#withBundleId':: d.fn(help='"The bundle of specification information (see list below)"', args=[d.arg(name='bundleId', type=d.T.string)]),
      ...
      '#withKeyPairName':: d.fn(help='"The name of your key pair. Created in the Lightsail console (cannot use aws_key_pair at this time)"', args=[d.arg(name='keyPairName', type=d.T.string)]),
      ...
      '#withUserData':: d.fn(help='"launch script to configure server with additional user data"', args=[d.arg(name='userData', type=d.T.string)]),
