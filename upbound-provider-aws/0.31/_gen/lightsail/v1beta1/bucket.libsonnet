{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRegion':: d.fn(help="\"The Amazon Web Services Region name. Region is the region you'd like your resource to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
