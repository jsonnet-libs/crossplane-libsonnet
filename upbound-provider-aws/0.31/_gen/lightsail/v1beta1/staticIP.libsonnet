{
  ...
  '#':: d.pkg(name='staticIP', url='', help='"StaticIP is the Schema for the StaticIPs API. Provides an Lightsail Static IP"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"The name for the allocated static IP"', args=[d.arg(name='name', type=d.T.string)]),
