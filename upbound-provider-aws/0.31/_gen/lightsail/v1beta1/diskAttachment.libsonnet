{
  ...
  '#':: d.pkg(name='diskAttachment', url='', help='"DiskAttachment is the Schema for the DiskAttachments API. Attaches a Lightsail disk to a Lightsail Instance"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDiskName':: d.fn(help='"The name of the Lightsail Disk."', args=[d.arg(name='diskName', type=d.T.string)]),
      withDiskName(diskName): { spec+: { forProvider+: { diskName: diskName } } },
      '#withDiskPath':: d.fn(help='"The disk path to expose to the instance."', args=[d.arg(name='diskPath', type=d.T.string)]),
      withDiskPath(diskPath): { spec+: { forProvider+: { diskPath: diskPath } } },
      '#withInstanceName':: d.fn(help='"The name of the Lightsail Instance to attach to."', args=[d.arg(name='instanceName', type=d.T.string)]),
