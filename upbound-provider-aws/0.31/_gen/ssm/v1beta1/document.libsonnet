{
  ...
  spec: {
    ...
    forProvider: {
      '#attachmentsSource':: d.obj(help='"One or more configuration blocks describing attachments sources to a version of a document. Defined below."'),
      attachmentsSource: {
        '#withKey':: d.fn(help='"The key describing the location of an attachment to a document. Valid key types include: SourceUrl and S3FileUrl"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { key: key },
        '#withName':: d.fn(help='"The name of the document attachment file"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValues':: d.fn(help='"The value describing the location of an attachment to a document"', args=[d.arg(name='values', type=d.T.array)]),
        withValues(values): { values: if std.isArray(v=values) then values else [values] },
        '#withValuesMixin':: d.fn(help='"The value describing the location of an attachment to a document"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
        withValuesMixin(values): { values+: if std.isArray(v=values) then values else [values] },
      },
      '#withAttachmentsSource':: d.fn(help='"One or more configuration blocks describing attachments sources to a version of a document. Defined below."', args=[d.arg(name='attachmentsSource', type=d.T.array)]),
      ...
      '#withAttachmentsSourceMixin':: d.fn(help='"One or more configuration blocks describing attachments sources to a version of a document. Defined below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='attachmentsSource', type=d.T.array)]),
      ...
      '#withContent':: d.fn(help='"The JSON or YAML content of the document."', args=[d.arg(name='content', type=d.T.string)]),
      withContent(content): { spec+: { forProvider+: { content: content } } },
      '#withDocumentFormat':: d.fn(help='"The format of the document. Valid document types include: JSON and YAML"', args=[d.arg(name='documentFormat', type=d.T.string)]),
      withDocumentFormat(documentFormat): { spec+: { forProvider+: { documentFormat: documentFormat } } },
      '#withDocumentType':: d.fn(help='"The type of the document. Valid document types include: Automation, Command, Package, Policy, and Session"', args=[d.arg(name='documentType', type=d.T.string)]),
      ...
      '#withTargetType':: d.fn(help='"The target type which defines the kinds of resources the document can run on. For example, /AWS::EC2::Instance. For a list of valid resource types, see AWS Resource Types Reference (http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html)"', args=[d.arg(name='targetType', type=d.T.string)]),
      withTargetType(targetType): { spec+: { forProvider+: { targetType: targetType } } },
      '#withVersionName':: d.fn(help='"A field specifying the version of the artifact you are creating with the document. For example, \\"Release 12, Update 6\\". This value is unique across all versions of a document and cannot be changed for an existing document version."', args=[d.arg(name='versionName', type=d.T.string)]),
