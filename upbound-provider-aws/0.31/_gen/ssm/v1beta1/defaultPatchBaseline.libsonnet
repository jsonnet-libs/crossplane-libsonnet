{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBaselineId':: d.fn(help='"ID of the patch baseline. Can be an ID or an ARN. When specifying an AWS-provided patch baseline, must be the ARN."', args=[d.arg(name='baselineId', type=d.T.string)]),
      withBaselineId(baselineId): { spec+: { forProvider+: { baselineId: baselineId } } },
      '#withOperatingSystem':: d.fn(help='"The operating system the patch baseline applies to. Valid values are AMAZON_LINUX, AMAZON_LINUX_2, AMAZON_LINUX_2022, CENTOS, DEBIAN, MACOS, ORACLE_LINUX, RASPBIAN, REDHAT_ENTERPRISE_LINUX, ROCKY_LINUX, SUSE, UBUNTU, and WINDOWS."', args=[d.arg(name='operatingSystem', type=d.T.string)]),
