  ...
  spec: {
    ...
    forProvider: {
      ...
      accessControlPolicy: {
        ...
        '#owner':: d.obj(help="\"Configuration block of the bucket owner's display name and ID. See below.\""),
        owner: {
        ...
        '#withOwner':: d.fn(help="\"Configuration block of the bucket owner's display name and ID. See below.\"", args=[d.arg(name='owner', type=d.T.array)]),
        withOwner(owner): { owner: if std.isArray(v=owner) then owner else [owner] },
        '#withOwnerMixin':: d.fn(help="\"Configuration block of the bucket owner's display name and ID. See below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='owner', type=d.T.array)]),
