{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRegion':: d.fn(help="\"AWS region this bucket resides in. Region is the region you'd like your resource to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
