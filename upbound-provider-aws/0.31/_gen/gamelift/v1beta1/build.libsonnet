{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withOperatingSystem':: d.fn(help='"Operating system that the game server binaries are built to run onE.g., WINDOWS_2012, AMAZON_LINUX or AMAZON_LINUX_2."', args=[d.arg(name='operatingSystem', type=d.T.string)]),
