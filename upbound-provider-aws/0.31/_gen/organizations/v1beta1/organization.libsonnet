{
  ...
  '#':: d.pkg(name='organization', url='', help='"Organization is the Schema for the Organizations API. Provides a resource to create an organization."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAwsServiceAccessPrincipals':: d.fn(help='"List of AWS service principal names for which you want to enable integration with your organization. This is typically in the form of a URL, such as service-abbreviation.amazonaws.com. Organization must have feature_set set to ALL. Some services do not support enablement via this endpoint, see warning in aws docs."', args=[d.arg(name='awsServiceAccessPrincipals', type=d.T.array)]),
      withAwsServiceAccessPrincipals(awsServiceAccessPrincipals): { spec+: { forProvider+: { awsServiceAccessPrincipals: if std.isArray(v=awsServiceAccessPrincipals) then awsServiceAccessPrincipals else [awsServiceAccessPrincipals] } } },
      '#withAwsServiceAccessPrincipalsMixin':: d.fn(help='"List of AWS service principal names for which you want to enable integration with your organization. This is typically in the form of a URL, such as service-abbreviation.amazonaws.com. Organization must have feature_set set to ALL. Some services do not support enablement via this endpoint, see warning in aws docs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='awsServiceAccessPrincipals', type=d.T.array)]),
      withAwsServiceAccessPrincipalsMixin(awsServiceAccessPrincipals): { spec+: { forProvider+: { awsServiceAccessPrincipals+: if std.isArray(v=awsServiceAccessPrincipals) then awsServiceAccessPrincipals else [awsServiceAccessPrincipals] } } },
      '#withEnabledPolicyTypes':: d.fn(help='"List of Organizations policy types to enable in the Organization Root. Organization must have feature_set set to ALL. For additional information about valid policy types (e.g., AISERVICES_OPT_OUT_POLICY, BACKUP_POLICY, SERVICE_CONTROL_POLICY, and TAG_POLICY), see the AWS Organizations API Reference."', args=[d.arg(name='enabledPolicyTypes', type=d.T.array)]),
      withEnabledPolicyTypes(enabledPolicyTypes): { spec+: { forProvider+: { enabledPolicyTypes: if std.isArray(v=enabledPolicyTypes) then enabledPolicyTypes else [enabledPolicyTypes] } } },
      '#withEnabledPolicyTypesMixin':: d.fn(help='"List of Organizations policy types to enable in the Organization Root. Organization must have feature_set set to ALL. For additional information about valid policy types (e.g., AISERVICES_OPT_OUT_POLICY, BACKUP_POLICY, SERVICE_CONTROL_POLICY, and TAG_POLICY), see the AWS Organizations API Reference."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enabledPolicyTypes', type=d.T.array)]),
      withEnabledPolicyTypesMixin(enabledPolicyTypes): { spec+: { forProvider+: { enabledPolicyTypes+: if std.isArray(v=enabledPolicyTypes) then enabledPolicyTypes else [enabledPolicyTypes] } } },
      '#withFeatureSet':: d.fn(help='"Specify \\"ALL\\" (default) or \\"CONSOLIDATED_BILLING\\"."', args=[d.arg(name='featureSet', type=d.T.string)]),
      withFeatureSet(featureSet): { spec+: { forProvider+: { featureSet: featureSet } } },
