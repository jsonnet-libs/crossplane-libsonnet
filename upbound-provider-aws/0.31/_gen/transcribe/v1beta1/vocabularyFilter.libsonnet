{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVocabularyFilterFileUri':: d.fn(help='"The Amazon S3 location (URI) of the text file that contains your custom VocabularyFilter. Conflicts with words."', args=[d.arg(name='vocabularyFilterFileUri', type=d.T.string)]),
      withVocabularyFilterFileUri(vocabularyFilterFileUri): { spec+: { forProvider+: { vocabularyFilterFileUri: vocabularyFilterFileUri } } },
      '#withWords':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_file_uri"', args=[d.arg(name='words', type=d.T.array)]),
      withWords(words): { spec+: { forProvider+: { words: if std.isArray(v=words) then words else [words] } } },
      '#withWordsMixin':: d.fn(help='"- A list of terms to include in the vocabulary. Conflicts with vocabulary_file_uri"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='words', type=d.T.array)]),
