{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLbPort':: d.fn(help='"Load balancer port to which the policy should be applied. This must be an active listener on the load balancer."', args=[d.arg(name='lbPort', type=d.T.number)]),
      withLbPort(lbPort): { spec+: { forProvider+: { lbPort: lbPort } } },
      '#withLoadBalancer':: d.fn(help='"Name of load balancer to which the policy should be attached."', args=[d.arg(name='loadBalancer', type=d.T.string)]),
