{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCookieExpirationPeriod':: d.fn(help='"The time period after which the session cookie should be considered stale, expressed in seconds."', args=[d.arg(name='cookieExpirationPeriod', type=d.T.number)]),
      withCookieExpirationPeriod(cookieExpirationPeriod): { spec+: { forProvider+: { cookieExpirationPeriod: cookieExpirationPeriod } } },
      '#withLbPort':: d.fn(help='"The load balancer port to which the policy should be applied. This must be an active listener on the load balancer."', args=[d.arg(name='lbPort', type=d.T.number)]),
      withLbPort(lbPort): { spec+: { forProvider+: { lbPort: lbPort } } },
      '#withLoadBalancer':: d.fn(help='"The load balancer to which the policy should be attached."', args=[d.arg(name='loadBalancer', type=d.T.string)]),
