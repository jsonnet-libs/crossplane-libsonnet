{
  ...
  spec: {
    ...
    forProvider: {
      '#withAssetType':: d.fn(help='"The type of asset that is added to a data set. Valid values are: S3_SNAPSHOT, REDSHIFT_DATA_SHARE, and API_GATEWAY_API."', args=[d.arg(name='assetType', type=d.T.string)]),
