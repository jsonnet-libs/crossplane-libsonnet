{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEventTypeIds':: d.fn(help='"A list of event types associated with this notification rule. For list of allowed events see here."', args=[d.arg(name='eventTypeIds', type=d.T.array)]),
      ...
      '#withEventTypeIdsMixin':: d.fn(help='"A list of event types associated with this notification rule. For list of allowed events see here."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventTypeIds', type=d.T.array)]),
