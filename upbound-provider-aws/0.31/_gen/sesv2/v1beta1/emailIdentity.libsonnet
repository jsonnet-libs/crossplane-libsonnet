  ...
  spec: {
    ...
    forProvider: {
      ...
      dkimSigningAttributes: {
        '#withDomainSigningPrivateKey':: d.fn(help="\"[Bring Your Own DKIM] A private key that's used to generate a DKIM signature. The private key must use 1024 or 2048-bit RSA encryption, and must be encoded using base64 encoding.\"", args=[d.arg(name='domainSigningPrivateKey', type=d.T.string)]),
        withDomainSigningPrivateKey(domainSigningPrivateKey): { domainSigningPrivateKey: domainSigningPrivateKey },
