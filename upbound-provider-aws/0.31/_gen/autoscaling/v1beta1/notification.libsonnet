{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNotifications':: d.fn(help='"List of Notification Types that trigger notifications. Acceptable values are documented in the AWS documentation here"', args=[d.arg(name='notifications', type=d.T.array)]),
      ...
      '#withNotificationsMixin':: d.fn(help='"List of Notification Types that trigger notifications. Acceptable values are documented in the AWS documentation here"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='notifications', type=d.T.array)]),
