{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#virtualInterfaceIdRef':: d.obj(help='"Reference to a HostedTransitVirtualInterface to populate virtualInterfaceId."'),
      ...
      '#virtualInterfaceIdSelector':: d.obj(help='"Selector for a HostedTransitVirtualInterface to populate virtualInterfaceId."'),
