{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAmazonAddress':: d.fn(help='"The IPv4 CIDR address to use to send traffic to Amazon. Required for IPv4 BGP peers on public virtual interfaces."', args=[d.arg(name='amazonAddress', type=d.T.string)]),
      ...
      '#withCustomerAddress':: d.fn(help='"The IPv4 CIDR destination address to which Amazon should send traffic. Required for IPv4 BGP peers on public virtual interfaces."', args=[d.arg(name='customerAddress', type=d.T.string)]),
