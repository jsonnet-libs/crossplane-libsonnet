{
  ...
  spec: {
    ...
    forProvider: {
      '#userIdRefs':: d.obj(help='"References to User to populate userIds."'),
      userIdRefs: {
      ...
      '#userIdSelector':: d.obj(help='"Selector for a list of User to populate userIds."'),
      userIdSelector: {
      ...
      '#withArn':: d.fn(help='"The ARN that identifies the user group."', args=[d.arg(name='arn', type=d.T.string)]),
      withArn(arn): { spec+: { forProvider+: { arn: arn } } },
      '#withEngine':: d.fn(help='"The current supported value is REDIS."', args=[d.arg(name='engine', type=d.T.string)]),
