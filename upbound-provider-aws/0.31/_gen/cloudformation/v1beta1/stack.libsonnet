{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCapabilities':: d.fn(help='"A list of capabilities. Valid values: CAPABILITY_IAM, CAPABILITY_NAMED_IAM, or CAPABILITY_AUTO_EXPAND"', args=[d.arg(name='capabilities', type=d.T.array)]),
      ...
      '#withCapabilitiesMixin':: d.fn(help='"A list of capabilities. Valid values: CAPABILITY_IAM, CAPABILITY_NAMED_IAM, or CAPABILITY_AUTO_EXPAND"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='capabilities', type=d.T.array)]),
      ...
      '#withDisableRollback':: d.fn(help='"Set to true to disable rollback of the stack if stack creation failed. Conflicts with on_failure."', args=[d.arg(name='disableRollback', type=d.T.boolean)]),
      ...
      '#withOnFailure':: d.fn(help='"Action to be taken if stack creation fails. This must be one of: DO_NOTHING, ROLLBACK, or DELETE. Conflicts with disable_rollback."', args=[d.arg(name='onFailure', type=d.T.string)]),
      ...
      '#withPolicyBody':: d.fn(help='"Structure containing the stack policy body. Conflicts w/ policy_url."', args=[d.arg(name='policyBody', type=d.T.string)]),
      withPolicyBody(policyBody): { spec+: { forProvider+: { policyBody: policyBody } } },
      '#withPolicyUrl':: d.fn(help='"Location of a file containing the stack policy. Conflicts w/ policy_body."', args=[d.arg(name='policyUrl', type=d.T.string)]),
