{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTableName':: d.fn(help='"The name of the DynamoDB table. There\\ncan only be one Kinesis streaming destination for a given DynamoDB table."', args=[d.arg(name='tableName', type=d.T.string)]),
