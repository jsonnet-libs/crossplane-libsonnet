{
  ...
  '#':: d.pkg(name='openIDConnectProvider', url='', help='"OpenIDConnectProvider is the Schema for the OpenIDConnectProviders API. Provides an IAM OpenID Connect provider."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withClientIdList':: d.fn(help="\"A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that's sent as the client_id parameter on OAuth requests.)\"", args=[d.arg(name='clientIdList', type=d.T.array)]),
      ...
      '#withThumbprintList':: d.fn(help="\"A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s).\"", args=[d.arg(name='thumbprintList', type=d.T.array)]),
      ...
      '#withThumbprintListMixin':: d.fn(help="\"A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s).\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='thumbprintList', type=d.T.array)]),
      ...
      '#withUrl':: d.fn(help='"The URL of the identity provider. Corresponds to the iss claim."', args=[d.arg(name='url', type=d.T.string)]),
    ...
    initProvider: {
      '#withClientIdList':: d.fn(help="\"A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that's sent as the client_id parameter on OAuth requests.)\"", args=[d.arg(name='clientIdList', type=d.T.array)]),
      withClientIdList(clientIdList): { spec+: { initProvider+: { clientIdList: if std.isArray(v=clientIdList) then clientIdList else [clientIdList] } } },
      '#withClientIdListMixin':: d.fn(help="\"A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that's sent as the client_id parameter on OAuth requests.)\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='clientIdList', type=d.T.array)]),
      withClientIdListMixin(clientIdList): { spec+: { initProvider+: { clientIdList+: if std.isArray(v=clientIdList) then clientIdList else [clientIdList] } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { initProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"Key-value map of resource tags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { initProvider+: { tags+: tags } } },
      '#withThumbprintList':: d.fn(help="\"A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s).\"", args=[d.arg(name='thumbprintList', type=d.T.array)]),
      withThumbprintList(thumbprintList): { spec+: { initProvider+: { thumbprintList: if std.isArray(v=thumbprintList) then thumbprintList else [thumbprintList] } } },
      '#withThumbprintListMixin':: d.fn(help="\"A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s).\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='thumbprintList', type=d.T.array)]),
      withThumbprintListMixin(thumbprintList): { spec+: { initProvider+: { thumbprintList+: if std.isArray(v=thumbprintList) then thumbprintList else [thumbprintList] } } },
      '#withUrl':: d.fn(help='"The URL of the identity provider. Corresponds to the iss claim."', args=[d.arg(name='url', type=d.T.string)]),
