{
  ...
  '#':: d.pkg(name='authenticationProfile', url='', help='"AuthenticationProfile is the Schema for the AuthenticationProfiles API. Creates a Redshift authentication profile"'),
  ...
  '#new':: d.fn(help='new returns an instance of AuthenticationProfile', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AuthenticationProfileSpec defines the desired state of AuthenticationProfile"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withAuthenticationProfileContent':: d.fn(help='"The content of the authentication profile in JSON format. The maximum length of the JSON string is determined by a quota for your account."', args=[d.arg(name='authenticationProfileContent', type=d.T.string)]),
      withAuthenticationProfileContent(authenticationProfileContent): { spec+: { forProvider+: { authenticationProfileContent: authenticationProfileContent } } },
    ...
    initProvider: {
      '#withAuthenticationProfileContent':: d.fn(help='"The content of the authentication profile in JSON format. The maximum length of the JSON string is determined by a quota for your account."', args=[d.arg(name='authenticationProfileContent', type=d.T.string)]),
      withAuthenticationProfileContent(authenticationProfileContent): { spec+: { initProvider+: { authenticationProfileContent: authenticationProfileContent } } },
    },
