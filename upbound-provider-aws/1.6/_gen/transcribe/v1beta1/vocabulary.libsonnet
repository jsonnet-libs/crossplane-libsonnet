{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withVocabularyFileUri':: d.fn(help='"The Amazon S3 location (URI) of the text file that contains your custom vocabulary."', args=[d.arg(name='vocabularyFileUri', type=d.T.string)]),
