{
  ...
  '#':: d.pkg(name='modelPackageGroupPolicy', url='', help='"ModelPackageGroupPolicy is the Schema for the ModelPackageGroupPolicys API. Provides a SageMaker Model Package Group Policy resource."'),
