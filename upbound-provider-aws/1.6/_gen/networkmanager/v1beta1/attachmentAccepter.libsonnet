{
  ...
  '#':: d.pkg(name='attachmentAccepter', url='', help='"AttachmentAccepter is the Schema for the AttachmentAccepters API."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAttachmentId':: d.fn(help='"The ID of the attachment."', args=[d.arg(name='attachmentId', type=d.T.string)]),
      withAttachmentId(attachmentId): { spec+: { forProvider+: { attachmentId: attachmentId } } },
      '#withAttachmentType':: d.fn(help='"The type of attachment. Valid values can be found in the AWS Documentation"', args=[d.arg(name='attachmentType', type=d.T.string)]),
