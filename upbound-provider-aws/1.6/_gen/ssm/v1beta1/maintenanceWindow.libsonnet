{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withScheduleOffset':: d.fn(help='"The number of days to wait after the date and time specified by a CRON expression before running the maintenance window."', args=[d.arg(name='scheduleOffset', type=d.T.number)]),
