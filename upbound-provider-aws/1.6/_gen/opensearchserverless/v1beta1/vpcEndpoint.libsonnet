{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"Name of the interface endpoint."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSecurityGroupIds':: d.fn(help='"One or more security groups that define the ports, protocols, and sources for inbound traffic that you are authorizing into your endpoint. Up to 5 security groups can be provided."', args=[d.arg(name='securityGroupIds', type=d.T.array)]),
      ...
      '#withSubnetIds':: d.fn(help="\"One or more subnet IDs from which you'll access OpenSearch Serverless. Up to 6 subnets can be provided.\"", args=[d.arg(name='subnetIds', type=d.T.array)]),
      ...
      '#withVpcId':: d.fn(help="\"ID of the VPC from which you'll access OpenSearch Serverless.\"", args=[d.arg(name='vpcId', type=d.T.string)]),
