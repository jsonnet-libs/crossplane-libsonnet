{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withKeyValueStoreAssociations':: d.fn(help='"List of aws_cloudfront_key_value_store ARNs to be associated to the function. AWS limits associations to on key value store per function."', args=[d.arg(name='keyValueStoreAssociations', type=d.T.array)]),
      ...
      '#withKeyValueStoreAssociationsMixin':: d.fn(help='"List of aws_cloudfront_key_value_store ARNs to be associated to the function. AWS limits associations to on key value store per function."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='keyValueStoreAssociations', type=d.T.array)]),
