{
  ...
  spec: {
    ...
    forProvider: {
      '#withAwsAccountId':: d.fn(help='"The ID for the AWS account that the group is in. Currently, you use the ID for the AWS account that contains your Amazon QuickSight account."', args=[d.arg(name='awsAccountId', type=d.T.string)]),
