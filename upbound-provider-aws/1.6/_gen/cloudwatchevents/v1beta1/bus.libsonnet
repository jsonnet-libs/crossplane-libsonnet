{
  ...
  spec: {
    ...
    forProvider: {
      '#withEventSourceName':: d.fn(help='"The partner event source that the new event bus will be matched with. Must match name."', args=[d.arg(name='eventSourceName', type=d.T.string)]),
