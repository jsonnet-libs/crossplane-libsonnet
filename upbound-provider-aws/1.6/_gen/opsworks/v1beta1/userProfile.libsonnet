{
  ...
  '#':: d.pkg(name='userProfile', url='', help='"UserProfile is the Schema for the UserProfiles API. Provides an OpsWorks User Profile resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAllowSelfManagement':: d.fn(help='"Whether users can specify their own SSH public key through the My Settings page"', args=[d.arg(name='allowSelfManagement', type=d.T.boolean)]),
      withAllowSelfManagement(allowSelfManagement): { spec+: { forProvider+: { allowSelfManagement: allowSelfManagement } } },
      '#withSshPublicKey':: d.fn(help='"The users public key"', args=[d.arg(name='sshPublicKey', type=d.T.string)]),
      withSshPublicKey(sshPublicKey): { spec+: { forProvider+: { sshPublicKey: sshPublicKey } } },
      '#withSshUsername':: d.fn(help='"The ssh username, with witch this user wants to log in"', args=[d.arg(name='sshUsername', type=d.T.string)]),
      withSshUsername(sshUsername): { spec+: { forProvider+: { sshUsername: sshUsername } } },
      '#withUserArn':: d.fn(help="\"The user's IAM ARN\"", args=[d.arg(name='userArn', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withAllowSelfManagement':: d.fn(help='"Whether users can specify their own SSH public key through the My Settings page"', args=[d.arg(name='allowSelfManagement', type=d.T.boolean)]),
      withAllowSelfManagement(allowSelfManagement): { spec+: { initProvider+: { allowSelfManagement: allowSelfManagement } } },
      '#withSshPublicKey':: d.fn(help='"The users public key"', args=[d.arg(name='sshPublicKey', type=d.T.string)]),
      withSshPublicKey(sshPublicKey): { spec+: { initProvider+: { sshPublicKey: sshPublicKey } } },
      '#withSshUsername':: d.fn(help='"The ssh username, with witch this user wants to log in"', args=[d.arg(name='sshUsername', type=d.T.string)]),
      withSshUsername(sshUsername): { spec+: { initProvider+: { sshUsername: sshUsername } } },
      '#withUserArn':: d.fn(help="\"The user's IAM ARN\"", args=[d.arg(name='userArn', type=d.T.string)]),
