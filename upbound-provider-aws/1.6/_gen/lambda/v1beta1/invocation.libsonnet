{
  ...
  '#':: d.pkg(name='invocation', url='', help='"Invocation is the Schema for the Invocations API. Invoke AWS Lambda Function"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withTerraformKey':: d.fn(help='"The JSON key used to store lifecycle information in the input JSON payload. Defaults to tf. This additional key is only included when lifecycle_scope is set to CRUD."', args=[d.arg(name='terraformKey', type=d.T.string)]),
