{
  ...
  '#':: d.pkg(name='provisionedConcurrencyConfig', url='', help='"ProvisionedConcurrencyConfig is the Schema for the ProvisionedConcurrencyConfigs API. Manages a Lambda Provisioned Concurrency Configuration"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSkipDestroy':: d.fn(help='"Whether to retain the provisoned concurrency configuration upon destruction. Defaults to false. If set to true, the resource in simply removed from state instead."', args=[d.arg(name='skipDestroy', type=d.T.boolean)]),
