{
  ...
  '#':: d.pkg(name='lb', url='', help='"LB is the Schema for the LBs API. Provides a Lightsail Load Balancer"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withHealthCheckPath':: d.fn(help='"The health check path of the load balancer. Default value \\"/\\"."', args=[d.arg(name='healthCheckPath', type=d.T.string)]),
      withHealthCheckPath(healthCheckPath): { spec+: { forProvider+: { healthCheckPath: healthCheckPath } } },
      '#withInstancePort':: d.fn(help='"The instance port the load balancer will connect."', args=[d.arg(name='instancePort', type=d.T.number)]),
