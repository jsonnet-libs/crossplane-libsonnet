{
  ...
  '#':: d.pkg(name='lbCertificate', url='', help='"LBCertificate is the Schema for the LBCertificates API. Provides a Lightsail Load Balancer"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDomainName':: d.fn(help='"The domain name (e.g., example.com) for your SSL/TLS certificate."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { spec+: { forProvider+: { domainName: domainName } } },
      '#withLbName':: d.fn(help='"The load balancer name where you want to create the SSL/TLS certificate."', args=[d.arg(name='lbName', type=d.T.string)]),
