{
  ...
  '#':: d.pkg(name='domain', url='', help='"Domain is the Schema for the Domains API. Provides an Lightsail Domain"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDomainName':: d.fn(help='"The name of the Lightsail domain to manage"', args=[d.arg(name='domainName', type=d.T.string)]),
