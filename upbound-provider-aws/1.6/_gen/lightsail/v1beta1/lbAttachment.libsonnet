{
  ...
  '#':: d.pkg(name='lbAttachment', url='', help='"LBAttachment is the Schema for the LBAttachments API. Attaches a Lightsail Instance to a Lightsail Load Balancer"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstanceName':: d.fn(help='"The name of the instance to attach to the load balancer."', args=[d.arg(name='instanceName', type=d.T.string)]),
      withInstanceName(instanceName): { spec+: { forProvider+: { instanceName: instanceName } } },
      '#withLbName':: d.fn(help='"The name of the Lightsail load balancer."', args=[d.arg(name='lbName', type=d.T.string)]),
