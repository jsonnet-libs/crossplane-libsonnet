{
  ...
  '#':: d.pkg(name='bucket', url='', help='"Bucket is the Schema for the Buckets API. Provides a lightsail bucket"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withBundleId':: d.fn(help='"- The ID of the bundle to use for the bucket. A bucket bundle specifies the monthly cost, storage space, and data transfer quota for a bucket. Use the get-bucket-bundles cli command to get a list of bundle IDs that you can specify."', args=[d.arg(name='bundleId', type=d.T.string)]),
      withBundleId(bundleId): { spec+: { forProvider+: { bundleId: bundleId } } },
      '#withForceDelete':: d.fn(help='"AWS by default will not delete an s3 bucket which is not empty, to prevent losing bucket data and affecting other resources in lightsail. If force_delete is set to true the bucket will be deleted even when not empty."', args=[d.arg(name='forceDelete', type=d.T.boolean)]),
      withForceDelete(forceDelete): { spec+: { forProvider+: { forceDelete: forceDelete } } },
      '#withRegion':: d.fn(help="\"The Amazon Web Services Region name.\\nRegion is the region you'd like your resource to be created in.\"", args=[d.arg(name='region', type=d.T.string)]),
