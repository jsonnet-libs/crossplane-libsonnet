{
  ...
  '#':: d.pkg(name='disk', url='', help='"Disk is the Schema for the Disks API. Provides a Lightsail Disk resource"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAvailabilityZone':: d.fn(help='"The Availability Zone in which to create your disk."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      ...
      '#withSizeInGb':: d.fn(help='"The instance port the load balancer will connect."', args=[d.arg(name='sizeInGb', type=d.T.number)]),
