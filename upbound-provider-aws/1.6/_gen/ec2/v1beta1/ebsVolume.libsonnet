{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAvailabilityZone':: d.fn(help='"The AZ where the EBS volume will exist."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      ...
      '#withIops':: d.fn(help='"The amount of IOPS to provision for the disk. Only valid for type of io1, io2 or gp3."', args=[d.arg(name='iops', type=d.T.number)]),
      ...
      '#withSize':: d.fn(help='"The size of the drive in GiBs."', args=[d.arg(name='size', type=d.T.number)]),
      ...
      '#withThroughput':: d.fn(help='"The throughput that the volume supports, in MiB/s. Only valid for type of gp3."', args=[d.arg(name='throughput', type=d.T.number)]),
      withThroughput(throughput): { spec+: { forProvider+: { throughput: throughput } } },
      '#withType':: d.fn(help='"The type of EBS volume. Can be standard, gp2, gp3, io1, io2, sc1 or st1 (Default: gp2)."', args=[d.arg(name='type', type=d.T.string)]),
