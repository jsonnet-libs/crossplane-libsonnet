{
  ...
  spec: {
    ...
    forProvider: {
      '#accepter':: d.obj(help='"An optional configuration block that allows for VPC Peering Connection options to be set for the VPC that acceptsthe peering connection (a maximum of one)."'),
      accepter: {
      ...
      '#requester':: d.obj(help='"A optional configuration block that allows for VPC Peering Connection options to be set for the VPC that requeststhe peering connection (a maximum of one)."'),
      requester: {
        '#withAllowRemoteVpcDnsResolution':: d.fn(help='"Allow a local VPC to resolve public DNS hostnames to private IP addresses when queried from instances in the peer VPC."', args=[d.arg(name='allowRemoteVpcDnsResolution', type=d.T.boolean)]),
        withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution): { allowRemoteVpcDnsResolution: allowRemoteVpcDnsResolution },
      },
      ...
      '#withAccepter':: d.fn(help='"An optional configuration block that allows for VPC Peering Connection options to be set for the VPC that acceptsthe peering connection (a maximum of one)."', args=[d.arg(name='accepter', type=d.T.array)]),
      withAccepter(accepter): { spec+: { forProvider+: { accepter: if std.isArray(v=accepter) then accepter else [accepter] } } },
      '#withAccepterMixin':: d.fn(help='"An optional configuration block that allows for VPC Peering Connection options to be set for the VPC that acceptsthe peering connection (a maximum of one)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='accepter', type=d.T.array)]),
      ...
      '#withRequester':: d.fn(help='"A optional configuration block that allows for VPC Peering Connection options to be set for the VPC that requeststhe peering connection (a maximum of one)."', args=[d.arg(name='requester', type=d.T.array)]),
      withRequester(requester): { spec+: { forProvider+: { requester: if std.isArray(v=requester) then requester else [requester] } } },
      '#withRequesterMixin':: d.fn(help='"A optional configuration block that allows for VPC Peering Connection options to be set for the VPC that requeststhe peering connection (a maximum of one)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requester', type=d.T.array)]),
