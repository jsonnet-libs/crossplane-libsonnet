{
  ...
  '#':: d.pkg(name='regionSettings', url='', help='"RegionSettings is the Schema for the RegionSettingss API. Provides an AWS Backup Region Settings resource."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionSettings', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionSettingsSpec defines the desired state of RegionSettings"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withResourceTypeManagementPreference':: d.fn(help='"A map of services along with the management preferences for the Region. For more information, see the AWS Documentation.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB"', args=[d.arg(name='resourceTypeManagementPreference', type=d.T.object)]),
      withResourceTypeManagementPreference(resourceTypeManagementPreference): { spec+: { forProvider+: { resourceTypeManagementPreference: resourceTypeManagementPreference } } },
      '#withResourceTypeManagementPreferenceMixin':: d.fn(help='"A map of services along with the management preferences for the Region. For more information, see the AWS Documentation.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceTypeManagementPreference', type=d.T.object)]),
      withResourceTypeManagementPreferenceMixin(resourceTypeManagementPreference): { spec+: { forProvider+: { resourceTypeManagementPreference+: resourceTypeManagementPreference } } },
      '#withResourceTypeOptInPreference':: d.fn(help='"A map of services along with the opt-in preferences for the Region.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB, EBS, EC2, FSx, S3, Aurora, RDS, Storage Gateway, VirtualMachine"', args=[d.arg(name='resourceTypeOptInPreference', type=d.T.object)]),
      withResourceTypeOptInPreference(resourceTypeOptInPreference): { spec+: { forProvider+: { resourceTypeOptInPreference: resourceTypeOptInPreference } } },
      '#withResourceTypeOptInPreferenceMixin':: d.fn(help='"A map of services along with the opt-in preferences for the Region.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB, EBS, EC2, FSx, S3, Aurora, RDS, Storage Gateway, VirtualMachine"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceTypeOptInPreference', type=d.T.object)]),
      withResourceTypeOptInPreferenceMixin(resourceTypeOptInPreference): { spec+: { forProvider+: { resourceTypeOptInPreference+: resourceTypeOptInPreference } } },
    },
    ...
    initProvider: {
      '#withResourceTypeManagementPreference':: d.fn(help='"A map of services along with the management preferences for the Region. For more information, see the AWS Documentation.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB"', args=[d.arg(name='resourceTypeManagementPreference', type=d.T.object)]),
      withResourceTypeManagementPreference(resourceTypeManagementPreference): { spec+: { initProvider+: { resourceTypeManagementPreference: resourceTypeManagementPreference } } },
      '#withResourceTypeManagementPreferenceMixin':: d.fn(help='"A map of services along with the management preferences for the Region. For more information, see the AWS Documentation.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceTypeManagementPreference', type=d.T.object)]),
      withResourceTypeManagementPreferenceMixin(resourceTypeManagementPreference): { spec+: { initProvider+: { resourceTypeManagementPreference+: resourceTypeManagementPreference } } },
      '#withResourceTypeOptInPreference':: d.fn(help='"A map of services along with the opt-in preferences for the Region.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB, EBS, EC2, FSx, S3, Aurora, RDS, Storage Gateway, VirtualMachine"', args=[d.arg(name='resourceTypeOptInPreference', type=d.T.object)]),
      withResourceTypeOptInPreference(resourceTypeOptInPreference): { spec+: { initProvider+: { resourceTypeOptInPreference: resourceTypeOptInPreference } } },
      '#withResourceTypeOptInPreferenceMixin':: d.fn(help='"A map of services along with the opt-in preferences for the Region.\\n\\n\\nWARNING: All parameters are required to be given: EFS, DynamoDB, EBS, EC2, FSx, S3, Aurora, RDS, Storage Gateway, VirtualMachine"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceTypeOptInPreference', type=d.T.object)]),
      withResourceTypeOptInPreferenceMixin(resourceTypeOptInPreference): { spec+: { initProvider+: { resourceTypeOptInPreference+: resourceTypeOptInPreference } } },
    },
