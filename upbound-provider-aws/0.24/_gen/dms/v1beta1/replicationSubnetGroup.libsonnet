{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReplicationSubnetGroupDescription':: d.fn(help='"The description for the subnet group."', args=[d.arg(name='replicationSubnetGroupDescription', type=d.T.string)]),
