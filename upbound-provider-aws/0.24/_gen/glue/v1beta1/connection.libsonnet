{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConnectionType':: d.fn(help='"–  The type of the connection. Supported are: JDBC, MONGODB, KAFKA, and NETWORK. Defaults to JBDC."', args=[d.arg(name='connectionType', type=d.T.string)]),
