{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#tag':: d.obj(help='"The tag to create. The tag block is documented below."'),
      tag: {
      ...
      '#withAutoscalingGroupName':: d.fn(help='"The name of the Autoscaling Group to apply the tag to."', args=[d.arg(name='autoscalingGroupName', type=d.T.string)]),
      ...
      '#withTag':: d.fn(help='"The tag to create. The tag block is documented below."', args=[d.arg(name='tag', type=d.T.array)]),
      withTag(tag): { spec+: { forProvider+: { tag: if std.isArray(v=tag) then tag else [tag] } } },
      '#withTagMixin':: d.fn(help='"The tag to create. The tag block is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tag', type=d.T.array)]),
