{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoscalingGroupName':: d.fn(help='"The name or Amazon Resource Name (ARN) of the Auto Scaling group."', args=[d.arg(name='autoscalingGroupName', type=d.T.string)]),
      withAutoscalingGroupName(autoscalingGroupName): { spec+: { forProvider+: { autoscalingGroupName: autoscalingGroupName } } },
      '#withDesiredCapacity':: d.fn(help="\"The number of EC2 instances that should be running in the group. Default 0.  Set to -1 if you don't want to change the desired capacity at the scheduled time.\"", args=[d.arg(name='desiredCapacity', type=d.T.number)]),
      withDesiredCapacity(desiredCapacity): { spec+: { forProvider+: { desiredCapacity: desiredCapacity } } },
      '#withEndTime':: d.fn(help='"The time for this action to end, in \\"YYYY-MM-DDThh:mm:ssZ\\" format in UTC/GMT only (for example, 2014-06-01T00:00:00Z ). If you try to schedule your action in the past, Auto Scaling returns an error message."', args=[d.arg(name='endTime', type=d.T.string)]),
      withEndTime(endTime): { spec+: { forProvider+: { endTime: endTime } } },
      '#withMaxSize':: d.fn(help="\"The maximum size for the Auto Scaling group. Default 0. Set to -1 if you don't want to change the maximum size at the scheduled time.\"", args=[d.arg(name='maxSize', type=d.T.number)]),
      withMaxSize(maxSize): { spec+: { forProvider+: { maxSize: maxSize } } },
      '#withMinSize':: d.fn(help="\"The minimum size for the Auto Scaling group. Default 0. Set to -1 if you don't want to change the minimum size at the scheduled time.\"", args=[d.arg(name='minSize', type=d.T.number)]),
      withMinSize(minSize): { spec+: { forProvider+: { minSize: minSize } } },
      '#withRecurrence':: d.fn(help='"The time when recurring future actions will start. Start time is specified by the user following the Unix cron syntax format."', args=[d.arg(name='recurrence', type=d.T.string)]),
      ...
      '#withStartTime':: d.fn(help='"The time for this action to start, in \\"YYYY-MM-DDThh:mm:ssZ\\" format in UTC/GMT only (for example, 2014-06-01T00:00:00Z ). If you try to schedule your action in the past, Auto Scaling returns an error message."', args=[d.arg(name='startTime', type=d.T.string)]),
      withStartTime(startTime): { spec+: { forProvider+: { startTime: startTime } } },
      '#withTimeZone':: d.fn(help='"The timezone for the cron expression. Valid values are the canonical names of the IANA time zones (such as Etc/GMT+9 or Pacific/Tahiti)."', args=[d.arg(name='timeZone', type=d.T.string)]),
