{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBranchName':: d.fn(help='"The name for a branch that is part of the Amplify app."', args=[d.arg(name='branchName', type=d.T.string)]),
      withBranchName(branchName): { spec+: { forProvider+: { branchName: branchName } } },
      '#withDescription':: d.fn(help='"The description for a webhook."', args=[d.arg(name='description', type=d.T.string)]),
