{
  ...
  spec: {
    ...
    forProvider: {
      '#certificateArnRef':: d.obj(help='"Reference to a Certificate to populate certificateArn."'),
      certificateArnRef: {
      ...
      '#certificateArnSelector':: d.obj(help='"Selector for a Certificate to populate certificateArn."'),
      ...
      '#withCertificateArn':: d.fn(help='"The ARN of the certificate that is being validated."', args=[d.arg(name='certificateArn', type=d.T.string)]),
