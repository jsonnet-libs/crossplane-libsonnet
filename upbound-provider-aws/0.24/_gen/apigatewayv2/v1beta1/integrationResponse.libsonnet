{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#integrationIdRef':: d.obj(help='"Reference to a Integration to populate integrationId."'),
      integrationIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#integrationIdSelector':: d.obj(help='"Selector for a Integration to populate integrationId."'),
      ...
      '#withIntegrationId':: d.fn(help='"The identifier of the aws_apigatewayv2_integration."', args=[d.arg(name='integrationId', type=d.T.string)]),
      withIntegrationId(integrationId): { spec+: { forProvider+: { integrationId: integrationId } } },
      '#withIntegrationResponseKey':: d.fn(help='"The integration response key."', args=[d.arg(name='integrationResponseKey', type=d.T.string)]),
      ...
      '#withResponseTemplates':: d.fn(help='"A map of Velocity templates that are applied on the request payload based on the value of the Content-Type header sent by the client."', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      withResponseTemplates(responseTemplates): { spec+: { forProvider+: { responseTemplates: responseTemplates } } },
      '#withResponseTemplatesMixin':: d.fn(help='"A map of Velocity templates that are applied on the request payload based on the value of the Content-Type header sent by the client."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseTemplates', type=d.T.object)]),
