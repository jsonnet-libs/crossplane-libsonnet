{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description for the deployment resource. Must be less than or equal to 1024 characters in length."', args=[d.arg(name='description', type=d.T.string)]),
