{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#domainNameRef':: d.obj(help='"Reference to a DomainName to populate domainName."'),
      domainNameRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#domainNameSelector':: d.obj(help='"Selector for a DomainName to populate domainName."'),
      domainNameSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#stageRef':: d.obj(help='"Reference to a Stage to populate stage."'),
      stageRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#stageSelector':: d.obj(help='"Selector for a Stage to populate stage."'),
      stageSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withApiMappingKey':: d.fn(help='"The API mapping key."', args=[d.arg(name='apiMappingKey', type=d.T.string)]),
      withApiMappingKey(apiMappingKey): { spec+: { forProvider+: { apiMappingKey: apiMappingKey } } },
      '#withDomainName':: d.fn(help='"The domain name. Use the aws_apigatewayv2_domain_name resource to configure a domain name."', args=[d.arg(name='domainName', type=d.T.string)]),
      ...
      '#withStage':: d.fn(help='"The API stage. Use the aws_apigatewayv2_stage resource to configure an API stage."', args=[d.arg(name='stage', type=d.T.string)]),
