{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withArn':: d.fn(help='"–  Amazon Resource Name (ARN) of the resource, an S3 path."', args=[d.arg(name='arn', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"linked role must exist and is used."', args=[d.arg(name='roleArn', type=d.T.string)]),
