{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#encryptionConfiguration':: d.obj(help='"The encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. See Encryption Configuration below."'),
      encryptionConfiguration: {
        '#withEncryptionOption':: d.fn(help='"The type of key; one of SSE_S3, SSE_KMS, CSE_KMS"', args=[d.arg(name='encryptionOption', type=d.T.string)]),
        withEncryptionOption(encryptionOption): { encryptionOption: encryptionOption },
        '#withKmsKey':: d.fn(help='"The KMS key ARN or ID; required for key types SSE_KMS and CSE_KMS."', args=[d.arg(name='kmsKey', type=d.T.string)]),
      ...
      '#withEncryptionConfiguration':: d.fn(help='"The encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. See Encryption Configuration below."', args=[d.arg(name='encryptionConfiguration', type=d.T.array)]),
      ...
      '#withEncryptionConfigurationMixin':: d.fn(help='"The encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. See Encryption Configuration below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptionConfiguration', type=d.T.array)]),
      ...
      '#withForceDestroy':: d.fn(help='"A boolean that indicates all tables should be deleted from the database so that the database can be destroyed without error. The tables are not recoverable."', args=[d.arg(name='forceDestroy', type=d.T.boolean)]),
      withForceDestroy(forceDestroy): { spec+: { forProvider+: { forceDestroy: forceDestroy } } },
      '#withProperties':: d.fn(help='"A key-value map of custom metadata properties for the database definition."', args=[d.arg(name='properties', type=d.T.object)]),
      withProperties(properties): { spec+: { forProvider+: { properties: properties } } },
      '#withPropertiesMixin':: d.fn(help='"A key-value map of custom metadata properties for the database definition."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='properties', type=d.T.object)]),
