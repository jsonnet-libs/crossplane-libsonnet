{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#targetGrant':: d.obj(help='"Set of configuration blocks with information for granting permissions documented below."'),
      targetGrant: {
        '#grantee':: d.obj(help='"A configuration block for the person being granted permissions documented below."'),
        grantee: {
        ...
        '#withGrantee':: d.fn(help='"A configuration block for the person being granted permissions documented below."', args=[d.arg(name='grantee', type=d.T.array)]),
        withGrantee(grantee): { grantee: if std.isArray(v=grantee) then grantee else [grantee] },
        '#withGranteeMixin':: d.fn(help='"A configuration block for the person being granted permissions documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='grantee', type=d.T.array)]),
      ...
      '#withTargetBucket':: d.fn(help='"The name of the bucket where you want Amazon S3 to store server access logs."', args=[d.arg(name='targetBucket', type=d.T.string)]),
      withTargetBucket(targetBucket): { spec+: { forProvider+: { targetBucket: targetBucket } } },
      '#withTargetGrant':: d.fn(help='"Set of configuration blocks with information for granting permissions documented below."', args=[d.arg(name='targetGrant', type=d.T.array)]),
      withTargetGrant(targetGrant): { spec+: { forProvider+: { targetGrant: if std.isArray(v=targetGrant) then targetGrant else [targetGrant] } } },
      '#withTargetGrantMixin':: d.fn(help='"Set of configuration blocks with information for granting permissions documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetGrant', type=d.T.array)]),
