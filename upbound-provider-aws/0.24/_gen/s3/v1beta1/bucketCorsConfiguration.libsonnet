{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#corsRule':: d.obj(help='"Set of origins and methods (cross-origin access that you want to allow) documented below. You can configure up to 100 rules."'),
      corsRule: {
        ...
        withId(id): { id: id },
        '#withMaxAgeSeconds':: d.fn(help='"The time in seconds that your browser is to cache the preflight response for the specified resource."', args=[d.arg(name='maxAgeSeconds', type=d.T.number)]),
      ...
      '#withCorsRule':: d.fn(help='"Set of origins and methods (cross-origin access that you want to allow) documented below. You can configure up to 100 rules."', args=[d.arg(name='corsRule', type=d.T.array)]),
      withCorsRule(corsRule): { spec+: { forProvider+: { corsRule: if std.isArray(v=corsRule) then corsRule else [corsRule] } } },
      '#withCorsRuleMixin':: d.fn(help='"Set of origins and methods (cross-origin access that you want to allow) documented below. You can configure up to 100 rules."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='corsRule', type=d.T.array)]),
