{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withBucket':: d.fn(help='"The name of the bucket to which to apply the policy."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withPolicy':: d.fn(help='"The text of the policy. Although this is a bucket policy rather than an IAM policy, the aws_iam_policy_document data source may be used, so long as it specifies a principal. Note: Bucket policies are limited to 20 KB in size."', args=[d.arg(name='policy', type=d.T.string)]),
