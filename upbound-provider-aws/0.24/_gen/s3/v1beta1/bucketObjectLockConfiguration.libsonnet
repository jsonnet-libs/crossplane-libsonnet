{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#rule':: d.obj(help='"Configuration block for specifying the Object Lock rule for the specified object detailed below."'),
      rule: {
        '#defaultRetention':: d.obj(help='"A configuration block for specifying the default Object Lock retention settings for new objects placed in the specified bucket detailed below."'),
        defaultRetention: {
          '#withDays':: d.fn(help='"The number of days that you want to specify for the default retention period."', args=[d.arg(name='days', type=d.T.number)]),
          withDays(days): { days: days },
          '#withMode':: d.fn(help='"The default Object Lock retention mode you want to apply to new objects placed in the specified bucket. Valid values: COMPLIANCE, GOVERNANCE."', args=[d.arg(name='mode', type=d.T.string)]),
          withMode(mode): { mode: mode },
          '#withYears':: d.fn(help='"The number of years that you want to specify for the default retention period."', args=[d.arg(name='years', type=d.T.number)]),
          withYears(years): { years: years },
        },
        '#withDefaultRetention':: d.fn(help='"A configuration block for specifying the default Object Lock retention settings for new objects placed in the specified bucket detailed below."', args=[d.arg(name='defaultRetention', type=d.T.array)]),
        ...
        '#withDefaultRetentionMixin':: d.fn(help='"A configuration block for specifying the default Object Lock retention settings for new objects placed in the specified bucket detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultRetention', type=d.T.array)]),
      ...
      '#tokenSecretRef':: d.obj(help="\"A token to allow Object Lock to be enabled for an existing bucket. You must contact AWS support for the bucket's \\\"Object Lock token\\\". The token is generated in the back-end when versioning is enabled on a bucket. For more details on versioning, see the aws_s3_bucket_versioning resource.\""),
      tokenSecretRef: {
      ...
      '#withRule':: d.fn(help='"Configuration block for specifying the Object Lock rule for the specified object detailed below."', args=[d.arg(name='rule', type=d.T.array)]),
      withRule(rule): { spec+: { forProvider+: { rule: if std.isArray(v=rule) then rule else [rule] } } },
      '#withRuleMixin':: d.fn(help='"Configuration block for specifying the Object Lock rule for the specified object detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rule', type=d.T.array)]),
