{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#filter':: d.obj(help="\"A bucket filter. The configuration only includes objects that meet the filter's criteria (documented below).\""),
      filter: {
        '#withPrefix':: d.fn(help='"An object key name prefix that identifies the subset of objects to which the configuration applies."', args=[d.arg(name='prefix', type=d.T.string)]),
      ...
      '#tiering':: d.obj(help='"The S3 Intelligent-Tiering storage class tiers of the configuration (documented below)."'),
      tiering: {
        ...
        '#withDays':: d.fn(help='"The number of consecutive days of no access after which an object will be eligible to be transitioned to the corresponding tier."', args=[d.arg(name='days', type=d.T.number)]),
        withDays(days): { days: days },
      },
      '#withBucket':: d.fn(help='"The name of the bucket this intelligent tiering configuration is associated with."', args=[d.arg(name='bucket', type=d.T.string)]),
      withBucket(bucket): { spec+: { forProvider+: { bucket: bucket } } },
      '#withFilter':: d.fn(help="\"A bucket filter. The configuration only includes objects that meet the filter's criteria (documented below).\"", args=[d.arg(name='filter', type=d.T.array)]),
      withFilter(filter): { spec+: { forProvider+: { filter: if std.isArray(v=filter) then filter else [filter] } } },
      '#withFilterMixin':: d.fn(help="\"A bucket filter. The configuration only includes objects that meet the filter's criteria (documented below).\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='filter', type=d.T.array)]),
      withFilterMixin(filter): { spec+: { forProvider+: { filter+: if std.isArray(v=filter) then filter else [filter] } } },
      '#withName':: d.fn(help='"The unique name used to identify the S3 Intelligent-Tiering configuration for the bucket."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withTiering':: d.fn(help='"The S3 Intelligent-Tiering storage class tiers of the configuration (documented below)."', args=[d.arg(name='tiering', type=d.T.array)]),
      withTiering(tiering): { spec+: { forProvider+: { tiering: if std.isArray(v=tiering) then tiering else [tiering] } } },
      '#withTieringMixin':: d.fn(help='"The S3 Intelligent-Tiering storage class tiers of the configuration (documented below)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tiering', type=d.T.array)]),
