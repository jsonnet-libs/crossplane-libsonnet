{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#workspaceIdRef':: d.obj(help='"Reference to a Workspace to populate workspaceId."'),
      workspaceIdRef: {
      ...
      '#workspaceIdSelector':: d.obj(help='"Selector for a Workspace to populate workspaceId."'),
      workspaceIdSelector: {
