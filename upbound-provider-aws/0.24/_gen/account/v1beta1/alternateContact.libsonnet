{
  ...
  spec: {
    ...
    forProvider: {
      '#withAccountId':: d.fn(help="\"The ID of the target account when managing member accounts. Will manage current user's account by default if omitted.\"", args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withAlternateContactType':: d.fn(help='"The type of the alternate contact. Allowed values are: BILLING, OPERATIONS, SECURITY."', args=[d.arg(name='alternateContactType', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name of the alternate contact."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPhoneNumber':: d.fn(help='"A phone number for the alternate contact."', args=[d.arg(name='phoneNumber', type=d.T.string)]),
      ...
      '#withTitle':: d.fn(help='"A title for the alternate contact."', args=[d.arg(name='title', type=d.T.string)]),
