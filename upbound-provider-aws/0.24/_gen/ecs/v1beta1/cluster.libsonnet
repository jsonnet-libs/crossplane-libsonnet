{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#defaultCapacityProviderStrategy':: d.obj(help='"Configuration block for capacity provider strategy to use by default for the cluster. Can be one or more. Detailed below."'),
      defaultCapacityProviderStrategy: {
        '#withBase':: d.fn(help='"The number of tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined."', args=[d.arg(name='base', type=d.T.number)]),
        withBase(base): { base: base },
        '#withCapacityProvider':: d.fn(help='"The short name of the capacity provider."', args=[d.arg(name='capacityProvider', type=d.T.string)]),
        withCapacityProvider(capacityProvider): { capacityProvider: capacityProvider },
        '#withWeight':: d.fn(help='"The relative percentage of the total number of launched tasks that should use the specified capacity provider."', args=[d.arg(name='weight', type=d.T.number)]),
      ...
      setting: {
        ...
        '#withValue':: d.fn(help='"The value to assign to the setting. Value values are enabled and disabled."', args=[d.arg(name='value', type=d.T.string)]),
      ...
      '#withDefaultCapacityProviderStrategy':: d.fn(help='"Configuration block for capacity provider strategy to use by default for the cluster. Can be one or more. Detailed below."', args=[d.arg(name='defaultCapacityProviderStrategy', type=d.T.array)]),
      ...
      '#withDefaultCapacityProviderStrategyMixin':: d.fn(help='"Configuration block for capacity provider strategy to use by default for the cluster. Can be one or more. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='defaultCapacityProviderStrategy', type=d.T.array)]),
