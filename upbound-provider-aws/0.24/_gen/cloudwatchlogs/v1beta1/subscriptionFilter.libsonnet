{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFilterPattern':: d.fn(help='"A valid CloudWatch Logs filter pattern for subscribing to a filtered stream of log events."', args=[d.arg(name='filterPattern', type=d.T.string)]),
