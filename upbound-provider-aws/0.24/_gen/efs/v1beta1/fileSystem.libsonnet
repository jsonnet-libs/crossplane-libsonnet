{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#lifecyclePolicy':: d.obj(help='"A file system lifecycle policy object (documented below)."'),
      lifecyclePolicy: {
        '#withTransitionToIa':: d.fn(help='"Indicates how long it takes to transition files to the IA storage class. Valid values: AFTER_7_DAYS, AFTER_14_DAYS, AFTER_30_DAYS, AFTER_60_DAYS, or AFTER_90_DAYS."', args=[d.arg(name='transitionToIa', type=d.T.string)]),
      ...
      '#withCreationToken':: d.fn(help='"A unique name (a maximum of 64 characters are allowed) used as reference when creating the Elastic File System to ensure idempotent file system creation. See Elastic File System user guide for more information."', args=[d.arg(name='creationToken', type=d.T.string)]),
      ...
      '#withLifecyclePolicy':: d.fn(help='"A file system lifecycle policy object (documented below)."', args=[d.arg(name='lifecyclePolicy', type=d.T.array)]),
      ...
      '#withThroughputMode':: d.fn(help='"Throughput mode for the file system. Defaults to bursting. Valid values: bursting, provisioned. When using provisioned, also set provisioned_throughput_in_mibps."', args=[d.arg(name='throughputMode', type=d.T.string)]),
