{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withShardCount':: d.fn(help='"–  The number of shards that the stream will use. If the stream_mode is PROVISIONED, this field is required. Amazon has guidelines for specifying the Stream size that should be referenced when creating a Kinesis stream. See Amazon Kinesis Streams for more."', args=[d.arg(name='shardCount', type=d.T.number)]),
