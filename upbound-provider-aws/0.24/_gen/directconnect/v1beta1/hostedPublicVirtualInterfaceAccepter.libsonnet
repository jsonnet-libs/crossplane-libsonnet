{
  ...
  spec: {
    ...
    forProvider: {
      '#virtualInterfaceIdRef':: d.obj(help='"Reference to a HostedPublicVirtualInterface to populate virtualInterfaceId."'),
      ...
      '#virtualInterfaceIdSelector':: d.obj(help='"Selector for a HostedPublicVirtualInterface to populate virtualInterfaceId."'),
