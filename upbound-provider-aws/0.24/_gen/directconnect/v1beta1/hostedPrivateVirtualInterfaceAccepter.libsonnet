{
  ...
  spec: {
    ...
    forProvider: {
      '#virtualInterfaceIdRef':: d.obj(help='"Reference to a HostedPrivateVirtualInterface to populate virtualInterfaceId."'),
      ...
      '#virtualInterfaceIdSelector':: d.obj(help='"Selector for a HostedPrivateVirtualInterface to populate virtualInterfaceId."'),
