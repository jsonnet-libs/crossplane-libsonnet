{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDestination':: d.fn(help='"ID of the resource which is the source of the path. Can be an Instance, Internet Gateway, Network Interface, Transit Gateway, VPC Endpoint, VPC Peering Connection or VPN Gateway."', args=[d.arg(name='destination', type=d.T.string)]),
      ...
      '#withSource':: d.fn(help='"ID of the resource which is the source of the path. Can be an Instance, Internet Gateway, Network Interface, Transit Gateway, VPC Endpoint, VPC Peering Connection or VPN Gateway."', args=[d.arg(name='source', type=d.T.string)]),
