{
  ...
  spec: {
    ...
    forProvider: {
      '#imageIdRef':: d.obj(help='"Reference to a AMI to populate imageId."'),
      imageIdRef: {
      ...
      '#imageIdSelector':: d.obj(help='"Selector for a AMI to populate imageId."'),
      imageIdSelector: {
      ...
      '#withAccountId':: d.fn(help='"The AWS account ID for the launch permission."', args=[d.arg(name='accountId', type=d.T.string)]),
      withAccountId(accountId): { spec+: { forProvider+: { accountId: accountId } } },
      '#withGroup':: d.fn(help='"The name of the group for the launch permission. Valid values: \\"all\\"."', args=[d.arg(name='group', type=d.T.string)]),
      withGroup(group): { spec+: { forProvider+: { group: group } } },
      '#withImageId':: d.fn(help='"The ID of the AMI."', args=[d.arg(name='imageId', type=d.T.string)]),
      withImageId(imageId): { spec+: { forProvider+: { imageId: imageId } } },
      '#withOrganizationArn':: d.fn(help='"The ARN of an organization for the launch permission."', args=[d.arg(name='organizationArn', type=d.T.string)]),
      withOrganizationArn(organizationArn): { spec+: { forProvider+: { organizationArn: organizationArn } } },
      '#withOrganizationalUnitArn':: d.fn(help='"The ARN of an organizational unit for the launch permission."', args=[d.arg(name='organizationalUnitArn', type=d.T.string)]),
