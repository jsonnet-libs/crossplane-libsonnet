{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeviceName':: d.fn(help='"The device name to expose to the instance (for example, /dev/sdh or xvdh).  See Device Naming on Linux Instances and Device Naming on Windows Instances for more information."', args=[d.arg(name='deviceName', type=d.T.string)]),
      withDeviceName(deviceName): { spec+: { forProvider+: { deviceName: deviceName } } },
      '#withForceDetach':: d.fn(help='"Set to true if you want to force the volume to detach. Useful if previous attempts failed, but use this option only as a last resort, as this can result in data loss. See Detaching an Amazon EBS Volume from an Instance for more information."', args=[d.arg(name='forceDetach', type=d.T.boolean)]),
      ...
      '#withSkipDestroy':: d.fn(help='"This is useful when destroying an instance which has volumes created by some other means attached."', args=[d.arg(name='skipDestroy', type=d.T.boolean)]),
      withSkipDestroy(skipDestroy): { spec+: { forProvider+: { skipDestroy: skipDestroy } } },
      '#withStopInstanceBeforeDetaching':: d.fn(help='"Set this to true to ensure that the target instance is stopped before trying to detach the volume. Stops the instance, if it is not already stopped."', args=[d.arg(name='stopInstanceBeforeDetaching', type=d.T.boolean)]),
