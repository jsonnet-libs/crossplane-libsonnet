{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withData':: d.fn(help='"Broker configuration in XML format. See official docs for supported parameters and format of the XML."', args=[d.arg(name='data', type=d.T.string)]),
