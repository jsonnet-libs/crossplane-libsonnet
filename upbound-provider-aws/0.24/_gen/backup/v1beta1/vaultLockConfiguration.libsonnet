{
  ...
  spec: {
    ...
    forProvider: {
      '#backupVaultNameRef':: d.obj(help='"Reference to a Vault to populate backupVaultName."'),
      backupVaultNameRef: {
      ...
      '#backupVaultNameSelector':: d.obj(help='"Selector for a Vault to populate backupVaultName."'),
      ...
      '#withChangeableForDays':: d.fn(help='"The number of days before the lock date."', args=[d.arg(name='changeableForDays', type=d.T.number)]),
