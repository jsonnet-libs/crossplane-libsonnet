{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withWorkspaceId':: d.fn(help='"The id of the prometheus workspace the alert manager definition should be linked to"', args=[d.arg(name='workspaceId', type=d.T.string)]),
