{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#contentSecretRef':: d.obj(help='"The content of the configuration or the configuration data."'),
      contentSecretRef: {
      ...
      '#withConfigurationProfileId':: d.fn(help='"The configuration profile ID."', args=[d.arg(name='configurationProfileId', type=d.T.string)]),
      withConfigurationProfileId(configurationProfileId): { spec+: { forProvider+: { configurationProfileId: configurationProfileId } } },
      '#withContentType':: d.fn(help='"A standard MIME type describing the format of the configuration content. For more information, see Content-Type."', args=[d.arg(name='contentType', type=d.T.string)]),
      withContentType(contentType): { spec+: { forProvider+: { contentType: contentType } } },
      '#withDescription':: d.fn(help='"A description of the configuration."', args=[d.arg(name='description', type=d.T.string)]),
