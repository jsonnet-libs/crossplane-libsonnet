{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationId':: d.fn(help='"The AppConfig application ID. Must be between 4 and 7 characters in length."', args=[d.arg(name='applicationId', type=d.T.string)]),
      withApplicationId(applicationId): { spec+: { forProvider+: { applicationId: applicationId } } },
      '#withDescription':: d.fn(help='"The description of the environment. Can be at most 1024 characters."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name for the environment. Must be between 1 and 64 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
