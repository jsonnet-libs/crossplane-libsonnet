{
  ...
  spec: {
    ...
    forProvider: {
      '#privateKeySecretRef':: d.obj(help='"encoded format."'),
      privateKeySecretRef: {
      ...
      '#withCertificateChain':: d.fn(help='"encoded public key certificates of the chain."', args=[d.arg(name='certificateChain', type=d.T.string)]),
      withCertificateChain(certificateChain): { spec+: { forProvider+: { certificateChain: certificateChain } } },
      '#withPath':: d.fn(help='"The IAM path for the server certificate.  If it is not included, it defaults to a slash (/). If this certificate is for use with AWS CloudFront, the path must be in format /cloudfront/your_path_here. See IAM Identifiers for more details on IAM Paths."', args=[d.arg(name='path', type=d.T.string)]),
