{
  ...
  spec: {
    ...
    forProvider: {
      ...
      accessEndpoint: {
        '#withEndpointType':: d.fn(help='"Type of interface endpoint."', args=[d.arg(name='endpointType', type=d.T.string)]),
        withEndpointType(endpointType): { endpointType: endpointType },
        '#withVpceId':: d.fn(help='"Identifier (ID) of the VPC in which the interface endpoint is used."', args=[d.arg(name='vpceId', type=d.T.string)]),
      ...
      vpcConfig: {
        ...
        '#withSubnetIds':: d.fn(help='"Identifiers of the subnets to which a network interface is attached from the image builder instance or image builder instance."', args=[d.arg(name='subnetIds', type=d.T.array)]),
        withSubnetIds(subnetIds): { subnetIds: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] },
        '#withSubnetIdsMixin':: d.fn(help='"Identifiers of the subnets to which a network interface is attached from the image builder instance or image builder instance."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetIds', type=d.T.array)]),
      ...
      '#withAppstreamAgentVersion':: d.fn(help='"The version of the AppStream 2.0 agent to use for this image builder."', args=[d.arg(name='appstreamAgentVersion', type=d.T.string)]),
      ...
      '#withInstanceType':: d.fn(help='"The instance type to use when launching the image builder."', args=[d.arg(name='instanceType', type=d.T.string)]),
