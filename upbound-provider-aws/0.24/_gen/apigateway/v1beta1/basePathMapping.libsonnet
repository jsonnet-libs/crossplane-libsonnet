{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiId':: d.fn(help='"The id of the API to connect."', args=[d.arg(name='apiId', type=d.T.string)]),
      ...
      '#withDomainName':: d.fn(help='"The already-registered domain name to connect the API to."', args=[d.arg(name='domainName', type=d.T.string)]),
      ...
      '#withStageName':: d.fn(help='"The name of a specific deployment stage to expose at the given path. If omitted, callers may select any stage by including its name as a path element after the base path."', args=[d.arg(name='stageName', type=d.T.string)]),
