{
  ...
  spec: {
    ...
    forProvider: {
      '#valueSecretRef':: d.obj(help='"The value of the API key. If not specified, it will be automatically generated by AWS on creation."'),
      valueSecretRef: {
      ...
      '#withDescription':: d.fn(help='"The API key description."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEnabled':: d.fn(help='"Specifies whether the API key can be used by callers. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { forProvider+: { enabled: enabled } } },
      '#withName':: d.fn(help='"The name of the API key"', args=[d.arg(name='name', type=d.T.string)]),
