{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"The name used to label and identify the VPC link."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withTargetArns':: d.fn(help='"The list of network load balancer arns in the VPC targeted by the VPC link. Currently AWS only supports 1 target."', args=[d.arg(name='targetArns', type=d.T.array)]),
      withTargetArns(targetArns): { spec+: { forProvider+: { targetArns: if std.isArray(v=targetArns) then targetArns else [targetArns] } } },
      '#withTargetArnsMixin':: d.fn(help='"The list of network load balancer arns in the VPC targeted by the VPC link. Currently AWS only supports 1 target."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetArns', type=d.T.array)]),
