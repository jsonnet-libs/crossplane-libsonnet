{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withContentType':: d.fn(help='"The content type of the model"', args=[d.arg(name='contentType', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name of the model"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSchema':: d.fn(help='"The schema of the model in a JSON form"', args=[d.arg(name='schema', type=d.T.string)]),
