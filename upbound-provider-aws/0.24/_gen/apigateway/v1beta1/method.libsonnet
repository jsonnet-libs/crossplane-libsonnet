{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAuthorization':: d.fn(help='"The type of authorization used for the method (NONE, CUSTOM, AWS_IAM, COGNITO_USER_POOLS)"', args=[d.arg(name='authorization', type=d.T.string)]),
      withAuthorization(authorization): { spec+: { forProvider+: { authorization: authorization } } },
      '#withAuthorizationScopes':: d.fn(help='"The authorization scopes used when the authorization is COGNITO_USER_POOLS"', args=[d.arg(name='authorizationScopes', type=d.T.array)]),
      ...
      '#withAuthorizationScopesMixin':: d.fn(help='"The authorization scopes used when the authorization is COGNITO_USER_POOLS"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='authorizationScopes', type=d.T.array)]),
      ...
      '#withAuthorizerId':: d.fn(help='"The authorizer id to be used when the authorization is CUSTOM or COGNITO_USER_POOLS"', args=[d.arg(name='authorizerId', type=d.T.string)]),
      withAuthorizerId(authorizerId): { spec+: { forProvider+: { authorizerId: authorizerId } } },
      '#withHttpMethod':: d.fn(help='"The HTTP Method (GET, POST, PUT, DELETE, HEAD, OPTIONS, ANY)"', args=[d.arg(name='httpMethod', type=d.T.string)]),
      withHttpMethod(httpMethod): { spec+: { forProvider+: { httpMethod: httpMethod } } },
      '#withOperationName':: d.fn(help='"The function name that will be given to the method when generating an SDK through API Gateway. If omitted, API Gateway will generate a function name based on the resource path and HTTP verb."', args=[d.arg(name='operationName', type=d.T.string)]),
