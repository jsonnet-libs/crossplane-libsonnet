{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCloudwatchRoleArn':: d.fn(help='"The ARN of an IAM role for CloudWatch (to allow logging & monitoring). See more in AWS Docs. Logging & monitoring can be enabled/disabled and otherwise tuned on the API Gateway Stage level."', args=[d.arg(name='cloudwatchRoleArn', type=d.T.string)]),
