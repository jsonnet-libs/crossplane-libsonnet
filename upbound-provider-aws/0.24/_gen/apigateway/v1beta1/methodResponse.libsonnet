{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResponseModels':: d.fn(help="\"A map of the API models used for the response's content type\"", args=[d.arg(name='responseModels', type=d.T.object)]),
      withResponseModels(responseModels): { spec+: { forProvider+: { responseModels: responseModels } } },
      '#withResponseModelsMixin':: d.fn(help="\"A map of the API models used for the response's content type\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='responseModels', type=d.T.object)]),
      withResponseModelsMixin(responseModels): { spec+: { forProvider+: { responseModels+: responseModels } } },
      '#withResponseParameters':: d.fn(help='"A map of response parameters that can be sent to the caller. For example: response_parameters = { \\"method.response.header.X-Some-Header\\" = true } would define that the header X-Some-Header can be provided on the response."', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParameters(responseParameters): { spec+: { forProvider+: { responseParameters: responseParameters } } },
      '#withResponseParametersMixin':: d.fn(help='"A map of response parameters that can be sent to the caller. For example: response_parameters = { \\"method.response.header.X-Some-Header\\" = true } would define that the header X-Some-Header can be provided on the response."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseParameters', type=d.T.object)]),
