{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAddonVersion':: d.fn(help='"on. The version must match one of the versions returned by describe-addon-versions."', args=[d.arg(name='addonVersion', type=d.T.string)]),
      ...
      '#withResolveConflicts':: d.fn(help='"Define how to resolve parameter value conflicts when migrating an existing add-on to an Amazon EKS add-on or when applying version updates to the add-on. Valid values are NONE and OVERWRITE."', args=[d.arg(name='resolveConflicts', type=d.T.string)]),
      withResolveConflicts(resolveConflicts): { spec+: { forProvider+: { resolveConflicts: resolveConflicts } } },
      '#withServiceAccountRoleArn':: d.fn(help="\"The Amazon Resource Name (ARN) of an existing IAM role to bind to the add-on's service account. The role must be assigned the IAM permissions required by the add-on. If you don't specify an existing IAM role, then the add-on uses the permissions assigned to the node IAM role. For more information, see Amazon EKS node IAM role in the Amazon EKS User Guide.\"", args=[d.arg(name='serviceAccountRoleArn', type=d.T.string)]),
