{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEdition':: d.fn(help='"The MicrosoftAD edition (Standard or Enterprise). Defaults to Enterprise (applies to MicrosoftAD type only)."', args=[d.arg(name='edition', type=d.T.string)]),
      ...
      '#withSize':: d.fn(help='"The size of the directory (Small or Large are accepted values)."', args=[d.arg(name='size', type=d.T.string)]),
