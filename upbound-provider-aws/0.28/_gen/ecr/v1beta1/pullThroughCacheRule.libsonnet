{
  ...
  spec: {
    ...
    forProvider: {
      '#withEcrRepositoryPrefix':: d.fn(help='"The repository name prefix to use when caching images from the source registry."', args=[d.arg(name='ecrRepositoryPrefix', type=d.T.string)]),
      ...
      '#withUpstreamRegistryUrl':: d.fn(help='"The registry URL of the upstream public registry to use as the source."', args=[d.arg(name='upstreamRegistryUrl', type=d.T.string)]),
