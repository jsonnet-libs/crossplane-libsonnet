{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPolicy':: d.fn(help='"The policy document. This is a JSON formatted string. See more details about Policy Parameters in the official AWS docs."', args=[d.arg(name='policy', type=d.T.string)]),
