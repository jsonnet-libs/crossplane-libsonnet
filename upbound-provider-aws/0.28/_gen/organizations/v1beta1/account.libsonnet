{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIamUserAccessToBilling':: d.fn(help='"If set to ALLOW, the new account enables IAM users to access account billing information if they have the required permissions. If set to DENY, then only the root user of the new account can access account billing information."', args=[d.arg(name='iamUserAccessToBilling', type=d.T.string)]),
