{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAutoscalingGroupName':: d.fn(help='"The name of the Auto Scaling group to which you want to assign the lifecycle hook"', args=[d.arg(name='autoscalingGroupName', type=d.T.string)]),
      ...
      '#withLifecycleTransition':: d.fn(help='"The instance state to which you want to attach the lifecycle hook. For a list of lifecycle hook types, see describe-lifecycle-hook-types"', args=[d.arg(name='lifecycleTransition', type=d.T.string)]),
      ...
      '#withNotificationTargetArn':: d.fn(help='"The ARN of the notification target that Auto Scaling will use to notify you when an instance is in the transition state for the lifecycle hook. This ARN target can be either an SQS queue or an SNS topic."', args=[d.arg(name='notificationTargetArn', type=d.T.string)]),
      ...
      '#withRoleArn':: d.fn(help='"The ARN of the IAM role that allows the Auto Scaling group to publish to the specified notification target."', args=[d.arg(name='roleArn', type=d.T.string)]),
