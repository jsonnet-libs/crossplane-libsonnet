{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withGroupNames':: d.fn(help='"A list of AutoScaling Group Names"', args=[d.arg(name='groupNames', type=d.T.array)]),
      withGroupNames(groupNames): { spec+: { forProvider+: { groupNames: if std.isArray(v=groupNames) then groupNames else [groupNames] } } },
      '#withGroupNamesMixin':: d.fn(help='"A list of AutoScaling Group Names"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='groupNames', type=d.T.array)]),
      withGroupNamesMixin(groupNames): { spec+: { forProvider+: { groupNames+: if std.isArray(v=groupNames) then groupNames else [groupNames] } } },
      '#withNotifications':: d.fn(help='"A list of Notification Types that trigger notifications. Acceptable values are documented in the AWS documentation here"', args=[d.arg(name='notifications', type=d.T.array)]),
      ...
      '#withNotificationsMixin':: d.fn(help='"A list of Notification Types that trigger notifications. Acceptable values are documented in the AWS documentation here"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='notifications', type=d.T.array)]),
      ...
      '#withTopicArn':: d.fn(help='"The Topic ARN for notifications to be sent through"', args=[d.arg(name='topicArn', type=d.T.string)]),
