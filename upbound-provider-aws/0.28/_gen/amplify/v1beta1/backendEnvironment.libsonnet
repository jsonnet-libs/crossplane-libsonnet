{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeploymentArtifacts':: d.fn(help='"The name of deployment artifacts."', args=[d.arg(name='deploymentArtifacts', type=d.T.string)]),
      ...
      '#withStackName':: d.fn(help='"The AWS CloudFormation stack name of a backend environment."', args=[d.arg(name='stackName', type=d.T.string)]),
