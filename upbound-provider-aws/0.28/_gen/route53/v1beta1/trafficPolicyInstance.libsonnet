{
  ...
  spec: {
    ...
    forProvider: {
      '#hostedZoneIdRef':: d.obj(help='"Reference to a Zone to populate hostedZoneId."'),
      hostedZoneIdRef: {
      ...
      '#hostedZoneIdSelector':: d.obj(help='"Selector for a Zone to populate hostedZoneId."'),
      ...
      '#trafficPolicyIdRef':: d.obj(help='"Reference to a TrafficPolicy to populate trafficPolicyId."'),
      trafficPolicyIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#trafficPolicyIdSelector':: d.obj(help='"Selector for a TrafficPolicy to populate trafficPolicyId."'),
