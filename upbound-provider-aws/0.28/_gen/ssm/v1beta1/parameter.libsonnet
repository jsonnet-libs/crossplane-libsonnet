{
  ...
  spec: {
    ...
    forProvider: {
      '#valueSecretRef':: d.obj(help='"The value of the parameter.15 and later, this may require additional configuration handling for certain scenarios.15 Upgrade Guide."'),
      valueSecretRef: {
      ...
      '#withAllowedPattern':: d.fn(help='"A regular expression used to validate the parameter value."', args=[d.arg(name='allowedPattern', type=d.T.string)]),
      withAllowedPattern(allowedPattern): { spec+: { forProvider+: { allowedPattern: allowedPattern } } },
      '#withArn':: d.fn(help='"The ARN of the parameter."', args=[d.arg(name='arn', type=d.T.string)]),
      withArn(arn): { spec+: { forProvider+: { arn: arn } } },
      '#withDataType':: d.fn(help='"The data_type of the parameter. Valid values: text and aws:ec2:image for AMI format, see the Native parameter support for Amazon Machine Image IDs"', args=[d.arg(name='dataType', type=d.T.string)]),
      withDataType(dataType): { spec+: { forProvider+: { dataType: dataType } } },
      '#withDescription':: d.fn(help='"The description of the parameter."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withKeyId':: d.fn(help='"The KMS key id or arn for encrypting a SecureString."', args=[d.arg(name='keyId', type=d.T.string)]),
      withKeyId(keyId): { spec+: { forProvider+: { keyId: keyId } } },
      '#withOverwrite':: d.fn(help='"Overwrite an existing parameter."', args=[d.arg(name='overwrite', type=d.T.boolean)]),
      ...
      '#withTier':: d.fn(help='"The tier of the parameter. If not specified, will default to Standard. Valid tiers are Standard, Advanced, and Intelligent-Tiering. For more information on parameter tiers, see the AWS SSM Parameter tier comparison and guide."', args=[d.arg(name='tier', type=d.T.string)]),
      withTier(tier): { spec+: { forProvider+: { tier: tier } } },
      '#withType':: d.fn(help='"The type of the parameter. Valid types are String, StringList and SecureString."', args=[d.arg(name='type', type=d.T.string)]),
