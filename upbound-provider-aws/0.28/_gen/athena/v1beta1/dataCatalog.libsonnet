{
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"A description of the data catalog."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of data catalog: LAMBDA for a federated catalog, GLUE for AWS Glue Catalog, or HIVE for an external hive metastore."', args=[d.arg(name='type', type=d.T.string)]),
