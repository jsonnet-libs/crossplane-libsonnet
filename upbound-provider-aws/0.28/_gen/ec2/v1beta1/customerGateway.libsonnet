{
  ...
  spec: {
    ...
    forProvider: {
      '#withBgpAsn':: d.fn(help="\"The gateway's Border Gateway Protocol (BGP) Autonomous System Number (ASN).\"", args=[d.arg(name='bgpAsn', type=d.T.string)]),
      ...
      '#withIpAddress':: d.fn(help="\"The IP address of the gateway's Internet-routable external interface.\"", args=[d.arg(name='ipAddress', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The type of customer gateway. The only type AWS supports at this time is \\"ipsec.1\\"."', args=[d.arg(name='type', type=d.T.string)]),
