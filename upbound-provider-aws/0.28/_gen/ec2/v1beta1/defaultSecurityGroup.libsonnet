  ...
  spec: {
    ...
    forProvider: {
      ...
      egress: {
        ...
        '#withSecurityGroups':: d.fn(help='"List of security group Group Names if using EC2-Classic, or Group IDs if using a VPC."', args=[d.arg(name='securityGroups', type=d.T.array)]),
        withSecurityGroups(securityGroups): { securityGroups: if std.isArray(v=securityGroups) then securityGroups else [securityGroups] },
        '#withSecurityGroupsMixin':: d.fn(help='"List of security group Group Names if using EC2-Classic, or Group IDs if using a VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroups', type=d.T.array)]),
