{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLogDestination':: d.fn(help='"The ARN of the logging destination."', args=[d.arg(name='logDestination', type=d.T.string)]),
      withLogDestination(logDestination): { spec+: { forProvider+: { logDestination: logDestination } } },
      '#withLogDestinationType':: d.fn(help='"The type of the logging destination. Valid values: cloud-watch-logs, s3. Default: cloud-watch-logs."', args=[d.arg(name='logDestinationType', type=d.T.string)]),
      ...
      '#withLogGroupName':: d.fn(help='"Deprecated: Use log_destination instead. The name of the CloudWatch log group."', args=[d.arg(name='logGroupName', type=d.T.string)]),
      withLogGroupName(logGroupName): { spec+: { forProvider+: { logGroupName: logGroupName } } },
      '#withMaxAggregationInterval':: d.fn(help='"The maximum interval of time during which a flow of packets is captured and aggregated into a flow log record. Valid Values: 60 seconds (1 minute) or 600 seconds (10 minutes). Default: 600."', args=[d.arg(name='maxAggregationInterval', type=d.T.number)]),
