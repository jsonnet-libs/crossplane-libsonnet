{
  ...
  spec: {
    ...
    forProvider: {
      '#accepter':: d.obj(help='"A configuration block that describes [VPC Peering Connection] (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC."'),
      accepter: {
        '#withAllowClassicLinkToRemoteVpc':: d.fn(help='"Indicates whether a local ClassicLink connection can communicate with the peer VPC over the VPC Peering Connection."', args=[d.arg(name='allowClassicLinkToRemoteVpc', type=d.T.boolean)]),
        withAllowClassicLinkToRemoteVpc(allowClassicLinkToRemoteVpc): { allowClassicLinkToRemoteVpc: allowClassicLinkToRemoteVpc },
        '#withAllowRemoteVpcDnsResolution':: d.fn(help='"Indicates whether a local VPC can resolve public DNS hostnames to private IP addresses when queried from instances in a peer VPC."', args=[d.arg(name='allowRemoteVpcDnsResolution', type=d.T.boolean)]),
        withAllowRemoteVpcDnsResolution(allowRemoteVpcDnsResolution): { allowRemoteVpcDnsResolution: allowRemoteVpcDnsResolution },
        '#withAllowVpcToRemoteClassicLink':: d.fn(help='"Indicates whether a local VPC can communicate with a ClassicLink connection in the peer VPC over the VPC Peering Connection."', args=[d.arg(name='allowVpcToRemoteClassicLink', type=d.T.boolean)]),
        withAllowVpcToRemoteClassicLink(allowVpcToRemoteClassicLink): { allowVpcToRemoteClassicLink: allowVpcToRemoteClassicLink },
      },
      '#requester':: d.obj(help='"A configuration block that describes [VPC Peering Connection] (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the requester VPC."'),
      requester: {
        '#withAllowClassicLinkToRemoteVpc':: d.fn(help='"Indicates whether a local ClassicLink connection can communicate with the peer VPC over the VPC Peering Connection."', args=[d.arg(name='allowClassicLinkToRemoteVpc', type=d.T.boolean)]),
        withAllowClassicLinkToRemoteVpc(allowClassicLinkToRemoteVpc): { allowClassicLinkToRemoteVpc: allowClassicLinkToRemoteVpc },
        '#withAllowRemoteVpcDnsResolution':: d.fn(help='"Indicates whether a local VPC can resolve public DNS hostnames to private IP addresses when queried from instances in a peer VPC."', args=[d.arg(name='allowRemoteVpcDnsResolution', type=d.T.boolean)]),
      ...
      '#withAccepter':: d.fn(help='"A configuration block that describes [VPC Peering Connection] (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC."', args=[d.arg(name='accepter', type=d.T.array)]),
      withAccepter(accepter): { spec+: { forProvider+: { accepter: if std.isArray(v=accepter) then accepter else [accepter] } } },
      '#withAccepterMixin':: d.fn(help='"A configuration block that describes [VPC Peering Connection] (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='accepter', type=d.T.array)]),
      ...
      '#withRequester':: d.fn(help='"A configuration block that describes [VPC Peering Connection] (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the requester VPC."', args=[d.arg(name='requester', type=d.T.array)]),
      withRequester(requester): { spec+: { forProvider+: { requester: if std.isArray(v=requester) then requester else [requester] } } },
      '#withRequesterMixin':: d.fn(help='"A configuration block that describes [VPC Peering Connection] (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the requester VPC."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requester', type=d.T.array)]),
