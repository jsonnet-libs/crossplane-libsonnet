{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRouteTableId':: d.fn(help='"The ID of the Route Table to set as the new main route table for the target VPC"', args=[d.arg(name='routeTableId', type=d.T.string)]),
