{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withNetmaskLength':: d.fn(help='"The netmask length of the CIDR you would like to allocate to the IPAM pool. Valid Values: 0-32."', args=[d.arg(name='netmaskLength', type=d.T.number)]),
