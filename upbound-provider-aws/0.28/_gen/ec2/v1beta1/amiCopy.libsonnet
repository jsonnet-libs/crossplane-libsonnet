{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#sourceAmiIdRef':: d.obj(help='"Reference to a AMI to populate sourceAmiId."'),
      sourceAmiIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#sourceAmiIdSelector':: d.obj(help='"Selector for a AMI to populate sourceAmiId."'),
      sourceAmiIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withDestinationOutpostArn':: d.fn(help='"The ARN of the Outpost to which to copy the AMI. Only specify this parameter when copying an AMI from an AWS Region to an Outpost. The AMI must be in the Region of the destination Outpost."', args=[d.arg(name='destinationOutpostArn', type=d.T.string)]),
      ...
      '#withEncrypted':: d.fn(help='"Specifies whether the destination snapshots of the copied image should be encrypted. Defaults to false"', args=[d.arg(name='encrypted', type=d.T.boolean)]),
      ...
      '#withKmsKeyId':: d.fn(help='"The full ARN of the KMS Key to use when encrypting the snapshots of an image during a copy operation. If not specified, then the default AWS KMS Key will be used"', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
      ...
      '#withSourceAmiId':: d.fn(help='"The id of the AMI to copy. This id must be valid in the region given by source_ami_region."', args=[d.arg(name='sourceAmiId', type=d.T.string)]),
      withSourceAmiId(sourceAmiId): { spec+: { forProvider+: { sourceAmiId: sourceAmiId } } },
      '#withSourceAmiRegion':: d.fn(help='"The region from which the AMI will be copied. This may be the same as the AWS provider region in order to create a copy within the same region."', args=[d.arg(name='sourceAmiRegion', type=d.T.string)]),
