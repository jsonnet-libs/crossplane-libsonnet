{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withParentId':: d.fn(help='"The ID of the parent API resource"', args=[d.arg(name='parentId', type=d.T.string)]),
      withParentId(parentId): { spec+: { forProvider+: { parentId: parentId } } },
      '#withPathPart':: d.fn(help='"The last path segment of this API resource."', args=[d.arg(name='pathPart', type=d.T.string)]),
