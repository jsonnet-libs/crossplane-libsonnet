{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withKeyId':: d.fn(help='"The identifier of the API key resource."', args=[d.arg(name='keyId', type=d.T.string)]),
      withKeyId(keyId): { spec+: { forProvider+: { keyId: keyId } } },
      '#withKeyType':: d.fn(help='"The type of the API key resource. Currently, the valid key type is API_KEY."', args=[d.arg(name='keyType', type=d.T.string)]),
      ...
      '#withUsagePlanId':: d.fn(help='"The Id of the usage plan resource representing to associate the key to."', args=[d.arg(name='usagePlanId', type=d.T.string)]),
