{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResponseParameters':: d.fn(help='"A map of response parameters that can be read from the backend response. For example: response_parameters = { \\"method.response.header.X-Some-Header\\" = \\"integration.response.header.X-Some-Other-Header\\" }"', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParameters(responseParameters): { spec+: { forProvider+: { responseParameters: responseParameters } } },
      '#withResponseParametersMixin':: d.fn(help='"A map of response parameters that can be read from the backend response. For example: response_parameters = { \\"method.response.header.X-Some-Header\\" = \\"integration.response.header.X-Some-Other-Header\\" }"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParametersMixin(responseParameters): { spec+: { forProvider+: { responseParameters+: responseParameters } } },
      '#withResponseTemplates':: d.fn(help='"A map specifying the templates used to transform the integration response body"', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      withResponseTemplates(responseTemplates): { spec+: { forProvider+: { responseTemplates: responseTemplates } } },
      '#withResponseTemplatesMixin':: d.fn(help='"A map specifying the templates used to transform the integration response body"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      ...
      '#withSelectionPattern':: d.fn(help='"Specifies the regular expression pattern used to choose an integration response based on the response from the backend. Omit configuring this to make the integration the default one. If the backend is an AWS Lambda function, the AWS Lambda function error header is matched. For all other HTTP and AWS backends, the HTTP status code is matched."', args=[d.arg(name='selectionPattern', type=d.T.string)]),
      withSelectionPattern(selectionPattern): { spec+: { forProvider+: { selectionPattern: selectionPattern } } },
      '#withStatusCode':: d.fn(help='"The HTTP status code"', args=[d.arg(name='statusCode', type=d.T.string)]),
