{
  ...
  spec: {
    ...
    forProvider: {
      '#location':: d.obj(help='"The location of the targeted API entity of the to-be-created documentation part. See below."'),
      location: {
        '#withMethod':: d.fn(help='"The HTTP verb of a method. The default value is * for any method."', args=[d.arg(name='method', type=d.T.string)]),
        withMethod(method): { method: method },
        '#withName':: d.fn(help='"The name of the targeted API entity."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withPath':: d.fn(help='"The URL path of the target. The default value is / for the root resource."', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { path: path },
        '#withStatusCode':: d.fn(help='"The HTTP status code of a response. The default value is * for any status code."', args=[d.arg(name='statusCode', type=d.T.string)]),
        withStatusCode(statusCode): { statusCode: statusCode },
        '#withType':: d.fn(help='"The type of API entity to which the documentation content appliesE.g., API, METHOD or REQUEST_BODY"', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withLocation':: d.fn(help='"The location of the targeted API entity of the to-be-created documentation part. See below."', args=[d.arg(name='location', type=d.T.array)]),
      withLocation(location): { spec+: { forProvider+: { location: if std.isArray(v=location) then location else [location] } } },
      '#withLocationMixin':: d.fn(help='"The location of the targeted API entity of the to-be-created documentation part. See below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='location', type=d.T.array)]),
      withLocationMixin(location): { spec+: { forProvider+: { location+: if std.isArray(v=location) then location else [location] } } },
      '#withProperties':: d.fn(help='"A content map of API-specific key-value pairs describing the targeted API entity. The map must be encoded as a JSON string, e.g., \\"{ \\"description\\": \\"The API does ...\\" }\\". Only Swagger-compliant key-value pairs can be exported and, hence, published."', args=[d.arg(name='properties', type=d.T.string)]),
