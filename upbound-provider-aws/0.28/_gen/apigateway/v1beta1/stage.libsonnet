{
  ...
  spec: {
    ...
    forProvider: {
      ...
      accessLogSettings: {
        '#withDestinationArn':: d.fn(help='"The Amazon Resource Name (ARN) of the CloudWatch Logs log group or Kinesis Data Firehose delivery stream to receive access logs. If you specify a Kinesis Data Firehose delivery stream, the stream name must begin with amazon-apigateway-. Automatically removes trailing :* if present."', args=[d.arg(name='destinationArn', type=d.T.string)]),
        withDestinationArn(destinationArn): { destinationArn: destinationArn },
        '#withFormat':: d.fn(help='"The formatting and values recorded in the logs. For more information on configuring the log format rules visit the AWS documentation"', args=[d.arg(name='format', type=d.T.string)]),
      ...
      canarySettings: {
        '#withPercentTraffic':: d.fn(help='"The percent 0.0 - 100.0 of traffic to divert to the canary deployment."', args=[d.arg(name='percentTraffic', type=d.T.number)]),
        withPercentTraffic(percentTraffic): { percentTraffic: percentTraffic },
        '#withStageVariableOverrides':: d.fn(help='"A map of overridden stage variables (including new variables) for the canary deployment."', args=[d.arg(name='stageVariableOverrides', type=d.T.object)]),
        withStageVariableOverrides(stageVariableOverrides): { stageVariableOverrides: stageVariableOverrides },
        '#withStageVariableOverridesMixin':: d.fn(help='"A map of overridden stage variables (including new variables) for the canary deployment."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='stageVariableOverrides', type=d.T.object)]),
      ...
      '#withCacheClusterEnabled':: d.fn(help='"Specifies whether a cache cluster is enabled for the stage"', args=[d.arg(name='cacheClusterEnabled', type=d.T.boolean)]),
      withCacheClusterEnabled(cacheClusterEnabled): { spec+: { forProvider+: { cacheClusterEnabled: cacheClusterEnabled } } },
      '#withCacheClusterSize':: d.fn(help='"The size of the cache cluster for the stage, if enabled. Allowed values include 0.5, 1.6, 6.1, 13.5, 28.4, 58.2, 118 and 237."', args=[d.arg(name='cacheClusterSize', type=d.T.string)]),
      ...
      '#withClientCertificateId':: d.fn(help='"The identifier of a client certificate for the stage."', args=[d.arg(name='clientCertificateId', type=d.T.string)]),
      withClientCertificateId(clientCertificateId): { spec+: { forProvider+: { clientCertificateId: clientCertificateId } } },
      '#withDeploymentId':: d.fn(help='"The ID of the deployment that the stage points to"', args=[d.arg(name='deploymentId', type=d.T.string)]),
      withDeploymentId(deploymentId): { spec+: { forProvider+: { deploymentId: deploymentId } } },
      '#withDescription':: d.fn(help='"The description of the stage."', args=[d.arg(name='description', type=d.T.string)]),
      ...
      '#withVariables':: d.fn(help='"A map that defines the stage variables"', args=[d.arg(name='variables', type=d.T.object)]),
      withVariables(variables): { spec+: { forProvider+: { variables: variables } } },
      '#withVariablesMixin':: d.fn(help='"A map that defines the stage variables"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.object)]),
