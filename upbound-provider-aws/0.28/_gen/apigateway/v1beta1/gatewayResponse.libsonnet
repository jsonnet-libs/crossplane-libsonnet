{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withResponseParameters':: d.fn(help='"A map specifying the parameters (paths, query strings and headers) of the Gateway Response."', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParameters(responseParameters): { spec+: { forProvider+: { responseParameters: responseParameters } } },
      '#withResponseParametersMixin':: d.fn(help='"A map specifying the parameters (paths, query strings and headers) of the Gateway Response."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseParameters', type=d.T.object)]),
      withResponseParametersMixin(responseParameters): { spec+: { forProvider+: { responseParameters+: responseParameters } } },
      '#withResponseTemplates':: d.fn(help='"A map specifying the templates used to transform the response body."', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      withResponseTemplates(responseTemplates): { spec+: { forProvider+: { responseTemplates: responseTemplates } } },
      '#withResponseTemplatesMixin':: d.fn(help='"A map specifying the templates used to transform the response body."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseTemplates', type=d.T.object)]),
      withResponseTemplatesMixin(responseTemplates): { spec+: { forProvider+: { responseTemplates+: responseTemplates } } },
      '#withResponseType':: d.fn(help='"The response type of the associated GatewayResponse."', args=[d.arg(name='responseType', type=d.T.string)]),
      ...
      '#withStatusCode':: d.fn(help='"The HTTP status code of the Gateway Response."', args=[d.arg(name='statusCode', type=d.T.string)]),
