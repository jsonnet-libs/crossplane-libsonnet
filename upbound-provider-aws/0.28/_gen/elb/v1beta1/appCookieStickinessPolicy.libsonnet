{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withCookieName':: d.fn(help="\"The application cookie whose lifetime the ELB's cookie should follow.\"", args=[d.arg(name='cookieName', type=d.T.string)]),
      ...
      '#withLoadBalancer':: d.fn(help='"The name of load balancer to which the policy should be attached."', args=[d.arg(name='loadBalancer', type=d.T.string)]),
