{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstancePorts':: d.fn(help='"List of instance ports to which the policy should be applied. This can be specified if the protocol is SSL or TCP."', args=[d.arg(name='instancePorts', type=d.T.array)]),
      ...
      '#withInstancePortsMixin':: d.fn(help='"List of instance ports to which the policy should be applied. This can be specified if the protocol is SSL or TCP."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='instancePorts', type=d.T.array)]),
