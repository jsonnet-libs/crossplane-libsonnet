{
  ...
  '#':: d.pkg(name='keyPair', url='', help='"KeyPair is the Schema for the KeyPairs API. Provides an Lightsail Key Pair"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"The name of the Lightsail Key Pair"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPgpKey':: d.fn(help='"–  An optional PGP key to encrypt the resulting private key material. Only used when creating a new key pair"', args=[d.arg(name='pgpKey', type=d.T.string)]),
      withPgpKey(pgpKey): { spec+: { forProvider+: { pgpKey: pgpKey } } },
      '#withPublicKey':: d.fn(help='"The public key material. This public key will be imported into Lightsail"', args=[d.arg(name='publicKey', type=d.T.string)]),
