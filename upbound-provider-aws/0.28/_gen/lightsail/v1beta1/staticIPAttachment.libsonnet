{
  ...
  '#':: d.pkg(name='staticIPAttachment', url='', help='"StaticIPAttachment is the Schema for the StaticIPAttachments API. Provides an Lightsail Static IP Attachment"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withInstanceName':: d.fn(help='"The name of the Lightsail instance to attach the IP to"', args=[d.arg(name='instanceName', type=d.T.string)]),
      ...
      '#withStaticIpName':: d.fn(help='"The name of the allocated static IP"', args=[d.arg(name='staticIpName', type=d.T.string)]),
