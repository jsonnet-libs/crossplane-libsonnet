{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"The description of the model. Must be between 1 and 128 characters in length."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"The name of the model. Must be alphanumeric. Must be between 1 and 128 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSchema':: d.fn(help='"The schema for the model. This should be a JSON schema draft 4 model. Must be less than or equal to 32768 characters in length."', args=[d.arg(name='schema', type=d.T.string)]),
