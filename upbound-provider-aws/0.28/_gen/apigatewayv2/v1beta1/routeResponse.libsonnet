{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#routeIdRef':: d.obj(help='"Reference to a Route to populate routeId."'),
      routeIdRef: {
        '#policy':: d.obj(help='"Policies for referencing."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#routeIdSelector':: d.obj(help='"Selector for a Route to populate routeId."'),
      routeIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
      ...
      '#withResponseModels':: d.fn(help='"The response models for the route response."', args=[d.arg(name='responseModels', type=d.T.object)]),
      withResponseModels(responseModels): { spec+: { forProvider+: { responseModels: responseModels } } },
      '#withResponseModelsMixin':: d.fn(help='"The response models for the route response."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='responseModels', type=d.T.object)]),
      withResponseModelsMixin(responseModels): { spec+: { forProvider+: { responseModels+: responseModels } } },
      '#withRouteId':: d.fn(help='"The identifier of the aws_apigatewayv2_route."', args=[d.arg(name='routeId', type=d.T.string)]),
      withRouteId(routeId): { spec+: { forProvider+: { routeId: routeId } } },
      '#withRouteResponseKey':: d.fn(help='"The route response key."', args=[d.arg(name='routeResponseKey', type=d.T.string)]),
