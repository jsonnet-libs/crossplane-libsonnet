{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#spec':: d.obj(help='"The virtual router specification to apply."'),
      spec: {
      ...
      '#withMeshName':: d.fn(help='"The name of the service mesh in which to create the virtual router. Must be between 1 and 255 characters in length."', args=[d.arg(name='meshName', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name to use for the virtual router. Must be between 1 and 255 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
