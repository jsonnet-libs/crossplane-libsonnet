{
  ...
  spec: {
    ...
    forProvider: {
      '#spec':: d.obj(help='"The service mesh specification to apply."'),
      spec: {
        '#egressFilter':: d.obj(help='"The egress filter rules for the service mesh."'),
        egressFilter: {
          '#withType':: d.fn(help='"The egress filter type. By default, the type is DROP_ALL. Valid values are ALLOW_ALL and DROP_ALL."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        '#withEgressFilter':: d.fn(help='"The egress filter rules for the service mesh."', args=[d.arg(name='egressFilter', type=d.T.array)]),
        withEgressFilter(egressFilter): { egressFilter: if std.isArray(v=egressFilter) then egressFilter else [egressFilter] },
        '#withEgressFilterMixin':: d.fn(help='"The egress filter rules for the service mesh."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='egressFilter', type=d.T.array)]),
