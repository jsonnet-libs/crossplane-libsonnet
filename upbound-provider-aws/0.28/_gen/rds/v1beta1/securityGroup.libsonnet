{
  ...
  '#':: d.pkg(name='securityGroup', url='', help='"SecurityGroup is the Schema for the SecurityGroups API. Provides an RDS security group resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#ingress':: d.obj(help='"A list of ingress rules."'),
      ingress: {
        '#withCidr':: d.fn(help='"The CIDR block to accept"', args=[d.arg(name='cidr', type=d.T.string)]),
        withCidr(cidr): { cidr: cidr },
        '#withSecurityGroupId':: d.fn(help='"The ID of the security group to authorize"', args=[d.arg(name='securityGroupId', type=d.T.string)]),
        withSecurityGroupId(securityGroupId): { securityGroupId: securityGroupId },
        '#withSecurityGroupName':: d.fn(help='"The name of the security group to authorize"', args=[d.arg(name='securityGroupName', type=d.T.string)]),
        withSecurityGroupName(securityGroupName): { securityGroupName: securityGroupName },
        '#withSecurityGroupOwnerId':: d.fn(help='"The owner Id of the security group provided by security_group_name."', args=[d.arg(name='securityGroupOwnerId', type=d.T.string)]),
        withSecurityGroupOwnerId(securityGroupOwnerId): { securityGroupOwnerId: securityGroupOwnerId },
      },
      '#withDescription':: d.fn(help='"The description of the DB security group."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIngress':: d.fn(help='"A list of ingress rules."', args=[d.arg(name='ingress', type=d.T.array)]),
      withIngress(ingress): { spec+: { forProvider+: { ingress: if std.isArray(v=ingress) then ingress else [ingress] } } },
      '#withIngressMixin':: d.fn(help='"A list of ingress rules."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingress', type=d.T.array)]),
