{
  ...
  spec: {
    ...
    forProvider: {
      ...
      datasources: {
        '#s3Logs':: d.obj(help='"Describes whether S3 data event logs are enabled as a data source. See S3 Logs below for more details."'),
        s3Logs: {
        ...
        '#withS3Logs':: d.fn(help='"Describes whether S3 data event logs are enabled as a data source. See S3 Logs below for more details."', args=[d.arg(name='s3Logs', type=d.T.array)]),
        withS3Logs(s3Logs): { s3Logs: if std.isArray(v=s3Logs) then s3Logs else [s3Logs] },
        '#withS3LogsMixin':: d.fn(help='"Describes whether S3 data event logs are enabled as a data source. See S3 Logs below for more details."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='s3Logs', type=d.T.array)]),
