{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#setting':: d.obj(help='"–  Option settings to configure the new Environment. These override specific values that are set as defaults. The format is detailed below in Option Settings"'),
      setting: {
      ...
      '#withSetting':: d.fn(help='"–  Option settings to configure the new Environment. These override specific values that are set as defaults. The format is detailed below in Option Settings"', args=[d.arg(name='setting', type=d.T.array)]),
      withSetting(setting): { spec+: { forProvider+: { setting: if std.isArray(v=setting) then setting else [setting] } } },
      '#withSettingMixin':: d.fn(help='"–  Option settings to configure the new Environment. These override specific values that are set as defaults. The format is detailed below in Option Settings"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='setting', type=d.T.array)]),
      withSettingMixin(setting): { spec+: { forProvider+: { setting+: if std.isArray(v=setting) then setting else [setting] } } },
      '#withSolutionStackName':: d.fn(help='"–  A solution stack to base your Template off of. Example stacks can be found in the Amazon API documentation"', args=[d.arg(name='solutionStackName', type=d.T.string)]),
