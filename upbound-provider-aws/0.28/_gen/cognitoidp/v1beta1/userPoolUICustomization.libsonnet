{
  ...
  spec: {
    ...
    forProvider: {
      '#clientIdRef':: d.obj(help='"Reference to a UserPoolClient to populate clientId."'),
      clientIdRef: {
      ...
      '#clientIdSelector':: d.obj(help='"Selector for a UserPoolClient to populate clientId."'),
      clientIdSelector: {
