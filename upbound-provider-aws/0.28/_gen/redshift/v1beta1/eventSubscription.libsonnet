{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSeverity':: d.fn(help='"The event severity to be published by the notification subscription. Valid options are INFO or ERROR."', args=[d.arg(name='severity', type=d.T.string)]),
      ...
      '#withSourceType':: d.fn(help='"The type of source that will be generating the events. Valid options are cluster, cluster-parameter-group, cluster-security-group, or cluster-snapshot. If not set, all sources will be subscribed to."', args=[d.arg(name='sourceType', type=d.T.string)]),
