{
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"Name of the account setting to set. Valid values are serviceLongArnFormat, taskLongArnFormat, containerInstanceLongArnFormat, awsvpcTrunking and containerInsights."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withValue':: d.fn(help='"State of the setting. Valid values are enabled and disabled."', args=[d.arg(name='value', type=d.T.string)]),
