{
  ...
  spec: {
    ...
    forProvider: {
      '#certificateAuthorityArnRef':: d.obj(help='"Reference to a CertificateAuthority to populate certificateAuthorityArn."'),
      ...
      '#certificateAuthorityArnSelector':: d.obj(help='"Selector for a CertificateAuthority to populate certificateAuthorityArn."'),
      ...
      '#certificateChainSecretRef':: d.obj(help='"The PEM-encoded certificate chain that includes any intermediate certificates and chains up to root CA. Required for subordinate Certificate Authorities. Not allowed for root Certificate Authorities."'),
      ...
      '#certificateSecretRef':: d.obj(help='"The PEM-encoded certificate for the Certificate Authority."'),
      ...
      '#withCertificateAuthorityArn':: d.fn(help='"Amazon Resource Name (ARN) of the Certificate Authority."', args=[d.arg(name='certificateAuthorityArn', type=d.T.string)]),
