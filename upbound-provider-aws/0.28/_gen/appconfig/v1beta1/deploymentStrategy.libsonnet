{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDescription':: d.fn(help='"A description of the deployment strategy. Can be at most 1024 characters."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withFinalBakeTimeInMinutes':: d.fn(help='"The amount of time AWS AppConfig monitors for alarms before considering the deployment to be complete and no longer eligible for automatic roll back. Minimum value of 0, maximum value of 1440."', args=[d.arg(name='finalBakeTimeInMinutes', type=d.T.number)]),
      withFinalBakeTimeInMinutes(finalBakeTimeInMinutes): { spec+: { forProvider+: { finalBakeTimeInMinutes: finalBakeTimeInMinutes } } },
      '#withGrowthFactor':: d.fn(help='"The percentage of targets to receive a deployed configuration during each interval. Minimum value of 1.0, maximum value of 100.0."', args=[d.arg(name='growthFactor', type=d.T.number)]),
      withGrowthFactor(growthFactor): { spec+: { forProvider+: { growthFactor: growthFactor } } },
      '#withGrowthType':: d.fn(help='"The algorithm used to define how percentage grows over time. Valid value: LINEAR and EXPONENTIAL. Defaults to LINEAR."', args=[d.arg(name='growthType', type=d.T.string)]),
      withGrowthType(growthType): { spec+: { forProvider+: { growthType: growthType } } },
      '#withName':: d.fn(help='"A name for the deployment strategy. Must be between 1 and 64 characters in length."', args=[d.arg(name='name', type=d.T.string)]),
