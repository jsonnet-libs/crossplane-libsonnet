{
  ...
  '#':: d.pkg(name='device', url='', help='"Device is the Schema for the Devices API. Provides a SageMaker Device resource."'),
  ...
  spec: {
    ...
    forProvider: {
      '#device':: d.obj(help='"The device to register with SageMaker Edge Manager. See Device details below."'),
      device: {
      ...
      '#withDevice':: d.fn(help='"The device to register with SageMaker Edge Manager. See Device details below."', args=[d.arg(name='device', type=d.T.array)]),
      ...
      '#withDeviceMixin':: d.fn(help='"The device to register with SageMaker Edge Manager. See Device details below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='device', type=d.T.array)]),
