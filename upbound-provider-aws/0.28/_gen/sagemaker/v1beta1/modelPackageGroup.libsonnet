{
  ...
  '#':: d.pkg(name='modelPackageGroup', url='', help='"ModelPackageGroup is the Schema for the ModelPackageGroups API. Provides a SageMaker Model Package Group resource."'),
