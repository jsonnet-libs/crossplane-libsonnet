{
  ...
  '#':: d.pkg(name='studioLifecycleConfig', url='', help='"StudioLifecycleConfig is the Schema for the StudioLifecycleConfigs API. Provides a SageMaker Studio Lifecycle Config resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withStudioLifecycleConfigAppType':: d.fn(help='"The App type that the Lifecycle Configuration is attached to. Valid values are JupyterServer and KernelGateway."', args=[d.arg(name='studioLifecycleConfigAppType', type=d.T.string)]),
