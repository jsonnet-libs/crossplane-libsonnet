{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPlatformIdentifier':: d.fn(help='"The platform identifier of the notebook instance runtime environment. This value can be either notebook-al1-v1 or notebook-al2-v1, depending on which version of Amazon Linux you require."', args=[d.arg(name='platformIdentifier', type=d.T.string)]),
