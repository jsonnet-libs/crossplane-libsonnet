{
  ...
  '#':: d.pkg(name='linkAssociation', url='', help='"LinkAssociation is the Schema for the LinkAssociations API. Associates a link to a device."'),
  ...
  spec: {
    ...
    forProvider: {
      '#deviceIdRef':: d.obj(help='"Reference to a Device to populate deviceId."'),
      deviceIdRef: {
      ...
      '#deviceIdSelector':: d.obj(help='"Selector for a Device to populate deviceId."'),
      deviceIdSelector: {
