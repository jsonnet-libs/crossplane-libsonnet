  ...
  spec: {
    ...
    forProvider: {
      ...
      geoMatchConstraint: {
        ...
        '#withValue':: d.fn(help='"The country that you want AWS WAF to search for. This is the two-letter country code, e.g., US, CA, RU, CN, etc. See docs for all supported values."', args=[d.arg(name='value', type=d.T.string)]),
