  ...
  spec: {
    ...
    forProvider: {
      ...
      sizeConstraints: {
        ...
        fieldToMatch: {
          '#withData':: d.fn(help='"When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field."', args=[d.arg(name='data', type=d.T.string)]),
          withData(data): { data: data },
          '#withType':: d.fn(help='"The part of the web request that you want AWS WAF to search for a specified string. e.g., HEADER, METHOD or BODY. See docs for all supported values."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        '#withComparisonOperator':: d.fn(help='"The type of comparison you want to perform. e.g., EQ, NE, LT, GT. See docs for all supported values."', args=[d.arg(name='comparisonOperator', type=d.T.string)]),
        ...
        '#withSize':: d.fn(help='"The size in bytes that you want to compare against the size of the specified field_to_match. Valid values are between 0 - 21474836480 bytes (0 - 20 GB)."', args=[d.arg(name='size', type=d.T.number)]),
        withSize(size): { size: size },
        '#withTextTransformation':: d.fn(help='"Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on field_to_match before inspecting a request for a match. e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE. See docs for all supported values. Note: if you choose BODY as type, you must choose NONE because CloudFront forwards only the first 8192 bytes for inspection."', args=[d.arg(name='textTransformation', type=d.T.string)]),
