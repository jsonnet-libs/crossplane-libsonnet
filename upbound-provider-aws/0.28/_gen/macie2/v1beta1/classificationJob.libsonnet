{
  ...
  spec: {
    ...
    forProvider: {
      ...
      s3JobDefinition: {
        '#bucketDefinitions':: d.obj(help='"An array of objects, one for each AWS account that owns buckets to analyze. Each object specifies the account ID for an account and one or more buckets to analyze for the account. (documented below)"'),
        bucketDefinitions: {
          ...
          excludes: {
            ...
            and: {
              ...
              tagScopeTerm: {
                ...
                '#withTarget':: d.fn(help='"The type of object to apply the condition to."', args=[d.arg(name='target', type=d.T.string)]),
        ...
        '#withBucketDefinitions':: d.fn(help='"An array of objects, one for each AWS account that owns buckets to analyze. Each object specifies the account ID for an account and one or more buckets to analyze for the account. (documented below)"', args=[d.arg(name='bucketDefinitions', type=d.T.array)]),
        ...
        '#withBucketDefinitionsMixin':: d.fn(help='"An array of objects, one for each AWS account that owns buckets to analyze. Each object specifies the account ID for an account and one or more buckets to analyze for the account. (documented below)"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='bucketDefinitions', type=d.T.array)]),
