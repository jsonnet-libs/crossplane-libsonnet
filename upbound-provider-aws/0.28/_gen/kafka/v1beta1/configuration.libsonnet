{
  ...
  '#':: d.pkg(name='configuration', url='', help='"Configuration is the Schema for the Configurations API. Upbound official provider resource for managing an amazon managed streaming for kafka configuration"'),
