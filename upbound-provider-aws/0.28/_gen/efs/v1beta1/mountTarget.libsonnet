{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#fileSystemIdSelector':: d.obj(help='"Selector for a FileSystem to populate fileSystemId."'),
      ...
      '#withIpAddress':: d.fn(help='"The address (within the address range of the specified subnet) at which the file system may be mounted via the mount target."', args=[d.arg(name='ipAddress', type=d.T.string)]),
      ...
      '#withSecurityGroups':: d.fn(help='"A list of up to 5 VPC security group IDs (that must be for the same VPC as subnet specified) in effect for the mount target."', args=[d.arg(name='securityGroups', type=d.T.array)]),
      ...
      '#withSecurityGroupsMixin':: d.fn(help='"A list of up to 5 VPC security group IDs (that must be for the same VPC as subnet specified) in effect for the mount target."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='securityGroups', type=d.T.array)]),
