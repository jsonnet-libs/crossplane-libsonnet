{
  ...
  '#':: d.pkg(name='cluster', url='', help='"Cluster is the Schema for the Clusters API. Manages a DocDB Aurora Cluster"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#masterPasswordSecretRef':: d.obj(help='"Password for the master DB user. Note that this may show up in logs, and it will be stored in the state file. Please refer to the DocDB Naming Constraints."'),
      ...
      '#withEnabledCloudwatchLogsExports':: d.fn(help='"List of log types to export to cloudwatch. If omitted, no logs will be exported. The following log types are supported: audit, profiler."', args=[d.arg(name='enabledCloudwatchLogsExports', type=d.T.array)]),
      ...
      '#withEnabledCloudwatchLogsExportsMixin':: d.fn(help='"List of log types to export to cloudwatch. If omitted, no logs will be exported. The following log types are supported: audit, profiler."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enabledCloudwatchLogsExports', type=d.T.array)]),
