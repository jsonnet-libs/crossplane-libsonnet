{
  ...
  spec: {
    ...
    forProvider: {
      '#accessControlPolicy':: d.obj(help='"A configuration block that sets the ACL permissions for an object per grantee documented below."'),
      accessControlPolicy: {
        '#grant':: d.obj(help='"Set of grant configuration blocks documented below."'),
        grant: {
          '#grantee':: d.obj(help='"Configuration block for the person being granted permissions documented below."'),
          grantee: {
            ...
            '#withId':: d.fn(help='"The ID of the owner."', args=[d.arg(name='id', type=d.T.string)]),
            withId(id): { id: id },
          ...
          '#withGrantee':: d.fn(help='"Configuration block for the person being granted permissions documented below."', args=[d.arg(name='grantee', type=d.T.array)]),
          withGrantee(grantee): { grantee: if std.isArray(v=grantee) then grantee else [grantee] },
          '#withGranteeMixin':: d.fn(help='"Configuration block for the person being granted permissions documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='grantee', type=d.T.array)]),
          withGranteeMixin(grantee): { grantee+: if std.isArray(v=grantee) then grantee else [grantee] },
          '#withPermission':: d.fn(help='"Logging permissions assigned to the grantee for the bucket."', args=[d.arg(name='permission', type=d.T.string)]),
          withPermission(permission): { permission: permission },
        },
        '#owner':: d.obj(help="\"Configuration block of the bucket owner's display name and ID documented below.\""),
        owner: {
          '#withDisplayName':: d.fn(help='"The display name of the owner."', args=[d.arg(name='displayName', type=d.T.string)]),
          withDisplayName(displayName): { displayName: displayName },
          '#withId':: d.fn(help='"The ID of the owner."', args=[d.arg(name='id', type=d.T.string)]),
          withId(id): { id: id },
        },
        '#withGrant':: d.fn(help='"Set of grant configuration blocks documented below."', args=[d.arg(name='grant', type=d.T.array)]),
        withGrant(grant): { grant: if std.isArray(v=grant) then grant else [grant] },
        '#withGrantMixin':: d.fn(help='"Set of grant configuration blocks documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='grant', type=d.T.array)]),
        withGrantMixin(grant): { grant+: if std.isArray(v=grant) then grant else [grant] },
        '#withOwner':: d.fn(help="\"Configuration block of the bucket owner's display name and ID documented below.\"", args=[d.arg(name='owner', type=d.T.array)]),
        withOwner(owner): { owner: if std.isArray(v=owner) then owner else [owner] },
        '#withOwnerMixin':: d.fn(help="\"Configuration block of the bucket owner's display name and ID documented below.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='owner', type=d.T.array)]),
      ...
      '#withAccessControlPolicy':: d.fn(help='"A configuration block that sets the ACL permissions for an object per grantee documented below."', args=[d.arg(name='accessControlPolicy', type=d.T.array)]),
      ...
      '#withAccessControlPolicyMixin':: d.fn(help='"A configuration block that sets the ACL permissions for an object per grantee documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='accessControlPolicy', type=d.T.array)]),
