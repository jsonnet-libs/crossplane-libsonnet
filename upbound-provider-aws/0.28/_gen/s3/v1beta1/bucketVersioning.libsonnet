{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#versioningConfiguration':: d.obj(help='"Configuration block for the versioning parameters detailed below."'),
      ...
      '#withBucket':: d.fn(help='"The name of the S3 bucket."', args=[d.arg(name='bucket', type=d.T.string)]),
      ...
      '#withMfa':: d.fn(help="\"The concatenation of the authentication device's serial number, a space, and the value that is displayed on your authentication device.\"", args=[d.arg(name='mfa', type=d.T.string)]),
      ...
      '#withVersioningConfiguration':: d.fn(help='"Configuration block for the versioning parameters detailed below."', args=[d.arg(name='versioningConfiguration', type=d.T.array)]),
