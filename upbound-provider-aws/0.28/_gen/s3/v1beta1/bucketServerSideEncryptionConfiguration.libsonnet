{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#rule':: d.obj(help='"Set of server-side encryption configuration rules. documented below. Currently, only a single rule is supported."'),
      rule: {
        '#applyServerSideEncryptionByDefault':: d.obj(help='"A single object for setting server-side encryption by default documented below"'),
        applyServerSideEncryptionByDefault: {
          ...
          '#withKmsMasterKeyId':: d.fn(help='"The AWS KMS master key ID used for the SSE-KMS encryption. This can only be used when you set the value of sse_algorithm as aws:kms. The default aws/s3 AWS KMS master key is used if this element is absent while the sse_algorithm is aws:kms."', args=[d.arg(name='kmsMasterKeyId', type=d.T.string)]),
          withKmsMasterKeyId(kmsMasterKeyId): { kmsMasterKeyId: kmsMasterKeyId },
          '#withSseAlgorithm':: d.fn(help='"The server-side encryption algorithm to use. Valid values are AES256 and aws:kms"', args=[d.arg(name='sseAlgorithm', type=d.T.string)]),
          withSseAlgorithm(sseAlgorithm): { sseAlgorithm: sseAlgorithm },
        },
        '#withApplyServerSideEncryptionByDefault':: d.fn(help='"A single object for setting server-side encryption by default documented below"', args=[d.arg(name='applyServerSideEncryptionByDefault', type=d.T.array)]),
        ...
        '#withApplyServerSideEncryptionByDefaultMixin':: d.fn(help='"A single object for setting server-side encryption by default documented below"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='applyServerSideEncryptionByDefault', type=d.T.array)]),
      ...
      '#withRule':: d.fn(help='"Set of server-side encryption configuration rules. documented below. Currently, only a single rule is supported."', args=[d.arg(name='rule', type=d.T.array)]),
      withRule(rule): { spec+: { forProvider+: { rule: if std.isArray(v=rule) then rule else [rule] } } },
      '#withRuleMixin':: d.fn(help='"Set of server-side encryption configuration rules. documented below. Currently, only a single rule is supported."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rule', type=d.T.array)]),
