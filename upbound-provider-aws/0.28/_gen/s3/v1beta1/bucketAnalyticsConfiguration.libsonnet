{
  ...
  spec: {
    ...
    forProvider: {
        ...
        dataExport: {
          ...
          destination: {
            ...
            s3BucketDestination: {
              ...
              '#withBucketAccountId':: d.fn(help='"The account ID that owns the destination bucket."', args=[d.arg(name='bucketAccountId', type=d.T.string)]),
              withBucketAccountId(bucketAccountId): { bucketAccountId: bucketAccountId },
              '#withBucketArn':: d.fn(help='"The ARN of the destination bucket."', args=[d.arg(name='bucketArn', type=d.T.string)]),
              withBucketArn(bucketArn): { bucketArn: bucketArn },
              '#withFormat':: d.fn(help='"The output format of exported analytics data. Allowed values: CSV. Default value: CSV."', args=[d.arg(name='format', type=d.T.string)]),
          ...
          '#withOutputSchemaVersion':: d.fn(help='"The schema version of exported analytics data. Allowed values: V_1. Default value: V_1."', args=[d.arg(name='outputSchemaVersion', type=d.T.string)]),
      ...
      '#withBucket':: d.fn(help='"The name of the bucket this analytics configuration is associated with."', args=[d.arg(name='bucket', type=d.T.string)]),
