{
  ...
  spec: {
    ...
    forProvider: {
      '#ipAddress':: d.obj(help='"The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."'),
      ipAddress: {
      ...
      '#withDirection':: d.fn(help='"The direction of DNS queries to or from the Route 53 Resolver endpoint. Valid values are INBOUND (resolver forwards DNS queries to the DNS service for a VPC from your network or another VPC) or OUTBOUND (resolver forwards DNS queries from the DNS service for a VPC to your network or another VPC)."', args=[d.arg(name='direction', type=d.T.string)]),
      withDirection(direction): { spec+: { forProvider+: { direction: direction } } },
      '#withIpAddress':: d.fn(help='"The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."', args=[d.arg(name='ipAddress', type=d.T.array)]),
      withIpAddress(ipAddress): { spec+: { forProvider+: { ipAddress: if std.isArray(v=ipAddress) then ipAddress else [ipAddress] } } },
      '#withIpAddressMixin':: d.fn(help='"The subnets and IP addresses in your VPC that you want DNS queries to pass through on the way from your VPCs to your network (for outbound endpoints) or on the way from your network to your VPCs (for inbound endpoints). Described below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ipAddress', type=d.T.array)]),
