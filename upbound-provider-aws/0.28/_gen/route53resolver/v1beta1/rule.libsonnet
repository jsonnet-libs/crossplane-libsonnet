{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#targetIp':: d.obj(help='"Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below). This argument should only be specified for FORWARD type rules."'),
      targetIp: {
        '#withIp':: d.fn(help='"One IP address that you want to forward DNS queries to. You can specify only IPv4 addresses."', args=[d.arg(name='ip', type=d.T.string)]),
        withIp(ip): { ip: ip },
        '#withPort':: d.fn(help='"The port at ip that you want to forward DNS queries to. Default value is 53"', args=[d.arg(name='port', type=d.T.number)]),
      ...
      '#withResolverEndpointId':: d.fn(help='"The ID of the outbound resolver endpoint that you want to use to route DNS queries to the IP addresses that you specify using target_ip. This argument should only be specified for FORWARD type rules."', args=[d.arg(name='resolverEndpointId', type=d.T.string)]),
      withResolverEndpointId(resolverEndpointId): { spec+: { forProvider+: { resolverEndpointId: resolverEndpointId } } },
      '#withRuleType':: d.fn(help='"The rule type. Valid values are FORWARD, SYSTEM and RECURSIVE."', args=[d.arg(name='ruleType', type=d.T.string)]),
      ...
      '#withTargetIp':: d.fn(help='"Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below). This argument should only be specified for FORWARD type rules."', args=[d.arg(name='targetIp', type=d.T.array)]),
      withTargetIp(targetIp): { spec+: { forProvider+: { targetIp: if std.isArray(v=targetIp) then targetIp else [targetIp] } } },
      '#withTargetIpMixin':: d.fn(help='"Configuration block(s) indicating the IPs that you want Resolver to forward DNS queries to (documented below). This argument should only be specified for FORWARD type rules."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetIp', type=d.T.array)]),
