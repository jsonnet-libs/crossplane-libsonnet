  ...
  spec: {
    ...
    forProvider: {
      ...
      byteMatchTuples: {
        ...
        '#withTargetString':: d.fn(help='"The value that you want to search forE.g., HEADER, METHOD or BODY. See docs for all supported values."', args=[d.arg(name='targetString', type=d.T.string)]),
