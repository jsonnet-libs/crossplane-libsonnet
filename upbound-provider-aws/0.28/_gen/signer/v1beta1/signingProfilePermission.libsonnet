{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withAction':: d.fn(help='"An AWS Signer action permitted as part of cross-account permissions. Valid values: signer:StartSigningJob, signer:GetSigningProfile, or signer:RevokeSignature."', args=[d.arg(name='action', type=d.T.string)]),
