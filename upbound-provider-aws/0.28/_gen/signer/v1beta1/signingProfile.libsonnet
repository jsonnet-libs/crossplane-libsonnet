{
  ...
  spec: {
    ...
    forProvider: {
      '#signatureValidityPeriod':: d.obj(help='"The validity period for a signing job."'),
      ...
      '#withSignatureValidityPeriod':: d.fn(help='"The validity period for a signing job."', args=[d.arg(name='signatureValidityPeriod', type=d.T.array)]),
