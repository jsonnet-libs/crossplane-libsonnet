{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDeploymentType':: d.fn(help='"- The filesystem deployment type. Supports MULTI_AZ_1 and SINGLE_AZ_1."', args=[d.arg(name='deploymentType', type=d.T.string)]),
      ...
      '#withStorageCapacity':: d.fn(help='"The storage capacity (GiB) of the file system. Valid values between 1024 and 196608."', args=[d.arg(name='storageCapacity', type=d.T.number)]),
      ...
      '#withSubnetIds':: d.fn(help='"A list of IDs for the subnets that the file system will be accessible from. Upto 2 subnets can be provided."', args=[d.arg(name='subnetIds', type=d.T.array)]),
      withSubnetIds(subnetIds): { spec+: { forProvider+: { subnetIds: if std.isArray(v=subnetIds) then subnetIds else [subnetIds] } } },
      '#withSubnetIdsMixin':: d.fn(help='"A list of IDs for the subnets that the file system will be accessible from. Upto 2 subnets can be provided."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='subnetIds', type=d.T.array)]),
      ...
      '#withThroughputCapacity':: d.fn(help="\"Sets the throughput capacity (in MBps) for the file system that you're creating. Valid values are 128, 256, 512, 1024, and 2048.\"", args=[d.arg(name='throughputCapacity', type=d.T.number)]),
