{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMaxConcurrency':: d.fn(help='"The maximal number of concurrent requests that you want an instance to process. When the number of concurrent requests goes over this limit, App Runner scales up your service."', args=[d.arg(name='maxConcurrency', type=d.T.number)]),
      withMaxConcurrency(maxConcurrency): { spec+: { forProvider+: { maxConcurrency: maxConcurrency } } },
      '#withMaxSize':: d.fn(help='"The maximal number of instances that App Runner provisions for your service."', args=[d.arg(name='maxSize', type=d.T.number)]),
      withMaxSize(maxSize): { spec+: { forProvider+: { maxSize: maxSize } } },
      '#withMinSize':: d.fn(help='"The minimal number of instances that App Runner provisions for your service."', args=[d.arg(name='minSize', type=d.T.number)]),
