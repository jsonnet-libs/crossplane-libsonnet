{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApiId':: d.fn(help='"The GraphQL API ID."', args=[d.arg(name='apiId', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"The cache instance type. Valid values are SMALL, MEDIUM, LARGE, XLARGE, LARGE_2X, LARGE_4X, LARGE_8X, LARGE_12X, T2_SMALL, T2_MEDIUM, R4_LARGE, R4_XLARGE, R4_2XLARGE, R4_4XLARGE, R4_8XLARGE."', args=[d.arg(name='type', type=d.T.string)]),
