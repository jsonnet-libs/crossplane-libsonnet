{
  ...
  spec: {
    ...
    forProvider: {
      '#acceleratorArnRef':: d.obj(help='"Reference to a Accelerator to populate acceleratorArn."'),
      acceleratorArnRef: {
      ...
      '#acceleratorArnSelector':: d.obj(help='"Selector for a Accelerator to populate acceleratorArn."'),
