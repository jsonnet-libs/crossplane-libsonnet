{
  ...
  spec: {
    ...
    forProvider: {
      '#eventFilter':: d.obj(help='"A block that defines the configuration information for the event filter. The Event Filter block is documented below."'),
      eventFilter: {
        '#withSource':: d.fn(help='"The source of the events."', args=[d.arg(name='source', type=d.T.string)]),
        withSource(source): { source: source },
      },
      '#withDescription':: d.fn(help='"Specifies the description of the Event Integration."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withEventFilter':: d.fn(help='"A block that defines the configuration information for the event filter. The Event Filter block is documented below."', args=[d.arg(name='eventFilter', type=d.T.array)]),
      withEventFilter(eventFilter): { spec+: { forProvider+: { eventFilter: if std.isArray(v=eventFilter) then eventFilter else [eventFilter] } } },
      '#withEventFilterMixin':: d.fn(help='"A block that defines the configuration information for the event filter. The Event Filter block is documented below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='eventFilter', type=d.T.array)]),
      ...
      '#withEventbridgeBus':: d.fn(help='"Specifies the EventBridge bus."', args=[d.arg(name='eventbridgeBus', type=d.T.string)]),
