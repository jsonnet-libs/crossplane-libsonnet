{
  ...
  '#':: d.pkg(name='smsChannel', url='', help='"SMSChannel is the Schema for the SMSChannels API. Provides a Pinpoint SMS Channel resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withApplicationId':: d.fn(help='"The application ID."', args=[d.arg(name='applicationId', type=d.T.string)]),
      withApplicationId(applicationId): { spec+: { forProvider+: { applicationId: applicationId } } },
      '#withEnabled':: d.fn(help='"Whether the channel is enabled or disabled. Defaults to true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withSenderId':: d.fn(help='"Sender identifier of your messages."', args=[d.arg(name='senderId', type=d.T.string)]),
      withSenderId(senderId): { spec+: { forProvider+: { senderId: senderId } } },
      '#withShortCode':: d.fn(help='"The Short Code registered with the phone provider."', args=[d.arg(name='shortCode', type=d.T.string)]),
