{
  ...
  spec: {
    ...
    forProvider: {
      ...
      customErrorResponse: {
        '#withErrorCachingMinTtl':: d.fn(help='"The minimum amount of time you want HTTP error codes to stay in CloudFront caches before CloudFront queries your origin to see whether the object has been updated."', args=[d.arg(name='errorCachingMinTtl', type=d.T.number)]),
        withErrorCachingMinTtl(errorCachingMinTtl): { errorCachingMinTtl: errorCachingMinTtl },
        '#withErrorCode':: d.fn(help='"The 4xx or 5xx HTTP status code that you want to customize."', args=[d.arg(name='errorCode', type=d.T.number)]),
        withErrorCode(errorCode): { errorCode: errorCode },
        '#withResponseCode':: d.fn(help='"The HTTP status code that you want CloudFront to return with the custom error page to the viewer."', args=[d.arg(name='responseCode', type=d.T.number)]),
        withResponseCode(responseCode): { responseCode: responseCode },
        '#withResponsePagePath':: d.fn(help='"The path of the custom error page (for example, /custom_404.html)."', args=[d.arg(name='responsePagePath', type=d.T.string)]),
        withResponsePagePath(responsePagePath): { responsePagePath: responsePagePath },
      },
      '#defaultCacheBehavior':: d.obj(help='"The default cache behavior for this distribution (maximum one)."'),
      defaultCacheBehavior: {
        ...
        forwardedValues: {
          ...
          cookies: {
            '#withForward':: d.fn(help='"Specifies whether you want CloudFront to forward cookies to the origin that is associated with this cache behavior. You can specify all, none or whitelist. If whitelist, you must include the subsequent whitelisted_names"', args=[d.arg(name='forward', type=d.T.string)]),
          ...
          '#withHeaders':: d.fn(help='"Specifies the Headers, if any, that you want CloudFront to vary upon for this cache behavior. Specify * to include all headers."', args=[d.arg(name='headers', type=d.T.array)]),
          withHeaders(headers): { headers: if std.isArray(v=headers) then headers else [headers] },
          '#withHeadersMixin':: d.fn(help='"Specifies the Headers, if any, that you want CloudFront to vary upon for this cache behavior. Specify * to include all headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
        ...
        functionAssociation: {
          '#withEventType':: d.fn(help='"The specific event to trigger this function. Valid values: viewer-request, origin-request, viewer-response, origin-response"', args=[d.arg(name='eventType', type=d.T.string)]),
        ...
        '#withCachePolicyId':: d.fn(help='"The unique identifier of the cache policy that is attached to the cache behavior."', args=[d.arg(name='cachePolicyId', type=d.T.string)]),
        ...
        '#withDefaultTtl':: d.fn(help='"The default amount of time (in seconds) that an object is in a CloudFront cache before CloudFront forwards another request in the absence of an Cache-Control max-age or Expires header."', args=[d.arg(name='defaultTtl', type=d.T.number)]),
        ...
        '#withMaxTtl':: d.fn(help='"The maximum amount of time (in seconds) that an object is in a CloudFront cache before CloudFront forwards another request to your origin to determine whether the object has been updated. Only effective in the presence of Cache-Control max-age, Cache-Control s-maxage, and Expires headers."', args=[d.arg(name='maxTtl', type=d.T.number)]),
        withMaxTtl(maxTtl): { maxTtl: maxTtl },
        '#withMinTtl':: d.fn(help='"The minimum amount of time that you want objects to stay in CloudFront caches before CloudFront queries your origin to see whether the object has been updated. Defaults to 0 seconds."', args=[d.arg(name='minTtl', type=d.T.number)]),
        withMinTtl(minTtl): { minTtl: minTtl },
        '#withOriginRequestPolicyId':: d.fn(help='"The unique identifier of the origin request policy that is attached to the behavior."', args=[d.arg(name='originRequestPolicyId', type=d.T.string)]),
        withOriginRequestPolicyId(originRequestPolicyId): { originRequestPolicyId: originRequestPolicyId },
        '#withRealtimeLogConfigArn':: d.fn(help='"The ARN of the real-time log configuration that is attached to this cache behavior."', args=[d.arg(name='realtimeLogConfigArn', type=d.T.string)]),
        withRealtimeLogConfigArn(realtimeLogConfigArn): { realtimeLogConfigArn: realtimeLogConfigArn },
        '#withResponseHeadersPolicyId':: d.fn(help='"The identifier for a response headers policy."', args=[d.arg(name='responseHeadersPolicyId', type=d.T.string)]),
        ...
        '#withTargetOriginId':: d.fn(help='"The value of ID for the origin that you want CloudFront to route requests to when a request matches the path pattern either for a cache behavior or for the default cache behavior."', args=[d.arg(name='targetOriginId', type=d.T.string)]),
        withTargetOriginId(targetOriginId): { targetOriginId: targetOriginId },
        '#withTrustedKeyGroups':: d.fn(help='"A list of key group IDs that CloudFront can use to validate signed URLs or signed cookies. See the CloudFront User Guide for more information about this feature."', args=[d.arg(name='trustedKeyGroups', type=d.T.array)]),
        ...
        '#withTrustedKeyGroupsMixin':: d.fn(help='"A list of key group IDs that CloudFront can use to validate signed URLs or signed cookies. See the CloudFront User Guide for more information about this feature."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='trustedKeyGroups', type=d.T.array)]),
      ...
      loggingConfig: {
        '#withBucket':: d.fn(help='"The Amazon S3 bucket to store the access logs in, for example, myawslogbucket.s3.amazonaws.com."', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { bucket: bucket },
        '#withIncludeCookies':: d.fn(help='"Specifies whether you want CloudFront to include cookies in access logs (default: false)."', args=[d.arg(name='includeCookies', type=d.T.boolean)]),
        withIncludeCookies(includeCookies): { includeCookies: includeCookies },
        '#withPrefix':: d.fn(help='"An optional string that you want CloudFront to prefix to the access log filenames for this distribution, for example, myprefix/."', args=[d.arg(name='prefix', type=d.T.string)]),
        withPrefix(prefix): { prefix: prefix },
      },
      '#orderedCacheBehavior':: d.obj(help='"An ordered list of cache behaviors resource for this distribution. List from top to bottom in order of precedence. The topmost cache behavior will have precedence 0."'),
      orderedCacheBehavior: {
        ...
        '#withOriginRequestPolicyId':: d.fn(help='"The unique identifier of the origin request policy that is attached to the behavior."', args=[d.arg(name='originRequestPolicyId', type=d.T.string)]),
        withOriginRequestPolicyId(originRequestPolicyId): { originRequestPolicyId: originRequestPolicyId },
        '#withPathPattern':: d.fn(help='"The pattern (for example, images/*.jpg) that specifies which requests you want this cache behavior to apply to."', args=[d.arg(name='pathPattern', type=d.T.string)]),
      ...
      origin: {
        ...
        '#customOriginConfig':: d.obj(help='"The CloudFront custom origin configuration information. If an S3 origin is required, use s3_origin_config instead."'),
        customOriginConfig: {
          '#withHttpPort':: d.fn(help='"The HTTP port the custom origin listens on."', args=[d.arg(name='httpPort', type=d.T.number)]),
          withHttpPort(httpPort): { httpPort: httpPort },
          '#withHttpsPort':: d.fn(help='"The HTTPS port the custom origin listens on."', args=[d.arg(name='httpsPort', type=d.T.number)]),
          withHttpsPort(httpsPort): { httpsPort: httpsPort },
          '#withOriginKeepaliveTimeout':: d.fn(help='"The Custom KeepAlive timeout, in seconds. By default, AWS enforces a limit of 60. But you can request an increase."', args=[d.arg(name='originKeepaliveTimeout', type=d.T.number)]),
          withOriginKeepaliveTimeout(originKeepaliveTimeout): { originKeepaliveTimeout: originKeepaliveTimeout },
          '#withOriginProtocolPolicy':: d.fn(help='"The origin protocol policy to apply to your origin. One of http-only, https-only, or match-viewer."', args=[d.arg(name='originProtocolPolicy', type=d.T.string)]),
          withOriginProtocolPolicy(originProtocolPolicy): { originProtocolPolicy: originProtocolPolicy },
          '#withOriginReadTimeout':: d.fn(help='"The Custom Read timeout, in seconds. By default, AWS enforces a limit of 60. But you can request an increase."', args=[d.arg(name='originReadTimeout', type=d.T.number)]),
          withOriginReadTimeout(originReadTimeout): { originReadTimeout: originReadTimeout },
          '#withOriginSslProtocols':: d.fn(help='"The SSL/TLS protocols that you want CloudFront to use when communicating with your origin over HTTPS. A list of one or more of SSLv3, TLSv1, TLSv1.1, and TLSv1.2."', args=[d.arg(name='originSslProtocols', type=d.T.array)]),
          ...
          '#withOriginSslProtocolsMixin':: d.fn(help='"The SSL/TLS protocols that you want CloudFront to use when communicating with your origin over HTTPS. A list of one or more of SSLv3, TLSv1, TLSv1.1, and TLSv1.2."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='originSslProtocols', type=d.T.array)]),
        ...
        '#originShield':: d.obj(help='"The CloudFront Origin Shield configuration information. Using Origin Shield can help reduce the load on your origin. For more information, see Using Origin Shield in the Amazon CloudFront Developer Guide."'),
        originShield: {
          ...
          '#withOriginShieldRegion':: d.fn(help='"The AWS Region for Origin Shield. To specify a region, use the region code, not the region name. For example, specify the US East (Ohio) region as us-east-2."', args=[d.arg(name='originShieldRegion', type=d.T.string)]),
          withOriginShieldRegion(originShieldRegion): { originShieldRegion: originShieldRegion },
        },
        '#s3OriginConfig':: d.obj(help='"The CloudFront S3 origin configuration information. If a custom origin is required, use custom_origin_config instead."'),
        s3OriginConfig: {
        ...
        '#withConnectionAttempts':: d.fn(help='"The number of times that CloudFront attempts to connect to the origin. Must be between 1-3. Defaults to 3."', args=[d.arg(name='connectionAttempts', type=d.T.number)]),
        withConnectionAttempts(connectionAttempts): { connectionAttempts: connectionAttempts },
        '#withConnectionTimeout':: d.fn(help='"The number of seconds that CloudFront waits when trying to establish a connection to the origin. Must be between 1-10. Defaults to 10."', args=[d.arg(name='connectionTimeout', type=d.T.number)]),
        ...
        '#withCustomOriginConfig':: d.fn(help='"The CloudFront custom origin configuration information. If an S3 origin is required, use s3_origin_config instead."', args=[d.arg(name='customOriginConfig', type=d.T.array)]),
        ...
        '#withCustomOriginConfigMixin':: d.fn(help='"The CloudFront custom origin configuration information. If an S3 origin is required, use s3_origin_config instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customOriginConfig', type=d.T.array)]),
        ...
        '#withDomainName':: d.fn(help='"The DNS domain name of either the S3 bucket, or web site of your custom origin."', args=[d.arg(name='domainName', type=d.T.string)]),
        withDomainName(domainName): { domainName: domainName },
        '#withOriginId':: d.fn(help='"A unique identifier for the origin."', args=[d.arg(name='originId', type=d.T.string)]),
        withOriginId(originId): { originId: originId },
        '#withOriginPath':: d.fn(help='"An optional element that causes CloudFront to request your content from a directory in your Amazon S3 bucket or your custom origin."', args=[d.arg(name='originPath', type=d.T.string)]),
        withOriginPath(originPath): { originPath: originPath },
        '#withOriginShield':: d.fn(help='"The CloudFront Origin Shield configuration information. Using Origin Shield can help reduce the load on your origin. For more information, see Using Origin Shield in the Amazon CloudFront Developer Guide."', args=[d.arg(name='originShield', type=d.T.array)]),
        withOriginShield(originShield): { originShield: if std.isArray(v=originShield) then originShield else [originShield] },
        '#withOriginShieldMixin':: d.fn(help='"The CloudFront Origin Shield configuration information. Using Origin Shield can help reduce the load on your origin. For more information, see Using Origin Shield in the Amazon CloudFront Developer Guide."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='originShield', type=d.T.array)]),
        withOriginShieldMixin(originShield): { originShield+: if std.isArray(v=originShield) then originShield else [originShield] },
        '#withS3OriginConfig':: d.fn(help='"The CloudFront S3 origin configuration information. If a custom origin is required, use custom_origin_config instead."', args=[d.arg(name='s3OriginConfig', type=d.T.array)]),
        withS3OriginConfig(s3OriginConfig): { s3OriginConfig: if std.isArray(v=s3OriginConfig) then s3OriginConfig else [s3OriginConfig] },
        '#withS3OriginConfigMixin':: d.fn(help='"The CloudFront S3 origin configuration information. If a custom origin is required, use custom_origin_config instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='s3OriginConfig', type=d.T.array)]),
      ...
      restrictions: {
        ...
        geoRestriction: {
          '#withLocations':: d.fn(help='"The ISO 3166-1-alpha-2 codes for which you want CloudFront either to distribute your content (whitelist) or not distribute your content (blacklist)."', args=[d.arg(name='locations', type=d.T.array)]),
          withLocations(locations): { locations: if std.isArray(v=locations) then locations else [locations] },
          '#withLocationsMixin':: d.fn(help='"The ISO 3166-1-alpha-2 codes for which you want CloudFront either to distribute your content (whitelist) or not distribute your content (blacklist)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='locations', type=d.T.array)]),
          withLocationsMixin(locations): { locations+: if std.isArray(v=locations) then locations else [locations] },
          '#withRestrictionType':: d.fn(help='"The method that you want to use to restrict distribution of your content by country: none, whitelist, or blacklist."', args=[d.arg(name='restrictionType', type=d.T.string)]),
      ...
      viewerCertificate: {
        '#withAcmCertificateArn':: d.fn(help='"The ARN of the AWS Certificate Manager certificate that you wish to use with this distribution. Specify this, cloudfront_default_certificate, or iam_certificate_id.  The ACM certificate must be in  US-EAST-1."', args=[d.arg(name='acmCertificateArn', type=d.T.string)]),
        ...
        '#withIamCertificateId':: d.fn(help='"The IAM certificate identifier of the custom viewer certificate for this distribution if you are using a custom domain. Specify this, acm_certificate_arn, or cloudfront_default_certificate."', args=[d.arg(name='iamCertificateId', type=d.T.string)]),
        withIamCertificateId(iamCertificateId): { iamCertificateId: iamCertificateId },
        '#withMinimumProtocolVersion':: d.fn(help='"The minimum version of the SSL protocol that you want CloudFront to use for HTTPS connections. Can only be set if cloudfront_default_certificate = false. See all possible values in this table under \\"Security policy.\\" Some examples include: TLSv1.2_2019 and TLSv1.2_2021. Default: TLSv1. NOTE: If you are using a custom certificate (specified with acm_certificate_arn or iam_certificate_id), and have specified sni-only in ssl_support_method, TLSv1 or later must be specified. If you have specified vip in ssl_support_method, only SSLv3 or TLSv1 can be specified. If you have specified cloudfront_default_certificate, TLSv1 must be specified."', args=[d.arg(name='minimumProtocolVersion', type=d.T.string)]),
        withMinimumProtocolVersion(minimumProtocolVersion): { minimumProtocolVersion: minimumProtocolVersion },
        '#withSslSupportMethod':: d.fn(help='"only. Required if you specify acm_certificate_arn or iam_certificate_id. NOTE: vip causes CloudFront to use a dedicated IP address and may incur extra charges."', args=[d.arg(name='sslSupportMethod', type=d.T.string)]),
      ...
      '#withDefaultCacheBehavior':: d.fn(help='"The default cache behavior for this distribution (maximum one)."', args=[d.arg(name='defaultCacheBehavior', type=d.T.array)]),
      ...
      '#withDefaultRootObject':: d.fn(help='"The object that you want CloudFront to return (for example, index.html) when an end user requests the root URL."', args=[d.arg(name='defaultRootObject', type=d.T.string)]),
      ...
      '#withHttpVersion':: d.fn(help='"The maximum HTTP version to support on the distribution. Allowed values are http1.1 and http2. The default is http2."', args=[d.arg(name='httpVersion', type=d.T.string)]),
      ...
      '#withOrderedCacheBehavior':: d.fn(help='"An ordered list of cache behaviors resource for this distribution. List from top to bottom in order of precedence. The topmost cache behavior will have precedence 0."', args=[d.arg(name='orderedCacheBehavior', type=d.T.array)]),
      ...
      '#withOrderedCacheBehaviorMixin':: d.fn(help='"An ordered list of cache behaviors resource for this distribution. List from top to bottom in order of precedence. The topmost cache behavior will have precedence 0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='orderedCacheBehavior', type=d.T.array)]),
      ...
      '#withPriceClass':: d.fn(help='"The price class for this distribution. One of PriceClass_All, PriceClass_200, PriceClass_100"', args=[d.arg(name='priceClass', type=d.T.string)]),
      ...
      '#withWebAclId':: d.fn(help='"A unique identifier that specifies the AWS WAF web ACL, if any, to associate with this distribution. To specify a web ACL created using the latest version of AWS WAF (WAFv2), use the ACL ARN, for example aws_wafv2_web_acl.example.arn. To specify a web ACL created using AWS WAF Classic, use the ACL ID, for example aws_waf_web_acl.example.id. The WAF Web ACL must exist in the WAF Global (CloudFront) region and the credentials configuring this argument must have waf:GetWebACL permissions assigned."', args=[d.arg(name='webAclId', type=d.T.string)]),
