    ...
    forProvider: {
      ...
      endpoint: {
        ...
        kinesisStreamConfig: {
          ...
          '#withRoleArn':: d.fn(help='"The ARN of an IAM role that CloudFront can use to send real-time log data to the Kinesis data stream. See the AWS documentation for more information."', args=[d.arg(name='roleArn', type=d.T.string)]),
