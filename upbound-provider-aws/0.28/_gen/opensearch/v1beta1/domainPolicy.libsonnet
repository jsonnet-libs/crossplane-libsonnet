{
  ...
  '#':: d.pkg(name='domainPolicy', url='', help='"DomainPolicy is the Schema for the DomainPolicys API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#domainNameRef':: d.obj(help='"Reference to a Domain to populate domainName."'),
      domainNameRef: {
      ...
      '#domainNameSelector':: d.obj(help='"Selector for a Domain to populate domainName."'),
      domainNameSelector: {
