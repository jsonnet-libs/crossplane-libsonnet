{
  ...
  spec: {
    ...
    forProvider: {
      ...
      rotationRules: {
        '#withAutomaticallyAfterDays':: d.fn(help='"Specifies the number of days between automatic scheduled rotations of the secret."', args=[d.arg(name='automaticallyAfterDays', type=d.T.number)]),
      ...
      '#withRotationLambdaArn':: d.fn(help='"Specifies the ARN of the Lambda function that can rotate the secret."', args=[d.arg(name='rotationLambdaArn', type=d.T.string)]),
