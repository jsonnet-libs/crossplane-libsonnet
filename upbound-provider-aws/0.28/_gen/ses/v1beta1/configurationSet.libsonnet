{
  ...
  spec: {
    ...
    forProvider: {
      '#deliveryOptions':: d.obj(help='"Configuration block. Detailed below."'),
      deliveryOptions: {
        '#withTlsPolicy':: d.fn(help="\"Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is Require, messages are only delivered if a TLS connection can be established. If the value is Optional, messages can be delivered in plain text if a TLS connection can't be established. Valid values: Require or Optional. Defaults to Optional.\"", args=[d.arg(name='tlsPolicy', type=d.T.string)]),
        withTlsPolicy(tlsPolicy): { tlsPolicy: tlsPolicy },
      },
      '#withDeliveryOptions':: d.fn(help='"Configuration block. Detailed below."', args=[d.arg(name='deliveryOptions', type=d.T.array)]),
