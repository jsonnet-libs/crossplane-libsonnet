{
  ...
  '#':: d.pkg(name='domainDKIM', url='', help='"DomainDKIM is the Schema for the DomainDKIMs API. Provides an SES domain DKIM generation resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of DomainDKIM', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DomainDKIMSpec defines the desired state of DomainDKIM"'),
  spec: {
