{
  ...
  '#':: d.pkg(name='domainIdentity', url='', help='"DomainIdentity is the Schema for the DomainIdentitys API. Provides an SES domain identity resource"'),
  ...
  '#new':: d.fn(help='new returns an instance of DomainIdentity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DomainIdentitySpec defines the desired state of DomainIdentity"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDomain':: d.fn(help='"The domain name to assign to SES"', args=[d.arg(name='domain', type=d.T.string)]),
