{
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description of the collection."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name of the collection."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withStandbyReplicas':: d.fn(help='"Indicates whether standby replicas should be used for a collection. One of ENABLED or DISABLED. Defaults to ENABLED."', args=[d.arg(name='standbyReplicas', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of collection. One of SEARCH, TIMESERIES, or VECTORSEARCH. Defaults to TIMESERIES."', args=[d.arg(name='type', type=d.T.string)]),
