{
  ...
  '#':: d.pkg(name='customDataIdentifier', url='', help='"CustomDataIdentifier is the Schema for the CustomDataIdentifiers API. Provides a resource to manage an AWS Macie Custom Data Identifier."'),
  ...
  '#new':: d.fn(help='new returns an instance of CustomDataIdentifier', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"CustomDataIdentifierSpec defines the desired state of CustomDataIdentifier"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withDescription':: d.fn(help='"A custom description of the custom data identifier. The description can contain as many as 512 characters."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIgnoreWords':: d.fn(help='"An array that lists specific character sequences (ignore words) to exclude from the results. If the text matched by the regular expression is the same as any string in this array, Amazon Macie ignores it. The array can contain as many as 10 ignore words. Each ignore word can contain 4 - 90 characters. Ignore words are case sensitive."', args=[d.arg(name='ignoreWords', type=d.T.array)]),
      withIgnoreWords(ignoreWords): { spec+: { forProvider+: { ignoreWords: if std.isArray(v=ignoreWords) then ignoreWords else [ignoreWords] } } },
      '#withIgnoreWordsMixin':: d.fn(help='"An array that lists specific character sequences (ignore words) to exclude from the results. If the text matched by the regular expression is the same as any string in this array, Amazon Macie ignores it. The array can contain as many as 10 ignore words. Each ignore word can contain 4 - 90 characters. Ignore words are case sensitive."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ignoreWords', type=d.T.array)]),
      withIgnoreWordsMixin(ignoreWords): { spec+: { forProvider+: { ignoreWords+: if std.isArray(v=ignoreWords) then ignoreWords else [ignoreWords] } } },
      '#withKeywords':: d.fn(help="\"An array that lists specific character sequences (keywords), one of which must be within proximity (maximum_match_distance) of the regular expression to match. The array can contain as many as 50 keywords. Each keyword can contain 3 - 90 characters. Keywords aren't case sensitive.\"", args=[d.arg(name='keywords', type=d.T.array)]),
      withKeywords(keywords): { spec+: { forProvider+: { keywords: if std.isArray(v=keywords) then keywords else [keywords] } } },
      '#withKeywordsMixin':: d.fn(help="\"An array that lists specific character sequences (keywords), one of which must be within proximity (maximum_match_distance) of the regular expression to match. The array can contain as many as 50 keywords. Each keyword can contain 3 - 90 characters. Keywords aren't case sensitive.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='keywords', type=d.T.array)]),
      withKeywordsMixin(keywords): { spec+: { forProvider+: { keywords+: if std.isArray(v=keywords) then keywords else [keywords] } } },
      '#withMaximumMatchDistance':: d.fn(help='"The maximum number of characters that can exist between text that matches the regex pattern and the character sequences specified by the keywords array. Macie includes or excludes a result based on the proximity of a keyword to text that matches the regex pattern. The distance can be 1 - 300 characters. The default value is 50."', args=[d.arg(name='maximumMatchDistance', type=d.T.number)]),
      withMaximumMatchDistance(maximumMatchDistance): { spec+: { forProvider+: { maximumMatchDistance: maximumMatchDistance } } },
      '#withName':: d.fn(help='"A custom name for the custom data identifier. The name can contain as many as 128 characters. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegex':: d.fn(help='"The regular expression (regex) that defines the pattern to match. The expression can contain as many as 512 characters."', args=[d.arg(name='regex', type=d.T.string)]),
      withRegex(regex): { spec+: { forProvider+: { regex: regex } } },
    ...
    initProvider: {
      ...
      '#withIgnoreWords':: d.fn(help='"An array that lists specific character sequences (ignore words) to exclude from the results. If the text matched by the regular expression is the same as any string in this array, Amazon Macie ignores it. The array can contain as many as 10 ignore words. Each ignore word can contain 4 - 90 characters. Ignore words are case sensitive."', args=[d.arg(name='ignoreWords', type=d.T.array)]),
      withIgnoreWords(ignoreWords): { spec+: { initProvider+: { ignoreWords: if std.isArray(v=ignoreWords) then ignoreWords else [ignoreWords] } } },
      '#withIgnoreWordsMixin':: d.fn(help='"An array that lists specific character sequences (ignore words) to exclude from the results. If the text matched by the regular expression is the same as any string in this array, Amazon Macie ignores it. The array can contain as many as 10 ignore words. Each ignore word can contain 4 - 90 characters. Ignore words are case sensitive."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ignoreWords', type=d.T.array)]),
      withIgnoreWordsMixin(ignoreWords): { spec+: { initProvider+: { ignoreWords+: if std.isArray(v=ignoreWords) then ignoreWords else [ignoreWords] } } },
      '#withKeywords':: d.fn(help="\"An array that lists specific character sequences (keywords), one of which must be within proximity (maximum_match_distance) of the regular expression to match. The array can contain as many as 50 keywords. Each keyword can contain 3 - 90 characters. Keywords aren't case sensitive.\"", args=[d.arg(name='keywords', type=d.T.array)]),
      withKeywords(keywords): { spec+: { initProvider+: { keywords: if std.isArray(v=keywords) then keywords else [keywords] } } },
      '#withKeywordsMixin':: d.fn(help="\"An array that lists specific character sequences (keywords), one of which must be within proximity (maximum_match_distance) of the regular expression to match. The array can contain as many as 50 keywords. Each keyword can contain 3 - 90 characters. Keywords aren't case sensitive.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='keywords', type=d.T.array)]),
      withKeywordsMixin(keywords): { spec+: { initProvider+: { keywords+: if std.isArray(v=keywords) then keywords else [keywords] } } },
      '#withMaximumMatchDistance':: d.fn(help='"The maximum number of characters that can exist between text that matches the regex pattern and the character sequences specified by the keywords array. Macie includes or excludes a result based on the proximity of a keyword to text that matches the regex pattern. The distance can be 1 - 300 characters. The default value is 50."', args=[d.arg(name='maximumMatchDistance', type=d.T.number)]),
      withMaximumMatchDistance(maximumMatchDistance): { spec+: { initProvider+: { maximumMatchDistance: maximumMatchDistance } } },
      '#withName':: d.fn(help='"A custom name for the custom data identifier. The name can contain as many as 128 characters. Conflicts with name_prefix."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { initProvider+: { name: name } } },
      '#withRegex':: d.fn(help='"The regular expression (regex) that defines the pattern to match. The expression can contain as many as 512 characters."', args=[d.arg(name='regex', type=d.T.string)]),
      withRegex(regex): { spec+: { initProvider+: { regex: regex } } },
      '#withTags':: d.fn(help='"Key-value map of resource tags."', args=[d.arg(name='tags', type=d.T.object)]),
