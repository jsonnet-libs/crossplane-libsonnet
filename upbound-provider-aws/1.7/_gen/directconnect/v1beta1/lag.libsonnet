{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withConnectionsBandwidth':: d.fn(help='"The bandwidth of the individual physical connections bundled by the LAG. Valid values: 50Mbps, 100Mbps, 200Mbps, 300Mbps, 400Mbps, 500Mbps, 1Gbps, 2Gbps, 5Gbps, 10Gbps and 100Gbps. Case sensitive."', args=[d.arg(name='connectionsBandwidth', type=d.T.string)]),
