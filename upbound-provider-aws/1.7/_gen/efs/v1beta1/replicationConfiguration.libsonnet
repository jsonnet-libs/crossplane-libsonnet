  ...
  spec: {
    ...
    forProvider: {
      ...
      destination: {
        ...
        '#withRegion':: d.fn(help='"The region in which the replica should be created."', args=[d.arg(name='region', type=d.T.string)]),
