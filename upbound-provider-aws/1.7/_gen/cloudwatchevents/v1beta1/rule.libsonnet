{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIsEnabled':: d.fn(help='"Whether the rule should be enabled.\\nDefaults to true.\\nConflicts with state."', args=[d.arg(name='isEnabled', type=d.T.boolean)]),
