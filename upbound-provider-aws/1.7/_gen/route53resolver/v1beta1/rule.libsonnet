  ...
  spec: {
    ...
    forProvider: {
      ...
      targetIp: {
        ...
        '#withProtocol':: d.fn(help='"The protocol for the resolver endpoint. Valid values can be found in the AWS documentation. Default value is Do53."', args=[d.arg(name='protocol', type=d.T.string)]),
      ...
      '#withResolverEndpointId':: d.fn(help='"The ID of the outbound resolver endpoint that you want to use to route DNS queries to the IP addresses that you specify using target_ip.\\nThis argument should only be specified for FORWARD type rules."', args=[d.arg(name='resolverEndpointId', type=d.T.string)]),
