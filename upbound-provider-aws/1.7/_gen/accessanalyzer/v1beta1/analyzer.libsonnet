{
  ...
  spec: {
    ...
    forProvider: {
      '#configuration':: d.obj(help='"A block that specifies the configuration of the analyzer. Documented below"'),
      configuration: {
        '#unusedAccess':: d.obj(help='"A block that specifies the configuration of an unused access analyzer for an AWS organization or account. Documented below"'),
        unusedAccess: {
          '#withUnusedAccessAge':: d.fn(help='"The specified access age in days for which to generate findings for unused access."', args=[d.arg(name='unusedAccessAge', type=d.T.number)]),
          withUnusedAccessAge(unusedAccessAge): { unusedAccessAge: unusedAccessAge },
        },
        '#withUnusedAccess':: d.fn(help='"A block that specifies the configuration of an unused access analyzer for an AWS organization or account. Documented below"', args=[d.arg(name='unusedAccess', type=d.T.array)]),
        withUnusedAccess(unusedAccess): { unusedAccess: if std.isArray(v=unusedAccess) then unusedAccess else [unusedAccess] },
        '#withUnusedAccessMixin':: d.fn(help='"A block that specifies the configuration of an unused access analyzer for an AWS organization or account. Documented below"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='unusedAccess', type=d.T.array)]),
        withUnusedAccessMixin(unusedAccess): { unusedAccess+: if std.isArray(v=unusedAccess) then unusedAccess else [unusedAccess] },
      },
      '#withConfiguration':: d.fn(help='"A block that specifies the configuration of the analyzer. Documented below"', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withConfigurationMixin':: d.fn(help='"A block that specifies the configuration of the analyzer. Documented below"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configuration', type=d.T.array)]),
      ...
      '#withType':: d.fn(help='"Type of Analyzer. Valid values are ACCOUNT, ORGANIZATION, ACCOUNT_UNUSED_ACCESS , ORGANIZATION_UNUSED_ACCESS. Defaults to ACCOUNT."', args=[d.arg(name='type', type=d.T.string)]),
