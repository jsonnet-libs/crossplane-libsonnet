{
  ...
  '#':: d.pkg(name='deviceFleet', url='', help='"DeviceFleet is the Schema for the DeviceFleets API. Provides a SageMaker Device Fleet resource."'),
