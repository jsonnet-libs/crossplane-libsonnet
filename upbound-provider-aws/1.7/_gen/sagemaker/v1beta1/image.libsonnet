{
  ...
  '#':: d.pkg(name='image', url='', help='"Image is the Schema for the Images API. Provides a SageMaker Image resource."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRoleArn':: d.fn(help='"The Amazon Resource Name (ARN) of an IAM role that enables Amazon SageMaker to perform tasks on your behalf."', args=[d.arg(name='roleArn', type=d.T.string)]),
