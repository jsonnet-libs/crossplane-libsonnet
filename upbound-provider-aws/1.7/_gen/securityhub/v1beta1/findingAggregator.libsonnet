{
  ...
  '#':: d.pkg(name='findingAggregator', url='', help='"FindingAggregator is the Schema for the FindingAggregators API. Manages a Security Hub finding aggregator"'),
  ...
  '#new':: d.fn(help='new returns an instance of FindingAggregator', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FindingAggregatorSpec defines the desired state of FindingAggregator"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withLinkingMode':: d.fn(help='"Indicates whether to aggregate findings from all of the available Regions or from a specified list. The options are ALL_REGIONS, ALL_REGIONS_EXCEPT_SPECIFIED or SPECIFIED_REGIONS. When ALL_REGIONS or ALL_REGIONS_EXCEPT_SPECIFIED are used, Security Hub will automatically aggregate findings from new Regions as Security Hub supports them and you opt into them."', args=[d.arg(name='linkingMode', type=d.T.string)]),
      withLinkingMode(linkingMode): { spec+: { forProvider+: { linkingMode: linkingMode } } },
      ...
      '#withSpecifiedRegions':: d.fn(help='"List of regions to include or exclude"', args=[d.arg(name='specifiedRegions', type=d.T.array)]),
      withSpecifiedRegions(specifiedRegions): { spec+: { forProvider+: { specifiedRegions: if std.isArray(v=specifiedRegions) then specifiedRegions else [specifiedRegions] } } },
      '#withSpecifiedRegionsMixin':: d.fn(help='"List of regions to include or exclude"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='specifiedRegions', type=d.T.array)]),
      withSpecifiedRegionsMixin(specifiedRegions): { spec+: { forProvider+: { specifiedRegions+: if std.isArray(v=specifiedRegions) then specifiedRegions else [specifiedRegions] } } },
    },
    ...
    initProvider: {
      '#withLinkingMode':: d.fn(help='"Indicates whether to aggregate findings from all of the available Regions or from a specified list. The options are ALL_REGIONS, ALL_REGIONS_EXCEPT_SPECIFIED or SPECIFIED_REGIONS. When ALL_REGIONS or ALL_REGIONS_EXCEPT_SPECIFIED are used, Security Hub will automatically aggregate findings from new Regions as Security Hub supports them and you opt into them."', args=[d.arg(name='linkingMode', type=d.T.string)]),
      withLinkingMode(linkingMode): { spec+: { initProvider+: { linkingMode: linkingMode } } },
      '#withSpecifiedRegions':: d.fn(help='"List of regions to include or exclude"', args=[d.arg(name='specifiedRegions', type=d.T.array)]),
      withSpecifiedRegions(specifiedRegions): { spec+: { initProvider+: { specifiedRegions: if std.isArray(v=specifiedRegions) then specifiedRegions else [specifiedRegions] } } },
      '#withSpecifiedRegionsMixin':: d.fn(help='"List of regions to include or exclude"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='specifiedRegions', type=d.T.array)]),
      withSpecifiedRegionsMixin(specifiedRegions): { spec+: { initProvider+: { specifiedRegions+: if std.isArray(v=specifiedRegions) then specifiedRegions else [specifiedRegions] } } },
    },
