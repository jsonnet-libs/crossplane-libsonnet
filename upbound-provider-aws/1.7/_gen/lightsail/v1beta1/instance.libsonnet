{
  ...
  '#':: d.pkg(name='instance', url='', help='"Instance is the Schema for the Instances API. Provides an Lightsail Instance"'),
  ...
  spec: {
    ...
    forProvider: {
      '#addOn':: d.obj(help='"The add on configuration for the instance. Detailed below."'),
      addOn: {
      ...
      '#withAddOn':: d.fn(help='"The add on configuration for the instance. Detailed below."', args=[d.arg(name='addOn', type=d.T.array)]),
      withAddOn(addOn): { spec+: { forProvider+: { addOn: if std.isArray(v=addOn) then addOn else [addOn] } } },
      '#withAddOnMixin':: d.fn(help='"The add on configuration for the instance. Detailed below."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addOn', type=d.T.array)]),
      withAddOnMixin(addOn): { spec+: { forProvider+: { addOn+: if std.isArray(v=addOn) then addOn else [addOn] } } },
      '#withAvailabilityZone':: d.fn(help='"The Availability Zone in which to create your instance. A\\nlist of available zones can be obtained using the AWS CLI command:\\naws lightsail get-regions --include-availability-zones."', args=[d.arg(name='availabilityZone', type=d.T.string)]),
      withAvailabilityZone(availabilityZone): { spec+: { forProvider+: { availabilityZone: availabilityZone } } },
      '#withBlueprintId':: d.fn(help='"The ID for a virtual private server image. A list of available\\nblueprint IDs can be obtained using the AWS CLI command:\\naws lightsail get-blueprints."', args=[d.arg(name='blueprintId', type=d.T.string)]),
      withBlueprintId(blueprintId): { spec+: { forProvider+: { blueprintId: blueprintId } } },
      '#withBundleId':: d.fn(help='"The bundle of specification information. A list of available\\nbundle IDs can be obtained using the AWS CLI command:\\naws lightsail get-bundles."', args=[d.arg(name='bundleId', type=d.T.string)]),
      withBundleId(bundleId): { spec+: { forProvider+: { bundleId: bundleId } } },
      '#withIpAddressType':: d.fn(help='"The IP address type of the Lightsail Instance. Valid Values: dualstack | ipv4."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
      withIpAddressType(ipAddressType): { spec+: { forProvider+: { ipAddressType: ipAddressType } } },
      '#withKeyPairName':: d.fn(help='"The name of your key pair. Created in the\\nLightsail console (cannot use aws_key_pair at this time)"', args=[d.arg(name='keyPairName', type=d.T.string)]),
