{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withLogGroupClass':: d.fn(help='"Specified the log class of the log group. Possible values are: STANDARD or INFREQUENT_ACCESS."', args=[d.arg(name='logGroupClass', type=d.T.string)]),
      ...
      '#withRetentionInDays':: d.fn(help='"Specifies the number of days\\nyou want to retain log events in the specified log group.  Possible values are: 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, 2192, 2557, 2922, 3288, 3653, and 0.\\nIf you select 0, the events in the log group are always retained and never expire."', args=[d.arg(name='retentionInDays', type=d.T.number)]),
