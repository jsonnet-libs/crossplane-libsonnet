{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withReplaceDefaultAssociation':: d.fn(help="\"Whether this association should replace the association with the VPC's default security group that is created when no security groups are specified during VPC endpoint creation. At most 1 association per-VPC endpoint should be configured with replace_default_association = true.\"", args=[d.arg(name='replaceDefaultAssociation', type=d.T.boolean)]),
