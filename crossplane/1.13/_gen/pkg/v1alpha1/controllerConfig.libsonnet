{
  ...
  '#':: d.pkg(name='controllerConfig', url='', help='"ControllerConfig is the CRD type for a packaged controller configuration. Deprecated: This API is scheduled to be removed in a future release. See https://github.com/crossplane/crossplane/issues/3601 for more information."'),
