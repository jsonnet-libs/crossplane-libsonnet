{
  ...
  spec: {
    ...
    controller: {
      '#permissionRequests':: d.obj(help="\"PermissionRequests for RBAC rules required for this provider's controller to function. The RBAC manager is responsible for assessing the requested permissions.\""),
      permissionRequests: {
      ...
      '#withPermissionRequests':: d.fn(help="\"PermissionRequests for RBAC rules required for this provider's controller to function. The RBAC manager is responsible for assessing the requested permissions.\"", args=[d.arg(name='permissionRequests', type=d.T.array)]),
      ...
      '#withPermissionRequestsMixin':: d.fn(help="\"PermissionRequests for RBAC rules required for this provider's controller to function. The RBAC manager is responsible for assessing the requested permissions.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='permissionRequests', type=d.T.array)]),
