{
  ...
  '#':: d.pkg(name='providerConfig', url='', help='"A ProviderConfig configures a SQL provider."'),
  ...
  spec: {
    ...
    credentials: {
      '#connectionSecretRef':: d.obj(help='"A CredentialsSecretRef is a reference to a MSSQL connection secret that contains the credentials that must be used to connect to the provider."'),
      connectionSecretRef: {
