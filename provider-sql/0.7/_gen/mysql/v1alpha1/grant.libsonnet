{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDatabase':: d.fn(help='"Database this grant is for, default *."', args=[d.arg(name='database', type=d.T.string)]),
      ...
      '#withTable':: d.fn(help='"Tables this grant is for, default *."', args=[d.arg(name='table', type=d.T.string)]),
