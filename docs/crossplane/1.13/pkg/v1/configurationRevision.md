---
permalink: /crossplane/1.13/pkg/v1/configurationRevision/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withEssTLSSecretName(essTLSSecretName)`](#fn-specwithesstlssecretname)
...
### fn spec.withEssTLSSecretName

```ts
withEssTLSSecretName(essTLSSecretName)
```
