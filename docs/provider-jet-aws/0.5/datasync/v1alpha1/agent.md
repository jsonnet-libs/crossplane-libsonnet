---
permalink: /provider-jet-aws/0.5/datasync/v1alpha1/agent/
---

# datasync.v1alpha1.agent
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPrivateLinkEndpoint(privateLinkEndpoint)`](#fn-specforproviderwithprivatelinkendpoint)
...
### fn spec.forProvider.withPrivateLinkEndpoint

```ts
withPrivateLinkEndpoint(privateLinkEndpoint)
```
