---
permalink: /provider-jet-aws/0.5/storagegateway/v1alpha1/cachedISCSIVolume/
---

# storagegateway.v1alpha1.cachedISCSIVolume
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withSourceVolumeArn(sourceVolumeArn)`](#fn-specforproviderwithsourcevolumearn)
    * [`fn withTags(tags)`](#fn-specforproviderwithtags)
    * [`fn withTagsMixin(tags)`](#fn-specforproviderwithtagsmixin)
    * [`fn withTargetName(targetName)`](#fn-specforproviderwithtargetname)
    * [`fn withVolumeSizeInBytes(volumeSizeInBytes)`](#fn-specforproviderwithvolumesizeinbytes)
...
new returns an instance of CachedISCSIVolume
...
### fn spec.forProvider.withSourceVolumeArn

```ts
withSourceVolumeArn(sourceVolumeArn)
```
...
### fn spec.forProvider.withTargetName
...
### fn spec.forProvider.withVolumeSizeInBytes

```ts
withVolumeSizeInBytes(volumeSizeInBytes)
```
