---
permalink: /provider-jet-aws/0.5/ec2/v1alpha1/amiFromInstance/
---

# ec2.v1alpha1.amiFromInstance
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withSnapshotWithoutReboot(snapshotWithoutReboot)`](#fn-specforproviderwithsnapshotwithoutreboot)
    * [`fn withSourceInstanceId(sourceInstanceId)`](#fn-specforproviderwithsourceinstanceid)
...
new returns an instance of AMIFromInstance
...
### fn spec.forProvider.withSnapshotWithoutReboot

```ts
withSnapshotWithoutReboot(snapshotWithoutReboot)
```



### fn spec.forProvider.withSourceInstanceId
