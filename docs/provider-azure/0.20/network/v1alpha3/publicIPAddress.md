---
permalink: /provider-azure/0.20/network/v1alpha3/publicIPAddress/
---

# network.v1alpha3.publicIPAddress
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withTcpIdleTimeoutInMinutes(tcpIdleTimeoutInMinutes)`](#fn-specforproviderwithtcpidletimeoutinminutes)
    * [`fn withVersion(version)`](#fn-specforproviderwithversion)
    * [`obj spec.forProvider.dnsSettings`](#obj-specforproviderdnssettings)
      * [`fn withDomainNameLabel(domainNameLabel)`](#fn-specforproviderdnssettingswithdomainnamelabel)
      * [`fn withReverseFqdn(reverseFqdn)`](#fn-specforproviderdnssettingswithreversefqdn)
    * [`obj spec.forProvider.ipTags`](#obj-specforprovideriptags)
      * [`fn withIpTagType(ipTagType)`](#fn-specforprovideriptagswithiptagtype)
      * [`fn withTag(tag)`](#fn-specforprovideriptagswithtag)
...
new returns an instance of PublicIPAddress
...
### fn spec.forProvider.withTcpIdleTimeoutInMinutes

```ts
withTcpIdleTimeoutInMinutes(tcpIdleTimeoutInMinutes)
```
...
### fn spec.forProvider.dnsSettings.withReverseFqdn
...
## obj spec.forProvider.ipTags

"IPTags - IP tags to be assigned to this public IP address"

### fn spec.forProvider.ipTags.withIpTagType

```ts
withIpTagType(ipTagType)
```

"IPTagType - Type of the IP tag. Example: FirstPartyUsage."

### fn spec.forProvider.ipTags.withTag
...
"ResourceGroupNameRef - A reference to the the Public IP address's resource group."
...
"ResourceGroupNameSelector - Select a reference to the Public IP address's resource group."
