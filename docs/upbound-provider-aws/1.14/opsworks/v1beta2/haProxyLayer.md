---
permalink: /upbound-provider-aws/1.14/opsworks/v1beta2/haProxyLayer/
---

# opsworks.v1beta2.haProxyLayer
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withHealthcheckMethod(healthcheckMethod)`](#fn-specforproviderwithhealthcheckmethod)
    * [`fn withHealthcheckUrl(healthcheckUrl)`](#fn-specforproviderwithhealthcheckurl)
    ...
    * [`fn withStatsEnabled(statsEnabled)`](#fn-specforproviderwithstatsenabled)
    * [`fn withStatsPassword(statsPassword)`](#fn-specforproviderwithstatspassword)
    * [`fn withStatsUrl(statsUrl)`](#fn-specforproviderwithstatsurl)
    * [`fn withStatsUser(statsUser)`](#fn-specforproviderwithstatsuser)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withHealthcheckMethod(healthcheckMethod)`](#fn-specinitproviderwithhealthcheckmethod)
    * [`fn withHealthcheckUrl(healthcheckUrl)`](#fn-specinitproviderwithhealthcheckurl)
    ...
    * [`fn withStatsEnabled(statsEnabled)`](#fn-specinitproviderwithstatsenabled)
    * [`fn withStatsPassword(statsPassword)`](#fn-specinitproviderwithstatspassword)
    * [`fn withStatsUrl(statsUrl)`](#fn-specinitproviderwithstatsurl)
    * [`fn withStatsUser(statsUser)`](#fn-specinitproviderwithstatsuser)
...
new returns an instance of HAProxyLayer
...
### fn spec.forProvider.withHealthcheckMethod

```ts
withHealthcheckMethod(healthcheckMethod)
```

"HTTP method to use for instance healthchecks. Defaults to \"OPTIONS\"."

### fn spec.forProvider.withHealthcheckUrl
...
### fn spec.forProvider.withStatsEnabled
...
### fn spec.forProvider.withStatsPassword

```ts
withStatsPassword(statsPassword)
```

"The password to use for HAProxy stats."

### fn spec.forProvider.withStatsUrl

```ts
withStatsUrl(statsUrl)
```

"The HAProxy stats URL. Defaults to \"/haproxy?stats\"."

### fn spec.forProvider.withStatsUser

```ts
withStatsUser(statsUser)
```
...
### fn spec.initProvider.withHealthcheckMethod
...
### fn spec.initProvider.withHealthcheckUrl
...
### fn spec.initProvider.withStatsEnabled
...
### fn spec.initProvider.withStatsPassword
...
### fn spec.initProvider.withStatsUrl
...
### fn spec.initProvider.withStatsUser
