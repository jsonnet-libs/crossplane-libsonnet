---
permalink: /upbound-provider-aws/1.14/opsworks/v1beta2/ecsClusterLayer/
---

# opsworks.v1beta2.ecsClusterLayer
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.ecsClusterArnRef`](#obj-specforproviderecsclusterarnref)
      * [`fn withName(name)`](#fn-specforproviderecsclusterarnrefwithname)
      * [`obj spec.forProvider.ecsClusterArnRef.policy`](#obj-specforproviderecsclusterarnrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderecsclusterarnrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderecsclusterarnrefpolicywithresolve)
    * [`obj spec.forProvider.ecsClusterArnSelector`](#obj-specforproviderecsclusterarnselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderecsclusterarnselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderecsclusterarnselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderecsclusterarnselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.ecsClusterArnSelector.policy`](#obj-specforproviderecsclusterarnselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderecsclusterarnselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderecsclusterarnselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.ecsClusterArnRef`](#obj-specinitproviderecsclusterarnref)
      * [`fn withName(name)`](#fn-specinitproviderecsclusterarnrefwithname)
      * [`obj spec.initProvider.ecsClusterArnRef.policy`](#obj-specinitproviderecsclusterarnrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderecsclusterarnrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderecsclusterarnrefpolicywithresolve)
    * [`obj spec.initProvider.ecsClusterArnSelector`](#obj-specinitproviderecsclusterarnselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderecsclusterarnselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderecsclusterarnselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderecsclusterarnselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.ecsClusterArnSelector.policy`](#obj-specinitproviderecsclusterarnselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderecsclusterarnselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderecsclusterarnselectorpolicywithresolve)
...
new returns an instance of EcsClusterLayer
...
## obj spec.forProvider.ecsClusterArnRef

"Reference to a Cluster in ecs to populate ecsClusterArn."

### fn spec.forProvider.ecsClusterArnRef.withName
...
## obj spec.forProvider.ecsClusterArnRef.policy

"Policies for referencing."

### fn spec.forProvider.ecsClusterArnRef.policy.withResolution
...
### fn spec.forProvider.ecsClusterArnRef.policy.withResolve
...
## obj spec.forProvider.ecsClusterArnSelector

"Selector for a Cluster in ecs to populate ecsClusterArn."

### fn spec.forProvider.ecsClusterArnSelector.withMatchControllerRef
...
### fn spec.forProvider.ecsClusterArnSelector.withMatchLabels
...
### fn spec.forProvider.ecsClusterArnSelector.withMatchLabelsMixin
...
## obj spec.forProvider.ecsClusterArnSelector.policy

"Policies for selection."

### fn spec.forProvider.ecsClusterArnSelector.policy.withResolution
...
### fn spec.forProvider.ecsClusterArnSelector.policy.withResolve
...
## obj spec.initProvider.ecsClusterArnRef

"Reference to a Cluster in ecs to populate ecsClusterArn."

### fn spec.initProvider.ecsClusterArnRef.withName
...
## obj spec.initProvider.ecsClusterArnRef.policy

"Policies for referencing."

### fn spec.initProvider.ecsClusterArnRef.policy.withResolution
...
### fn spec.initProvider.ecsClusterArnRef.policy.withResolve
...
## obj spec.initProvider.ecsClusterArnSelector

"Selector for a Cluster in ecs to populate ecsClusterArn."

### fn spec.initProvider.ecsClusterArnSelector.withMatchControllerRef
...
### fn spec.initProvider.ecsClusterArnSelector.withMatchLabels
...
### fn spec.initProvider.ecsClusterArnSelector.withMatchLabelsMixin
...
## obj spec.initProvider.ecsClusterArnSelector.policy

"Policies for selection."

### fn spec.initProvider.ecsClusterArnSelector.policy.withResolution
...
### fn spec.initProvider.ecsClusterArnSelector.policy.withResolve
