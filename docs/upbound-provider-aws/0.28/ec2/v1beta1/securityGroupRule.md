---
permalink: /upbound-provider-aws/0.28/ec2/v1beta1/securityGroupRule/
---
...
"Type of rule being created. Valid options are ingress (inbound) or egress (outbound). Type of rule, ingress (inbound) or egress (outbound)."
