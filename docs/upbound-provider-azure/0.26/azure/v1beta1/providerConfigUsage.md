---
permalink: /upbound-provider-azure/0.26/azure/v1beta1/providerConfigUsage/
---

# azure.v1beta1.providerConfigUsage

"A ProviderConfigUsage indicates that a resource is using a ProviderConfig. Please replace `PROVIDER-NAME` with your actual provider name, like `aws`, `azure`, `gcp`, `alibaba`"
