---
permalink: /upbound-provider-azure/0.29/web/v1beta1/functionAppFunction/
---

# web.v1beta1.functionAppFunction
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withFileMixin(file)`](#fn-specforproviderwithfilemixin)
    ...
    * [`fn withTestData(testData)`](#fn-specforproviderwithtestdata)
    * [`obj spec.forProvider.file`](#obj-specforproviderfile)
      * [`fn withContent(content)`](#fn-specforproviderfilewithcontent)
      * [`fn withName(name)`](#fn-specforproviderfilewithname)
...
new returns an instance of FunctionAppFunction
...
"The config for this Function in JSON format. The config for this Function in JSON format."
...
"Should this function be enabled. Defaults to true. Should this function be enabled. Defaults to `true`."
...
### fn spec.forProvider.withFileMixin
...
"The ID of the Function App in which this function should reside. Changing this forces a new resource to be created. The ID of the Function App in which this function should reside."
...
"The language the Function is written in. Possible values are CSharp, Custom, Java, Javascript, Python, PowerShell, and TypeScript. The language the Function is written in."
...
"The name of the function. Changing this forces a new resource to be created. The name of the function."

### fn spec.forProvider.withTestData

```ts
withTestData(testData)
```

"The test data for the function. The test data for the function."

## obj spec.forProvider.file

"A file block as detailed below. Changing this forces a new resource to be created."

### fn spec.forProvider.file.withContent

```ts
withContent(content)
```

"The content of the file. Changing this forces a new resource to be created. The content of the file."

### fn spec.forProvider.file.withName

```ts
withName(name)
```

"The filename of the file to be uploaded. Changing this forces a new resource to be created. The filename of the file to be uploaded."
