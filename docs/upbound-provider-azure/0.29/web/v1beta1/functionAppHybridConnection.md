---
permalink: /upbound-provider-azure/0.29/web/v1beta1/functionAppHybridConnection/
---
...
"The ID of the Function App for this Hybrid Connection. Changing this forces a new resource to be created. The ID of the Function App for this Hybrid Connection."
...
"The hostname of the endpoint. The hostname of the endpoint."
...
"The port to use for the endpoint The port to use for the endpoint"
...
"The ID of the Relay Hybrid Connection to use. Changing this forces a new resource to be created. The ID of the Relay Hybrid Connection to use."
...
"The name of the Relay key with Send permission to use. Defaults to RootManageSharedAccessKey The name of the Relay key with `Send` permission to use. Defaults to `RootManageSharedAccessKey`"
