---
permalink: /upbound-provider-azure/0.29/insights/v1beta1/monitorScheduledQueryRulesAlert/
---
...
"Should the alerts in this Metric Alert be auto resolved? Defaults to false. -> NOTE auto_mitigation_enabled and throttling are mutually exclusive and cannot both be set."
