---
permalink: /upbound-provider-azure/0.29/healthcareapis/v1beta1/healthcareFHIRService/
---
...
"The Azure Active Directory (tenant) that serves as the authentication authority to access the service. Authority must be registered to Azure AD and in the following format: https://{Azure-AD-endpoint}/{tenant-id}."
