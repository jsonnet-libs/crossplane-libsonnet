---
permalink: /upbound-provider-azure/0.29/streamanalytics/v1beta1/managedPrivateEndpoint/
---

# streamanalytics.v1beta1.managedPrivateEndpoint
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withStreamAnalyticsClusterName(streamAnalyticsClusterName)`](#fn-specforproviderwithstreamanalyticsclustername)
    ...
    * [`obj spec.forProvider.streamAnalyticsClusterNameRef`](#obj-specforproviderstreamanalyticsclusternameref)
      * [`fn withName(name)`](#fn-specforproviderstreamanalyticsclusternamerefwithname)
      * [`obj spec.forProvider.streamAnalyticsClusterNameRef.policy`](#obj-specforproviderstreamanalyticsclusternamerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderstreamanalyticsclusternamerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderstreamanalyticsclusternamerefpolicywithresolve)
    * [`obj spec.forProvider.streamAnalyticsClusterNameSelector`](#obj-specforproviderstreamanalyticsclusternameselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderstreamanalyticsclusternameselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderstreamanalyticsclusternameselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderstreamanalyticsclusternameselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.streamAnalyticsClusterNameSelector.policy`](#obj-specforproviderstreamanalyticsclusternameselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderstreamanalyticsclusternameselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderstreamanalyticsclusternameselectorpolicywithresolve)
...
### fn spec.forProvider.withStreamAnalyticsClusterName

```ts
withStreamAnalyticsClusterName(streamAnalyticsClusterName)
```
...
## obj spec.forProvider.streamAnalyticsClusterNameRef

"Reference to a Cluster in streamanalytics to populate streamAnalyticsClusterName."

### fn spec.forProvider.streamAnalyticsClusterNameRef.withName
...
## obj spec.forProvider.streamAnalyticsClusterNameRef.policy

"Policies for referencing."

### fn spec.forProvider.streamAnalyticsClusterNameRef.policy.withResolution
...
### fn spec.forProvider.streamAnalyticsClusterNameRef.policy.withResolve
...
## obj spec.forProvider.streamAnalyticsClusterNameSelector

"Selector for a Cluster in streamanalytics to populate streamAnalyticsClusterName."

### fn spec.forProvider.streamAnalyticsClusterNameSelector.withMatchControllerRef
...
### fn spec.forProvider.streamAnalyticsClusterNameSelector.withMatchLabels
...
### fn spec.forProvider.streamAnalyticsClusterNameSelector.withMatchLabelsMixin
...
## obj spec.forProvider.streamAnalyticsClusterNameSelector.policy

"Policies for selection."

### fn spec.forProvider.streamAnalyticsClusterNameSelector.policy.withResolution
...
### fn spec.forProvider.streamAnalyticsClusterNameSelector.policy.withResolve
