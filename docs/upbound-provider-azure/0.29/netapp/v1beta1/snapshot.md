---
permalink: /upbound-provider-azure/0.29/netapp/v1beta1/snapshot/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withVolumeName(volumeName)`](#fn-specforproviderwithvolumename)
    ...
    * [`obj spec.forProvider.volumeNameRef`](#obj-specforprovidervolumenameref)
      * [`fn withName(name)`](#fn-specforprovidervolumenamerefwithname)
      * [`obj spec.forProvider.volumeNameRef.policy`](#obj-specforprovidervolumenamerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidervolumenamerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidervolumenamerefpolicywithresolve)
    * [`obj spec.forProvider.volumeNameSelector`](#obj-specforprovidervolumenameselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidervolumenameselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidervolumenameselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidervolumenameselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.volumeNameSelector.policy`](#obj-specforprovidervolumenameselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidervolumenameselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidervolumenameselectorpolicywithresolve)
...
### fn spec.forProvider.withVolumeName
...
## obj spec.forProvider.volumeNameRef

"Reference to a Volume to populate volumeName."

### fn spec.forProvider.volumeNameRef.withName
...
## obj spec.forProvider.volumeNameRef.policy

"Policies for referencing."

### fn spec.forProvider.volumeNameRef.policy.withResolution
...
### fn spec.forProvider.volumeNameRef.policy.withResolve
...
## obj spec.forProvider.volumeNameSelector

"Selector for a Volume to populate volumeName."

### fn spec.forProvider.volumeNameSelector.withMatchControllerRef
...
### fn spec.forProvider.volumeNameSelector.withMatchLabels
...
### fn spec.forProvider.volumeNameSelector.withMatchLabelsMixin
...
## obj spec.forProvider.volumeNameSelector.policy

"Policies for selection."

### fn spec.forProvider.volumeNameSelector.policy.withResolution
...
### fn spec.forProvider.volumeNameSelector.policy.withResolve
