---
permalink: /upbound-provider-azure/0.29/azure/v1beta1/providerConfig/
---
...
"ClientID is the user-assigned managed identity's ID when Credentials.Source is `InjectedIdentity`. If unset and Credentials.Source is `InjectedIdentity`, then a system-assigned managed identity is used."
...
"MSIEndpoint is the optional path to a custom endpoint for Managed Service Identity."
...
"TenantID is the Azure AD tenant ID to be used. If unset, tenant ID from Credentials will be used. Required if Credentials.Source is InjectedIdentity."
