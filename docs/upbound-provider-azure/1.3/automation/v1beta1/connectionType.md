---
permalink: /upbound-provider-azure/1.3/automation/v1beta1/connectionType/
---

# automation.v1beta1.connectionType
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withFieldMixin(field)`](#fn-specforproviderwithfieldmixin)
    * [`fn withIsGlobal(isGlobal)`](#fn-specforproviderwithisglobal)
    ...
    * [`obj spec.forProvider.field`](#obj-specforproviderfield)
      * [`fn withIsEncrypted(isEncrypted)`](#fn-specforproviderfieldwithisencrypted)
      * [`fn withIsOptional(isOptional)`](#fn-specforproviderfieldwithisoptional)
      * [`fn withName(name)`](#fn-specforproviderfieldwithname)
      * [`fn withType(type)`](#fn-specforproviderfieldwithtype)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withField(field)`](#fn-specinitproviderwithfield)
    * [`fn withFieldMixin(field)`](#fn-specinitproviderwithfieldmixin)
    * [`fn withIsGlobal(isGlobal)`](#fn-specinitproviderwithisglobal)
    ...
    * [`obj spec.initProvider.field`](#obj-specinitproviderfield)
      * [`fn withIsEncrypted(isEncrypted)`](#fn-specinitproviderfieldwithisencrypted)
      * [`fn withIsOptional(isOptional)`](#fn-specinitproviderfieldwithisoptional)
      * [`fn withName(name)`](#fn-specinitproviderfieldwithname)
      * [`fn withType(type)`](#fn-specinitproviderfieldwithtype)
...
new returns an instance of ConnectionType
...
### fn spec.forProvider.withFieldMixin
...
### fn spec.forProvider.withIsGlobal

```ts
withIsGlobal(isGlobal)
```
...
## obj spec.forProvider.field

"One or more field blocks as defined below. Changing this forces a new Automation to be created."

### fn spec.forProvider.field.withIsEncrypted

```ts
withIsEncrypted(isEncrypted)
```

"Whether to set the isEncrypted flag of the connection field definition."

### fn spec.forProvider.field.withIsOptional

```ts
withIsOptional(isOptional)
```

"Whether to set the isOptional flag of the connection field definition."

### fn spec.forProvider.field.withName
...
### fn spec.forProvider.field.withType
...
### fn spec.initProvider.withField
...
### fn spec.initProvider.withFieldMixin
...
### fn spec.initProvider.withIsGlobal
...
## obj spec.initProvider.field

"One or more field blocks as defined below. Changing this forces a new Automation to be created."

### fn spec.initProvider.field.withIsEncrypted
...
### fn spec.initProvider.field.withIsOptional
...
### fn spec.initProvider.field.withName
...
### fn spec.initProvider.field.withType
