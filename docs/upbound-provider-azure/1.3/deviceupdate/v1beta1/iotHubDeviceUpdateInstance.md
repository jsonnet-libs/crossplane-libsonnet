---
permalink: /upbound-provider-azure/1.3/deviceupdate/v1beta1/iotHubDeviceUpdateInstance/
---

# deviceupdate.v1beta1.iotHubDeviceUpdateInstance
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withDiagnosticStorageAccount(diagnosticStorageAccount)`](#fn-specforproviderwithdiagnosticstorageaccount)
    * [`fn withDiagnosticStorageAccountMixin(diagnosticStorageAccount)`](#fn-specforproviderwithdiagnosticstorageaccountmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withDiagnosticStorageAccount(diagnosticStorageAccount)`](#fn-specinitproviderwithdiagnosticstorageaccount)
    * [`fn withDiagnosticStorageAccountMixin(diagnosticStorageAccount)`](#fn-specinitproviderwithdiagnosticstorageaccountmixin)
...
### fn spec.forProvider.withDiagnosticStorageAccount

```ts
withDiagnosticStorageAccount(diagnosticStorageAccount)
```

"A diagnostic_storage_account block as defined below."

### fn spec.forProvider.withDiagnosticStorageAccountMixin

```ts
withDiagnosticStorageAccountMixin(diagnosticStorageAccount)
```
...
### fn spec.initProvider.withDiagnosticStorageAccount
...
### fn spec.initProvider.withDiagnosticStorageAccountMixin
