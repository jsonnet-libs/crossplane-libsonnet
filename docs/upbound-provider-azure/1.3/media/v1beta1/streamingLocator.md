---
permalink: /upbound-provider-azure/1.3/media/v1beta1/streamingLocator/
---

# media.v1beta1.streamingLocator
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAlternativeMediaId(alternativeMediaId)`](#fn-specforproviderwithalternativemediaid)
    * [`fn withAssetName(assetName)`](#fn-specforproviderwithassetname)
    * [`fn withContentKey(contentKey)`](#fn-specforproviderwithcontentkey)
    * [`fn withContentKeyMixin(contentKey)`](#fn-specforproviderwithcontentkeymixin)
    ...
    * [`fn withFilterNames(filterNames)`](#fn-specforproviderwithfilternames)
    * [`fn withFilterNamesMixin(filterNames)`](#fn-specforproviderwithfilternamesmixin)
    ...
    * [`fn withStreamingLocatorId(streamingLocatorId)`](#fn-specforproviderwithstreaminglocatorid)
    * [`fn withStreamingPolicyName(streamingPolicyName)`](#fn-specforproviderwithstreamingpolicyname)
    ...
    * [`obj spec.forProvider.contentKey`](#obj-specforprovidercontentkey)
      * [`fn withContentKeyId(contentKeyId)`](#fn-specforprovidercontentkeywithcontentkeyid)
      * [`fn withLabelReferenceInStreamingPolicy(labelReferenceInStreamingPolicy)`](#fn-specforprovidercontentkeywithlabelreferenceinstreamingpolicy)
      * [`fn withPolicyName(policyName)`](#fn-specforprovidercontentkeywithpolicyname)
      * [`fn withType(type)`](#fn-specforprovidercontentkeywithtype)
      * [`fn withValue(value)`](#fn-specforprovidercontentkeywithvalue)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAlternativeMediaId(alternativeMediaId)`](#fn-specinitproviderwithalternativemediaid)
    * [`fn withAssetName(assetName)`](#fn-specinitproviderwithassetname)
    * [`fn withContentKey(contentKey)`](#fn-specinitproviderwithcontentkey)
    * [`fn withContentKeyMixin(contentKey)`](#fn-specinitproviderwithcontentkeymixin)
    ...
    * [`fn withFilterNames(filterNames)`](#fn-specinitproviderwithfilternames)
    * [`fn withFilterNamesMixin(filterNames)`](#fn-specinitproviderwithfilternamesmixin)
    * [`fn withStartTime(startTime)`](#fn-specinitproviderwithstarttime)
    * [`fn withStreamingLocatorId(streamingLocatorId)`](#fn-specinitproviderwithstreaminglocatorid)
    * [`fn withStreamingPolicyName(streamingPolicyName)`](#fn-specinitproviderwithstreamingpolicyname)
    ...
    * [`obj spec.initProvider.contentKey`](#obj-specinitprovidercontentkey)
      * [`fn withContentKeyId(contentKeyId)`](#fn-specinitprovidercontentkeywithcontentkeyid)
      * [`fn withLabelReferenceInStreamingPolicy(labelReferenceInStreamingPolicy)`](#fn-specinitprovidercontentkeywithlabelreferenceinstreamingpolicy)
      * [`fn withPolicyName(policyName)`](#fn-specinitprovidercontentkeywithpolicyname)
      * [`fn withType(type)`](#fn-specinitprovidercontentkeywithtype)
      * [`fn withValue(value)`](#fn-specinitprovidercontentkeywithvalue)
...
new returns an instance of StreamingLocator
...
### fn spec.forProvider.withAlternativeMediaId
...
### fn spec.forProvider.withContentKey
...
### fn spec.forProvider.withContentKeyMixin

```ts
withContentKeyMixin(contentKey)
```
...
### fn spec.forProvider.withFilterNames

```ts
withFilterNames(filterNames)
```
...
### fn spec.forProvider.withFilterNamesMixin

```ts
withFilterNamesMixin(filterNames)
```
...
### fn spec.forProvider.withStreamingLocatorId

```ts
withStreamingLocatorId(streamingLocatorId)
```

"The ID of the Streaming Locator. Changing this forces a new Streaming Locator to be created."

### fn spec.forProvider.withStreamingPolicyName
...
## obj spec.forProvider.contentKey

"One or more content_key blocks as defined below. Changing this forces a new Streaming Locator to be created."

### fn spec.forProvider.contentKey.withContentKeyId

```ts
withContentKeyId(contentKeyId)
```

"ID of Content Key. Changing this forces a new Streaming Locator to be created."

### fn spec.forProvider.contentKey.withLabelReferenceInStreamingPolicy

```ts
withLabelReferenceInStreamingPolicy(labelReferenceInStreamingPolicy)
```

"Label of Content Key as specified in the Streaming Policy. Changing this forces a new Streaming Locator to be created."

### fn spec.forProvider.contentKey.withPolicyName
...
### fn spec.forProvider.contentKey.withType
...
### fn spec.forProvider.contentKey.withValue
...
### fn spec.initProvider.withAlternativeMediaId
...
### fn spec.initProvider.withContentKey
...
### fn spec.initProvider.withContentKeyMixin
...
### fn spec.initProvider.withFilterNames
...
### fn spec.initProvider.withFilterNamesMixin
...
### fn spec.initProvider.withStreamingLocatorId
...
### fn spec.initProvider.withStreamingPolicyName
...
## obj spec.initProvider.contentKey

"One or more content_key blocks as defined below. Changing this forces a new Streaming Locator to be created."

### fn spec.initProvider.contentKey.withContentKeyId
...
### fn spec.initProvider.contentKey.withLabelReferenceInStreamingPolicy
...
### fn spec.initProvider.contentKey.withPolicyName
...
### fn spec.initProvider.contentKey.withType
...
### fn spec.initProvider.contentKey.withValue
