---
permalink: /upbound-provider-azure/1.3/media/v1beta1/assetFilter/
---

# media.v1beta1.assetFilter
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.assetIdRef`](#obj-specforproviderassetidref)
      * [`fn withName(name)`](#fn-specforproviderassetidrefwithname)
      * [`obj spec.forProvider.assetIdRef.policy`](#obj-specforproviderassetidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderassetidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderassetidrefpolicywithresolve)
    * [`obj spec.forProvider.assetIdSelector`](#obj-specforproviderassetidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderassetidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderassetidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderassetidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.assetIdSelector.policy`](#obj-specforproviderassetidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderassetidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderassetidselectorpolicywithresolve)
    * [`obj spec.forProvider.presentationTimeRange`](#obj-specforproviderpresentationtimerange)
      ...
      * [`fn withUnitTimescaleInMiliseconds(unitTimescaleInMiliseconds)`](#fn-specforproviderpresentationtimerangewithunittimescaleinmiliseconds)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.presentationTimeRange`](#obj-specinitproviderpresentationtimerange)
      ...
      * [`fn withUnitTimescaleInMiliseconds(unitTimescaleInMiliseconds)`](#fn-specinitproviderpresentationtimerangewithunittimescaleinmiliseconds)
...
new returns an instance of AssetFilter
...
## obj spec.forProvider.assetIdRef

"Reference to a Asset in media to populate assetId."

### fn spec.forProvider.assetIdRef.withName
...
## obj spec.forProvider.assetIdRef.policy

"Policies for referencing."

### fn spec.forProvider.assetIdRef.policy.withResolution
...
### fn spec.forProvider.assetIdRef.policy.withResolve
...
## obj spec.forProvider.assetIdSelector

"Selector for a Asset in media to populate assetId."

### fn spec.forProvider.assetIdSelector.withMatchControllerRef
...
### fn spec.forProvider.assetIdSelector.withMatchLabels
...
### fn spec.forProvider.assetIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.assetIdSelector.policy

"Policies for selection."

### fn spec.forProvider.assetIdSelector.policy.withResolution
...
### fn spec.forProvider.assetIdSelector.policy.withResolve
...
### fn spec.forProvider.presentationTimeRange.withUnitTimescaleInMiliseconds

```ts
withUnitTimescaleInMiliseconds(unitTimescaleInMiliseconds)
```
...
### fn spec.initProvider.presentationTimeRange.withUnitTimescaleInMiliseconds
