---
permalink: /upbound-provider-azure/1.3/media/v1beta1/job/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withInputAsset(inputAsset)`](#fn-specforproviderwithinputasset)
    * [`fn withInputAssetMixin(inputAsset)`](#fn-specforproviderwithinputassetmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withInputAsset(inputAsset)`](#fn-specinitproviderwithinputasset)
    * [`fn withInputAssetMixin(inputAsset)`](#fn-specinitproviderwithinputassetmixin)
...
### fn spec.forProvider.withInputAsset

```ts
withInputAsset(inputAsset)
```

"A input_asset block as defined below. Changing this forces a new Media Job to be created."

### fn spec.forProvider.withInputAssetMixin

```ts
withInputAssetMixin(inputAsset)
```
...
### fn spec.initProvider.withInputAsset
...
### fn spec.initProvider.withInputAssetMixin
