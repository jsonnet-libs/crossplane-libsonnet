---
permalink: /upbound-provider-azure/1.3/datafactory/v1beta1/linkedServiceAzureFunction/
---

# datafactory.v1beta1.linkedServiceAzureFunction
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withKeyVaultKey(keyVaultKey)`](#fn-specforproviderwithkeyvaultkey)
    * [`fn withKeyVaultKeyMixin(keyVaultKey)`](#fn-specforproviderwithkeyvaultkeymixin)
    ...
    * [`obj spec.forProvider.keyVaultKey`](#obj-specforproviderkeyvaultkey)
      * [`fn withLinkedServiceName(linkedServiceName)`](#fn-specforproviderkeyvaultkeywithlinkedservicename)
      * [`fn withSecretName(secretName)`](#fn-specforproviderkeyvaultkeywithsecretname)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withKeyVaultKey(keyVaultKey)`](#fn-specinitproviderwithkeyvaultkey)
    * [`fn withKeyVaultKeyMixin(keyVaultKey)`](#fn-specinitproviderwithkeyvaultkeymixin)
    ...
    * [`obj spec.initProvider.keyVaultKey`](#obj-specinitproviderkeyvaultkey)
      * [`fn withLinkedServiceName(linkedServiceName)`](#fn-specinitproviderkeyvaultkeywithlinkedservicename)
      * [`fn withSecretName(secretName)`](#fn-specinitproviderkeyvaultkeywithsecretname)
...
new returns an instance of LinkedServiceAzureFunction
...
### fn spec.forProvider.withKeyVaultKey

```ts
withKeyVaultKey(keyVaultKey)
```
...
### fn spec.forProvider.withKeyVaultKeyMixin

```ts
withKeyVaultKeyMixin(keyVaultKey)
```
...
## obj spec.forProvider.keyVaultKey

"A key_vault_key block as defined below. Use this Argument to store the system key of the Azure Function in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. Exactly one of either key or key_vault_key is required."

### fn spec.forProvider.keyVaultKey.withLinkedServiceName
...
### fn spec.forProvider.keyVaultKey.withSecretName
...
### fn spec.initProvider.withKeyVaultKey
...
### fn spec.initProvider.withKeyVaultKeyMixin
...
## obj spec.initProvider.keyVaultKey

"A key_vault_key block as defined below. Use this Argument to store the system key of the Azure Function in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. Exactly one of either key or key_vault_key is required."

### fn spec.initProvider.keyVaultKey.withLinkedServiceName
...
### fn spec.initProvider.keyVaultKey.withSecretName
