---
permalink: /upbound-provider-azure/1.3/datafactory/v1beta1/pipeline/
---

# datafactory.v1beta1.pipeline
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withActivitiesJson(activitiesJson)`](#fn-specforproviderwithactivitiesjson)
    ...
    * [`fn withMoniterMetricsAfterDuration(moniterMetricsAfterDuration)`](#fn-specforproviderwithmonitermetricsafterduration)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withActivitiesJson(activitiesJson)`](#fn-specinitproviderwithactivitiesjson)
    ...
    * [`fn withMoniterMetricsAfterDuration(moniterMetricsAfterDuration)`](#fn-specinitproviderwithmonitermetricsafterduration)
...
### fn spec.forProvider.withActivitiesJson

```ts
withActivitiesJson(activitiesJson)
```
...
### fn spec.forProvider.withMoniterMetricsAfterDuration

```ts
withMoniterMetricsAfterDuration(moniterMetricsAfterDuration)
```
...
### fn spec.initProvider.withActivitiesJson
...
### fn spec.initProvider.withMoniterMetricsAfterDuration
