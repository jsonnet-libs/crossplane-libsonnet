---
permalink: /upbound-provider-azure/1.3/datafactory/v1beta1/triggerCustomEvent/
---

# datafactory.v1beta1.triggerCustomEvent
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withEventgridTopicId(eventgridTopicId)`](#fn-specforproviderwitheventgridtopicid)
    ...
    * [`fn withSubjectBeginsWith(subjectBeginsWith)`](#fn-specforproviderwithsubjectbeginswith)
    * [`fn withSubjectEndsWith(subjectEndsWith)`](#fn-specforproviderwithsubjectendswith)
    ...
    * [`obj spec.forProvider.eventgridTopicIdRef`](#obj-specforprovidereventgridtopicidref)
      * [`fn withName(name)`](#fn-specforprovidereventgridtopicidrefwithname)
      * [`obj spec.forProvider.eventgridTopicIdRef.policy`](#obj-specforprovidereventgridtopicidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidereventgridtopicidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidereventgridtopicidrefpolicywithresolve)
    * [`obj spec.forProvider.eventgridTopicIdSelector`](#obj-specforprovidereventgridtopicidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidereventgridtopicidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidereventgridtopicidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidereventgridtopicidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.eventgridTopicIdSelector.policy`](#obj-specforprovidereventgridtopicidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidereventgridtopicidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidereventgridtopicidselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withEventgridTopicId(eventgridTopicId)`](#fn-specinitproviderwitheventgridtopicid)
    ...
    * [`fn withSubjectBeginsWith(subjectBeginsWith)`](#fn-specinitproviderwithsubjectbeginswith)
    * [`fn withSubjectEndsWith(subjectEndsWith)`](#fn-specinitproviderwithsubjectendswith)
    * [`obj spec.initProvider.eventgridTopicIdRef`](#obj-specinitprovidereventgridtopicidref)
      * [`fn withName(name)`](#fn-specinitprovidereventgridtopicidrefwithname)
      * [`obj spec.initProvider.eventgridTopicIdRef.policy`](#obj-specinitprovidereventgridtopicidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidereventgridtopicidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidereventgridtopicidrefpolicywithresolve)
    * [`obj spec.initProvider.eventgridTopicIdSelector`](#obj-specinitprovidereventgridtopicidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidereventgridtopicidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidereventgridtopicidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidereventgridtopicidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.eventgridTopicIdSelector.policy`](#obj-specinitprovidereventgridtopicidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidereventgridtopicidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidereventgridtopicidselectorpolicywithresolve)
...
new returns an instance of TriggerCustomEvent
...
### fn spec.forProvider.withEventgridTopicId

```ts
withEventgridTopicId(eventgridTopicId)
```
...
### fn spec.forProvider.withSubjectBeginsWith
...
### fn spec.forProvider.withSubjectEndsWith
...
## obj spec.forProvider.eventgridTopicIdRef

"Reference to a Topic in eventgrid to populate eventgridTopicId."

### fn spec.forProvider.eventgridTopicIdRef.withName
...
## obj spec.forProvider.eventgridTopicIdRef.policy

"Policies for referencing."

### fn spec.forProvider.eventgridTopicIdRef.policy.withResolution
...
### fn spec.forProvider.eventgridTopicIdRef.policy.withResolve
...
## obj spec.forProvider.eventgridTopicIdSelector

"Selector for a Topic in eventgrid to populate eventgridTopicId."

### fn spec.forProvider.eventgridTopicIdSelector.withMatchControllerRef
...
### fn spec.forProvider.eventgridTopicIdSelector.withMatchLabels
...
### fn spec.forProvider.eventgridTopicIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.eventgridTopicIdSelector.policy

"Policies for selection."

### fn spec.forProvider.eventgridTopicIdSelector.policy.withResolution
...
### fn spec.forProvider.eventgridTopicIdSelector.policy.withResolve
...
### fn spec.initProvider.withEventgridTopicId
...
### fn spec.initProvider.withSubjectBeginsWith
...
### fn spec.initProvider.withSubjectEndsWith
...
## obj spec.initProvider.eventgridTopicIdRef

"Reference to a Topic in eventgrid to populate eventgridTopicId."

### fn spec.initProvider.eventgridTopicIdRef.withName
...
## obj spec.initProvider.eventgridTopicIdRef.policy

"Policies for referencing."

### fn spec.initProvider.eventgridTopicIdRef.policy.withResolution
...
### fn spec.initProvider.eventgridTopicIdRef.policy.withResolve
...
## obj spec.initProvider.eventgridTopicIdSelector

"Selector for a Topic in eventgrid to populate eventgridTopicId."

### fn spec.initProvider.eventgridTopicIdSelector.withMatchControllerRef
...
### fn spec.initProvider.eventgridTopicIdSelector.withMatchLabels
...
### fn spec.initProvider.eventgridTopicIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.eventgridTopicIdSelector.policy

"Policies for selection."

### fn spec.initProvider.eventgridTopicIdSelector.policy.withResolution
...
### fn spec.initProvider.eventgridTopicIdSelector.policy.withResolve
