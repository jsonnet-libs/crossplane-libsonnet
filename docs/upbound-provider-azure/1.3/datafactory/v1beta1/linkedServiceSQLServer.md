---
permalink: /upbound-provider-azure/1.3/datafactory/v1beta1/linkedServiceSQLServer/
---

# datafactory.v1beta1.linkedServiceSQLServer
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withKeyVaultConnectionString(keyVaultConnectionString)`](#fn-specforproviderwithkeyvaultconnectionstring)
    * [`fn withKeyVaultConnectionStringMixin(keyVaultConnectionString)`](#fn-specforproviderwithkeyvaultconnectionstringmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withKeyVaultConnectionString(keyVaultConnectionString)`](#fn-specinitproviderwithkeyvaultconnectionstring)
    * [`fn withKeyVaultConnectionStringMixin(keyVaultConnectionString)`](#fn-specinitproviderwithkeyvaultconnectionstringmixin)
...
new returns an instance of LinkedServiceSQLServer
...
### fn spec.forProvider.withKeyVaultConnectionString

```ts
withKeyVaultConnectionString(keyVaultConnectionString)
```
...
### fn spec.forProvider.withKeyVaultConnectionStringMixin

```ts
withKeyVaultConnectionStringMixin(keyVaultConnectionString)
```
...
### fn spec.initProvider.withKeyVaultConnectionString
...
### fn spec.initProvider.withKeyVaultConnectionStringMixin
