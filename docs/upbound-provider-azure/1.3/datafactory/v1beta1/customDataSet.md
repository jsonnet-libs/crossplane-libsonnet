---
permalink: /upbound-provider-azure/1.3/datafactory/v1beta1/customDataSet/
---

# datafactory.v1beta1.customDataSet
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withLinkedService(linkedService)`](#fn-specforproviderwithlinkedservice)
    * [`fn withLinkedServiceMixin(linkedService)`](#fn-specforproviderwithlinkedservicemixin)
    ...
    * [`fn withSchemaJson(schemaJson)`](#fn-specforproviderwithschemajson)
    ...
    * [`obj spec.forProvider.linkedService`](#obj-specforproviderlinkedservice)
      * [`fn withName(name)`](#fn-specforproviderlinkedservicewithname)
      * [`fn withParameters(parameters)`](#fn-specforproviderlinkedservicewithparameters)
      * [`fn withParametersMixin(parameters)`](#fn-specforproviderlinkedservicewithparametersmixin)
      * [`obj spec.forProvider.linkedService.nameRef`](#obj-specforproviderlinkedservicenameref)
        * [`fn withName(name)`](#fn-specforproviderlinkedservicenamerefwithname)
        * [`obj spec.forProvider.linkedService.nameRef.policy`](#obj-specforproviderlinkedservicenamerefpolicy)
      ...
      * [`obj spec.forProvider.linkedService.nameSelector`](#obj-specforproviderlinkedservicenameselector)
        ...
        * [`obj spec.forProvider.linkedService.nameSelector.policy`](#obj-specforproviderlinkedservicenameselectorpolicy)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withLinkedService(linkedService)`](#fn-specinitproviderwithlinkedservice)
    * [`fn withLinkedServiceMixin(linkedService)`](#fn-specinitproviderwithlinkedservicemixin)
    ...
    * [`fn withSchemaJson(schemaJson)`](#fn-specinitproviderwithschemajson)
    * [`fn withType(type)`](#fn-specinitproviderwithtype)
    * [`fn withTypePropertiesJson(typePropertiesJson)`](#fn-specinitproviderwithtypepropertiesjson)
    * [`obj spec.initProvider.linkedService`](#obj-specinitproviderlinkedservice)
      * [`fn withName(name)`](#fn-specinitproviderlinkedservicewithname)
      * [`fn withParameters(parameters)`](#fn-specinitproviderlinkedservicewithparameters)
      * [`fn withParametersMixin(parameters)`](#fn-specinitproviderlinkedservicewithparametersmixin)
      * [`obj spec.initProvider.linkedService.nameRef`](#obj-specinitproviderlinkedservicenameref)
        * [`fn withName(name)`](#fn-specinitproviderlinkedservicenamerefwithname)
        * [`obj spec.initProvider.linkedService.nameRef.policy`](#obj-specinitproviderlinkedservicenamerefpolicy)
      ...
      * [`obj spec.initProvider.linkedService.nameSelector`](#obj-specinitproviderlinkedservicenameselector)
        ...
        * [`obj spec.initProvider.linkedService.nameSelector.policy`](#obj-specinitproviderlinkedservicenameselectorpolicy)
...
new returns an instance of CustomDataSet
...
### fn spec.forProvider.withLinkedService
...
### fn spec.forProvider.withLinkedServiceMixin
...
### fn spec.forProvider.withSchemaJson

```ts
withSchemaJson(schemaJson)
```
...
## obj spec.forProvider.linkedService

"A linked_service block as defined below."

### fn spec.forProvider.linkedService.withName
...
### fn spec.forProvider.linkedService.withParameters
...
### fn spec.forProvider.linkedService.withParametersMixin
...
## obj spec.forProvider.linkedService.nameRef

"Reference to a LinkedCustomService in datafactory to populate name."

### fn spec.forProvider.linkedService.nameRef.withName
...
## obj spec.forProvider.linkedService.nameRef.policy

"Policies for referencing."

### fn spec.forProvider.linkedService.nameRef.policy.withResolution
...
### fn spec.forProvider.linkedService.nameRef.policy.withResolve
...
## obj spec.forProvider.linkedService.nameSelector

"Selector for a LinkedCustomService in datafactory to populate name."

### fn spec.forProvider.linkedService.nameSelector.withMatchControllerRef
...
### fn spec.forProvider.linkedService.nameSelector.withMatchLabels
...
### fn spec.forProvider.linkedService.nameSelector.withMatchLabelsMixin
...
## obj spec.forProvider.linkedService.nameSelector.policy

"Policies for selection."

### fn spec.forProvider.linkedService.nameSelector.policy.withResolution
...
### fn spec.forProvider.linkedService.nameSelector.policy.withResolve
...
### fn spec.initProvider.withLinkedService
...
### fn spec.initProvider.withLinkedServiceMixin
...
### fn spec.initProvider.withSchemaJson
...
## obj spec.initProvider.linkedService

"A linked_service block as defined below."

### fn spec.initProvider.linkedService.withName
...
### fn spec.initProvider.linkedService.withParameters
...
### fn spec.initProvider.linkedService.withParametersMixin
...
## obj spec.initProvider.linkedService.nameRef

"Reference to a LinkedCustomService in datafactory to populate name."

### fn spec.initProvider.linkedService.nameRef.withName
...
## obj spec.initProvider.linkedService.nameRef.policy

"Policies for referencing."

### fn spec.initProvider.linkedService.nameRef.policy.withResolution
...
### fn spec.initProvider.linkedService.nameRef.policy.withResolve
...
## obj spec.initProvider.linkedService.nameSelector

"Selector for a LinkedCustomService in datafactory to populate name."

### fn spec.initProvider.linkedService.nameSelector.withMatchControllerRef
...
### fn spec.initProvider.linkedService.nameSelector.withMatchLabels
...
### fn spec.initProvider.linkedService.nameSelector.withMatchLabelsMixin
...
## obj spec.initProvider.linkedService.nameSelector.policy

"Policies for selection."

### fn spec.initProvider.linkedService.nameSelector.policy.withResolution
...
### fn spec.initProvider.linkedService.nameSelector.policy.withResolve
