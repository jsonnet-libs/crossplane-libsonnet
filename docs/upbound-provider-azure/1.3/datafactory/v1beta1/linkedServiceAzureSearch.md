---
permalink: /upbound-provider-azure/1.3/datafactory/v1beta1/linkedServiceAzureSearch/
---

# datafactory.v1beta1.linkedServiceAzureSearch
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withSearchServiceKey(searchServiceKey)`](#fn-specforproviderwithsearchservicekey)
    ...
    * [`obj spec.forProvider.searchServiceKeyRef`](#obj-specforprovidersearchservicekeyref)
      * [`fn withName(name)`](#fn-specforprovidersearchservicekeyrefwithname)
      * [`obj spec.forProvider.searchServiceKeyRef.policy`](#obj-specforprovidersearchservicekeyrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidersearchservicekeyrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidersearchservicekeyrefpolicywithresolve)
    * [`obj spec.forProvider.searchServiceKeySelector`](#obj-specforprovidersearchservicekeyselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidersearchservicekeyselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidersearchservicekeyselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidersearchservicekeyselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.searchServiceKeySelector.policy`](#obj-specforprovidersearchservicekeyselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidersearchservicekeyselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidersearchservicekeyselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withSearchServiceKey(searchServiceKey)`](#fn-specinitproviderwithsearchservicekey)
    * [`fn withUrl(url)`](#fn-specinitproviderwithurl)
    * [`obj spec.initProvider.searchServiceKeyRef`](#obj-specinitprovidersearchservicekeyref)
      * [`fn withName(name)`](#fn-specinitprovidersearchservicekeyrefwithname)
      * [`obj spec.initProvider.searchServiceKeyRef.policy`](#obj-specinitprovidersearchservicekeyrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidersearchservicekeyrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidersearchservicekeyrefpolicywithresolve)
    * [`obj spec.initProvider.searchServiceKeySelector`](#obj-specinitprovidersearchservicekeyselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidersearchservicekeyselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidersearchservicekeyselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidersearchservicekeyselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.searchServiceKeySelector.policy`](#obj-specinitprovidersearchservicekeyselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidersearchservicekeyselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidersearchservicekeyselectorpolicywithresolve)
...
new returns an instance of LinkedServiceAzureSearch
...
### fn spec.forProvider.withSearchServiceKey

```ts
withSearchServiceKey(searchServiceKey)
```
...
## obj spec.forProvider.searchServiceKeyRef

"Reference to a Service in search to populate searchServiceKey."

### fn spec.forProvider.searchServiceKeyRef.withName
...
## obj spec.forProvider.searchServiceKeyRef.policy

"Policies for referencing."

### fn spec.forProvider.searchServiceKeyRef.policy.withResolution
...
### fn spec.forProvider.searchServiceKeyRef.policy.withResolve
...
## obj spec.forProvider.searchServiceKeySelector

"Selector for a Service in search to populate searchServiceKey."

### fn spec.forProvider.searchServiceKeySelector.withMatchControllerRef
...
### fn spec.forProvider.searchServiceKeySelector.withMatchLabels
...
### fn spec.forProvider.searchServiceKeySelector.withMatchLabelsMixin
...
## obj spec.forProvider.searchServiceKeySelector.policy

"Policies for selection."

### fn spec.forProvider.searchServiceKeySelector.policy.withResolution
...
### fn spec.forProvider.searchServiceKeySelector.policy.withResolve
...
### fn spec.initProvider.withSearchServiceKey
...
## obj spec.initProvider.searchServiceKeyRef

"Reference to a Service in search to populate searchServiceKey."

### fn spec.initProvider.searchServiceKeyRef.withName
...
## obj spec.initProvider.searchServiceKeyRef.policy

"Policies for referencing."

### fn spec.initProvider.searchServiceKeyRef.policy.withResolution
...
### fn spec.initProvider.searchServiceKeyRef.policy.withResolve
...
## obj spec.initProvider.searchServiceKeySelector

"Selector for a Service in search to populate searchServiceKey."

### fn spec.initProvider.searchServiceKeySelector.withMatchControllerRef
...
### fn spec.initProvider.searchServiceKeySelector.withMatchLabels
...
### fn spec.initProvider.searchServiceKeySelector.withMatchLabelsMixin
...
## obj spec.initProvider.searchServiceKeySelector.policy

"Policies for selection."

### fn spec.initProvider.searchServiceKeySelector.policy.withResolution
...
### fn spec.initProvider.searchServiceKeySelector.policy.withResolve
