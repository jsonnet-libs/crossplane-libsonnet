---
permalink: /upbound-provider-azure/1.3/signalrservice/v1beta1/webPubsubNetworkACL/
---

# signalrservice.v1beta1.webPubsubNetworkACL
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPublicNetwork(publicNetwork)`](#fn-specforproviderwithpublicnetwork)
    * [`fn withPublicNetworkMixin(publicNetwork)`](#fn-specforproviderwithpublicnetworkmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withPublicNetwork(publicNetwork)`](#fn-specinitproviderwithpublicnetwork)
    * [`fn withPublicNetworkMixin(publicNetwork)`](#fn-specinitproviderwithpublicnetworkmixin)
...
new returns an instance of WebPubsubNetworkACL
...
### fn spec.forProvider.withPublicNetwork

```ts
withPublicNetwork(publicNetwork)
```

"A public_network block as defined below."

### fn spec.forProvider.withPublicNetworkMixin

```ts
withPublicNetworkMixin(publicNetwork)
```
...
### fn spec.initProvider.withPublicNetwork
...
### fn spec.initProvider.withPublicNetworkMixin
