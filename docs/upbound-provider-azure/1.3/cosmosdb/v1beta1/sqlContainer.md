---
permalink: /upbound-provider-azure/1.3/cosmosdb/v1beta1/sqlContainer/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.indexingPolicy`](#obj-specforproviderindexingpolicy)
      ...
      * [`obj spec.forProvider.indexingPolicy.spatialIndex`](#obj-specforproviderindexingpolicyspatialindex)
        * [`fn withPath(path)`](#fn-specforproviderindexingpolicyspatialindexwithpath)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withAutoscaleSettings(autoscaleSettings)`](#fn-specinitproviderwithautoscalesettings)
    * [`fn withAutoscaleSettingsMixin(autoscaleSettings)`](#fn-specinitproviderwithautoscalesettingsmixin)
    * [`fn withConflictResolutionPolicy(conflictResolutionPolicy)`](#fn-specinitproviderwithconflictresolutionpolicy)
    * [`fn withConflictResolutionPolicyMixin(conflictResolutionPolicy)`](#fn-specinitproviderwithconflictresolutionpolicymixin)
    * [`fn withDefaultTtl(defaultTtl)`](#fn-specinitproviderwithdefaultttl)
    * [`fn withIndexingPolicy(indexingPolicy)`](#fn-specinitproviderwithindexingpolicy)
    * [`fn withIndexingPolicyMixin(indexingPolicy)`](#fn-specinitproviderwithindexingpolicymixin)
    ...
    * [`obj spec.initProvider.indexingPolicy`](#obj-specinitproviderindexingpolicy)
      * [`fn withCompositeIndex(compositeIndex)`](#fn-specinitproviderindexingpolicywithcompositeindex)
      * [`fn withCompositeIndexMixin(compositeIndex)`](#fn-specinitproviderindexingpolicywithcompositeindexmixin)
      * [`fn withExcludedPath(excludedPath)`](#fn-specinitproviderindexingpolicywithexcludedpath)
      * [`fn withExcludedPathMixin(excludedPath)`](#fn-specinitproviderindexingpolicywithexcludedpathmixin)
      * [`fn withIncludedPath(includedPath)`](#fn-specinitproviderindexingpolicywithincludedpath)
      * [`fn withIncludedPathMixin(includedPath)`](#fn-specinitproviderindexingpolicywithincludedpathmixin)
      * [`fn withIndexingMode(indexingMode)`](#fn-specinitproviderindexingpolicywithindexingmode)
      * [`fn withSpatialIndex(spatialIndex)`](#fn-specinitproviderindexingpolicywithspatialindex)
      * [`fn withSpatialIndexMixin(spatialIndex)`](#fn-specinitproviderindexingpolicywithspatialindexmixin)
      * [`obj spec.initProvider.indexingPolicy.compositeIndex`](#obj-specinitproviderindexingpolicycompositeindex)
        * [`fn withIndex(index)`](#fn-specinitproviderindexingpolicycompositeindexwithindex)
        * [`fn withIndexMixin(index)`](#fn-specinitproviderindexingpolicycompositeindexwithindexmixin)
        * [`obj spec.initProvider.indexingPolicy.compositeIndex.index`](#obj-specinitproviderindexingpolicycompositeindexindex)
          * [`fn withOrder(order)`](#fn-specinitproviderindexingpolicycompositeindexindexwithorder)
          * [`fn withPath(path)`](#fn-specinitproviderindexingpolicycompositeindexindexwithpath)
      * [`obj spec.initProvider.indexingPolicy.excludedPath`](#obj-specinitproviderindexingpolicyexcludedpath)
        * [`fn withPath(path)`](#fn-specinitproviderindexingpolicyexcludedpathwithpath)
      * [`obj spec.initProvider.indexingPolicy.includedPath`](#obj-specinitproviderindexingpolicyincludedpath)
        * [`fn withPath(path)`](#fn-specinitproviderindexingpolicyincludedpathwithpath)
      * [`obj spec.initProvider.indexingPolicy.spatialIndex`](#obj-specinitproviderindexingpolicyspatialindex)
        * [`fn withPath(path)`](#fn-specinitproviderindexingpolicyspatialindexwithpath)
...
### fn spec.initProvider.withAutoscaleSettings
...
### fn spec.initProvider.withAutoscaleSettingsMixin
...
### fn spec.initProvider.withConflictResolutionPolicy
...
### fn spec.initProvider.withConflictResolutionPolicyMixin
...
### fn spec.initProvider.withIndexingPolicy
...
### fn spec.initProvider.withIndexingPolicyMixin
...
## obj spec.initProvider.indexingPolicy

"An indexing_policy block as defined below."

### fn spec.initProvider.indexingPolicy.withCompositeIndex
...
### fn spec.initProvider.indexingPolicy.withCompositeIndexMixin
...
### fn spec.initProvider.indexingPolicy.withExcludedPath
...
### fn spec.initProvider.indexingPolicy.withExcludedPathMixin
...
### fn spec.initProvider.indexingPolicy.withIncludedPath
...
### fn spec.initProvider.indexingPolicy.withIncludedPathMixin
...
### fn spec.initProvider.indexingPolicy.withIndexingMode
...
### fn spec.initProvider.indexingPolicy.withSpatialIndex
...
### fn spec.initProvider.indexingPolicy.withSpatialIndexMixin
...
## obj spec.initProvider.indexingPolicy.compositeIndex

"One or more composite_index blocks as defined below."

### fn spec.initProvider.indexingPolicy.compositeIndex.withIndex
...
### fn spec.initProvider.indexingPolicy.compositeIndex.withIndexMixin
...
## obj spec.initProvider.indexingPolicy.compositeIndex.index

"One or more index blocks as defined below."

### fn spec.initProvider.indexingPolicy.compositeIndex.index.withOrder
...
### fn spec.initProvider.indexingPolicy.compositeIndex.index.withPath
...
## obj spec.initProvider.indexingPolicy.excludedPath

"One or more excluded_path blocks as defined below. Either included_path or excluded_path must contain the path /*"

### fn spec.initProvider.indexingPolicy.excludedPath.withPath
...
## obj spec.initProvider.indexingPolicy.includedPath

"One or more included_path blocks as defined below. Either included_path or excluded_path must contain the path /*"

### fn spec.initProvider.indexingPolicy.includedPath.withPath
...
## obj spec.initProvider.indexingPolicy.spatialIndex

"One or more spatial_index blocks as defined below."

### fn spec.initProvider.indexingPolicy.spatialIndex.withPath
