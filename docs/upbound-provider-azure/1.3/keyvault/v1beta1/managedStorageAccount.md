---
permalink: /upbound-provider-azure/1.3/keyvault/v1beta1/managedStorageAccount/
---

# keyvault.v1beta1.managedStorageAccount
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withRegenerateKeyAutomatically(regenerateKeyAutomatically)`](#fn-specforproviderwithregeneratekeyautomatically)
    * [`fn withRegenerationPeriod(regenerationPeriod)`](#fn-specforproviderwithregenerationperiod)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withRegenerateKeyAutomatically(regenerateKeyAutomatically)`](#fn-specinitproviderwithregeneratekeyautomatically)
    * [`fn withRegenerationPeriod(regenerationPeriod)`](#fn-specinitproviderwithregenerationperiod)
...
new returns an instance of ManagedStorageAccount
...
### fn spec.forProvider.withRegenerateKeyAutomatically

```ts
withRegenerateKeyAutomatically(regenerateKeyAutomatically)
```

"Should Storage Account access key be regenerated periodically?"

### fn spec.forProvider.withRegenerationPeriod

```ts
withRegenerationPeriod(regenerationPeriod)
```
...
### fn spec.initProvider.withRegenerateKeyAutomatically
...
### fn spec.initProvider.withRegenerationPeriod
