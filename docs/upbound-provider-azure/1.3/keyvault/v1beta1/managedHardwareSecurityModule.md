---
permalink: /upbound-provider-azure/1.3/keyvault/v1beta1/managedHardwareSecurityModule/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAdminObjectIds(adminObjectIds)`](#fn-specforproviderwithadminobjectids)
    * [`fn withAdminObjectIdsMixin(adminObjectIds)`](#fn-specforproviderwithadminobjectidsmixin)
    ...
    * [`fn withSecurityDomainKeyVaultCertificateIds(securityDomainKeyVaultCertificateIds)`](#fn-specforproviderwithsecuritydomainkeyvaultcertificateids)
    * [`fn withSecurityDomainKeyVaultCertificateIdsMixin(securityDomainKeyVaultCertificateIds)`](#fn-specforproviderwithsecuritydomainkeyvaultcertificateidsmixin)
    * [`fn withSecurityDomainQuorum(securityDomainQuorum)`](#fn-specforproviderwithsecuritydomainquorum)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAdminObjectIds(adminObjectIds)`](#fn-specinitproviderwithadminobjectids)
    * [`fn withAdminObjectIdsMixin(adminObjectIds)`](#fn-specinitproviderwithadminobjectidsmixin)
    ...
    * [`fn withSecurityDomainKeyVaultCertificateIds(securityDomainKeyVaultCertificateIds)`](#fn-specinitproviderwithsecuritydomainkeyvaultcertificateids)
    * [`fn withSecurityDomainKeyVaultCertificateIdsMixin(securityDomainKeyVaultCertificateIds)`](#fn-specinitproviderwithsecuritydomainkeyvaultcertificateidsmixin)
    * [`fn withSecurityDomainQuorum(securityDomainQuorum)`](#fn-specinitproviderwithsecuritydomainquorum)
...
new returns an instance of ManagedHardwareSecurityModule
...
### fn spec.forProvider.withAdminObjectIds

```ts
withAdminObjectIds(adminObjectIds)
```
...
### fn spec.forProvider.withAdminObjectIdsMixin

```ts
withAdminObjectIdsMixin(adminObjectIds)
```
...
### fn spec.forProvider.withSecurityDomainKeyVaultCertificateIds

```ts
withSecurityDomainKeyVaultCertificateIds(securityDomainKeyVaultCertificateIds)
```
...
### fn spec.forProvider.withSecurityDomainKeyVaultCertificateIdsMixin

```ts
withSecurityDomainKeyVaultCertificateIdsMixin(securityDomainKeyVaultCertificateIds)
```
...
### fn spec.forProvider.withSecurityDomainQuorum

```ts
withSecurityDomainQuorum(securityDomainQuorum)
```
...
### fn spec.initProvider.withAdminObjectIds
...
### fn spec.initProvider.withAdminObjectIdsMixin
...
### fn spec.initProvider.withSecurityDomainKeyVaultCertificateIds
...
### fn spec.initProvider.withSecurityDomainKeyVaultCertificateIdsMixin
...
### fn spec.initProvider.withSecurityDomainQuorum
