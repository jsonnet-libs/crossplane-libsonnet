---
permalink: /upbound-provider-azure/1.3/network/v1beta2/vpnServerConfiguration/
---

# network.v1beta2.vpnServerConfiguration
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.radius`](#obj-specinitproviderradius)
      ...
      * [`obj spec.initProvider.radius.server`](#obj-specinitproviderradiusserver)
        ...
        * [`obj spec.initProvider.radius.server.secretSecretRef`](#obj-specinitproviderradiusserversecretsecretref)
          * [`fn withKey(key)`](#fn-specinitproviderradiusserversecretsecretrefwithkey)
          * [`fn withName(name)`](#fn-specinitproviderradiusserversecretsecretrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specinitproviderradiusserversecretsecretrefwithnamespace)
...
## obj spec.initProvider.radius.server.secretSecretRef

"The Secret used to communicate with the Radius Server."

### fn spec.initProvider.radius.server.secretSecretRef.withKey
...
### fn spec.initProvider.radius.server.secretSecretRef.withName
...
### fn spec.initProvider.radius.server.secretSecretRef.withNamespace
