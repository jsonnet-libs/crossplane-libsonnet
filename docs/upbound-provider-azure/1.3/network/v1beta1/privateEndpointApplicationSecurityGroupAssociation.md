---
permalink: /upbound-provider-azure/1.3/network/v1beta1/privateEndpointApplicationSecurityGroupAssociation/
---

# network.v1beta1.privateEndpointApplicationSecurityGroupAssociation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPrivateEndpointId(privateEndpointId)`](#fn-specforproviderwithprivateendpointid)
    ...
    * [`obj spec.forProvider.privateEndpointIdRef`](#obj-specforproviderprivateendpointidref)
      * [`fn withName(name)`](#fn-specforproviderprivateendpointidrefwithname)
      * [`obj spec.forProvider.privateEndpointIdRef.policy`](#obj-specforproviderprivateendpointidrefpolicy)
    ...
    * [`obj spec.forProvider.privateEndpointIdSelector`](#obj-specforproviderprivateendpointidselector)
      ...
      * [`obj spec.forProvider.privateEndpointIdSelector.policy`](#obj-specforproviderprivateendpointidselectorpolicy)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withPrivateEndpointId(privateEndpointId)`](#fn-specinitproviderwithprivateendpointid)
    ...
    * [`obj spec.initProvider.privateEndpointIdRef`](#obj-specinitproviderprivateendpointidref)
      * [`fn withName(name)`](#fn-specinitproviderprivateendpointidrefwithname)
      * [`obj spec.initProvider.privateEndpointIdRef.policy`](#obj-specinitproviderprivateendpointidrefpolicy)
    ...
    * [`obj spec.initProvider.privateEndpointIdSelector`](#obj-specinitproviderprivateendpointidselector)
      ...
      * [`obj spec.initProvider.privateEndpointIdSelector.policy`](#obj-specinitproviderprivateendpointidselectorpolicy)
...
new returns an instance of PrivateEndpointApplicationSecurityGroupAssociation
...
### fn spec.forProvider.withPrivateEndpointId

```ts
withPrivateEndpointId(privateEndpointId)
```
...
## obj spec.forProvider.privateEndpointIdRef

"Reference to a PrivateEndpoint in network to populate privateEndpointId."

### fn spec.forProvider.privateEndpointIdRef.withName
...
## obj spec.forProvider.privateEndpointIdRef.policy

"Policies for referencing."

### fn spec.forProvider.privateEndpointIdRef.policy.withResolution
...
### fn spec.forProvider.privateEndpointIdRef.policy.withResolve
...
## obj spec.forProvider.privateEndpointIdSelector

"Selector for a PrivateEndpoint in network to populate privateEndpointId."

### fn spec.forProvider.privateEndpointIdSelector.withMatchControllerRef
...
### fn spec.forProvider.privateEndpointIdSelector.withMatchLabels
...
### fn spec.forProvider.privateEndpointIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.privateEndpointIdSelector.policy

"Policies for selection."

### fn spec.forProvider.privateEndpointIdSelector.policy.withResolution
...
### fn spec.forProvider.privateEndpointIdSelector.policy.withResolve
...
### fn spec.initProvider.withPrivateEndpointId
...
## obj spec.initProvider.privateEndpointIdRef

"Reference to a PrivateEndpoint in network to populate privateEndpointId."

### fn spec.initProvider.privateEndpointIdRef.withName
...
## obj spec.initProvider.privateEndpointIdRef.policy

"Policies for referencing."

### fn spec.initProvider.privateEndpointIdRef.policy.withResolution
...
### fn spec.initProvider.privateEndpointIdRef.policy.withResolve
...
## obj spec.initProvider.privateEndpointIdSelector

"Selector for a PrivateEndpoint in network to populate privateEndpointId."

### fn spec.initProvider.privateEndpointIdSelector.withMatchControllerRef
...
### fn spec.initProvider.privateEndpointIdSelector.withMatchLabels
...
### fn spec.initProvider.privateEndpointIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.privateEndpointIdSelector.policy

"Policies for selection."

### fn spec.initProvider.privateEndpointIdSelector.policy.withResolution
...
### fn spec.initProvider.privateEndpointIdSelector.policy.withResolve
