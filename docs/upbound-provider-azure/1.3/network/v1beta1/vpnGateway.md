---
permalink: /upbound-provider-azure/1.3/network/v1beta1/vpnGateway/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.bgpSettings`](#obj-specforproviderbgpsettings)
      ...
      * [`fn withInstance0BgpPeeringAddress(instance0BgpPeeringAddress)`](#fn-specforproviderbgpsettingswithinstance0bgppeeringaddress)
      * [`fn withInstance0BgpPeeringAddressMixin(instance0BgpPeeringAddress)`](#fn-specforproviderbgpsettingswithinstance0bgppeeringaddressmixin)
      * [`fn withInstance1BgpPeeringAddress(instance1BgpPeeringAddress)`](#fn-specforproviderbgpsettingswithinstance1bgppeeringaddress)
      * [`fn withInstance1BgpPeeringAddressMixin(instance1BgpPeeringAddress)`](#fn-specforproviderbgpsettingswithinstance1bgppeeringaddressmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.bgpSettings`](#obj-specinitproviderbgpsettings)
      ...
      * [`fn withInstance0BgpPeeringAddress(instance0BgpPeeringAddress)`](#fn-specinitproviderbgpsettingswithinstance0bgppeeringaddress)
      * [`fn withInstance0BgpPeeringAddressMixin(instance0BgpPeeringAddress)`](#fn-specinitproviderbgpsettingswithinstance0bgppeeringaddressmixin)
      * [`fn withInstance1BgpPeeringAddress(instance1BgpPeeringAddress)`](#fn-specinitproviderbgpsettingswithinstance1bgppeeringaddress)
      * [`fn withInstance1BgpPeeringAddressMixin(instance1BgpPeeringAddress)`](#fn-specinitproviderbgpsettingswithinstance1bgppeeringaddressmixin)
...
### fn spec.forProvider.bgpSettings.withInstance0BgpPeeringAddress

```ts
withInstance0BgpPeeringAddress(instance0BgpPeeringAddress)
```

"An instance_bgp_peering_address block as defined below."

### fn spec.forProvider.bgpSettings.withInstance0BgpPeeringAddressMixin

```ts
withInstance0BgpPeeringAddressMixin(instance0BgpPeeringAddress)
```
...
### fn spec.forProvider.bgpSettings.withInstance1BgpPeeringAddress

```ts
withInstance1BgpPeeringAddress(instance1BgpPeeringAddress)
```

"An instance_bgp_peering_address block as defined below."

### fn spec.forProvider.bgpSettings.withInstance1BgpPeeringAddressMixin

```ts
withInstance1BgpPeeringAddressMixin(instance1BgpPeeringAddress)
```
...
### fn spec.initProvider.bgpSettings.withInstance0BgpPeeringAddress
...
### fn spec.initProvider.bgpSettings.withInstance0BgpPeeringAddressMixin
...
### fn spec.initProvider.bgpSettings.withInstance1BgpPeeringAddress
...
### fn spec.initProvider.bgpSettings.withInstance1BgpPeeringAddressMixin
