---
permalink: /upbound-provider-azure/1.3/network/v1beta1/networkInterfaceNatRuleAssociation/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withIpConfigurationName(ipConfigurationName)`](#fn-specforproviderwithipconfigurationname)
    * [`fn withNatRuleId(natRuleId)`](#fn-specforproviderwithnatruleid)
    * [`fn withNetworkInterfaceId(networkInterfaceId)`](#fn-specforproviderwithnetworkinterfaceid)
    * [`obj spec.forProvider.natRuleIdRef`](#obj-specforprovidernatruleidref)
      * [`fn withName(name)`](#fn-specforprovidernatruleidrefwithname)
      * [`obj spec.forProvider.natRuleIdRef.policy`](#obj-specforprovidernatruleidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidernatruleidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidernatruleidrefpolicywithresolve)
    * [`obj spec.forProvider.natRuleIdSelector`](#obj-specforprovidernatruleidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidernatruleidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidernatruleidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidernatruleidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.natRuleIdSelector.policy`](#obj-specforprovidernatruleidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidernatruleidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidernatruleidselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withIpConfigurationName(ipConfigurationName)`](#fn-specinitproviderwithipconfigurationname)
    * [`fn withNatRuleId(natRuleId)`](#fn-specinitproviderwithnatruleid)
    * [`fn withNetworkInterfaceId(networkInterfaceId)`](#fn-specinitproviderwithnetworkinterfaceid)
    * [`obj spec.initProvider.natRuleIdRef`](#obj-specinitprovidernatruleidref)
      * [`fn withName(name)`](#fn-specinitprovidernatruleidrefwithname)
      * [`obj spec.initProvider.natRuleIdRef.policy`](#obj-specinitprovidernatruleidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidernatruleidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidernatruleidrefpolicywithresolve)
    * [`obj spec.initProvider.natRuleIdSelector`](#obj-specinitprovidernatruleidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidernatruleidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidernatruleidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidernatruleidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.natRuleIdSelector.policy`](#obj-specinitprovidernatruleidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidernatruleidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidernatruleidselectorpolicywithresolve)
...
new returns an instance of NetworkInterfaceNatRuleAssociation
...
### fn spec.forProvider.withIpConfigurationName
...
### fn spec.forProvider.withNatRuleId

```ts
withNatRuleId(natRuleId)
```
...
## obj spec.forProvider.natRuleIdRef

"Reference to a LoadBalancerNatRule in network to populate natRuleId."

### fn spec.forProvider.natRuleIdRef.withName
...
## obj spec.forProvider.natRuleIdRef.policy

"Policies for referencing."

### fn spec.forProvider.natRuleIdRef.policy.withResolution
...
### fn spec.forProvider.natRuleIdRef.policy.withResolve
...
## obj spec.forProvider.natRuleIdSelector

"Selector for a LoadBalancerNatRule in network to populate natRuleId."

### fn spec.forProvider.natRuleIdSelector.withMatchControllerRef
...
### fn spec.forProvider.natRuleIdSelector.withMatchLabels
...
### fn spec.forProvider.natRuleIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.natRuleIdSelector.policy

"Policies for selection."

### fn spec.forProvider.natRuleIdSelector.policy.withResolution
...
### fn spec.forProvider.natRuleIdSelector.policy.withResolve
...
### fn spec.initProvider.withIpConfigurationName
...
### fn spec.initProvider.withNatRuleId
...
## obj spec.initProvider.natRuleIdRef

"Reference to a LoadBalancerNatRule in network to populate natRuleId."

### fn spec.initProvider.natRuleIdRef.withName
...
## obj spec.initProvider.natRuleIdRef.policy

"Policies for referencing."

### fn spec.initProvider.natRuleIdRef.policy.withResolution
...
### fn spec.initProvider.natRuleIdRef.policy.withResolve
...
## obj spec.initProvider.natRuleIdSelector

"Selector for a LoadBalancerNatRule in network to populate natRuleId."

### fn spec.initProvider.natRuleIdSelector.withMatchControllerRef
...
### fn spec.initProvider.natRuleIdSelector.withMatchLabels
...
### fn spec.initProvider.natRuleIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.natRuleIdSelector.policy

"Policies for selection."

### fn spec.initProvider.natRuleIdSelector.policy.withResolution
...
### fn spec.initProvider.natRuleIdSelector.policy.withResolve
