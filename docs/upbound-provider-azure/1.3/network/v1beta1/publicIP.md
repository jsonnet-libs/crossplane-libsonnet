---
permalink: /upbound-provider-azure/1.3/network/v1beta1/publicIP/
---

# network.v1beta1.publicIP
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAllocationMethod(allocationMethod)`](#fn-specforproviderwithallocationmethod)
    * [`fn withDdosProtectionMode(ddosProtectionMode)`](#fn-specforproviderwithddosprotectionmode)
    * [`fn withDdosProtectionPlanId(ddosProtectionPlanId)`](#fn-specforproviderwithddosprotectionplanid)
    * [`fn withDomainNameLabel(domainNameLabel)`](#fn-specforproviderwithdomainnamelabel)
    ...
    * [`fn withIpTags(ipTags)`](#fn-specforproviderwithiptags)
    * [`fn withIpTagsMixin(ipTags)`](#fn-specforproviderwithiptagsmixin)
    ...
    * [`fn withReverseFqdn(reverseFqdn)`](#fn-specforproviderwithreversefqdn)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAllocationMethod(allocationMethod)`](#fn-specinitproviderwithallocationmethod)
    * [`fn withDdosProtectionMode(ddosProtectionMode)`](#fn-specinitproviderwithddosprotectionmode)
    * [`fn withDdosProtectionPlanId(ddosProtectionPlanId)`](#fn-specinitproviderwithddosprotectionplanid)
    * [`fn withDomainNameLabel(domainNameLabel)`](#fn-specinitproviderwithdomainnamelabel)
    ...
    * [`fn withIpTags(ipTags)`](#fn-specinitproviderwithiptags)
    * [`fn withIpTagsMixin(ipTags)`](#fn-specinitproviderwithiptagsmixin)
    ...
    * [`fn withReverseFqdn(reverseFqdn)`](#fn-specinitproviderwithreversefqdn)
...
new returns an instance of PublicIP
...
### fn spec.forProvider.withAllocationMethod
...
### fn spec.forProvider.withDdosProtectionMode

```ts
withDdosProtectionMode(ddosProtectionMode)
```
...
### fn spec.forProvider.withDdosProtectionPlanId

```ts
withDdosProtectionPlanId(ddosProtectionPlanId)
```

"The ID of DDoS protection plan associated with the public IP."

### fn spec.forProvider.withDomainNameLabel
...
### fn spec.forProvider.withIpTags
...
### fn spec.forProvider.withIpTagsMixin

```ts
withIpTagsMixin(ipTags)
```
...
### fn spec.forProvider.withReverseFqdn

```ts
withReverseFqdn(reverseFqdn)
```
...
### fn spec.initProvider.withAllocationMethod
...
### fn spec.initProvider.withDdosProtectionMode
...
### fn spec.initProvider.withDdosProtectionPlanId
...
### fn spec.initProvider.withDomainNameLabel
...
### fn spec.initProvider.withIpTags
...
### fn spec.initProvider.withIpTagsMixin
...
### fn spec.initProvider.withReverseFqdn
