---
permalink: /upbound-provider-azure/1.3/network/v1beta1/natGatewayPublicIPPrefixAssociation/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPublicIpPrefixId(publicIpPrefixId)`](#fn-specforproviderwithpublicipprefixid)
    ...
    * [`obj spec.forProvider.publicIpPrefixIdRef`](#obj-specforproviderpublicipprefixidref)
      * [`fn withName(name)`](#fn-specforproviderpublicipprefixidrefwithname)
      * [`obj spec.forProvider.publicIpPrefixIdRef.policy`](#obj-specforproviderpublicipprefixidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderpublicipprefixidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderpublicipprefixidrefpolicywithresolve)
    * [`obj spec.forProvider.publicIpPrefixIdSelector`](#obj-specforproviderpublicipprefixidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderpublicipprefixidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderpublicipprefixidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderpublicipprefixidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.publicIpPrefixIdSelector.policy`](#obj-specforproviderpublicipprefixidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderpublicipprefixidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderpublicipprefixidselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withNatGatewayId(natGatewayId)`](#fn-specinitproviderwithnatgatewayid)
    * [`fn withPublicIpPrefixId(publicIpPrefixId)`](#fn-specinitproviderwithpublicipprefixid)
    ...
    * [`obj spec.initProvider.publicIpPrefixIdRef`](#obj-specinitproviderpublicipprefixidref)
      * [`fn withName(name)`](#fn-specinitproviderpublicipprefixidrefwithname)
      * [`obj spec.initProvider.publicIpPrefixIdRef.policy`](#obj-specinitproviderpublicipprefixidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderpublicipprefixidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderpublicipprefixidrefpolicywithresolve)
    * [`obj spec.initProvider.publicIpPrefixIdSelector`](#obj-specinitproviderpublicipprefixidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderpublicipprefixidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderpublicipprefixidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderpublicipprefixidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.publicIpPrefixIdSelector.policy`](#obj-specinitproviderpublicipprefixidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderpublicipprefixidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderpublicipprefixidselectorpolicywithresolve)
...
new returns an instance of NATGatewayPublicIPPrefixAssociation
...
### fn spec.forProvider.withPublicIpPrefixId
...
## obj spec.forProvider.publicIpPrefixIdRef

"Reference to a PublicIPPrefix in network to populate publicIpPrefixId."

### fn spec.forProvider.publicIpPrefixIdRef.withName
...
## obj spec.forProvider.publicIpPrefixIdRef.policy

"Policies for referencing."

### fn spec.forProvider.publicIpPrefixIdRef.policy.withResolution
...
### fn spec.forProvider.publicIpPrefixIdRef.policy.withResolve
...
## obj spec.forProvider.publicIpPrefixIdSelector

"Selector for a PublicIPPrefix in network to populate publicIpPrefixId."

### fn spec.forProvider.publicIpPrefixIdSelector.withMatchControllerRef
...
### fn spec.forProvider.publicIpPrefixIdSelector.withMatchLabels
...
### fn spec.forProvider.publicIpPrefixIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.publicIpPrefixIdSelector.policy

"Policies for selection."

### fn spec.forProvider.publicIpPrefixIdSelector.policy.withResolution
...
### fn spec.forProvider.publicIpPrefixIdSelector.policy.withResolve
...
### fn spec.initProvider.withPublicIpPrefixId
...
## obj spec.initProvider.publicIpPrefixIdRef

"Reference to a PublicIPPrefix in network to populate publicIpPrefixId."

### fn spec.initProvider.publicIpPrefixIdRef.withName
...
## obj spec.initProvider.publicIpPrefixIdRef.policy

"Policies for referencing."

### fn spec.initProvider.publicIpPrefixIdRef.policy.withResolution
...
### fn spec.initProvider.publicIpPrefixIdRef.policy.withResolve
...
## obj spec.initProvider.publicIpPrefixIdSelector

"Selector for a PublicIPPrefix in network to populate publicIpPrefixId."

### fn spec.initProvider.publicIpPrefixIdSelector.withMatchControllerRef
...
### fn spec.initProvider.publicIpPrefixIdSelector.withMatchLabels
...
### fn spec.initProvider.publicIpPrefixIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.publicIpPrefixIdSelector.policy

"Policies for selection."

### fn spec.initProvider.publicIpPrefixIdSelector.policy.withResolution
...
### fn spec.initProvider.publicIpPrefixIdSelector.policy.withResolve
