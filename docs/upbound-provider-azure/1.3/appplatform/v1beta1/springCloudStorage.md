---
permalink: /upbound-provider-azure/1.3/appplatform/v1beta1/springCloudStorage/
---

# appplatform.v1beta1.springCloudStorage
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withStorageAccountKey(storageAccountKey)`](#fn-specforproviderwithstorageaccountkey)
    ...
    * [`obj spec.forProvider.storageAccountKeyRef`](#obj-specforproviderstorageaccountkeyref)
      * [`fn withName(name)`](#fn-specforproviderstorageaccountkeyrefwithname)
      * [`obj spec.forProvider.storageAccountKeyRef.policy`](#obj-specforproviderstorageaccountkeyrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderstorageaccountkeyrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderstorageaccountkeyrefpolicywithresolve)
    * [`obj spec.forProvider.storageAccountKeySelector`](#obj-specforproviderstorageaccountkeyselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderstorageaccountkeyselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderstorageaccountkeyselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderstorageaccountkeyselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.storageAccountKeySelector.policy`](#obj-specforproviderstorageaccountkeyselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderstorageaccountkeyselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderstorageaccountkeyselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withStorageAccountKey(storageAccountKey)`](#fn-specinitproviderwithstorageaccountkey)
    * [`fn withStorageAccountName(storageAccountName)`](#fn-specinitproviderwithstorageaccountname)
    * [`obj spec.initProvider.storageAccountKeyRef`](#obj-specinitproviderstorageaccountkeyref)
      * [`fn withName(name)`](#fn-specinitproviderstorageaccountkeyrefwithname)
      * [`obj spec.initProvider.storageAccountKeyRef.policy`](#obj-specinitproviderstorageaccountkeyrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderstorageaccountkeyrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderstorageaccountkeyrefpolicywithresolve)
    * [`obj spec.initProvider.storageAccountKeySelector`](#obj-specinitproviderstorageaccountkeyselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderstorageaccountkeyselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderstorageaccountkeyselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderstorageaccountkeyselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.storageAccountKeySelector.policy`](#obj-specinitproviderstorageaccountkeyselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderstorageaccountkeyselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderstorageaccountkeyselectorpolicywithresolve)
...
new returns an instance of SpringCloudStorage
...
### fn spec.forProvider.withStorageAccountKey
...
## obj spec.forProvider.storageAccountKeyRef

"Reference to a Account in storage to populate storageAccountKey."

### fn spec.forProvider.storageAccountKeyRef.withName
...
## obj spec.forProvider.storageAccountKeyRef.policy

"Policies for referencing."

### fn spec.forProvider.storageAccountKeyRef.policy.withResolution
...
### fn spec.forProvider.storageAccountKeyRef.policy.withResolve
...
## obj spec.forProvider.storageAccountKeySelector

"Selector for a Account in storage to populate storageAccountKey."

### fn spec.forProvider.storageAccountKeySelector.withMatchControllerRef
...
### fn spec.forProvider.storageAccountKeySelector.withMatchLabels
...
### fn spec.forProvider.storageAccountKeySelector.withMatchLabelsMixin
...
## obj spec.forProvider.storageAccountKeySelector.policy

"Policies for selection."

### fn spec.forProvider.storageAccountKeySelector.policy.withResolution
...
### fn spec.forProvider.storageAccountKeySelector.policy.withResolve
...
### fn spec.initProvider.withStorageAccountKey
...
## obj spec.initProvider.storageAccountKeyRef

"Reference to a Account in storage to populate storageAccountKey."

### fn spec.initProvider.storageAccountKeyRef.withName
...
## obj spec.initProvider.storageAccountKeyRef.policy

"Policies for referencing."

### fn spec.initProvider.storageAccountKeyRef.policy.withResolution
...
### fn spec.initProvider.storageAccountKeyRef.policy.withResolve
...
## obj spec.initProvider.storageAccountKeySelector

"Selector for a Account in storage to populate storageAccountKey."

### fn spec.initProvider.storageAccountKeySelector.withMatchControllerRef
...
### fn spec.initProvider.storageAccountKeySelector.withMatchLabels
...
### fn spec.initProvider.storageAccountKeySelector.withMatchLabelsMixin
...
## obj spec.initProvider.storageAccountKeySelector.policy

"Policies for selection."

### fn spec.initProvider.storageAccountKeySelector.policy.withResolution
...
### fn spec.initProvider.storageAccountKeySelector.policy.withResolve
