---
permalink: /upbound-provider-azure/1.3/apimanagement/v1beta2/logger/
---

# apimanagement.v1beta2.logger
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withBuffered(buffered)`](#fn-specforproviderwithbuffered)
    ...
    * [`obj spec.forProvider.applicationInsights`](#obj-specforproviderapplicationinsights)
      * [`obj spec.forProvider.applicationInsights.instrumentationKeySecretRef`](#obj-specforproviderapplicationinsightsinstrumentationkeysecretref)
        * [`fn withKey(key)`](#fn-specforproviderapplicationinsightsinstrumentationkeysecretrefwithkey)
        * [`fn withName(name)`](#fn-specforproviderapplicationinsightsinstrumentationkeysecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specforproviderapplicationinsightsinstrumentationkeysecretrefwithnamespace)
    * [`obj spec.forProvider.eventhub`](#obj-specforprovidereventhub)
      * [`fn withEndpointUri(endpointUri)`](#fn-specforprovidereventhubwithendpointuri)
      * [`fn withName(name)`](#fn-specforprovidereventhubwithname)
      * [`fn withUserAssignedIdentityClientId(userAssignedIdentityClientId)`](#fn-specforprovidereventhubwithuserassignedidentityclientid)
      * [`obj spec.forProvider.eventhub.connectionStringSecretRef`](#obj-specforprovidereventhubconnectionstringsecretref)
        * [`fn withKey(key)`](#fn-specforprovidereventhubconnectionstringsecretrefwithkey)
        * [`fn withName(name)`](#fn-specforprovidereventhubconnectionstringsecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specforprovidereventhubconnectionstringsecretrefwithnamespace)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withBuffered(buffered)`](#fn-specinitproviderwithbuffered)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withResourceId(resourceId)`](#fn-specinitproviderwithresourceid)
    * [`obj spec.initProvider.applicationInsights`](#obj-specinitproviderapplicationinsights)
      * [`obj spec.initProvider.applicationInsights.instrumentationKeySecretRef`](#obj-specinitproviderapplicationinsightsinstrumentationkeysecretref)
        * [`fn withKey(key)`](#fn-specinitproviderapplicationinsightsinstrumentationkeysecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitproviderapplicationinsightsinstrumentationkeysecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitproviderapplicationinsightsinstrumentationkeysecretrefwithnamespace)
    * [`obj spec.initProvider.eventhub`](#obj-specinitprovidereventhub)
      * [`fn withEndpointUri(endpointUri)`](#fn-specinitprovidereventhubwithendpointuri)
      * [`fn withName(name)`](#fn-specinitprovidereventhubwithname)
      * [`fn withUserAssignedIdentityClientId(userAssignedIdentityClientId)`](#fn-specinitprovidereventhubwithuserassignedidentityclientid)
      * [`obj spec.initProvider.eventhub.connectionStringSecretRef`](#obj-specinitprovidereventhubconnectionstringsecretref)
        * [`fn withKey(key)`](#fn-specinitprovidereventhubconnectionstringsecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitprovidereventhubconnectionstringsecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitprovidereventhubconnectionstringsecretrefwithnamespace)
...
### fn spec.forProvider.withBuffered
...
## obj spec.forProvider.applicationInsights

"An application_insights block as documented below. Changing this forces a new resource to be created."

## obj spec.forProvider.applicationInsights.instrumentationKeySecretRef

"The instrumentation key used to push data to Application Insights."

### fn spec.forProvider.applicationInsights.instrumentationKeySecretRef.withKey
...
### fn spec.forProvider.applicationInsights.instrumentationKeySecretRef.withName
...
### fn spec.forProvider.applicationInsights.instrumentationKeySecretRef.withNamespace
...
### fn spec.forProvider.eventhub.withName
...
### fn spec.forProvider.eventhub.withUserAssignedIdentityClientId

```ts
withUserAssignedIdentityClientId(userAssignedIdentityClientId)
```
...
## obj spec.forProvider.eventhub.connectionStringSecretRef

"The connection string of an EventHub Namespace."

### fn spec.forProvider.eventhub.connectionStringSecretRef.withKey
...
### fn spec.forProvider.eventhub.connectionStringSecretRef.withName
...
### fn spec.forProvider.eventhub.connectionStringSecretRef.withNamespace
...
### fn spec.initProvider.withBuffered
...
## obj spec.initProvider.applicationInsights

"An application_insights block as documented below. Changing this forces a new resource to be created."

## obj spec.initProvider.applicationInsights.instrumentationKeySecretRef

"The instrumentation key used to push data to Application Insights."

### fn spec.initProvider.applicationInsights.instrumentationKeySecretRef.withKey
...
### fn spec.initProvider.applicationInsights.instrumentationKeySecretRef.withName
...
### fn spec.initProvider.applicationInsights.instrumentationKeySecretRef.withNamespace
...
## obj spec.initProvider.eventhub

"An eventhub block as documented below. Changing this forces a new resource to be created."

### fn spec.initProvider.eventhub.withEndpointUri
...
### fn spec.initProvider.eventhub.withName
...
### fn spec.initProvider.eventhub.withUserAssignedIdentityClientId
...
## obj spec.initProvider.eventhub.connectionStringSecretRef

"The connection string of an EventHub Namespace."

### fn spec.initProvider.eventhub.connectionStringSecretRef.withKey
...
### fn spec.initProvider.eventhub.connectionStringSecretRef.withName
...
### fn spec.initProvider.eventhub.connectionStringSecretRef.withNamespace
