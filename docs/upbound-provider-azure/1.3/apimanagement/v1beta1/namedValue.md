---
permalink: /upbound-provider-azure/1.3/apimanagement/v1beta1/namedValue/
---

# apimanagement.v1beta1.namedValue
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withValueFromKeyVault(valueFromKeyVault)`](#fn-specforproviderwithvaluefromkeyvault)
    * [`fn withValueFromKeyVaultMixin(valueFromKeyVault)`](#fn-specforproviderwithvaluefromkeyvaultmixin)
    ...
    * [`obj spec.forProvider.valueFromKeyVault`](#obj-specforprovidervaluefromkeyvault)
      * [`fn withIdentityClientId(identityClientId)`](#fn-specforprovidervaluefromkeyvaultwithidentityclientid)
      * [`fn withSecretId(secretId)`](#fn-specforprovidervaluefromkeyvaultwithsecretid)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withValueFromKeyVault(valueFromKeyVault)`](#fn-specinitproviderwithvaluefromkeyvault)
    * [`fn withValueFromKeyVaultMixin(valueFromKeyVault)`](#fn-specinitproviderwithvaluefromkeyvaultmixin)
    * [`obj spec.initProvider.valueFromKeyVault`](#obj-specinitprovidervaluefromkeyvault)
      * [`fn withIdentityClientId(identityClientId)`](#fn-specinitprovidervaluefromkeyvaultwithidentityclientid)
      * [`fn withSecretId(secretId)`](#fn-specinitprovidervaluefromkeyvaultwithsecretid)
...
new returns an instance of NamedValue
...
### fn spec.forProvider.withValueFromKeyVault

```ts
withValueFromKeyVault(valueFromKeyVault)
```

"A value_from_key_vault block as defined below."

### fn spec.forProvider.withValueFromKeyVaultMixin

```ts
withValueFromKeyVaultMixin(valueFromKeyVault)
```
...
## obj spec.forProvider.valueFromKeyVault

"A value_from_key_vault block as defined below."

### fn spec.forProvider.valueFromKeyVault.withIdentityClientId
...
### fn spec.forProvider.valueFromKeyVault.withSecretId
...
### fn spec.initProvider.withValueFromKeyVault
...
### fn spec.initProvider.withValueFromKeyVaultMixin
...
## obj spec.initProvider.valueFromKeyVault

"A value_from_key_vault block as defined below."

### fn spec.initProvider.valueFromKeyVault.withIdentityClientId
...
### fn spec.initProvider.valueFromKeyVault.withSecretId
