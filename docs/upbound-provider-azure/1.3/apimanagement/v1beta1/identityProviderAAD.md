---
permalink: /upbound-provider-azure/1.3/apimanagement/v1beta1/identityProviderAAD/
---

# apimanagement.v1beta1.identityProviderAAD
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAllowedTenants(allowedTenants)`](#fn-specforproviderwithallowedtenants)
    * [`fn withAllowedTenantsMixin(allowedTenants)`](#fn-specforproviderwithallowedtenantsmixin)
    ...
    * [`fn withSigninTenant(signinTenant)`](#fn-specforproviderwithsignintenant)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAllowedTenants(allowedTenants)`](#fn-specinitproviderwithallowedtenants)
    * [`fn withAllowedTenantsMixin(allowedTenants)`](#fn-specinitproviderwithallowedtenantsmixin)
    * [`fn withClientId(clientId)`](#fn-specinitproviderwithclientid)
    * [`fn withSigninTenant(signinTenant)`](#fn-specinitproviderwithsignintenant)
...
new returns an instance of IdentityProviderAAD
...
### fn spec.forProvider.withAllowedTenants

```ts
withAllowedTenants(allowedTenants)
```

"List of allowed AAD Tenants."

### fn spec.forProvider.withAllowedTenantsMixin

```ts
withAllowedTenantsMixin(allowedTenants)
```
...
### fn spec.forProvider.withSigninTenant

```ts
withSigninTenant(signinTenant)
```
...
### fn spec.initProvider.withAllowedTenants
...
### fn spec.initProvider.withAllowedTenantsMixin
...
### fn spec.initProvider.withSigninTenant
