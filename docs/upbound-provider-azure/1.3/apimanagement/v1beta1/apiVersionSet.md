---
permalink: /upbound-provider-azure/1.3/apimanagement/v1beta1/apiVersionSet/
---

# apimanagement.v1beta1.apiVersionSet
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withVersionHeaderName(versionHeaderName)`](#fn-specforproviderwithversionheadername)
    * [`fn withVersionQueryName(versionQueryName)`](#fn-specforproviderwithversionqueryname)
    * [`fn withVersioningScheme(versioningScheme)`](#fn-specforproviderwithversioningscheme)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withVersionHeaderName(versionHeaderName)`](#fn-specinitproviderwithversionheadername)
    * [`fn withVersionQueryName(versionQueryName)`](#fn-specinitproviderwithversionqueryname)
    * [`fn withVersioningScheme(versioningScheme)`](#fn-specinitproviderwithversioningscheme)
...
new returns an instance of APIVersionSet
...
### fn spec.forProvider.withVersionHeaderName

```ts
withVersionHeaderName(versionHeaderName)
```

"The name of the Header which should be read from Inbound Requests which defines the API Version."

### fn spec.forProvider.withVersionQueryName

```ts
withVersionQueryName(versionQueryName)
```

"The name of the Query String which should be read from Inbound Requests which defines the API Version."

### fn spec.forProvider.withVersioningScheme

```ts
withVersioningScheme(versioningScheme)
```
...
### fn spec.initProvider.withVersionHeaderName
...
### fn spec.initProvider.withVersionQueryName
...
### fn spec.initProvider.withVersioningScheme
