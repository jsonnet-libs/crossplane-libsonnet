---
permalink: /upbound-provider-azure/1.3/storagecache/v1beta1/hpcCacheNFSTarget/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withNamespaceJunction(namespaceJunction)`](#fn-specforproviderwithnamespacejunction)
    * [`fn withNamespaceJunctionMixin(namespaceJunction)`](#fn-specforproviderwithnamespacejunctionmixin)
    * [`fn withResourceGroupName(resourceGroupName)`](#fn-specforproviderwithresourcegroupname)
    * [`fn withTargetHostName(targetHostName)`](#fn-specforproviderwithtargethostname)
    * [`fn withUsageModel(usageModel)`](#fn-specforproviderwithusagemodel)
    * [`fn withVerificationTimerInSeconds(verificationTimerInSeconds)`](#fn-specforproviderwithverificationtimerinseconds)
    * [`fn withWriteBackTimerInSeconds(writeBackTimerInSeconds)`](#fn-specforproviderwithwritebacktimerinseconds)
    ...
    * [`obj spec.forProvider.namespaceJunction`](#obj-specforprovidernamespacejunction)
      * [`fn withAccessPolicyName(accessPolicyName)`](#fn-specforprovidernamespacejunctionwithaccesspolicyname)
      * [`fn withNamespacePath(namespacePath)`](#fn-specforprovidernamespacejunctionwithnamespacepath)
      * [`fn withNfsExport(nfsExport)`](#fn-specforprovidernamespacejunctionwithnfsexport)
      * [`fn withTargetPath(targetPath)`](#fn-specforprovidernamespacejunctionwithtargetpath)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withNamespaceJunction(namespaceJunction)`](#fn-specinitproviderwithnamespacejunction)
    * [`fn withNamespaceJunctionMixin(namespaceJunction)`](#fn-specinitproviderwithnamespacejunctionmixin)
    * [`fn withTargetHostName(targetHostName)`](#fn-specinitproviderwithtargethostname)
    * [`fn withUsageModel(usageModel)`](#fn-specinitproviderwithusagemodel)
    * [`fn withVerificationTimerInSeconds(verificationTimerInSeconds)`](#fn-specinitproviderwithverificationtimerinseconds)
    * [`fn withWriteBackTimerInSeconds(writeBackTimerInSeconds)`](#fn-specinitproviderwithwritebacktimerinseconds)
    ...
    * [`obj spec.initProvider.namespaceJunction`](#obj-specinitprovidernamespacejunction)
      * [`fn withAccessPolicyName(accessPolicyName)`](#fn-specinitprovidernamespacejunctionwithaccesspolicyname)
      * [`fn withNamespacePath(namespacePath)`](#fn-specinitprovidernamespacejunctionwithnamespacepath)
      * [`fn withNfsExport(nfsExport)`](#fn-specinitprovidernamespacejunctionwithnfsexport)
      * [`fn withTargetPath(targetPath)`](#fn-specinitprovidernamespacejunctionwithtargetpath)
...
new returns an instance of HPCCacheNFSTarget
...
### fn spec.forProvider.withNamespaceJunction

```ts
withNamespaceJunction(namespaceJunction)
```
...
### fn spec.forProvider.withNamespaceJunctionMixin

```ts
withNamespaceJunctionMixin(namespaceJunction)
```
...
### fn spec.forProvider.withTargetHostName
...
### fn spec.forProvider.withUsageModel

```ts
withUsageModel(usageModel)
```
...
### fn spec.forProvider.withVerificationTimerInSeconds

```ts
withVerificationTimerInSeconds(verificationTimerInSeconds)
```
...
### fn spec.forProvider.withWriteBackTimerInSeconds

```ts
withWriteBackTimerInSeconds(writeBackTimerInSeconds)
```
...
## obj spec.forProvider.namespaceJunction

"Can be specified multiple times to define multiple namespace_junction. Each namespace_junction block supports fields documented below."

### fn spec.forProvider.namespaceJunction.withAccessPolicyName
...
### fn spec.forProvider.namespaceJunction.withNamespacePath
...
### fn spec.forProvider.namespaceJunction.withNfsExport

```ts
withNfsExport(nfsExport)
```

"The NFS export of this NFS target within the HPC Cache NFS Target."

### fn spec.forProvider.namespaceJunction.withTargetPath
...
### fn spec.initProvider.withNamespaceJunction
...
### fn spec.initProvider.withNamespaceJunctionMixin
...
### fn spec.initProvider.withTargetHostName
...
### fn spec.initProvider.withUsageModel
...
### fn spec.initProvider.withVerificationTimerInSeconds
...
### fn spec.initProvider.withWriteBackTimerInSeconds
...
## obj spec.initProvider.namespaceJunction

"Can be specified multiple times to define multiple namespace_junction. Each namespace_junction block supports fields documented below."

### fn spec.initProvider.namespaceJunction.withAccessPolicyName
...
### fn spec.initProvider.namespaceJunction.withNamespacePath
...
### fn spec.initProvider.namespaceJunction.withNfsExport
...
### fn spec.initProvider.namespaceJunction.withTargetPath
