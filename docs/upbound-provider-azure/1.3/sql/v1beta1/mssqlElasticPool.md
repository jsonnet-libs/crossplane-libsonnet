---
permalink: /upbound-provider-azure/1.3/sql/v1beta1/mssqlElasticPool/
---

# sql.v1beta1.mssqlElasticPool
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withMaxSizeBytes(maxSizeBytes)`](#fn-specforproviderwithmaxsizebytes)
    * [`fn withMaxSizeGb(maxSizeGb)`](#fn-specforproviderwithmaxsizegb)
    * [`fn withPerDatabaseSettings(perDatabaseSettings)`](#fn-specforproviderwithperdatabasesettings)
    * [`fn withPerDatabaseSettingsMixin(perDatabaseSettings)`](#fn-specforproviderwithperdatabasesettingsmixin)
    ...
    * [`obj spec.forProvider.perDatabaseSettings`](#obj-specforproviderperdatabasesettings)
      * [`fn withMaxCapacity(maxCapacity)`](#fn-specforproviderperdatabasesettingswithmaxcapacity)
      * [`fn withMinCapacity(minCapacity)`](#fn-specforproviderperdatabasesettingswithmincapacity)
    ...
    * [`obj spec.forProvider.serverNameRef`](#obj-specforproviderservernameref)
      ...
      * [`obj spec.forProvider.serverNameRef.policy`](#obj-specforproviderservernamerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderservernamerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderservernamerefpolicywithresolve)
    * [`obj spec.forProvider.serverNameSelector`](#obj-specforproviderservernameselector)
      ...
      * [`obj spec.forProvider.serverNameSelector.policy`](#obj-specforproviderservernameselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderservernameselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderservernameselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withMaxSizeBytes(maxSizeBytes)`](#fn-specinitproviderwithmaxsizebytes)
    * [`fn withMaxSizeGb(maxSizeGb)`](#fn-specinitproviderwithmaxsizegb)
    * [`fn withPerDatabaseSettings(perDatabaseSettings)`](#fn-specinitproviderwithperdatabasesettings)
    * [`fn withPerDatabaseSettingsMixin(perDatabaseSettings)`](#fn-specinitproviderwithperdatabasesettingsmixin)
    ...
    * [`obj spec.initProvider.perDatabaseSettings`](#obj-specinitproviderperdatabasesettings)
      * [`fn withMaxCapacity(maxCapacity)`](#fn-specinitproviderperdatabasesettingswithmaxcapacity)
      * [`fn withMinCapacity(minCapacity)`](#fn-specinitproviderperdatabasesettingswithmincapacity)
    * [`obj spec.initProvider.sku`](#obj-specinitprovidersku)
      * [`fn withCapacity(capacity)`](#fn-specinitproviderskuwithcapacity)
      * [`fn withFamily(family)`](#fn-specinitproviderskuwithfamily)
...
new returns an instance of MSSQLElasticPool
...
### fn spec.forProvider.withMaxSizeBytes
...
### fn spec.forProvider.withPerDatabaseSettings

```ts
withPerDatabaseSettings(perDatabaseSettings)
```

"A per_database_settings block as defined below."

### fn spec.forProvider.withPerDatabaseSettingsMixin

```ts
withPerDatabaseSettingsMixin(perDatabaseSettings)
```
...
## obj spec.forProvider.perDatabaseSettings

"A per_database_settings block as defined below."

### fn spec.forProvider.perDatabaseSettings.withMaxCapacity
...
### fn spec.forProvider.perDatabaseSettings.withMinCapacity
...
## obj spec.forProvider.serverNameRef.policy

"Policies for referencing."

### fn spec.forProvider.serverNameRef.policy.withResolution
...
### fn spec.forProvider.serverNameRef.policy.withResolve
...
## obj spec.forProvider.serverNameSelector.policy

"Policies for selection."

### fn spec.forProvider.serverNameSelector.policy.withResolution
...
### fn spec.forProvider.serverNameSelector.policy.withResolve
...
### fn spec.initProvider.withMaxSizeBytes
...
### fn spec.initProvider.withPerDatabaseSettings
...
### fn spec.initProvider.withPerDatabaseSettingsMixin
...
## obj spec.initProvider.perDatabaseSettings

"A per_database_settings block as defined below."

### fn spec.initProvider.perDatabaseSettings.withMaxCapacity
...
### fn spec.initProvider.perDatabaseSettings.withMinCapacity
...
### fn spec.initProvider.sku.withFamily
