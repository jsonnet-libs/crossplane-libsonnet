---
permalink: /upbound-provider-azure/1.3/sql/v1beta1/mssqlServer/
---

# sql.v1beta1.mssqlServer
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withAzureadAdministrator(azureadAdministrator)`](#fn-specforproviderwithazureadadministrator)
    * [`fn withAzureadAdministratorMixin(azureadAdministrator)`](#fn-specforproviderwithazureadadministratormixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withAzureadAdministrator(azureadAdministrator)`](#fn-specinitproviderwithazureadadministrator)
    * [`fn withAzureadAdministratorMixin(azureadAdministrator)`](#fn-specinitproviderwithazureadadministratormixin)
...
### fn spec.forProvider.withAzureadAdministrator

```ts
withAzureadAdministrator(azureadAdministrator)
```

"An azuread_administrator block as defined below."

### fn spec.forProvider.withAzureadAdministratorMixin

```ts
withAzureadAdministratorMixin(azureadAdministrator)
```
...
### fn spec.initProvider.withAzureadAdministrator
...
### fn spec.initProvider.withAzureadAdministratorMixin
