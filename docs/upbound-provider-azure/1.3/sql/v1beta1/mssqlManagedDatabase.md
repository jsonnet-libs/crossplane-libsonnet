---
permalink: /upbound-provider-azure/1.3/sql/v1beta1/mssqlManagedDatabase/
---

# sql.v1beta1.mssqlManagedDatabase
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPointInTimeRestore(pointInTimeRestore)`](#fn-specforproviderwithpointintimerestore)
    * [`fn withPointInTimeRestoreMixin(pointInTimeRestore)`](#fn-specforproviderwithpointintimerestoremixin)
    * [`fn withShortTermRetentionDays(shortTermRetentionDays)`](#fn-specforproviderwithshorttermretentiondays)
    ...
    * [`obj spec.forProvider.pointInTimeRestore`](#obj-specforproviderpointintimerestore)
      * [`fn withRestorePointInTime(restorePointInTime)`](#fn-specforproviderpointintimerestorewithrestorepointintime)
      * [`fn withSourceDatabaseId(sourceDatabaseId)`](#fn-specforproviderpointintimerestorewithsourcedatabaseid)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withLongTermRetentionPolicy(longTermRetentionPolicy)`](#fn-specinitproviderwithlongtermretentionpolicy)
    * [`fn withLongTermRetentionPolicyMixin(longTermRetentionPolicy)`](#fn-specinitproviderwithlongtermretentionpolicymixin)
    * [`fn withPointInTimeRestore(pointInTimeRestore)`](#fn-specinitproviderwithpointintimerestore)
    * [`fn withPointInTimeRestoreMixin(pointInTimeRestore)`](#fn-specinitproviderwithpointintimerestoremixin)
    * [`fn withShortTermRetentionDays(shortTermRetentionDays)`](#fn-specinitproviderwithshorttermretentiondays)
    ...
    * [`obj spec.initProvider.pointInTimeRestore`](#obj-specinitproviderpointintimerestore)
      * [`fn withRestorePointInTime(restorePointInTime)`](#fn-specinitproviderpointintimerestorewithrestorepointintime)
      * [`fn withSourceDatabaseId(sourceDatabaseId)`](#fn-specinitproviderpointintimerestorewithsourcedatabaseid)
...
new returns an instance of MSSQLManagedDatabase
...
### fn spec.forProvider.withPointInTimeRestore

```ts
withPointInTimeRestore(pointInTimeRestore)
```

"A point_in_time_restore block as defined below. Changing this forces a new resource to be created."

### fn spec.forProvider.withPointInTimeRestoreMixin

```ts
withPointInTimeRestoreMixin(pointInTimeRestore)
```
...
### fn spec.forProvider.withShortTermRetentionDays

```ts
withShortTermRetentionDays(shortTermRetentionDays)
```
...
## obj spec.forProvider.pointInTimeRestore

"A point_in_time_restore block as defined below. Changing this forces a new resource to be created."

### fn spec.forProvider.pointInTimeRestore.withRestorePointInTime
...
### fn spec.forProvider.pointInTimeRestore.withSourceDatabaseId

```ts
withSourceDatabaseId(sourceDatabaseId)
```
...
### fn spec.initProvider.withLongTermRetentionPolicy
...
### fn spec.initProvider.withLongTermRetentionPolicyMixin
...
### fn spec.initProvider.withPointInTimeRestore
...
### fn spec.initProvider.withPointInTimeRestoreMixin
...
### fn spec.initProvider.withShortTermRetentionDays
...
## obj spec.initProvider.pointInTimeRestore

"A point_in_time_restore block as defined below. Changing this forces a new resource to be created."

### fn spec.initProvider.pointInTimeRestore.withRestorePointInTime
...
### fn spec.initProvider.pointInTimeRestore.withSourceDatabaseId
