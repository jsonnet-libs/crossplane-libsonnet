---
permalink: /upbound-provider-azure/1.3/botservice/v1beta1/botChannelSlack/
---

# botservice.v1beta1.botChannelSlack
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withLandingPageUrl(landingPageUrl)`](#fn-specforproviderwithlandingpageurl)
    ...
    * [`obj spec.forProvider.signingSecretSecretRef`](#obj-specforprovidersigningsecretsecretref)
      * [`fn withKey(key)`](#fn-specforprovidersigningsecretsecretrefwithkey)
      * [`fn withName(name)`](#fn-specforprovidersigningsecretsecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforprovidersigningsecretsecretrefwithnamespace)
    * [`obj spec.forProvider.verificationTokenSecretRef`](#obj-specforproviderverificationtokensecretref)
      * [`fn withKey(key)`](#fn-specforproviderverificationtokensecretrefwithkey)
      * [`fn withName(name)`](#fn-specforproviderverificationtokensecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specforproviderverificationtokensecretrefwithnamespace)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withClientId(clientId)`](#fn-specinitproviderwithclientid)
    * [`fn withLandingPageUrl(landingPageUrl)`](#fn-specinitproviderwithlandingpageurl)
    ...
    * [`obj spec.initProvider.signingSecretSecretRef`](#obj-specinitprovidersigningsecretsecretref)
      * [`fn withKey(key)`](#fn-specinitprovidersigningsecretsecretrefwithkey)
      * [`fn withName(name)`](#fn-specinitprovidersigningsecretsecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersigningsecretsecretrefwithnamespace)
    * [`obj spec.initProvider.verificationTokenSecretRef`](#obj-specinitproviderverificationtokensecretref)
      * [`fn withKey(key)`](#fn-specinitproviderverificationtokensecretrefwithkey)
      * [`fn withName(name)`](#fn-specinitproviderverificationtokensecretrefwithname)
      * [`fn withNamespace(namespace)`](#fn-specinitproviderverificationtokensecretrefwithnamespace)
...
new returns an instance of BotChannelSlack
...
### fn spec.forProvider.withLandingPageUrl
...
## obj spec.forProvider.signingSecretSecretRef

"The Signing Secret that will be used to sign the requests."

### fn spec.forProvider.signingSecretSecretRef.withKey
...
### fn spec.forProvider.signingSecretSecretRef.withName
...
### fn spec.forProvider.signingSecretSecretRef.withNamespace
...
## obj spec.forProvider.verificationTokenSecretRef

"The Verification Token that will be used to authenticate with Slack."

### fn spec.forProvider.verificationTokenSecretRef.withKey
...
### fn spec.forProvider.verificationTokenSecretRef.withName
...
### fn spec.forProvider.verificationTokenSecretRef.withNamespace
...
### fn spec.initProvider.withLandingPageUrl
...
## obj spec.initProvider.signingSecretSecretRef

"The Signing Secret that will be used to sign the requests."

### fn spec.initProvider.signingSecretSecretRef.withKey
...
### fn spec.initProvider.signingSecretSecretRef.withName
...
### fn spec.initProvider.signingSecretSecretRef.withNamespace
...
## obj spec.initProvider.verificationTokenSecretRef

"The Verification Token that will be used to authenticate with Slack."

### fn spec.initProvider.verificationTokenSecretRef.withKey
...
### fn spec.initProvider.verificationTokenSecretRef.withName
...
### fn spec.initProvider.verificationTokenSecretRef.withNamespace
