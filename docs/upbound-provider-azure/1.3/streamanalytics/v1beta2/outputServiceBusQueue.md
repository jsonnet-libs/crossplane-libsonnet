---
permalink: /upbound-provider-azure/1.3/streamanalytics/v1beta2/outputServiceBusQueue/
---

# streamanalytics.v1beta2.outputServiceBusQueue
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withQueueName(queueName)`](#fn-specforproviderwithqueuename)
    ...
    * [`obj spec.forProvider.queueNameRef`](#obj-specforproviderqueuenameref)
      * [`fn withName(name)`](#fn-specforproviderqueuenamerefwithname)
      * [`obj spec.forProvider.queueNameRef.policy`](#obj-specforproviderqueuenamerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderqueuenamerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderqueuenamerefpolicywithresolve)
    * [`obj spec.forProvider.queueNameSelector`](#obj-specforproviderqueuenameselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderqueuenameselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderqueuenameselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderqueuenameselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.queueNameSelector.policy`](#obj-specforproviderqueuenameselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderqueuenameselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderqueuenameselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withQueueName(queueName)`](#fn-specinitproviderwithqueuename)
    ...
    * [`obj spec.initProvider.queueNameRef`](#obj-specinitproviderqueuenameref)
      * [`fn withName(name)`](#fn-specinitproviderqueuenamerefwithname)
      * [`obj spec.initProvider.queueNameRef.policy`](#obj-specinitproviderqueuenamerefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderqueuenamerefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderqueuenamerefpolicywithresolve)
    * [`obj spec.initProvider.queueNameSelector`](#obj-specinitproviderqueuenameselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderqueuenameselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderqueuenameselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderqueuenameselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.queueNameSelector.policy`](#obj-specinitproviderqueuenameselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderqueuenameselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderqueuenameselectorpolicywithresolve)
    ...
    * [`obj spec.initProvider.sharedAccessPolicyKeySecretRef`](#obj-specinitprovidersharedaccesspolicykeysecretref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitprovidersharedaccesspolicykeysecretrefwithnamespace)
...
new returns an instance of OutputServiceBusQueue
...
### fn spec.forProvider.withQueueName
...
## obj spec.forProvider.queueNameRef

"Reference to a Queue in servicebus to populate queueName."

### fn spec.forProvider.queueNameRef.withName
...
## obj spec.forProvider.queueNameRef.policy

"Policies for referencing."

### fn spec.forProvider.queueNameRef.policy.withResolution
...
### fn spec.forProvider.queueNameRef.policy.withResolve
...
## obj spec.forProvider.queueNameSelector

"Selector for a Queue in servicebus to populate queueName."

### fn spec.forProvider.queueNameSelector.withMatchControllerRef
...
### fn spec.forProvider.queueNameSelector.withMatchLabels
...
### fn spec.forProvider.queueNameSelector.withMatchLabelsMixin
...
## obj spec.forProvider.queueNameSelector.policy

"Policies for selection."

### fn spec.forProvider.queueNameSelector.policy.withResolution
...
### fn spec.forProvider.queueNameSelector.policy.withResolve
...
### fn spec.initProvider.withQueueName
...
## obj spec.initProvider.queueNameRef

"Reference to a Queue in servicebus to populate queueName."

### fn spec.initProvider.queueNameRef.withName
...
## obj spec.initProvider.queueNameRef.policy

"Policies for referencing."

### fn spec.initProvider.queueNameRef.policy.withResolution
...
### fn spec.initProvider.queueNameRef.policy.withResolve
...
## obj spec.initProvider.queueNameSelector

"Selector for a Queue in servicebus to populate queueName."

### fn spec.initProvider.queueNameSelector.withMatchControllerRef
...
### fn spec.initProvider.queueNameSelector.withMatchLabels
...
### fn spec.initProvider.queueNameSelector.withMatchLabelsMixin
...
## obj spec.initProvider.queueNameSelector.policy

"Policies for selection."

### fn spec.initProvider.queueNameSelector.policy.withResolution
...
### fn spec.initProvider.queueNameSelector.policy.withResolve
...
### fn spec.initProvider.sharedAccessPolicyKeySecretRef.withNamespace
