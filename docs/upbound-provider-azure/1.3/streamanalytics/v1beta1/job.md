---
permalink: /upbound-provider-azure/1.3/streamanalytics/v1beta1/job/
---

# streamanalytics.v1beta1.job
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withJobStorageAccount(jobStorageAccount)`](#fn-specforproviderwithjobstorageaccount)
    * [`fn withJobStorageAccountMixin(jobStorageAccount)`](#fn-specforproviderwithjobstorageaccountmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withJobStorageAccount(jobStorageAccount)`](#fn-specinitproviderwithjobstorageaccount)
    * [`fn withJobStorageAccountMixin(jobStorageAccount)`](#fn-specinitproviderwithjobstorageaccountmixin)
...
### fn spec.forProvider.withJobStorageAccount

```ts
withJobStorageAccount(jobStorageAccount)
```

"The details of the job storage account. A job_storage_account block as defined below."

### fn spec.forProvider.withJobStorageAccountMixin

```ts
withJobStorageAccountMixin(jobStorageAccount)
```
...
### fn spec.initProvider.withJobStorageAccount
...
### fn spec.initProvider.withJobStorageAccountMixin
