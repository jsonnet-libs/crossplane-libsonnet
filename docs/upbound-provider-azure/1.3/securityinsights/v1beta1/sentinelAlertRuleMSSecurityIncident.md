---
permalink: /upbound-provider-azure/1.3/securityinsights/v1beta1/sentinelAlertRuleMSSecurityIncident/
---

# securityinsights.v1beta1.sentinelAlertRuleMSSecurityIncident
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAlertRuleTemplateGuid(alertRuleTemplateGuid)`](#fn-specforproviderwithalertruletemplateguid)
    * [`fn withDescription(description)`](#fn-specforproviderwithdescription)
    * [`fn withDisplayName(displayName)`](#fn-specforproviderwithdisplayname)
    * [`fn withDisplayNameExcludeFilter(displayNameExcludeFilter)`](#fn-specforproviderwithdisplaynameexcludefilter)
    * [`fn withDisplayNameExcludeFilterMixin(displayNameExcludeFilter)`](#fn-specforproviderwithdisplaynameexcludefiltermixin)
    * [`fn withDisplayNameFilter(displayNameFilter)`](#fn-specforproviderwithdisplaynamefilter)
    * [`fn withDisplayNameFilterMixin(displayNameFilter)`](#fn-specforproviderwithdisplaynamefiltermixin)
    * [`fn withEnabled(enabled)`](#fn-specforproviderwithenabled)
    * [`fn withLogAnalyticsWorkspaceId(logAnalyticsWorkspaceId)`](#fn-specforproviderwithloganalyticsworkspaceid)
    * [`fn withProductFilter(productFilter)`](#fn-specforproviderwithproductfilter)
    * [`fn withSeverityFilter(severityFilter)`](#fn-specforproviderwithseverityfilter)
    * [`fn withSeverityFilterMixin(severityFilter)`](#fn-specforproviderwithseverityfiltermixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAlertRuleTemplateGuid(alertRuleTemplateGuid)`](#fn-specinitproviderwithalertruletemplateguid)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withDisplayName(displayName)`](#fn-specinitproviderwithdisplayname)
    * [`fn withDisplayNameExcludeFilter(displayNameExcludeFilter)`](#fn-specinitproviderwithdisplaynameexcludefilter)
    * [`fn withDisplayNameExcludeFilterMixin(displayNameExcludeFilter)`](#fn-specinitproviderwithdisplaynameexcludefiltermixin)
    * [`fn withDisplayNameFilter(displayNameFilter)`](#fn-specinitproviderwithdisplaynamefilter)
    * [`fn withDisplayNameFilterMixin(displayNameFilter)`](#fn-specinitproviderwithdisplaynamefiltermixin)
    * [`fn withEnabled(enabled)`](#fn-specinitproviderwithenabled)
    * [`fn withProductFilter(productFilter)`](#fn-specinitproviderwithproductfilter)
    * [`fn withSeverityFilter(severityFilter)`](#fn-specinitproviderwithseverityfilter)
    * [`fn withSeverityFilterMixin(severityFilter)`](#fn-specinitproviderwithseverityfiltermixin)
...
new returns an instance of SentinelAlertRuleMSSecurityIncident
...
### fn spec.forProvider.withAlertRuleTemplateGuid

```ts
withAlertRuleTemplateGuid(alertRuleTemplateGuid)
```
...
### fn spec.forProvider.withDisplayNameExcludeFilter

```ts
withDisplayNameExcludeFilter(displayNameExcludeFilter)
```

"Only create incidents when the alert display name doesn't contain text from this list."

### fn spec.forProvider.withDisplayNameExcludeFilterMixin

```ts
withDisplayNameExcludeFilterMixin(displayNameExcludeFilter)
```
...
### fn spec.forProvider.withDisplayNameFilter

```ts
withDisplayNameFilter(displayNameFilter)
```

"Only create incidents when the alert display name contain text from this list, leave empty to apply no filter."

### fn spec.forProvider.withDisplayNameFilterMixin

```ts
withDisplayNameFilterMixin(displayNameFilter)
```
...
### fn spec.forProvider.withProductFilter

```ts
withProductFilter(productFilter)
```
...
### fn spec.forProvider.withSeverityFilter

```ts
withSeverityFilter(severityFilter)
```

"Only create incidents from alerts when alert severity level is contained in this list. Possible values are High, Medium, Low and Informational."

### fn spec.forProvider.withSeverityFilterMixin

```ts
withSeverityFilterMixin(severityFilter)
```
...
### fn spec.initProvider.withAlertRuleTemplateGuid
...
### fn spec.initProvider.withDisplayNameExcludeFilter
...
### fn spec.initProvider.withDisplayNameExcludeFilterMixin
...
### fn spec.initProvider.withDisplayNameFilter
...
### fn spec.initProvider.withDisplayNameFilterMixin
...
### fn spec.initProvider.withProductFilter
...
### fn spec.initProvider.withSeverityFilter
...
### fn spec.initProvider.withSeverityFilterMixin
