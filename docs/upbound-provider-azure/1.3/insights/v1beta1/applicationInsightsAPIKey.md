---
permalink: /upbound-provider-azure/1.3/insights/v1beta1/applicationInsightsAPIKey/
---

# insights.v1beta1.applicationInsightsAPIKey
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withReadPermissions(readPermissions)`](#fn-specforproviderwithreadpermissions)
    * [`fn withReadPermissionsMixin(readPermissions)`](#fn-specforproviderwithreadpermissionsmixin)
    * [`fn withWritePermissions(writePermissions)`](#fn-specforproviderwithwritepermissions)
    * [`fn withWritePermissionsMixin(writePermissions)`](#fn-specforproviderwithwritepermissionsmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withReadPermissions(readPermissions)`](#fn-specinitproviderwithreadpermissions)
    * [`fn withReadPermissionsMixin(readPermissions)`](#fn-specinitproviderwithreadpermissionsmixin)
    * [`fn withWritePermissions(writePermissions)`](#fn-specinitproviderwithwritepermissions)
    * [`fn withWritePermissionsMixin(writePermissions)`](#fn-specinitproviderwithwritepermissionsmixin)
...
new returns an instance of ApplicationInsightsAPIKey
...
### fn spec.forProvider.withReadPermissions
...
### fn spec.forProvider.withReadPermissionsMixin

```ts
withReadPermissionsMixin(readPermissions)
```
...
### fn spec.forProvider.withWritePermissions

```ts
withWritePermissions(writePermissions)
```

"Specifies the list of write permissions granted to the API key. Valid values are annotations. Please note these values are case sensitive. Changing this forces a new resource to be created."

### fn spec.forProvider.withWritePermissionsMixin

```ts
withWritePermissionsMixin(writePermissions)
```
...
### fn spec.initProvider.withReadPermissions
...
### fn spec.initProvider.withReadPermissionsMixin
...
### fn spec.initProvider.withWritePermissions
...
### fn spec.initProvider.withWritePermissionsMixin
