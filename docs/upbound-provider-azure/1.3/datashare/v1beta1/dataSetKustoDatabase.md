---
permalink: /upbound-provider-azure/1.3/datashare/v1beta1/dataSetKustoDatabase/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withKustoDatabaseId(kustoDatabaseId)`](#fn-specinitproviderwithkustodatabaseid)
    * [`obj spec.initProvider.kustoDatabaseIdRef`](#obj-specinitproviderkustodatabaseidref)
      * [`fn withName(name)`](#fn-specinitproviderkustodatabaseidrefwithname)
      * [`obj spec.initProvider.kustoDatabaseIdRef.policy`](#obj-specinitproviderkustodatabaseidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderkustodatabaseidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderkustodatabaseidrefpolicywithresolve)
    * [`obj spec.initProvider.kustoDatabaseIdSelector`](#obj-specinitproviderkustodatabaseidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderkustodatabaseidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderkustodatabaseidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderkustodatabaseidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.kustoDatabaseIdSelector.policy`](#obj-specinitproviderkustodatabaseidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderkustodatabaseidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderkustodatabaseidselectorpolicywithresolve)
...
### fn spec.forProvider.kustoDatabaseIdSelector.policy.withResolve
...
### fn spec.initProvider.withKustoDatabaseId
...
## obj spec.initProvider.kustoDatabaseIdRef

"Reference to a Database in kusto to populate kustoDatabaseId."

### fn spec.initProvider.kustoDatabaseIdRef.withName
...
## obj spec.initProvider.kustoDatabaseIdRef.policy

"Policies for referencing."

### fn spec.initProvider.kustoDatabaseIdRef.policy.withResolution
...
### fn spec.initProvider.kustoDatabaseIdRef.policy.withResolve
...
## obj spec.initProvider.kustoDatabaseIdSelector

"Selector for a Database in kusto to populate kustoDatabaseId."

### fn spec.initProvider.kustoDatabaseIdSelector.withMatchControllerRef
...
### fn spec.initProvider.kustoDatabaseIdSelector.withMatchLabels
...
### fn spec.initProvider.kustoDatabaseIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.kustoDatabaseIdSelector.policy

"Policies for selection."

### fn spec.initProvider.kustoDatabaseIdSelector.policy.withResolution
...
### fn spec.initProvider.kustoDatabaseIdSelector.policy.withResolve
