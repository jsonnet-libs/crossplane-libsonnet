---
permalink: /upbound-provider-azure/1.3/operationalinsights/v1beta1/logAnalyticsLinkedService/
---

# operationalinsights.v1beta1.logAnalyticsLinkedService
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withReadAccessId(readAccessId)`](#fn-specforproviderwithreadaccessid)
    * [`fn withResourceGroupName(resourceGroupName)`](#fn-specforproviderwithresourcegroupname)
    * [`fn withWorkspaceId(workspaceId)`](#fn-specforproviderwithworkspaceid)
    * [`fn withWriteAccessId(writeAccessId)`](#fn-specforproviderwithwriteaccessid)
    * [`obj spec.forProvider.readAccessIdRef`](#obj-specforproviderreadaccessidref)
      * [`fn withName(name)`](#fn-specforproviderreadaccessidrefwithname)
      * [`obj spec.forProvider.readAccessIdRef.policy`](#obj-specforproviderreadaccessidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderreadaccessidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderreadaccessidrefpolicywithresolve)
    * [`obj spec.forProvider.readAccessIdSelector`](#obj-specforproviderreadaccessidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderreadaccessidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderreadaccessidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderreadaccessidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.readAccessIdSelector.policy`](#obj-specforproviderreadaccessidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderreadaccessidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderreadaccessidselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withReadAccessId(readAccessId)`](#fn-specinitproviderwithreadaccessid)
    * [`fn withResourceGroupName(resourceGroupName)`](#fn-specinitproviderwithresourcegroupname)
    * [`fn withWriteAccessId(writeAccessId)`](#fn-specinitproviderwithwriteaccessid)
    * [`obj spec.initProvider.readAccessIdRef`](#obj-specinitproviderreadaccessidref)
      * [`fn withName(name)`](#fn-specinitproviderreadaccessidrefwithname)
      * [`obj spec.initProvider.readAccessIdRef.policy`](#obj-specinitproviderreadaccessidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderreadaccessidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderreadaccessidrefpolicywithresolve)
    * [`obj spec.initProvider.readAccessIdSelector`](#obj-specinitproviderreadaccessidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderreadaccessidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderreadaccessidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderreadaccessidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.readAccessIdSelector.policy`](#obj-specinitproviderreadaccessidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderreadaccessidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderreadaccessidselectorpolicywithresolve)
...
new returns an instance of LogAnalyticsLinkedService
...
### fn spec.forProvider.withReadAccessId

```ts
withReadAccessId(readAccessId)
```
...
### fn spec.forProvider.withWriteAccessId

```ts
withWriteAccessId(writeAccessId)
```

"The ID of the writable Resource that will be linked to the workspace. This should be used for linking to a Log Analytics Cluster resource."

## obj spec.forProvider.readAccessIdRef

"Reference to a Account in automation to populate readAccessId."

### fn spec.forProvider.readAccessIdRef.withName
...
## obj spec.forProvider.readAccessIdRef.policy

"Policies for referencing."

### fn spec.forProvider.readAccessIdRef.policy.withResolution
...
### fn spec.forProvider.readAccessIdRef.policy.withResolve
...
## obj spec.forProvider.readAccessIdSelector

"Selector for a Account in automation to populate readAccessId."

### fn spec.forProvider.readAccessIdSelector.withMatchControllerRef
...
### fn spec.forProvider.readAccessIdSelector.withMatchLabels
...
### fn spec.forProvider.readAccessIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.readAccessIdSelector.policy

"Policies for selection."

### fn spec.forProvider.readAccessIdSelector.policy.withResolution
...
### fn spec.forProvider.readAccessIdSelector.policy.withResolve
...
### fn spec.initProvider.withReadAccessId
...
### fn spec.initProvider.withWriteAccessId
...
## obj spec.initProvider.readAccessIdRef

"Reference to a Account in automation to populate readAccessId."

### fn spec.initProvider.readAccessIdRef.withName
...
## obj spec.initProvider.readAccessIdRef.policy

"Policies for referencing."

### fn spec.initProvider.readAccessIdRef.policy.withResolution
...
### fn spec.initProvider.readAccessIdRef.policy.withResolve
...
## obj spec.initProvider.readAccessIdSelector

"Selector for a Account in automation to populate readAccessId."

### fn spec.initProvider.readAccessIdSelector.withMatchControllerRef
...
### fn spec.initProvider.readAccessIdSelector.withMatchLabels
...
### fn spec.initProvider.readAccessIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.readAccessIdSelector.policy

"Policies for selection."

### fn spec.initProvider.readAccessIdSelector.policy.withResolution
...
### fn spec.initProvider.readAccessIdSelector.policy.withResolve
