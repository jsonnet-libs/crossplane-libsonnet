---
permalink: /upbound-provider-azure/1.3/operationalinsights/v1beta2/workspace/
---

# operationalinsights.v1beta2.workspace
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAllowResourceOnlyPermissions(allowResourceOnlyPermissions)`](#fn-specforproviderwithallowresourceonlypermissions)
    * [`fn withCmkForQueryForced(cmkForQueryForced)`](#fn-specforproviderwithcmkforqueryforced)
    * [`fn withDailyQuotaGb(dailyQuotaGb)`](#fn-specforproviderwithdailyquotagb)
    * [`fn withDataCollectionRuleId(dataCollectionRuleId)`](#fn-specforproviderwithdatacollectionruleid)
    * [`fn withImmediateDataPurgeOn30DaysEnabled(immediateDataPurgeOn30DaysEnabled)`](#fn-specforproviderwithimmediatedatapurgeon30daysenabled)
    ...
    * [`fn withReservationCapacityInGbPerDay(reservationCapacityInGbPerDay)`](#fn-specforproviderwithreservationcapacityingbperday)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAllowResourceOnlyPermissions(allowResourceOnlyPermissions)`](#fn-specinitproviderwithallowresourceonlypermissions)
    * [`fn withCmkForQueryForced(cmkForQueryForced)`](#fn-specinitproviderwithcmkforqueryforced)
    * [`fn withDailyQuotaGb(dailyQuotaGb)`](#fn-specinitproviderwithdailyquotagb)
    * [`fn withDataCollectionRuleId(dataCollectionRuleId)`](#fn-specinitproviderwithdatacollectionruleid)
    * [`fn withImmediateDataPurgeOn30DaysEnabled(immediateDataPurgeOn30DaysEnabled)`](#fn-specinitproviderwithimmediatedatapurgeon30daysenabled)
    ...
    * [`fn withReservationCapacityInGbPerDay(reservationCapacityInGbPerDay)`](#fn-specinitproviderwithreservationcapacityingbperday)
...
### fn spec.forProvider.withAllowResourceOnlyPermissions

```ts
withAllowResourceOnlyPermissions(allowResourceOnlyPermissions)
```
...
### fn spec.forProvider.withCmkForQueryForced

```ts
withCmkForQueryForced(cmkForQueryForced)
```

"Is Customer Managed Storage mandatory for query management?"

### fn spec.forProvider.withDailyQuotaGb

```ts
withDailyQuotaGb(dailyQuotaGb)
```
...
### fn spec.forProvider.withImmediateDataPurgeOn30DaysEnabled

```ts
withImmediateDataPurgeOn30DaysEnabled(immediateDataPurgeOn30DaysEnabled)
```
...
### fn spec.forProvider.withReservationCapacityInGbPerDay

```ts
withReservationCapacityInGbPerDay(reservationCapacityInGbPerDay)
```
...
### fn spec.initProvider.withAllowResourceOnlyPermissions
...
### fn spec.initProvider.withCmkForQueryForced
...
### fn spec.initProvider.withDailyQuotaGb
...
### fn spec.initProvider.withImmediateDataPurgeOn30DaysEnabled
...
### fn spec.initProvider.withReservationCapacityInGbPerDay
