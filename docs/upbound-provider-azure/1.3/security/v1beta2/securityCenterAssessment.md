---
permalink: /upbound-provider-azure/1.3/security/v1beta2/securityCenterAssessment/
---

# security.v1beta2.securityCenterAssessment
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.assessmentPolicyIdRef`](#obj-specforproviderassessmentpolicyidref)
      ...
      * [`obj spec.forProvider.assessmentPolicyIdRef.policy`](#obj-specforproviderassessmentpolicyidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderassessmentpolicyidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderassessmentpolicyidrefpolicywithresolve)
    * [`obj spec.forProvider.assessmentPolicyIdSelector`](#obj-specforproviderassessmentpolicyidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderassessmentpolicyidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderassessmentpolicyidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderassessmentpolicyidselectorwithmatchlabelsmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAdditionalData(additionalData)`](#fn-specinitproviderwithadditionaldata)
    * [`fn withAdditionalDataMixin(additionalData)`](#fn-specinitproviderwithadditionaldatamixin)
    * [`fn withAssessmentPolicyId(assessmentPolicyId)`](#fn-specinitproviderwithassessmentpolicyid)
    * [`fn withTargetResourceId(targetResourceId)`](#fn-specinitproviderwithtargetresourceid)
    * [`obj spec.initProvider.assessmentPolicyIdRef`](#obj-specinitproviderassessmentpolicyidref)
      * [`fn withName(name)`](#fn-specinitproviderassessmentpolicyidrefwithname)
      * [`obj spec.initProvider.assessmentPolicyIdRef.policy`](#obj-specinitproviderassessmentpolicyidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderassessmentpolicyidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderassessmentpolicyidrefpolicywithresolve)
    * [`obj spec.initProvider.assessmentPolicyIdSelector`](#obj-specinitproviderassessmentpolicyidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderassessmentpolicyidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderassessmentpolicyidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderassessmentpolicyidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.assessmentPolicyIdSelector.policy`](#obj-specinitproviderassessmentpolicyidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderassessmentpolicyidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderassessmentpolicyidselectorpolicywithresolve)
...
new returns an instance of SecurityCenterAssessment
...
### fn spec.forProvider.withAdditionalData
...
### fn spec.forProvider.withAdditionalDataMixin

```ts
withAdditionalDataMixin(additionalData)
```
...
### fn spec.forProvider.withAssessmentPolicyId

```ts
withAssessmentPolicyId(assessmentPolicyId)
```
...
## obj spec.forProvider.assessmentPolicyIdRef

"Reference to a SecurityCenterAssessmentPolicy in security to populate assessmentPolicyId."

### fn spec.forProvider.assessmentPolicyIdRef.withName
...
## obj spec.forProvider.assessmentPolicyIdRef.policy

"Policies for referencing."

### fn spec.forProvider.assessmentPolicyIdRef.policy.withResolution
...
### fn spec.forProvider.assessmentPolicyIdRef.policy.withResolve
...
## obj spec.forProvider.assessmentPolicyIdSelector

"Selector for a SecurityCenterAssessmentPolicy in security to populate assessmentPolicyId."

### fn spec.forProvider.assessmentPolicyIdSelector.withMatchControllerRef
...
### fn spec.forProvider.assessmentPolicyIdSelector.withMatchLabels
...
### fn spec.forProvider.assessmentPolicyIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.assessmentPolicyIdSelector.policy

"Policies for selection."

### fn spec.forProvider.assessmentPolicyIdSelector.policy.withResolution
...
### fn spec.forProvider.assessmentPolicyIdSelector.policy.withResolve
...
### fn spec.initProvider.withAdditionalData
...
### fn spec.initProvider.withAdditionalDataMixin
...
### fn spec.initProvider.withAssessmentPolicyId
...
## obj spec.initProvider.assessmentPolicyIdRef

"Reference to a SecurityCenterAssessmentPolicy in security to populate assessmentPolicyId."

### fn spec.initProvider.assessmentPolicyIdRef.withName
...
## obj spec.initProvider.assessmentPolicyIdRef.policy

"Policies for referencing."

### fn spec.initProvider.assessmentPolicyIdRef.policy.withResolution
...
### fn spec.initProvider.assessmentPolicyIdRef.policy.withResolve
...
## obj spec.initProvider.assessmentPolicyIdSelector

"Selector for a SecurityCenterAssessmentPolicy in security to populate assessmentPolicyId."

### fn spec.initProvider.assessmentPolicyIdSelector.withMatchControllerRef
...
### fn spec.initProvider.assessmentPolicyIdSelector.withMatchLabels
...
### fn spec.initProvider.assessmentPolicyIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.assessmentPolicyIdSelector.policy

"Policies for selection."

### fn spec.initProvider.assessmentPolicyIdSelector.policy.withResolution
...
### fn spec.initProvider.assessmentPolicyIdSelector.policy.withResolve
