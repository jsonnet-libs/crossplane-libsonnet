---
permalink: /upbound-provider-azure/1.3/resources/v1beta2/resourceDeploymentScriptAzurePowerShell/
---

# resources.v1beta2.resourceDeploymentScriptAzurePowerShell
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.environmentVariable`](#obj-specinitproviderenvironmentvariable)
      ...
      * [`obj spec.initProvider.environmentVariable.secureValueSecretRef`](#obj-specinitproviderenvironmentvariablesecurevaluesecretref)
        * [`fn withKey(key)`](#fn-specinitproviderenvironmentvariablesecurevaluesecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitproviderenvironmentvariablesecurevaluesecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitproviderenvironmentvariablesecurevaluesecretrefwithnamespace)
    ...
    * [`obj spec.initProvider.storageAccount`](#obj-specinitproviderstorageaccount)
      ...
      * [`obj spec.initProvider.storageAccount.keySecretRef`](#obj-specinitproviderstorageaccountkeysecretref)
...
## obj spec.initProvider.environmentVariable.secureValueSecretRef

"Specifies the value of the secure environment variable."

### fn spec.initProvider.environmentVariable.secureValueSecretRef.withKey
...
### fn spec.initProvider.environmentVariable.secureValueSecretRef.withName
...
### fn spec.initProvider.environmentVariable.secureValueSecretRef.withNamespace
...
## obj spec.initProvider.storageAccount.keySecretRef

"Specifies the storage account access key."

### fn spec.initProvider.storageAccount.keySecretRef.withKey
...
### fn spec.initProvider.storageAccount.keySecretRef.withName
...
### fn spec.initProvider.storageAccount.keySecretRef.withNamespace
