---
permalink: /upbound-provider-azure/1.3/maintenance/v1beta1/maintenanceConfiguration/
---

# maintenance.v1beta1.maintenanceConfiguration
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withInstallPatches(installPatches)`](#fn-specforproviderwithinstallpatches)
    * [`fn withInstallPatchesMixin(installPatches)`](#fn-specforproviderwithinstallpatchesmixin)
    ...
    * [`fn withWindowMixin(window)`](#fn-specforproviderwithwindowmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withInstallPatches(installPatches)`](#fn-specinitproviderwithinstallpatches)
    * [`fn withInstallPatchesMixin(installPatches)`](#fn-specinitproviderwithinstallpatchesmixin)
    ...
    * [`fn withWindowMixin(window)`](#fn-specinitproviderwithwindowmixin)
...
### fn spec.forProvider.withInstallPatches

```ts
withInstallPatches(installPatches)
```

"An install_patches block as defined below."

### fn spec.forProvider.withInstallPatchesMixin

```ts
withInstallPatchesMixin(installPatches)
```
...
### fn spec.forProvider.withWindowMixin
...
### fn spec.initProvider.withInstallPatches
...
### fn spec.initProvider.withInstallPatchesMixin
...
### fn spec.initProvider.withWindowMixin
