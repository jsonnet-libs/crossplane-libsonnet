---
permalink: /upbound-provider-azure/1.3/cdn/v1beta1/frontdoorSecurityPolicy/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withSecurityPolicies(securityPolicies)`](#fn-specforproviderwithsecuritypolicies)
    * [`fn withSecurityPoliciesMixin(securityPolicies)`](#fn-specforproviderwithsecuritypoliciesmixin)
    ...
    * [`obj spec.forProvider.securityPolicies`](#obj-specforprovidersecuritypolicies)
      * [`fn withFirewall(firewall)`](#fn-specforprovidersecuritypolicieswithfirewall)
      * [`fn withFirewallMixin(firewall)`](#fn-specforprovidersecuritypolicieswithfirewallmixin)
      * [`obj spec.forProvider.securityPolicies.firewall`](#obj-specforprovidersecuritypoliciesfirewall)
        * [`fn withAssociation(association)`](#fn-specforprovidersecuritypoliciesfirewallwithassociation)
        * [`fn withAssociationMixin(association)`](#fn-specforprovidersecuritypoliciesfirewallwithassociationmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withSecurityPolicies(securityPolicies)`](#fn-specinitproviderwithsecuritypolicies)
    * [`fn withSecurityPoliciesMixin(securityPolicies)`](#fn-specinitproviderwithsecuritypoliciesmixin)
    * [`obj spec.initProvider.securityPolicies`](#obj-specinitprovidersecuritypolicies)
      * [`fn withFirewall(firewall)`](#fn-specinitprovidersecuritypolicieswithfirewall)
      * [`fn withFirewallMixin(firewall)`](#fn-specinitprovidersecuritypolicieswithfirewallmixin)
      * [`obj spec.initProvider.securityPolicies.firewall`](#obj-specinitprovidersecuritypoliciesfirewall)
        * [`fn withAssociation(association)`](#fn-specinitprovidersecuritypoliciesfirewallwithassociation)
        * [`fn withAssociationMixin(association)`](#fn-specinitprovidersecuritypoliciesfirewallwithassociationmixin)
...
### fn spec.forProvider.withSecurityPolicies

```ts
withSecurityPolicies(securityPolicies)
```

"An security_policies block as defined below. Changing this forces a new Front Door Security Policy to be created."

### fn spec.forProvider.withSecurityPoliciesMixin

```ts
withSecurityPoliciesMixin(securityPolicies)
```
...
### fn spec.forProvider.securityPolicies.withFirewall
...
### fn spec.forProvider.securityPolicies.withFirewallMixin

```ts
withFirewallMixin(firewall)
```
...
### fn spec.forProvider.securityPolicies.firewall.withAssociation
...
### fn spec.forProvider.securityPolicies.firewall.withAssociationMixin
...
### fn spec.initProvider.withSecurityPolicies
...
### fn spec.initProvider.withSecurityPoliciesMixin
...
### fn spec.initProvider.securityPolicies.withFirewall
...
### fn spec.initProvider.securityPolicies.withFirewallMixin
...
### fn spec.initProvider.securityPolicies.firewall.withAssociation
...
### fn spec.initProvider.securityPolicies.firewall.withAssociationMixin
