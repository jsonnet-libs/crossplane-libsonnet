---
permalink: /upbound-provider-azure/1.3/cdn/v1beta1/frontdoorOriginGroup/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withHealthProbe(healthProbe)`](#fn-specinitproviderwithhealthprobe)
    * [`fn withHealthProbeMixin(healthProbe)`](#fn-specinitproviderwithhealthprobemixin)
    * [`fn withLoadBalancing(loadBalancing)`](#fn-specinitproviderwithloadbalancing)
    * [`fn withLoadBalancingMixin(loadBalancing)`](#fn-specinitproviderwithloadbalancingmixin)
    * [`fn withRestoreTrafficTimeToHealedOrNewEndpointInMinutes(restoreTrafficTimeToHealedOrNewEndpointInMinutes)`](#fn-specinitproviderwithrestoretraffictimetohealedornewendpointinminutes)
    * [`fn withSessionAffinityEnabled(sessionAffinityEnabled)`](#fn-specinitproviderwithsessionaffinityenabled)
    * [`obj spec.initProvider.healthProbe`](#obj-specinitproviderhealthprobe)
      * [`fn withIntervalInSeconds(intervalInSeconds)`](#fn-specinitproviderhealthprobewithintervalinseconds)
      * [`fn withPath(path)`](#fn-specinitproviderhealthprobewithpath)
      * [`fn withProtocol(protocol)`](#fn-specinitproviderhealthprobewithprotocol)
      * [`fn withRequestType(requestType)`](#fn-specinitproviderhealthprobewithrequesttype)
    * [`obj spec.initProvider.loadBalancing`](#obj-specinitproviderloadbalancing)
      * [`fn withAdditionalLatencyInMilliseconds(additionalLatencyInMilliseconds)`](#fn-specinitproviderloadbalancingwithadditionallatencyinmilliseconds)
      * [`fn withSampleSize(sampleSize)`](#fn-specinitproviderloadbalancingwithsamplesize)
      * [`fn withSuccessfulSamplesRequired(successfulSamplesRequired)`](#fn-specinitproviderloadbalancingwithsuccessfulsamplesrequired)
...
### fn spec.initProvider.withHealthProbe
...
### fn spec.initProvider.withHealthProbeMixin
...
### fn spec.initProvider.withLoadBalancing
...
### fn spec.initProvider.withLoadBalancingMixin
...
### fn spec.initProvider.withRestoreTrafficTimeToHealedOrNewEndpointInMinutes
...
### fn spec.initProvider.withSessionAffinityEnabled
...
## obj spec.initProvider.healthProbe

"A health_probe block as defined below."

### fn spec.initProvider.healthProbe.withIntervalInSeconds
...
### fn spec.initProvider.healthProbe.withPath
...
### fn spec.initProvider.healthProbe.withProtocol
...
### fn spec.initProvider.healthProbe.withRequestType
...
## obj spec.initProvider.loadBalancing

"A load_balancing block as defined below."

### fn spec.initProvider.loadBalancing.withAdditionalLatencyInMilliseconds
...
### fn spec.initProvider.loadBalancing.withSampleSize
...
### fn spec.initProvider.loadBalancing.withSuccessfulSamplesRequired
