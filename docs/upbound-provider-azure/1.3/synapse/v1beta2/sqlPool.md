---
permalink: /upbound-provider-azure/1.3/synapse/v1beta2/sqlPool/
---

# synapse.v1beta2.sqlPool
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withDataEncrypted(dataEncrypted)`](#fn-specforproviderwithdataencrypted)
    * [`fn withGeoBackupPolicyEnabled(geoBackupPolicyEnabled)`](#fn-specforproviderwithgeobackuppolicyenabled)
    * [`fn withRecoveryDatabaseId(recoveryDatabaseId)`](#fn-specforproviderwithrecoverydatabaseid)
    ...
    * [`obj spec.forProvider.restore`](#obj-specforproviderrestore)
      * [`fn withPointInTime(pointInTime)`](#fn-specforproviderrestorewithpointintime)
      * [`fn withSourceDatabaseId(sourceDatabaseId)`](#fn-specforproviderrestorewithsourcedatabaseid)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withDataEncrypted(dataEncrypted)`](#fn-specinitproviderwithdataencrypted)
    * [`fn withGeoBackupPolicyEnabled(geoBackupPolicyEnabled)`](#fn-specinitproviderwithgeobackuppolicyenabled)
    * [`fn withRecoveryDatabaseId(recoveryDatabaseId)`](#fn-specinitproviderwithrecoverydatabaseid)
    ...
    * [`obj spec.initProvider.restore`](#obj-specinitproviderrestore)
      * [`fn withPointInTime(pointInTime)`](#fn-specinitproviderrestorewithpointintime)
      * [`fn withSourceDatabaseId(sourceDatabaseId)`](#fn-specinitproviderrestorewithsourcedatabaseid)
...
new returns an instance of SQLPool
...
### fn spec.forProvider.withDataEncrypted

```ts
withDataEncrypted(dataEncrypted)
```

"Is transparent data encryption enabled?"

### fn spec.forProvider.withGeoBackupPolicyEnabled

```ts
withGeoBackupPolicyEnabled(geoBackupPolicyEnabled)
```

"Is geo-backup policy enabled? Possible values include true or false. Defaults to true."

### fn spec.forProvider.withRecoveryDatabaseId

```ts
withRecoveryDatabaseId(recoveryDatabaseId)
```
...
### fn spec.forProvider.restore.withPointInTime
...
### fn spec.forProvider.restore.withSourceDatabaseId
...
### fn spec.initProvider.withDataEncrypted
...
### fn spec.initProvider.withGeoBackupPolicyEnabled
...
### fn spec.initProvider.withRecoveryDatabaseId
...
### fn spec.initProvider.restore.withPointInTime
...
### fn spec.initProvider.restore.withSourceDatabaseId
