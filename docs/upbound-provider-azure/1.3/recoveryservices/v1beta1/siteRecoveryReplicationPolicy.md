---
permalink: /upbound-provider-azure/1.3/recoveryservices/v1beta1/siteRecoveryReplicationPolicy/
---

# recoveryservices.v1beta1.siteRecoveryReplicationPolicy
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withApplicationConsistentSnapshotFrequencyInMinutes(applicationConsistentSnapshotFrequencyInMinutes)`](#fn-specforproviderwithapplicationconsistentsnapshotfrequencyinminutes)
    * [`fn withRecoveryPointRetentionInMinutes(recoveryPointRetentionInMinutes)`](#fn-specforproviderwithrecoverypointretentioninminutes)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withApplicationConsistentSnapshotFrequencyInMinutes(applicationConsistentSnapshotFrequencyInMinutes)`](#fn-specinitproviderwithapplicationconsistentsnapshotfrequencyinminutes)
    * [`fn withRecoveryPointRetentionInMinutes(recoveryPointRetentionInMinutes)`](#fn-specinitproviderwithrecoverypointretentioninminutes)
...
new returns an instance of SiteRecoveryReplicationPolicy
...
### fn spec.forProvider.withApplicationConsistentSnapshotFrequencyInMinutes

```ts
withApplicationConsistentSnapshotFrequencyInMinutes(applicationConsistentSnapshotFrequencyInMinutes)
```

"Specifies the frequency(in minutes) at which to create application consistent recovery points."

### fn spec.forProvider.withRecoveryPointRetentionInMinutes

```ts
withRecoveryPointRetentionInMinutes(recoveryPointRetentionInMinutes)
```
...
### fn spec.initProvider.withApplicationConsistentSnapshotFrequencyInMinutes
...
### fn spec.initProvider.withRecoveryPointRetentionInMinutes
