---
permalink: /upbound-provider-azure/1.3/servicebus/v1beta1/subscription/
---

# servicebus.v1beta1.subscription
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withClientScopedSubscription(clientScopedSubscription)`](#fn-specforproviderwithclientscopedsubscription)
    * [`fn withClientScopedSubscriptionEnabled(clientScopedSubscriptionEnabled)`](#fn-specforproviderwithclientscopedsubscriptionenabled)
    * [`fn withClientScopedSubscriptionMixin(clientScopedSubscription)`](#fn-specforproviderwithclientscopedsubscriptionmixin)
    * [`fn withDeadLetteringOnFilterEvaluationError(deadLetteringOnFilterEvaluationError)`](#fn-specforproviderwithdeadletteringonfilterevaluationerror)
    ...
    * [`obj spec.forProvider.clientScopedSubscription`](#obj-specforproviderclientscopedsubscription)
      ...
      * [`fn withIsClientScopedSubscriptionShareable(isClientScopedSubscriptionShareable)`](#fn-specforproviderclientscopedsubscriptionwithisclientscopedsubscriptionshareable)
    * [`obj spec.forProvider.topicIdRef`](#obj-specforprovidertopicidref)
      * [`fn withName(name)`](#fn-specforprovidertopicidrefwithname)
      * [`obj spec.forProvider.topicIdRef.policy`](#obj-specforprovidertopicidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidertopicidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidertopicidrefpolicywithresolve)
    * [`obj spec.forProvider.topicIdSelector`](#obj-specforprovidertopicidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidertopicidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidertopicidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidertopicidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.topicIdSelector.policy`](#obj-specforprovidertopicidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidertopicidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidertopicidselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAutoDeleteOnIdle(autoDeleteOnIdle)`](#fn-specinitproviderwithautodeleteonidle)
    * [`fn withClientScopedSubscription(clientScopedSubscription)`](#fn-specinitproviderwithclientscopedsubscription)
    * [`fn withClientScopedSubscriptionEnabled(clientScopedSubscriptionEnabled)`](#fn-specinitproviderwithclientscopedsubscriptionenabled)
    * [`fn withClientScopedSubscriptionMixin(clientScopedSubscription)`](#fn-specinitproviderwithclientscopedsubscriptionmixin)
    * [`fn withDeadLetteringOnFilterEvaluationError(deadLetteringOnFilterEvaluationError)`](#fn-specinitproviderwithdeadletteringonfilterevaluationerror)
    ...
    * [`obj spec.initProvider.clientScopedSubscription`](#obj-specinitproviderclientscopedsubscription)
      * [`fn withClientId(clientId)`](#fn-specinitproviderclientscopedsubscriptionwithclientid)
      * [`fn withIsClientScopedSubscriptionShareable(isClientScopedSubscriptionShareable)`](#fn-specinitproviderclientscopedsubscriptionwithisclientscopedsubscriptionshareable)
...
### fn spec.forProvider.withClientScopedSubscription

```ts
withClientScopedSubscription(clientScopedSubscription)
```

"A client_scoped_subscription block as defined below."

### fn spec.forProvider.withClientScopedSubscriptionEnabled

```ts
withClientScopedSubscriptionEnabled(clientScopedSubscriptionEnabled)
```

"whether the subscription is scoped to a client id. Defaults to false."

### fn spec.forProvider.withClientScopedSubscriptionMixin

```ts
withClientScopedSubscriptionMixin(clientScopedSubscription)
```
...
### fn spec.forProvider.withDeadLetteringOnFilterEvaluationError

```ts
withDeadLetteringOnFilterEvaluationError(deadLetteringOnFilterEvaluationError)
```
...
## obj spec.forProvider.clientScopedSubscription

"A client_scoped_subscription block as defined below."

### fn spec.forProvider.clientScopedSubscription.withClientId
...
### fn spec.forProvider.clientScopedSubscription.withIsClientScopedSubscriptionShareable

```ts
withIsClientScopedSubscriptionShareable(isClientScopedSubscriptionShareable)
```

"Whether the client scoped subscription is shareable. Defaults to true Changing this forces a new resource to be created."

## obj spec.forProvider.topicIdRef

"Reference to a Topic in servicebus to populate topicId."

### fn spec.forProvider.topicIdRef.withName
...
## obj spec.forProvider.topicIdRef.policy

"Policies for referencing."

### fn spec.forProvider.topicIdRef.policy.withResolution
...
### fn spec.forProvider.topicIdRef.policy.withResolve
...
## obj spec.forProvider.topicIdSelector

"Selector for a Topic in servicebus to populate topicId."

### fn spec.forProvider.topicIdSelector.withMatchControllerRef
...
### fn spec.forProvider.topicIdSelector.withMatchLabels
...
### fn spec.forProvider.topicIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.topicIdSelector.policy

"Policies for selection."

### fn spec.forProvider.topicIdSelector.policy.withResolution
...
### fn spec.forProvider.topicIdSelector.policy.withResolve
...
### fn spec.initProvider.withClientScopedSubscription
...
### fn spec.initProvider.withClientScopedSubscriptionEnabled
...
### fn spec.initProvider.withClientScopedSubscriptionMixin
...
### fn spec.initProvider.withDeadLetteringOnFilterEvaluationError
...
## obj spec.initProvider.clientScopedSubscription

"A client_scoped_subscription block as defined below."

### fn spec.initProvider.clientScopedSubscription.withClientId
...
### fn spec.initProvider.clientScopedSubscription.withIsClientScopedSubscriptionShareable
