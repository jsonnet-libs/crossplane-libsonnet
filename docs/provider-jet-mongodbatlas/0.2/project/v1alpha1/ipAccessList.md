---
permalink: /provider-jet-mongodbatlas/0.2/project/v1alpha1/ipAccessList/
---

# project.v1alpha1.ipAccessList
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAwsSecurityGroup(awsSecurityGroup)`](#fn-specforproviderwithawssecuritygroup)
...
new returns an instance of IPAccessList
...
### fn spec.forProvider.withAwsSecurityGroup

```ts
withAwsSecurityGroup(awsSecurityGroup)
```
