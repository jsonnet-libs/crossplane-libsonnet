---
permalink: /provider-jet-mongodbatlas/0.2/custom/v1alpha1/dnsConfigurationClusterAws/
---

# custom.v1alpha1.dnsConfigurationClusterAws
...
new returns an instance of DNSConfigurationClusterAws
