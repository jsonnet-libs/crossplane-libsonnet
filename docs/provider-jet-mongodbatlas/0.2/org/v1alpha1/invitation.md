---
permalink: /provider-jet-mongodbatlas/0.2/org/v1alpha1/invitation/
---

# org.v1alpha1.invitation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withTeamsIds(teamsIds)`](#fn-specforproviderwithteamsids)
    * [`fn withTeamsIdsMixin(teamsIds)`](#fn-specforproviderwithteamsidsmixin)
...
### fn spec.forProvider.withTeamsIds

```ts
withTeamsIds(teamsIds)
```



### fn spec.forProvider.withTeamsIdsMixin

```ts
withTeamsIdsMixin(teamsIds)
```
