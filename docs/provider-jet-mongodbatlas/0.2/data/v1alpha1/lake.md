---
permalink: /provider-jet-mongodbatlas/0.2/data/v1alpha1/lake/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withDataProcessRegion(dataProcessRegion)`](#fn-specforproviderwithdataprocessregion)
    * [`fn withDataProcessRegionMixin(dataProcessRegion)`](#fn-specforproviderwithdataprocessregionmixin)
    * [`fn withName(name)`](#fn-specforproviderwithname)
    * [`fn withProjectId(projectId)`](#fn-specforproviderwithprojectid)
    * [`obj spec.forProvider.aws`](#obj-specforprovideraws)
      * [`fn withRoleId(roleId)`](#fn-specforproviderawswithroleid)
      * [`fn withTestS3Bucket(testS3Bucket)`](#fn-specforproviderawswithtests3bucket)
    * [`obj spec.forProvider.dataProcessRegion`](#obj-specforproviderdataprocessregion)
      * [`fn withCloudProvider(cloudProvider)`](#fn-specforproviderdataprocessregionwithcloudprovider)
      * [`fn withRegion(region)`](#fn-specforproviderdataprocessregionwithregion)
...
new returns an instance of Lake
...
### fn spec.forProvider.withDataProcessRegion

```ts
withDataProcessRegion(dataProcessRegion)
```



### fn spec.forProvider.withDataProcessRegionMixin

```ts
withDataProcessRegionMixin(dataProcessRegion)
```
...
### fn spec.forProvider.aws.withRoleId
...
### fn spec.forProvider.aws.withTestS3Bucket

```ts
withTestS3Bucket(testS3Bucket)
```



## obj spec.forProvider.dataProcessRegion



### fn spec.forProvider.dataProcessRegion.withCloudProvider
...
### fn spec.forProvider.dataProcessRegion.withRegion
