---
permalink: /provider-jet-mongodbatlas/0.2/online/v1alpha1/archive/
---

# online.v1alpha1.archive
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withCollName(collName)`](#fn-specforproviderwithcollname)
    ...
    * [`fn withPartitionFields(partitionFields)`](#fn-specforproviderwithpartitionfields)
    * [`fn withPartitionFieldsMixin(partitionFields)`](#fn-specforproviderwithpartitionfieldsmixin)
    * [`fn withPaused(paused)`](#fn-specforproviderwithpaused)
    * [`fn withProjectId(projectId)`](#fn-specforproviderwithprojectid)
    * [`fn withSyncCreation(syncCreation)`](#fn-specforproviderwithsynccreation)
    * [`obj spec.forProvider.criteria`](#obj-specforprovidercriteria)
      * [`fn withDateField(dateField)`](#fn-specforprovidercriteriawithdatefield)
      * [`fn withDateFormat(dateFormat)`](#fn-specforprovidercriteriawithdateformat)
      * [`fn withExpireAfterDays(expireAfterDays)`](#fn-specforprovidercriteriawithexpireafterdays)
      * [`fn withQuery(query)`](#fn-specforprovidercriteriawithquery)
      * [`fn withType(type)`](#fn-specforprovidercriteriawithtype)
    * [`obj spec.forProvider.partitionFields`](#obj-specforproviderpartitionfields)
      * [`fn withFieldName(fieldName)`](#fn-specforproviderpartitionfieldswithfieldname)
      * [`fn withOrder(order)`](#fn-specforproviderpartitionfieldswithorder)
...
### fn spec.forProvider.withCollName

```ts
withCollName(collName)
```
...
### fn spec.forProvider.withPartitionFields

```ts
withPartitionFields(partitionFields)
```



### fn spec.forProvider.withPartitionFieldsMixin

```ts
withPartitionFieldsMixin(partitionFields)
```
...
### fn spec.forProvider.withSyncCreation

```ts
withSyncCreation(syncCreation)
```
...
### fn spec.forProvider.criteria.withDateField
...
### fn spec.forProvider.criteria.withDateFormat
...
### fn spec.forProvider.criteria.withExpireAfterDays

```ts
withExpireAfterDays(expireAfterDays)
```
...
### fn spec.forProvider.criteria.withType
...
## obj spec.forProvider.partitionFields



### fn spec.forProvider.partitionFields.withFieldName
...
### fn spec.forProvider.partitionFields.withOrder
