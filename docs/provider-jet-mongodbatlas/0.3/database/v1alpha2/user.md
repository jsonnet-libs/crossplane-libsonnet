---
permalink: /provider-jet-mongodbatlas/0.3/database/v1alpha2/user/
---

# database.v1alpha2.user
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAuthDatabaseName(authDatabaseName)`](#fn-specforproviderwithauthdatabasename)
    * [`fn withAwsIamType(awsIamType)`](#fn-specforproviderwithawsiamtype)
    * [`fn withDatabaseName(databaseName)`](#fn-specforproviderwithdatabasename)
    * [`fn withLabels(labels)`](#fn-specforproviderwithlabels)
    * [`fn withLabelsMixin(labels)`](#fn-specforproviderwithlabelsmixin)
    * [`fn withLdapAuthType(ldapAuthType)`](#fn-specforproviderwithldapauthtype)
...
### fn spec.forProvider.withAuthDatabaseName

```ts
withAuthDatabaseName(authDatabaseName)
```



### fn spec.forProvider.withAwsIamType

```ts
withAwsIamType(awsIamType)
```
...
### fn spec.forProvider.withLdapAuthType

```ts
withLdapAuthType(ldapAuthType)
```
...
### fn spec.forProvider.withX509Type

```ts
withX509Type(x509Type)
```
