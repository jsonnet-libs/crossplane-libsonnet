---
permalink: /provider-jet-mongodbatlas/0.3/
---

# crossplane_jet_mongodbatlas

```jsonnet
local crossplane_jet_mongodbatlas = import "github.com/jsonnet-libs/crossplane-libsonnet/provider-jet-mongodbatlas/0.3/main.libsonnet"
```
