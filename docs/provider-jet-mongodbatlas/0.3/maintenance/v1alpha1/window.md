---
permalink: /provider-jet-mongodbatlas/0.3/maintenance/v1alpha1/window/
---

# maintenance.v1alpha1.window
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAutoDefer(autoDefer)`](#fn-specforproviderwithautodefer)
    * [`fn withAutoDeferOnceEnabled(autoDeferOnceEnabled)`](#fn-specforproviderwithautodeferonceenabled)
    * [`fn withDayOfWeek(dayOfWeek)`](#fn-specforproviderwithdayofweek)
    * [`fn withDefer(defer)`](#fn-specforproviderwithdefer)
    * [`fn withHourOfDay(hourOfDay)`](#fn-specforproviderwithhourofday)
    * [`fn withNumberOfDeferrals(numberOfDeferrals)`](#fn-specforproviderwithnumberofdeferrals)
...
### fn spec.forProvider.withAutoDefer

```ts
withAutoDefer(autoDefer)
```



### fn spec.forProvider.withAutoDeferOnceEnabled

```ts
withAutoDeferOnceEnabled(autoDeferOnceEnabled)
```



### fn spec.forProvider.withDayOfWeek
...
### fn spec.forProvider.withHourOfDay
...
### fn spec.forProvider.withNumberOfDeferrals

```ts
withNumberOfDeferrals(numberOfDeferrals)
```
