---
permalink: /provider-jet-mongodbatlas/0.3/custom/v1alpha1/dbRole/
---

# custom.v1alpha1.dbRole
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withInheritedRoles(inheritedRoles)`](#fn-specforproviderwithinheritedroles)
...
new returns an instance of DBRole
...
### fn spec.forProvider.withInheritedRoles

```ts
withInheritedRoles(inheritedRoles)
```



### fn spec.forProvider.withInheritedRolesMixin

```ts
withInheritedRolesMixin(inheritedRoles)
```
