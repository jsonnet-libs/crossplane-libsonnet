---
permalink: /provider-jet-mongodbatlas/0.3/mongodbatlas/v1alpha1/auditing/
---

# mongodbatlas.v1alpha1.auditing
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAuditAuthorizationSuccess(auditAuthorizationSuccess)`](#fn-specforproviderwithauditauthorizationsuccess)
    * [`fn withAuditFilter(auditFilter)`](#fn-specforproviderwithauditfilter)
...
new returns an instance of Auditing
...
### fn spec.forProvider.withAuditAuthorizationSuccess

```ts
withAuditAuthorizationSuccess(auditAuthorizationSuccess)
```



### fn spec.forProvider.withAuditFilter

```ts
withAuditFilter(auditFilter)
```
