---
permalink: /provider-grafana/0.1/grafana/v1alpha1/alertNotification/
---

# grafana.v1alpha1.alertNotification
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withDisableResolveMessage(disableResolveMessage)`](#fn-specforproviderwithdisableresolvemessage)
    ...
    * [`fn withSecureSettingsSecretRef(secureSettingsSecretRef)`](#fn-specforproviderwithsecuresettingssecretref)
    * [`fn withSecureSettingsSecretRefMixin(secureSettingsSecretRef)`](#fn-specforproviderwithsecuresettingssecretrefmixin)
    * [`fn withSendReminder(sendReminder)`](#fn-specforproviderwithsendreminder)
...
new returns an instance of AlertNotification
...
### fn spec.forProvider.withDisableResolveMessage
...
### fn spec.forProvider.withSecureSettingsSecretRef

```ts
withSecureSettingsSecretRef(secureSettingsSecretRef)
```
...
### fn spec.forProvider.withSecureSettingsSecretRefMixin

```ts
withSecureSettingsSecretRefMixin(secureSettingsSecretRef)
```
...
### fn spec.forProvider.withSendReminder
