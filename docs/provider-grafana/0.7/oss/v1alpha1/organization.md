---
permalink: /provider-grafana/0.7/oss/v1alpha1/organization/
---
...
"The login name of the configured default admin user for the Grafana installation. If unset, this value defaults to admin, the Grafana default. Defaults to `admin`."
