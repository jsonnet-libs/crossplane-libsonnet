---
permalink: /provider-jet-gcp/0.2/cloudplatform/v1alpha1/serviceAccountIAMPolicy/
---

# cloudplatform.v1alpha1.serviceAccountIAMPolicy
...
new returns an instance of ServiceAccountIAMPolicy
