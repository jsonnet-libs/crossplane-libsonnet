---
permalink: /provider-jet-gcp/0.2/cloudidentity/v1alpha1/groupMembership/
---

# cloudidentity.v1alpha1.groupMembership
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withPreferredMemberKey(preferredMemberKey)`](#fn-specforproviderwithpreferredmemberkey)
...
### fn spec.forProvider.withPreferredMemberKey

```ts
withPreferredMemberKey(preferredMemberKey)
```

"EntityKey of the member."

### fn spec.forProvider.withPreferredMemberKeyMixin

```ts
withPreferredMemberKeyMixin(preferredMemberKey)
```
