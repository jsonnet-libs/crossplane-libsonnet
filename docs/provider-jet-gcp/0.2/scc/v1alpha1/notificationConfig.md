---
permalink: /provider-jet-gcp/0.2/scc/v1alpha1/notificationConfig/
---

# scc.v1alpha1.notificationConfig
...
new returns an instance of NotificationConfig
...
### fn spec.forProvider.withPubsubTopic
...
### fn spec.forProvider.withStreamingConfig

```ts
withStreamingConfig(streamingConfig)
```

"The config for triggering streaming-based notifications."

### fn spec.forProvider.withStreamingConfigMixin

```ts
withStreamingConfigMixin(streamingConfig)
```
