---
permalink: /provider-jet-gcp/0.2/logging/v1alpha1/billingAccountBucketConfig/
---

# logging.v1alpha1.billingAccountBucketConfig
...
new returns an instance of BillingAccountBucketConfig
