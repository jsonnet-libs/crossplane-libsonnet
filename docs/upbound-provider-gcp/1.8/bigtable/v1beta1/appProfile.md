---
permalink: /upbound-provider-gcp/1.8/bigtable/v1beta1/appProfile/
---

# bigtable.v1beta1.appProfile
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withDataBoostIsolationReadOnly(dataBoostIsolationReadOnly)`](#fn-specforproviderwithdataboostisolationreadonly)
    * [`fn withDataBoostIsolationReadOnlyMixin(dataBoostIsolationReadOnly)`](#fn-specforproviderwithdataboostisolationreadonlymixin)
    ...
    * [`fn withStandardIsolation(standardIsolation)`](#fn-specforproviderwithstandardisolation)
    * [`fn withStandardIsolationMixin(standardIsolation)`](#fn-specforproviderwithstandardisolationmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withDataBoostIsolationReadOnly(dataBoostIsolationReadOnly)`](#fn-specinitproviderwithdataboostisolationreadonly)
    * [`fn withDataBoostIsolationReadOnlyMixin(dataBoostIsolationReadOnly)`](#fn-specinitproviderwithdataboostisolationreadonlymixin)
    ...
    * [`fn withSingleClusterRouting(singleClusterRouting)`](#fn-specinitproviderwithsingleclusterrouting)
    * [`fn withSingleClusterRoutingMixin(singleClusterRouting)`](#fn-specinitproviderwithsingleclusterroutingmixin)
    * [`fn withStandardIsolation(standardIsolation)`](#fn-specinitproviderwithstandardisolation)
    * [`fn withStandardIsolationMixin(standardIsolation)`](#fn-specinitproviderwithstandardisolationmixin)
...
### fn spec.forProvider.withDataBoostIsolationReadOnly

```ts
withDataBoostIsolationReadOnly(dataBoostIsolationReadOnly)
```

"Specifies that this app profile is intended for read-only usage via the Data Boost feature.\nStructure is documented below."

### fn spec.forProvider.withDataBoostIsolationReadOnlyMixin

```ts
withDataBoostIsolationReadOnlyMixin(dataBoostIsolationReadOnly)
```
...
### fn spec.forProvider.withSingleClusterRouting

```ts
withSingleClusterRouting(singleClusterRouting)
```

"Use a single-cluster routing policy.\nStructure is documented below."

### fn spec.forProvider.withSingleClusterRoutingMixin

```ts
withSingleClusterRoutingMixin(singleClusterRouting)
```
...
### fn spec.forProvider.withStandardIsolation

```ts
withStandardIsolation(standardIsolation)
```

"The standard options used for isolating this app profile's traffic from other use cases.\nStructure is documented below."

### fn spec.forProvider.withStandardIsolationMixin

```ts
withStandardIsolationMixin(standardIsolation)
```
...
### fn spec.initProvider.withDataBoostIsolationReadOnly
...
### fn spec.initProvider.withDataBoostIsolationReadOnlyMixin
...
### fn spec.initProvider.withSingleClusterRouting
...
### fn spec.initProvider.withSingleClusterRoutingMixin
...
### fn spec.initProvider.withStandardIsolation
...
### fn spec.initProvider.withStandardIsolationMixin
