---
permalink: /upbound-provider-gcp/1.8/privateca/v1beta1/certificateTemplate/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withMaximumLifetime(maximumLifetime)`](#fn-specforproviderwithmaximumlifetime)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withIdentityConstraints(identityConstraints)`](#fn-specinitproviderwithidentityconstraints)
    * [`fn withIdentityConstraintsMixin(identityConstraints)`](#fn-specinitproviderwithidentityconstraintsmixin)
    * [`fn withLabels(labels)`](#fn-specinitproviderwithlabels)
    * [`fn withLabelsMixin(labels)`](#fn-specinitproviderwithlabelsmixin)
    * [`fn withMaximumLifetime(maximumLifetime)`](#fn-specinitproviderwithmaximumlifetime)
    * [`fn withPassthroughExtensions(passthroughExtensions)`](#fn-specinitproviderwithpassthroughextensions)
    * [`fn withPassthroughExtensionsMixin(passthroughExtensions)`](#fn-specinitproviderwithpassthroughextensionsmixin)
    * [`fn withPredefinedValues(predefinedValues)`](#fn-specinitproviderwithpredefinedvalues)
    * [`fn withPredefinedValuesMixin(predefinedValues)`](#fn-specinitproviderwithpredefinedvaluesmixin)
    * [`fn withProject(project)`](#fn-specinitproviderwithproject)
    * [`obj spec.initProvider.identityConstraints`](#obj-specinitprovideridentityconstraints)
      * [`fn withAllowSubjectAltNamesPassthrough(allowSubjectAltNamesPassthrough)`](#fn-specinitprovideridentityconstraintswithallowsubjectaltnamespassthrough)
      * [`fn withAllowSubjectPassthrough(allowSubjectPassthrough)`](#fn-specinitprovideridentityconstraintswithallowsubjectpassthrough)
      * [`fn withCelExpression(celExpression)`](#fn-specinitprovideridentityconstraintswithcelexpression)
      * [`fn withCelExpressionMixin(celExpression)`](#fn-specinitprovideridentityconstraintswithcelexpressionmixin)
      * [`obj spec.initProvider.identityConstraints.celExpression`](#obj-specinitprovideridentityconstraintscelexpression)
        * [`fn withDescription(description)`](#fn-specinitprovideridentityconstraintscelexpressionwithdescription)
        * [`fn withExpression(expression)`](#fn-specinitprovideridentityconstraintscelexpressionwithexpression)
        * [`fn withTitle(title)`](#fn-specinitprovideridentityconstraintscelexpressionwithtitle)
    * [`obj spec.initProvider.passthroughExtensions`](#obj-specinitproviderpassthroughextensions)
      * [`fn withAdditionalExtensions(additionalExtensions)`](#fn-specinitproviderpassthroughextensionswithadditionalextensions)
      * [`fn withAdditionalExtensionsMixin(additionalExtensions)`](#fn-specinitproviderpassthroughextensionswithadditionalextensionsmixin)
      * [`fn withKnownExtensions(knownExtensions)`](#fn-specinitproviderpassthroughextensionswithknownextensions)
      * [`fn withKnownExtensionsMixin(knownExtensions)`](#fn-specinitproviderpassthroughextensionswithknownextensionsmixin)
      * [`obj spec.initProvider.passthroughExtensions.additionalExtensions`](#obj-specinitproviderpassthroughextensionsadditionalextensions)
        * [`fn withObjectIdPath(objectIdPath)`](#fn-specinitproviderpassthroughextensionsadditionalextensionswithobjectidpath)
        * [`fn withObjectIdPathMixin(objectIdPath)`](#fn-specinitproviderpassthroughextensionsadditionalextensionswithobjectidpathmixin)
    * [`obj spec.initProvider.predefinedValues`](#obj-specinitproviderpredefinedvalues)
      * [`fn withAdditionalExtensions(additionalExtensions)`](#fn-specinitproviderpredefinedvalueswithadditionalextensions)
      * [`fn withAdditionalExtensionsMixin(additionalExtensions)`](#fn-specinitproviderpredefinedvalueswithadditionalextensionsmixin)
      * [`fn withAiaOcspServers(aiaOcspServers)`](#fn-specinitproviderpredefinedvalueswithaiaocspservers)
      * [`fn withAiaOcspServersMixin(aiaOcspServers)`](#fn-specinitproviderpredefinedvalueswithaiaocspserversmixin)
      * [`fn withCaOptions(caOptions)`](#fn-specinitproviderpredefinedvalueswithcaoptions)
      * [`fn withCaOptionsMixin(caOptions)`](#fn-specinitproviderpredefinedvalueswithcaoptionsmixin)
      * [`fn withKeyUsage(keyUsage)`](#fn-specinitproviderpredefinedvalueswithkeyusage)
      * [`fn withKeyUsageMixin(keyUsage)`](#fn-specinitproviderpredefinedvalueswithkeyusagemixin)
      * [`fn withPolicyIds(policyIds)`](#fn-specinitproviderpredefinedvalueswithpolicyids)
      * [`fn withPolicyIdsMixin(policyIds)`](#fn-specinitproviderpredefinedvalueswithpolicyidsmixin)
      * [`obj spec.initProvider.predefinedValues.additionalExtensions`](#obj-specinitproviderpredefinedvaluesadditionalextensions)
        * [`fn withCritical(critical)`](#fn-specinitproviderpredefinedvaluesadditionalextensionswithcritical)
        * [`fn withObjectId(objectId)`](#fn-specinitproviderpredefinedvaluesadditionalextensionswithobjectid)
        * [`fn withObjectIdMixin(objectId)`](#fn-specinitproviderpredefinedvaluesadditionalextensionswithobjectidmixin)
        * [`fn withValue(value)`](#fn-specinitproviderpredefinedvaluesadditionalextensionswithvalue)
        * [`obj spec.initProvider.predefinedValues.additionalExtensions.objectId`](#obj-specinitproviderpredefinedvaluesadditionalextensionsobjectid)
          * [`fn withObjectIdPath(objectIdPath)`](#fn-specinitproviderpredefinedvaluesadditionalextensionsobjectidwithobjectidpath)
          * [`fn withObjectIdPathMixin(objectIdPath)`](#fn-specinitproviderpredefinedvaluesadditionalextensionsobjectidwithobjectidpathmixin)
      * [`obj spec.initProvider.predefinedValues.caOptions`](#obj-specinitproviderpredefinedvaluescaoptions)
        * [`fn withIsCa(isCa)`](#fn-specinitproviderpredefinedvaluescaoptionswithisca)
        * [`fn withMaxIssuerPathLength(maxIssuerPathLength)`](#fn-specinitproviderpredefinedvaluescaoptionswithmaxissuerpathlength)
      * [`obj spec.initProvider.predefinedValues.keyUsage`](#obj-specinitproviderpredefinedvalueskeyusage)
        * [`fn withBaseKeyUsage(baseKeyUsage)`](#fn-specinitproviderpredefinedvalueskeyusagewithbasekeyusage)
        * [`fn withBaseKeyUsageMixin(baseKeyUsage)`](#fn-specinitproviderpredefinedvalueskeyusagewithbasekeyusagemixin)
        * [`fn withExtendedKeyUsage(extendedKeyUsage)`](#fn-specinitproviderpredefinedvalueskeyusagewithextendedkeyusage)
        * [`fn withExtendedKeyUsageMixin(extendedKeyUsage)`](#fn-specinitproviderpredefinedvalueskeyusagewithextendedkeyusagemixin)
        * [`fn withUnknownExtendedKeyUsages(unknownExtendedKeyUsages)`](#fn-specinitproviderpredefinedvalueskeyusagewithunknownextendedkeyusages)
        * [`fn withUnknownExtendedKeyUsagesMixin(unknownExtendedKeyUsages)`](#fn-specinitproviderpredefinedvalueskeyusagewithunknownextendedkeyusagesmixin)
        * [`obj spec.initProvider.predefinedValues.keyUsage.baseKeyUsage`](#obj-specinitproviderpredefinedvalueskeyusagebasekeyusage)
          * [`fn withCertSign(certSign)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithcertsign)
          * [`fn withContentCommitment(contentCommitment)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithcontentcommitment)
          * [`fn withCrlSign(crlSign)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithcrlsign)
          * [`fn withDataEncipherment(dataEncipherment)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithdataencipherment)
          * [`fn withDecipherOnly(decipherOnly)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithdecipheronly)
          * [`fn withDigitalSignature(digitalSignature)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithdigitalsignature)
          * [`fn withEncipherOnly(encipherOnly)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithencipheronly)
          * [`fn withKeyAgreement(keyAgreement)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithkeyagreement)
          * [`fn withKeyEncipherment(keyEncipherment)`](#fn-specinitproviderpredefinedvalueskeyusagebasekeyusagewithkeyencipherment)
        * [`obj spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage`](#obj-specinitproviderpredefinedvalueskeyusageextendedkeyusage)
          * [`fn withClientAuth(clientAuth)`](#fn-specinitproviderpredefinedvalueskeyusageextendedkeyusagewithclientauth)
          * [`fn withCodeSigning(codeSigning)`](#fn-specinitproviderpredefinedvalueskeyusageextendedkeyusagewithcodesigning)
          * [`fn withEmailProtection(emailProtection)`](#fn-specinitproviderpredefinedvalueskeyusageextendedkeyusagewithemailprotection)
          * [`fn withOcspSigning(ocspSigning)`](#fn-specinitproviderpredefinedvalueskeyusageextendedkeyusagewithocspsigning)
          * [`fn withServerAuth(serverAuth)`](#fn-specinitproviderpredefinedvalueskeyusageextendedkeyusagewithserverauth)
          * [`fn withTimeStamping(timeStamping)`](#fn-specinitproviderpredefinedvalueskeyusageextendedkeyusagewithtimestamping)
        * [`obj spec.initProvider.predefinedValues.keyUsage.unknownExtendedKeyUsages`](#obj-specinitproviderpredefinedvalueskeyusageunknownextendedkeyusages)
          * [`fn withObjectIdPath(objectIdPath)`](#fn-specinitproviderpredefinedvalueskeyusageunknownextendedkeyusageswithobjectidpath)
          * [`fn withObjectIdPathMixin(objectIdPath)`](#fn-specinitproviderpredefinedvalueskeyusageunknownextendedkeyusageswithobjectidpathmixin)
      * [`obj spec.initProvider.predefinedValues.policyIds`](#obj-specinitproviderpredefinedvaluespolicyids)
        * [`fn withObjectIdPath(objectIdPath)`](#fn-specinitproviderpredefinedvaluespolicyidswithobjectidpath)
        * [`fn withObjectIdPathMixin(objectIdPath)`](#fn-specinitproviderpredefinedvaluespolicyidswithobjectidpathmixin)
...
### fn spec.forProvider.withMaximumLifetime
...
### fn spec.initProvider.withIdentityConstraints
...
### fn spec.initProvider.withIdentityConstraintsMixin
...
### fn spec.initProvider.withMaximumLifetime
...
### fn spec.initProvider.withPassthroughExtensions
...
### fn spec.initProvider.withPassthroughExtensionsMixin
...
### fn spec.initProvider.withPredefinedValues
...
### fn spec.initProvider.withPredefinedValuesMixin
...
## obj spec.initProvider.identityConstraints

"Optional. Describes constraints on identities that may be appear in Certificates issued using this template. If this is omitted, then this template will not add restrictions on a certificate's identity."

### fn spec.initProvider.identityConstraints.withAllowSubjectAltNamesPassthrough
...
### fn spec.initProvider.identityConstraints.withAllowSubjectPassthrough
...
### fn spec.initProvider.identityConstraints.withCelExpression
...
### fn spec.initProvider.identityConstraints.withCelExpressionMixin
...
## obj spec.initProvider.identityConstraints.celExpression

"Optional. A CEL expression that may be used to validate the resolved X.509 Subject and/or Subject Alternative Name before a certificate is signed. To see the full allowed syntax and some examples, see https://cloud.google.com/certificate-authority-service/docs/using-cel"

### fn spec.initProvider.identityConstraints.celExpression.withDescription
...
### fn spec.initProvider.identityConstraints.celExpression.withExpression
...
### fn spec.initProvider.identityConstraints.celExpression.withTitle
...
## obj spec.initProvider.passthroughExtensions

"Optional. Describes the set of X.509 extensions that may appear in a Certificate issued using this CertificateTemplate. If a certificate request sets extensions that don't appear in the passthrough_extensions, those extensions will be dropped. If the issuing CaPool's IssuancePolicy defines baseline_values that don't appear here, the certificate issuance request will fail. If this is omitted, then this template will not add restrictions on a certificate's X.509 extensions. These constraints do not apply to X.509 extensions set in this CertificateTemplate's predefined_values."

### fn spec.initProvider.passthroughExtensions.withAdditionalExtensions
...
### fn spec.initProvider.passthroughExtensions.withAdditionalExtensionsMixin
...
### fn spec.initProvider.passthroughExtensions.withKnownExtensions
...
### fn spec.initProvider.passthroughExtensions.withKnownExtensionsMixin
...
## obj spec.initProvider.passthroughExtensions.additionalExtensions

"Optional. A set of ObjectIds identifying custom X.509 extensions. Will be combined with known_extensions to determine the full set of X.509 extensions."

### fn spec.initProvider.passthroughExtensions.additionalExtensions.withObjectIdPath
...
### fn spec.initProvider.passthroughExtensions.additionalExtensions.withObjectIdPathMixin
...
## obj spec.initProvider.predefinedValues

"Optional. A set of X.509 values that will be applied to all issued certificates that use this template. If the certificate request includes conflicting values for the same properties, they will be overwritten by the values defined here. If the issuing CaPool's IssuancePolicy defines conflicting baseline_values for the same properties, the certificate issuance request will fail."

### fn spec.initProvider.predefinedValues.withAdditionalExtensions
...
### fn spec.initProvider.predefinedValues.withAdditionalExtensionsMixin
...
### fn spec.initProvider.predefinedValues.withAiaOcspServers
...
### fn spec.initProvider.predefinedValues.withAiaOcspServersMixin
...
### fn spec.initProvider.predefinedValues.withCaOptions
...
### fn spec.initProvider.predefinedValues.withCaOptionsMixin
...
### fn spec.initProvider.predefinedValues.withKeyUsage
...
### fn spec.initProvider.predefinedValues.withKeyUsageMixin
...
### fn spec.initProvider.predefinedValues.withPolicyIds
...
### fn spec.initProvider.predefinedValues.withPolicyIdsMixin
...
## obj spec.initProvider.predefinedValues.additionalExtensions

"Optional. Describes custom X.509 extensions."

### fn spec.initProvider.predefinedValues.additionalExtensions.withCritical
...
### fn spec.initProvider.predefinedValues.additionalExtensions.withObjectId
...
### fn spec.initProvider.predefinedValues.additionalExtensions.withObjectIdMixin
...
### fn spec.initProvider.predefinedValues.additionalExtensions.withValue
...
## obj spec.initProvider.predefinedValues.additionalExtensions.objectId

"Required. The OID for this X.509 extension."

### fn spec.initProvider.predefinedValues.additionalExtensions.objectId.withObjectIdPath
...
### fn spec.initProvider.predefinedValues.additionalExtensions.objectId.withObjectIdPathMixin
...
## obj spec.initProvider.predefinedValues.caOptions

"Optional. Describes options in this X509Parameters that are relevant in a CA certificate."

### fn spec.initProvider.predefinedValues.caOptions.withIsCa
...
### fn spec.initProvider.predefinedValues.caOptions.withMaxIssuerPathLength
...
## obj spec.initProvider.predefinedValues.keyUsage

"Optional. Indicates the intended use for keys that correspond to a certificate."

### fn spec.initProvider.predefinedValues.keyUsage.withBaseKeyUsage
...
### fn spec.initProvider.predefinedValues.keyUsage.withBaseKeyUsageMixin
...
### fn spec.initProvider.predefinedValues.keyUsage.withExtendedKeyUsage
...
### fn spec.initProvider.predefinedValues.keyUsage.withExtendedKeyUsageMixin
...
### fn spec.initProvider.predefinedValues.keyUsage.withUnknownExtendedKeyUsages
...
### fn spec.initProvider.predefinedValues.keyUsage.withUnknownExtendedKeyUsagesMixin
...
## obj spec.initProvider.predefinedValues.keyUsage.baseKeyUsage

"Describes high-level ways in which a key may be used."

### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withCertSign
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withContentCommitment
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withCrlSign
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withDataEncipherment
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withDecipherOnly
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withDigitalSignature
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withEncipherOnly
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withKeyAgreement
...
### fn spec.initProvider.predefinedValues.keyUsage.baseKeyUsage.withKeyEncipherment
...
## obj spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage

"Detailed scenarios in which a key may be used."

### fn spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage.withClientAuth
...
### fn spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage.withCodeSigning
...
### fn spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage.withEmailProtection
...
### fn spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage.withOcspSigning
...
### fn spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage.withServerAuth
...
### fn spec.initProvider.predefinedValues.keyUsage.extendedKeyUsage.withTimeStamping
...
## obj spec.initProvider.predefinedValues.keyUsage.unknownExtendedKeyUsages

"Used to describe extended key usages that are not listed in the KeyUsage.ExtendedKeyUsageOptions message."

### fn spec.initProvider.predefinedValues.keyUsage.unknownExtendedKeyUsages.withObjectIdPath
...
### fn spec.initProvider.predefinedValues.keyUsage.unknownExtendedKeyUsages.withObjectIdPathMixin
...
## obj spec.initProvider.predefinedValues.policyIds

"Optional. Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4."

### fn spec.initProvider.predefinedValues.policyIds.withObjectIdPath
...
### fn spec.initProvider.predefinedValues.policyIds.withObjectIdPathMixin
