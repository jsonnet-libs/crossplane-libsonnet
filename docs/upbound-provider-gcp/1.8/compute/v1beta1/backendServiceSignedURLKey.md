---
permalink: /upbound-provider-gcp/1.8/compute/v1beta1/backendServiceSignedURLKey/
---

# compute.v1beta1.backendServiceSignedURLKey
...
new returns an instance of BackendServiceSignedURLKey
