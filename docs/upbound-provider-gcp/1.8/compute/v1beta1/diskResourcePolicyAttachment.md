---
permalink: /upbound-provider-gcp/1.8/compute/v1beta1/diskResourcePolicyAttachment/
---

# compute.v1beta1.diskResourcePolicyAttachment
...
new returns an instance of DiskResourcePolicyAttachment
