---
permalink: /upbound-provider-gcp/1.8/compute/v1beta1/routerInterface/
---

# compute.v1beta1.routerInterface
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withInterconnectAttachment(interconnectAttachment)`](#fn-specforproviderwithinterconnectattachment)
    ...
    * [`fn withRedundantInterface(redundantInterface)`](#fn-specforproviderwithredundantinterface)
    * [`fn withRegion(region)`](#fn-specforproviderwithregion)
    * [`fn withRouter(router)`](#fn-specforproviderwithrouter)
    * [`fn withSubnetwork(subnetwork)`](#fn-specforproviderwithsubnetwork)
    * [`fn withVpnTunnel(vpnTunnel)`](#fn-specforproviderwithvpntunnel)
    ...
    * [`obj spec.forProvider.vpnTunnelRef`](#obj-specforprovidervpntunnelref)
      * [`fn withName(name)`](#fn-specforprovidervpntunnelrefwithname)
      * [`obj spec.forProvider.vpnTunnelRef.policy`](#obj-specforprovidervpntunnelrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidervpntunnelrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidervpntunnelrefpolicywithresolve)
    * [`obj spec.forProvider.vpnTunnelSelector`](#obj-specforprovidervpntunnelselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidervpntunnelselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidervpntunnelselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidervpntunnelselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.vpnTunnelSelector.policy`](#obj-specforprovidervpntunnelselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidervpntunnelselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidervpntunnelselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withInterconnectAttachment(interconnectAttachment)`](#fn-specinitproviderwithinterconnectattachment)
    ...
    * [`fn withRedundantInterface(redundantInterface)`](#fn-specinitproviderwithredundantinterface)
    ...
    * [`fn withVpnTunnel(vpnTunnel)`](#fn-specinitproviderwithvpntunnel)
    ...
    * [`obj spec.initProvider.vpnTunnelRef`](#obj-specinitprovidervpntunnelref)
      * [`fn withName(name)`](#fn-specinitprovidervpntunnelrefwithname)
      * [`obj spec.initProvider.vpnTunnelRef.policy`](#obj-specinitprovidervpntunnelrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidervpntunnelrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidervpntunnelrefpolicywithresolve)
    * [`obj spec.initProvider.vpnTunnelSelector`](#obj-specinitprovidervpntunnelselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidervpntunnelselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidervpntunnelselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidervpntunnelselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.vpnTunnelSelector.policy`](#obj-specinitprovidervpntunnelselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidervpntunnelselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidervpntunnelselectorpolicywithresolve)
...
new returns an instance of RouterInterface
...
### fn spec.forProvider.withInterconnectAttachment
...
### fn spec.forProvider.withRedundantInterface

```ts
withRedundantInterface(redundantInterface)
```
...
### fn spec.forProvider.withVpnTunnel

```ts
withVpnTunnel(vpnTunnel)
```
...
## obj spec.forProvider.vpnTunnelRef

"Reference to a VPNTunnel in compute to populate vpnTunnel."

### fn spec.forProvider.vpnTunnelRef.withName
...
## obj spec.forProvider.vpnTunnelRef.policy

"Policies for referencing."

### fn spec.forProvider.vpnTunnelRef.policy.withResolution
...
### fn spec.forProvider.vpnTunnelRef.policy.withResolve
...
## obj spec.forProvider.vpnTunnelSelector

"Selector for a VPNTunnel in compute to populate vpnTunnel."

### fn spec.forProvider.vpnTunnelSelector.withMatchControllerRef
...
### fn spec.forProvider.vpnTunnelSelector.withMatchLabels
...
### fn spec.forProvider.vpnTunnelSelector.withMatchLabelsMixin
...
## obj spec.forProvider.vpnTunnelSelector.policy

"Policies for selection."

### fn spec.forProvider.vpnTunnelSelector.policy.withResolution
...
### fn spec.forProvider.vpnTunnelSelector.policy.withResolve
...
### fn spec.initProvider.withInterconnectAttachment
...
### fn spec.initProvider.withRedundantInterface
...
### fn spec.initProvider.withVpnTunnel
...
## obj spec.initProvider.vpnTunnelRef

"Reference to a VPNTunnel in compute to populate vpnTunnel."

### fn spec.initProvider.vpnTunnelRef.withName
...
## obj spec.initProvider.vpnTunnelRef.policy

"Policies for referencing."

### fn spec.initProvider.vpnTunnelRef.policy.withResolution
...
### fn spec.initProvider.vpnTunnelRef.policy.withResolve
...
## obj spec.initProvider.vpnTunnelSelector

"Selector for a VPNTunnel in compute to populate vpnTunnel."

### fn spec.initProvider.vpnTunnelSelector.withMatchControllerRef
...
### fn spec.initProvider.vpnTunnelSelector.withMatchLabels
...
### fn spec.initProvider.vpnTunnelSelector.withMatchLabelsMixin
...
## obj spec.initProvider.vpnTunnelSelector.policy

"Policies for selection."

### fn spec.initProvider.vpnTunnelSelector.policy.withResolution
...
### fn spec.initProvider.vpnTunnelSelector.policy.withResolve
