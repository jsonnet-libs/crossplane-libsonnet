---
permalink: /upbound-provider-gcp/1.8/compute/v1beta1/regionDiskResourcePolicyAttachment/
---

# compute.v1beta1.regionDiskResourcePolicyAttachment
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.diskRef`](#obj-specforproviderdiskref)
      * [`fn withName(name)`](#fn-specforproviderdiskrefwithname)
      * [`obj spec.forProvider.diskRef.policy`](#obj-specforproviderdiskrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderdiskrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderdiskrefpolicywithresolve)
    * [`obj spec.forProvider.diskSelector`](#obj-specforproviderdiskselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforproviderdiskselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforproviderdiskselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforproviderdiskselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.diskSelector.policy`](#obj-specforproviderdiskselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforproviderdiskselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforproviderdiskselectorpolicywithresolve)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.diskRef`](#obj-specinitproviderdiskref)
      * [`fn withName(name)`](#fn-specinitproviderdiskrefwithname)
      * [`obj spec.initProvider.diskRef.policy`](#obj-specinitproviderdiskrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderdiskrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderdiskrefpolicywithresolve)
    * [`obj spec.initProvider.diskSelector`](#obj-specinitproviderdiskselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitproviderdiskselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitproviderdiskselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitproviderdiskselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.diskSelector.policy`](#obj-specinitproviderdiskselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitproviderdiskselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitproviderdiskselectorpolicywithresolve)
...
new returns an instance of RegionDiskResourcePolicyAttachment
...
## obj spec.forProvider.diskRef

"Reference to a RegionDisk in compute to populate disk."

### fn spec.forProvider.diskRef.withName
...
## obj spec.forProvider.diskRef.policy

"Policies for referencing."

### fn spec.forProvider.diskRef.policy.withResolution
...
### fn spec.forProvider.diskRef.policy.withResolve
...
## obj spec.forProvider.diskSelector

"Selector for a RegionDisk in compute to populate disk."

### fn spec.forProvider.diskSelector.withMatchControllerRef
...
### fn spec.forProvider.diskSelector.withMatchLabels
...
### fn spec.forProvider.diskSelector.withMatchLabelsMixin
...
## obj spec.forProvider.diskSelector.policy

"Policies for selection."

### fn spec.forProvider.diskSelector.policy.withResolution
...
### fn spec.forProvider.diskSelector.policy.withResolve
...
## obj spec.initProvider.diskRef

"Reference to a RegionDisk in compute to populate disk."

### fn spec.initProvider.diskRef.withName
...
## obj spec.initProvider.diskRef.policy

"Policies for referencing."

### fn spec.initProvider.diskRef.policy.withResolution
...
### fn spec.initProvider.diskRef.policy.withResolve
...
## obj spec.initProvider.diskSelector

"Selector for a RegionDisk in compute to populate disk."

### fn spec.initProvider.diskSelector.withMatchControllerRef
...
### fn spec.initProvider.diskSelector.withMatchLabels
...
### fn spec.initProvider.diskSelector.withMatchLabelsMixin
...
## obj spec.initProvider.diskSelector.policy

"Policies for selection."

### fn spec.initProvider.diskSelector.policy.withResolution
...
### fn spec.initProvider.diskSelector.policy.withResolve
