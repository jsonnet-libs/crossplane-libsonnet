---
permalink: /upbound-provider-gcp/1.8/dialogflowcx/v1beta1/intent/
---

# dialogflowcx.v1beta1.intent
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withIsDefaultNegativeIntent(isDefaultNegativeIntent)`](#fn-specforproviderwithisdefaultnegativeintent)
    * [`fn withIsDefaultWelcomeIntent(isDefaultWelcomeIntent)`](#fn-specforproviderwithisdefaultwelcomeintent)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withIsDefaultNegativeIntent(isDefaultNegativeIntent)`](#fn-specinitproviderwithisdefaultnegativeintent)
    * [`fn withIsDefaultWelcomeIntent(isDefaultWelcomeIntent)`](#fn-specinitproviderwithisdefaultwelcomeintent)
    * [`fn withIsFallback(isFallback)`](#fn-specinitproviderwithisfallback)
    ...
    * [`fn withTrainingPhrases(trainingPhrases)`](#fn-specinitproviderwithtrainingphrases)
    * [`fn withTrainingPhrasesMixin(trainingPhrases)`](#fn-specinitproviderwithtrainingphrasesmixin)
    * [`obj spec.initProvider.parameters`](#obj-specinitproviderparameters)
      * [`fn withEntityType(entityType)`](#fn-specinitproviderparameterswithentitytype)
      * [`fn withId(id)`](#fn-specinitproviderparameterswithid)
      * [`fn withIsList(isList)`](#fn-specinitproviderparameterswithislist)
      * [`fn withRedact(redact)`](#fn-specinitproviderparameterswithredact)
    ...
    * [`obj spec.initProvider.trainingPhrases`](#obj-specinitprovidertrainingphrases)
      * [`fn withParts(parts)`](#fn-specinitprovidertrainingphraseswithparts)
      * [`fn withPartsMixin(parts)`](#fn-specinitprovidertrainingphraseswithpartsmixin)
      * [`fn withRepeatCount(repeatCount)`](#fn-specinitprovidertrainingphraseswithrepeatcount)
      * [`obj spec.initProvider.trainingPhrases.parts`](#obj-specinitprovidertrainingphrasesparts)
        * [`fn withParameterId(parameterId)`](#fn-specinitprovidertrainingphrasespartswithparameterid)
        * [`fn withText(text)`](#fn-specinitprovidertrainingphrasespartswithtext)
...
### fn spec.forProvider.withIsDefaultNegativeIntent

```ts
withIsDefaultNegativeIntent(isDefaultNegativeIntent)
```
...
### fn spec.forProvider.withIsDefaultWelcomeIntent

```ts
withIsDefaultWelcomeIntent(isDefaultWelcomeIntent)
```
...
### fn spec.initProvider.withIsDefaultNegativeIntent
...
### fn spec.initProvider.withIsDefaultWelcomeIntent
...
### fn spec.initProvider.withIsFallback
...
### fn spec.initProvider.withTrainingPhrases
...
### fn spec.initProvider.withTrainingPhrasesMixin
...
### fn spec.initProvider.parameters.withEntityType
...
### fn spec.initProvider.parameters.withId
...
### fn spec.initProvider.parameters.withIsList
...
### fn spec.initProvider.parameters.withRedact
...
## obj spec.initProvider.trainingPhrases

"The collection of training phrases the agent is trained on to identify the intent.\nStructure is documented below."

### fn spec.initProvider.trainingPhrases.withParts
...
### fn spec.initProvider.trainingPhrases.withPartsMixin
...
### fn spec.initProvider.trainingPhrases.withRepeatCount
...
## obj spec.initProvider.trainingPhrases.parts

"The ordered list of training phrase parts. The parts are concatenated in order to form the training phrase.\nNote: The API does not automatically annotate training phrases like the Dialogflow Console does.\nNote: Do not forget to include whitespace at part boundaries, so the training phrase is well formatted when the parts are concatenated.\nIf the training phrase does not need to be annotated with parameters, you just need a single part with only the Part.text field set.\nIf you want to annotate the training phrase, you must create multiple parts, where the fields of each part are populated in one of two ways:\nPart.text is set to a part of the phrase that has no parameters.\nPart.text is set to a part of the phrase that you want to annotate, and the parameterId field is set.\nStructure is documented below."

### fn spec.initProvider.trainingPhrases.parts.withParameterId
...
### fn spec.initProvider.trainingPhrases.parts.withText
