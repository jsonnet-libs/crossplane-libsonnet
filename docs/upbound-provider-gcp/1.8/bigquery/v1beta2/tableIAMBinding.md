---
permalink: /upbound-provider-gcp/1.8/bigquery/v1beta2/tableIAMBinding/
---

# bigquery.v1beta2.tableIAMBinding
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`obj spec.forProvider.tableIdRef`](#obj-specforprovidertableidref)
      * [`fn withName(name)`](#fn-specforprovidertableidrefwithname)
      * [`obj spec.forProvider.tableIdRef.policy`](#obj-specforprovidertableidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidertableidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidertableidrefpolicywithresolve)
    * [`obj spec.forProvider.tableIdSelector`](#obj-specforprovidertableidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specforprovidertableidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specforprovidertableidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specforprovidertableidselectorwithmatchlabelsmixin)
      * [`obj spec.forProvider.tableIdSelector.policy`](#obj-specforprovidertableidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specforprovidertableidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specforprovidertableidselectorpolicywithresolve)
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withTableId(tableId)`](#fn-specinitproviderwithtableid)
    ...
    * [`obj spec.initProvider.tableIdRef`](#obj-specinitprovidertableidref)
      * [`fn withName(name)`](#fn-specinitprovidertableidrefwithname)
      * [`obj spec.initProvider.tableIdRef.policy`](#obj-specinitprovidertableidrefpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidertableidrefpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidertableidrefpolicywithresolve)
    * [`obj spec.initProvider.tableIdSelector`](#obj-specinitprovidertableidselector)
      * [`fn withMatchControllerRef(matchControllerRef)`](#fn-specinitprovidertableidselectorwithmatchcontrollerref)
      * [`fn withMatchLabels(matchLabels)`](#fn-specinitprovidertableidselectorwithmatchlabels)
      * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specinitprovidertableidselectorwithmatchlabelsmixin)
      * [`obj spec.initProvider.tableIdSelector.policy`](#obj-specinitprovidertableidselectorpolicy)
        * [`fn withResolution(resolution)`](#fn-specinitprovidertableidselectorpolicywithresolution)
        * [`fn withResolve(resolve)`](#fn-specinitprovidertableidselectorpolicywithresolve)
...
new returns an instance of TableIAMBinding
...
## obj spec.forProvider.tableIdRef

"Reference to a Table in bigquery to populate tableId."

### fn spec.forProvider.tableIdRef.withName
...
## obj spec.forProvider.tableIdRef.policy

"Policies for referencing."

### fn spec.forProvider.tableIdRef.policy.withResolution
...
### fn spec.forProvider.tableIdRef.policy.withResolve
...
## obj spec.forProvider.tableIdSelector

"Selector for a Table in bigquery to populate tableId."

### fn spec.forProvider.tableIdSelector.withMatchControllerRef
...
### fn spec.forProvider.tableIdSelector.withMatchLabels
...
### fn spec.forProvider.tableIdSelector.withMatchLabelsMixin
...
## obj spec.forProvider.tableIdSelector.policy

"Policies for selection."

### fn spec.forProvider.tableIdSelector.policy.withResolution
...
### fn spec.forProvider.tableIdSelector.policy.withResolve
...
### fn spec.initProvider.withTableId
...
## obj spec.initProvider.tableIdRef

"Reference to a Table in bigquery to populate tableId."

### fn spec.initProvider.tableIdRef.withName
...
## obj spec.initProvider.tableIdRef.policy

"Policies for referencing."

### fn spec.initProvider.tableIdRef.policy.withResolution
...
### fn spec.initProvider.tableIdRef.policy.withResolve
...
## obj spec.initProvider.tableIdSelector

"Selector for a Table in bigquery to populate tableId."

### fn spec.initProvider.tableIdSelector.withMatchControllerRef
...
### fn spec.initProvider.tableIdSelector.withMatchLabels
...
### fn spec.initProvider.tableIdSelector.withMatchLabelsMixin
...
## obj spec.initProvider.tableIdSelector.policy

"Policies for selection."

### fn spec.initProvider.tableIdSelector.policy.withResolution
...
### fn spec.initProvider.tableIdSelector.policy.withResolve
