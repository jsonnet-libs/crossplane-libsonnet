---
permalink: /upbound-provider-gcp/1.8/pubsub/v1beta1/subscription/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withCloudStorageConfig(cloudStorageConfig)`](#fn-specforproviderwithcloudstorageconfig)
    * [`fn withCloudStorageConfigMixin(cloudStorageConfig)`](#fn-specforproviderwithcloudstorageconfigmixin)
    ...
    * [`obj spec.forProvider.cloudStorageConfig`](#obj-specforprovidercloudstorageconfig)
      * [`fn withAvroConfig(avroConfig)`](#fn-specforprovidercloudstorageconfigwithavroconfig)
      * [`fn withAvroConfigMixin(avroConfig)`](#fn-specforprovidercloudstorageconfigwithavroconfigmixin)
    ...
    * [`obj spec.forProvider.pushConfig`](#obj-specforproviderpushconfig)
      ...
      * [`fn withNoWrapper(noWrapper)`](#fn-specforproviderpushconfigwithnowrapper)
      * [`fn withNoWrapperMixin(noWrapper)`](#fn-specforproviderpushconfigwithnowrappermixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withBigqueryConfig(bigqueryConfig)`](#fn-specinitproviderwithbigqueryconfig)
    * [`fn withBigqueryConfigMixin(bigqueryConfig)`](#fn-specinitproviderwithbigqueryconfigmixin)
    * [`fn withCloudStorageConfig(cloudStorageConfig)`](#fn-specinitproviderwithcloudstorageconfig)
    * [`fn withCloudStorageConfigMixin(cloudStorageConfig)`](#fn-specinitproviderwithcloudstorageconfigmixin)
    * [`fn withDeadLetterPolicy(deadLetterPolicy)`](#fn-specinitproviderwithdeadletterpolicy)
    * [`fn withDeadLetterPolicyMixin(deadLetterPolicy)`](#fn-specinitproviderwithdeadletterpolicymixin)
    ...
    * [`fn withExpirationPolicy(expirationPolicy)`](#fn-specinitproviderwithexpirationpolicy)
    * [`fn withExpirationPolicyMixin(expirationPolicy)`](#fn-specinitproviderwithexpirationpolicymixin)
    ...
    * [`fn withPushConfig(pushConfig)`](#fn-specinitproviderwithpushconfig)
    * [`fn withPushConfigMixin(pushConfig)`](#fn-specinitproviderwithpushconfigmixin)
    ...
    * [`obj spec.initProvider.cloudStorageConfig`](#obj-specinitprovidercloudstorageconfig)
      * [`fn withAvroConfig(avroConfig)`](#fn-specinitprovidercloudstorageconfigwithavroconfig)
      * [`fn withAvroConfigMixin(avroConfig)`](#fn-specinitprovidercloudstorageconfigwithavroconfigmixin)
    ...
    * [`obj spec.initProvider.pushConfig`](#obj-specinitproviderpushconfig)
      ...
      * [`fn withNoWrapper(noWrapper)`](#fn-specinitproviderpushconfigwithnowrapper)
      * [`fn withNoWrapperMixin(noWrapper)`](#fn-specinitproviderpushconfigwithnowrappermixin)
      * [`fn withOidcToken(oidcToken)`](#fn-specinitproviderpushconfigwithoidctoken)
      * [`fn withOidcTokenMixin(oidcToken)`](#fn-specinitproviderpushconfigwithoidctokenmixin)
...
### fn spec.forProvider.withCloudStorageConfig

```ts
withCloudStorageConfig(cloudStorageConfig)
```

"If delivery to Cloud Storage is used with this subscription, this field is used to configure it.\nEither pushConfig, bigQueryConfig or cloudStorageConfig can be set, but not combined.\nIf all three are empty, then the subscriber will pull and ack messages using API methods.\nStructure is documented below."

### fn spec.forProvider.withCloudStorageConfigMixin

```ts
withCloudStorageConfigMixin(cloudStorageConfig)
```
...
### fn spec.forProvider.cloudStorageConfig.withAvroConfig

```ts
withAvroConfig(avroConfig)
```

"If set, message data will be written to Cloud Storage in Avro format.\nStructure is documented below."

### fn spec.forProvider.cloudStorageConfig.withAvroConfigMixin

```ts
withAvroConfigMixin(avroConfig)
```
...
### fn spec.forProvider.pushConfig.withNoWrapper

```ts
withNoWrapper(noWrapper)
```

"When set, the payload to the push endpoint is not wrapped.Sets the\ndata field as the HTTP body for delivery.\nStructure is documented below."

### fn spec.forProvider.pushConfig.withNoWrapperMixin

```ts
withNoWrapperMixin(noWrapper)
```
...
### fn spec.initProvider.withBigqueryConfig
...
### fn spec.initProvider.withBigqueryConfigMixin
...
### fn spec.initProvider.withCloudStorageConfig
...
### fn spec.initProvider.withCloudStorageConfigMixin
...
### fn spec.initProvider.withDeadLetterPolicy
...
### fn spec.initProvider.withDeadLetterPolicyMixin
...
### fn spec.initProvider.withExpirationPolicy
...
### fn spec.initProvider.withExpirationPolicyMixin
...
### fn spec.initProvider.withPushConfig
...
### fn spec.initProvider.withPushConfigMixin
...
### fn spec.initProvider.cloudStorageConfig.withAvroConfig
...
### fn spec.initProvider.cloudStorageConfig.withAvroConfigMixin
...
### fn spec.initProvider.pushConfig.withNoWrapper
...
### fn spec.initProvider.pushConfig.withNoWrapperMixin
...
### fn spec.initProvider.pushConfig.withOidcToken
...
### fn spec.initProvider.pushConfig.withOidcTokenMixin
