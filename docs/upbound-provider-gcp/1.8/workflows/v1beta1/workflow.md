---
permalink: /upbound-provider-gcp/1.8/workflows/v1beta1/workflow/
---

# workflows.v1beta1.workflow
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withCallLogLevel(callLogLevel)`](#fn-specforproviderwithcallloglevel)
    * [`fn withCryptoKeyName(cryptoKeyName)`](#fn-specforproviderwithcryptokeyname)
    ...
    * [`fn withSourceContents(sourceContents)`](#fn-specforproviderwithsourcecontents)
    * [`fn withUserEnvVars(userEnvVars)`](#fn-specforproviderwithuserenvvars)
    * [`fn withUserEnvVarsMixin(userEnvVars)`](#fn-specforproviderwithuserenvvarsmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withCallLogLevel(callLogLevel)`](#fn-specinitproviderwithcallloglevel)
    * [`fn withCryptoKeyName(cryptoKeyName)`](#fn-specinitproviderwithcryptokeyname)
    ...
    * [`fn withSourceContents(sourceContents)`](#fn-specinitproviderwithsourcecontents)
    * [`fn withUserEnvVars(userEnvVars)`](#fn-specinitproviderwithuserenvvars)
    * [`fn withUserEnvVarsMixin(userEnvVars)`](#fn-specinitproviderwithuserenvvarsmixin)
...
### fn spec.forProvider.withCallLogLevel

```ts
withCallLogLevel(callLogLevel)
```
...
### fn spec.forProvider.withCryptoKeyName
...
### fn spec.forProvider.withSourceContents
...
### fn spec.forProvider.withUserEnvVars

```ts
withUserEnvVars(userEnvVars)
```

"User-defined environment variables associated with this workflow revision. This map has a maximum length of 20. Each string can take up to 4KiB. Keys cannot be empty strings and cannot start with “GOOGLE” or “WORKFLOWS\"."

### fn spec.forProvider.withUserEnvVarsMixin

```ts
withUserEnvVarsMixin(userEnvVars)
```
...
### fn spec.initProvider.withCallLogLevel
...
### fn spec.initProvider.withCryptoKeyName
...
### fn spec.initProvider.withSourceContents
...
### fn spec.initProvider.withUserEnvVars
...
### fn spec.initProvider.withUserEnvVarsMixin
