---
permalink: /upbound-provider-gcp/1.8/monitoring/v1beta2/uptimeCheckConfig/
---

# monitoring.v1beta2.uptimeCheckConfig
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.httpCheck`](#obj-specinitproviderhttpcheck)
      ...
      * [`obj spec.initProvider.httpCheck.authInfo`](#obj-specinitproviderhttpcheckauthinfo)
        ...
        * [`obj spec.initProvider.httpCheck.authInfo.passwordSecretRef`](#obj-specinitproviderhttpcheckauthinfopasswordsecretref)
          * [`fn withKey(key)`](#fn-specinitproviderhttpcheckauthinfopasswordsecretrefwithkey)
          * [`fn withName(name)`](#fn-specinitproviderhttpcheckauthinfopasswordsecretrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specinitproviderhttpcheckauthinfopasswordsecretrefwithnamespace)
...
## obj spec.initProvider.httpCheck.authInfo.passwordSecretRef

"The password to authenticate.\nNote: This property is sensitive and will not be displayed in the plan."

### fn spec.initProvider.httpCheck.authInfo.passwordSecretRef.withKey
...
### fn spec.initProvider.httpCheck.authInfo.passwordSecretRef.withName
...
### fn spec.initProvider.httpCheck.authInfo.passwordSecretRef.withNamespace
