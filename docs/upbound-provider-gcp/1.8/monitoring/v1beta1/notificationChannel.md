---
permalink: /upbound-provider-gcp/1.8/monitoring/v1beta1/notificationChannel/
---

# monitoring.v1beta1.notificationChannel
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withSensitiveLabels(sensitiveLabels)`](#fn-specinitproviderwithsensitivelabels)
    * [`fn withSensitiveLabelsMixin(sensitiveLabels)`](#fn-specinitproviderwithsensitivelabelsmixin)
    ...
    * [`obj spec.initProvider.sensitiveLabels`](#obj-specinitprovidersensitivelabels)
      * [`obj spec.initProvider.sensitiveLabels.authTokenSecretRef`](#obj-specinitprovidersensitivelabelsauthtokensecretref)
        * [`fn withKey(key)`](#fn-specinitprovidersensitivelabelsauthtokensecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitprovidersensitivelabelsauthtokensecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitprovidersensitivelabelsauthtokensecretrefwithnamespace)
      * [`obj spec.initProvider.sensitiveLabels.passwordSecretRef`](#obj-specinitprovidersensitivelabelspasswordsecretref)
        * [`fn withKey(key)`](#fn-specinitprovidersensitivelabelspasswordsecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitprovidersensitivelabelspasswordsecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitprovidersensitivelabelspasswordsecretrefwithnamespace)
      * [`obj spec.initProvider.sensitiveLabels.serviceKeySecretRef`](#obj-specinitprovidersensitivelabelsservicekeysecretref)
        * [`fn withKey(key)`](#fn-specinitprovidersensitivelabelsservicekeysecretrefwithkey)
        * [`fn withName(name)`](#fn-specinitprovidersensitivelabelsservicekeysecretrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specinitprovidersensitivelabelsservicekeysecretrefwithnamespace)
...
### fn spec.initProvider.withSensitiveLabels
...
### fn spec.initProvider.withSensitiveLabelsMixin
...
## obj spec.initProvider.sensitiveLabels

"Different notification type behaviors are configured primarily using the the labels field on this\nresource. This block contains the labels which contain secrets or passwords so that they can be marked\nsensitive and hidden from plan output. The name of the field, eg: password, will be the key\nin the labels map in the api request.\nCredentials may not be specified in both locations and will cause an error. Changing from one location\nto a different credential configuration in the config will require an apply to update state.\nStructure is documented below."

## obj spec.initProvider.sensitiveLabels.authTokenSecretRef

"An authorization token for a notification channel. Channel types that support this field include: slack\nNote: This property is sensitive and will not be displayed in the plan."

### fn spec.initProvider.sensitiveLabels.authTokenSecretRef.withKey
...
### fn spec.initProvider.sensitiveLabels.authTokenSecretRef.withName
...
### fn spec.initProvider.sensitiveLabels.authTokenSecretRef.withNamespace
...
## obj spec.initProvider.sensitiveLabels.passwordSecretRef

"An password for a notification channel. Channel types that support this field include: webhook_basicauth\nNote: This property is sensitive and will not be displayed in the plan."

### fn spec.initProvider.sensitiveLabels.passwordSecretRef.withKey
...
### fn spec.initProvider.sensitiveLabels.passwordSecretRef.withName
...
### fn spec.initProvider.sensitiveLabels.passwordSecretRef.withNamespace
...
## obj spec.initProvider.sensitiveLabels.serviceKeySecretRef

"An servicekey token for a notification channel. Channel types that support this field include: pagerduty\nNote: This property is sensitive and will not be displayed in the plan."

### fn spec.initProvider.sensitiveLabels.serviceKeySecretRef.withKey
...
### fn spec.initProvider.sensitiveLabels.serviceKeySecretRef.withName
...
### fn spec.initProvider.sensitiveLabels.serviceKeySecretRef.withNamespace
