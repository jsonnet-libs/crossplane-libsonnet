---
permalink: /upbound-provider-gcp/0.36/cloudscheduler/v1beta1/job/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAppEngineHttpTarget(appEngineHttpTarget)`](#fn-specinitproviderwithappenginehttptarget)
    * [`fn withAppEngineHttpTargetMixin(appEngineHttpTarget)`](#fn-specinitproviderwithappenginehttptargetmixin)
    ...
    * [`fn withPubsubTarget(pubsubTarget)`](#fn-specinitproviderwithpubsubtarget)
    * [`fn withPubsubTargetMixin(pubsubTarget)`](#fn-specinitproviderwithpubsubtargetmixin)
    ...
    * [`obj spec.initProvider.appEngineHttpTarget`](#obj-specinitproviderappenginehttptarget)
      * [`fn withAppEngineRouting(appEngineRouting)`](#fn-specinitproviderappenginehttptargetwithappenginerouting)
      * [`fn withAppEngineRoutingMixin(appEngineRouting)`](#fn-specinitproviderappenginehttptargetwithappengineroutingmixin)
    ...
    * [`obj spec.initProvider.httpTarget`](#obj-specinitproviderhttptarget)
      ...
      * [`fn withOauthToken(oauthToken)`](#fn-specinitproviderhttptargetwithoauthtoken)
      * [`fn withOauthTokenMixin(oauthToken)`](#fn-specinitproviderhttptargetwithoauthtokenmixin)
      * [`fn withOidcToken(oidcToken)`](#fn-specinitproviderhttptargetwithoidctoken)
      * [`fn withOidcTokenMixin(oidcToken)`](#fn-specinitproviderhttptargetwithoidctokenmixin)
