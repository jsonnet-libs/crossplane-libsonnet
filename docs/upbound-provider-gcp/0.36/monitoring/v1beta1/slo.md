---
permalink: /upbound-provider-gcp/0.36/monitoring/v1beta1/slo/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withBasicSli(basicSli)`](#fn-specinitproviderwithbasicsli)
    * [`fn withBasicSliMixin(basicSli)`](#fn-specinitproviderwithbasicslimixin)
    ...
    * [`fn withRequestBasedSli(requestBasedSli)`](#fn-specinitproviderwithrequestbasedsli)
    * [`fn withRequestBasedSliMixin(requestBasedSli)`](#fn-specinitproviderwithrequestbasedslimixin)
    ...
    * [`fn withWindowsBasedSli(windowsBasedSli)`](#fn-specinitproviderwithwindowsbasedsli)
    * [`fn withWindowsBasedSliMixin(windowsBasedSli)`](#fn-specinitproviderwithwindowsbasedslimixin)
    * [`obj spec.initProvider.basicSli`](#obj-specinitproviderbasicsli)
      * [`fn withAvailability(availability)`](#fn-specinitproviderbasicsliwithavailability)
      * [`fn withAvailabilityMixin(availability)`](#fn-specinitproviderbasicsliwithavailabilitymixin)
      * [`fn withLatency(latency)`](#fn-specinitproviderbasicsliwithlatency)
      * [`fn withLatencyMixin(latency)`](#fn-specinitproviderbasicsliwithlatencymixin)
    ...
    * [`obj spec.initProvider.requestBasedSli`](#obj-specinitproviderrequestbasedsli)
      * [`fn withDistributionCut(distributionCut)`](#fn-specinitproviderrequestbasedsliwithdistributioncut)
      * [`fn withDistributionCutMixin(distributionCut)`](#fn-specinitproviderrequestbasedsliwithdistributioncutmixin)
      * [`fn withGoodTotalRatio(goodTotalRatio)`](#fn-specinitproviderrequestbasedsliwithgoodtotalratio)
      * [`fn withGoodTotalRatioMixin(goodTotalRatio)`](#fn-specinitproviderrequestbasedsliwithgoodtotalratiomixin)
      * [`obj spec.initProvider.requestBasedSli.distributionCut`](#obj-specinitproviderrequestbasedslidistributioncut)
        ...
        * [`fn withRange(range)`](#fn-specinitproviderrequestbasedslidistributioncutwithrange)
        * [`fn withRangeMixin(range)`](#fn-specinitproviderrequestbasedslidistributioncutwithrangemixin)
    ...
    * [`obj spec.initProvider.windowsBasedSli`](#obj-specinitproviderwindowsbasedsli)
      ...
      * [`fn withGoodTotalRatioThreshold(goodTotalRatioThreshold)`](#fn-specinitproviderwindowsbasedsliwithgoodtotalratiothreshold)
      * [`fn withGoodTotalRatioThresholdMixin(goodTotalRatioThreshold)`](#fn-specinitproviderwindowsbasedsliwithgoodtotalratiothresholdmixin)
      * [`fn withMetricMeanInRange(metricMeanInRange)`](#fn-specinitproviderwindowsbasedsliwithmetricmeaninrange)
      * [`fn withMetricMeanInRangeMixin(metricMeanInRange)`](#fn-specinitproviderwindowsbasedsliwithmetricmeaninrangemixin)
      * [`fn withMetricSumInRange(metricSumInRange)`](#fn-specinitproviderwindowsbasedsliwithmetricsuminrange)
      * [`fn withMetricSumInRangeMixin(metricSumInRange)`](#fn-specinitproviderwindowsbasedsliwithmetricsuminrangemixin)
      ...
      * [`obj spec.initProvider.windowsBasedSli.goodTotalRatioThreshold`](#obj-specinitproviderwindowsbasedsligoodtotalratiothreshold)
        * [`fn withBasicSliPerformance(basicSliPerformance)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdwithbasicsliperformance)
        * [`fn withBasicSliPerformanceMixin(basicSliPerformance)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdwithbasicsliperformancemixin)
        * [`fn withPerformance(performance)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdwithperformance)
        * [`fn withPerformanceMixin(performance)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdwithperformancemixin)
        ...
        * [`obj spec.initProvider.windowsBasedSli.goodTotalRatioThreshold.basicSliPerformance`](#obj-specinitproviderwindowsbasedsligoodtotalratiothresholdbasicsliperformance)
          * [`fn withAvailability(availability)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdbasicsliperformancewithavailability)
          * [`fn withAvailabilityMixin(availability)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdbasicsliperformancewithavailabilitymixin)
          * [`fn withLatency(latency)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdbasicsliperformancewithlatency)
          * [`fn withLatencyMixin(latency)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdbasicsliperformancewithlatencymixin)
        ...
        * [`obj spec.initProvider.windowsBasedSli.goodTotalRatioThreshold.performance`](#obj-specinitproviderwindowsbasedsligoodtotalratiothresholdperformance)
          * [`fn withDistributionCut(distributionCut)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancewithdistributioncut)
          * [`fn withDistributionCutMixin(distributionCut)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancewithdistributioncutmixin)
          * [`fn withGoodTotalRatio(goodTotalRatio)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancewithgoodtotalratio)
          * [`fn withGoodTotalRatioMixin(goodTotalRatio)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancewithgoodtotalratiomixin)
          * [`obj spec.initProvider.windowsBasedSli.goodTotalRatioThreshold.performance.distributionCut`](#obj-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancedistributioncut)
            ...
            * [`fn withRange(range)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancedistributioncutwithrange)
            * [`fn withRangeMixin(range)`](#fn-specinitproviderwindowsbasedsligoodtotalratiothresholdperformancedistributioncutwithrangemixin)
      ...
      * [`obj spec.initProvider.windowsBasedSli.metricMeanInRange`](#obj-specinitproviderwindowsbasedslimetricmeaninrange)
        * [`fn withRange(range)`](#fn-specinitproviderwindowsbasedslimetricmeaninrangewithrange)
        * [`fn withRangeMixin(range)`](#fn-specinitproviderwindowsbasedslimetricmeaninrangewithrangemixin)
      ...
      * [`obj spec.initProvider.windowsBasedSli.metricSumInRange`](#obj-specinitproviderwindowsbasedslimetricsuminrange)
        * [`fn withRange(range)`](#fn-specinitproviderwindowsbasedslimetricsuminrangewithrange)
        * [`fn withRangeMixin(range)`](#fn-specinitproviderwindowsbasedslimetricsuminrangewithrangemixin)
