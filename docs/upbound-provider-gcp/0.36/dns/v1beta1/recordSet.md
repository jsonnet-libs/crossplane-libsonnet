---
permalink: /upbound-provider-gcp/0.36/dns/v1beta1/recordSet/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withRoutingPolicy(routingPolicy)`](#fn-specinitproviderwithroutingpolicy)
    * [`fn withRoutingPolicyMixin(routingPolicy)`](#fn-specinitproviderwithroutingpolicymixin)
    ...
    * [`obj spec.initProvider.routingPolicy`](#obj-specinitproviderroutingpolicy)
      ...
      * [`fn withPrimaryBackup(primaryBackup)`](#fn-specinitproviderroutingpolicywithprimarybackup)
      * [`fn withPrimaryBackupMixin(primaryBackup)`](#fn-specinitproviderroutingpolicywithprimarybackupmixin)
      ...
      * [`obj spec.initProvider.routingPolicy.geo`](#obj-specinitproviderroutingpolicygeo)
        * [`fn withHealthCheckedTargets(healthCheckedTargets)`](#fn-specinitproviderroutingpolicygeowithhealthcheckedtargets)
        * [`fn withHealthCheckedTargetsMixin(healthCheckedTargets)`](#fn-specinitproviderroutingpolicygeowithhealthcheckedtargetsmixin)
      ...
      * [`obj spec.initProvider.routingPolicy.primaryBackup`](#obj-specinitproviderroutingpolicyprimarybackup)
        ...
        * [`fn withPrimary(primary)`](#fn-specinitproviderroutingpolicyprimarybackupwithprimary)
        * [`fn withPrimaryMixin(primary)`](#fn-specinitproviderroutingpolicyprimarybackupwithprimarymixin)
        ...
        * [`obj spec.initProvider.routingPolicy.primaryBackup.backupGeo`](#obj-specinitproviderroutingpolicyprimarybackupbackupgeo)
          * [`fn withHealthCheckedTargets(healthCheckedTargets)`](#fn-specinitproviderroutingpolicyprimarybackupbackupgeowithhealthcheckedtargets)
          * [`fn withHealthCheckedTargetsMixin(healthCheckedTargets)`](#fn-specinitproviderroutingpolicyprimarybackupbackupgeowithhealthcheckedtargetsmixin)
      ...
      * [`obj spec.initProvider.routingPolicy.wrr`](#obj-specinitproviderroutingpolicywrr)
        * [`fn withHealthCheckedTargets(healthCheckedTargets)`](#fn-specinitproviderroutingpolicywrrwithhealthcheckedtargets)
        * [`fn withHealthCheckedTargetsMixin(healthCheckedTargets)`](#fn-specinitproviderroutingpolicywrrwithhealthcheckedtargetsmixin)
...
### fn spec.initProvider.withRoutingPolicy
...
### fn spec.initProvider.withRoutingPolicyMixin
...
### fn spec.initProvider.routingPolicy.withPrimaryBackup
...
### fn spec.initProvider.routingPolicy.withPrimaryBackupMixin
...
### fn spec.initProvider.routingPolicy.geo.withHealthCheckedTargets
...
### fn spec.initProvider.routingPolicy.geo.withHealthCheckedTargetsMixin
...
### fn spec.initProvider.routingPolicy.primaryBackup.withPrimary
...
### fn spec.initProvider.routingPolicy.primaryBackup.withPrimaryMixin
...
### fn spec.initProvider.routingPolicy.primaryBackup.backupGeo.withHealthCheckedTargets
...
### fn spec.initProvider.routingPolicy.primaryBackup.backupGeo.withHealthCheckedTargetsMixin
...
### fn spec.initProvider.routingPolicy.wrr.withHealthCheckedTargets
...
### fn spec.initProvider.routingPolicy.wrr.withHealthCheckedTargetsMixin
