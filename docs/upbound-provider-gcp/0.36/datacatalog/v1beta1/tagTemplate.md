---
permalink: /upbound-provider-gcp/0.36/datacatalog/v1beta1/tagTemplate/
---

# datacatalog.v1beta1.tagTemplate
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`obj spec.initProvider.fields`](#obj-specinitproviderfields)
      * [`fn withDescription(description)`](#fn-specinitproviderfieldswithdescription)
      * [`fn withDisplayName(displayName)`](#fn-specinitproviderfieldswithdisplayname)
      * [`fn withFieldId(fieldId)`](#fn-specinitproviderfieldswithfieldid)
      * [`fn withIsRequired(isRequired)`](#fn-specinitproviderfieldswithisrequired)
      * [`fn withOrder(order)`](#fn-specinitproviderfieldswithorder)
      * [`fn withType(type)`](#fn-specinitproviderfieldswithtype)
      * [`fn withTypeMixin(type)`](#fn-specinitproviderfieldswithtypemixin)
      * [`obj spec.initProvider.fields.type`](#obj-specinitproviderfieldstype)
        * [`fn withEnumType(enumType)`](#fn-specinitproviderfieldstypewithenumtype)
        * [`fn withEnumTypeMixin(enumType)`](#fn-specinitproviderfieldstypewithenumtypemixin)
        * [`fn withPrimitiveType(primitiveType)`](#fn-specinitproviderfieldstypewithprimitivetype)
        * [`obj spec.initProvider.fields.type.enumType`](#obj-specinitproviderfieldstypeenumtype)
          * [`fn withAllowedValues(allowedValues)`](#fn-specinitproviderfieldstypeenumtypewithallowedvalues)
          * [`fn withAllowedValuesMixin(allowedValues)`](#fn-specinitproviderfieldstypeenumtypewithallowedvaluesmixin)
          * [`obj spec.initProvider.fields.type.enumType.allowedValues`](#obj-specinitproviderfieldstypeenumtypeallowedvalues)
            * [`fn withDisplayName(displayName)`](#fn-specinitproviderfieldstypeenumtypeallowedvalueswithdisplayname)
...
### fn spec.initProvider.fields.withDescription
...
### fn spec.initProvider.fields.withDisplayName
...
### fn spec.initProvider.fields.withFieldId
...
### fn spec.initProvider.fields.withIsRequired
...
### fn spec.initProvider.fields.withOrder
...
### fn spec.initProvider.fields.withType
...
### fn spec.initProvider.fields.withTypeMixin
...
## obj spec.initProvider.fields.type

"The type of value this tag field can contain. Structure is documented below."

### fn spec.initProvider.fields.type.withEnumType
...
### fn spec.initProvider.fields.type.withEnumTypeMixin
...
### fn spec.initProvider.fields.type.withPrimitiveType
...
## obj spec.initProvider.fields.type.enumType

"Represents an enum type. Exactly one of primitive_type or enum_type must be set Structure is documented below."

### fn spec.initProvider.fields.type.enumType.withAllowedValues
...
### fn spec.initProvider.fields.type.enumType.withAllowedValuesMixin
...
## obj spec.initProvider.fields.type.enumType.allowedValues

"The set of allowed values for this enum. The display names of the values must be case-insensitively unique within this set. Currently, enum values can only be added to the list of allowed values. Deletion and renaming of enum values are not supported. Can have up to 500 allowed values. Structure is documented below."

### fn spec.initProvider.fields.type.enumType.allowedValues.withDisplayName
