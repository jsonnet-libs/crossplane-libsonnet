---
permalink: /upbound-provider-gcp/0.36/containeranalysis/v1beta1/note/
---

# containeranalysis.v1beta1.note
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAttestationAuthority(attestationAuthority)`](#fn-specinitproviderwithattestationauthority)
    * [`fn withAttestationAuthorityMixin(attestationAuthority)`](#fn-specinitproviderwithattestationauthoritymixin)
    * [`fn withExpirationTime(expirationTime)`](#fn-specinitproviderwithexpirationtime)
    * [`fn withLongDescription(longDescription)`](#fn-specinitproviderwithlongdescription)
    * [`fn withProject(project)`](#fn-specinitproviderwithproject)
    * [`fn withRelatedNoteNames(relatedNoteNames)`](#fn-specinitproviderwithrelatednotenames)
    * [`fn withRelatedNoteNamesMixin(relatedNoteNames)`](#fn-specinitproviderwithrelatednotenamesmixin)
    * [`fn withRelatedUrl(relatedUrl)`](#fn-specinitproviderwithrelatedurl)
    * [`fn withRelatedUrlMixin(relatedUrl)`](#fn-specinitproviderwithrelatedurlmixin)
    * [`fn withShortDescription(shortDescription)`](#fn-specinitproviderwithshortdescription)
    * [`obj spec.initProvider.attestationAuthority`](#obj-specinitproviderattestationauthority)
      * [`fn withHint(hint)`](#fn-specinitproviderattestationauthoritywithhint)
      * [`fn withHintMixin(hint)`](#fn-specinitproviderattestationauthoritywithhintmixin)
      * [`obj spec.initProvider.attestationAuthority.hint`](#obj-specinitproviderattestationauthorityhint)
        * [`fn withHumanReadableName(humanReadableName)`](#fn-specinitproviderattestationauthorityhintwithhumanreadablename)
    * [`obj spec.initProvider.relatedUrl`](#obj-specinitproviderrelatedurl)
      * [`fn withLabel(label)`](#fn-specinitproviderrelatedurlwithlabel)
      * [`fn withUrl(url)`](#fn-specinitproviderrelatedurlwithurl)
...
### fn spec.initProvider.withAttestationAuthority
...
### fn spec.initProvider.withAttestationAuthorityMixin
...
### fn spec.initProvider.withLongDescription
...
### fn spec.initProvider.withRelatedNoteNames
...
### fn spec.initProvider.withRelatedNoteNamesMixin
...
### fn spec.initProvider.withRelatedUrl
...
### fn spec.initProvider.withRelatedUrlMixin
...
### fn spec.initProvider.withShortDescription
...
## obj spec.initProvider.attestationAuthority

"Note kind that represents a logical attestation \"role\" or \"authority\". For example, an organization might have one AttestationAuthority for \"QA\" and one for \"build\". This Note is intended to act strictly as a grouping mechanism for the attached Occurrences (Attestations). This grouping mechanism also provides a security boundary, since IAM ACLs gate the ability for a principle to attach an Occurrence to a given Note. It also provides a single point of lookup to find all attached Attestation Occurrences, even if they don't all live in the same project. Structure is documented below."

### fn spec.initProvider.attestationAuthority.withHint
...
### fn spec.initProvider.attestationAuthority.withHintMixin
...
## obj spec.initProvider.attestationAuthority.hint

"This submessage provides human-readable hints about the purpose of the AttestationAuthority. Because the name of a Note acts as its resource reference, it is important to disambiguate the canonical name of the Note (which might be a UUID for security purposes) from \"readable\" names more suitable for debug output. Note that these hints should NOT be used to look up AttestationAuthorities in security sensitive contexts, such as when looking up Attestations to verify. Structure is documented below."

### fn spec.initProvider.attestationAuthority.hint.withHumanReadableName
...
## obj spec.initProvider.relatedUrl

"URLs associated with this note and related metadata. Structure is documented below."

### fn spec.initProvider.relatedUrl.withLabel
...
### fn spec.initProvider.relatedUrl.withUrl
