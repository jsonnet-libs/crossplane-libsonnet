---
permalink: /upbound-provider-gcp/0.36/notebooks/v1beta1/instance/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withNicType(nicType)`](#fn-specforproviderwithnictype)
    ...
    * [`obj spec.forProvider.reservationAffinity`](#obj-specforproviderreservationaffinity)
      * [`fn withConsumeReservationType(consumeReservationType)`](#fn-specforproviderreservationaffinitywithconsumereservationtype)
      * [`fn withKey(key)`](#fn-specforproviderreservationaffinitywithkey)
      * [`fn withValues(values)`](#fn-specforproviderreservationaffinitywithvalues)
      * [`fn withValuesMixin(values)`](#fn-specforproviderreservationaffinitywithvaluesmixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAcceleratorConfig(acceleratorConfig)`](#fn-specinitproviderwithacceleratorconfig)
    * [`fn withAcceleratorConfigMixin(acceleratorConfig)`](#fn-specinitproviderwithacceleratorconfigmixin)
    * [`fn withBootDiskSizeGb(bootDiskSizeGb)`](#fn-specinitproviderwithbootdisksizegb)
    * [`fn withBootDiskType(bootDiskType)`](#fn-specinitproviderwithbootdisktype)
    * [`fn withContainerImage(containerImage)`](#fn-specinitproviderwithcontainerimage)
    * [`fn withContainerImageMixin(containerImage)`](#fn-specinitproviderwithcontainerimagemixin)
    * [`fn withCustomGpuDriverPath(customGpuDriverPath)`](#fn-specinitproviderwithcustomgpudriverpath)
    * [`fn withDataDiskSizeGb(dataDiskSizeGb)`](#fn-specinitproviderwithdatadisksizegb)
    * [`fn withDataDiskType(dataDiskType)`](#fn-specinitproviderwithdatadisktype)
    * [`fn withDiskEncryption(diskEncryption)`](#fn-specinitproviderwithdiskencryption)
    * [`fn withInstallGpuDriver(installGpuDriver)`](#fn-specinitproviderwithinstallgpudriver)
    * [`fn withInstanceOwners(instanceOwners)`](#fn-specinitproviderwithinstanceowners)
    * [`fn withInstanceOwnersMixin(instanceOwners)`](#fn-specinitproviderwithinstanceownersmixin)
    ...
    * [`fn withNicType(nicType)`](#fn-specinitproviderwithnictype)
    * [`fn withNoProxyAccess(noProxyAccess)`](#fn-specinitproviderwithnoproxyaccess)
    * [`fn withNoPublicIp(noPublicIp)`](#fn-specinitproviderwithnopublicip)
    * [`fn withNoRemoveDataDisk(noRemoveDataDisk)`](#fn-specinitproviderwithnoremovedatadisk)
    * [`fn withPostStartupScript(postStartupScript)`](#fn-specinitproviderwithpoststartupscript)
    ...
    * [`fn withServiceAccountScopes(serviceAccountScopes)`](#fn-specinitproviderwithserviceaccountscopes)
    * [`fn withServiceAccountScopesMixin(serviceAccountScopes)`](#fn-specinitproviderwithserviceaccountscopesmixin)
    ...
    * [`fn withVmImageMixin(vmImage)`](#fn-specinitproviderwithvmimagemixin)
    * [`obj spec.initProvider.acceleratorConfig`](#obj-specinitprovideracceleratorconfig)
      * [`fn withCoreCount(coreCount)`](#fn-specinitprovideracceleratorconfigwithcorecount)
      * [`fn withType(type)`](#fn-specinitprovideracceleratorconfigwithtype)
    * [`obj spec.initProvider.containerImage`](#obj-specinitprovidercontainerimage)
      * [`fn withRepository(repository)`](#fn-specinitprovidercontainerimagewithrepository)
      * [`fn withTag(tag)`](#fn-specinitprovidercontainerimagewithtag)
    * [`obj spec.initProvider.reservationAffinity`](#obj-specinitproviderreservationaffinity)
      * [`fn withConsumeReservationType(consumeReservationType)`](#fn-specinitproviderreservationaffinitywithconsumereservationtype)
      * [`fn withKey(key)`](#fn-specinitproviderreservationaffinitywithkey)
      * [`fn withValues(values)`](#fn-specinitproviderreservationaffinitywithvalues)
      * [`fn withValuesMixin(values)`](#fn-specinitproviderreservationaffinitywithvaluesmixin)
    ...
    * [`obj spec.initProvider.vmImage`](#obj-specinitprovidervmimage)
      * [`fn withImageFamily(imageFamily)`](#fn-specinitprovidervmimagewithimagefamily)
      * [`fn withImageName(imageName)`](#fn-specinitprovidervmimagewithimagename)
      * [`fn withProject(project)`](#fn-specinitprovidervmimagewithproject)
...
### fn spec.forProvider.withNicType
...
### fn spec.forProvider.reservationAffinity.withConsumeReservationType
...
### fn spec.forProvider.reservationAffinity.withKey
...
### fn spec.forProvider.reservationAffinity.withValues
...
### fn spec.forProvider.reservationAffinity.withValuesMixin
...
### fn spec.initProvider.withAcceleratorConfig
...
### fn spec.initProvider.withAcceleratorConfigMixin
...
### fn spec.initProvider.withBootDiskSizeGb
...
### fn spec.initProvider.withBootDiskType
...
### fn spec.initProvider.withContainerImage
...
### fn spec.initProvider.withContainerImageMixin
...
### fn spec.initProvider.withCustomGpuDriverPath
...
### fn spec.initProvider.withDataDiskSizeGb
...
### fn spec.initProvider.withDataDiskType
...
### fn spec.initProvider.withInstallGpuDriver
...
### fn spec.initProvider.withInstanceOwners
...
### fn spec.initProvider.withInstanceOwnersMixin
...
### fn spec.initProvider.withNicType
...
### fn spec.initProvider.withNoProxyAccess
...
### fn spec.initProvider.withNoPublicIp
...
### fn spec.initProvider.withNoRemoveDataDisk
...
### fn spec.initProvider.withPostStartupScript
...
### fn spec.initProvider.withServiceAccountScopes
...
### fn spec.initProvider.withServiceAccountScopesMixin
...
### fn spec.initProvider.withVmImageMixin
...
## obj spec.initProvider.acceleratorConfig

"The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the machineType you have selected. Structure is documented below."

### fn spec.initProvider.acceleratorConfig.withCoreCount
...
### fn spec.initProvider.acceleratorConfig.withType
...
## obj spec.initProvider.containerImage

"Use a container image to start the notebook instance. Structure is documented below."

### fn spec.initProvider.containerImage.withRepository
...
### fn spec.initProvider.containerImage.withTag
...
### fn spec.initProvider.reservationAffinity.withConsumeReservationType
...
### fn spec.initProvider.reservationAffinity.withKey
...
### fn spec.initProvider.reservationAffinity.withValues
...
### fn spec.initProvider.reservationAffinity.withValuesMixin
...
## obj spec.initProvider.vmImage

"Use a Compute Engine VM image to start the notebook instance. Structure is documented below."

### fn spec.initProvider.vmImage.withImageFamily
...
### fn spec.initProvider.vmImage.withImageName
...
### fn spec.initProvider.vmImage.withProject
