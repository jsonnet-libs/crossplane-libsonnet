---
permalink: /upbound-provider-gcp/0.36/cloudrun/v1beta1/v2Job/
---
    ...
    * [`obj spec.forProvider.template`](#obj-specforprovidertemplate)
      ...
      * [`obj spec.forProvider.template.template`](#obj-specforprovidertemplatetemplate)
        ...
        * [`obj spec.forProvider.template.template.containers`](#obj-specforprovidertemplatetemplatecontainers)
          ...
          * [`fn withLivenessProbe(livenessProbe)`](#fn-specforprovidertemplatetemplatecontainerswithlivenessprobe)
          * [`fn withLivenessProbeMixin(livenessProbe)`](#fn-specforprovidertemplatetemplatecontainerswithlivenessprobemixin)
          ...
          * [`fn withStartupProbe(startupProbe)`](#fn-specforprovidertemplatetemplatecontainerswithstartupprobe)
          * [`fn withStartupProbeMixin(startupProbe)`](#fn-specforprovidertemplatetemplatecontainerswithstartupprobemixin)
          ...
          * [`obj spec.forProvider.template.template.containers.livenessProbe`](#obj-specforprovidertemplatetemplatecontainerslivenessprobe)
            * [`fn withFailureThreshold(failureThreshold)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithfailurethreshold)
            * [`fn withHttpGet(httpGet)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithhttpget)
            * [`fn withHttpGetMixin(httpGet)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithhttpgetmixin)
            * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithinitialdelayseconds)
            * [`fn withPeriodSeconds(periodSeconds)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithperiodseconds)
            * [`fn withTcpSocket(tcpSocket)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithtcpsocket)
            * [`fn withTcpSocketMixin(tcpSocket)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithtcpsocketmixin)
            * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobewithtimeoutseconds)
            * [`obj spec.forProvider.template.template.containers.livenessProbe.httpGet`](#obj-specforprovidertemplatetemplatecontainerslivenessprobehttpget)
              * [`fn withHttpHeaders(httpHeaders)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobehttpgetwithhttpheaders)
              * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobehttpgetwithhttpheadersmixin)
              * [`fn withPath(path)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobehttpgetwithpath)
              * [`obj spec.forProvider.template.template.containers.livenessProbe.httpGet.httpHeaders`](#obj-specforprovidertemplatetemplatecontainerslivenessprobehttpgethttpheaders)
                * [`fn withName(name)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobehttpgethttpheaderswithname)
                * [`fn withValue(value)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobehttpgethttpheaderswithvalue)
            * [`obj spec.forProvider.template.template.containers.livenessProbe.tcpSocket`](#obj-specforprovidertemplatetemplatecontainerslivenessprobetcpsocket)
              * [`fn withPort(port)`](#fn-specforprovidertemplatetemplatecontainerslivenessprobetcpsocketwithport)
          ...
          * [`obj spec.forProvider.template.template.containers.startupProbe`](#obj-specforprovidertemplatetemplatecontainersstartupprobe)
            * [`fn withFailureThreshold(failureThreshold)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithfailurethreshold)
            * [`fn withHttpGet(httpGet)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithhttpget)
            * [`fn withHttpGetMixin(httpGet)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithhttpgetmixin)
            * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithinitialdelayseconds)
            * [`fn withPeriodSeconds(periodSeconds)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithperiodseconds)
            * [`fn withTcpSocket(tcpSocket)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithtcpsocket)
            * [`fn withTcpSocketMixin(tcpSocket)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithtcpsocketmixin)
            * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specforprovidertemplatetemplatecontainersstartupprobewithtimeoutseconds)
            * [`obj spec.forProvider.template.template.containers.startupProbe.httpGet`](#obj-specforprovidertemplatetemplatecontainersstartupprobehttpget)
              * [`fn withHttpHeaders(httpHeaders)`](#fn-specforprovidertemplatetemplatecontainersstartupprobehttpgetwithhttpheaders)
              * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specforprovidertemplatetemplatecontainersstartupprobehttpgetwithhttpheadersmixin)
              * [`fn withPath(path)`](#fn-specforprovidertemplatetemplatecontainersstartupprobehttpgetwithpath)
              * [`obj spec.forProvider.template.template.containers.startupProbe.httpGet.httpHeaders`](#obj-specforprovidertemplatetemplatecontainersstartupprobehttpgethttpheaders)
                * [`fn withName(name)`](#fn-specforprovidertemplatetemplatecontainersstartupprobehttpgethttpheaderswithname)
                * [`fn withValue(value)`](#fn-specforprovidertemplatetemplatecontainersstartupprobehttpgethttpheaderswithvalue)
            * [`obj spec.forProvider.template.template.containers.startupProbe.tcpSocket`](#obj-specforprovidertemplatetemplatecontainersstartupprobetcpsocket)
              * [`fn withPort(port)`](#fn-specforprovidertemplatetemplatecontainersstartupprobetcpsocketwithport)
    ...
    * [`obj spec.initProvider.template`](#obj-specinitprovidertemplate)
      ...
      * [`obj spec.initProvider.template.template`](#obj-specinitprovidertemplatetemplate)
        ...
        * [`obj spec.initProvider.template.template.containers`](#obj-specinitprovidertemplatetemplatecontainers)
          ...
          * [`fn withLivenessProbe(livenessProbe)`](#fn-specinitprovidertemplatetemplatecontainerswithlivenessprobe)
          * [`fn withLivenessProbeMixin(livenessProbe)`](#fn-specinitprovidertemplatetemplatecontainerswithlivenessprobemixin)
          ...
          * [`fn withStartupProbe(startupProbe)`](#fn-specinitprovidertemplatetemplatecontainerswithstartupprobe)
          * [`fn withStartupProbeMixin(startupProbe)`](#fn-specinitprovidertemplatetemplatecontainerswithstartupprobemixin)
          ...
          * [`obj spec.initProvider.template.template.containers.livenessProbe`](#obj-specinitprovidertemplatetemplatecontainerslivenessprobe)
            * [`fn withFailureThreshold(failureThreshold)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithfailurethreshold)
            * [`fn withHttpGet(httpGet)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithhttpget)
            * [`fn withHttpGetMixin(httpGet)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithhttpgetmixin)
            * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithinitialdelayseconds)
            * [`fn withPeriodSeconds(periodSeconds)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithperiodseconds)
            * [`fn withTcpSocket(tcpSocket)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithtcpsocket)
            * [`fn withTcpSocketMixin(tcpSocket)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithtcpsocketmixin)
            * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobewithtimeoutseconds)
            * [`obj spec.initProvider.template.template.containers.livenessProbe.httpGet`](#obj-specinitprovidertemplatetemplatecontainerslivenessprobehttpget)
              * [`fn withHttpHeaders(httpHeaders)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobehttpgetwithhttpheaders)
              * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobehttpgetwithhttpheadersmixin)
              * [`fn withPath(path)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobehttpgetwithpath)
              * [`obj spec.initProvider.template.template.containers.livenessProbe.httpGet.httpHeaders`](#obj-specinitprovidertemplatetemplatecontainerslivenessprobehttpgethttpheaders)
                * [`fn withName(name)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobehttpgethttpheaderswithname)
                * [`fn withValue(value)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobehttpgethttpheaderswithvalue)
            * [`obj spec.initProvider.template.template.containers.livenessProbe.tcpSocket`](#obj-specinitprovidertemplatetemplatecontainerslivenessprobetcpsocket)
              * [`fn withPort(port)`](#fn-specinitprovidertemplatetemplatecontainerslivenessprobetcpsocketwithport)
          ...
          * [`obj spec.initProvider.template.template.containers.startupProbe`](#obj-specinitprovidertemplatetemplatecontainersstartupprobe)
            * [`fn withFailureThreshold(failureThreshold)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithfailurethreshold)
            * [`fn withHttpGet(httpGet)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithhttpget)
            * [`fn withHttpGetMixin(httpGet)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithhttpgetmixin)
            * [`fn withInitialDelaySeconds(initialDelaySeconds)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithinitialdelayseconds)
            * [`fn withPeriodSeconds(periodSeconds)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithperiodseconds)
            * [`fn withTcpSocket(tcpSocket)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithtcpsocket)
            * [`fn withTcpSocketMixin(tcpSocket)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithtcpsocketmixin)
            * [`fn withTimeoutSeconds(timeoutSeconds)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobewithtimeoutseconds)
            * [`obj spec.initProvider.template.template.containers.startupProbe.httpGet`](#obj-specinitprovidertemplatetemplatecontainersstartupprobehttpget)
              * [`fn withHttpHeaders(httpHeaders)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobehttpgetwithhttpheaders)
              * [`fn withHttpHeadersMixin(httpHeaders)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobehttpgetwithhttpheadersmixin)
              * [`fn withPath(path)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobehttpgetwithpath)
              * [`obj spec.initProvider.template.template.containers.startupProbe.httpGet.httpHeaders`](#obj-specinitprovidertemplatetemplatecontainersstartupprobehttpgethttpheaders)
                * [`fn withName(name)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobehttpgethttpheaderswithname)
                * [`fn withValue(value)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobehttpgethttpheaderswithvalue)
            * [`obj spec.initProvider.template.template.containers.startupProbe.tcpSocket`](#obj-specinitprovidertemplatetemplatecontainersstartupprobetcpsocket)
              * [`fn withPort(port)`](#fn-specinitprovidertemplatetemplatecontainersstartupprobetcpsocketwithport)
