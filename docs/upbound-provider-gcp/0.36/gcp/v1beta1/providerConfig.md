---
permalink: /upbound-provider-gcp/0.36/gcp/v1beta1/providerConfig/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.credentials`](#obj-speccredentials)
    ...
    * [`obj spec.credentials.impersonateServiceAccount`](#obj-speccredentialsimpersonateserviceaccount)
      * [`fn withName(name)`](#fn-speccredentialsimpersonateserviceaccountwithname)
    ...
    * [`obj spec.credentials.upbound`](#obj-speccredentialsupbound)
      * [`obj spec.credentials.upbound.federation`](#obj-speccredentialsupboundfederation)
        * [`fn withProviderID(providerID)`](#fn-speccredentialsupboundfederationwithproviderid)
        * [`fn withServiceAccount(serviceAccount)`](#fn-speccredentialsupboundfederationwithserviceaccount)
...
## obj spec.credentials.impersonateServiceAccount

"Use GCP service account impersonation for authentication."

### fn spec.credentials.impersonateServiceAccount.withName
...
## obj spec.credentials.upbound.federation

"Federation is the configuration for federated identity."

### fn spec.credentials.upbound.federation.withProviderID
...
### fn spec.credentials.upbound.federation.withServiceAccount
