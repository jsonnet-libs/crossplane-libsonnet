---
permalink: /upbound-provider-gcp/0.36/compute/v1beta1/image/
---

# compute.v1beta1.image
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withImageEncryptionKey(imageEncryptionKey)`](#fn-specforproviderwithimageencryptionkey)
    * [`fn withImageEncryptionKeyMixin(imageEncryptionKey)`](#fn-specforproviderwithimageencryptionkeymixin)
    ...
    * [`fn withRawDisk(rawDisk)`](#fn-specforproviderwithrawdisk)
    * [`fn withRawDiskMixin(rawDisk)`](#fn-specforproviderwithrawdiskmixin)
    ...
    * [`obj spec.forProvider.imageEncryptionKey`](#obj-specforproviderimageencryptionkey)
      * [`fn withKmsKeySelfLink(kmsKeySelfLink)`](#fn-specforproviderimageencryptionkeywithkmskeyselflink)
      * [`fn withKmsKeyServiceAccount(kmsKeyServiceAccount)`](#fn-specforproviderimageencryptionkeywithkmskeyserviceaccount)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withImageEncryptionKey(imageEncryptionKey)`](#fn-specinitproviderwithimageencryptionkey)
    * [`fn withImageEncryptionKeyMixin(imageEncryptionKey)`](#fn-specinitproviderwithimageencryptionkeymixin)
    ...
    * [`fn withRawDisk(rawDisk)`](#fn-specinitproviderwithrawdisk)
    * [`fn withRawDiskMixin(rawDisk)`](#fn-specinitproviderwithrawdiskmixin)
    * [`fn withSourceDisk(sourceDisk)`](#fn-specinitproviderwithsourcedisk)
    * [`fn withSourceImage(sourceImage)`](#fn-specinitproviderwithsourceimage)
    * [`fn withSourceSnapshot(sourceSnapshot)`](#fn-specinitproviderwithsourcesnapshot)
    ...
    * [`obj spec.initProvider.imageEncryptionKey`](#obj-specinitproviderimageencryptionkey)
      * [`fn withKmsKeySelfLink(kmsKeySelfLink)`](#fn-specinitproviderimageencryptionkeywithkmskeyselflink)
      * [`fn withKmsKeyServiceAccount(kmsKeyServiceAccount)`](#fn-specinitproviderimageencryptionkeywithkmskeyserviceaccount)
    * [`obj spec.initProvider.rawDisk`](#obj-specinitproviderrawdisk)
      * [`fn withContainerType(containerType)`](#fn-specinitproviderrawdiskwithcontainertype)
      * [`fn withSha1(sha1)`](#fn-specinitproviderrawdiskwithsha1)
      * [`fn withSource(source)`](#fn-specinitproviderrawdiskwithsource)
...
### fn spec.forProvider.withImageEncryptionKey

```ts
withImageEncryptionKey(imageEncryptionKey)
```
...
### fn spec.forProvider.withImageEncryptionKeyMixin

```ts
withImageEncryptionKeyMixin(imageEncryptionKey)
```
...
### fn spec.forProvider.withRawDisk
...
### fn spec.forProvider.withRawDiskMixin

```ts
withRawDiskMixin(rawDisk)
```
...
### fn spec.forProvider.withSourceImage
...
### fn spec.forProvider.withSourceSnapshot
...
## obj spec.forProvider.imageEncryptionKey

"Encrypts the image using a customer-supplied encryption key. After you encrypt an image with a customer-supplied key, you must provide the same key if you use the image later (e.g. to create a disk from the image) Structure is documented below."

### fn spec.forProvider.imageEncryptionKey.withKmsKeySelfLink
...
### fn spec.forProvider.imageEncryptionKey.withKmsKeyServiceAccount
...
### fn spec.initProvider.withImageEncryptionKey
...
### fn spec.initProvider.withImageEncryptionKeyMixin
...
### fn spec.initProvider.withRawDisk
...
### fn spec.initProvider.withRawDiskMixin
...
### fn spec.initProvider.withSourceImage
...
### fn spec.initProvider.withSourceSnapshot
...
## obj spec.initProvider.imageEncryptionKey

"Encrypts the image using a customer-supplied encryption key. After you encrypt an image with a customer-supplied key, you must provide the same key if you use the image later (e.g. to create a disk from the image) Structure is documented below."

### fn spec.initProvider.imageEncryptionKey.withKmsKeySelfLink
...
### fn spec.initProvider.imageEncryptionKey.withKmsKeyServiceAccount
...
## obj spec.initProvider.rawDisk

"The parameters of the raw disk image. Structure is documented below."

### fn spec.initProvider.rawDisk.withContainerType
...
### fn spec.initProvider.rawDisk.withSha1
...
### fn spec.initProvider.rawDisk.withSource
