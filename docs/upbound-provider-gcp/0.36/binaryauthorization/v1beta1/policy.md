---
permalink: /upbound-provider-gcp/0.36/binaryauthorization/v1beta1/policy/
---

# binaryauthorization.v1beta1.policy
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAdmissionWhitelistPatterns(admissionWhitelistPatterns)`](#fn-specinitproviderwithadmissionwhitelistpatterns)
    * [`fn withAdmissionWhitelistPatternsMixin(admissionWhitelistPatterns)`](#fn-specinitproviderwithadmissionwhitelistpatternsmixin)
    * [`fn withClusterAdmissionRules(clusterAdmissionRules)`](#fn-specinitproviderwithclusteradmissionrules)
    * [`fn withClusterAdmissionRulesMixin(clusterAdmissionRules)`](#fn-specinitproviderwithclusteradmissionrulesmixin)
    * [`fn withDefaultAdmissionRule(defaultAdmissionRule)`](#fn-specinitproviderwithdefaultadmissionrule)
    * [`fn withDefaultAdmissionRuleMixin(defaultAdmissionRule)`](#fn-specinitproviderwithdefaultadmissionrulemixin)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withGlobalPolicyEvaluationMode(globalPolicyEvaluationMode)`](#fn-specinitproviderwithglobalpolicyevaluationmode)
    * [`fn withProject(project)`](#fn-specinitproviderwithproject)
    * [`obj spec.initProvider.admissionWhitelistPatterns`](#obj-specinitprovideradmissionwhitelistpatterns)
      * [`fn withNamePattern(namePattern)`](#fn-specinitprovideradmissionwhitelistpatternswithnamepattern)
    * [`obj spec.initProvider.clusterAdmissionRules`](#obj-specinitproviderclusteradmissionrules)
      * [`fn withCluster(cluster)`](#fn-specinitproviderclusteradmissionruleswithcluster)
      * [`fn withEnforcementMode(enforcementMode)`](#fn-specinitproviderclusteradmissionruleswithenforcementmode)
      * [`fn withEvaluationMode(evaluationMode)`](#fn-specinitproviderclusteradmissionruleswithevaluationmode)
      * [`fn withRequireAttestationsBy(requireAttestationsBy)`](#fn-specinitproviderclusteradmissionruleswithrequireattestationsby)
      * [`fn withRequireAttestationsByMixin(requireAttestationsBy)`](#fn-specinitproviderclusteradmissionruleswithrequireattestationsbymixin)
    * [`obj spec.initProvider.defaultAdmissionRule`](#obj-specinitproviderdefaultadmissionrule)
      * [`fn withEnforcementMode(enforcementMode)`](#fn-specinitproviderdefaultadmissionrulewithenforcementmode)
      * [`fn withEvaluationMode(evaluationMode)`](#fn-specinitproviderdefaultadmissionrulewithevaluationmode)
      * [`fn withRequireAttestationsBy(requireAttestationsBy)`](#fn-specinitproviderdefaultadmissionrulewithrequireattestationsby)
      * [`fn withRequireAttestationsByMixin(requireAttestationsBy)`](#fn-specinitproviderdefaultadmissionrulewithrequireattestationsbymixin)
...
### fn spec.initProvider.withAdmissionWhitelistPatterns
...
### fn spec.initProvider.withAdmissionWhitelistPatternsMixin
...
### fn spec.initProvider.withClusterAdmissionRules
...
### fn spec.initProvider.withClusterAdmissionRulesMixin
...
### fn spec.initProvider.withDefaultAdmissionRule
...
### fn spec.initProvider.withDefaultAdmissionRuleMixin
...
### fn spec.initProvider.withGlobalPolicyEvaluationMode
...
## obj spec.initProvider.admissionWhitelistPatterns

"A whitelist of image patterns to exclude from admission rules. If an image's name matches a whitelist pattern, the image's admission requests will always be permitted regardless of your admission rules. Structure is documented below."

### fn spec.initProvider.admissionWhitelistPatterns.withNamePattern
...
## obj spec.initProvider.clusterAdmissionRules

"Per-cluster admission rules. An admission rule specifies either that all container images used in a pod creation request must be attested to by one or more attestors, that all pod creations will be allowed, or that all pod creations will be denied. There can be at most one admission rule per cluster spec."

### fn spec.initProvider.clusterAdmissionRules.withCluster
...
### fn spec.initProvider.clusterAdmissionRules.withEnforcementMode
...
### fn spec.initProvider.clusterAdmissionRules.withEvaluationMode
...
### fn spec.initProvider.clusterAdmissionRules.withRequireAttestationsBy
...
### fn spec.initProvider.clusterAdmissionRules.withRequireAttestationsByMixin
...
## obj spec.initProvider.defaultAdmissionRule

"Default admission rule for a cluster without a per-cluster admission rule. Structure is documented below."

### fn spec.initProvider.defaultAdmissionRule.withEnforcementMode
...
### fn spec.initProvider.defaultAdmissionRule.withEvaluationMode
...
### fn spec.initProvider.defaultAdmissionRule.withRequireAttestationsBy
...
### fn spec.initProvider.defaultAdmissionRule.withRequireAttestationsByMixin
