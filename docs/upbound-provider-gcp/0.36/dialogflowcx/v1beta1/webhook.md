---
permalink: /upbound-provider-gcp/0.36/dialogflowcx/v1beta1/webhook/
---

# dialogflowcx.v1beta1.webhook
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withGenericWebService(genericWebService)`](#fn-specforproviderwithgenericwebservice)
    * [`fn withGenericWebServiceMixin(genericWebService)`](#fn-specforproviderwithgenericwebservicemixin)
    ...
    * [`fn withServiceDirectory(serviceDirectory)`](#fn-specforproviderwithservicedirectory)
    * [`fn withServiceDirectoryMixin(serviceDirectory)`](#fn-specforproviderwithservicedirectorymixin)
    ...
    * [`obj spec.forProvider.serviceDirectory`](#obj-specforproviderservicedirectory)
      * [`fn withGenericWebService(genericWebService)`](#fn-specforproviderservicedirectorywithgenericwebservice)
      * [`fn withGenericWebServiceMixin(genericWebService)`](#fn-specforproviderservicedirectorywithgenericwebservicemixin)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withGenericWebService(genericWebService)`](#fn-specinitproviderwithgenericwebservice)
    * [`fn withGenericWebServiceMixin(genericWebService)`](#fn-specinitproviderwithgenericwebservicemixin)
    * [`fn withSecuritySettings(securitySettings)`](#fn-specinitproviderwithsecuritysettings)
    * [`fn withServiceDirectory(serviceDirectory)`](#fn-specinitproviderwithservicedirectory)
    * [`fn withServiceDirectoryMixin(serviceDirectory)`](#fn-specinitproviderwithservicedirectorymixin)
    ...
    * [`obj spec.initProvider.serviceDirectory`](#obj-specinitproviderservicedirectory)
      * [`fn withGenericWebService(genericWebService)`](#fn-specinitproviderservicedirectorywithgenericwebservice)
      * [`fn withGenericWebServiceMixin(genericWebService)`](#fn-specinitproviderservicedirectorywithgenericwebservicemixin)
...
### fn spec.forProvider.withGenericWebService

```ts
withGenericWebService(genericWebService)
```

"Configuration for a generic web service. Structure is documented below."

### fn spec.forProvider.withGenericWebServiceMixin

```ts
withGenericWebServiceMixin(genericWebService)
```
...
### fn spec.forProvider.withServiceDirectory

```ts
withServiceDirectory(serviceDirectory)
```

"Configuration for a Service Directory service. Structure is documented below."

### fn spec.forProvider.withServiceDirectoryMixin

```ts
withServiceDirectoryMixin(serviceDirectory)
```
...
### fn spec.forProvider.serviceDirectory.withGenericWebService
...
### fn spec.forProvider.serviceDirectory.withGenericWebServiceMixin
...
### fn spec.initProvider.withGenericWebService
...
### fn spec.initProvider.withGenericWebServiceMixin
...
### fn spec.initProvider.withServiceDirectory
...
### fn spec.initProvider.withServiceDirectoryMixin
...
### fn spec.initProvider.serviceDirectory.withGenericWebService
...
### fn spec.initProvider.serviceDirectory.withGenericWebServiceMixin
