---
permalink: /upbound-provider-gcp/0.36/dialogflowcx/v1beta1/entityType/
---

# dialogflowcx.v1beta1.entityType
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withAutoExpansionMode(autoExpansionMode)`](#fn-specinitproviderwithautoexpansionmode)
    * [`fn withDisplayName(displayName)`](#fn-specinitproviderwithdisplayname)
    * [`fn withEnableFuzzyExtraction(enableFuzzyExtraction)`](#fn-specinitproviderwithenablefuzzyextraction)
    * [`fn withEntities(entities)`](#fn-specinitproviderwithentities)
    * [`fn withEntitiesMixin(entities)`](#fn-specinitproviderwithentitiesmixin)
    * [`fn withExcludedPhrases(excludedPhrases)`](#fn-specinitproviderwithexcludedphrases)
    * [`fn withExcludedPhrasesMixin(excludedPhrases)`](#fn-specinitproviderwithexcludedphrasesmixin)
    * [`fn withKind(kind)`](#fn-specinitproviderwithkind)
    * [`fn withLanguageCode(languageCode)`](#fn-specinitproviderwithlanguagecode)
    * [`fn withRedact(redact)`](#fn-specinitproviderwithredact)
    * [`obj spec.initProvider.entities`](#obj-specinitproviderentities)
      * [`fn withSynonyms(synonyms)`](#fn-specinitproviderentitieswithsynonyms)
      * [`fn withSynonymsMixin(synonyms)`](#fn-specinitproviderentitieswithsynonymsmixin)
      * [`fn withValue(value)`](#fn-specinitproviderentitieswithvalue)
    * [`obj spec.initProvider.excludedPhrases`](#obj-specinitproviderexcludedphrases)
      * [`fn withValue(value)`](#fn-specinitproviderexcludedphraseswithvalue)
...
### fn spec.initProvider.withAutoExpansionMode
...
### fn spec.initProvider.withEnableFuzzyExtraction
...
### fn spec.initProvider.withEntities
...
### fn spec.initProvider.withEntitiesMixin
...
### fn spec.initProvider.withExcludedPhrases
...
### fn spec.initProvider.withExcludedPhrasesMixin
...
### fn spec.initProvider.withRedact
...
## obj spec.initProvider.entities

"The collection of entity entries associated with the entity type. Structure is documented below."

### fn spec.initProvider.entities.withSynonyms
...
### fn spec.initProvider.entities.withSynonymsMixin
...
### fn spec.initProvider.entities.withValue
...
## obj spec.initProvider.excludedPhrases

"Collection of exceptional words and phrases that shouldn't be matched. For example, if you have a size entity type with entry giant(an adjective), you might consider adding giants(a noun) as an exclusion. If the kind of entity type is KIND_MAP, then the phrases specified by entities and excluded phrases should be mutually exclusive. Structure is documented below."

### fn spec.initProvider.excludedPhrases.withValue
