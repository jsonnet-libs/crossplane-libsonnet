---
permalink: /upbound-provider-gcp/0.36/containerazure/v1beta1/cluster/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withAzureServicesAuthentication(azureServicesAuthentication)`](#fn-specforproviderwithazureservicesauthentication)
    * [`fn withAzureServicesAuthenticationMixin(azureServicesAuthentication)`](#fn-specforproviderwithazureservicesauthenticationmixin)
    ...
    * [`obj spec.forProvider.azureServicesAuthentication`](#obj-specforproviderazureservicesauthentication)
      * [`fn withApplicationId(applicationId)`](#fn-specforproviderazureservicesauthenticationwithapplicationid)
      * [`fn withTenantId(tenantId)`](#fn-specforproviderazureservicesauthenticationwithtenantid)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withAzureRegion(azureRegion)`](#fn-specinitproviderwithazureregion)
    * [`fn withAzureServicesAuthentication(azureServicesAuthentication)`](#fn-specinitproviderwithazureservicesauthentication)
    * [`fn withAzureServicesAuthenticationMixin(azureServicesAuthentication)`](#fn-specinitproviderwithazureservicesauthenticationmixin)
    * [`fn withClient(client)`](#fn-specinitproviderwithclient)
    * [`fn withControlPlane(controlPlane)`](#fn-specinitproviderwithcontrolplane)
    * [`fn withControlPlaneMixin(controlPlane)`](#fn-specinitproviderwithcontrolplanemixin)
    * [`fn withDescription(description)`](#fn-specinitproviderwithdescription)
    * [`fn withFleet(fleet)`](#fn-specinitproviderwithfleet)
    * [`fn withFleetMixin(fleet)`](#fn-specinitproviderwithfleetmixin)
    * [`fn withNetworking(networking)`](#fn-specinitproviderwithnetworking)
    * [`fn withNetworkingMixin(networking)`](#fn-specinitproviderwithnetworkingmixin)
    ...
    * [`obj spec.initProvider.azureServicesAuthentication`](#obj-specinitproviderazureservicesauthentication)
      * [`fn withApplicationId(applicationId)`](#fn-specinitproviderazureservicesauthenticationwithapplicationid)
      * [`fn withTenantId(tenantId)`](#fn-specinitproviderazureservicesauthenticationwithtenantid)
    * [`obj spec.initProvider.controlPlane`](#obj-specinitprovidercontrolplane)
      * [`fn withDatabaseEncryption(databaseEncryption)`](#fn-specinitprovidercontrolplanewithdatabaseencryption)
      * [`fn withDatabaseEncryptionMixin(databaseEncryption)`](#fn-specinitprovidercontrolplanewithdatabaseencryptionmixin)
      * [`fn withMainVolume(mainVolume)`](#fn-specinitprovidercontrolplanewithmainvolume)
      * [`fn withMainVolumeMixin(mainVolume)`](#fn-specinitprovidercontrolplanewithmainvolumemixin)
      * [`fn withProxyConfig(proxyConfig)`](#fn-specinitprovidercontrolplanewithproxyconfig)
      * [`fn withProxyConfigMixin(proxyConfig)`](#fn-specinitprovidercontrolplanewithproxyconfigmixin)
      * [`fn withReplicaPlacements(replicaPlacements)`](#fn-specinitprovidercontrolplanewithreplicaplacements)
      * [`fn withReplicaPlacementsMixin(replicaPlacements)`](#fn-specinitprovidercontrolplanewithreplicaplacementsmixin)
      * [`fn withRootVolume(rootVolume)`](#fn-specinitprovidercontrolplanewithrootvolume)
      * [`fn withRootVolumeMixin(rootVolume)`](#fn-specinitprovidercontrolplanewithrootvolumemixin)
      * [`fn withSshConfig(sshConfig)`](#fn-specinitprovidercontrolplanewithsshconfig)
      * [`fn withSshConfigMixin(sshConfig)`](#fn-specinitprovidercontrolplanewithsshconfigmixin)
      * [`fn withSubnetId(subnetId)`](#fn-specinitprovidercontrolplanewithsubnetid)
      ...
      * [`fn withVmSize(vmSize)`](#fn-specinitprovidercontrolplanewithvmsize)
      * [`obj spec.initProvider.controlPlane.databaseEncryption`](#obj-specinitprovidercontrolplanedatabaseencryption)
        * [`fn withKeyId(keyId)`](#fn-specinitprovidercontrolplanedatabaseencryptionwithkeyid)
      ...
      * [`obj spec.initProvider.controlPlane.proxyConfig`](#obj-specinitprovidercontrolplaneproxyconfig)
        * [`fn withResourceGroupId(resourceGroupId)`](#fn-specinitprovidercontrolplaneproxyconfigwithresourcegroupid)
        * [`fn withSecretId(secretId)`](#fn-specinitprovidercontrolplaneproxyconfigwithsecretid)
      * [`obj spec.initProvider.controlPlane.replicaPlacements`](#obj-specinitprovidercontrolplanereplicaplacements)
        * [`fn withAzureAvailabilityZone(azureAvailabilityZone)`](#fn-specinitprovidercontrolplanereplicaplacementswithazureavailabilityzone)
        * [`fn withSubnetId(subnetId)`](#fn-specinitprovidercontrolplanereplicaplacementswithsubnetid)
      ...
      * [`obj spec.initProvider.controlPlane.sshConfig`](#obj-specinitprovidercontrolplanesshconfig)
        * [`fn withAuthorizedKey(authorizedKey)`](#fn-specinitprovidercontrolplanesshconfigwithauthorizedkey)
    ...
    * [`obj spec.initProvider.networking`](#obj-specinitprovidernetworking)
      ...
      * [`fn withVirtualNetworkId(virtualNetworkId)`](#fn-specinitprovidernetworkingwithvirtualnetworkid)
