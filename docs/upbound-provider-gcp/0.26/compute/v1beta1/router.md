---
permalink: /upbound-provider-gcp/0.26/compute/v1beta1/router/
---
...
"User-specified flag to indicate which mode to use for advertisement. Default value is DEFAULT. Possible values are DEFAULT and CUSTOM."
