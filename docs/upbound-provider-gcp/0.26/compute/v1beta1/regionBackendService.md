---
permalink: /upbound-provider-gcp/0.26/compute/v1beta1/regionBackendService/
---
...
"Specifies the balancing mode for this backend. See the Backend Services Overview for an explanation of load balancing modes. Default value is CONNECTION. Possible values are UTILIZATION, RATE, and CONNECTION."
