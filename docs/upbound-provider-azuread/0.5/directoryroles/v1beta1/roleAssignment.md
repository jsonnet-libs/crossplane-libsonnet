---
permalink: /upbound-provider-azuread/0.5/directoryroles/v1beta1/roleAssignment/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withAppScopeObjectId(appScopeObjectId)`](#fn-specforproviderwithappscopeobjectid)
    * [`fn withDirectoryScopeId(directoryScopeId)`](#fn-specforproviderwithdirectoryscopeid)
    * [`fn withDirectoryScopeObjectId(directoryScopeObjectId)`](#fn-specforproviderwithdirectoryscopeobjectid)
...
### fn spec.forProvider.withAppScopeObjectId

```ts
withAppScopeObjectId(appScopeObjectId)
```
...
### fn spec.forProvider.withDirectoryScopeObjectId

```ts
withDirectoryScopeObjectId(directoryScopeObjectId)
```
