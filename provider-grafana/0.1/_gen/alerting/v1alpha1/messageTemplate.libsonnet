{
  ...
  '#':: d.pkg(name='messageTemplate', url='', help='"MessageTemplate is the Schema for the MessageTemplates API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"The name of the message template."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withTemplate':: d.fn(help='"The content of the message template."', args=[d.arg(name='template', type=d.T.string)]),
