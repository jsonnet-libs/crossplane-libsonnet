{
  ...
  '#':: d.pkg(name='stack', url='', help='"Stack is the Schema for the Stacks API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"Description of stack."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withName':: d.fn(help='"Name of stack. Conventionally matches the url of the instance (e.g. “<stack_slug>.grafana.net”)."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegionSlug':: d.fn(help='"Region slug to assign to this stack. Changing region will destroy the existing stack and create a new one in the desired region. Available input au (GCP Australia), eu (GCP Belgium), us (GCP US Central), prod-ap-southeast-0 (GCP Singapore), prod-gb-south-0 (GCP UK), prod-ap-south-0 (GCP India), prod-sa-east-0 (GCP Brazil)"', args=[d.arg(name='regionSlug', type=d.T.string)]),
      withRegionSlug(regionSlug): { spec+: { forProvider+: { regionSlug: regionSlug } } },
      '#withSlug':: d.fn(help='"Subdomain that the Grafana instance will be available at (i.e. setting slug to “<stack_slug>” will make the instance available at “https://<stack_slug>.grafana.net\\"."', args=[d.arg(name='slug', type=d.T.string)]),
      withSlug(slug): { spec+: { forProvider+: { slug: slug } } },
      '#withUrl':: d.fn(help='"Custom URL for the Grafana instance. Must have a CNAME setup to point to `.grafana.net` before creating the stack"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { forProvider+: { url: url } } },
      '#withWaitForReadiness':: d.fn(help='"Whether to wait for readiness of the stack after creating it. The check is a HEAD request to the stack URL (Grafana instance). Defaults to `true`."', args=[d.arg(name='waitForReadiness', type=d.T.boolean)]),
      withWaitForReadiness(waitForReadiness): { spec+: { forProvider+: { waitForReadiness: waitForReadiness } } },
      '#withWaitForReadinessTimeout':: d.fn(help='"How long to wait for readiness (if enabled). Defaults to `5m0s`."', args=[d.arg(name='waitForReadinessTimeout', type=d.T.string)]),
