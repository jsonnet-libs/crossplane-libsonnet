{
  ...
  '#':: d.pkg(name='schedule', url='', help='"Schedule is the Schema for the Schedules API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#slack':: d.obj(help='"The Slack-specific settings for a schedule."'),
      slack: {
        '#withChannelId':: d.fn(help='"Slack channel id. Reminder about schedule shifts will be directed to this channel in Slack."', args=[d.arg(name='channelId', type=d.T.string)]),
        withChannelId(channelId): { channelId: channelId },
        '#withUserGroupId':: d.fn(help='"Slack user group id. Members of user group will be updated when on-call users change."', args=[d.arg(name='userGroupId', type=d.T.string)]),
        withUserGroupId(userGroupId): { userGroupId: userGroupId },
      },
      '#withIcalUrlOverrides':: d.fn(help='"The URL of external iCal calendar which override primary events."', args=[d.arg(name='icalUrlOverrides', type=d.T.string)]),
      withIcalUrlOverrides(icalUrlOverrides): { spec+: { forProvider+: { icalUrlOverrides: icalUrlOverrides } } },
      '#withIcalUrlPrimary':: d.fn(help='"The URL of the external calendar iCal file."', args=[d.arg(name='icalUrlPrimary', type=d.T.string)]),
      withIcalUrlPrimary(icalUrlPrimary): { spec+: { forProvider+: { icalUrlPrimary: icalUrlPrimary } } },
      '#withName':: d.fn(help="\"The schedule's name.\"", args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withShifts':: d.fn(help="\"The list of ID's of on-call shifts.\"", args=[d.arg(name='shifts', type=d.T.array)]),
      withShifts(shifts): { spec+: { forProvider+: { shifts: if std.isArray(v=shifts) then shifts else [shifts] } } },
      '#withShiftsMixin':: d.fn(help="\"The list of ID's of on-call shifts.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='shifts', type=d.T.array)]),
      withShiftsMixin(shifts): { spec+: { forProvider+: { shifts+: if std.isArray(v=shifts) then shifts else [shifts] } } },
      '#withSlack':: d.fn(help='"The Slack-specific settings for a schedule."', args=[d.arg(name='slack', type=d.T.array)]),
      withSlack(slack): { spec+: { forProvider+: { slack: if std.isArray(v=slack) then slack else [slack] } } },
      '#withSlackMixin':: d.fn(help='"The Slack-specific settings for a schedule."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='slack', type=d.T.array)]),
      ...
      '#withTimeZone':: d.fn(help="\"The schedule's time zone.\"", args=[d.arg(name='timeZone', type=d.T.string)]),
      withTimeZone(timeZone): { spec+: { forProvider+: { timeZone: timeZone } } },
      '#withType':: d.fn(help="\"The schedule's type.\"", args=[d.arg(name='type', type=d.T.string)]),
