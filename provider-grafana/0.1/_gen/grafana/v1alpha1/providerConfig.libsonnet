{
  ...
  '#':: d.pkg(name='providerConfig', url='', help='"A ProviderConfig configures a Grafana JET provider."'),
  ...
  spec: {
    ...
    credentials: {
      '#connectionSecretRef':: d.obj(help='"A SecretReference is a reference to a secret in an arbitrary namespace."'),
      connectionSecretRef: {
    ...
    '#withOrgID':: d.fn(help='"OrgID of the organization in which to reconcile resources."', args=[d.arg(name='orgID', type=d.T.integer)]),
