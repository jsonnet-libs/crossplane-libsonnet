{
  ...
  '#':: d.pkg(name='folder', url='', help='"Folder is the Schema for the Folders API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPreventDestroyIfNotEmpty':: d.fn(help='"Prevent deletion of the folder if it is not empty (contains dashboards or alert rules). Defaults to `false`."', args=[d.arg(name='preventDestroyIfNotEmpty', type=d.T.boolean)]),
      withPreventDestroyIfNotEmpty(preventDestroyIfNotEmpty): { spec+: { forProvider+: { preventDestroyIfNotEmpty: preventDestroyIfNotEmpty } } },
      '#withTitle':: d.fn(help='"The title of the folder."', args=[d.arg(name='title', type=d.T.string)]),
      withTitle(title): { spec+: { forProvider+: { title: title } } },
      '#withUid':: d.fn(help='"Unique identifier."', args=[d.arg(name='uid', type=d.T.string)]),
