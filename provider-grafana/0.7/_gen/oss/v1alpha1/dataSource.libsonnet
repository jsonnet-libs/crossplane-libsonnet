{
  ...
  '#':: d.pkg(name='dataSource', url='', help='"DataSource is the Schema for the DataSources API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#httpHeadersSecretRef':: d.obj(help='"Custom HTTP headers"'),
      ...
      '#secureJsonDataEncodedSecretRef':: d.obj(help='"Serialized JSON string containing the secure json data. This attribute can be used to pass secure configuration options to the data source. To figure out what options a datasource has available, see its docs or inspect the network data when saving it from the Grafana UI. Note that keys in this map are usually camelCased."'),
      secureJsonDataEncodedSecretRef: {
      ...
      '#withJsonDataEncoded':: d.fn(help='"Serialized JSON string containing the json data. This attribute can be used to pass configuration options to the data source. To figure out what options a datasource has available, see its docs or inspect the network data when saving it from the Grafana UI. Note that keys in this map are usually camelCased."', args=[d.arg(name='jsonDataEncoded', type=d.T.string)]),
