{
  ...
  '#':: d.pkg(name='folderPermission', url='', help='"FolderPermission is the Schema for the FolderPermissions API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFolderUid':: d.fn(help='"The UID of the folder."', args=[d.arg(name='folderUid', type=d.T.string)]),
