{
  ...
  '#':: d.pkg(name='team', url='', help='"Team is the Schema for the Teams API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      preferences: {
        '#withHomeDashboardUid':: d.fn(help='"The UID of the dashboard to display when a team member logs in. Defaults to “."', args=[d.arg(name='homeDashboardUid', type=d.T.string)]),
        withHomeDashboardUid(homeDashboardUid): { homeDashboardUid: homeDashboardUid },
        '#withTheme':: d.fn(help='"The default theme for this team. Available themes are `light`, `dark`, or an empty string for the default theme. Defaults to “."', args=[d.arg(name='theme', type=d.T.string)]),
        withTheme(theme): { theme: theme },
        '#withTimezone':: d.fn(help='"The default timezone for this team. Available values are `utc`, `browser`, or an empty string for the default. Defaults to “."', args=[d.arg(name='timezone', type=d.T.string)]),
        withTimezone(timezone): { timezone: timezone },
      },
      '#teamSync':: d.obj(help='"Sync external auth provider groups with this Grafana team. Only available in Grafana Enterprise. * [Official documentation](https://grafana.com/docs/grafana/latest/setup-grafana/configure-security/configure-team-sync/) * [HTTP API](https://grafana.com/docs/grafana/latest/developers/http_api/team_sync/)"'),
      teamSync: {
      ...
      '#withIgnoreExternallySyncedMembers':: d.fn(help='"Ignores team members that have been added to team by [Team Sync](https://grafana.com/docs/grafana/latest/setup-grafana/configure-security/configure-team-sync/). Team Sync can be provisioned using [grafana_team_external_group resource](https://registry.io/providers/grafana/grafana/latest/docs/resources/team_external_group). Defaults to `true`."', args=[d.arg(name='ignoreExternallySyncedMembers', type=d.T.boolean)]),
