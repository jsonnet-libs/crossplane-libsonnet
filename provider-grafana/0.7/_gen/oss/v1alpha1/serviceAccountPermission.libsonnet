{
  ...
  '#':: d.pkg(name='serviceAccountPermission', url='', help='"ServiceAccountPermission is the Schema for the ServiceAccountPermissions API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      permissions: {
        '#withPermission':: d.fn(help='"Permission to associate with item. Must be `Edit` or `Admin`."', args=[d.arg(name='permission', type=d.T.string)]),
        withPermission(permission): { permission: permission },
        '#withTeamId':: d.fn(help='"ID of the team to manage permissions for. Specify either this or `user_id`. Defaults to `0`."', args=[d.arg(name='teamId', type=d.T.string)]),
        withTeamId(teamId): { teamId: teamId },
        '#withUserId':: d.fn(help='"ID of the user or service account to manage permissions for. Specify either this or `team_id`. Defaults to `0`."', args=[d.arg(name='userId', type=d.T.string)]),
      ...
      '#withServiceAccountId':: d.fn(help='"The id of the service account."', args=[d.arg(name='serviceAccountId', type=d.T.string)]),
