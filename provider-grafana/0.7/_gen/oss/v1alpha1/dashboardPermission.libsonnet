{
  ...
  '#':: d.pkg(name='dashboardPermission', url='', help='"DashboardPermission is the Schema for the DashboardPermissions API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#permissions':: d.obj(help='"The permission items to add/update. Items that are omitted from the list will be removed."'),
      permissions: {
        '#withPermission':: d.fn(help='"Permission to associate with item. Must be one of `View`, `Edit`, or `Admin`."', args=[d.arg(name='permission', type=d.T.string)]),
        withPermission(permission): { permission: permission },
        '#withRole':: d.fn(help='"Manage permissions for `Viewer` or `Editor` roles."', args=[d.arg(name='role', type=d.T.string)]),
        withRole(role): { role: role },
        '#withTeamId':: d.fn(help='"ID of the team to manage permissions for. Defaults to `0`."', args=[d.arg(name='teamId', type=d.T.string)]),
        withTeamId(teamId): { teamId: teamId },
        '#withUserId':: d.fn(help='"ID of the user or service account to manage permissions for. Defaults to `0`."', args=[d.arg(name='userId', type=d.T.string)]),
        withUserId(userId): { userId: userId },
      },
      '#withDashboardUid':: d.fn(help='"UID of the dashboard to apply permissions to."', args=[d.arg(name='dashboardUid', type=d.T.string)]),
      ...
      '#withPermissions':: d.fn(help='"The permission items to add/update. Items that are omitted from the list will be removed."', args=[d.arg(name='permissions', type=d.T.array)]),
      withPermissions(permissions): { spec+: { forProvider+: { permissions: if std.isArray(v=permissions) then permissions else [permissions] } } },
      '#withPermissionsMixin':: d.fn(help='"The permission items to add/update. Items that are omitted from the list will be removed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='permissions', type=d.T.array)]),
