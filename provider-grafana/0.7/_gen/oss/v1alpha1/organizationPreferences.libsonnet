{
  ...
  '#':: d.pkg(name='organizationPreferences', url='', help='"OrganizationPreferences is the Schema for the OrganizationPreferencess API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withHomeDashboardId':: d.fn(help='"The Organization home dashboard ID."', args=[d.arg(name='homeDashboardId', type=d.T.number)]),
      withHomeDashboardId(homeDashboardId): { spec+: { forProvider+: { homeDashboardId: homeDashboardId } } },
      '#withHomeDashboardUid':: d.fn(help='"The Organization home dashboard UID. This is only available in Grafana 9.0+."', args=[d.arg(name='homeDashboardUid', type=d.T.string)]),
      ...
      '#withTheme':: d.fn(help='"The Organization theme. Available values are `light`, `dark`, or an empty string for the default."', args=[d.arg(name='theme', type=d.T.string)]),
      withTheme(theme): { spec+: { forProvider+: { theme: theme } } },
      '#withTimezone':: d.fn(help='"The Organization timezone. Available values are `utc`, `browser`, or an empty string for the default."', args=[d.arg(name='timezone', type=d.T.string)]),
      withTimezone(timezone): { spec+: { forProvider+: { timezone: timezone } } },
      '#withWeekStart':: d.fn(help='"The Organization week start."', args=[d.arg(name='weekStart', type=d.T.string)]),
