{
  ...
  '#':: d.pkg(name='dashboard', url='', help='"Dashboard is the Schema for the Dashboards API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFolder':: d.fn(help='"The id or UID of the folder to save the dashboard in."', args=[d.arg(name='folder', type=d.T.string)]),
      ...
      '#withOverwrite':: d.fn(help='"Set to true if you want to overwrite existing dashboard with newer version, same dashboard title in folder or same dashboard uid."', args=[d.arg(name='overwrite', type=d.T.boolean)]),
