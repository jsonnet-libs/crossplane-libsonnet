{
  ...
  '#':: d.pkg(name='serviceAccount', url='', help='"ServiceAccount is the Schema for the ServiceAccounts API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIsDisabled':: d.fn(help='"The disabled status for the service account. Defaults to `false`."', args=[d.arg(name='isDisabled', type=d.T.boolean)]),
      ...
      '#withRole':: d.fn(help='"The basic role of the service account in the organization."', args=[d.arg(name='role', type=d.T.string)]),
