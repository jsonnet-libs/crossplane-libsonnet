{
  ...
  '#':: d.pkg(name='stackServiceAccountToken', url='', help='"StackServiceAccountToken is the Schema for the StackServiceAccountTokens API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withSecondsToLive':: d.fn(help='', args=[d.arg(name='secondsToLive', type=d.T.number)]),
      ...
      '#withStackSlug':: d.fn(help='', args=[d.arg(name='stackSlug', type=d.T.string)]),
