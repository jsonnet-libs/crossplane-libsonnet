{
  ...
  spec: {
    ...
    forProvider: {
      '#authorizationHeaderSecretRef':: d.obj(help='"The auth data of the webhook. Used in Authorization header instead of user/password auth."'),
      ...
      '#passwordSecretRef':: d.obj(help='"The auth data of the webhook. Used for Basic authentication"'),
      passwordSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
