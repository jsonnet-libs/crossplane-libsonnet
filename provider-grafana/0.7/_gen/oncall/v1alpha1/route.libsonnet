{
  ...
  '#':: d.pkg(name='route', url='', help='"Route is the Schema for the Routes API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIntegrationId':: d.fn(help='"The ID of the integration."', args=[d.arg(name='integrationId', type=d.T.string)]),
      ...
      '#withPosition':: d.fn(help='"The position of the route (starts from 0)."', args=[d.arg(name='position', type=d.T.number)]),
      withPosition(position): { spec+: { forProvider+: { position: position } } },
      '#withRoutingRegex':: d.fn(help='"Python Regex query. Route is chosen for an alert if there is a match inside the alert payload."', args=[d.arg(name='routingRegex', type=d.T.string)]),
      withRoutingRegex(routingRegex): { spec+: { forProvider+: { routingRegex: routingRegex } } },
      '#withRoutingType':: d.fn(help='"The type of route. Can be jinja2, regex Defaults to `regex`."', args=[d.arg(name='routingType', type=d.T.string)]),
