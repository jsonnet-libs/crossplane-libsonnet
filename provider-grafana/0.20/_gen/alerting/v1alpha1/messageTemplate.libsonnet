{
  ...
  '#':: d.pkg(name='messageTemplate', url='', help='"MessageTemplate is the Schema for the MessageTemplates API. Manages Grafana Alerting message templates. Official documentation https://grafana.com/docs/grafana/latest/developers/http_api/alerting_provisioning/#templates This resource requires Grafana 9.1.0 or later."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"(String) The name of the message template.\\nThe name of the message template."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withTemplate':: d.fn(help='"(String) The content of the message template.\\nThe content of the message template."', args=[d.arg(name='template', type=d.T.string)]),
