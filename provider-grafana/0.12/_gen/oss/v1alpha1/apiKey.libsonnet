{
  ...
  '#':: d.pkg(name='apiKey', url='', help='"APIKey is the Schema for the APIKeys API. Manages Grafana API Keys. HTTP API https://grafana."'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withRole':: d.fn(help='"(String)"', args=[d.arg(name='role', type=d.T.string)]),
      withRole(role): { spec+: { forProvider+: { role: role } } },
      '#withSecondsToLive':: d.fn(help='"(Number)"', args=[d.arg(name='secondsToLive', type=d.T.number)]),
