  ...
  spec: {
    ...
    forProvider: {
      ...
      permissions: {
        ...
        '#withTeamId':: d.fn(help='"ID of the team to manage permissions for. Defaults to `0`."', args=[d.arg(name='teamId', type=d.T.number)]),
        withTeamId(teamId): { teamId: teamId },
        '#withUserId':: d.fn(help='"ID of the user to manage permissions for. Defaults to `0`."', args=[d.arg(name='userId', type=d.T.number)]),
