{
  ...
  spec: {
    ...
    forProvider: {
      '#passwordSecretRef':: d.obj(help='"The password for the Grafana user."'),
      passwordSecretRef: {
      ...
      '#withIsAdmin':: d.fn(help='"Whether to make user an admin. Defaults to `false`."', args=[d.arg(name='isAdmin', type=d.T.boolean)]),
      ...
      '#withName':: d.fn(help='"The display name for the Grafana user."', args=[d.arg(name='name', type=d.T.string)]),
