{
  ...
  '#':: d.pkg(name='organization', url='', help='"Organization is the Schema for the Organizations API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAdminUser':: d.fn(help='"The login name of the configured default admin user for the Grafana installation. If unset, this value defaults to admin, the Grafana default. Defaults to `admin`."', args=[d.arg(name='adminUser', type=d.T.string)]),
      withAdminUser(adminUser): { spec+: { forProvider+: { adminUser: adminUser } } },
      '#withAdmins':: d.fn(help="\"A list of email addresses corresponding to users who should be given admin access to the organization. Note: users specified here must already exist in Grafana unless 'create_users' is set to true.\"", args=[d.arg(name='admins', type=d.T.array)]),
      withAdmins(admins): { spec+: { forProvider+: { admins: if std.isArray(v=admins) then admins else [admins] } } },
      '#withAdminsMixin':: d.fn(help="\"A list of email addresses corresponding to users who should be given admin access to the organization. Note: users specified here must already exist in Grafana unless 'create_users' is set to true.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='admins', type=d.T.array)]),
      withAdminsMixin(admins): { spec+: { forProvider+: { admins+: if std.isArray(v=admins) then admins else [admins] } } },
      '#withCreateUsers':: d.fn(help="\"Whether or not to create Grafana users specified in the organization's membership if they don't already exist in Grafana. If unspecified, this parameter defaults to true, creating placeholder users with the name, login, and email set to the email of the user, and a random password. Setting this option to false will cause an error to be thrown for any users that do not already exist in Grafana. Defaults to `true`.\"", args=[d.arg(name='createUsers', type=d.T.boolean)]),
      withCreateUsers(createUsers): { spec+: { forProvider+: { createUsers: createUsers } } },
      '#withEditors':: d.fn(help="\"A list of email addresses corresponding to users who should be given editor access to the organization. Note: users specified here must already exist in Grafana unless 'create_users' is set to true.\"", args=[d.arg(name='editors', type=d.T.array)]),
      withEditors(editors): { spec+: { forProvider+: { editors: if std.isArray(v=editors) then editors else [editors] } } },
      '#withEditorsMixin':: d.fn(help="\"A list of email addresses corresponding to users who should be given editor access to the organization. Note: users specified here must already exist in Grafana unless 'create_users' is set to true.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='editors', type=d.T.array)]),
      withEditorsMixin(editors): { spec+: { forProvider+: { editors+: if std.isArray(v=editors) then editors else [editors] } } },
      '#withName':: d.fn(help='"The display name for the Grafana organization created."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withViewers':: d.fn(help="\"A list of email addresses corresponding to users who should be given viewer access to the organization. Note: users specified here must already exist in Grafana unless 'create_users' is set to true.\"", args=[d.arg(name='viewers', type=d.T.array)]),
      withViewers(viewers): { spec+: { forProvider+: { viewers: if std.isArray(v=viewers) then viewers else [viewers] } } },
      '#withViewersMixin':: d.fn(help="\"A list of email addresses corresponding to users who should be given viewer access to the organization. Note: users specified here must already exist in Grafana unless 'create_users' is set to true.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='viewers', type=d.T.array)]),
      withViewersMixin(viewers): { spec+: { forProvider+: { viewers+: if std.isArray(v=viewers) then viewers else [viewers] } } },
    },
