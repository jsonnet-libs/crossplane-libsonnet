{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withDashboardUid':: d.fn(help='"(String) The ID of the dashboard on which to create the annotation.\\nThe ID of the dashboard on which to create the annotation."', args=[d.arg(name='dashboardUid', type=d.T.string)]),
