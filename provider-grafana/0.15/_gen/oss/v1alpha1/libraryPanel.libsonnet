{
  ...
  spec: {
    ...
    forProvider: {
      '#folderRef':: d.obj(help='"Reference to a Folder in oss to populate folderId."'),
      folderRef: {
      ...
      '#folderSelector':: d.obj(help='"Selector for a Folder in oss to populate folderId."'),
      folderSelector: {
      ...
      '#withFolderId':: d.fn(help='"(String, Deprecated) Deprecated. Use folder_uid instead\\nDeprecated. Use `folder_uid` instead"', args=[d.arg(name='folderId', type=d.T.string)]),
