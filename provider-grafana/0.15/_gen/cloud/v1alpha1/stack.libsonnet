{
  ...
  '#':: d.pkg(name='stack', url='', help='"Stack is the Schema for the Stacks API. Official documentation https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#stacks/ Required access policy scopes: stacks:readstacks:writestacks:delete"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withDescription':: d.fn(help='"(String) Description of stack.\\nDescription of stack."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLabels':: d.fn(help='"zA-Z0-9/\\\\-.]+$\\" and stacks cannot have more than 10 labels.\\nA map of labels to assign to the stack. Label keys and values must match the following regexp: \\"^[a-zA-Z0-9/\\\\\\\\-.]+$\\" and stacks cannot have more than 10 labels."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"zA-Z0-9/\\\\-.]+$\\" and stacks cannot have more than 10 labels.\\nA map of labels to assign to the stack. Label keys and values must match the following regexp: \\"^[a-zA-Z0-9/\\\\\\\\-.]+$\\" and stacks cannot have more than 10 labels."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withName':: d.fn(help='"(String) Name of stack. Conventionally matches the url of the instance (e.g. <stack_slug>.grafana.net).\\nName of stack. Conventionally matches the url of the instance (e.g. `<stack_slug>.grafana.net`)."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegionSlug':: d.fn(help='"cloud/developer-resources/api-reference/cloud-api/#list-regions.\\nRegion slug to assign to this stack. Changing region will destroy the existing stack and create a new one in the desired region. Use the region list API to get the list of available regions: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-regions."', args=[d.arg(name='regionSlug', type=d.T.string)]),
      withRegionSlug(regionSlug): { spec+: { forProvider+: { regionSlug: regionSlug } } },
      '#withSlug':: d.fn(help='"(String) Subdomain that the Grafana instance will be available at. Setting slug to <stack_slug> will make the instance available at https://<stack_slug>.grafana.net.\\nSubdomain that the Grafana instance will be available at. Setting slug to `<stack_slug>` will make the instance available at `https://<stack_slug>.grafana.net`."', args=[d.arg(name='slug', type=d.T.string)]),
      withSlug(slug): { spec+: { forProvider+: { slug: slug } } },
      '#withUrl':: d.fn(help='"(String) Custom URL for the Grafana instance. Must have a CNAME setup to point to .grafana.net before creating the stack\\nCustom URL for the Grafana instance. Must have a CNAME setup to point to `.grafana.net` before creating the stack"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { forProvider+: { url: url } } },
      '#withWaitForReadiness':: d.fn(help='"(Boolean) Whether to wait for readiness of the stack after creating it. The check is a HEAD request to the stack URL (Grafana instance). Defaults to true.\\nWhether to wait for readiness of the stack after creating it. The check is a HEAD request to the stack URL (Grafana instance). Defaults to `true`."', args=[d.arg(name='waitForReadiness', type=d.T.boolean)]),
      withWaitForReadiness(waitForReadiness): { spec+: { forProvider+: { waitForReadiness: waitForReadiness } } },
      '#withWaitForReadinessTimeout':: d.fn(help='"(String) How long to wait for readiness (if enabled). Defaults to 5m0s.\\nHow long to wait for readiness (if enabled). Defaults to `5m0s`."', args=[d.arg(name='waitForReadinessTimeout', type=d.T.string)]),
      withWaitForReadinessTimeout(waitForReadinessTimeout): { spec+: { forProvider+: { waitForReadinessTimeout: waitForReadinessTimeout } } },
    },
    ...
    initProvider: {
      ...
      '#withRegionSlug':: d.fn(help='"cloud/developer-resources/api-reference/cloud-api/#list-regions.\\nRegion slug to assign to this stack. Changing region will destroy the existing stack and create a new one in the desired region. Use the region list API to get the list of available regions: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-regions."', args=[d.arg(name='regionSlug', type=d.T.string)]),
      withRegionSlug(regionSlug): { spec+: { initProvider+: { regionSlug: regionSlug } } },
      '#withSlug':: d.fn(help='"(String) Subdomain that the Grafana instance will be available at. Setting slug to <stack_slug> will make the instance available at https://<stack_slug>.grafana.net.\\nSubdomain that the Grafana instance will be available at. Setting slug to `<stack_slug>` will make the instance available at `https://<stack_slug>.grafana.net`."', args=[d.arg(name='slug', type=d.T.string)]),
      withSlug(slug): { spec+: { initProvider+: { slug: slug } } },
      '#withUrl':: d.fn(help='"(String) Custom URL for the Grafana instance. Must have a CNAME setup to point to .grafana.net before creating the stack\\nCustom URL for the Grafana instance. Must have a CNAME setup to point to `.grafana.net` before creating the stack"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { initProvider+: { url: url } } },
      '#withWaitForReadiness':: d.fn(help='"(Boolean) Whether to wait for readiness of the stack after creating it. The check is a HEAD request to the stack URL (Grafana instance). Defaults to true.\\nWhether to wait for readiness of the stack after creating it. The check is a HEAD request to the stack URL (Grafana instance). Defaults to `true`."', args=[d.arg(name='waitForReadiness', type=d.T.boolean)]),
      withWaitForReadiness(waitForReadiness): { spec+: { initProvider+: { waitForReadiness: waitForReadiness } } },
      '#withWaitForReadinessTimeout':: d.fn(help='"(String) How long to wait for readiness (if enabled). Defaults to 5m0s.\\nHow long to wait for readiness (if enabled). Defaults to `5m0s`."', args=[d.arg(name='waitForReadinessTimeout', type=d.T.string)]),
      withWaitForReadinessTimeout(waitForReadinessTimeout): { spec+: { initProvider+: { waitForReadinessTimeout: waitForReadinessTimeout } } },
    },
