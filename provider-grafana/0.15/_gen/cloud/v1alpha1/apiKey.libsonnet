{
  ...
  '#':: d.pkg(name='apiKey', url='', help='"APIKey is the Schema for the APIKeys API. This resource is deprecated and will be removed in a future release. Please use grafanacloudaccess_policy instead. Manages a single API key on the Grafana Cloud portal (on the organization level)"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withCloudOrgSlug':: d.fn(help='"(String) The slug of the organization to create the API key in. This is the same slug as the organization name in the URL.\\nThe slug of the organization to create the API key in. This is the same slug as the organization name in the URL."', args=[d.arg(name='cloudOrgSlug', type=d.T.string)]),
      withCloudOrgSlug(cloudOrgSlug): { spec+: { forProvider+: { cloudOrgSlug: cloudOrgSlug } } },
      '#withName':: d.fn(help='"(String) Name of the API key.\\nName of the API key."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRole':: d.fn(help='"cloud/api/#create-api-key for details.\\nRole of the API key. Should be one of [Viewer Editor Admin MetricsPublisher PluginPublisher]. See https://grafana.com/docs/grafana-cloud/api/#create-api-key for details."', args=[d.arg(name='role', type=d.T.string)]),
    ...
    initProvider: {
      '#withCloudOrgSlug':: d.fn(help='"(String) The slug of the organization to create the API key in. This is the same slug as the organization name in the URL.\\nThe slug of the organization to create the API key in. This is the same slug as the organization name in the URL."', args=[d.arg(name='cloudOrgSlug', type=d.T.string)]),
      withCloudOrgSlug(cloudOrgSlug): { spec+: { initProvider+: { cloudOrgSlug: cloudOrgSlug } } },
      '#withName':: d.fn(help='"(String) Name of the API key.\\nName of the API key."', args=[d.arg(name='name', type=d.T.string)]),
