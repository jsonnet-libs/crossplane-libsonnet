{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPreventDestroyIfNotEmpty':: d.fn(help='"(Boolean) Prevent deletion of the folder if it is not empty (contains dashboards or alert rules). Defaults to false.\\nPrevent deletion of the folder if it is not empty (contains dashboards or alert rules). Defaults to `false`."', args=[d.arg(name='preventDestroyIfNotEmpty', type=d.T.boolean)]),
