{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withFolderId':: d.fn(help='"(String) ID of the folder where the library panel is stored.\\nID of the folder where the library panel is stored."', args=[d.arg(name='folderId', type=d.T.string)]),
