{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withHomeDashboardId':: d.fn(help='"(Number, Deprecated) The Organization home dashboard ID. Deprecated: Use home_dashboard_uid instead.\\nThe Organization home dashboard ID. Deprecated: Use `home_dashboard_uid` instead."', args=[d.arg(name='homeDashboardId', type=d.T.number)]),
      withHomeDashboardId(homeDashboardId): { spec+: { forProvider+: { homeDashboardId: homeDashboardId } } },
      ...
      '#withTheme':: d.fn(help='"(String) The Organization theme. Available values are light, dark, system, or an empty string for the default.\\nThe Organization theme. Available values are `light`, `dark`, `system`, or an empty string for the default."', args=[d.arg(name='theme', type=d.T.string)]),
      withTheme(theme): { spec+: { forProvider+: { theme: theme } } },
      '#withTimezone':: d.fn(help='"(String) The Organization timezone. Available values are utc, browser, or an empty string for the default.\\nThe Organization timezone. Available values are `utc`, `browser`, or an empty string for the default."', args=[d.arg(name='timezone', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withHomeDashboardId':: d.fn(help='"(Number, Deprecated) The Organization home dashboard ID. Deprecated: Use home_dashboard_uid instead.\\nThe Organization home dashboard ID. Deprecated: Use `home_dashboard_uid` instead."', args=[d.arg(name='homeDashboardId', type=d.T.number)]),
      withHomeDashboardId(homeDashboardId): { spec+: { initProvider+: { homeDashboardId: homeDashboardId } } },
      '#withHomeDashboardUid':: d.fn(help='"(String) The Organization home dashboard UID. This is only available in Grafana 9.0+.\\nThe Organization home dashboard UID. This is only available in Grafana 9.0+."', args=[d.arg(name='homeDashboardUid', type=d.T.string)]),
