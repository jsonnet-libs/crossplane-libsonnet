{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withJsonDataEncoded':: d.fn(help='"Serialized JSON string containing the json data. Replaces the json_data attribute, this attribute can be used to pass configuration options to the data source. To figure out what options a datasource has available, see its docs or inspect the network data when saving it from the Grafana UI."', args=[d.arg(name='jsonDataEncoded', type=d.T.string)]),
