{
  ...
  '#':: d.pkg(name='outgoingWebhook', url='', help='"OutgoingWebhook is the Schema for the OutgoingWebhooks API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withAuthorizationHeader':: d.fn(help='"The auth data of the webhook. Used in Authorization header instead of user/password auth."', args=[d.arg(name='authorizationHeader', type=d.T.string)]),
      withAuthorizationHeader(authorizationHeader): { spec+: { forProvider+: { authorizationHeader: authorizationHeader } } },
      '#withData':: d.fn(help='"The data of the webhook."', args=[d.arg(name='data', type=d.T.string)]),
      withData(data): { spec+: { forProvider+: { data: data } } },
      '#withForwardWholePayload':: d.fn(help="\"Forwards whole payload of the alert to the webhook's url as POST data.\"", args=[d.arg(name='forwardWholePayload', type=d.T.boolean)]),
      withForwardWholePayload(forwardWholePayload): { spec+: { forProvider+: { forwardWholePayload: forwardWholePayload } } },
      '#withName':: d.fn(help='"The name of the outgoing webhook."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPassword':: d.fn(help='"The auth data of the webhook. Used for Basic authentication"', args=[d.arg(name='password', type=d.T.string)]),
      ...
      '#withUrl':: d.fn(help='"The webhook URL."', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { forProvider+: { url: url } } },
      '#withUser':: d.fn(help='"The auth data of the webhook. Used for Basic authentication."', args=[d.arg(name='user', type=d.T.string)]),
