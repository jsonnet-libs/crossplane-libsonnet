{
  ...
  '#':: d.pkg(name='escalationChain', url='', help='"EscalationChain is the Schema for the EscalationChains API. <no value>"'),
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"The name of the escalation chain."', args=[d.arg(name='name', type=d.T.string)]),
