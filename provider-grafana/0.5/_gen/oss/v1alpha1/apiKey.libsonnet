{
  ...
  spec: {
    ...
    forProvider: {
      '#cloudStackRef':: d.obj(help='"Reference to a Stack in cloud to populate cloudStackSlug."'),
      cloudStackRef: {
      ...
      '#cloudStackSelector':: d.obj(help='"Selector for a Stack in cloud to populate cloudStackSlug."'),
      cloudStackSelector: {
      ...
      '#withCloudStackSlug':: d.fn(help='"Deprecated: Use `grafana_cloud_stack_service_account` and `grafana_cloud_stack_service_account_token` resources instead"', args=[d.arg(name='cloudStackSlug', type=d.T.string)]),
