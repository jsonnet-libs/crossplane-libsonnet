{
  ...
  '#':: d.pkg(name='webBackendServiceIAMBinding', url='', help='"WebBackendServiceIAMBinding is the Schema for the WebBackendServiceIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebBackendServiceIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebBackendServiceIAMBindingSpec defines the desired state of WebBackendServiceIAMBinding"'),
  spec: {
