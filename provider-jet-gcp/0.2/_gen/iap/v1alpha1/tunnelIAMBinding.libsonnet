{
  ...
  '#':: d.pkg(name='tunnelIAMBinding', url='', help='"TunnelIAMBinding is the Schema for the TunnelIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TunnelIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TunnelIAMBindingSpec defines the desired state of TunnelIAMBinding"'),
  spec: {
