{
  ...
  '#':: d.pkg(name='tunnelInstanceIAMBinding', url='', help='"TunnelInstanceIAMBinding is the Schema for the TunnelInstanceIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TunnelInstanceIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TunnelInstanceIAMBindingSpec defines the desired state of TunnelInstanceIAMBinding"'),
  spec: {
