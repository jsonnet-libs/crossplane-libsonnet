{
  ...
  '#':: d.pkg(name='webIAMBinding', url='', help='"WebIAMBinding is the Schema for the WebIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebIAMBindingSpec defines the desired state of WebIAMBinding"'),
  spec: {
