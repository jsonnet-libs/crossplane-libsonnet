{
  ...
  '#':: d.pkg(name='appEngineServiceIAMBinding', url='', help='"AppEngineServiceIAMBinding is the Schema for the AppEngineServiceIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppEngineServiceIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppEngineServiceIAMBindingSpec defines the desired state of AppEngineServiceIAMBinding"'),
  spec: {
