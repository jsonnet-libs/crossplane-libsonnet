{
  ...
  '#':: d.pkg(name='webTypeComputeIAMBinding', url='', help='"WebTypeComputeIAMBinding is the Schema for the WebTypeComputeIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebTypeComputeIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
