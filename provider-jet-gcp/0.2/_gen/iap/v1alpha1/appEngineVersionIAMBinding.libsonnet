{
  ...
  '#':: d.pkg(name='appEngineVersionIAMBinding', url='', help='"AppEngineVersionIAMBinding is the Schema for the AppEngineVersionIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AppEngineVersionIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AppEngineVersionIAMBindingSpec defines the desired state of AppEngineVersionIAMBinding"'),
  spec: {
