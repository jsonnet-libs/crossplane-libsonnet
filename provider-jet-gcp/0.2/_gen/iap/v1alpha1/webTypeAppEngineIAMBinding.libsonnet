{
  ...
  '#':: d.pkg(name='webTypeAppEngineIAMBinding', url='', help='"WebTypeAppEngineIAMBinding is the Schema for the WebTypeAppEngineIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of WebTypeAppEngineIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"WebTypeAppEngineIAMBindingSpec defines the desired state of WebTypeAppEngineIAMBinding"'),
  spec: {
