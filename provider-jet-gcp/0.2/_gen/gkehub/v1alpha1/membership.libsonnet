{
  ...
  '#':: d.pkg(name='membership', url='', help='"Membership is the Schema for the Memberships API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEndpoint':: d.fn(help='"If this Membership is a Kubernetes API server hosted on GKE, this is a self link to its GCP resource."', args=[d.arg(name='endpoint', type=d.T.array)]),
      ...
      '#withMembershipId':: d.fn(help='"The client-provided identifier of the membership."', args=[d.arg(name='membershipId', type=d.T.string)]),
