{
  ...
  '#':: d.pkg(name='hl7V2StoreIAMBinding', url='', help='"HL7V2StoreIAMBinding is the Schema for the HL7V2StoreIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of HL7V2StoreIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HL7V2StoreIAMBindingSpec defines the desired state of HL7V2StoreIAMBinding"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withHl7V2StoreId':: d.fn(help='', args=[d.arg(name='hl7V2StoreId', type=d.T.string)]),
      withHl7V2StoreId(hl7V2StoreId): { spec+: { forProvider+: { hl7V2StoreId: hl7V2StoreId } } },
