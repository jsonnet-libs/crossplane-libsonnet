{
  ...
  '#':: d.pkg(name='dicomStoreIAMBinding', url='', help='"DICOMStoreIAMBinding is the Schema for the DICOMStoreIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DICOMStoreIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DICOMStoreIAMBindingSpec defines the desired state of DICOMStoreIAMBinding"'),
  spec: {
