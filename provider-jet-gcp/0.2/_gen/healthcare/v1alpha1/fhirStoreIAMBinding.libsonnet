{
  ...
  '#':: d.pkg(name='fhirStoreIAMBinding', url='', help='"FHIRStoreIAMBinding is the Schema for the FHIRStoreIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FHIRStoreIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FHIRStoreIAMBindingSpec defines the desired state of FHIRStoreIAMBinding"'),
  spec: {
