{
  ...
  '#':: d.pkg(name='folderIAMBinding', url='', help='"FolderIAMBinding is the Schema for the FolderIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FolderIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FolderIAMBindingSpec defines the desired state of FolderIAMBinding"'),
  spec: {
