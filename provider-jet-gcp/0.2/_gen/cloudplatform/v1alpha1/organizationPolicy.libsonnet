{
  ...
  '#':: d.pkg(name='organizationPolicy', url='', help='"OrganizationPolicy is the Schema for the OrganizationPolicys API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
