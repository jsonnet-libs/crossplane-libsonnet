{
  ...
  '#':: d.pkg(name='folderOrganizationPolicy', url='', help='"FolderOrganizationPolicy is the Schema for the FolderOrganizationPolicys API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FolderOrganizationPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudplatform.gcp.jet.crossplane.io/v1alpha1',
    kind: 'FolderOrganizationPolicy',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'true',
  }),
  '#spec':: d.obj(help='"FolderOrganizationPolicySpec defines the desired state of FolderOrganizationPolicy"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withFolder':: d.fn(help='"The resource name of the folder to set the policy for. Its format is folders/{folder_id}."', args=[d.arg(name='folder', type=d.T.string)]),
