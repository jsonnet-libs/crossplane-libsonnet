{
  ...
  '#':: d.pkg(name='projectIAMBinding', url='', help='"ProjectIAMBinding is the Schema for the ProjectIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ProjectIAMBindingSpec defines the desired state of ProjectIAMBinding"'),
  spec: {
