{
  ...
  '#':: d.pkg(name='organizationIAMBinding', url='', help='"OrganizationIAMBinding is the Schema for the OrganizationIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrganizationIAMBindingSpec defines the desired state of OrganizationIAMBinding"'),
  spec: {
