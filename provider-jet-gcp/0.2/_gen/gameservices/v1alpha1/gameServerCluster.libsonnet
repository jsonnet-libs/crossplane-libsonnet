{
  ...
  '#':: d.pkg(name='gameServerCluster', url='', help='"GameServerCluster is the Schema for the GameServerClusters API"'),
  ...
  '#new':: d.fn(help='new returns an instance of GameServerCluster', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GameServerClusterSpec defines the desired state of GameServerCluster"'),
  spec: {
    ...
    forProvider: {
      ...
      withConnectionInfo(connectionInfo): { spec+: { forProvider+: { connectionInfo: if std.isArray(v=connectionInfo) then connectionInfo else [connectionInfo] } } },
      '#withConnectionInfoMixin':: d.fn(help='"Game server cluster connection information. This information is used to manage game server clusters."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='connectionInfo', type=d.T.array)]),
      withConnectionInfoMixin(connectionInfo): { spec+: { forProvider+: { connectionInfo+: if std.isArray(v=connectionInfo) then connectionInfo else [connectionInfo] } } },
      '#withDescription':: d.fn(help='"Human readable description of the cluster."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withLabels':: d.fn(help='"The labels associated with this game server cluster. Each label is a key-value pair."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { forProvider+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"The labels associated with this game server cluster. Each label is a key-value pair."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { forProvider+: { labels+: labels } } },
      '#withLocation':: d.fn(help='"Location of the Cluster."', args=[d.arg(name='location', type=d.T.string)]),
      ...
      '#withRealmId':: d.fn(help='"The realm id of the game server realm."', args=[d.arg(name='realmId', type=d.T.string)]),
      withRealmId(realmId): { spec+: { forProvider+: { realmId: realmId } } },
    },
