{
  ...
  '#':: d.pkg(name='gameServerDeploymentRollout', url='', help='"GameServerDeploymentRollout is the Schema for the GameServerDeploymentRollouts API"'),
  ...
  '#new':: d.fn(help='new returns an instance of GameServerDeploymentRollout', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"GameServerDeploymentRolloutSpec defines the desired state of GameServerDeploymentRollout"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withGameServerConfigOverrides':: d.fn(help='"The game_server_config_overrides contains the per game server config overrides. The overrides are processed in the order they are listed. As soon as a match is found for a cluster, the rest of the list is not processed."', args=[d.arg(name='gameServerConfigOverrides', type=d.T.array)]),
      withGameServerConfigOverrides(gameServerConfigOverrides): { spec+: { forProvider+: { gameServerConfigOverrides: if std.isArray(v=gameServerConfigOverrides) then gameServerConfigOverrides else [gameServerConfigOverrides] } } },
      '#withGameServerConfigOverridesMixin':: d.fn(help='"The game_server_config_overrides contains the per game server config overrides. The overrides are processed in the order they are listed. As soon as a match is found for a cluster, the rest of the list is not processed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='gameServerConfigOverrides', type=d.T.array)]),
      withGameServerConfigOverridesMixin(gameServerConfigOverrides): { spec+: { forProvider+: { gameServerConfigOverrides+: if std.isArray(v=gameServerConfigOverrides) then gameServerConfigOverrides else [gameServerConfigOverrides] } } },
