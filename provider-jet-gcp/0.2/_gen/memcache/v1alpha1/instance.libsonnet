{
  ...
  new(name): {
    apiVersion: 'memcache.gcp.jet.crossplane.io/v1alpha1',
    kind: 'Instance',
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMemcacheParameters':: d.fn(help='"User-specified parameters for this memcache instance."', args=[d.arg(name='memcacheParameters', type=d.T.array)]),
      ...
      '#withMemcacheVersion':: d.fn(help='"The major version of Memcached software. If not provided, latest supported version will be used. Currently the latest supported major version is MEMCACHE_1_5. The minor version will be automatically determined by our system based on the latest supported minor version. Default value: \\"MEMCACHE_1_5\\" Possible values: [\\"MEMCACHE_1_5\\"]"', args=[d.arg(name='memcacheVersion', type=d.T.string)]),
      ...
      '#withNodeConfig':: d.fn(help='"Configuration for memcache nodes."', args=[d.arg(name='nodeConfig', type=d.T.array)]),
