{
  ...
  '#':: d.pkg(name='functionIAMBinding', url='', help='"FunctionIAMBinding is the Schema for the FunctionIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of FunctionIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"FunctionIAMBindingSpec defines the desired state of FunctionIAMBinding"'),
  spec: {
