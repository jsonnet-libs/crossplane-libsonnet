{
  ...
  '#':: d.pkg(name='databaseIAMBinding', url='', help='"DatabaseIAMBinding is the Schema for the DatabaseIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DatabaseIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
