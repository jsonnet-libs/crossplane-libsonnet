{
  ...
  '#':: d.pkg(name='tagKeyIAMBinding', url='', help='"TagKeyIAMBinding is the Schema for the TagKeyIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TagKeyIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
