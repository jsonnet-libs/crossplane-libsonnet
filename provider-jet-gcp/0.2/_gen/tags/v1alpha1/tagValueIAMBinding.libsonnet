{
  ...
  '#':: d.pkg(name='tagValueIAMBinding', url='', help='"TagValueIAMBinding is the Schema for the TagValueIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TagValueIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TagValueIAMBindingSpec defines the desired state of TagValueIAMBinding"'),
  spec: {
