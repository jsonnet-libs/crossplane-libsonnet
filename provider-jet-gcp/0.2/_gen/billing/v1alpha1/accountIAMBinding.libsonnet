{
  ...
  '#':: d.pkg(name='accountIAMBinding', url='', help='"AccountIAMBinding is the Schema for the AccountIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AccountIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
