  ...
  spec: {
    ...
    forProvider: {
      ...
      cluster: {
        ...
        '#withKmsKeyName':: d.fn(help='"Describes the Cloud KMS encryption key that will be used to protect the destination Bigtable cluster. The requirements for this key are: 1) The Cloud Bigtable service account associated with the project that contains this cluster must be granted the cloudkms.cryptoKeyEncrypterDecrypter role on the CMEK key. 2) Only regional keys can be used and the region of the CMEK key must match the region of the cluster. 3) All clusters within an instance must use the same CMEK key. Values are of the form projects/{project}/locations/{location}/keyRings/{keyring}/cryptoKeys/{key}"', args=[d.arg(name='kmsKeyName', type=d.T.string)]),
        withKmsKeyName(kmsKeyName): { kmsKeyName: kmsKeyName },
        '#withNumNodes':: d.fn(help='"The number of nodes in your Cloud Bigtable cluster. Required, with a minimum of 1 for a PRODUCTION instance. Must be left unset for a DEVELOPMENT instance."', args=[d.arg(name='numNodes', type=d.T.integer)]),
      ...
      '#withInstanceType':: d.fn(help='"The instance type to create. One of \\"DEVELOPMENT\\" or \\"PRODUCTION\\". Defaults to \\"PRODUCTION\\"."', args=[d.arg(name='instanceType', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name (also called Instance Id in the Cloud Console) of the Cloud Bigtable instance."', args=[d.arg(name='name', type=d.T.string)]),
