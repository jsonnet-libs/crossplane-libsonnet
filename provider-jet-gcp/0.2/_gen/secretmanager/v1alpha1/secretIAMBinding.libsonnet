{
  ...
  '#':: d.pkg(name='secretIAMBinding', url='', help='"SecretIAMBinding is the Schema for the SecretIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of SecretIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SecretIAMBindingSpec defines the desired state of SecretIAMBinding"'),
  spec: {
