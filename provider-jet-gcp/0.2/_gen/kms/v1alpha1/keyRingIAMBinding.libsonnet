{
  ...
  '#':: d.pkg(name='keyRingIAMBinding', url='', help='"KeyRingIAMBinding is the Schema for the KeyRingIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of KeyRingIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
