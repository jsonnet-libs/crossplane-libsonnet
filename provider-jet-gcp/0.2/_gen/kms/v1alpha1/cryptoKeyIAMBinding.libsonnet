{
  ...
  '#':: d.pkg(name='cryptoKeyIAMBinding', url='', help='"CryptoKeyIAMBinding is the Schema for the CryptoKeyIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CryptoKeyIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
