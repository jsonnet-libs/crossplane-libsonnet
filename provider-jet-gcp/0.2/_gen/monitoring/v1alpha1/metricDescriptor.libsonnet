{
  ...
  '#':: d.pkg(name='metricDescriptor', url='', help='"MetricDescriptor is the Schema for the MetricDescriptors API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      labels: {
        ...
        withKey(key): { key: key },
        '#withValueType':: d.fn(help='"The type of data that can be assigned to the label. Default value: \\"STRING\\" Possible values: [\\"STRING\\", \\"BOOL\\", \\"INT64\\"]"', args=[d.arg(name='valueType', type=d.T.string)]),
      ...
      '#withLabels':: d.fn(help='"The set of labels that can be used to describe a specific instance of this metric type. In order to delete a label, the entire resource must be deleted, then created with the desired labels."', args=[d.arg(name='labels', type=d.T.array)]),
      ...
      '#withLaunchStage':: d.fn(help='"The launch stage of the metric definition. Possible values: [\\"LAUNCH_STAGE_UNSPECIFIED\\", \\"UNIMPLEMENTED\\", \\"PRELAUNCH\\", \\"EARLY_ACCESS\\", \\"ALPHA\\", \\"BETA\\", \\"GA\\", \\"DEPRECATED\\"]"', args=[d.arg(name='launchStage', type=d.T.string)]),
      withLaunchStage(launchStage): { spec+: { forProvider+: { launchStage: launchStage } } },
      '#withMetadata':: d.fn(help='"Metadata which can be used to guide usage of the metric."', args=[d.arg(name='metadata', type=d.T.array)]),
      withMetadata(metadata): { spec+: { forProvider+: { metadata: if std.isArray(v=metadata) then metadata else [metadata] } } },
      '#withMetadataMixin':: d.fn(help='"Metadata which can be used to guide usage of the metric."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metadata', type=d.T.array)]),
      withMetadataMixin(metadata): { spec+: { forProvider+: { metadata+: if std.isArray(v=metadata) then metadata else [metadata] } } },
      '#withMetricKind':: d.fn(help='"Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metricKind and valueType might not be supported. Possible values: [\\"METRIC_KIND_UNSPECIFIED\\", \\"GAUGE\\", \\"DELTA\\", \\"CUMULATIVE\\"]"', args=[d.arg(name='metricKind', type=d.T.string)]),
