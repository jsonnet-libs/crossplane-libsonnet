{
  ...
  '#':: d.pkg(name='uptimeCheckConfig', url='', help='"UptimeCheckConfig is the Schema for the UptimeCheckConfigs API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      contentMatchers: {
        ...
        '#withMatcher':: d.fn(help='"The type of content matcher that will be applied to the server output, compared to the content string when the check is run. Default value: \\"CONTAINS_STRING\\" Possible values: [\\"CONTAINS_STRING\\", \\"NOT_CONTAINS_STRING\\", \\"MATCHES_REGEX\\", \\"NOT_MATCHES_REGEX\\"]"', args=[d.arg(name='matcher', type=d.T.string)]),
      ...
      httpCheck: {
        ...
        '#withAuthInfo':: d.fn(help='"The authentication information. Optional when creating an HTTP check; defaults to empty."', args=[d.arg(name='authInfo', type=d.T.array)]),
        ...
        '#withPath':: d.fn(help='"The path to the page to run the check against. Will be combined with the host (specified within the MonitoredResource) and port to construct the full URL. Optional (defaults to \\"/\\")."', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { path: path },
        '#withPort':: d.fn(help='"The port to the page to run the check against. Will be combined with host (specified within the MonitoredResource) and path to construct the full URL. Optional (defaults to 80 without SSL, or 443 with SSL)."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { port: port },
        '#withRequestMethod':: d.fn(help='"The HTTP request method to use for the check. If set to METHOD_UNSPECIFIED then requestMethod defaults to GET. Default value: \\"GET\\" Possible values: [\\"METHOD_UNSPECIFIED\\", \\"GET\\", \\"POST\\"]"', args=[d.arg(name='requestMethod', type=d.T.string)]),
      ...
      tcpCheck: {
        '#withPort':: d.fn(help='"The port to the page to run the check against. Will be combined with host (specified within the MonitoredResource) to construct the full URL."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { port: port },
      },
      '#withContentMatchers':: d.fn(help="\"The expected content on the page the check is run against. Currently, only the first entry in the list is supported, and other entries will be ignored. The server will look for an exact match of the string in the page response's content. This field is optional and should only be specified if a content match is required.\"", args=[d.arg(name='contentMatchers', type=d.T.array)]),
      ...
      '#withHttpCheck':: d.fn(help='"Contains information needed to make an HTTP or HTTPS check."', args=[d.arg(name='httpCheck', type=d.T.array)]),
      ...
      '#withMonitoredResource':: d.fn(help='"The monitored resource (https://cloud.google.com/monitoring/api/resources) associated with the configuration. The following monitored resource types are supported for uptime checks:  uptime_url  gce_instance  gae_app  aws_ec2_instance  aws_elb_load_balancer"', args=[d.arg(name='monitoredResource', type=d.T.array)]),
      ...
      '#withMonitoredResourceMixin':: d.fn(help='"The monitored resource (https://cloud.google.com/monitoring/api/resources) associated with the configuration. The following monitored resource types are supported for uptime checks:  uptime_url  gce_instance  gae_app  aws_ec2_instance  aws_elb_load_balancer"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='monitoredResource', type=d.T.array)]),
      ...
      '#withResourceGroup':: d.fn(help='"The group resource associated with the configuration."', args=[d.arg(name='resourceGroup', type=d.T.array)]),
      ...
      '#withTcpCheck':: d.fn(help='"Contains information needed to make a TCP check."', args=[d.arg(name='tcpCheck', type=d.T.array)]),
