{
  ...
  '#':: d.pkg(name='tagTemplateIAMBinding', url='', help='"TagTemplateIAMBinding is the Schema for the TagTemplateIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TagTemplateIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'datacatalog.gcp.jet.crossplane.io/v1alpha1',
    kind: 'TagTemplateIAMBinding',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'true',
  }),
  '#spec':: d.obj(help='"TagTemplateIAMBindingSpec defines the desired state of TagTemplateIAMBinding"'),
  spec: {
