{
  ...
  '#':: d.pkg(name='entryGroupIAMBinding', url='', help='"EntryGroupIAMBinding is the Schema for the EntryGroupIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of EntryGroupIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'datacatalog.gcp.jet.crossplane.io/v1alpha1',
    kind: 'EntryGroupIAMBinding',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'true',
  }),
  '#spec':: d.obj(help='"EntryGroupIAMBindingSpec defines the desired state of EntryGroupIAMBinding"'),
  spec: {
