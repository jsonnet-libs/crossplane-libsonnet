{
  ...
  '#':: d.pkg(name='attestorIAMBinding', url='', help='"AttestorIAMBinding is the Schema for the AttestorIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AttestorIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"AttestorIAMBindingSpec defines the desired state of AttestorIAMBinding"'),
  spec: {
