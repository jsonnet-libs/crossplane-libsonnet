{
  ...
  '#':: d.pkg(name='jobIAMMember', url='', help='"JobIAMMember is the Schema for the JobIAMMembers API"'),
  ...
  '#new':: d.fn(help='new returns an instance of JobIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
