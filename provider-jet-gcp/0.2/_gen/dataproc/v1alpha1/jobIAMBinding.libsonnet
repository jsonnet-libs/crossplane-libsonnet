{
  ...
  '#':: d.pkg(name='jobIAMBinding', url='', help='"JobIAMBinding is the Schema for the JobIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of JobIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"JobIAMBindingSpec defines the desired state of JobIAMBinding"'),
  spec: {
