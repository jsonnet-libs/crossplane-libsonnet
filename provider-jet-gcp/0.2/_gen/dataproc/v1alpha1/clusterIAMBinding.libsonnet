{
  ...
  '#':: d.pkg(name='clusterIAMBinding', url='', help='"ClusterIAMBinding is the Schema for the ClusterIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClusterIAMBindingSpec defines the desired state of ClusterIAMBinding"'),
  spec: {
