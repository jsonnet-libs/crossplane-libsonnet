{
  ...
  '#':: d.pkg(name='clusterIAMMember', url='', help='"ClusterIAMMember is the Schema for the ClusterIAMMembers API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterIAMMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ClusterIAMMemberSpec defines the desired state of ClusterIAMMember"'),
  spec: {
