{
  ...
  '#':: d.pkg(name='serviceIAMBinding', url='', help='"ServiceIAMBinding is the Schema for the ServiceIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ServiceIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ServiceIAMBindingSpec defines the desired state of ServiceIAMBinding"'),
  spec: {
