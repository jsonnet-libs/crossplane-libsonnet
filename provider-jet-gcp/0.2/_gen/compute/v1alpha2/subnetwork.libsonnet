{
  ...
  '#':: d.pkg(name='subnetwork', url='', help='"Subnetwork is the Schema for the Subnetworks API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIpv6AccessType':: d.fn(help="\"The access type of IPv6 address this subnet holds. It's immutable and can only be specified during creation or the first time the subnet is updated into IPV4_IPV6 dual stack. If the ipv6_type is EXTERNAL then this subnet cannot enable direct path. Possible values: [\\\"EXTERNAL\\\"]\"", args=[d.arg(name='ipv6AccessType', type=d.T.string)]),
      withIpv6AccessType(ipv6AccessType): { spec+: { forProvider+: { ipv6AccessType: ipv6AccessType } } },
      '#withLogConfig':: d.fn(help="\"Denotes the logging options for the subnetwork flow logs. If logging is enabled logs will be exported to Stackdriver. This field cannot be set if the 'purpose' of this subnetwork is 'INTERNAL_HTTPS_LOAD_BALANCER'\"", args=[d.arg(name='logConfig', type=d.T.array)]),
      withLogConfig(logConfig): { spec+: { forProvider+: { logConfig: if std.isArray(v=logConfig) then logConfig else [logConfig] } } },
      '#withLogConfigMixin':: d.fn(help="\"Denotes the logging options for the subnetwork flow logs. If logging is enabled logs will be exported to Stackdriver. This field cannot be set if the 'purpose' of this subnetwork is 'INTERNAL_HTTPS_LOAD_BALANCER'\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='logConfig', type=d.T.array)]),
      ...
      '#withPurpose':: d.fn(help="\"The purpose of the resource. This field can be either PRIVATE or INTERNAL_HTTPS_LOAD_BALANCER. A subnetwork with purpose set to INTERNAL_HTTPS_LOAD_BALANCER is a user-created subnetwork that is reserved for Internal HTTP(S) Load Balancing. If unspecified, the purpose defaults to PRIVATE. \\n If set to INTERNAL_HTTPS_LOAD_BALANCER you must also set 'role'.\"", args=[d.arg(name='purpose', type=d.T.string)]),
      ...
      '#withRole':: d.fn(help='"The role of subnetwork. Currently, this field is only used when purpose = INTERNAL_HTTPS_LOAD_BALANCER. The value can be set to ACTIVE or BACKUP. An ACTIVE subnetwork is one that is currently being used for Internal HTTP(S) Load Balancing. A BACKUP subnetwork is one that is ready to be promoted to ACTIVE or is currently draining. Possible values: [\\"ACTIVE\\", \\"BACKUP\\"]"', args=[d.arg(name='role', type=d.T.string)]),
      withRole(role): { spec+: { forProvider+: { role: role } } },
      '#withSecondaryIpRange':: d.fn(help="\"An array of configurations for secondary IP ranges for VM instances contained in this subnetwork. The primary IP of such VM must belong to the primary ipCidrRange of the subnetwork. The alias IPs may belong to either primary or secondary ranges. \\n **Note**: This field uses [attr-as-block mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html) to avoid breaking users during the 0.12 upgrade. To explicitly send a list of zero objects you must use the following syntax: 'example=[]' For more details about this behavior, see [this section](https://www.terraform.io/docs/configuration/attr-as-blocks.html#defining-a-fixed-object-collection-value).\"", args=[d.arg(name='secondaryIpRange', type=d.T.array)]),
      ...
      '#withSecondaryIpRangeMixin':: d.fn(help="\"An array of configurations for secondary IP ranges for VM instances contained in this subnetwork. The primary IP of such VM must belong to the primary ipCidrRange of the subnetwork. The alias IPs may belong to either primary or secondary ranges. \\n **Note**: This field uses [attr-as-block mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html) to avoid breaking users during the 0.12 upgrade. To explicitly send a list of zero objects you must use the following syntax: 'example=[]' For more details about this behavior, see [this section](https://www.terraform.io/docs/configuration/attr-as-blocks.html#defining-a-fixed-object-collection-value).\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='secondaryIpRange', type=d.T.array)]),
      ...
      '#withStackType':: d.fn(help='"The stack type for this subnet to identify whether the IPv6 feature is enabled or not. If not specified IPV4_ONLY will be used. Possible values: [\\"IPV4_ONLY\\", \\"IPV4_IPV6\\"]"', args=[d.arg(name='stackType', type=d.T.string)]),
