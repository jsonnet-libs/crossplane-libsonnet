{
  ...
  '#':: d.pkg(name='diskIAMBinding', url='', help='"DiskIAMBinding is the Schema for the DiskIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DiskIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"DiskIAMBindingSpec defines the desired state of DiskIAMBinding"'),
  spec: {
