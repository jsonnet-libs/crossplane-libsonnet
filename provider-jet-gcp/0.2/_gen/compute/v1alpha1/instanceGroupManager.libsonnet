{
  ...
  '#':: d.pkg(name='instanceGroupManager', url='', help='"InstanceGroupManager is the Schema for the InstanceGroupManagers API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#statefulDisk':: d.obj(help='"Disks created on the instances that will be preserved on instance delete, update, etc."'),
      statefulDisk: {
      ...
      updatePolicy: {
        '#withMaxSurgeFixed':: d.fn(help='"The maximum number of instances that can be created above the specified targetSize during the update process. Conflicts with max_surge_percent. If neither is set, defaults to 1"', args=[d.arg(name='maxSurgeFixed', type=d.T.integer)]),
        withMaxSurgeFixed(maxSurgeFixed): { maxSurgeFixed: maxSurgeFixed },
        '#withMaxSurgePercent':: d.fn(help='"The maximum number of instances(calculated as percentage) that can be created above the specified targetSize during the update process. Conflicts with max_surge_fixed."', args=[d.arg(name='maxSurgePercent', type=d.T.integer)]),
        withMaxSurgePercent(maxSurgePercent): { maxSurgePercent: maxSurgePercent },
        '#withMaxUnavailableFixed':: d.fn(help='"The maximum number of instances that can be unavailable during the update process. Conflicts with max_unavailable_percent. If neither is set, defaults to 1."', args=[d.arg(name='maxUnavailableFixed', type=d.T.integer)]),
        withMaxUnavailableFixed(maxUnavailableFixed): { maxUnavailableFixed: maxUnavailableFixed },
        '#withMaxUnavailablePercent':: d.fn(help='"The maximum number of instances(calculated as percentage) that can be unavailable during the update process. Conflicts with max_unavailable_fixed."', args=[d.arg(name='maxUnavailablePercent', type=d.T.integer)]),
      ...
      '#withStatefulDisk':: d.fn(help='"Disks created on the instances that will be preserved on instance delete, update, etc."', args=[d.arg(name='statefulDisk', type=d.T.array)]),
      ...
      '#withStatefulDiskMixin':: d.fn(help='"Disks created on the instances that will be preserved on instance delete, update, etc."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='statefulDisk', type=d.T.array)]),
