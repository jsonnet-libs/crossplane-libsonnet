{
  ...
  '#':: d.pkg(name='subnetworkIAMBinding', url='', help='"SubnetworkIAMBinding is the Schema for the SubnetworkIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of SubnetworkIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubnetworkIAMBindingSpec defines the desired state of SubnetworkIAMBinding"'),
  spec: {
