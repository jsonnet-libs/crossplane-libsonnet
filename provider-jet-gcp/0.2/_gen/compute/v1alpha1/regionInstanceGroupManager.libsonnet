{
  ...
  spec: {
    ...
    forProvider: {
      '#autoHealingPolicies':: d.obj(help='"The autohealing policies for this managed instance group. You can specify only one value."'),
      autoHealingPolicies: {
        ...
        '#withInitialDelaySec':: d.fn(help='"The number of seconds that the managed instance group waits before it applies autohealing policies to new instances or recently recreated instances. Between 0 and 3600."', args=[d.arg(name='initialDelaySec', type=d.T.integer)]),
      ...
      namedPort: {
        ...
        '#withPort':: d.fn(help='"The port number."', args=[d.arg(name='port', type=d.T.integer)]),
      ...
      updatePolicy: {
        ...
        '#withMaxSurgeFixed':: d.fn(help='"The maximum number of instances that can be created above the specified targetSize during the update process. Conflicts with max_surge_percent. It has to be either 0 or at least equal to the number of zones. If fixed values are used, at least one of max_unavailable_fixed or max_surge_fixed must be greater than 0."', args=[d.arg(name='maxSurgeFixed', type=d.T.integer)]),
        ...
        '#withMaxUnavailableFixed':: d.fn(help='"The maximum number of instances that can be unavailable during the update process. Conflicts with max_unavailable_percent. It has to be either 0 or at least equal to the number of zones. If fixed values are used, at least one of max_unavailable_fixed or max_surge_fixed must be greater than 0."', args=[d.arg(name='maxUnavailableFixed', type=d.T.integer)]),
      ...
      '#version':: d.obj(help='"Application versions managed by this instance group. Each version deals with a specific instance template, allowing canary release scenarios."'),
      version: {
        '#targetSize':: d.obj(help='"The number of instances calculated as a fixed number or a percentage depending on the settings."'),
        targetSize: {
          '#withFixed':: d.fn(help='"The number of instances which are managed for this version. Conflicts with percent."', args=[d.arg(name='fixed', type=d.T.integer)]),
          withFixed(fixed): { fixed: fixed },
          '#withPercent':: d.fn(help='"The number of instances (calculated as percentage) which are managed for this version. Conflicts with fixed. Note that when using percent, rounding will be in favor of explicitly set target_size values; a managed instance group with 2 instances and 2 versions, one of which has a target_size.percent of 60 will create 2 instances of that version."', args=[d.arg(name='percent', type=d.T.integer)]),
        ...
        withName(name): { name: name },
        '#withTargetSize':: d.fn(help='"The number of instances calculated as a fixed number or a percentage depending on the settings."', args=[d.arg(name='targetSize', type=d.T.array)]),
        withTargetSize(targetSize): { targetSize: if std.isArray(v=targetSize) then targetSize else [targetSize] },
        '#withTargetSizeMixin':: d.fn(help='"The number of instances calculated as a fixed number or a percentage depending on the settings."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetSize', type=d.T.array)]),
