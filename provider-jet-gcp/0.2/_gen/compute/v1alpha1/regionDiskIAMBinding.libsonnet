{
  ...
  '#':: d.pkg(name='regionDiskIAMBinding', url='', help='"RegionDiskIAMBinding is the Schema for the RegionDiskIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of RegionDiskIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"RegionDiskIAMBindingSpec defines the desired state of RegionDiskIAMBinding"'),
  spec: {
