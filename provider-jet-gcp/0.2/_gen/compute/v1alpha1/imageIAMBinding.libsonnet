{
  ...
  '#':: d.pkg(name='imageIAMBinding', url='', help='"ImageIAMBinding is the Schema for the ImageIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ImageIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"ImageIAMBindingSpec defines the desired state of ImageIAMBinding"'),
  spec: {
