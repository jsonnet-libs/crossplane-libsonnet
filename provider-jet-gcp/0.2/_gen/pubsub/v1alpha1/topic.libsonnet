{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withMessageStoragePolicy':: d.fn(help='"Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect."', args=[d.arg(name='messageStoragePolicy', type=d.T.array)]),
      ...
      '#withMessageStoragePolicyMixin':: d.fn(help='"Policy constraining the set of Google Cloud Platform regions where messages published to the topic may be stored. If not present, then no constraints are in effect."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='messageStoragePolicy', type=d.T.array)]),
      ...
      '#withSchemaSettings':: d.fn(help='"Settings for validating messages published against a schema."', args=[d.arg(name='schemaSettings', type=d.T.array)]),
