{
  ...
  '#':: d.pkg(name='topicIAMBinding', url='', help='"TopicIAMBinding is the Schema for the TopicIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TopicIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"TopicIAMBindingSpec defines the desired state of TopicIAMBinding"'),
  spec: {
