{
  ...
  '#':: d.pkg(name='subscriptionIAMBinding', url='', help='"SubscriptionIAMBinding is the Schema for the SubscriptionIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of SubscriptionIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"SubscriptionIAMBindingSpec defines the desired state of SubscriptionIAMBinding"'),
  spec: {
