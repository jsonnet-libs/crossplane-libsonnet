{
  ...
  '#':: d.pkg(name='bucketIAMBinding', url='', help='"BucketIAMBinding is the Schema for the BucketIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of BucketIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"BucketIAMBindingSpec defines the desired state of BucketIAMBinding"'),
  spec: {
