{
  ...
  '#':: d.pkg(name='certificateAuthority', url='', help='"CertificateAuthority is the Schema for the CertificateAuthoritys API"'),
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#keySpec':: d.obj(help='"Used when issuing certificates for this CertificateAuthority. If this CertificateAuthority is a self-signed CertificateAuthority, this key is also used to sign the self-signed CA certificate. Otherwise, it is used to sign a CSR."'),
      keySpec: {
      ...
      '#withCertificateAuthorityId':: d.fn(help='"The user provided Resource ID for this Certificate Authority."', args=[d.arg(name='certificateAuthorityId', type=d.T.string)]),
      withCertificateAuthorityId(certificateAuthorityId): { spec+: { forProvider+: { certificateAuthorityId: certificateAuthorityId } } },
      ...
      '#withKeySpec':: d.fn(help='"Used when issuing certificates for this CertificateAuthority. If this CertificateAuthority is a self-signed CertificateAuthority, this key is also used to sign the self-signed CA certificate. Otherwise, it is used to sign a CSR."', args=[d.arg(name='keySpec', type=d.T.array)]),
      withKeySpec(keySpec): { spec+: { forProvider+: { keySpec: if std.isArray(v=keySpec) then keySpec else [keySpec] } } },
      '#withKeySpecMixin':: d.fn(help='"Used when issuing certificates for this CertificateAuthority. If this CertificateAuthority is a self-signed CertificateAuthority, this key is also used to sign the self-signed CA certificate. Otherwise, it is used to sign a CSR."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='keySpec', type=d.T.array)]),
      ...
      '#withType':: d.fn(help="\"The Type of this CertificateAuthority. \\n ~\u003e **Note:** For 'SUBORDINATE' Certificate Authorities, they need to be manually activated (via Cloud Console of 'gcloud') before they can issue certificates. Default value: \\\"SELF_SIGNED\\\" Possible values: [\\\"SELF_SIGNED\\\", \\\"SUBORDINATE\\\"]\"", args=[d.arg(name='type', type=d.T.string)]),
