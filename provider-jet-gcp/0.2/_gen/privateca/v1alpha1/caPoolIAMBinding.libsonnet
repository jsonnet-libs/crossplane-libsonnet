{
  ...
  '#':: d.pkg(name='caPoolIAMBinding', url='', help='"CAPoolIAMBinding is the Schema for the CAPoolIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CAPoolIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'privateca.gcp.jet.crossplane.io/v1alpha1',
    kind: 'CAPoolIAMBinding',
  } + self.metadata.withName(name=name) + self.metadata.withAnnotations(annotations={
    'tanka.dev/namespaced': 'true',
  }),
  '#spec':: d.obj(help='"CAPoolIAMBindingSpec defines the desired state of CAPoolIAMBinding"'),
  spec: {
