{
  ...
  '#':: d.pkg(name='repositoryIAMBinding', url='', help='"RepositoryIAMBinding is the Schema for the RepositoryIAMBindings API"'),
  ...
  '#new':: d.fn(help='new returns an instance of RepositoryIAMBinding', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
