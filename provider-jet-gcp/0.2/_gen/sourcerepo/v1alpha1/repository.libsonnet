{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withPubsubConfigs':: d.fn(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names."', args=[d.arg(name='pubsubConfigs', type=d.T.array)]),
      ...
      '#withPubsubConfigsMixin':: d.fn(help='"How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pubsubConfigs', type=d.T.array)]),
