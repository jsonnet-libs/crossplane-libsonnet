  ...
  spec: {
    ...
    forProvider: {
      ...
      configuration: {
        ...
        resultConfiguration: {
          '#aclConfiguration':: d.obj(help='"Indicates that an Amazon S3 canned ACL should be set to control ownership of stored query results. When Athena stores query results in Amazon S3, the canned ACL is set with the x-amz-acl request header. For more information about S3 Object Ownership, see Object Ownership settings (https://docs.aws.amazon.com/AmazonS3/latest/userguide/about-object-ownership.html#object-ownership-overview) in the Amazon S3 User Guide."'),
          aclConfiguration: {
            '#withS3ACLOption':: d.fn(help='', args=[d.arg(name='s3ACLOption', type=d.T.string)]),
            withS3ACLOption(s3ACLOption): { spec+: { forProvider+: { configuration+: { resultConfiguration+: { aclConfiguration+: { s3ACLOption: s3ACLOption } } } } } },
          },
          '#encryptionConfiguration':: d.obj(help='"If query results are encrypted in Amazon S3, indicates the encryption option used (for example, SSE_KMS or CSE_KMS) and key information."'),
