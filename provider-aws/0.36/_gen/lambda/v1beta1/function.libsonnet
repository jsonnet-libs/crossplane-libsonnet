{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#ephemeralStorage':: d.obj(help='"The size of the function’s /tmp directory in MB. The default value is 512, but can be any whole number between 512 and 10240 MB."'),
      ephemeralStorage: {
      ...
      '#withArchitectures':: d.fn(help='"The instruction set architecture that the function supports. Enter a string array with one of the valid values (arm64 or x86_64). The default value is x86_64."', args=[d.arg(name='architectures', type=d.T.array)]),
      ...
      '#withArchitecturesMixin':: d.fn(help='"The instruction set architecture that the function supports. Enter a string array with one of the valid values (arm64 or x86_64). The default value is x86_64."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='architectures', type=d.T.array)]),
      ...
      '#withRuntime':: d.fn(help="\"The identifier of the function's runtime (https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html). Runtime is required if the deployment package is a .zip file archive.\"", args=[d.arg(name='runtime', type=d.T.string)]),
