  ...
  spec: {
    ...
    forProvider: {
      ...
      outpostConfig: {
        ...
        '#withOutpostArns':: d.fn(help='"The ARN of the Outpost that you want to use for your local Amazon EKS cluster on Outposts. Only a single Outpost ARN is supported. \\n This member is required."', args=[d.arg(name='outpostArns', type=d.T.array)]),
        ...
        '#withOutpostArnsMixin':: d.fn(help='"The ARN of the Outpost that you want to use for your local Amazon EKS cluster on Outposts. Only a single Outpost ARN is supported. \\n This member is required."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='outpostArns', type=d.T.array)]),
