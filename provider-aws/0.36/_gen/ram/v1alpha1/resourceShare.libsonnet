{
  ...
  spec: {
    ...
    forProvider: {
      '#tags':: d.obj(help="\"Specifies one or more tags to attach to the resource share itself. It doesn't attach the tags to the resources associated with the resource share.\""),
      tags: {
      ...
      '#withAllowExternalPrincipals':: d.fn(help='"Specifies whether principals outside your organization in Organizations can be associated with a resource share. A value of true lets you share with individual Amazon Web Services accounts that are not in your organization. A value of false only has meaning if your account is a member of an Amazon Web Services Organization. The default value is true."', args=[d.arg(name='allowExternalPrincipals', type=d.T.boolean)]),
      withAllowExternalPrincipals(allowExternalPrincipals): { spec+: { forProvider+: { allowExternalPrincipals: allowExternalPrincipals } } },
      '#withClientToken':: d.fn(help="\"Specifies a unique, case-sensitive identifier that you provide to ensure the idempotency of the request. This lets you safely retry the request without accidentally performing the same operation a second time. Passing the same value to a later call to an operation requires that you also pass the same value for all other parameters. We recommend that you use a UUID type of value. (https://wikipedia.org/wiki/Universally_unique_identifier). \\n If you don't provide this value, then Amazon Web Services generates a random one for you.\"", args=[d.arg(name='clientToken', type=d.T.string)]),
      withClientToken(clientToken): { spec+: { forProvider+: { clientToken: clientToken } } },
      '#withName':: d.fn(help='"Specifies the name of the resource share."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withPermissionARNs':: d.fn(help='"Specifies the Amazon Resource Names (ARNs) (https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the RAM permission to associate with the resource share. If you do not specify an ARN for the permission, RAM automatically attaches the default version of the permission for each resource type. You can associate only one permission with each resource type included in the resource share."', args=[d.arg(name='permissionARNs', type=d.T.array)]),
      ...
      '#withResourceARNs':: d.fn(help='"Specifies a list of one or more ARNs of the resources to associate with the resource share."', args=[d.arg(name='resourceARNs', type=d.T.array)]),
      ...
      '#withResourceARNsMixin':: d.fn(help='"Specifies a list of one or more ARNs of the resources to associate with the resource share."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resourceARNs', type=d.T.array)]),
      ...
      '#withTags':: d.fn(help="\"Specifies one or more tags to attach to the resource share itself. It doesn't attach the tags to the resources associated with the resource share.\"", args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { spec+: { forProvider+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      '#withTagsMixin':: d.fn(help="\"Specifies one or more tags to attach to the resource share itself. It doesn't attach the tags to the resources associated with the resource share.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='tags', type=d.T.array)]),
