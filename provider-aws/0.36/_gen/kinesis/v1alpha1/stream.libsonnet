{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#streamModeDetails':: d.obj(help='"Indicates the capacity mode of the data stream. Currently, in Kinesis Data Streams, you can choose between an on-demand capacity mode and a provisioned capacity mode for your data streams."'),
      streamModeDetails: {
        '#withStreamMode':: d.fn(help='', args=[d.arg(name='streamMode', type=d.T.string)]),
