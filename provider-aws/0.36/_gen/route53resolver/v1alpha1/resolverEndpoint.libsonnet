{
  ...
  spec: {
    ...
    forProvider: {
      '#ipAddresses':: d.obj(help='"IPAddresses are the subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC."'),
      ipAddresses: {
        '#subnetIdRef':: d.obj(help='"SubnetIDRefs is a list of references to Subnets used to set the SubnetIDs."'),
        subnetIdRef: {
        ...
        '#withIp':: d.fn(help='"IP address that you want to use for DNS queries."', args=[d.arg(name='ip', type=d.T.string)]),
        withIp(ip): { ip: ip },
        '#withSubnetId':: d.fn(help='"SubnetId is the ID of the subnet that contains the IP address."', args=[d.arg(name='subnetId', type=d.T.string)]),
      ...
      '#tags':: d.obj(help='"A list of the tag keys and values that you want to associate with the endpoint."'),
      tags: {
