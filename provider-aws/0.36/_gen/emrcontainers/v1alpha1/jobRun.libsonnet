{
  ...
  '#':: d.pkg(name='jobRun', url='', help='"JobRun is the Schema for the JobRuns API"'),
  ...
  '#new':: d.fn(help='new returns an instance of JobRun', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"JobRunSpec defines the desired state of JobRun"'),
  spec: {
    '#forProvider':: d.obj(help='"JobRunParameters defines the desired state of JobRun"'),
    forProvider: {
      '#jobDriver':: d.obj(help='"The job driver for the job run."'),
      jobDriver: {
        '#sparkSubmitJobDriver':: d.obj(help='"The information about job driver for Spark submit."'),
        sparkSubmitJobDriver: {
          '#withEntryPoint':: d.fn(help='', args=[d.arg(name='entryPoint', type=d.T.string)]),
          withEntryPoint(entryPoint): { spec+: { forProvider+: { jobDriver+: { sparkSubmitJobDriver+: { entryPoint: entryPoint } } } } },
          '#withEntryPointArguments':: d.fn(help='', args=[d.arg(name='entryPointArguments', type=d.T.array)]),
          withEntryPointArguments(entryPointArguments): { spec+: { forProvider+: { jobDriver+: { sparkSubmitJobDriver+: { entryPointArguments: if std.isArray(v=entryPointArguments) then entryPointArguments else [entryPointArguments] } } } } },
          '#withEntryPointArgumentsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='entryPointArguments', type=d.T.array)]),
          withEntryPointArgumentsMixin(entryPointArguments): { spec+: { forProvider+: { jobDriver+: { sparkSubmitJobDriver+: { entryPointArguments+: if std.isArray(v=entryPointArguments) then entryPointArguments else [entryPointArguments] } } } } },
          '#withSparkSubmitParameters':: d.fn(help='', args=[d.arg(name='sparkSubmitParameters', type=d.T.string)]),
          withSparkSubmitParameters(sparkSubmitParameters): { spec+: { forProvider+: { jobDriver+: { sparkSubmitJobDriver+: { sparkSubmitParameters: sparkSubmitParameters } } } } },
        },
      },
      '#virtualClusterIdRef':: d.obj(help='"VirtualClusterIdRef is a reference to an API used to set the VirtualClusterId."'),
      virtualClusterIdRef: {
        ...
        policy: {
          ...
          withResolution(resolution): { spec+: { forProvider+: { virtualClusterIdRef+: { policy+: { resolution: resolution } } } } },
          ...
          withResolve(resolve): { spec+: { forProvider+: { virtualClusterIdRef+: { policy+: { resolve: resolve } } } } },
        },
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { virtualClusterIdRef+: { name: name } } } },
      },
      '#virtualClusterIdSelector':: d.obj(help='"VirtualClusterIdSelector is a reference to an API used to set the VirtualClusterIdSelector."'),
      virtualClusterIdSelector: {
        '#policy':: d.obj(help='"Policies for selection."'),
        policy: {
          '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
          withResolution(resolution): { spec+: { forProvider+: { virtualClusterIdSelector+: { policy+: { resolution: resolution } } } } },
          '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
          withResolve(resolve): { spec+: { forProvider+: { virtualClusterIdSelector+: { policy+: { resolve: resolve } } } } },
        },
        ...
        withMatchControllerRef(matchControllerRef): { spec+: { forProvider+: { virtualClusterIdSelector+: { matchControllerRef: matchControllerRef } } } },
        '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { forProvider+: { virtualClusterIdSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { virtualClusterIdSelector+: { matchLabels+: matchLabels } } } },
      },
      '#withConfigurationOverrides':: d.fn(help='', args=[d.arg(name='configurationOverrides', type=d.T.string)]),
      withConfigurationOverrides(configurationOverrides): { spec+: { forProvider+: { configurationOverrides: configurationOverrides } } },
      '#withExecutionRoleARN':: d.fn(help='"The execution role ARN for the job run."', args=[d.arg(name='executionRoleARN', type=d.T.string)]),
      withExecutionRoleARN(executionRoleARN): { spec+: { forProvider+: { executionRoleARN: executionRoleARN } } },
      '#withRegion':: d.fn(help='"Region is which region the JobRun will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withReleaseLabel':: d.fn(help='"The Amazon EMR release version to use for the job run."', args=[d.arg(name='releaseLabel', type=d.T.string)]),
      withReleaseLabel(releaseLabel): { spec+: { forProvider+: { releaseLabel: releaseLabel } } },
      '#withTags':: d.fn(help='"The tags assigned to job runs."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"The tags assigned to job runs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
      withTagsMixin(tags): { spec+: { forProvider+: { tags+: tags } } },
      '#withVirtualClusterId':: d.fn(help='"The virtual cluster ID for which the job run request is submitted."', args=[d.arg(name='virtualClusterId', type=d.T.string)]),
      withVirtualClusterId(virtualClusterId): { spec+: { forProvider+: { virtualClusterId: virtualClusterId } } },
    },
