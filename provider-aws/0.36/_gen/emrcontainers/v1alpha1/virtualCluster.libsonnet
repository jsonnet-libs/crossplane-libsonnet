{
  ...
  '#':: d.pkg(name='virtualCluster', url='', help='"VirtualCluster is the Schema for the VirtualClusters API"'),
  ...
  '#new':: d.fn(help='new returns an instance of VirtualCluster', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"VirtualClusterSpec defines the desired state of VirtualCluster"'),
  spec: {
    '#forProvider':: d.obj(help='"VirtualClusterParameters defines the desired state of VirtualCluster"'),
    forProvider: {
      '#containerProvider':: d.obj(help='"The container provider of the virtual cluster."'),
      containerProvider: {
        '#info':: d.obj(help='"The information about the container used for a job run or a managed endpoint."'),
        info: {
          '#eksInfo':: d.obj(help='"The information about the EKS cluster."'),
          eksInfo: {
            '#withNamespace':: d.fn(help='', args=[d.arg(name='namespace', type=d.T.string)]),
            withNamespace(namespace): { spec+: { forProvider+: { containerProvider+: { info+: { eksInfo+: { namespace: namespace } } } } } },
          },
        },
        '#withId':: d.fn(help='', args=[d.arg(name='id', type=d.T.string)]),
        withId(id): { spec+: { forProvider+: { containerProvider+: { id: id } } } },
        '#withType_':: d.fn(help='', args=[d.arg(name='type_', type=d.T.string)]),
        withType_(type_): { spec+: { forProvider+: { containerProvider+: { type_: type_ } } } },
      },
      '#withRegion':: d.fn(help='"Region is which region the VirtualCluster will be created."', args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { forProvider+: { region: region } } },
      '#withTags':: d.fn(help='"The tags assigned to the virtual cluster."', args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { spec+: { forProvider+: { tags: tags } } },
      '#withTagsMixin':: d.fn(help='"The tags assigned to the virtual cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
