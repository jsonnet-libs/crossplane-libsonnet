{
  ...
  spec: {
    ...
    forProvider: {
      '#scopes':: d.obj(help='"A list of scopes. Each scope is a key-value map with the keys name and description."'),
      scopes: {
      ...
      '#withIdentifier':: d.fn(help='"A unique resource server identifier for the resource server. This could be an HTTPS endpoint where the resource server is located, such as https://my-weather-api.example.com."', args=[d.arg(name='identifier', type=d.T.string)]),
      ...
      '#withScopes':: d.fn(help='"A list of scopes. Each scope is a key-value map with the keys name and description."', args=[d.arg(name='scopes', type=d.T.array)]),
      withScopes(scopes): { spec+: { forProvider+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } },
      '#withScopesMixin':: d.fn(help='"A list of scopes. Each scope is a key-value map with the keys name and description."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
