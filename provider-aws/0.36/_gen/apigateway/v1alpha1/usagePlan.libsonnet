      ...
      apiStages: {
        ...
        restApiIdRef: {
          ...
          policy: {
            ...
            withResolution(resolution): { restApiIdRef+: { policy+: { resolution: resolution } } },
            ...
            withResolve(resolve): { restApiIdRef+: { policy+: { resolve: resolve } } },
          },
          '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { restApiIdRef+: { name: name } },
        },
        ...
        restApiIdSelector: {
          ...
          policy: {
            '#withResolution':: d.fn(help="\"Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.\"", args=[d.arg(name='resolution', type=d.T.string)]),
            withResolution(resolution): { restApiIdSelector+: { policy+: { resolution: resolution } } },
            '#withResolve':: d.fn(help="\"Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.\"", args=[d.arg(name='resolve', type=d.T.string)]),
            withResolve(resolve): { restApiIdSelector+: { policy+: { resolve: resolve } } },
          },
          ...
          withMatchControllerRef(matchControllerRef): { restApiIdSelector+: { matchControllerRef: matchControllerRef } },
          '#withMatchLabels':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { restApiIdSelector+: { matchLabels: matchLabels } },
          '#withMatchLabelsMixin':: d.fn(help='"MatchLabels ensures an object with matching labels is selected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { restApiIdSelector+: { matchLabels+: matchLabels } },
        },
        '#withRestApiId':: d.fn(help='"RestAPIID is the ID for the RestAPI."', args=[d.arg(name='restApiId', type=d.T.string)]),
        withRestApiId(restApiId): { restApiId: restApiId },
        '#withStage':: d.fn(help='', args=[d.arg(name='stage', type=d.T.string)]),
        withStage(stage): { stage: stage },
        '#withThrottle':: d.fn(help='', args=[d.arg(name='throttle', type=d.T.object)]),
        withThrottle(throttle): { throttle: throttle },
        '#withThrottleMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='throttle', type=d.T.object)]),
        withThrottleMixin(throttle): { throttle+: throttle },
      },
