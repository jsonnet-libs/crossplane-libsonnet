{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withIpAddressType':: d.fn(help='"The type of IP addresses used by the subnets for your load balancer. The possible values are ipv4 (for IPv4 addresses) and dualstack (for IPv4 and IPv6 addresses)."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
