  ...
  spec: {
    ...
    forProvider: {
      ...
      networkInterfaces: {
        ...
        '#withNetworkInterfaceId':: d.fn(help='"The ID of the network interface. \\n If you are creating a Spot Fleet, omit this parameter because you can’t specify a network interface ID in a launch specification."', args=[d.arg(name='networkInterfaceId', type=d.T.string)]),
