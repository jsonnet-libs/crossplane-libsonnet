{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#withEnableIAMDatabaseAuthentication':: d.fn(help='"Not supported by Neptune."', args=[d.arg(name='enableIAMDatabaseAuthentication', type=d.T.boolean)]),
      ...
      '#withKmsKeyID':: d.fn(help='"The AWS KMS key identifier for an encrypted DB cluster. \\n The KMS key identifier is the Amazon Resource Name (ARN) for the KMS encryption key. If you are creating a DB cluster with the same AWS account that owns the KMS encryption key used to encrypt the new DB cluster, then you can use the KMS key alias instead of the ARN for the KMS encryption key. \\n If an encryption key is not specified in KmsKeyId: \\n    * If ReplicationSourceIdentifier identifies an encrypted source, then    Amazon Neptune will use the encryption key used to encrypt the source.    Otherwise, Amazon Neptune will use your default encryption key. \\n    * If the StorageEncrypted parameter is true and ReplicationSourceIdentifier    is not specified, then Amazon Neptune will use your default encryption    key. \\n AWS KMS creates the default encryption key for your AWS account. Your AWS account has a different default encryption key for each AWS Region. \\n If you create a Read Replica of an encrypted DB cluster in another AWS Region, you must set KmsKeyId to a KMS key ID that is valid in the destination AWS Region. This key is used to encrypt the Read Replica in that AWS Region."', args=[d.arg(name='kmsKeyID', type=d.T.string)]),
      withKmsKeyID(kmsKeyID): { spec+: { forProvider+: { kmsKeyID: kmsKeyID } } },
      '#withMasterUserPassword':: d.fn(help='"The password for the master database user. This password can contain any printable ASCII character except \\"/\\", \\"\\"\\", or \\"@\\". \\n Constraints: Must contain from 8 to 41 characters."', args=[d.arg(name='masterUserPassword', type=d.T.string)]),
