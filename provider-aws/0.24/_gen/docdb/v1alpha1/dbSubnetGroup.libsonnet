{
  ...
  spec: {
    ...
    forProvider: {
      '#subnetIDsRefs':: d.obj(help=''),
      subnetIDsRefs: {
        '#withName':: d.fn(help='"Name of the referenced object."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      '#subnetIDsSelector':: d.obj(help='"A Selector selects an object."'),
      subnetIDsSelector: {
      ...
      '#tags':: d.obj(help='"The tags to be assigned to the subnet group."'),
      tags: {
      ...
      '#withSubnetIDsRefs':: d.fn(help='', args=[d.arg(name='subnetIDsRefs', type=d.T.array)]),
